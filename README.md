...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 350 · 🔀 1.5K · 📦 18K · 📋 1.4K - 28% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 23 · 🔀 790 · 📦 25 · 📋 1.1K - 1% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 260 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 41 · 📋 210 - 24% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 440 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 910 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 980 · 🔀 38K · 📦 1 · 📋 1.2K - 1% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 79M · ⏱️ 01.02.2023):
	```
	conda install -c conda-forge Python
	```
</details>
<details><summary><b><a href="https://github.com/pytransitions/transitions">transitions</a></b> (🥇29 ·  ⭐ 4.7K) - A lightweight, object-oriented finite state machine implementation. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 75 · 🔀 500 · 📦 2.8K · 📋 420 - 1% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/pytransitions/transitions
	```
- [PyPi](https://pypi.org/project/transitions) (📥 380K / month):
	```
	pip install transitions
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 320K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 23 · 🔀 190 · 📦 98K · 📋 160 - 8% open · ⏱️ 06.11.2022):
...
<details><summary><b><a href="https://github.com/tylerlaberge/PyPattyrn">PyPattyrn</a></b> (🥉18 ·  ⭐ 1.8K · 💀) - A simple yet effective library for implementing common design.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 29 · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 3K / month):
	```
...
<details><summary><b><a href="https://github.com/faif/python-patterns">python-patterns</a></b> (🥉16 ·  ⭐ 36K) - A collection of design patterns in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 130 · 🔀 6.4K · 📋 81 - 11% open · ⏱️ 27.01.2023):
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇28 ·  ⭐ 6.1K) - A lightning-fast ASGI server implementation, using uvloop and httptools. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 150 · 🔀 520 · 📋 630 - 3% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 63 · 🔀 220 · 📋 300 - 10% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/django/daphne
	```
- [PyPi](https://pypi.org/project/daphne) (📥 590K / month):
	```
	pip install daphne
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 23K · 📋 690 - 38% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 6.4M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 970K · ⏱️ 26.10.2022):
	```
...
<details><summary><b><a href="https://github.com/jiaaro/pydub">pydub</a></b> (🥇31 ·  ⭐ 6.7K) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 7.9K · 📦 280 · 📋 2.6K - 18% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/beets) (📥 3.3K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 99 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 39 · 🔀 130 · 📥 58K · 📦 9.4K · 📋 490 - 21% open · ⏱️ 26.10.2022):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 760K / month):
	```
	pip install mutagen
	```
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 25 · 🔀 55 · 📥 2.4K · 📦 2.1K · 📋 190 - 24% open · ⏱️ 08.10.2022):

	```
	git clone https://github.com/nicfit/eyeD3
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 35K / month):
	```
	pip install eyeD3
	```
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉22 ·  ⭐ 5.6K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 57 · 📦 16 · 📋 210 - 19% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/Parisson/TimeSide
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 41 / month):
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉19 ·  ⭐ 820) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 110 · 📦 12 · 📋 40 - 32% open · ⏱️ 09.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/matchering) (📥 490 / month):
	```
...
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥉18 ·  ⭐ 420) - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/oauthlib) (📥 89M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 7.5M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 590 · 📦 310K · 📋 380 - 3% open · ⏱️ 31.01.2023):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 100M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 9.4M · ⏱️ 20.10.2022):
	```
	conda install -c conda-forge pyjwt
	```
</details>
<details><summary><b><a href="https://github.com/pennersr/django-allauth">django-allauth</a></b> (🥈34 ·  ⭐ 7.7K) - Authentication app for Django that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 620 · 🔀 2.6K · 📦 130K · 📋 1.9K - 14% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 690K / month):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 90 · 🔀 340 · 📦 24K · 📋 360 - 11% open · ⏱️ 27.12.2022):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 5.8M / month):
	```
	pip install authlib
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 10K · 📋 130 - 38% open · ⏱️ 12.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 50K / month):
	```
...
- [GitHub](https://github.com/davedoesdev/python-jwt) (👨‍💻 5 · 🔀 24 · ⏱️ 01.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-jwt) (📥 240K / month):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 690 · 📋 3.9K - 4% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 320 · 📦 600K · 📋 610 - 17% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 51 · 📦 11K · 📋 54 - 5% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/jab/bidict
	```
- [PyPi](https://pypi.org/project/bidict) (📥 1.1M / month):
	```
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 190K · ⏱️ 01.01.2023):
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 89 · 📥 31 · 📋 150 - 16% open · ⏱️ 29.10.2022):
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 17 · 📥 65 · 📦 68 · 📋 9 - 77% open · ⏱️ 30.10.2015):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 130 · 🔀 340 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 1.8K / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.5K · 📋 1K - 3% open · ⏱️ 02.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 1.6K / month):
	```
	pip install Kotti
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 210 · 📋 440 - 5% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 4.2K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 39 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 64 · 🔀 200 · 📦 840 · 📋 310 - 8% open · ⏱️ 11.07.2022):
...
- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 87 · 🔀 140 · 📦 4.1K · 📋 120 - 52% open · ⏱️ 29.01.2023):
...
- [PyPi](https://pypi.org/project/beaker) (📥 340K / month):
	...
	pip install beaker
	```
- [Conda](https://anaconda.org/conda-forge/beaker) (📥 66K · ⏱️ 11.12.2022):
	```
...
- [GitHub](https://github.com/errbotio/errbot) (🔀 580 · 📦 280 · 📋 760 - 8% open · ⏱️ 22.01.2023):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 360 · 🔀 1.9K · 📥 26K · 📦 240K · 📋 2.2K - 15% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/black) (📥 17M / month):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 6.1M · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 310K · 📋 1.2K - 10% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/isort) (📥 26M / month):
	...
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 4.2M · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 350 · 📦 11K · 📋 1K - 9% open · ⏱️ 02.01.2023):
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 86 · 🔀 150 · 📦 3.6K · 📋 340 - 13% open · ⏱️ 31.01.2023):
...
- [PyPi](https://pypi.org/project/prospector) (📥 700K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 56K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 850 · 📦 49K · 📋 770 - 47% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 2.6M / month):
	```
	pip install yapf
	```
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈26 ·  ⭐ 970) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 93 · 📦 4.6K · 📋 140 - 31% open · ⏱️ 08.08.2022):
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 34 · 🔀 110 · 📦 2.2K · 📋 170 - 6% open · ⏱️ 19.01.2023):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 230 · 🔀 380 · 📋 340 - 31% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 88K / month):
	```
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 270 · 📦 380 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 17K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 14 · 📋 49 - 12% open · ⏱️ 08.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 2.3K / month):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 20% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 120K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 87 · 🔀 250 · 📋 580 - 18% open · ⏱️ 31.01.2023):
...
- [PyPi](https://pypi.org/project/pytype) (📥 280K / month):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 140K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 97 · 📋 59 - 44% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.2K · 🔀 1.4K · 📋 2K - 7% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 210 · 🔀 1.4K · 📦 50K · 📋 1K - 6% open · ⏱️ 28.01.2023):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 19M / month):
	```
	pip install rich
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 390K · 📋 880 - 36% open · ⏱️ 03.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 48M / month):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 760 · 📋 290 - 8% open · ⏱️ 17.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 60K / month):
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 57 · 🔀 1.3K · 📦 17K · 📋 270 - 38% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.5K · 📋 180 - 9% open · ⏱️ 01.01.2023):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 180K / month):
	```
...
<details><summary><b><a href="https://github.com/prompt-toolkit/python-prompt-toolkit">python-prompt-toolkit</a></b> (🥉19 ·  ⭐ 8.1K) - A library for building powerful interactive command.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 640 · 📋 1K - 47% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 4.8K / month):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 2.3K · 📦 12K · 📋 800 - 15% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/jakubroztocil/httpie
	```
- [PyPi](https://pypi.org/project/httpie) (📥 160K / month):
	```
	pip install httpie
	```
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 560K · ⏱️ 01.06.2022):
	```
...
<details><summary><b><a href="https://github.com/tmux-python/tmuxp">tmuxp</a></b> (🥈28 ·  ⭐ 3.6K) - A [tmux](https://github.com/tmux/tmux) session manager. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 70 · 🔀 220 · 📦 220 · 📋 330 - 23% open · ⏱️ 29.01.2023):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 8.6K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 480 · 📦 740 · 📋 660 - 22% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 83 · 🔀 830 · 📦 440 · 📋 250 - 3% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/gleitz/howdoi
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 7.7K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 91 · 📥 11K · 📦 14 · 📋 200 - 24% open · ⏱️ 29.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/iredis) (📥 1.5K / month):
	```
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 520 · ⏱️ 10.08.2022):
	```
	conda install -c conda-forge iredis
	```
</details>
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈24 ·  ⭐ 850) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 50 · 🔀 110 · 📦 160 · 📋 310 - 12% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 23K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 1.4K · ⏱️ 07.01.2023):
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 61 · 📦 200 · 📋 88 - 32% open · ⏱️ 11.07.2022):
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 280 · 📦 38 · 📋 94 - 34% open · ⏱️ 15.01.2022):

	```
	git clone https://github.com/donnemartin/saws
	```
- [PyPi](https://pypi.org/project/saws) (📥 390 / month):
	```
	pip install saws
	```
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 650 · 📦 14 · 📋 69 - 82% open · ⏱️ 19.09.2018):
	...
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 700 / month):
	```
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 93 · 📦 18 · 📋 48 - 25% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/doitlive) (📥 84 / month):
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 45 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 50K / month):
	```
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 120K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 2K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/kornia/kornia) (🔀 750 · 📥 510 · 📋 700 - 28% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 33 · 🔀 170 · 📥 10 · 📦 88K · 📋 84 - 11% open · ⏱️ 09.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 1.1M / month):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 11 · 📦 24K · 📋 150 - 35% open · ⏱️ 18.01.2023):
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 500 · 📦 12 · 📋 1.2K - 14% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 24K / month):
	```
	pip install hydra
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 69K · 📋 1.4K - 51% open · ⏱️ 27.01.2023):
...
- [PyPi](https://pypi.org/project/paramiko) (📥 33M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 2.6M · ⏱️ 26.01.2023):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 17K / month):
	```
	pip install blaze
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 560 · 📥 170K · 📦 760 · 📋 840 - 4% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 17 · 📋 180 - 36% open · ⏱️ 02.12.2016):

	```
	git clone https://github.com/mining/mining
	```
- [PyPi](https://pypi.org/project/mining) (📥 23 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 530 · 📦 300K · 📋 700 - 5% open · ⏱️ 20.01.2023):
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 63 · 🔀 220 · 📦 13K · 📋 340 - 12% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 4.1M / month):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 5.2K · 📋 140 - 51% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/schema) (📥 4.3M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 79K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 89 · 🔀 200 · 📦 6.4K · 📋 240 - 16% open · ⏱️ 23.10.2022):
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 740 · 📋 410 - 56% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 86K / month):
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 3K · 📋 1.1K - 26% open · ⏱️ 02.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 55K / month):
	```
	pip install cartopy
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 590 · 📦 980 · 📋 1.3K - 20% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 42K / month):
	```
	pip install vispy
	```
...
<details><summary><b><a href="https://github.com/msiemens/tinydb">tinydb</a></b> (🥇31 ·  ⭐ 5.6K · 📈) - A tiny, document-oriented database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 79 · 🔀 470 · 📦 9.4K · 📋 290 - 2% open · ⏱️ 14.01.2023):
...
- [PyPi](https://pypi.org/project/tinydb) (📥 450K / month):
	...
	pip install tinydb
	```
- [Conda](https://anaconda.org/conda-forge/tinydb) (📥 240K · ⏱️ 14.01.2023):
	```
	conda install -c conda-forge tinydb
	```
</details>
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥉23 ·  ⭐ 580) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 79 · 📦 960 · 📋 160 - 38% open · ⏱️ 09.11.2022):
...
🔗&nbsp;<b><a href="https://github.com/dhamaniasad/awesome-postgres">awesome-postgres</a></b> ( ⭐ 8.3K)  - A curated list of awesome PostgreSQL software, libraries, tools and..
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 13K · 📋 1.4K - 16% open · ⏱️ 27.03.2022):
...
- [PyPi](https://pypi.org/project/kafka-python) (📥 7.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/kafka-python) (📥 370K · ⏱️ 30.09.2020):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 41 · 🔀 180 · 📦 47K · ⏱️ 11.01.2023):
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 150K · 📋 620 - 4% open · ⏱️ 19.01.2023):
...
- [PyPi](https://pypi.org/project/PyMySQL) (📥 36M / month):
	...
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 990K · ⏱️ 09.01.2021):
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 370 · 🔀 2.2K · 📋 1.3K - 9% open · ⏱️ 29.01.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 880K · ⏱️ 12.01.2023):
	```
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 49 · 🔀 180 · 📦 890 · 📋 260 - 10% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 980 · ⏱️ 31.01.2023):
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 87 · 🔀 310 · 📥 63 · 📦 15K · 📋 460 - 42% open · ⏱️ 23.12.2022):
...
- [PyPi](https://pypi.org/project/pendulum) (📥 10M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 650K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 130 · 📦 890 · 📋 63 - 41% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 760 · 📋 40 - 7% open · ⏱️ 27.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/moment) (📥 78K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 22 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 770 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 20 · 📦 32 · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 4.4K / month):
	```
	pip install PyTime
	```
...
<details><summary><b><a href="https://github.com/jazzband/django-debug-toolbar">django-debug-toolbar</a></b> (🥇31 ·  ⭐ 7.3K) - Display various debug information for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 870 · 📥 180 · 📦 61K · 📋 830 - 7% open · ⏱️ 29.01.2023):

	```
	git clone https://github.com/jazzband/django-debug-toolbar
	```
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 1.7M / month):
	```
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇30 ·  ⭐ 9.7K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 320 · 📥 11K · 📦 300 · 📋 270 - 33% open · ⏱️ 09.12.2022):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 1.5M / month):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 360K · ⏱️ 09.09.2022):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 54 · 🔀 140 · 📦 38K · 📋 180 - 32% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 2.1M / month):
	```
	pip install ipdb
	```
...
- [GitHub](https://github.com/pallets-eco/flask-debugtoolbar) (👨‍💻 46 · 🔀 130 · 📦 20K · 📋 110 - 36% open · ⏱️ 17.01.2023):
...
- [PyPi](https://pypi.org/project/flask-debugtoolbar) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-debugtoolbar) (📥 58K · ⏱️ 30.03.2022):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 88 · 🔀 440 · 📦 4.5K · 📋 210 - 32% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 2M / month):
	```
...
<details><summary><b><a href="https://github.com/inducer/pudb">pudb</a></b> (🥈25 ·  ⭐ 2.6K) - A full-screen, console-based Python debugger. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 210 · 📦 3.8K · 📋 300 - 45% open · ⏱️ 10.01.2023):
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 140 · 📋 98 - 29% open · ⏱️ 04.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 230K / month):
	```
...
- [PyPi](https://pypi.org/project/line_profiler) (📥 360K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 310K · ⏱️ 09.12.2022):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 860 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 41 · 📦 110 · 📋 91 - 42% open · ⏱️ 29.10.2022):
...
<details><summary><b><a href="https://github.com/ionelmc/python-manhole">manhole</a></b> (🥉17 ·  ⭐ 330) - Debugging UNIX socket connections and present the stacktraces for all.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 640K / month):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 28 / month):
	```
	pip install pyringe
	```
...
<details><summary><b><a href="https://github.com/apache/mxnet">mxnet</a></b> (🥈33 ·  ⭐ 20K) - A deep learning framework designed for both efficiency and flexibility. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥉30 ·  ⭐ 62K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.8K · 🔀 17K · 📥 10K · 📋 31K - 32% open · ⏱️ 02.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 61K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 1.3M · ⏱️ 15.01.2023):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇37 ·  ⭐ 9K) - A cross-platform process and system utilities module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 26K · 📋 31K - 2% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 16K · 📋 25K - 9% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 76K / month):
	```
	pip install salt
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 86 · 🔀 300 · 📦 59 · 📋 640 - 17% open · ⏱️ 29.01.2023):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 20K / month):
	```
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 320 · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 19 · 🔀 1.7K · 📋 1.7K - 23% open · ⏱️ 20.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/fabric) (📥 3M / month):
	```
	pip install fabric
	```
...
<details><summary><b><a href="https://github.com/sebastien/cuisine">cuisine</a></b> (🥉19 ·  ⭐ 1.3K · 💀) - Chef-like functionality for Fabric. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sebastien/cuisine) (👨‍💻 57 · 🔀 160 · 📦 170 · 📋 110 - 24% open · ⏱️ 27.02.2018):

	```
	git clone https://github.com/sebastien/cuisine
	```
- [PyPi](https://pypi.org/project/cuisine) (📥 1.7K / month):
	```
	pip install cuisine
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.1K · 📦 7.2K · 📋 13K - 19% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 730K · 📦 35K · 📋 4.8K - 5% open · ⏱️ 29.01.2023):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 920K / month):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 26 · 🔀 210 · 📦 650 · 📋 880 - 4% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 320K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 79 · 📥 370 · 📋 110 - 32% open · ⏱️ 04.11.2022):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 13K / month):
	```
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 990 · ⏱️ 03.11.2022):
	```
...
<details><summary><b><a href="https://github.com/mitmproxy/pdoc">pdoc</a></b> (🥉25 ·  ⭐ 1.4K) - Epydoc replacement to auto generate API documentation for Python.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 42 · 🔀 160 · 📦 1K · 📋 300 - 4% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 79K / month):
	```
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 9.7K · ⏱️ 17.11.2022):
	```
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.6M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 7.9K · ⏱️ 22.12.2018):
	```
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 49 · 🔀 1.3K · 📦 260 · 📋 750 - 0% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 39K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 200 · 📦 33 · 📋 130 - 61% open · ⏱️ 06.05.2022):

	```
	git clone https://github.com/bloomreach/s4cmd
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 47K / month):
	```
	pip install s4cmd
	```
...
<details><summary><b><a href="https://github.com/MicroPyramid/forex-python">forex-python</a></b> (🥇24 ·  ⭐ 550) - Foreign exchange rates, Bitcoin price index and currency conversion. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 25 · 🔀 160 · 📦 1.6K · 📋 69 - 23% open · ⏱️ 05.08.2022):
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 280 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 260 / month):
	```
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.6M · 📦 25K · 📋 17K - 6% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 180 · 🔀 2.7K · 📋 3.2K - 0% open · ⏱️ 17.01.2023):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 81 · 🔀 660 · 📥 33K · 📋 4.5K - 1% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 310 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 170 · 📋 130 - 48% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 30K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 59 · 📥 78 · 📦 17 · 📋 90 - 18% open · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 86 · 🔀 900 · 📦 210K · 📋 1.3K - 6% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 42M / month):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 3.5M · ⏱️ 10.12.2022):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 410 · 🔀 2.6K · 📋 1.6K - 1% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 8.9K / month):
	```
	pip install pyenv
	```
...
<details><summary><b><a href="https://github.com/gorakhargosh/watchdog">watchdog</a></b> (🥇34 ·  ⭐ 5.6K) - API and shell utilities to monitor file system events. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 75K · 📋 590 - 26% open · ⏱️ 29.01.2023):
...
- [PyPi](https://pypi.org/project/watchdog) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 1.7M · ⏱️ 01.01.2023):
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 39 · 📦 8.4K · 📋 17 - 41% open · ⏱️ 14.02.2015):

	```
	git clone https://github.com/mikeorr/Unipath
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 60K / month):
	```
	pip install Unipath
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 680 · 📦 110K · 📋 660 - 9% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/django-crispy-forms/django-crispy-forms
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 750K / month):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 220 · 📦 92K · 📋 160 - 13% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 6.7K · 📋 74 - 8% open · ⏱️ 29.01.2023):

	```
	git clone https://github.com/Suor/funcy
	```
- [PyPi](https://pypi.org/project/funcy) (📥 1.7M / month):
	```
	pip install funcy
	```
...
<details><summary><b><a href="https://github.com/more-itertools/more-itertools">more-itertools</a></b> (🥈28 ·  ⭐ 2.9K) - More routines for operating on iterables, beyond `itertools`. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 96 · 🔀 220 · 📥 2.6K · 📋 230 - 6% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 94 · 📦 260 · 📋 390 - 14% open · ⏱️ 13.01.2023):
...
- [PyPi](https://pypi.org/project/returns) (📥 57K / month):
	...
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 4.2K · ⏱️ 13.03.2022):
	```
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 460 · 📋 48 - 47% open · ⏱️ 13.10.2014):
	...
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 460 / month):
	```
	pip install fn.py
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 20K · 📋 420 - 14% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/pyglet) (📥 320K / month):
	...
	pip install pyglet
	```
- [Conda](https://anaconda.org/conda-forge/pyglet) (📥 470K · ⏱️ 27.01.2023):
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.6K · 📦 7.1K · 📋 3.2K - 21% open · ⏱️ 30.01.2023):
...
<details><summary><b><a href="https://github.com/python-eel/Eel">Eel</a></b> (🥈30 ·  ⭐ 5.4K) - A library for making simple Electron-like offline HTML/JS GUI apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 40 · 🔀 530 · 📦 4.7K · 📋 480 - 32% open · ⏱️ 09.12.2022):

	```
	git clone https://github.com/ChrisKnott/Eel
	```
- [PyPi](https://pypi.org/project/Eel) (📥 87K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 380 · 📦 660 · 📋 570 - 20% open · ⏱️ 08.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 4.5K / month):
	```
	pip install Gooey
	```
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 500 · 📦 720 · 📋 1.1K - 14% open · ⏱️ 31.01.2023):
...
<details><summary><b><a href="https://github.com/r0x0r/pywebview">pywebview</a></b> (🥉24 ·  ⭐ 3.3K) - A lightweight cross-platform native wrapper around a webview.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/r0x0r/pywebview) (🔀 430 · 📦 900 · 📋 700 - 2% open · ⏱️ 31.01.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 440 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 470 / month):
	```
	pip install flexx
	```
- [Conda](https://anaconda.org/conda-forge/flexx) (📥 95K · ⏱️ 12.04.2022):
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 220 · 🔀 560 · 📥 1K · 📋 610 - 17% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 220 · 📦 1.1M · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 48K · 📋 230 - 30% open · ⏱️ 08.05.2022):
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 78 · 🔀 220 · 📦 220K · 📋 360 - 7% open · ⏱️ 23.01.2023):
...
- [PyPi](https://pypi.org/project/bleach) (📥 14M / month):
	...
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 10M · ⏱️ 24.01.2023):
	```
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 180 · 🔀 640 · 📦 54K · 📋 740 - 3% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/httpx) (📥 12M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 440K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 970 · 📥 5.1K · 📦 1.1M · 📋 1.1K - 9% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/urllib3) (📥 310M / month):
	...
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 28M · ⏱️ 11.01.2023):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 77 · 🔀 180 · 📦 130K · 📋 110 - 39% open · ⏱️ 19.01.2023):
...
- [PyPi](https://pypi.org/project/grequests) (📥 340K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 69K · ⏱️ 22.04.2020):
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 410 · 🔀 1.7K · 📦 9.8K · 📋 1.4K - 3% open · ⏱️ 31.01.2023):
...
- [PyPi](https://pypi.org/project/scapy) (📥 2.2M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 68K · ⏱️ 25.12.2022):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 380 · 📦 9.1K · 📋 520 - 64% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 340K / month):
	```
	pip install keyboard
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 13K · ⏱️ 01.11.2022):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 110 · 📦 890 · 📋 110 - 74% open · ⏱️ 23.08.2022):

	```
	git clone https://github.com/boppreh/mouse
	```
- [PyPi](https://pypi.org/project/mouse) (📥 23K / month):
	```
	pip install mouse
	```
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 480 · 📋 100 - 70% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 330 · 📋 930 - 1% open · ⏱️ 27.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 6.5K / month):
	```
	pip install thumbor
	```
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 280 · 📥 920 · 📦 220 · 📋 520 - 25% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/dylanaraps/pywal
	```
- [PyPi](https://pypi.org/project/pywal) (📥 2.4K / month):
	```
	pip install pywal
	```
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 43 · 🔀 110 · 📥 250 · 📦 16K · 📋 100 - 39% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/WhyNotHugo/python-barcode
	```
- [PyPi](https://pypi.org/project/python-barcode) (📥 210K / month):
	```
	pip install python-barcode
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 8.8K · ⏱️ 22.08.2020):
	```
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 230 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 55 · 🔀 540 · 📋 190 - 19% open · ⏱️ 31.01.2023):
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 550 · 🔀 4.5K · 📥 56K · 📋 4.6K - 26% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/micropython) (📥 5 / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micropython) (📥 11K · ⏱️ 17.06.2022):
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 46K · 📋 550 - 45% open · ⏱️ 17.01.2023):
...
<details><summary><b><a href="https://github.com/python/cpython">CPython</a></b> (🥈22 ·  ⭐ 50K) - **Default, most widely used implementation of the Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 25K · 📋 62K - 10% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 120K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 25 · 🔀 150 · 📦 12 · 📋 89 - 26% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 27 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 240K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 71 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 670 / month):
	```
	pip install Pyjion
	```
...
- [GitHub](https://github.com/metawilm/cl-python) (👨‍💻 12 · 🔀 33 · 📋 18 - 11% open · ⏱️ 10.03.2022):
...
🔗&nbsp;<b><a href="https://github.com/markusschanta/awesome-jupyter">awesome-jupyter</a></b> ( ⭐ 3.1K)  - A curated list of awesome Jupyter projects, libraries and resources.
...
- [PyPi](https://pypi.org/project/ptpython) (📥 440K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 27K · ⏱️ 31.10.2022):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 220 · 📋 770 - 16% open · ⏱️ 30.01.2023):
...
- [PyPi](https://pypi.org/project/bpython) (📥 99K / month):
	...
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 57K · ⏱️ 18.01.2023):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 52 · 📦 3K · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 220K / month):
	```
	pip install pyicu
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 51 · 🔀 810 · 📦 23K · 📋 400 - 33% open · ⏱️ 23.04.2022):
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 50 · 🔀 270 · 📦 50 · 📋 100 - 6% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 75 · 📋 9 - 11% open · ⏱️ 14.05.2020):
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 580 · 📦 38K · 📋 700 - 9% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/loguru) (📥 4.1M / month):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 920K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 330 · 📥 3.8K · 📦 29K · 📋 800 - 20% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.6K · 📦 120 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 710 / month):
	```
	pip install nupic
	```
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 270 · 🔀 1.5K · 📋 1.9K - 14% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 7.3K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 84 · 🔀 710 · 📥 600K · 📦 110K · 📋 1.7K - 25% open · ⏱️ 04.01.2023):
...
<details><summary><b><a href="https://github.com/pythonnet/pythonnet">PythonNet</a></b> (🥉28 ·  ⭐ 3.5K) - Python Integration with the .NET Common Language Runtime (CLR). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 98 · 🔀 540 · 📥 840 · 📦 160 · 📋 1.3K - 7% open · ⏱️ 29.01.2023):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 61K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 210 · 📦 770K · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/itsdangerous) (📥 56M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 4.6M · ⏱️ 24.03.2022):
	```
	conda install -c conda-forge itsdangerous
	```
</details>
<details><summary><b><a href="https://github.com/mahmoud/boltons">boltons</a></b> (🥈29 ·  ⭐ 6K) - A set of pure-Python utilities. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 82 · 🔀 330 · 📥 23 · 📦 3K · 📋 140 - 32% open · ⏱️ 20.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/boltons) (📥 3.1M / month):
	```
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 740K · ⏱️ 27.05.2021):
	```
...
- [PyPi](https://pypi.org/project/blinker) (📥 7M / month):
	...
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 7.6M · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.4K · 📦 18K · 📋 820 - 73% open · ⏱️ 15.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jieba) (📥 550K / month):
	```
	pip install jieba
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 33 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):
...
- [PyPi](https://pypi.org/project/stanza) (📥 160K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 7.8K · ⏱️ 15.09.2022):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 250 · 📦 460 · 📋 68 - 27% open · ⏱️ 10.07.2021):

	```
	git clone https://github.com/PetrochukM/PyTorch-NLP
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 6.2K / month):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 940 · 📥 97K · 📦 240 · 📋 160 - 74% open · ⏱️ 08.06.2022):
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.1K · 📋 100 - 38% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 6.3K / month):
	```
	pip install snownlp
	```
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 310 · 📦 850 · 📋 220 - 68% open · ⏱️ 22.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 51K / month):
	```
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 290 · 📦 1.2K · 📋 71 - 35% open · ⏱️ 15.07.2017):
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉14 ·  ⭐ 46K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 230 · 🔀 790 · 📥 310 · 📋 140 - 45% open · ⏱️ 17.10.2022):
...
<details><summary><b><a href="https://github.com/mininet/mininet">mininet</a></b> (🥉25 ·  ⭐ 4.7K) - A popular network emulator and API written in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 490K · 📦 190 · 📋 680 - 36% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mininet) (📥 1.8K / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 4 · 📦 930 · 📋 300 - 5% open · ⏱️ 19.12.2022):
...
- [GitHub](https://github.com/tschellenbach/Stream-Framework) (👨‍💻 26 · 🔀 540 · 📋 180 - 35% open · ⏱️ 15.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/Stream-Framework) (📥 2.8K / month):
	```
...
<details><summary><b><a href="https://github.com/coleifer/peewee">peewee</a></b> (🥇36 ·  ⭐ 9.7K) - A small, expressive ORM. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 19K · ⏱️ 01.02.2023):

	```
	git clone https://github.com/coleifer/peewee
	```
- [PyPi](https://pypi.org/project/peewee) (📥 1.5M / month):
	```
	pip install peewee
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 380 · 🔀 1.1K · 📦 19K · 📋 1.6K - 20% open · ⏱️ 28.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 930K / month):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 400 · 📦 1.2K · 📋 550 - 37% open · ⏱️ 29.01.2023):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 240K · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 2.7K · 📋 280 - 7% open · ⏱️ 30.01.2023):
...
- [PyPi](https://pypi.org/project/dataset) (📥 50K / month):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 4.4K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 45 · 📦 2.9K · 📋 600 - 46% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 18 · 🔀 92 · 📋 79 - 20% open · ⏱️ 30.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/orm) (📥 3.7K / month):
	```
	pip install orm
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 430 · 🔀 1.8K · 📥 15M · 📋 4.7K - 11% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 490 · 📋 900 - 12% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 9M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 70K · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.2K · 📋 8.8K - 10% open · ⏱️ 02.02.2023):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇20 ·  ⭐ 640) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 92 · 🔀 110 · 📦 200 · 📋 720 - 10% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/devpi) (📥 3.1K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 330 · 🔀 790 · 📋 2.8K - 14% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 5 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 79 / month):
	```
...
<details><summary><b><a href="https://github.com/pypa/bandersnatch">bandersnatch</a></b> (🥉13 ·  ⭐ 350) - PyPI mirroring tool provided by Python Packaging Authority.. <code><a href="https://tldrlegal.com/search?q=AFL-3.0">❗️AFL-3.0</a></code></summary>

- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 31.01.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 4.9K · 📋 4.9K - 1% open · ⏱️ 01.02.2023):
...
<details><summary><b><a href="https://github.com/django-guardian/django-guardian">django-guardian</a></b> (🥇26 ·  ⭐ 3.3K · 💤) - Implementation of per object permissions for Django.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 86 · 🔀 460 · 📦 11K · 📋 430 - 3% open · ⏱️ 05.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/sh) (📥 3.7M / month):
	```
	pip install sh
	```
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 400 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 4.2K / month):
	```
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 28 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 2.3K / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 460 · 📦 100 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 570 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 78 · 🔀 140 · 📦 49K · 📋 290 - 25% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 410 · 🔀 4.4K · 📦 130K · 📋 3.3K - 27% open · ⏱️ 31.01.2023):
...
- [PyPi](https://pypi.org/project/fastapi) (📥 11M / month):
	...
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 1.2M · ⏱️ 10.01.2023):
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 880 · 📥 4.2K · 📦 7.5K · 📋 970 - 15% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 690K / month):
	```
	pip install falcon
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.4K · 📦 9K · 📋 1.3K - 4% open · ⏱️ 30.01.2023):
...
<details><summary><b><a href="https://github.com/flask-restful/flask-restful">flask-restful</a></b> (🥈32 ·  ⭐ 6.5K · 💤) - Quickly building REST APIs for Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 1.9K · 📋 460 - 35% open · ⏱️ 10.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/hug) (📥 58K / month):
	```
	pip install hug
	```
...
- [GitHub](https://github.com/Cornices/cornice) (👨‍💻 120 · 🔀 140 · 📦 780 · 📋 240 - 19% open · ⏱️ 18.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/cornice) (📥 34K / month):
	```
	pip install cornice
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.1K · 📋 310 - 4% open · ⏱️ 30.01.2023):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.7K · 📥 490K · 📦 52K · 📋 12K - 32% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 3.4M / month):
	```
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 2.8M · ⏱️ 27.10.2022):
	```
	conda install -c conda-forge sympy
	```
</details>
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">statsmodels</a></b> (🥇35 ·  ⭐ 8.1K) - Statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/zipline) (📥 3K / month):
	...
	pip install zipline
	```
- [Conda](https://anaconda.org/conda-forge/zipline) (📥 6.7K · ⏱️ 05.10.2020):
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 440 · 🔀 1.7K · 📥 1.9K · 📦 1.1K · 📋 2.9K - 5% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 120 · ⏱️ 22.01.2023):
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 96 · 🔀 340 · 📋 3K - 3% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 90 / month):
	```
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 590 · 📦 66K · 📋 1.2K - 11% open · ⏱️ 24.01.2023):
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 46 · 📦 780 · 📋 79 - 13% open · ⏱️ 12.09.2022):
...
- [PyPi](https://pypi.org/project/pysimdjson) (📥 240K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 52K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 19 · 🔀 42 · 📦 3.2K · 📋 100 - 11% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/python-rapidjson/python-rapidjson
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 890K / month):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 85 · 🔀 330 · 📋 330 - 7% open · ⏱️ 29.01.2023):
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 570 · 📥 8K · 📋 2.4K - 10% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 35 · 🔀 220 · 📦 200K · 📋 250 - 6% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/mistune) (📥 12M / month):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 10M · ⏱️ 16.01.2023):
	```
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 28K · 📋 240 - 11% open · ⏱️ 21.01.2023):
...
- [PyPi](https://pypi.org/project/tablib) (📥 1.5M / month):
	...
	pip install tablib
	```
- [Conda](https://anaconda.org/conda-forge/tablib) (📥 81K · ⏱️ 16.01.2023):
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 55K · 📋 830 - 1% open · ⏱️ 31.01.2023):
...
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/XlsxWriter) (📥 2.4M · ⏱️ 14.01.2023):
	```
	conda install -c conda-forge XlsxWriter
	```
</details>
<details><summary><b><a href="https://github.com/wireservice/csvkit">csvkit</a></b> (🥈28 ·  ⭐ 5.3K) - Utilities for converting to and working with CSV. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/euske/pdfminer) (👨‍💻 28 · 🔀 1K · 📦 3.5K · 📋 240 - 82% open · ⏱️ 18.01.2020):
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 440 · 📥 24K · 📦 27K · 📋 1.7K - 15% open · ⏱️ 02.02.2023):
...
- [PyPi](https://pypi.org/project/xlwings) (📥 84K / month):
	...
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 540K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 760 · 📦 240K · 📋 800 - 4% open · ⏱️ 09.01.2023):
...
<details><summary><b><a href="https://github.com/py-pdf/pypdf">PyPDF2</a></b> (🥉23 ·  ⭐ 5.1K · 📉) - A library capable of splitting, merging and transforming PDF.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 160 · 🔀 1K · 📋 650 - 11% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/mstamy2/PyPDF2
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 5.4M / month):
	```
	pip install PyPDF2
	```
- [Conda](https://anaconda.org/conda-forge/PyPDF2) (📥 340K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 56 · 📦 10 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 29 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 720 · 📦 6.5K · 📋 1.6K - 3% open · ⏱️ 30.01.2023):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.1K · 📦 30K · 📋 1.8K - 6% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 230 · 🔀 350 · 📦 460 · 📋 2.1K - 2% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/nikola) (📥 870 / month):
	```
	pip install nikola
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 290 · 📥 7K · 📋 620 - 35% open · ⏱️ 18.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/lektor) (📥 3K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 12K · 📋 1K - 13% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 790K / month):
	```
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 85K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 86 · 🔀 230 · 📥 34 · 📦 580 · 📋 310 - 10% open · ⏱️ 28.12.2022):
...
- [PyPi](https://pypi.org/project/dramatiq) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 40K · ⏱️ 03.04.2022):
	```
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇22 ·  ⭐ 9K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 940 - 5% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 500 · 🔀 1.7K · 📦 100K · 📋 610 - 2% open · ⏱️ 27.01.2023):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 7.2M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 710K · ⏱️ 25.01.2023):
	```
	conda install -c conda-forge faker
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇35 ·  ⭐ 7.7K) - A generic test automation framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 170 · 🔀 2K · 📥 540 · 📦 6.7K · 📋 4K - 6% open · ⏱️ 18.01.2023):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 520 · 📦 16K · 📋 1.4K - 3% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 4.3M / month):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7.1M · ⏱️ 02.02.2023):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6K · 📋 510 - 8% open · ⏱️ 25.01.2023):
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈30 ·  ⭐ 7.6K · 💀) - PyAutoGUI is a cross-platform GUI automation Python module for.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 980 · 📦 20K · 📋 610 - 64% open · ⏱️ 14.09.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 380 · 📦 1.1K · 📋 310 - 0% open · ⏱️ 27.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 95K / month):
	```
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 76K · ⏱️ 18.12.2022):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 120 · 🔀 310 · 📦 4.6K · 📋 340 - 24% open · ⏱️ 01.11.2022):
...
- [PyPi](https://pypi.org/project/locust) (📥 1.3M / month):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 97K · ⏱️ 06.01.2023):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 250 · 📦 7.1K · 📋 240 - 39% open · ⏱️ 16.10.2022):
...
<details><summary><b><a href="https://github.com/schemathesis/schemathesis">Schemathesis</a></b> (🥉26 ·  ⭐ 1.6K) - A tool for automatic property-based testing of web applications.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 51 · 🔀 120 · 📦 150 · 📋 690 - 16% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/schemathesis) (📥 56K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 3K · ⏱️ 13.11.2022):
	```
	conda install -c conda-forge schemathesis
	```
</details>
<details><summary><b><a href="https://github.com/spulec/freezegun">freezegun</a></b> (🥉23 ·  ⭐ 3.6K) - Travel through time by mocking the datetime module. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 230 · 📋 270 - 36% open · ⏱️ 12.08.2022):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 5.9M / month):
	```
	pip install freezegun
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 680K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 130 · 🔀 350 · 📋 540 - 29% open · ⏱️ 07.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/factory_boy) (📥 2.5M / month):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 5.7K · 📋 260 - 19% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/nose-devs/nose2
	```
- [PyPi](https://pypi.org/project/nose2) (📥 540K / month):
	```
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 82K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 190 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 100 / month):
	```
	pip install sixpack
	```
...
- [PyPi](https://pypi.org/project/httmock) (📥 410K / month):
	...
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 7.2K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 43 · 🔀 91 · 📋 84 - 41% open · ⏱️ 23.03.2022):

	```
	git clone https://github.com/klen/mixer
	```
- [PyPi](https://pypi.org/project/mixer) (📥 92K / month):
	```
	pip install mixer
	```
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 600 · 📦 660K · 📋 490 - 42% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 53 · 🔀 230 · 📥 7.6K · 📦 710K · 📋 280 - 13% open · ⏱️ 23.01.2023):
...
- [PyPi](https://pypi.org/project/pyparsing) (📥 77M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 31M · ⏱️ 14.07.2022):
	```
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📦 16K · 📋 180 - 44% open · ⏱️ 09.09.2021):
...
<details><summary><b><a href="https://github.com/life4/textdistance">textdistance</a></b> (🥈28 ·  ⭐ 3K) - Compute distance between sequences with 30+ algorithms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 100 · 📦 26K · 📋 48 - 27% open · ⏱️ 16.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 930K / month):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 32 · 🔀 92 · 📋 63 - 1% open · ⏱️ 27.01.2023):
...
- [PyPi](https://pypi.org/project/ply) (📥 21M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 3.1M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 47 · 📦 2.1K · 📋 18 - 55% open · ⏱️ 22.10.2021):

	```
	git clone https://github.com/mozilla/unicode-slugify
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 33K / month):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 240 - 10% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 15 / month):
	```
...
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 58K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/awesome-slugify) (📥 64K · ⏱️ 28.06.2019):
	```
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.6K · 📦 250K · 📋 2.8K - 4% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 530M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 14M · ⏱️ 02.02.2023):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 130K · 📋 960 - 8% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 42M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 1.8M · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 860 · 📥 240 · 📦 20K · 📋 780 - 6% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 390 · 📦 5.7K · 📋 330 - 6% open · ⏱️ 16.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/twython) (📥 150K / month):
	```
	pip install twython
	```
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 920 · 📦 3.8K · 📋 240 - 8% open · ⏱️ 27.12.2020):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.5K · 📋 280 - 2% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 810K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 58 · 📦 7.6K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 70K / month):
	```
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 15 · 🔀 140 · 📋 110 - 26% open · ⏱️ 01.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 3.3M / month):
	```
	pip install furl
	```
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 43K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 860 · 📦 9.7K · 📋 370 - 44% open · ⏱️ 10.05.2020):

	```
	git clone https://github.com/psf/requests-html
	```
- [PyPi](https://pypi.org/project/requests-html) (📥 870K / month):
	```
	pip install requests-html
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 4.9K · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 890 · ⏱️ 14.12.2022):

	```
	git clone https://github.com/coleifer/micawber
	```
- [PyPi](https://pypi.org/project/micawber) (📥 43K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 7.7K · ⏱️ 14.07.2021):
	```
...
- [PyPi](https://pypi.org/project/textract) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textract) (📥 18K · ⏱️ 10.03.2022):
	```
...
- [PyPi](https://pypi.org/project/html2text) (📥 1.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 26K · ⏱️ 09.02.2020):
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 53 · 🔀 360 · 📥 43 · 📋 160 - 15% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 64K / month):
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 340 · 📦 880 · 📋 74 - 59% open · ⏱️ 07.06.2015):
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 130 · 🔀 730 · 📦 23K · 📋 880 - 20% open · ⏱️ 15.01.2023):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 730 · 📋 1.2K - 5% open · ⏱️ 30.12.2022):

	```
	git clone https://github.com/django/channels
	```
- [PyPi](https://pypi.org/project/channels) (📥 590K / month):
	```
...
- [PyPi](https://pypi.org/project/gunicorn) (📥 25M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gunicorn) (📥 1.7M · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 250 · 📦 920K · 📋 1K - 1% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/werkzeug) (📥 84M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 6.7M · ⏱️ 09.08.2022):
	```
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 50 · 🔀 150 · 📦 100K · 📋 210 - 6% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/waitress) (📥 3M / month):
	```
	pip install waitress
	```
- [Conda](https://anaconda.org/conda-forge/waitress) (📥 100K · ⏱️ 31.05.2022):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 540 · 📋 160 - 15% open · ⏱️ 11.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 19K / month):
	```
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 95K · ⏱️ 02.11.2022):
	```
