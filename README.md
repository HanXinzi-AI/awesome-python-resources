...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 24 · 🔀 790 · 📦 25 · 📋 1.1K - 0% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 390 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 790 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 340 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 42 · 📋 210 - 24% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 530 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 760 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 980 · 🔀 38K · 📦 2 · 📋 1.2K - 1% open · ⏱️ 20.03.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 86M · ⏱️ 02.02.2023):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 75 · 🔀 500 · 📦 3K · 📋 420 - 1% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/transitions) (📥 420K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 360K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 200 · 🔀 4.1K · 📦 79 · 📋 160 - 35% open · ⏱️ 08.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 9.4K / month):
	```
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 36 · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 2K / month):
	```
...
- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 130 · 🔀 6.4K · 📋 82 - 10% open · ⏱️ 27.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-patterns) (📥 30 / month):
	```
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇36 ·  ⭐ 6.3K · 📈) - A lightning-fast ASGI server implementation, using uvloop and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 160 · 🔀 540 · 📦 160K · 📋 640 - 3% open · ⏱️ 16.03.2023):
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 64 · 🔀 230 · 📋 300 - 10% open · ⏱️ 07.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/daphne) (📥 620K / month):
	```
	pip install daphne
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 56 · 🔀 470 · 📥 370 · 📦 71K · 📋 310 - 18% open · ⏱️ 15.01.2023):
...
- [PyPi](https://pypi.org/project/uvloop) (📥 16M / month):
	...
	pip install uvloop
	```
- [Conda](https://anaconda.org/conda-forge/uvloop) (📥 560K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 27K · 📋 700 - 36% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 7.9M / month):
	```
	pip install trio
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 900 · 📦 20K · 📋 520 - 49% open · ⏱️ 08.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pydub) (📥 6M / month):
	```
	pip install pydub
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 8K · 📦 310 · 📋 2.6K - 18% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 2.3K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 170 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 42 · 🔀 130 · 📥 58K · 📦 11K · 📋 490 - 18% open · ⏱️ 22.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 1.9M / month):
	```
	pip install mutagen
	```
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 25 · 🔀 55 · 📥 2.6K · 📦 2.3K · 📋 190 - 24% open · ⏱️ 08.10.2022):

	```
	git clone https://github.com/nicfit/eyeD3
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 27K / month):
	```
	pip install eyeD3
	```
...
- [PyPi](https://pypi.org/project/audioread) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/audioread) (📥 600K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 850 · 📋 1.1K - 4% open · ⏱️ 17.03.2023):
...
- [PyPi](https://pypi.org/project/librosa) (📥 1.6M / month):
	...
	pip install librosa
	```
- [Conda](https://anaconda.org/conda-forge/librosa) (📥 600K · ⏱️ 17.03.2023):
	```
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 25 · 🔀 92 · 📦 720 · 📋 99 - 13% open · ⏱️ 20.03.2023):
...
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥉21 ·  ⭐ 870 · 💤) - Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/worldveil/dejavu">dejavu</a></b> (🥉19 ·  ⭐ 6K · 💀) - Audio fingerprinting and recognition. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.3K · 📦 26 · 📋 220 - 41% open · ⏱️ 03.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 310 / month):
	```
	pip install dejavu
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉19 ·  ⭐ 870) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 110 · 📦 13 · 📋 40 - 32% open · ⏱️ 06.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/matchering) (📥 520 / month):
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 190 · 🔀 440 · 📦 340K · 📋 360 - 20% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/oauthlib) (📥 83M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 8M · ⏱️ 18.10.2022):
	```
	conda install -c conda-forge oauthlib
	```
</details>
<details><summary><b><a href="https://github.com/jpadilla/pyjwt">pyjwt</a></b> (🥈36 ·  ⭐ 4.5K) - JSON Web Token implementation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 600 · 📦 350K · 📋 390 - 5% open · ⏱️ 18.03.2023):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 110M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 9.9M · ⏱️ 20.10.2022):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 620 · 🔀 2.6K · 📦 140K · 📋 1.9K - 14% open · ⏱️ 20.03.2023):
...
- [PyPi](https://pypi.org/project/django-allauth) (📥 730K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 88K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 93 · 🔀 340 · 📦 26K · 📋 360 - 12% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 6M / month):
	```
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 98K · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 690 · 📋 750 - 20% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 690 · 📋 3.9K - 4% open · ⏱️ 21.03.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 330 · 📦 660K · 📋 620 - 18% open · ⏱️ 18.03.2023):
...
- [PyPi](https://pypi.org/project/attrs) (📥 130M / month):
	...
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 26M · ⏱️ 21.12.2022):
	```
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 53 · 📦 12K · 📋 54 - 5% open · ⏱️ 05.03.2023):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 350 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 890 / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 760 / month):
	```
	pip install Kotti
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 210 · 📋 440 - 5% open · ⏱️ 09.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 6.2K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 51 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 66 · 🔀 200 · 📦 1.1K · 📋 310 - 5% open · ⏱️ 17.03.2023):
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 91 · 📦 4.5K · 📋 190 - 10% open · ⏱️ 26.08.2022):
...
- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 88 · 🔀 130 · 📦 4.5K · 📋 120 - 52% open · ⏱️ 04.02.2023):

	```
	git clone https://github.com/bbangert/beaker
	```
- [PyPi](https://pypi.org/project/beaker) (📥 330K / month):
	```
	pip install beaker
	```
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 260 · 📋 72 - 22% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 6.5K / month):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 360 · 🔀 1.9K · 📥 27K · 📦 350K · 📋 2.2K - 16% open · ⏱️ 19.03.2023):
...
- [PyPi](https://pypi.org/project/black) (📥 20M / month):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 6.7M · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 370K · 📋 1.2K - 10% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 360 · 📦 14K · 📋 1.1K - 8% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 87 · 🔀 160 · 📦 4.1K · 📋 350 - 14% open · ⏱️ 07.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 620K / month):
	```
	pip install prospector
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 63K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 850 · 📦 72K · 📋 770 - 47% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 3.8M / month):
	```
	pip install yapf
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 93 · 📦 5.7K · 📋 140 - 33% open · ⏱️ 08.08.2022):
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 35 · 🔀 110 · 📦 3.6K · 📋 180 - 7% open · ⏱️ 27.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/vulture) (📥 410K / month):
	```
	pip install vulture
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 240 · 🔀 390 · 📋 340 - 31% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 280 · 📦 400 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 13K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 15 · 📋 51 - 15% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/scottrogowski/code2flow
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 3.6K / month):
	```
	pip install code2flow
	```
- [Conda](https://anaconda.org/conda-forge/code2flow) (📥 2.1K · ⏱️ 10.01.2023):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 90 · 🔀 250 · 📋 600 - 19% open · ⏱️ 21.03.2023):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 310K / month):
	```
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 150K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 55 · 📦 110 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 5.2K / month):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 20% open · ⏱️ 20.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 51K / month):
	```
	pip install MonkeyType
	```
- [Conda](https://anaconda.org/conda-forge/MonkeyType) (📥 48K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.3K · 🔀 1.4K · 📋 2.1K - 7% open · ⏱️ 23.03.2023):
...
<details><summary><b><a href="https://github.com/Textualize/rich">rich</a></b> (🥇37 ·  ⭐ 43K) - Python library for rich text and beautiful formatting in the terminal. Also.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Textualize/rich) (👨‍💻 220 · 🔀 1.5K · 📦 74K · 📋 1.1K - 7% open · ⏱️ 21.03.2023):
...
- [PyPi](https://pypi.org/project/rich) (📥 23M / month):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 3.3M · ⏱️ 04.03.2023):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 430K · 📋 900 - 37% open · ⏱️ 03.03.2023):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 58M / month):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 820 · 📋 290 - 8% open · ⏱️ 17.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 70K / month):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.7K · 📋 180 - 8% open · ⏱️ 01.01.2023):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 280K / month):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 2.9K · 📦 13K · 📋 810 - 16% open · ⏱️ 22.03.2023):
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 630K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.2K · 📦 410 · 📋 660 - 31% open · ⏱️ 25.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/thefuck) (📥 6.5K / month):
	```
	pip install thefuck
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 72 · 🔀 220 · 📦 230 · 📋 340 - 23% open · ⏱️ 05.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 5.7K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 490 · 📦 870 · 📋 660 - 22% open · ⏱️ 18.03.2023):
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 290 · 📋 620 - 29% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mycli) (📥 68K / month):
	```
	pip install mycli
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈25 ·  ⭐ 930) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 54 · 🔀 110 · 📦 380 · 📋 330 - 15% open · ⏱️ 21.03.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 35K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 2K · ⏱️ 07.01.2023):
	```
...
- [PyPi](https://pypi.org/project/iredis) (📥 1.8K / month):
	...
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 570 · ⏱️ 10.08.2022):
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 63 · 📦 210 · 📋 89 - 32% open · ⏱️ 11.07.2022):
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 660 · 📦 14 · 📋 70 - 82% open · ⏱️ 19.09.2018):
	...
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 550 / month):
	```
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 93 · 📦 18 · 📋 49 - 26% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 45 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 68K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.4K · 📥 4M · 📦 2.3K · 📋 740 - 24% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 150K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 2.7K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 13K · 📥 1.1K · 📋 1.3K - 54% open · ⏱️ 10.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 59K / month):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉24 ·  ⭐ 7.9K) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 790 · 📥 570 · 📦 3.4K · 📋 730 - 28% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/sightmachine/SimpleCV) (👨‍💻 100 · 🔀 760 · 📦 390 · 📋 330 - 22% open · ⏱️ 07.04.2015):
	...
	```
- [PyPi](https://pypi.org/project/SimpleCV) (📥 4K / month):
	```
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 86 · 📦 300 · 📋 75 - 44% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 35 · 🔀 170 · 📥 11 · 📦 93K · 📋 85 - 4% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 21 · 📦 25K · 📋 150 - 36% open · ⏱️ 18.01.2023):
...
- [PyPi](https://pypi.org/project/configobj) (📥 3.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 590K · ⏱️ 20.01.2023):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 520 · 📦 14 · 📋 1.2K - 14% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 74K · 📋 1.5K - 50% open · ⏱️ 10.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 35M / month):
	```
	pip install paramiko
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 2.9M · ⏱️ 13.03.2023):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 64 · 🔀 200 · 📋 290 - 14% open · ⏱️ 16.03.2023):
...
- [PyPi](https://pypi.org/project/pynacl) (📥 40M / month):
	...
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 3.9M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 9.4K / month):
	```
	pip install blaze
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 570 · 📥 180K · 📦 920 · 📋 890 - 4% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 18 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 27 / month):
	```
	pip install mining
	```
...
<details><summary><b><a href="https://github.com/python-jsonschema/jsonschema">jsonschema</a></b> (🥇33 ·  ⭐ 4.1K) - An implementation of [JSON Schema](http://json-schema.org/) for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 110 · 🔀 530 · 📦 350K · 📋 720 - 4% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 63 · 🔀 230 · 📦 13K · 📋 340 - 12% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 5.7M / month):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 6K · 📋 150 - 51% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/schema) (📥 4.7M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 86K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 90 · 🔀 200 · 📦 13K · 📋 240 - 16% open · ⏱️ 22.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/voluptuous) (📥 2.7M / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 190 · 🔀 1.6K · 📥 240 · 📦 240K · 📋 2.3K - 4% open · ⏱️ 20.03.2023):
...
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈36 ·  ⭐ 8.1K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📥 21 · 📦 49K · 📋 1.8K - 11% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 920 · 📋 420 - 57% open · ⏱️ 13.01.2023):
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 640 · 🔀 4K · 📦 200 · 📋 7.2K - 9% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 99 · 🔀 190 · 📦 4.6K · 📋 550 - 12% open · ⏱️ 15.03.2023):
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 60 · 🔀 440 · 📦 38 · 📋 580 - 37% open · ⏱️ 21.03.2023):
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 590 · 📦 1.1K · 📋 1.4K - 21% open · ⏱️ 20.03.2023):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 54K / month):
	```
	pip install vispy
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 3.2K · 📋 1.1K - 26% open · ⏱️ 16.03.2023):
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 81 · 📦 1K · 📋 160 - 39% open · ⏱️ 12.03.2023):

	```
	git clone https://github.com/zopefoundation/ZODB
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 69K / month):
	```
	pip install ZODB
	```
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 17K · 📋 1.4K - 16% open · ⏱️ 02.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 11M / month):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 42 · 🔀 180 · 📦 54K · ⏱️ 21.03.2023):
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 160K · 📋 630 - 3% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/PyMySQL/PyMySQL
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 40M / month):
	```
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 1.1M · ⏱️ 09.01.2021):
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 380 · 🔀 2.2K · 📋 1.4K - 10% open · ⏱️ 22.03.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 920K · ⏱️ 23.03.2023):
	```
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 52 · 🔀 180 · 📦 1.4K · 📋 270 - 11% open · ⏱️ 12.03.2023):
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.8K · ⏱️ 13.03.2023):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 980 · ⏱️ 21.03.2023):
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 12 · 🔀 32 · 📦 120 · 📋 18 - 22% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 5.4K / month):
	```
	pip install queries
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 230 / month):
	```
...
- [GitHub](https://github.com/PyMySQL/mysqlclient) (👨‍💻 73 · 🔀 360 · 📥 5.2K · 📋 300 - 5% open · ⏱️ 13.03.2023):
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 88 · 🔀 310 · 📥 79 · 📦 19K · 📋 460 - 43% open · ⏱️ 25.02.2023):
...
- [PyPi](https://pypi.org/project/pendulum) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 680K · ⏱️ 04.02.2023):
	```
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 420 · 📥 35K · 📦 980K · 📋 660 - 40% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 780 · 📋 40 - 7% open · ⏱️ 27.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/moment) (📥 74K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 880 · 📥 180 · 📦 68K · 📋 830 - 7% open · ⏱️ 11.03.2023):
...
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 1.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-debug-toolbar) (📥 160K · ⏱️ 06.02.2023):
	```
	conda install -c conda-forge django-debug-toolbar
	```
</details>
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇30 ·  ⭐ 9.9K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 330 · 📥 12K · 📦 2.4K · 📋 280 - 35% open · ⏱️ 09.12.2022):
...
- [PyPi](https://pypi.org/project/py-spy) (📥 1.8M / month):
	...
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 400K · ⏱️ 09.09.2022):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 56 · 🔀 140 · 📦 43K · 📋 180 - 31% open · ⏱️ 13.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 2.4M / month):
	```
	pip install ipdb
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 89 · 🔀 440 · 📦 4.9K · 📋 210 - 32% open · ⏱️ 21.03.2023):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 2.2M / month):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 210 · 📦 4.5K · 📋 310 - 45% open · ⏱️ 13.03.2023):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 230K / month):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 41 · 🔀 56 · 📦 4.6K · 📋 200 - 37% open · ⏱️ 14.07.2022):
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 150 · 📦 110 · 📋 83 - 31% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 4.5K / month):
	```
	pip install vprof
	```
...
- [PyPi](https://pypi.org/project/line_profiler) (📥 340K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 360K · ⏱️ 09.12.2022):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 560 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 20 · 📦 240 · 📋 22 - 31% open · ⏱️ 17.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-manhole) (📥 6 / month):
	```
...
- [PyPi](https://pypi.org/project/memory_profiler) (📥 700K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/memory_profiler) (📥 300K · ⏱️ 16.11.2022):
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 260K · 📋 37K - 5% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/tensorflow) (📥 17M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 4M · ⏱️ 23.03.2023):
	```
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 6.2K · 📋 9.6K - 18% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 530K / month):
	```
	pip install mxnet
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.9K · 🔀 17K · 📥 12K · 📋 32K - 32% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 87K / month):
	```
	pip install pytorch
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 740 · 📥 270 · ⏱️ 22.05.2020):

	```
	git clone https://github.com/SerpentAI/SerpentAI
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 98 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 280K · 📋 1.6K - 14% open · ⏱️ 18.03.2023):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 66M / month):
	```
	pip install psutil
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 27K · 📋 31K - 2% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.3M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 840K · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 15K · 📋 25K - 9% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.8K · 📋 1.1K - 10% open · ⏱️ 19.03.2023):
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 140 · 📦 4.8K · 📋 100 - 11% open · ⏱️ 24.10.2022):
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 88 · 🔀 300 · 📦 74 · 📋 650 - 18% open · ⏱️ 16.03.2023):
...
- [PyPi](https://pypi.org/project/pyinfra) (📥 17K / month):
	...
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 520 · ⏱️ 21.01.2023):
	```
...
- [PyPi](https://pypi.org/project/fabric) (📥 3.5M / month):
	...
	pip install fabric
	```
- [Conda](https://anaconda.org/conda-forge/fabric) (📥 61K · ⏱️ 22.01.2023):
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 190 · 📦 300 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools) (📥 3.4K / month):
	```
...
- [PyPi](https://pypi.org/project/luigi) (📥 790K / month):
	...
	pip install luigi
	```
- [Conda](https://anaconda.org/conda-forge/luigi) (📥 610K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 47K · 📋 4.7K - 16% open · ⏱️ 22.03.2023):
...
- [PyPi](https://pypi.org/project/dask) (📥 7.2M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 8.3M · ⏱️ 10.03.2023):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.2K · 📥 40 · 📦 8.6K · 📋 13K - 20% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 740K · 📦 41K · 📋 4.8K - 5% open · ⏱️ 19.03.2023):
...
- [PyPi](https://pypi.org/project/pyinstaller) (📥 1.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 410K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 28 · 🔀 220 · 📦 770 · 📋 940 - 7% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 140K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 80 · 📥 400 · 📋 110 - 32% open · ⏱️ 04.11.2022):
...
- [PyPi](https://pypi.org/project/shiv) (📥 19K / month):
	...
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 1.2K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.8K · 📦 290K · 📋 6.4K - 17% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 43 · 🔀 160 · 📦 1.6K · 📋 310 - 5% open · ⏱️ 21.03.2023):
...
- [PyPi](https://pypi.org/project/pdoc) (📥 100K / month):
	...
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 11K · ⏱️ 22.03.2023):
	```
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 140 · 📦 290 · 📋 57 - 50% open · ⏱️ 20.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pycco) (📥 1.7K / month):
	```
	pip install pycco
	```
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.7M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 8.2K · ⏱️ 22.12.2018):
	```
	conda install -c conda-forge s3cmd
	```
</details>
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥉25 ·  ⭐ 6.2K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 54 · 🔀 1.4K · 📦 290 · 📋 800 - 0% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 54K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 200 · 📦 33 · 📋 140 - 61% open · ⏱️ 06.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 32K / month):
	```
	pip install s4cmd
	```
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 950 · 📦 210 · 📋 380 - 22% open · ⏱️ 28.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 6.7K / month):
	```
...
<details><summary><b><a href="https://github.com/stephenmcd/cartridge">Cartridge</a></b> (🥉19 ·  ⭐ 680) - A shopping cart app built using the Mezzanine. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 280 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 540 / month):
	```
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.8M · 📦 25K · 📋 17K - 6% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 63K / month):
	```
	pip install spyder
	```
- [Conda](https://anaconda.org/conda-forge/spyder) (📥 1.7M · ⏱️ 19.01.2023):
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 92 · 🔀 240 · 📦 210 · 📋 1.6K - 23% open · ⏱️ 22.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 840 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 180 · 🔀 2.7K · 📋 3.2K - 0% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 81 · 🔀 660 · 📥 33K · 📋 4.6K - 2% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 57 · 🔀 180 · 📦 470 · 📋 88 - 59% open · ⏱️ 03.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/flanker) (📥 30K / month):
	```
	pip install flanker
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 330 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 15.03.2023):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 2.9K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 180 · 📋 130 - 48% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 11K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 60 · 📥 83 · 📦 18 · 📋 90 - 18% open · ⏱️ 06.06.2022):

	```
	git clone https://github.com/moggers87/salmon
	```
- [PyPi](https://pypi.org/project/salmon) (📥 80 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 95 · 🔀 910 · 📦 240K · 📋 1.3K - 6% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/virtualenv) (📥 47M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 3.9M · ⏱️ 13.03.2023):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 410 · 🔀 2.7K · 📋 1.6K - 1% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 85K · 📋 610 - 26% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 58 · 🔀 250 · 📦 39K · 📋 190 - 16% open · ⏱️ 23.01.2023):
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 48 · 🔀 130 · 📋 130 - 1% open · ⏱️ 23.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/path.py) (📥 320K / month):
	```
	pip install path.py
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 39 · 📦 8.6K · 📋 17 - 35% open · ⏱️ 14.02.2015):
	...
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 68K / month):
	```
	pip install Unipath
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 690 · 📦 110K · 📋 670 - 8% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/django-crispy-forms/django-crispy-forms
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 820K / month):
	```
	pip install django-crispy-forms
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 68K · ⏱️ 14.02.2023):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 100K · 📋 160 - 13% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 770 · 📋 180 - 25% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 16K / month):
	```
	pip install deform
	```
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 86 · 📦 20 · 📋 16 - 75% open · ⏱️ 12.07.2017):
	...
	```
- [PyPi](https://pypi.org/project/django-remote-forms) (📥 170 / month):
	```
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 99 · 🔀 240 · 📥 2.6K · 📦 170K · 📋 250 - 9% open · ⏱️ 19.03.2023):
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 86K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 7.1K · 📋 74 - 5% open · ⏱️ 11.03.2023):

	```
	git clone https://github.com/Suor/funcy
	```
- [PyPi](https://pypi.org/project/funcy) (📥 2.1M / month):
	```
	pip install funcy
	```
- [Conda](https://anaconda.org/conda-forge/funcy) (📥 310K · ⏱️ 27.01.2023):
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 95 · 📦 330 · 📋 400 - 15% open · ⏱️ 13.01.2023):
...
- [PyPi](https://pypi.org/project/returns) (📥 58K / month):
	...
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 4.5K · ⏱️ 13.03.2022):
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 21K · 📋 440 - 13% open · ⏱️ 22.03.2023):
...
- [PyPi](https://pypi.org/project/pyglet) (📥 270K / month):
	...
	pip install pyglet
	```
- [Conda](https://anaconda.org/conda-forge/pyglet) (📥 490K · ⏱️ 27.01.2023):
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.7K · 📦 7.7K · 📋 3.2K - 21% open · ⏱️ 17.03.2023):
...
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 200K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 95K · ⏱️ 17.10.2022):
	```
...
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥈25 ·  ⭐ 9.9K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 510 · 📦 1.7K · 📋 1.1K - 15% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 410 · 📦 720 · 📋 570 - 21% open · ⏱️ 08.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 6.2K / month):
	```
	pip install Gooey
	```
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 440 · 📦 1K · 📋 740 - 3% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 450 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 610 / month):
	```
	pip install flexx
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 230 · 🔀 570 · 📥 1.2K · 📋 630 - 18% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/pybee/toga
	```
- [PyPi](https://pypi.org/project/toga) (📥 1.7K / month):
	```
	pip install toga
	```
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 280 · 📦 210 · 📋 220 - 16% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/nucleic/enaml
	```
- [PyPi](https://pypi.org/project/enaml) (📥 3.3K / month):
	```
	pip install enaml
	```
...
- [PyPi](https://pypi.org/project/geopy) (📥 4.1M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 990K · ⏱️ 13.11.2022):
	```
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 420 · 📦 1.1M · 📋 100 - 0% open · ⏱️ 01.03.2023):
...
- [PyPi](https://pypi.org/project/markupsafe) (📥 120M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/markupsafe) (📥 28M · ⏱️ 19.01.2023):
	```
...
- [PyPi](https://pypi.org/project/untangle) (📥 160K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 3.8K · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 730 · 🔀 8.6K · 📥 4.7K · 📦 2M · 📋 3.7K - 5% open · ⏱️ 03.03.2023):
...
- [PyPi](https://pypi.org/project/requests) (📥 300M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 30M · ⏱️ 16.01.2023):
	```
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 190 · 🔀 660 · 📦 78K · 📋 740 - 3% open · ⏱️ 20.03.2023):
...
- [PyPi](https://pypi.org/project/httpx) (📥 16M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 510K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 980 · 📥 6.3K · 📦 1.2M · 📋 1.1K - 9% open · ⏱️ 19.03.2023):
...
- [PyPi](https://pypi.org/project/urllib3) (📥 320M / month):
	...
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 31M · ⏱️ 12.03.2023):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 77 · 🔀 180 · 📦 140K · 📋 110 - 40% open · ⏱️ 21.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/httplib2) (📥 34M / month):
	```
	pip install httplib2
	```
- [Conda](https://anaconda.org/conda-forge/httplib2) (📥 2.2M · ⏱️ 22.03.2023):
	```
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 300 · 📦 3.6K · 📋 110 - 3% open · ⏱️ 26.01.2022):
...
- [PyPi](https://pypi.org/project/grequests) (📥 310K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 72K · ⏱️ 22.04.2020):
	```
	conda install -c conda-forge grequests
	```
</details>
<details><summary><b><a href="https://github.com/twisted/treq">treq</a></b> (🥉19 ·  ⭐ 550) - Python requests like API built on top of Twisted's HTTP client. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 50 · 🔀 130 · 📥 160 · 📦 1.4K · 📋 150 - 36% open · ⏱️ 10.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/treq) (📥 57K / month):
	```
	pip install treq
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 420 · 🔀 1.7K · 📦 10K · 📋 1.4K - 4% open · ⏱️ 21.03.2023):
...
- [PyPi](https://pypi.org/project/scapy) (📥 2.5M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 74K · ⏱️ 25.12.2022):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 390 · 📦 9.8K · 📋 530 - 64% open · ⏱️ 31.01.2023):
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 110 · 📦 980 · 📋 110 - 72% open · ⏱️ 23.08.2022):

	```
	git clone https://github.com/boppreh/mouse
	```
- [PyPi](https://pypi.org/project/mouse) (📥 31K / month):
	```
	pip install mouse
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 430 · 🔀 1.8K · 📦 1.1M · 📋 2.7K - 3% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 11K · 📦 15K · 📋 390 - 4% open · ⏱️ 05.03.2023):
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 340 · 📋 930 - 0% open · ⏱️ 27.01.2023):
...
- [PyPi](https://pypi.org/project/python-barcode) (📥 230K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 9.2K · ⏱️ 22.08.2020):
	```
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 270 · 📥 950 · 📦 220 · 📋 520 - 24% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 11 · 🔀 42 · 📦 64 · 📋 8 - 50% open · ⏱️ 30.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pagan) (📥 200 / month):
	```
	pip install pagan
	```
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 56 · 🔀 550 · 📋 200 - 21% open · ⏱️ 05.02.2023):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 91 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 22 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 720 / month):
	```
	pip install hmap
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 560 · 🔀 4.6K · 📥 58K · 📦 39 · 📋 4.7K - 26% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 52K · 📋 560 - 46% open · ⏱️ 17.03.2023):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 25K · 📋 63K - 10% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 290K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 69 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 810 / month):
	```
	pip install Pyjion
	```
- [Conda](https://anaconda.org/conda-forge/Pyjion) (📥 450 · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 54 · 🔀 260 · 📦 2.5K · 📋 360 - 57% open · ⏱️ 22.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 370K / month):
	```
	pip install ptpython
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 30K · ⏱️ 31.10.2022):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 220 · 📋 770 - 16% open · ⏱️ 20.03.2023):
...
- [PyPi](https://pypi.org/project/bpython) (📥 100K / month):
	...
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 60K · ⏱️ 15.03.2023):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 51 · 📦 3.4K · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 300K / month):
	```
	pip install pyicu
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 140 · 🔀 1.1K · 📦 2.4K · 📋 3.4K - 19% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 650K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 410K · ⏱️ 16.03.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 51 · 🔀 270 · 📦 59 · 📋 110 - 3% open · ⏱️ 21.03.2023):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 580 · 📦 48K · 📋 720 - 11% open · ⏱️ 03.03.2023):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 8.2M / month):
	```
	pip install loguru
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 340 · 📥 3.8K · 📦 41K · 📋 840 - 19% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 600 · 🔀 8K · 📥 6.2K · 📦 50K · 📋 4.8K - 6% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/xgboost) (📥 9.1M / month):
	...
	pip install xgboost
	```
- [Conda](https://anaconda.org/conda-forge/xgboost) (📥 3.7M · ⏱️ 17.03.2023):
	```
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.8K · 📦 39K · 📋 1.8K - 2% open · ⏱️ 30.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/gym) (📥 690K / month):
	```
	pip install gym
	```
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 400 · 🔀 1.7K · 📋 2.2K - 17% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 9.4K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 99 · 🔀 540 · 📥 1.3K · 📦 1.3K · 📋 1.3K - 7% open · ⏱️ 12.03.2023):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 65K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 86 · 🔀 720 · 📥 610K · 📦 110K · 📋 1.7K - 26% open · ⏱️ 10.03.2023):

	```
	git clone https://github.com/mhammond/pywin32
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 4.6M / month):
	```
	pip install pywin32
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 800K · ⏱️ 01.03.2023):
...
- [PyPi](https://pypi.org/project/itsdangerous) (📥 54M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 5M · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 83 · 🔀 330 · 📥 23 · 📦 4.1K · 📋 140 - 31% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/mahmoud/boltons
	```
- [PyPi](https://pypi.org/project/boltons) (📥 4.2M / month):
	```
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 770K · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 16 · 🔀 160 · 📦 140K · 📋 38 - 2% open · ⏱️ 24.01.2023):
...
- [PyPi](https://pypi.org/project/blinker) (📥 7.2M / month):
	...
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 8.1M · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1.7K · 📋 13 - 7% open · ⏱️ 16.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 540K / month):
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 41 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):
...
- [PyPi](https://pypi.org/project/stanza) (📥 180K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 8.5K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 250 · 📦 510 · 📋 69 - 28% open · ⏱️ 10.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 9.3K / month):
	```
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 310 · 📦 950 · 📋 220 - 68% open · ⏱️ 22.09.2020):

	```
	git clone https://github.com/aboSamoor/polyglot
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 69K / month):
	```
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.1K · 📋 100 - 38% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 8.9K / month):
	```
	pip install snownlp
	```
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉16 ·  ⭐ 48K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 11 · 🔀 12K · 📋 55 - 20% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/funNLP) (📥 22 / month):
	```
	pip install funNLP
	```
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 1.4K · 📋 590 - 21% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 500K · 📦 200 · 📋 690 - 36% open · ⏱️ 23.11.2022):
...
- [GitHub](https://github.com/tschellenbach/Stream-Framework) (👨‍💻 26 · 🔀 540 · 📋 180 - 35% open · ⏱️ 15.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/Stream-Framework) (📥 1.8K / month):
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 21K · ⏱️ 18.03.2023):
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 400 · 📦 1.4K · 📋 560 - 36% open · ⏱️ 28.02.2023):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 290K · ⏱️ 21.02.2023):
	```
...
- [PyPi](https://pypi.org/project/dataset) (📥 52K / month):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 4.8K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 32 · 🔀 160 · 📦 540 · 📋 320 - 41% open · ⏱️ 13.03.2022):
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 49 · 📦 3.3K · 📋 610 - 46% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 910 / month):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 440 · 🔀 1.9K · 📥 15M · 📋 4.8K - 12% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/poetry) (📥 12M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 800K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 500 · 📋 910 - 13% open · ⏱️ 15.03.2023):
...
- [PyPi](https://pypi.org/project/pip-tools) (📥 9.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 77K · ⏱️ 01.03.2023):
	```
	conda install -c conda-forge pip-tools
	```
</details>
<details><summary><b><a href="https://github.com/conda/conda">conda</a></b> (🥉15 ·  ⭐ 5.3K) - Cross-platform, Python-agnostic binary package manager. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/conda/conda) (🔀 1.3K · 📋 8.9K - 8% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 92 · 🔀 110 · 📦 210 · 📋 730 - 9% open · ⏱️ 25.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/devpi) (📥 3.9K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 340 · 🔀 790 · 📋 2.9K - 14% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 5 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 82 / month):
	```
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 21.03.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 5K · 📋 4.9K - 1% open · ⏱️ 20.03.2023):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 7.2K / month):
	```
	pip install sqlmap
	```
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉18 ·  ⭐ 8.7K · 💀) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 91 · 🔀 460 · 📦 12K · 📋 440 - 1% open · ⏱️ 20.03.2023):

	```
	git clone https://github.com/amoffat/sh
	```
- [PyPi](https://pypi.org/project/sh) (📥 4.5M / month):
	```
	pip install sh
	```
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 45 · 🔀 640 · 📦 1K · 📋 480 - 26% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 560 · 📥 330 · 📦 880 · 📋 450 - 16% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 29 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 1.9K / month):
	```
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 410 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 920 / month):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 78 · 🔀 140 · 📦 60K · 📋 290 - 23% open · ⏱️ 06.03.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 700K / month):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 420 · 🔀 4.5K · 📦 160K · 📋 3.3K - 0% open · ⏱️ 18.03.2023):
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 870 · 📥 4.3K · 📦 7.8K · 📋 980 - 15% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 730K / month):
	```
	pip install falcon
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 980 · 📦 89K · 📋 550 - 17% open · ⏱️ 04.03.2022):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.5K · 📦 13K · 📋 1.3K - 4% open · ⏱️ 21.03.2023):
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 2.2K · 📋 460 - 35% open · ⏱️ 10.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/hug) (📥 96K / month):
	```
	pip install hug
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.2K · 📋 310 - 3% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.8K · 📥 490K · 📦 55K · 📋 12K - 32% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 3.7M / month):
	```
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 3M · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 410 · 🔀 2.5K · 📥 27 · 📦 88K · 📋 5K - 47% open · ⏱️ 19.03.2023):
...
- [PyPi](https://pypi.org/project/statsmodels) (📥 9.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 9.1M · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4.1K · 📦 920 · 📋 980 - 32% open · ⏱️ 14.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/zipline) (📥 3.3K / month):
	```
	pip install zipline
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 440 · 🔀 1.7K · 📥 1.9K · 📦 1.3K · 📋 3K - 5% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 140 · 📋 100 - 2% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/obspy/obspy) (🔀 500 · 📥 6.8K · 📋 1.7K - 9% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/chapmanb/bcbb) (👨‍💻 33 · 🔀 220 · 📦 250 · 📋 74 - 20% open · ⏱️ 13.03.2023):
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 750 · 📥 160 · 📦 8.7K · 📋 1.3K - 9% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 72K · 📋 1.2K - 11% open · ⏱️ 14.03.2023):
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 22 · 🔀 43 · 📦 3.7K · 📋 100 - 11% open · ⏱️ 15.03.2023):
...
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 960K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 1.1M · ⏱️ 15.03.2023):
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 48 · 📦 940 · 📋 81 - 14% open · ⏱️ 12.09.2022):

	```
	git clone https://github.com/TkTech/pysimdjson
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 220K / month):
	```
	pip install pysimdjson
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 56K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 85 · 🔀 330 · 📋 330 - 5% open · ⏱️ 19.03.2023):
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 48 · 🔀 220 · 📦 180 · 📋 90 - 41% open · ⏱️ 03.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 4.9K / month):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 580 · 📥 8.3K · 📋 2.4K - 10% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 37 · 🔀 220 · 📦 210K · 📋 250 - 5% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 37K · 📋 240 - 11% open · ⏱️ 05.03.2023):
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 57K · 📋 860 - 1% open · ⏱️ 15.03.2023):
...
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/XlsxWriter) (📥 2.5M · ⏱️ 13.03.2023):
	```
...
- [PyPi](https://pypi.org/project/csvkit) (📥 160K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 83K · ⏱️ 22.02.2023):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 59 · 🔀 450 · 📥 24K · 📦 27K · 📋 1.7K - 15% open · ⏱️ 21.03.2023):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 94K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 570K · ⏱️ 17.03.2023):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 780 · 📦 260K · 📋 810 - 4% open · ⏱️ 23.03.2023):
...
<details><summary><b><a href="https://github.com/py-pdf/pypdf">PyPDF2</a></b> (🥉23 ·  ⭐ 5.4K · 📉) - A library capable of splitting, merging and transforming PDF.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 170 · 🔀 1K · 📋 710 - 6% open · ⏱️ 23.03.2023):
...
- [PyPi](https://pypi.org/project/PyPDF2) (📥 4.7M / month):
	...
	pip install PyPDF2
	```
- [Conda](https://anaconda.org/conda-forge/PyPDF2) (📥 370K · ⏱️ 29.10.2022):
	```
...
- [PyPi](https://pypi.org/project/nikola) (📥 1.2K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 7.5K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 300 · 📥 7K · 📦 410 · 📋 630 - 35% open · ⏱️ 10.03.2023):

	```
	git clone https://github.com/lektor/lektor
	```
- [PyPi](https://pypi.org/project/lektor) (📥 3.8K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 13K · 📋 1K - 13% open · ⏱️ 20.03.2023):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 770K / month):
	```
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 88K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 360 · 📦 1.2K · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 40 · 🔀 110 · 📦 29 · 📋 170 - 30% open · ⏱️ 13.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrq) (📥 250 / month):
	```
	pip install mrq
	```
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 950 - 5% open · ⏱️ 01.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/jinja) (📥 7.1K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 510 · 🔀 1.7K · 📦 120K · 📋 620 - 2% open · ⏱️ 21.03.2023):
...
- [PyPi](https://pypi.org/project/faker) (📥 7.7M / month):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 730K · ⏱️ 22.03.2023):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 180 · 🔀 2.1K · 📥 540 · 📦 7.3K · 📋 4.1K - 6% open · ⏱️ 22.03.2023):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 520 · 📦 20K · 📋 1.4K - 3% open · ⏱️ 16.03.2023):
...
- [PyPi](https://pypi.org/project/hypothesis) (📥 4.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7.3M · ⏱️ 16.03.2023):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 310 · 📥 91 · 📦 23K · ⏱️ 10.03.2023):
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.3K · 📋 510 - 8% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/cobrateam/splinter
	```
- [PyPi](https://pypi.org/project/splinter) (📥 93K / month):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 390 · 📦 1.3K · 📋 310 - 0% open · ⏱️ 22.03.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 130K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 89K · ⏱️ 18.12.2022):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.6K · 📋 1.4K - 1% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 54 · 🔀 120 · 📦 210 · 📋 710 - 16% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 69K / month):
	```
	pip install schemathesis
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 3.7K · ⏱️ 18.02.2023):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 250 · 📦 14K · 📋 240 - 40% open · ⏱️ 16.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/HTTPretty) (📥 500K / month):
	```
...
- [PyPi](https://pypi.org/project/freezegun) (📥 6.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 810K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 23K · 📋 260 - 20% open · ⏱️ 16.03.2023):

	```
	git clone https://github.com/nose-devs/nose2
	```
- [PyPi](https://pypi.org/project/nose2) (📥 630K / month):
	```
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 87K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 130 · 🔀 360 · 📋 540 - 29% open · ⏱️ 21.03.2023):
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 210 / month):
	```
	pip install sixpack
	```
...
- [PyPi](https://pypi.org/project/httmock) (📥 360K / month):
	...
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 7.5K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 110 · 📦 22 · 📋 22 - 31% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/fake2db) (📥 250 / month):
	```
	pip install fake2db
	```
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 600 · 📦 700K · 📋 500 - 42% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 54 · 🔀 240 · 📥 7.7K · 📦 740K · 📋 290 - 12% open · ⏱️ 13.03.2023):
...
- [PyPi](https://pypi.org/project/pyparsing) (📥 78M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 33M · ⏱️ 14.07.2022):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 33 · 🔀 110 · 📦 16K · ⏱️ 25.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/shortuuid) (📥 4.1M / month):
	```
	pip install shortuuid
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 330K · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 98 · 📦 28K · 📋 49 - 28% open · ⏱️ 16.09.2022):
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 33 · 🔀 94 · 📋 65 - 1% open · ⏱️ 24.02.2023):
...
- [PyPi](https://pypi.org/project/ply) (📥 25M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 4.5M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 32 · 🔀 190 · 📦 5.8K · 📋 73 - 56% open · ⏱️ 16.02.2023):
...
<details><summary><b><a href="https://github.com/mozillazg/python-pinyin">pypinyin</a></b> (🥉20 ·  ⭐ 4.3K) - Convert Chinese hanzi () to pinyin (). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 240 - 10% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 21 / month):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 9.7K · 📋 130 - 9% open · ⏱️ 25.10.2022):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.7K · 📦 280K · 📋 2.9K - 4% open · ⏱️ 23.03.2023):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 500M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 15M · ⏱️ 23.03.2023):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 140K · 📋 970 - 8% open · ⏱️ 21.03.2023):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 45M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 2M · ⏱️ 21.03.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 870 · 📥 460 · 📦 21K · 📋 780 - 7% open · ⏱️ 23.03.2023):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.9K · 📋 280 - 2% open · ⏱️ 14.03.2023):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 880K / month):
	```
	pip install webargs
	```
...
<details><summary><b><a href="https://github.com/ellisonleao/pyshorteners">pyshorteners</a></b> (🥈23 ·  ⭐ 360 · 💤) - A pure Python URL shortening lib. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 62 · 📦 8K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 60K / month):
	```
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 35 · 📦 3.8K · 📋 20 - 25% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/purl) (📥 55K / month):
	```
	pip install purl
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 220 · 📥 760 · 📦 360 · 📋 250 - 1% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 73K / month):
	```
...
<details><summary><b><a href="https://github.com/jazzband/django-pipeline">django-pipeline</a></b> (🥈26 ·  ⭐ 1.5K) - An asset packaging library for Django. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📋 440 - 27% open · ⏱️ 10.03.2023):

	```
	git clone https://github.com/jazzband/django-pipeline
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 80K / month):
	```
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 210 · 🔀 540 · 📋 640 - 16% open · ⏱️ 22.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-compressor) (📥 380K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 64 · 🔀 870 · 📦 11K · 📋 370 - 43% open · ⏱️ 26.02.2023):
...
- [PyPi](https://pypi.org/project/requests-html) (📥 840K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 5.6K · ⏱️ 26.06.2021):
	```
...
- [PyPi](https://pypi.org/project/sumy) (📥 25K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 4.2K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/codelucas/newspaper) (👨‍💻 100 · 🔀 1.9K · 📋 660 - 60% open · ⏱️ 02.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/newspaper) (📥 15K / month):
	```
...
- [PyPi](https://pypi.org/project/html2text) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 29K · ⏱️ 09.02.2020):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 2.7K · ⏱️ 14.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/micawber) (📥 52K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 8.6K · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 110 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 900 · 📋 74 - 59% open · ⏱️ 07.06.2015):
	...
	```
- [PyPi](https://pypi.org/project/robobrowser) (📥 18K / month):
	```
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 66 · 🔀 260 · ⏱️ 28.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 2.8K / month):
	```
	pip install grab
	```
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 3 · 🔀 530 · 📦 18 · 📋 65 - 20% open · ⏱️ 01.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/cola) (📥 130 / month):
	```
	pip install cola
	```
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 83 · 🔀 120 · 📦 460 · 📋 380 - 6% open · ⏱️ 05.11.2022):

	```
	git clone https://github.com/MasoniteFramework/masonite
	```
- [PyPi](https://pypi.org/project/masonite) (📥 3K / month):
	```
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 64 · 🔀 460 · 📦 94K · 📋 970 - 2% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 740 · 📋 1.2K - 6% open · ⏱️ 09.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/channels) (📥 640K / month):
	```
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 890K · 📋 1.9K - 18% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 300 · 📦 960K · 📋 1K - 0% open · ⏱️ 18.03.2023):
...
- [PyPi](https://pypi.org/project/werkzeug) (📥 81M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 7.2M · ⏱️ 14.02.2023):
	```
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 50 · 🔀 150 · 📦 110K · 📋 220 - 7% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/Pylons/waitress
	```
- [PyPi](https://pypi.org/project/waitress) (📥 4.3M / month):
	```
...
- [PyPi](https://pypi.org/project/bjoern) (📥 26K / month):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 99K · ⏱️ 02.11.2022):
	```
