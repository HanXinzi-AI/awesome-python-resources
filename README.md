...
- [GitHub](https://github.com/mher/flower) (👨‍💻 200 · 🔀 950 · 📦 12K · 📋 860 - 12% open · ⏱️ 14.11.2022):
...
- [PyPi](https://pypi.org/project/flower) (📥 1.6M / month):
	...
	pip install flower
	```
- [Conda](https://anaconda.org/conda-forge/flower) (📥 150K · ⏱️ 30.10.2022):
	```
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 24 · 🔀 790 · 📦 25 · 📋 1.1K - 0% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 540 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 790 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 310 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 42 · 📋 210 - 24% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 340 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 03.03.2023):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 560 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 980 · 🔀 38K · 📦 2 · 📋 1.2K - 1% open · ⏱️ 07.03.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 84M · ⏱️ 02.02.2023):
	```
...
- [PyPi](https://pypi.org/project/transitions) (📥 430K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 350K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 200 · 🔀 4.1K · 📦 79 · 📋 160 - 35% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/keon/algorithms
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 17K / month):
	```
...
- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 23 · 🔀 180 · 📦 100K · 📋 170 - 8% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 36 · ⏱️ 09.02.2020):

	```
	git clone https://github.com/tylerlaberge/PyPattyrn
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 2.6K / month):
	```
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 110 · 🔀 510 · 📋 88 - 22% open · ⏱️ 04.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-ds) (📥 16 / month):
	```
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 150 · 🔀 540 · 📦 160K · 📋 630 - 3% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 63 · 🔀 220 · 📋 300 - 10% open · ⏱️ 07.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/daphne) (📥 640K / month):
	```
	pip install daphne
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 56 · 🔀 460 · 📥 360 · 📦 70K · 📋 300 - 18% open · ⏱️ 15.01.2023):
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 26K · 📋 700 - 37% open · ⏱️ 09.03.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 7.7M / month):
	```
	pip install trio
	```
...
<details><summary><b><a href="https://github.com/jiaaro/pydub">pydub</a></b> (🥇32 ·  ⭐ 6.9K) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 890 · 📦 19K · 📋 520 - 49% open · ⏱️ 08.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pydub) (📥 4.6M / month):
	```
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 41K · ⏱️ 13.03.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 8K · 📦 310 · 📋 2.6K - 18% open · ⏱️ 09.03.2023):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 2.7K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 160 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 40 · 🔀 130 · 📥 58K · 📦 11K · 📋 490 - 18% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 1.4M / month):
	```
	pip install mutagen
	```
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 25 · 🔀 55 · 📥 2.5K · 📦 2.2K · 📋 190 - 24% open · ⏱️ 08.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 29K / month):
	```
	pip install eyeD3
	```
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 58 · 📦 16 · 📋 210 - 18% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 140 / month):
	```
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 110 · 📦 13 · 📋 40 - 32% open · ⏱️ 06.03.2023):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 480 / month):
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 190 · 🔀 440 · 📦 340K · 📋 360 - 19% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/idan/oauthlib
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 86M / month):
	```
	pip install oauthlib
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 7.9M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 600 · 📦 340K · 📋 390 - 4% open · ⏱️ 07.03.2023):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 110M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 9.8M · ⏱️ 20.10.2022):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 620 · 🔀 2.6K · 📦 140K · 📋 1.9K - 14% open · ⏱️ 08.03.2023):
...
- [PyPi](https://pypi.org/project/django-allauth) (📥 730K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 87K · ⏱️ 07.06.2022):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 92 · 🔀 340 · 📦 26K · 📋 360 - 12% open · ⏱️ 27.02.2023):
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 690 · 📋 750 - 20% open · ⏱️ 07.03.2023):
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 22K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 36K · ⏱️ 22.02.2023):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 690 · 📋 3.9K - 4% open · ⏱️ 08.03.2023):
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 52 · 📦 12K · 📋 54 - 5% open · ⏱️ 05.03.2023):
...
- [PyPi](https://pypi.org/project/bidict) (📥 1.4M / month):
	...
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 210K · ⏱️ 01.01.2023):
	```
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 18 · 📥 68 · 📦 72 · 📋 9 - 77% open · ⏱️ 30.10.2015):

	```
	git clone https://github.com/carlosescri/DottedDict
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 30 / month):
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 91 · 📥 31 · 📋 150 - 9% open · ⏱️ 22.02.2023):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 350 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.5K · 📋 1K - 3% open · ⏱️ 02.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 4.7K / month):
	```
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 710 / month):
	```
	pip install Kotti
	```
...
<details><summary><b><a href="https://github.com/feincms/feincms">feincms</a></b> (🥉16 ·  ⭐ 850) - One of the most advanced Content Management Systems built on Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 76 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 66 · 🔀 200 · 📦 1.1K · 📋 310 - 5% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 87 · 📦 4.4K · 📋 190 - 10% open · ⏱️ 26.08.2022):
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 260 · 📋 72 - 22% open · ⏱️ 20.02.2023):
...
<details><summary><b><a href="https://github.com/psf/black">black</a></b> (🥇36 ·  ⭐ 32K) - The uncompromising Python code formatter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/psf/black) (👨‍💻 360 · 🔀 1.9K · 📥 27K · 📦 350K · 📋 2.2K - 16% open · ⏱️ 07.03.2023):
...
- [PyPi](https://pypi.org/project/black) (📥 20M / month):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 6.5M · ⏱️ 01.02.2023):
	```
	conda install -c conda-forge black
	```
</details>
<details><summary><b><a href="https://github.com/PyCQA/isort">isort</a></b> (🥇35 ·  ⭐ 5.7K) - A Python utility / library to sort imports. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 370K · 📋 1.2K - 10% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 360 · 📦 14K · 📋 1K - 9% open · ⏱️ 04.03.2023):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 250K / month):
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 87 · 🔀 160 · 📦 4.1K · 📋 350 - 14% open · ⏱️ 07.03.2023):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 650K / month):
	```
...
<details><summary><b><a href="https://github.com/google/yapf">yapf</a></b> (🥈30 ·  ⭐ 13K) - Yet another Python code formatter from Google. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 850 · 📦 71K · 📋 770 - 47% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 3.3M / month):
	```
	pip install yapf
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 93 · 📦 5.7K · 📋 140 - 32% open · ⏱️ 08.08.2022):
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 35 · 🔀 110 · 📦 3.6K · 📋 180 - 7% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 420K / month):
	```
	pip install vulture
	```
...
<details><summary><b><a href="https://github.com/facebook/pyre-check">pyre-check</a></b> (🥉22 ·  ⭐ 6.3K) - Performant type checking. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 240 · 🔀 390 · 📋 340 - 31% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 60K / month):
	```
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 280 · 📦 400 · 📋 160 - 30% open · ⏱️ 28.02.2018):

	```
	git clone https://github.com/gak/pycallgraph
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 23K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 15 · 📋 50 - 14% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/scottrogowski/code2flow
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 3.3K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 90 · 🔀 250 · 📋 590 - 18% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 260K / month):
	```
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 150K · ⏱️ 03.03.2023):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 110 · 📋 59 - 44% open · ⏱️ 12.10.2021):

	```
	git clone https://github.com/dropbox/pyannotate
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 5.5K / month):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 20% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 50K / month):
	```
...
<details><summary><b><a href="https://github.com/python/typeshed">typeshed</a></b> (🥉15 ·  ⭐ 3.5K) - Collection of library stubs for Python, with static types. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.3K · 🔀 1.4K · 📋 2K - 7% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 220 · 🔀 1.5K · 📦 71K · 📋 1K - 7% open · ⏱️ 04.03.2023):
...
- [PyPi](https://pypi.org/project/rich) (📥 23M / month):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 3.1M · ⏱️ 04.03.2023):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 420K · 📋 890 - 36% open · ⏱️ 03.03.2023):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 54M / month):
	```
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 18M · ⏱️ 04.03.2023):
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 59 · 🔀 1.3K · 📦 19K · 📋 280 - 38% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-fire) (📥 140 / month):
	```
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 820 · 📋 290 - 8% open · ⏱️ 17.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 74K / month):
	```
...
- [PyPi](https://pypi.org/project/alive-progress) (📥 260K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 27K · ⏱️ 02.01.2023):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 650 · 📋 1K - 46% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 7K / month):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 2.8K · 📦 13K · 📋 810 - 16% open · ⏱️ 15.01.2023):
...
- [PyPi](https://pypi.org/project/httpie) (📥 190K / month):
	...
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 95K · ⏱️ 01.11.2022):
	```
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 610K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 72 · 🔀 220 · 📦 230 · 📋 340 - 23% open · ⏱️ 05.03.2023):
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 490 · 📦 850 · 📋 660 - 22% open · ⏱️ 27.02.2023):
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 280 · 📋 620 - 29% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mycli) (📥 59K / month):
	```
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 52K · ⏱️ 02.09.2022):
	```
	conda install -c conda-forge mycli
	```
</details>
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈25 ·  ⭐ 910) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 54 · 🔀 110 · 📦 370 · 📋 320 - 14% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 29K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 1.9K · ⏱️ 07.01.2023):
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 90 · 📥 11K · 📦 14 · 📋 200 - 24% open · ⏱️ 29.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/iredis) (📥 1.8K / month):
	```
	pip install iredis
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 63 · 📦 210 · 📋 88 - 32% open · ⏱️ 11.07.2022):

	```
	git clone https://github.com/dbcli/litecli
	```
- [PyPi](https://pypi.org/project/litecli) (📥 8.1K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 660 · 📦 14 · 📋 70 - 82% open · ⏱️ 19.09.2018):
	...
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 600 / month):
	```
...
- [GitHub](https://github.com/mooz/percol) (👨‍💻 36 · 🔀 140 · 📦 33 · 📋 65 - 55% open · ⏱️ 23.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/percol) (📥 1K / month):
	```
	pip install percol
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.4K · 📥 3.9M · 📦 2.3K · 📋 730 - 23% open · ⏱️ 06.01.2023):
...
<details><summary><b><a href="https://github.com/ageitgey/face_recognition">Face Recognition</a></b> (🥈25 ·  ⭐ 48K · 💤) - Simple facial recognition library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 12K · 📥 940 · 📋 1.3K - 54% open · ⏱️ 10.06.2022):
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 27 · 🔀 240 · 📦 810 · 📋 250 - 30% open · ⏱️ 26.08.2022):
...
- [GitHub](https://github.com/kornia/kornia) (🔀 780 · 📥 560 · 📦 3.3K · 📋 720 - 28% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 41 · 🔀 630 · 📋 330 - 7% open · ⏱️ 07.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 760K / month):
	```
...
- [GitHub](https://github.com/sightmachine/SimpleCV) (👨‍💻 100 · 🔀 760 · 📦 390 · 📋 330 - 22% open · ⏱️ 07.04.2015):
	...
	```
- [PyPi](https://pypi.org/project/SimpleCV) (📥 2.3K / month):
	```
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 86 · 📦 300 · 📋 73 - 43% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/scoop) (📥 1.7K / month):
	```
	pip install scoop
	```
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 35 · 🔀 170 · 📥 11 · 📦 92K · 📋 85 - 5% open · ⏱️ 01.03.2023):
...
- [PyPi](https://pypi.org/project/python-decouple) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 57K · ⏱️ 02.03.2023):
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉23 ·  ⭐ 6.9K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 520 · 📦 14 · 📋 1.2K - 14% open · ⏱️ 25.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/hydra) (📥 15K / month):
	```
	pip install hydra
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 73K · 📋 1.5K - 51% open · ⏱️ 03.03.2023):
...
<details><summary><b><a href="https://github.com/pyca/pynacl">pynacl</a></b> (🥉22 ·  ⭐ 950) - Python binding to the Networking and Cryptography (NaCl) library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 560 · 📥 180K · 📦 900 · 📋 880 - 4% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 18 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 21 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 530 · 📦 340K · 📋 710 - 3% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 66M / month):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 6K · 📋 150 - 52% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/schema) (📥 4.7M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 84K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 9 · 🔀 24 · 📦 65 · 📋 15 - 26% open · ⏱️ 05.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/valideer) (📥 14K / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 190 · 🔀 1.6K · 📥 240 · 📦 230K · 📋 2.3K - 4% open · ⏱️ 26.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 9.4M / month):
	```
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 6.1M · ⏱️ 31.12.2022):
	```
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📥 18 · 📦 48K · 📋 1.7K - 11% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 910 · 📋 420 - 57% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 99K / month):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 640 · 🔀 4K · 📦 200 · 📋 7.2K - 9% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 3.1K · 📋 1.1K - 26% open · ⏱️ 28.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 58K / month):
	```
	pip install cartopy
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 590 · 📦 1.1K · 📋 1.4K - 21% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 47K / month):
	```
	pip install vispy
	```
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 99 · 🔀 190 · 📋 540 - 14% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 80 · 🔀 480 · 📦 10K · 📋 290 - 3% open · ⏱️ 18.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/tinydb) (📥 470K / month):
	```
	pip install tinydb
	```
- [Conda](https://anaconda.org/conda-forge/tinydb) (📥 260K · ⏱️ 14.01.2023):
	```
...
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉20 ·  ⭐ 770 · 💀) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/dpkp/kafka-python">kafka-python</a></b> (🥇34 ·  ⭐ 5.1K) - The Python client for Apache Kafka. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 17K · 📋 1.4K - 16% open · ⏱️ 02.03.2023):
...
- [PyPi](https://pypi.org/project/motor) (📥 1.4M / month):
	...
	pip install motor
	```
- [Conda](https://anaconda.org/conda-forge/motor) (📥 54K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 160K · 📋 630 - 4% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/PyMySQL/PyMySQL
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 46M / month):
	```
	pip install PyMySQL
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 380 · 🔀 2.2K · 📋 1.4K - 9% open · ⏱️ 19.02.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 910K · ⏱️ 09.02.2023):
	```
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.7K · ⏱️ 08.03.2023):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 980 · ⏱️ 07.03.2023):
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 260 / month):
	```
...
- [GitHub](https://github.com/PyMySQL/mysqlclient) (👨‍💻 73 · 🔀 360 · 📥 5.2K · 📋 300 - 5% open · ⏱️ 17.01.2023):
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 88 · 🔀 310 · 📥 76 · 📦 18K · 📋 460 - 43% open · ⏱️ 25.02.2023):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 780 · 📋 40 - 7% open · ⏱️ 27.11.2020):

	```
	git clone https://github.com/zachwill/moment
	```
- [PyPi](https://pypi.org/project/moment) (📥 75K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 24 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 310 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 20 · 📦 32 · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 1.2K / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 880 · 📥 180 · 📦 68K · 📋 830 - 7% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 320 · 📥 12K · 📦 2.4K · 📋 280 - 34% open · ⏱️ 09.12.2022):
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 210 · 📦 4.5K · 📋 310 - 45% open · ⏱️ 06.03.2023):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 240K / month):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 160 · 📦 110 · 📋 83 - 31% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 4K / month):
	```
	pip install vprof
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 110 · 📦 190 · 📋 110 - 27% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 10K / month):
	```
	pip install wdb
	```
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 360 · 📋 67 - 58% open · ⏱️ 05.03.2016):
	...
	```
- [PyPi](https://pypi.org/project/django-devserver) (📥 4.3K / month):
	```
...
- [PyPi](https://pypi.org/project/line_profiler) (📥 320K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 330K · ⏱️ 09.12.2022):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 500 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 710K / month):
	```
	pip install memory_profiler
	```
- [Conda](https://anaconda.org/conda-forge/memory_profiler) (📥 290K · ⏱️ 16.11.2022):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 60 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 37 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 290 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 260K · 📋 37K - 5% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 6.1K · 📋 9.5K - 18% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 510K / month):
	```
	pip install mxnet
	```
...
<details><summary><b><a href="https://github.com/keras-team/keras">keras</a></b> (🥈32 ·  ⭐ 58K) - A high-level neural networks library and capable of running on top of.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 09.03.2023):
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥉30 ·  ⭐ 64K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.9K · 🔀 17K · 📥 12K · 📋 32K - 32% open · ⏱️ 09.03.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 82K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 1.4M · ⏱️ 07.02.2023):
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 740 · 📥 260 · ⏱️ 22.05.2020):
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 280K · 📋 1.6K - 14% open · ⏱️ 07.03.2023):
...
<details><summary><b><a href="https://github.com/ansible/ansible">ansible</a></b> (🥈33 ·  ⭐ 57K) - A radically simple IT automation platform. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 27K · 📋 31K - 2% open · ⏱️ 08.03.2023):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.4M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 830K · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 15K · 📋 25K - 9% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.8K · 📋 1.1K - 10% open · ⏱️ 09.03.2023):
...
- [PyPi](https://pypi.org/project/supervisor) (📥 1.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/supervisor) (📥 240K · ⏱️ 29.12.2022):
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 88 · 🔀 300 · 📦 74 · 📋 650 - 18% open · ⏱️ 07.03.2023):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 16K / month):
	```
	pip install pyinfra
	```
...
- [GitHub](https://github.com/sebastien/cuisine) (👨‍💻 57 · 🔀 160 · 📦 170 · 📋 110 - 24% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 47K · 📋 4.7K - 16% open · ⏱️ 08.03.2023):
...
- [PyPi](https://pypi.org/project/dask) (📥 7.2M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 8.1M · ⏱️ 02.03.2023):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.2K · 📥 23 · 📦 8.5K · 📋 13K - 20% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 740K · 📦 40K · 📋 4.8K - 5% open · ⏱️ 08.03.2023):
...
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈26 ·  ⭐ 2.1K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 27 · 🔀 210 · 📦 760 · 📋 910 - 6% open · ⏱️ 06.03.2023):
...
<details><summary><b><a href="https://github.com/sphinx-doc/sphinx">sphinx</a></b> (🥇27 ·  ⭐ 5.3K) - Python Documentation generator. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.8K · 📦 290K · 📋 6.4K - 17% open · ⏱️ 07.03.2023):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 42 · 🔀 160 · 📦 1.6K · 📋 310 - 5% open · ⏱️ 01.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 92K / month):
	```
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 11K · ⏱️ 20.02.2023):
	```
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 140 · 📦 290 · 📋 57 - 50% open · ⏱️ 20.12.2019):
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 51 · 🔀 1.3K · 📦 280 · 📋 780 - 0% open · ⏱️ 08.03.2023):
...
- [GitHub](https://github.com/s3tools/s3cmd) (👨‍💻 210 · 🔀 820 · 📥 3.1M · 📋 850 - 27% open · ⏱️ 19.11.2022):
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 26 · 🔀 170 · 📦 1.9K · 📋 73 - 24% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/MicroPyramid/forex-python
	```
- [PyPi](https://pypi.org/project/forex-python) (📥 160K / month):
	```
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 28 · 📦 280 · 📋 23 - 30% open · ⏱️ 04.09.2016):

	```
	git clone https://github.com/carlospalol/money
	```
- [PyPi](https://pypi.org/project/money) (📥 53K / month):
	```
	pip install money
	```
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 280 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 410 / month):
	```
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 91 · 📦 110 · 📋 15 - 20% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 370 / month):
	```
	pip install alipay
	```
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.8M · 📦 25K · 📋 17K - 6% open · ⏱️ 07.03.2023):
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 180 · 🔀 2.7K · 📋 3.2K - 0% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 81 · 🔀 660 · 📥 33K · 📋 4.6K - 1% open · ⏱️ 08.03.2023):
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 57 · 🔀 180 · 📦 470 · 📋 88 - 59% open · ⏱️ 03.03.2023):
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 320 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 09.03.2023):
...
- [PyPi](https://pypi.org/project/mailer) (📥 59K / month):
	...
	pip install mailer
	```
- [Conda](https://anaconda.org/conda-forge/mailer) (📥 56K · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 60 · 📥 82 · 📦 18 · 📋 90 - 18% open · ⏱️ 06.06.2022):

	```
	git clone https://github.com/moggers87/salmon
	```
- [PyPi](https://pypi.org/project/salmon) (📥 86 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 89 · 🔀 910 · 📦 240K · 📋 1.3K - 6% open · ⏱️ 28.02.2023):
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 410 · 🔀 2.7K · 📋 1.6K - 1% open · ⏱️ 08.03.2023):
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 84K · 📋 600 - 26% open · ⏱️ 28.02.2023):
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 39 · 📦 8.6K · 📋 17 - 35% open · ⏱️ 14.02.2015):
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 140 · 🔀 370 · 📦 160K · 📋 420 - 13% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/wtforms/wtforms
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 3.8M / month):
	```
	pip install wtforms
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 690 · 📦 110K · 📋 660 - 8% open · ⏱️ 24.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 830K / month):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 99K · 📋 160 - 13% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 97 · 🔀 230 · 📥 2.6K · 📦 170K · 📋 240 - 9% open · ⏱️ 08.03.2023):
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 85K · 📋 220 - 34% open · ⏱️ 03.11.2022):
...
- [PyPi](https://pypi.org/project/toolz) (📥 18M / month):
	...
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 14M · ⏱️ 10.07.2022):
	```
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 7K · 📋 74 - 6% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 94 · 📦 320 · 📋 400 - 14% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 64K / month):
	```
	pip install returns
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 31 · 🔀 100 · 📋 620 - 10% open · ⏱️ 30.12.2022):

	```
	git clone https://github.com/evhub/coconut
	```
- [PyPi](https://pypi.org/project/coconut) (📥 870 / month):
	```
	pip install coconut
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 21K · 📋 440 - 16% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.7K · 📦 7.5K · 📋 3.2K - 21% open · ⏱️ 09.03.2023):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 190K / month):
	```
	pip install PySimpleGUI
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 94K · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 46 · 🔀 540 · 📦 4.9K · 📋 490 - 32% open · ⏱️ 04.03.2023):

	```
	git clone https://github.com/ChrisKnott/Eel
	```
- [PyPi](https://pypi.org/project/Eel) (📥 78K / month):
	```
	pip install Eel
	```
...
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥈25 ·  ⭐ 9.8K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 400 · 📦 720 · 📋 570 - 21% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 5.5K / month):
	```
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 62K · ⏱️ 29.12.2021):
	```
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 440 · 📦 980 · 📋 730 - 3% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 450 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 550 / month):
	```
	pip install flexx
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 230 · 🔀 570 · 📥 1.1K · 📋 620 - 17% open · ⏱️ 05.03.2023):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 250 · 📦 210 · 📋 220 - 16% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/nucleic/enaml
	```
- [PyPi](https://pypi.org/project/enaml) (📥 3.1K / month):
	```
	pip install enaml
	```
...
- [GitHub](https://github.com/graphql-python/graphene) (🔀 780 · 📦 17K · 📋 970 - 10% open · ⏱️ 09.03.2023):
...
- [PyPi](https://pypi.org/project/geopy) (📥 3.9M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 970K · ⏱️ 13.11.2022):
	```
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 53 · 🔀 250 · 📋 270 - 5% open · ⏱️ 31.01.2023):
...
<details><summary><b><a href="https://github.com/martinblech/xmltodict">xmltodict</a></b> (🥈31 ·  ⭐ 5.1K · 💤) - Working with XML feel like you are working with JSON. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 52 · 🔀 170 · 📦 18K · 📋 180 - 27% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 1.7M / month):
	```
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 37K · ⏱️ 28.12.2022):
	```
...
- [PyPi](https://pypi.org/project/untangle) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 3.7K · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/html5lib/html5lib-python) (👨‍💻 65 · 🔀 260 · 📋 250 - 29% open · ⏱️ 03.03.2023):
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 730 · 🔀 8.6K · 📥 4.6K · 📦 2M · 📋 3.7K - 5% open · ⏱️ 03.03.2023):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 190 · 🔀 650 · 📦 76K · 📋 740 - 3% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 970 · 📥 5.9K · 📦 1.2M · 📋 1.1K - 9% open · ⏱️ 08.03.2023):
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 420 · 🔀 1.7K · 📦 10K · 📋 1.4K - 4% open · ⏱️ 09.03.2023):
...
- [PyPi](https://pypi.org/project/scapy) (📥 2.7M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 72K · ⏱️ 25.12.2022):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 390 · 📦 9.6K · 📋 530 - 64% open · ⏱️ 31.01.2023):
...
- [PyPi](https://pypi.org/project/keyboard) (📥 390K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 15K · ⏱️ 01.11.2022):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 110 · 📦 970 · 📋 110 - 72% open · ⏱️ 23.08.2022):
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 500 · 📋 100 - 70% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 430 · 🔀 1.8K · 📦 1.1M · 📋 2.7K - 3% open · ⏱️ 06.03.2023):
...
- [PyPi](https://pypi.org/project/Pillow) (📥 53M / month):
	...
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 24M · ⏱️ 08.03.2023):
	```
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 780 · 📦 330 · 📋 930 - 0% open · ⏱️ 27.01.2023):

	```
	git clone https://github.com/thumbor/thumbor
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 5.2K / month):
	```
	pip install thumbor
	```
...
<details><summary><b><a href="https://github.com/WhyNotHugo/python-barcode">python-barcode</a></b> (🥈25 ·  ⭐ 440) - Create barcodes in Python with no extra dependencies. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 44 · 🔀 110 · 📥 260 · 📦 16K · 📋 100 - 39% open · ⏱️ 03.03.2023):
...
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥉22 ·  ⭐ 490) - A fast image processing library with low memory needs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 46 · 📦 480 · 📋 340 - 38% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/libvips/pyvips
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 32K / month):
	```
	pip install pyvips
	```
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 11 · 🔀 42 · 📦 64 · 📋 8 - 50% open · ⏱️ 30.11.2022):
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 22 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 760 / month):
	```
	pip install hmap
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 560 · 🔀 4.6K · 📥 58K · 📦 37 · 📋 4.6K - 26% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 50K · 📋 560 - 46% open · ⏱️ 26.02.2023):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 25K · 📋 63K - 10% open · ⏱️ 09.03.2023):
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉11 ·  ⭐ 910 · 💀) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 60 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 36 / month):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 220 · 📋 770 - 16% open · ⏱️ 02.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/bpython) (📥 100K / month):
	```
	pip install bpython
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 51 · 📦 3.3K · ⏱️ 08.04.2021):

	```
	git clone https://github.com/ovalhub/pyicu
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 230K / month):
	```
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 140K · ⏱️ 26.04.2022):
	```
...
- [PyPi](https://pypi.org/project/schedule) (📥 2.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 30K · ⏱️ 10.04.2021):
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 130 · 🔀 1.1K · 📦 2.3K · 📋 3.4K - 20% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 730K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 400K · ⏱️ 03.03.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 51 · 🔀 270 · 📦 59 · 📋 110 - 5% open · ⏱️ 01.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 5.4K / month):
	```
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 76 · 📋 9 - 11% open · ⏱️ 14.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/plan) (📥 1.1K / month):
	```
	pip install plan
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 580 · 📦 48K · 📋 710 - 10% open · ⏱️ 03.03.2023):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 8.1M / month):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 1M · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 340 · 📥 3.8K · 📦 40K · 📋 830 - 19% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 600 · 🔀 8K · 📥 6.2K · 📦 49K · 📋 4.7K - 6% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.8K · 📦 39K · 📋 1.7K - 2% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 700K / month):
	```
	pip install gym
	```
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 340 · 🔀 1.6K · 📋 2.1K - 17% open · ⏱️ 09.03.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 9.7K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 09.03.2023):
...
<details><summary><b><a href="https://github.com/benhamner/Metrics">Metrics</a></b> (🥉17 ·  ⭐ 1.6K · 💀) - Machine learning evaluation metrics. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 9.2K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 98 · 🔀 540 · 📥 1.2K · 📦 1.3K · 📋 1.3K - 7% open · ⏱️ 03.02.2023):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 85 · 🔀 720 · 📥 600K · 📦 110K · 📋 1.7K - 25% open · ⏱️ 19.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 4.5M / month):
	```
	pip install pywin32
	```
- [Conda](https://anaconda.org/conda-forge/pywin32) (📥 3.5M · ⏱️ 28.10.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 790K · ⏱️ 01.03.2023):

	```
	git clone https://github.com/pallets/itsdangerous
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 54M / month):
	```
	pip install itsdangerous
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 4.9M · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 83 · 🔀 330 · 📥 23 · 📦 4K · 📋 140 - 31% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/boltons) (📥 3.9M / month):
	```
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 760K · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 16 · 🔀 160 · 📦 140K · 📋 36 - 2% open · ⏱️ 24.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/blinker) (📥 7.3M / month):
	```
	pip install blinker
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 440 · 🔀 4.1K · 📥 4.3K · 📦 43K · 📋 1.8K - 20% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.4K · 📦 21K · 📋 820 - 73% open · ⏱️ 15.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jieba) (📥 520K / month):
	```
	pip install jieba
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 40 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/pattern) (📥 1.5M / month):
	```
	pip install pattern
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 54 · 🔀 820 · 📦 1.6K · 📋 760 - 11% open · ⏱️ 15.09.2022):
...
- [PyPi](https://pypi.org/project/stanza) (📥 170K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 8.3K · ⏱️ 15.09.2022):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 250 · 📦 500 · 📋 69 - 28% open · ⏱️ 10.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 6.6K / month):
	```
...
- [PyPi](https://pypi.org/project/snownlp) (📥 7.7K / month):
	...
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 1.6K · ⏱️ 07.09.2021):
	```
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉16 ·  ⭐ 47K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 1.4K · 📋 580 - 21% open · ⏱️ 17.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/napalm) (📥 50K / month):
	```
	pip install napalm
	```
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 500K · 📦 200 · 📋 680 - 36% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mininet) (📥 3.6K / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 430 · 📋 190 - 22% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 4.3M / month):
	```
	pip install pox
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 6 · 📦 1K · 📋 300 - 4% open · ⏱️ 11.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-activity-stream) (📥 42K / month):
	```
...
<details><summary><b><a href="https://github.com/coleifer/peewee">peewee</a></b> (🥇36 ·  ⭐ 9.9K) - A small, expressive ORM. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 21K · ⏱️ 09.03.2023):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 270K · ⏱️ 21.02.2023):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 2.9K · 📋 280 - 7% open · ⏱️ 30.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/dataset) (📥 52K / month):
	```
	pip install dataset
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 47 · 📦 3.3K · 📋 610 - 46% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 18 · 🔀 92 · 📋 79 - 18% open · ⏱️ 30.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/orm) (📥 4.4K / month):
	```
	pip install orm
	```
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 660 / month):
	```
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 81 · 📋 51 - 70% open · ⏱️ 06.06.2016):
	...
	```
- [PyPi](https://pypi.org/project/redisco) (📥 450 / month):
	```
	pip install redisco
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 440 · 🔀 1.9K · 📥 15M · 📋 4.8K - 12% open · ⏱️ 07.03.2023):
...
- [PyPi](https://pypi.org/project/poetry) (📥 12M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 790K · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 490 · 📋 910 - 12% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 9.9M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 75K · ⏱️ 01.03.2023):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.3K · 📋 8.9K - 9% open · ⏱️ 09.03.2023):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇20 ·  ⭐ 670) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 330 · 🔀 790 · 📋 2.9K - 14% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 5 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 130 / month):
	```
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 07.03.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 5K · 📋 4.9K - 1% open · ⏱️ 09.03.2023):
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉20 ·  ⭐ 8.4K) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/dfunckt/django-rules">django-rules</a></b> (🥉24 ·  ⭐ 1.6K) - A tiny but powerful app providing object-level permissions to.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 28 · 🔀 130 · 📦 1.2K · 📋 110 - 22% open · ⏱️ 23.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 150 / month):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 91 · 🔀 460 · 📦 12K · 📋 430 - 1% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/sh) (📥 4.1M / month):
	```
	pip install sh
	```
...
- [GitHub](https://github.com/amitt001/delegator.py) (👨‍💻 23 · 🔀 88 · 📋 45 - 17% open · ⏱️ 06.05.2019):

	```
	git clone https://github.com/amitt001/delegator.py
	```
- [PyPi](https://pypi.org/project/delegator.py) (📥 40K / month):
	```
...
<details><summary><b><a href="https://github.com/lyst/lightfm">lightfm</a></b> (🥈27 ·  ⭐ 4.3K · 💤) - A Python implementation of a number of popular recommendation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 650 · 📦 990 · 📋 480 - 26% open · ⏱️ 19.07.2022):
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 29 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 2K / month):
	```
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 400 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 980 / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 470 · 📦 100 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 310 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 78 · 🔀 140 · 📦 59K · 📋 290 - 23% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 420 · 🔀 4.5K · 📦 160K · 📋 3.3K - 0% open · ⏱️ 07.03.2023):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 15M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 1.3M · ⏱️ 07.03.2023):
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.5K · 📦 13K · 📋 1.3K - 4% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 210 · 🔀 730 · 📦 1.1K · 📋 970 - 2% open · ⏱️ 10.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/eve) (📥 14K / month):
	```
	pip install eve
	```
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 210 · 📦 24 · 📋 84 - 38% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 520 / month):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.2K · 📋 310 - 4% open · ⏱️ 07.03.2023):
...
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">statsmodels</a></b> (🥇35 ·  ⭐ 8.3K) - Statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/statsmodels) (📥 9.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 8.9M · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.8K · 📥 490K · 📦 55K · 📋 12K - 32% open · ⏱️ 08.03.2023):
...
- [PyPi](https://pypi.org/project/sympy) (📥 3M / month):
	...
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 3M · ⏱️ 27.10.2022):
	```
...
<details><summary><b><a href="https://github.com/pymc-devs/pymc">PyMC</a></b> (🥉27 ·  ⭐ 7.4K) - Markov Chain Monte Carlo sampling toolkit. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 440 · 🔀 1.7K · 📥 1.9K · 📦 1.2K · 📋 3K - 5% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 140 · ⏱️ 08.02.2023):

	```
	git clone https://github.com/benedekrozemberczki/karateclub
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/obspy/obspy) (🔀 500 · 📥 6.8K · 📋 1.7K - 10% open · ⏱️ 03.03.2023):
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 310 · 📦 2.9K · 📋 140 - 16% open · ⏱️ 12.04.2022):

	```
	git clone https://github.com/django-haystack/pysolr
	```
- [PyPi](https://pypi.org/project/pysolr) (📥 260K / month):
	```
	pip install pysolr
	```
...
<details><summary><b><a href="https://github.com/marshmallow-code/marshmallow">marshmallow</a></b> (🥇30 ·  ⭐ 6.5K) - A lightweight library for converting complex objects to and from.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 71K · 📋 1.2K - 11% open · ⏱️ 07.03.2023):
...
<details><summary><b><a href="https://github.com/TkTech/pysimdjson">pysimdjson</a></b> (🥈23 ·  ⭐ 580) - A Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 47 · 📦 920 · 📋 80 - 15% open · ⏱️ 12.09.2022):
...
<details><summary><b><a href="https://github.com/xonsh/xonsh">xonsh</a></b> (🥇15 ·  ⭐ 6.9K) - A Python-powered, cross-platform, Unix-gazing shell language and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xonsh/xonsh) (🔀 570 · 📥 8.3K · 📋 2.4K - 10% open · ⏱️ 05.03.2023):
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 36 · 🔀 220 · 📦 200K · 📋 250 - 6% open · ⏱️ 08.03.2023):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 34K · 📋 240 - 11% open · ⏱️ 05.03.2023):
...
- [PyPi](https://pypi.org/project/tablib) (📥 1.5M / month):
	...
	pip install tablib
	```
- [Conda](https://anaconda.org/conda-forge/tablib) (📥 83K · ⏱️ 16.01.2023):
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 57K · 📋 850 - 1% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 560 · 📦 1.3K · 📋 870 - 6% open · ⏱️ 07.03.2023):
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 440 · 📥 24K · 📦 27K · 📋 1.7K - 15% open · ⏱️ 06.03.2023):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 88K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 560K · ⏱️ 06.03.2023):
	```
...
- [GitHub](https://github.com/euske/pdfminer) (👨‍💻 28 · 🔀 1K · 📦 3.7K · 📋 240 - 82% open · ⏱️ 18.01.2020):
...
- [GitHub](https://github.com/pyexcel/pyexcel) (👨‍💻 20 · 🔀 160 · 📥 160 · 📦 3.4K · 📋 210 - 6% open · ⏱️ 09.09.2022):
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 780 · 📦 250K · 📋 810 - 4% open · ⏱️ 09.01.2023):
...
- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 170 · 🔀 1K · 📋 690 - 7% open · ⏱️ 05.03.2023):
...
- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 370 · 📦 110 · 📋 480 - 16% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 28K / month):
	```
	pip install unoconv
	```
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 850 · 📋 1K - 49% open · ⏱️ 15.05.2021):
...
- [PyPi](https://pypi.org/project/python-pptx) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-pptx) (📥 200K · ⏱️ 21.09.2021):
	```
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 56 · 📦 10 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 54 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 750 · 📦 6.8K · 📋 1.6K - 4% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/getpelican/pelican
	```
- [PyPi](https://pypi.org/project/pelican) (📥 21K / month):
	```
	pip install pelican
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.1K · 📦 41K · 📋 1.8K - 6% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 300 · 📥 7K · 📦 400 · 📋 620 - 35% open · ⏱️ 09.03.2023):
...
<details><summary><b><a href="https://github.com/sunainapai/makesite">makesite</a></b> (🥉16 ·  ⭐ 1.7K) - Simple, lightweight, and magic-free static site/blog generator ( 130.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sunainapai/makesite) (👨‍💻 8 · 🔀 270 · 📋 14 - 42% open · ⏱️ 12.10.2022):

	```
	git clone https://github.com/sunainapai/makesite
	```
- [PyPi](https://pypi.org/project/makesite) (📥 250 / month):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 13K · 📋 1K - 13% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 820K / month):
	```
	pip install rq
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 360 · 📦 1.1K · ⏱️ 08.03.2023):

	```
	git clone https://github.com/coleifer/huey
	```
- [PyPi](https://pypi.org/project/huey) (📥 79K / month):
	```
	pip install huey
	```
...
<details><summary><b><a href="https://github.com/Bogdanp/dramatiq">dramatiq</a></b> (🥉28 ·  ⭐ 3.5K) - A fast and reliable background task processing library for Python.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 87 · 🔀 240 · 📥 36 · 📦 860 · 📋 320 - 11% open · ⏱️ 27.02.2023):
...
- [PyPi](https://pypi.org/project/dramatiq) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 41K · ⏱️ 27.02.2023):
	```
	conda install -c conda-forge dramatiq
	```
</details>
<details><summary><b><a href="https://github.com/pricingassistant/mrq">mrq</a></b> (🥉20 ·  ⭐ 880 · 💀) - A distributed worker task queue in Python using Redis & gevent. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 950 - 5% open · ⏱️ 01.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/jinja) (📥 8.7K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 510 · 🔀 1.7K · 📦 110K · 📋 620 - 2% open · ⏱️ 03.03.2023):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 7.7M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 720K · ⏱️ 03.03.2023):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 170 · 🔀 2.1K · 📥 540 · 📦 7.3K · 📋 4K - 6% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 310 · 📥 90 · 📦 23K · 📋 260 - 0% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.2K · 📋 510 - 8% open · ⏱️ 06.03.2023):

	```
	git clone https://github.com/cobrateam/splinter
	```
- [PyPi](https://pypi.org/project/splinter) (📥 91K / month):
	```
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈30 ·  ⭐ 7.8K · 💀) - PyAutoGUI is a cross-platform GUI automation Python module for.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 380 · 📦 1.3K · 📋 310 - 0% open · ⏱️ 07.03.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 110K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 85K · ⏱️ 18.12.2022):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 120 · 🔀 310 · 📦 7.1K · 📋 340 - 25% open · ⏱️ 01.11.2022):
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.6K · 📋 1.4K - 0% open · ⏱️ 05.03.2023):
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 53 · 🔀 120 · 📦 210 · 📋 710 - 16% open · ⏱️ 01.03.2023):
...
- [PyPi](https://pypi.org/project/HTTPretty) (📥 470K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/HTTPretty) (📥 290K · ⏱️ 16.08.2021):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 240 · 📋 280 - 36% open · ⏱️ 22.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 6.7M / month):
	```
	pip install freezegun
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 760K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 23K · 📋 260 - 20% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 130 · 🔀 360 · 📋 540 - 30% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 38 · 🔀 72 · 📦 980 · 📋 180 - 2% open · ⏱️ 20.09.2022):
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 48 · 📦 2.1K · 📋 26 - 42% open · ⏱️ 28.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/httmock) (📥 340K / month):
	```
	pip install httmock
	```
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 110 · 📦 22 · 📋 22 - 31% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/fake2db) (📥 190 / month):
	```
	pip install fake2db
	```
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 600 · 📦 690K · 📋 490 - 42% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 53 · 🔀 240 · 📥 7.7K · 📦 740K · 📋 290 - 11% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/pyparsing/pyparsing
	```
- [PyPi](https://pypi.org/project/pyparsing) (📥 78M / month):
	```
...
- [PyPi](https://pypi.org/project/pyfiglet) (📥 950K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyfiglet) (📥 140K · ⏱️ 18.05.2019):
	```
...
<details><summary><b><a href="https://github.com/seatgeek/fuzzywuzzy">fuzzywuzzy</a></b> (🥈25 ·  ⭐ 8.8K · 💀) - Fuzzy String Matching. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📋 180 - 44% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 33 · 🔀 93 · 📋 65 - 1% open · ⏱️ 24.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-slugify) (📥 15M / month):
	```
	pip install python-slugify
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 1.4M · ⏱️ 25.02.2023):
	```
...
- [PyPi](https://pypi.org/project/ply) (📥 24M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 3.6M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 240 - 11% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/mozillazg/python-pinyin
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 23 / month):
	```
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 46 · 📦 2.1K · 📋 18 - 55% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 47K / month):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 9.5K · 📋 130 - 9% open · ⏱️ 25.10.2022):
...
- [GitHub](https://github.com/voronind/awesome-slugify) (👨‍💻 11 · 🔀 41 · 📦 3.2K · 📋 24 - 54% open · ⏱️ 20.01.2017):
	...
	```
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 62K / month):
	```
...
- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 22 · 🔀 94 · 📦 1.1K · 📋 100 - 20% open · ⏱️ 14.11.2022):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 27 · 🔀 380 · 📋 160 - 3% open · ⏱️ 03.03.2023):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.7K · 📦 280K · 📋 2.9K - 4% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 520M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 14M · ⏱️ 08.03.2023):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 140K · 📋 970 - 8% open · ⏱️ 07.03.2023):
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 860 · 📥 400 · 📦 21K · 📋 780 - 7% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.9K · 📋 280 - 2% open · ⏱️ 08.03.2023):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 860K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 61 · 📦 7.9K · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 35 · 📦 3.8K · 📋 20 - 25% open · ⏱️ 15.05.2021):

	```
	git clone https://github.com/codeinthehole/purl
	```
- [PyPi](https://pypi.org/project/purl) (📥 49K / month):
	```
	pip install purl
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 210 · 📥 750 · 📦 360 · 📋 250 - 1% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 50K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.2K · 📋 440 - 27% open · ⏱️ 09.03.2023):

	```
	git clone https://github.com/jazzband/django-pipeline
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 85K / month):
	```
...
- [PyPi](https://pypi.org/project/requests-html) (📥 840K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 5.4K · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/codelucas/newspaper) (👨‍💻 100 · 🔀 1.9K · 📋 660 - 60% open · ⏱️ 02.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/newspaper) (📥 14K / month):
	```
...
- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 40 · 🔀 490 · 📋 220 - 41% open · ⏱️ 10.03.2022):
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 2.7K · ⏱️ 14.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/micawber) (📥 53K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 8.4K · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 160 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 51 · 🔀 1.4K · 📥 230 · 📦 45 · 📋 450 - 25% open · ⏱️ 10.07.2019):

	```
	git clone https://github.com/scrapinghub/portia
	```
- [PyPi](https://pypi.org/project/portia) (📥 250 / month):
	```
	pip install portia
	```
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 66 · 🔀 260 · ⏱️ 28.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 2.7K / month):
	```
	pip install grab
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 53 · 🔀 360 · 📥 43 · 📋 160 - 15% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 47K / month):
	```
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 3 · 🔀 530 · 📦 18 · 📋 65 - 20% open · ⏱️ 01.03.2020):
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 83 · 🔀 120 · 📦 460 · 📋 380 - 5% open · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/masonite) (📥 2.7K / month):
	```
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 64 · 🔀 460 · 📦 92K · 📋 970 - 1% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/aaugustin/websockets
	```
- [PyPi](https://pypi.org/project/websockets) (📥 17M / month):
	```
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 740 · 📋 1.2K - 6% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 280 · 📦 950K · 📋 1K - 0% open · ⏱️ 06.03.2023):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 81M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 7.1M · ⏱️ 14.02.2023):
	```
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 50 · 🔀 150 · 📦 110K · 📋 210 - 6% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/waitress) (📥 4M / month):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 580 · 📋 160 - 15% open · ⏱️ 11.09.2022):

	```
	git clone https://github.com/jonashaag/bjoern
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 26K / month):
	```
	pip install bjoern
	```
