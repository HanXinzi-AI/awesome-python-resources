...
<details><summary><b><a href="https://github.com/flask-admin/flask-admin">flask-admin</a></b> (🥇34 ·  ⭐ 5.2K) - Simple and extensible administrative interface framework for Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/mher/flower">flower</a></b> (🥈29 ·  ⭐ 5.5K) - Real-time monitor and web admin for Celery. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 24 · 🔀 790 · 📦 25 · 📋 1.1K - 0% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 790 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 170 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 41 · 📋 210 - 24% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 450 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 08.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 930 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 980 · 🔀 38K · 📦 2 · 📋 1.2K - 1% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 80M · ⏱️ 02.02.2023):
	```
...
<details><summary><b><a href="https://github.com/pytransitions/transitions">transitions</a></b> (🥈24 ·  ⭐ 4.7K) - A lightweight, object-oriented finite state machine implementation. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 75 · 🔀 500 · 📋 420 - 1% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/transitions) (📥 400K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 330K · ⏱️ 02.09.2022):
	```
	conda install -c conda-forge transitions
	```
</details>
<details><summary><b><a href="https://github.com/grantjenks/python-sortedcontainers">sortedcontainers</a></b> (🥉22 ·  ⭐ 2.9K) - Fast and pure-Python implementation of sorted.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 23 · 🔀 180 · 📦 99K · 📋 170 - 9% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 29 · ⏱️ 09.02.2020):

	```
	git clone https://github.com/tylerlaberge/PyPattyrn
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 3.4K / month):
	```
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 110 · 🔀 510 · 📋 87 - 21% open · ⏱️ 04.10.2022):
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇36 ·  ⭐ 6.1K · 📈) - A lightning-fast ASGI server implementation, using uvloop and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 150 · 🔀 530 · 📦 130K · 📋 630 - 3% open · ⏱️ 08.02.2023):
...
- [PyPi](https://pypi.org/project/uvicorn) (📥 11M / month):
	...
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 1.5M · ⏱️ 23.11.2022):
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 56 · 🔀 460 · 📥 360 · 📦 63K · 📋 300 - 16% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/MagicStack/uvloop
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 19M / month):
	```
	pip install uvloop
	```
- [Conda](https://anaconda.org/conda-forge/uvloop) (📥 540K · ⏱️ 26.10.2022):
	```
	conda install -c conda-forge uvloop
	```
</details>
<details><summary><b><a href="https://github.com/python-trio/trio">trio</a></b> (🥉30 ·  ⭐ 5.1K) - A friendly library for async concurrency and I/O. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 23K · 📋 690 - 38% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 6.7M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 980K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 900 · 📦 17K · 📋 510 - 49% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 3.6M / month):
	```
	pip install pydub
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 7.9K · 📦 280 · 📋 2.6K - 18% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 3.1K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 110 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 39 · 🔀 130 · 📥 58K · 📦 9.5K · 📋 490 - 21% open · ⏱️ 26.10.2022):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 840K / month):
	```
	pip install mutagen
	```
...
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥈25 ·  ⭐ 430) - A tool for working with audio files, specifically MP3 files containing.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 25 · 🔀 55 · 📥 2.5K · 📦 2.1K · 📋 190 - 24% open · ⏱️ 08.10.2022):
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 850 · 📋 1.1K - 4% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 57 · 📦 16 · 📋 210 - 18% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 36 / month):
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉19 ·  ⭐ 830) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 110 · 📦 12 · 📋 40 - 32% open · ⏱️ 09.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/matchering) (📥 500 / month):
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 190 · 🔀 440 · 📦 320K · 📋 360 - 19% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/oauthlib) (📥 90M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 7.6M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 590 · 📦 310K · 📋 380 - 3% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 620 · 🔀 2.6K · 📦 130K · 📋 1.9K - 14% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/pennersr/django-allauth
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 720K / month):
	```
	pip install django-allauth
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 85K · ⏱️ 07.06.2022):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 90 · 🔀 340 · 📦 24K · 📋 360 - 11% open · ⏱️ 07.02.2023):
...
- [PyPi](https://pypi.org/project/authlib) (📥 5.3M / month):
	...
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 94K · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 10K · 📋 130 - 38% open · ⏱️ 12.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 48K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 680 · 📋 740 - 20% open · ⏱️ 30.01.2023):
...
- [GitHub](https://github.com/davedoesdev/python-jwt) (👨‍💻 5 · 🔀 24 · ⏱️ 01.01.2023):
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 18K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 33K · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 690 · 📋 3.9K - 4% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 320 · 📦 600K · 📋 610 - 17% open · ⏱️ 06.02.2023):
...
- [PyPi](https://pypi.org/project/attrs) (📥 130M / month):
	...
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 24M · ⏱️ 21.12.2022):
	```
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 52 · 📦 11K · 📋 54 - 5% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/jab/bidict
	```
- [PyPi](https://pypi.org/project/bidict) (📥 1.2M / month):
	```
	pip install bidict
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 91 · 📥 31 · 📋 150 - 10% open · ⏱️ 04.02.2023):
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 17 · 📥 66 · 📦 68 · 📋 9 - 77% open · ⏱️ 30.10.2015):

	```
	git clone https://github.com/carlosescri/DottedDict
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 8 / month):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 350 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.5K · 📋 1K - 3% open · ⏱️ 02.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 5.6K / month):
	```
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 1.4K / month):
	```
	pip install Kotti
	```
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 54 · 📦 4.4K · 📋 190 - 10% open · ⏱️ 26.08.2022):

	```
	git clone https://github.com/lericson/pylibmc
	```
- [PyPi](https://pypi.org/project/pylibmc) (📥 230K / month):
	```
	pip install pylibmc
	```
...
<details><summary><b><a href="https://github.com/Suor/django-cacheops">django-cacheops</a></b> (🥈26 ·  ⭐ 1.8K · 💤) - A slick ORM cache with automatic granular event-driven.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 64 · 🔀 200 · 📦 840 · 📋 310 - 9% open · ⏱️ 11.07.2022):
...
- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 88 · 🔀 140 · 📦 4.2K · 📋 120 - 51% open · ⏱️ 04.02.2023):
...
- [PyPi](https://pypi.org/project/beaker) (📥 360K / month):
	...
	pip install beaker
	```
- [Conda](https://anaconda.org/conda-forge/beaker) (📥 66K · ⏱️ 06.02.2023):
	```
...
- [GitHub](https://github.com/errbotio/errbot) (🔀 580 · 📦 280 · 📋 760 - 8% open · ⏱️ 04.02.2023):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 360 · 🔀 1.9K · 📥 27K · 📦 240K · 📋 2.2K - 15% open · ⏱️ 07.02.2023):
...
<details><summary><b><a href="https://github.com/PyCQA/isort">isort</a></b> (🥇34 ·  ⭐ 5.6K) - A Python utility / library to sort imports. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 310K · 📋 1.2K - 10% open · ⏱️ 04.02.2023):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 360 · 📦 11K · 📋 1K - 9% open · ⏱️ 02.01.2023):
...
<details><summary><b><a href="https://github.com/PyCQA/prospector">prospector</a></b> (🥈30 ·  ⭐ 1.8K) - A tool to analyse Python code. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 86 · 🔀 150 · 📦 3.7K · 📋 350 - 13% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 700K / month):
	```
	pip install prospector
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 57K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 850 · 📦 50K · 📋 770 - 47% open · ⏱️ 04.02.2023):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 2.7M / month):
	```
	pip install yapf
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 34 · 🔀 110 · 📦 2.3K · 📋 170 - 6% open · ⏱️ 19.01.2023):
...
- [PyPi](https://pypi.org/project/vulture) (📥 450K / month):
	...
	pip install vulture
	```
- [Conda](https://anaconda.org/conda-forge/vulture) (📥 65K · ⏱️ 09.01.2023):
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 93 · 📦 4.7K · 📋 140 - 31% open · ⏱️ 08.08.2022):
...
<details><summary><b><a href="https://github.com/facebook/pyre-check">pyre-check</a></b> (🥉22 ·  ⭐ 6.2K) - Performant type checking. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 230 · 🔀 380 · 📋 340 - 31% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 270 · 📦 380 · 📋 160 - 30% open · ⏱️ 28.02.2018):
...
<details><summary><b><a href="https://github.com/scottrogowski/code2flow">code2flow</a></b> (🥉20 ·  ⭐ 3K) - Turn your Python and JavaScript code into DOT flowcharts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 14 · 📋 49 - 12% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/scottrogowski/code2flow
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 2.5K / month):
	```
	pip install code2flow
	```
- [Conda](https://anaconda.org/conda-forge/code2flow) (📥 1.9K · ⏱️ 10.01.2023):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 20% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 97K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 87 · 🔀 250 · 📋 580 - 18% open · ⏱️ 04.02.2023):
...
- [PyPi](https://pypi.org/project/pytype) (📥 250K / month):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 150K · ⏱️ 06.02.2023):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 98 · 📋 59 - 44% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.2K · 🔀 1.4K · 📋 2K - 7% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 210 · 🔀 1.4K · 📦 52K · 📋 1K - 7% open · ⏱️ 28.01.2023):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 20M / month):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 2.9M · ⏱️ 28.01.2023):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 390K · 📋 880 - 36% open · ⏱️ 03.09.2022):
...
<details><summary><b><a href="https://github.com/peterbrittain/asciimatics">asciimatics</a></b> (🥈27 ·  ⭐ 3.2K) - A package to create full-screen text UIs (from interactive.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 760 · 📋 290 - 8% open · ⏱️ 17.01.2023):
...
<details><summary><b><a href="https://github.com/google/python-fire">python-fire</a></b> (🥉26 ·  ⭐ 24K) - A library for creating command line interfaces from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/python-fire) (👨‍💻 58 · 🔀 1.3K · 📦 17K · 📋 270 - 38% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/google/python-fire
	```
- [PyPi](https://pypi.org/project/python-fire) (📥 130 / month):
	```
...
<details><summary><b><a href="https://github.com/rsalmei/alive-progress">alive-progress</a></b> (🥉24 ·  ⭐ 4.1K) - A new kind of Progress Bar, with real-time throughput, eta and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.5K · 📋 180 - 8% open · ⏱️ 01.01.2023):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 200K / month):
	```
	pip install alive-progress
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 25K · ⏱️ 02.01.2023):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 650 · 📋 1K - 47% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 5.8K / month):
	```
	pip install bashplotlib
	```
- [Conda](https://anaconda.org/conda-forge/bashplotlib) (📥 4K · ⏱️ 08.09.2018):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 2.4K · 📦 12K · 📋 800 - 15% open · ⏱️ 15.01.2023):
...
- [PyPi](https://pypi.org/project/httpie) (📥 170K / month):
	...
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 93K · ⏱️ 01.11.2022):
	```
	conda install -c conda-forge httpie
	```
</details>
<details><summary><b><a href="https://github.com/cookiecutter/cookiecutter">cookiecutter</a></b> (🥇31 ·  ⭐ 19K) - A command-line utility that creates projects from cookiecutters.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 280 · 🔀 1.7K · 📦 17K · 📋 760 - 25% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 570K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.2K · 📦 400 · 📋 660 - 31% open · ⏱️ 25.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/thefuck) (📥 6.3K / month):
	```
	pip install thefuck
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 71 · 🔀 220 · 📦 220 · 📋 330 - 23% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 7.3K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 480 · 📦 760 · 📋 660 - 22% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 280 · 📋 620 - 29% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mycli) (📥 36K / month):
	```
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 50K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 83 · 🔀 840 · 📦 440 · 📋 250 - 3% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/gleitz/howdoi
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 7.1K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 91 · 📥 11K · 📦 14 · 📋 200 - 24% open · ⏱️ 29.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/iredis) (📥 1K / month):
	```
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 530 · ⏱️ 10.08.2022):
	```
	conda install -c conda-forge iredis
	```
</details>
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈24 ·  ⭐ 860) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 51 · 🔀 110 · 📦 170 · 📋 310 - 14% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 25K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 1.5K · ⏱️ 07.01.2023):
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 62 · 📦 200 · 📋 88 - 32% open · ⏱️ 11.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/litecli) (📥 10K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/mooz/percol) (👨‍💻 36 · 🔀 140 · 📦 33 · 📋 65 - 55% open · ⏱️ 23.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/percol) (📥 1.2K / month):
	```
	pip install percol
	```
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 650 · 📦 14 · 📋 69 - 82% open · ⏱️ 19.09.2018):

	```
	git clone https://github.com/cloudnativelabs/kube-shell
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 690 / month):
	```
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 92 · 📦 18 · 📋 48 - 25% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/doitlive) (📥 52 / month):
	```
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 130K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 2.2K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 27 · 🔀 230 · 📦 780 · 📋 250 - 30% open · ⏱️ 26.08.2022):
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 12K · 📥 700 · 📋 1.2K - 54% open · ⏱️ 10.06.2022):
...
- [GitHub](https://github.com/kornia/kornia) (🔀 760 · 📥 510 · 📋 700 - 28% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 86 · 📦 300 · 📋 73 - 43% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/scoop) (📥 2.9K / month):
	```
	pip install scoop
	```
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 33 · 🔀 170 · 📥 10 · 📦 88K · 📋 84 - 11% open · ⏱️ 09.01.2023):
...
- [PyPi](https://pypi.org/project/python-decouple) (📥 1.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 55K · ⏱️ 09.01.2023):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 12 · 📦 24K · 📋 150 - 35% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/DiffSK/configobj
	```
- [PyPi](https://pypi.org/project/configobj) (📥 3M / month):
	```
	pip install configobj
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 550K · ⏱️ 20.01.2023):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 510 · 📦 12 · 📋 1.2K - 14% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 22K / month):
	```
	pip install hydra
	```
...
<details><summary><b><a href="https://github.com/paramiko/paramiko">paramiko</a></b> (🥇32 ·  ⭐ 8.1K) - The leading native Python SSHv2 protocol library. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 70K · 📋 1.4K - 51% open · ⏱️ 27.01.2023):
...
- [PyPi](https://pypi.org/project/pynacl) (📥 38M / month):
	...
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 3.6M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 16K / month):
	```
	pip install blaze
	```
...
<details><summary><b><a href="https://github.com/aws/aws-sdk-pandas">AWS Data Wrangler</a></b> (🥈24 ·  ⭐ 3.3K) - Pandas on AWS. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 560 · 📥 170K · 📦 760 · 📋 840 - 3% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 530 · 📦 300K · 📋 700 - 5% open · ⏱️ 05.02.2023):
...
- [PyPi](https://pypi.org/project/cerberus) (📥 4.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cerberus) (📥 280K · ⏱️ 10.12.2021):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 5.3K · 📋 150 - 52% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/keleshev/schema
	```
- [PyPi](https://pypi.org/project/schema) (📥 4.3M / month):
	```
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 80K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 89 · 🔀 200 · 📦 6.6K · 📋 240 - 16% open · ⏱️ 23.10.2022):
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 180 · 🔀 1.6K · 📥 240 · 📦 220K · 📋 2.2K - 4% open · ⏱️ 07.02.2023):
...
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈35 ·  ⭐ 8K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📥 2 · 📦 44K · 📋 1.7K - 11% open · ⏱️ 08.02.2023):
...
<details><summary><b><a href="https://github.com/mingrammer/diagrams">diagrams</a></b> (🥈30 ·  ⭐ 28K) - Diagram as Code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 750 · 📋 420 - 57% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 92K / month):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 630 · 🔀 3.9K · 📦 190 · 📋 7.1K - 9% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 59 · 🔀 440 · 📦 38 · 📋 580 - 37% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 3K · 📋 1.1K - 26% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 590 · 📦 990 · 📋 1.4K - 21% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 44K / month):
	```
	pip install vispy
	```
...
<details><summary><b><a href="https://github.com/has2k1/plotnine">plotnine</a></b> (🥉22 ·  ⭐ 3.3K) - A grammar of graphics for Python based on ggplot2. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 79 · 🔀 480 · 📦 9.4K · 📋 290 - 2% open · ⏱️ 14.01.2023):
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 79 · 📦 970 · 📋 160 - 38% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 120 · 📦 1K · 📋 57 - 28% open · ⏱️ 15.11.2019):
...
- [PyPi](https://pypi.org/project/pickledb) (📥 38K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pickledb) (📥 3.3K · ⏱️ 17.04.2019):
	```
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 14K · 📋 1.4K - 16% open · ⏱️ 27.03.2022):

	```
	git clone https://github.com/dpkp/kafka-python
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 7.5M / month):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 41 · 🔀 180 · 📦 48K · ⏱️ 11.01.2023):
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 150K · 📋 620 - 3% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/PyMySQL/PyMySQL
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 37M / month):
	```
	pip install PyMySQL
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 380 · 🔀 2.2K · 📋 1.3K - 9% open · ⏱️ 08.02.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 890K · ⏱️ 07.02.2023):
	```
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 50 · 🔀 180 · 📦 910 · 📋 270 - 11% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.6K · ⏱️ 24.01.2023):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 980 · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 160 · 📦 720 · 📋 210 - 11% open · ⏱️ 12.07.2022):
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 12 · 🔀 32 · 📦 120 · 📋 18 - 22% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 3K / month):
	```
	pip install queries
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 140 / month):
	```
...
<details><summary><b><a href="https://github.com/sdispater/pendulum">Pendulum</a></b> (🥇31 ·  ⭐ 5.3K) - Python datetimes made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 87 · 🔀 310 · 📥 64 · 📦 16K · 📋 460 - 42% open · ⏱️ 23.12.2022):
...
- [PyPi](https://pypi.org/project/pendulum) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 650K · ⏱️ 04.02.2023):
	```
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 420 · 📥 35K · 📦 920K · 📋 650 - 40% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 760 · 📋 40 - 7% open · ⏱️ 27.11.2020):

	```
	git clone https://github.com/zachwill/moment
	```
- [PyPi](https://pypi.org/project/moment) (📥 82K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 22 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 630 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 20 · 📦 32 · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 4.6K / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 320 · 📥 11K · 📦 2.3K · 📋 270 - 34% open · ⏱️ 09.12.2022):
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 870 · 📥 180 · 📦 62K · 📋 830 - 7% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 54 · 🔀 140 · 📦 38K · 📋 180 - 32% open · ⏱️ 13.12.2022):
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 89 · 🔀 440 · 📦 4.6K · 📋 210 - 32% open · ⏱️ 04.02.2023):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 2.3M / month):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 210 · 📦 3.9K · 📋 300 - 45% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 270K / month):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 130 · 📋 98 - 29% open · ⏱️ 04.12.2022):
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 160 · 📦 100 · 📋 83 - 31% open · ⏱️ 15.07.2022):

	```
	git clone https://github.com/nvdv/vprof
	```
- [PyPi](https://pypi.org/project/vprof) (📥 4.4K / month):
	```
	pip install vprof
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 110 · 📦 130 · 📋 110 - 27% open · ⏱️ 16.09.2019):
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 360 · 📋 67 - 58% open · ⏱️ 05.03.2016):
	...
	```
- [PyPi](https://pypi.org/project/django-devserver) (📥 5.7K / month):
	```
...
<details><summary><b><a href="https://github.com/pdbpp/pdbpp">pdb++</a></b> (🥉21 ·  ⭐ 1.1K · 💤) - Another drop-in replacement for pdb. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 41 · 🔀 56 · 📦 3.5K · 📋 200 - 37% open · ⏱️ 14.07.2022):
...
- [GitHub](https://github.com/rkern/line_profiler) (👨‍💻 14 · 🔀 250 · 📋 140 - 36% open · ⏱️ 23.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 360K / month):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 920 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 41 · 📦 110 · 📋 92 - 43% open · ⏱️ 29.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-hunter) (📥 15 / month):
	```
...
<details><summary><b><a href="https://github.com/ionelmc/python-manhole">manhole</a></b> (🥉16 ·  ⭐ 330) - Debugging UNIX socket connections and present the stacktraces for all.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 20 · 📦 120 · 📋 21 - 28% open · ⏱️ 17.12.2022):
...
- [PyPi](https://pypi.org/project/memory_profiler) (📥 660K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/memory_profiler) (📥 270K · ⏱️ 16.11.2022):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 26 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 37 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 170 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 240K · 📋 37K - 5% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 3.9K · 📋 9.5K - 18% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/Theano/Theano) (👨‍💻 390 · 🔀 2.4K · 📦 13K · 📋 2.7K - 21% open · ⏱️ 20.12.2022):

	```
	git clone https://github.com/Theano/Theano
	```
- [PyPi](https://pypi.org/project/Theano) (📥 280K / month):
	```
	pip install Theano
	```
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.8K · 🔀 17K · 📥 11K · 📋 31K - 32% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 64K / month):
	```
	pip install pytorch
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 740 · 📥 240 · ⏱️ 22.05.2020):

	```
	git clone https://github.com/SerpentAI/SerpentAI
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 62 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 250K · 📋 1.6K - 13% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 26K · 📋 31K - 2% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/ansible/ansible
	```
- [PyPi](https://pypi.org/project/ansible) (📥 4.6M / month):
	```
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 810K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 16K · 📋 25K - 9% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 77K / month):
	```
	pip install salt
	```
...
<details><summary><b><a href="https://github.com/Supervisor/supervisor">supervisor</a></b> (🥈27 ·  ⭐ 7.6K) - Supervisor process control system for UNIX. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.4K · 📋 1.1K - 10% open · ⏱️ 27.12.2022):
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 130 · 📦 4.3K · 📋 100 - 11% open · ⏱️ 24.10.2022):
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 86 · 🔀 300 · 📦 60 · 📋 640 - 17% open · ⏱️ 29.01.2023):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 19K / month):
	```
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 360 · ⏱️ 21.01.2023):
	```
...
- [PyPi](https://pypi.org/project/fabric) (📥 3.1M / month):
	...
	pip install fabric
	```
- [Conda](https://anaconda.org/conda-forge/fabric) (📥 59K · ⏱️ 22.01.2023):
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 190 · 📦 290 · 📋 140 - 54% open · ⏱️ 16.09.2019):
...
- [GitHub](https://github.com/sebastien/cuisine) (👨‍💻 57 · 🔀 160 · 📦 170 · 📋 110 - 24% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/sebastien/cuisine
	```
- [PyPi](https://pypi.org/project/cuisine) (📥 780 / month):
	```
	pip install cuisine
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 600 · 🔀 2.3K · 📦 1.9K · 📋 960 - 8% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/spotify/luigi
	```
- [PyPi](https://pypi.org/project/luigi) (📥 490K / month):
	```
	pip install luigi
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.5K · 📦 44K · 📋 4.6K - 15% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 7.6M / month):
	```
	pip install dask
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.1K · 📦 7.3K · 📋 13K - 19% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 94 · 🔀 540 · 📦 1.3K · 📋 470 - 48% open · ⏱️ 09.10.2020):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 740K · 📦 35K · 📋 4.8K - 5% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 950K / month):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 400K · ⏱️ 13.12.2022):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 26 · 🔀 210 · 📦 650 · 📋 890 - 5% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 210K / month):
	```
	pip install pyarmor
	```
...
<details><summary><b><a href="https://github.com/linkedin/shiv">shiv</a></b> (🥉19 ·  ⭐ 1.5K) - A command line utility for building fully self-contained zipapps (PEP 441),.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/shiv) (📥 14K / month):
	...
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 1K · ⏱️ 03.11.2022):
	```
...
🔗&nbsp;<b><a href="https://github.com/yoloseem/awesome-sphinxdoc">awesome-sphinxdoc</a></b> ( ⭐ 840)  - A curated list of awesome tools for Sphinx Python Documentation Generator.
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.7K · 📦 250K · 📋 6.3K - 16% open · ⏱️ 31.01.2023):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 42 · 🔀 160 · 📦 1K · 📋 310 - 4% open · ⏱️ 04.02.2023):
...
- [PyPi](https://pypi.org/project/pdoc) (📥 84K / month):
	...
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 9.9K · ⏱️ 17.11.2022):
	```
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥉25 ·  ⭐ 5.9K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 49 · 🔀 1.3K · 📦 260 · 📋 760 - 0% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 37K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 200 · 📦 33 · 📋 140 - 61% open · ⏱️ 06.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 46K / month):
	```
	pip install s4cmd
	```
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 26 · 🔀 160 · 📦 1.6K · 📋 70 - 22% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 280 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 340 / month):
	```
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 27 · 📦 270 · 📋 23 - 30% open · ⏱️ 04.09.2016):
...
<details><summary><b><a href="https://github.com/awesto/django-shop">django-shop</a></b> (🥉19 ·  ⭐ 2.9K · 💀) - A Django based shop system. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 940 · 📋 380 - 22% open · ⏱️ 28.02.2021):
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 91 · 📦 110 · 📋 15 - 20% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 230 / month):
	```
	pip install alipay
	```
...
- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 12 · 📥 6 · 📦 47 · 📋 6 - 50% open · ⏱️ 22.12.2020):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.6M · 📦 25K · 📋 17K - 6% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 77K / month):
	```
	pip install spyder
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 92 · 🔀 240 · 📦 210 · 📋 1.6K - 22% open · ⏱️ 22.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 740 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 32 · 🔀 260 · 📦 2.9K · 📋 220 - 43% open · ⏱️ 28.09.2022):
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 55 · 🔀 180 · 📦 300 · 📋 88 - 59% open · ⏱️ 29.03.2021):
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 320 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 2.5K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 170 · 📋 130 - 48% open · ⏱️ 17.11.2022):
...
- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 55 · 📥 130 · 📋 72 - 33% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/mailer) (📥 58K / month):
	```
	pip install mailer
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 59 · 📥 79 · 📦 17 · 📋 90 - 18% open · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 88 · 🔀 900 · 📦 220K · 📋 1.3K - 6% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 44M / month):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 3.5M · ⏱️ 08.02.2023):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 410 · 🔀 2.6K · 📋 1.6K - 1% open · ⏱️ 08.02.2023):
...
<details><summary><b><a href="https://github.com/gorakhargosh/watchdog">watchdog</a></b> (🥇34 ·  ⭐ 5.7K) - API and shell utilities to monitor file system events. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 76K · 📋 590 - 26% open · ⏱️ 29.01.2023):
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 58 · 🔀 240 · 📦 37K · 📋 180 - 15% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/ahupp/python-magic
	```
- [PyPi](https://pypi.org/project/python-magic) (📥 7M / month):
	```
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 140 · 🔀 370 · 📦 160K · 📋 410 - 12% open · ⏱️ 13.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 4.1M / month):
	```
	pip install wtforms
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 680 · 📦 110K · 📋 660 - 9% open · ⏱️ 02.02.2023):
...
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 790K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 65K · ⏱️ 25.01.2022):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 220 · 📦 94K · 📋 160 - 13% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 760 · 📋 180 - 25% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 19K / month):
	```
	pip install deform
	```
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 86 · 📦 20 · 📋 16 - 75% open · ⏱️ 12.07.2017):
	...
	```
- [PyPi](https://pypi.org/project/django-remote-forms) (📥 130 / month):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 81K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 6.7K · 📋 74 - 8% open · ⏱️ 04.02.2023):
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 95 · 📦 260 · 📋 390 - 14% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 63K / month):
	```
	pip install returns
	```
...
<details><summary><b><a href="https://github.com/pytoolz/cytoolz">CyToolz</a></b> (🥉21 ·  ⭐ 900) - Cython implementation of `Toolz`: High performance functional.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 460 · 📋 48 - 47% open · ⏱️ 13.10.2014):
	...
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 560 / month):
	```
	pip install fn.py
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 20K · 📋 430 - 15% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/pyglet/pyglet
	```
- [PyPi](https://pypi.org/project/pyglet) (📥 320K / month):
	```
	pip install pyglet
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.6K · 📦 7.1K · 📋 3.2K - 21% open · ⏱️ 08.02.2023):
...
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 180K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 91K · ⏱️ 17.10.2022):
	```
	conda install -c conda-forge PySimpleGUI
	```
</details>
<details><summary><b><a href="https://github.com/python-eel/Eel">Eel</a></b> (🥈28 ·  ⭐ 5.4K) - A library for making simple Electron-like offline HTML/JS GUI apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 44 · 🔀 530 · 📦 4.7K · 📋 480 - 32% open · ⏱️ 05.02.2023):

	```
	git clone https://github.com/ChrisKnott/Eel
	```
- [PyPi](https://pypi.org/project/Eel) (📥 90K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 380 · 📦 660 · 📋 570 - 20% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 4.8K / month):
	```
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 60K · ⏱️ 29.12.2021):
	```
	conda install -c conda-forge Gooey
	```
</details>
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉24 ·  ⭐ 9.6K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 500 · 📦 740 · 📋 1.1K - 14% open · ⏱️ 31.01.2023):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 430 · 📦 900 · 📋 710 - 2% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 440 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 480 / month):
	```
	pip install flexx
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 230 · 🔀 560 · 📥 1.1K · 📋 610 - 17% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 210 · 📦 210 · 📋 220 - 16% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/nucleic/enaml
	```
- [PyPi](https://pypi.org/project/enaml) (📥 1.2K / month):
	```
	pip install enaml
	```
...
- [GitHub](https://github.com/graphql-python/graphene) (🔀 770 · 📦 15K · 📋 970 - 10% open · ⏱️ 25.12.2022):
...
- [GitHub](https://github.com/tartiflette/tartiflette-asgi) (🔀 16 · 📦 12 · 📋 49 - 12% open · ⏱️ 20.05.2022):
...
- [PyPi](https://pypi.org/project/geopy) (📥 3.7M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 940K · ⏱️ 13.11.2022):
	```
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 53 · 🔀 250 · 📋 260 - 4% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/SmileyChris/django-countries
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 500K / month):
	```
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 52 · 🔀 110 · 📦 11K · 📋 88 - 21% open · ⏱️ 04.02.2023):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 240 · 📦 1.1M · ⏱️ 07.02.2023):
...
- [PyPi](https://pypi.org/project/markupsafe) (📥 120M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/markupsafe) (📥 26M · ⏱️ 19.01.2023):
	```
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 48K · 📋 230 - 31% open · ⏱️ 08.05.2022):
...
- [PyPi](https://pypi.org/project/xmltodict) (📥 22M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xmltodict) (📥 2.3M · ⏱️ 08.05.2022):
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 78 · 🔀 230 · 📦 220K · 📋 360 - 7% open · ⏱️ 23.01.2023):
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 52 · 🔀 170 · 📦 17K · 📋 180 - 27% open · ⏱️ 02.01.2023):
...
- [PyPi](https://pypi.org/project/pyquery) (📥 1.4M / month):
	...
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 35K · ⏱️ 28.12.2022):
	```
	conda install -c conda-forge pyquery
	```
</details>
<details><summary><b><a href="https://github.com/stchris/untangle">untangle</a></b> (🥉23 ·  ⭐ 570) - Converts XML documents to Python objects for easy access. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/stchris/untangle) (👨‍💻 17 · 🔀 81 · 📥 530 · 📦 960 · 📋 56 - 26% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/stchris/untangle
	```
- [PyPi](https://pypi.org/project/untangle) (📥 180K / month):
	```
	pip install untangle
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 3.4K · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 730 · 🔀 8.6K · 📥 4.4K · 📦 1.9M · 📋 3.7K - 5% open · ⏱️ 21.01.2023):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 190 · 🔀 640 · 📦 55K · 📋 740 - 3% open · ⏱️ 09.02.2023):
...
- [PyPi](https://pypi.org/project/httpx) (📥 12M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 460K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 970 · 📥 5.2K · 📦 1.2M · 📋 1.1K - 9% open · ⏱️ 03.02.2023):
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 290 · 📦 3.5K · 📋 110 - 2% open · ⏱️ 26.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/grequests) (📥 340K / month):
	```
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 50 · 🔀 130 · 📥 150 · 📦 1.1K · 📋 150 - 36% open · ⏱️ 10.09.2022):
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 410 · 🔀 1.7K · 📦 9.8K · 📋 1.4K - 3% open · ⏱️ 03.02.2023):

	```
	git clone https://github.com/secdev/scapy
	```
- [PyPi](https://pypi.org/project/scapy) (📥 2.5M / month):
	```
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 69K · ⏱️ 25.12.2022):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 380 · 📦 9.2K · 📋 520 - 64% open · ⏱️ 31.01.2023):
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 110 · 📦 900 · 📋 110 - 73% open · ⏱️ 23.08.2022):
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 490 · 📋 100 - 70% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 420 · 🔀 1.8K · 📦 1M · 📋 2.7K - 3% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 9.1K · 📦 14K · 📋 390 - 4% open · ⏱️ 14.01.2023):
...
<details><summary><b><a href="https://github.com/thumbor/thumbor">thumbor</a></b> (🥈29 ·  ⭐ 9.3K) - A smart imaging service. It enables on-demand crop, re-sizing and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 270 · 📥 920 · 📦 220 · 📋 520 - 25% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/dylanaraps/pywal
	```
- [PyPi](https://pypi.org/project/pywal) (📥 2.5K / month):
	```
	pip install pywal
	```
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 43 · 🔀 110 · 📥 250 · 📦 16K · 📋 100 - 39% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/WhyNotHugo/python-barcode
	```
- [PyPi](https://pypi.org/project/python-barcode) (📥 220K / month):
	```
	pip install python-barcode
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 8.9K · ⏱️ 22.08.2020):
	```
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 46 · 📦 440 · 📋 330 - 38% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/libvips/pyvips
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 29K / month):
	```
	pip install pyvips
	```
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 11 · 🔀 42 · 📦 62 · 📋 8 - 50% open · ⏱️ 30.11.2022):

	```
	git clone https://github.com/daboth/pagan
	```
- [PyPi](https://pypi.org/project/pagan) (📥 270 / month):
	```
	pip install pagan
	```
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 56 · 🔀 540 · 📋 200 - 19% open · ⏱️ 05.02.2023):
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 550 · 🔀 4.5K · 📥 56K · 📋 4.6K - 26% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 47K · 📋 560 - 45% open · ⏱️ 17.01.2023):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 25K · 📋 62K - 10% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 110K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 25 · 🔀 150 · 📦 12 · 📋 89 - 26% open · ⏱️ 13.11.2022):
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 250K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 71 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 660 / month):
	```
	pip install Pyjion
	```
- [Conda](https://anaconda.org/conda-forge/Pyjion) (📥 430 · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 59 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 24 / month):
	```
...
<details><summary><b><a href="https://github.com/prompt-toolkit/ptpython">ptpython</a></b> (🥇28 ·  ⭐ 4.7K) - Advanced Python REPL built on top of the [python-prompt-.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 52 · 🔀 260 · 📦 2.1K · 📋 360 - 57% open · ⏱️ 06.12.2022):

	```
	git clone https://github.com/jonathanslenders/ptpython
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 450K / month):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 52 · 📦 3K · ⏱️ 08.04.2021):
...
<details><summary><b><a href="https://github.com/dbader/schedule">schedule</a></b> (🥇30 ·  ⭐ 11K · 💤) - Python job scheduling for humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dbader/schedule) (👨‍💻 51 · 🔀 820 · 📦 23K · 📋 400 - 33% open · ⏱️ 23.04.2022):

	```
	git clone https://github.com/dbader/schedule
	```
- [PyPi](https://pypi.org/project/schedule) (📥 2.7M / month):
	```
	pip install schedule
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 28K · ⏱️ 10.04.2021):
	```
	conda install -c conda-forge schedule
	```
</details>
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥈29 ·  ⭐ 11K) - A modern workflow orchestration framework that makes it easy to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 120 · 🔀 1.1K · 📦 1.9K · 📋 3.3K - 20% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 620K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 390K · ⏱️ 07.02.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 50 · 🔀 270 · 📦 50 · 📋 100 - 6% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 4.4K / month):
	```
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 76 · 📋 9 - 11% open · ⏱️ 14.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/plan) (📥 2.1K / month):
	```
	pip install plan
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 580 · 📦 38K · 📋 700 - 9% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 4.4M / month):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 930K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 330 · 📥 3.7K · 📦 29K · 📋 810 - 20% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 590 · 🔀 8K · 📥 5.9K · 📦 44K · 📋 4.7K - 6% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.6K · 📦 120 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 550 / month):
	```
	pip install nupic
	```
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉21 ·  ⭐ 13K) - MindsDB is an open source AI layer for existing databases that.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 270 · 🔀 1.5K · 📋 1.9K - 15% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 8.1K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 98 · 🔀 540 · 📥 890 · 📦 1.2K · 📋 1.3K - 7% open · ⏱️ 03.02.2023):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 85 · 🔀 710 · 📥 600K · 📦 110K · 📋 1.7K - 25% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/mhammond/pywin32
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 3.6M / month):
	```
	pip install pywin32
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 770K · ⏱️ 07.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 57M / month):
	```
...
<details><summary><b><a href="https://github.com/mahmoud/boltons">boltons</a></b> (🥈29 ·  ⭐ 6.1K) - A set of pure-Python utilities. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 82 · 🔀 330 · 📥 23 · 📦 3K · 📋 140 - 32% open · ⏱️ 20.01.2023):

	```
	git clone https://github.com/mahmoud/boltons
	```
- [PyPi](https://pypi.org/project/boltons) (📥 3.2M / month):
	```
	pip install boltons
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 16 · 🔀 160 · 📦 130K · 📋 36 - 2% open · ⏱️ 24.01.2023):
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 440 · 🔀 4.1K · 📥 4.3K · 📦 41K · 📋 1.8K - 20% open · ⏱️ 21.12.2022):
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.4K · 📦 18K · 📋 820 - 73% open · ⏱️ 15.02.2020):
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 35 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 54 · 🔀 820 · 📦 1.5K · 📋 750 - 10% open · ⏱️ 15.09.2022):
...
- [PyPi](https://pypi.org/project/stanza) (📥 160K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 7.9K · ⏱️ 15.09.2022):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 250 · 📦 470 · 📋 69 - 27% open · ⏱️ 10.07.2021):

	```
	git clone https://github.com/PetrochukM/PyTorch-NLP
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 6.1K / month):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 940 · 📥 98K · 📦 240 · 📋 160 - 74% open · ⏱️ 08.06.2022):
...
- [PyPi](https://pypi.org/project/snownlp) (📥 5.8K / month):
	...
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 1.4K · ⏱️ 07.09.2021):
	```
	conda install -c conda-forge snownlp
	```
</details>
<details><summary><b><a href="https://github.com/aboSamoor/polyglot">polyglot</a></b> (🥉21 ·  ⭐ 2.1K · 💀) - Natural language pipeline supporting hundreds of languages. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 310 · 📦 850 · 📋 220 - 68% open · ⏱️ 22.09.2020):

	```
	git clone https://github.com/aboSamoor/polyglot
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 55K / month):
	```
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 290 · 📦 1.3K · 📋 71 - 35% open · ⏱️ 15.07.2017):
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉14 ·  ⭐ 47K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 11 · 🔀 11K · 📋 53 - 18% open · ⏱️ 17.11.2022):

	```
	git clone https://github.com/fighting41love/funNLP
	```
- [PyPi](https://pypi.org/project/funNLP) (📥 9 / month):
	```
	pip install funNLP
	```
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 1K · 📋 580 - 20% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/napalm-automation/napalm
	```
- [PyPi](https://pypi.org/project/napalm) (📥 46K / month):
	```
	pip install napalm
	```
...
<details><summary><b><a href="https://github.com/mininet/mininet">mininet</a></b> (🥉26 ·  ⭐ 4.7K) - A popular network emulator and API written in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 5 · 📦 930 · 📋 300 - 5% open · ⏱️ 19.12.2022):

	```
	git clone https://github.com/justquick/django-activity-stream
	```
- [PyPi](https://pypi.org/project/django-activity-stream) (📥 44K / month):
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 19K · ⏱️ 09.02.2023):
...
- [PyPi](https://pypi.org/project/peewee) (📥 1.3M / month):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 470K · ⏱️ 11.11.2022):
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 380 · 🔀 1.1K · 📦 19K · 📋 1.6K - 20% open · ⏱️ 28.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 960K / month):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 400 · 📦 1.2K · 📋 550 - 36% open · ⏱️ 29.01.2023):
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 2.8K · 📋 280 - 7% open · ⏱️ 30.01.2023):
...
- [PyPi](https://pypi.org/project/dataset) (📥 51K / month):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 4.5K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 32 · 🔀 160 · 📦 520 · 📋 320 - 42% open · ⏱️ 13.03.2022):
...
- [PyPi](https://pypi.org/project/orator) (📥 18K / month):
	...
	pip install orator
	```
- [Conda](https://anaconda.org/conda-forge/orator) (📥 2.4K · ⏱️ 18.03.2020):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 46 · 📦 3K · 📋 600 - 46% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/web2py/pydal) (🔀 130 · 📦 270 · 📋 310 - 44% open · ⏱️ 21.11.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 620 / month):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 430 · 🔀 1.9K · 📥 15M · 📋 4.7K - 11% open · ⏱️ 07.02.2023):
...
- [PyPi](https://pypi.org/project/poetry) (📥 12M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 760K · ⏱️ 11.01.2023):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 490 · 📋 900 - 12% open · ⏱️ 02.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 9.3M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 71K · ⏱️ 31.01.2023):
	```
	conda install -c conda-forge pip-tools
	```
</details>
<details><summary><b><a href="https://github.com/conda/conda">conda</a></b> (🥉15 ·  ⭐ 5.1K) - Cross-platform, Python-agnostic binary package manager. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/conda/conda) (🔀 1.2K · 📋 8.8K - 10% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 92 · 🔀 110 · 📦 200 · 📋 720 - 10% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 330 · 🔀 790 · 📋 2.9K - 14% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 4.9K · 📋 4.9K - 1% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 6.8K / month):
	```
	pip install sqlmap
	```
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉18 ·  ⭐ 8.5K · 💀) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 530 · 📦 5.3K · 📋 440 - 27% open · ⏱️ 25.03.2022):

	```
	git clone https://github.com/django-guardian/django-guardian
	```
- [PyPi](https://pypi.org/project/django-guardian) (📥 400K / month):
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 26 · 🔀 130 · 📦 1.1K · 📋 110 - 22% open · ⏱️ 11.01.2023):
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 86 · 🔀 460 · 📦 11K · 📋 430 - 3% open · ⏱️ 05.12.2022):
...
- [PyPi](https://pypi.org/project/sh) (📥 3.8M / month):
	...
	pip install sh
	```
- [Conda](https://anaconda.org/conda-forge/sh) (📥 150K · ⏱️ 28.11.2022):
	```
...
- [GitHub](https://github.com/amitt001/delegator.py) (👨‍💻 23 · 🔀 87 · 📋 45 - 17% open · ⏱️ 06.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/delegator.py) (📥 47K / month):
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 560 · 📥 310 · 📦 790 · 📋 440 - 16% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 400 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 3.4K / month):
	```
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 28 · 📋 130 - 28% open · ⏱️ 04.02.2020):

	```
	git clone https://github.com/jfkirk/tensorrec
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 1.8K / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 460 · 📦 100 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 560 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 78 · 🔀 140 · 📦 49K · 📋 290 - 26% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 660K / month):
	```
	pip install rope
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥇38 ·  ⭐ 54K · 📈) - A modern, fast, web framework for building APIs with Python 3.6+ based.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 410 · 🔀 4.4K · 📦 130K · 📋 3.3K - 27% open · ⏱️ 08.02.2023):
...
- [PyPi](https://pypi.org/project/fastapi) (📥 12M / month):
	...
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 1.3M · ⏱️ 08.02.2023):
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 880 · 📥 4.2K · 📦 7.6K · 📋 970 - 15% open · ⏱️ 18.01.2023):
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 980 · 📦 87K · 📋 550 - 17% open · ⏱️ 04.03.2022):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.4K · 📦 9.2K · 📋 1.3K - 4% open · ⏱️ 05.02.2023):
...
- [PyPi](https://pypi.org/project/sanic) (📥 940K / month):
	...
	pip install sanic
	```
- [Conda](https://anaconda.org/conda-forge/sanic) (📥 250K · ⏱️ 28.12.2022):
	```
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 1.9K · 📋 460 - 35% open · ⏱️ 10.08.2020):

	```
	git clone https://github.com/hugapi/hug
	```
- [PyPi](https://pypi.org/project/hug) (📥 66K / month):
	```
	pip install hug
	```
...
- [GitHub](https://github.com/Cornices/cornice) (👨‍💻 120 · 🔀 140 · 📦 780 · 📋 240 - 19% open · ⏱️ 18.07.2022):
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 210 · 📦 24 · 📋 84 - 38% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 340 / month):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.1K · 📋 310 - 4% open · ⏱️ 07.02.2023):
...
<details><summary><b><a href="https://github.com/sympy/sympy">SymPy</a></b> (🥇35 ·  ⭐ 10K) - A Python library for symbolic mathematics. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.7K · 📥 490K · 📦 52K · 📋 12K - 32% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 400 · 🔀 2.5K · 📥 26 · 📦 80K · 📋 5K - 47% open · ⏱️ 08.02.2023):
...
<details><summary><b><a href="https://github.com/quantopian/zipline">Zipline</a></b> (🥈29 ·  ⭐ 16K · 💀) - A Pythonic algorithmic trading library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4.1K · 📦 900 · 📋 980 - 33% open · ⏱️ 14.10.2020):

	```
	git clone https://github.com/quantopian/zipline
	```
- [PyPi](https://pypi.org/project/zipline) (📥 3K / month):
	```
	pip install zipline
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 440 · 🔀 1.7K · 📥 1.9K · 📦 1.1K · 📋 2.9K - 5% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 130 · 📋 99 - 1% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 96 · 🔀 340 · 📋 3K - 3% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 40 / month):
	```
...
<details><summary><b><a href="https://github.com/obspy/obspy">ObsPy</a></b> (🥉18 ·  ⭐ 990) - A Python toolbox for seismology. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/obspy/obspy) (🔀 490 · 📥 6.8K · 📋 1.7K - 9% open · ⏱️ 23.01.2023):
...
- [GitHub](https://github.com/chapmanb/bcbb) (👨‍💻 32 · 🔀 220 · 📦 250 · 📋 73 - 19% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 8.6K · 📋 1.2K - 36% open · ⏱️ 30.01.2023):
...
- [PyPi](https://pypi.org/project/django-haystack) (📥 130K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-haystack) (📥 5.1K · ⏱️ 31.05.2018):
	```
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 750 · 📥 160 · 📦 7.1K · 📋 1.3K - 9% open · ⏱️ 27.10.2022):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 590 · 📦 67K · 📋 1.2K - 11% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 46 · 📦 800 · 📋 80 - 15% open · ⏱️ 12.09.2022):
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 19 · 🔀 42 · 📦 3.3K · 📋 100 - 11% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/python-rapidjson/python-rapidjson
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 940K / month):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 85 · 🔀 330 · 📋 330 - 7% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 570 · 📥 8K · 📋 2.4K - 10% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 29K · 📋 240 - 11% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 55K · 📋 840 - 1% open · ⏱️ 03.02.2023):
...
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/XlsxWriter) (📥 2.4M · ⏱️ 03.02.2023):
	```
...
- [PyPi](https://pypi.org/project/csvkit) (📥 170K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 80K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 440 · 📥 24K · 📦 27K · 📋 1.7K - 15% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 87K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 540K · ⏱️ 05.02.2023):
	```
...
- [GitHub](https://github.com/pyexcel/pyexcel) (👨‍💻 20 · 🔀 160 · 📥 160 · 📦 2.9K · 📋 200 - 5% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/pyexcel) (📥 190K / month):
	...
	pip install pyexcel
	```
- [Conda](https://anaconda.org/conda-forge/pyexcel) (📥 53K · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 770 · 📦 240K · 📋 800 - 4% open · ⏱️ 09.01.2023):
...
- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 170 · 🔀 1K · 📋 660 - 10% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/mstamy2/PyPDF2
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 5.5M / month):
	```
	pip install PyPDF2
	```
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 840 · 📋 1K - 49% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 3.5M / month):
	```
...
- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 370 · 📦 110 · 📋 480 - 16% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 24K / month):
	```
	pip install unoconv
	```
...
- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 370 · 📋 760 - 46% open · ⏱️ 20.09.2021):
...
<details><summary><b><a href="https://github.com/mitsuhiko/unp">unp</a></b> (🥉9 ·  ⭐ 410 · 💀) - A command line tool that can unpack archives easily. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 56 · 📦 10 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 20 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 730 · 📦 6.5K · 📋 1.6K - 3% open · ⏱️ 30.01.2023):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.1K · 📦 31K · 📋 1.8K - 6% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 230 · 🔀 350 · 📦 460 · 📋 2.1K - 2% open · ⏱️ 03.02.2023):

	```
	git clone https://github.com/getnikola/nikola
	```
- [PyPi](https://pypi.org/project/nikola) (📥 880 / month):
	```
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 7.2K · ⏱️ 24.05.2022):
	```
...
- [PyPi](https://pypi.org/project/lektor) (📥 3.5K / month):
	...
	pip install lektor
	```
- [Conda](https://anaconda.org/conda-forge/lektor) (📥 59K · ⏱️ 22.09.2022):
	```
...
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇33 ·  ⭐ 8.7K) - Simple job queues for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 12K · 📋 1K - 12% open · ⏱️ 05.02.2023):
...
<details><summary><b><a href="https://github.com/coleifer/huey">huey</a></b> (🥈28 ·  ⭐ 4.4K) - Little multi-threaded task queue. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 350 · 📦 1.1K · ⏱️ 09.02.2023):
...
<details><summary><b><a href="https://github.com/Bogdanp/dramatiq">dramatiq</a></b> (🥉26 ·  ⭐ 3.4K) - A fast and reliable background task processing library for Python.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 86 · 🔀 240 · 📥 35 · 📦 600 · 📋 310 - 10% open · ⏱️ 05.02.2023):
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 40 · 🔀 110 · 📦 29 · 📋 170 - 30% open · ⏱️ 13.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrq) (📥 240 / month):
	```
	pip install mrq
	```
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇23 ·  ⭐ 9K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 940 - 5% open · ⏱️ 07.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/jinja) (📥 8.3K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 500 · 🔀 1.7K · 📦 100K · 📋 610 - 2% open · ⏱️ 07.02.2023):
...
- [PyPi](https://pypi.org/project/faker) (📥 7.5M / month):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 710K · ⏱️ 08.02.2023):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 170 · 🔀 2K · 📥 540 · 📦 6.8K · 📋 4K - 5% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 300 · 📥 85 · 📦 18K · 📋 250 - 1% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 9.4M / month):
	```
...
<details><summary><b><a href="https://github.com/HypothesisWorks/hypothesis">hypothesis</a></b> (🥈32 ·  ⭐ 6.5K) - Hypothesis is an advanced Quickcheck style property based.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 520 · 📦 16K · 📋 1.4K - 3% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 4.6M / month):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7.1M · ⏱️ 09.02.2023):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6K · 📋 510 - 8% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/cobrateam/splinter
	```
- [PyPi](https://pypi.org/project/splinter) (📥 99K / month):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 990 · 📦 20K · 📋 610 - 64% open · ⏱️ 14.09.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 590K / month):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 380 · 📦 1.1K · 📋 310 - 0% open · ⏱️ 27.01.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 100K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 78K · ⏱️ 18.12.2022):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 120 · 🔀 310 · 📦 4.7K · 📋 340 - 24% open · ⏱️ 01.11.2022):
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.5K · 📋 1.4K - 0% open · ⏱️ 29.01.2023):
...
- [PyPi](https://pypi.org/project/locust) (📥 1.3M / month):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 98K · ⏱️ 06.01.2023):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 250 · 📦 7.6K · 📋 240 - 39% open · ⏱️ 16.10.2022):
...
- [PyPi](https://pypi.org/project/HTTPretty) (📥 470K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/HTTPretty) (📥 270K · ⏱️ 16.08.2021):
	```
	conda install -c conda-forge HTTPretty
	```
</details>
<details><summary><b><a href="https://github.com/schemathesis/schemathesis">Schemathesis</a></b> (🥉27 ·  ⭐ 1.6K) - A tool for automatic property-based testing of web applications.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 51 · 🔀 120 · 📦 150 · 📋 690 - 16% open · ⏱️ 08.02.2023):
...
- [PyPi](https://pypi.org/project/schemathesis) (📥 60K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 3.2K · ⏱️ 08.02.2023):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 240 · 📋 270 - 36% open · ⏱️ 09.02.2023):
...
- [PyPi](https://pypi.org/project/freezegun) (📥 6.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 690K · ⏱️ 12.08.2022):
	```
...
<details><summary><b><a href="https://github.com/nose-devs/nose2">nose2</a></b> (🥉23 ·  ⭐ 740) - The successor to `nose`, based on `unittest2`. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 6.4K · 📋 260 - 19% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/nose-devs/nose2
	```
- [PyPi](https://pypi.org/project/nose2) (📥 550K / month):
	```
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 83K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 190 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 60 / month):
	```
	pip install sixpack
	```
...
<details><summary><b><a href="https://github.com/CleanCut/green">green</a></b> (🥉20 ·  ⭐ 760) - A clean, colorful test runner. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/CleanCut/green) (👨‍💻 38 · 🔀 72 · 📦 770 · 📋 180 - 2% open · ⏱️ 20.09.2022):

	```
	git clone https://github.com/CleanCut/green
	```
- [PyPi](https://pypi.org/project/green) (📥 13K / month):
	```
	pip install green
	```
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 48 · 📦 1.9K · 📋 26 - 42% open · ⏱️ 28.10.2020):

	```
	git clone https://github.com/patrys/httmock
	```
- [PyPi](https://pypi.org/project/httmock) (📥 410K / month):
	```
	pip install httmock
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 24 · 🔀 39 · 📦 74 · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 78K / month):
	```
...
<details><summary><b><a href="https://github.com/klen/mixer">mixer</a></b> (🥉17 ·  ⭐ 870 · 💤) - Another fixtures replacement. Supports Django, Flask,.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 600 · 📦 670K · 📋 490 - 42% open · ⏱️ 05.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/sqlparse) (📥 35M / month):
	```
	pip install sqlparse
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 1.4M · ⏱️ 24.09.2022):
	```
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 53 · 🔀 230 · 📥 7.6K · 📦 720K · 📋 280 - 13% open · ⏱️ 23.01.2023):
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📦 17K · 📋 180 - 44% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 6.6M / month):
	```
	pip install fuzzywuzzy
	```
- [Conda](https://anaconda.org/conda-forge/fuzzywuzzy) (📥 430K · ⏱️ 18.11.2020):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 33 · 🔀 110 · 📦 15K · ⏱️ 14.01.2023):
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 100 · 📦 26K · 📋 48 - 27% open · ⏱️ 16.09.2022):
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 48 · 🔀 240 · 📋 130 - 36% open · ⏱️ 02.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/chardet) (📥 61M / month):
	```
	pip install chardet
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 32 · 🔀 92 · 📋 64 - 3% open · ⏱️ 27.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-slugify) (📥 12M / month):
	```
...
- [PyPi](https://pypi.org/project/ply) (📥 21M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 3.2M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 31 · 🔀 190 · 📦 5.4K · 📋 72 - 56% open · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 240 - 10% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 22 / month):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 8.8K · 📋 130 - 9% open · ⏱️ 25.10.2022):
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 46 · 📦 2.1K · 📋 18 - 55% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 42K / month):
	```
...
- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 22 · 🔀 92 · 📦 1K · 📋 100 - 20% open · ⏱️ 14.11.2022):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 27 · 🔀 370 · 📋 160 - 3% open · ⏱️ 29.01.2023):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.6K · 📦 250K · 📋 2.9K - 4% open · ⏱️ 08.02.2023):
...
- [PyPi](https://pypi.org/project/boto3) (📥 550M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 14M · ⏱️ 08.02.2023):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 130K · 📋 960 - 8% open · ⏱️ 08.02.2023):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 43M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 1.9M · ⏱️ 07.02.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 860 · 📥 240 · 📦 21K · 📋 780 - 6% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 8.9M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 390 · 📦 5.7K · 📋 330 - 6% open · ⏱️ 16.07.2021):
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 920 · 📦 3.9K · 📋 240 - 8% open · ⏱️ 27.12.2020):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.6K · 📋 280 - 2% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 59 · 📦 7.7K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 68K / month):
	```
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 35 · 📦 2.1K · 📋 20 - 25% open · ⏱️ 15.05.2021):

	```
	git clone https://github.com/codeinthehole/purl
	```
- [PyPi](https://pypi.org/project/purl) (📥 53K / month):
	```
	pip install purl
	```
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 15 · 🔀 140 · 📋 110 - 26% open · ⏱️ 01.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 3.2M / month):
	```
	pip install furl
	```
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥇24 ·  ⭐ 2.6K) - Most Powerful multi-threaded Video Processing framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 210 · 📥 730 · 📦 280 · 📋 250 - 1% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/abhiTronix/vidgear
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 4.7K / month):
	```
	pip install vidgear
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.1K · 📋 440 - 27% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/jazzband/django-pipeline
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 91K / month):
	```
...
- [PyPi](https://pypi.org/project/webassets) (📥 250K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/webassets) (📥 52K · ⏱️ 24.12.2019):
	```
...
- [GitHub](https://github.com/miracle2k/flask-assets) (👨‍💻 38 · 🔀 86 · 📦 6.8K · 📋 97 - 21% open · ⏱️ 29.02.2020):
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 240 · 🔀 750 · 📋 610 - 26% open · ⏱️ 01.01.2023):
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 210 · 🔀 540 · 📋 630 - 16% open · ⏱️ 22.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-compressor) (📥 480K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 870 · 📦 9.7K · 📋 370 - 44% open · ⏱️ 10.05.2020):

	```
	git clone https://github.com/psf/requests-html
	```
- [PyPi](https://pypi.org/project/requests-html) (📥 890K / month):
	```
	pip install requests-html
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 5K · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 25 · 🔀 480 · 📦 1.6K · 📋 110 - 15% open · ⏱️ 04.02.2023):

	```
	git clone https://github.com/miso-belica/sumy
	```
- [PyPi](https://pypi.org/project/sumy) (📥 28K / month):
	```
	pip install sumy
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 900 · ⏱️ 14.12.2022):

	```
	git clone https://github.com/coleifer/micawber
	```
- [PyPi](https://pypi.org/project/micawber) (📥 45K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 7.8K · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/michaelhelmick/lassie) (👨‍💻 15 · 🔀 47 · 📦 34 · 📋 39 - 25% open · ⏱️ 20.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/lassie) (📥 1.7K / month):
	```
	pip install lassie
	```
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 51 · 🔀 1.4K · 📥 210 · 📦 45 · 📋 450 - 25% open · ⏱️ 10.07.2019):
...
<details><summary><b><a href="https://github.com/MechanicalSoup/MechanicalSoup">MechanicalSoup</a></b> (🥈22 ·  ⭐ 4.3K) - A Python library for automating interaction with websites. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 53 · 🔀 360 · 📥 43 · 📋 160 - 15% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 59K / month):
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 880 · 📋 74 - 59% open · ⏱️ 07.06.2015):
...
- [PyPi](https://pypi.org/project/robobrowser) (📥 16K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robobrowser) (📥 4.8K · ⏱️ 23.03.2018):
	```
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 3 · 🔀 530 · 📦 16 · 📋 65 - 20% open · ⏱️ 01.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/cola) (📥 71 / month):
	```
	pip install cola
	```
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 83 · 🔀 120 · 📦 460 · 📋 380 - 5% open · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/masonite) (📥 2.9K / month):
	```
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 63 · 🔀 450 · 📦 85K · 📋 960 - 1% open · ⏱️ 18.01.2023):
...
- [PyPi](https://pypi.org/project/websockets) (📥 15M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 1.7M · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 130 · 🔀 730 · 📦 23K · 📋 880 - 20% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 730 · 📋 1.2K - 5% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/django/channels
	```
- [PyPi](https://pypi.org/project/channels) (📥 620K / month):
	```
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 850K · 📋 1.9K - 18% open · ⏱️ 26.01.2023):
...
<details><summary><b><a href="https://github.com/pallets/werkzeug">werkzeug</a></b> (🥈35 ·  ⭐ 6.3K) - A WSGI utility library for Python that powers Flask and can easily be.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 250 · 📦 920K · 📋 1K - 0% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 85M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 6.8M · ⏱️ 09.08.2022):
	```
	conda install -c conda-forge werkzeug
	```
</details>
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉27 ·  ⭐ 1.2K) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 50 · 🔀 150 · 📦 100K · 📋 210 - 6% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/Pylons/waitress
	```
- [PyPi](https://pypi.org/project/waitress) (📥 3.2M / month):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 540 · 📋 160 - 15% open · ⏱️ 11.09.2022):

	```
	git clone https://github.com/jonashaag/bjoern
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 21K / month):
	```
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 96K · ⏱️ 02.11.2022):
	```
