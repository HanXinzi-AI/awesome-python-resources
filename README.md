...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 320 · 🔀 1.3K · 📦 12K · 📋 1.2K - 25% open · ⏱️ 17.04.2021):
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 180 · 🔀 800 · 📦 6.1K · 📋 770 - 6% open · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 740 · 📋 560 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 900 / month):
	```
	pip install xadmin
	```
...
<details><summary><b><a href="https://github.com/jet-admin/jet-bridge">jet-bridge</a></b> (🥉15 ·  ⭐ 970) - Admin panel framework for any application with nice UI (ex Jet Django). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 720 · 🔀 30K · 📋 690 - 1% open · ⏱️ 24.06.2021):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 31M · ⏱️ 22.06.2021):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 66 · 🔀 430 · 📦 1.7K · 📋 370 - 2% open · ⏱️ 31.05.2021):
...
- [PyPi](https://pypi.org/project/algorithms) (📥 1.4K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 120 · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 100 · 🔀 430 · 📋 83 - 21% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 110 · 🔀 320 · 📦 27K · 📋 480 - 9% open · ⏱️ 23.06.2021):
...
- [PyPi](https://pypi.org/project/uvicorn) (📥 2.4M / month):
	...
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 470K · ⏱️ 01.06.2021):
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 57 · 🔀 180 · 📦 9.9K · 📋 260 - 13% open · ⏱️ 16.04.2021):
...
- [PyPi](https://pypi.org/project/daphne) (📥 360K / month):
	...
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 48K · ⏱️ 07.04.2021):
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 240 · 📦 1K · 📋 640 - 39% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 95K / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 430K · ⏱️ 15.06.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 460 · 🔀 1.6K · 📥 6.6K · 📦 210 · 📋 2.4K - 19% open · ⏱️ 18.06.2021):
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 34 · 🔀 100 · 📥 45K · 📦 4.8K · 📋 440 - 16% open · ⏱️ 14.03.2021):
...
- [PyPi](https://pypi.org/project/mutagen) (📥 370K / month):
	...
	pip install mutagen
	```
- [Conda](https://anaconda.org/conda-forge/mutagen) (📥 94K · ⏱️ 30.05.2021):
	```
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 22 · 🔀 43 · 📥 2K · 📦 1.4K · 📋 160 - 24% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/nicfit/eyeD3
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 42K / month):
	```
	pip install eyeD3
	```
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.2K · 📦 18 · 📋 200 - 34% open · ⏱️ 03.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 75 / month):
	```
	pip install dejavu
	```
...
- [GitHub](https://github.com/Parisson/TimeSide) (👨‍💻 19 · 🔀 51 · 📦 14 · 📋 200 - 26% open · ⏱️ 20.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 250 / month):
	```
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 54 · 📦 3 · 📋 27 - 33% open · ⏱️ 03.06.2021):
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 180 · 🔀 410 · 📦 150K · 📋 330 - 20% open · ⏱️ 01.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 51M / month):
	```
	pip install oauthlib
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 2.7M · ⏱️ 01.06.2021):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 540 · 🔀 2.2K · 📦 67K · 📋 1.7K - 17% open · ⏱️ 05.06.2021):
...
- [PyPi](https://pypi.org/project/django-allauth) (📥 520K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 62K · ⏱️ 23.12.2019):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 64 · 🔀 250 · 📦 14K · 📋 260 - 9% open · ⏱️ 19.06.2021):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 2.2M / month):
	```
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 56K · ⏱️ 05.06.2021):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 180 · 🔀 580 · 📋 620 - 25% open · ⏱️ 25.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-oauth-toolkit) (📥 310K / month):
	```
...
<details><summary><b><a href="https://github.com/mpdavis/python-jose">python-jose</a></b> (🥉23 ·  ⭐ 890) - A JOSE implementation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mpdavis/python-jose) (🔀 170 · 📦 7.2K · 📋 110 - 37% open · ⏱️ 07.06.2021):
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 18K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 7.1K · ⏱️ 11.02.2019):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 48 · 🔀 540 · 📋 3.5K - 5% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 100 · 🔀 260 · 📦 250K · 📋 480 - 21% open · ⏱️ 14.06.2021):
...
- [PyPi](https://pypi.org/project/attrs) (📥 56M / month):
	...
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 9M · ⏱️ 07.05.2021):
	```
	conda install -c conda-forge attrs
	```
</details>
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥈24 ·  ⭐ 850) - Efficient, Pythonic bidirectional map data structures and related.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/jab/bidict) (👨‍💻 11 · 🔀 41 · 📦 3.3K · 📋 44 - 2% open · ⏱️ 15.06.2021):
...
- [PyPi](https://pypi.org/project/bidict) (📥 560K / month):
	...
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 92K · ⏱️ 07.09.2020):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 110 · 🔀 290 · 📥 2.8K · 📋 3.1K - 21% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 530 / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 130 · 🔀 210 · 📋 440 - 8% open · ⏱️ 25.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 3K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 48 · 🔀 110 · 📦 3.5K · 📋 180 - 11% open · ⏱️ 22.01.2021):
...
- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 85 · 🔀 130 · 📦 2.9K · 📋 110 - 54% open · ⏱️ 08.10.2020):
...
- [GitHub](https://github.com/errbotio/errbot) (🔀 520 · 📦 210 · 📋 740 - 10% open · ⏱️ 22.06.2021):
...
🔗&nbsp;<b><a href="https://github.com/typeddjango/awesome-python-typing">awesome-python-typing</a></b> ( ⭐ 790)  - Collection of awesome Python types, stubs, plugins, and tools to..
...
- [GitHub](https://github.com/psf/black) (👨‍💻 260 · 🔀 1.3K · 📥 14K · 📦 64K · 📋 1.6K - 17% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 240 · 🔀 400 · 📦 180K · 📋 970 - 2% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 780 · 📦 21K · 📋 690 - 45% open · ⏱️ 30.05.2021):
...
- [PyPi](https://pypi.org/project/yapf) (📥 1.7M / month):
	...
	pip install yapf
	```
- [Conda](https://anaconda.org/conda-forge/yapf) (📥 680K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 140 · 🔀 280 · 📦 390 · 📋 950 - 8% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 77K / month):
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 28 · 🔀 81 · 📦 980 · 📋 140 - 7% open · ⏱️ 04.06.2021):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 160 · 🔀 320 · 📋 250 - 22% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 67 · 🔀 120 · 📦 2.3K · 📋 260 - 18% open · ⏱️ 21.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 440K / month):
	```
...
- [PyPi](https://pypi.org/project/pylama) (📥 91K / month):
	...
	pip install pylama
	```
- [Conda](https://anaconda.org/conda-forge/pylama) (📥 58K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 63 · 🔀 180 · 📋 420 - 23% open · ⏱️ 23.06.2021):
...
- [PyPi](https://pypi.org/project/pytype) (📥 110K / month):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 50K · ⏱️ 13.10.2020):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 120 · 📦 120 · 📋 140 - 21% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 40K / month):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 16 · 🔀 45 · 📦 62 · 📋 59 - 44% open · ⏱️ 19.03.2021):
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 920 · 🔀 1K · 📋 1.3K - 9% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 5 · 🔀 140 · 📦 5 · ⏱️ 24.06.2021):

	```
	git clone https://github.com/scottrogowski/code2flow
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 87 / month):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 100 · 🔀 930 · 📥 7.9K · 📦 180K · 📋 760 - 32% open · ⏱️ 12.06.2021):
...
- [PyPi](https://pypi.org/project/tqdm) (📥 25M / month):
	...
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 6.6M · ⏱️ 12.06.2021):
	```
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 95 · 🔀 800 · 📦 4.8K · 📋 460 - 1% open · ⏱️ 18.06.2021):
...
- [PyPi](https://pypi.org/project/rich) (📥 1.8M / month):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 260K · ⏱️ 18.06.2021):
	```
	conda install -c conda-forge rich
	```
</details>
<details><summary><b><a href="https://github.com/google/python-fire">python-fire</a></b> (🥈27 ·  ⭐ 20K) - A library for creating command line interfaces from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.1K · 📦 7.9K · 📋 230 - 38% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 35 · 🔀 200 · 📦 490 · 📋 250 - 7% open · ⏱️ 23.06.2021):
...
- [PyPi](https://pypi.org/project/asciimatics) (📥 10K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/asciimatics) (📥 69K · ⏱️ 09.04.2021):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 180 · 🔀 540 · 📦 160K · 📋 870 - 44% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/rsalmei/alive-progress) (🔀 100 · 📦 320 · 📋 66 - 25% open · ⏱️ 08.01.2021):
...
- [PyPi](https://pypi.org/project/alive-progress) (📥 15K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 7.8K · ⏱️ 08.01.2021):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 170 · 🔀 2.8K · 📦 280 · 📋 600 - 34% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 160 · 🔀 430 · 📦 300 · 📋 600 - 20% open · ⏱️ 21.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 27K / month):
	```
	pip install pgcli
	```
...
- [PyPi](https://pypi.org/project/mycli) (📥 27K / month):
	...
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 16K · ⏱️ 04.03.2021):
	```
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 68 · 🔀 780 · 📦 330 · 📋 220 - 7% open · ⏱️ 21.06.2021):

	```
	git clone https://github.com/gleitz/howdoi
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 4.3K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 59 · 🔀 190 · 📋 270 - 18% open · ⏱️ 20.06.2021):
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 19 · 🔀 43 · 📦 100 · 📋 66 - 27% open · ⏱️ 16.05.2021):
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 250 · 📦 35 · 📋 91 - 32% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 21 · 🔀 63 · 📥 3.9K · 📋 180 - 31% open · ⏱️ 04.06.2021):

	```
	git clone https://github.com/laixintao/iredis
	```
- [PyPi](https://pypi.org/project/iredis) (📥 850 / month):
	```
	pip install iredis
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥉18 ·  ⭐ 360) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 15 · 🔀 29 · 📋 190 - 18% open · ⏱️ 11.06.2021):
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 40 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 500K / month):
	```
...
<details><summary><b><a href="https://github.com/JaidedAI/EasyOCR">EasyOCR</a></b> (🥇30 ·  ⭐ 12K) - Ready-to-use OCR with 40+ languages supported. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/sirfz/tesserocr">tesserocr</a></b> (🥈27 ·  ⭐ 1.5K · 📈) - Another simple, Pillow-friendly, wrapper around the `tesseract-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/face_recognition) (📥 71K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/face_recognition) (📥 2.1K · ⏱️ 30.04.2021):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉20 ·  ⭐ 4.2K) - Open Source Differentiable Computer Vision Library for PyTorch. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 400 · 📥 36 · 📦 450 · 📋 400 - 20% open · ⏱️ 24.06.2021):
...
- [PyPi](https://pypi.org/project/python-decouple) (📥 410K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 23K · ⏱️ 05.01.2021):
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉24 ·  ⭐ 4.4K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 75 · 🔀 330 · 📋 790 - 6% open · ⏱️ 23.06.2021):
...
- [PyPi](https://pypi.org/project/hydra) (📥 8.3K / month):
	...
	pip install hydra
	```
- [Conda](https://anaconda.org/conda-forge/hydra) (📥 6.7K · ⏱️ 18.01.2021):
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 160 · 🔀 1.6K · 📦 44K · 📋 1.2K - 52% open · ⏱️ 06.06.2021):
...
- [PyPi](https://pypi.org/project/paramiko) (📥 15M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 1M · ⏱️ 01.09.2020):
	```
...
<details><summary><b><a href="https://github.com/hi-primus/optimus">Optimus</a></b> (🥈22 ·  ⭐ 1K · 📉) - Agile Data Science Workflows made easy with PySpark. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/awslabs/aws-data-wrangler) (👨‍💻 73 · 🔀 290 · 📥 46K · 📋 420 - 4% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/Julian/jsonschema) (👨‍💻 85 · 🔀 450 · 📦 160K · 📋 580 - 10% open · ⏱️ 24.06.2021):
...
- [PyPi](https://pypi.org/project/jsonschema) (📥 26M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 6.7M · ⏱️ 04.03.2021):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 62 · 🔀 210 · 📦 9.6K · 📋 320 - 10% open · ⏱️ 05.05.2021):
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 61 · 🔀 160 · 📦 2.9K · 📋 120 - 48% open · ⏱️ 12.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/schema) (📥 990K / month):
	```
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 29K · ⏱️ 01.02.2021):
	```
...
- [GitHub](https://github.com/schematics/schematics) (👨‍💻 110 · 🔀 280 · 📦 960 · 📋 320 - 29% open · ⏱️ 22.12.2018):
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 94 · 🔀 280 · 📦 1.7K · 📋 930 - 27% open · ⏱️ 11.06.2021):
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 88 · 🔀 780 · 📋 280 - 54% open · ⏱️ 23.05.2021):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 48K / month):
	```
	pip install diagrams
	```
- [Conda](https://anaconda.org/conda-forge/diagrams) (📥 75K · ⏱️ 25.05.2021):
	```
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 65 · 📦 730 · 📋 140 - 37% open · ⏱️ 03.05.2021):
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 200 · 🔀 1.1K · 📥 1.7K · 📦 7.1K · 📋 1.3K - 12% open · ⏱️ 22.02.2021):
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 31 · 🔀 150 · 📦 5.9K · ⏱️ 07.06.2021):

	```
	git clone https://github.com/mongodb/motor
	```
- [PyPi](https://pypi.org/project/motor) (📥 3.1M / month):
	```
	pip install motor
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 180 · 🔀 890 · 📦 100K · ⏱️ 23.06.2021):
...
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥉22 ·  ⭐ 630) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 31 · 🔀 110 · 📦 320 · 📋 170 - 16% open · ⏱️ 09.06.2021):

	```
	git clone https://github.com/mymarilyn/clickhouse-driver
	```
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 250K / month):
	```
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 150 · 📦 500 · 📋 200 - 10% open · ⏱️ 08.02.2021):

	```
	git clone https://github.com/wbolster/happybase
	```
- [PyPi](https://pypi.org/project/happybase) (📥 73K / month):
	```
	pip install happybase
	```
- [Conda](https://anaconda.org/conda-forge/happybase) (📥 60K · ⏱️ 01.07.2019):
	```
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 11 · 🔀 28 · 📦 92 · 📋 18 - 27% open · ⏱️ 07.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 1.7K / month):
	```
	pip install queries
	```
...
- [PyPi](https://pypi.org/project/maya) (📥 48K / month):
	...
	pip install maya
	```
- [Conda](https://anaconda.org/conda-forge/maya) (📥 40K · ⏱️ 07.01.2019):
	```
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 66 · 🔀 240 · 📋 390 - 42% open · ⏱️ 11.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 4.3M / month):
	```
	pip install pendulum
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 350K · ⏱️ 08.11.2020):
	```
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 36 · 📦 530 · 📋 33 - 9% open · ⏱️ 27.11.2020):

	```
	git clone https://github.com/zachwill/moment
	```
- [PyPi](https://pypi.org/project/moment) (📥 46K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 12 · 📦 16 · 📋 9 - 44% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 230 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 5 · 🔀 16 · 📦 14 · ⏱️ 17.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 6K / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 26 · 🔀 240 · 📥 5.4K · 📦 900 · 📋 210 - 28% open · ⏱️ 09.06.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 680K / month):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 6.4K · ⏱️ 17.05.2021):
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 240 · 🔀 800 · 📥 160 · 📦 40K · 📋 760 - 10% open · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 48 · 🔀 120 · 📦 27K · 📋 160 - 31% open · ⏱️ 02.06.2021):
...
- [PyPi](https://pypi.org/project/ipdb) (📥 1.6M / month):
	...
	pip install ipdb
	```
- [Conda](https://anaconda.org/conda-forge/ipdb) (📥 170K · ⏱️ 24.06.2021):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 75 · 🔀 380 · 📦 2.2K · 📋 160 - 30% open · ⏱️ 27.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 630K / month):
	```
...
- [PyPi](https://pypi.org/project/flask-debugtoolbar) (📥 92K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-debugtoolbar) (📥 43K · ⏱️ 30.05.2021):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 77 · 🔀 170 · 📦 2.4K · 📋 260 - 48% open · ⏱️ 08.06.2021):
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥈22 ·  ⭐ 4.9K) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gruns/icecream) (👨‍💻 14 · 🔀 96 · 📋 65 - 21% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 62K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 310 · ⏱️ 23.06.2021):
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 99 · 📦 93 · 📋 110 - 26% open · ⏱️ 16.09.2019):
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 39 · 🔀 42 · 📦 2.1K · 📋 170 - 34% open · ⏱️ 30.04.2021):
...
<details><summary><b><a href="https://github.com/ionelmc/python-hunter">python-hunter</a></b> (🥉19 ·  ⭐ 620) - A flexible code tracing toolkit. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 8 · 🔀 31 · 📦 63 · 📋 80 - 42% open · ⏱️ 23.06.2021):
...
<details><summary><b><a href="https://github.com/fabianp/memory_profiler">memory_profiler</a></b> (🥉16 ·  ⭐ 63 · 💀) - Monitor Memory usage of Python code. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 61 · 🔀 12 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 480K / month):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 68 · 📦 2 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 57 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 35 · 📦 2 · 📋 11 - 45% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 230 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 2.7K · 🔀 13K · 📦 83K · 📋 21K - 30% open · ⏱️ 24.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 39K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 140K · ⏱️ 22.04.2021):
	```
...
<details><summary><b><a href="https://github.com/keras-team/keras">keras</a></b> (🥉27 ·  ⭐ 52K) - A high-level neural networks library and capable of running on top.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 160 · 🔀 1.1K · 📦 91K · 📋 1.4K - 10% open · ⏱️ 06.06.2021):
...
- [PyPi](https://pypi.org/project/psutil) (📥 23M / month):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 7.1M · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.4K · 🔀 20K · 📦 17K · 📋 29K - 3% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.7K · 🔀 4.9K · 📥 15K · 📋 24K - 8% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 160 · 🔀 1.1K · 📦 6K · 📋 1K - 10% open · ⏱️ 04.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/supervisor) (📥 950K / month):
	```
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 18 · 🔀 1.7K · 📋 1.6K - 23% open · ⏱️ 06.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/fabric) (📥 980K / month):
	```
	pip install fabric
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 200 · 📦 270 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools) (📥 3.3K / month):
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 50 · 🔀 110 · 📦 26 · 📋 440 - 11% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 5.1K / month):
	```
	pip install pyinfra
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 2.7K · 📦 2.3K · 📋 6.9K - 21% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 400 · 🔀 1.5K · 📥 710K · 📦 18K · 📋 4.2K - 7% open · ⏱️ 17.06.2021):
...
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈24 ·  ⭐ 990) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 14 · 🔀 130 · 📥 18 · 📦 220 · 📋 510 - 1% open · ⏱️ 21.06.2021):
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 33 · 🔀 68 · 📥 140 · 📋 82 - 28% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 8K / month):
	```
	pip install shiv
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.4K · 📦 150K · 📋 5.4K - 13% open · ⏱️ 20.06.2021):
...
<details><summary><b><a href="https://github.com/mitmproxy/pdoc">pdoc</a></b> (🥉21 ·  ⭐ 950) - Epydoc replacement to auto generate API documentation for Python.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 30 · 🔀 100 · 📦 330 · 📋 170 - 2% open · ⏱️ 16.06.2021):
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 130 · 📦 220 · 📋 55 - 49% open · ⏱️ 20.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pycco) (📥 3.4K / month):
	```
	pip install pycco
	```
...
<details><summary><b><a href="https://github.com/jindaxiang/akshare">akshare</a></b> (🥇26 ·  ⭐ 3.7K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jindaxiang/akshare) (👨‍💻 15 · 🔀 750 · 📦 85 · 📋 230 - 0% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 9.7K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 860 · 📦 190 · 📋 370 - 22% open · ⏱️ 28.02.2021):
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 19 · 🔀 140 · 📦 790 · 📋 50 - 24% open · ⏱️ 08.06.2021):
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 95 · 📦 90 · 📋 14 - 14% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 430 / month):
	```
	pip install alipay
	```
...
- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 13 · 📥 5 · 📦 20 · 📋 5 - 40% open · ⏱️ 22.12.2020):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 220 · 🔀 1.2K · 📥 610K · 📦 19K · 📋 13K - 8% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 76 · 🔀 220 · 📦 200 · 📋 1.5K - 22% open · ⏱️ 21.06.2021):
...
- [GitHub](https://github.com/DamnWidget/anaconda) (👨‍💻 87 · 🔀 240 · 📋 760 - 20% open · ⏱️ 20.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/anaconda) (📥 82K / month):
	```
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 73 · 🔀 640 · 📥 31K · 📋 3.9K - 16% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 26 · 🔀 230 · 📦 1.4K · 📋 180 - 43% open · ⏱️ 10.05.2021):
...
- [PyPi](https://pypi.org/project/yagmail) (📥 130K / month):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 5.8K · ⏱️ 12.05.2021):
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 46 · 🔀 150 · 📦 98 · 📋 110 - 43% open · ⏱️ 17.09.2020):

	```
	git clone https://github.com/martinrusev/imbox
	```
- [PyPi](https://pypi.org/project/imbox) (📥 5.3K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 330 · 🔀 2K · 📋 1.3K - 1% open · ⏱️ 19.06.2021):
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 50 · 🔀 840 · 📋 1.1K - 5% open · ⏱️ 21.06.2021):
...
- [PyPi](https://pypi.org/project/virtualenv) (📥 19M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 950K · ⏱️ 24.05.2021):
	```
...
<details><summary><b><a href="https://github.com/gorakhargosh/watchdog">watchdog</a></b> (🥇32 ·  ⭐ 4.8K) - API and shell utilities to monitor file system events. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 110 · 🔀 560 · 📦 36K · 📋 520 - 26% open · ⏱️ 19.05.2021):
...
- [PyPi](https://pypi.org/project/watchdog) (📥 3.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 560K · ⏱️ 19.05.2021):
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 36 · 📦 5.5K · 📋 17 - 41% open · ⏱️ 14.02.2015):
...
- [GitHub](https://github.com/PyFilesystem/pyfilesystem2) (👨‍💻 40 · 🔀 130 · 📋 300 - 17% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 130 · 🔀 340 · 📦 98K · 📋 370 - 10% open · ⏱️ 19.05.2021):
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 650 · 📦 66K · 📋 620 - 9% open · ⏱️ 11.06.2021):
...
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 530K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 38K · ⏱️ 11.06.2021):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 97 · 🔀 680 · 📦 15K · 📋 290 - 1% open · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 150 · 📦 690 · 📋 180 - 24% open · ⏱️ 12.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 8K / month):
	```
	pip install deform
	```
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 83 · 📦 17 · 📋 14 - 71% open · ⏱️ 12.07.2017):
...
- [PyPi](https://pypi.org/project/more-itertools) (📥 14M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 6.2M · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 69 · 🔀 200 · 📦 42K · 📋 200 - 35% open · ⏱️ 22.04.2021):
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 26 · 🔀 120 · 📦 3.1K · 📋 61 - 3% open · ⏱️ 10.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/funcy) (📥 490K / month):
	```
	pip install funcy
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 30 · 🔀 67 · 📦 80 · 📋 360 - 12% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 46K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 100 · ⏱️ 14.05.2021):
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 27 · 🔀 98 · 📋 490 - 14% open · ⏱️ 06.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/coconut) (📥 610 / month):
	```
	pip install coconut
	```
- [Conda](https://anaconda.org/conda-forge/coconut) (📥 98K · ⏱️ 06.03.2021):
	```
...
- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 59 · 📦 28K · 📋 59 - 32% open · ⏱️ 13.01.2021):
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇31 ·  ⭐ 840) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 110 · 🔀 150 · 📦 12K · 📋 240 - 18% open · ⏱️ 10.06.2021):

	```
	git clone https://github.com/pyglet/pyglet
	```
- [PyPi](https://pypi.org/project/pyglet) (📥 520K / month):
	```
	pip install pyglet
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 99 · 🔀 720 · 📥 90 · 📦 370 · 📋 460 - 15% open · ⏱️ 12.06.2021):
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.1K · 📦 2.8K · 📋 2.2K - 31% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 78K / month):
	```
	pip install PySimpleGUI
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 32K · ⏱️ 21.06.2021):
	```
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 240 · 📦 89 · 📋 420 - 18% open · ⏱️ 02.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 740 / month):
	```
	pip install flexx
	```
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 240 · 📦 140 · 📋 510 - 10% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 320 · 📦 450 · 📋 520 - 5% open · ⏱️ 20.05.2021):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 190 · 🔀 480 · 📋 480 - 24% open · ⏱️ 20.06.2021):
...
- [GitHub](https://github.com/graphql-python/graphene) (🔀 690 · 📦 9.3K · 📋 890 - 9% open · ⏱️ 23.04.2021):
...
<details><summary><b><a href="https://github.com/SmileyChris/django-countries">django-countries</a></b> (🥈21 ·  ⭐ 1K) - A Django app that provides a country field for models and forms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 45 · 🔀 210 · 📋 230 - 3% open · ⏱️ 11.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 450K / month):
	```
...
- [GitHub](https://github.com/maxmind/geoip-api-python) (👨‍💻 13 · 🔀 53 · 📦 810 · ⏱️ 11.02.2021):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 34 · 🔀 97 · 📦 610K · 📋 74 - 1% open · ⏱️ 02.06.2021):

	```
	git clone https://github.com/pallets/markupsafe
	```
- [PyPi](https://pypi.org/project/markupsafe) (📥 66M / month):
	```
...
- [PyPi](https://pypi.org/project/bleach) (📥 13M / month):
	...
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 4.4M · ⏱️ 01.02.2021):
	```
...
- [GitHub](https://github.com/stchris/untangle) (👨‍💻 13 · 🔀 74 · 📥 520 · 📦 680 · 📋 44 - 40% open · ⏱️ 07.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/untangle) (📥 100K / month):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 280 · 🔀 820 · 📥 310 · 📦 580K · 📋 930 - 15% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/shazow/urllib3
	```
- [PyPi](https://pypi.org/project/urllib3) (📥 160M / month):
	```
	pip install urllib3
	```
...
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈32 ·  ⭐ 7.1K) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 130 · 🔀 460 · 📦 7.6K · 📋 600 - 6% open · ⏱️ 24.06.2021):
...
- [PyPi](https://pypi.org/project/httpx) (📥 4.1M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 60K · ⏱️ 18.05.2021):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 65 · 🔀 140 · 📦 78K · 📋 100 - 38% open · ⏱️ 13.05.2021):
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 27 · 🔀 290 · 📦 2.4K · 📋 100 - 8% open · ⏱️ 05.04.2020):
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 44 · 🔀 130 · 📥 84 · 📦 840 · 📋 140 - 37% open · ⏱️ 24.05.2021):
...
- [PyPi](https://pypi.org/project/treq) (📥 84K / month):
	...
	pip install treq
	```
- [Conda](https://anaconda.org/conda-forge/treq) (📥 54K · ⏱️ 25.05.2021):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 31 · 🔀 280 · 📦 3.7K · 📋 410 - 61% open · ⏱️ 20.06.2021):
...
- [PyPi](https://pypi.org/project/keyboard) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 300 · ⏱️ 15.06.2021):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 77 · 📦 320 · 📋 77 - 68% open · ⏱️ 05.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/mouse) (📥 15K / month):
	```
	pip install mouse
	```
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 160 · 🔀 690 · 📦 280 · 📋 840 - 13% open · ⏱️ 13.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 8.9K / month):
	```
	pip install thumbor
	```
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 36 · 🔀 78 · 📥 150 · 📦 6.8K · 📋 74 - 37% open · ⏱️ 07.04.2021):
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 57 · 🔀 200 · 📥 500 · 📦 120 · 📋 440 - 18% open · ⏱️ 27.09.2020):
...
<details><summary><b><a href="https://github.com/lincolnloop/python-qrcode">python-qrcode</a></b> (🥉13 ·  ⭐ 2.6K · 💀) - A pure Python QR Code generator. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 32 · 🔀 430 · 📋 130 - 29% open · ⏱️ 26.03.2020):
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 19 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 82 / month):
	```
	pip install hmap
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 29 · 🔀 180 · 📥 4.5K · 📦 2K · 📋 380 - 45% open · ⏱️ 07.06.2021):
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 420 · 🔀 3.4K · 📥 19K · 📋 3.6K - 26% open · ⏱️ 24.06.2021):
...
- [PyPi](https://pypi.org/project/micropython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micropython) (📥 3.3K · ⏱️ 18.06.2021):
	```
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 1.7K · 🔀 19K · ⏱️ 24.06.2021):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 6.8K / month):
	```
	pip install cpython
	```
...
<details><summary><b><a href="https://github.com/Maratyszcza/PeachPy">PeachPy</a></b> (🥉14 ·  ⭐ 1.5K) - x86-64 assembler embedded in Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 21 · 🔀 120 · 📦 6 · 📋 81 - 24% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 18 / month):
	```
	pip install PeachPy
	```
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉12 ·  ⭐ 720) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 840 · 🔀 49 · 📋 250 - 4% open · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 48 · 🔀 240 · 📦 1.4K · 📋 320 - 55% open · ⏱️ 10.06.2021):
...
- [PyPi](https://pypi.org/project/ptpython) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 1K · ⏱️ 23.05.2021):
	```
...
- [PyPi](https://pypi.org/project/bpython) (📥 68K / month):
	...
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 23K · ⏱️ 26.01.2021):
	```
...
- [PyPi](https://pypi.org/project/pyicu) (📥 580K / month):
	...
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 57K · ⏱️ 15.01.2021):
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 44 · 🔀 720 · 📦 12K · 📋 320 - 26% open · ⏱️ 10.04.2021):
...
- [PyPi](https://pypi.org/project/schedule) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 7K · ⏱️ 10.04.2021):
	```
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 64 · 📋 9 - 11% open · ⏱️ 14.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/plan) (📥 400 / month):
	```
	pip install plan
	```
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥇31 ·  ⭐ 9.2K) - Library which aims to bring enjoyable logging in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 29 · 🔀 410 · 📦 7.8K · 📋 420 - 11% open · ⏱️ 19.03.2021):
...
<details><summary><b><a href="https://github.com/getsentry/sentry-python">sentry-python</a></b> (🥉26 ·  ⭐ 950) - Sentry SDK for Python. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/gym) (📥 560K / month):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 52K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 210 · 🔀 1.8K · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 67 · 🔀 590 · 📥 460K · 📦 45K · 📋 1.5K - 27% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 95 · 🔀 420 · 📦 24 · 📋 950 - 21% open · ⏱️ 18.06.2021):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 24K · ⏱️ 06.02.2021):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 36 · 🔀 180 · 📦 440K · ⏱️ 01.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 27M / month):
	```
...
<details><summary><b><a href="https://github.com/fxsjy/jieba">jieba</a></b> (🥇32 ·  ⭐ 27K · 💀) - The most popular Chinese text segmentation library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/pattern) (📥 120K / month):
	...
	pip install pattern
	```
- [Conda](https://anaconda.org/conda-forge/pattern) (📥 7.3K · ⏱️ 05.05.2020):
	```
...
<details><summary><b><a href="https://github.com/aboSamoor/polyglot">polyglot</a></b> (🥈24 ·  ⭐ 1.9K · 💤) - Natural language pipeline supporting hundreds of languages. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [PyPi](https://pypi.org/project/stanza) (📥 45K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 780 · ⏱️ 28.01.2021):
	```
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 170 · 🔀 460 · 📦 630 · 📋 510 - 20% open · ⏱️ 16.06.2021):
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 76 · 🔀 1.4K · 📥 380K · 📦 95 · 📋 630 - 40% open · ⏱️ 28.03.2021):

	```
	git clone https://github.com/mininet/mininet
	```
- [PyPi](https://pypi.org/project/mininet) (📥 950 / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 420 · 📋 170 - 24% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 740K / month):
	```
	pip install pox
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 88 · 🔀 350 · 📦 740 · 📋 440 - 39% open · ⏱️ 17.06.2021):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 670K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 99K · ⏱️ 18.05.2021):
	```
...
- [PyPi](https://pypi.org/project/dataset) (📥 84K / month):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 410 · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 190 · 📦 1.9K · 📋 550 - 44% open · ⏱️ 28.02.2021):
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 31 · 🔀 140 · 📋 310 - 40% open · ⏱️ 06.01.2020):
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 10 · 🔀 76 · 📋 56 - 48% open · ⏱️ 06.04.2020):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 27 · 📦 23 · 📋 10 - 50% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 530 / month):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 280 · 🔀 1.2K · 📥 6.9M · 📋 2.9K - 33% open · ⏱️ 23.06.2021):
...
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥉27 ·  ⭐ 5K · 📈) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 150 · 🔀 390 · 📋 720 - 14% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 2.5M / month):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 990 · 📋 7.9K - 23% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 79 · 🔀 82 · 📦 150 · 📋 650 - 13% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/pypa/warehouse) (👨‍💻 300 · 🔀 700 · 📋 2.3K - 13% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 86 · 📋 170 - 11% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.2K · 📋 4.3K - 1% open · ⏱️ 21.06.2021):
...
- [GitHub](https://github.com/trustedsec/social-engineer-toolkit) (👨‍💻 78 · 🔀 1.9K · 📋 750 - 20% open · ⏱️ 03.06.2021):
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 21 · 🔀 100 · 📦 640 · 📋 95 - 17% open · ⏱️ 23.05.2021):

	```
	git clone https://github.com/dfunckt/django-rules
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 320 / month):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 81 · 🔀 430 · 📦 7.2K · 📋 390 - 2% open · ⏱️ 10.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/sh) (📥 2.2M / month):
	```
	pip install sh
	```
...
<details><summary><b><a href="https://github.com/spotify/annoy">annoy</a></b> (🥇30 ·  ⭐ 8.7K) - Approximate Nearest Neighbors in C++/Python optimized for memory usage. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 370 · 📋 110 - 55% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 1.6K / month):
	```
...
<details><summary><b><a href="https://github.com/python-rope/rope">Rope</a></b> (🥇29 ·  ⭐ 1.1K) - Rope is a python refactoring library. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 63 · 🔀 120 · 📦 29K · 📋 180 - 36% open · ⏱️ 20.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 440K / month):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 170 · 🔀 810 · 📥 840 · 📦 5.6K · 📋 900 - 21% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 300 · 🔀 1.3K · 📦 5.4K · 📋 1K - 3% open · ⏱️ 21.06.2021):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 5M / month):
	```
	pip install sanic
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 910 · 📦 60K · 📋 520 - 15% open · ⏱️ 17.05.2021):
...
- [PyPi](https://pypi.org/project/flask-restful) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-restful) (📥 87K · ⏱️ 30.05.2021):
	```
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 220 · 🔀 2.2K · 📋 2.2K - 28% open · ⏱️ 09.06.2021):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 2.3M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 290K · ⏱️ 09.06.2021):
	```
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 370 · 📦 1.1K · 📋 450 - 33% open · ⏱️ 10.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/hug) (📥 31K / month):
	```
	pip install hug
	```
...
- [PyPi](https://pypi.org/project/apistar) (📥 13K / month):
	...
	pip install apistar
	```
- [Conda](https://anaconda.org/conda-forge/apistar) (📥 81K · ⏱️ 03.04.2019):
	```
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 170 · 📦 15 · 📋 75 - 30% open · ⏱️ 21.12.2020):

	```
	git clone https://github.com/jeffknupp/sandman2
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 500 / month):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 86 · 🔀 3.9K · 📋 240 - 3% open · ⏱️ 21.06.2021):
...
<details><summary><b><a href="https://github.com/pymc-devs/pymc3">PyMC</a></b> (🥉27 ·  ⭐ 5.9K) - Markov Chain Monte Carlo sampling toolkit. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/karateclub) (📥 6.2K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 4K · ⏱️ 20.05.2021):
	```
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 200 · 🔀 1.2K · 📦 7.1K · 📋 1.1K - 36% open · ⏱️ 22.06.2021):
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 120 · 🔀 670 · 📥 65 · 📦 4.8K · 📋 1.2K - 6% open · ⏱️ 08.12.2020):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 190 · 🔀 540 · 📦 29K · 📋 1K - 9% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/marshmallow-code/marshmallow
	```
- [PyPi](https://pypi.org/project/marshmallow) (📥 8.6M / month):
	```
	pip install marshmallow
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 610K · ⏱️ 11.05.2021):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 73 · 🔀 300 · 📦 26K · 📋 300 - 14% open · ⏱️ 12.06.2021):
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 17 · 🔀 38 · 📦 1.3K · 📋 96 - 10% open · ⏱️ 19.06.2021):

	```
	git clone https://github.com/python-rapidjson/python-rapidjson
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 550K / month):
	```
	pip install python-rapidjson
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 540K · ⏱️ 12.01.2021):
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 12 · 🔀 35 · 📦 91 · 📋 66 - 13% open · ⏱️ 21.06.2021):

	```
	git clone https://github.com/TkTech/pysimdjson
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 110K / month):
	```
	pip install pysimdjson
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 9.6K · ⏱️ 21.06.2021):
	```
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📥 250 · 📋 1.3K - 47% open · ⏱️ 20.02.2021):
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 47 · 🔀 210 · 📦 140 · 📋 86 - 39% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 6.1K / month):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 470 · 📥 4.5K · 📦 210 · 📋 2.1K - 12% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 54 · 🔀 360 · 📥 25K · 📦 16K · 📋 1.3K - 23% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 480K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 350K · ⏱️ 16.06.2021):
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 44 · 🔀 520 · 📦 37K · 📋 720 - 1% open · ⏱️ 28.05.2021):

	```
	git clone https://github.com/jmcnamara/XlsxWriter
	```
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 6M / month):
	```
...
- [GitHub](https://github.com/pyexcel/pyexcel) (👨‍💻 20 · 🔀 140 · 📥 140 · 📦 2K · 📋 180 - 3% open · ⏱️ 20.06.2021):
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 690 · 📋 820 - 44% open · ⏱️ 15.05.2021):

	```
	git clone https://github.com/python-openxml/python-docx
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 810K / month):
	```
	pip install python-docx
	```
- [Conda](https://anaconda.org/conda-forge/python-docx) (📥 83K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 41 · 🔀 250 · 📦 770 · 📋 290 - 19% open · ⏱️ 09.05.2021):
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 420 · 🔀 1.7K · 📥 370 · 📦 5.1K · 📋 1.5K - 2% open · ⏱️ 12.06.2021):
...
- [PyPi](https://pypi.org/project/nikola) (📥 2.3K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 1.6K · ⏱️ 14.02.2021):
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 130 · 🔀 520 · 📋 360 - 18% open · ⏱️ 17.06.2021):
...
- [PyPi](https://pypi.org/project/django-taggit) (📥 270K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-taggit) (📥 80K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 65 · 🔀 300 · 📦 750 · ⏱️ 23.06.2021):

	```
	git clone https://github.com/coleifer/huey
	```
- [PyPi](https://pypi.org/project/huey) (📥 43K / month):
	```
	pip install huey
	```
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 280 · 🔀 1.4K · 📥 52K · 📦 670K · 📋 780 - 5% open · ⏱️ 01.06.2021):
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 200 · 🔀 2.1K · 📦 1.4K · 📋 1.2K - 2% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/locustio/locust
	```
- [PyPi](https://pypi.org/project/locust) (📥 340K / month):
	```
	pip install locust
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 140 · 🔀 1.7K · 📥 510 · 📦 3.9K · 📋 3.5K - 4% open · ⏱️ 24.06.2021):
...
- [PyPi](https://pypi.org/project/robotframework) (📥 720K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robotframework) (📥 52K · ⏱️ 25.05.2021):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 96 · 🔀 250 · 📥 1 · 📦 9.7K · 📋 180 - 32% open · ⏱️ 27.04.2021):
...
- [PyPi](https://pypi.org/project/responses) (📥 4.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 610K · ⏱️ 27.04.2021):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 440 · 📦 9K · 📋 1.1K - 5% open · ⏱️ 15.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 1.8M / month):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 94 · 🔀 200 · 📦 8.2K · 📋 230 - 27% open · ⏱️ 18.06.2021):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 4.2M / month):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 50 · 🔀 700 · 📦 8.5K · 📋 470 - 63% open · ⏱️ 18.04.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 420K / month):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 100 · 🔀 270 · 📥 160 · 📋 290 - 1% open · ⏱️ 20.06.2021):
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 120 · 🔀 310 · 📋 470 - 27% open · ⏱️ 23.06.2021):
...
- [PyPi](https://pypi.org/project/factory_boy) (📥 1.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/factory_boy) (📥 72K · ⏱️ 04.04.2021):
	```
...
<details><summary><b><a href="https://github.com/schemathesis/schemathesis">Schemathesis</a></b> (🥉22 ·  ⭐ 890) - A tool for automatic property-based testing of web applications.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 29 · 🔀 63 · 📋 540 - 14% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 35K / month):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 8 · 📋 190 - 34% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 320 / month):
	```
	pip install sixpack
	```
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 48 · 📦 1.4K · 📋 26 - 42% open · ⏱️ 28.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/httmock) (📥 450K / month):
	```
	pip install httmock
	```
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 150 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 210K / month):
	```
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 39 · 🔀 88 · 📋 75 - 37% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/mixer) (📥 63K / month):
	```
	pip install mixer
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 39 · 🔀 210 · 📦 540K · 📋 110 - 47% open · ⏱️ 07.05.2021):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 32 · 🔀 170 · 📥 5.5K · 📦 330K · 📋 170 - 22% open · ⏱️ 14.05.2021):
...
<details><summary><b><a href="https://github.com/un33k/python-slugify">python-slugify</a></b> (🥈29 ·  ⭐ 1K) - A Python slugify library that translates unicode to ASCII. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 30 · 🔀 84 · 📦 18K · 📋 49 - 2% open · ⏱️ 12.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-slugify) (📥 3.3M / month):
	```
	pip install python-slugify
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 360K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 22 · 🔀 91 · 📦 5.6K · 📋 30 - 6% open · ⏱️ 17.02.2021):

	```
	git clone https://github.com/skorokithakis/shortuuid
	```
- [PyPi](https://pypi.org/project/shortuuid) (📥 910K / month):
	```
	pip install shortuuid
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 89K · ⏱️ 07.04.2021):
	```
	conda install -c conda-forge shortuuid
	```
</details>
<details><summary><b><a href="https://github.com/life4/textdistance">textdistance</a></b> (🥈26 ·  ⭐ 2K) - Compute distance between sequences with 30+ algorithms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 91 · 🔀 480 · 📋 440 - 40% open · ⏱️ 12.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sqlparse) (📥 14M / month):
	```
	pip install sqlparse
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 400K · ⏱️ 08.10.2020):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 20 · 🔀 490 · 📦 1.2K · 📋 190 - 13% open · ⏱️ 14.06.2021):

	```
	git clone https://github.com/mozillazg/python-pinyin
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 77 / month):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 20 · 🔀 87 · 📦 11K · 📋 40 - 20% open · ⏱️ 08.11.2020):

	```
	git clone https://github.com/pwaller/pyfiglet
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 520K / month):
	```
	pip install pyfiglet
	```
- [Conda](https://anaconda.org/conda-forge/pyfiglet) (📥 62K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/ztane/python-Levenshtein) (🔀 130 · 📦 8.4K · 📋 53 - 79% open · ⏱️ 01.02.2021):
...
- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 15 · 🔀 78 · 📦 680 · 📋 94 - 25% open · ⏱️ 09.08.2020):
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 20 · 📦 30 · 📋 7 - 28% open · ⏱️ 09.02.2019):
...
<details><summary><b><a href="https://github.com/boto/boto3">boto3</a></b> (🥇36 ·  ⭐ 6.5K) - Python interface to Amazon Web Services. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/boto/boto3) (👨‍💻 120 · 🔀 1.3K · 📦 120K · 📋 2.4K - 11% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 130M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 5.8M · ⏱️ 23.06.2021):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 170 · 🔀 1.9K · 📥 90 · 📦 64K · 📋 790 - 4% open · ⏱️ 23.06.2021):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 25M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 750K · ⏱️ 22.06.2021):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 120 · 🔀 790 · 📦 11K · 📋 630 - 15% open · ⏱️ 02.06.2021):
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 900 · 📦 3.1K · 📋 230 - 8% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/facebook-sdk) (📥 240K / month):
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 56 · 🔀 140 · 📦 2.8K · 📋 250 - 2% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 430K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 32 · 📦 1.7K · 📋 19 - 26% open · ⏱️ 15.05.2021):
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 14 · 🔀 120 · 📋 94 - 19% open · ⏱️ 04.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 530K / month):
	```
	pip install furl
	```
...
- [PyPi](https://pypi.org/project/scikit-video) (📥 52K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scikit-video) (📥 10K · ⏱️ 20.09.2018):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 800 · 📦 4.8K · 📋 320 - 39% open · ⏱️ 10.05.2020):
...
- [PyPi](https://pypi.org/project/sumy) (📥 25K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 34 · ⏱️ 22.06.2021):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 83 · 📦 580 · ⏱️ 11.06.2021):
...
- [PyPi](https://pypi.org/project/micawber) (📥 14K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 530 · ⏱️ 04.06.2021):
	```
...
<details><summary><b><a href="https://github.com/michaelhelmick/lassie">lassie</a></b> (🥉19 ·  ⭐ 530) - Web Content Retrieval for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/binux/pyspider) (👨‍💻 62 · 🔀 3.5K · 📦 300 · 📋 810 - 32% open · ⏱️ 02.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyspider) (📥 6K / month):
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 46 · 🔀 330 · 📥 39 · 📋 150 - 15% open · ⏱️ 09.06.2021):
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 49 · 🔀 1.3K · 📥 130 · 📦 39 · 📋 450 - 24% open · ⏱️ 10.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/portia) (📥 430 / month):
	```
	pip install portia
	```
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 73 · 🔀 97 · 📥 8 · 📋 250 - 10% open · ⏱️ 28.05.2021):
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 48 · 🔀 360 · 📦 35K · 📋 740 - 2% open · ⏱️ 20.06.2021):
...
- [PyPi](https://pypi.org/project/websockets) (📥 5.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 770K · ⏱️ 31.05.2021):
	```
...
- [GitHub](https://github.com/django/channels) (👨‍💻 230 · 🔀 660 · 📦 13K · 📋 1.1K - 9% open · ⏱️ 26.05.2021):
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 360 · 🔀 1.4K · 📥 97 · 📦 470K · 📋 1.7K - 16% open · ⏱️ 27.03.2021):
...
- [PyPi](https://pypi.org/project/gunicorn) (📥 17M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gunicorn) (📥 660K · ⏱️ 11.05.2021):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 420 · 🔀 1.5K · 📥 240 · 📦 540K · 📋 880 - 3% open · ⏱️ 01.06.2021):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 31M / month):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 40 · 🔀 180 · 📦 310 · 📋 140 - 18% open · ⏱️ 20.12.2020):
...
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉20 ·  ⭐ 950) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 43 · 🔀 130 · 📋 190 - 7% open · ⏱️ 15.05.2021):
