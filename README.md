...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 340 · 🔀 1.3K · 📦 13K · 📋 1.3K - 26% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 180 · 🔀 840 · 📦 7.1K · 📋 800 - 7% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/mher/flower
	```
- [PyPi](https://pypi.org/project/flower) (📥 670K / month):
	```
	pip install flower
	```
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 18 · 🔀 740 · 📦 23 · 📋 1.1K - 1% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 1.2K / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 22 · 🔀 170 · 📦 31 · 📋 200 - 27% open · ⏱️ 09.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 190 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 97 · 📋 10 - 60% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 820 · 🔀 32K · 📋 880 - 3% open · ⏱️ 28.11.2021):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 41M · ⏱️ 20.11.2021):
	```
	conda install -c conda-forge Python
	```
</details>
<details><summary><b><a href="https://github.com/pytransitions/transitions">transitions</a></b> (🥇29 ·  ⭐ 4.1K) - A lightweight, object-oriented finite state machine implementation. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 70 · 🔀 460 · 📦 1.9K · 📋 390 - 2% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/pytransitions/transitions
	```
- [PyPi](https://pypi.org/project/transitions) (📥 140K / month):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 180 · 🔀 3.8K · 📦 55 · 📋 140 - 35% open · ⏱️ 20.11.2021):

	```
	git clone https://github.com/keon/algorithms
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 970 / month):
	```
	pip install algorithms
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 430 · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 110 · 📦 17 · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 4K / month):
	```
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 100 · 🔀 450 · 📋 84 - 21% open · ⏱️ 24.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-ds) (📥 15 / month):
	```
...
- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 120 · 🔀 5.8K · 📋 74 - 16% open · ⏱️ 07.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-patterns) (📥 13 / month):
	```
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 120 · 🔀 360 · 📦 44K · 📋 530 - 11% open · ⏱️ 28.11.2021):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 3.4M / month):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 690K · ⏱️ 03.11.2021):
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 57 · 🔀 190 · 📦 12K · 📋 270 - 14% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/daphne) (📥 300K / month):
	```
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 69K · ⏱️ 07.04.2021):
	```
...
<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇28 ·  ⭐ 8.2K) - Ultra fast asyncio event loop. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 42 · 🔀 420 · 📥 350 · 📦 30K · 📋 270 - 18% open · ⏱️ 10.08.2021):
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 250 · 📦 2.7K · 📋 650 - 39% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 2.4M / month):
	```
	pip install trio
	```
...
<details><summary><b><a href="https://github.com/beetbox/beets">beets</a></b> (🥇31 ·  ⭐ 11K) - A music library manager and [MusicBrainz](https://musicbrainz.org/) tagger. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beetbox/beets) (👨‍💻 470 · 🔀 1.6K · 📥 7K · 📦 230 · 📋 2.4K - 18% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 90 · 🔀 760 · 📦 9.7K · 📋 450 - 43% open · ⏱️ 08.06.2021):
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 21 · 🔀 89 · 📦 6.7K · 📋 74 - 39% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/beetbox/audioread
	```
- [PyPi](https://pypi.org/project/audioread) (📥 390K / month):
	```
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 22 · 🔀 44 · 📥 2.1K · 📦 1.6K · 📋 170 - 24% open · ⏱️ 14.09.2021):
...
<details><summary><b><a href="https://github.com/tyiannak/pyAudioAnalysis">pyAudioAnalysis</a></b> (🥈24 ·  ⭐ 4.3K) - Audio feature extraction, classification, segmentation and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 25 · 🔀 1K · 📦 240 · 📋 280 - 58% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyAudioAnalysis) (📥 8.3K / month):
	```
...
<details><summary><b><a href="https://github.com/quodlibet/mutagen">mutagen</a></b> (🥈24 ·  ⭐ 900) - A Python module to handle audio metadata. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 35 · 🔀 120 · 📥 49K · 📦 5.8K · 📋 460 - 18% open · ⏱️ 31.10.2021):
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉21 ·  ⭐ 4.9K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 92 · 🔀 760 · 📋 920 - 3% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 400K / month):
	```
	pip install librosa
	```
...
<details><summary><b><a href="https://github.com/devsnd/tinytag">tinytag</a></b> (🥉19 ·  ⭐ 490) - A library for reading music meta data of MP3, OGG, FLAC and Wave files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 20 · 🔀 82 · 📦 440 · 📋 84 - 17% open · ⏱️ 28.08.2021):

	```
	git clone https://github.com/devsnd/tinytag
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 7.2K / month):
	```
	pip install tinytag
	```
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.2K · 📦 19 · 📋 200 - 36% open · ⏱️ 03.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 72 / month):
	```
	pip install dejavu
	```
...
<details><summary><b><a href="https://github.com/Parisson/TimeSide">TimeSide</a></b> (🥉17 ·  ⭐ 310 · 💤) - Open web audio processing framework. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉16 ·  ⭐ 510) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 62 · 📦 4 · 📋 32 - 34% open · ⏱️ 27.11.2021):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 67 / month):
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 180 · 🔀 420 · 📦 190K · 📋 340 - 22% open · ⏱️ 14.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 43M / month):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 100 · 🔀 520 · 📦 160K · 📋 330 - 21% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/jpadilla/pyjwt
	```
- [PyPi](https://pypi.org/project/pyjwt) (📥 46M / month):
	```
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 4.9M · ⏱️ 16.10.2021):
	```
	conda install -c conda-forge pyjwt
	```
</details>
<details><summary><b><a href="https://github.com/pennersr/django-allauth">django-allauth</a></b> (🥈33 ·  ⭐ 6.9K) - Authentication app for Django that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 560 · 🔀 2.4K · 📦 78K · 📋 1.8K - 18% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/pennersr/django-allauth
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 370K / month):
	```
...
<details><summary><b><a href="https://github.com/lepture/authlib">authlib</a></b> (🥉24 ·  ⭐ 2.8K) - JavaScript Object Signing and Encryption draft implementation. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/lepture/authlib) (👨‍💻 70 · 🔀 280 · 📋 280 - 8% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 2.8M / month):
	```
	pip install authlib
	```
...
<details><summary><b><a href="https://github.com/mpdavis/python-jose">python-jose</a></b> (🥉22 ·  ⭐ 980) - A JOSE implementation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/davedoesdev/python-jwt) (👨‍💻 5 · 🔀 23 · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-jwt) (📥 160K / month):
	```
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 15K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 8.3K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 55 · 🔀 580 · 📋 3.6K - 4% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 110 · 🔀 280 · 📦 310K · 📋 500 - 19% open · ⏱️ 30.11.2021):
...
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥈26 ·  ⭐ 940) - Efficient, Pythonic bidirectional map data structures and related.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/jab/bidict) (👨‍💻 11 · 🔀 44 · 📦 5.2K · 📋 46 - 4% open · ⏱️ 08.11.2021):
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 3 · 🔀 14 · 📥 60 · 📦 49 · 📋 9 - 77% open · ⏱️ 30.10.2015):
	...
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 14 / month):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 120 · 🔀 310 · 📥 2.9K · 📋 3.2K - 18% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 400 / month):
	```
	pip install indico
	```
...
<details><summary><b><a href="https://github.com/Kotti/Kotti">Kotti</a></b> (🥉18 ·  ⭐ 370) - A high-level, Pythonic web application framework built on Pyramid. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 64 · 🔀 110 · 📦 220 · 📋 210 - 19% open · ⏱️ 02.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 230 / month):
	```
	pip install Kotti
	```
...
<details><summary><b><a href="https://github.com/feincms/feincms">feincms</a></b> (🥉12 ·  ⭐ 810) - One of the most advanced Content Management Systems built on Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/psf/black) (👨‍💻 290 · 🔀 1.5K · 📥 19K · 📦 99K · 📋 1.7K - 19% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 420 · 📦 210K · 📋 1K - 2% open · ⏱️ 26.11.2021):

	```
	git clone https://github.com/timothycrosley/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 13M / month):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 800 · 📦 26K · 📋 720 - 46% open · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/yapf) (📥 1.3M / month):
	```
	pip install yapf
	```
...
<details><summary><b><a href="https://github.com/wemake-services/wemake-python-styleguide">wemake-python-styleguide</a></b> (🥈29 ·  ⭐ 1.7K) - The strictest and most opinionated python linter ever. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 830 · 📋 980 - 8% open · ⏱️ 01.12.2021):
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈25 ·  ⭐ 830) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 41 · 🔀 80 · 📦 2.8K · 📋 120 - 28% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/klen/pylama
	```
- [PyPi](https://pypi.org/project/pylama) (📥 66K / month):
	```
	pip install pylama
	```
- [Conda](https://anaconda.org/conda-forge/pylama) (📥 71K · ⏱️ 18.05.2019):
	```
	conda install -c conda-forge pylama
	```
</details>
<details><summary><b><a href="https://github.com/jendrikseipp/vulture">vulture</a></b> (🥈23 ·  ⭐ 2K) - A tool for finding and analysing dead Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 350 · 📋 270 - 24% open · ⏱️ 02.12.2021):
...
<details><summary><b><a href="https://github.com/PyCQA/prospector">prospector</a></b> (🥉20 ·  ⭐ 1.6K) - A tool to analyse Python code. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 140 · 📋 290 - 18% open · ⏱️ 30.11.2021):
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 160 · 📋 140 - 22% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 27K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1K · 🔀 1.1K · 📋 1.5K - 10% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 66 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 70 · 🔀 210 · 📋 460 - 21% open · ⏱️ 01.12.2021):
...
<details><summary><b><a href="https://github.com/scottrogowski/code2flow">code2flow</a></b> (🥉14 ·  ⭐ 1.2K) - Turn your Python and JavaScript code into DOT flowcharts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/tqdm/tqdm">tqdm</a></b> (🥇34 ·  ⭐ 20K) - Fast, extensible progress bar for loops and CLI. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1K · 📥 8K · 📦 230K · 📋 800 - 33% open · ⏱️ 20.09.2021):
...
- [PyPi](https://pypi.org/project/tqdm) (📥 22M / month):
	...
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 8.9M · ⏱️ 20.09.2021):
	```
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 140 · 🔀 980 · 📦 8.9K · 📋 600 - 3% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 2.1M / month):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 510K · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.2K · 📦 9.9K · 📋 240 - 40% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 37 · 🔀 210 · 📦 560 · 📋 260 - 7% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/peterbrittain/asciimatics
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 5.9K / month):
	```
	pip install asciimatics
	```
- [Conda](https://anaconda.org/conda-forge/asciimatics) (📥 81K · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (🔀 120 · 📦 490 · 📋 87 - 24% open · ⏱️ 06.11.2021):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 140 · 📋 28 - 60% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 200 · 🔀 580 · 📋 920 - 45% open · ⏱️ 26.11.2021):
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 140 · 🔀 3.2K · 📦 9.6K · 📋 720 - 15% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 160 · 🔀 440 · 📦 360 · 📋 610 - 20% open · ⏱️ 18.11.2021):
...
<details><summary><b><a href="https://github.com/nvbn/thefuck">thefuck</a></b> (🥈26 ·  ⭐ 65K) - Correcting your previous console command. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 95 · 🔀 600 · 📦 220 · 📋 570 - 27% open · ⏱️ 09.05.2021):

	```
	git clone https://github.com/dbcli/mycli
	```
- [PyPi](https://pypi.org/project/mycli) (📥 19K / month):
	```
	pip install mycli
	```
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 78 · 🔀 810 · 📦 380 · 📋 240 - 7% open · ⏱️ 26.10.2021):

	```
	git clone https://github.com/gleitz/howdoi
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 2.2K / month):
	```
	pip install howdoi
	```
...
<details><summary><b><a href="https://github.com/laixintao/iredis">iredis</a></b> (🥈21 ·  ⭐ 1.6K) - Redis CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 24 · 🔀 73 · 📥 7K · 📋 190 - 30% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/copier-org/copier) (👨‍💻 24 · 🔀 43 · 📦 28 · 📋 220 - 13% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 2.8K / month):
	```
	pip install copier
	```
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 260 · 📦 36 · 📋 91 - 31% open · ⏱️ 30.11.2021):
...
<details><summary><b><a href="https://github.com/mooz/percol">percol</a></b> (🥉17 ·  ⭐ 3.1K · 💀) - Adds flavor of interactive selection to the traditional pipe.. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/dbcli/litecli">litecli</a></b> (🥉16 ·  ⭐ 1.5K) - SQLite CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 20 · 🔀 50 · 📦 130 · 📋 70 - 31% open · ⏱️ 11.09.2021):
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 44 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 22K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 90 · 🔀 1.7K · 📥 820K · 📦 710 · 📋 460 - 28% open · ⏱️ 15.10.2021):
...
<details><summary><b><a href="https://github.com/sirfz/tesserocr">tesserocr</a></b> (🥈26 ·  ⭐ 1.6K) - Another simple, Pillow-friendly, wrapper around the `tesseract-ocr`.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 26 · 🔀 200 · 📦 580 · 📋 230 - 31% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 53K / month):
	```
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 47 · 🔀 12K · 📥 450 · 📋 1.2K - 53% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 38K / month):
	```
...
- [GitHub](https://github.com/kornia/kornia) (🔀 520 · 📥 150 · 📦 800 · 📋 490 - 21% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 18 · 🔀 81 · 📦 200 · 📋 72 - 43% open · ⏱️ 07.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/scoop) (📥 2.1K / month):
	```
	pip install scoop
	```
...
- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 27 · 🔀 140 · 📥 4 · 📦 52K · 📋 72 - 9% open · ⏱️ 30.09.2021):

	```
	git clone https://github.com/henriquebastos/python-decouple
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 490K / month):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 22 · 🔀 63 · 📦 16K · 📋 140 - 48% open · ⏱️ 14.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/configobj) (📥 1.2M / month):
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉21 ·  ⭐ 5.1K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 82 · 🔀 380 · 📦 3 · 📋 930 - 10% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 5.7K / month):
	```
	pip install hydra
	```
- [Conda](https://anaconda.org/conda-forge/hydra) (📥 8.8K · ⏱️ 18.01.2021):
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 160 · 🔀 1.7K · 📦 50K · 📋 1.3K - 53% open · ⏱️ 29.11.2021):
...
- [PyPi](https://pypi.org/project/paramiko) (📥 14M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 1.4M · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 62 · 🔀 180 · 📋 260 - 16% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/pyca/pynacl
	```
- [PyPi](https://pypi.org/project/pynacl) (📥 16M / month):
	```
	pip install pynacl
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 64 · 🔀 360 · 📦 8K · 📋 750 - 33% open · ⏱️ 15.08.2019):
...
- [GitHub](https://github.com/awslabs/aws-data-wrangler) (👨‍💻 85 · 🔀 370 · 📥 110K · 📋 540 - 5% open · ⏱️ 27.11.2021):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 220 · 📦 7 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 52 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 23 · 🔀 200 · 📋 220 - 14% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/ironmussa/Optimus
	```
- [PyPi](https://pypi.org/project/Optimus) (📥 9.1K / month):
	```
	pip install Optimus
	```
...
- [PyPi](https://pypi.org/project/jsonschema):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 8.7M · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 62 · 🔀 210 · 📦 10K · 📋 320 - 10% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 1.9M / month):
	```
...
<details><summary><b><a href="https://github.com/keleshev/schema">schema</a></b> (🥇30 ·  ⭐ 2.5K · 📈) - A library for validating Python data structures. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 180 · 📦 3.4K · 📋 130 - 48% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/schema) (📥 1.1M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 37K · ⏱️ 02.12.2021):
	```
...
<details><summary><b><a href="https://github.com/mwaskom/seaborn">Seaborn</a></b> (🥇35 ·  ⭐ 9K) - Statistical data visualization using Matplotlib. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 580 · 🔀 3.8K · 📦 41K · 📋 6.8K - 10% open · ⏱️ 30.11.2021):
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 130 · 🔀 590 · 📦 19K · 📋 1.6K - 13% open · ⏱️ 19.11.2021):
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 55 · 🔀 430 · 📦 28 · 📋 550 - 35% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/bloomberg/bqplot
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 47K / month):
	```
	pip install bqplot
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 100 · 🔀 300 · 📦 2K · 📋 1K - 26% open · ⏱️ 28.11.2021):
...
<details><summary><b><a href="https://github.com/has2k1/plotnine">plotnine</a></b> (🥉25 ·  ⭐ 2.9K) - A grammar of graphics for Python based on ggplot2. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 89 · 🔀 150 · 📦 2.7K · 📋 450 - 16% open · ⏱️ 30.11.2021):
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 97 · 🔀 870 · 📋 310 - 55% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 39K / month):
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 170 · 🔀 570 · 📦 640 · 📋 1.3K - 20% open · ⏱️ 29.11.2021):
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 69 · 🔀 400 · 📋 270 - 2% open · ⏱️ 01.12.2021):
...
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥉22 ·  ⭐ 500) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 110 · 📦 780 · 📋 54 - 27% open · ⏱️ 15.11.2019):

	```
	git clone https://github.com/patx/pickledb
	```
- [PyPi](https://pypi.org/project/pickledb) (📥 12K / month):
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 280 · 🔀 2K · 📦 130K · 📋 960 - 5% open · ⏱️ 02.12.2021):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 490K · ⏱️ 22.11.2021):
	```
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.2K · 📥 1.7K · 📦 8.5K · 📋 1.4K - 14% open · ⏱️ 03.08.2021):

	```
	git clone https://github.com/dpkp/kafka-python
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 4M / month):
	```
...
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥉22 ·  ⭐ 720) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 190 · 🔀 910 · ⏱️ 30.11.2021):
...
<details><summary><b><a href="https://github.com/python-happybase/happybase">happybase</a></b> (🥉21 ·  ⭐ 580 · 💤) - A developer-friendly library for Apache HBase. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 150 · 📦 570 · 📋 200 - 10% open · ⏱️ 08.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/happybase) (📥 80K / month):
	```
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 11 · 🔀 29 · 📦 100 · 📋 18 - 27% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 2K / month):
	```
	pip install queries
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 21 · 📦 9 · 📋 6 - 83% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 350 / month):
	```
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 68 · 🔀 260 · 📋 400 - 43% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 4.6M / month):
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 120 · 📦 670 · 📋 61 - 40% open · ⏱️ 06.12.2020):
...
<details><summary><b><a href="https://github.com/zachwill/moment">moment</a></b> (🥉20 ·  ⭐ 690 · 💀) - A Python library for dealing with dates/times. Inspired by.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 38 · 📦 600 · 📋 35 - 11% open · ⏱️ 27.11.2020):

	```
	git clone https://github.com/zachwill/moment
	```
- [PyPi](https://pypi.org/project/moment) (📥 60K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 13 · 📦 20 · 📋 9 - 44% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 170 / month):
	```
	pip install Chronyk
	```
...
<details><summary><b><a href="https://github.com/shinux/PyTime">PyTime</a></b> (🥉14 ·  ⭐ 140) - An easy-to-use Python module which aims to operate date/time/datetime by.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 5 · 🔀 16 · 📦 19 · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 7.9K / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 250 · 🔀 830 · 📥 170 · 📦 45K · 📋 770 - 10% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/jazzband/django-debug-toolbar
	```
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 960K / month):
	```
...
<details><summary><b><a href="https://github.com/gotcha/ipdb">ipdb</a></b> (🥇26 ·  ⭐ 1.5K) - IPython-enabled [pdb](https://docs.python.org/3/library/pdb.html). <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 49 · 🔀 130 · 📦 29K · 📋 170 - 33% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 1.3M / month):
	```
	pip install ipdb
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 80 · 🔀 400 · 📦 2.7K · 📋 170 - 32% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 590K / month):
	```
...
- [GitHub](https://github.com/flask-debugtoolbar/flask-debugtoolbar) (👨‍💻 38 · 🔀 120 · 📦 15K · 📋 88 - 28% open · ⏱️ 14.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/flask-debugtoolbar) (📥 73K / month):
	```
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥈24 ·  ⭐ 7.6K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 260 · 📥 7.1K · 📋 230 - 27% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 430K / month):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 160K · ⏱️ 13.11.2021):
	```
	conda install -c conda-forge py-spy
	```
</details>
<details><summary><b><a href="https://github.com/inducer/pudb">pudb</a></b> (🥈23 ·  ⭐ 2.3K) - A full-screen, console-based Python debugger. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 80 · 🔀 180 · 📦 2.7K · 📋 270 - 45% open · ⏱️ 01.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pudb) (📥 120K / month):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 45 · 📦 2.4K · 📋 180 - 34% open · ⏱️ 27.11.2021):
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 16 · 🔀 110 · 📋 80 - 28% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 82K / month):
	```
...
<details><summary><b><a href="https://github.com/Kozea/wdb">wdb</a></b> (🥉16 ·  ⭐ 1.5K · 💀) - An improbable web debugger through WebSockets. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/fabianp/memory_profiler">memory_profiler</a></b> (🥉15 ·  ⭐ 67 · 💀) - Monitor Memory usage of Python code. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 61 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 350K / month):
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 3.9K · 🔀 69K · 📦 170K · 📋 33K - 7% open · ⏱️ 02.12.2021):
...
- [PyPi](https://pypi.org/project/tensorflow):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 2.9M · ⏱️ 22.11.2021):
	```
...
- [GitHub](https://github.com/Theano/Theano) (👨‍💻 380 · 🔀 2.4K · 📦 12K · 📋 2.7K - 21% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/Theano) (📥 170K / month):
	```
	pip install Theano
	```
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3K · 🔀 14K · 📥 470 · 📋 23K - 31% open · ⏱️ 02.12.2021):
...
- [PyPi](https://pypi.org/project/pytorch):
	...
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 300K · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1K · 🔀 18K · 📋 11K - 1% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 970 · 🔀 6.5K · 📥 24K · 📋 9.4K - 18% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 700 · 📥 130 · ⏱️ 22.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 88 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.1K · 📦 120K · 📋 1.5K - 11% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 26M / month):
	```
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 9.2M · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.7K · 🔀 5K · 📥 16K · 📋 24K - 9% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 75K / month):
	```
	pip install salt
	```
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 160 · 🔀 1.1K · 📦 6.5K · 📋 1K - 10% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/supervisor) (📥 630K / month):
	```
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 44 · 🔀 130 · 📦 3.2K · 📋 99 - 11% open · ⏱️ 31.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/honcho) (📥 84K / month):
	```
	pip install honcho
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 59 · 🔀 250 · 📦 36 · 📋 510 - 17% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 490 · 🔀 1.4K · 📦 32K · 📋 4K - 16% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 6.2M / month):
	```
	pip install dask
	```
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 570 · 📦 890 · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 84K / month):
	```
	pip install mrjob
	```
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 93 · 🔀 480 · 📦 890 · 📋 460 - 48% open · ⏱️ 09.10.2020):

	```
	git clone https://github.com/robinhood/faust
	```
- [PyPi](https://pypi.org/project/faust) (📥 270K / month):
	```
	pip install faust
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 3K · 📋 8.5K - 21% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 41 · 🔀 210 · 📦 51 · 📋 320 - 19% open · ⏱️ 18.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/streamparse) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.6K · 📥 720K · 📋 4.3K - 7% open · ⏱️ 30.11.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 520K / month):
	```
...
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈25 ·  ⭐ 1.3K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 17 · 🔀 150 · 📥 18 · 📦 320 · 📋 610 - 1% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 52K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 71 · 📥 160 · 📋 92 - 27% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 5.1K / month):
	```
	pip install shiv
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.5K · 📦 170K · 📋 5.7K - 15% open · ⏱️ 30.11.2021):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 32 · 🔀 110 · 📦 460 · 📋 190 - 3% open · ⏱️ 26.11.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 74K / month):
	```
	pip install pdoc
	```
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥇26 ·  ⭐ 4.3K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 20 · 🔀 890 · 📦 120 · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 25 · 📦 220 · 📋 23 - 30% open · ⏱️ 04.09.2016):
	...
	```
- [PyPi](https://pypi.org/project/money) (📥 38K / month):
	```
	pip install money
	```
...
<details><summary><b><a href="https://github.com/MicroPyramid/forex-python">forex-python</a></b> (🥈19 ·  ⭐ 440) - Foreign exchange rates, Bitcoin price index and currency conversion. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 12 · 📥 6 · 📦 23 · 📋 5 - 40% open · ⏱️ 22.12.2020):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 230 · 🔀 1.3K · 📥 1.1M · 📦 21K · 📋 14K - 8% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 92K / month):
	```
	pip install spyder
	```
- [Conda](https://anaconda.org/conda-forge/spyder) (📥 1.2M · ⏱️ 29.11.2021):
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 170 · 🔀 2.6K · 📋 3.1K - 0% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 73 · 🔀 650 · 📥 32K · 📋 4.1K - 2% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/DamnWidget/anaconda) (👨‍💻 89 · 🔀 240 · 📋 770 - 21% open · ⏱️ 28.11.2021):
...
- [GitHub](https://github.com/python-mode/python-mode) (👨‍💻 130 · 🔀 760 · 📋 890 - 2% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 27 · 🔀 240 · 📦 1.8K · 📋 180 - 43% open · ⏱️ 30.08.2021):

	```
	git clone https://github.com/kootenpv/yagmail
	```
- [PyPi](https://pypi.org/project/yagmail) (📥 99K / month):
	```
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 8.8K · ⏱️ 30.08.2021):
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 100 · 🔀 270 · 📦 33 · 📋 1.6K - 4% open · ⏱️ 10.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 1.4K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 48 · 🔀 150 · 📦 120 · 📋 110 - 42% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 18K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 51 · 📥 49 · 📦 15 · 📋 89 - 17% open · ⏱️ 05.10.2021):
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 350 · 🔀 2.2K · 📋 1.4K - 2% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 5.2K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 120 · 🔀 590 · 📦 44K · 📋 550 - 27% open · ⏱️ 01.10.2021):

	```
	git clone https://github.com/gorakhargosh/watchdog
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 3.6M / month):
	```
	pip install watchdog
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 880K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 44 · 🔀 130 · 📋 130 - 2% open · ⏱️ 26.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/path.py) (📥 180K / month):
	```
	pip install path.py
	```
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 130 · 🔀 350 · 📦 110K · 📋 380 - 10% open · ⏱️ 07.11.2021):
...
- [PyPi](https://pypi.org/project/wtforms):
	...
	pip install wtforms
	```
- [Conda](https://anaconda.org/conda-forge/wtforms) (📥 84K · ⏱️ 07.11.2021):
	```
	conda install -c conda-forge wtforms
	```
</details>
<details><summary><b><a href="https://github.com/django-crispy-forms/django-crispy-forms">django-crispy-forms</a></b> (🥈28 ·  ⭐ 4.4K) - A Django app which lets you create beautiful forms in a.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 54K · 📋 150 - 12% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 97 · 🔀 680 · 📦 16K · 📋 290 - 1% open · ⏱️ 02.12.2021):
...
<details><summary><b><a href="https://github.com/WiserTogether/django-remote-forms">django-remote-forms</a></b> (🥉13 ·  ⭐ 210 · 💀) - A platform independent Django form serializer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 85 · 🔀 180 · 📥 2.4K · 📦 120K · 📋 190 - 4% open · ⏱️ 26.11.2021):
...
- [PyPi](https://pypi.org/project/more-itertools):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 8.3M · ⏱️ 24.11.2021):
	```
...
- [PyPi](https://pypi.org/project/toolz):
	...
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 5.6M · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 36 · 🔀 84 · 📦 120 · 📋 370 - 14% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/returns):
	...
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 540 · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 29 · 🔀 99 · 📋 530 - 12% open · ⏱️ 07.11.2021):
...
- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 61 · 📦 33K · 📋 62 - 35% open · ⏱️ 06.11.2021):
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇30 ·  ⭐ 980) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 120 · 🔀 190 · 📦 14K · 📋 290 - 19% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/pyglet/pyglet
	```
- [PyPi](https://pypi.org/project/pyglet) (📥 420K / month):
	```
	pip install pyglet
	```
...
<details><summary><b><a href="https://github.com/PySimpleGUI/PySimpleGUI">PySimpleGUI</a></b> (🥈29 ·  ⭐ 8.9K) - Wrapper for tkinter, Qt, WxPython and Remi. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.3K · 📦 3.9K · 📋 2.5K - 25% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 63K / month):
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 99 · 🔀 770 · 📥 150 · 📦 470 · 📋 500 - 17% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 3.6K / month):
	```
	pip install Gooey
	```
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 310 · 📦 220 · 📋 810 - 12% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 350 · 📦 550 · 📋 580 - 5% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 45 · 🔀 84 · 📦 8.1K · 📋 77 - 24% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 45 · 🔀 220 · 📋 230 - 4% open · ⏱️ 11.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 300K / month):
	```
...
- [GitHub](https://github.com/maxmind/geoip-api-python) (👨‍💻 13 · 🔀 53 · 📦 920 · ⏱️ 11.02.2021):
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 72 · 🔀 200 · 📦 150K · 📋 330 - 14% open · ⏱️ 05.10.2021):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 37 · 🔀 100 · 📦 720K · ⏱️ 05.11.2021):
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 50 · 🔀 170 · 📦 13K · 📋 170 - 25% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 680K / month):
	```
	pip install pyquery
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 700 · 🔀 8.2K · 📦 1.2M · 📋 3.5K - 4% open · ⏱️ 30.11.2021):
...
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈32 ·  ⭐ 8K) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 140 · 🔀 510 · 📦 14K · 📋 630 - 7% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 3.6M / month):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 91K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 290 · 🔀 840 · 📥 1K · 📦 710K · 📋 970 - 12% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 69 · 🔀 150 · 📦 91K · 📋 100 - 38% open · ⏱️ 19.11.2021):
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 360 · 🔀 1.5K · 📦 6.6K · 📋 1.3K - 2% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/keyboard):
	...
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 2.2K · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 82 · 📦 450 · 📋 88 - 70% open · ⏱️ 05.04.2021):

	```
	git clone https://github.com/boppreh/mouse
	```
- [PyPi](https://pypi.org/project/mouse) (📥 14K / month):
	```
	pip install mouse
	```
...
<details><summary><b><a href="https://github.com/SavinaRoja/PyUserInput">PyUserInput</a></b> (🥉20 ·  ⭐ 990 · 💤) - A module for cross-platform control of the mouse and.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 400 · 📋 96 - 68% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 7.2K / month):
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 370 · 🔀 1.6K · 📋 2.3K - 6% open · ⏱️ 27.11.2021):

	```
	git clone https://github.com/python-pillow/Pillow
	```
- [PyPi](https://pypi.org/project/Pillow) (📥 27M / month):
	```
	pip install Pillow
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 97 · 🔀 190 · 📥 5.3K · 📦 7.6K · 📋 360 - 3% open · ⏱️ 20.11.2021):
...
- [PyPi](https://pypi.org/project/wand):
	...
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 7.7K · ⏱️ 30.11.2020):
	```
	conda install -c conda-forge wand
	```
</details>
<details><summary><b><a href="https://github.com/thumbor/thumbor">thumbor</a></b> (🥈25 ·  ⭐ 8.7K) - A smart imaging service. It enables on-demand crop, re-sizing and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 39 · 🔀 87 · 📥 180 · 📦 9.6K · 📋 80 - 37% open · ⏱️ 23.11.2021):
...
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥈22 ·  ⭐ 370) - A fast image processing library with low memory needs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 12 · 🔀 31 · 📦 250 · 📋 250 - 35% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 230 · 📥 630 · 📦 150 · 📋 480 - 21% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 6 · 🔀 33 · 📦 38 · 📋 3 - 33% open · ⏱️ 09.07.2018):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 120 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 110 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 19 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 99 / month):
	```
	pip install hmap
	```
...
- [GitHub](https://github.com/ajknzhol/pygram) (🔀 12 · ⏱️ 22.02.2014):
	...
	```
- [PyPi](https://pypi.org/project/pygram) (📥 88 / month):
	```
	pip install pygram
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 460 · 🔀 3.7K · 📥 28K · 📋 3.9K - 27% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/micropython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micropython) (📥 5K · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 29 · 🔀 190 · 📥 14K · 📋 420 - 45% open · ⏱️ 20.11.2021):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 1.9K · 🔀 20K · ⏱️ 02.12.2021):
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉10 ·  ⭐ 770) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/ptpython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 7K · ⏱️ 14.11.2021):
	```
...
- [PyPi](https://pypi.org/project/pyicu):
	...
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 72K · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 270 · 🔀 720 · 📦 510 · 📋 1.9K - 19% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/prefect) (📥 140K / month):
	...
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 220K · ⏱️ 01.12.2021):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 42 · 🔀 240 · 📦 28 · 📋 71 - 1% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 110 · 🔀 240 · 📥 4.5K · 📦 16K · 📋 580 - 30% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 540 · 🔀 7.7K · 📥 3.4K · 📦 24K · 📋 4.2K - 6% open · ⏱️ 27.11.2021):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 6.9M / month):
	```
	pip install xgboost
	```
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 330 · 🔀 6.9K · 📦 25K · 📋 1.4K - 7% open · ⏱️ 22.11.2021):
...
- [PyPi](https://pypi.org/project/gym):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 81K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 220 · 🔀 1.8K · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 89 · 🔀 540 · 📋 770 - 9% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 6.3K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/josephreisinger/vowpal_porpoise) (👨‍💻 14 · 🔀 28 · 📋 9 - 66% open · ⏱️ 07.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/vowpal_porpoise) (📥 5 / month):
	```
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 70 · 🔀 640 · 📥 500K · 📦 61K · 📋 1.6K - 27% open · ⏱️ 23.11.2021):
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 95 · 🔀 460 · 📦 54 · 📋 1K - 16% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/pythonnet/pythonnet
	```
- [PyPi](https://pypi.org/project/pythonnet) (📥 94K / month):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 38 · 🔀 180 · 📦 520K · ⏱️ 05.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 34M / month):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 72 · 🔀 310 · 📥 23 · 📦 1.8K · 📋 130 - 28% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/boltons) (📥 970K / month):
	```
	pip install boltons
	```
...
<details><summary><b><a href="https://github.com/jek/blinker">blinker</a></b> (🥉26 ·  ⭐ 1.3K · 💤) - A fast Python in-process signal/event dispatching system. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.5K · 📦 320 · 📋 860 - 33% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/pattern):
	...
	pip install pattern
	```
- [Conda](https://anaconda.org/conda-forge/pattern) (📥 9K · ⏱️ 05.05.2020):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 890 · 📥 72K · 📦 160 · 📋 140 - 72% open · ⏱️ 21.06.2020):
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 41 · 🔀 740 · 📦 760 · 📋 600 - 10% open · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/stanza):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 2K · ⏱️ 17.08.2021):
	```
...
<details><summary><b><a href="https://github.com/isnowfy/snownlp">snownlp</a></b> (🥉19 ·  ⭐ 5.6K · 💀) - A library for processing Chinese text. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 740 · 📋 100 - 36% open · ⏱️ 19.01.2020):
...
- [PyPi](https://pypi.org/project/snownlp):
	...
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 240 · ⏱️ 07.09.2021):
	```
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 300 · 📦 610 · 📋 200 - 67% open · ⏱️ 22.09.2020):
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 280 · 📦 860 · 📋 71 - 36% open · ⏱️ 15.07.2017):
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 10 · 🔀 9.7K · 📋 44 - 36% open · ⏱️ 20.08.2021):
...
<details><summary><b><a href="https://github.com/napalm-automation/napalm">napalm</a></b> (🥇28 ·  ⭐ 1.8K) - Cross-vendor API to manipulate network devices. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 170 · 🔀 460 · 📦 730 · 📋 530 - 22% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/napalm-automation/napalm
	```
- [PyPi](https://pypi.org/project/napalm) (📥 17K / month):
	```
	pip install napalm
	```
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 78 · 🔀 1.5K · 📥 410K · 📦 120 · 📋 640 - 40% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/mininet) (📥 1.3K / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 420 · 📋 170 - 24% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 1.5M / month):
	```
	pip install pox
	```
...
<details><summary><b><a href="https://github.com/coleifer/peewee">peewee</a></b> (🥇33 ·  ⭐ 8.8K) - A small, expressive ORM. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 140 · 🔀 1.3K · 📦 15K · 📋 2.1K - 0% open · ⏱️ 24.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/peewee) (📥 420K / month):
	```
	pip install peewee
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 370 · 🔀 1.1K · 📦 15K · 📋 1.6K - 21% open · ⏱️ 30.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 540K / month):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 270 · 📦 2.2K · 📋 260 - 4% open · ⏱️ 17.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/dataset) (📥 76K / month):
	```
	pip install dataset
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 92 · 🔀 370 · 📦 860 · 📋 460 - 39% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 200 · 📦 2.2K · 📋 560 - 44% open · ⏱️ 29.11.2021):
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 31 · 🔀 150 · 📋 310 - 41% open · ⏱️ 06.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/orator) (📥 9.4K / month):
	```
	pip install orator
	```
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 15 · 🔀 81 · 📋 67 - 17% open · ⏱️ 29.11.2021):
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.4K · 📥 9.5M · 📋 3.3K - 33% open · ⏱️ 30.11.2021):
...
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥉27 ·  ⭐ 5.3K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 410 · 📋 770 - 14% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 2.8M / month):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1K · 📋 8.1K - 21% open · ⏱️ 30.11.2021):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇19 ·  ⭐ 510) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/devpi/devpi) (👨‍💻 81 · 🔀 92 · 📦 160 · 📋 670 - 14% open · ⏱️ 19.11.2021):

	```
	git clone https://github.com/devpi/devpi
	```
- [PyPi](https://pypi.org/project/devpi) (📥 2.1K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypa/warehouse) (👨‍💻 310 · 🔀 720 · 📋 2.4K - 14% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 87 · 📋 180 - 15% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.4K · 📋 4.5K - 1% open · ⏱️ 27.11.2021):
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 82 · 🔀 440 · 📦 8.1K · 📋 400 - 2% open · ⏱️ 12.11.2021):
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 75 · 🔀 950 · 📦 1.8K · 📋 340 - 11% open · ⏱️ 18.10.2021):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 610 · 📦 590 · 📋 430 - 20% open · ⏱️ 07.02.2021):
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 30 · 🔀 500 · 📦 510 · 📋 370 - 22% open · ⏱️ 02.10.2021):
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 26 · 📋 120 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 360 / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 190 · 📥 420 · 📦 91 · 📋 110 - 43% open · ⏱️ 24.03.2021):
...
<details><summary><b><a href="https://github.com/python-rope/rope">Rope</a></b> (🥇28 ·  ⭐ 1.2K) - Rope is a python refactoring library. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/python-rope/rope) (👨‍💻 68 · 🔀 130 · 📦 33K · 📋 230 - 30% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 410K / month):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 310 · 🔀 1.4K · 📦 6.1K · 📋 1.1K - 4% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 2.2M / month):
	```
	pip install sanic
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥈29 ·  ⭐ 39K) - A modern, fast, web framework for building APIs with Python 3.6+ based on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 270 · 🔀 2.8K · 📋 2.5K - 32% open · ⏱️ 26.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 3.2M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 480K · ⏱️ 07.10.2021):
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 940 · 📦 67K · 📋 530 - 15% open · ⏱️ 07.07.2021):
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 370 · 📦 1.2K · 📋 450 - 34% open · ⏱️ 10.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/hug) (📥 22K / month):
	```
	pip install hug
	```
...
<details><summary><b><a href="https://github.com/flask-api/flask-api">flask-api</a></b> (🥉20 ·  ⭐ 1.3K) - Browsable Web APIs for Flask. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 93 · 🔀 4.3K · 📋 260 - 3% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.4K · 📥 440K · 📦 37K · 📋 11K - 32% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 350 · 🔀 2.2K · 📥 26 · 📦 54K · 📋 4.5K - 46% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/statsmodels/statsmodels
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 5.5M / month):
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 350 · 🔀 1.4K · 📥 1K · 📦 570 · 📋 2.4K - 8% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 13 · 🔀 170 · 📦 63 · ⏱️ 21.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 3.3K / month):
	```
	pip install karateclub
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 7.2K · ⏱️ 05.08.2021):
	```
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 93 · 🔀 330 · 📋 2.9K - 2% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 200 · 🔀 1.2K · 📦 7.5K · 📋 1.2K - 36% open · ⏱️ 02.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-haystack) (📥 80K / month):
	```
...
<details><summary><b><a href="https://github.com/django-haystack/pysolr">pysolr</a></b> (🥉24 ·  ⭐ 610) - A lightweight Python wrapper for [Apache.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 560 · 📦 36K · 📋 1.1K - 9% open · ⏱️ 02.12.2021):
...
- [PyPi](https://pypi.org/project/marshmallow):
	...
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 890K · ⏱️ 15.11.2021):
	```
...
- [PyPi](https://pypi.org/project/python-rapidjson):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 760K · ⏱️ 12.11.2021):
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 12 · 🔀 39 · 📦 170 · 📋 70 - 17% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 500 · 📥 5.7K · 📦 270 · 📋 2.2K - 13% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 550 · 📦 12K · 📋 230 - 11% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/tablib) (📥 810K / month):
	```
	pip install tablib
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 46 · 🔀 540 · 📦 42K · 📋 740 - 1% open · ⏱️ 26.11.2021):

	```
	git clone https://github.com/jmcnamara/XlsxWriter
	```
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 6.1M / month):
	```
...
- [GitHub](https://github.com/mstamy2/PyPDF2) (👨‍💻 83 · 🔀 880 · 📦 25K · 📋 420 - 74% open · ⏱️ 25.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 2M / month):
	```
	pip install PyPDF2
	```
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 540 · 📦 960 · 📋 830 - 7% open · ⏱️ 08.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/csvkit) (📥 38K / month):
	```
	pip install csvkit
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 150 · 🔀 680 · 📦 160K · 📋 730 - 3% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 360 · 📦 84 · 📋 460 - 14% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 6.6K / month):
	```
	pip install unoconv
	```
...
- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 330 · 📋 660 - 41% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-pptx) (📥 500K / month):
	```
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 730 · 📋 870 - 44% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 700K / month):
	```
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 43 · 🔀 280 · 📦 940 · 📋 320 - 22% open · ⏱️ 06.10.2021):
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 420 · 🔀 1.7K · 📥 440 · 📦 5.4K · 📋 1.5K - 2% open · ⏱️ 27.11.2021):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 1.8K · 📦 17K · 📋 1.6K - 6% open · ⏱️ 28.11.2021):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 220 · 🔀 330 · 📦 390 · 📋 2.1K - 1% open · ⏱️ 26.11.2021):
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 89 · 🔀 270 · 📥 6.9K · 📋 550 - 38% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/lektor) (📥 1.8K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 140 · 🔀 540 · 📋 370 - 18% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-taggit) (📥 200K / month):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 250 · 🔀 1.2K · 📦 9.2K · 📋 920 - 16% open · ⏱️ 02.12.2021):
...
- [PyPi](https://pypi.org/project/rq):
	...
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 65K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 74 · 🔀 200 · 📥 32 · 📦 350 · 📋 270 - 8% open · ⏱️ 27.11.2021):
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 66 · 🔀 320 · 📦 830 · ⏱️ 28.11.2021):
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 430 · 🔀 1.5K · 📦 44K · 📋 530 - 23% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 3.9M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 520K · ⏱️ 30.11.2021):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 100 · 🔀 270 · 📥 21 · 📦 11K · 📋 200 - 16% open · ⏱️ 26.11.2021):
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 220 · 🔀 2.2K · 📦 2K · 📋 1.2K - 1% open · ⏱️ 02.12.2021):
...
- [PyPi](https://pypi.org/project/locust):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 42K · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.7K · 📋 3.7K - 4% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 450 · 📦 11K · 📋 1.2K - 4% open · ⏱️ 02.12.2021):
...
- [PyPi](https://pypi.org/project/hypothesis):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5M · ⏱️ 02.12.2021):
	```
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈28 ·  ⭐ 5.9K) - PyAutoGUI is a cross-platform GUI automation Python module for human.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 780 · 📦 12K · 📋 520 - 61% open · ⏱️ 14.09.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 380K / month):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 240 · 📦 5.4K · 📋 230 - 38% open · ⏱️ 05.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/HTTPretty) (📥 370K / month):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 490 · 📦 5.1K · 📋 490 - 10% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 270 · 📥 180 · 📋 300 - 0% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 67K / month):
	```
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 4K · ⏱️ 15.07.2020):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 120 · 📦 4.3K · 📋 250 - 20% open · ⏱️ 12.10.2021):

	```
	git clone https://github.com/nose-devs/nose2
	```
- [PyPi](https://pypi.org/project/nose2) (📥 300K / month):
	```
	pip install nose2
	```
...
<details><summary><b><a href="https://github.com/spulec/freezegun">freezegun</a></b> (🥉23 ·  ⭐ 3.1K) - Travel through time by mocking the datetime module. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 97 · 🔀 210 · 📋 240 - 29% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 2.7M / month):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 120 · 🔀 320 · 📋 490 - 28% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/factory_boy) (📥 1.5M / month):
	```
...
<details><summary><b><a href="https://github.com/schemathesis/schemathesis">Schemathesis</a></b> (🥉22 ·  ⭐ 1.1K) - A tool for automatic property-based testing of web applications.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 35 · 🔀 74 · 📋 600 - 16% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 32K / month):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 69 · 📦 620 · 📋 170 - 1% open · ⏱️ 16.07.2021):
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 47 · 📦 1.5K · 📋 26 - 42% open · ⏱️ 28.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/httmock) (📥 100K / month):
	```
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 5.6K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 21 · 🔀 36 · 📦 60 · 📋 54 - 3% open · ⏱️ 01.12.2021):
...
<details><summary><b><a href="https://github.com/klen/mixer">mixer</a></b> (🥉16 ·  ⭐ 790) - Another fixtures replacement. Supports Django, Flask, SQLAlchemy,.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 41 · 🔀 87 · 📋 77 - 38% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mixer) (📥 48K / month):
	```
	pip install mixer
	```
...
<details><summary><b><a href="https://github.com/berinhard/model_mommy">model_mommy</a></b> (🥉13 ·  ⭐ 930 · 💀) - Creating random fixtures for testing in Django. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 37 · 🔀 190 · 📥 6.2K · 📦 410K · 📋 200 - 7% open · ⏱️ 13.11.2021):
...
- [PyPi](https://pypi.org/project/sqlparse) (📥 18M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 520K · ⏱️ 10.09.2021):
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 44 · 🔀 220 · 📋 120 - 48% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/chardet) (📥 43M / month):
	```
	pip install chardet
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 11 · 🔀 200 · 📥 350 · 📦 1.4K · ⏱️ 29.11.2021):
...
- [PyPi](https://pypi.org/project/textdistance):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 65K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 100 · 📦 4.4K · 📋 120 - 9% open · ⏱️ 17.05.2021):
...
<details><summary><b><a href="https://github.com/pwaller/pyfiglet">pyfiglet</a></b> (🥈22 ·  ⭐ 920) - An implementation of figlet written in Python. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/pyfiglet):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyfiglet) (📥 78K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 32 · 🔀 340 · 📋 170 - 16% open · ⏱️ 18.06.2020):
...
- [PyPi](https://pypi.org/project/ply):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 880K · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 20 · 🔀 520 · 📋 210 - 13% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 25 · 🔀 350 · 📋 130 - 3% open · ⏱️ 27.11.2021):
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 22 · 📦 49 · 📋 8 - 37% open · ⏱️ 09.02.2019):
...
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥇34 ·  ⭐ 5.2K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 170 · 🔀 2K · 📥 93 · 📦 81K · 📋 850 - 4% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 21M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 970K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 120 · 🔀 1.4K · 📦 140K · 📋 2.5K - 10% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/boto3):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 7.7M · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 140 · 🔀 820 · 📥 52 · 📦 13K · 📋 670 - 10% open · ⏱️ 26.11.2021):
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 380 · 📦 4.8K · 📋 320 - 5% open · ⏱️ 16.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/twython) (📥 98K / month):
	```
	pip install twython
	```
...
<details><summary><b><a href="https://github.com/mobolic/facebook-sdk">facebook-sdk</a></b> (🥉26 ·  ⭐ 2.6K · 💤) - Facebook Platform Python SDK. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 910 · 📦 3.3K · 📋 240 - 8% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/facebook-sdk) (📥 90K / month):
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 58 · 🔀 140 · 📦 3.3K · 📋 260 - 1% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 350K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 55 · 📦 3K · 📋 73 - 2% open · ⏱️ 29.07.2020):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 91K / month):
	```
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 34 · 📦 1.8K · 📋 20 - 25% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/purl) (📥 33K / month):
	```
	pip install purl
	```
...
<details><summary><b><a href="https://github.com/gruns/furl">furl</a></b> (🥉18 ·  ⭐ 2.1K) - A small Python library that makes parsing and manipulating URLs easy. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/gruns/furl) (👨‍💻 14 · 🔀 120 · 📋 100 - 21% open · ⏱️ 27.09.2021):

	```
	git clone https://github.com/gruns/furl
	```
- [PyPi](https://pypi.org/project/furl) (📥 380K / month):
	```
	pip install furl
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 7 · 🔀 150 · 📥 500 · 📦 150 · 📋 190 - 1% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 1.8K · 📋 430 - 28% open · ⏱️ 25.11.2021):
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 220 · 🔀 690 · 📋 550 - 24% open · ⏱️ 06.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-storages) (📥 1.3M / month):
	```
...
- [PyPi](https://pypi.org/project/requests-html):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 490 · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 21 · 🔀 450 · 📦 1K · 📋 93 - 15% open · ⏱️ 23.11.2021):
...
- [PyPi](https://pypi.org/project/sumy):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 520 · ⏱️ 22.10.2021):
	```
	conda install -c conda-forge sumy
	```
</details>
<details><summary><b><a href="https://github.com/deanmalmgren/textract">textract</a></b> (🥈21 ·  ⭐ 3.2K) - Extract text from any document, Word, PowerPoint, PDFs, etc. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/codelucas/newspaper">newspaper</a></b> (🥉18 ·  ⭐ 12K · 💀) - News extraction, article extraction and content curation.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 790 · 📋 73 - 58% open · ⏱️ 07.06.2015):
	...
	```
- [PyPi](https://pypi.org/project/robobrowser) (📥 5.2K / month):
	```
...
<details><summary><b><a href="https://github.com/MasoniteFramework/masonite">Masonite</a></b> (🥇18 ·  ⭐ 1.7K) - The modern and developer centric Python web framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 74 · 🔀 99 · 📥 8 · 📋 260 - 2% open · ⏱️ 25.07.2021):
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 52 · 🔀 390 · 📦 44K · 📋 810 - 2% open · ⏱️ 20.11.2021):

	```
	git clone https://github.com/aaugustin/websockets
	```
- [PyPi](https://pypi.org/project/websockets) (📥 5.7M / month):
	```
...
- [PyPi](https://pypi.org/project/channels):
	...
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 68K · ⏱️ 11.07.2021):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 440 · 🔀 1.6K · 📥 250 · 📦 630K · 📋 910 - 2% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 40M / month):
	```
...
<details><summary><b><a href="https://github.com/benoitc/gunicorn">gunicorn</a></b> (🥈35 ·  ⭐ 8K) - Pre-forked, ported from Ruby's Unicorn project. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 360 · 🔀 1.5K · 📥 99 · 📦 560K · 📋 1.7K - 17% open · ⏱️ 06.09.2021):

	```
	git clone https://github.com/benoitc/gunicorn
	```
- [PyPi](https://pypi.org/project/gunicorn) (📥 19M / month):
	```
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 44 · 🔀 130 · 📋 190 - 8% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/waitress) (📥 1.7M / month):
	```
