...
<details><summary><b><a href="https://github.com/mher/flower">flower</a></b> (🥈30 ·  ⭐ 6.1K) - Real-time monitor and web admin for Celery. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 210 · 🔀 990 · 📦 17K · 📋 910 - 10% open · ⏱️ 17.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/flower) (📥 2.6M / month):
	```
	pip install flower
	```
...
- [GitHub](https://github.com/geex-arts/django-jet) (👨‍💻 29 · 🔀 670 · 📦 3.2K · 📋 350 - 63% open · ⏱️ 21.05.2019):
...
<details><summary><b><a href="https://github.com/wooey/Wooey">wooey</a></b> (🥉23 ·  ⭐ 2.1K) - A Django app which creates automatic web UIs for Python scripts. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 47 · 📋 220 - 23% open · ⏱️ 14.12.2023):

	```
	git clone https://github.com/wooey/wooey
	```
- [PyPi](https://pypi.org/project/wooey) (📥 500 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 140 · 📋 21 - 33% open · ⏱️ 15.03.2024):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 1.5K / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 1.2K · 🔀 42K · 📦 3 · 📋 1.4K - 2% open · ⏱️ 25.03.2024):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 120M · ⏱️ 20.03.2024):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 76 · 🔀 500 · 📦 3.4K · 📋 450 - 4% open · ⏱️ 20.09.2023):

	```
	git clone https://github.com/pytransitions/transitions
	```
- [PyPi](https://pypi.org/project/transitions) (📥 630K / month):
	```
	pip install transitions
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 610K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 200 · 🔀 4.3K · 📦 100 · 📋 160 - 36% open · ⏱️ 05.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 1.9K / month):
	```
...
- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 24 · 🔀 190 · 📋 180 - 8% open · ⏱️ 01.03.2024):
...
<details><summary><b><a href="https://github.com/prabhupant/python-ds">python-ds</a></b> (🥉15 ·  ⭐ 2.7K · 💀) - A collection of data structure and algorithms for coding interviews. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 110 · 🔀 580 · 📋 90 - 1% open · ⏱️ 04.10.2022):

	```
	git clone https://github.com/prabhupant/python-ds
	```
- [PyPi](https://pypi.org/project/python-ds) (📥 20 / month):
	```
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇37 ·  ⭐ 7.7K · 📈) - A lightning-fast ASGI server implementation, using uvloop and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 180 · 🔀 650 · 📦 330K · 📋 670 - 4% open · ⏱️ 20.03.2024):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 27M / month):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 2.4M · ⏱️ 20.03.2024):
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 69 · 🔀 250 · 📦 26K · 📋 310 - 10% open · ⏱️ 10.02.2024):

	```
	git clone https://github.com/django/daphne
	```
- [PyPi](https://pypi.org/project/daphne) (📥 1.2M / month):
	```
	pip install daphne
	```
...
🔗&nbsp;<b><a href="https://github.com/timofurrer/awesome-asyncio">awesome-asyncio</a></b> ( ⭐ 4.4K · 💀)  - A curated list of awesome Python asyncio frameworks, libraries,..

🔗&nbsp;<b><a href="https://twistedmatrix.com/trac/">Twisted</a></b>  - An event-driven networking engine.

<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇35 ·  ⭐ 10K) - Ultra fast asyncio event loop. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 60 · 🔀 500 · 📥 430 · 📦 120K · 📋 350 - 25% open · ⏱️ 22.10.2023):
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 160 · 🔀 310 · 📦 55K · 📋 780 - 36% open · ⏱️ 25.03.2024):
...
- [PyPi](https://pypi.org/project/trio) (📥 12M / month):
	...
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 1.5M · ⏱️ 17.03.2024):
	```
...
<details><summary><b><a href="https://github.com/jiaaro/pydub">pydub</a></b> (🥇33 ·  ⭐ 8.3K · 💀) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 980 · 📦 53K · 📋 560 - 51% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 4.7M / month):
	```
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 85K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 570 · 🔀 1.8K · 📥 9.1K · 📦 370 · 📋 2.7K - 19% open · ⏱️ 24.03.2024):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 7.7K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 760 · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 44 · 🔀 150 · 📥 61K · 📦 18K · 📋 510 - 19% open · ⏱️ 28.10.2023):
...
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥈26 ·  ⭐ 480) - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/audioread) (📥 2.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/audioread) (📥 750K · ⏱️ 30.09.2023):
	```
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 26 · 🔀 58 · 📥 3.3K · 📦 3.2K · 📋 220 - 29% open · ⏱️ 07.01.2024):

	```
	git clone https://github.com/nicfit/eyeD3
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 50K / month):
	```
	pip install eyeD3
	```
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 28 · 🔀 1.1K · 📦 450 · 📋 300 - 60% open · ⏱️ 22.10.2023):
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉22 ·  ⭐ 6.6K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 120 · 🔀 890 · 📋 1.2K - 4% open · ⏱️ 18.03.2024):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 2.8M / month):
	```
	pip install librosa
	```
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 26 · 📦 2.4K · 📋 97 - 15% open · ⏱️ 04.07.2022):

	```
	git clone https://github.com/keunwoochoi/kapre
	```
- [PyPi](https://pypi.org/project/kapre) (📥 5.7K / month):
	```
	pip install kapre
	```
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 140 · 📦 35 · 📋 46 - 34% open · ⏱️ 29.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/matchering) (📥 1.7K / month):
	```
...
<details><summary><b><a href="https://github.com/worldveil/dejavu">dejavu</a></b> (🥉19 ·  ⭐ 6.3K · 💀) - Audio fingerprinting and recognition. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.3K · 📦 21 · 📋 240 - 43% open · ⏱️ 03.06.2020):
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 26 · 🔀 97 · 📋 110 - 5% open · ⏱️ 16.03.2024):
...
- [GitHub](https://github.com/yomguy/TimeSide) (👨‍💻 22 · 🔀 61 · 📦 17 · 📋 220 - 15% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 73 / month):
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 200 · 🔀 460 · 📦 510K · 📋 370 - 21% open · ⏱️ 06.01.2024):

	```
	git clone https://github.com/idan/oauthlib
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 100M / month):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 140 · 🔀 650 · 📦 540K · 📋 430 - 4% open · ⏱️ 22.03.2024):

	```
	git clone https://github.com/jpadilla/pyjwt
	```
- [PyPi](https://pypi.org/project/pyjwt) (📥 150M / month):
	```
	pip install pyjwt
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 110 · 🔀 400 · 📦 32K · 📋 430 - 18% open · ⏱️ 28.02.2024):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 8.6M / month):
	```
	pip install authlib
	```
...
<details><summary><b><a href="https://github.com/pennersr/django-allauth">django-allauth</a></b> (🥈32 ·  ⭐ 8.8K) - Authentication app for Django that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 690 · 🔀 2.8K · 📦 220K · 📋 2.2K - 3% open · ⏱️ 27.03.2024):
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 250 · 🔀 730 · 📋 820 - 20% open · ⏱️ 27.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-oauth-toolkit) (📥 770K / month):
	```
	pip install django-oauth-toolkit
	```
- [Conda](https://anaconda.org/conda-forge/django-oauth-toolkit) (📥 4.3K · ⏱️ 05.07.2023):
	```
...
- [GitHub](https://github.com/mpdavis/python-jose) (🔀 220 · 📋 150 - 48% open · ⏱️ 03.05.2023):
...
<details><summary><b><a href="https://github.com/platformio/platformio-core">PlatformIO</a></b> (🥉20 ·  ⭐ 7.5K) - A console tool to build code with different development platforms. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 85 · 🔀 740 · 📦 1 · 📋 4.1K - 4% open · ⏱️ 26.03.2024):
...
<details><summary><b><a href="https://github.com/python-attrs/attrs">attrs</a></b> (🥇36 ·  ⭐ 5.1K) - Replacement for `__init__`, `__eq__`, `__repr__`, etc. boilerplate in class.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 160 · 🔀 360 · 📦 980K · 📋 700 - 18% open · ⏱️ 18.03.2024):

	```
	git clone https://github.com/python-attrs/attrs
	```
- [PyPi](https://pypi.org/project/attrs) (📥 200M / month):
	```
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 35M · ⏱️ 31.12.2023):
	```
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 15 · 🔀 63 · 📥 40 · 📦 23K · 📋 60 - 1% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/jab/bidict
	```
- [PyPi](https://pypi.org/project/bidict) (📥 2.3M / month):
	```
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 390K · ⏱️ 18.02.2024):
	```
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 22 · 📥 100 · 📦 99 · 📋 9 - 77% open · ⏱️ 30.10.2015):

	```
	git clone https://github.com/carlosescri/DottedDict
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 200 / month):
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 95 · 📥 39 · 📋 160 - 13% open · ⏱️ 26.08.2023):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 390 · 📥 3K · 📋 3.5K - 19% open · ⏱️ 28.03.2024):
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.6K · 📋 1.1K - 3% open · ⏱️ 02.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 4.4K / month):
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 180 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 67 · 🔀 210 · 📦 1.2K · 📋 330 - 4% open · ⏱️ 12.03.2024):
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 54 · 🔀 120 · 📥 580 · 📦 5K · 📋 190 - 11% open · ⏱️ 11.10.2023):

	```
	git clone https://github.com/lericson/pylibmc
	```
- [PyPi](https://pypi.org/project/pylibmc) (📥 290K / month):
	```
	pip install pylibmc
	```
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 280 · 📋 75 - 25% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 13K / month):
	```
...
<details><summary><b><a href="https://github.com/bbangert/beaker">beaker</a></b> (🥉19 ·  ⭐ 510) - A WSGI middleware for sessions and caching. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 91 · 🔀 140 · 📋 130 - 53% open · ⏱️ 20.03.2024):
...
<details><summary><b><a href="https://github.com/errbotio/errbot">errbot</a></b> (🥇22 ·  ⭐ 3.1K) - The easiest and most popular chatbot to implement ChatOps. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
🔗&nbsp;<b><a href="https://github.com/typeddjango/awesome-python-typing">awesome-python-typing</a></b> ( ⭐ 1.6K)  - Collection of awesome Python types, stubs, plugins, and tools to..
...
- [GitHub](https://github.com/psf/black) (👨‍💻 440 · 🔀 2.3K · 📥 71K · 📦 480K · 📋 2.5K - 13% open · ⏱️ 23.03.2024):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 37M / month):
	```
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 9.5M · ⏱️ 18.03.2024):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 290 · 🔀 550 · 📦 460K · 📋 1.3K - 14% open · ⏱️ 15.01.2024):

	```
	git clone https://github.com/timothycrosley/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 39M / month):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 150 · 🔀 870 · 📦 91K · 📋 840 - 44% open · ⏱️ 19.03.2024):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 5.5M / month):
	```
	pip install yapf
	```
...
<details><summary><b><a href="https://github.com/wemake-services/wemake-python-styleguide">wemake-python-styleguide</a></b> (🥈32 ·  ⭐ 2.4K) - The strictest and most opinionated python linter ever. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 380 · 📦 16K · 📋 1.1K - 9% open · ⏱️ 27.03.2024):
...
- [GitHub](https://github.com/landscapeio/prospector) (👨‍💻 90 · 🔀 170 · 📦 4.8K · 📋 380 - 15% open · ⏱️ 18.10.2023):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 900K / month):
	```
...
<details><summary><b><a href="https://github.com/jendrikseipp/vulture">vulture</a></b> (🥈27 ·  ⭐ 3K) - A tool for finding and analysing dead Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 42 · 🔀 130 · 📦 4.4K · 📋 200 - 11% open · ⏱️ 19.03.2024):
...
- [PyPi](https://pypi.org/project/vulture) (📥 590K / month):
	...
	pip install vulture
	```
- [Conda](https://anaconda.org/conda-forge/vulture) (📥 79K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 96 · 📦 6.3K · 📋 150 - 37% open · ⏱️ 08.08.2022):

	```
	git clone https://github.com/klen/pylama
	```
- [PyPi](https://pypi.org/project/pylama) (📥 230K / month):
	```
	pip install pylama
	```
...
<details><summary><b><a href="https://github.com/facebook/pyre-check">pyre-check</a></b> (🥉24 ·  ⭐ 6.7K) - Performant type checking. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 260 · 🔀 420 · 📦 21 · 📋 380 - 32% open · ⏱️ 28.03.2024):
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 100 · 🔀 260 · 📦 3.5K · 📋 690 - 22% open · ⏱️ 27.03.2024):
...
<details><summary><b><a href="https://github.com/scottrogowski/code2flow">code2flow</a></b> (🥉21 ·  ⭐ 3.7K · 💀) - Turn your Python and JavaScript code into DOT flowcharts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 260 · 📦 44 · 📋 68 - 33% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/scottrogowski/code2flow
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 8.2K / month):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 50 · 🔀 170 · 📋 180 - 23% open · ⏱️ 06.02.2024):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 220K / month):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 56 · 📦 130 · 📋 60 - 45% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 6.5K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.4K · 🔀 1.6K · 📋 2.4K - 7% open · ⏱️ 28.03.2024):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 240 · 🔀 1.6K · 📦 180K · 📋 1.2K - 14% open · ⏱️ 29.02.2024):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 50M / month):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 6.4M · ⏱️ 28.02.2024):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 120 · 🔀 1.3K · 📥 12K · 📦 680K · 📋 970 - 40% open · ⏱️ 10.02.2024):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 94M / month):
	```
	pip install tqdm
	```
...
<details><summary><b><a href="https://github.com/google/python-fire">python-fire</a></b> (🥈28 ·  ⭐ 26K) - A library for creating command line interfaces from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/python-fire) (👨‍💻 65 · 🔀 1.4K · 📦 31K · 📋 310 - 38% open · ⏱️ 14.03.2024):

	```
	git clone https://github.com/google/python-fire
	```
- [PyPi](https://pypi.org/project/python-fire) (📥 260 / month):
	```
...
<details><summary><b><a href="https://github.com/peterbrittain/asciimatics">asciimatics</a></b> (🥈28 ·  ⭐ 3.5K) - A package to create full-screen text UIs (from interactive.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 45 · 🔀 240 · 📦 980 · 📋 300 - 7% open · ⏱️ 30.11.2023):

	```
	git clone https://github.com/peterbrittain/asciimatics
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 25K / month):
	```
...
<details><summary><b><a href="https://github.com/rsalmei/alive-progress">alive-progress</a></b> (🥉25 ·  ⭐ 5.1K) - A new kind of Progress Bar, with real-time throughput, eta and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 190 · 📦 2.9K · 📋 220 - 8% open · ⏱️ 02.12.2023):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 760K / month):
	```
	pip install alive-progress
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 51K · ⏱️ 09.11.2023):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 230 · 🔀 690 · 📋 1.1K - 49% open · ⏱️ 12.02.2024):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 180 · 📋 29 - 62% open · ⏱️ 31.03.2021):
...
- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 320 · 🔀 1.9K · 📦 26K · 📋 840 - 23% open · ⏱️ 25.03.2024):

	```
	git clone https://github.com/audreyr/cookiecutter
	```
- [PyPi](https://pypi.org/project/cookiecutter) (📥 4.6M / month):
	```
	pip install cookiecutter
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 970K · ⏱️ 22.02.2024):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 200 · 🔀 3.3K · 📦 500 · 📋 710 - 34% open · ⏱️ 25.01.2024):

	```
	git clone https://github.com/nvbn/thefuck
	```
- [PyPi](https://pypi.org/project/thefuck) (📥 8.6K / month):
	```
	pip install thefuck
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥇30 ·  ⭐ 1.6K) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 72 · 🔀 160 · 📦 900 · 📋 440 - 13% open · ⏱️ 25.03.2024):
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 74 · 🔀 230 · 📦 300 · 📋 350 - 24% open · ⏱️ 24.03.2024):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 23K / month):
	```
	pip install tmuxp
	```
...
<details><summary><b><a href="https://github.com/httpie/cli">httpie</a></b> (🥈27 ·  ⭐ 32K · 📉) - A command line HTTP client, a user-friendly cURL replacement. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/httpie/cli) (👨‍💻 170 · 🔀 3.6K · 📥 7.6K · 📦 1 · 📋 850 - 19% open · ⏱️ 18.03.2024):

	```
	git clone https://github.com/jakubroztocil/httpie
	```
- [PyPi](https://pypi.org/project/httpie) (📥 430K / month):
	```
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 120K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 180 · 🔀 530 · 📦 1.4K · 📋 690 - 19% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/dbcli/pgcli
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 120K / month):
	```
	pip install pgcli
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 110 · 🔀 640 · 📦 350 · 📋 650 - 30% open · ⏱️ 25.03.2024):

	```
	git clone https://github.com/dbcli/mycli
	```
- [PyPi](https://pypi.org/project/mycli) (📥 43K / month):
	```
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 72K · ⏱️ 12.08.2023):
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 31 · 🔀 100 · 📥 12K · 📦 19 · 📋 220 - 24% open · ⏱️ 16.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/iredis) (📥 4.7K / month):
	```
	pip install iredis
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 28 · 🔀 64 · 📦 310 · 📋 100 - 33% open · ⏱️ 23.03.2024):
...
- [PyPi](https://pypi.org/project/litecli) (📥 14K / month):
	...
	pip install litecli
	```
- [Conda](https://anaconda.org/conda-forge/litecli) (📥 150 · ⏱️ 05.12.2023):
	```
	conda install -c conda-forge litecli
	```
</details>
<details><summary><b><a href="https://github.com/facebook/PathPicker">PathPicker</a></b> (🥉20 ·  ⭐ 5.1K) - Select files out of bash output. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 21 · 🔀 97 · 📦 20 · 📋 49 - 20% open · ⏱️ 26.03.2024):
...
<details><summary><b><a href="https://github.com/PyCQA/modernize">modernize</a></b> (🥇18 ·  ⭐ 350 · 💀) - Modernizes Python code for eventual Python 3 migration. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 48 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 64K / month):
	```
...
<details><summary><b><a href="https://github.com/JaidedAI/EasyOCR">EasyOCR</a></b> (🥇32 ·  ⭐ 22K) - Ready-to-use OCR with 40+ languages supported. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 130 · 🔀 2.9K · 📥 9.8M · 📦 5.6K · 📋 930 - 37% open · ⏱️ 04.09.2023):
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 30 · 🔀 250 · 📥 160 · 📦 950 · 📋 270 - 18% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/sirfz/tesserocr
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 60K / month):
	```
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 13K · 📥 1.2K · 📦 21 · 📋 1.3K - 55% open · ⏱️ 10.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 140K / month):
	```
...
<details><summary><b><a href="https://github.com/madmaze/pytesseract">pytesseract</a></b> (🥉25 ·  ⭐ 5.5K) - A wrapper for [Google Tesseract.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 46 · 🔀 680 · 📋 350 - 2% open · ⏱️ 20.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 2.2M / month):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉23 ·  ⭐ 9.2K) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 900 · 📥 1K · 📦 9K · 📋 880 - 28% open · ⏱️ 27.03.2024):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 25 · 🔀 85 · 📦 410 · 📋 75 - 44% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/scoop) (📥 3K / month):
	```
	pip install scoop
	```
...
<details><summary><b><a href="https://github.com/HBNetwork/python-decouple">python-decouple</a></b> (🥇31 ·  ⭐ 2.7K) - Strict separation of settings from code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 36 · 🔀 190 · 📥 12 · 📦 130K · 📋 94 - 4% open · ⏱️ 01.01.2024):

	```
	git clone https://github.com/henriquebastos/python-decouple
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 3.2M / month):
	```
	pip install python-decouple
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 79K · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge python-decouple
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉27 ·  ⭐ 8.1K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 120 · 🔀 580 · 📦 22K · 📋 1.3K - 17% open · ⏱️ 05.03.2024):
...
<details><summary><b><a href="https://github.com/DiffSK/configobj">configobj</a></b> (🥉27 ·  ⭐ 310 · 💀) - INI file parser with validation. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 73 · 📥 520 · 📦 34K · 📋 150 - 37% open · ⏱️ 18.01.2023):
...
- [PyPi](https://pypi.org/project/configobj) (📥 3.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 780K · ⏱️ 16.06.2023):
	```
...
<details><summary><b><a href="https://github.com/paramiko/paramiko">paramiko</a></b> (🥇33 ·  ⭐ 8.8K) - The leading native Python SSHv2 protocol library. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 190 · 🔀 1.9K · 📦 93K · 📋 1.6K - 50% open · ⏱️ 11.02.2024):

	```
	git clone https://github.com/paramiko/paramiko
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 53M / month):
	```
	pip install paramiko
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 4.3M · ⏱️ 19.12.2023):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 67 · 🔀 210 · 📋 300 - 14% open · ⏱️ 23.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/pynacl) (📥 69M / month):
	```
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 5.6M · ⏱️ 24.09.2023):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 67 · 🔀 360 · 📦 9.2K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 38K / month):
	```
	pip install blaze
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 150 · 🔀 650 · 📥 230K · 📦 1.5K · 📋 1.1K - 2% open · ⏱️ 27.03.2024):
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 110 · 🔀 560 · 📥 200 · 📦 540K · 📋 820 - 3% open · ⏱️ 25.03.2024):
...
<details><summary><b><a href="https://github.com/keleshev/schema">schema</a></b> (🥈32 ·  ⭐ 2.8K) - A library for validating Python data structures. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/keleshev/schema) (👨‍💻 67 · 🔀 200 · 📦 8.6K · 📋 160 - 50% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/keleshev/schema
	```
- [PyPi](https://pypi.org/project/schema) (📥 17M / month):
	```
	pip install schema
	```
...
<details><summary><b><a href="https://github.com/podio/valideer">valideer</a></b> (🥉17 ·  ⭐ 260 · 💀) - Lightweight extensible data validation and adaptation library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 9 · 🔀 23 · 📦 70 · 📋 15 - 26% open · ⏱️ 05.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/valideer) (📥 6.9K / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 210 · 🔀 1.8K · 📥 380 · 📦 380K · 📋 2.5K - 5% open · ⏱️ 25.02.2024):

	```
	git clone https://github.com/mwaskom/seaborn
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 18M / month):
	```
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 8.3M · ⏱️ 27.01.2024):
	```
	conda install -c conda-forge seaborn
	```
</details>
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈34 ·  ⭐ 8.9K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 160 · 🔀 720 · 📥 120 · 📦 120K · 📋 1.9K - 8% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 23M / month):
	```
	pip install altair
	```
- [Conda](https://anaconda.org/conda-forge/altair) (📥 2.2M · ⏱️ 18.03.2024):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 690 · 🔀 4.1K · 📦 85K · 📋 7.6K - 9% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/bokeh/bokeh
	```
- [PyPi](https://pypi.org/project/bokeh) (📥 4.9M / month):
	```
	pip install bokeh
	```
- [Conda](https://anaconda.org/conda-forge/bokeh) (📥 14M · ⏱️ 15.03.2024):
	```
	conda install -c conda-forge bokeh
	```
</details>
<details><summary><b><a href="https://github.com/mingrammer/diagrams">diagrams</a></b> (🥉31 ·  ⭐ 35K) - Diagram as Code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 140 · 🔀 2.2K · 📦 1.4K · 📋 480 - 60% open · ⏱️ 05.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 160K / month):
	```
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 110 · 🔀 200 · 📦 7.1K · 📋 610 - 10% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/has2k1/plotnine
	```
- [PyPi](https://pypi.org/project/plotnine) (📥 2.9M / month):
	```
	pip install plotnine
	```
- [Conda](https://anaconda.org/conda-forge/plotnine) (📥 340K · ⏱️ 27.03.2024):
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 350 · 📦 4.6K · 📋 1.2K - 22% open · ⏱️ 17.03.2024):

	```
	git clone https://github.com/SciTools/cartopy
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 240K / month):
	```
	pip install cartopy
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 190 · 🔀 610 · 📦 1.5K · 📋 1.4K - 21% open · ⏱️ 21.03.2024):
...
- [PyPi](https://pypi.org/project/vispy) (📥 92K / month):
	...
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 460K · ⏱️ 15.03.2024):
	```
...
<details><summary><b><a href="https://github.com/msiemens/tinydb">tinydb</a></b> (🥇30 ·  ⭐ 6.5K · 💤) - A tiny, document-oriented database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 82 · 🔀 500 · 📦 13K · 📋 310 - 5% open · ⏱️ 24.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/tinydb) (📥 600K / month):
	```
	pip install tinydb
	```
- [Conda](https://anaconda.org/conda-forge/tinydb) (📥 380K · ⏱️ 12.06.2023):
	```
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 88 · 📦 1.3K · 📋 160 - 38% open · ⏱️ 04.03.2024):
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 15 · 🔀 120 · 📦 1.6K · 📋 60 - 30% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 220 · 🔀 1.3K · 📥 1.8K · 📦 25K · 📋 1.5K - 17% open · ⏱️ 08.03.2024):
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 51 · 🔀 200 · 📦 85K · ⏱️ 26.03.2024):
...
- [PyPi](https://pypi.org/project/motor) (📥 1.7M / month):
	...
	pip install motor
	```
- [Conda](https://anaconda.org/conda-forge/motor) (📥 65K · ⏱️ 26.03.2024):
	```
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.4K · 📦 210K · 📋 650 - 1% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/PyMySQL/PyMySQL
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 42M / month):
	```
	pip install PyMySQL
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 440 · 🔀 2.4K · 📋 1.6K - 10% open · ⏱️ 27.03.2024):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 1.2M · ⏱️ 10.03.2024):
	```
	conda install -c conda-forge redis-py
	```
</details>
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥈26 ·  ⭐ 1.2K) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 61 · 🔀 200 · 📦 2.1K · 📋 320 - 15% open · ⏱️ 12.03.2024):

	```
	git clone https://github.com/mymarilyn/clickhouse-driver
	```
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 2.2M / month):
	```
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 200 · 🔀 470 · 📦 6.6K · ⏱️ 26.03.2024):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 210 · 🔀 1K · ⏱️ 27.03.2024):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 21 · 🔀 160 · 📦 830 · 📋 210 - 11% open · ⏱️ 04.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/happybase) (📥 51K / month):
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 180 / month):
	```
...
<details><summary><b><a href="https://github.com/sdispater/pendulum">Pendulum</a></b> (🥇34 ·  ⭐ 6K) - Python datetimes made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 96 · 🔀 360 · 📥 630 · 📦 26K · 📋 520 - 37% open · ⏱️ 16.12.2023):

	```
	git clone https://github.com/sdispater/pendulum
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 28M / month):
	```
	pip install pendulum
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 930K · ⏱️ 07.01.2024):
	```
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 48 · 🔀 190 · 📋 93 - 20% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/timofurrer/maya
	```
- [PyPi](https://pypi.org/project/maya) (📥 99K / month):
	```
	pip install maya
	```
...
<details><summary><b><a href="https://github.com/zachwill/moment">moment</a></b> (🥈21 ·  ⭐ 730 · 💀) - A Python library for dealing with dates/times. Inspired by.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 46 · 📦 950 · 📋 41 - 7% open · ⏱️ 27.11.2020):
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 470 · 📥 35K · 📋 710 - 40% open · ⏱️ 01.03.2024):
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 31 · 📋 10 - 50% open · ⏱️ 02.08.2015):

	```
	git clone https://github.com/KoffeinFlummi/Chronyk
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 640 / month):
	```
	pip install Chronyk
	```
...
<details><summary><b><a href="https://github.com/jazzband/django-debug-toolbar">django-debug-toolbar</a></b> (🥇31 ·  ⭐ 7.9K) - Display various debug information for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 280 · 🔀 900 · 📥 210 · 📦 86K · 📋 880 - 7% open · ⏱️ 21.03.2024):

	```
	git clone https://github.com/jazzband/django-debug-toolbar
	```
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 2.8M / month):
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 38 · 🔀 380 · 📥 16K · 📦 3.8K · 📋 340 - 43% open · ⏱️ 27.02.2024):
...
- [GitHub](https://github.com/pallets-eco/flask-debugtoolbar) (👨‍💻 54 · 🔀 140 · 📦 26K · 📋 120 - 30% open · ⏱️ 20.03.2024):
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 180 · 📦 21 · 📋 120 - 43% open · ⏱️ 01.02.2024):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 980K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 34K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 99 · 🔀 480 · 📦 7.2K · 📋 250 - 29% open · ⏱️ 14.03.2024):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 4M / month):
	```
	pip install pyelftools
	```
- [Conda](https://anaconda.org/conda-forge/pyelftools) (📥 150K · ⏱️ 14.03.2024):
	```
	conda install -c conda-forge pyelftools
	```
</details>
<details><summary><b><a href="https://github.com/inducer/pudb">pudb</a></b> (🥈25 ·  ⭐ 2.9K) - A full-screen, console-based Python debugger. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/inducer/pudb) (👨‍💻 95 · 🔀 220 · 📦 6.1K · 📋 320 - 44% open · ⏱️ 21.02.2024):
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 41 · 🔀 68 · 📦 5.5K · 📋 200 - 38% open · ⏱️ 14.07.2022):
...
- [GitHub](https://github.com/rkern/line_profiler) (👨‍💻 14 · 🔀 250 · 📦 850 · 📋 140 - 36% open · ⏱️ 23.04.2019):

	```
	git clone https://github.com/rkern/line_profiler
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 520K / month):
	```
	pip install line_profiler
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 580K · ⏱️ 27.09.2023):
	```
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 150 · 📦 120 · 📋 86 - 33% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 5.8K / month):
	```
	pip install vprof
	```
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 400 · 📋 67 - 58% open · ⏱️ 05.03.2016):
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 10K / month):
	```
	pip install pyflame
	```
...
<details><summary><b><a href="https://github.com/ionelmc/python-hunter">python-hunter</a></b> (🥉19 ·  ⭐ 780 · 💤) - A flexible code tracing toolkit. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 45 · 📦 170 · 📋 97 - 44% open · ⏱️ 26.04.2023):

	```
	git clone https://github.com/ionelmc/python-hunter
	```
- [PyPi](https://pypi.org/project/python-hunter) (📥 170 / month):
	```
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 1.6M / month):
	```
	pip install memory_profiler
	```
- [Conda](https://anaconda.org/conda-forge/memory_profiler) (📥 510K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.6K · 🔀 72K · 📦 350K · 📋 39K - 4% open · ⏱️ 28.03.2024):
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥈35 ·  ⭐ 77K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 4.7K · 🔀 20K · 📥 37K · 📦 410K · 📋 41K - 31% open · ⏱️ 28.03.2024):
...
- [PyPi](https://pypi.org/project/pytorch) (📥 230K / month):
	...
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 2.9M · ⏱️ 25.03.2024):
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.3K · 🔀 19K · 📋 12K - 1% open · ⏱️ 27.03.2024):
...
- [PyPi](https://pypi.org/project/keras) (📥 18M / month):
	...
	pip install keras
	```
- [Conda](https://anaconda.org/conda-forge/keras) (📥 3.4M · ⏱️ 22.03.2024):
	```
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 27K · 📦 7.1K · 📋 9.6K - 18% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 560K / month):
	```
	pip install mxnet
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 760 · 📥 340 · ⏱️ 22.05.2020):

	```
	git clone https://github.com/SerpentAI/SerpentAI
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 36 / month):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇38 ·  ⭐ 9.9K) - A cross-platform process and system utilities module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 200 · 🔀 1.3K · 📦 460K · 📋 1.7K - 15% open · ⏱️ 15.03.2024):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 100M / month):
	```
	pip install psutil
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.8K · 🔀 23K · 📦 33K · 📋 32K - 1% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/ansible/ansible
	```
- [PyPi](https://pypi.org/project/ansible) (📥 5.5M / month):
	```
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 1M · ⏱️ 28.03.2024):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.3K · 📥 18K · 📦 760 · 📋 26K - 9% open · ⏱️ 22.03.2024):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 48K / month):
	```
	pip install salt
	```
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 180 · 🔀 1.2K · 📦 10K · 📋 1.2K - 11% open · ⏱️ 02.03.2024):
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 140 · 📦 9.2K · 📋 100 - 14% open · ⏱️ 24.10.2022):

	```
	git clone https://github.com/nickstenning/honcho
	```
- [PyPi](https://pypi.org/project/honcho) (📥 300K / month):
	```
	pip install honcho
	```
- [Conda](https://anaconda.org/conda-forge/honcho) (📥 110 · ⏱️ 08.01.2024):
	```
	conda install -c conda-forge honcho
	```
</details>
<details><summary><b><a href="https://github.com/fabric/fabric">fabric</a></b> (🥉25 ·  ⭐ 15K) - A simple, Pythonic tool for remote execution and deployment. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 19 · 🔀 1.7K · 📦 21 · 📋 1.7K - 24% open · ⏱️ 26.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/fabric) (📥 6.5M / month):
	```
	pip install fabric
	```
- [Conda](https://anaconda.org/conda-forge/fabric) (📥 87K · ⏱️ 31.08.2023):
	```
	conda install -c conda-forge fabric
	```
</details>
<details><summary><b><a href="https://github.com/pyinfra-dev/pyinfra">pyinfra</a></b> (🥉25 ·  ⭐ 2.6K) - A versatile CLI tools and python libraries to automate infrastructure. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyinfra-dev/pyinfra) (👨‍💻 110 · 🔀 320 · 📦 100 · 📋 710 - 21% open · ⏱️ 09.03.2024):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 63K / month):
	```
	pip install pyinfra
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 610 · 🔀 2.3K · 📦 2.4K · 📋 980 - 9% open · ⏱️ 23.01.2024):
...
- [PyPi](https://pypi.org/project/luigi) (📥 440K / month):
	...
	pip install luigi
	```
- [Conda](https://anaconda.org/conda-forge/luigi) (📥 690K · ⏱️ 15.01.2024):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 600 · 🔀 1.6K · 📦 59K · 📋 5K - 17% open · ⏱️ 27.03.2024):
...
- [PyPi](https://pypi.org/project/dask) (📥 7.4M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 11M · ⏱️ 18.03.2024):
	```
	conda install -c conda-forge dask
	```
</details>
<details><summary><b><a href="https://github.com/ray-project/ray">Ray</a></b> (🥈26 ·  ⭐ 31K) - A system for parallel and distributed Python that unifies the machine.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ray-project/ray) (🔀 5.1K · 📥 210 · 📦 14K · 📋 17K - 18% open · ⏱️ 28.03.2024):
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 45 · 🔀 210 · 📦 64 · 📋 330 - 19% open · ⏱️ 18.07.2022):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 470 · 🔀 1.8K · 📥 740K · 📦 56K · 📋 5.2K - 5% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 2.3M / month):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 33 · 🔀 260 · 📦 1.2K · 📋 1.4K - 0% open · ⏱️ 20.03.2024):
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 41 · 🔀 90 · 📥 730 · 📋 120 - 35% open · ⏱️ 05.02.2024):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 31K / month):
	```
	pip install shiv
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.9K · 📦 370K · 📋 6.8K - 16% open · ⏱️ 28.03.2024):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 49 · 🔀 180 · 📦 2.7K · 📋 360 - 5% open · ⏱️ 01.03.2024):
...
- [PyPi](https://pypi.org/project/pdoc) (📥 230K / month):
	...
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 38K · ⏱️ 18.01.2024):
	```
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 140 · 📦 320 · 📋 59 - 52% open · ⏱️ 20.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pycco) (📥 3.6K / month):
	```
	pip install pycco
	```
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥇27 ·  ⭐ 8.2K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 69 · 🔀 1.7K · 📦 520 · ⏱️ 28.03.2024):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 130K / month):
	```
	pip install akshare
	```
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.3M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd):
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 200 · 📦 46 · 📋 140 - 61% open · ⏱️ 06.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 39K / month):
	```
	pip install s4cmd
	```
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 27 · 🔀 180 · 📦 2.5K · 📋 92 - 35% open · ⏱️ 04.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/forex-python) (📥 320K / month):
	```
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 33 · 📦 320 · 📋 24 - 29% open · ⏱️ 04.09.2016):
...
- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 12 · 📥 7 · 📦 77 · 📋 7 - 57% open · ⏱️ 22.12.2020):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 260 · 🔀 1.5K · 📥 4.4M · 📦 28K · 📋 18K - 6% open · ⏱️ 27.03.2024):
...
- [PyPi](https://pypi.org/project/spyder) (📥 84K / month):
	...
	pip install spyder
	```
- [Conda](https://anaconda.org/conda-forge/spyder):
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 95 · 🔀 250 · 📦 210 · 📋 1.6K - 22% open · ⏱️ 09.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 1.7K / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 190 · 🔀 2.7K · 📋 3.2K - 0% open · ⏱️ 20.03.2024):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 84 · 🔀 660 · 📥 34K · 📋 4.9K - 1% open · ⏱️ 18.03.2024):
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 32 · 🔀 260 · 📦 4K · 📋 230 - 43% open · ⏱️ 28.09.2022):
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 370 · 📦 42 · 📋 1.8K - 4% open · ⏱️ 20.03.2024):
...
- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 59 · 📥 160 · 📦 320 · 📋 73 - 26% open · ⏱️ 05.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/mailer) (📥 100K / month):
	```
	pip install mailer
	```
...
<details><summary><b><a href="https://github.com/moggers87/salmon">salmon</a></b> (🥉13 ·  ⭐ 630 · 💤) - A Python Mail Server. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 110 · 🔀 960 · 📦 370K · 📋 1.3K - 1% open · ⏱️ 22.03.2024):
...
- [PyPi](https://pypi.org/project/virtualenv) (📥 120M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 6.3M · ⏱️ 22.02.2024):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 440 · 🔀 2.9K · 📦 21 · 📋 1.7K - 2% open · ⏱️ 21.03.2024):
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 150 · 🔀 670 · 📦 140K · 📋 640 - 27% open · ⏱️ 12.02.2024):

	```
	git clone https://github.com/gorakhargosh/watchdog
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 21M / month):
	```
	pip install watchdog
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 2.8M · ⏱️ 07.02.2024):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 61 · 🔀 250 · 📦 55K · 📋 200 - 6% open · ⏱️ 09.10.2023):

	```
	git clone https://github.com/ahupp/python-magic
	```
- [PyPi](https://pypi.org/project/python-magic) (📥 9.1M / month):
	```
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 53 · 🔀 140 · 📋 140 - 2% open · ⏱️ 07.02.2024):

	```
	git clone https://github.com/jaraco/path.py
	```
- [PyPi](https://pypi.org/project/path.py) (📥 390K / month):
	```
	pip install path.py
	```
- [Conda](https://anaconda.org/conda-forge/path.py):
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 39 · 📦 9.6K · 📋 17 - 35% open · ⏱️ 14.02.2015):
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 160 · 🔀 390 · 📦 210K · 📋 450 - 11% open · ⏱️ 22.03.2024):

	```
	git clone https://github.com/wtforms/wtforms
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 5.7M / month):
	```
	pip install wtforms
	```
- [Conda](https://anaconda.org/conda-forge/wtforms) (📥 210K · ⏱️ 21.02.2024):
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 700 · 📦 140K · 📋 680 - 7% open · ⏱️ 03.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 1.2M / month):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 160K · 📋 160 - 11% open · ⏱️ 25.03.2024):
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 99 · 🔀 670 · 📦 19K · 📋 300 - 1% open · ⏱️ 25.03.2024):

	```
	git clone https://github.com/dyve/django-bootstrap3
	```
- [PyPi](https://pypi.org/project/django-bootstrap3) (📥 140K / month):
	```
	pip install django-bootstrap3
	```
- [Conda](https://anaconda.org/conda-forge/django-bootstrap3):
	```
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 86 · 📦 23 · 📋 16 - 75% open · ⏱️ 12.07.2017):
	...
	```
- [PyPi](https://pypi.org/project/django-remote-forms) (📥 49 / month):
	```
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 120 · 🔀 260 · 📥 2.9K · 📦 220K · 📋 300 - 4% open · ⏱️ 21.03.2024):

	```
	git clone https://github.com/erikrose/more-itertools
	```
- [PyPi](https://pypi.org/project/more-itertools) (📥 77M / month):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 77 · 🔀 240 · 📦 140K · 📋 220 - 36% open · ⏱️ 24.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/toolz) (📥 33M / month):
	```
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 20M · ⏱️ 24.01.2024):
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 49 · 🔀 110 · 📦 530 · 📋 410 - 13% open · ⏱️ 26.03.2024):
...
- [PyPi](https://pypi.org/project/returns) (📥 200K / month):
	...
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 8.6K · ⏱️ 28.08.2023):
	```
	conda install -c conda-forge returns
	```
</details>
<details><summary><b><a href="https://github.com/evhub/coconut">Coconut</a></b> (🥉23 ·  ⭐ 3.9K) - A variant of Python built for simple, elegant, Pythonic functional.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/evhub/coconut) (👨‍💻 34 · 🔀 120 · 📋 720 - 10% open · ⏱️ 02.03.2024):

	```
	git clone https://github.com/evhub/coconut
	```
- [PyPi](https://pypi.org/project/coconut) (📥 3K / month):
	```
	pip install coconut
	```
...
<details><summary><b><a href="https://github.com/pytoolz/cytoolz">CyToolz</a></b> (🥉21 ·  ⭐ 970) - Cython implementation of `Toolz`: High performance functional.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 190 · 📦 490 · 📋 50 - 48% open · ⏱️ 13.10.2014):
	...
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 1.5K / month):
	```
	pip install fn.py
	```
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇32 ·  ⭐ 1.7K) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 160 · 🔀 280 · 📦 25K · 📋 570 - 15% open · ⏱️ 26.03.2024):
...
<details><summary><b><a href="https://github.com/chriskiehl/Gooey">Gooey</a></b> (🥈27 ·  ⭐ 20K · 💀) - Turn command line programs into a full GUI application with one line. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 980 · 📥 610 · 📦 890 · 📋 600 - 22% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 7.5K / month):
	```
	pip install Gooey
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 3 · 🔀 1.8K · 📦 11K · 📋 3.6K - 20% open · ⏱️ 23.03.2024):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 790K / month):
	```
...
- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 46 · 🔀 560 · 📦 7.1K · 📋 530 - 35% open · ⏱️ 04.03.2023):
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 640 · 📦 2.8K · 📋 1.3K - 20% open · ⏱️ 15.03.2024):
...
<details><summary><b><a href="https://github.com/r0x0r/pywebview">pywebview</a></b> (🥉24 ·  ⭐ 4.2K) - A lightweight cross-platform native wrapper around a webview.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/r0x0r/pywebview) (🔀 500 · 📦 1.8K · 📋 910 - 1% open · ⏱️ 22.03.2024):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 260 · 🔀 630 · 📥 2.7K · 📦 3 · 📋 840 - 17% open · ⏱️ 24.03.2024):

	```
	git clone https://github.com/pybee/toga
	```
- [PyPi](https://pypi.org/project/toga) (📥 3.8K / month):
	```
	pip install toga
	```
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 770 · 📦 230 · 📋 240 - 17% open · ⏱️ 12.02.2024):

	```
	git clone https://github.com/nucleic/enaml
	```
- [PyPi](https://pypi.org/project/enaml) (📥 6.9K / month):
	```
	pip install enaml
	```
- [Conda](https://anaconda.org/conda-forge/enaml):
	```
...
<details><summary><b><a href="https://github.com/graphql-python/graphene">graphene</a></b> (🥇25 ·  ⭐ 8K) - GraphQL framework for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/tartiflette/tartiflette-aiohttp) (🔀 10 · 📦 53 · 📋 19 - 21% open · ⏱️ 07.09.2022):
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 130 · 🔀 610 · 📥 23 · 📋 280 - 9% open · ⏱️ 23.11.2023):
...
- [PyPi](https://pypi.org/project/geopy) (📥 5.1M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy):
	```
	conda install -c conda-forge geopy
	```
</details>
<details><summary><b><a href="https://github.com/SmileyChris/django-countries">django-countries</a></b> (🥈21 ·  ⭐ 1.4K) - A Django app that provides a country field for models and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 55 · 🔀 270 · 📋 290 - 7% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/SmileyChris/django-countries
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 780K / month):
	```
	pip install django-countries
	```
- [Conda](https://anaconda.org/conda-forge/django-countries) (📥 4.4K · ⏱️ 27.03.2024):
	```
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 56 · 🔀 120 · 📦 17K · 📋 98 - 24% open · ⏱️ 25.03.2024):
...
<details><summary><b><a href="https://github.com/pallets/markupsafe">MarkupSafe</a></b> (🥇33 ·  ⭐ 590) - Implements a XML/HTML/XHTML Markup safe string for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 43 · 🔀 140 · 📥 4.4K · 📦 1.6M · 📋 110 - 0% open · ⏱️ 12.03.2024):
...
<details><summary><b><a href="https://github.com/martinblech/xmltodict">xmltodict</a></b> (🥈32 ·  ⭐ 5.4K · 💤) - Working with XML feel like you are working with JSON. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 450 · 📦 64K · 📋 240 - 33% open · ⏱️ 12.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/xmltodict) (📥 46M / month):
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 79 · 🔀 230 · 📦 310K · 📋 370 - 1% open · ⏱️ 01.02.2024):

	```
	git clone https://github.com/mozilla/bleach
	```
- [PyPi](https://pypi.org/project/bleach) (📥 23M / month):
	```
	pip install bleach
	```
...
<details><summary><b><a href="https://github.com/gawel/pyquery">pyquery</a></b> (🥈28 ·  ⭐ 2.3K · 💤) - A jQuery-like library for parsing HTML. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 53 · 🔀 180 · 📦 23K · 📋 190 - 29% open · ⏱️ 31.07.2023):
...
- [PyPi](https://pypi.org/project/pyquery) (📥 3.6M / month):
	...
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 60K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 750 · 🔀 8.9K · 📥 9.5K · 📦 2.8M · 📋 3.9K - 5% open · ⏱️ 18.03.2024):

	```
	git clone https://github.com/psf/requests
	```
- [PyPi](https://pypi.org/project/requests) (📥 440M / month):
	```
	pip install requests
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 41M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 220 · 🔀 770 · 📦 180K · 📋 820 - 3% open · ⏱️ 21.03.2024):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 56M / month):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 1.4M · ⏱️ 21.02.2024):
	```
	conda install -c conda-forge httpx
	```
</details>
<details><summary><b><a href="https://github.com/urllib3/urllib3">urllib3</a></b> (🥈37 ·  ⭐ 3.7K) - A HTTP library with thread-safe connection pooling, file post support,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 350 · 🔀 1.1K · 📥 36K · 📦 1.7M · 📋 1.2K - 9% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/shazow/urllib3
	```
- [PyPi](https://pypi.org/project/urllib3) (📥 510M / month):
	```
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 44M · ⏱️ 18.02.2024):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 77 · 🔀 180 · 📦 180K · 📋 120 - 40% open · ⏱️ 21.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/httplib2) (📥 39M / month):
	```
	pip install httplib2
	```
- [Conda](https://anaconda.org/conda-forge/httplib2) (📥 3M · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge httplib2
	```
</details>
<details><summary><b><a href="https://github.com/spyoungtech/grequests">grequests</a></b> (🥉28 ·  ⭐ 4.4K · 💤) - requests + gevent for asynchronous HTTP requests. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 300 · 📥 13 · 📦 4.3K · 📋 120 - 4% open · ⏱️ 08.06.2023):

	```
	git clone https://github.com/spyoungtech/grequests
	```
- [PyPi](https://pypi.org/project/grequests) (📥 490K / month):
	```
...
<details><summary><b><a href="https://github.com/twisted/treq">treq</a></b> (🥉22 ·  ⭐ 580) - Python requests like API built on top of Twisted's HTTP client. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 51 · 🔀 130 · 📥 260 · 📦 1.6K · 📋 160 - 35% open · ⏱️ 06.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/treq) (📥 110K / month):
	```
	pip install treq
	```
...
<details><summary><b><a href="https://github.com/secdev/scapy">scapy</a></b> (🥇33 ·  ⭐ 10K) - A brilliant packet manipulation library. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/secdev/scapy) (👨‍💻 460 · 🔀 1.9K · 📦 14K · 📋 1.6K - 4% open · ⏱️ 24.03.2024):
...
- [PyPi](https://pypi.org/project/scapy) (📥 2.3M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy):
	```
	conda install -c conda-forge scapy
	```
</details>
<details><summary><b><a href="https://github.com/boppreh/keyboard">keyboard</a></b> (🥈29 ·  ⭐ 3.7K · 💀) - Hook and simulate global keyboard events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 420 · 📦 16K · 📋 570 - 65% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 330K / month):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 9 · 🔀 130 · 📦 1.4K · 📋 120 - 75% open · ⏱️ 26.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/mouse) (📥 54K / month):
	```
	pip install mouse
	```
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 570 · 📋 100 - 70% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 620 · 📋 64 - 51% open · ⏱️ 20.03.2017):
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 460 · 🔀 2K · 📦 1.6M · 📋 3K - 2% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/python-pillow/Pillow
	```
- [PyPi](https://pypi.org/project/Pillow) (📥 92M / month):
	```
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 37M · ⏱️ 03.01.2024):
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 200 · 📥 44K · 📦 19K · 📋 420 - 4% open · ⏱️ 11.02.2024):

	```
	git clone https://github.com/dahlia/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 910K / month):
	```
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 38K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 200 · 🔀 800 · 📦 350 · 📋 980 - 1% open · ⏱️ 04.03.2024):
...
<details><summary><b><a href="https://github.com/WhyNotHugo/python-barcode">python-barcode</a></b> (🥈26 ·  ⭐ 520) - Create barcodes in Python with no extra dependencies. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 49 · 🔀 120 · 📥 340 · 📦 19K · 📋 110 - 36% open · ⏱️ 09.03.2024):

	```
	git clone https://github.com/WhyNotHugo/python-barcode
	```
- [PyPi](https://pypi.org/project/python-barcode) (📥 430K / month):
	```
...
<details><summary><b><a href="https://github.com/dylanaraps/pywal">pywal</a></b> (🥈25 ·  ⭐ 8K · 💀) - A tool that generates color schemes from images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 16 · 🔀 51 · 📦 680 · 📋 400 - 41% open · ⏱️ 07.03.2024):

	```
	git clone https://github.com/libvips/pyvips
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 44K / month):
	```
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 75K · ⏱️ 26.09.2023):
	```
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 56 · 🔀 610 · 📋 230 - 30% open · ⏱️ 05.02.2023):
...
<details><summary><b><a href="https://github.com/rossgoodwin/hmap">hmap</a></b> (🥉10 ·  ⭐ 210 · 💀) - Image histogram remapping. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 2 · 🔀 23 · ⏱️ 04.11.2019):
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 620 · 🔀 5.3K · 📥 75K · 📋 5.2K - 27% open · ⏱️ 28.03.2024):
...
<details><summary><b><a href="https://github.com/IronLanguages/ironpython3">IronPython</a></b> (🥈22 ·  ⭐ 2.4K) - Implementation of the Python programming language written in C#. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 34 · 🔀 270 · 📥 97K · 📋 610 - 44% open · ⏱️ 29.01.2024):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.9K · 🔀 28K · 📦 4 · 📋 67K - 10% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 51 / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📦 20 · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 810K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 67 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 820 / month):
	```
	pip install Pyjion
	```
...
<details><summary><b><a href="https://github.com/Maratyszcza/PeachPy">PeachPy</a></b> (🥉14 ·  ⭐ 1.9K · 💀) - x86-64 assembler embedded in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 25 · 🔀 160 · 📋 89 - 26% open · ⏱️ 13.11.2022):
...
- [GitHub](https://github.com/metawilm/cl-python) (👨‍💻 12 · 🔀 34 · 📋 18 - 11% open · ⏱️ 26.10.2023):
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 60 · 🔀 280 · 📦 2.9K · 📋 390 - 57% open · ⏱️ 28.02.2024):

	```
	git clone https://github.com/jonathanslenders/ptpython
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 810K / month):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 230 · 📋 790 - 17% open · ⏱️ 06.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/bpython) (📥 180K / month):
	```
	pip install bpython
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 50 · 📦 4.4K · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 360K / month):
	```
	pip install pyicu
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 230 · 🔀 1.4K · 📦 4.6K · 📋 4.6K - 13% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 850K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 610K · ⏱️ 23.03.2024):
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 59 · 🔀 860 · 📦 33K · 📋 430 - 31% open · ⏱️ 10.12.2023):
...
- [PyPi](https://pypi.org/project/schedule) (📥 2.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 52K · ⏱️ 02.10.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 53 · 🔀 300 · 📦 68 · 📋 130 - 3% open · ⏱️ 20.03.2024):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 7.1K / month):
	```
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 91 · 📦 86 · 📋 9 - 11% open · ⏱️ 14.05.2020):
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 53 · 🔀 660 · 📦 79K · 📋 940 - 16% open · ⏱️ 02.03.2024):
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 210 · 🔀 440 · 📥 3.7K · 📋 1.2K - 14% open · ⏱️ 28.03.2024):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 640 · 🔀 8.2K · 📥 8.2K · 📦 85K · 📋 5.1K - 7% open · ⏱️ 26.03.2024):
...
- [GitHub](https://github.com/numenta/nupic-legacy) (👨‍💻 120 · 🔀 1.6K · 📥 6 · 📦 21 · 📋 1.8K - 25% open · ⏱️ 31.08.2023):
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 260 · 🔀 2K · 📦 21 · 📋 9.2K - 28% open · ⏱️ 26.03.2024):
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉21 ·  ⭐ 21K) - MindsDB is an open source AI layer for existing databases that.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 820 · 🔀 2.6K · 📋 3.7K - 9% open · ⏱️ 28.03.2024):
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 3.9K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 100 · 🔀 600 · 📥 2.7K · 📦 2.2K · 📋 1.4K - 8% open · ⏱️ 28.02.2024):

	```
	git clone https://github.com/pythonnet/pythonnet
	```
- [PyPi](https://pypi.org/project/pythonnet) (📥 400K / month):
	```
	pip install pythonnet
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 95K · ⏱️ 11.10.2023):
	```
	conda install -c conda-forge pythonnet
	```
</details>
<details><summary><b><a href="https://github.com/mhammond/pywin32">PyWin32</a></b> (🥉28 ·  ⭐ 4.8K) - Python Extensions for Windows. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 92 · 🔀 770 · 📥 660K · 📦 180K · 📋 1.8K - 20% open · ⏱️ 25.03.2024):

	```
	git clone https://github.com/mhammond/pywin32
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 9.6M / month):
	```
	pip install pywin32
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 210 · 📦 1M · 📋 110 - 0% open · ⏱️ 06.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 65M / month):
	```
	pip install itsdangerous
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 6.9M · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge itsdangerous
	```
</details>
<details><summary><b><a href="https://github.com/pallets-eco/blinker">blinker</a></b> (🥈32 ·  ⭐ 1.7K) - A fast Python in-process signal/event dispatching system. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 19 · 🔀 170 · 📥 35 · 📦 310K · 📋 47 - 4% open · ⏱️ 01.11.2023):
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 89 · 🔀 350 · 📥 25 · 📦 6.7K · 📋 160 - 33% open · ⏱️ 24.03.2024):
...
- [PyPi](https://pypi.org/project/boltons) (📥 4.1M / month):
	...
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 4.3M · ⏱️ 21.12.2023):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 160 · 🔀 3.6K · 📦 500 · 📋 950 - 38% open · ⏱️ 11.07.2023):
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 2.3K · 📋 15 - 20% open · ⏱️ 16.05.2021):

	```
	git clone https://github.com/mitsuhiko/pluginbase
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 790K / month):
	```
...
- [GitHub](https://github.com/piskvorky/gensim) (👨‍💻 450 · 🔀 4.2K · 📥 4.6K · 📦 57K · 📋 1.8K - 20% open · ⏱️ 08.02.2024):

	```
	git clone https://github.com/RaRe-Technologies/gensim
	```
- [PyPi](https://pypi.org/project/gensim) (📥 5.1M / month):
	```
	pip install gensim
	```
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 49 · 🔀 6.5K · 📦 27K · 📋 840 - 73% open · ⏱️ 15.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jieba) (📥 840K / month):
	```
	pip install jieba
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 110 · 📦 1.7K · 📋 210 - 63% open · ⏱️ 25.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/pattern) (📥 640K / month):
	```
	pip install pattern
	```
- [Conda](https://anaconda.org/conda-forge/pattern) (📥 16K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 68 · 🔀 840 · 📦 2.6K · 📋 870 - 10% open · ⏱️ 01.03.2024):

	```
	git clone https://github.com/stanfordnlp/stanza
	```
- [PyPi](https://pypi.org/project/stanza) (📥 240K / month):
	```
	pip install stanza
	```
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.4K · 📦 1.3K · 📋 110 - 39% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 28K / month):
	```
	pip install snownlp
	```
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 330 · 📦 1.2K · 📋 220 - 69% open · ⏱️ 22.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 67K / month):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 260 · 📦 660 · 📋 69 - 27% open · ⏱️ 04.07.2023):

	```
	git clone https://github.com/PetrochukM/PyTorch-NLP
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 7K / month):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 960 · 📥 170K · 📦 300 · 📋 160 - 75% open · ⏱️ 08.06.2022):
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉17 ·  ⭐ 63K · 💤) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 13 · 🔀 13K · 📋 71 - 33% open · ⏱️ 24.08.2023):
...
<details><summary><b><a href="https://github.com/facebookresearch/pytext">pytext</a></b> (🥉16 ·  ⭐ 6.3K · 💀) - A natural language modeling framework based on PyTorch. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 81 · 🔀 1.7K · 📥 580K · 📦 300 · 📋 700 - 37% open · ⏱️ 17.09.2023):
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 520 · 📦 1.5K · 📋 620 - 20% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/napalm-automation/napalm
	```
- [PyPi](https://pypi.org/project/napalm) (📥 52K / month):
	```
	pip install napalm
	```
...
- [PyPi](https://pypi.org/project/pox) (📥 17M / month):
	...
	pip install pox
	```
- [Conda](https://anaconda.org/conda-forge/pox) (📥 410K · ⏱️ 28.01.2024):
	```
...
<details><summary><b><a href="https://github.com/justquick/django-activity-stream">django-activity-stream</a></b> (🥇27 ·  ⭐ 2.3K) - Generating generic activity streams from the actions.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 9 · 📦 1.2K · 📋 310 - 5% open · ⏱️ 04.10.2023):

	```
	git clone https://github.com/justquick/django-activity-stream
	```
- [PyPi](https://pypi.org/project/django-activity-stream) (📥 75K / month):
	```
...
- [GitHub](https://github.com/tschellenbach/Stream-Framework) (👨‍💻 26 · 🔀 520 · 📋 180 - 35% open · ⏱️ 15.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/Stream-Framework) (📥 710 / month):
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 28K · ⏱️ 25.03.2024):
...
- [PyPi](https://pypi.org/project/peewee) (📥 2.4M / month):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 610K · ⏱️ 05.02.2024):
	```
	conda install -c conda-forge peewee
	```
</details>
<details><summary><b><a href="https://github.com/MongoEngine/mongoengine">mongoengine</a></b> (🥈35 ·  ⭐ 4.2K) - A Python Object-Document-Mapper for working with MongoDB. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 390 · 🔀 1.2K · 📦 23K · 📋 1.7K - 20% open · ⏱️ 10.03.2024):
...
- [PyPi](https://pypi.org/project/mongoengine) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mongoengine) (📥 240K · ⏱️ 28.09.2023):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 110 · 🔀 420 · 📦 1.6K · 📋 600 - 37% open · ⏱️ 16.02.2024):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 530K · ⏱️ 17.01.2024):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 78 · 🔀 290 · 📦 3.7K · 📋 290 - 9% open · ⏱️ 12.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/dataset) (📥 130K / month):
	```
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 8.1K · ⏱️ 12.07.2023):
	```
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 32 · 🔀 160 · 📦 590 · 📋 320 - 42% open · ⏱️ 13.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/orator) (📥 22K / month):
	```
	pip install orator
	```
- [Conda](https://anaconda.org/conda-forge/orator) (📥 3.2K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 240 · 📥 93 · 📦 3.9K · 📋 630 - 47% open · ⏱️ 25.09.2023):
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 18 · 🔀 97 · 📦 510 · 📋 80 - 20% open · ⏱️ 30.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/orm) (📥 7.9K / month):
	```
	pip install orm
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 210 · 🔀 530 · 📦 27K · 📋 1K - 14% open · ⏱️ 25.03.2024):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 14M / month):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 550 · 🔀 2.2K · 📥 15M · 📋 5.6K - 10% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 35M / month):
	```
	pip install poetry
	```
...
<details><summary><b><a href="https://github.com/conda/conda">conda</a></b> (🥉22 ·  ⭐ 6.1K) - Cross-platform, Python-agnostic binary package manager. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/conda/conda) (🔀 1.5K · 📥 230 · 📦 46K · 📋 9.5K - 6% open · ⏱️ 26.03.2024):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇20 ·  ⭐ 820) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/pypi/warehouse">warehouse</a></b> (🥈15 ·  ⭐ 3.5K) - Next generation Python Package Repository (PyPI). <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 380 · 🔀 880 · 📋 3.2K - 13% open · ⏱️ 28.03.2024):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 120 · 📋 260 - 17% open · ⏱️ 25.03.2024):
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉23 ·  ⭐ 10K · 💀) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.8K · 📦 21 · 📋 140 - 34% open · ⏱️ 06.09.2022):
...
<details><summary><b><a href="https://github.com/django-guardian/django-guardian">django-guardian</a></b> (🥇28 ·  ⭐ 3.5K · 💀) - Implementation of per object permissions for Django.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 31 · 🔀 140 · 📦 1.6K · 📋 110 - 21% open · ⏱️ 25.03.2024):

	```
	git clone https://github.com/dfunckt/django-rules
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 440 / month):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 98 · 🔀 480 · 📦 14K · 📋 470 - 1% open · ⏱️ 13.03.2024):

	```
	git clone https://github.com/amoffat/sh
	```
- [PyPi](https://pypi.org/project/sh) (📥 6.8M / month):
	```
	pip install sh
	```
...
- [GitHub](https://github.com/amitt001/delegator.py) (👨‍💻 23 · 🔀 89 · 📦 590 · 📋 45 - 17% open · ⏱️ 06.05.2019):

	```
	git clone https://github.com/amitt001/delegator.py
	```
- [PyPi](https://pypi.org/project/delegator.py) (📥 46K / month):
	```
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 88 · 🔀 1.1K · 📦 3.7K · 📋 390 - 12% open · ⏱️ 20.08.2023):
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 580 · 📥 710 · 📦 1.3K · 📋 480 - 16% open · ⏱️ 21.11.2023):
...
<details><summary><b><a href="https://github.com/NicolasHug/Surprise">Surprise</a></b> (🥉21 ·  ⭐ 6.2K · 💀) - A scikit for building and analyzing recommender systems. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 34 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 390 / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 600 · 📦 120 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 590 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 81 · 🔀 160 · 📥 28 · 📦 73K · 📋 350 - 27% open · ⏱️ 24.03.2024):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 930K / month):
	```
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 1.4M · ⏱️ 24.03.2024):
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥇40 ·  ⭐ 70K · 📈) - A modern, fast, web framework for building APIs with Python 3.6+ based.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 600 · 🔀 5.8K · 📦 330K · 📋 3.4K - 1% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 33M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 2M · ⏱️ 25.02.2024):
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 900 · 📥 7.2K · 📦 9K · 📋 1K - 15% open · ⏱️ 21.03.2024):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 970K / month):
	```
	pip install falcon
	```
...
<details><summary><b><a href="https://github.com/flask-restful/flask-restful">flask-restful</a></b> (🥈33 ·  ⭐ 6.8K · 💤) - Quickly building REST APIs for Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 1K · 📦 110K · 📋 560 - 17% open · ⏱️ 21.05.2023):

	```
	git clone https://github.com/flask-restful/flask-restful
	```
- [PyPi](https://pypi.org/project/flask-restful) (📥 2M / month):
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 340 · 🔀 1.5K · 📦 17K · 📋 1.4K - 6% open · ⏱️ 24.03.2024):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 910K / month):
	```
	pip install sanic
	```
- [Conda](https://anaconda.org/conda-forge/sanic) (📥 320K · ⏱️ 09.01.2024):
	```
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 91 · 🔀 400 · 📦 760 · 📋 310 - 7% open · ⏱️ 31.08.2021):
...
- [GitHub](https://github.com/Cornices/cornice) (👨‍💻 120 · 🔀 140 · 📦 860 · 📋 240 - 20% open · ⏱️ 08.02.2024):
...
- [PyPi](https://pypi.org/project/cornice) (📥 46K / month):
	...
	pip install cornice
	```
- [Conda](https://anaconda.org/conda-forge/cornice) (📥 240 · ⏱️ 14.10.2023):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 120 · 🔀 5.9K · 📦 21 · 📋 340 - 4% open · ⏱️ 25.03.2024):
...
- [PyPi](https://pypi.org/project/zerorpc-python):
	...
	```
- [Conda](https://anaconda.org/conda-forge/zerorpc-python) (📥 3K · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.3K · 🔀 4.1K · 📥 540K · 📦 120K · 📋 13K - 33% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 21M / month):
	```
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 5.1M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 420 · 🔀 2.6K · 📥 30 · 📦 120K · 📋 5.3K - 48% open · ⏱️ 18.03.2024):
...
- [PyPi](https://pypi.org/project/statsmodels) (📥 17M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels):
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4.1K · 📦 990 · 📋 980 - 33% open · ⏱️ 14.10.2020):
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 480 · 🔀 1.8K · 📥 1.9K · 📦 3K · 📋 3.2K - 6% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/pymc-devs/pymc3
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 870K / month):
	```
	pip install pymc3
	```
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 20 · 🔀 230 · 📦 230 · 📋 120 - 4% open · ⏱️ 05.03.2024):
...
- [GitHub](https://github.com/chapmanb/bcbb) (👨‍💻 35 · 🔀 230 · 📦 310 · 📋 79 - 21% open · ⏱️ 29.01.2024):
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 9.6K · 📋 1.2K - 36% open · ⏱️ 26.03.2024):
...
- [PyPi](https://pypi.org/project/django-haystack) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-haystack):
	```
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 71 · 🔀 310 · 📦 3.4K · 📋 150 - 15% open · ⏱️ 19.03.2024):

	```
	git clone https://github.com/django-haystack/pysolr
	```
- [PyPi](https://pypi.org/project/pysolr) (📥 320K / month):
	```
	pip install pysolr
	```
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 780 · 📥 200 · 📦 10K · 📋 1.3K - 9% open · ⏱️ 20.03.2024):
...
<details><summary><b><a href="https://github.com/marshmallow-code/marshmallow">marshmallow</a></b> (🥇32 ·  ⭐ 6.9K) - A lightweight library for converting complex objects to and from.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 210 · 🔀 610 · 📦 130K · 📋 1.2K - 12% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/marshmallow-code/marshmallow
	```
- [PyPi](https://pypi.org/project/marshmallow) (📥 46M / month):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 23 · 🔀 45 · 📦 5.2K · 📋 110 - 10% open · ⏱️ 28.02.2024):
...
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 1.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 1.6M · ⏱️ 28.02.2024):
	```
	conda install -c conda-forge python-rapidjson
	```
</details>
<details><summary><b><a href="https://github.com/TkTech/pysimdjson">pysimdjson</a></b> (🥉24 ·  ⭐ 630) - A Python bindings for.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 50 · 📦 1.3K · 📋 84 - 7% open · ⏱️ 05.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 1M / month):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 88 · 🔀 340 · 📋 340 - 7% open · ⏱️ 01.03.2024):
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📥 320 · 📦 21 · 📋 1.3K - 47% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/Zappa) (📥 160K / month):
	```
	pip install Zappa
	```
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 48 · 🔀 220 · 📦 210 · 📋 92 - 41% open · ⏱️ 03.06.2022):
...
<details><summary><b><a href="https://github.com/xonsh/xonsh">xonsh</a></b> (🥇15 ·  ⭐ 7.9K) - A Python-powered, cross-platform, Unix-gazing shell language and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xonsh/xonsh) (🔀 610 · 📥 9.8K · 📋 2.5K - 11% open · ⏱️ 25.03.2024):
...
<details><summary><b><a href="https://github.com/jazzband/tablib">tablib</a></b> (🥇34 ·  ⭐ 4.5K) - A module for Tabular Datasets in XLS, CSV, JSON, YAML. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 550 · 📦 95K · 📋 250 - 10% open · ⏱️ 23.03.2024):

	```
	git clone https://github.com/jazzband/tablib
	```
- [PyPi](https://pypi.org/project/tablib) (📥 2M / month):
	```
	pip install tablib
	```
- [Conda](https://anaconda.org/conda-forge/tablib) (📥 95K · ⏱️ 24.03.2024):
	```
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 43 · 🔀 240 · 📦 270K · 📋 280 - 10% open · ⏱️ 17.01.2024):

	```
	git clone https://github.com/lepture/mistune
	```
- [PyPi](https://pypi.org/project/mistune) (📥 23M / month):
	```
	pip install mistune
	```
...
<details><summary><b><a href="https://github.com/jmcnamara/XlsxWriter">XlsxWriter</a></b> (🥈32 ·  ⭐ 3.5K) - A Python module for creating Excel .xlsx files. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 52 · 🔀 610 · 📦 75K · 📋 920 - 1% open · ⏱️ 23.02.2024):

	```
	git clone https://github.com/jmcnamara/XlsxWriter
	```
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 18M / month):
	```
...
<details><summary><b><a href="https://github.com/py-pdf/pypdf">PyPDF2</a></b> (🥈31 ·  ⭐ 7.2K) - A library capable of splitting, merging and transforming PDF pages. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 220 · 🔀 1.2K · 📦 72K · 📋 1K - 9% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/mstamy2/PyPDF2
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 6.3M / month):
	```
	pip install PyPDF2
	```
- [Conda](https://anaconda.org/conda-forge/PyPDF2) (📥 530K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 16 · 🔀 930 · 📦 26K · 📋 1.2K - 43% open · ⏱️ 04.11.2023):

	```
	git clone https://github.com/python-openxml/python-docx
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 4.6M / month):
	```
	pip install python-docx
	```
- [Conda](https://anaconda.org/conda-forge/python-docx) (📥 180K · ⏱️ 04.11.2023):
	```
	conda install -c conda-forge python-docx
	```
</details>
<details><summary><b><a href="https://github.com/Python-Markdown/markdown">Python-Markdown</a></b> (🥈29 ·  ⭐ 3.6K) - A Python implementation of John Grubers Markdown. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 170 · 🔀 830 · 📥 57 · 📦 350K · 📋 870 - 2% open · ⏱️ 18.03.2024):
...
- [GitHub](https://github.com/pyexcel/pyexcel) (👨‍💻 21 · 🔀 160 · 📥 190 · 📦 3.9K · 📋 220 - 9% open · ⏱️ 16.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyexcel) (📥 390K / month):
	```
	pip install pyexcel
	```
...
<details><summary><b><a href="https://github.com/wireservice/csvkit">csvkit</a></b> (🥉27 ·  ⭐ 5.8K) - Utilities for converting to and working with CSV. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 110 · 🔀 590 · 📦 1.6K · 📋 900 - 3% open · ⏱️ 27.03.2024):
...
- [PyPi](https://pypi.org/project/csvkit) (📥 200K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit):
	```
...
- [GitHub](https://github.com/euske/pdfminer) (👨‍💻 28 · 🔀 1K · 📦 8.2K · 📋 240 - 82% open · ⏱️ 18.01.2020):
...
- [PyPi](https://pypi.org/project/pdfminer) (📥 220K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pdfminer) (📥 37K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 65 · 🔀 480 · 📥 17K · 📦 31K · 📋 1.8K - 17% open · ⏱️ 26.03.2024):
...
- [PyPi](https://pypi.org/project/xlwings) (📥 180K / month):
	...
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 730K · ⏱️ 27.03.2024):
	```
...
- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 450 · 📋 840 - 46% open · ⏱️ 02.11.2023):
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 57 · 🔀 360 · 📦 2.5K · 📋 430 - 24% open · ⏱️ 12.02.2024):
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 460 · 🔀 1.8K · 📥 1K · 📦 7.7K · 📋 1.6K - 1% open · ⏱️ 27.03.2024):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 240 · 🔀 370 · 📥 100 · 📦 510 · 📋 2.2K - 2% open · ⏱️ 02.03.2024):

	```
	git clone https://github.com/getnikola/nikola
	```
- [PyPi](https://pypi.org/project/nikola) (📥 2.6K / month):
	```
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 11K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.3K · 📦 59K · 📋 1.9K - 6% open · ⏱️ 16.03.2024):
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 150 · 🔀 570 · 📋 430 - 20% open · ⏱️ 07.03.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-taggit) (📥 690K / month):
	```
...
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇33 ·  ⭐ 9.4K) - Simple job queues for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/rq/rq) (👨‍💻 310 · 🔀 1.4K · 📦 16K · 📋 1.1K - 15% open · ⏱️ 23.03.2024):
...
- [PyPi](https://pypi.org/project/rq) (📥 1.9M / month):
	...
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 100K · ⏱️ 26.03.2024):
	```
	conda install -c conda-forge rq
	```
</details>
<details><summary><b><a href="https://github.com/coleifer/huey">huey</a></b> (🥈28 ·  ⭐ 4.9K) - Little multi-threaded task queue. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 360 · 📦 1.4K · ⏱️ 23.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/huey) (📥 94K / month):
	```
	pip install huey
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 100 · 🔀 280 · 📥 40 · 📦 1.1K · 📋 360 - 14% open · ⏱️ 10.02.2024):
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇25 ·  ⭐ 9.9K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 570 · 🔀 1.8K · 📦 210K · 📋 700 - 1% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 15M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 900K · ⏱️ 26.03.2024):
	```
	conda install -c conda-forge faker
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇35 ·  ⭐ 9K) - A generic test automation framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 200 · 🔀 2.2K · 📥 550 · 📦 10K · 📋 4.4K - 6% open · ⏱️ 22.03.2024):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 2.4M / month):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 320 · 📥 240 · 📦 35K · 📋 300 - 3% open · ⏱️ 15.02.2024):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 20M / month):
	```
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈32 ·  ⭐ 9.4K · 💤) - PyAutoGUI is a cross-platform GUI automation Python module for.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 52 · 🔀 1.2K · 📦 33K · 📋 680 - 66% open · ⏱️ 07.06.2023):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 330 · 🔀 560 · 📦 26K · 📋 1.5K - 2% open · ⏱️ 24.03.2024):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 7M / month):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 8.5M · ⏱️ 24.03.2024):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 140 · 🔀 350 · 📦 8.5K · 📋 380 - 23% open · ⏱️ 11.03.2024):
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.7K · 📋 520 - 7% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/cobrateam/splinter
	```
- [PyPi](https://pypi.org/project/splinter) (📥 160K / month):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 320 · 🔀 2.8K · 📦 4 · 📋 1.6K - 1% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/locustio/locust
	```
- [PyPi](https://pypi.org/project/locust) (📥 1.8M / month):
	```
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 140K · ⏱️ 21.03.2024):
	```
	conda install -c conda-forge locust
	```
</details>
<details><summary><b><a href="https://github.com/lk-geimfari/mimesis">mimesis</a></b> (🥈30 ·  ⭐ 4.3K) - is a Python library that help you generate fake data. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 120 · 🔀 320 · 📥 560 · 📦 1.7K · 📋 340 - 2% open · ⏱️ 25.03.2024):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 200K / month):
	```
	pip install mimesis
	```
...
<details><summary><b><a href="https://github.com/schemathesis/schemathesis">Schemathesis</a></b> (🥉28 ·  ⭐ 2.1K) - A tool for automatic property-based testing of web applications.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 62 · 🔀 140 · 📦 300 · 📋 800 - 9% open · ⏱️ 25.03.2024):
...
- [PyPi](https://pypi.org/project/schemathesis) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 13K · ⏱️ 22.03.2024):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 260 · 📦 15K · 📋 250 - 41% open · ⏱️ 16.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/HTTPretty) (📥 590K / month):
	```
	pip install HTTPretty
	```
- [Conda](https://anaconda.org/conda-forge/HTTPretty) (📥 370K · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge HTTPretty
	```
</details>
<details><summary><b><a href="https://github.com/spulec/freezegun">freezegun</a></b> (🥉26 ·  ⭐ 4K) - Travel through time by mocking the datetime module. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 120 · 🔀 250 · 📥 13 · 📋 300 - 35% open · ⏱️ 18.03.2024):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 11M / month):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 130 · 🔀 370 · 📋 570 - 27% open · ⏱️ 18.03.2024):

	```
	git clone https://github.com/FactoryBoy/factory_boy
	```
- [PyPi](https://pypi.org/project/factory_boy) (📥 4.3M / month):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 77 · 🔀 130 · 📦 25K · 📋 270 - 18% open · ⏱️ 31.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 900K / month):
	```
	pip install nose2
	```
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · 📦 390 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 140K / month):
	```
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 50 · 📦 2.5K · 📋 27 - 44% open · ⏱️ 28.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/httmock) (📥 850K / month):
	```
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock):
	```
...
- [PyPi](https://pypi.org/project/green) (📥 17K / month):
	...
	pip install green
	```
- [Conda](https://anaconda.org/conda-forge/green):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 26 · 🔀 39 · 📦 93 · 📋 77 - 2% open · ⏱️ 06.02.2024):
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 43 · 🔀 93 · 📋 86 - 43% open · ⏱️ 23.03.2022):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 66 · 🔀 270 · 📥 9.9K · 📦 960K · 📋 330 - 10% open · ⏱️ 25.03.2024):
...
<details><summary><b><a href="https://github.com/andialbrecht/sqlparse">sqlparse</a></b> (🥇35 ·  ⭐ 3.6K) - A non-validating SQL parser. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 110 · 🔀 640 · 📦 1M · 📋 530 - 42% open · ⏱️ 17.03.2024):

	```
	git clone https://github.com/andialbrecht/sqlparse
	```
- [PyPi](https://pypi.org/project/sqlparse) (📥 50M / month):
	```
	pip install sqlparse
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 2.3M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 34 · 🔀 110 · 📦 23K · ⏱️ 11.03.2024):
...
- [PyPi](https://pypi.org/project/shortuuid) (📥 4.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 440K · ⏱️ 12.03.2024):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 36 · 🔀 100 · 📦 80K · 📋 72 - 1% open · ⏱️ 01.03.2024):
...
- [PyPi](https://pypi.org/project/python-slugify) (📥 19M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 2M · ⏱️ 08.02.2024):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 14 · 🔀 240 · 📥 1K · 📦 6K · ⏱️ 29.12.2023):

	```
	git clone https://github.com/orsinium/textdistance
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 720K / month):
	```
	pip install textdistance
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 530K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 24 · 🔀 600 · 📦 5.4K · 📋 260 - 12% open · ⏱️ 10.03.2024):

	```
	git clone https://github.com/mozillazg/python-pinyin
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 66 / month):
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 48 · 🔀 250 · 📦 6 · 📋 140 - 37% open · ⏱️ 01.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/chardet) (📥 66M / month):
	```
	pip install chardet
	```
...
- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 36 · 🔀 440 · 📋 200 - 4% open · ⏱️ 19.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/ply) (📥 38M / month):
	```
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 8.9M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 48 · 📦 2.2K · 📋 18 - 55% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 84K / month):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 32 · 🔀 200 · 📦 7.8K · 📋 76 - 56% open · ⏱️ 16.02.2023):
...
<details><summary><b><a href="https://github.com/rspeer/python-ftfy">ftfy</a></b> (🥉19 ·  ⭐ 3.7K) - Makes Unicode text less broken and more consistent automagically. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 120 · 📦 18K · 📋 140 - 9% open · ⏱️ 15.03.2024):
...
- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 23 · 🔀 100 · 📦 1.4K · 📋 110 - 23% open · ⏱️ 21.09.2023):
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 24 · 📦 230 · 📋 9 - 44% open · ⏱️ 30.03.2023):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 30 · 🔀 390 · 📋 180 - 4% open · ⏱️ 25.03.2024):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 160 · 🔀 1.8K · 📦 420K · 📋 3.2K - 5% open · ⏱️ 27.03.2024):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 1.2B / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 18M · ⏱️ 26.03.2024):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 190 · 🔀 2.3K · 📦 190K · 📋 1K - 11% open · ⏱️ 27.03.2024):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 42M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 2.7M · ⏱️ 22.03.2024):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 170 · 🔀 900 · 📥 3K · 📦 31K · 📋 900 - 4% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 9.5M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 68 · 🔀 160 · 📦 8.1K · 📋 290 - 2% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 1.7M / month):
	```
	pip install webargs
	```
...
<details><summary><b><a href="https://github.com/ellisonleao/pyshorteners">pyshorteners</a></b> (🥈23 ·  ⭐ 380 · 💀) - A pure Python URL shortening lib. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 63 · 📦 12K · ⏱️ 06.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 66K / month):
	```
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 37 · 📦 4K · 📋 20 - 25% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/purl) (📥 97K / month):
	```
	pip install purl
	```
...
<details><summary><b><a href="https://github.com/gruns/furl">furl</a></b> (🥉19 ·  ⭐ 2.6K · 💀) - A small Python library that makes parsing and manipulating URLs.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 15 · 🔀 140 · 📋 120 - 26% open · ⏱️ 01.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 2.5M / month):
	```
	pip install furl
	```
- [Conda](https://anaconda.org/conda-forge/furl) (📥 350K · ⏱️ 16.06.2023):
	```
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥇24 ·  ⭐ 3.2K) - Most Powerful multi-threaded Video Processing framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 14 · 🔀 230 · 📥 1K · 📦 520 · 📋 270 - 2% open · ⏱️ 10.09.2023):
...
<details><summary><b><a href="https://github.com/aizvorski/scikit-video">scikit-video</a></b> (🥉12 ·  ⭐ 130 · 💀) - Video processing routines for SciPy. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 8 - 62% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 100K / month):
	```
	pip install scikit-video
	```
- [Conda](https://anaconda.org/conda-forge/scikit-video) (📥 32K · ⏱️ 16.06.2023):
	```
...
<details><summary><b><a href="https://github.com/jschneier/django-storages">django-storages</a></b> (🥇34 ·  ⭐ 2.6K · 📈) - A collection of custom storage back ends for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 260 · 🔀 790 · 📦 180K · 📋 680 - 18% open · ⏱️ 26.03.2024):

	```
	git clone https://github.com/jschneier/django-storages
	```
- [PyPi](https://pypi.org/project/django-storages) (📥 3.5M / month):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 180 · 🔀 350 · 📦 2.4K · 📋 440 - 26% open · ⏱️ 15.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 140K / month):
	```
...
- [GitHub](https://github.com/miracle2k/webassets) (👨‍💻 160 · 🔀 250 · 📦 6.9K · 📋 290 - 20% open · ⏱️ 01.05.2021):

	```
	git clone https://github.com/miracle2k/webassets
	```
- [PyPi](https://pypi.org/project/webassets) (📥 340K / month):
	```
	pip install webassets
	```
- [Conda](https://anaconda.org/conda-forge/webassets) (📥 63K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/miracle2k/flask-assets) (👨‍💻 42 · 🔀 90 · 📦 7.5K · 📋 100 - 21% open · ⏱️ 15.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/flask-assets) (📥 190K / month):
	```
	pip install flask-assets
	```
- [Conda](https://anaconda.org/conda-forge/flask-assets) (📥 45K · ⏱️ 09.11.2023):
	```
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 220 · 🔀 560 · 📋 650 - 16% open · ⏱️ 18.03.2024):
...
- [PyPi](https://pypi.org/project/django-compressor) (📥 620K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-compressor) (📥 630 · ⏱️ 27.09.2023):
	```
...
- [GitHub](https://github.com/codelucas/newspaper) (👨‍💻 100 · 🔀 2K · 📦 21 · 📋 690 - 61% open · ⏱️ 02.09.2020):

	```
	git clone https://github.com/codelucas/newspaper
	```
- [PyPi](https://pypi.org/project/newspaper) (📥 8.4K / month):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 31 · 🔀 520 · 📦 2.6K · 📋 120 - 15% open · ⏱️ 24.02.2024):

	```
	git clone https://github.com/miso-belica/sumy
	```
- [PyPi](https://pypi.org/project/sumy) (📥 280K / month):
	```
	pip install sumy
	```
...
- [PyPi](https://pypi.org/project/requests-html) (📥 1.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 9.3K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/Alir3z4/html2text) (👨‍💻 77 · 🔀 250 · 📋 210 - 36% open · ⏱️ 28.02.2024):
	...
	```
- [PyPi](https://pypi.org/project/html2text) (📥 1.8M / month):
	```
	pip install html2text
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 54K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 88 · 📦 2.8K · ⏱️ 02.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/micawber) (📥 28K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 15K · ⏱️ 10.07.2023):
	```
	conda install -c conda-forge micawber
	```
</details>
<details><summary><b><a href="https://github.com/deanmalmgren/textract">textract</a></b> (🥉23 ·  ⭐ 3.8K) - Extract text from any document, Word, PowerPoint, PDFs, etc. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 41 · 🔀 540 · 📋 240 - 45% open · ⏱️ 10.03.2024):
...
<details><summary><b><a href="https://github.com/elliotgao2/toapi">toapi</a></b> (🥉17 ·  ⭐ 3.5K · 💀) - Every web site provides APIs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/buriy/python-readability">python-readability</a></b> (🥉17 ·  ⭐ 2.5K · 💤) - Fast Python port of arc90's readability tool. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/lorien/grab">grab</a></b> (🥇27 ·  ⭐ 2.4K · 💤) - Site scraping framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 67 · 🔀 260 · 📦 410 · ⏱️ 01.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 16K / month):
	```
	pip install grab
	```
...
<details><summary><b><a href="https://github.com/scrapinghub/portia">portia</a></b> (🥈22 ·  ⭐ 9.2K · 💀) - Visual scraping for Scrapy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 53 · 🔀 1.4K · 📥 270 · 📦 21 · 📋 450 - 24% open · ⏱️ 10.07.2019):
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 55 · 🔀 370 · 📥 43 · 📋 170 - 18% open · ⏱️ 24.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 75K / month):
	```
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 4 · 🔀 530 · 📦 39 · 📋 65 - 20% open · ⏱️ 01.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/cola) (📥 96 / month):
	```
	pip install cola
	```
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 87 · 🔀 130 · 📦 510 · 📋 400 - 7% open · ⏱️ 12.03.2024):
...
- [GitHub](https://github.com/python-websockets/websockets) (👨‍💻 71 · 🔀 490 · 📦 170K · 📋 1.1K - 3% open · ⏱️ 11.02.2024):

	```
	git clone https://github.com/aaugustin/websockets
	```
- [PyPi](https://pypi.org/project/websockets) (📥 28M / month):
	```
	pip install websockets
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 2.5M · ⏱️ 21.10.2023):
	```
...
<details><summary><b><a href="https://github.com/django/channels">channels</a></b> (🥉23 ·  ⭐ 5.9K · 📉) - Developer-friendly asynchrony for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/django/channels) (👨‍💻 260 · 🔀 780 · 📦 21 · 📋 1.3K - 6% open · ⏱️ 28.03.2024):

	```
	git clone https://github.com/django/channels
	```
- [PyPi](https://pypi.org/project/channels) (📥 1.3M / month):
	```
	pip install channels
	```
- [Conda](https://anaconda.org/conda-forge/channels):
	```
...
<details><summary><b><a href="https://github.com/benoitc/gunicorn">gunicorn</a></b> (🥇37 ·  ⭐ 9.5K) - Pre-forked, ported from Ruby's Unicorn project. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 420 · 🔀 1.7K · 📥 100 · 📦 1.1M · 📋 2K - 13% open · ⏱️ 05.01.2024):
	...
	```
- [PyPi](https://pypi.org/project/gunicorn) (📥 39M / month):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 490 · 🔀 1.7K · 📥 820 · 📦 1.2M · 📋 1.2K - 0% open · ⏱️ 05.03.2024):
...
- [PyPi](https://pypi.org/project/werkzeug) (📥 110M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 9.9M · ⏱️ 09.11.2023):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 730 · 📋 160 - 16% open · ⏱️ 11.09.2022):

	```
	git clone https://github.com/jonashaag/bjoern
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 34K / month):
	```
	pip install bjoern
	```
