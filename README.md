...
- [GitHub](https://github.com/mher/flower) (👨‍💻 200 · 🔀 930 · 📦 10K · 📋 850 - 12% open · ⏱️ 14.11.2022):
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 23 · 🔀 790 · 📦 25 · 📋 1.1K - 0% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 380 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 790 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 280 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 41 · 📋 210 - 24% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 250 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 18 - 33% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 750 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 980 · 🔀 37K · 📋 1.2K - 1% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 77M · ⏱️ 22.11.2022):
	```
...
- [PyPi](https://pypi.org/project/transitions) (📥 290K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 310K · ⏱️ 02.09.2022):
	```
...
- [PyPi](https://pypi.org/project/algorithms) (📥 20K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 1.2K · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 23 · 🔀 180 · 📦 95K · 📋 160 - 7% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 29 · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 130 · 🔀 6.3K · 📋 80 - 11% open · ⏱️ 08.08.2022):
...
<details><summary><b><a href="https://github.com/prabhupant/python-ds">python-ds</a></b> (🥉15 ·  ⭐ 1.9K) - A collection of data structure and algorithms for coding interviews. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 150 · 🔀 510 · 📋 620 - 3% open · ⏱️ 06.01.2023):
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 63 · 🔀 220 · 📋 290 - 10% open · ⏱️ 29.12.2022):

	```
	git clone https://github.com/django/daphne
	```
- [PyPi](https://pypi.org/project/daphne) (📥 470K / month):
	```
	pip install daphne
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 55 · 🔀 460 · 📥 360 · 📦 60K · 📋 300 - 16% open · ⏱️ 14.09.2022):

	```
	git clone https://github.com/MagicStack/uvloop
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 13M / month):
	```
	pip install uvloop
	```
- [Conda](https://anaconda.org/conda-forge/uvloop) (📥 530K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 22K · 📋 680 - 37% open · ⏱️ 12.01.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 5.5M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 950K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 7.9K · 📦 280 · 📋 2.6K - 18% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 4.2K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 68 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 880 · 📦 17K · 📋 510 - 48% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 2.6M / month):
	```
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 37K · ⏱️ 13.03.2021):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 39 · 🔀 130 · 📥 58K · 📦 9.2K · 📋 490 - 20% open · ⏱️ 26.10.2022):
...
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥈25 ·  ⭐ 420) - A tool for working with audio files, specifically MP3 files containing.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 840 · 📋 1.1K - 4% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 25 · 🔀 90 · 📦 660 · 📋 98 - 16% open · ⏱️ 02.01.2023):
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 22 · 📦 2K · 📋 95 - 13% open · ⏱️ 04.07.2022):

	```
	git clone https://github.com/keunwoochoi/kapre
	```
- [PyPi](https://pypi.org/project/kapre) (📥 3.3K / month):
	```
	pip install kapre
	```
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 57 · 📦 16 · 📋 210 - 22% open · ⏱️ 06.01.2023):
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉19 ·  ⭐ 800) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 100 · 📦 12 · 📋 39 - 33% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 390 / month):
	```
...
- [PyPi](https://pypi.org/project/audioread) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/audioread) (📥 560K · ⏱️ 29.10.2022):
	```
...
- [PyPi](https://pypi.org/project/oauthlib) (📥 84M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 7.4M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 580 · 📦 300K · 📋 380 - 3% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 97M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 9.2M · ⏱️ 20.10.2022):
	```
...
- [PyPi](https://pypi.org/project/django-allauth) (📥 510K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 84K · ⏱️ 07.06.2022):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 90 · 🔀 340 · 📦 23K · 📋 360 - 11% open · ⏱️ 27.12.2022):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 6.6M / month):
	```
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 92K · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/omab/python-social-auth) (👨‍💻 280 · 🔀 1.1K · 📦 5.6K · 📋 660 - 2% open · ⏱️ 04.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/python-social-auth) (📥 28K / month):
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 9.9K · 📋 130 - 38% open · ⏱️ 12.02.2018):

	```
	git clone https://github.com/joestump/python-oauth2
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 49K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 680 · 📋 740 - 20% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/mpdavis/python-jose) (🔀 210 · 📋 130 - 43% open · ⏱️ 09.02.2022):
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 39 · 🔀 230 · 📋 500 - 16% open · ⏱️ 04.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 14K / month):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 680 · 📋 3.9K - 4% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 320 · 📦 570K · 📋 610 - 17% open · ⏱️ 12.01.2023):
...
- [PyPi](https://pypi.org/project/attrs) (📥 120M / month):
	...
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 23M · ⏱️ 21.12.2022):
	```
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 51 · 📦 11K · 📋 54 - 5% open · ⏱️ 04.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/bidict) (📥 860K / month):
	```
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 180K · ⏱️ 01.01.2023):
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 87 · 📥 31 · 📋 150 - 16% open · ⏱️ 29.10.2022):
...
<details><summary><b><a href="https://github.com/carlosescri/DottedDict">DottedDict</a></b> (🥉16 ·  ⭐ 160 · 💀) - A library that provides a method of accessing lists and dicts with.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 18 · 📥 65 · 📦 68 · 📋 9 - 77% open · ⏱️ 30.10.2015):
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.5K · 📋 1K - 3% open · ⏱️ 02.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 3K / month):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 130 · 🔀 340 · 📥 2.9K · 📋 3.3K - 18% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 600 / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 65 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 64 · 🔀 200 · 📦 820 · 📋 310 - 8% open · ⏱️ 11.07.2022):
...
- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 87 · 🔀 140 · 📦 4.1K · 📋 120 - 52% open · ⏱️ 07.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/beaker) (📥 240K / month):
	```
	pip install beaker
	```
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 240 · 📋 71 - 21% open · ⏱️ 06.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 6.3K / month):
	```
...
<details><summary><b><a href="https://github.com/errbotio/errbot">errbot</a></b> (🥇20 ·  ⭐ 2.8K) - The easiest and most popular chatbot to implement ChatOps. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/errbotio/errbot) (🔀 580 · 📦 280 · 📋 760 - 8% open · ⏱️ 02.12.2022):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 350 · 🔀 1.9K · 📥 26K · 📦 230K · 📋 2.2K - 15% open · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/black) (📥 15M / month):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 5.9M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 270 · 🔀 490 · 📦 300K · 📋 1.2K - 10% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/isort) (📥 24M / month):
	...
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 4.1M · ⏱️ 22.12.2022):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 350 · 📦 11K · 📋 1K - 8% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 210K / month):
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 86 · 🔀 150 · 📦 3.5K · 📋 340 - 13% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/prospector) (📥 690K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 53K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 850 · 📦 47K · 📋 770 - 47% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 91 · 📦 4.6K · 📋 140 - 31% open · ⏱️ 08.08.2022):

	```
	git clone https://github.com/klen/pylama
	```
- [PyPi](https://pypi.org/project/pylama) (📥 130K / month):
	```
	pip install pylama
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 33 · 🔀 110 · 📦 2.2K · 📋 170 - 6% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 340K / month):
	```
	pip install vulture
	```
- [Conda](https://anaconda.org/conda-forge/vulture) (📥 64K · ⏱️ 09.01.2023):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 230 · 🔀 380 · 📋 330 - 31% open · ⏱️ 12.01.2023):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 200K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 13 · 📋 49 - 12% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/scottrogowski/code2flow
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 1.6K / month):
	```
	pip install code2flow
	```
- [Conda](https://anaconda.org/conda-forge/code2flow) (📥 1.8K · ⏱️ 10.01.2023):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 44 · 🔀 150 · 📋 160 - 21% open · ⏱️ 16.12.2022):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 69K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 87 · 🔀 240 · 📋 580 - 18% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 380K / month):
	```
	pip install pytype
	```
...
<details><summary><b><a href="https://github.com/gak/pycallgraph">pycallgraph</a></b> (🥉18 ·  ⭐ 1.7K · 💀) - A library that visualises the flow (call graph) of your.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 270 · 📋 160 - 30% open · ⏱️ 28.02.2018):

	```
	git clone https://github.com/gak/pycallgraph
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 19K / month):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 55 · 📦 91 · 📋 59 - 44% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.2K · 🔀 1.4K · 📋 2K - 7% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 200 · 🔀 1.4K · 📦 47K · 📋 1K - 7% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 18M / month):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 2.7M · ⏱️ 06.01.2023):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 10K · 📦 370K · 📋 880 - 36% open · ⏱️ 03.09.2022):
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 55 · 🔀 1.3K · 📦 16K · 📋 270 - 38% open · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 40 · 🔀 240 · 📦 730 · 📋 280 - 9% open · ⏱️ 03.07.2022):

	```
	git clone https://github.com/peterbrittain/asciimatics
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 41K / month):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.4K · 📋 170 - 8% open · ⏱️ 01.01.2023):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 140K / month):
	```
	pip install alive-progress
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 24K · ⏱️ 02.01.2023):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 640 · 📋 1K - 46% open · ⏱️ 06.12.2022):
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 2.1K · 📦 12K · 📋 800 - 15% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/jakubroztocil/httpie
	```
- [PyPi](https://pypi.org/project/httpie) (📥 140K / month):
	```
	pip install httpie
	```
...
- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 280 · 🔀 1.7K · 📦 16K · 📋 760 - 25% open · ⏱️ 09.09.2022):

	```
	git clone https://github.com/audreyr/cookiecutter
	```
- [PyPi](https://pypi.org/project/cookiecutter) (📥 1.8M / month):
	```
	pip install cookiecutter
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 540K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 70 · 🔀 220 · 📦 220 · 📋 330 - 22% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 7.8K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 480 · 📦 700 · 📋 660 - 22% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/dbcli/pgcli
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 31K / month):
	```
	pip install pgcli
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 270 · 📋 610 - 28% open · ⏱️ 08.11.2022):
...
<details><summary><b><a href="https://github.com/gleitz/howdoi">howdoi</a></b> (🥈25 ·  ⭐ 9.8K) - Instant coding answers via the command line. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 83 · 🔀 830 · 📦 440 · 📋 250 - 3% open · ⏱️ 05.12.2022):

	```
	git clone https://github.com/gleitz/howdoi
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 8.6K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 91 · 📥 11K · 📦 13 · 📋 200 - 25% open · ⏱️ 29.12.2022):
...
- [PyPi](https://pypi.org/project/iredis) (📥 1.8K / month):
	...
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 480 · ⏱️ 10.08.2022):
	```
	conda install -c conda-forge iredis
	```
</details>
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥉24 ·  ⭐ 820) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 48 · 🔀 100 · 📦 150 · 📋 300 - 12% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 20K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 1.2K · ⏱️ 07.01.2023):
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 61 · 📦 200 · 📋 87 - 32% open · ⏱️ 11.07.2022):

	```
	git clone https://github.com/dbcli/litecli
	```
- [PyPi](https://pypi.org/project/litecli) (📥 20K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/facebook/PathPicker) (👨‍💻 78 · 🔀 280 · 📥 45K · 📦 3 · 📋 170 - 10% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/PathPicker) (📥 6 / month):
	```
...
- [GitHub](https://github.com/mooz/percol) (👨‍💻 36 · 🔀 140 · 📦 33 · 📋 65 - 55% open · ⏱️ 23.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/percol) (📥 920 / month):
	```
	pip install percol
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 45 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 41K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.4K · 📥 3.2M · 📦 2K · 📋 710 - 21% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 120K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 1.7K · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 27 · 🔀 230 · 📦 760 · 📋 250 - 30% open · ⏱️ 26.08.2022):

	```
	git clone https://github.com/sirfz/tesserocr
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 39K / month):
	```
	pip install tesserocr
	```
- [Conda](https://anaconda.org/conda-forge/tesserocr) (📥 98K · ⏱️ 06.11.2022):
	```
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 12K · 📥 510 · 📋 1.2K - 54% open · ⏱️ 10.06.2022):
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 41 · 🔀 620 · 📋 320 - 6% open · ⏱️ 26.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 540K / month):
	```
...
<details><summary><b><a href="https://github.com/sightmachine/SimpleCV">SimpleCV</a></b> (🥉22 ·  ⭐ 2.6K · 💀) - An open source framework for building computer vision applications. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/kornia/kornia) (🔀 740 · 📥 500 · 📋 680 - 28% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 85 · 📦 290 · 📋 73 - 43% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 33 · 🔀 160 · 📥 10 · 📦 85K · 📋 83 - 10% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/henriquebastos/python-decouple
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 900K / month):
	```
	pip install python-decouple
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 54K · ⏱️ 09.01.2023):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 22 · 🔀 68 · 📦 23K · 📋 140 - 41% open · ⏱️ 14.10.2020):
...
- [PyPi](https://pypi.org/project/configobj) (📥 2.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 530K · ⏱️ 29.07.2018):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 500 · 📦 11 · 📋 1.2K - 14% open · ⏱️ 12.01.2023):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 34K / month):
	```
	pip install hydra
	```
...
<details><summary><b><a href="https://github.com/paramiko/paramiko">paramiko</a></b> (🥇31 ·  ⭐ 8.1K) - The leading native Python SSHv2 protocol library. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 68K · 📋 1.4K - 51% open · ⏱️ 04.11.2022):
...
- [PyPi](https://pypi.org/project/paramiko) (📥 31M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 2.5M · ⏱️ 05.11.2022):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 64 · 🔀 200 · 📋 290 - 14% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/pynacl) (📥 36M / month):
	...
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 3.5M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 8.9K · 📋 750 - 33% open · ⏱️ 15.08.2019):

	```
	git clone https://github.com/blaze/blaze
	```
- [PyPi](https://pypi.org/project/blaze) (📥 6.7K / month):
	```
	pip install blaze
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 550 · 📥 170K · 📦 720 · 📋 820 - 4% open · ⏱️ 11.01.2023):
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 520 · 📦 280K · 📋 700 - 5% open · ⏱️ 28.12.2022):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 61M / month):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 62 · 🔀 220 · 📦 12K · 📋 340 - 12% open · ⏱️ 05.05.2021):
...
- [PyPi](https://pypi.org/project/cerberus) (📥 3.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cerberus) (📥 270K · ⏱️ 10.12.2021):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 5.1K · 📋 140 - 51% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/schema) (📥 4M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 76K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 89 · 🔀 200 · 📦 6.2K · 📋 240 - 16% open · ⏱️ 23.10.2022):
...
- [PyPi](https://pypi.org/project/voluptuous) (📥 2.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/voluptuous) (📥 240K · ⏱️ 07.04.2022):
	```
...
- [GitHub](https://github.com/schematics/schematics) (👨‍💻 120 · 🔀 270 · 📦 1.4K · 📋 330 - 27% open · ⏱️ 17.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/schematics) (📥 120K / month):
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 9 · 🔀 23 · 📦 64 · 📋 15 - 26% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/podio/valideer
	```
- [PyPi](https://pypi.org/project/valideer) (📥 9.8K / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 180 · 🔀 1.6K · 📥 240 · 📦 210K · 📋 2.2K - 4% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/mwaskom/seaborn
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 8.3M / month):
	```
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 5.6M · ⏱️ 31.12.2022):
	```
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 670 · 📦 42K · 📋 1.7K - 12% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 9.9M / month):
	```
	pip install altair
	```
- [Conda](https://anaconda.org/conda-forge/altair) (📥 1.6M · ⏱️ 29.12.2021):
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 720 · 📋 410 - 56% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 68K / month):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 630 · 🔀 3.9K · 📦 180 · 📋 7.1K - 9% open · ⏱️ 10.01.2023):
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 59 · 🔀 440 · 📦 36 · 📋 570 - 37% open · ⏱️ 29.09.2022):
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 2.9K · 📋 1.1K - 26% open · ⏱️ 14.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 97K / month):
	```
	pip install cartopy
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 590 · 📦 950 · 📋 1.3K - 20% open · ⏱️ 26.12.2022):
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 99 · 🔀 180 · 📋 530 - 12% open · ⏱️ 09.01.2023):
...
<details><summary><b><a href="https://github.com/msiemens/tinydb">tinydb</a></b> (🥇29 ·  ⭐ 5.6K) - A tiny, document-oriented database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 79 · 🔀 470 · 📦 9.2K · 📋 290 - 3% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/msiemens/tinydb
	```
- [PyPi](https://pypi.org/project/tinydb) (📥 380K / month):
	```
	pip install tinydb
	```
- [Conda](https://anaconda.org/conda-forge/tinydb) (📥 240K · ⏱️ 19.02.2022):
	```
	conda install -c conda-forge tinydb
	```
</details>
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥉23 ·  ⭐ 570) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 79 · 📦 950 · 📋 160 - 38% open · ⏱️ 09.11.2022):

	```
	git clone https://github.com/zopefoundation/ZODB
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 48K / month):
	```
	pip install ZODB
	```
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 120 · 📦 1K · 📋 57 - 28% open · ⏱️ 15.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/pickledb) (📥 40K / month):
	```
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 13K · 📋 1.4K - 16% open · ⏱️ 27.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 7.1M / month):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 41 · 🔀 180 · 📦 45K · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/motor) (📥 1.1M / month):
	...
	pip install motor
	```
- [Conda](https://anaconda.org/conda-forge/motor) (📥 52K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 150K · 📋 620 - 4% open · ⏱️ 09.01.2023):
...
- [PyPi](https://pypi.org/project/PyMySQL) (📥 32M / month):
	...
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 960K · ⏱️ 09.01.2021):
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 370 · 🔀 2.2K · 📋 1.3K - 9% open · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 860K · ⏱️ 09.01.2023):
	```
	conda install -c conda-forge redis-py
	```
</details>
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥈25 ·  ⭐ 960) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 48 · 🔀 180 · 📦 870 · 📋 260 - 11% open · ⏱️ 18.12.2022):
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.6K · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 980 · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 150 · 📦 710 · 📋 210 - 11% open · ⏱️ 12.07.2022):

	```
	git clone https://github.com/wbolster/happybase
	```
- [PyPi](https://pypi.org/project/happybase) (📥 190K / month):
	```
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 12 · 🔀 32 · 📦 120 · 📋 18 - 22% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 4.5K / month):
	```
	pip install queries
	```
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 87 · 🔀 300 · 📥 62 · 📦 15K · 📋 450 - 42% open · ⏱️ 23.12.2022):

	```
	git clone https://github.com/sdispater/pendulum
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 9.4M / month):
	```
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 420 · 📥 35K · 📦 890K · 📋 640 - 40% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 48 · 🔀 190 · 📦 1K · 📋 90 - 17% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/maya) (📥 34K / month):
	```
	pip install maya
	```
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 740 · 📋 40 - 7% open · ⏱️ 27.11.2020):

	```
	git clone https://github.com/zachwill/moment
	```
- [PyPi](https://pypi.org/project/moment) (📥 62K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 22 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 510 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 19 · 📦 31 · ⏱️ 05.11.2022):

	```
	git clone https://github.com/shinux/PyTime
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 720 / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 260 · 🔀 870 · 📥 180 · 📦 60K · 📋 830 - 9% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 320 · 📥 11K · 📦 300 · 📋 270 - 33% open · ⏱️ 09.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 820K / month):
	```
	pip install py-spy
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 54 · 🔀 140 · 📦 37K · 📋 180 - 32% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/gotcha/ipdb
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 1.8M / month):
	```
	pip install ipdb
	```
...
- [GitHub](https://github.com/pallets-eco/flask-debugtoolbar) (👨‍💻 46 · 🔀 130 · 📦 20K · 📋 110 - 36% open · ⏱️ 27.12.2022):

	```
	git clone https://github.com/mgood/flask-debugtoolbar
	```
- [PyPi](https://pypi.org/project/flask-debugtoolbar) (📥 100K / month):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 87 · 🔀 440 · 📦 4.4K · 📋 210 - 32% open · ⏱️ 27.10.2022):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 1.4M / month):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 210 · 📦 3.7K · 📋 300 - 46% open · ⏱️ 10.01.2023):
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 130 · 📋 98 - 29% open · ⏱️ 04.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 190K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 10K · ⏱️ 21.07.2022):
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 110 · 📦 130 · 📋 110 - 27% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 8.4K / month):
	```
	pip install wdb
	```
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 360 · 📋 67 - 58% open · ⏱️ 05.03.2016):
	...
	```
- [PyPi](https://pypi.org/project/django-devserver) (📥 4.2K / month):
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 41 · 🔀 56 · 📦 3.4K · 📋 200 - 37% open · ⏱️ 14.07.2022):
...
- [GitHub](https://github.com/rkern/line_profiler) (👨‍💻 14 · 🔀 250 · 📋 140 - 36% open · ⏱️ 23.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 280K / month):
	```
	pip install line_profiler
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 300K · ⏱️ 09.12.2022):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 40 · 📦 110 · 📋 91 - 42% open · ⏱️ 29.10.2022):
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 470 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 490K / month):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 39 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 37 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 91 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.2K · 🔀 71K · 📦 240K · 📋 36K - 5% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 3.7K · 📋 9.5K - 18% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/dmlc/mxnet
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 590K / month):
	```
	pip install mxnet
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.1K · 🔀 18K · 📋 12K - 2% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/keras-team/keras
	```
- [PyPi](https://pypi.org/project/keras) (📥 9.7M / month):
	```
	pip install keras
	```
...
<details><summary><b><a href="https://github.com/Theano/Theano">Theano</a></b> (🥉31 ·  ⭐ 9.6K) - A library for fast numerical computation. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.8K · 🔀 17K · 📥 9.5K · 📋 30K - 32% open · ⏱️ 12.01.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 53K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 1.2M · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 730 · 📥 240 · ⏱️ 22.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 76 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 240K · 📋 1.6K - 13% open · ⏱️ 09.01.2023):
...
- [PyPi](https://pypi.org/project/psutil) (📥 60M / month):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 18M · ⏱️ 08.11.2022):
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 25K · 📋 31K - 2% open · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.2M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 790K · ⏱️ 07.12.2022):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.1K · 📥 16K · 📋 25K - 9% open · ⏱️ 11.01.2023):
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.3K · 📋 1.1K - 11% open · ⏱️ 27.12.2022):
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 130 · 📦 4.2K · 📋 100 - 11% open · ⏱️ 24.10.2022):
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 84 · 🔀 300 · 📦 54 · 📋 640 - 18% open · ⏱️ 31.12.2022):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 14K / month):
	```
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 220 · ⏱️ 19.12.2022):
	```
...
- [PyPi](https://pypi.org/project/fabric) (📥 2.5M / month):
	...
	pip install fabric
	```
- [Conda](https://anaconda.org/conda-forge/fabric) (📥 58K · ⏱️ 09.09.2022):
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 190 · 📦 290 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools) (📥 1.5K / month):
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 600 · 🔀 2.3K · 📦 1.9K · 📋 950 - 8% open · ⏱️ 29.12.2022):

	```
	git clone https://github.com/spotify/luigi
	```
- [PyPi](https://pypi.org/project/luigi) (📥 370K / month):
	```
	pip install luigi
	```
- [Conda](https://anaconda.org/conda-forge/luigi) (📥 600K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 570 · 🔀 1.5K · 📦 43K · 📋 4.6K - 15% open · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/dask) (📥 7M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 7.6M · ⏱️ 16.12.2022):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4K · 📦 6.9K · 📋 12K - 19% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 580 · 📦 1.2K · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 55K / month):
	```
	pip install mrjob
	```
...
<details><summary><b><a href="https://github.com/robinhood/faust">faust</a></b> (🥉25 ·  ⭐ 6.4K · 💀) - A stream processing library, porting the ideas from [Kafka.. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/pyinstaller/pyinstaller">PyInstaller</a></b> (🥇34 ·  ⭐ 9.9K) - Converts Python programs into stand-alone executables.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 440 · 🔀 1.7K · 📥 730K · 📦 34K · 📋 4.7K - 5% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 820K / month):
	```
...
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈28 ·  ⭐ 2K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 26 · 🔀 200 · 📦 630 · 📋 870 - 3% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 530K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 79 · 📥 360 · 📋 110 - 32% open · ⏱️ 04.11.2022):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 11K / month):
	```
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 920 · ⏱️ 03.11.2022):
	```
...
🔗&nbsp;<b><a href="https://github.com/yoloseem/awesome-sphinxdoc">awesome-sphinxdoc</a></b> ( ⭐ 840 · 💀)  - A curated list of awesome tools for Sphinx Python Documentation..

<details><summary><b><a href="https://github.com/sphinx-doc/sphinx">sphinx</a></b> (🥇27 ·  ⭐ 5.1K) - Python Documentation generator. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.7K · 📦 240K · 📋 6.3K - 16% open · ⏱️ 10.01.2023):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 42 · 🔀 150 · 📦 1K · 📋 300 - 4% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 59K / month):
	```
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 9.2K · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 140 · 📦 280 · 📋 57 - 50% open · ⏱️ 20.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pycco) (📥 1.1K / month):
	```
	pip install pycco
	```
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.6M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 7.8K · ⏱️ 22.12.2018):
	```
	conda install -c conda-forge s3cmd
	```
</details>
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥉25 ·  ⭐ 5.8K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 48 · 🔀 1.3K · 📦 250 · 📋 730 - 0% open · ⏱️ 12.01.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 40K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 190 · 📦 32 · 📋 130 - 60% open · ⏱️ 06.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 44K / month):
	```
	pip install s4cmd
	```
...
<details><summary><b><a href="https://github.com/MicroPyramid/forex-python">forex-python</a></b> (🥇24 ·  ⭐ 540) - Foreign exchange rates, Bitcoin price index and currency conversion. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 91 · 📦 110 · 📋 15 - 20% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 280 / month):
	```
	pip install alipay
	```
...
<details><summary><b><a href="https://github.com/spyder-ide/spyder">spyder</a></b> (🥇35 ·  ⭐ 7.3K) - Open Source Python IDE. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.5M · 📦 24K · 📋 17K - 6% open · ⏱️ 12.01.2023):
...
- [PyPi](https://pypi.org/project/spyder) (📥 46K / month):
	...
	pip install spyder
	```
- [Conda](https://anaconda.org/conda-forge/spyder) (📥 1.6M · ⏱️ 30.12.2022):
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 92 · 🔀 240 · 📦 210 · 📋 1.6K - 22% open · ⏱️ 22.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 620 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 180 · 🔀 2.7K · 📋 3.2K - 0% open · ⏱️ 09.01.2023):
...
- [GitHub](https://github.com/davidhalter/jedi-vim) (👨‍💻 96 · 🔀 370 · 📋 770 - 3% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 32 · 🔀 270 · 📦 2.8K · 📋 220 - 43% open · ⏱️ 28.09.2022):
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 170 · 📋 130 - 48% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 32K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 310 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 1.9K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 55 · 📥 130 · 📋 72 - 33% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/mailer) (📥 55K / month):
	```
	pip install mailer
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 58 · 📥 78 · 📦 17 · 📋 90 - 18% open · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 86 · 🔀 900 · 📦 210K · 📋 1.3K - 5% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/virtualenv) (📥 38M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 3.3M · ⏱️ 10.12.2022):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 410 · 🔀 2.6K · 📋 1.6K - 1% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 7.4K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 640 · 📦 73K · 📋 590 - 26% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/gorakhargosh/watchdog
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 9.3M / month):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 57 · 🔀 240 · 📦 36K · 📋 180 - 15% open · ⏱️ 10.01.2023):
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 48 · 🔀 130 · 📋 130 - 1% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/path.py) (📥 210K / month):
	```
	pip install path.py
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 39 · 📦 8.4K · 📋 17 - 41% open · ⏱️ 14.02.2015):
	...
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 45K / month):
	```
	pip install Unipath
	```
...
<details><summary><b><a href="https://github.com/wtforms/wtforms">WTForms</a></b> (🥇33 ·  ⭐ 1.4K) - A flexible forms validation and rendering library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 140 · 🔀 370 · 📦 160K · 📋 410 - 12% open · ⏱️ 24.12.2022):

	```
	git clone https://github.com/wtforms/wtforms
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 2.8M / month):
	```
	pip install wtforms
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 680 · 📦 110K · 📋 660 - 9% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/django-crispy-forms/django-crispy-forms
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 570K / month):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 220 · 📦 88K · 📋 160 - 13% open · ⏱️ 14.12.2022):

	```
	git clone https://github.com/zostera/django-bootstrap4
	```
- [PyPi](https://pypi.org/project/django-bootstrap4) (📥 130K / month):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 98 · 🔀 680 · 📦 18K · 📋 290 - 2% open · ⏱️ 14.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-bootstrap3) (📥 79K / month):
	```
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 760 · 📋 180 - 25% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 11K / month):
	```
	pip install deform
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 78K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 93 · 🔀 220 · 📥 2.5K · 📋 230 - 5% open · ⏱️ 20.12.2022):

	```
	git clone https://github.com/erikrose/more-itertools
	```
- [PyPi](https://pypi.org/project/more-itertools) (📥 30M / month):
	```
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 6.5K · 📋 73 - 10% open · ⏱️ 25.08.2022):
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 93 · 📦 250 · 📋 390 - 14% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 48K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 4.1K · ⏱️ 13.03.2022):
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 31 · 🔀 100 · 📋 610 - 9% open · ⏱️ 30.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/coconut) (📥 1.6K / month):
	```
	pip install coconut
	```
...
<details><summary><b><a href="https://github.com/pytoolz/cytoolz">CyToolz</a></b> (🥉21 ·  ⭐ 890) - Cython implementation of `Toolz`: High performance functional.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 66 · 📦 46K · 📋 75 - 32% open · ⏱️ 19.12.2022):
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 450 · 📋 48 - 47% open · ⏱️ 13.10.2014):

	```
	git clone https://github.com/kachayev/fn.py
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 350 / month):
	```
	pip install fn.py
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 19K · 📋 420 - 14% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.6K · 📦 6.9K · 📋 3.1K - 21% open · ⏱️ 12.01.2023):
...
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 180K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 88K · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 40 · 🔀 530 · 📦 4.5K · 📋 480 - 32% open · ⏱️ 09.12.2022):

	```
	git clone https://github.com/ChrisKnott/Eel
	```
- [PyPi](https://pypi.org/project/Eel) (📥 62K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 370 · 📦 650 · 📋 570 - 20% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 3.2K / month):
	```
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 59K · ⏱️ 29.12.2021):
	```
	conda install -c conda-forge Gooey
	```
</details>
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉24 ·  ⭐ 9.5K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 490 · 📦 660 · 📋 1.1K - 15% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 430 · 📦 870 · 📋 690 - 2% open · ⏱️ 19.12.2022):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 440 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 440 / month):
	```
	pip install flexx
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 220 · 🔀 560 · 📥 830 · 📋 600 - 17% open · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/geopy) (📥 4M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 910K · ⏱️ 13.11.2022):
	```
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 51 · 🔀 240 · 📋 260 - 4% open · ⏱️ 11.12.2022):

	```
	git clone https://github.com/SmileyChris/django-countries
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 350K / month):
	```
...
<details><summary><b><a href="https://github.com/jazzband/geojson">geojson</a></b> (🥉20 ·  ⭐ 770) - Python bindings and utilities for GeoJSON. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/pallets/markupsafe">MarkupSafe</a></b> (🥇31 ·  ⭐ 520) - Implements a XML/HTML/XHTML Markup safe string for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📦 1.1M · 📋 100 - 1% open · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/markupsafe) (📥 100M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/markupsafe) (📥 26M · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 47K · 📋 230 - 30% open · ⏱️ 08.05.2022):
...
- [PyPi](https://pypi.org/project/xmltodict) (📥 19M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xmltodict) (📥 2.2M · ⏱️ 08.05.2022):
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 78 · 🔀 220 · 📦 220K · 📋 360 - 8% open · ⏱️ 23.12.2022):
...
- [PyPi](https://pypi.org/project/bleach) (📥 13M / month):
	...
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 10M · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 52 · 🔀 170 · 📦 17K · 📋 180 - 27% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 1.9M / month):
	```
	pip install pyquery
	```
...
- [GitHub](https://github.com/stchris/untangle) (👨‍💻 17 · 🔀 80 · 📥 530 · 📦 940 · 📋 56 - 26% open · ⏱️ 03.01.2023):
...
<details><summary><b><a href="https://github.com/psf/requests">requests</a></b> (🥇39 ·  ⭐ 49K) - HTTP Requests for Humans. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/psf/requests) (👨‍💻 720 · 🔀 8.6K · 📥 4.2K · 📦 1.8M · 📋 3.7K - 5% open · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/requests) (📥 260M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 27M · ⏱️ 30.08.2022):
	```
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 180 · 🔀 630 · 📦 51K · 📋 730 - 3% open · ⏱️ 12.01.2023):
...
- [PyPi](https://pypi.org/project/httpx) (📥 10M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 420K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 960 · 📥 4.7K · 📦 1.1M · 📋 1.1K - 9% open · ⏱️ 12.01.2023):
...
- [PyPi](https://pypi.org/project/urllib3) (📥 290M / month):
	...
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 27M · ⏱️ 11.01.2023):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 76 · 🔀 180 · 📦 130K · 📋 110 - 39% open · ⏱️ 17.11.2022):

	```
	git clone https://github.com/httplib2/httplib2
	```
- [PyPi](https://pypi.org/project/httplib2) (📥 29M / month):
	```
	pip install httplib2
	```
- [Conda](https://anaconda.org/conda-forge/httplib2) (📥 2M · ⏱️ 01.11.2022):
	```
...
- [PyPi](https://pypi.org/project/grequests) (📥 320K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 68K · ⏱️ 22.04.2020):
	```
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 50 · 🔀 130 · 📥 120 · 📦 1.1K · 📋 150 - 36% open · ⏱️ 10.09.2022):
...
<details><summary><b><a href="https://github.com/secdev/scapy">scapy</a></b> (🥇34 ·  ⭐ 8.3K) - A brilliant packet manipulation library. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/secdev/scapy) (👨‍💻 400 · 🔀 1.7K · 📦 9.5K · 📋 1.4K - 3% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/scapy) (📥 1.8M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 65K · ⏱️ 25.12.2022):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 380 · 📦 8.9K · 📋 520 - 64% open · ⏱️ 16.12.2022):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 290K / month):
	```
...
<details><summary><b><a href="https://github.com/boppreh/mouse">mouse</a></b> (🥉22 ·  ⭐ 720) - Hook and simulate global mouse events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 100 · 📦 870 · 📋 110 - 74% open · ⏱️ 23.08.2022):

	```
	git clone https://github.com/boppreh/mouse
	```
- [PyPi](https://pypi.org/project/mouse) (📥 21K / month):
	```
	pip install mouse
	```
...
<details><summary><b><a href="https://github.com/rockymeza/wifi">wifi</a></b> (🥉18 ·  ⭐ 290 · 💀) - A Python library and command line tool for working with WiFi on Linux. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 440 · 📋 64 - 51% open · ⏱️ 20.03.2017):

	```
	git clone https://github.com/rockymeza/wifi
	```
- [PyPi](https://pypi.org/project/wifi) (📥 7.8K / month):
	```
	pip install wifi
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 420 · 🔀 1.8K · 📦 970K · 📋 2.7K - 3% open · ⏱️ 12.01.2023):
...
- [PyPi](https://pypi.org/project/Pillow) (📥 47M / month):
	...
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 22M · ⏱️ 02.01.2023):
	```
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 320 · 📋 930 - 1% open · ⏱️ 06.01.2023):
...
<details><summary><b><a href="https://github.com/emcconville/wand">wand</a></b> (🥇29 ·  ⭐ 1.2K) - Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 8.6K · 📦 14K · 📋 390 - 4% open · ⏱️ 11.01.2023):
...
<details><summary><b><a href="https://github.com/dylanaraps/pywal">pywal</a></b> (🥈25 ·  ⭐ 6.9K · 💀) - A tool that generates color schemes from images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 280 · 📥 900 · 📦 220 · 📋 520 - 24% open · ⏱️ 09.09.2021):
...
<details><summary><b><a href="https://github.com/WhyNotHugo/python-barcode">python-barcode</a></b> (🥈25 ·  ⭐ 420) - Create barcodes in Python with no extra dependencies. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 43 · 🔀 110 · 📥 250 · 📦 15K · 📋 100 - 40% open · ⏱️ 03.12.2022):
...
- [PyPi](https://pypi.org/project/python-barcode) (📥 160K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 8.7K · ⏱️ 22.08.2020):
	```
	conda install -c conda-forge python-barcode
	```
</details>
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥉22 ·  ⭐ 470) - A fast image processing library with low memory needs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 43 · 📦 420 · 📋 320 - 38% open · ⏱️ 08.01.2023):
...
- [PyPi](https://pypi.org/project/pyvips) (📥 20K / month):
	...
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 44K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/hhatto/nude.py) (👨‍💻 12 · 🔀 130 · 📦 3.1K · 📋 10 - 70% open · ⏱️ 23.11.2020):
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 55 · 🔀 540 · 📋 190 - 20% open · ⏱️ 28.11.2022):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 370 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 540 · 🔀 4.5K · 📥 55K · 📋 4.6K - 26% open · ⏱️ 12.01.2023):

	```
	git clone https://github.com/micropython/micropython
	```
- [PyPi](https://pypi.org/project/micropython) (📥 2 / month):
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 230 · 📥 43K · 📋 550 - 45% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.3K · 🔀 25K · 📋 62K - 10% open · ⏱️ 12.01.2023):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 99K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 210K / month):
	```
	pip install pyston
	```
...
- [PyPi](https://pypi.org/project/Pyjion) (📥 760 / month):
	...
	pip install Pyjion
	```
- [Conda](https://anaconda.org/conda-forge/Pyjion) (📥 420 · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 58 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 65 / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 52 · 🔀 260 · 📦 2.1K · 📋 360 - 58% open · ⏱️ 06.12.2022):

	```
	git clone https://github.com/jonathanslenders/ptpython
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 350K / month):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 210 · 📋 770 - 16% open · ⏱️ 17.12.2022):
...
- [PyPi](https://pypi.org/project/bpython) (📥 64K / month):
	...
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 56K · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 52 · 📦 2.9K · ⏱️ 08.04.2021):
...
- [PyPi](https://pypi.org/project/schedule) (📥 2.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 26K · ⏱️ 10.04.2021):
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 120 · 🔀 1.1K · 📦 1.5K · 📋 3.2K - 21% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 340K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 380K · ⏱️ 07.01.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 49 · 🔀 270 · 📦 48 · 📋 100 - 6% open · ⏱️ 10.01.2023):
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 74 · 📋 9 - 11% open · ⏱️ 14.05.2020):

	```
	git clone https://github.com/fengsp/plan
	```
- [PyPi](https://pypi.org/project/plan) (📥 1.4K / month):
	```
	pip install plan
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 41 · 🔀 570 · 📦 36K · 📋 680 - 9% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/loguru) (📥 3.5M / month):
	...
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 870K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 320 · 📥 3.8K · 📦 28K · 📋 790 - 21% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 590 · 🔀 8K · 📥 5.7K · 📦 42K · 📋 4.7K - 6% open · ⏱️ 11.01.2023):
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.6K · 📦 36K · 📋 1.7K - 1% open · ⏱️ 25.10.2022):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 780K / month):
	```
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 180K · ⏱️ 10.01.2023):
	```
	conda install -c conda-forge gym
	```
</details>
<details><summary><b><a href="https://github.com/numenta/nupic">NuPIC</a></b> (🥈25 ·  ⭐ 6.3K · 💀) - Numenta Platform for Intelligent Computing. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 260 · 🔀 1.4K · 📋 1.9K - 15% open · ⏱️ 12.01.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 3.9K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 4.8K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/josephreisinger/vowpal_porpoise) (👨‍💻 14 · 🔀 28 · 📋 9 - 66% open · ⏱️ 07.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/vowpal_porpoise) (📥 15 / month):
	```
...
<details><summary><b><a href="https://github.com/mhammond/pywin32">PyWin32</a></b> (🥇29 ·  ⭐ 4.1K) - Python Extensions for Windows. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 84 · 🔀 710 · 📥 590K · 📦 100K · 📋 1.7K - 26% open · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 98 · 🔀 540 · 📥 710 · 📦 140 · 📋 1.3K - 7% open · ⏱️ 30.11.2022):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 59K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 750K · ⏱️ 09.01.2023):
...
- [PyPi](https://pypi.org/project/itsdangerous) (📥 51M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 4.5M · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 81 · 🔀 330 · 📥 23 · 📦 2.9K · 📋 140 - 31% open · ⏱️ 10.12.2022):

	```
	git clone https://github.com/mahmoud/boltons
	```
- [PyPi](https://pypi.org/project/boltons) (📥 2.6M / month):
	```
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 730K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 14 · 🔀 160 · 📦 130K · 📋 36 - 8% open · ⏱️ 17.07.2022):

	```
	git clone https://github.com/jek/blinker
	```
- [PyPi](https://pypi.org/project/blinker) (📥 6.1M / month):
	```
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 7.4M · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.6K · 📦 400 · 📋 910 - 35% open · ⏱️ 22.12.2022):

	```
	git clone https://github.com/magenta/magenta
	```
- [PyPi](https://pypi.org/project/magenta) (📥 7.2K / month):
	```
	pip install magenta
	```
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1.6K · 📋 13 - 7% open · ⏱️ 16.05.2021):

	```
	git clone https://github.com/mitsuhiko/pluginbase
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 440K / month):
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 440 · 🔀 4.1K · 📥 4.2K · 📦 40K · 📋 1.8K - 20% open · ⏱️ 21.12.2022):
...
- [PyPi](https://pypi.org/project/gensim) (📥 4.2M / month):
	...
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 950K · ⏱️ 21.12.2022):
	```
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.4K · 📦 17K · 📋 820 - 73% open · ⏱️ 15.02.2020):

	```
	git clone https://github.com/fxsjy/jieba
	```
- [PyPi](https://pypi.org/project/jieba) (📥 570K / month):
	```
	pip install jieba
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 29 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 54 · 🔀 810 · 📦 1.4K · 📋 740 - 9% open · ⏱️ 15.09.2022):
...
- [PyPi](https://pypi.org/project/stanza) (📥 130K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 7.5K · ⏱️ 15.09.2022):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 940 · 📥 96K · 📦 240 · 📋 160 - 74% open · ⏱️ 08.06.2022):
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 250 · 📦 450 · 📋 67 - 26% open · ⏱️ 10.07.2021):

	```
	git clone https://github.com/PetrochukM/PyTorch-NLP
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 4.5K / month):
	```
...
<details><summary><b><a href="https://github.com/aboSamoor/polyglot">polyglot</a></b> (🥉17 ·  ⭐ 2.1K · 💀) - Natural language pipeline supporting hundreds of languages. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 310 · 📋 220 - 68% open · ⏱️ 22.09.2020):

	```
	git clone https://github.com/aboSamoor/polyglot
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 46K / month):
	```
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉16 ·  ⭐ 46K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 980 · 📋 580 - 21% open · ⏱️ 09.01.2023):
...
<details><summary><b><a href="https://github.com/justquick/django-activity-stream">django-activity-stream</a></b> (🥇26 ·  ⭐ 2.1K) - Generating generic activity streams from the actions.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 2 · 📦 910 · 📋 300 - 5% open · ⏱️ 19.12.2022):

	```
	git clone https://github.com/justquick/django-activity-stream
	```
- [PyPi](https://pypi.org/project/django-activity-stream) (📥 29K / month):
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 380 · 🔀 1.1K · 📦 19K · 📋 1.6K - 20% open · ⏱️ 09.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 760K / month):
	```
	pip install mongoengine
	```
- [Conda](https://anaconda.org/conda-forge/mongoengine) (📥 180K · ⏱️ 29.12.2022):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 400 · 📦 1.2K · 📋 540 - 37% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 2.7K · 📋 280 - 7% open · ⏱️ 27.12.2022):

	```
	git clone https://github.com/pudo/dataset
	```
- [PyPi](https://pypi.org/project/dataset) (📥 43K / month):
	```
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 4.2K · ⏱️ 16.12.2021):
	```
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 32 · 🔀 160 · 📦 510 · 📋 320 - 42% open · ⏱️ 13.03.2022):
...
- [GitHub](https://github.com/web2py/pydal) (🔀 130 · 📦 260 · 📋 310 - 44% open · ⏱️ 21.11.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 570 / month):
	```
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 82 · 📋 51 - 70% open · ⏱️ 06.06.2016):
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 420 · 🔀 1.8K · 📥 15M · 📋 4.6K - 12% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 9.7M / month):
	```
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 740K · ⏱️ 11.01.2023):
	```
	conda install -c conda-forge poetry
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥉25 ·  ⭐ 6.5K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 480 · 📋 900 - 12% open · ⏱️ 28.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 7.6M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 67K · ⏱️ 19.12.2022):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.2K · 📋 8.8K - 10% open · ⏱️ 10.01.2023):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇20 ·  ⭐ 630) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/devpi/devpi) (👨‍💻 91 · 🔀 110 · 📦 200 · 📋 720 - 10% open · ⏱️ 07.01.2023):

	```
	git clone https://github.com/devpi/devpi
	```
- [PyPi](https://pypi.org/project/devpi) (📥 2K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 330 · 🔀 780 · 📋 2.8K - 14% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 10.01.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 4.9K · 📋 4.8K - 1% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 5.9K / month):
	```
	pip install sqlmap
	```
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉20 ·  ⭐ 8.2K) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.7K · 📋 130 - 25% open · ⏱️ 06.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 940 / month):
	```
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉18 ·  ⭐ 8.4K · 💤) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 530 · 📦 5.2K · 📋 440 - 27% open · ⏱️ 25.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-guardian) (📥 340K / month):
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 26 · 🔀 130 · 📦 1K · 📋 110 - 22% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/dfunckt/django-rules
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 230 / month):
	```
...
<details><summary><b><a href="https://github.com/amoffat/sh">sh</a></b> (🥇30 ·  ⭐ 6.5K) - A full-fledged subprocess replacement for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/amoffat/sh) (👨‍💻 86 · 🔀 460 · 📦 11K · 📋 420 - 2% open · ⏱️ 05.12.2022):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 640 · 📦 900 · 📋 470 - 25% open · ⏱️ 19.07.2022):
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 550 · 📥 280 · 📦 760 · 📋 440 - 16% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 27 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 3.5K / month):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 78 · 🔀 140 · 📦 47K · 📋 280 - 25% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 500K / month):
	```
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 970K · ⏱️ 15.12.2022):
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥇38 ·  ⭐ 53K · 📈) - A modern, fast, web framework for building APIs with Python 3.6+ based.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 410 · 🔀 4.3K · 📦 120K · 📋 3.3K - 27% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 9.3M / month):
	```
	pip install fastapi
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 880 · 📥 4.2K · 📦 7.4K · 📋 970 - 16% open · ⏱️ 08.01.2023):
...
- [PyPi](https://pypi.org/project/falcon) (📥 610K / month):
	...
	pip install falcon
	```
- [Conda](https://anaconda.org/conda-forge/falcon) (📥 290K · ⏱️ 19.11.2022):
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 980 · 📦 86K · 📋 550 - 17% open · ⏱️ 04.03.2022):

	```
	git clone https://github.com/flask-restful/flask-restful
	```
- [PyPi](https://pypi.org/project/flask-restful) (📥 1.1M / month):
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 320 · 🔀 1.4K · 📦 8.7K · 📋 1.2K - 3% open · ⏱️ 27.12.2022):
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 1.8K · 📋 460 - 35% open · ⏱️ 10.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/hug) (📥 48K / month):
	```
	pip install hug
	```
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 33 · 🔀 180 · 📦 5.5K · 📋 64 - 18% open · ⏱️ 01.12.2022):
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 91 · 🔀 410 · 📦 720 · 📋 310 - 7% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/apistar) (📥 8.4K / month):
	```
	pip install apistar
	```
...
- [GitHub](https://github.com/Cornices/cornice) (👨‍💻 120 · 🔀 140 · 📦 770 · 📋 240 - 19% open · ⏱️ 18.07.2022):
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 210 · 📦 23 · 📋 84 - 38% open · ⏱️ 21.12.2020):
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.1K · 📋 310 - 4% open · ⏱️ 09.01.2023):
...
- [PyPi](https://pypi.org/project/zerorpc-python):
	...
	```
- [Conda](https://anaconda.org/conda-forge/zerorpc-python) (📥 1.6K · ⏱️ 06.06.2022):
	```
...
<details><summary><b><a href="https://github.com/sympy/sympy">SymPy</a></b> (🥇36 ·  ⭐ 10K) - A Python library for symbolic mathematics. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.7K · 📥 480K · 📦 51K · 📋 12K - 32% open · ⏱️ 12.01.2023):
...
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">statsmodels</a></b> (🥈34 ·  ⭐ 8.1K) - Statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 400 · 🔀 2.5K · 📥 26 · 📦 77K · 📋 4.9K - 47% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/statsmodels/statsmodels
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 8.4M / month):
	```
	pip install statsmodels
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 8.3M · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4.1K · 📦 900 · 📋 980 - 33% open · ⏱️ 14.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/zipline) (📥 2.3K / month):
	```
	pip install zipline
	```
...
<details><summary><b><a href="https://github.com/pymc-devs/pymc">PyMC</a></b> (🥉27 ·  ⭐ 7.2K) - Markov Chain Monte Carlo sampling toolkit. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 430 · 🔀 1.6K · 📥 1.9K · 📦 1K · 📋 2.9K - 5% open · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/pymc3) (📥 340K / month):
	...
	pip install pymc3
	```
- [Conda](https://anaconda.org/conda-forge/pymc3) (📥 480K · ⏱️ 20.05.2022):
	```
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 120 · ⏱️ 17.12.2022):
...
- [PyPi](https://pypi.org/project/karateclub) (📥 2.6K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 15K · ⏱️ 28.01.2022):
	```
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 95 · 🔀 340 · 📋 3K - 3% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 240 / month):
	```
...
<details><summary><b><a href="https://github.com/obspy/obspy">ObsPy</a></b> (🥉18 ·  ⭐ 980) - A Python toolbox for seismology. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/obspy/obspy) (🔀 490 · 📥 6.8K · 📋 1.7K - 9% open · ⏱️ 10.01.2023):
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 8.5K · 📋 1.2K - 36% open · ⏱️ 21.11.2022):

	```
	git clone https://github.com/django-haystack/django-haystack
	```
- [PyPi](https://pypi.org/project/django-haystack) (📥 96K / month):
	```
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 300 · 📦 2.8K · 📋 140 - 15% open · ⏱️ 12.04.2022):
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 750 · 📥 150 · 📦 6.9K · 📋 1.3K - 9% open · ⏱️ 27.10.2022):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 64K · 📋 1.2K - 11% open · ⏱️ 19.12.2022):

	```
	git clone https://github.com/marshmallow-code/marshmallow
	```
- [PyPi](https://pypi.org/project/marshmallow) (📥 24M / month):
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 45 · 📦 710 · 📋 79 - 13% open · ⏱️ 12.09.2022):
...
- [PyPi](https://pypi.org/project/pysimdjson) (📥 200K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 50K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 19 · 🔀 42 · 📦 3.1K · 📋 100 - 11% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/python-rapidjson/python-rapidjson
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 800K / month):
	```
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📥 290 · 📋 1.3K - 47% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/Zappa) (📥 76K / month):
	```
	pip install Zappa
	```
...
<details><summary><b><a href="https://github.com/xonsh/xonsh">xonsh</a></b> (🥇15 ·  ⭐ 6.7K) - A Python-powered, cross-platform, Unix-gazing shell language and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xonsh/xonsh) (🔀 570 · 📥 7.9K · 📋 2.4K - 10% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 35 · 🔀 220 · 📦 190K · 📋 250 - 6% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/mistune) (📥 13M / month):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 10M · ⏱️ 15.07.2022):
	```
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 24K · 📋 240 - 12% open · ⏱️ 02.01.2023):
...
- [PyPi](https://pypi.org/project/tablib) (📥 1.3M / month):
	...
	pip install tablib
	```
- [Conda](https://anaconda.org/conda-forge/tablib) (📥 81K · ⏱️ 10.12.2022):
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 54K · 📋 830 - 1% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 10M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/XlsxWriter) (📥 2.4M · ⏱️ 05.01.2023):
	```
...
- [PyPi](https://pypi.org/project/csvkit) (📥 160K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 78K · ⏱️ 04.01.2023):
	```
...
- [PyPi](https://pypi.org/project/pdfminer) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pdfminer) (📥 26K · ⏱️ 15.02.2021):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 440 · 📥 25K · 📦 26K · 📋 1.7K - 17% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 62K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 520K · ⏱️ 29.12.2022):
	```
...
- [PyPi](https://pypi.org/project/pyexcel) (📥 130K / month):
	...
	pip install pyexcel
	```
- [Conda](https://anaconda.org/conda-forge/pyexcel) (📥 52K · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 160 · 🔀 1K · 📋 640 - 12% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/mstamy2/PyPDF2
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 4M / month):
	```
	pip install PyPDF2
	```
- [Conda](https://anaconda.org/conda-forge/PyPDF2) (📥 330K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 370 · 📋 750 - 45% open · ⏱️ 20.09.2021):

	```
	git clone https://github.com/scanny/python-pptx
	```
- [PyPi](https://pypi.org/project/python-pptx) (📥 1.2M / month):
	```
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 51 · 🔀 320 · 📦 1.5K · 📋 380 - 19% open · ⏱️ 07.01.2023):
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 56 · 📦 10 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 64 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 720 · 📦 6.5K · 📋 1.6K - 4% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/getpelican/pelican
	```
- [PyPi](https://pypi.org/project/pelican) (📥 17K / month):
	```
	pip install pelican
	```
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 230 · 🔀 350 · 📦 460 · 📋 2.1K - 2% open · ⏱️ 09.01.2023):
...
- [PyPi](https://pypi.org/project/nikola) (📥 1.2K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 7K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.1K · 📦 29K · 📋 1.8K - 6% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/sunainapai/makesite) (👨‍💻 8 · 🔀 270 · 📋 13 - 38% open · ⏱️ 12.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/makesite) (📥 230 / month):
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 150 · 🔀 560 · 📋 400 - 18% open · ⏱️ 21.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-taggit) (📥 300K / month):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 12K · 📋 1K - 18% open · ⏱️ 08.01.2023):
...
<details><summary><b><a href="https://github.com/coleifer/huey">huey</a></b> (🥈27 ·  ⭐ 4.3K) - Little multi-threaded task queue. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 350 · 📦 1K · ⏱️ 30.12.2022):

	```
	git clone https://github.com/coleifer/huey
	```
- [PyPi](https://pypi.org/project/huey) (📥 55K / month):
	```
	pip install huey
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 86 · 🔀 230 · 📥 34 · 📦 560 · 📋 310 - 11% open · ⏱️ 28.12.2022):

	```
	git clone https://github.com/Bogdanp/dramatiq
	```
- [PyPi](https://pypi.org/project/dramatiq) (📥 79K / month):
	```
	pip install dramatiq
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 39K · ⏱️ 03.04.2022):
	```
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 930 - 5% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/pallets/jinja
	```
- [PyPi](https://pypi.org/project/jinja) (📥 5.7K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 490 · 🔀 1.7K · 📦 96K · 📋 600 - 2% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 6.7M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 700K · ⏱️ 12.01.2023):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 170 · 🔀 2K · 📥 540 · 📦 6.6K · 📋 4K - 5% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/robotframework) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robotframework) (📥 110K · ⏱️ 09.01.2023):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 300 · 📥 82 · 📦 18K · 📋 250 - 0% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 7.6M / month):
	```
...
<details><summary><b><a href="https://github.com/HypothesisWorks/hypothesis">hypothesis</a></b> (🥈32 ·  ⭐ 6.4K) - Hypothesis is an advanced Quickcheck style property based.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 510 · 📦 16K · 📋 1.3K - 3% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 3.8M / month):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7M · ⏱️ 08.01.2023):
	```
	conda install -c conda-forge hypothesis
	```
</details>
<details><summary><b><a href="https://github.com/cobrateam/splinter">splinter</a></b> (🥈31 ·  ⭐ 2.6K) - Open source tool for testing web applications. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 500 · 📦 5.9K · 📋 510 - 8% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/cobrateam/splinter
	```
- [PyPi](https://pypi.org/project/splinter) (📥 69K / month):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 120 · 🔀 300 · 📦 4.5K · 📋 340 - 24% open · ⏱️ 01.11.2022):
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 980 · 📦 20K · 📋 600 - 64% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 500K / month):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 380 · 📦 1.1K · 📋 310 - 0% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 81K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 72K · ⏱️ 18.12.2022):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.5K · 📋 1.4K - 0% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/locustio/locust
	```
- [PyPi](https://pypi.org/project/locust) (📥 1.1M / month):
	```
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 95K · ⏱️ 06.01.2023):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 250 · 📦 7K · 📋 230 - 39% open · ⏱️ 16.10.2022):

	```
	git clone https://github.com/gabrielfalcao/HTTPretty
	```
- [PyPi](https://pypi.org/project/HTTPretty) (📥 380K / month):
	```
	pip install HTTPretty
	```
- [Conda](https://anaconda.org/conda-forge/HTTPretty) (📥 260K · ⏱️ 16.08.2021):
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 51 · 🔀 110 · 📦 150 · 📋 680 - 15% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 44K / month):
	```
	pip install schemathesis
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 2.8K · ⏱️ 13.11.2022):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 230 · 📋 270 - 36% open · ⏱️ 12.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 4.9M / month):
	```
	pip install freezegun
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 640K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 5.6K · 📋 260 - 19% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/nose-devs/nose2
	```
- [PyPi](https://pypi.org/project/nose2) (📥 460K / month):
	```
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 79K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 38 · 🔀 73 · 📦 760 · 📋 180 - 2% open · ⏱️ 20.09.2022):

	```
	git clone https://github.com/CleanCut/green
	```
- [PyPi](https://pypi.org/project/green) (📥 9.2K / month):
	```
	pip install green
	```
...
- [PyPi](https://pypi.org/project/httmock) (📥 280K / month):
	...
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 7.1K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 60K / month):
	```
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 590 · 📦 640K · 📋 490 - 41% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 52 · 🔀 230 · 📥 7.5K · 📦 690K · 📋 280 - 12% open · ⏱️ 22.12.2022):
...
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 6.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/fuzzywuzzy) (📥 420K · ⏱️ 18.11.2020):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 32 · 🔀 110 · 📦 14K · ⏱️ 04.01.2023):
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 880 · 📦 3.3K · ⏱️ 18.09.2022):
...
- [PyPi](https://pypi.org/project/textdistance) (📥 440K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 290K · ⏱️ 18.09.2022):
	```
	conda install -c conda-forge textdistance
	```
</details>
<details><summary><b><a href="https://github.com/pwaller/pyfiglet">pyfiglet</a></b> (🥈26 ·  ⭐ 1.1K) - An implementation of figlet written in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 100 · 📦 25K · 📋 48 - 27% open · ⏱️ 16.09.2022):

	```
	git clone https://github.com/pwaller/pyfiglet
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 800K / month):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 31 · 🔀 92 · 📋 63 - 1% open · ⏱️ 22.11.2022):
...
- [PyPi](https://pypi.org/project/python-slugify) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 1.2M · ⏱️ 19.11.2022):
	```
...
- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 35 · 🔀 390 · 📋 180 - 1% open · ⏱️ 29.11.2022):
...
- [PyPi](https://pypi.org/project/ply) (📥 21M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 2.9M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 31 · 🔀 190 · 📦 5.3K · 📋 72 - 56% open · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 230 - 9% open · ⏱️ 24.12.2022):
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 8.4K · 📋 130 - 9% open · ⏱️ 25.10.2022):
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 47 · 📦 2.1K · 📋 18 - 55% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 23K / month):
	```
...
- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 22 · 🔀 92 · 📦 990 · 📋 100 - 20% open · ⏱️ 14.11.2022):
...
- [GitHub](https://github.com/voronind/awesome-slugify) (👨‍💻 11 · 🔀 41 · 📦 3.2K · 📋 24 - 54% open · ⏱️ 20.01.2017):
	...
	```
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 43K / month):
	```
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 26 · 🔀 370 · 📋 160 - 3% open · ⏱️ 09.01.2023):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.6K · 📦 240K · 📋 2.8K - 4% open · ⏱️ 11.01.2023):
...
- [PyPi](https://pypi.org/project/boto3) (📥 500M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 14M · ⏱️ 12.01.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 860 · 📥 230 · 📦 20K · 📋 770 - 6% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/gspread) (📥 8.5M / month):
	...
	pip install gspread
	```
- [Conda](https://anaconda.org/conda-forge/gspread) (📥 240K · ⏱️ 22.11.2022):
	```
	conda install -c conda-forge gspread
	```
</details>
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥈35 ·  ⭐ 6.2K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 130K · 📋 960 - 7% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 41M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 1.8M · ⏱️ 11.01.2023):
	```
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 390 · 📦 5.6K · 📋 320 - 5% open · ⏱️ 16.07.2021):
...
<details><summary><b><a href="https://github.com/jcarbaugh/django-wordpress">django-wordpress</a></b> (🥉11 ·  ⭐ 330 · 💀) - WordPress models and views for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jcarbaugh/django-wordpress) (👨‍💻 10 · 🔀 79 · 📋 11 - 18% open · ⏱️ 24.01.2018):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.4K · 📋 280 - 2% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 620K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 58 · 📦 7.4K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 67K / month):
	```
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 15 · 🔀 140 · 📋 110 - 26% open · ⏱️ 01.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 1.4M / month):
	```
	pip install furl
	```
- [Conda](https://anaconda.org/conda-forge/furl) (📥 220K · ⏱️ 28.09.2021):
	```
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥇23 ·  ⭐ 2.6K) - Most Powerful multi-threaded Video Processing framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 210 · 📥 700 · 📦 260 · 📋 250 - 1% open · ⏱️ 06.07.2022):
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 57K / month):
	```
...
<details><summary><b><a href="https://github.com/jazzband/django-pipeline">django-pipeline</a></b> (🥇29 ·  ⭐ 1.5K) - An asset packaging library for Django. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.1K · 📋 440 - 27% open · ⏱️ 06.08.2022):
...
- [GitHub](https://github.com/miracle2k/webassets) (👨‍💻 160 · 🔀 250 · 📦 6.1K · 📋 290 - 19% open · ⏱️ 01.05.2021):

	```
	git clone https://github.com/miracle2k/webassets
	```
- [PyPi](https://pypi.org/project/webassets) (📥 180K / month):
	```
...
- [GitHub](https://github.com/miracle2k/flask-assets) (👨‍💻 38 · 🔀 85 · 📦 6.7K · 📋 97 - 21% open · ⏱️ 29.02.2020):
...
- [PyPi](https://pypi.org/project/django-storages) (📥 1.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 43K · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 210 · 🔀 540 · 📋 630 - 16% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/django-compressor/django-compressor
	```
- [PyPi](https://pypi.org/project/django-compressor) (📥 340K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 860 · 📦 9.4K · 📋 370 - 44% open · ⏱️ 10.05.2020):

	```
	git clone https://github.com/psf/requests-html
	```
- [PyPi](https://pypi.org/project/requests-html) (📥 700K / month):
	```
	pip install requests-html
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 4.6K · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 24 · 🔀 480 · 📦 1.5K · 📋 110 - 13% open · ⏱️ 23.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/sumy) (📥 17K / month):
	```
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 3.6K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 85 · 📦 870 · ⏱️ 14.12.2022):

	```
	git clone https://github.com/coleifer/micawber
	```
- [PyPi](https://pypi.org/project/micawber) (📥 33K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 7.4K · ⏱️ 14.07.2021):
	```
...
- [PyPi](https://pypi.org/project/html2text) (📥 1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 25K · ⏱️ 09.02.2020):
	```
...
<details><summary><b><a href="https://github.com/gaojiuli/toapi">toapi</a></b> (🥉17 ·  ⭐ 3.3K · 💀) - Every web site provides APIs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 18 · 📋 54 - 11% open · ⏱️ 28.06.2021):

	```
	git clone https://github.com/gaojiuli/toapi
	```
- [PyPi](https://pypi.org/project/toapi) (📥 150 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/michaelhelmick/lassie) (👨‍💻 15 · 🔀 46 · 📦 30 · 📋 39 - 25% open · ⏱️ 20.08.2021):
...
- [GitHub](https://github.com/binux/pyspider) (👨‍💻 62 · 🔀 3.6K · 📦 320 · 📋 820 - 32% open · ⏱️ 02.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyspider) (📥 1.5K / month):
	```
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 51 · 🔀 1.4K · 📥 210 · 📦 45 · 📋 450 - 25% open · ⏱️ 10.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/portia) (📥 210 / month):
	```
	pip install portia
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 340 · 📦 870 · 📋 73 - 58% open · ⏱️ 07.06.2015):

	```
	git clone https://github.com/jmcarp/robobrowser
	```
- [PyPi](https://pypi.org/project/robobrowser) (📥 12K / month):
	```
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 66 · 🔀 260 · ⏱️ 28.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 1.9K / month):
	```
	pip install grab
	```
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 83 · 🔀 120 · 📦 460 · 📋 370 - 5% open · ⏱️ 05.11.2022):
...
<details><summary><b><a href="https://github.com/aaugustin/websockets">websockets</a></b> (🥇30 ·  ⭐ 4.3K) - A library for building WebSocket servers and clients with a focus.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 62 · 🔀 450 · 📦 81K · 📋 950 - 1% open · ⏱️ 08.01.2023):
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 130 · 🔀 730 · 📦 23K · 📋 880 - 20% open · ⏱️ 18.12.2022):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 730 · 📋 1.2K - 5% open · ⏱️ 30.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/channels) (📥 470K / month):
	```
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 830K · 📋 1.9K - 17% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/benoitc/gunicorn
	```
- [PyPi](https://pypi.org/project/gunicorn) (📥 22M / month):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 250 · 📦 900K · 📋 1K - 1% open · ⏱️ 09.01.2023):
...
- [PyPi](https://pypi.org/project/werkzeug) (📥 77M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 6.6M · ⏱️ 09.08.2022):
	```
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 49 · 🔀 150 · 📦 98K · 📋 210 - 8% open · ⏱️ 25.12.2022):

	```
	git clone https://github.com/Pylons/waitress
	```
- [PyPi](https://pypi.org/project/waitress) (📥 2.4M / month):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 530 · 📋 150 - 14% open · ⏱️ 11.09.2022):
...
- [PyPi](https://pypi.org/project/bjoern) (📥 17K / month):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 94K · ⏱️ 02.11.2022):
	```
