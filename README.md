...
本资源清单包含690个python相关的开源工具资源，这些热门工具总共分成91个不同的应用领域，目前在github上已经收到2.9M个点赞。所有的工具(github项目)每周会自动从GitHub和工具维护平台采集信息，并更新排行展示。本清单参考[best-of模板](https://github.com/best-of-lists/best-of)完成，内容参考了[awesome-python](https://github.com/vinta/awesome-python)，欢迎大家提PR丰富本清单。
## Contents
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 200 · 🔀 920 · 📦 9.4K · 📋 840 - 11% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/flower) (📥 2M / month):
	...
	pip install flower
	```
- [Conda](https://anaconda.org/conda-forge/flower) (📥 130K · ⏱️ 07.08.2022):
	```
...
- [GitHub](https://github.com/geex-arts/django-jet) (👨‍💻 29 · 🔀 660 · 📦 2.7K · 📋 340 - 63% open · ⏱️ 21.05.2019):

	```
	git clone https://github.com/geex-arts/django-jet
	```
- [PyPi](https://pypi.org/project/django-jet) (📥 19K / month):
	```
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 23 · 🔀 790 · 📦 25 · 📋 1.1K - 0% open · ⏱️ 04.10.2022):
...
<details><summary><b><a href="https://github.com/wooey/Wooey">wooey</a></b> (🥉23 ·  ⭐ 1.8K) - A Django app which creates automatic web UIs for Python scripts. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 110 · 📋 17 - 76% open · ⏱️ 23.09.2022):
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 910 · 🔀 37K · 📋 1.2K - 7% open · ⏱️ 20.10.2022):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 68M · ⏱️ 22.08.2022):
	```
...
- [PyPi](https://pypi.org/project/transitions) (📥 340K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 260K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 190 · 🔀 4.1K · 📦 71 · 📋 160 - 37% open · ⏱️ 29.07.2022):
...
- [PyPi](https://pypi.org/project/algorithms) (📥 5K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 1K · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 23 · 🔀 180 · 📦 86K · 📋 160 - 8% open · ⏱️ 17.10.2022):
...
<details><summary><b><a href="https://github.com/tylerlaberge/PyPattyrn">PyPattyrn</a></b> (🥉18 ·  ⭐ 1.6K · 💀) - A simple yet effective library for implementing common design.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 120 · 📦 28 · ⏱️ 09.02.2020):
...
<details><summary><b><a href="https://github.com/faif/python-patterns">python-patterns</a></b> (🥉17 ·  ⭐ 35K) - A collection of design patterns in Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 110 · 🔀 490 · 📋 87 - 21% open · ⏱️ 04.10.2022):
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇34 ·  ⭐ 5.8K · 📈) - A lightning-fast ASGI server implementation, using uvloop and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 140 · 🔀 490 · 📦 100K · 📋 610 - 6% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 63 · 🔀 210 · 📦 16K · 📋 290 - 10% open · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/daphne) (📥 520K / month):
	...
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 110K · ⏱️ 07.10.2022):
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 55 · 🔀 440 · 📥 350 · 📦 53K · 📋 290 - 14% open · ⏱️ 14.09.2022):
...
- [PyPi](https://pypi.org/project/uvloop) (📥 19M / month):
	...
	pip install uvloop
	```
- [Conda](https://anaconda.org/conda-forge/uvloop) (📥 500K · ⏱️ 14.09.2022):
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 270 · 📦 17K · 📋 680 - 39% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 6.9M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 840K · ⏱️ 28.09.2022):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 510 · 🔀 1.7K · 📥 7.7K · 📦 260 · 📋 2.5K - 18% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 94 · 🔀 850 · 📦 15K · 📋 500 - 47% open · ⏱️ 15.10.2022):
...
- [PyPi](https://pypi.org/project/pydub) (📥 2.4M / month):
	...
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 32K · ⏱️ 13.03.2021):
	```
	conda install -c conda-forge pydub
	```
</details>
<details><summary><b><a href="https://github.com/quodlibet/mutagen">mutagen</a></b> (🥈28 ·  ⭐ 1.1K) - A Python module to handle audio metadata. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 38 · 🔀 130 · 📥 57K · 📦 8.5K · 📋 480 - 20% open · ⏱️ 09.10.2022):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 2.3M / month):
	```
	pip install mutagen
	```
- [Conda](https://anaconda.org/conda-forge/mutagen) (📥 130K · ⏱️ 09.10.2022):
	```
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 25 · 🔀 55 · 📥 2.3K · 📦 1.9K · 📋 190 - 23% open · ⏱️ 08.10.2022):

	```
	git clone https://github.com/nicfit/eyeD3
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 40K / month):
	```
	pip install eyeD3
	```
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 27 · 🔀 1.1K · 📦 310 · 📋 290 - 58% open · ⏱️ 18.09.2022):
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 820 · 📋 1K - 3% open · ⏱️ 12.10.2022):
...
- [PyPi](https://pypi.org/project/librosa) (📥 1.5M / month):
	...
	pip install librosa
	```
- [Conda](https://anaconda.org/conda-forge/librosa) (📥 530K · ⏱️ 27.06.2022):
	```
	conda install -c conda-forge librosa
	```
</details>
<details><summary><b><a href="https://github.com/devsnd/tinytag">tinytag</a></b> (🥉22 ·  ⭐ 560) - A library for reading music meta data of MP3, OGG, FLAC and Wave files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 23 · 🔀 89 · 📦 610 · 📋 95 - 13% open · ⏱️ 30.09.2022):

	```
	git clone https://github.com/devsnd/tinytag
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 28K / month):
	```
	pip install tinytag
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉19 ·  ⭐ 690) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 94 · 📦 11 · 📋 36 - 27% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 22 · 🔀 96 · 📋 81 - 38% open · ⏱️ 12.08.2022):
...
- [PyPi](https://pypi.org/project/audioread) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/audioread) (📥 510K · ⏱️ 14.08.2022):
	```
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.3K · 📦 24 · 📋 220 - 39% open · ⏱️ 03.06.2020):

	```
	git clone https://github.com/worldveil/dejavu
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 86 / month):
	```
	pip install dejavu
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 190 · 🔀 440 · 📦 270K · 📋 360 - 20% open · ⏱️ 18.10.2022):

	```
	git clone https://github.com/idan/oauthlib
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 91M / month):
	```
	pip install oauthlib
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 6.6M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 580 · 📦 260K · 📋 360 - 3% open · ⏱️ 20.10.2022):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 110M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 8.3M · ⏱️ 20.10.2022):
	```
	conda install -c conda-forge pyjwt
	```
</details>
<details><summary><b><a href="https://github.com/pennersr/django-allauth">django-allauth</a></b> (🥈34 ·  ⭐ 7.5K) - Authentication app for Django that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 600 · 🔀 2.6K · 📦 110K · 📋 1.9K - 16% open · ⏱️ 14.09.2022):
...
- [PyPi](https://pypi.org/project/django-allauth) (📥 590K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 80K · ⏱️ 07.06.2022):
	```
	conda install -c conda-forge django-allauth
	```
</details>
<details><summary><b><a href="https://github.com/lepture/authlib">authlib</a></b> (🥈33 ·  ⭐ 3.3K) - JavaScript Object Signing and Encryption draft implementation. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lepture/authlib) (👨‍💻 87 · 🔀 330 · 📦 23K · 📋 340 - 12% open · ⏱️ 15.10.2022):
...
- [PyPi](https://pypi.org/project/authlib) (📥 5.7M / month):
	...
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 85K · ⏱️ 13.09.2022):
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 9.7K · 📋 130 - 38% open · ⏱️ 12.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 40K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 670 · 📋 730 - 20% open · ⏱️ 18.10.2022):
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 38 · 🔀 230 · 📋 500 - 16% open · ⏱️ 09.10.2022):
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 18K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 23K · ⏱️ 11.08.2022):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 70 · 🔀 660 · 📋 3.8K - 3% open · ⏱️ 01.10.2022):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 130 · 🔀 310 · 📦 500K · 📋 580 - 17% open · ⏱️ 04.10.2022):
...
- [PyPi](https://pypi.org/project/attrs) (📥 140M / month):
	...
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 21M · ⏱️ 31.07.2022):
	```
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 51 · 📦 9.2K · 📋 53 - 7% open · ⏱️ 01.10.2022):
...
- [PyPi](https://pypi.org/project/bidict) (📥 910K / month):
	...
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 160K · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 3 · 🔀 18 · 📥 63 · 📦 66 · 📋 9 - 77% open · ⏱️ 30.10.2015):
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 85 · 📥 30 · 📋 140 - 14% open · ⏱️ 02.04.2022):
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 320 · 🔀 1.5K · 📋 1K - 3% open · ⏱️ 19.09.2022):
...
<details><summary><b><a href="https://github.com/indico/indico">indico</a></b> (🥈22 ·  ⭐ 1.4K) - A feature-rich event management system, made @.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/indico/indico) (👨‍💻 130 · 🔀 340 · 📥 2.9K · 📋 3.3K - 18% open · ⏱️ 13.10.2022):
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 96 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 47 · 📦 4.1K · 📋 190 - 10% open · ⏱️ 26.08.2022):
...
- [PyPi](https://pypi.org/project/pylibmc) (📥 180K / month):
	...
	pip install pylibmc
	```
- [Conda](https://anaconda.org/conda-forge/pylibmc) (📥 190K · ⏱️ 30.08.2022):
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 64 · 🔀 190 · 📦 760 · 📋 300 - 7% open · ⏱️ 11.07.2022):
...
<details><summary><b><a href="https://github.com/bbangert/beaker">beaker</a></b> (🥉23 ·  ⭐ 490 · 💤) - A WSGI middleware for sessions and caching. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 86 · 🔀 130 · 📦 3.8K · 📋 120 - 53% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 240 · 📋 71 - 21% open · ⏱️ 06.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 9.3K / month):
	```
...
- [GitHub](https://github.com/errbotio/errbot) (🔀 580 · 📦 260 · 📋 750 - 8% open · ⏱️ 07.10.2022):
...
🔗&nbsp;<b><a href="https://github.com/DmytroLitvinov/awesome-flake8-extensions">awesome-flake8-extensions</a></b> ( ⭐ 930)  - A curated awesome list of flake8 extensions. Feel free to..
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 260 · 🔀 470 · 📦 280K · 📋 1.1K - 9% open · ⏱️ 20.05.2022):
...
- [PyPi](https://pypi.org/project/isort) (📥 24M / month):
	...
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 3.8M · ⏱️ 09.11.2021):
	```
	conda install -c conda-forge isort
	```
</details>
<details><summary><b><a href="https://github.com/wemake-services/wemake-python-styleguide">wemake-python-styleguide</a></b> (🥇32 ·  ⭐ 2K) - The strictest and most opinionated python linter ever. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 350 · 📦 6.7K · 📋 1K - 8% open · ⏱️ 20.10.2022):
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 840 · 📦 40K · 📋 760 - 47% open · ⏱️ 23.09.2022):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 340 · 🔀 1.8K · 📥 25K · 📋 2.1K - 15% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/black) (📥 16M / month):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 5.2M · ⏱️ 10.10.2022):
	```
	conda install -c conda-forge black
	```
</details>
<details><summary><b><a href="https://github.com/jendrikseipp/vulture">vulture</a></b> (🥈26 ·  ⭐ 2.3K) - A tool for finding and analysing dead Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/vulture) (📥 440K / month):
	...
	pip install vulture
	```
- [Conda](https://anaconda.org/conda-forge/vulture) (📥 60K · ⏱️ 20.05.2022):
	```
	conda install -c conda-forge vulture
	```
</details>
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈26 ·  ⭐ 940) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 89 · 📦 4.3K · 📋 140 - 31% open · ⏱️ 08.08.2022):
...
- [PyPi](https://pypi.org/project/pylama) (📥 150K / month):
	...
	pip install pylama
	```
- [Conda](https://anaconda.org/conda-forge/pylama) (📥 86K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 79 · 🔀 150 · 📋 320 - 12% open · ⏱️ 24.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 550K / month):
	```
	pip install prospector
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 42K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 220 · 🔀 370 · 📋 320 - 30% open · ⏱️ 19.10.2022):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 190K / month):
	```
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 270 · 📦 370 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 28K / month):
	```
...
<details><summary><b><a href="https://github.com/scottrogowski/code2flow">code2flow</a></b> (🥉19 ·  ⭐ 2.7K) - Turn your Python and JavaScript code into DOT flowcharts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 9 · 🔀 210 · 📦 12 · 📋 46 - 10% open · ⏱️ 25.07.2022):

	```
	git clone https://github.com/scottrogowski/code2flow
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 4.5K / month):
	```
	pip install code2flow
	```
- [Conda](https://anaconda.org/conda-forge/code2flow) (📥 1.4K · ⏱️ 25.03.2022):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 86 · 🔀 240 · 📋 560 - 18% open · ⏱️ 13.10.2022):
...
- [PyPi](https://pypi.org/project/pytype) (📥 370K / month):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 120K · ⏱️ 14.10.2022):
	```
...
<details><summary><b><a href="https://github.com/python/typeshed">typeshed</a></b> (🥉18 ·  ⭐ 3.2K) - Collection of library stubs for Python, with static types. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.2K · 🔀 1.4K · 📋 1.9K - 7% open · ⏱️ 20.10.2022):
...
<details><summary><b><a href="https://github.com/dropbox/pyannotate">pyannotate</a></b> (🥉18 ·  ⭐ 1.3K · 💤) - Auto-generate PEP-484 annotations. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/Instagram/MonkeyType">MonkeyType</a></b> (🥉17 ·  ⭐ 4K) - A system for Python that generates static type annotations by.. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/MonkeyType) (📥 65K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/MonkeyType) (📥 44K · ⏱️ 19.02.2022):
	```
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 200 · 🔀 1.3K · 📦 35K · 📋 930 - 6% open · ⏱️ 20.10.2022):
...
- [PyPi](https://pypi.org/project/rich) (📥 13M / month):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 2.1M · ⏱️ 02.10.2022):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.1K · 📥 10K · 📦 340K · 📋 860 - 34% open · ⏱️ 03.09.2022):
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 49 · 🔀 1.3K · 📦 15K · 📋 260 - 37% open · ⏱️ 16.04.2022):
...
<details><summary><b><a href="https://github.com/peterbrittain/asciimatics">asciimatics</a></b> (🥈25 ·  ⭐ 3.2K) - A package to create full-screen text UIs (from interactive.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 40 · 🔀 230 · 📦 700 · 📋 280 - 8% open · ⏱️ 03.07.2022):
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 160 · 📦 1.2K · 📋 160 - 12% open · ⏱️ 16.07.2022):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 91K / month):
	```
	pip install alive-progress
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 20K · ⏱️ 08.01.2021):
	```
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 83 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
...
- [PyPi](https://pypi.org/project/bashplotlib) (📥 2.6K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/bashplotlib) (📥 3.7K · ⏱️ 08.09.2018):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 630 · 📋 1K - 46% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 150 · 🔀 3.5K · 📥 1.5K · 📦 11K · 📋 780 - 14% open · ⏱️ 01.10.2022):
...
- [PyPi](https://pypi.org/project/httpie) (📥 180K / month):
	...
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 86K · ⏱️ 09.05.2022):
	```
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 440K · ⏱️ 01.06.2022):
	```
	conda install -c conda-forge cookiecutter
	```
</details>
<details><summary><b><a href="https://github.com/nvbn/thefuck">thefuck</a></b> (🥈29 ·  ⭐ 74K) - Correcting your previous console command. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.1K · 📦 380 · 📋 650 - 31% open · ⏱️ 25.09.2022):

	```
	git clone https://github.com/nvbn/thefuck
	```
- [PyPi](https://pypi.org/project/thefuck) (📥 7.5K / month):
	```
	pip install thefuck
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 69 · 🔀 220 · 📦 210 · 📋 320 - 23% open · ⏱️ 20.10.2022):
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 620 · 📦 260 · 📋 600 - 29% open · ⏱️ 02.09.2022):

	```
	git clone https://github.com/dbcli/mycli
	```
- [PyPi](https://pypi.org/project/mycli) (📥 170K / month):
	```
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 41K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 470 · 📦 610 · 📋 650 - 21% open · ⏱️ 13.10.2022):
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 82 · 🔀 820 · 📦 430 · 📋 250 - 9% open · ⏱️ 11.10.2022):
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥉24 ·  ⭐ 740) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 43 · 🔀 92 · 📦 120 · 📋 280 - 11% open · ⏱️ 16.10.2022):
...
- [PyPi](https://pypi.org/project/copier) (📥 21K / month):
	...
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 640 · ⏱️ 21.09.2022):
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 87 · 📥 11K · 📋 200 - 24% open · ⏱️ 14.09.2022):

	```
	git clone https://github.com/laixintao/iredis
	```
- [PyPi](https://pypi.org/project/iredis) (📥 4.4K / month):
	```
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 300 · ⏱️ 10.08.2022):
	```
...
- [GitHub](https://github.com/facebook/PathPicker) (👨‍💻 78 · 🔀 270 · 📥 45K · 📋 170 - 8% open · ⏱️ 03.07.2022):
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 620 · 📦 13 · 📋 69 - 82% open · ⏱️ 19.09.2018):

	```
	git clone https://github.com/cloudnativelabs/kube-shell
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 500 / month):
	```
...
<details><summary><b><a href="https://github.com/dbcli/litecli">litecli</a></b> (🥉19 ·  ⭐ 1.7K) - SQLite CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 60 · 📦 170 · 📋 86 - 31% open · ⏱️ 11.07.2022):
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 270 · 📦 38 · 📋 92 - 32% open · ⏱️ 15.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/saws) (📥 490 / month):
	```
	pip install saws
	```
...
- [GitHub](https://github.com/mooz/percol) (👨‍💻 36 · 🔀 140 · 📦 32 · 📋 65 - 55% open · ⏱️ 23.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/percol) (📥 2.5K / month):
	```
	pip install percol
	```
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 95 · 📦 17 · 📋 48 - 25% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.2K · 📥 2.4M · 📦 1.7K · 📋 670 - 18% open · ⏱️ 13.10.2022):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 130K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 360 · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 27 · 🔀 220 · 📦 720 · 📋 250 - 30% open · ⏱️ 26.08.2022):
...
- [PyPi](https://pypi.org/project/tesserocr) (📥 46K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tesserocr) (📥 87K · ⏱️ 04.05.2022):
	```
...
- [PyPi](https://pypi.org/project/face_recognition) (📥 47K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/face_recognition) (📥 10K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 41 · 🔀 620 · 📋 320 - 5% open · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/pytesseract) (📥 910K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pytesseract) (📥 530K · ⏱️ 15.03.2022):
	```
...
- [GitHub](https://github.com/sightmachine/SimpleCV) (👨‍💻 100 · 🔀 760 · 📦 370 · 📋 330 - 22% open · ⏱️ 07.04.2015):
	...
	```
- [PyPi](https://pypi.org/project/SimpleCV) (📥 1.9K / month):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉19 ·  ⭐ 7.3K · 📉) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 720 · 📥 450 · 📋 630 - 26% open · ⏱️ 19.10.2022):
...
<details><summary><b><a href="https://github.com/henriquebastos/python-decouple">python-decouple</a></b> (🥇31 ·  ⭐ 2.2K) - Strict separation of settings from code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 32 · 🔀 160 · 📥 10 · 📦 79K · 📋 80 - 10% open · ⏱️ 11.05.2022):
...
- [PyPi](https://pypi.org/project/python-decouple) (📥 1.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 50K · ⏱️ 02.02.2022):
	```
	conda install -c conda-forge python-decouple
	```
</details>
<details><summary><b><a href="https://github.com/DiffSK/configobj">configobj</a></b> (🥉26 ·  ⭐ 280 · 💀) - INI file parser with validation. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 22 · 🔀 66 · 📦 21K · 📋 140 - 48% open · ⏱️ 14.10.2020):
...
- [PyPi](https://pypi.org/project/configobj) (📥 2.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 470K · ⏱️ 29.07.2018):
	```
	conda install -c conda-forge configobj
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉23 ·  ⭐ 6.4K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 100 · 🔀 470 · 📦 10 · 📋 1.1K - 13% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 23K / month):
	```
	pip install hydra
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 64K · 📋 1.4K - 51% open · ⏱️ 27.09.2022):
...
- [PyPi](https://pypi.org/project/paramiko) (📥 32M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 2.2M · ⏱️ 17.05.2022):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 64 · 🔀 200 · 📋 290 - 14% open · ⏱️ 07.09.2022):

	```
	git clone https://github.com/pyca/pynacl
	```
- [PyPi](https://pypi.org/project/pynacl) (📥 42M / month):
	```
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 3.1M · ⏱️ 09.04.2022):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 8.6K · 📋 750 - 33% open · ⏱️ 15.08.2019):
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 520 · 📥 160K · 📋 760 - 4% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 24 · 🔀 210 · 📋 210 - 3% open · ⏱️ 17.10.2022):
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 520 · 📦 250K · 📋 680 - 6% open · ⏱️ 05.10.2022):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 49M / month):
	```
	pip install jsonschema
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 14M · ⏱️ 09.09.2022):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 62 · 🔀 220 · 📦 12K · 📋 330 - 12% open · ⏱️ 05.05.2021):
...
- [PyPi](https://pypi.org/project/cerberus) (📥 3.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cerberus) (📥 250K · ⏱️ 10.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 88 · 🔀 200 · 📦 5.7K · 📋 240 - 16% open · ⏱️ 13.07.2022):

	```
	git clone https://github.com/alecthomas/voluptuous
	```
- [PyPi](https://pypi.org/project/voluptuous) (📥 4M / month):
	```
	pip install voluptuous
	```
- [Conda](https://anaconda.org/conda-forge/voluptuous) (📥 210K · ⏱️ 07.04.2022):
	```
	conda install -c conda-forge voluptuous
	```
</details>
<details><summary><b><a href="https://github.com/keleshev/schema">schema</a></b> (🥉29 ·  ⭐ 2.7K · 💤) - A library for validating Python data structures. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 180 · 📦 4.6K · 📋 140 - 51% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/keleshev/schema
	```
- [PyPi](https://pypi.org/project/schema) (📥 3.2M / month):
	```
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 66K · ⏱️ 02.12.2021):
	```
...
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥇33 ·  ⭐ 7.8K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 140 · 🔀 660 · 📦 35K · 📋 1.6K - 13% open · ⏱️ 16.10.2022):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 8.6M / month):
	```
	pip install altair
	```
...
<details><summary><b><a href="https://github.com/mwaskom/seaborn">Seaborn</a></b> (🥈30 ·  ⭐ 9.9K) - Statistical data visualization using Matplotlib. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 180 · 🔀 1.6K · 📥 240 · 📋 2.2K - 4% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/seaborn) (📥 8.7M / month):
	...
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 4.9M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 110 · 🔀 1.6K · 📋 390 - 60% open · ⏱️ 13.09.2022):
...
<details><summary><b><a href="https://github.com/vispy/vispy">VisPy</a></b> (🥉26 ·  ⭐ 2.9K) - High-performance scientific visualization based on OpenGL. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 580 · 📦 880 · 📋 1.3K - 20% open · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/vispy) (📥 61K / month):
	...
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 290K · ⏱️ 05.07.2022):
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 2.7K · 📋 1.1K - 25% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/cartopy) (📥 120K / month):
	...
	pip install cartopy
	```
- [Conda](https://anaconda.org/conda-forge/cartopy) (📥 2.4M · ⏱️ 10.09.2022):
	```
	conda install -c conda-forge cartopy
	```
</details>
<details><summary><b><a href="https://github.com/has2k1/plotnine">plotnine</a></b> (🥉23 ·  ⭐ 3.2K) - A grammar of graphics for Python based on ggplot2. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 97 · 🔀 170 · 📋 520 - 13% open · ⏱️ 20.10.2022):

	```
	git clone https://github.com/has2k1/plotnine
	```
- [PyPi](https://pypi.org/project/plotnine) (📥 460K / month):
	```
	pip install plotnine
	```
- [Conda](https://anaconda.org/conda-forge/plotnine) (📥 210K · ⏱️ 10.10.2022):
	```
...
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥇24 ·  ⭐ 560) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 74 · 📦 900 · 📋 150 - 38% open · ⏱️ 02.09.2022):
...
- [PyPi](https://pypi.org/project/ZODB) (📥 63K / month):
	...
	pip install ZODB
	```
- [Conda](https://anaconda.org/conda-forge/ZODB) (📥 51K · ⏱️ 17.03.2022):
	```
	conda install -c conda-forge ZODB
	```
</details>
<details><summary><b><a href="https://github.com/msiemens/tinydb">tinydb</a></b> (🥉23 ·  ⭐ 5.4K) - A tiny, document-oriented database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/tinydb) (📥 440K / month):
	...
	pip install tinydb
	```
- [Conda](https://anaconda.org/conda-forge/tinydb) (📥 210K · ⏱️ 19.02.2022):
	```
	conda install -c conda-forge tinydb
	```
</details>
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉20 ·  ⭐ 710 · 💀) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 110 · 📦 980 · 📋 57 - 28% open · ⏱️ 15.11.2019):

	```
	git clone https://github.com/patx/pickledb
	```
- [PyPi](https://pypi.org/project/pickledb) (📥 55K / month):
	```
	pip install pickledb
	```
- [Conda](https://anaconda.org/conda-forge/pickledb) (📥 3.1K · ⏱️ 17.04.2019):
	```
...
🔗&nbsp;<b><a href="https://github.com/dhamaniasad/awesome-postgres">awesome-postgres</a></b> ( ⭐ 8.1K)  - A curated list of awesome PostgreSQL software, libraries, tools and..
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 350 · 🔀 2.1K · 📦 160K · 📋 1.3K - 10% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 810K · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.2K · 📥 1.8K · 📦 12K · 📋 1.4K - 16% open · ⏱️ 27.03.2022):
...
- [PyPi](https://pypi.org/project/kafka-python) (📥 7.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/kafka-python) (📥 340K · ⏱️ 30.09.2020):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 41 · 🔀 180 · 📦 38K · ⏱️ 13.09.2022):

	```
	git clone https://github.com/mongodb/motor
	```
- [PyPi](https://pypi.org/project/motor) (📥 3.8M / month):
	```
	pip install motor
	```
- [Conda](https://anaconda.org/conda-forge/motor) (📥 50K · ⏱️ 28.04.2022):
	```
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 140K · 📋 610 - 4% open · ⏱️ 11.10.2022):
...
- [PyPi](https://pypi.org/project/PyMySQL) (📥 33M / month):
	...
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 830K · ⏱️ 09.01.2021):
	```
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 180 · 🔀 440 · 📦 4.3K · ⏱️ 03.09.2022):
...
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥈24 ·  ⭐ 920) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 45 · 🔀 170 · 📦 760 · 📋 260 - 13% open · ⏱️ 02.09.2022):
...
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/clickhouse-driver) (📥 340K · ⏱️ 13.06.2022):
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 970 · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 150 · 📦 680 · 📋 210 - 10% open · ⏱️ 12.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/happybase) (📥 140K / month):
	```
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 11 · 🔀 31 · 📦 110 · 📋 18 - 22% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/PyMySQL/mysqlclient) (👨‍💻 71 · 🔀 340 · 📥 5.2K · 📋 290 - 5% open · ⏱️ 20.09.2022):
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 410 / month):
	```
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 48 · 🔀 190 · 📦 970 · 📋 90 - 17% open · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/maya) (📥 44K / month):
	...
	pip install maya
	```
- [Conda](https://anaconda.org/conda-forge/maya) (📥 51K · ⏱️ 14.09.2022):
	```
	conda install -c conda-forge maya
	```
</details>
<details><summary><b><a href="https://github.com/dateutil/dateutil">dateutil</a></b> (🥇27 ·  ⭐ 1.9K) - Extensions to the standard Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 410 · 📥 35K · 📦 810K · 📋 640 - 40% open · ⏱️ 18.04.2022):
...
<details><summary><b><a href="https://github.com/sdispater/pendulum">Pendulum</a></b> (🥈25 ·  ⭐ 5.1K) - Python datetimes made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 87 · 🔀 290 · 📋 450 - 41% open · ⏱️ 04.10.2022):
...
- [PyPi](https://pypi.org/project/pendulum) (📥 9.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 580K · ⏱️ 06.04.2022):
	```
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 40 · 📦 720 · 📋 40 - 7% open · ⏱️ 27.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/moment) (📥 66K / month):
	```
	pip install moment
	```
- [Conda](https://anaconda.org/conda-forge/moment) (📥 9.7K · ⏱️ 31.01.2019):
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 130 · 📦 820 · 📋 63 - 41% open · ⏱️ 28.06.2022):
...
<details><summary><b><a href="https://github.com/shinux/PyTime">PyTime</a></b> (🥉14 ·  ⭐ 150 · 💀) - An easy-to-use Python module which aims to operate date/time/datetime.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 5 · 🔀 17 · 📦 29 · ⏱️ 31.08.2021):
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇30 ·  ⭐ 9.2K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 30 · 🔀 310 · 📥 10K · 📦 300 · 📋 260 - 31% open · ⏱️ 12.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 930K / month):
	```
	pip install py-spy
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 260 · 🔀 850 · 📥 180 · 📦 57K · 📋 810 - 9% open · ⏱️ 25.09.2022):
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 49 · 🔀 140 · 📦 35K · 📋 180 - 34% open · ⏱️ 30.12.2021):
...
- [PyPi](https://pypi.org/project/ipdb) (📥 2.8M / month):
	...
	pip install ipdb
	```
- [Conda](https://anaconda.org/conda-forge/ipdb) (📥 300K · ⏱️ 24.06.2021):
	```
	conda install -c conda-forge ipdb
	```
</details>
<details><summary><b><a href="https://github.com/flask-debugtoolbar/flask-debugtoolbar">flask-debugtoolbar</a></b> (🥈28 ·  ⭐ 850) - A port of the django-debug-toolbar to flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/flask-debugtoolbar/flask-debugtoolbar) (👨‍💻 44 · 🔀 130 · 📦 19K · 📋 100 - 34% open · ⏱️ 04.10.2022):
...
- [PyPi](https://pypi.org/project/flask-debugtoolbar) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-debugtoolbar) (📥 56K · ⏱️ 30.03.2022):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 86 · 🔀 440 · 📦 4.1K · 📋 200 - 30% open · ⏱️ 18.10.2022):
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 90 · 🔀 200 · 📦 3.5K · 📋 300 - 45% open · ⏱️ 14.10.2022):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 330K / month):
	```
	pip install pudb
	```
- [Conda](https://anaconda.org/conda-forge/pudb) (📥 160K · ⏱️ 11.01.2022):
	```
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 19 · 🔀 130 · 📋 94 - 27% open · ⏱️ 10.10.2022):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 180K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 8.2K · ⏱️ 21.07.2022):
	```
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 150 · 📦 99 · 📋 82 - 30% open · ⏱️ 15.07.2022):

	```
	git clone https://github.com/nvdv/vprof
	```
- [PyPi](https://pypi.org/project/vprof) (📥 6.5K / month):
	```
	pip install vprof
	```
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 360 · 📋 67 - 58% open · ⏱️ 05.03.2016):
	...
	```
- [PyPi](https://pypi.org/project/django-devserver) (📥 3.8K / month):
	```
...
<details><summary><b><a href="https://github.com/pdbpp/pdbpp">pdb++</a></b> (🥉20 ·  ⭐ 1K) - Another drop-in replacement for pdb. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 41 · 🔀 52 · 📦 3.2K · 📋 200 - 38% open · ⏱️ 14.07.2022):
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 39 · 📦 100 · 📋 90 - 42% open · ⏱️ 27.09.2022):
...
- [PyPi](https://pypi.org/project/line_profiler) (📥 270K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 280K · ⏱️ 22.03.2022):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 290 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 61 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 1.5M / month):
	```
	pip install memory_profiler
	```
- [Conda](https://anaconda.org/conda-forge/memory_profiler) (📥 230K · ⏱️ 19.12.2021):
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 37 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 510 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.1K · 🔀 18K · 📋 11K - 2% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/keras) (📥 10M / month):
	...
	pip install keras
	```
- [Conda](https://anaconda.org/conda-forge/keras) (📥 2.6M · ⏱️ 04.09.2022):
	```
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥈29 ·  ⭐ 60K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.6K · 🔀 16K · 📥 7.1K · 📋 29K - 33% open · ⏱️ 20.10.2022):
...
- [PyPi](https://pypi.org/project/pytorch) (📥 56K / month):
	...
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 860K · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📋 9.5K - 18% open · ⏱️ 26.09.2022):
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇37 ·  ⭐ 8.8K) - A cross-platform process and system utilities module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.2K · 📦 210K · 📋 1.6K - 13% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/psutil) (📥 66M / month):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 16M · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.6K · 🔀 22K · 📦 23K · 📋 31K - 2% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.8M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 740K · ⏱️ 13.10.2022):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.8K · 🔀 5.1K · 📥 16K · 📋 25K - 9% open · ⏱️ 20.10.2022):
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 7.8K · 📋 1.1K - 10% open · ⏱️ 10.09.2022):
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 74 · 🔀 280 · 📦 52 · 📋 620 - 19% open · ⏱️ 15.10.2022):
...
- [PyPi](https://pypi.org/project/fabric) (📥 2.6M / month):
	...
	pip install fabric
	```
- [Conda](https://anaconda.org/conda-forge/fabric) (📥 55K · ⏱️ 09.09.2022):
	```
...
- [PyPi](https://pypi.org/project/luigi) (📥 560K / month):
	...
	pip install luigi
	```
- [Conda](https://anaconda.org/conda-forge/luigi) (📥 570K · ⏱️ 18.08.2022):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 560 · 🔀 1.5K · 📦 41K · 📋 4.5K - 15% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/dask) (📥 6.1M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 7M · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 3.8K · 📦 6.1K · 📋 12K - 21% open · ⏱️ 20.10.2022):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 580 · 📦 1.1K · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 56K / month):
	```
	pip install mrjob
	```
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 94 · 🔀 530 · 📦 1.1K · 📋 470 - 48% open · ⏱️ 09.10.2020):

	```
	git clone https://github.com/robinhood/faust
	```
- [PyPi](https://pypi.org/project/faust) (📥 36K / month):
	```
	pip install faust
	```
...
<details><summary><b><a href="https://github.com/pyinstaller/pyinstaller">PyInstaller</a></b> (🥇33 ·  ⭐ 9.7K) - Converts Python programs into stand-alone executables.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 440 · 🔀 1.7K · 📥 730K · 📦 31K · 📋 4.7K - 5% open · ⏱️ 19.10.2022):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 780K / month):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 360K · ⏱️ 21.05.2022):
	```
	conda install -c conda-forge pyinstaller
	```
</details>
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈28 ·  ⭐ 1.8K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 25 · 🔀 190 · 📦 530 · 📋 830 - 2% open · ⏱️ 10.10.2022):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 590K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 38 · 🔀 81 · 📥 340 · 📋 110 - 31% open · ⏱️ 13.09.2022):
...
- [PyPi](https://pypi.org/project/shiv) (📥 20K / month):
	...
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 380 · ⏱️ 14.09.2022):
	```
...
<details><summary><b><a href="https://github.com/sphinx-doc/sphinx">sphinx</a></b> (🥇26 ·  ⭐ 4.9K) - Python Documentation generator. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.7K · 📦 230K · 📋 6.2K - 16% open · ⏱️ 17.10.2022):
...
<details><summary><b><a href="https://github.com/mitmproxy/pdoc">pdoc</a></b> (🥉23 ·  ⭐ 1.4K) - Epydoc replacement to auto generate API documentation for Python.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 40 · 🔀 140 · 📦 860 · 📋 280 - 3% open · ⏱️ 11.10.2022):
...
- [PyPi](https://pypi.org/project/pdoc) (📥 51K / month):
	...
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 6.4K · ⏱️ 21.09.2022):
	```
...
- [GitHub](https://github.com/s3tools/s3cmd) (👨‍💻 210 · 🔀 820 · 📥 3.1M · 📋 830 - 26% open · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.7M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 7.3K · ⏱️ 22.12.2018):
	```
	conda install -c conda-forge s3cmd
	```
</details>
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥉25 ·  ⭐ 5.5K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 45 · 🔀 1.2K · 📦 220 · ⏱️ 20.10.2022):
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 190 · 📦 31 · 📋 130 - 60% open · ⏱️ 06.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 29K / month):
	```
	pip install s4cmd
	```
...
<details><summary><b><a href="https://github.com/MicroPyramid/forex-python">forex-python</a></b> (🥇25 ·  ⭐ 520) - Foreign exchange rates, Bitcoin price index and currency conversion. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 290 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 740 / month):
	```
...
<details><summary><b><a href="https://github.com/Alir3z4/python-currencies">python-currencies</a></b> (🥉12 ·  ⭐ 63 · 💀) - Display money format and its filthy currencies. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 13 · 📥 6 · 📦 40 · 📋 5 - 40% open · ⏱️ 22.12.2020):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 240 · 🔀 1.4K · 📥 2.2M · 📦 24K · 📋 16K - 6% open · ⏱️ 20.10.2022):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 57K / month):
	```
	pip install spyder
	```
- [Conda](https://anaconda.org/conda-forge/spyder) (📥 1.5M · ⏱️ 30.08.2022):
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 180 · 🔀 2.7K · 📋 3.1K - 0% open · ⏱️ 06.10.2022):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 80 · 🔀 660 · 📥 33K · 📋 4.4K - 2% open · ⏱️ 12.10.2022):
...
- [GitHub](https://github.com/davidhalter/jedi-vim) (👨‍💻 94 · 🔀 360 · 📋 760 - 3% open · ⏱️ 08.04.2022):
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 32 · 🔀 260 · 📦 2.6K · 📋 210 - 43% open · ⏱️ 28.09.2022):
...
- [PyPi](https://pypi.org/project/yagmail) (📥 200K / month):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 18K · ⏱️ 11.09.2022):
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 310 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 13.10.2022):
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 52 · 🔀 160 · 📦 160 · 📋 120 - 46% open · ⏱️ 24.09.2022):
...
- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 56 · 📥 130 · 📋 72 - 33% open · ⏱️ 15.07.2022):
...
- [PyPi](https://pypi.org/project/mailer) (📥 44K / month):
	...
	pip install mailer
	```
- [Conda](https://anaconda.org/conda-forge/mailer) (📥 52K · ⏱️ 01.07.2021):
	```
	conda install -c conda-forge mailer
	```
</details>
<details><summary><b><a href="https://github.com/moggers87/salmon">salmon</a></b> (🥉13 ·  ⭐ 570) - A Python Mail Server. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 56 · 📥 75 · 📦 17 · 📋 90 - 18% open · ⏱️ 06.06.2022):
...
<details><summary><b><a href="https://github.com/pyenv/pyenv">pyenv</a></b> (🥇27 ·  ⭐ 29K) - Simple Python version management. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 380 · 🔀 2.5K · 📋 1.5K - 2% open · ⏱️ 12.10.2022):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 8.2K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 82 · 🔀 890 · 📋 1.2K - 6% open · ⏱️ 08.10.2022):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 37M / month):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 2.8M · ⏱️ 08.09.2022):
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 130 · 🔀 640 · 📦 65K · 📋 580 - 28% open · ⏱️ 12.10.2022):

	```
	git clone https://github.com/gorakhargosh/watchdog
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 7.6M / month):
	```
	pip install watchdog
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 1.5M · ⏱️ 10.06.2022):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 55 · 🔀 250 · 📦 33K · 📋 180 - 15% open · ⏱️ 20.06.2022):
...
- [PyPi](https://pypi.org/project/python-magic) (📥 5.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-magic) (📥 170K · ⏱️ 10.06.2022):
	```
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 47 · 🔀 130 · ⏱️ 06.10.2022):
...
<details><summary><b><a href="https://github.com/PyFilesystem/pyfilesystem2">PyFilesystem2</a></b> (🥉19 ·  ⭐ 1.8K) - Python's filesystem abstraction layer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyFilesystem/pyfilesystem2) (👨‍💻 47 · 🔀 160 · 📋 340 - 20% open · ⏱️ 18.10.2022):
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 40 · 📦 8K · 📋 17 - 41% open · ⏱️ 14.02.2015):
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 140 · 🔀 370 · 📦 150K · 📋 400 - 12% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 3.4M / month):
	```
	pip install wtforms
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 680 · 📦 100K · 📋 650 - 8% open · ⏱️ 15.07.2022):
...
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 660K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 59K · ⏱️ 25.01.2022):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 98 · 🔀 680 · 📦 18K · 📋 290 - 2% open · ⏱️ 17.10.2022):
...
<details><summary><b><a href="https://github.com/zostera/django-bootstrap4">django-bootstrap4</a></b> (🥈27 ·  ⭐ 970) - Bootstrap 4 integration with Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 74K · 📋 160 - 13% open · ⏱️ 17.10.2022):
...
<details><summary><b><a href="https://github.com/Pylons/deform">Deform</a></b> (🥉19 ·  ⭐ 380) - Python HTML form generation library influenced by the formish form.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 740 · 📋 180 - 25% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 6.6K / month):
	```
	pip install deform
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 70K · 📋 220 - 35% open · ⏱️ 22.09.2022):

	```
	git clone https://github.com/pytoolz/toolz
	```
- [PyPi](https://pypi.org/project/toolz) (📥 16M / month):
	```
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 10M · ⏱️ 10.07.2022):
	```
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 5.9K · 📋 71 - 8% open · ⏱️ 25.08.2022):
...
- [PyPi](https://pypi.org/project/funcy) (📥 1.2M / month):
	...
	pip install funcy
	```
- [Conda](https://anaconda.org/conda-forge/funcy) (📥 250K · ⏱️ 21.12.2021):
	```
	conda install -c conda-forge funcy
	```
</details>
<details><summary><b><a href="https://github.com/more-itertools/more-itertools">more-itertools</a></b> (🥈28 ·  ⭐ 2.7K) - More routines for operating on iterables, beyond `itertools`. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 90 · 🔀 210 · 📥 2.5K · 📋 220 - 5% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/more-itertools) (📥 29M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 9.8M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 90 · 📦 210 · 📋 390 - 14% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/returns) (📥 55K / month):
	...
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 3.3K · ⏱️ 13.03.2022):
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 31 · 🔀 100 · 📋 570 - 10% open · ⏱️ 26.09.2022):
...
- [PyPi](https://pypi.org/project/coconut) (📥 1.2K / month):
	...
	pip install coconut
	```
- [Conda](https://anaconda.org/conda-forge/coconut) (📥 140K · ⏱️ 26.09.2022):
	```
...
- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 68 · 📦 43K · 📋 73 - 32% open · ⏱️ 01.08.2022):
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 430 · 📋 48 - 47% open · ⏱️ 13.10.2014):
	...
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 480 / month):
	```
	pip install fn.py
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 240 · 📦 18K · 📋 380 - 14% open · ⏱️ 15.10.2022):
...
- [PyPi](https://pypi.org/project/pyglet) (📥 220K / month):
	...
	pip install pyglet
	```
- [Conda](https://anaconda.org/conda-forge/pyglet) (📥 430K · ⏱️ 21.09.2022):
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.6K · 📦 6.1K · 📋 3K - 22% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 140K / month):
	```
	pip install PySimpleGUI
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 77K · ⏱️ 17.10.2022):
	```
	conda install -c conda-forge PySimpleGUI
	```
</details>
<details><summary><b><a href="https://github.com/python-eel/Eel">Eel</a></b> (🥈28 ·  ⭐ 5.2K) - A library for making simple Electron-like offline HTML/JS GUI apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 40 · 🔀 510 · 📦 4.2K · 📋 470 - 31% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/ChrisKnott/Eel
	```
- [PyPi](https://pypi.org/project/Eel) (📥 51K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 880 · 📥 320 · 📦 610 · 📋 560 - 19% open · ⏱️ 08.05.2022):
...
- [PyPi](https://pypi.org/project/Gooey) (📥 4.2K / month):
	...
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 55K · ⏱️ 29.12.2021):
	```
	conda install -c conda-forge Gooey
	```
</details>
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉24 ·  ⭐ 8.9K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 460 · 📦 530 · 📋 1.1K - 22% open · ⏱️ 17.10.2022):
...
<details><summary><b><a href="https://github.com/flexxui/flexx">Flexx</a></b> (🥉23 ·  ⭐ 3K) - Flexx is a pure Python toolkit for creating GUI's, that uses web technology.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 110 · 📋 440 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 630 / month):
	```
	pip install flexx
	```
- [Conda](https://anaconda.org/conda-forge/flexx) (📥 92K · ⏱️ 12.04.2022):
	```
	conda install -c conda-forge flexx
	```
</details>
<details><summary><b><a href="https://github.com/r0x0r/pywebview">pywebview</a></b> (🥉22 ·  ⭐ 3.1K) - A lightweight cross-platform native wrapper around a webview.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/r0x0r/pywebview) (🔀 400 · 📦 780 · 📋 670 - 4% open · ⏱️ 29.09.2022):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 220 · 🔀 540 · 📥 600 · 📋 580 - 17% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 37 · 🔀 120 · 📥 180 · 📋 220 - 17% open · ⏱️ 06.10.2022):
...
- [GitHub](https://github.com/graphql-python/graphene) (🔀 760 · 📦 14K · 📋 960 - 11% open · ⏱️ 19.09.2022):
...
- [GitHub](https://github.com/tartiflette/tartiflette-asgi) (🔀 15 · 📦 11 · 📋 49 - 12% open · ⏱️ 20.05.2022):
...
<details><summary><b><a href="https://github.com/geopy/geopy">geopy</a></b> (🥇32 ·  ⭐ 3.8K) - Python Geocoding Toolbox. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/geopy/geopy) (👨‍💻 130 · 🔀 580 · 📦 43K · 📋 260 - 8% open · ⏱️ 07.08.2022):
...
- [PyPi](https://pypi.org/project/geopy) (📥 4.5M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 840K · ⏱️ 12.07.2021):
	```
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 51 · 🔀 240 · 📋 250 - 3% open · ⏱️ 09.10.2022):
...
- [PyPi](https://pypi.org/project/django-countries) (📥 490K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-countries) (📥 2.1K · ⏱️ 28.02.2022):
	```
	conda install -c conda-forge django-countries
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/geojson">geojson</a></b> (🥉19 ·  ⭐ 750) - Python bindings and utilities for GeoJSON. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 48 · 🔀 96 · 📦 10K · 📋 86 - 25% open · ⏱️ 07.05.2022):
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 44K · 📋 220 - 29% open · ⏱️ 08.05.2022):
...
- [PyPi](https://pypi.org/project/xmltodict) (📥 20M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xmltodict) (📥 2M · ⏱️ 08.05.2022):
	```
	conda install -c conda-forge xmltodict
	```
</details>
<details><summary><b><a href="https://github.com/pallets/markupsafe">MarkupSafe</a></b> (🥇31 ·  ⭐ 500) - Implements a XML/HTML/XHTML Markup safe string for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 39 · 🔀 120 · 📦 980K · ⏱️ 02.10.2022):
...
- [PyPi](https://pypi.org/project/markupsafe) (📥 130M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/markupsafe) (📥 23M · ⏱️ 08.06.2022):
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 78 · 🔀 220 · 📦 200K · 📋 360 - 9% open · ⏱️ 27.06.2022):
...
- [PyPi](https://pypi.org/project/bleach) (📥 13M / month):
	...
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 9.1M · ⏱️ 27.06.2022):
	```
...
- [PyPi](https://pypi.org/project/pyquery) (📥 1.1M / month):
	...
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 31K · ⏱️ 27.11.2020):
	```
...
- [GitHub](https://github.com/stchris/untangle) (👨‍💻 17 · 🔀 79 · 📥 530 · 📦 900 · 📋 55 - 29% open · ⏱️ 02.07.2022):
...
- [PyPi](https://pypi.org/project/untangle) (📥 180K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 2.9K · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 720 · 🔀 8.5K · 📥 3.6K · 📦 1.7M · 📋 3.6K - 5% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/requests) (📥 230M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 24M · ⏱️ 30.08.2022):
	```
	conda install -c conda-forge requests
	```
</details>
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈36 ·  ⭐ 9.5K · 📈) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 170 · 🔀 610 · 📦 36K · 📋 720 - 4% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/httpx) (📥 13M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 330K · ⏱️ 09.08.2022):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 310 · 🔀 940 · 📥 3.5K · 📦 1M · 📋 1K - 9% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/urllib3) (📥 260M / month):
	...
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 24M · ⏱️ 25.07.2022):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 73 · 🔀 170 · 📦 120K · 📋 110 - 39% open · ⏱️ 25.09.2022):
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 290 · 📦 3.3K · 📋 110 - 7% open · ⏱️ 26.01.2022):
...
- [PyPi](https://pypi.org/project/grequests) (📥 370K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 62K · ⏱️ 22.04.2020):
	```
...
- [PyPi](https://pypi.org/project/treq) (📥 76K / month):
	...
	pip install treq
	```
- [Conda](https://anaconda.org/conda-forge/treq) (📥 65K · ⏱️ 30.01.2022):
	```
...
<details><summary><b><a href="https://github.com/secdev/scapy">scapy</a></b> (🥇32 ·  ⭐ 8.1K) - A brilliant packet manipulation library. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/secdev/scapy) (👨‍💻 400 · 🔀 1.7K · 📦 8.9K · 📋 1.4K - 2% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/scapy) (📥 1.8M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 54K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 40 · 🔀 370 · 📦 7.9K · 📋 510 - 64% open · ⏱️ 20.07.2022):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 630K / month):
	```
	pip install keyboard
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 9.1K · ⏱️ 08.11.2021):
	```
	conda install -c conda-forge keyboard
	```
</details>
<details><summary><b><a href="https://github.com/boppreh/mouse">mouse</a></b> (🥉22 ·  ⭐ 680) - Hook and simulate global mouse events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 100 · 📦 780 · 📋 110 - 74% open · ⏱️ 23.08.2022):
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 450 · 📋 100 - 70% open · ⏱️ 19.04.2021):

	```
	git clone https://github.com/SavinaRoja/PyUserInput
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 7.7K / month):
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 410 · 🔀 1.8K · 📦 870K · 📋 2.6K - 3% open · ⏱️ 20.10.2022):
...
- [PyPi](https://pypi.org/project/Pillow) (📥 47M / month):
	...
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 20M · ⏱️ 13.08.2022):
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 200 · 📥 8.5K · 📦 13K · 📋 380 - 4% open · ⏱️ 13.10.2022):

	```
	git clone https://github.com/dahlia/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 500K / month):
	```
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 17K · ⏱️ 22.08.2022):
	```
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 180 · 🔀 760 · 📦 320 · 📋 910 - 1% open · ⏱️ 20.10.2022):

	```
	git clone https://github.com/thumbor/thumbor
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 4K / month):
	```
	pip install thumbor
	```
...
<details><summary><b><a href="https://github.com/WhyNotHugo/python-barcode">python-barcode</a></b> (🥈26 ·  ⭐ 400) - Create barcodes in Python with no extra dependencies. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 42 · 🔀 98 · 📥 240 · 📦 15K · 📋 97 - 40% open · ⏱️ 11.10.2022):
...
- [PyPi](https://pypi.org/project/python-barcode) (📥 210K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 7.7K · ⏱️ 22.08.2020):
	```
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 270 · 📥 860 · 📦 200 · 📋 510 - 24% open · ⏱️ 09.09.2021):
...
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥉22 ·  ⭐ 450) - A fast image processing library with low memory needs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 14 · 🔀 40 · 📦 380 · 📋 300 - 36% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/pyvips) (📥 20K / month):
	...
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 35K · ⏱️ 24.07.2022):
	```
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 9 · 🔀 41 · 📦 59 · 📋 8 - 62% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/hhatto/nude.py) (👨‍💻 12 · 🔀 130 · 📦 2.8K · 📋 10 - 70% open · ⏱️ 23.11.2020):
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 51 · 🔀 520 · 📋 180 - 18% open · ⏱️ 19.09.2022):
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 21 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 930 / month):
	```
	pip install hmap
	```
...
<details><summary><b><a href="https://github.com/ajkumar25/pygram">pygram</a></b> (🥉4) - Instagram-like image filters. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/ajkumar25/pygram) (⏱️ 18.10.2022):
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 520 · 🔀 4.3K · 📥 50K · 📋 4.5K - 26% open · ⏱️ 14.10.2022):
...
- [PyPi](https://pypi.org/project/micropython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micropython) (📥 9.4K · ⏱️ 17.06.2022):
	```
	conda install -c conda-forge micropython
	```
</details>
<details><summary><b><a href="https://github.com/python/cpython">CPython</a></b> (🥈22 ·  ⭐ 48K) - **Default, most widely used implementation of the Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/cpython) (👨‍💻 2.2K · 🔀 24K · 📋 61K - 10% open · ⏱️ 20.10.2022):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 74K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 31 · 🔀 220 · 📥 36K · 📋 520 - 45% open · ⏱️ 17.10.2022):
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 300 · 📥 5.1K · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 130K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 24 · 🔀 140 · 📦 11 · 📋 89 - 26% open · ⏱️ 27.09.2022):
...
- [PyPi](https://pypi.org/project/Pyjion) (📥 1K / month):
	...
	pip install Pyjion
	```
- [Conda](https://anaconda.org/conda-forge/Pyjion) (📥 340 · ⏱️ 13.02.2022):
	```
	conda install -c conda-forge Pyjion
	```
</details>
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉11 ·  ⭐ 860 · 💀) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/metawilm/cl-python) (👨‍💻 12 · 🔀 33 · 📋 17 - 11% open · ⏱️ 10.03.2022):
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 52 · 🔀 260 · 📦 2K · 📋 350 - 57% open · ⏱️ 20.06.2022):
...
- [PyPi](https://pypi.org/project/ptpython) (📥 410K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 21K · ⏱️ 14.11.2021):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 210 · 📋 770 - 16% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/bpython) (📥 88K / month):
	...
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 49K · ⏱️ 02.09.2022):
	```
...
- [PyPi](https://pypi.org/project/pyicu) (📥 270K / month):
	...
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 110K · ⏱️ 26.04.2022):
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 51 · 🔀 790 · 📦 20K · 📋 390 - 32% open · ⏱️ 23.04.2022):
...
- [PyPi](https://pypi.org/project/schedule) (📥 2.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 21K · ⏱️ 10.04.2021):
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 82 · 🔀 1K · 📦 1.3K · 📋 2.8K - 21% open · ⏱️ 19.10.2022):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 440K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 340K · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 49 · 🔀 260 · 📦 44 · 📋 98 - 7% open · ⏱️ 19.10.2022):
...
<details><summary><b><a href="https://github.com/gunnery/gunnery">gunnery</a></b> (🥉13 ·  ⭐ 740 · 💀) - Multipurpose task execution tool for distributed systems with.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 39 · 🔀 550 · 📦 28K · 📋 650 - 8% open · ⏱️ 10.10.2022):
...
- [PyPi](https://pypi.org/project/loguru) (📥 4.4M / month):
	...
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 720K · ⏱️ 08.04.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 150 · 🔀 300 · 📥 3.9K · 📦 25K · 📋 740 - 20% open · ⏱️ 20.10.2022):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 580 · 🔀 7.9K · 📥 5.3K · 📦 37K · 📋 4.6K - 5% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/xgboost) (📥 8.4M / month):
	...
	pip install xgboost
	```
- [Conda](https://anaconda.org/conda-forge/xgboost) (📥 3.2M · ⏱️ 12.10.2022):
	```
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.5K · 📦 33K · 📋 1.7K - 1% open · ⏱️ 04.10.2022):
...
- [PyPi](https://pypi.org/project/gym) (📥 930K / month):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 150K · ⏱️ 10.07.2022):
	```
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 200 · 🔀 1.2K · 📋 1.6K - 19% open · ⏱️ 20.10.2022):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 4.6K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 230 · 🔀 1.9K · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 81 · 🔀 700 · 📥 580K · 📦 94K · 📋 1.7K - 25% open · ⏱️ 18.09.2022):
...
- [PyPi](https://pypi.org/project/pywin32) (📥 4.1M / month):
	...
	pip install pywin32
	```
- [Conda](https://anaconda.org/conda-forge/pywin32) (📥 2.8M · ⏱️ 27.12.2021):
	```
	conda install -c conda-forge pywin32
	```
</details>
<details><summary><b><a href="https://github.com/pythonnet/pythonnet">PythonNet</a></b> (🥉28 ·  ⭐ 3.3K) - Python Integration with the .NET Common Language Runtime (CLR). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 97 · 🔀 530 · 📥 210 · 📦 110 · 📋 1.2K - 7% open · ⏱️ 14.10.2022):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 51K · ⏱️ 01.10.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 41 · 🔀 200 · 📦 690K · ⏱️ 02.10.2022):

	```
	git clone https://github.com/pallets/itsdangerous
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 80M / month):
	```
	pip install itsdangerous
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 4M · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 14 · 🔀 160 · 📦 120K · 📋 35 - 8% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/blinker) (📥 8.2M / month):
	```
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 6.6M · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 75 · 🔀 320 · 📥 23 · 📦 2.6K · 📋 140 - 32% open · ⏱️ 29.04.2022):

	```
	git clone https://github.com/mahmoud/boltons
	```
- [PyPi](https://pypi.org/project/boltons) (📥 1.9M / month):
	```
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 700K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.5K · 📦 390 · 📋 900 - 35% open · ⏱️ 04.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/magenta) (📥 4.2K / month):
	```
	pip install magenta
	```
...
- [PyPi](https://pypi.org/project/pluginbase) (📥 550K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pluginbase) (📥 250K · ⏱️ 04.02.2019):
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 430 · 🔀 4.1K · 📥 3.8K · 📦 37K · 📋 1.8K - 20% open · ⏱️ 02.10.2022):
...
- [PyPi](https://pypi.org/project/gensim) (📥 4.9M / month):
	...
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 900K · ⏱️ 29.07.2022):
	```
	conda install -c conda-forge gensim
	```
</details>
<details><summary><b><a href="https://github.com/fxsjy/jieba">jieba</a></b> (🥇31 ·  ⭐ 29K · 💀) - The most popular Chinese text segmentation library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.4K · 📦 15K · 📋 810 - 73% open · ⏱️ 15.02.2020):

	```
	git clone https://github.com/fxsjy/jieba
	```
- [PyPi](https://pypi.org/project/jieba) (📥 480K / month):
	```
	pip install jieba
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 18 · 📦 1.4K · 📋 200 - 62% open · ⏱️ 25.04.2020):

	```
	git clone https://github.com/clips/pattern
	```
- [PyPi](https://pypi.org/project/pattern) (📥 2.2M / month):
	```
	pip install pattern
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 54 · 🔀 800 · 📦 1.3K · 📋 730 - 9% open · ⏱️ 15.09.2022):
...
- [PyPi](https://pypi.org/project/stanza) (📥 230K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 5.9K · ⏱️ 15.09.2022):
	```
...
<details><summary><b><a href="https://github.com/lancopku/pkuseg-python">pkuseg-python</a></b> (🥉22 ·  ⭐ 6K) - A toolkit for Chinese word segmentation in various domains. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 930 · 📥 88K · 📦 220 · 📋 150 - 73% open · ⏱️ 08.06.2022):
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 970 · 📋 100 - 38% open · ⏱️ 19.01.2020):
...
- [PyPi](https://pypi.org/project/snownlp) (📥 5.6K / month):
	...
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 1.1K · ⏱️ 07.09.2021):
	```
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 310 · 📦 770 · 📋 210 - 68% open · ⏱️ 22.09.2020):
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉15 ·  ⭐ 44K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 10 · 🔀 11K · 📋 51 - 19% open · ⏱️ 03.10.2022):
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 920 · 📋 570 - 20% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 470K · 📦 160 · 📋 670 - 39% open · ⏱️ 11.07.2022):
...
- [PyPi](https://pypi.org/project/pox) (📥 4M / month):
	...
	pip install pox
	```
- [Conda](https://anaconda.org/conda-forge/pox) (📥 230K · ⏱️ 20.05.2022):
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📦 880 · 📋 300 - 5% open · ⏱️ 19.10.2022):
...
<details><summary><b><a href="https://github.com/coleifer/peewee">peewee</a></b> (🥇36 ·  ⭐ 9.5K) - A small, expressive ORM. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 18K · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/peewee) (📥 1.6M / month):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 440K · ⏱️ 22.09.2022):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 98 · 🔀 400 · 📦 1.1K · 📋 520 - 39% open · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 210K · ⏱️ 09.06.2022):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 2.6K · 📋 270 - 4% open · ⏱️ 03.06.2022):

	```
	git clone https://github.com/pudo/dataset
	```
- [PyPi](https://pypi.org/project/dataset) (📥 58K / month):
	```
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 3.2K · ⏱️ 16.12.2021):
	```
	conda install -c conda-forge dataset
	```
</details>
<details><summary><b><a href="https://github.com/sdispater/orator">orator</a></b> (🥉21 ·  ⭐ 1.4K · 💤) - The Orator ORM provides a simple yet beautiful ActiveRecord.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/orator) (📥 16K / month):
	...
	pip install orator
	```
- [Conda](https://anaconda.org/conda-forge/orator) (📥 2.2K · ⏱️ 18.03.2020):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 35 · 📦 2.7K · 📋 600 - 45% open · ⏱️ 25.05.2022):
...
- [GitHub](https://github.com/web2py/pydal) (🔀 130 · 📦 240 · 📋 310 - 44% open · ⏱️ 17.10.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 26 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 740 / month):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 410 · 🔀 1.8K · 📥 14M · 📋 4.3K - 14% open · ⏱️ 13.10.2022):
...
- [PyPi](https://pypi.org/project/poetry) (📥 9.7M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 660K · ⏱️ 31.08.2022):
	```
	conda install -c conda-forge poetry
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥉28 ·  ⭐ 6.3K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 170 · 🔀 470 · 📋 860 - 13% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 6.7M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 57K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.2K · 📋 8.7K - 10% open · ⏱️ 19.10.2022):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇19 ·  ⭐ 610) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 320 · 🔀 780 · 📋 2.8K - 14% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 99 · 📋 220 - 15% open · ⏱️ 10.10.2022):
...
<details><summary><b><a href="https://github.com/sqlmapproject/sqlmap">sqlmap</a></b> (🥇23 ·  ⭐ 25K) - Automatic SQL injection and database takeover tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 4.8K · 📋 4.8K - 1% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 8.2K / month):
	```
	pip install sqlmap
	```
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉19 ·  ⭐ 8K) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.7K · 📋 120 - 23% open · ⏱️ 06.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 800 / month):
	```
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉18 ·  ⭐ 8.1K · 💤) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 25 · 🔀 120 · 📦 950 · 📋 100 - 22% open · ⏱️ 23.03.2022):
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 85 · 🔀 460 · 📦 10K · 📋 420 - 2% open · ⏱️ 18.08.2022):
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 82 · 🔀 1K · 📦 2.3K · 📋 360 - 10% open · ⏱️ 08.08.2022):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 640 · 📦 830 · 📋 460 - 24% open · ⏱️ 19.07.2022):
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 32 · 🔀 540 · 📥 180 · 📦 680 · 📋 430 - 16% open · ⏱️ 27.09.2022):
...
- [PyPi](https://pypi.org/project/implicit) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/implicit) (📥 410K · ⏱️ 29.01.2022):
	```
...
- [GitHub](https://github.com/NicolasHug/Surprise) (👨‍💻 43 · 🔀 920 · 📋 360 - 15% open · ⏱️ 23.09.2022):
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 400 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 590 / month):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 71 · 🔀 140 · 📋 250 - 27% open · ⏱️ 06.10.2022):
...
- [PyPi](https://pypi.org/project/rope) (📥 590K / month):
	...
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 880K · ⏱️ 29.07.2022):
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 190 · 🔀 870 · 📥 3.9K · 📦 7.1K · 📋 970 - 17% open · ⏱️ 10.10.2022):
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 980 · 📦 82K · 📋 540 - 17% open · ⏱️ 04.03.2022):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 320 · 🔀 1.4K · 📦 7.8K · 📋 1.2K - 4% open · ⏱️ 29.09.2022):
...
- [PyPi](https://pypi.org/project/sanic) (📥 1M / month):
	...
	pip install sanic
	```
- [Conda](https://anaconda.org/conda-forge/sanic) (📥 230K · ⏱️ 01.10.2022):
	```
	conda install -c conda-forge sanic
	```
</details>
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥈30 ·  ⭐ 51K) - A modern, fast, web framework for building APIs with Python 3.6+ based on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 390 · 🔀 4K · 📋 3.1K - 35% open · ⏱️ 20.10.2022):
...
- [PyPi](https://pypi.org/project/fastapi) (📥 10M / month):
	...
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 1M · ⏱️ 15.10.2022):
	```
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 210 · 🔀 730 · 📦 1K · 📋 970 - 2% open · ⏱️ 23.09.2022):
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 90 · 🔀 420 · 📦 700 · 📋 310 - 7% open · ⏱️ 31.08.2021):
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 100 · 🔀 4.9K · 📋 300 - 4% open · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/zerorpc-python):
	...
	```
- [Conda](https://anaconda.org/conda-forge/zerorpc-python) (📥 1.3K · ⏱️ 06.06.2022):
	```
...
<details><summary><b><a href="https://github.com/sympy/sympy">SymPy</a></b> (🥇35 ·  ⭐ 9.7K) - A Python library for symbolic mathematics. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.7K · 📥 470K · 📦 47K · 📋 12K - 32% open · ⏱️ 14.10.2022):
...
- [PyPi](https://pypi.org/project/sympy) (📥 2.9M / month):
	...
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 2.5M · ⏱️ 30.09.2022):
	```
	conda install -c conda-forge sympy
	```
</details>
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">statsmodels</a></b> (🥈32 ·  ⭐ 7.8K) - Statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 390 · 🔀 2.4K · 📥 26 · 📦 71K · 📋 4.8K - 47% open · ⏱️ 11.10.2022):
...
- [PyPi](https://pypi.org/project/statsmodels) (📥 9.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 7.5M · ⏱️ 09.06.2022):
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4K · 📦 880 · 📋 980 - 33% open · ⏱️ 14.10.2020):

	```
	git clone https://github.com/quantopian/zipline
	```
- [PyPi](https://pypi.org/project/zipline) (📥 2.4K / month):
	```
	pip install zipline
	```
- [Conda](https://anaconda.org/conda-forge/zipline) (📥 6.4K · ⏱️ 05.10.2020):
	```
	conda install -c conda-forge zipline
	```
</details>
<details><summary><b><a href="https://github.com/pymc-devs/pymc">PyMC</a></b> (🥉26 ·  ⭐ 7.1K) - Markov Chain Monte Carlo sampling toolkit. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 420 · 🔀 1.6K · 📥 1.9K · 📦 800 · 📋 2.8K - 6% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/pymc3) (📥 330K / month):
	...
	pip install pymc3
	```
- [Conda](https://anaconda.org/conda-forge/pymc3) (📥 460K · ⏱️ 20.05.2022):
	```
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 16 · 🔀 220 · 📦 110 · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/karateclub) (📥 3.3K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 13K · ⏱️ 28.01.2022):
	```
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 95 · 🔀 340 · 📋 3K - 3% open · ⏱️ 23.09.2022):
...
<details><summary><b><a href="https://github.com/obspy/obspy">ObsPy</a></b> (🥉18 ·  ⭐ 950) - A Python toolbox for seismology. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/obspy/obspy) (🔀 490 · 📥 6.7K · 📋 1.6K - 11% open · ⏱️ 19.10.2022):
...
<details><summary><b><a href="https://github.com/chapmanb/bcbb">bccb</a></b> (🥉17 ·  ⭐ 550 · 💤) - Collection of useful code related to biological analysis. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/django-haystack) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-haystack) (📥 4.9K · ⏱️ 31.05.2018):
	```
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 740 · 📥 140 · 📦 6.6K · 📋 1.3K - 9% open · ⏱️ 14.07.2022):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 590 · 📦 57K · 📋 1.1K - 11% open · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/marshmallow) (📥 22M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 1.3M · ⏱️ 16.09.2022):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 19 · 🔀 41 · 📦 2.8K · 📋 100 - 11% open · ⏱️ 17.10.2022):
...
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 670K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 1M · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 41 · 📦 490 · 📋 78 - 14% open · ⏱️ 12.09.2022):
...
- [PyPi](https://pypi.org/project/pysimdjson) (📥 230K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 39K · ⏱️ 13.09.2022):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 83 · 🔀 330 · 📋 330 - 7% open · ⏱️ 14.10.2022):
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📥 280 · 📋 1.3K - 47% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/Zappa) (📥 85K / month):
	```
	pip install Zappa
	```
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 48 · 🔀 220 · 📦 170 · 📋 90 - 41% open · ⏱️ 03.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 3.3K / month):
	```
...
<details><summary><b><a href="https://github.com/xonsh/xonsh">xonsh</a></b> (🥇15 ·  ⭐ 6.4K) - A Python-powered, cross-platform, Unix-gazing shell language and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xonsh/xonsh) (🔀 560 · 📥 8.1K · 📋 2.4K - 10% open · ⏱️ 19.10.2022):
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 35 · 🔀 210 · 📦 180K · 📋 240 - 7% open · ⏱️ 12.10.2022):
...
- [PyPi](https://pypi.org/project/mistune) (📥 11M / month):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 9.2M · ⏱️ 15.07.2022):
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 51K · 📋 800 - 1% open · ⏱️ 15.10.2022):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 16K · 📋 240 - 12% open · ⏱️ 03.10.2022):
...
- [PyPi](https://pypi.org/project/tablib) (📥 1.2M / month):
	...
	pip install tablib
	```
- [Conda](https://anaconda.org/conda-forge/tablib) (📥 77K · ⏱️ 09.04.2022):
	```
	conda install -c conda-forge tablib
	```
</details>
<details><summary><b><a href="https://github.com/py-pdf/PyPDF2">PyPDF2</a></b> (🥈30 ·  ⭐ 4.8K) - A library capable of splitting, merging and transforming PDF pages. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/py-pdf/PyPDF2) (👨‍💻 150 · 🔀 990 · 📦 36K · 📋 590 - 10% open · ⏱️ 16.10.2022):
...
- [PyPi](https://pypi.org/project/PyPDF2) (📥 3.7M / month):
	...
	pip install PyPDF2
	```
- [Conda](https://anaconda.org/conda-forge/PyPDF2) (📥 300K · ⏱️ 15.09.2022):
	```
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 560 · 📦 1.2K · 📋 860 - 6% open · ⏱️ 08.09.2022):
...
- [PyPi](https://pypi.org/project/csvkit) (📥 140K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 72K · ⏱️ 20.03.2022):
	```
...
<details><summary><b><a href="https://github.com/xlwings/xlwings">xlwings</a></b> (🥈27 ·  ⭐ 2.4K) - A BSD-licensed library that makes it easy to call Python from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 430 · 📥 31K · 📦 25K · 📋 1.6K - 16% open · ⏱️ 20.10.2022):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 390K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 480K · ⏱️ 18.09.2022):
	```
...
- [GitHub](https://github.com/pyexcel/pyexcel) (👨‍💻 20 · 🔀 160 · 📥 160 · 📦 2.7K · 📋 200 - 5% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/pyexcel) (📥 160K / month):
	...
	pip install pyexcel
	```
- [Conda](https://anaconda.org/conda-forge/pyexcel) (📥 49K · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 740 · 📦 220K · 📋 790 - 4% open · ⏱️ 31.08.2022):
...
- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 370 · 📦 100 · 📋 480 - 16% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 22K / month):
	```
	pip install unoconv
	```
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 810 · 📋 980 - 47% open · ⏱️ 15.05.2021):
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 430 · 🔀 1.8K · 📥 670 · 📦 6.2K · 📋 1.6K - 3% open · ⏱️ 15.09.2022):
...
- [PyPi](https://pypi.org/project/nikola) (📥 1.7K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 6K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2K · 📦 26K · 📋 1.7K - 5% open · ⏱️ 16.10.2022):
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 92 · 🔀 290 · 📥 7K · 📋 600 - 36% open · ⏱️ 20.10.2022):
...
- [GitHub](https://github.com/sunainapai/makesite) (👨‍💻 8 · 🔀 260 · 📋 13 - 38% open · ⏱️ 12.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/makesite) (📥 590 / month):
	```
...
- [PyPi](https://pypi.org/project/django-taggit) (📥 350K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-taggit) (📥 99K · ⏱️ 02.05.2022):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 270 · 🔀 1.3K · 📦 11K · 📋 980 - 19% open · ⏱️ 13.10.2022):
...
- [PyPi](https://pypi.org/project/rq) (📥 690K / month):
	...
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 79K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 66 · 🔀 350 · 📦 1K · ⏱️ 18.08.2022):
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 85 · 🔀 230 · 📥 33 · 📦 520 · 📋 300 - 9% open · ⏱️ 04.10.2022):

	```
	git clone https://github.com/Bogdanp/dramatiq
	```
- [PyPi](https://pypi.org/project/dramatiq) (📥 91K / month):
	```
	pip install dramatiq
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 36K · ⏱️ 03.04.2022):
	```
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇22 ·  ⭐ 8.8K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.4K · 📥 53K · 📋 910 - 4% open · ⏱️ 13.10.2022):
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 480 · 🔀 1.6K · 📦 78K · 📋 590 - 2% open · ⏱️ 13.10.2022):
...
- [PyPi](https://pypi.org/project/faker) (📥 6.9M / month):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 660K · ⏱️ 13.10.2022):
	```
	conda install -c conda-forge faker
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇34 ·  ⭐ 7.4K) - A generic test automation framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 170 · 🔀 2K · 📥 540 · 📦 6K · 📋 3.9K - 5% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/robotframework) (📥 1.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robotframework) (📥 97K · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 500 · 📦 14K · 📋 1.3K - 2% open · ⏱️ 20.10.2022):
...
- [PyPi](https://pypi.org/project/hypothesis) (📥 3.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 6.3M · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 110 · 🔀 290 · 📥 72 · 📦 16K · 📋 240 - 0% open · ⏱️ 14.10.2022):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 8M / month):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 500 · 📦 5.8K · 📋 510 - 8% open · ⏱️ 10.10.2022):
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 120 · 🔀 300 · 📦 4.3K · 📋 340 - 24% open · ⏱️ 14.10.2022):

	```
	git clone https://github.com/kevin1024/vcrpy
	```
- [PyPi](https://pypi.org/project/vcrpy) (📥 2M / month):
	```
	pip install vcrpy
	```
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈30 ·  ⭐ 7.3K · 💀) - PyAutoGUI is a cross-platform GUI automation Python module for.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 940 · 📦 18K · 📋 590 - 63% open · ⏱️ 14.09.2021):
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 260 · 🔀 2.5K · 📋 1.4K - 0% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/locust) (📥 1.1M / month):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 82K · ⏱️ 16.10.2022):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 250 · 📦 6.7K · 📋 230 - 38% open · ⏱️ 16.10.2022):
...
- [PyPi](https://pypi.org/project/HTTPretty) (📥 490K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/HTTPretty) (📥 230K · ⏱️ 16.08.2021):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 290 · 📥 370 · 📋 310 - 0% open · ⏱️ 15.10.2022):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 180K / month):
	```
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 50K · ⏱️ 02.10.2022):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 230 · 📋 260 - 35% open · ⏱️ 12.08.2022):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 5.6M / month):
	```
	pip install freezegun
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 480K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 50 · 🔀 110 · 📋 680 - 16% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/schemathesis) (📥 120K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 1.4K · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 120 · 🔀 350 · 📋 530 - 29% open · ⏱️ 03.10.2022):
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 5.3K · 📋 260 - 18% open · ⏱️ 10.10.2022):
...
- [PyPi](https://pypi.org/project/nose2) (📥 570K / month):
	...
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 69K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 38 · 🔀 73 · 📦 730 · 📋 180 - 2% open · ⏱️ 20.09.2022):
...
- [PyPi](https://pypi.org/project/green) (📥 15K / month):
	...
	pip install green
	```
- [Conda](https://anaconda.org/conda-forge/green) (📥 110K · ⏱️ 21.03.2022):
	```
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 48 · 📦 1.8K · 📋 26 - 42% open · ⏱️ 28.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/httmock) (📥 220K / month):
	```
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 6.7K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 22 · 🔀 40 · 📦 70 · ⏱️ 29.08.2022):
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 43 · 🔀 89 · 📋 82 - 40% open · ⏱️ 23.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/mixer) (📥 90K / month):
	```
	pip install mixer
	```
...
<details><summary><b><a href="https://github.com/pyparsing/pyparsing">pyparsing</a></b> (🥇35 ·  ⭐ 1.7K) - A general purpose framework for generating parsers. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 50 · 🔀 220 · 📥 7.3K · 📦 620K · 📋 270 - 11% open · ⏱️ 29.08.2022):
...
- [PyPi](https://pypi.org/project/pyparsing) (📥 120M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 28M · ⏱️ 14.07.2022):
	```
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📦 15K · 📋 180 - 44% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 7.8M / month):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 840 · 📦 2.9K · ⏱️ 18.09.2022):

	```
	git clone https://github.com/orsinium/textdistance
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 700K / month):
	```
	pip install textdistance
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 240K · ⏱️ 18.09.2022):
	```
	conda install -c conda-forge textdistance
	```
</details>
<details><summary><b><a href="https://github.com/pwaller/pyfiglet">pyfiglet</a></b> (🥈27 ·  ⭐ 1K) - An implementation of figlet written in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 100 · 📦 23K · 📋 45 - 22% open · ⏱️ 16.09.2022):
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 580 · 📋 480 - 41% open · ⏱️ 23.09.2022):
...
- [PyPi](https://pypi.org/project/sqlparse) (📥 30M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 1.2M · ⏱️ 24.09.2022):
	```
...
- [PyPi](https://pypi.org/project/shortuuid) (📥 4.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 240K · ⏱️ 29.06.2022):
	```
	conda install -c conda-forge shortuuid
	```
</details>
<details><summary><b><a href="https://github.com/chardet/chardet">chardet</a></b> (🥈23 ·  ⭐ 1.8K) - Python 2/3 compatible character encoding detector. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/chardet/chardet) (👨‍💻 48 · 🔀 240 · 📋 130 - 37% open · ⏱️ 22.07.2022):

	```
	git clone https://github.com/chardet/chardet
	```
- [PyPi](https://pypi.org/project/chardet) (📥 67M / month):
	```
	pip install chardet
	```
- [Conda](https://anaconda.org/conda-forge/chardet) (📥 18M · ⏱️ 25.06.2022):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 31 · 🔀 88 · 📋 60 - 10% open · ⏱️ 27.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-slugify) (📥 9M / month):
	```
...
<details><summary><b><a href="https://github.com/dabeaz/ply">ply</a></b> (🥉22 ·  ⭐ 2.3K) - Implementation of lex and yacc parsing tools for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 32 · 🔀 370 · 📋 180 - 19% open · ⏱️ 11.10.2022):
...
- [PyPi](https://pypi.org/project/ply) (📥 20M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 2M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 31 · 🔀 190 · 📦 4.9K · 📋 69 - 55% open · ⏱️ 14.12.2021):
...
<details><summary><b><a href="https://github.com/mozilla/unicode-slugify">unicode-slugify</a></b> (🥉21 ·  ⭐ 310 · 💤) - A slugifier that generates unicode slugs with Django as a.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 560 · 📋 230 - 9% open · ⏱️ 28.08.2022):
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 7.1K · 📋 130 - 9% open · ⏱️ 09.02.2022):
...
- [GitHub](https://github.com/voronind/awesome-slugify) (👨‍💻 11 · 🔀 41 · 📦 3.1K · 📋 24 - 54% open · ⏱️ 20.01.2017):
	...
	```
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 82K / month):
	```
	pip install awesome-slugify
	```
- [Conda](https://anaconda.org/conda-forge/awesome-slugify) (📥 62K · ⏱️ 28.06.2019):
	```
	conda install -c conda-forge awesome-slugify
	```
</details>
<details><summary><b><a href="https://github.com/derek73/python-nameparser">python-nameparser</a></b> (🥉18 ·  ⭐ 560 · 💤) - Parsing human names into their individual components. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 20 · 🔀 91 · 📦 920 · 📋 100 - 21% open · ⏱️ 08.02.2022):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 26 · 🔀 370 · 📋 150 - 2% open · ⏱️ 14.10.2022):
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 21 · 📦 92 · 📋 8 - 37% open · ⏱️ 09.02.2019):
...
<details><summary><b><a href="https://github.com/boto/boto3">boto3</a></b> (🥇37 ·  ⭐ 7.6K) - Python interface to Amazon Web Services. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.6K · 📦 210K · 📋 2.8K - 6% open · ⏱️ 19.10.2022):
...
- [PyPi](https://pypi.org/project/boto3) (📥 390M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 12M · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 150 · 🔀 840 · 📥 190 · 📦 18K · 📋 760 - 6% open · ⏱️ 09.10.2022):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 9.6M / month):
	```
	pip install gspread
	```
...
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥈35 ·  ⭐ 6K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 120K · 📋 940 - 6% open · ⏱️ 19.10.2022):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 29M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 1.6M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 390 · 📦 5.4K · 📋 320 - 5% open · ⏱️ 16.07.2021):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 4.8K · 📋 280 - 2% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 710K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 59 · 📦 6.8K · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 15 · 🔀 140 · 📋 110 - 25% open · ⏱️ 01.08.2022):
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 190 · 📥 670 · 📦 240 · 📋 240 - 2% open · ⏱️ 06.07.2022):
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 23K / month):
	```
	pip install scikit-video
	```
- [Conda](https://anaconda.org/conda-forge/scikit-video) (📥 21K · ⏱️ 20.09.2018):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 230 · 🔀 720 · 📋 600 - 26% open · ⏱️ 27.09.2022):
...
- [PyPi](https://pypi.org/project/django-storages) (📥 2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 40K · ⏱️ 06.08.2022):
	```
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 210 · 🔀 540 · 📋 630 - 15% open · ⏱️ 13.10.2022):
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 850 · 📦 8.8K · 📋 370 - 44% open · ⏱️ 10.05.2020):
...
- [PyPi](https://pypi.org/project/requests-html) (📥 640K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 3.4K · ⏱️ 26.06.2021):
	```
	conda install -c conda-forge requests-html
	```
</details>
<details><summary><b><a href="https://github.com/miso-belica/sumy">sumy</a></b> (🥈25 ·  ⭐ 2.9K) - A module for automatic summarization of text documents and HTML pages. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/sumy) (📥 18K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 2.7K · ⏱️ 22.04.2022):
	```
...
- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 40 · 🔀 480 · 📋 210 - 40% open · ⏱️ 10.03.2022):
...
- [GitHub](https://github.com/Alir3z4/html2text) (👨‍💻 76 · 🔀 220 · 📋 200 - 40% open · ⏱️ 22.02.2022):
...
- [PyPi](https://pypi.org/project/html2text) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 21K · ⏱️ 09.02.2020):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 800 · ⏱️ 12.07.2021):
...
- [PyPi](https://pypi.org/project/micawber) (📥 25K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 5.7K · ⏱️ 14.07.2021):
	```
...
<details><summary><b><a href="https://github.com/michaelhelmick/lassie">lassie</a></b> (🥉17 ·  ⭐ 560 · 💀) - Web Content Retrieval for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/michaelhelmick/lassie) (👨‍💻 15 · 🔀 46 · 📦 29 · 📋 39 - 25% open · ⏱️ 20.08.2021):

	```
	git clone https://github.com/michaelhelmick/lassie
	```
- [PyPi](https://pypi.org/project/lassie) (📥 2.8K / month):
	```
	pip install lassie
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📋 53 - 9% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 170 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/binux/pyspider) (👨‍💻 62 · 🔀 3.6K · 📦 320 · 📋 820 - 32% open · ⏱️ 02.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyspider) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 50 · 🔀 1.4K · 📥 200 · 📦 44 · 📋 450 - 24% open · ⏱️ 10.07.2019):

	```
	git clone https://github.com/scrapinghub/portia
	```
- [PyPi](https://pypi.org/project/portia) (📥 280 / month):
	```
	pip install portia
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 51 · 🔀 360 · 📥 43 · 📋 160 - 15% open · ⏱️ 17.09.2022):
...
🔗&nbsp;<b><a href="https://github.com/shahraizali/awesome-django">awesome-django</a></b> ( ⭐ 950)  - The Best Django Resource, Awesome Django for mature packages.
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 82 · 🔀 120 · 📦 440 · 📋 370 - 3% open · ⏱️ 13.10.2022):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 720 · 📦 20K · 📋 1.2K - 4% open · ⏱️ 18.10.2022):
...
- [PyPi](https://pypi.org/project/channels) (📥 520K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 110K · ⏱️ 15.10.2022):
	```
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 62 · 🔀 440 · 📦 71K · 📋 920 - 1% open · ⏱️ 16.10.2022):
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 130 · 🔀 730 · 📦 21K · 📋 870 - 20% open · ⏱️ 26.09.2022):
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 770K · 📋 1.9K - 17% open · ⏱️ 15.10.2022):
...
- [PyPi](https://pypi.org/project/gunicorn) (📥 26M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gunicorn) (📥 1.5M · ⏱️ 08.04.2022):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 460 · 🔀 1.6K · 📥 250 · 📦 830K · 📋 1K - 1% open · ⏱️ 13.10.2022):
...
- [PyPi](https://pypi.org/project/werkzeug) (📥 120M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 5.9M · ⏱️ 09.08.2022):
	```
	conda install -c conda-forge werkzeug
	```
</details>
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉29 ·  ⭐ 1.1K · 📈) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 45 · 🔀 140 · 📦 83K · 📋 210 - 7% open · ⏱️ 31.07.2022):

	```
	git clone https://github.com/Pylons/waitress
	```
- [PyPi](https://pypi.org/project/waitress) (📥 2.9M / month):
	```
	pip install waitress
	```
- [Conda](https://anaconda.org/conda-forge/waitress) (📥 85K · ⏱️ 31.05.2022):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 490 · 📋 150 - 15% open · ⏱️ 11.09.2022):
...
- [PyPi](https://pypi.org/project/bjoern) (📥 22K / month):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 84K · ⏱️ 12.09.2022):
	```
