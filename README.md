...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 350 · 🔀 1.5K · 📦 20K · 📋 1.4K - 28% open · ⏱️ 20.02.2023):
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 200 · 🔀 950 · 📦 12K · 📋 860 - 13% open · ⏱️ 14.11.2022):
...
- [PyPi](https://pypi.org/project/flower) (📥 1.7M / month):
	...
	pip install flower
	```
- [Conda](https://anaconda.org/conda-forge/flower) (📥 150K · ⏱️ 17.03.2023):
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 800 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 330 / month):
	```
	pip install xadmin
	```
...
<details><summary><b><a href="https://github.com/wooey/Wooey">wooey</a></b> (🥉21 ·  ⭐ 1.9K) - A Django app which creates automatic web UIs for Python scripts. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 720 / month):
	```
...
<details><summary><b><a href="https://github.com/TheAlgorithms/Python">TheAlgorithms</a></b> (🥇29 ·  ⭐ 160K) - All Algorithms implemented in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 990 · 🔀 38K · 📦 2 · 📋 1.2K - 1% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 87M · ⏱️ 06.04.2023):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 75 · 🔀 500 · 📦 3K · 📋 430 - 2% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/transitions) (📥 410K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 380K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 200 · 🔀 4.1K · 📦 80 · 📋 160 - 35% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/keon/algorithms
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 4.3K / month):
	```
	pip install algorithms
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 1.4K · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 23 · 🔀 180 · 📦 110K · 📋 170 - 9% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 37 · ⏱️ 09.02.2020):

	```
	git clone https://github.com/tylerlaberge/PyPattyrn
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 1.7K / month):
	```
...
<details><summary><b><a href="https://github.com/faif/python-patterns">python-patterns</a></b> (🥉15 ·  ⭐ 37K) - A collection of design patterns in Python. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇36 ·  ⭐ 6.4K · 📈) - A lightning-fast ASGI server implementation, using uvloop and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 160 · 🔀 540 · 📦 170K · 📋 640 - 4% open · ⏱️ 01.04.2023):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 14M / month):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 1.7M · ⏱️ 16.03.2023):
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 64 · 🔀 230 · 📋 300 - 10% open · ⏱️ 07.02.2023):
...
- [PyPi](https://pypi.org/project/daphne) (📥 610K / month):
	...
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 140K · ⏱️ 11.11.2022):
	```
...
🔗&nbsp;<b><a href="https://github.com/timofurrer/awesome-asyncio">awesome-asyncio</a></b> ( ⭐ 4K)  - A curated list of awesome Python asyncio frameworks, libraries, software and..

🔗&nbsp;<b><a href="https://twistedmatrix.com/trac/">Twisted</a></b>  - An event-driven networking engine.

<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇33 ·  ⭐ 9.3K) - Ultra fast asyncio event loop. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 56 · 🔀 470 · 📥 370 · 📦 73K · 📋 310 - 18% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/MagicStack/uvloop
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 12M / month):
	```
	pip install uvloop
	```
- [Conda](https://anaconda.org/conda-forge/uvloop) (📥 570K · ⏱️ 26.10.2022):
	```
	conda install -c conda-forge uvloop
	```
</details>
<details><summary><b><a href="https://github.com/python-trio/trio">trio</a></b> (🥉30 ·  ⭐ 5.3K) - A friendly library for async concurrency and I/O. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 28K · 📋 700 - 36% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 7.8M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 1.1M · ⏱️ 26.10.2022):
	```
...
<details><summary><b><a href="https://github.com/jiaaro/pydub">pydub</a></b> (🥇32 ·  ⭐ 7K) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 910 · 📦 21K · 📋 520 - 49% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 7.1M / month):
	```
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 44K · ⏱️ 13.03.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 8K · 📦 310 · 📋 2.6K - 18% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/beets) (📥 2.2K / month):
	...
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 210 · ⏱️ 01.12.2022):
	```
	conda install -c conda-forge beets
	```
</details>
<details><summary><b><a href="https://github.com/quodlibet/mutagen">mutagen</a></b> (🥈28 ·  ⭐ 1.2K) - A Python module to handle audio metadata. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 42 · 🔀 130 · 📥 58K · 📦 11K · 📋 490 - 18% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 2.1M / month):
	```
	pip install mutagen
	```
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 25 · 🔀 55 · 📥 2.6K · 📦 2.3K · 📋 190 - 23% open · ⏱️ 08.10.2022):

	```
	git clone https://github.com/nicfit/eyeD3
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 26K / month):
	```
	pip install eyeD3
	```
...
<details><summary><b><a href="https://github.com/tyiannak/pyAudioAnalysis">pyAudioAnalysis</a></b> (🥈24 ·  ⭐ 5.2K · 💤) - Audio feature extraction, classification, segmentation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/audioread) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/audioread) (📥 610K · ⏱️ 29.10.2022):
	```
	conda install -c conda-forge audioread
	```
</details>
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉22 ·  ⭐ 5.8K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 850 · 📋 1.1K - 4% open · ⏱️ 02.04.2023):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 1.8M / month):
	```
	pip install librosa
	```
- [Conda](https://anaconda.org/conda-forge/librosa) (📥 610K · ⏱️ 17.03.2023):
	```
	conda install -c conda-forge librosa
	```
</details>
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥉22 ·  ⭐ 880 · 💤) - Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 22 · 📦 2.2K · 📋 95 - 13% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/kapre) (📥 18K / month):
	```
	pip install kapre
	```
...
<details><summary><b><a href="https://github.com/devsnd/tinytag">tinytag</a></b> (🥉22 ·  ⭐ 590) - A library for reading music meta data of MP3, OGG, FLAC and Wave files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 25 · 🔀 94 · 📦 730 · 📋 99 - 13% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 58 · 📦 16 · 📋 210 - 18% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 77 / month):
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉18 ·  ⭐ 900) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 110 · 📦 13 · 📋 40 - 32% open · ⏱️ 27.03.2023):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 580 / month):
	```
...
<details><summary><b><a href="https://github.com/worldveil/dejavu">dejavu</a></b> (🥉17 ·  ⭐ 6K · 💀) - Audio fingerprinting and recognition. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.3K · 📋 230 - 42% open · ⏱️ 03.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 330 / month):
	```
	pip install dejavu
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 190 · 🔀 450 · 📦 350K · 📋 360 - 20% open · ⏱️ 10.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 82M / month):
	```
	pip install oauthlib
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 8.2M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 600 · 📦 360K · 📋 390 - 4% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 110M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 10M · ⏱️ 20.10.2022):
	```
	conda install -c conda-forge pyjwt
	```
</details>
<details><summary><b><a href="https://github.com/pennersr/django-allauth">django-allauth</a></b> (🥈34 ·  ⭐ 7.9K) - Authentication app for Django that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 630 · 🔀 2.7K · 📦 150K · 📋 2K - 14% open · ⏱️ 31.03.2023):

	```
	git clone https://github.com/pennersr/django-allauth
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 740K / month):
	```
	pip install django-allauth
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 89K · ⏱️ 20.03.2023):
	```
	conda install -c conda-forge django-allauth
	```
</details>
<details><summary><b><a href="https://github.com/lepture/authlib">authlib</a></b> (🥈34 ·  ⭐ 3.6K) - JavaScript Object Signing and Encryption draft implementation. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lepture/authlib) (👨‍💻 94 · 🔀 350 · 📦 26K · 📋 370 - 12% open · ⏱️ 24.03.2023):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 7.4M / month):
	```
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 99K · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/omab/python-social-auth) (👨‍💻 280 · 🔀 1.1K · 📦 5.7K · 📋 660 - 2% open · ⏱️ 04.02.2017):
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 690 · 📋 750 - 21% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 20K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 38K · ⏱️ 22.02.2023):
	```
	conda install -c conda-forge pybuilder
	```
</details>
<details><summary><b><a href="https://github.com/platformio/platformio-core">PlatformIO</a></b> (🥉20 ·  ⭐ 6.7K) - A console tool to build code with different development platforms. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 690 · 📋 3.9K - 4% open · ⏱️ 29.03.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 330 · 📦 670K · 📋 620 - 17% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/attrs) (📥 130M / month):
	...
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 27M · ⏱️ 21.12.2022):
	```
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 53 · 📦 13K · 📋 54 - 5% open · ⏱️ 01.04.2023):
...
- [PyPi](https://pypi.org/project/bidict) (📥 1.4M / month):
	...
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 220K · ⏱️ 01.01.2023):
	```
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 19 · 📥 68 · 📦 72 · 📋 9 - 77% open · ⏱️ 30.10.2015):
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 91 · 📥 31 · 📋 150 - 10% open · ⏱️ 22.02.2023):
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.6K · 📋 1K - 3% open · ⏱️ 02.11.2022):

	```
	git clone https://github.com/stephenmcd/mezzanine
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 5K / month):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 350 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 680 / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 570 / month):
	```
	pip install Kotti
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 210 · 📋 440 - 5% open · ⏱️ 09.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 6.1K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 36 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 66 · 🔀 200 · 📦 1.1K · 📋 310 - 5% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 88 · 🔀 140 · 📦 4.5K · 📋 120 - 52% open · ⏱️ 04.02.2023):
...
- [PyPi](https://pypi.org/project/beaker) (📥 320K / month):
	...
	pip install beaker
	```
- [Conda](https://anaconda.org/conda-forge/beaker) (📥 68K · ⏱️ 06.02.2023):
	```
	conda install -c conda-forge beaker
	```
</details>
<details><summary><b><a href="https://github.com/lericson/pylibmc">pylibmc</a></b> (🥈26 ·  ⭐ 470 · 💤) - A Python wrapper around the.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 93 · 📦 4.5K · 📋 190 - 10% open · ⏱️ 26.08.2022):

	```
	git clone https://github.com/lericson/pylibmc
	```
- [PyPi](https://pypi.org/project/pylibmc) (📥 210K / month):
	```
	pip install pylibmc
	```
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 260 · 📋 72 - 22% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 6.2K / month):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 370 · 🔀 1.9K · 📥 28K · 📦 350K · 📋 2.2K - 16% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/black) (📥 20M / month):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 6.8M · ⏱️ 30.03.2023):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 370K · 📋 1.2K - 10% open · ⏱️ 01.04.2023):
...
- [PyPi](https://pypi.org/project/isort) (📥 26M / month):
	...
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 4.5M · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 360 · 📦 14K · 📋 1.1K - 8% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 87 · 🔀 160 · 📦 4.1K · 📋 360 - 14% open · ⏱️ 27.03.2023):
...
- [PyPi](https://pypi.org/project/prospector) (📥 680K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 65K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 860 · 📦 73K · 📋 770 - 47% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 4.1M / month):
	```
	pip install yapf
	```
- [Conda](https://anaconda.org/conda-forge/yapf) (📥 1.4M · ⏱️ 06.01.2022):
	```
	conda install -c conda-forge yapf
	```
</details>
<details><summary><b><a href="https://github.com/jendrikseipp/vulture">vulture</a></b> (🥈25 ·  ⭐ 2.5K) - A tool for finding and analysing dead Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 35 · 🔀 110 · 📦 3.6K · 📋 180 - 8% open · ⏱️ 27.02.2023):
...
- [PyPi](https://pypi.org/project/vulture) (📥 440K / month):
	...
	pip install vulture
	```
- [Conda](https://anaconda.org/conda-forge/vulture) (📥 67K · ⏱️ 09.01.2023):
	```
	conda install -c conda-forge vulture
	```
</details>
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈25 ·  ⭐ 980 · 💤) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 94 · 📦 5.7K · 📋 140 - 33% open · ⏱️ 08.08.2022):
...
- [PyPi](https://pypi.org/project/pylama) (📥 170K / month):
	...
	pip install pylama
	```
- [Conda](https://anaconda.org/conda-forge/pylama) (📥 90K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 240 · 🔀 390 · 📋 340 - 31% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 280 · 📦 400 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 12K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 15 · 📋 53 - 18% open · ⏱️ 08.01.2023):
...
- [PyPi](https://pypi.org/project/code2flow) (📥 4.1K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/code2flow) (📥 2.2K · ⏱️ 10.01.2023):
	```
	conda install -c conda-forge code2flow
	```
</details>
<details><summary><b><a href="https://github.com/google/pytype">pytype</a></b> (🥉18 ·  ⭐ 4.2K) - Pytype checks and infers types for Python code - without.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/pytype) (👨‍💻 92 · 🔀 250 · 📋 600 - 18% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/pytype) (📥 300K / month):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 150K · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 55 · 📦 110 · 📋 59 - 44% open · ⏱️ 12.10.2021):

	```
	git clone https://github.com/dropbox/pyannotate
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 4.2K / month):
	```
...
<details><summary><b><a href="https://github.com/Instagram/MonkeyType">MonkeyType</a></b> (🥉17 ·  ⭐ 4.2K) - A system for Python that generates static type annotations.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 20% open · ⏱️ 20.03.2023):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 55K / month):
	```
	pip install MonkeyType
	```
- [Conda](https://anaconda.org/conda-forge/MonkeyType) (📥 49K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.3K · 🔀 1.5K · 📋 2.1K - 7% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/Textualize/rich">rich</a></b> (🥇38 ·  ⭐ 43K) - Python library for rich text and beautiful formatting in the terminal. Also.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Textualize/rich) (👨‍💻 220 · 🔀 1.5K · 📦 77K · 📋 1.1K - 8% open · ⏱️ 27.03.2023):
...
- [PyPi](https://pypi.org/project/rich) (📥 23M / month):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 3.4M · ⏱️ 27.03.2023):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 440K · 📋 910 - 37% open · ⏱️ 03.03.2023):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 60M / month):
	```
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 19M · ⏱️ 04.03.2023):
	```
	conda install -c conda-forge tqdm
	```
</details>
<details><summary><b><a href="https://github.com/google/python-fire">python-fire</a></b> (🥈28 ·  ⭐ 24K) - A library for creating command line interfaces from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/python-fire) (👨‍💻 59 · 🔀 1.3K · 📦 19K · 📋 280 - 39% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/google/python-fire
	```
- [PyPi](https://pypi.org/project/python-fire) (📥 170 / month):
	```
...
<details><summary><b><a href="https://github.com/peterbrittain/asciimatics">asciimatics</a></b> (🥉26 ·  ⭐ 3.3K) - A package to create full-screen text UIs (from interactive.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 830 · 📋 290 - 8% open · ⏱️ 17.01.2023):
...
- [PyPi](https://pypi.org/project/asciimatics) (📥 65K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/asciimatics) (📥 130K · ⏱️ 10.11.2022):
	```
	conda install -c conda-forge asciimatics
	```
</details>
<details><summary><b><a href="https://github.com/rsalmei/alive-progress">alive-progress</a></b> (🥉24 ·  ⭐ 4.3K) - A new kind of Progress Bar, with real-time throughput, eta and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.7K · 📋 190 - 8% open · ⏱️ 24.03.2023):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 300K / month):
	```
	pip install alive-progress
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 29K · ⏱️ 24.03.2023):
	```
	conda install -c conda-forge alive-progress
	```
</details>
<details><summary><b><a href="https://github.com/prompt-toolkit/python-prompt-toolkit">python-prompt-toolkit</a></b> (🥉19 ·  ⭐ 8.3K) - A library for building powerful interactive command.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 660 · 📋 1K - 47% open · ⏱️ 06.03.2023):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 6.1K / month):
	```
	pip install bashplotlib
	```
- [Conda](https://anaconda.org/conda-forge/bashplotlib) (📥 4.2K · ⏱️ 08.09.2018):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 3.1K · 📦 13K · 📋 810 - 16% open · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/httpie) (📥 200K / month):
	...
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 96K · ⏱️ 01.11.2022):
	```
	conda install -c conda-forge httpie
	```
</details>
<details><summary><b><a href="https://github.com/cookiecutter/cookiecutter">cookiecutter</a></b> (🥇32 ·  ⭐ 19K · 💤) - A command-line utility that creates projects from.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 640K · ⏱️ 01.06.2022):
	```
	conda install -c conda-forge cookiecutter
	```
</details>
<details><summary><b><a href="https://github.com/nvbn/thefuck">thefuck</a></b> (🥈29 ·  ⭐ 77K · 💤) - Correcting your previous console command. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.2K · 📦 410 · 📋 670 - 31% open · ⏱️ 25.09.2022):

	```
	git clone https://github.com/nvbn/thefuck
	```
- [PyPi](https://pypi.org/project/thefuck) (📥 6.7K / month):
	```
	pip install thefuck
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 72 · 🔀 220 · 📦 230 · 📋 340 - 23% open · ⏱️ 01.04.2023):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 5.3K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 490 · 📦 880 · 📋 660 - 22% open · ⏱️ 18.03.2023):

	```
	git clone https://github.com/dbcli/pgcli
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 49K / month):
	```
	pip install pgcli
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 290 · 📋 620 - 29% open · ⏱️ 08.11.2022):

	```
	git clone https://github.com/dbcli/mycli
	```
- [PyPi](https://pypi.org/project/mycli) (📥 71K / month):
	```
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 54K · ⏱️ 02.09.2022):
	```
	conda install -c conda-forge mycli
	```
</details>
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈25 ·  ⭐ 960) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 55 · 🔀 120 · 📦 380 · 📋 340 - 13% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 40K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 2.2K · ⏱️ 07.01.2023):
	```
	conda install -c conda-forge copier
	```
</details>
<details><summary><b><a href="https://github.com/laixintao/iredis">iredis</a></b> (🥉24 ·  ⭐ 2.3K) - Redis CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 90 · 📥 11K · 📦 15 · 📋 200 - 24% open · ⏱️ 29.12.2022):

	```
	git clone https://github.com/laixintao/iredis
	```
- [PyPi](https://pypi.org/project/iredis) (📥 2K / month):
	```
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 610 · ⏱️ 10.08.2022):
	```
...
<details><summary><b><a href="https://github.com/facebook/PathPicker">PathPicker</a></b> (🥉20 ·  ⭐ 4.9K · 💤) - Select files out of bash output. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 63 · 📦 220 · 📋 92 - 34% open · ⏱️ 11.07.2022):

	```
	git clone https://github.com/dbcli/litecli
	```
- [PyPi](https://pypi.org/project/litecli) (📥 7.9K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 270 · 📦 38 · 📋 94 - 34% open · ⏱️ 15.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/saws) (📥 360 / month):
	```
	pip install saws
	```
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 670 · 📦 14 · 📋 70 - 82% open · ⏱️ 19.09.2018):

	```
	git clone https://github.com/cloudnativelabs/kube-shell
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 510 / month):
	```
...
<details><summary><b><a href="https://github.com/sloria/doitlive">doitlive</a></b> (🥉16 ·  ⭐ 3.3K · 💤) - A tool for live presentations in the terminal. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 94 · 📦 18 · 📋 49 - 26% open · ⏱️ 14.08.2022):
...
<details><summary><b><a href="https://github.com/timofurrer/try">try</a></b> (🥉12 ·  ⭐ 670 · 💤) - A dead simple CLI to try out python packages - it's never been easier. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/PyCQA/modernize">modernize</a></b> (🥇18 ·  ⭐ 310 · 💀) - Modernizes Python code for eventual Python 3 migration. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 45 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 71K / month):
	```
...
<details><summary><b><a href="https://github.com/JaidedAI/EasyOCR">EasyOCR</a></b> (🥇30 ·  ⭐ 18K) - Ready-to-use OCR with 40+ languages supported. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.5K · 📥 4.2M · 📦 2.4K · 📋 750 - 24% open · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 140K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 3.1K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 27 · 🔀 240 · 📦 820 · 📋 250 - 29% open · ⏱️ 14.03.2023):
...
<details><summary><b><a href="https://github.com/ageitgey/face_recognition">Face Recognition</a></b> (🥈26 ·  ⭐ 48K · 💤) - Simple facial recognition library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 13K · 📥 1.1K · 📋 1.3K - 54% open · ⏱️ 10.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 70K / month):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉24 ·  ⭐ 8K) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 800 · 📥 580 · 📦 3.6K · 📋 730 - 28% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/madmaze/pytesseract">pytesseract</a></b> (🥉24 ·  ⭐ 4.8K) - A wrapper for [Google Tesseract.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 41 · 🔀 630 · 📋 330 - 7% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/madmaze/pytesseract
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 840K / month):
	```
...
- [GitHub](https://github.com/sightmachine/SimpleCV) (👨‍💻 100 · 🔀 760 · 📦 390 · 📋 330 - 22% open · ⏱️ 07.04.2015):
	...
	```
- [PyPi](https://pypi.org/project/SimpleCV) (📥 3.8K / month):
	```
...
<details><summary><b><a href="https://github.com/soravux/scoop">scoop</a></b> (🥇20 ·  ⭐ 590 · 💤) - Scalable Concurrent Operations in Python. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 85 · 📦 310 · 📋 75 - 44% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 35 · 🔀 170 · 📥 11 · 📦 94K · 📋 85 - 4% open · ⏱️ 01.03.2023):
...
- [PyPi](https://pypi.org/project/python-decouple) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 58K · ⏱️ 02.03.2023):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 24 · 📦 25K · 📋 150 - 36% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/DiffSK/configobj
	```
- [PyPi](https://pypi.org/project/configobj) (📥 2.8M / month):
	```
	pip install configobj
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 600K · ⏱️ 20.01.2023):
	```
	conda install -c conda-forge configobj
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉21 ·  ⭐ 6.9K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 520 · 📋 1.2K - 15% open · ⏱️ 26.03.2023):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 8.8K / month):
	```
	pip install hydra
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 74K · 📋 1.5K - 50% open · ⏱️ 10.03.2023):

	```
	git clone https://github.com/paramiko/paramiko
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 36M / month):
	```
	pip install paramiko
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 3M · ⏱️ 13.03.2023):
	```
	conda install -c conda-forge paramiko
	```
</details>
<details><summary><b><a href="https://github.com/pyca/pynacl">pynacl</a></b> (🥉22 ·  ⭐ 960) - Python binding to the Networking and Cryptography (NaCl) library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 64 · 🔀 200 · 📋 290 - 14% open · ⏱️ 24.03.2023):
...
- [PyPi](https://pypi.org/project/pynacl) (📥 40M / month):
	...
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 4M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 8.5K / month):
	```
	pip install blaze
	```
...
<details><summary><b><a href="https://github.com/aws/aws-sdk-pandas">AWS Data Wrangler</a></b> (🥈25 ·  ⭐ 3.4K) - Pandas on AWS. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 130 · 🔀 580 · 📥 180K · 📦 950 · 📋 900 - 4% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 18 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 43 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 24 · 🔀 220 · 📋 220 - 4% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/Optimus) (📥 13K / month):
	```
	pip install Optimus
	```
...
<details><summary><b><a href="https://github.com/python-jsonschema/jsonschema">jsonschema</a></b> (🥇34 ·  ⭐ 4.1K) - An implementation of [JSON Schema](http://json-schema.org/) for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 110 · 🔀 530 · 📦 360K · 📋 720 - 3% open · ⏱️ 28.03.2023):
...
- [PyPi](https://pypi.org/project/jsonschema) (📥 67M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 18M · ⏱️ 30.11.2022):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 63 · 🔀 230 · 📦 13K · 📋 340 - 12% open · ⏱️ 05.05.2021):

	```
	git clone https://github.com/pyeve/cerberus
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 5.6M / month):
	```
	pip install cerberus
	```
- [Conda](https://anaconda.org/conda-forge/cerberus) (📥 300K · ⏱️ 10.12.2021):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 6.1K · 📋 150 - 51% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/keleshev/schema
	```
- [PyPi](https://pypi.org/project/schema) (📥 4.6M / month):
	```
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 88K · ⏱️ 02.12.2021):
	```
...
- [PyPi](https://pypi.org/project/voluptuous) (📥 2.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/voluptuous) (📥 270K · ⏱️ 07.04.2022):
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 9 · 🔀 24 · 📦 66 · 📋 15 - 26% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/podio/valideer
	```
- [PyPi](https://pypi.org/project/valideer) (📥 16K / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 190 · 🔀 1.6K · 📥 240 · 📦 240K · 📋 2.3K - 4% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/seaborn) (📥 9.3M / month):
	...
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 6.4M · ⏱️ 31.12.2022):
	```
	conda install -c conda-forge seaborn
	```
</details>
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈36 ·  ⭐ 8.2K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📥 21 · 📦 50K · 📋 1.8K - 11% open · ⏱️ 04.04.2023):
...
<details><summary><b><a href="https://github.com/mingrammer/diagrams">diagrams</a></b> (🥈31 ·  ⭐ 29K) - Diagram as Code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 940 · 📋 420 - 57% open · ⏱️ 13.01.2023):
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 650 · 🔀 4K · 📦 210 · 📋 7.2K - 9% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/has2k1/plotnine">plotnine</a></b> (🥉27 ·  ⭐ 3.4K) - A grammar of graphics for Python based on ggplot2. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 99 · 🔀 190 · 📦 4.7K · 📋 550 - 12% open · ⏱️ 03.04.2023):
...
<details><summary><b><a href="https://github.com/vispy/vispy">VisPy</a></b> (🥉26 ·  ⭐ 3K) - High-performance scientific visualization based on OpenGL. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 590 · 📦 1.1K · 📋 1.4K - 21% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 58K / month):
	```
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 360K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 340 · 📦 3.2K · 📋 1.1K - 26% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/cartopy) (📥 64K / month):
	...
	pip install cartopy
	```
- [Conda](https://anaconda.org/conda-forge/cartopy) (📥 2.8M · ⏱️ 18.03.2023):
	```
...
<details><summary><b><a href="https://github.com/msiemens/tinydb">tinydb</a></b> (🥇31 ·  ⭐ 5.8K) - A tiny, document-oriented database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 80 · 🔀 480 · 📦 10K · 📋 290 - 3% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/tinydb) (📥 460K / month):
	...
	pip install tinydb
	```
- [Conda](https://anaconda.org/conda-forge/tinydb) (📥 270K · ⏱️ 14.01.2023):
	```
	conda install -c conda-forge tinydb
	```
</details>
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥉24 ·  ⭐ 600) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 81 · 📦 1K · 📋 160 - 38% open · ⏱️ 28.03.2023):

	```
	git clone https://github.com/zopefoundation/ZODB
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 64K / month):
	```
	pip install ZODB
	```
- [Conda](https://anaconda.org/conda-forge/ZODB) (📥 55K · ⏱️ 09.11.2022):
	```
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 120 · 📦 1.1K · 📋 57 - 28% open · ⏱️ 15.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/pickledb) (📥 28K / month):
	```
	pip install pickledb
	```
- [Conda](https://anaconda.org/conda-forge/pickledb) (📥 3.5K · ⏱️ 17.04.2019):
	```
...
🔗&nbsp;<b><a href="https://github.com/dhamaniasad/awesome-postgres">awesome-postgres</a></b> ( ⭐ 8.5K)  - A curated list of awesome PostgreSQL software, libraries, tools and..
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 160K · 📋 630 - 4% open · ⏱️ 31.03.2023):
...
- [PyPi](https://pypi.org/project/PyMySQL) (📥 34M / month):
	...
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 1.1M · ⏱️ 28.03.2023):
	```
	conda install -c conda-forge PyMySQL
	```
</details>
<details><summary><b><a href="https://github.com/dpkp/kafka-python">kafka-python</a></b> (🥇34 ·  ⭐ 5.2K) - The Python client for Apache Kafka. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/kafka-python) (📥 7.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/kafka-python) (📥 390K · ⏱️ 30.09.2020):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 42 · 🔀 180 · 📦 55K · ⏱️ 21.03.2023):
...
- [PyPi](https://pypi.org/project/motor) (📥 1.4M / month):
	...
	pip install motor
	```
- [Conda](https://anaconda.org/conda-forge/motor) (📥 55K · ⏱️ 06.04.2023):
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 390 · 🔀 2.3K · 📋 1.4K - 11% open · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 940K · ⏱️ 29.03.2023):
	```
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 54 · 🔀 180 · 📦 1.4K · 📋 270 - 12% open · ⏱️ 01.04.2023):

	```
	git clone https://github.com/mymarilyn/clickhouse-driver
	```
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 1.6M / month):
	```
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.8K · ⏱️ 28.03.2023):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 990 · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 160 · 📦 740 · 📋 210 - 11% open · ⏱️ 12.07.2022):

	```
	git clone https://github.com/wbolster/happybase
	```
- [PyPi](https://pypi.org/project/happybase) (📥 160K / month):
	```
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 12 · 🔀 32 · 📦 120 · 📋 18 - 22% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 5.6K / month):
	```
	pip install queries
	```
...
- [GitHub](https://github.com/PyMySQL/mysqlclient) (👨‍💻 73 · 🔀 360 · 📥 5.2K · 📋 300 - 5% open · ⏱️ 31.03.2023):
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 52 / month):
	```
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 88 · 🔀 310 · 📥 85 · 📦 19K · 📋 460 - 43% open · ⏱️ 25.02.2023):
...
- [PyPi](https://pypi.org/project/pendulum) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 690K · ⏱️ 04.02.2023):
	```
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 420 · 📥 35K · 📦 990K · 📋 660 - 40% open · ⏱️ 03.12.2022):
...
- [PyPi](https://pypi.org/project/maya) (📥 45K / month):
	...
	pip install maya
	```
- [Conda](https://anaconda.org/conda-forge/maya) (📥 55K · ⏱️ 14.09.2022):
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 130 · 📦 910 · 📋 64 - 42% open · ⏱️ 28.06.2022):
...
<details><summary><b><a href="https://github.com/zachwill/moment">moment</a></b> (🥉20 ·  ⭐ 720 · 💀) - A Python library for dealing with dates/times. Inspired by.. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/moment) (📥 80K / month):
	...
	pip install moment
	```
- [Conda](https://anaconda.org/conda-forge/moment) (📥 11K · ⏱️ 31.01.2019):
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 24 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 430 / month):
	```
	pip install Chronyk
	```
...
<details><summary><b><a href="https://github.com/shinux/PyTime">PyTime</a></b> (🥉13 ·  ⭐ 150) - An easy-to-use Python module which aims to operate date/time/datetime by.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 20 · 📦 32 · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 980 / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 880 · 📥 180 · 📦 69K · 📋 830 - 7% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 1.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-debug-toolbar) (📥 160K · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 330 · 📥 12K · 📦 2.5K · 📋 280 - 35% open · ⏱️ 09.12.2022):
...
- [PyPi](https://pypi.org/project/py-spy) (📥 2.2M / month):
	...
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 420K · ⏱️ 09.09.2022):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 56 · 🔀 140 · 📦 43K · 📋 180 - 31% open · ⏱️ 13.03.2023):

	```
	git clone https://github.com/gotcha/ipdb
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 3.1M / month):
	```
	pip install ipdb
	```
- [Conda](https://anaconda.org/conda-forge/ipdb) (📥 350K · ⏱️ 23.03.2023):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 89 · 🔀 440 · 📦 4.9K · 📋 210 - 31% open · ⏱️ 21.03.2023):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 2.1M / month):
	```
...
<details><summary><b><a href="https://github.com/pallets-eco/flask-debugtoolbar">flask-debugtoolbar</a></b> (🥈27 ·  ⭐ 870) - A port of the django-debug-toolbar to flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets-eco/flask-debugtoolbar) (👨‍💻 46 · 🔀 130 · 📦 22K · 📋 110 - 37% open · ⏱️ 17.01.2023):
...
- [PyPi](https://pypi.org/project/flask-debugtoolbar) (📥 130K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-debugtoolbar) (📥 60K · ⏱️ 30.03.2022):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 210 · 📦 4.6K · 📋 310 - 45% open · ⏱️ 13.03.2023):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 220K / month):
	```
	pip install pudb
	```
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥈22 ·  ⭐ 6.7K) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 140 · 📋 100 - 32% open · ⏱️ 04.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 270K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 13K · ⏱️ 21.07.2022):
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 41 · 🔀 58 · 📦 4.6K · 📋 200 - 38% open · ⏱️ 14.07.2022):
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 110 · 📦 190 · 📋 110 - 27% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 9.4K / month):
	```
	pip install wdb
	```
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 370 · 📋 67 - 58% open · ⏱️ 05.03.2016):

	```
	git clone https://github.com/dcramer/django-devserver
	```
- [PyPi](https://pypi.org/project/django-devserver) (📥 5.4K / month):
	```
...
- [PyPi](https://pypi.org/project/line_profiler) (📥 340K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 370K · ⏱️ 09.12.2022):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 550 / month):
	```
	pip install pyflame
	```
- [Conda](https://anaconda.org/conda-forge/pyflame) (📥 20K · ⏱️ 25.06.2021):
	```
...
- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 20 · 📦 240 · 📋 22 - 31% open · ⏱️ 17.12.2022):
...
- [PyPi](https://pypi.org/project/memory_profiler) (📥 700K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/memory_profiler) (📥 320K · ⏱️ 16.11.2022):
	```
...
<details><summary><b><a href="https://github.com/khamidou/lptrace">lptrace</a></b> (🥉11 ·  ⭐ 690 · 💀) - [strace](http://man7.org/linux/man-pages/man1/strace.1.html) for.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 37 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 53 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 260K · 📋 37K - 5% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 6.2K · 📋 9.6K - 18% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/dmlc/mxnet
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 480K / month):
	```
	pip install mxnet
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥉30 ·  ⭐ 65K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 4K · 🔀 17K · 📥 13K · 📋 33K - 32% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 88K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 1.4M · ⏱️ 04.04.2023):
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 730 · 📥 280 · ⏱️ 22.05.2020):

	```
	git clone https://github.com/SerpentAI/SerpentAI
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 56 / month):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇37 ·  ⭐ 9.2K) - A cross-platform process and system utilities module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 290K · 📋 1.6K - 14% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/psutil) (📥 65M / month):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 21M · ⏱️ 08.11.2022):
	```
	conda install -c conda-forge psutil
	```
</details>
<details><summary><b><a href="https://github.com/ansible/ansible">ansible</a></b> (🥈35 ·  ⭐ 57K) - A radically simple IT automation platform. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 27K · 📋 31K - 2% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/ansible/ansible
	```
- [PyPi](https://pypi.org/project/ansible) (📥 4.3M / month):
	```
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 850K · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 15K · 📋 25K - 9% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/salt) (📥 63K / month):
	...
	pip install salt
	```
- [Conda](https://anaconda.org/conda-forge/salt) (📥 28K · ⏱️ 26.02.2019):
	```
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.9K · 📋 1.1K - 10% open · ⏱️ 27.03.2023):
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 140 · 📦 4.9K · 📋 100 - 11% open · ⏱️ 24.10.2022):
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 88 · 🔀 300 · 📦 75 · 📋 660 - 18% open · ⏱️ 16.03.2023):
...
- [PyPi](https://pypi.org/project/pyinfra) (📥 19K / month):
	...
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 620 · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 19 · 🔀 1.7K · 📋 1.7K - 23% open · ⏱️ 16.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/fabric) (📥 3.5M / month):
	```
	pip install fabric
	```
- [Conda](https://anaconda.org/conda-forge/fabric) (📥 62K · ⏱️ 22.01.2023):
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 190 · 📦 300 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools) (📥 4.7K / month):
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 600 · 🔀 2.3K · 📦 2.1K · 📋 960 - 8% open · ⏱️ 14.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/luigi) (📥 720K / month):
	```
	pip install luigi
	```
- [Conda](https://anaconda.org/conda-forge/luigi) (📥 620K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 47K · 📋 4.7K - 15% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/dask) (📥 7.2M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 8.4M · ⏱️ 24.03.2023):
	```
	conda install -c conda-forge dask
	```
</details>
<details><summary><b><a href="https://github.com/ray-project/ray">Ray</a></b> (🥈27 ·  ⭐ 25K) - A system for parallel and distributed Python that unifies the machine.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ray-project/ray) (🔀 4.2K · 📥 53 · 📦 8.8K · 📋 13K - 19% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 580 · 📦 1.2K · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 72K / month):
	```
	pip install mrjob
	```
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 95 · 🔀 540 · 📦 1.5K · 📋 480 - 49% open · ⏱️ 23.02.2023):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 740K · 📦 41K · 📋 4.8K - 5% open · ⏱️ 02.04.2023):
...
- [PyPi](https://pypi.org/project/pyinstaller) (📥 1.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 420K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 29 · 🔀 220 · 📦 780 · 📋 1K - 4% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 80 · 📥 410 · 📋 110 - 32% open · ⏱️ 04.11.2022):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 19K / month):
	```
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 1.3K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/spotify/dh-virtualenv) (👨‍💻 60 · 🔀 180 · 📋 200 - 14% open · ⏱️ 03.01.2023):
...
🔗&nbsp;<b><a href="https://github.com/yoloseem/awesome-sphinxdoc">awesome-sphinxdoc</a></b> ( ⭐ 860)  - A curated list of awesome tools for Sphinx Python Documentation Generator.
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.8K · 📦 290K · 📋 6.4K - 17% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 44 · 🔀 160 · 📦 1.7K · 📋 320 - 5% open · ⏱️ 01.04.2023):
...
- [PyPi](https://pypi.org/project/pdoc) (📥 110K / month):
	...
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 12K · ⏱️ 22.03.2023):
	```
	conda install -c conda-forge pdoc
	```
</details>
<details><summary><b><a href="https://github.com/pycco-docs/pycco">pycco</a></b> (🥉20 ·  ⭐ 820 · 💀) - The literate-programming-style documentation generator. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥇25 ·  ⭐ 6.3K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 55 · 🔀 1.4K · 📦 310 · 📋 820 - 0% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 52K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/s3tools/s3cmd) (👨‍💻 210 · 🔀 820 · 📥 3.1M · 📋 850 - 27% open · ⏱️ 14.03.2023):
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.7M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 8.3K · ⏱️ 22.12.2018):
	```
...
<details><summary><b><a href="https://github.com/MicroPyramid/forex-python">forex-python</a></b> (🥇25 ·  ⭐ 560) - Foreign exchange rates, Bitcoin price index and currency conversion. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 26 · 🔀 170 · 📦 1.9K · 📋 74 - 24% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 950 · 📦 210 · 📋 380 - 22% open · ⏱️ 28.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 7.5K / month):
	```
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 28 · 📦 280 · 📋 23 - 30% open · ⏱️ 04.09.2016):
	...
	```
- [PyPi](https://pypi.org/project/money) (📥 48K / month):
	```
	pip install money
	```
...
- [GitHub](https://github.com/agiliq/merchant) (👨‍💻 49 · 🔀 160 · 📦 26 · 📋 63 - 36% open · ⏱️ 08.07.2015):
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 91 · 📦 110 · 📋 15 - 20% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 390 / month):
	```
	pip install alipay
	```
...
<details><summary><b><a href="https://github.com/Alir3z4/python-currencies">python-currencies</a></b> (🥉13 ·  ⭐ 66 · 💀) - Display money format and its filthy currencies. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/spyder-ide/spyder">spyder</a></b> (🥇35 ·  ⭐ 7.5K) - Open Source Python IDE. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.9M · 📦 25K · 📋 17K - 6% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 59K / month):
	```
	pip install spyder
	```
- [Conda](https://anaconda.org/conda-forge/spyder) (📥 1.7M · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 93 · 🔀 240 · 📦 210 · 📋 1.6K - 23% open · ⏱️ 02.04.2023):

	```
	git clone https://github.com/jorgenschaefer/elpy
	```
- [PyPi](https://pypi.org/project/elpy) (📥 890 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/DamnWidget/anaconda) (👨‍💻 89 · 🔀 260 · 📋 780 - 21% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/anaconda) (📥 16K / month):
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 180 · 🔀 2.7K · 📋 3.2K - 0% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 81 · 🔀 660 · 📥 33K · 📋 4.6K - 2% open · ⏱️ 30.03.2023):
...
<details><summary><b><a href="https://github.com/davidhalter/jedi-vim">jedi-vim</a></b> (🥉15 ·  ⭐ 5.2K) - Vim bindings for the Jedi auto-completion library for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 32 · 🔀 260 · 📦 3.1K · 📋 220 - 43% open · ⏱️ 28.09.2022):
...
- [PyPi](https://pypi.org/project/yagmail) (📥 130K / month):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 24K · ⏱️ 11.09.2022):
	```
	conda install -c conda-forge yagmail
	```
</details>
<details><summary><b><a href="https://github.com/modoboa/modoboa">modoboa</a></b> (🥈25 ·  ⭐ 2.5K) - A mail hosting and management platform including a modern Web UI. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 330 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 2.3K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 180 · 📋 130 - 48% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 10K / month):
	```
	pip install imbox
	```
...
<details><summary><b><a href="https://github.com/marrow/mailer">mailer</a></b> (🥉18 ·  ⭐ 260 · 💤) - High-performance extensible mail delivery framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 56 · 📥 140 · 📋 72 - 33% open · ⏱️ 15.07.2022):
...
<details><summary><b><a href="https://github.com/moggers87/salmon">salmon</a></b> (🥉14 ·  ⭐ 590) - A Python Mail Server. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 60 · 📥 83 · 📦 18 · 📋 90 - 18% open · ⏱️ 02.04.2023):

	```
	git clone https://github.com/moggers87/salmon
	```
- [PyPi](https://pypi.org/project/salmon) (📥 91 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 96 · 🔀 910 · 📦 250K · 📋 1.3K - 5% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/virtualenv) (📥 47M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 4M · ⏱️ 13.03.2023):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 420 · 🔀 2.7K · 📋 1.6K - 2% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/gorakhargosh/watchdog">watchdog</a></b> (🥇35 ·  ⭐ 5.8K) - API and shell utilities to monitor file system events. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 87K · 📋 610 - 26% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/watchdog) (📥 13M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 1.9M · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 58 · 🔀 250 · 📦 40K · 📋 190 - 16% open · ⏱️ 30.03.2023):

	```
	git clone https://github.com/ahupp/python-magic
	```
- [PyPi](https://pypi.org/project/python-magic) (📥 6.2M / month):
	```
	pip install python-magic
	```
- [Conda](https://anaconda.org/conda-forge/python-magic) (📥 200K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 48 · 🔀 130 · 📋 130 - 1% open · ⏱️ 23.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/path.py) (📥 280K / month):
	```
	pip install path.py
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 38 · 📦 8.6K · 📋 17 - 35% open · ⏱️ 14.02.2015):

	```
	git clone https://github.com/mikeorr/Unipath
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 72K / month):
	```
	pip install Unipath
	```
...
- [GitHub](https://github.com/PyFilesystem/pyfilesystem2) (👨‍💻 47 · 🔀 160 · 📋 350 - 23% open · ⏱️ 18.10.2022):
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 140 · 🔀 370 · 📦 170K · 📋 420 - 13% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/wtforms/wtforms
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 4.2M / month):
	```
	pip install wtforms
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 690 · 📦 110K · 📋 670 - 8% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/django-crispy-forms/django-crispy-forms
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 810K / month):
	```
	pip install django-crispy-forms
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 69K · ⏱️ 14.02.2023):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 100K · 📋 160 - 13% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/django-bootstrap4) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-bootstrap4) (📥 23K · ⏱️ 20.10.2021):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 98 · 🔀 680 · 📦 18K · 📋 290 - 2% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/django-bootstrap3) (📥 95K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-bootstrap3) (📥 26K · ⏱️ 04.08.2019):
	```
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 770 · 📋 180 - 25% open · ⏱️ 15.07.2022):
...
<details><summary><b><a href="https://github.com/WiserTogether/django-remote-forms">django-remote-forms</a></b> (🥉16 ·  ⭐ 220 · 💀) - A platform independent Django form serializer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 100 · 🔀 230 · 📥 2.6K · 📦 170K · 📋 250 - 7% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/erikrose/more-itertools
	```
- [PyPi](https://pypi.org/project/more-itertools) (📥 37M / month):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 88K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 7.2K · 📋 74 - 5% open · ⏱️ 28.03.2023):
...
- [PyPi](https://pypi.org/project/funcy) (📥 1.8M / month):
	...
	pip install funcy
	```
- [Conda](https://anaconda.org/conda-forge/funcy) (📥 310K · ⏱️ 28.03.2023):
	```
	conda install -c conda-forge funcy
	```
</details>
<details><summary><b><a href="https://github.com/dry-python/returns">returns</a></b> (🥉26 ·  ⭐ 2.6K) - A set of type-safe monads, transformers, and composition utilities. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 96 · 📦 340 · 📋 400 - 15% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 55K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 4.6K · ⏱️ 13.03.2022):
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 31 · 🔀 100 · 📋 620 - 9% open · ⏱️ 30.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/coconut) (📥 1K / month):
	```
	pip install coconut
	```
- [Conda](https://anaconda.org/conda-forge/coconut) (📥 170K · ⏱️ 30.12.2022):
	```
	conda install -c conda-forge coconut
	```
</details>
<details><summary><b><a href="https://github.com/pytoolz/cytoolz">CyToolz</a></b> (🥉21 ·  ⭐ 920) - Cython implementation of `Toolz`: High performance functional.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 65 · 📦 49K · 📋 75 - 30% open · ⏱️ 19.12.2022):
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 460 · 📋 49 - 48% open · ⏱️ 13.10.2014):

	```
	git clone https://github.com/kachayev/fn.py
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 400 / month):
	```
	pip install fn.py
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 150 · 🔀 260 · 📦 21K · 📋 440 - 13% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/pyglet/pyglet
	```
- [PyPi](https://pypi.org/project/pyglet) (📥 270K / month):
	```
	pip install pyglet
	```
- [Conda](https://anaconda.org/conda-forge/pyglet) (📥 500K · ⏱️ 27.01.2023):
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.7K · 📦 7.8K · 📋 3.3K - 21% open · ⏱️ 27.03.2023):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 200K / month):
	```
	pip install PySimpleGUI
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 98K · ⏱️ 17.10.2022):
	```
	conda install -c conda-forge PySimpleGUI
	```
</details>
<details><summary><b><a href="https://github.com/python-eel/Eel">Eel</a></b> (🥈28 ·  ⭐ 5.6K) - A library for making simple Electron-like offline HTML/JS GUI apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 46 · 🔀 540 · 📦 5K · 📋 500 - 32% open · ⏱️ 04.03.2023):

	```
	git clone https://github.com/ChrisKnott/Eel
	```
- [PyPi](https://pypi.org/project/Eel) (📥 76K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 410 · 📦 720 · 📋 570 - 21% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 7.1K / month):
	```
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 63K · ⏱️ 29.12.2021):
	```
	conda install -c conda-forge Gooey
	```
</details>
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥈25 ·  ⭐ 10K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 520 · 📦 1.8K · 📋 1.1K - 15% open · ⏱️ 05.04.2023):
...
<details><summary><b><a href="https://github.com/r0x0r/pywebview">pywebview</a></b> (🥉24 ·  ⭐ 3.5K) - A lightweight cross-platform native wrapper around a webview.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/r0x0r/pywebview) (🔀 440 · 📦 1K · 📋 740 - 2% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 450 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 620 / month):
	```
	pip install flexx
	```
- [Conda](https://anaconda.org/conda-forge/flexx) (📥 97K · ⏱️ 12.04.2022):
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 230 · 🔀 570 · 📥 1.2K · 📋 640 - 18% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/pybee/toga
	```
- [PyPi](https://pypi.org/project/toga) (📥 1.9K / month):
	```
	pip install toga
	```
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 290 · 📦 210 · 📋 230 - 17% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/enaml) (📥 2.1K / month):
	...
	pip install enaml
	```
- [Conda](https://anaconda.org/conda-forge/enaml) (📥 140K · ⏱️ 20.08.2022):
	```
...
- [GitHub](https://github.com/graphql-python/graphene) (🔀 780 · 📦 17K · 📋 970 - 10% open · ⏱️ 13.03.2023):
...
<details><summary><b><a href="https://github.com/geopy/geopy">geopy</a></b> (🥇26 ·  ⭐ 3.9K · 📉) - Python Geocoding Toolbox. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 130 · 🔀 590 · 📋 260 - 8% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/geopy) (📥 4.4M / month):
	```
	pip install geopy
	```
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 53 · 🔀 250 · 📋 270 - 5% open · ⏱️ 16.03.2023):
...
- [PyPi](https://pypi.org/project/django-countries) (📥 490K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-countries) (📥 2.9K · ⏱️ 28.02.2022):
	```
	conda install -c conda-forge django-countries
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/geojson">geojson</a></b> (🥉18 ·  ⭐ 790) - Python bindings and utilities for GeoJSON. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 52 · 🔀 110 · 📦 12K · 📋 90 - 22% open · ⏱️ 16.02.2023):
...
<details><summary><b><a href="https://github.com/pallets/markupsafe">MarkupSafe</a></b> (🥇32 ·  ⭐ 530) - Implements a XML/HTML/XHTML Markup safe string for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 440 · 📦 1.2M · 📋 100 - 0% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/markupsafe) (📥 120M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/markupsafe) (📥 29M · ⏱️ 19.01.2023):
	```
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 52K · 📋 230 - 31% open · ⏱️ 12.03.2023):

	```
	git clone https://github.com/martinblech/xmltodict
	```
- [PyPi](https://pypi.org/project/xmltodict) (📥 23M / month):
	```
	pip install xmltodict
	```
- [Conda](https://anaconda.org/conda-forge/xmltodict) (📥 2.5M · ⏱️ 08.05.2022):
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 52 · 🔀 170 · 📦 18K · 📋 180 - 27% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 4.3M / month):
	```
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 38K · ⏱️ 28.12.2022):
	```
	conda install -c conda-forge pyquery
	```
</details>
<details><summary><b><a href="https://github.com/mozilla/bleach">bleach</a></b> (🥉27 ·  ⭐ 2.5K) - A whitelist-based HTML sanitization and text linkification library. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 78 · 🔀 230 · 📦 240K · 📋 360 - 7% open · ⏱️ 23.01.2023):
...
- [GitHub](https://github.com/stchris/untangle) (👨‍💻 17 · 🔀 80 · 📥 530 · 📦 990 · 📋 56 - 26% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/untangle) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 3.9K · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 730 · 🔀 8.6K · 📥 4.8K · 📦 2.1M · 📋 3.7K - 5% open · ⏱️ 03.03.2023):

	```
	git clone https://github.com/psf/requests
	```
- [PyPi](https://pypi.org/project/requests) (📥 300M / month):
	```
	pip install requests
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 31M · ⏱️ 31.03.2023):
	```
	conda install -c conda-forge requests
	```
</details>
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈37 ·  ⭐ 10K) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 190 · 🔀 660 · 📦 80K · 📋 750 - 3% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/httpx) (📥 16M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 530K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 980 · 📥 6.7K · 📦 1.2M · 📋 1.1K - 9% open · ⏱️ 31.03.2023):
...
- [PyPi](https://pypi.org/project/urllib3) (📥 320M / month):
	...
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 32M · ⏱️ 12.03.2023):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 77 · 🔀 180 · 📦 140K · 📋 110 - 40% open · ⏱️ 21.03.2023):
...
- [PyPi](https://pypi.org/project/httplib2) (📥 32M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/httplib2) (📥 2.3M · ⏱️ 22.03.2023):
	```
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 300 · 📦 3.6K · 📋 120 - 3% open · ⏱️ 26.01.2022):
...
- [PyPi](https://pypi.org/project/grequests) (📥 320K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 73K · ⏱️ 22.04.2020):
	```
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 50 · 🔀 130 · 📥 160 · 📦 1.5K · 📋 150 - 36% open · ⏱️ 10.09.2022):

	```
	git clone https://github.com/twisted/treq
	```
- [PyPi](https://pypi.org/project/treq) (📥 59K / month):
	```
	pip install treq
	```
- [Conda](https://anaconda.org/conda-forge/treq) (📥 69K · ⏱️ 30.01.2022):
	```
...
<details><summary><b><a href="https://github.com/secdev/scapy">scapy</a></b> (🥇34 ·  ⭐ 8.6K) - A brilliant packet manipulation library. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/secdev/scapy) (👨‍💻 420 · 🔀 1.8K · 📦 10K · 📋 1.4K - 4% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/scapy) (📥 2.5M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 76K · ⏱️ 25.12.2022):
	```
	conda install -c conda-forge scapy
	```
</details>
<details><summary><b><a href="https://github.com/boppreh/keyboard">keyboard</a></b> (🥈29 ·  ⭐ 3.4K) - Hook and simulate global keyboard events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 390 · 📦 10K · 📋 530 - 64% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 410K / month):
	```
	pip install keyboard
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 16K · ⏱️ 01.11.2022):
	```
	conda install -c conda-forge keyboard
	```
</details>
<details><summary><b><a href="https://github.com/boppreh/mouse">mouse</a></b> (🥉22 ·  ⭐ 750 · 💤) - Hook and simulate global mouse events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 120 · 📦 990 · 📋 110 - 72% open · ⏱️ 23.08.2022):
...
- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 470 · 📋 64 - 51% open · ⏱️ 20.03.2017):

	```
	git clone https://github.com/rockymeza/wifi
	```
- [PyPi](https://pypi.org/project/wifi) (📥 15K / month):
	```
	pip install wifi
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 430 · 🔀 1.9K · 📦 1.1M · 📋 2.8K - 2% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/python-pillow/Pillow
	```
- [PyPi](https://pypi.org/project/Pillow) (📥 57M / month):
	```
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 26M · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 12K · 📦 15K · 📋 390 - 4% open · ⏱️ 05.03.2023):

	```
	git clone https://github.com/dahlia/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 640K / month):
	```
	pip install wand
	```
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 340 · 📋 940 - 0% open · ⏱️ 27.01.2023):

	```
	git clone https://github.com/thumbor/thumbor
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 5.4K / month):
	```
	pip install thumbor
	```
...
- [PyPi](https://pypi.org/project/python-barcode) (📥 240K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 9.4K · ⏱️ 22.08.2020):
	```
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 270 · 📥 960 · 📦 230 · 📋 520 - 25% open · ⏱️ 09.09.2021):
...
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥉22 ·  ⭐ 500) - A fast image processing library with low memory needs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 46 · 📦 500 · 📋 350 - 38% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/libvips/pyvips
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 42K / month):
	```
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 51K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 11 · 🔀 42 · 📦 64 · 📋 8 - 50% open · ⏱️ 30.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pagan) (📥 170 / month):
	```
	pip install pagan
	```
...
<details><summary><b><a href="https://github.com/hhatto/nude.py">nude.py</a></b> (🥉16 ·  ⭐ 900 · 💀) - Nudity detection. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hhatto/nude.py) (👨‍💻 12 · 🔀 130 · 📦 3.3K · 📋 11 - 72% open · ⏱️ 23.11.2020):
...
<details><summary><b><a href="https://github.com/lincolnloop/python-qrcode">python-qrcode</a></b> (🥉12 ·  ⭐ 3.6K) - A pure Python QR Code generator. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 56 · 🔀 550 · 📋 200 - 22% open · ⏱️ 05.02.2023):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 55 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 22 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 750 / month):
	```
	pip install hmap
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 560 · 🔀 4.6K · 📥 59K · 📋 4.7K - 26% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 54K · 📋 560 - 46% open · ⏱️ 17.03.2023):
...
<details><summary><b><a href="https://github.com/python/cpython">CPython</a></b> (🥈21 ·  ⭐ 52K) - **Default, most widely used implementation of the Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 25K · 📋 63K - 10% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 54K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 310K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 68 · 📋 110 - 33% open · ⏱️ 16.11.2020):
...
- [PyPi](https://pypi.org/project/Pyjion) (📥 740 / month):
	...
	pip install Pyjion
	```
- [Conda](https://anaconda.org/conda-forge/Pyjion) (📥 470 · ⏱️ 13.02.2022):
	```
	conda install -c conda-forge Pyjion
	```
</details>
<details><summary><b><a href="https://github.com/metawilm/cl-python">CLPython</a></b> (🥉11 ·  ⭐ 350 · 💀) - Implementation of the Python programming language written in.. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉10 ·  ⭐ 910 · 💀) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 60 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 20 / month):
	```
...
🔗&nbsp;<b><a href="https://github.com/markusschanta/awesome-jupyter">awesome-jupyter</a></b> ( ⭐ 3.3K)  - A curated list of awesome Jupyter projects, libraries and resources.
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 54 · 🔀 260 · 📦 2.5K · 📋 360 - 57% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/jonathanslenders/ptpython
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 300K / month):
	```
	pip install ptpython
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 31K · ⏱️ 31.10.2022):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 220 · 📋 780 - 16% open · ⏱️ 20.03.2023):

	```
	git clone https://github.com/bpython/bpython
	```
- [PyPi](https://pypi.org/project/bpython) (📥 99K / month):
	```
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 62K · ⏱️ 15.03.2023):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 51 · 📦 3.4K · ⏱️ 08.04.2021):

	```
	git clone https://github.com/ovalhub/pyicu
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 410K / month):
	```
	pip install pyicu
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 51 · 🔀 830 · 📦 24K · 📋 400 - 34% open · ⏱️ 23.04.2022):
...
- [PyPi](https://pypi.org/project/schedule) (📥 2.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 31K · ⏱️ 10.04.2021):
	```
	conda install -c conda-forge schedule
	```
</details>
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥈30 ·  ⭐ 12K) - A modern workflow orchestration framework that makes it easy to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 140 · 🔀 1.2K · 📦 2.5K · 📋 3.5K - 17% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 790K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 420K · ⏱️ 30.03.2023):
	```
	conda install -c conda-forge prefect
	```
</details>
<details><summary><b><a href="https://github.com/sartography/SpiffWorkflow">Spiff</a></b> (🥈21 ·  ⭐ 1.4K) - A powerful workflow engine implemented in pure Python. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 51 · 🔀 280 · 📦 59 · 📋 110 - 3% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 6K / month):
	```
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 77 · 📋 9 - 11% open · ⏱️ 14.05.2020):

	```
	git clone https://github.com/fengsp/plan
	```
- [PyPi](https://pypi.org/project/plan) (📥 1K / month):
	```
	pip install plan
	```
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥇33 ·  ⭐ 15K) - Library which aims to bring enjoyable logging in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 590 · 📦 49K · 📋 730 - 11% open · ⏱️ 01.04.2023):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 7.4M / month):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 1.1M · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 340 · 📥 3.9K · 📦 41K · 📋 840 - 19% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 600 · 🔀 8K · 📥 6.3K · 📦 52K · 📋 4.8K - 6% open · ⏱️ 03.04.2023):
...
<details><summary><b><a href="https://github.com/openai/gym">gym</a></b> (🥈33 ·  ⭐ 31K) - A toolkit for developing and comparing reinforcement learning.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.8K · 📦 40K · 📋 1.8K - 2% open · ⏱️ 30.01.2023):
...
- [PyPi](https://pypi.org/project/gym) (📥 650K / month):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 210K · ⏱️ 26.01.2023):
	```
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.6K · 📦 120 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 2.2K / month):
	```
	pip install nupic
	```
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉22 ·  ⭐ 15K) - MindsDB is an open source AI layer for existing databases that.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 450 · 🔀 1.7K · 📋 2.4K - 19% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 11K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 15K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 99 · 🔀 550 · 📥 1.4K · 📦 1.4K · 📋 1.3K - 7% open · ⏱️ 12.03.2023):

	```
	git clone https://github.com/pythonnet/pythonnet
	```
- [PyPi](https://pypi.org/project/pythonnet) (📥 170K / month):
	```
	pip install pythonnet
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 67K · ⏱️ 03.11.2022):
	```
	conda install -c conda-forge pythonnet
	```
</details>
<details><summary><b><a href="https://github.com/mhammond/pywin32">PyWin32</a></b> (🥉29 ·  ⭐ 4.3K) - Python Extensions for Windows. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 88 · 🔀 730 · 📥 610K · 📦 120K · 📋 1.7K - 25% open · ⏱️ 26.03.2023):

	```
	git clone https://github.com/mhammond/pywin32
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 4.8M / month):
	```
	pip install pywin32
	```
- [Conda](https://anaconda.org/conda-forge/pywin32) (📥 3.6M · ⏱️ 28.10.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 810K · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/itsdangerous) (📥 52M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 5.1M · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 84 · 🔀 330 · 📥 23 · 📦 4.1K · 📋 150 - 32% open · ⏱️ 02.04.2023):

	```
	git clone https://github.com/mahmoud/boltons
	```
- [PyPi](https://pypi.org/project/boltons) (📥 4.3M / month):
	```
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 970K · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 16 · 🔀 160 · 📦 140K · 📋 40 - 7% open · ⏱️ 02.04.2023):

	```
	git clone https://github.com/jek/blinker
	```
- [PyPi](https://pypi.org/project/blinker) (📥 7.1M / month):
	```
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 8.2M · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 160 · 🔀 3.6K · 📦 410 · 📋 920 - 36% open · ⏱️ 18.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/magenta) (📥 8.3K / month):
	```
	pip install magenta
	```
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1.7K · 📋 13 - 7% open · ⏱️ 16.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 570K / month):
	```
	pip install pluginbase
	```
- [Conda](https://anaconda.org/conda-forge/pluginbase) (📥 280K · ⏱️ 04.02.2019):
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 440 · 🔀 4.1K · 📥 4.3K · 📦 44K · 📋 1.8K - 20% open · ⏱️ 13.03.2023):
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.4K · 📦 22K · 📋 820 - 73% open · ⏱️ 15.02.2020):

	```
	git clone https://github.com/fxsjy/jieba
	```
- [PyPi](https://pypi.org/project/jieba) (📥 500K / month):
	```
	pip install jieba
	```
- [Conda](https://anaconda.org/conda-forge/jieba) (📥 140K · ⏱️ 30.05.2021):
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 47 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):

	```
	git clone https://github.com/clips/pattern
	```
- [PyPi](https://pypi.org/project/pattern) (📥 1.3M / month):
	```
	pip install pattern
	```
...
<details><summary><b><a href="https://github.com/stanfordnlp/stanza">Stanza</a></b> (🥈25 ·  ⭐ 6.6K) - The Stanford NLP Group's official Python library, supporting 60+.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 58 · 🔀 820 · 📦 1.7K · 📋 770 - 9% open · ⏱️ 14.03.2023):
...
- [PyPi](https://pypi.org/project/stanza) (📥 180K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 9K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 250 · 📦 510 · 📋 69 - 28% open · ⏱️ 10.07.2021):

	```
	git clone https://github.com/PetrochukM/PyTorch-NLP
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 9.5K / month):
	```
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 320 · 📦 950 · 📋 220 - 68% open · ⏱️ 22.09.2020):

	```
	git clone https://github.com/aboSamoor/polyglot
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 65K / month):
	```
...
<details><summary><b><a href="https://github.com/isnowfy/snownlp">snownlp</a></b> (🥉23 ·  ⭐ 6K · 💀) - A library for processing Chinese text. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.1K · 📋 100 - 38% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 9.6K / month):
	```
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 1.7K · ⏱️ 07.09.2021):
	```
...
<details><summary><b><a href="https://github.com/saffsd/langid.py">langid.py</a></b> (🥉17 ·  ⭐ 2.1K · 💀) - Stand-alone language identification system. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉15 ·  ⭐ 49K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 230 · 🔀 800 · 📥 320 · 📋 140 - 45% open · ⏱️ 17.10.2022):
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 500 · 📦 1.4K · 📋 590 - 21% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/napalm-automation/napalm
	```
- [PyPi](https://pypi.org/project/napalm) (📥 43K / month):
	```
	pip install napalm
	```
...
<details><summary><b><a href="https://github.com/mininet/mininet">mininet</a></b> (🥉28 ·  ⭐ 4.8K) - A popular network emulator and API written in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 510K · 📦 200 · 📋 690 - 36% open · ⏱️ 23.11.2022):

	```
	git clone https://github.com/mininet/mininet
	```
- [PyPi](https://pypi.org/project/mininet) (📥 3.5K / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 430 · 📋 190 - 22% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 4.1M / month):
	```
	pip install pox
	```
- [Conda](https://anaconda.org/conda-forge/pox) (📥 290K · ⏱️ 24.10.2022):
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 6 · 📦 1K · 📋 300 - 4% open · ⏱️ 31.03.2023):

	```
	git clone https://github.com/justquick/django-activity-stream
	```
- [PyPi](https://pypi.org/project/django-activity-stream) (📥 47K / month):
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 21K · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/peewee) (📥 1.2M / month):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 490K · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 380 · 🔀 1.1K · 📦 20K · 📋 1.7K - 20% open · ⏱️ 03.03.2023):
...
- [PyPi](https://pypi.org/project/mongoengine) (📥 1.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/mongoengine) (📥 200K · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 410 · 📦 1.4K · 📋 560 - 36% open · ⏱️ 30.03.2023):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 300K · ⏱️ 21.02.2023):
	```
	conda install -c conda-forge PynamoDB
	```
</details>
<details><summary><b><a href="https://github.com/pudo/dataset">dataset</a></b> (🥈26 ·  ⭐ 4.4K) - Store Python dicts in a database - works with SQLite, MySQL, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 3K · 📋 280 - 7% open · ⏱️ 30.01.2023):
...
- [PyPi](https://pypi.org/project/dataset) (📥 50K / month):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 5K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 32 · 🔀 160 · 📦 540 · 📋 320 - 42% open · ⏱️ 13.03.2022):
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 230 · 📥 50 · 📦 3.3K · 📋 610 - 46% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/web2py/pydal) (🔀 130 · 📦 400 · 📋 310 - 44% open · ⏱️ 21.11.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 29 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 1.4K / month):
	```
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 18 · 🔀 92 · 📋 79 - 18% open · ⏱️ 30.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/orm) (📥 4.8K / month):
	```
	pip install orm
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 450 · 🔀 1.9K · 📥 15M · 📋 4.9K - 12% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/poetry) (📥 12M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 820K · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 500 · 📋 920 - 13% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/pip-tools) (📥 9.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 80K · ⏱️ 01.03.2023):
	```
	conda install -c conda-forge pip-tools
	```
</details>
<details><summary><b><a href="https://github.com/conda/conda">conda</a></b> (🥉22 ·  ⭐ 5.3K) - Cross-platform, Python-agnostic binary package manager. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/conda/conda) (🔀 1.3K · 📦 39K · 📋 9K - 8% open · ⏱️ 06.04.2023):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇20 ·  ⭐ 680) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/devpi/devpi) (👨‍💻 92 · 🔀 110 · 📦 210 · 📋 730 - 9% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 5 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 41 / month):
	```
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 340 · 🔀 790 · 📋 2.9K - 14% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 04.04.2023):
...
<details><summary><b><a href="https://github.com/sqlmapproject/sqlmap">sqlmap</a></b> (🥇23 ·  ⭐ 27K) - Automatic SQL injection and database takeover tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 5K · 📋 4.9K - 1% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 7.8K / month):
	```
	pip install sqlmap
	```
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉19 ·  ⭐ 8.5K · 💤) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.7K · 📋 130 - 26% open · ⏱️ 06.09.2022):
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉18 ·  ⭐ 8.8K · 💀) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/trustedsec/social-engineer-toolkit) (👨‍💻 85 · 🔀 2.4K · 📋 840 - 27% open · ⏱️ 26.01.2022):
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 530 · 📦 5.8K · 📋 440 - 27% open · ⏱️ 25.03.2022):
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 28 · 🔀 130 · 📦 1.2K · 📋 110 - 22% open · ⏱️ 23.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 280 / month):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 92 · 🔀 460 · 📦 12K · 📋 440 - 0% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/amoffat/sh
	```
- [PyPi](https://pypi.org/project/sh) (📥 4.6M / month):
	```
	pip install sh
	```
- [Conda](https://anaconda.org/conda-forge/sh) (📥 160K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/amitt001/delegator.py) (👨‍💻 23 · 🔀 88 · 📋 45 - 17% open · ⏱️ 06.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/delegator.py) (📥 42K / month):
	```
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 84 · 🔀 1.1K · 📦 2.7K · 📋 380 - 12% open · ⏱️ 24.03.2023):

	```
	git clone https://github.com/spotify/annoy
	```
- [PyPi](https://pypi.org/project/annoy) (📥 960K / month):
	```
	pip install annoy
	```
...
<details><summary><b><a href="https://github.com/lyst/lightfm">lightfm</a></b> (🥈28 ·  ⭐ 4.3K) - A Python implementation of a number of popular recommendation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 45 · 🔀 650 · 📦 1K · 📋 480 - 26% open · ⏱️ 20.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/lightfm) (📥 350K / month):
	```
	pip install lightfm
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 570 · 📥 330 · 📦 900 · 📋 450 - 16% open · ⏱️ 11.12.2022):
...
- [PyPi](https://pypi.org/project/implicit) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/implicit) (📥 460K · ⏱️ 29.01.2022):
	```
	conda install -c conda-forge implicit
	```
</details>
<details><summary><b><a href="https://github.com/NicolasHug/Surprise">Surprise</a></b> (🥉19 ·  ⭐ 5.8K) - A scikit for building and analyzing recommender systems. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 29 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 2.2K / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 480 · 📦 100 · 📋 110 - 43% open · ⏱️ 24.03.2021):

	```
	git clone https://github.com/ibayer/fastFM
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 250 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 77 · 🔀 140 · 📦 61K · 📋 290 - 23% open · ⏱️ 06.03.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 780K / month):
	```
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 1.1M · ⏱️ 29.01.2023):
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥇38 ·  ⭐ 56K · 📈) - A modern, fast, web framework for building APIs with Python 3.6+ based.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 420 · 🔀 4.6K · 📦 170K · 📋 3.3K - 0% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 17M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 1.4M · ⏱️ 19.03.2023):
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 870 · 📥 4.4K · 📦 7.9K · 📋 980 - 15% open · ⏱️ 18.01.2023):
...
- [PyPi](https://pypi.org/project/falcon) (📥 720K / month):
	...
	pip install falcon
	```
- [Conda](https://anaconda.org/conda-forge/falcon) (📥 310K · ⏱️ 17.03.2023):
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 990 · 📦 90K · 📋 550 - 17% open · ⏱️ 04.03.2022):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.5K · 📦 13K · 📋 1.3K - 4% open · ⏱️ 26.03.2023):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 970K / month):
	```
	pip install sanic
	```
- [Conda](https://anaconda.org/conda-forge/sanic) (📥 270K · ⏱️ 28.12.2022):
	```
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 2.3K · 📋 460 - 35% open · ⏱️ 10.08.2020):

	```
	git clone https://github.com/hugapi/hug
	```
- [PyPi](https://pypi.org/project/hug) (📥 74K / month):
	```
	pip install hug
	```
...
- [PyPi](https://pypi.org/project/apistar) (📥 10K / month):
	...
	pip install apistar
	```
- [Conda](https://anaconda.org/conda-forge/apistar) (📥 120K · ⏱️ 03.04.2019):
	```
...
- [GitHub](https://github.com/Cornices/cornice) (👨‍💻 120 · 🔀 140 · 📦 810 · 📋 240 - 19% open · ⏱️ 18.07.2022):
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 210 · 📦 24 · 📋 84 - 38% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 270 / month):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.3K · 📋 310 - 3% open · ⏱️ 27.03.2023):
...
<details><summary><b><a href="https://github.com/0rpc/zerorpc-python">zeroRPC</a></b> (🥇15 ·  ⭐ 3.1K · 💀) - zerorpc is a flexible RPC implementation based on.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/0rpc/zerorpc-python) (👨‍💻 38 · 🔀 360 · 📋 160 - 26% open · ⏱️ 06.01.2022):
...
- [PyPi](https://pypi.org/project/zerorpc-python):
	...
	```
- [Conda](https://anaconda.org/conda-forge/zerorpc-python) (📥 1.9K · ⏱️ 06.06.2022):
	```
...
<details><summary><b><a href="https://github.com/sympy/sympy">SymPy</a></b> (🥇35 ·  ⭐ 11K) - A Python library for symbolic mathematics. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.8K · 📥 490K · 📦 57K · 📋 12K - 32% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 5.4M / month):
	```
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 3.1M · ⏱️ 20.03.2023):
	```
	conda install -c conda-forge sympy
	```
</details>
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">statsmodels</a></b> (🥇35 ·  ⭐ 8.4K) - Statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 410 · 🔀 2.5K · 📥 27 · 📦 89K · 📋 5.1K - 47% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/statsmodels) (📥 9.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 9.3M · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4.1K · 📦 920 · 📋 980 - 32% open · ⏱️ 14.10.2020):

	```
	git clone https://github.com/quantopian/zipline
	```
- [PyPi](https://pypi.org/project/zipline) (📥 3.8K / month):
	```
	pip install zipline
	```
- [Conda](https://anaconda.org/conda-forge/zipline) (📥 6.9K · ⏱️ 05.10.2020):
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 450 · 🔀 1.7K · 📥 1.9K · 📦 1.3K · 📋 3K - 5% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/pymc-devs/pymc3
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 290K / month):
	```
	pip install pymc3
	```
- [Conda](https://anaconda.org/conda-forge/pymc3) (📥 500K · ⏱️ 20.05.2022):
	```
	conda install -c conda-forge pymc3
	```
</details>
<details><summary><b><a href="https://github.com/benedekrozemberczki/karateclub">Karate Club</a></b> (🥉23 ·  ⭐ 1.9K) - Unsupervised machine learning toolbox for graph structured data. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 140 · 📋 100 - 2% open · ⏱️ 26.03.2023):

	```
	git clone https://github.com/benedekrozemberczki/karateclub
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 2.9K / month):
	```
	pip install karateclub
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 17K · ⏱️ 28.01.2022):
	```
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 96 · 🔀 340 · 📋 3K - 3% open · ⏱️ 20.03.2023):

	```
	git clone https://github.com/chapmanb/bcbio-nextgen
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 190 / month):
	```
...
- [GitHub](https://github.com/obspy/obspy) (🔀 500 · 📥 6.8K · 📋 1.7K - 9% open · ⏱️ 04.04.2023):
...
<details><summary><b><a href="https://github.com/chapmanb/bcbb">bccb</a></b> (🥉18 ·  ⭐ 570) - Collection of useful code related to biological analysis. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/chapmanb/bcbb) (👨‍💻 33 · 🔀 220 · 📦 260 · 📋 74 - 20% open · ⏱️ 13.03.2023):
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 8.9K · 📋 1.2K - 36% open · ⏱️ 30.01.2023):
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 760 · 📥 160 · 📦 8.8K · 📋 1.3K - 9% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 74K · 📋 1.2K - 11% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/marshmallow-code/marshmallow
	```
- [PyPi](https://pypi.org/project/marshmallow) (📥 21M / month):
	```
	pip install marshmallow
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 1.6M · ⏱️ 13.11.2022):
	```
	conda install -c conda-forge marshmallow
	```
</details>
<details><summary><b><a href="https://github.com/python-rapidjson/python-rapidjson">python-rapidjson</a></b> (🥈24 ·  ⭐ 470) - A Python wrapper around.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 22 · 🔀 42 · 📦 3.8K · 📋 100 - 11% open · ⏱️ 15.03.2023):
...
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 950K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 1.2M · ⏱️ 15.03.2023):
	```
	conda install -c conda-forge python-rapidjson
	```
</details>
<details><summary><b><a href="https://github.com/TkTech/pysimdjson">pysimdjson</a></b> (🥉22 ·  ⭐ 580 · 💤) - A Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 48 · 📦 960 · 📋 81 - 14% open · ⏱️ 12.09.2022):
...
- [PyPi](https://pypi.org/project/pysimdjson) (📥 230K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 58K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 85 · 🔀 330 · 📋 340 - 6% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 48 · 🔀 220 · 📦 180 · 📋 90 - 41% open · ⏱️ 03.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 4.6K / month):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 580 · 📥 8.4K · 📋 2.4K - 10% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 37 · 🔀 220 · 📦 210K · 📋 250 - 5% open · ⏱️ 24.03.2023):
...
- [PyPi](https://pypi.org/project/mistune) (📥 14M / month):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 12M · ⏱️ 07.02.2023):
	```
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 40K · 📋 240 - 11% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/jazzband/tablib
	```
- [PyPi](https://pypi.org/project/tablib) (📥 1.7M / month):
	```
	pip install tablib
	```
- [Conda](https://anaconda.org/conda-forge/tablib) (📥 84K · ⏱️ 24.03.2023):
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 58K · 📋 860 - 2% open · ⏱️ 26.03.2023):
...
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/XlsxWriter) (📥 2.6M · ⏱️ 13.03.2023):
	```
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 570 · 📦 1.3K · 📋 870 - 7% open · ⏱️ 07.03.2023):
...
- [PyPi](https://pypi.org/project/csvkit) (📥 150K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 84K · ⏱️ 22.02.2023):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 59 · 🔀 450 · 📥 24K · 📦 28K · 📋 1.7K - 15% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 92K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 570K · ⏱️ 31.03.2023):
	```
...
- [PyPi](https://pypi.org/project/pdfminer) (📥 190K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pdfminer) (📥 28K · ⏱️ 15.02.2021):
	```
...
- [PyPi](https://pypi.org/project/pyexcel) (📥 190K / month):
	...
	pip install pyexcel
	```
- [Conda](https://anaconda.org/conda-forge/pyexcel) (📥 55K · ⏱️ 13.02.2022):
	```
	conda install -c conda-forge pyexcel
	```
</details>
<details><summary><b><a href="https://github.com/Python-Markdown/markdown">Python-Markdown</a></b> (🥉24 ·  ⭐ 3.2K) - A Python implementation of John Grubers Markdown. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 790 · 📦 260K · 📋 810 - 4% open · ⏱️ 23.03.2023):
...
<details><summary><b><a href="https://github.com/py-pdf/pypdf">PyPDF2</a></b> (🥉23 ·  ⭐ 5.5K · 📉) - A library capable of splitting, merging and transforming PDF.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 180 · 🔀 1.1K · 📋 720 - 7% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/mstamy2/PyPDF2
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 4.7M / month):
	```
	pip install PyPDF2
	```
- [Conda](https://anaconda.org/conda-forge/PyPDF2) (📥 380K · ⏱️ 29.10.2022):
	```
	conda install -c conda-forge PyPDF2
	```
</details>
<details><summary><b><a href="https://github.com/python-openxml/python-docx">python-docx</a></b> (🥉23 ·  ⭐ 3.6K · 💀) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 860 · 📋 1K - 49% open · ⏱️ 15.05.2021):
...
- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 370 · 📦 110 · 📋 480 - 17% open · ⏱️ 12.11.2021):

	```
	git clone https://github.com/unoconv/unoconv
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 26K / month):
	```
	pip install unoconv
	```
...
- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 390 · 📋 770 - 46% open · ⏱️ 20.09.2021):

	```
	git clone https://github.com/scanny/python-pptx
	```
- [PyPi](https://pypi.org/project/python-pptx) (📥 1.9M / month):
	```
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 53 · 🔀 330 · 📦 1.7K · 📋 390 - 19% open · ⏱️ 12.03.2023):
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 56 · 📦 10 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 48 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 760 · 📦 6.8K · 📋 1.6K - 3% open · ⏱️ 27.03.2023):
...
- [PyPi](https://pypi.org/project/pelican) (📥 20K / month):
	...
	pip install pelican
	```
- [Conda](https://anaconda.org/conda-forge/pelican) (📥 140K · ⏱️ 11.07.2022):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.1K · 📦 42K · 📋 1.8K - 6% open · ⏱️ 06.11.2022):
...
- [PyPi](https://pypi.org/project/nikola) (📥 1.3K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 7.7K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 300 · 📥 7K · 📦 410 · 📋 630 - 35% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/lektor/lektor
	```
- [PyPi](https://pypi.org/project/lektor) (📥 3.7K / month):
	```
	pip install lektor
	```
- [Conda](https://anaconda.org/conda-forge/lektor) (📥 61K · ⏱️ 01.03.2023):
	```
...
- [GitHub](https://github.com/sunainapai/makesite) (👨‍💻 8 · 🔀 270 · 📋 14 - 35% open · ⏱️ 12.10.2022):
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 150 · 🔀 560 · 📋 410 - 18% open · ⏱️ 21.11.2022):
...
- [PyPi](https://pypi.org/project/django-taggit) (📥 420K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-taggit) (📥 110K · ⏱️ 18.11.2022):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 290 · 🔀 1.3K · 📦 13K · 📋 1K - 13% open · ⏱️ 01.04.2023):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 690K / month):
	```
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 89K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 350 · 📦 1.2K · ⏱️ 24.03.2023):

	```
	git clone https://github.com/coleifer/huey
	```
- [PyPi](https://pypi.org/project/huey) (📥 75K / month):
	```
	pip install huey
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 88 · 🔀 240 · 📥 36 · 📦 870 · 📋 320 - 9% open · ⏱️ 02.04.2023):
...
- [PyPi](https://pypi.org/project/dramatiq) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 42K · ⏱️ 25.03.2023):
	```
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 40 · 🔀 110 · 📦 30 · 📋 170 - 30% open · ⏱️ 13.12.2020):

	```
	git clone https://github.com/pricingassistant/mrq
	```
- [PyPi](https://pypi.org/project/mrq) (📥 360 / month):
	```
	pip install mrq
	```
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇22 ·  ⭐ 9.1K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 950 - 5% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 520 · 🔀 1.7K · 📦 120K · 📋 630 - 2% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/faker) (📥 7.7M / month):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 740K · ⏱️ 05.04.2023):
	```
	conda install -c conda-forge faker
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇35 ·  ⭐ 7.9K) - A generic test automation framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 180 · 🔀 2.1K · 📥 540 · 📦 7.4K · 📋 4.1K - 6% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/robotframework) (📥 1.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robotframework) (📥 120K · ⏱️ 12.01.2023):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 520 · 📦 20K · 📋 1.4K - 3% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 4.7M / month):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7.4M · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 310 · 📥 110 · 📦 24K · ⏱️ 10.03.2023):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 11M / month):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.3K · 📋 520 - 8% open · ⏱️ 22.03.2023):
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈30 ·  ⭐ 7.9K · 💀) - PyAutoGUI is a cross-platform GUI automation Python module for.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 1K · 📦 22K · 📋 620 - 64% open · ⏱️ 14.09.2021):
...
- [PyPi](https://pypi.org/project/pyautogui) (📥 560K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyautogui) (📥 190K · ⏱️ 10.09.2022):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 120 · 🔀 300 · 📥 390 · 📦 1.3K · 📋 310 - 0% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 140K / month):
	```
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 95K · ⏱️ 18.12.2022):
	```
...
- [PyPi](https://pypi.org/project/vcrpy) (📥 1.3M / month):
	...
	pip install vcrpy
	```
- [Conda](https://anaconda.org/conda-forge/vcrpy) (📥 290K · ⏱️ 01.09.2022):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.6K · 📋 1.4K - 0% open · ⏱️ 24.03.2023):
...
- [PyPi](https://pypi.org/project/locust) (📥 1.4M / month):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 100K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 54 · 🔀 120 · 📦 210 · 📋 720 - 16% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 70K / month):
	```
	pip install schemathesis
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 4.2K · ⏱️ 26.03.2023):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 250 · 📦 14K · 📋 240 - 40% open · ⏱️ 16.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/HTTPretty) (📥 510K / month):
	```
	pip install HTTPretty
	```
- [Conda](https://anaconda.org/conda-forge/HTTPretty) (📥 300K · ⏱️ 16.08.2021):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 240 · 📋 280 - 37% open · ⏱️ 22.02.2023):
...
- [PyPi](https://pypi.org/project/freezegun) (📥 6.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 850K · ⏱️ 12.08.2022):
	```
	conda install -c conda-forge freezegun
	```
</details>
<details><summary><b><a href="https://github.com/nose-devs/nose2">nose2</a></b> (🥉24 ·  ⭐ 750) - The successor to `nose`, based on `unittest2`. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 23K · 📋 260 - 20% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/nose-devs/nose2
	```
- [PyPi](https://pypi.org/project/nose2) (📥 650K / month):
	```
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 88K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 130 · 🔀 360 · 📋 540 - 30% open · ⏱️ 28.03.2023):
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 48 · 📦 2.2K · 📋 26 - 42% open · ⏱️ 28.10.2020):

	```
	git clone https://github.com/patrys/httmock
	```
- [PyPi](https://pypi.org/project/httmock) (📥 360K / month):
	```
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 7.6K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 24 · 🔀 38 · 📦 79 · ⏱️ 21.02.2023):
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 120 · 📦 22 · 📋 22 - 31% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/fake2db) (📥 230 / month):
	```
	pip install fake2db
	```
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 85K / month):
	```
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 43 · 🔀 89 · 📋 84 - 41% open · ⏱️ 23.03.2022):
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 600 · 📦 710K · 📋 500 - 42% open · ⏱️ 20.03.2023):

	```
	git clone https://github.com/andialbrecht/sqlparse
	```
- [PyPi](https://pypi.org/project/sqlparse) (📥 32M / month):
	```
	pip install sqlparse
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 1.6M · ⏱️ 24.09.2022):
	```
	conda install -c conda-forge sqlparse
	```
</details>
<details><summary><b><a href="https://github.com/pyparsing/pyparsing">pyparsing</a></b> (🥇35 ·  ⭐ 1.8K) - A general purpose framework for generating parsers. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 54 · 🔀 240 · 📥 7.7K · 📦 750K · 📋 290 - 9% open · ⏱️ 05.04.2023):
...
- [PyPi](https://pypi.org/project/pyparsing) (📥 78M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 34M · ⏱️ 14.07.2022):
	```
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📦 18K · 📋 180 - 44% open · ⏱️ 09.09.2021):
...
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 6.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/fuzzywuzzy) (📥 460K · ⏱️ 18.11.2020):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 33 · 🔀 100 · 📦 16K · ⏱️ 25.02.2023):
...
- [PyPi](https://pypi.org/project/shortuuid) (📥 4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 340K · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 97 · 📦 28K · 📋 49 - 28% open · ⏱️ 16.09.2022):

	```
	git clone https://github.com/pwaller/pyfiglet
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 910K / month):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 900 · 📦 3.8K · ⏱️ 18.09.2022):
...
- [PyPi](https://pypi.org/project/textdistance) (📥 400K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 350K · ⏱️ 18.09.2022):
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 48 · 🔀 240 · 📋 130 - 37% open · ⏱️ 02.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/chardet) (📥 57M / month):
	```
	pip install chardet
	```
- [Conda](https://anaconda.org/conda-forge/chardet) (📥 20M · ⏱️ 02.12.2022):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 33 · 🔀 95 · 📋 65 - 1% open · ⏱️ 24.02.2023):
...
- [PyPi](https://pypi.org/project/ply) (📥 25M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 4.8M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 32 · 🔀 190 · 📦 5.8K · 📋 74 - 56% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 46 · 📦 2.1K · 📋 18 - 55% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 45K / month):
	```
...
<details><summary><b><a href="https://github.com/mozillazg/python-pinyin">pypinyin</a></b> (🥉19 ·  ⭐ 4.3K) - Convert Chinese hanzi () to pinyin (). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 240 - 10% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 27 / month):
	```
...
- [GitHub](https://github.com/voronind/awesome-slugify) (👨‍💻 11 · 🔀 41 · 📦 3.3K · 📋 24 - 54% open · ⏱️ 20.01.2017):
...
<details><summary><b><a href="https://github.com/vinta/pangu.py">pangu.py</a></b> (🥉15 ·  ⭐ 200) - Paranoid text spacing. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 21 · 📦 140 · 📋 8 - 37% open · ⏱️ 30.03.2023):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 27 · 🔀 380 · 📋 160 - 3% open · ⏱️ 27.03.2023):
...
<details><summary><b><a href="https://github.com/boto/boto3">boto3</a></b> (🥇37 ·  ⭐ 8K) - Python interface to Amazon Web Services. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.7K · 📦 290K · 📋 2.9K - 4% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 510M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 15M · ⏱️ 05.04.2023):
	```
	conda install -c conda-forge boto3
	```
</details>
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥈35 ·  ⭐ 6.5K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 140K · 📋 970 - 8% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 45M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 2M · ⏱️ 06.04.2023):
	```
	conda install -c conda-forge google-api-python-client
	```
</details>
<details><summary><b><a href="https://github.com/burnash/gspread">gspread</a></b> (🥈35 ·  ⭐ 6.4K) - Google Spreadsheets Python API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 870 · 📥 530 · 📦 22K · 📋 790 - 6% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/gspread) (📥 8.6M / month):
	...
	pip install gspread
	```
- [Conda](https://anaconda.org/conda-forge/gspread) (📥 260K · ⏱️ 22.11.2022):
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 66 · 🔀 150 · 📦 6K · 📋 280 - 2% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 900K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 62 · 📦 8.1K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 52K / month):
	```
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 35 · 📦 3.8K · 📋 20 - 25% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/purl) (📥 61K / month):
	```
	pip install purl
	```
...
- [PyPi](https://pypi.org/project/furl) (📥 1.6M / month):
	...
	pip install furl
	```
- [Conda](https://anaconda.org/conda-forge/furl) (📥 250K · ⏱️ 28.09.2021):
	```
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥇23 ·  ⭐ 2.7K) - Most Powerful multi-threaded Video Processing framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 220 · 📥 770 · 📦 370 · 📋 250 - 1% open · ⏱️ 26.01.2023):
...
- [PyPi](https://pypi.org/project/scikit-video) (📥 68K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scikit-video) (📥 24K · ⏱️ 20.09.2018):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.2K · 📋 440 - 26% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/jazzband/django-pipeline
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 78K / month):
	```
...
- [PyPi](https://pypi.org/project/webassets) (📥 250K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/webassets) (📥 54K · ⏱️ 24.12.2019):
	```
...
- [GitHub](https://github.com/miracle2k/flask-assets) (👨‍💻 38 · 🔀 85 · 📦 7K · 📋 97 - 21% open · ⏱️ 29.02.2020):

	```
	git clone https://github.com/miracle2k/flask-assets
	```
- [PyPi](https://pypi.org/project/flask-assets) (📥 170K / month):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 240 · 🔀 760 · 📋 610 - 26% open · ⏱️ 28.02.2023):
...
- [PyPi](https://pypi.org/project/django-storages) (📥 2.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 46K · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 66 · 🔀 880 · 📦 11K · 📋 380 - 43% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/psf/requests-html
	```
- [PyPi](https://pypi.org/project/requests-html) (📥 900K / month):
	```
	pip install requests-html
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 5.9K · ⏱️ 26.06.2021):
	```
	conda install -c conda-forge requests-html
	```
</details>
<details><summary><b><a href="https://github.com/miso-belica/sumy">sumy</a></b> (🥈25 ·  ⭐ 3.1K) - A module for automatic summarization of text documents and HTML pages. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/sumy) (📥 27K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 4.4K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 40 · 🔀 500 · 📋 220 - 41% open · ⏱️ 10.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/textract) (📥 130K / month):
	```
...
- [PyPi](https://pypi.org/project/micawber) (📥 44K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 8.8K · ⏱️ 14.07.2021):
	```
	conda install -c conda-forge micawber
	```
</details>
<details><summary><b><a href="https://github.com/Alir3z4/html2text">html2text</a></b> (🥉22 ·  ⭐ 1.4K · 💀) - Convert HTML to Markdown-formatted text. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [PyPi](https://pypi.org/project/html2text) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 30K · ⏱️ 09.02.2020):
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 74 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/buriy/python-readability) (👨‍💻 39 · 🔀 340 · 📋 99 - 34% open · ⏱️ 09.12.2022):
...
- [GitHub](https://github.com/binux/pyspider) (👨‍💻 62 · 🔀 3.6K · 📦 320 · 📋 820 - 32% open · ⏱️ 02.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyspider) (📥 1.9K / month):
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 900 · 📋 74 - 59% open · ⏱️ 07.06.2015):
	...
	```
- [PyPi](https://pypi.org/project/robobrowser) (📥 14K / month):
	```
...
<details><summary><b><a href="https://github.com/scrapinghub/portia">portia</a></b> (🥈21 ·  ⭐ 8.8K · 💀) - Visual scraping for Scrapy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 51 · 🔀 1.4K · 📥 230 · 📋 450 - 25% open · ⏱️ 10.07.2019):

	```
	git clone https://github.com/scrapinghub/portia
	```
- [PyPi](https://pypi.org/project/portia) (📥 260 / month):
	```
	pip install portia
	```
...
<details><summary><b><a href="https://github.com/lorien/grab">grab</a></b> (🥈21 ·  ⭐ 2.3K) - Site scraping framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 66 · 🔀 260 · ⏱️ 28.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 3K / month):
	```
	pip install grab
	```
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 83 · 🔀 120 · 📦 470 · 📋 380 - 7% open · ⏱️ 05.11.2022):

	```
	git clone https://github.com/MasoniteFramework/masonite
	```
- [PyPi](https://pypi.org/project/masonite) (📥 4.9K / month):
	```
...
<details><summary><b><a href="https://github.com/aaugustin/websockets">websockets</a></b> (🥇30 ·  ⭐ 4.5K) - A library for building WebSocket servers and clients with a focus.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 67 · 🔀 460 · 📦 96K · 📋 990 - 2% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/aaugustin/websockets
	```
- [PyPi](https://pypi.org/project/websockets) (📥 21M / month):
	```
	pip install websockets
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 1.9M · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 130 · 🔀 740 · 📦 24K · 📋 880 - 20% open · ⏱️ 31.03.2023):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 740 · 📋 1.2K - 6% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/channels) (📥 630K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 140K · ⏱️ 11.11.2022):
	```
...
<details><summary><b><a href="https://github.com/benoitc/gunicorn">gunicorn</a></b> (🥇37 ·  ⭐ 8.9K) - Pre-forked, ported from Ruby's Unicorn project. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 900K · 📋 1.9K - 18% open · ⏱️ 26.01.2023):
...
- [PyPi](https://pypi.org/project/gunicorn) (📥 27M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gunicorn) (📥 1.9M · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 300 · 📦 970K · 📋 1.1K - 0% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 77M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 7.3M · ⏱️ 14.02.2023):
	```
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 51 · 🔀 150 · 📦 120K · 📋 220 - 7% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/Pylons/waitress
	```
- [PyPi](https://pypi.org/project/waitress) (📥 4.4M / month):
	```
	pip install waitress
	```
- [Conda](https://anaconda.org/conda-forge/waitress) (📥 120K · ⏱️ 31.05.2022):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 600 · 📋 160 - 15% open · ⏱️ 11.09.2022):

	```
	git clone https://github.com/jonashaag/bjoern
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 27K / month):
	```
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 100K · ⏱️ 02.11.2022):
	```
