...
- [GitHub](https://github.com/mher/flower) (👨‍💻 200 · 🔀 970 · 📦 14K · 📋 880 - 8% open · ⏱️ 04.07.2023):
...
- [PyPi](https://pypi.org/project/flower) (📥 1.8M / month):
	...
	pip install flower
	```
- [Conda](https://anaconda.org/conda-forge/flower) (📥 170K · ⏱️ 18.06.2023):
	```
	conda install -c conda-forge flower
	```
</details>
<details><summary><b><a href="https://github.com/ajenti/ajenti">ajenti</a></b> (🥈25 ·  ⭐ 7.2K) - The admin panel your servers deserve. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 24 · 🔀 800 · 📦 26 · 📋 1.2K - 0% open · ⏱️ 03.08.2023):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 2.1K / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 800 · 📋 570 - 64% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 200 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 130 · 📋 20 - 35% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 1K · 🔀 39K · 📦 4 · 📋 1.3K - 2% open · ⏱️ 01.08.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 100M · ⏱️ 23.06.2023):
	```
	conda install -c conda-forge Python
	```
</details>
<details><summary><b><a href="https://github.com/pytransitions/transitions">transitions</a></b> (🥈28 ·  ⭐ 5K · 💤) - A lightweight, object-oriented finite state machine implementation. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/transitions) (📥 420K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 490K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 200 · 🔀 4.2K · 📦 91 · 📋 160 - 35% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/keon/algorithms
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 7.5K / month):
	```
...
<details><summary><b><a href="https://github.com/faif/python-patterns">python-patterns</a></b> (🥉16 ·  ⭐ 38K · 💤) - A collection of design patterns in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 130 · 🔀 6.5K · 📋 84 - 13% open · ⏱️ 27.01.2023):
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇36 ·  ⭐ 6.8K · 📈) - A lightning-fast ASGI server implementation, using uvloop and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 160 · 🔀 580 · 📦 220K · 📋 660 - 3% open · ⏱️ 02.08.2023):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 15M / month):
	```
	pip install uvicorn
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 56 · 🔀 480 · 📥 420 · 📦 88K · 📋 320 - 21% open · ⏱️ 15.01.2023):
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 150 · 🔀 300 · 📦 37K · 📋 720 - 36% open · ⏱️ 02.08.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 7M / month):
	```
	pip install trio
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 940 · 📦 34K · 📋 530 - 49% open · ⏱️ 08.12.2022):
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 540 · 🔀 1.7K · 📥 8.5K · 📦 340 · 📋 2.6K - 18% open · ⏱️ 31.07.2023):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 2.5K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 490 · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 44 · 🔀 140 · 📥 60K · 📦 13K · 📋 500 - 19% open · ⏱️ 30.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 890K / month):
	```
	pip install mutagen
	```
...
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥈25 ·  ⭐ 480 · 💤) - A tool for working with audio files, specifically MP3 files.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉22 ·  ⭐ 6.1K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>
...
- [PyPi](https://pypi.org/project/librosa) (📥 2.2M / month):
	...
	pip install librosa
	```
- [Conda](https://anaconda.org/conda-forge/librosa) (📥 670K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 26 · 🔀 93 · 📦 820 · 📋 100 - 10% open · ⏱️ 17.07.2023):
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 25 · 📦 2.3K · 📋 95 - 13% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/kapre) (📥 1.3K / month):
	```
	pip install kapre
	```
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 59 · 📦 16 · 📋 220 - 14% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 96 / month):
	```
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 130 · 📦 14 · 📋 42 - 33% open · ⏱️ 22.06.2023):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 820 / month):
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 190 · 🔀 460 · 📦 410K · 📋 360 - 20% open · ⏱️ 13.06.2023):
...
- [PyPi](https://pypi.org/project/oauthlib) (📥 80M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 9.1M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 140 · 🔀 620 · 📦 430K · 📋 400 - 2% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 97 · 🔀 360 · 📦 27K · 📋 390 - 13% open · ⏱️ 29.07.2023):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 6.2M / month):
	```
	pip install authlib
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 230 · 🔀 710 · 📋 770 - 21% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/evonove/django-oauth-toolkit
	```
- [PyPi](https://pypi.org/project/django-oauth-toolkit) (📥 450K / month):
	```
	pip install django-oauth-toolkit
	```
- [Conda](https://anaconda.org/conda-forge/django-oauth-toolkit) (📥 1.4K · ⏱️ 05.07.2023):
	```
	conda install -c conda-forge django-oauth-toolkit
	```
</details>
<details><summary><b><a href="https://github.com/pennersr/django-allauth">django-allauth</a></b> (🥉24 ·  ⭐ 8.1K · 📉) - Authentication app for Django that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 640 · 🔀 2.7K · 📋 2K - 10% open · ⏱️ 03.08.2023):
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 20K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 52K · ⏱️ 10.07.2023):
	```
	conda install -c conda-forge pybuilder
	```
</details>
<details><summary><b><a href="https://github.com/platformio/platformio-core">PlatformIO</a></b> (🥉20 ·  ⭐ 6.9K) - A console tool to build code with different development platforms. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 75 · 🔀 700 · 📋 4K - 4% open · ⏱️ 29.07.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 340 · 📦 790K · 📋 650 - 18% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 15 · 🔀 58 · 📦 15K · 📋 55 - 5% open · ⏱️ 02.08.2023):
...
- [PyPi](https://pypi.org/project/bidict) (📥 1.7M / month):
	...
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 320K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 22 · 📥 79 · 📦 89 · 📋 9 - 77% open · ⏱️ 30.10.2015):
	...
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 82 / month):
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 94 · 📥 38 · 📋 160 - 11% open · ⏱️ 22.02.2023):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 360 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 740 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 210 · 📋 440 - 6% open · ⏱️ 09.03.2023):
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 250 · 📦 4.7K · 📋 190 - 10% open · ⏱️ 26.08.2022):
...
- [GitHub](https://github.com/errbotio/errbot) (🔀 580 · 📦 310 · 📋 770 - 9% open · ⏱️ 13.06.2023):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 390 · 🔀 2K · 📥 47K · 📦 400K · 📋 2.3K - 14% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 24M / month):
	```
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 7.7M · ⏱️ 11.07.2023):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 290 · 🔀 520 · 📦 400K · 📋 1.2K - 12% open · ⏱️ 26.07.2023):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 370 · 📦 15K · 📋 1.1K - 9% open · ⏱️ 02.08.2023):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 290K / month):
	```
...
- [GitHub](https://github.com/landscapeio/prospector) (👨‍💻 89 · 🔀 160 · 📦 4.4K · 📋 360 - 14% open · ⏱️ 15.07.2023):
...
- [PyPi](https://pypi.org/project/prospector) (📥 770K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 82K · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge prospector
	```
</details>
<details><summary><b><a href="https://github.com/jendrikseipp/vulture">vulture</a></b> (🥈26 ·  ⭐ 2.7K) - A tool for finding and analysing dead Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 35 · 🔀 120 · 📦 3.9K · 📋 180 - 9% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 500K / month):
	```
	pip install vulture
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 96 · 📦 6K · 📋 140 - 34% open · ⏱️ 08.08.2022):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 250 · 🔀 400 · 📋 360 - 31% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 280 · 📦 410 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 6.4K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 240 · 📦 28 · 📋 58 - 25% open · ⏱️ 08.01.2023):
...
- [PyPi](https://pypi.org/project/code2flow) (📥 4.3K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/code2flow) (📥 3.1K · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 160 · 📋 170 - 22% open · ⏱️ 27.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 62K / month):
	```
	pip install MonkeyType
	```
- [Conda](https://anaconda.org/conda-forge/MonkeyType) (📥 53K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 94 · 🔀 260 · 📋 640 - 21% open · ⏱️ 28.07.2023):
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 56 · 📦 120 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 3.1K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.3K · 🔀 1.5K · 📋 2.2K - 7% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 230 · 🔀 1.6K · 📦 110K · 📋 1.1K - 10% open · ⏱️ 01.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/rich) (📥 28M / month):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 4.5M · ⏱️ 31.07.2023):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 12K · 📦 520K · 📋 920 - 38% open · ⏱️ 03.03.2023):
...
- [PyPi](https://pypi.org/project/tqdm) (📥 57M / month):
	...
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 22M · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge tqdm
	```
</details>
<details><summary><b><a href="https://github.com/peterbrittain/asciimatics">asciimatics</a></b> (🥈28 ·  ⭐ 3.4K) - A package to create full-screen text UIs (from interactive.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 42 · 🔀 240 · 📦 880 · 📋 290 - 8% open · ⏱️ 18.07.2023):
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 59 · 🔀 1.4K · 📦 23K · 📋 290 - 40% open · ⏱️ 13.02.2023):
...
<details><summary><b><a href="https://github.com/rsalmei/alive-progress">alive-progress</a></b> (🥉24 ·  ⭐ 4.6K) - A new kind of Progress Bar, with real-time throughput, eta and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 180 · 📦 2.1K · 📋 200 - 7% open · ⏱️ 01.06.2023):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 390K / month):
	```
	pip install alive-progress
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 38K · ⏱️ 01.06.2023):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 220 · 🔀 670 · 📋 1K - 47% open · ⏱️ 04.07.2023):
...
<details><summary><b><a href="https://github.com/httpie/cli">httpie</a></b> (🥇34 ·  ⭐ 29K) - A command line HTTP client, a user-friendly cURL replacement. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/httpie/cli) (👨‍💻 160 · 🔀 3.6K · 📥 4.6K · 📦 14K · 📋 820 - 17% open · ⏱️ 24.05.2023):
...
- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 300 · 🔀 1.8K · 📦 22K · 📋 790 - 22% open · ⏱️ 02.08.2023):
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 790K · ⏱️ 11.07.2023):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 200 · 🔀 3.3K · 📦 440 · 📋 680 - 32% open · ⏱️ 30.07.2023):
...
- [GitHub](https://github.com/copier-org/copier) (👨‍💻 58 · 🔀 130 · 📦 470 · 📋 390 - 13% open · ⏱️ 03.08.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 74K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 6.6K · ⏱️ 10.07.2023):
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 72 · 🔀 220 · 📦 260 · 📋 340 - 24% open · ⏱️ 29.07.2023):
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 500 · 📦 1K · 📋 670 - 23% open · ⏱️ 23.06.2023):
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 110 · 🔀 640 · 📦 310 · 📋 630 - 29% open · ⏱️ 05.05.2023):

	```
	git clone https://github.com/dbcli/mycli
	```
- [PyPi](https://pypi.org/project/mycli) (📥 49K / month):
	```
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 65K · ⏱️ 16.06.2023):
	```
...
- [PyPi](https://pypi.org/project/iredis) (📥 2K / month):
	...
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 880 · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 26 · 🔀 63 · 📦 280 · 📋 93 - 35% open · ⏱️ 12.05.2023):

	```
	git clone https://github.com/dbcli/litecli
	```
- [PyPi](https://pypi.org/project/litecli) (📥 8.4K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/mooz/percol) (👨‍💻 36 · 🔀 140 · 📦 33 · 📋 65 - 55% open · ⏱️ 23.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/percol) (📥 690 / month):
	```
	pip install percol
	```
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 95 · 📦 19 · 📋 49 - 26% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/doitlive) (📥 240 / month):
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 48 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 58K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 120 · 🔀 2.6K · 📥 5.6M · 📦 3.4K · 📋 840 - 31% open · ⏱️ 04.07.2023):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 110K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 7.6K · ⏱️ 03.06.2023):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 29 · 🔀 240 · 📥 2 · 📦 860 · 📋 250 - 27% open · ⏱️ 19.07.2023):
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥈26 ·  ⭐ 8.4K) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 830 · 📥 770 · 📦 5.5K · 📋 790 - 28% open · ⏱️ 02.08.2023):
...
<details><summary><b><a href="https://github.com/ageitgey/face_recognition">Face Recognition</a></b> (🥉25 ·  ⭐ 49K · 💀) - Simple facial recognition library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/python-decouple) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 67K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 70 · 📥 180 · 📦 28K · 📋 150 - 36% open · ⏱️ 18.01.2023):
...
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉20 ·  ⭐ 7.4K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 550 · 📋 1.3K - 15% open · ⏱️ 25.07.2023):
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 190 · 🔀 1.8K · 📦 81K · 📋 1.5K - 50% open · ⏱️ 28.07.2023):

	```
	git clone https://github.com/paramiko/paramiko
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 42M / month):
	```
	pip install paramiko
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 3.5M · ⏱️ 30.07.2023):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 65 · 🔀 200 · 📋 290 - 14% open · ⏱️ 12.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/pynacl) (📥 44M / month):
	```
	pip install pynacl
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 67 · 🔀 360 · 📦 9.1K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 6.2K / month):
	```
	pip install blaze
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 130 · 🔀 600 · 📥 200K · 📦 1.1K · 📋 960 - 3% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 110 · 🔀 540 · 📥 33 · 📦 420K · 📋 780 - 3% open · ⏱️ 03.08.2023):
...
- [PyPi](https://pypi.org/project/jsonschema) (📥 120M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 22M · ⏱️ 03.08.2023):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 65 · 🔀 230 · 📦 14K · 📋 340 - 3% open · ⏱️ 30.07.2023):
...
- [PyPi](https://pypi.org/project/cerberus) (📥 3.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cerberus) (📥 330K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 6.9K · 📋 150 - 51% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 200 · 🔀 1.7K · 📥 260 · 📦 290K · 📋 2.4K - 5% open · ⏱️ 01.08.2023):
...
- [PyPi](https://pypi.org/project/seaborn) (📥 9.9M / month):
	...
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 7.1M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 160 · 🔀 700 · 📥 73 · 📦 67K · 📋 1.8K - 9% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 660 · 🔀 4K · 📦 73K · 📋 7.4K - 9% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 100 · 🔀 200 · 📦 5.5K · 📋 570 - 12% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/has2k1/plotnine
	```
- [PyPi](https://pypi.org/project/plotnine) (📥 1.6M / month):
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 190 · 🔀 590 · 📦 1.2K · 📋 1.4K - 21% open · ⏱️ 17.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/vispy) (📥 76K / month):
	```
	pip install vispy
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 340 · 📦 3.6K · 📋 1.2K - 25% open · ⏱️ 01.08.2023):
...
- [PyPi](https://pypi.org/project/cartopy) (📥 67K / month):
	...
	pip install cartopy
	```
- [Conda](https://anaconda.org/conda-forge/cartopy) (📥 3.1M · ⏱️ 16.06.2023):
	```
...
- [PyPi](https://pypi.org/project/tinydb) (📥 450K / month):
	...
	pip install tinydb
	```
- [Conda](https://anaconda.org/conda-forge/tinydb) (📥 320K · ⏱️ 12.06.2023):
	```
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 85 · 📦 1.1K · 📋 160 - 38% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 19K · 📋 1.4K - 17% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/dpkp/kafka-python
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 6.4M / month):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 43 · 🔀 190 · 📦 66K · ⏱️ 26.07.2023):
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 400 · 🔀 2.3K · 📋 1.5K - 9% open · ⏱️ 03.08.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 1M · ⏱️ 10.07.2023):
	```
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 55 · 🔀 190 · 📦 1.6K · 📋 290 - 13% open · ⏱️ 30.06.2023):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 160 · 📦 770 · 📋 210 - 11% open · ⏱️ 12.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/happybase) (📥 92K / month):
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 1K · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 89 · 🔀 320 · 📥 160 · 📦 21K · 📋 470 - 41% open · ⏱️ 18.07.2023):
...
- [PyPi](https://pypi.org/project/pendulum) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 790K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 430 · 📥 35K · 📦 1.1M · 📋 680 - 41% open · ⏱️ 06.06.2023):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 45 · 📦 840 · 📋 41 - 7% open · ⏱️ 27.11.2020):
...
<details><summary><b><a href="https://github.com/KoffeinFlummi/Chronyk">Chronyk</a></b> (🥉17 ·  ⭐ 340 · 💀) - A Python 3 library for parsing human-written times and dates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 28 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 1.1K / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 33 · 🔀 360 · 📥 13K · 📦 2.9K · 📋 300 - 38% open · ⏱️ 31.07.2023):
...
- [PyPi](https://pypi.org/project/py-spy) (📥 2.3M / month):
	...
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 460K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 890 · 📥 210 · 📦 75K · 📋 860 - 8% open · ⏱️ 01.08.2023):
...
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-debug-toolbar) (📥 170K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 57 · 🔀 140 · 📦 47K · 📋 190 - 31% open · ⏱️ 11.04.2023):
...
- [PyPi](https://pypi.org/project/ipdb) (📥 2.3M / month):
	...
	pip install ipdb
	```
- [Conda](https://anaconda.org/conda-forge/ipdb) (📥 380K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 91 · 🔀 460 · 📦 5.7K · 📋 220 - 31% open · ⏱️ 29.06.2023):
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 92 · 🔀 210 · 📦 5.1K · 📋 310 - 46% open · ⏱️ 01.08.2023):
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥉22 ·  ⭐ 6.9K · 💤) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 140 · 📋 110 - 33% open · ⏱️ 04.12.2022):
...
- [PyPi](https://pypi.org/project/icecream) (📥 240K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 21K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 1.6K / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 42 · 📦 140 · 📋 94 - 42% open · ⏱️ 26.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-hunter) (📥 24 / month):
	```
...
<details><summary><b><a href="https://github.com/ionelmc/python-manhole">manhole</a></b> (🥉18 ·  ⭐ 350 · 💤) - Debugging UNIX socket connections and present the stacktraces for.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 22 · 📦 250 · 📋 22 - 31% open · ⏱️ 17.12.2022):
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 800K / month):
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.4K · 🔀 72K · 📦 300K · 📋 38K - 5% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/Theano/Theano) (👨‍💻 390 · 🔀 2.4K · 📦 14K · 📋 2.7K - 21% open · ⏱️ 20.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/Theano) (📥 330K / month):
	```
	pip install Theano
	```
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥉26 ·  ⭐ 69K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 4.2K · 🔀 18K · 📥 21K · 📋 35K - 32% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 740 · 📥 290 · ⏱️ 22.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 86 / month):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇38 ·  ⭐ 9.4K) - A cross-platform process and system utilities module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 200 · 🔀 1.3K · 📦 340K · 📋 1.6K - 14% open · ⏱️ 03.08.2023):
...
- [PyPi](https://pypi.org/project/psutil) (📥 68M / month):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 24M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.8K · 🔀 23K · 📦 29K · 📋 32K - 1% open · ⏱️ 03.08.2023):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.3M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 940K · ⏱️ 19.07.2023):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 16K · 📋 26K - 10% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 180 · 🔀 1.1K · 📦 9.5K · 📋 1.1K - 10% open · ⏱️ 14.06.2023):
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 140 · 📦 5.7K · 📋 100 - 11% open · ⏱️ 24.10.2022):
...
- [PyPi](https://pypi.org/project/fabric) (📥 4.2M / month):
	...
	pip install fabric
	```
- [Conda](https://anaconda.org/conda-forge/fabric) (📥 68K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 92 · 🔀 300 · 📦 82 · 📋 670 - 20% open · ⏱️ 19.07.2023):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 26K / month):
	```
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 2K · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 600 · 🔀 2.3K · 📦 2.2K · 📋 970 - 9% open · ⏱️ 04.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/luigi) (📥 610K / month):
	```
	pip install luigi
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 51K · 📋 4.8K - 16% open · ⏱️ 02.08.2023):
...
- [PyPi](https://pypi.org/project/dask) (📥 8.2M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 9.6M · ⏱️ 20.07.2023):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.5K · 📥 86 · 📦 11K · 📋 15K - 19% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 44 · 🔀 210 · 📦 59 · 📋 330 - 19% open · ⏱️ 18.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/streamparse) (📥 7.4K / month):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 460 · 🔀 1.8K · 📥 740K · 📦 46K · 📋 4.9K - 5% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 1.4M / month):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 470K · ⏱️ 26.06.2023):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 31 · 🔀 230 · 📦 900 · 📋 1.2K - 0% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 80 · 📥 590 · 📋 110 - 32% open · ⏱️ 04.11.2022):
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.8K · 📦 320K · 📋 6.5K - 17% open · ⏱️ 02.08.2023):
...
- [PyPi](https://pypi.org/project/pdoc) (📥 110K / month):
	...
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 20K · ⏱️ 19.06.2023):
	```
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥇26 ·  ⭐ 7K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 58 · 🔀 1.5K · 📦 400 · 📋 980 - 0% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 26 · 🔀 180 · 📦 2.1K · 📋 81 - 29% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 92 · 📦 110 · 📋 15 - 20% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 500 / month):
	```
	pip install alipay
	```
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 260 · 🔀 1.5K · 📥 3.3M · 📦 26K · 📋 17K - 6% open · ⏱️ 31.07.2023):
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 94 · 🔀 250 · 📦 210 · 📋 1.6K - 22% open · ⏱️ 23.07.2023):

	```
	git clone https://github.com/jorgenschaefer/elpy
	```
- [PyPi](https://pypi.org/project/elpy) (📥 630 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 82 · 🔀 670 · 📥 34K · 📋 4.8K - 1% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/davidhalter/jedi-vim) (👨‍💻 97 · 🔀 370 · 📋 780 - 2% open · ⏱️ 31.07.2023):
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 57 · 🔀 180 · 📦 480 · 📋 89 - 57% open · ⏱️ 03.03.2023):
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 180 · 📦 190 · 📋 130 - 48% open · ⏱️ 17.11.2022):
...
- [PyPi](https://pypi.org/project/mailer) (📥 120K / month):
	...
	pip install mailer
	```
- [Conda](https://anaconda.org/conda-forge/mailer) (📥 61K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 60 · 📥 94 · 📦 19 · 📋 90 - 18% open · ⏱️ 02.04.2023):

	```
	git clone https://github.com/moggers87/salmon
	```
- [PyPi](https://pypi.org/project/salmon) (📥 71 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 100 · 🔀 940 · 📦 300K · 📋 1.3K - 1% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 74M / month):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 4.9M · ⏱️ 25.07.2023):
	```
	conda install -c conda-forge virtualenv
	```
</details>
<details><summary><b><a href="https://github.com/pyenv/pyenv">pyenv</a></b> (🥉27 ·  ⭐ 33K) - Simple Python version management. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 420 · 🔀 2.8K · 📋 1.6K - 1% open · ⏱️ 28.07.2023):
...
- [PyPi](https://pypi.org/project/watchdog) (📥 13M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 2.3M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 58 · 🔀 250 · 📦 45K · 📋 190 - 17% open · ⏱️ 30.03.2023):

	```
	git clone https://github.com/ahupp/python-magic
	```
- [PyPi](https://pypi.org/project/python-magic) (📥 5.4M / month):
	```
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 49 · 🔀 140 · 📋 130 - 2% open · ⏱️ 08.07.2023):
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 150 · 🔀 380 · 📦 180K · 📋 430 - 11% open · ⏱️ 30.07.2023):
...
- [PyPi](https://pypi.org/project/wtforms) (📥 4M / month):
	...
	pip install wtforms
	```
- [Conda](https://anaconda.org/conda-forge/wtforms) (📥 160K · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge wtforms
	```
</details>
<details><summary><b><a href="https://github.com/django-crispy-forms/django-crispy-forms">django-crispy-forms</a></b> (🥈30 ·  ⭐ 4.7K) - A Django app which lets you create beautiful forms in a.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 690 · 📦 120K · 📋 680 - 8% open · ⏱️ 05.07.2023):

	```
	git clone https://github.com/django-crispy-forms/django-crispy-forms
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 760K / month):
	```
	pip install django-crispy-forms
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 82K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 110 · 🔀 250 · 📥 2.8K · 📦 190K · 📋 260 - 7% open · ⏱️ 02.08.2023):

	```
	git clone https://github.com/erikrose/more-itertools
	```
- [PyPi](https://pypi.org/project/more-itertools) (📥 41M / month):
	```
	pip install more-itertools
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 12M · ⏱️ 29.07.2023):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 75 · 🔀 230 · 📦 100K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 140 · 📦 8.2K · 📋 77 - 7% open · ⏱️ 11.05.2023):
...
- [PyPi](https://pypi.org/project/funcy) (📥 1.4M / month):
	...
	pip install funcy
	```
- [Conda](https://anaconda.org/conda-forge/funcy) (📥 360K · ⏱️ 16.06.2023):
	```
...
- [PyPi](https://pypi.org/project/returns) (📥 100K / month):
	...
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 6.3K · ⏱️ 27.06.2023):
	```
...
- [PyPi](https://pypi.org/project/coconut) (📥 1.7K / month):
	...
	pip install coconut
	```
- [Conda](https://anaconda.org/conda-forge/coconut) (📥 190K · ⏱️ 29.07.2023):
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 150 · 🔀 270 · 📦 23K · 📋 490 - 18% open · ⏱️ 31.07.2023):
...
- [PyPi](https://pypi.org/project/pyglet) (📥 220K / month):
	...
	pip install pyglet
	```
- [Conda](https://anaconda.org/conda-forge/pyglet) (📥 550K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.7K · 📦 9.2K · 📋 3.4K - 21% open · ⏱️ 31.07.2023):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 300K / month):
	```
...
<details><summary><b><a href="https://github.com/python-eel/Eel">Eel</a></b> (🥈27 ·  ⭐ 5.7K) - A library for making simple Electron-like offline HTML/JS GUI apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 46 · 🔀 540 · 📦 5.8K · 📋 510 - 33% open · ⏱️ 04.03.2023):
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 910 · 📥 470 · 📦 790 · 📋 580 - 21% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 5K / month):
	```
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 70K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 470 · 📦 1.3K · 📋 800 - 2% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 130 · 📋 450 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 510 / month):
	```
	pip install flexx
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 240 · 🔀 600 · 📥 1.7K · 📋 700 - 16% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 680 · 📦 220 · 📋 230 - 17% open · ⏱️ 24.05.2023):
...
- [PyPi](https://pypi.org/project/xmltodict) (📥 30M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xmltodict) (📥 3.1M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 740 · 🔀 8.7K · 📥 6.2K · 📦 2.3M · 📋 3.8K - 5% open · ⏱️ 30.07.2023):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 200 · 🔀 690 · 📦 100K · 📋 780 - 2% open · ⏱️ 02.08.2023):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 19M / month):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 700K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 330 · 🔀 1K · 📥 14K · 📦 1.4M · 📋 1.2K - 9% open · ⏱️ 29.07.2023):

	```
	git clone https://github.com/shazow/urllib3
	```
- [PyPi](https://pypi.org/project/urllib3) (📥 360M / month):
	```
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 37M · ⏱️ 19.07.2023):
	```
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 300 · 📥 3 · 📦 3.9K · 📋 120 - 4% open · ⏱️ 08.06.2023):
...
- [PyPi](https://pypi.org/project/grequests) (📥 270K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 80K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 430 · 🔀 1.8K · 📦 12K · 📋 1.5K - 4% open · ⏱️ 03.08.2023):
...
- [PyPi](https://pypi.org/project/scapy) (📥 2.2M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 91K · ⏱️ 16.06.2023):
	```
...
<details><summary><b><a href="https://github.com/boppreh/mouse">mouse</a></b> (🥉23 ·  ⭐ 780) - Hook and simulate global mouse events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 9 · 🔀 120 · 📦 1.1K · 📋 110 - 73% open · ⏱️ 26.06.2023):
...
- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 520 · 📋 64 - 51% open · ⏱️ 20.03.2017):
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 440 · 🔀 1.9K · 📦 1.3M · 📋 2.8K - 2% open · ⏱️ 03.08.2023):

	```
	git clone https://github.com/python-pillow/Pillow
	```
- [PyPi](https://pypi.org/project/Pillow) (📥 59M / month):
	```
	pip install Pillow
	```
...
<details><summary><b><a href="https://github.com/thumbor/thumbor">thumbor</a></b> (🥇29 ·  ⭐ 9.6K) - A smart imaging service. It enables on-demand crop, re-sizing and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 20K · 📦 17K · 📋 400 - 4% open · ⏱️ 16.06.2023):
...
- [PyPi](https://pypi.org/project/wand) (📥 750K / month):
	...
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 27K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 47 · 🔀 110 · 📥 290 · 📦 17K · 📋 100 - 39% open · ⏱️ 25.07.2023):

	```
	git clone https://github.com/WhyNotHugo/python-barcode
	```
- [PyPi](https://pypi.org/project/python-barcode) (📥 270K / month):
	```
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 280 · 📥 1K · 📦 250 · 📋 530 - 24% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/dylanaraps/pywal
	```
- [PyPi](https://pypi.org/project/pywal) (📥 2.3K / month):
	```
	pip install pywal
	```
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 56 · 🔀 570 · 📋 220 - 26% open · ⏱️ 05.02.2023):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 95 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 580 · 🔀 4.9K · 📥 64K · 📋 4.9K - 27% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 34 · 🔀 250 · 📥 69K · 📋 580 - 45% open · ⏱️ 29.07.2023):
...
<details><summary><b><a href="https://github.com/python/cpython">CPython</a></b> (🥈22 ·  ⭐ 55K) - **Default, most widely used implementation of the Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/cpython) (👨‍💻 2.6K · 🔀 26K · 📋 64K - 10% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 69 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 720 / month):
	```
	pip install Pyjion
	```
- [Conda](https://anaconda.org/conda-forge/Pyjion) (📥 620 · ⏱️ 18.06.2023):
	```
	conda install -c conda-forge Pyjion
	```
</details>
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉11 ·  ⭐ 940 · 💀) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 61 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 29 / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 53 · 🔀 260 · 📦 2.6K · 📋 370 - 58% open · ⏱️ 12.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 310K / month):
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 190 · 🔀 1.3K · 📦 3.5K · 📋 4K - 12% open · ⏱️ 02.08.2023):
...
- [PyPi](https://pypi.org/project/prefect) (📥 670K / month):
	...
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 490K · ⏱️ 27.07.2023):
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 58 · 🔀 850 · 📦 27K · 📋 410 - 32% open · ⏱️ 11.04.2023):
...
- [PyPi](https://pypi.org/project/schedule) (📥 2.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 38K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 51 · 🔀 280 · 📦 62 · 📋 120 - 2% open · ⏱️ 27.07.2023):
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 90 · 📦 81 · 📋 9 - 11% open · ⏱️ 14.05.2020):

	```
	git clone https://github.com/fengsp/plan
	```
- [PyPi](https://pypi.org/project/plan) (📥 720 / month):
	```
	pip install plan
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 45 · 🔀 620 · 📦 59K · 📋 800 - 13% open · ⏱️ 30.07.2023):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 6.8M / month):
	```
	pip install loguru
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 180 · 🔀 380 · 📥 3.2K · 📦 47K · 📋 960 - 16% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 620 · 🔀 8.1K · 📥 6.9K · 📦 63K · 📋 4.9K - 6% open · ⏱️ 03.08.2023):
...
- [PyPi](https://pypi.org/project/xgboost) (📥 10M / month):
	...
	pip install xgboost
	```
- [Conda](https://anaconda.org/conda-forge/xgboost) (📥 4.1M · ⏱️ 02.08.2023):
	```
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 740 · 🔀 2.2K · 📋 3.1K - 17% open · ⏱️ 03.08.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 8.8K / month):
	```
	pip install mindsdb
	```
...
<details><summary><b><a href="https://github.com/h2oai/h2o-3">H2O</a></b> (🥉20 ·  ⭐ 6.4K) - Open Source Fast Scalable Machine Learning Platform. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · 📋 9K - 29% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 10K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 90 · 🔀 750 · 📥 630K · 📦 140K · 📋 1.8K - 26% open · ⏱️ 24.07.2023):
...
- [PyPi](https://pypi.org/project/pywin32) (📥 5.2M / month):
	...
	pip install pywin32
	```
- [Conda](https://anaconda.org/conda-forge/pywin32) (📥 4.1M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 100 · 🔀 560 · 📥 2.4K · 📦 1.6K · 📋 1.3K - 8% open · ⏱️ 21.07.2023):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 78K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 210 · 📦 890K · 📋 110 - 0% open · ⏱️ 01.08.2023):
...
- [PyPi](https://pypi.org/project/itsdangerous) (📥 49M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 5.9M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 18 · 🔀 170 · 📦 190K · 📋 43 - 2% open · ⏱️ 01.08.2023):
...
- [PyPi](https://pypi.org/project/blinker) (📥 23M / month):
	...
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 9.5M · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge blinker
	```
</details>
<details><summary><b><a href="https://github.com/mahmoud/boltons">boltons</a></b> (🥉29 ·  ⭐ 6.2K) - A set of pure-Python utilities. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 85 · 🔀 340 · 📥 25 · 📦 4.9K · 📋 150 - 33% open · ⏱️ 06.05.2023):
...
- [PyPi](https://pypi.org/project/boltons) (📥 3.2M / month):
	...
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 2.8M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1.9K · 📋 14 - 14% open · ⏱️ 16.05.2021):
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 450 · 🔀 4.1K · 📥 4.4K · 📦 49K · 📋 1.8K - 20% open · ⏱️ 25.05.2023):
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 49 · 🔀 6.4K · 📦 23K · 📋 830 - 73% open · ⏱️ 15.02.2020):
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 84 · 📦 1.6K · 📋 200 - 62% open · ⏱️ 25.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/pattern) (📥 740K / month):
	```
	pip install pattern
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 58 · 🔀 830 · 📦 2K · 📋 800 - 11% open · ⏱️ 14.03.2023):
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.2K · 📋 100 - 38% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 5.1K / month):
	```
	pip install snownlp
	```
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 290 · 📦 6.6K · 📋 71 - 35% open · ⏱️ 15.07.2017):
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉17 ·  ⭐ 53K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 12 · 🔀 12K · 📋 61 - 22% open · ⏱️ 03.06.2023):
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 530K · 📦 240 · 📋 690 - 37% open · ⏱️ 06.07.2023):

	```
	git clone https://github.com/mininet/mininet
	```
- [PyPi](https://pypi.org/project/mininet) (📥 2.5K / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 440 · 📋 190 - 14% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 6.1M / month):
	```
	pip install pox
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 23K · ⏱️ 28.07.2023):
...
- [PyPi](https://pypi.org/project/peewee) (📥 1.1M / month):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 540K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 410 · 📦 1.5K · 📋 570 - 36% open · ⏱️ 18.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/PynamoDB) (📥 3.1M / month):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 77 · 🔀 290 · 📦 3.2K · 📋 290 - 9% open · ⏱️ 12.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/dataset) (📥 69K / month):
	```
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 6.5K · ⏱️ 12.07.2023):
	```
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 32 · 🔀 160 · 📦 560 · 📋 320 - 42% open · ⏱️ 13.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/orator) (📥 20K / month):
	```
	pip install orator
	```
...
- [GitHub](https://github.com/web2py/pydal) (🔀 130 · 📦 420 · 📋 310 - 45% open · ⏱️ 22.05.2023):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 29 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 1.7K / month):
	```
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 80 · 📋 51 - 68% open · ⏱️ 06.06.2016):
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 190 · 🔀 500 · 📦 22K · 📋 980 - 13% open · ⏱️ 03.08.2023):
...
- [PyPi](https://pypi.org/project/pip-tools) (📥 9.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 110K · ⏱️ 03.08.2023):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 470 · 🔀 2K · 📥 15M · 📋 5.1K - 10% open · ⏱️ 03.08.2023):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 17M / month):
	```
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 950K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.3K · 📦 42K · 📋 9.1K - 7% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 93 · 🔀 120 · 📦 240 · 📋 760 - 10% open · ⏱️ 24.07.2023):
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 360 · 🔀 830 · 📋 3K - 13% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 5 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 66 / month):
	```
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 120 · 📋 240 - 16% open · ⏱️ 03.08.2023):
...
<details><summary><b><a href="https://github.com/sqlmapproject/sqlmap">sqlmap</a></b> (🥇23 ·  ⭐ 28K) - Automatic SQL injection and database takeover tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 130 · 🔀 5.1K · 📋 5K - 1% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 9.9K / month):
	```
	pip install sqlmap
	```
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉20 ·  ⭐ 9.3K · 💤) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.8K · 📋 130 - 29% open · ⏱️ 06.09.2022):

	```
	git clone https://github.com/Manisso/fsociety
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 1.5K / month):
	```
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉17 ·  ⭐ 9.2K · 💀) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/trustedsec/social-engineer-toolkit) (👨‍💻 85 · 🔀 2.4K · 📋 870 - 29% open · ⏱️ 26.01.2022):
...
<details><summary><b><a href="https://github.com/django-guardian/django-guardian">django-guardian</a></b> (🥇24 ·  ⭐ 3.4K · 💀) - Implementation of per object permissions for Django.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 530 · 📦 6.1K · 📋 450 - 27% open · ⏱️ 25.03.2022):
...
<details><summary><b><a href="https://github.com/amoffat/sh">sh</a></b> (🥇31 ·  ⭐ 6.7K) - A full-fledged subprocess replacement for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/amoffat/sh) (👨‍💻 95 · 🔀 480 · 📦 13K · 📋 460 - 2% open · ⏱️ 12.07.2023):
...
- [PyPi](https://pypi.org/project/sh) (📥 4.3M / month):
	...
	pip install sh
	```
- [Conda](https://anaconda.org/conda-forge/sh) (📥 180K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/amitt001/delegator.py) (👨‍💻 23 · 🔀 90 · 📦 510 · 📋 45 - 17% open · ⏱️ 06.05.2019):

	```
	git clone https://github.com/amitt001/delegator.py
	```
- [PyPi](https://pypi.org/project/delegator.py) (📥 35K / month):
	```
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 47 · 🔀 660 · 📦 1.2K · 📋 490 - 27% open · ⏱️ 30.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/lightfm) (📥 480K / month):
	```
	pip install lightfm
	```
...
<details><summary><b><a href="https://github.com/NicolasHug/Surprise">Surprise</a></b> (🥉19 ·  ⭐ 5.9K · 💤) - A scikit for building and analyzing recommender systems. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 31 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 350 / month):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 77 · 🔀 140 · 📦 66K · 📋 300 - 24% open · ⏱️ 29.06.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 760K / month):
	```
	pip install rope
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥇39 ·  ⭐ 61K · 📈) - A modern, fast, web framework for building APIs with Python 3.6+ based.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 480 · 🔀 5K · 📦 210K · 📋 3.3K - 0% open · ⏱️ 03.08.2023):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 19M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 1.6M · ⏱️ 27.07.2023):
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 900 · 📥 5K · 📦 8.3K · 📋 980 - 15% open · ⏱️ 18.07.2023):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 570K / month):
	```
	pip install falcon
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 990 · 📦 95K · 📋 550 - 17% open · ⏱️ 21.05.2023):
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 2.4K · 📋 460 - 35% open · ⏱️ 30.06.2023):
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 34 · 🔀 180 · 📦 5.9K · 📋 66 - 19% open · ⏱️ 02.08.2023):

	```
	git clone https://github.com/flask-api/flask-api
	```
- [PyPi](https://pypi.org/project/flask-api) (📥 98K / month):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.6K · 📋 330 - 4% open · ⏱️ 01.08.2023):
...
- [PyPi](https://pypi.org/project/zerorpc-python):
	...
	```
- [Conda](https://anaconda.org/conda-forge/zerorpc-python) (📥 2.5K · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.9K · 📥 510K · 📦 74K · 📋 13K - 33% open · ⏱️ 02.08.2023):
...
- [PyPi](https://pypi.org/project/sympy) (📥 9.2M / month):
	...
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 3.9M · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge sympy
	```
</details>
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">statsmodels</a></b> (🥈35 ·  ⭐ 8.7K) - Statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 410 · 🔀 2.6K · 📥 29 · 📦 99K · 📋 5.2K - 48% open · ⏱️ 30.06.2023):
...
- [PyPi](https://pypi.org/project/zipline) (📥 3.8K / month):
	...
	pip install zipline
	```
- [Conda](https://anaconda.org/conda-forge/zipline) (📥 7.2K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 460 · 🔀 1.7K · 📥 1.9K · 📦 1.8K · 📋 3.1K - 5% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 180 · 📋 110 - 2% open · ⏱️ 01.07.2023):

	```
	git clone https://github.com/benedekrozemberczki/karateclub
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 6K / month):
	```
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 97 · 🔀 350 · 📋 3K - 3% open · ⏱️ 20.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 520 / month):
	```
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 9.1K · 📋 1.2K - 36% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 68 · 🔀 310 · 📦 3.1K · 📋 150 - 16% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 770 · 📥 200 · 📦 9.3K · 📋 1.3K - 10% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 210 · 🔀 600 · 📦 90K · 📋 1.2K - 11% open · ⏱️ 31.07.2023):
...
- [PyPi](https://pypi.org/project/marshmallow) (📥 24M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 1.9M · ⏱️ 21.07.2023):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 22 · 🔀 42 · 📦 4.3K · 📋 100 - 11% open · ⏱️ 16.06.2023):
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 49 · 📦 1.1K · 📋 82 - 13% open · ⏱️ 12.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 330K / month):
	```
	pip install pysimdjson
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 74K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📥 320 · 📋 1.3K - 47% open · ⏱️ 20.02.2021):
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 590 · 📥 9K · 📋 2.4K - 10% open · ⏱️ 01.08.2023):
...
- [PyPi](https://pypi.org/project/mistune) (📥 16M / month):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 14M · ⏱️ 09.06.2023):
	```
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 550 · 📦 66K · 📋 240 - 11% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 600 · 📦 64K · 📋 880 - 1% open · ⏱️ 15.06.2023):
...
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/XlsxWriter) (📥 2.8M · ⏱️ 16.06.2023):
	```
	conda install -c conda-forge XlsxWriter
	```
</details>
<details><summary><b><a href="https://github.com/py-pdf/pypdf">PyPDF2</a></b> (🥈30 ·  ⭐ 6K) - A library capable of splitting, merging and transforming PDF pages. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 190 · 🔀 1.1K · 📦 7.5K · 📋 830 - 5% open · ⏱️ 02.08.2023):
...
- [PyPi](https://pypi.org/project/csvkit) (📥 170K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 94K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/euske/pdfminer) (👨‍💻 28 · 🔀 1K · 📦 4.2K · 📋 240 - 82% open · ⏱️ 18.01.2020):
...
- [PyPi](https://pypi.org/project/pdfminer) (📥 190K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pdfminer) (📥 32K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 62 · 🔀 460 · 📥 21K · 📦 29K · 📋 1.8K - 15% open · ⏱️ 27.07.2023):
...
- [PyPi](https://pypi.org/project/xlwings) (📥 96K / month):
	...
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 640K · ⏱️ 25.06.2023):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 170 · 🔀 800 · 📦 290K · 📋 830 - 3% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 370 · 📦 130 · 📋 480 - 17% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 16K / month):
	```
	pip install unoconv
	```
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 880 · 📋 1K - 50% open · ⏱️ 15.05.2021):
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 840 · 📦 7.2K · 📋 1.6K - 2% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 240 · 🔀 360 · 📥 7 · 📦 490 · 📋 2.1K - 2% open · ⏱️ 26.07.2023):
...
- [PyPi](https://pypi.org/project/nikola) (📥 1.4K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 9.3K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.2K · 📦 47K · 📋 1.8K - 5% open · ⏱️ 02.08.2023):
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 94 · 🔀 300 · 📥 7.1K · 📦 420 · 📋 640 - 34% open · ⏱️ 01.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/lektor) (📥 6.3K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/sunainapai/makesite) (👨‍💻 8 · 🔀 280 · 📋 15 - 40% open · ⏱️ 12.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/makesite) (📥 270 / month):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 300 · 🔀 1.3K · 📦 14K · 📋 1.1K - 13% open · ⏱️ 21.07.2023):
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 360 · 📦 1.2K · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 93 · 🔀 250 · 📥 40 · 📦 950 · 📋 330 - 10% open · ⏱️ 20.07.2023):
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇22 ·  ⭐ 9.4K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 55K · 📋 970 - 5% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 530 · 🔀 1.7K · 📦 160K · 📋 650 - 2% open · ⏱️ 20.07.2023):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 8.7M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 830K · ⏱️ 21.07.2023):
	```
	conda install -c conda-forge faker
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇36 ·  ⭐ 8.2K) - A generic test automation framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 190 · 🔀 2.1K · 📥 550 · 📦 8.1K · 📋 4.2K - 6% open · ⏱️ 28.07.2023):
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 290 · 🔀 2.7K · 📦 6.3K · 📋 1.5K - 0% open · ⏱️ 31.07.2023):
...
- [PyPi](https://pypi.org/project/locust) (📥 1.1M / month):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 130K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 310 · 🔀 540 · 📦 22K · 📋 1.4K - 3% open · ⏱️ 20.07.2023):
...
- [PyPi](https://pypi.org/project/hypothesis) (📥 5.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 8M · ⏱️ 20.07.2023):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 310 · 📥 160 · 📦 27K · 📋 280 - 1% open · ⏱️ 01.08.2023):
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 130 · 🔀 320 · 📦 7.8K · 📋 360 - 23% open · ⏱️ 01.08.2023):
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈31 ·  ⭐ 8.4K) - PyAutoGUI is a cross-platform GUI automation Python module for human.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.4K · 📋 520 - 9% open · ⏱️ 07.07.2023):

	```
	git clone https://github.com/cobrateam/splinter
	```
- [PyPi](https://pypi.org/project/splinter) (📥 79K / month):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 120 · 🔀 310 · 📥 450 · 📦 1.4K · 📋 320 - 1% open · ⏱️ 24.07.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 120K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 140K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 56 · 🔀 120 · 📦 250 · 📋 730 - 17% open · ⏱️ 25.07.2023):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 90K / month):
	```
	pip install schemathesis
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 8.3K · ⏱️ 03.06.2023):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 130 · 🔀 360 · 📋 550 - 29% open · ⏱️ 02.08.2023):
...
- [PyPi](https://pypi.org/project/httmock) (📥 340K / month):
	...
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 8.7K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 11 · 📋 200 - 34% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 120 / month):
	```
	pip install sixpack
	```
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 57 · 🔀 250 · 📥 8.2K · 📦 830K · 📋 310 - 9% open · ⏱️ 30.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyparsing) (📥 81M / month):
	```
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 620 · 📦 820K · 📋 510 - 43% open · ⏱️ 24.07.2023):
...
- [PyPi](https://pypi.org/project/sqlparse) (📥 34M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 1.8M · ⏱️ 16.06.2023):
	```
...
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 5.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/fuzzywuzzy) (📥 490K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 910 · 📦 4.6K · ⏱️ 18.09.2022):
...
- [PyPi](https://pypi.org/project/textdistance) (📥 330K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 430K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 25 · 🔀 110 · 📦 31K · 📋 51 - 31% open · ⏱️ 14.04.2023):

	```
	git clone https://github.com/pwaller/pyfiglet
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 960K / month):
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 48 · 🔀 240 · 📋 130 - 36% open · ⏱️ 01.08.2023):
...
- [PyPi](https://pypi.org/project/ply) (📥 26M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 6.9M · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 32 · 🔀 190 · 📦 6.5K · 📋 74 - 55% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 47 · 📦 2.2K · 📋 18 - 55% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 38K / month):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 580 · 📋 240 - 9% open · ⏱️ 14.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 37 / month):
	```
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 28 · 🔀 380 · 📋 170 - 2% open · ⏱️ 30.07.2023):
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 23 · 📦 170 · 📋 9 - 44% open · ⏱️ 30.03.2023):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.7K · 📦 340K · 📋 3K - 5% open · ⏱️ 02.08.2023):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 750M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 17M · ⏱️ 01.08.2023):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 190 · 🔀 2.3K · 📦 160K · 📋 1K - 9% open · ⏱️ 27.07.2023):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 48M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 2.3M · ⏱️ 25.07.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 880 · 📥 1.1K · 📦 25K · 📋 820 - 5% open · ⏱️ 16.07.2023):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 6.8M / month):
	```
	pip install gspread
	```
...
<details><summary><b><a href="https://github.com/ryanmcgrath/twython">twython</a></b> (🥉29 ·  ⭐ 1.9K · 💀) - A Python wrapper for the Twitter API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 68 · 🔀 160 · 📦 6.8K · 📋 290 - 2% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 64 · 📦 9.2K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 49K / month):
	```
...
- [PyPi](https://pypi.org/project/furl) (📥 1.6M / month):
	...
	pip install furl
	```
- [Conda](https://anaconda.org/conda-forge/furl) (📥 280K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 220 · 📥 900 · 📦 430 · 📋 260 - 1% open · ⏱️ 22.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 9.3K / month):
	```
	pip install vidgear
	```
...
- [PyPi](https://pypi.org/project/webassets) (📥 230K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/webassets) (📥 58K · ⏱️ 16.06.2023):
	```
...
- [PyPi](https://pypi.org/project/flask-assets) (📥 160K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-assets) (📥 41K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 250 · 🔀 770 · 📋 640 - 26% open · ⏱️ 02.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-storages) (📥 2.4M / month):
	```
...
- [PyPi](https://pypi.org/project/requests-html) (📥 700K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 7.9K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 26 · 🔀 500 · 📦 2.1K · 📋 110 - 15% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/sumy) (📥 24K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 6.1K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 88 · 📦 2.7K · ⏱️ 19.06.2023):
	...
	```
- [PyPi](https://pypi.org/project/micawber) (📥 25K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 11K · ⏱️ 10.07.2023):
	```
...
- [GitHub](https://github.com/codelucas/newspaper) (👨‍💻 100 · 🔀 2K · 📋 660 - 60% open · ⏱️ 02.09.2020):

	```
	git clone https://github.com/codelucas/newspaper
	```
- [PyPi](https://pypi.org/project/newspaper) (📥 8.5K / month):
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 230 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 89 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 54 · 🔀 360 · 📥 43 · 📋 170 - 16% open · ⏱️ 04.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 34K / month):
	```
...
<details><summary><b><a href="https://github.com/scrapinghub/portia">portia</a></b> (🥉20 ·  ⭐ 9K · 💀) - Visual scraping for Scrapy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/websockets) (📥 16M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 2.1M · ⏱️ 16.06.2023):
	```
...
<details><summary><b><a href="https://github.com/django/channels">channels</a></b> (🥉22 ·  ⭐ 5.7K · 📉) - Developer-friendly asynchrony for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 760 · 📋 1.2K - 6% open · ⏱️ 14.06.2023):
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 410 · 🔀 1.6K · 📥 100 · 📦 990K · 📋 2K - 13% open · ⏱️ 19.07.2023):
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 480 · 🔀 1.7K · 📥 500 · 📦 1.1M · 📋 1.1K - 0% open · ⏱️ 01.08.2023):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 98M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 8.5M · ⏱️ 09.06.2023):
	```
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 51 · 🔀 150 · 📦 140K · 📋 220 - 8% open · ⏱️ 06.04.2023):
