...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 790 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 420 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 40 · 📋 210 - 24% open · ⏱️ 11.12.2022):

	```
	git clone https://github.com/wooey/wooey
	```
- [PyPi](https://pypi.org/project/wooey) (📥 120 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 18 - 33% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 970 · 🔀 37K · 📋 1.2K - 0% open · ⏱️ 15.12.2022):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 74M · ⏱️ 22.11.2022):
	```
...
- [PyPi](https://pypi.org/project/transitions) (📥 340K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 300K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 190 · 🔀 4.1K · 📦 78 · 📋 160 - 37% open · ⏱️ 12.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 11K / month):
	```
...
<details><summary><b><a href="https://github.com/prabhupant/python-ds">python-ds</a></b> (🥉17 ·  ⭐ 1.9K) - A collection of data structure and algorithms for coding interviews. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 130 · 🔀 6.3K · 📋 80 - 11% open · ⏱️ 08.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-patterns) (📥 31 / month):
	```
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇36 ·  ⭐ 5.9K · 📈) - A lightning-fast ASGI server implementation, using uvloop and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 150 · 🔀 500 · 📦 120K · 📋 620 - 3% open · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 63 · 🔀 220 · 📋 290 - 10% open · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 55 · 🔀 450 · 📥 350 · 📦 58K · 📋 300 - 16% open · ⏱️ 14.09.2022):

	```
	git clone https://github.com/MagicStack/uvloop
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 9.7M / month):
	```
	pip install uvloop
	```
...
- [PyPi](https://pypi.org/project/trio) (📥 5.9M / month):
	...
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 920K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 870 · 📦 16K · 📋 500 - 48% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 4M / month):
	```
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 35K · ⏱️ 13.03.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 7.9K · 📦 270 · 📋 2.5K - 18% open · ⏱️ 30.11.2022):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 1.8K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 26 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 39 · 🔀 130 · 📥 57K · 📦 8.9K · 📋 480 - 20% open · ⏱️ 26.10.2022):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 1.1M / month):
	```
	pip install mutagen
	```
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉22 ·  ⭐ 5.5K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 830 · 📋 1K - 4% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 25 · 🔀 90 · 📦 630 · 📋 97 - 15% open · ⏱️ 04.11.2022):
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 100 · 📦 12 · 📋 38 - 31% open · ⏱️ 03.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/matchering) (📥 640 / month):
	```
...
- [GitHub](https://github.com/Parisson/TimeSide) (👨‍💻 22 · 🔀 59 · 📦 16 · 📋 210 - 27% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 69 / month):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 580 · 📦 290K · 📋 380 - 3% open · ⏱️ 10.12.2022):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 100M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 8.9M · ⏱️ 20.10.2022):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 610 · 🔀 2.6K · 📦 120K · 📋 1.9K - 14% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/django-allauth) (📥 590K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 83K · ⏱️ 07.06.2022):
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 9.8K · 📋 130 - 38% open · ⏱️ 12.02.2018):
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 680 · 📋 740 - 20% open · ⏱️ 12.12.2022):
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 16K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 30K · ⏱️ 04.11.2022):
	```
	conda install -c conda-forge pybuilder
	```
</details>
<details><summary><b><a href="https://github.com/platformio/platformio-core">PlatformIO</a></b> (🥉20 ·  ⭐ 6.4K) - A console tool to build code with different development platforms. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 680 · 📋 3.8K - 4% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 310 · 📦 550K · 📋 600 - 16% open · ⏱️ 07.12.2022):
...
- [PyPi](https://pypi.org/project/attrs) (📥 130M / month):
	...
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 23M · ⏱️ 31.07.2022):
	```
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 50 · 📦 10K · 📋 53 - 5% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/bidict) (📥 980K / month):
	```
	pip install bidict
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 87 · 📥 30 · 📋 140 - 14% open · ⏱️ 29.10.2022):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 130 · 🔀 340 · 📥 2.9K · 📋 3.3K - 18% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 220 · 📋 440 - 5% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 6K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/errbotio/errbot) (🔀 580 · 📦 270 · 📋 750 - 8% open · ⏱️ 02.12.2022):
...
<details><summary><b><a href="https://github.com/psf/black">black</a></b> (🥇35 ·  ⭐ 30K) - The uncompromising Python code formatter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/psf/black) (👨‍💻 350 · 🔀 1.8K · 📥 26K · 📦 220K · 📋 2.1K - 16% open · ⏱️ 15.12.2022):
...
- [PyPi](https://pypi.org/project/black) (📥 17M / month):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 5.7M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 270 · 🔀 490 · 📦 290K · 📋 1.2K - 10% open · ⏱️ 15.12.2022):
...
- [PyPi](https://pypi.org/project/isort) (📥 26M / month):
	...
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 4M · ⏱️ 13.12.2022):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 350 · 📦 9.3K · 📋 1K - 8% open · ⏱️ 28.11.2022):
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 84 · 🔀 150 · 📦 3.5K · 📋 340 - 13% open · ⏱️ 13.12.2022):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 230 · 🔀 380 · 📋 330 - 30% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 220K / month):
	```
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 270 · 📦 370 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 20K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 9 · 🔀 230 · 📦 13 · 📋 48 - 12% open · ⏱️ 25.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 2.4K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 87 · 🔀 240 · 📋 570 - 18% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/pytype) (📥 440K / month):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 140K · ⏱️ 10.12.2022):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 56 · 📦 89 · 📋 59 - 44% open · ⏱️ 12.10.2021):

	```
	git clone https://github.com/dropbox/pyannotate
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 5.6K / month):
	```
...
<details><summary><b><a href="https://github.com/Instagram/MonkeyType">MonkeyType</a></b> (🥉16 ·  ⭐ 4.1K) - A system for Python that generates static type annotations.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 43 · 🔀 150 · 📋 160 - 21% open · ⏱️ 08.12.2022):
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.2K · 🔀 1.4K · 📋 2K - 7% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 200 · 🔀 1.4K · 📦 43K · 📋 980 - 6% open · ⏱️ 04.12.2022):
...
- [PyPi](https://pypi.org/project/rich) (📥 18M / month):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 2.5M · ⏱️ 02.10.2022):
	```
...
<details><summary><b><a href="https://github.com/google/python-fire">python-fire</a></b> (🥈27 ·  ⭐ 23K) - A library for creating command line interfaces from.. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/alive-progress) (📥 130K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 23K · ⏱️ 13.11.2022):
	```
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 4.5K / month):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 150 · 🔀 3.5K · 📥 1.9K · 📦 12K · 📋 790 - 14% open · ⏱️ 01.10.2022):
...
- [PyPi](https://pypi.org/project/httpie) (📥 180K / month):
	...
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 91K · ⏱️ 01.11.2022):
	```
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 510K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 70 · 🔀 220 · 📦 220 · 📋 330 - 23% open · ⏱️ 12.12.2022):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 4K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 480 · 📦 670 · 📋 650 - 22% open · ⏱️ 22.11.2022):
...
- [PyPi](https://pypi.org/project/mycli) (📥 38K / month):
	...
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 47K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 82 · 🔀 830 · 📦 440 · 📋 250 - 3% open · ⏱️ 05.12.2022):

	```
	git clone https://github.com/gleitz/howdoi
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 9.9K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 89 · 📥 11K · 📦 13 · 📋 200 - 25% open · ⏱️ 14.09.2022):
...
- [PyPi](https://pypi.org/project/iredis) (📥 1.3K / month):
	...
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 440 · ⏱️ 10.08.2022):
	```
	conda install -c conda-forge iredis
	```
</details>
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥉24 ·  ⭐ 790) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 45 · 🔀 99 · 📦 130 · 📋 300 - 13% open · ⏱️ 30.11.2022):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 24K / month):
	```
	pip install copier
	```
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 280 · 📦 38 · 📋 93 - 33% open · ⏱️ 15.01.2022):
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 94 · 📦 18 · 📋 48 - 25% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.3K · 📥 2.9M · 📦 1.9K · 📋 690 - 20% open · ⏱️ 18.11.2022):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 160K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 1.5K · ⏱️ 19.10.2022):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 27 · 🔀 230 · 📦 750 · 📋 250 - 30% open · ⏱️ 26.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 55K / month):
	```
	pip install tesserocr
	```
- [Conda](https://anaconda.org/conda-forge/tesserocr) (📥 96K · ⏱️ 06.11.2022):
	```
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 12K · 📥 490 · 📋 1.2K - 54% open · ⏱️ 10.06.2022):
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 41 · 🔀 620 · 📋 320 - 6% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/kornia/kornia) (🔀 740 · 📥 480 · 📋 670 - 28% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 85 · 📦 280 · 📋 73 - 43% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 32 · 🔀 160 · 📥 10 · 📦 83K · 📋 82 - 12% open · ⏱️ 11.05.2022):
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 22 · 🔀 68 · 📦 22K · 📋 140 - 48% open · ⏱️ 14.10.2020):
...
- [PyPi](https://pypi.org/project/configobj) (📥 3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 510K · ⏱️ 29.07.2018):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 100 · 🔀 480 · 📦 10 · 📋 1.2K - 14% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 33K / month):
	```
	pip install hydra
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 66K · 📋 1.4K - 51% open · ⏱️ 04.11.2022):
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 8.9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 6.6K / month):
	```
	pip install blaze
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 540 · 📥 170K · 📦 690 · 📋 810 - 3% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 14 · 📋 180 - 36% open · ⏱️ 02.12.2016):

	```
	git clone https://github.com/mining/mining
	```
- [PyPi](https://pypi.org/project/mining) (📥 30 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 520 · 📦 270K · 📋 700 - 5% open · ⏱️ 14.12.2022):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 59M / month):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 62 · 🔀 220 · 📦 12K · 📋 330 - 11% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 3.6M / month):
	```
...
- [PyPi](https://pypi.org/project/schema) (📥 4.2M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 73K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 89 · 🔀 200 · 📦 6K · 📋 240 - 17% open · ⏱️ 23.10.2022):
...
- [PyPi](https://pypi.org/project/voluptuous) (📥 2.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/voluptuous) (📥 230K · ⏱️ 07.04.2022):
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 7 · 🔀 23 · 📦 62 · 📋 15 - 26% open · ⏱️ 07.03.2018):
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 670 · 📦 40K · 📋 1.7K - 13% open · ⏱️ 11.12.2022):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 8.9M / month):
	```
	pip install altair
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 120 · 🔀 1.6K · 📦 690 · 📋 400 - 56% open · ⏱️ 27.11.2022):
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 180 · 🔀 1.6K · 📥 240 · 📋 2.2K - 4% open · ⏱️ 10.12.2022):

	```
	git clone https://github.com/mwaskom/seaborn
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 8.4M / month):
	```
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 5.4M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 620 · 🔀 3.9K · 📦 180 · 📋 7.1K - 9% open · ⏱️ 12.12.2022):
...
- [PyPi](https://pypi.org/project/bokeh) (📥 3.6M / month):
	...
	pip install bokeh
	```
- [Conda](https://anaconda.org/conda-forge/bokeh) (📥 9.5M · ⏱️ 12.12.2022):
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 2.8K · 📋 1.1K - 26% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 590 · 📦 930 · 📋 1.3K - 21% open · ⏱️ 14.11.2022):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 48K / month):
	```
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 320K · ⏱️ 14.11.2022):
	```
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 79 · 📦 930 · 📋 150 - 38% open · ⏱️ 09.11.2022):
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 120 · 📦 1K · 📋 57 - 28% open · ⏱️ 15.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/pickledb) (📥 41K / month):
	```
...
- [PyPi](https://pypi.org/project/kafka-python) (📥 7.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/kafka-python) (📥 360K · ⏱️ 30.09.2020):
	```
	conda install -c conda-forge kafka-python
	```
</details>
<details><summary><b><a href="https://github.com/mongodb/motor">motor</a></b> (🥇34 ·  ⭐ 2.1K) - The async Python driver for MongoDB. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/mongodb/motor) (👨‍💻 41 · 🔀 180 · 📦 43K · ⏱️ 13.12.2022):

	```
	git clone https://github.com/mongodb/motor
	```
- [PyPi](https://pypi.org/project/motor) (📥 3.5M / month):
	```
	pip install motor
	```
...
- [PyPi](https://pypi.org/project/PyMySQL) (📥 34M / month):
	...
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 910K · ⏱️ 09.01.2021):
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 360 · 🔀 2.2K · 📋 1.3K - 9% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 850K · ⏱️ 05.12.2022):
	```
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 180 · 🔀 440 · 📦 4.5K · ⏱️ 03.09.2022):

	```
	git clone https://github.com/datastax/python-driver
	```
- [PyPi](https://pypi.org/project/python-driver) (📥 13 / month):
	```
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 48 · 🔀 180 · 📦 820 · 📋 260 - 10% open · ⏱️ 29.11.2022):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 150 · 📦 690 · 📋 210 - 11% open · ⏱️ 12.07.2022):
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 12 · 🔀 32 · 📦 120 · 📋 18 - 22% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 4.9K / month):
	```
	pip install queries
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 160 / month):
	```
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 87 · 🔀 300 · 📥 27 · 📦 14K · 📋 450 - 42% open · ⏱️ 24.11.2022):
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 48 · 🔀 190 · 📦 1K · 📋 90 - 17% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/maya) (📥 50K / month):
	```
	pip install maya
	```
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 41 · 📦 730 · 📋 40 - 7% open · ⏱️ 27.11.2020):

	```
	git clone https://github.com/zachwill/moment
	```
- [PyPi](https://pypi.org/project/moment) (📥 65K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 130 · 📦 850 · 📋 63 - 41% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 22 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 410 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 18 · 📦 31 · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 560 / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 260 · 🔀 860 · 📥 180 · 📦 59K · 📋 820 - 9% open · ⏱️ 09.12.2022):
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇30 ·  ⭐ 9.4K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 54 · 🔀 140 · 📦 36K · 📋 180 - 31% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/gotcha/ipdb
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 2.6M / month):
	```
	pip install ipdb
	```
...
- [GitHub](https://github.com/pallets-eco/flask-debugtoolbar) (👨‍💻 45 · 🔀 130 · 📦 20K · 📋 110 - 37% open · ⏱️ 02.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/flask-debugtoolbar) (📥 150K / month):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 200 · 📦 3.6K · 📋 300 - 46% open · ⏱️ 20.11.2022):
...
- [PyPi](https://pypi.org/project/icecream) (📥 210K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 9.9K · ⏱️ 21.07.2022):
	```
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 160 · 📦 99 · 📋 83 - 31% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 4.7K / month):
	```
	pip install vprof
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 380 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 630K / month):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 4 · 📋 24 - 62% open · ⏱️ 10.05.2014):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.1K · 🔀 18K · 📋 12K - 2% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.8K · 🔀 16K · 📥 8.7K · 📋 30K - 32% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 63K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 1.1M · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 730 · 📥 240 · ⏱️ 22.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 44 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.2K · 📦 230K · 📋 1.6K - 13% open · ⏱️ 14.11.2022):
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 25K · 📋 31K - 2% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.5M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 780K · ⏱️ 07.12.2022):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.1K · 📥 16K · 📋 25K - 9% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 73K / month):
	```
	pip install salt
	```
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.1K · 📋 1.1K - 10% open · ⏱️ 10.09.2022):

	```
	git clone https://github.com/Supervisor/supervisor
	```
- [PyPi](https://pypi.org/project/supervisor) (📥 2.1M / month):
	```
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 140 · 📦 4K · 📋 100 - 11% open · ⏱️ 24.10.2022):
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 83 · 🔀 300 · 📦 53 · 📋 630 - 17% open · ⏱️ 13.12.2022):
...
- [PyPi](https://pypi.org/project/pyinfra) (📥 12K / month):
	...
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 130 · ⏱️ 15.11.2022):
	```
...
- [PyPi](https://pypi.org/project/fabric) (📥 2.9M / month):
	...
	pip install fabric
	```
- [Conda](https://anaconda.org/conda-forge/fabric) (📥 57K · ⏱️ 09.09.2022):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 570 · 🔀 1.5K · 📦 42K · 📋 4.6K - 15% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 7.8M / month):
	```
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 7.4M · ⏱️ 03.12.2022):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4K · 📦 6.6K · 📋 12K - 19% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 580 · 📦 1.2K · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 59K / month):
	```
	pip install mrjob
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 440 · 🔀 1.7K · 📥 730K · 📦 33K · 📋 4.7K - 5% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 940K / month):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 380K · ⏱️ 13.12.2022):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 25 · 🔀 200 · 📦 590 · 📋 850 - 2% open · ⏱️ 11.12.2022):
...
- [PyPi](https://pypi.org/project/shiv) (📥 18K / month):
	...
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 800 · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.7K · 📦 240K · 📋 6.3K - 16% open · ⏱️ 07.12.2022):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 41 · 🔀 150 · 📦 950 · 📋 300 - 4% open · ⏱️ 29.11.2022):
...
- [PyPi](https://pypi.org/project/pdoc) (📥 63K / month):
	...
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 8.6K · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 140 · 📦 270 · 📋 57 - 50% open · ⏱️ 20.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pycco) (📥 1.2K / month):
	```
	pip install pycco
	```
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.7M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 7.6K · ⏱️ 22.12.2018):
	```
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 47 · 🔀 1.3K · 📦 240 · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 950 · 📦 210 · 📋 380 - 22% open · ⏱️ 28.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 6.6K / month):
	```
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 280 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 240 / month):
	```
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.4K · 📥 2.4M · 📦 24K · 📋 16K - 6% open · ⏱️ 10.12.2022):
...
- [GitHub](https://github.com/davidhalter/jedi-vim) (👨‍💻 95 · 🔀 370 · 📋 770 - 3% open · ⏱️ 23.11.2022):
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 32 · 🔀 260 · 📦 2.8K · 📋 220 - 44% open · ⏱️ 28.09.2022):
...
- [PyPi](https://pypi.org/project/yagmail) (📥 170K / month):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 21K · ⏱️ 11.09.2022):
	```
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 55 · 🔀 180 · 📦 290 · 📋 88 - 59% open · ⏱️ 29.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/flanker) (📥 38K / month):
	```
	pip install flanker
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 160 · 📋 130 - 47% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 48K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 58 · 📥 76 · 📦 17 · 📋 90 - 18% open · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 400 · 🔀 2.6K · 📋 1.5K - 1% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 8.8K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 86 · 🔀 900 · 📋 1.2K - 6% open · ⏱️ 07.12.2022):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 43M / month):
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 640 · 📦 70K · 📋 590 - 28% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/gorakhargosh/watchdog
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 9.2M / month):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 57 · 🔀 240 · 📦 34K · 📋 180 - 15% open · ⏱️ 24.10.2022):
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 48 · 🔀 130 · 📋 130 - 1% open · ⏱️ 30.11.2022):
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 39 · 📦 8.2K · 📋 17 - 41% open · ⏱️ 14.02.2015):
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 680 · 📦 100K · 📋 660 - 8% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 220 · 📦 84K · 📋 160 - 13% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 220 · 📦 76K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 92 · 🔀 210 · 📥 2.5K · 📋 230 - 5% open · ⏱️ 05.12.2022):
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 94 · 📦 230 · 📋 390 - 14% open · ⏱️ 09.12.2022):
...
- [PyPi](https://pypi.org/project/returns) (📥 55K / month):
	...
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 3.9K · ⏱️ 13.03.2022):
	```
...
- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 66 · 📦 45K · 📋 75 - 34% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 19K · 📋 400 - 14% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.6K · 📦 6.6K · 📋 3.1K - 22% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 160K / month):
	```
	pip install PySimpleGUI
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 86K · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 890 · 📥 360 · 📦 630 · 📋 570 - 20% open · ⏱️ 08.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 4.3K / month):
	```
	pip install Gooey
	```
...
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉24 ·  ⭐ 9.2K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 480 · 📦 630 · 📋 1.1K - 22% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 420 · 📦 840 · 📋 680 - 3% open · ⏱️ 05.12.2022):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 220 · 🔀 550 · 📥 800 · 📋 600 - 17% open · ⏱️ 13.12.2022):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 37 · 🔀 120 · 📥 190 · 📋 220 - 17% open · ⏱️ 06.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/enaml) (📥 1.3K / month):
	```
	pip install enaml
	```
...
- [PyPi](https://pypi.org/project/geopy) (📥 4.5M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 890K · ⏱️ 13.11.2022):
	```
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 46K · 📋 220 - 29% open · ⏱️ 08.05.2022):
...
- [PyPi](https://pypi.org/project/bleach) (📥 13M / month):
	...
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 9.8M · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 50 · 🔀 170 · 📦 16K · 📋 170 - 27% open · ⏱️ 17.07.2022):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 180 · 🔀 620 · 📦 45K · 📋 730 - 3% open · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 960 · 📥 4.4K · 📦 1.1M · 📋 1.1K - 9% open · ⏱️ 13.12.2022):
...
- [PyPi](https://pypi.org/project/urllib3) (📥 290M / month):
	...
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 26M · ⏱️ 24.11.2022):
	```
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 300 · 📦 3.4K · 📋 110 - 1% open · ⏱️ 26.01.2022):
...
- [PyPi](https://pypi.org/project/grequests) (📥 340K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 66K · ⏱️ 22.04.2020):
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 400 · 🔀 1.7K · 📦 9.3K · 📋 1.4K - 2% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/scapy) (📥 1.8M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 62K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 40 · 🔀 370 · 📦 8.5K · 📋 510 - 64% open · ⏱️ 20.07.2022):
...
<details><summary><b><a href="https://github.com/boppreh/mouse">mouse</a></b> (🥉21 ·  ⭐ 710) - Hook and simulate global mouse events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 470 · 📋 100 - 70% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 8.1K / month):
	```
...
- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 440 · 📋 64 - 51% open · ⏱️ 20.03.2017):
	...
	```
- [PyPi](https://pypi.org/project/wifi) (📥 8.7K / month):
	```
	pip install wifi
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 420 · 🔀 1.8K · 📦 940K · 📋 2.7K - 3% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/Pillow) (📥 51M / month):
	...
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 22M · ⏱️ 28.10.2022):
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 8.5K · 📦 14K · 📋 390 - 4% open · ⏱️ 13.10.2022):
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 760 · 📦 320 · 📋 920 - 1% open · ⏱️ 06.12.2022):

	```
	git clone https://github.com/thumbor/thumbor
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 3.5K / month):
	```
	pip install thumbor
	```
...
- [PyPi](https://pypi.org/project/python-barcode) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 8.4K · ⏱️ 22.08.2020):
	```
	conda install -c conda-forge python-barcode
	```
</details>
<details><summary><b><a href="https://github.com/dylanaraps/pywal">pywal</a></b> (🥈24 ·  ⭐ 6.9K · 💀) - A tool that generates color schemes from images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 270 · 📥 880 · 📦 210 · 📋 520 - 24% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 14 · 🔀 41 · 📦 410 · 📋 320 - 37% open · ⏱️ 04.12.2022):
...
- [PyPi](https://pypi.org/project/pyvips) (📥 22K / month):
	...
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 43K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 150 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 540 · 🔀 4.4K · 📥 53K · 📋 4.5K - 26% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 32 · 🔀 230 · 📥 40K · 📋 540 - 45% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.3K · 🔀 24K · 📋 62K - 10% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 210 · 📋 770 - 16% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 52 · 📦 2.9K · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 260K / month):
	```
	pip install pyicu
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 51 · 🔀 810 · 📦 21K · 📋 390 - 33% open · ⏱️ 23.04.2022):
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 100 · 🔀 1.1K · 📦 1.5K · 📋 3.1K - 21% open · ⏱️ 15.12.2022):
...
- [PyPi](https://pypi.org/project/prefect) (📥 540K / month):
	...
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 370K · ⏱️ 09.12.2022):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 49 · 🔀 270 · 📦 47 · 📋 100 - 6% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 41 · 🔀 560 · 📦 33K · 📋 680 - 9% open · ⏱️ 02.12.2022):
...
- [PyPi](https://pypi.org/project/loguru) (📥 4M / month):
	...
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 830K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 150 · 🔀 320 · 📥 3.8K · 📦 27K · 📋 780 - 21% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 590 · 🔀 8K · 📥 5.6K · 📦 41K · 📋 4.6K - 6% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.6K · 📦 110 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 980 / month):
	```
	pip install nupic
	```
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 260 · 🔀 1.4K · 📋 1.8K - 17% open · ⏱️ 14.12.2022):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 3.1K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 84 · 🔀 700 · 📥 590K · 📦 100K · 📋 1.7K - 25% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 4.2M / month):
	```
	pip install pywin32
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 98 · 🔀 540 · 📥 530 · 📦 120 · 📋 1.2K - 7% open · ⏱️ 30.11.2022):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 57K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 41 · 🔀 200 · 📦 730K · ⏱️ 01.11.2022):
...
- [PyPi](https://pypi.org/project/blinker) (📥 7M / month):
	...
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 7.2M · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 81 · 🔀 330 · 📥 23 · 📦 2.8K · 📋 140 - 31% open · ⏱️ 10.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/boltons) (📥 2.4M / month):
	```
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 720K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.6K · 📦 400 · 📋 900 - 35% open · ⏱️ 04.10.2022):
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 440 · 🔀 4.1K · 📥 4K · 📦 39K · 📋 1.8K - 20% open · ⏱️ 12.12.2022):

	```
	git clone https://github.com/RaRe-Technologies/gensim
	```
- [PyPi](https://pypi.org/project/gensim) (📥 4.7M / month):
	```
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 940K · ⏱️ 29.07.2022):
	```
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.4K · 📦 16K · 📋 820 - 73% open · ⏱️ 15.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jieba) (📥 650K / month):
	```
	pip install jieba
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 28 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/pattern) (📥 1.7M / month):
	```
	pip install pattern
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 54 · 🔀 810 · 📦 1.4K · 📋 730 - 9% open · ⏱️ 15.09.2022):
...
- [PyPi](https://pypi.org/project/stanza) (📥 180K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 7.1K · ⏱️ 15.09.2022):
	```
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 310 · 📦 800 · 📋 220 - 68% open · ⏱️ 22.09.2020):
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 960 · 📋 580 - 21% open · ⏱️ 24.10.2022):
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 480K · 📦 180 · 📋 680 - 36% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mininet) (📥 3.9K / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📦 900 · 📋 300 - 5% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 18K · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/peewee) (📥 1.2M / month):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 460K · ⏱️ 11.11.2022):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 2.6K · 📋 280 - 6% open · ⏱️ 03.06.2022):

	```
	git clone https://github.com/pudo/dataset
	```
- [PyPi](https://pypi.org/project/dataset) (📥 44K / month):
	```
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 3.9K · ⏱️ 16.12.2021):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 38 · 📦 2.8K · 📋 600 - 46% open · ⏱️ 25.05.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 26 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 700 / month):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 420 · 🔀 1.8K · 📥 15M · 📋 4.5K - 12% open · ⏱️ 12.12.2022):
...
- [PyPi](https://pypi.org/project/poetry) (📥 11M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 720K · ⏱️ 12.12.2022):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 480 · 📋 890 - 12% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/pip-tools) (📥 8.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 64K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.2K · 📋 8.7K - 10% open · ⏱️ 15.12.2022):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇20 ·  ⭐ 620) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/devpi/devpi) (👨‍💻 90 · 🔀 110 · 📦 200 · 📋 720 - 10% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 330 · 🔀 780 · 📋 2.8K - 14% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 4 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 35 / month):
	```
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 220 - 16% open · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 4.9K · 📋 4.8K - 1% open · ⏱️ 13.12.2022):
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.7K · 📋 120 - 23% open · ⏱️ 06.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 970 / month):
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 25 · 🔀 130 · 📦 1K · 📋 110 - 21% open · ⏱️ 23.03.2022):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 640 · 📦 870 · 📋 470 - 25% open · ⏱️ 19.07.2022):

	```
	git clone https://github.com/lyst/lightfm
	```
- [PyPi](https://pypi.org/project/lightfm) (📥 410K / month):
	```
	pip install lightfm
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 550 · 📥 190 · 📦 740 · 📋 440 - 16% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 27 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 5.6K / month):
	```
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 400 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 600 / month):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 73 · 🔀 140 · 📦 46K · 📋 280 - 25% open · ⏱️ 15.12.2022):
...
- [PyPi](https://pypi.org/project/rope) (📥 620K / month):
	...
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 940K · ⏱️ 25.11.2022):
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 980 · 📦 84K · 📋 550 - 17% open · ⏱️ 04.03.2022):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 320 · 🔀 1.4K · 📦 8.3K · 📋 1.2K - 3% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 930K / month):
	```
	pip install sanic
	```
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 400 · 🔀 4.2K · 📋 3.2K - 27% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 100 · 🔀 5K · 📋 310 - 5% open · ⏱️ 05.12.2022):
...
- [PyPi](https://pypi.org/project/zerorpc-python):
	...
	```
- [Conda](https://anaconda.org/conda-forge/zerorpc-python) (📥 1.5K · ⏱️ 06.06.2022):
	```
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.7K · 📥 480K · 📦 49K · 📋 12K - 32% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 400 · 🔀 2.4K · 📥 26 · 📦 75K · 📋 4.9K - 47% open · ⏱️ 10.12.2022):
...
- [PyPi](https://pypi.org/project/statsmodels) (📥 9.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 8.1M · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4K · 📦 890 · 📋 980 - 33% open · ⏱️ 14.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/zipline) (📥 2.1K / month):
	```
	pip install zipline
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 430 · 🔀 1.6K · 📥 1.9K · 📦 950 · 📋 2.9K - 5% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 120 · 📋 92 - 1% open · ⏱️ 04.12.2022):
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 95 · 🔀 340 · 📋 3K - 3% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 71 / month):
	```
...
- [GitHub](https://github.com/obspy/obspy) (🔀 490 · 📥 6.8K · 📋 1.7K - 9% open · ⏱️ 09.12.2022):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 62K · 📋 1.1K - 11% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 42 · 📦 640 · 📋 78 - 12% open · ⏱️ 12.09.2022):
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 570 · 📥 7.8K · 📋 2.4K - 10% open · ⏱️ 15.12.2022):
...
- [PyPi](https://pypi.org/project/mistune) (📥 12M / month):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 9.9M · ⏱️ 15.07.2022):
	```
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 20K · 📋 240 - 12% open · ⏱️ 10.12.2022):
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 53K · 📋 820 - 1% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/py-pdf/PyPDF2) (👨‍💻 160 · 🔀 1K · 📦 38K · 📋 620 - 11% open · ⏱️ 13.12.2022):
...
- [PyPi](https://pypi.org/project/csvkit) (📥 150K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 77K · ⏱️ 20.03.2022):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 440 · 📥 31K · 📦 26K · 📋 1.6K - 17% open · ⏱️ 15.12.2022):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 68K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 510K · ⏱️ 31.10.2022):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 750 · 📦 230K · 📋 800 - 4% open · ⏱️ 09.12.2022):
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 830 · 📋 1K - 48% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 2.8M / month):
	```
...
- [PyPi](https://pypi.org/project/nikola) (📥 1.2K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 6.8K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.1K · 📦 28K · 📋 1.7K - 5% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 290 · 📥 7K · 📋 620 - 35% open · ⏱️ 05.11.2022):

	```
	git clone https://github.com/lektor/lektor
	```
- [PyPi](https://pypi.org/project/lektor) (📥 3.1K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 12K · 📋 990 - 18% open · ⏱️ 28.11.2022):
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 86 · 🔀 230 · 📥 34 · 📦 540 · 📋 300 - 10% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 40 · 🔀 110 · 📦 29 · 📋 170 - 30% open · ⏱️ 13.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrq) (📥 270 / month):
	```
	pip install mrq
	```
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 930 - 5% open · ⏱️ 01.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/jinja) (📥 7K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 490 · 🔀 1.7K · 📦 90K · 📋 600 - 1% open · ⏱️ 30.11.2022):
...
- [PyPi](https://pypi.org/project/faker) (📥 6.8M / month):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 690K · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 170 · 🔀 2K · 📥 540 · 📦 6.4K · 📋 4K - 5% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 510 · 📦 15K · 📋 1.3K - 3% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 4M / month):
	```
...
<details><summary><b><a href="https://github.com/getsentry/responses">responses</a></b> (🥇32 ·  ⭐ 3.8K) - A utility library for mocking out the requests Python library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/getsentry/responses) (👨‍💻 110 · 🔀 300 · 📥 79 · 📦 17K · 📋 250 - 0% open · ⏱️ 21.11.2022):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 9M / month):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 500 · 📦 5.9K · 📋 510 - 8% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 120 · 🔀 300 · 📦 4.4K · 📋 340 - 24% open · ⏱️ 01.11.2022):

	```
	git clone https://github.com/kevin1024/vcrpy
	```
- [PyPi](https://pypi.org/project/vcrpy) (📥 1.6M / month):
	```
	pip install vcrpy
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 960 · 📦 19K · 📋 600 - 63% open · ⏱️ 14.09.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 370 · 📦 1.1K · 📋 310 - 0% open · ⏱️ 27.10.2022):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 130K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 64K · ⏱️ 02.10.2022):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 270 · 🔀 2.5K · 📋 1.4K - 0% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/locustio/locust
	```
- [PyPi](https://pypi.org/project/locust) (📥 910K / month):
	```
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 92K · ⏱️ 13.12.2022):
	```
...
- [PyPi](https://pypi.org/project/HTTPretty) (📥 480K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/HTTPretty) (📥 250K · ⏱️ 16.08.2021):
	```
...
- [PyPi](https://pypi.org/project/schemathesis) (📥 58K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 2.5K · ⏱️ 13.11.2022):
	```
...
- [PyPi](https://pypi.org/project/freezegun) (📥 5.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 590K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 5.5K · 📋 260 - 19% open · ⏱️ 06.12.2022):
...
- [PyPi](https://pypi.org/project/nose2) (📥 580K / month):
	...
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 77K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 190 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 68 / month):
	```
	pip install sixpack
	```
...
- [PyPi](https://pypi.org/project/httmock) (📥 310K / month):
	...
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 7K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 24 · 🔀 40 · 📦 72 · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 69K / month):
	```
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 52 · 🔀 230 · 📥 7.4K · 📦 670K · 📋 280 - 12% open · ⏱️ 13.12.2022):
...
- [PyPi](https://pypi.org/project/pyparsing) (📥 120M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 30M · ⏱️ 14.07.2022):
	```
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📦 16K · 📋 180 - 44% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 7.1M / month):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 30 · 🔀 100 · 📦 14K · 📋 55 - 3% open · ⏱️ 13.11.2022):

	```
	git clone https://github.com/skorokithakis/shortuuid
	```
- [PyPi](https://pypi.org/project/shortuuid) (📥 4.4M / month):
	```
	pip install shortuuid
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 280K · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 590 · 📋 480 - 42% open · ⏱️ 23.09.2022):
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 100 · 📦 25K · 📋 46 - 23% open · ⏱️ 16.09.2022):

	```
	git clone https://github.com/pwaller/pyfiglet
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 880K / month):
	```
...
- [PyPi](https://pypi.org/project/ply) (📥 21M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 2.6M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 31 · 🔀 190 · 📦 5.1K · 📋 72 - 56% open · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 230 - 8% open · ⏱️ 28.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 35 / month):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 8K · 📋 130 - 9% open · ⏱️ 25.10.2022):
...
- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 22 · 🔀 92 · 📦 970 · 📋 100 - 20% open · ⏱️ 14.11.2022):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 26 · 🔀 370 · 📋 150 - 2% open · ⏱️ 08.12.2022):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.6K · 📦 230K · 📋 2.8K - 4% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/boto3) (📥 510M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 13M · ⏱️ 15.12.2022):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 860 · 📥 220 · 📦 19K · 📋 770 - 6% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 9.2M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 130K · 📋 950 - 7% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 42M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 1.7M · ⏱️ 14.12.2022):
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.2K · 📋 280 - 2% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/webargs) (📥 690K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 210 · 📥 690 · 📦 250 · 📋 240 - 4% open · ⏱️ 06.07.2022):
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 230 · 🔀 730 · 📋 600 - 26% open · ⏱️ 23.11.2022):
...
- [PyPi](https://pypi.org/project/django-storages) (📥 2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 42K · ⏱️ 06.08.2022):
	```
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 210 · 🔀 540 · 📋 630 - 16% open · ⏱️ 30.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-compressor) (📥 360K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 860 · 📦 9.2K · 📋 370 - 44% open · ⏱️ 10.05.2020):

	```
	git clone https://github.com/psf/requests-html
	```
- [PyPi](https://pypi.org/project/requests-html) (📥 590K / month):
	```
	pip install requests-html
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 4.3K · ⏱️ 26.06.2021):
	```
...
- [PyPi](https://pypi.org/project/sumy) (📥 18K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 3.4K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 840 · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/micawber) (📥 31K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 6.9K · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 18 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 40 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 51 · 🔀 1.4K · 📥 210 · 📦 45 · 📋 450 - 24% open · ⏱️ 10.07.2019):

	```
	git clone https://github.com/scrapinghub/portia
	```
- [PyPi](https://pypi.org/project/portia) (📥 300 / month):
	```
	pip install portia
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 53 · 🔀 360 · 📥 43 · 📋 160 - 15% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 93K / month):
	```
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 66 · 🔀 260 · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 83 · 🔀 120 · 📦 450 · 📋 370 - 5% open · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/masonite) (📥 1.8K / month):
	```
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 62 · 🔀 450 · 📦 77K · 📋 940 - 1% open · ⏱️ 28.11.2022):
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 130 · 🔀 730 · 📦 22K · 📋 880 - 20% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 730 · 📋 1.2K - 5% open · ⏱️ 08.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/channels) (📥 570K / month):
	```
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 810K · 📋 1.9K - 17% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 460 · 🔀 1.6K · 📥 250 · 📦 880K · 📋 1K - 1% open · ⏱️ 01.11.2022):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 91M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 6.4M · ⏱️ 09.08.2022):
	```
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 47 · 🔀 150 · 📦 93K · 📋 210 - 7% open · ⏱️ 17.11.2022):
...
- [PyPi](https://pypi.org/project/waitress) (📥 2.7M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/waitress) (📥 96K · ⏱️ 31.05.2022):
	```
...
- [PyPi](https://pypi.org/project/bjoern) (📥 22K / month):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 92K · ⏱️ 02.11.2022):
	```
