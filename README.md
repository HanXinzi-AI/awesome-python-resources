...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 350 · 🔀 1.5K · 📦 18K · 📋 1.3K - 28% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 200 · 🔀 940 · 📦 11K · 📋 850 - 12% open · ⏱️ 14.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/flower) (📥 2.1M / month):
	```
	pip install flower
	```
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 23 · 🔀 790 · 📦 25 · 📋 1.1K - 1% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 790 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 160 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 41 · 📋 210 - 24% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 420 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 980 · 🔀 38K · 📦 1 · 📋 1.2K - 1% open · ⏱️ 26.01.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 78M · ⏱️ 26.01.2023):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 75 · 🔀 500 · 📦 2.7K · 📋 420 - 1% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/pytransitions/transitions
	```
- [PyPi](https://pypi.org/project/transitions) (📥 330K / month):
	```
...
- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 23 · 🔀 180 · 📦 97K · 📋 160 - 8% open · ⏱️ 06.11.2022):
...
- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 130 · 🔀 6.4K · 📋 81 - 12% open · ⏱️ 08.08.2022):
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 150 · 🔀 520 · 📋 620 - 3% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 9.4M / month):
	```
	pip install uvicorn
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 63 · 🔀 220 · 📋 300 - 10% open · ⏱️ 29.12.2022):

	```
	git clone https://github.com/django/daphne
	```
- [PyPi](https://pypi.org/project/daphne) (📥 530K / month):
	```
	pip install daphne
	```
...
🔗&nbsp;<b><a href="https://github.com/timofurrer/awesome-asyncio">awesome-asyncio</a></b> ( ⭐ 3.8K)  - A curated list of awesome Python asyncio frameworks, libraries, software..

🔗&nbsp;<b><a href="https://twistedmatrix.com/trac/">Twisted</a></b>  - An event-driven networking engine.

<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇34 ·  ⭐ 9.1K) - Ultra fast asyncio event loop. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 56 · 🔀 460 · 📥 360 · 📦 62K · 📋 300 - 16% open · ⏱️ 15.01.2023):
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 23K · 📋 690 - 38% open · ⏱️ 19.01.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 5.9M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 960K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 7.9K · 📦 280 · 📋 2.6K - 18% open · ⏱️ 14.01.2023):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 3.9K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 87 · ⏱️ 01.12.2022):
	```
	conda install -c conda-forge beets
	```
</details>
<details><summary><b><a href="https://github.com/jiaaro/pydub">pydub</a></b> (🥇30 ·  ⭐ 6.7K) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 890 · 📦 17K · 📋 510 - 48% open · ⏱️ 08.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/pydub) (📥 2.7M / month):
	```
	pip install pydub
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 39 · 🔀 130 · 📥 58K · 📦 9.4K · 📋 490 - 21% open · ⏱️ 26.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 740K / month):
	```
	pip install mutagen
	```
...
<details><summary><b><a href="https://github.com/tyiannak/pyAudioAnalysis">pyAudioAnalysis</a></b> (🥈25 ·  ⭐ 5.1K) - Audio feature extraction, classification, segmentation and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 840 · 📋 1.1K - 3% open · ⏱️ 18.01.2023):
...
- [PyPi](https://pypi.org/project/librosa) (📥 1.3M / month):
	...
	pip install librosa
	```
- [Conda](https://anaconda.org/conda-forge/librosa) (📥 570K · ⏱️ 27.06.2022):
	```
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 25 · 🔀 90 · 📦 670 · 📋 98 - 16% open · ⏱️ 15.01.2023):
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 57 · 📦 16 · 📋 210 - 19% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/Parisson/TimeSide
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 46 / month):
	```
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 110 · 📦 12 · 📋 39 - 33% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 460 / month):
	```
...
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥉19 ·  ⭐ 420) - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 190 · 🔀 440 · 📦 310K · 📋 360 - 19% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/idan/oauthlib
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 85M / month):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 590 · 📦 310K · 📋 380 - 3% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/jpadilla/pyjwt
	```
- [PyPi](https://pypi.org/project/pyjwt) (📥 98M / month):
	```
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 9.3M · ⏱️ 20.10.2022):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 620 · 🔀 2.6K · 📦 130K · 📋 1.9K - 14% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 620K / month):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 90 · 🔀 340 · 📦 24K · 📋 360 - 11% open · ⏱️ 27.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/authlib) (📥 5.9M / month):
	```
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 93K · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 680 · 📋 740 - 20% open · ⏱️ 20.01.2023):

	```
	git clone https://github.com/evonove/django-oauth-toolkit
	```
- [PyPi](https://pypi.org/project/django-oauth-toolkit) (📥 380K / month):
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 39 · 🔀 240 · 📋 500 - 16% open · ⏱️ 04.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 15K / month):
	```
	pip install pybuilder
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 32K · ⏱️ 04.11.2022):
	```
	conda install -c conda-forge pybuilder
	```
</details>
<details><summary><b><a href="https://github.com/platformio/platformio-core">PlatformIO</a></b> (🥉20 ·  ⭐ 6.5K) - A console tool to build code with different development platforms. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 680 · 📋 3.9K - 4% open · ⏱️ 23.01.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 320 · 📦 590K · 📋 610 - 17% open · ⏱️ 25.01.2023):
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 51 · 📦 11K · 📋 54 - 5% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/jab/bidict
	```
- [PyPi](https://pypi.org/project/bidict) (📥 940K / month):
	```
	pip install bidict
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 88 · 📥 31 · 📋 150 - 16% open · ⏱️ 29.10.2022):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 130 · 🔀 340 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 25.01.2023):
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 1.5K / month):
	```
	pip install Kotti
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 40 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 53 · 📦 4.3K · 📋 190 - 10% open · ⏱️ 26.08.2022):
...
- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 87 · 🔀 140 · 📦 4.1K · 📋 120 - 52% open · ⏱️ 07.12.2022):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 360 · 🔀 1.9K · 📥 26K · 📦 230K · 📋 2.2K - 15% open · ⏱️ 24.01.2023):
...
- [PyPi](https://pypi.org/project/black) (📥 15M / month):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 6M · ⏱️ 12.01.2023):
	```
	conda install -c conda-forge black
	```
</details>
<details><summary><b><a href="https://github.com/PyCQA/isort">isort</a></b> (🥇33 ·  ⭐ 5.5K) - A Python utility / library to sort imports. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 490 · 📦 310K · 📋 1.2K - 10% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/timothycrosley/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 24M / month):
	```
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 4.2M · ⏱️ 17.01.2023):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 360 · 📦 11K · 📋 1K - 8% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 230K / month):
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 86 · 🔀 150 · 📦 3.6K · 📋 340 - 13% open · ⏱️ 17.01.2023):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 610K / month):
	```
	pip install prospector
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 55K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 850 · 📦 48K · 📋 770 - 47% open · ⏱️ 04.01.2023):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 2.4M / month):
	```
	pip install yapf
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 93 · 📦 4.6K · 📋 140 - 31% open · ⏱️ 08.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/pylama) (📥 160K / month):
	```
	pip install pylama
	```
- [Conda](https://anaconda.org/conda-forge/pylama) (📥 88K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 230 · 🔀 380 · 📋 340 - 31% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 270 · 📦 380 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 18K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 14 · 📋 49 - 12% open · ⏱️ 08.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 1.8K / month):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 20% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 110K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 87 · 🔀 240 · 📋 580 - 18% open · ⏱️ 21.01.2023):
...
- [PyPi](https://pypi.org/project/pytype) (📥 280K / month):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 140K · ⏱️ 11.01.2023):
	```
...
- [GitHub](https://github.com/coala/coala) (🔀 1.3K · 📥 160 · 📦 10 · 📋 3K - 21% open · ⏱️ 11.06.2021):
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 96 · 📋 59 - 44% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.2K · 🔀 1.4K · 📋 2K - 7% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 200 · 🔀 1.4K · 📦 49K · 📋 1K - 6% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 17M / month):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 2.8M · ⏱️ 20.01.2023):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 380K · 📋 880 - 36% open · ⏱️ 03.09.2022):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 45M / month):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 55 · 🔀 1.3K · 📦 17K · 📋 270 - 38% open · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 750 · 📋 290 - 8% open · ⏱️ 17.01.2023):

	```
	git clone https://github.com/peterbrittain/asciimatics
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 51K / month):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.5K · 📋 180 - 8% open · ⏱️ 01.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 150K / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 640 · 📋 1K - 47% open · ⏱️ 19.01.2023):
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 2.2K · 📦 12K · 📋 800 - 15% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/jakubroztocil/httpie
	```
- [PyPi](https://pypi.org/project/httpie) (📥 150K / month):
	```
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 92K · ⏱️ 01.11.2022):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.2K · 📦 400 · 📋 660 - 31% open · ⏱️ 25.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/thefuck) (📥 5.7K / month):
	```
	pip install thefuck
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 70 · 🔀 220 · 📦 220 · 📋 330 - 23% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 9K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 480 · 📦 730 · 📋 660 - 22% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/dbcli/pgcli
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 40K / month):
	```
	pip install pgcli
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 280 · 📋 610 - 29% open · ⏱️ 08.11.2022):

	```
	git clone https://github.com/dbcli/mycli
	```
- [PyPi](https://pypi.org/project/mycli) (📥 33K / month):
	```
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 49K · ⏱️ 02.09.2022):
	```
	conda install -c conda-forge mycli
	```
</details>
<details><summary><b><a href="https://github.com/gleitz/howdoi">howdoi</a></b> (🥈24 ·  ⭐ 9.8K) - Instant coding answers via the command line. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 83 · 🔀 830 · 📦 440 · 📋 250 - 3% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 7.9K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 91 · 📥 11K · 📦 13 · 📋 200 - 24% open · ⏱️ 29.12.2022):
...
- [PyPi](https://pypi.org/project/iredis) (📥 1.8K / month):
	...
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 500 · ⏱️ 10.08.2022):
	```
	conda install -c conda-forge iredis
	```
</details>
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈24 ·  ⭐ 840) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 48 · 🔀 110 · 📦 160 · 📋 300 - 13% open · ⏱️ 25.01.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 21K / month):
	```
	pip install copier
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 61 · 📦 200 · 📋 88 - 32% open · ⏱️ 11.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/litecli) (📥 15K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 93 · 📦 18 · 📋 48 - 25% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/doitlive) (📥 90 / month):
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 45 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 44K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.4K · 📥 3.4M · 📦 2.1K · 📋 710 - 22% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 120K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 1.9K · ⏱️ 25.01.2023):
	```
...
- [PyPi](https://pypi.org/project/tesserocr) (📥 40K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tesserocr) (📥 99K · ⏱️ 06.11.2022):
	```
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 12K · 📥 570 · 📋 1.2K - 54% open · ⏱️ 10.06.2022):

	```
	git clone https://github.com/ageitgey/face_recognition
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 47K / month):
	```
...
- [GitHub](https://github.com/sightmachine/SimpleCV) (👨‍💻 100 · 🔀 760 · 📦 380 · 📋 330 - 22% open · ⏱️ 07.04.2015):
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉19 ·  ⭐ 7.6K) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 750 · 📥 500 · 📋 700 - 27% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 86 · 📦 290 · 📋 73 - 43% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 33 · 🔀 160 · 📥 10 · 📦 87K · 📋 83 - 10% open · ⏱️ 09.01.2023):
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 4 · 📦 23K · 📋 150 - 34% open · ⏱️ 18.01.2023):
...
- [PyPi](https://pypi.org/project/configobj) (📥 2.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 540K · ⏱️ 20.01.2023):
	```
	conda install -c conda-forge configobj
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉23 ·  ⭐ 6.7K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 500 · 📦 12 · 📋 1.2K - 13% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 69K · 📋 1.4K - 51% open · ⏱️ 21.01.2023):

	```
	git clone https://github.com/paramiko/paramiko
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 31M / month):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 64 · 🔀 200 · 📋 290 - 14% open · ⏱️ 19.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pynacl) (📥 36M / month):
	```
	pip install pynacl
	```
...
<details><summary><b><a href="https://github.com/blaze/blaze">Blaze</a></b> (🥇29 ·  ⭐ 3.1K · 💀) - NumPy and Pandas interface to Big Data. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 15K / month):
	```
	pip install blaze
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 550 · 📥 170K · 📦 740 · 📋 830 - 4% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 530 · 📦 290K · 📋 700 - 5% open · ⏱️ 20.01.2023):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 60M / month):
	```
	pip install jsonschema
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 16M · ⏱️ 30.11.2022):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 63 · 🔀 220 · 📦 13K · 📋 340 - 12% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 3.7M / month):
	```
...
- [PyPi](https://pypi.org/project/schema) (📥 4M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 78K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 89 · 🔀 200 · 📦 6.3K · 📋 240 - 16% open · ⏱️ 23.10.2022):
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 180 · 🔀 1.6K · 📥 240 · 📦 210K · 📋 2.2K - 4% open · ⏱️ 25.01.2023):

	```
	git clone https://github.com/mwaskom/seaborn
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 8.6M / month):
	```
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 5.7M · ⏱️ 31.12.2022):
	```
	conda install -c conda-forge seaborn
	```
</details>
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈34 ·  ⭐ 8K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📦 43K · 📋 1.7K - 12% open · ⏱️ 25.01.2023):
...
- [PyPi](https://pypi.org/project/altair) (📥 9.4M / month):
	...
	pip install altair
	```
- [Conda](https://anaconda.org/conda-forge/altair) (📥 1.6M · ⏱️ 16.01.2023):
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 740 · 📋 410 - 57% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 77K / month):
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 2.9K · 📋 1.1K - 26% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/cartopy) (📥 63K / month):
	...
	pip install cartopy
	```
- [Conda](https://anaconda.org/conda-forge/cartopy) (📥 2.6M · ⏱️ 13.12.2022):
	```
...
- [PyPi](https://pypi.org/project/vispy) (📥 37K / month):
	...
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 330K · ⏱️ 14.11.2022):
	```
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 99 · 🔀 180 · 📋 530 - 13% open · ⏱️ 09.01.2023):
...
- [PyPi](https://pypi.org/project/plotnine) (📥 250K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/plotnine) (📥 230K · ⏱️ 10.10.2022):
	```
...
<details><summary><b><a href="https://github.com/msiemens/tinydb">tinydb</a></b> (🥇30 ·  ⭐ 5.6K) - A tiny, document-oriented database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 79 · 🔀 470 · 📦 9.3K · 📋 290 - 2% open · ⏱️ 14.01.2023):
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 78 · 📦 960 · 📋 160 - 38% open · ⏱️ 09.11.2022):
...
- [PyPi](https://pypi.org/project/ZODB) (📥 53K / month):
	...
	pip install ZODB
	```
- [Conda](https://anaconda.org/conda-forge/ZODB) (📥 53K · ⏱️ 09.11.2022):
	```
	conda install -c conda-forge ZODB
	```
</details>
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉21 ·  ⭐ 740 · 💀) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/PyMySQL) (📥 31M / month):
	...
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 980K · ⏱️ 09.01.2021):
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 370 · 🔀 2.2K · 📋 1.3K - 9% open · ⏱️ 22.01.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 870K · ⏱️ 12.01.2023):
	```
	conda install -c conda-forge redis-py
	```
</details>
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥈25 ·  ⭐ 970) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 48 · 🔀 180 · 📦 880 · 📋 260 - 11% open · ⏱️ 18.12.2022):
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.6K · ⏱️ 24.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-driver) (📥 10 / month):
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 980 · ⏱️ 25.01.2023):
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 87 · 🔀 300 · 📥 63 · 📦 15K · 📋 450 - 42% open · ⏱️ 23.12.2022):

	```
	git clone https://github.com/sdispater/pendulum
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 9.7M / month):
	```
	pip install pendulum
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 640K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 420 · 📥 35K · 📦 910K · 📋 650 - 40% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 48 · 🔀 190 · 📦 1K · 📋 90 - 17% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/maya) (📥 36K / month):
	```
	pip install maya
	```
- [Conda](https://anaconda.org/conda-forge/maya) (📥 53K · ⏱️ 14.09.2022):
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 130 · 📦 880 · 📋 63 - 41% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 750 · 📋 40 - 7% open · ⏱️ 27.11.2020):
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 22 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 610 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 19 · 📦 32 · ⏱️ 05.11.2022):

	```
	git clone https://github.com/shinux/PyTime
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 4.2K / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 260 · 🔀 870 · 📥 180 · 📦 61K · 📋 830 - 7% open · ⏱️ 20.01.2023):
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇30 ·  ⭐ 9.6K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 320 · 📥 11K · 📦 300 · 📋 270 - 33% open · ⏱️ 09.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 1.2M / month):
	```
	pip install py-spy
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 54 · 🔀 140 · 📦 38K · 📋 180 - 31% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/gotcha/ipdb
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 1.9M / month):
	```
	pip install ipdb
	```
- [Conda](https://anaconda.org/conda-forge/ipdb) (📥 320K · ⏱️ 24.12.2022):
	```
...
<details><summary><b><a href="https://github.com/eliben/pyelftools">pyelftools</a></b> (🥈26 ·  ⭐ 1.6K) - Parsing and analyzing ELF files and DWARF debugging.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 87 · 🔀 440 · 📦 4.5K · 📋 210 - 32% open · ⏱️ 27.10.2022):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 1.7M / month):
	```
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥈22 ·  ⭐ 6.5K) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 160 · 📦 100 · 📋 83 - 31% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 4.3K / month):
	```
	pip install vprof
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 700 / month):
	```
	pip install pyflame
	```
...
<details><summary><b><a href="https://github.com/fabianp/memory_profiler">memory_profiler</a></b> (🥉17 ·  ⭐ 80 · 💀) - Monitor Memory usage of Python code. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 560K / month):
	```
	pip install memory_profiler
	```
- [Conda](https://anaconda.org/conda-forge/memory_profiler) (📥 260K · ⏱️ 16.11.2022):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 30 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 240K · 📋 37K - 5% open · ⏱️ 26.01.2023):
...
- [PyPi](https://pypi.org/project/tensorflow) (📥 15M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 3.9M · ⏱️ 08.01.2023):
	```
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 3.8K · 📋 9.5K - 18% open · ⏱️ 12.01.2023):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.1K · 🔀 18K · 📋 12K - 2% open · ⏱️ 25.01.2023):

	```
	git clone https://github.com/keras-team/keras
	```
- [PyPi](https://pypi.org/project/keras) (📥 9.5M / month):
	```
	pip install keras
	```
- [Conda](https://anaconda.org/conda-forge/keras) (📥 2.8M · ⏱️ 21.11.2022):
	```
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.8K · 🔀 17K · 📥 10K · 📋 31K - 32% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 56K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 1.2M · ⏱️ 15.01.2023):
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 730 · 📥 240 · ⏱️ 22.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 65 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 250K · 📋 1.6K - 13% open · ⏱️ 24.01.2023):
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 25K · 📋 31K - 2% open · ⏱️ 26.01.2023):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.4M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 800K · ⏱️ 07.12.2022):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.1K · 📥 16K · 📋 25K - 9% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.4K · 📋 1.1K - 11% open · ⏱️ 27.12.2022):
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 85 · 🔀 300 · 📦 57 · 📋 640 - 17% open · ⏱️ 15.01.2023):
...
- [PyPi](https://pypi.org/project/pyinfra) (📥 16K / month):
	...
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 290 · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 19 · 🔀 1.7K · 📋 1.7K - 23% open · ⏱️ 20.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/fabric) (📥 2.7M / month):
	```
	pip install fabric
	```
...
<details><summary><b><a href="https://github.com/spotify/luigi">luigi</a></b> (🥇33 ·  ⭐ 16K) - A module that helps you build complex pipelines of batch jobs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/spotify/luigi) (👨‍💻 600 · 🔀 2.3K · 📦 1.9K · 📋 950 - 8% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/spotify/luigi
	```
- [PyPi](https://pypi.org/project/luigi) (📥 400K / month):
	```
	pip install luigi
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 570 · 🔀 1.5K · 📦 44K · 📋 4.6K - 15% open · ⏱️ 25.01.2023):
...
- [PyPi](https://pypi.org/project/dask) (📥 7.3M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 7.7M · ⏱️ 13.01.2023):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4K · 📦 7.2K · 📋 13K - 19% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 580 · 📦 1.2K · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 97K / month):
	```
	pip install mrjob
	```
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 94 · 🔀 540 · 📦 1.3K · 📋 470 - 48% open · ⏱️ 09.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/faust) (📥 30K / month):
	```
	pip install faust
	```
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 43 · 🔀 210 · 📦 57 · 📋 330 - 19% open · ⏱️ 18.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/streamparse) (📥 2K / month):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 730K · 📦 35K · 📋 4.8K - 5% open · ⏱️ 25.01.2023):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 830K / month):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 390K · ⏱️ 13.12.2022):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 26 · 🔀 210 · 📦 640 · 📋 880 - 4% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 430K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 79 · 📥 360 · 📋 110 - 30% open · ⏱️ 04.11.2022):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 12K / month):
	```
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 960 · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.7K · 📦 250K · 📋 6.3K - 16% open · ⏱️ 24.01.2023):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 42 · 🔀 160 · 📦 1K · 📋 300 - 4% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 68K / month):
	```
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 9.5K · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 49 · 🔀 1.3K · 📦 260 · 📋 740 - 0% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 38K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 200 · 📦 32 · 📋 130 - 61% open · ⏱️ 06.05.2022):
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 25 · 🔀 160 · 📦 1.5K · 📋 69 - 23% open · ⏱️ 05.08.2022):

	```
	git clone https://github.com/MicroPyramid/forex-python
	```
- [PyPi](https://pypi.org/project/forex-python) (📥 150K / month):
	```
...
<details><summary><b><a href="https://github.com/stephenmcd/cartridge">Cartridge</a></b> (🥈21 ·  ⭐ 680) - A shopping cart app built using the Mezzanine. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 280 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 250 / month):
	```
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 27 · 📦 270 · 📋 23 - 30% open · ⏱️ 04.09.2016):
	...
	```
- [PyPi](https://pypi.org/project/money) (📥 47K / month):
	```
	pip install money
	```
...
- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 12 · 📥 6 · 📦 46 · 📋 6 - 50% open · ⏱️ 22.12.2020):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.6M · 📦 24K · 📋 17K - 6% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 70K / month):
	```
	pip install spyder
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 92 · 🔀 240 · 📦 210 · 📋 1.6K - 22% open · ⏱️ 22.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 660 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 81 · 🔀 660 · 📥 33K · 📋 4.5K - 2% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/yagmail) (📥 130K / month):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 22K · ⏱️ 11.09.2022):
	```
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 55 · 🔀 180 · 📦 300 · 📋 88 - 59% open · ⏱️ 29.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/flanker) (📥 31K / month):
	```
	pip install flanker
	```
...
<details><summary><b><a href="https://github.com/martinrusev/imbox">imbox</a></b> (🥇26 ·  ⭐ 1.1K) - Python IMAP for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 170 · 📋 130 - 48% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 28K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 310 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 25.01.2023):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 2.1K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 55 · 📥 130 · 📋 72 - 33% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/mailer) (📥 57K / month):
	```
	pip install mailer
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 59 · 📥 78 · 📦 17 · 📋 90 - 18% open · ⏱️ 06.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/salmon) (📥 46 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 86 · 🔀 900 · 📦 210K · 📋 1.3K - 5% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 38M / month):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 3.4M · ⏱️ 10.12.2022):
	```
	conda install -c conda-forge virtualenv
	```
</details>
<details><summary><b><a href="https://github.com/pyenv/pyenv">pyenv</a></b> (🥉26 ·  ⭐ 30K) - Simple Python version management. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 410 · 🔀 2.6K · 📋 1.6K - 1% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 8.1K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 74K · 📋 590 - 26% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/gorakhargosh/watchdog
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 9.5M / month):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 58 · 🔀 240 · 📦 36K · 📋 180 - 15% open · ⏱️ 23.01.2023):
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 39 · 📦 8.4K · 📋 17 - 41% open · ⏱️ 14.02.2015):
	...
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 54K / month):
	```
	pip install Unipath
	```
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 140 · 🔀 370 · 📦 160K · 📋 410 - 12% open · ⏱️ 13.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 3.5M / month):
	```
	pip install wtforms
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 680 · 📦 110K · 📋 660 - 9% open · ⏱️ 18.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 670K / month):
	```
	pip install django-crispy-forms
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 64K · ⏱️ 25.01.2022):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 220 · 📦 91K · 📋 160 - 13% open · ⏱️ 14.12.2022):
...
<details><summary><b><a href="https://github.com/Pylons/deform">Deform</a></b> (🥉20 ·  ⭐ 390) - Python HTML form generation library influenced by the formish form.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 86 · 📦 20 · 📋 16 - 75% open · ⏱️ 12.07.2017):
	...
	```
- [PyPi](https://pypi.org/project/django-remote-forms) (📥 110 / month):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 80K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [PyPi](https://pypi.org/project/toolz) (📥 17M / month):
	...
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 12M · ⏱️ 10.07.2022):
	```
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 6.6K · 📋 73 - 10% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/Suor/funcy
	```
- [PyPi](https://pypi.org/project/funcy) (📥 1.4M / month):
	```
	pip install funcy
	```
- [Conda](https://anaconda.org/conda-forge/funcy) (📥 280K · ⏱️ 21.12.2021):
	```
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 96 · 🔀 220 · 📥 2.6K · 📋 230 - 5% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 31 · 🔀 100 · 📋 610 - 9% open · ⏱️ 30.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/coconut) (📥 1.8K / month):
	```
	pip install coconut
	```
...
- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 66 · 📦 46K · 📋 75 - 30% open · ⏱️ 19.12.2022):
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 20K · 📋 420 - 15% open · ⏱️ 24.01.2023):
...
- [PyPi](https://pypi.org/project/pyglet) (📥 300K / month):
	...
	pip install pyglet
	```
- [Conda](https://anaconda.org/conda-forge/pyglet) (📥 470K · ⏱️ 08.11.2022):
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.6K · 📦 7K · 📋 3.2K - 22% open · ⏱️ 25.01.2023):
...
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 180K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 90K · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 40 · 🔀 530 · 📦 4.6K · 📋 480 - 32% open · ⏱️ 09.12.2022):
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 370 · 📦 660 · 📋 570 - 20% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 3.9K / month):
	```
	pip install Gooey
	```
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 490 · 📦 700 · 📋 1.1K - 14% open · ⏱️ 19.01.2023):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 430 · 📦 890 · 📋 700 - 1% open · ⏱️ 20.01.2023):
...
<details><summary><b><a href="https://github.com/nucleic/enaml">enaml</a></b> (🥉21 ·  ⭐ 1.4K) - Creating beautiful user-interfaces with Declarative Syntax like QML. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 200 · 📦 210 · 📋 220 - 16% open · ⏱️ 12.01.2023):

	```
	git clone https://github.com/nucleic/enaml
	```
- [PyPi](https://pypi.org/project/enaml) (📥 1.5K / month):
	```
	pip install enaml
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 220 · 🔀 560 · 📥 840 · 📋 610 - 18% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/pybee/toga
	```
- [PyPi](https://pypi.org/project/toga) (📥 960 / month):
	```
	pip install toga
	```
...
<details><summary><b><a href="https://github.com/SmileyChris/django-countries">django-countries</a></b> (🥈22 ·  ⭐ 1.2K) - A Django app that provides a country field for models and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 52 · 🔀 250 · 📋 260 - 3% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/SmileyChris/django-countries
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 430K / month):
	```
	pip install django-countries
	```
- [Conda](https://anaconda.org/conda-forge/django-countries) (📥 2.6K · ⏱️ 28.02.2022):
	```
	conda install -c conda-forge django-countries
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/geojson">geojson</a></b> (🥉18 ·  ⭐ 770) - Python bindings and utilities for GeoJSON. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 51 · 🔀 100 · 📦 11K · 📋 88 - 23% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 110 · 📦 1.1M · ⏱️ 19.01.2023):
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 52 · 🔀 170 · 📦 17K · 📋 180 - 27% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 1.8M / month):
	```
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 34K · ⏱️ 28.12.2022):
	```
...
- [GitHub](https://github.com/stchris/untangle) (👨‍💻 17 · 🔀 80 · 📥 530 · 📦 960 · 📋 56 - 26% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/untangle) (📥 160K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 3.3K · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 730 · 🔀 8.6K · 📥 4.3K · 📦 1.9M · 📋 3.7K - 5% open · ⏱️ 21.01.2023):

	```
	git clone https://github.com/psf/requests
	```
- [PyPi](https://pypi.org/project/requests) (📥 260M / month):
	```
	pip install requests
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 27M · ⏱️ 16.01.2023):
	```
	conda install -c conda-forge requests
	```
</details>
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈36 ·  ⭐ 9.9K) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 180 · 🔀 640 · 📦 53K · 📋 740 - 3% open · ⏱️ 12.01.2023):
...
- [PyPi](https://pypi.org/project/httpx) (📥 11M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 430K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 970 · 📥 5K · 📦 1.1M · 📋 1.1K - 9% open · ⏱️ 19.01.2023):

	```
	git clone https://github.com/shazow/urllib3
	```
- [PyPi](https://pypi.org/project/urllib3) (📥 290M / month):
	```
	pip install urllib3
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 77 · 🔀 180 · 📦 130K · 📋 110 - 39% open · ⏱️ 19.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/httplib2) (📥 30M / month):
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 410 · 🔀 1.7K · 📦 9.7K · 📋 1.4K - 3% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/secdev/scapy
	```
- [PyPi](https://pypi.org/project/scapy) (📥 2M / month):
	```
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 67K · ⏱️ 25.12.2022):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 380 · 📦 9.1K · 📋 520 - 64% open · ⏱️ 16.12.2022):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 320K / month):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 100 · 📦 880 · 📋 110 - 74% open · ⏱️ 23.08.2022):

	```
	git clone https://github.com/boppreh/mouse
	```
- [PyPi](https://pypi.org/project/mouse) (📥 22K / month):
	```
	pip install mouse
	```
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 480 · 📋 100 - 70% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 5.1K / month):
	```
...
- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 450 · 📋 64 - 51% open · ⏱️ 20.03.2017):
	...
	```
- [PyPi](https://pypi.org/project/wifi) (📥 9.8K / month):
	```
	pip install wifi
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 420 · 🔀 1.8K · 📦 990K · 📋 2.7K - 3% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/python-pillow/Pillow
	```
- [PyPi](https://pypi.org/project/Pillow) (📥 49M / month):
	```
	pip install Pillow
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 8.9K · 📦 14K · 📋 390 - 4% open · ⏱️ 14.01.2023):
...
- [PyPi](https://pypi.org/project/wand) (📥 490K / month):
	...
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 20K · ⏱️ 22.08.2022):
	```
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 320 · 📋 930 - 1% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/thumbor/thumbor
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 5K / month):
	```
	pip install thumbor
	```
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 280 · 📥 910 · 📦 220 · 📋 520 - 24% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 43 · 🔀 110 · 📥 250 · 📦 16K · 📋 100 - 39% open · ⏱️ 03.12.2022):

	```
	git clone https://github.com/WhyNotHugo/python-barcode
	```
- [PyPi](https://pypi.org/project/python-barcode) (📥 180K / month):
	```
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 43 · 📦 440 · 📋 320 - 37% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/libvips/pyvips
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 25K / month):
	```
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 45K · ⏱️ 29.10.2022):
	```
	conda install -c conda-forge pyvips
	```
</details>
<details><summary><b><a href="https://github.com/daboth/pagan">pagan</a></b> (🥉19 ·  ⭐ 280) - Retro identicon (Avatar) generation based on input string and hash. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 11 · 🔀 42 · 📦 62 · 📋 8 - 50% open · ⏱️ 30.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pagan) (📥 250 / month):
	```
	pip install pagan
	```
...
<details><summary><b><a href="https://github.com/hhatto/nude.py">nude.py</a></b> (🥉16 ·  ⭐ 880 · 💀) - Nudity detection. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/lincolnloop/python-qrcode">python-qrcode</a></b> (🥉14 ·  ⭐ 3.5K) - A pure Python QR Code generator. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 55 · 🔀 540 · 📋 190 - 21% open · ⏱️ 28.11.2022):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 290 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 550 · 🔀 4.5K · 📥 55K · 📋 4.6K - 26% open · ⏱️ 24.01.2023):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 45K · 📋 550 - 45% open · ⏱️ 17.01.2023):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.3K · 🔀 25K · 📋 62K - 10% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 25 · 🔀 150 · 📦 11 · 📋 89 - 26% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 25 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 220K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 71 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 690 / month):
	```
	pip install Pyjion
	```
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉11 ·  ⭐ 890 · 💀) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 52 · 🔀 260 · 📦 2.1K · 📋 360 - 57% open · ⏱️ 06.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 380K / month):
	```
...
<details><summary><b><a href="https://github.com/bpython/bpython">bpython</a></b> (🥉19 ·  ⭐ 2.3K) - A fancy interface to the Python interpreter. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 210 · 📋 770 - 16% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/bpython/bpython
	```
- [PyPi](https://pypi.org/project/bpython) (📥 88K / month):
	```
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 56K · ⏱️ 18.01.2023):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 52 · 📦 3K · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 210K / month):
	```
	pip install pyicu
	```
...
<details><summary><b><a href="https://github.com/dbader/schedule">schedule</a></b> (🥇30 ·  ⭐ 10K · 💤) - Python job scheduling for humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dbader/schedule) (👨‍💻 51 · 🔀 810 · 📦 22K · 📋 400 - 33% open · ⏱️ 23.04.2022):

	```
	git clone https://github.com/dbader/schedule
	```
- [PyPi](https://pypi.org/project/schedule) (📥 2.6M / month):
	```
	pip install schedule
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 27K · ⏱️ 10.04.2021):
	```
	conda install -c conda-forge schedule
	```
</details>
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥈28 ·  ⭐ 11K) - A modern workflow orchestration framework that makes it easy to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 120 · 🔀 1.1K · 📦 1.6K · 📋 3.2K - 20% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 430K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 380K · ⏱️ 20.01.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 50 · 🔀 270 · 📦 49 · 📋 100 - 6% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 75 · 📋 9 - 11% open · ⏱️ 14.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/plan) (📥 2K / month):
	```
	pip install plan
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 570 · 📦 37K · 📋 690 - 9% open · ⏱️ 20.01.2023):
...
- [PyPi](https://pypi.org/project/loguru) (📥 3.7M / month):
	...
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 900K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 330 · 📥 3.7K · 📦 28K · 📋 800 - 20% open · ⏱️ 25.01.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 590 · 🔀 8K · 📥 5.8K · 📦 43K · 📋 4.7K - 6% open · ⏱️ 25.01.2023):
...
- [PyPi](https://pypi.org/project/xgboost) (📥 8.4M / month):
	...
	pip install xgboost
	```
- [Conda](https://anaconda.org/conda-forge/xgboost) (📥 3.5M · ⏱️ 07.11.2022):
	```
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.7K · 📦 37K · 📋 1.7K - 1% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 920K / month):
	```
	pip install gym
	```
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.6K · 📦 120 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 760 / month):
	```
	pip install nupic
	```
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉21 ·  ⭐ 12K) - MindsDB is an open source AI layer for existing databases that.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 270 · 🔀 1.4K · 📋 1.9K - 15% open · ⏱️ 25.01.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 6.8K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 4.4K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/josephreisinger/vowpal_porpoise) (👨‍💻 14 · 🔀 28 · 📋 9 - 66% open · ⏱️ 07.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/vowpal_porpoise) (📥 12 / month):
	```
...
<details><summary><b><a href="https://github.com/mhammond/pywin32">PyWin32</a></b> (🥇28 ·  ⭐ 4.2K) - Python Extensions for Windows. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 84 · 🔀 710 · 📥 600K · 📦 110K · 📋 1.7K - 25% open · ⏱️ 04.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 3.2M / month):
	```
	pip install pywin32
	```
- [Conda](https://anaconda.org/conda-forge/pywin32) (📥 3.2M · ⏱️ 28.10.2022):
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 98 · 🔀 540 · 📥 790 · 📦 150 · 📋 1.3K - 7% open · ⏱️ 18.01.2023):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 120K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 60K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 760K · ⏱️ 20.01.2023):
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 16 · 🔀 160 · 📦 130K · 📋 36 - 2% open · ⏱️ 24.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/blinker) (📥 6.6M / month):
	```
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 7.5M · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.6K · 📦 400 · 📋 910 - 35% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/magenta/magenta
	```
- [PyPi](https://pypi.org/project/magenta) (📥 6.8K / month):
	```
	pip install magenta
	```
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1.7K · 📋 13 - 7% open · ⏱️ 16.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 460K / month):
	```
...
- [PyPi](https://pypi.org/project/gensim) (📥 4.2M / month):
	...
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 960K · ⏱️ 21.12.2022):
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 54 · 🔀 810 · 📦 1.5K · 📋 750 - 10% open · ⏱️ 15.09.2022):
...
- [PyPi](https://pypi.org/project/stanza) (📥 130K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 7.7K · ⏱️ 15.09.2022):
	```
	conda install -c conda-forge stanza
	```
</details>
<details><summary><b><a href="https://github.com/lancopku/pkuseg-python">pkuseg-python</a></b> (🥈23 ·  ⭐ 6.1K · 💤) - A toolkit for Chinese word segmentation in various domains. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 310 · 📦 840 · 📋 220 - 68% open · ⏱️ 22.09.2020):

	```
	git clone https://github.com/aboSamoor/polyglot
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 47K / month):
	```
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉15 ·  ⭐ 46K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 1K · 📋 580 - 20% open · ⏱️ 09.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/napalm) (📥 37K / month):
	```
	pip install napalm
	```
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 490K · 📦 190 · 📋 680 - 36% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mininet) (📥 1.6K / month):
	```
	pip install mininet
	```
...
- [PyPi](https://pypi.org/project/pox) (📥 3.6M / month):
	...
	pip install pox
	```
- [Conda](https://anaconda.org/conda-forge/pox) (📥 260K · ⏱️ 24.10.2022):
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 3 · 📦 920 · 📋 300 - 5% open · ⏱️ 19.12.2022):

	```
	git clone https://github.com/justquick/django-activity-stream
	```
- [PyPi](https://pypi.org/project/django-activity-stream) (📥 36K / month):
	```
...
- [GitHub](https://github.com/tschellenbach/Stream-Framework) (👨‍💻 26 · 🔀 540 · 📋 180 - 35% open · ⏱️ 15.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/Stream-Framework) (📥 2.5K / month):
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 19K · ⏱️ 03.01.2023):

	```
	git clone https://github.com/coleifer/peewee
	```
- [PyPi](https://pypi.org/project/peewee) (📥 1.4M / month):
	```
	pip install peewee
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 380 · 🔀 1.1K · 📦 19K · 📋 1.6K - 20% open · ⏱️ 21.01.2023):

	```
	git clone https://github.com/MongoEngine/mongoengine
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 880K / month):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 400 · 📦 1.2K · 📋 550 - 37% open · ⏱️ 19.01.2023):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 240K · ⏱️ 08.12.2022):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 2.7K · 📋 280 - 6% open · ⏱️ 27.12.2022):

	```
	git clone https://github.com/pudo/dataset
	```
- [PyPi](https://pypi.org/project/dataset) (📥 45K / month):
	```
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 4.3K · ⏱️ 16.12.2021):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 44 · 📦 2.9K · 📋 600 - 46% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 580 / month):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 430 · 🔀 1.8K · 📥 15M · 📋 4.7K - 11% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 9.9M / month):
	```
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 750K · ⏱️ 11.01.2023):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 480 · 📋 900 - 12% open · ⏱️ 28.12.2022):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 7.9M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 69K · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.2K · 📋 8.8K - 10% open · ⏱️ 25.01.2023):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 92 · 🔀 110 · 📦 200 · 📋 720 - 10% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/devpi/devpi
	```
- [PyPi](https://pypi.org/project/devpi) (📥 2.7K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 330 · 🔀 780 · 📋 2.8K - 14% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 24.01.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 4.9K · 📋 4.9K - 1% open · ⏱️ 24.01.2023):
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉20 ·  ⭐ 8.3K) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.7K · 📋 130 - 25% open · ⏱️ 06.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 960 / month):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 86 · 🔀 460 · 📦 11K · 📋 430 - 2% open · ⏱️ 05.12.2022):
...
<details><summary><b><a href="https://github.com/spotify/annoy">annoy</a></b> (🥇31 ·  ⭐ 11K) - Approximate Nearest Neighbors in C++/Python optimized for memory usage. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/lyst/lightfm">lightfm</a></b> (🥈27 ·  ⭐ 4.2K) - A Python implementation of a number of popular recommendation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 640 · 📦 920 · 📋 470 - 25% open · ⏱️ 19.07.2022):
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 550 · 📥 300 · 📦 780 · 📋 440 - 16% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/NicolasHug/Surprise) (👨‍💻 44 · 🔀 940 · 📋 370 - 17% open · ⏱️ 31.10.2022):
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 400 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 5.1K / month):
	```
...
<details><summary><b><a href="https://github.com/jfkirk/tensorrec">tensorrec</a></b> (🥉20 ·  ⭐ 1.2K · 💀) - A Recommendation Engine Framework in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 27 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 2.9K / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 460 · 📦 100 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 530 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 78 · 🔀 140 · 📦 49K · 📋 280 - 25% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 580K / month):
	```
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 990K · ⏱️ 15.12.2022):
	```
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 410 · 🔀 4.3K · 📦 130K · 📋 3.3K - 27% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 9.7M / month):
	```
	pip install fastapi
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 880 · 📥 4.2K · 📦 7.5K · 📋 970 - 15% open · ⏱️ 18.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/falcon) (📥 640K / month):
	```
	pip install falcon
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 320 · 🔀 1.4K · 📦 8.9K · 📋 1.3K - 4% open · ⏱️ 27.12.2022):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 870K / month):
	```
	pip install sanic
	```
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 1.8K · 📋 460 - 35% open · ⏱️ 10.08.2020):
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 91 · 🔀 410 · 📦 720 · 📋 310 - 7% open · ⏱️ 31.08.2021):

	```
	git clone https://github.com/encode/apistar
	```
- [PyPi](https://pypi.org/project/apistar) (📥 8.8K / month):
	```
	pip install apistar
	```
...
- [GitHub](https://github.com/Cornices/cornice) (👨‍💻 120 · 🔀 140 · 📦 780 · 📋 240 - 19% open · ⏱️ 18.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/cornice) (📥 30K / month):
	```
	pip install cornice
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.1K · 📋 310 - 4% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.7K · 📥 480K · 📦 51K · 📋 12K - 32% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 400 · 🔀 2.5K · 📥 26 · 📦 79K · 📋 4.9K - 47% open · ⏱️ 17.01.2023):

	```
	git clone https://github.com/statsmodels/statsmodels
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 8.6M / month):
	```
	pip install statsmodels
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 8.5M · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 440 · 🔀 1.7K · 📥 1.9K · 📦 1.1K · 📋 2.9K - 5% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/pymc-devs/pymc3
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 330K / month):
	```
	pip install pymc3
	```
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 96 · 🔀 340 · 📋 3K - 3% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 130 / month):
	```
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 8.6K · 📋 1.2K - 36% open · ⏱️ 21.11.2022):
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 300 · 📦 2.9K · 📋 140 - 15% open · ⏱️ 12.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/pysolr) (📥 210K / month):
	```
	pip install pysolr
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 45 · 📦 760 · 📋 79 - 13% open · ⏱️ 12.09.2022):
...
- [PyPi](https://pypi.org/project/pysimdjson) (📥 230K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 51K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 19 · 🔀 42 · 📦 3.2K · 📋 100 - 11% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 840K / month):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 84 · 🔀 330 · 📋 330 - 6% open · ⏱️ 02.01.2023):
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 48 · 🔀 220 · 📦 170 · 📋 90 - 41% open · ⏱️ 03.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 4.7K / month):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 570 · 📥 7.9K · 📋 2.4K - 10% open · ⏱️ 23.01.2023):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 27K · 📋 240 - 11% open · ⏱️ 21.01.2023):

	```
	git clone https://github.com/jazzband/tablib
	```
- [PyPi](https://pypi.org/project/tablib) (📥 1.4M / month):
	```
	pip install tablib
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 55K · 📋 830 - 1% open · ⏱️ 14.01.2023):
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 560 · 📦 1.3K · 📋 860 - 7% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/csvkit) (📥 160K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 79K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 440 · 📥 25K · 📦 27K · 📋 1.7K - 14% open · ⏱️ 21.01.2023):
...
- [PyPi](https://pypi.org/project/xlwings) (📥 75K / month):
	...
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 530K · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/pyexcel/pyexcel) (👨‍💻 20 · 🔀 160 · 📥 160 · 📦 2.9K · 📋 200 - 5% open · ⏱️ 09.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyexcel) (📥 160K / month):
	```
	pip install pyexcel
	```
...
- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 160 · 🔀 1K · 📋 640 - 11% open · ⏱️ 26.01.2023):
...
<details><summary><b><a href="https://github.com/python-openxml/python-docx">python-docx</a></b> (🥉22 ·  ⭐ 3.4K · 💀) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 830 · 📋 1K - 48% open · ⏱️ 15.05.2021):
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 51 · 🔀 320 · 📦 1.6K · 📋 390 - 19% open · ⏱️ 07.01.2023):
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 56 · 📦 10 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 32 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 720 · 📦 6.5K · 📋 1.6K - 4% open · ⏱️ 20.01.2023):
...
- [PyPi](https://pypi.org/project/nikola) (📥 900 / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 7.1K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 150 · 🔀 560 · 📋 400 - 18% open · ⏱️ 21.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-taggit) (📥 350K / month):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 12K · 📋 1K - 18% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 670K / month):
	```
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 84K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 350 · 📦 1.1K · ⏱️ 13.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/huey) (📥 62K / month):
	```
	pip install huey
	```
- [Conda](https://anaconda.org/conda-forge/huey) (📥 28K · ⏱️ 16.10.2019):
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 86 · 🔀 230 · 📥 34 · 📦 580 · 📋 310 - 11% open · ⏱️ 28.12.2022):

	```
	git clone https://github.com/Bogdanp/dramatiq
	```
- [PyPi](https://pypi.org/project/dramatiq) (📥 95K / month):
	```
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 940 - 5% open · ⏱️ 20.01.2023):
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 500 · 🔀 1.7K · 📦 100K · 📋 610 - 2% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 6.9M / month):
	```
	pip install faker
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 170 · 🔀 2K · 📥 540 · 📦 6.7K · 📋 4K - 5% open · ⏱️ 18.01.2023):
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 300 · 📥 84 · 📦 18K · 📋 250 - 0% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 8.2M / month):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 520 · 📦 16K · 📋 1.4K - 3% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 3.7M / month):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7.1M · ⏱️ 24.01.2023):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6K · 📋 510 - 8% open · ⏱️ 25.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/splinter) (📥 86K / month):
	```
...
<details><summary><b><a href="https://github.com/kevin1024/vcrpy">VCR.py</a></b> (🥈31 ·  ⭐ 2.4K) - Record and replay HTTP interactions on your tests. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 980 · 📦 20K · 📋 600 - 64% open · ⏱️ 14.09.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 380 · 📦 1.1K · 📋 310 - 0% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 84K / month):
	```
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 75K · ⏱️ 18.12.2022):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.5K · 📋 1.4K - 0% open · ⏱️ 16.01.2023):

	```
	git clone https://github.com/locustio/locust
	```
- [PyPi](https://pypi.org/project/locust) (📥 1.2M / month):
	```
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 96K · ⏱️ 06.01.2023):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 250 · 📦 7.1K · 📋 230 - 39% open · ⏱️ 16.10.2022):
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 51 · 🔀 110 · 📦 150 · 📋 690 - 16% open · ⏱️ 14.01.2023):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 48K / month):
	```
	pip install schemathesis
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 2.9K · ⏱️ 13.11.2022):
	```
...
- [PyPi](https://pypi.org/project/freezegun) (📥 5.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 660K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 5.7K · 📋 260 - 19% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/nose-devs/nose2
	```
- [PyPi](https://pypi.org/project/nose2) (📥 490K / month):
	```
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 81K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 190 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 140 / month):
	```
	pip install sixpack
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 38 · 🔀 72 · 📦 770 · 📋 180 - 2% open · ⏱️ 20.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/green) (📥 9.5K / month):
	```
	pip install green
	```
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 48 · 📦 1.9K · 📋 26 - 42% open · ⏱️ 28.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/httmock) (📥 380K / month):
	```
	pip install httmock
	```
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 68K / month):
	```
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 43 · 🔀 90 · 📋 84 - 41% open · ⏱️ 23.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/mixer) (📥 80K / month):
	```
	pip install mixer
	```
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 53 · 🔀 230 · 📥 7.5K · 📦 710K · 📋 280 - 13% open · ⏱️ 23.01.2023):
...
- [PyPi](https://pypi.org/project/shortuuid) (📥 3.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 300K · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 880 · 📦 3.4K · ⏱️ 18.09.2022):

	```
	git clone https://github.com/orsinium/textdistance
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 450K / month):
	```
	pip install textdistance
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 300K · ⏱️ 18.09.2022):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 100 · 📦 26K · 📋 48 - 27% open · ⏱️ 16.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 860K / month):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 31 · 🔀 91 · 📋 63 - 1% open · ⏱️ 22.11.2022):
...
- [PyPi](https://pypi.org/project/python-slugify) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 1.3M · ⏱️ 19.11.2022):
	```
...
- [PyPi](https://pypi.org/project/ply) (📥 20M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 3M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 8.6K · 📋 130 - 9% open · ⏱️ 25.10.2022):
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 47 · 📦 2.1K · 📋 18 - 55% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 29K / month):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 230 - 8% open · ⏱️ 15.01.2023):
...
<details><summary><b><a href="https://github.com/derek73/python-nameparser">python-nameparser</a></b> (🥉19 ·  ⭐ 580) - Parsing human names into their individual components. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/voronind/awesome-slugify) (👨‍💻 11 · 🔀 41 · 📦 3.2K · 📋 24 - 54% open · ⏱️ 20.01.2017):
	...
	```
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 51K / month):
	```
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 27 · 🔀 370 · 📋 160 - 3% open · ⏱️ 24.01.2023):
...
<details><summary><b><a href="https://github.com/boto/boto3">boto3</a></b> (🥇37 ·  ⭐ 7.8K) - Python interface to Amazon Web Services. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.6K · 📦 240K · 📋 2.8K - 4% open · ⏱️ 25.01.2023):
...
- [PyPi](https://pypi.org/project/boto3) (📥 500M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 14M · ⏱️ 26.01.2023):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 130K · 📋 960 - 8% open · ⏱️ 25.01.2023):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 41M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 1.8M · ⏱️ 24.01.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 860 · 📥 240 · 📦 20K · 📋 770 - 6% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 390 · 📦 5.7K · 📋 320 - 6% open · ⏱️ 16.07.2021):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.5K · 📋 280 - 2% open · ⏱️ 25.01.2023):
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 58 · 📦 7.6K · ⏱️ 06.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 71K / month):
	```
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 15 · 🔀 140 · 📋 110 - 26% open · ⏱️ 01.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 2.6M / month):
	```
	pip install furl
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 210 · 📥 710 · 📦 280 · 📋 250 - 1% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/abhiTronix/vidgear
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 3.6K / month):
	```
	pip install vidgear
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.1K · 📋 440 - 27% open · ⏱️ 24.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 73K / month):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 240 · 🔀 740 · 📋 610 - 26% open · ⏱️ 01.01.2023):
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 860 · 📦 9.6K · 📋 370 - 44% open · ⏱️ 10.05.2020):

	```
	git clone https://github.com/psf/requests-html
	```
- [PyPi](https://pypi.org/project/requests-html) (📥 790K / month):
	```
	pip install requests-html
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 4.8K · ⏱️ 26.06.2021):
	```
...
- [PyPi](https://pypi.org/project/sumy) (📥 25K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 3.7K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 85 · 📦 880 · ⏱️ 14.12.2022):

	```
	git clone https://github.com/coleifer/micawber
	```
- [PyPi](https://pypi.org/project/micawber) (📥 39K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 7.6K · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/Alir3z4/html2text) (👨‍💻 76 · 🔀 230 · 📋 200 - 39% open · ⏱️ 22.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/html2text) (📥 1.1M / month):
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 35 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 66 · 🔀 260 · ⏱️ 28.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 2K / month):
	```
	pip install grab
	```
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 3 · 🔀 530 · 📦 16 · 📋 65 - 20% open · ⏱️ 01.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/cola) (📥 81 / month):
	```
	pip install cola
	```
...
🔗&nbsp;<b><a href="https://github.com/shahraizali/awesome-django">awesome-django</a></b> ( ⭐ 1K)  - The Best Django Resource, Awesome Django for mature packages.
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 63 · 🔀 450 · 📦 84K · 📋 950 - 1% open · ⏱️ 18.01.2023):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 730 · 📋 1.2K - 5% open · ⏱️ 30.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/channels) (📥 530K / month):
	```
...
<details><summary><b><a href="https://github.com/benoitc/gunicorn">gunicorn</a></b> (🥇36 ·  ⭐ 8.7K) - Pre-forked, ported from Ruby's Unicorn project. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 840K · 📋 1.9K - 18% open · ⏱️ 17.01.2023):

	```
	git clone https://github.com/benoitc/gunicorn
	```
- [PyPi](https://pypi.org/project/gunicorn) (📥 23M / month):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 250 · 📦 910K · 📋 1K - 1% open · ⏱️ 20.01.2023):
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 50 · 🔀 150 · 📦 100K · 📋 210 - 6% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/waitress) (📥 2.7M / month):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 530 · 📋 160 - 14% open · ⏱️ 11.09.2022):
