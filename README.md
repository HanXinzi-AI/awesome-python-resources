...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 330 · 🔀 1.3K · 📦 13K · 📋 1.3K - 26% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/flask-admin/flask-admin
	```
- [PyPi](https://pypi.org/project/flask-admin) (📥 1.4M / month):
	```
...
<details><summary><b><a href="https://github.com/mher/flower">flower</a></b> (🥈26 ·  ⭐ 5K) - Real-time monitor and web admin for Celery. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/flower):
	...
	pip install flower
	```
- [Conda](https://anaconda.org/conda-forge/flower) (📥 99K · ⏱️ 04.07.2021):
	```
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 18 · 🔀 740 · 📦 21 · 📋 1.1K - 0% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 2.3K / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 750 · 📋 560 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 430 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 22 · 🔀 170 · 📦 30 · 📋 200 - 28% open · ⏱️ 09.08.2021):

	```
	git clone https://github.com/wooey/wooey
	```
- [PyPi](https://pypi.org/project/wooey) (📥 220 / month):
	```
	pip install wooey
	```
...
<details><summary><b><a href="https://github.com/jet-admin/jet-bridge">jet-bridge</a></b> (🥉13 ·  ⭐ 1.1K) - Admin panel framework for any application with nice UI (ex Jet Django). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 94 · 📋 11 - 63% open · ⏱️ 14.10.2021):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 800 · 🔀 32K · 📋 840 - 4% open · ⏱️ 28.10.2021):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 38M · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 69 · 🔀 450 · 📦 1.8K · 📋 390 - 2% open · ⏱️ 04.10.2021):
...
- [PyPi](https://pypi.org/project/transitions) (📥 200K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 61K · ⏱️ 04.10.2021):
	```
...
- [PyPi](https://pypi.org/project/algorithms) (📥 1.4K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 380 · ⏱️ 23.04.2021):
	```
	conda install -c conda-forge algorithms
	```
</details>
<details><summary><b><a href="https://github.com/tylerlaberge/PyPattyrn">PyPattyrn</a></b> (🥉19 ·  ⭐ 1.3K · 💀) - A simple yet effective library for implementing common design.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 110 · 📦 16 · ⏱️ 09.02.2020):

	```
	git clone https://github.com/tylerlaberge/PyPattyrn
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 100 · 🔀 450 · 📋 84 - 21% open · ⏱️ 24.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-ds) (📥 61 / month):
	```
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 110 · 🔀 350 · 📦 40K · 📋 520 - 11% open · ⏱️ 15.10.2021):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 4.3M / month):
	```
	pip install uvicorn
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 57 · 🔀 190 · 📦 12K · 📋 270 - 14% open · ⏱️ 16.04.2021):

	```
	git clone https://github.com/django/daphne
	```
- [PyPi](https://pypi.org/project/daphne) (📥 370K / month):
	```
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 64K · ⏱️ 07.04.2021):
	```
...
<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇32 ·  ⭐ 8.1K) - Ultra fast asyncio event loop. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 42 · 🔀 410 · 📥 350 · 📦 28K · 📋 270 - 18% open · ⏱️ 10.08.2021):

	```
	git clone https://github.com/MagicStack/uvloop
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 10M / month):
	```
	pip install uvloop
	```
- [Conda](https://anaconda.org/conda-forge/uvloop) (📥 400K · ⏱️ 11.08.2021):
	```
	conda install -c conda-forge uvloop
	```
</details>
<details><summary><b><a href="https://github.com/python-trio/trio">trio</a></b> (🥉27 ·  ⭐ 4.3K) - A friendly library for async concurrency and I/O. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 250 · 📦 1.6K · 📋 650 - 39% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 1.5M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 590K · ⏱️ 05.07.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 470 · 🔀 1.6K · 📥 6.9K · 📦 220 · 📋 2.4K - 19% open · ⏱️ 27.10.2021):
...
<details><summary><b><a href="https://github.com/quodlibet/mutagen">mutagen</a></b> (🥇27 ·  ⭐ 870 · 💤) - A Python module to handle audio metadata. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 34 · 🔀 120 · 📥 48K · 📦 5.6K · 📋 450 - 17% open · ⏱️ 14.03.2021):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 660K / month):
	```
	pip install mutagen
	```
...
<details><summary><b><a href="https://github.com/jiaaro/pydub">pydub</a></b> (🥈26 ·  ⭐ 5.7K) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 90 · 🔀 750 · 📦 9.2K · 📋 440 - 42% open · ⏱️ 08.06.2021):
...
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥈24 ·  ⭐ 380 · 💤) - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 20 · 🔀 86 · 📦 6.4K · 📋 71 - 38% open · ⏱️ 20.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/audioread) (📥 430K / month):
	```
...
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥈22 ·  ⭐ 320) - A tool for working with audio files, specifically MP3 files containing.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 22 · 🔀 45 · 📥 2.1K · 📦 1.5K · 📋 170 - 24% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/eyeD3):
	```
	pip install eyeD3
	```
...
<details><summary><b><a href="https://github.com/devsnd/tinytag">tinytag</a></b> (🥉21 ·  ⭐ 490) - A library for reading music meta data of MP3, OGG, FLAC and Wave files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 20 · 🔀 82 · 📦 420 · 📋 81 - 16% open · ⏱️ 28.08.2021):

	```
	git clone https://github.com/devsnd/tinytag
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 8.4K / month):
	```
	pip install tinytag
	```
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 91 · 🔀 750 · 📋 910 - 3% open · ⏱️ 27.10.2021):
...
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥉19 ·  ⭐ 780 · 💤) - Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.2K · 📦 18 · 📋 200 - 36% open · ⏱️ 03.06.2020):
...
- [GitHub](https://github.com/Parisson/TimeSide) (👨‍💻 19 · 🔀 52 · 📦 14 · 📋 200 - 26% open · ⏱️ 20.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 260 / month):
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉16 ·  ⭐ 500) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 63 · 📦 4 · 📋 29 - 27% open · ⏱️ 23.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/matchering) (📥 91 / month):
	```
...
<details><summary><b><a href="https://github.com/oauthlib/oauthlib">oauthlib</a></b> (🥇37 ·  ⭐ 2.3K) - A generic and thorough implementation of the OAuth request-signing.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 180 · 🔀 420 · 📦 180K · 📋 340 - 22% open · ⏱️ 22.10.2021):
...
- [PyPi](https://pypi.org/project/oauthlib) (📥 56M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 3.5M · ⏱️ 01.06.2021):
	```
	conda install -c conda-forge oauthlib
	```
</details>
<details><summary><b><a href="https://github.com/jpadilla/pyjwt">pyjwt</a></b> (🥈35 ·  ⭐ 4K) - JSON Web Token implementation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 100 · 🔀 510 · 📦 160K · 📋 330 - 22% open · ⏱️ 22.10.2021):

	```
	git clone https://github.com/jpadilla/pyjwt
	```
- [PyPi](https://pypi.org/project/pyjwt) (📥 57M / month):
	```
	pip install pyjwt
	```
...
<details><summary><b><a href="https://github.com/pennersr/django-allauth">django-allauth</a></b> (🥈33 ·  ⭐ 6.8K) - Authentication app for Django that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 540 · 🔀 2.4K · 📦 76K · 📋 1.8K - 18% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 500K / month):
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 800 · 📦 8.7K · 📋 130 - 37% open · ⏱️ 12.02.2018):

	```
	git clone https://github.com/joestump/python-oauth2
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 130K / month):
	```
...
- [GitHub](https://github.com/omab/python-social-auth) (👨‍💻 280 · 🔀 1.1K · 📦 5.1K · 📋 660 - 2% open · ⏱️ 04.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/python-social-auth) (📥 56K / month):
	```
...
<details><summary><b><a href="https://github.com/lepture/authlib">authlib</a></b> (🥉25 ·  ⭐ 2.8K) - JavaScript Object Signing and Encryption draft implementation. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/lepture/authlib) (👨‍💻 68 · 🔀 270 · 📋 280 - 8% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 3.5M / month):
	```
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 66K · ⏱️ 18.10.2021):
	```
	conda install -c conda-forge authlib
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/django-oauth-toolkit">django-oauth-toolkit</a></b> (🥉23 ·  ⭐ 2.4K · 📈) - OAuth 2 goodies for Django. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 190 · 🔀 590 · 📋 640 - 18% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/mpdavis/python-jose) (🔀 180 · 📦 9.4K · 📋 120 - 38% open · ⏱️ 12.10.2021):
...
<details><summary><b><a href="https://github.com/davedoesdev/python-jwt">python-jwt</a></b> (🥉13 ·  ⭐ 190) - A module for generating and verifying JSON Web Tokens. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/davedoesdev/python-jwt) (👨‍💻 5 · 🔀 23 · ⏱️ 28.10.2021):

	```
	git clone https://github.com/davedoesdev/python-jwt
	```
- [PyPi](https://pypi.org/project/python-jwt):
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 220 · 📋 490 - 15% open · ⏱️ 24.10.2021):

	```
	git clone https://github.com/pybuilder/pybuilder
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 17K / month):
	```
	pip install pybuilder
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 7.6K · ⏱️ 11.02.2019):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 53 · 🔀 580 · 📋 3.5K - 4% open · ⏱️ 26.10.2021):
...
<details><summary><b><a href="https://github.com/python-attrs/attrs">attrs</a></b> (🥇33 ·  ⭐ 3.7K) - Replacement for `__init__`, `__eq__`, `__repr__`, etc. boilerplate in class.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 110 · 🔀 260 · 📦 290K · 📋 500 - 20% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/python-attrs/attrs
	```
- [PyPi](https://pypi.org/project/attrs) (📥 88M / month):
	```
	pip install attrs
	```
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 11 · 🔀 43 · 📦 4.7K · 📋 45 - 4% open · ⏱️ 23.10.2021):

	```
	git clone https://github.com/jab/bidict
	```
- [PyPi](https://pypi.org/project/bidict) (📥 580K / month):
	```
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 100K · ⏱️ 23.10.2021):
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 71 · 📥 30 · 📦 1.7K · 📋 130 - 16% open · ⏱️ 22.08.2021):
...
<details><summary><b><a href="https://github.com/carlosescri/DottedDict">DottedDict</a></b> (🥉15 ·  ⭐ 130 · 💀) - A library that provides a method of accessing lists and dicts with.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 110 · 🔀 300 · 📥 2.9K · 📋 3.2K - 18% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 59 · 🔀 170 · 📦 600 · 📋 290 - 5% open · ⏱️ 19.10.2021):
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 49 · 🔀 120 · 📦 3.6K · 📋 190 - 12% open · ⏱️ 26.10.2021):

	```
	git clone https://github.com/lericson/pylibmc
	```
- [PyPi](https://pypi.org/project/pylibmc) (📥 140K / month):
	```
	pip install pylibmc
	```
...
<details><summary><b><a href="https://github.com/bbangert/beaker">beaker</a></b> (🥉20 ·  ⭐ 480 · 💤) - A WSGI middleware for sessions and caching. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 85 · 🔀 130 · 📦 3.1K · 📋 120 - 56% open · ⏱️ 08.10.2020):

	```
	git clone https://github.com/bbangert/beaker
	```
- [PyPi](https://pypi.org/project/beaker):
	```
	pip install beaker
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 270 · 🔀 1.4K · 📥 18K · 📦 91K · 📋 1.7K - 19% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 8.9M / month):
	```
	pip install black
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 420 · 📦 200K · 📋 1K - 2% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 300 · 📦 750 · 📋 970 - 7% open · ⏱️ 25.10.2021):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 110K / month):
	```
...
- [PyPi](https://pypi.org/project/yapf) (📥 1.7M / month):
	...
	pip install yapf
	```
- [Conda](https://anaconda.org/conda-forge/yapf) (📥 850K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 29 · 🔀 88 · 📦 1.2K · 📋 150 - 9% open · ⏱️ 27.10.2021):
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈25 ·  ⭐ 820 · 💀) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 38 · 🔀 78 · 📦 2.8K · 📋 120 - 55% open · ⏱️ 10.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/pylama) (📥 87K / month):
	```
	pip install pylama
	```
...
<details><summary><b><a href="https://github.com/PyCQA/prospector">prospector</a></b> (🥉23 ·  ⭐ 1.5K) - A tool to analyse Python code. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 77 · 🔀 140 · 📋 280 - 17% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 380K / month):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 340 · 📋 270 - 23% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 22K / month):
	```
...
<details><summary><b><a href="https://github.com/google/pytype">pytype</a></b> (🥉21 ·  ⭐ 3.5K) - Pytype checks and infers types for Python code - without.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/pytype) (👨‍💻 69 · 🔀 210 · 📋 450 - 21% open · ⏱️ 25.10.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 130K / month):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 150 · 📋 140 - 22% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 33K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 990 · 🔀 1.1K · 📋 1.4K - 10% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/tqdm/tqdm">tqdm</a></b> (🥇32 ·  ⭐ 20K) - Fast, extensible progress bar for loops and CLI. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1K · 📥 7.9K · 📦 220K · 📋 800 - 33% open · ⏱️ 20.09.2021):
...
- [PyPi](https://pypi.org/project/tqdm):
	...
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 8.3M · ⏱️ 20.09.2021):
	```
	conda install -c conda-forge tqdm
	```
</details>
<details><summary><b><a href="https://github.com/willmcgugan/rich">rich</a></b> (🥈31 ·  ⭐ 31K) - Python library for rich text and beautiful formatting in the terminal. Also.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 130 · 🔀 950 · 📦 7.9K · 📋 560 - 4% open · ⏱️ 16.10.2021):
...
- [PyPi](https://pypi.org/project/rich):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 420K · ⏱️ 06.10.2021):
	```
	conda install -c conda-forge rich
	```
</details>
<details><summary><b><a href="https://github.com/google/python-fire">python-fire</a></b> (🥈25 ·  ⭐ 20K) - A library for creating command line interfaces from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.2K · 📦 9.5K · 📋 240 - 39% open · ⏱️ 17.06.2021):

	```
	git clone https://github.com/google/python-fire
	```
- [PyPi](https://pypi.org/project/python-fire) (📥 86 / month):
	```
...
<details><summary><b><a href="https://github.com/peterbrittain/asciimatics">asciimatics</a></b> (🥈25 ·  ⭐ 2.8K) - A package to create full-screen text UIs (from interactive.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 37 · 🔀 210 · 📦 550 · 📋 260 - 7% open · ⏱️ 26.09.2021):
...
<details><summary><b><a href="https://github.com/rsalmei/alive-progress">alive-progress</a></b> (🥉21 ·  ⭐ 2.8K) - A new kind of Progress Bar, with real-time throughput, eta and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rsalmei/alive-progress) (🔀 110 · 📦 460 · 📋 85 - 22% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 19K / month):
	```
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 82 · 📦 130 · 📋 28 - 60% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 4.2K / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 190 · 🔀 560 · 📋 910 - 45% open · ⏱️ 21.10.2021):
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 140 · 🔀 3.2K · 📦 9.4K · 📋 700 - 16% open · ⏱️ 25.10.2021):
...
<details><summary><b><a href="https://github.com/nvbn/thefuck">thefuck</a></b> (🥇30 ·  ⭐ 64K) - Correcting your previous console command. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/dbcli/pgcli">pgcli</a></b> (🥈28 ·  ⭐ 9.9K) - PostgreSQL CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 160 · 🔀 440 · 📦 340 · 📋 610 - 20% open · ⏱️ 30.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 42K / month):
	```
	pip install pgcli
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 60 · 🔀 200 · 📋 280 - 19% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 4.5K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 78 · 🔀 810 · 📦 370 · 📋 240 - 7% open · ⏱️ 26.10.2021):
...
<details><summary><b><a href="https://github.com/laixintao/iredis">iredis</a></b> (🥉20 ·  ⭐ 1.6K) - Redis CLI with autocompletion and syntax highlighting. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 23 · 🔀 71 · 📥 6.1K · 📋 180 - 31% open · ⏱️ 17.08.2021):

	```
	git clone https://github.com/laixintao/iredis
	```
- [PyPi](https://pypi.org/project/iredis) (📥 920 / month):
	```
	pip install iredis
	```
...
<details><summary><b><a href="https://github.com/dbcli/litecli">litecli</a></b> (🥉20 ·  ⭐ 1.5K) - SQLite CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 20 · 🔀 50 · 📦 120 · 📋 67 - 28% open · ⏱️ 11.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/litecli) (📥 6.4K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 260 · 📦 35 · 📋 91 - 31% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/donnemartin/saws
	```
- [PyPi](https://pypi.org/project/saws):
	```
	pip install saws
	```
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 150 · 📥 510 · 📦 13 · 📋 69 - 82% open · ⏱️ 19.09.2018):
	...
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 410 / month):
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥉18 ·  ⭐ 420) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 21 · 🔀 37 · 📦 25 · 📋 220 - 14% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 43 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 31K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 90 · 🔀 1.6K · 📥 680K · 📦 600 · 📋 430 - 25% open · ⏱️ 15.10.2021):
...
<details><summary><b><a href="https://github.com/sirfz/tesserocr">tesserocr</a></b> (🥈26 ·  ⭐ 1.5K) - Another simple, Pillow-friendly, wrapper around the `tesseract-ocr`.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/tesserocr):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tesserocr) (📥 60K · ⏱️ 13.01.2021):
	```
...
- [PyPi](https://pypi.org/project/face_recognition) (📥 51K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/face_recognition) (📥 3.4K · ⏱️ 30.04.2021):
	```
	conda install -c conda-forge face_recognition
	```
</details>
<details><summary><b><a href="https://github.com/madmaze/pytesseract">pytesseract</a></b> (🥈25 ·  ⭐ 3.9K) - A wrapper for [Google Tesseract.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 38 · 🔀 540 · 📋 280 - 3% open · ⏱️ 25.10.2021):
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉21 ·  ⭐ 5.2K) - Open Source Differentiable Computer Vision Library for PyTorch. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 490 · 📥 140 · 📦 700 · 📋 470 - 20% open · ⏱️ 26.10.2021):
...
<details><summary><b><a href="https://github.com/henriquebastos/python-decouple">python-decouple</a></b> (🥇30 ·  ⭐ 1.9K · 📈) - Strict separation of settings from code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 27 · 🔀 140 · 📥 2 · 📦 50K · 📋 70 - 7% open · ⏱️ 30.09.2021):

	```
	git clone https://github.com/henriquebastos/python-decouple
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 670K / month):
	```
	pip install python-decouple
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 31K · ⏱️ 05.01.2021):
	```
...
- [PyPi](https://pypi.org/project/configobj):
	...
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 310K · ⏱️ 29.07.2018):
	```
	conda install -c conda-forge configobj
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉20 ·  ⭐ 5K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 81 · 🔀 370 · 📦 3 · 📋 900 - 9% open · ⏱️ 22.10.2021):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra):
	```
	pip install hydra
	```
- [Conda](https://anaconda.org/conda-forge/hydra) (📥 8.5K · ⏱️ 18.01.2021):
	```
...
<details><summary><b><a href="https://github.com/paramiko/paramiko">paramiko</a></b> (🥇27 ·  ⭐ 7.3K) - The leading native Python SSHv2 protocol library. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 160 · 🔀 1.7K · 📦 49K · 📋 1.3K - 52% open · ⏱️ 15.10.2021):
...
<details><summary><b><a href="https://github.com/blaze/blaze">Blaze</a></b> (🥇25 ·  ⭐ 3K · 💀) - NumPy and Pandas interface to Big Data. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 64 · 🔀 350 · 📦 7.9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze):
	```
	pip install blaze
	```
...
<details><summary><b><a href="https://github.com/awslabs/aws-data-wrangler">AWS Data Wrangler</a></b> (🥈20 ·  ⭐ 2.3K) - Pandas on AWS. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/awslabs/aws-data-wrangler) (👨‍💻 83 · 🔀 360 · 📥 98K · 📋 510 - 6% open · ⏱️ 19.10.2021):
...
<details><summary><b><a href="https://github.com/mining/mining">Open Mining</a></b> (🥉17 ·  ⭐ 1.2K · 💀) - Business Intelligence (BI) in Pandas interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 220 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining):
	```
	pip install mining
	```
...
<details><summary><b><a href="https://github.com/hi-primus/optimus">Optimus</a></b> (🥉15 ·  ⭐ 1.1K) - Agile Data Science Workflows made easy with PySpark. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 23 · 🔀 200 · 📋 220 - 15% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/Julian/jsonschema) (👨‍💻 92 · 🔀 470 · 📦 180K · 📋 610 - 10% open · ⏱️ 25.10.2021):
...
- [PyPi](https://pypi.org/project/jsonschema):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 8.1M · ⏱️ 20.10.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 87 · 🔀 190 · 📦 3.9K · 📋 230 - 16% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/voluptuous) (📥 1.7M / month):
	```
...
<details><summary><b><a href="https://github.com/keleshev/schema">schema</a></b> (🥉26 ·  ⭐ 2.5K) - A library for validating Python data structures. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/schema):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 35K · ⏱️ 01.02.2021):
	```
	conda install -c conda-forge schema
	```
</details>
<details><summary><b><a href="https://github.com/schematics/schematics">Schematics</a></b> (🥉22 ·  ⭐ 2.5K) - Data Structure Validation. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 7 · 🔀 18 · 📦 46 · 📋 14 - 21% open · ⏱️ 07.03.2018):
	...
	```
- [PyPi](https://pypi.org/project/valideer) (📥 98K / month):
	```
...
<details><summary><b><a href="https://github.com/mwaskom/seaborn">Seaborn</a></b> (🥇35 ·  ⭐ 8.9K) - Statistical data visualization using Matplotlib. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 160 · 🔀 1.5K · 📥 200 · 📦 120K · 📋 1.9K - 4% open · ⏱️ 23.10.2021):
...
- [PyPi](https://pypi.org/project/seaborn):
	...
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 3M · ⏱️ 16.08.2021):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 580 · 🔀 3.7K · 📦 40K · 📋 6.7K - 10% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈30 ·  ⭐ 7K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/altair):
	...
	pip install altair
	```
- [Conda](https://anaconda.org/conda-forge/altair) (📥 980K · ⏱️ 01.04.2020):
	```
	conda install -c conda-forge altair
	```
</details>
<details><summary><b><a href="https://github.com/SciTools/cartopy">Cartopy</a></b> (🥉28 ·  ⭐ 950) - A cartographic python library with matplotlib support. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 100 · 🔀 290 · 📦 2K · 📋 980 - 25% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/SciTools/cartopy
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 100K / month):
	```
	pip install cartopy
	```
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 55 · 🔀 420 · 📦 28 · 📋 550 - 35% open · ⏱️ 21.10.2021):

	```
	git clone https://github.com/bloomberg/bqplot
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 67K / month):
	```
	pip install bqplot
	```
...
<details><summary><b><a href="https://github.com/has2k1/plotnine">plotnine</a></b> (🥉25 ·  ⭐ 2.8K) - A grammar of graphics for Python based on ggplot2. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 160 · 🔀 560 · 📦 610 · 📋 1.3K - 26% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 36K / month):
	```
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 190K · ⏱️ 28.10.2021):
	```
	conda install -c conda-forge vispy
	```
</details>
<details><summary><b><a href="https://github.com/mingrammer/diagrams">diagrams</a></b> (🥉23 ·  ⭐ 15K) - Diagram as Code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 97 · 🔀 840 · 📋 300 - 54% open · ⏱️ 21.08.2021):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams):
	```
	pip install diagrams
	```
- [Conda](https://anaconda.org/conda-forge/diagrams) (📥 96K · ⏱️ 05.07.2021):
	```
...
<details><summary><b><a href="https://github.com/msiemens/tinydb">tinydb</a></b> (🥇25 ·  ⭐ 4.6K) - A tiny, document-oriented database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 68 · 🔀 400 · 📋 270 - 3% open · ⏱️ 27.10.2021):
...
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥉23 ·  ⭐ 490) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 68 · 📦 770 · 📋 140 - 37% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/zopefoundation/ZODB
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 61K / month):
	```
	pip install ZODB
	```
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 100 · 📦 740 · 📋 53 - 26% open · ⏱️ 15.11.2019):

	```
	git clone https://github.com/patx/pickledb
	```
- [PyPi](https://pypi.org/project/pickledb) (📥 34K / month):
	```
...
🔗&nbsp;<b><a href="https://github.com/planetopendata/awesome-sqlite">awesome-sqlite</a></b> ( ⭐ 150)  - A collection of awesome sqlite tools, scripts, books, etc.
...
<details><summary><b><a href="https://github.com/redis/redis-py">redis-py</a></b> (🥇32 ·  ⭐ 9.7K · 📈) - The Python client for Redis. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/redis/redis-py) (👨‍💻 270 · 🔀 1.9K · 📦 120K · 📋 930 - 5% open · ⏱️ 28.10.2021):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 400K · ⏱️ 01.06.2020):
	```
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 110 · 🔀 1.2K · 📦 97K · 📋 580 - 2% open · ⏱️ 02.10.2021):

	```
	git clone https://github.com/PyMySQL/PyMySQL
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 13M / month):
	```
	pip install PyMySQL
	```
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.2K · 📥 1.7K · 📦 8.1K · 📋 1.4K - 13% open · ⏱️ 03.08.2021):
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 34 · 🔀 130 · 📦 390 · 📋 200 - 11% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/mymarilyn/clickhouse-driver
	```
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 380K / month):
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 190 · 🔀 900 · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 150 · 📦 550 · 📋 200 - 10% open · ⏱️ 08.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/happybase) (📥 84K / month):
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 21 · 📦 9 · 📋 6 - 83% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 130 / month):
	```
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 68 · 🔀 250 · 📋 390 - 42% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 5.9M / month):
	```
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 46 · 🔀 190 · 📦 830 · 📋 88 - 15% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/maya) (📥 37K / month):
	```
	pip install maya
	```
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 36 · 📦 590 · 📋 34 - 8% open · ⏱️ 27.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/moment) (📥 72K / month):
	```
	pip install moment
	```
- [Conda](https://anaconda.org/conda-forge/moment) (📥 8.2K · ⏱️ 31.01.2019):
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 120 · 📦 650 · 📋 61 - 40% open · ⏱️ 06.12.2020):
...
<details><summary><b><a href="https://github.com/KoffeinFlummi/Chronyk">Chronyk</a></b> (🥉14 ·  ⭐ 320 · 💀) - A Python 3 library for parsing human-written times and dates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 13 · 📦 19 · 📋 9 - 44% open · ⏱️ 02.08.2015):

	```
	git clone https://github.com/KoffeinFlummi/Chronyk
	```
- [PyPi](https://pypi.org/project/Chronyk):
	```
	pip install Chronyk
	```
...
<details><summary><b><a href="https://github.com/shinux/PyTime">PyTime</a></b> (🥉12 ·  ⭐ 140) - An easy-to-use Python module which aims to operate date/time/datetime by.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/jazzband/django-debug-toolbar">django-debug-toolbar</a></b> (🥇31 ·  ⭐ 6.7K) - Display various debug information for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 250 · 🔀 820 · 📥 170 · 📦 44K · 📋 770 - 10% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-debug-toolbar) (📥 130K · ⏱️ 14.08.2021):
	```
	conda install -c conda-forge django-debug-toolbar
	```
</details>
<details><summary><b><a href="https://github.com/gotcha/ipdb">ipdb</a></b> (🥇27 ·  ⭐ 1.5K) - IPython-enabled [pdb](https://docs.python.org/3/library/pdb.html). <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 260 · 📥 6.8K · 📋 220 - 27% open · ⏱️ 21.10.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 490K / month):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 79K · ⏱️ 02.10.2021):
	```
	conda install -c conda-forge py-spy
	```
</details>
<details><summary><b><a href="https://github.com/flask-debugtoolbar/flask-debugtoolbar">flask-debugtoolbar</a></b> (🥈24 ·  ⭐ 820 · 💀) - A port of the django-debug-toolbar to flask. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/flask-debugtoolbar/flask-debugtoolbar) (👨‍💻 38 · 🔀 120 · 📦 15K · 📋 88 - 28% open · ⏱️ 14.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/flask-debugtoolbar) (📥 87K / month):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 78 · 🔀 180 · 📦 2.6K · 📋 270 - 46% open · ⏱️ 22.10.2021):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 160K / month):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 79 · 🔀 400 · 📦 2.6K · 📋 170 - 32% open · ⏱️ 25.10.2021):
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥈22 ·  ⭐ 5.5K) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 16 · 🔀 110 · 📋 78 - 28% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 100K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 1.4K · ⏱️ 23.06.2021):
	```
	conda install -c conda-forge icecream
	```
</details>
<details><summary><b><a href="https://github.com/pdbpp/pdbpp">pdb++</a></b> (🥈22 ·  ⭐ 820) - Another drop-in replacement for pdb. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 46 · 📦 2.3K · 📋 180 - 34% open · ⏱️ 28.09.2021):
...
<details><summary><b><a href="https://github.com/ionelmc/python-hunter">python-hunter</a></b> (🥉19 ·  ⭐ 650) - A flexible code tracing toolkit. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/Kozea/wdb">wdb</a></b> (🥉17 ·  ⭐ 1.5K · 💀) - An improbable web debugger through WebSockets. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 100 · 📦 100 · 📋 110 - 26% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb):
	```
	pip install wdb
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 71 · 📦 2 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 51 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 36 · 📦 2 · 📋 12 - 50% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 130 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 3.8K · 🔀 69K · 📦 160K · 📋 33K - 8% open · ⏱️ 28.10.2021):
...
- [PyPi](https://pypi.org/project/tensorflow):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 2.9M · ⏱️ 25.10.2021):
	```
	conda install -c conda-forge tensorflow
	```
</details>
<details><summary><b><a href="https://github.com/Theano/Theano">Theano</a></b> (🥈30 ·  ⭐ 9.5K) - A library for fast numerical computation. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Theano/Theano) (👨‍💻 380 · 🔀 2.4K · 📦 12K · 📋 2.7K - 21% open · ⏱️ 13.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/Theano):
	```
	pip install Theano
	```
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥈29 ·  ⭐ 52K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 2.9K · 🔀 14K · 📥 94 · 📋 23K - 30% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 41K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 260K · ⏱️ 26.10.2021):
	```
	conda install -c conda-forge pytorch
	```
</details>
<details><summary><b><a href="https://github.com/keras-team/keras">keras</a></b> (🥉26 ·  ⭐ 53K) - A high-level neural networks library and capable of running on top.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/keras-team/keras) (👨‍💻 990 · 🔀 18K · 📋 11K - 2% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 970 · 🔀 6.5K · 📥 24K · 📋 9.4K - 18% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/SerpentAI/SerpentAI">SerpentAI</a></b> (🥉16 ·  ⭐ 6.1K · 💀) - Game agent framework. Use any video game as a deep learning sandbox. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 690 · 📥 120 · ⏱️ 22.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 150 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.1K · 📦 120K · 📋 1.5K - 11% open · ⏱️ 25.10.2021):
...
- [PyPi](https://pypi.org/project/psutil) (📥 39M / month):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 8.6M · ⏱️ 29.06.2021):
	```
	conda install -c conda-forge psutil
	```
</details>
<details><summary><b><a href="https://github.com/ansible/ansible">ansible</a></b> (🥈30 ·  ⭐ 50K) - A radically simple IT automation platform. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.5K · 🔀 20K · 📦 19K · 📋 30K - 3% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/saltstack/salt">saltstack</a></b> (🥈27 ·  ⭐ 12K) - Infrastructure automation and management system. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.7K · 🔀 5K · 📥 16K · 📋 24K - 8% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/nickstenning/honcho">honcho</a></b> (🥉22 ·  ⭐ 1.4K · 💀) - A Python clone of [Foreman](https://github.com/ddollar/foreman), for.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 41 · 🔀 130 · 📦 3.1K · 📋 98 - 21% open · ⏱️ 22.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/honcho):
	```
	pip install honcho
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 190 · 📦 270 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools) (📥 2.9K / month):
	```
...
- [GitHub](https://github.com/sebastien/cuisine) (👨‍💻 57 · 🔀 160 · 📦 140 · 📋 100 - 23% open · ⏱️ 27.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/cuisine) (📥 1.6K / month):
	```
	pip install cuisine
	```
...
<details><summary><b><a href="https://github.com/Fizzadar/pyinfra">pyinfra</a></b> (🥉18 ·  ⭐ 1.4K) - A versatile CLI tools and python libraries to automate infrastructure. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 53 · 🔀 130 · 📦 33 · 📋 490 - 18% open · ⏱️ 15.10.2021):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra):
	```
	pip install pyinfra
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 570 · 🔀 2.2K · 📦 1.6K · 📋 910 - 7% open · ⏱️ 26.10.2021):

	```
	git clone https://github.com/spotify/luigi
	```
- [PyPi](https://pypi.org/project/luigi) (📥 790K / month):
	```
	pip install luigi
	```
...
<details><summary><b><a href="https://github.com/dask/dask">dask</a></b> (🥈30 ·  ⭐ 9K) - A flexible parallel computing library for analytic computing. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/dask/dask) (👨‍💻 480 · 🔀 1.3K · 📦 31K · 📋 3.9K - 15% open · ⏱️ 28.10.2021):
...
- [PyPi](https://pypi.org/project/dask):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 4.4M · ⏱️ 23.10.2021):
	```
...
- [PyPi](https://pypi.org/project/mrjob) (📥 100K / month):
	...
	pip install mrjob
	```
- [Conda](https://anaconda.org/conda-forge/mrjob) (📥 410K · ⏱️ 24.12.2020):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 2.9K · 📋 8.2K - 21% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/robinhood/faust">faust</a></b> (🥉21 ·  ⭐ 5.8K · 💤) - A stream processing library, porting the ideas from [Kafka.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/robinhood/faust) (👨‍💻 91 · 🔀 480 · 📦 870 · 📋 450 - 47% open · ⏱️ 09.10.2020):
...
<details><summary><b><a href="https://github.com/pyinstaller/pyinstaller">PyInstaller</a></b> (🥇27 ·  ⭐ 8.5K) - Converts Python programs into stand-alone executables.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 410 · 🔀 1.6K · 📥 720K · 📋 4.3K - 7% open · ⏱️ 26.10.2021):
...
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈25 ·  ⭐ 1.2K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 17 · 🔀 150 · 📥 18 · 📦 280 · 📋 580 - 1% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 78K / month):
	```
	pip install pyarmor
	```
...
<details><summary><b><a href="https://github.com/linkedin/shiv">shiv</a></b> (🥉18 ·  ⭐ 1.3K) - A command line utility for building fully self-contained zipapps (PEP 441),.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 70 · 📥 150 · 📋 89 - 29% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/shiv) (📥 7.5K / month):
	```
	pip install shiv
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.5K · 📦 160K · 📋 5.6K - 14% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 31 · 🔀 110 · 📦 440 · 📋 190 - 4% open · ⏱️ 09.10.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 91K / month):
	```
	pip install pdoc
	```
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 130 · 📦 240 · 📋 56 - 50% open · ⏱️ 20.12.2019):
...
<details><summary><b><a href="https://github.com/s3tools/s3cmd">s3cmd</a></b> (🥇26 ·  ⭐ 3.7K) - A command line tool for managing Amazon S3 and CloudFront. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.6M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 5.2K · ⏱️ 22.12.2018):
	```
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 18 · 🔀 860 · 📦 110 · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 890 · 📦 190 · 📋 370 - 21% open · ⏱️ 28.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 3.8K / month):
	```
...
<details><summary><b><a href="https://github.com/MicroPyramid/forex-python">forex-python</a></b> (🥈20 ·  ⭐ 430) - Foreign exchange rates, Bitcoin price index and currency conversion. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 21 · 🔀 140 · 📦 970 · 📋 57 - 24% open · ⏱️ 02.09.2021):
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 25 · 📦 220 · 📋 23 - 30% open · ⏱️ 04.09.2016):
	...
	```
- [PyPi](https://pypi.org/project/money) (📥 42K / month):
	```
	pip install money
	```
...
<details><summary><b><a href="https://github.com/stephenmcd/cartridge">Cartridge</a></b> (🥉19 ·  ⭐ 630) - A shopping cart app built using the Mezzanine. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 74 · 🔀 280 · 📦 180 · 📋 150 - 15% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/cartridge):
	```
...
<details><summary><b><a href="https://github.com/lxneng/alipay">alipay</a></b> (🥉12 ·  ⭐ 320 · 💀) - Unofficial Alipay API for Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 93 · 📦 97 · 📋 14 - 14% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay):
	```
	pip install alipay
	```
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 230 · 🔀 1.3K · 📥 980K · 📦 20K · 📋 13K - 8% open · ⏱️ 18.10.2021):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 97K / month):
	```
	pip install spyder
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 80 · 🔀 230 · 📦 200 · 📋 1.5K - 22% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 1K / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/DamnWidget/anaconda) (👨‍💻 89 · 🔀 240 · 📋 770 - 21% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/DamnWidget/anaconda
	```
- [PyPi](https://pypi.org/project/anaconda) (📥 24K / month):
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 170 · 🔀 2.6K · 📋 3.1K - 1% open · ⏱️ 20.10.2021):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 72 · 🔀 640 · 📥 32K · 📋 4K - 1% open · ⏱️ 22.10.2021):
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 100 · 🔀 270 · 📦 32 · 📋 1.6K - 4% open · ⏱️ 07.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 3.4K / month):
	```
	pip install modoboa
	```
...
<details><summary><b><a href="https://github.com/kootenpv/yagmail">yagmail</a></b> (🥈24 ·  ⭐ 2.1K) - Yet another Gmail/SMTP client. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 27 · 🔀 240 · 📦 1.7K · 📋 180 - 43% open · ⏱️ 30.08.2021):
...
- [PyPi](https://pypi.org/project/yagmail):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 8.3K · ⏱️ 30.08.2021):
	```
	conda install -c conda-forge yagmail
	```
</details>
<details><summary><b><a href="https://github.com/mailgun/flanker">flanker</a></b> (🥈24 ·  ⭐ 1.5K · 💤) - An email address and Mime parsing library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 54 · 🔀 170 · 📦 170 · 📋 88 - 59% open · ⏱️ 29.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/flanker) (📥 51K / month):
	```
	pip install flanker
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 48 · 🔀 150 · 📦 110 · 📋 110 - 42% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 7.8K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 50 · 📥 120 · 📋 72 - 36% open · ⏱️ 20.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/mailer) (📥 29K / month):
	```
	pip install mailer
	```
- [Conda](https://anaconda.org/conda-forge/mailer) (📥 43K · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 50 · 📥 48 · 📦 14 · 📋 89 - 17% open · ⏱️ 05.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/salmon) (📥 56 / month):
	```
	pip install salmon
	```
...
<details><summary><b><a href="https://github.com/pyenv/pyenv">pyenv</a></b> (🥇23 ·  ⭐ 25K) - Simple Python version management. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 340 · 🔀 2.2K · 📋 1.3K - 2% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 62 · 🔀 850 · 📋 1.2K - 5% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 120 · 🔀 590 · 📦 42K · 📋 540 - 27% open · ⏱️ 01.10.2021):

	```
	git clone https://github.com/gorakhargosh/watchdog
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 4.7M / month):
	```
	pip install watchdog
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 800K · ⏱️ 02.10.2021):
	```
	conda install -c conda-forge watchdog
	```
</details>
<details><summary><b><a href="https://github.com/ahupp/python-magic">python-magic</a></b> (🥈25 ·  ⭐ 2K) - A Python interface to the libmagic file type identification.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 53 · 🔀 220 · 📦 20K · 📋 160 - 14% open · ⏱️ 23.10.2021):
...
<details><summary><b><a href="https://github.com/mikeorr/Unipath">Unipath</a></b> (🥉15 ·  ⭐ 500 · 💀) - An object-oriented approach to file/directory operations. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 37 · 📦 6.1K · 📋 17 - 41% open · ⏱️ 14.02.2015):

	```
	git clone https://github.com/mikeorr/Unipath
	```
- [PyPi](https://pypi.org/project/Unipath):
	```
	pip install Unipath
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 53K · 📋 150 - 11% open · ⏱️ 25.10.2021):
...
<details><summary><b><a href="https://github.com/django-crispy-forms/django-crispy-forms">django-crispy-forms</a></b> (🥈27 ·  ⭐ 4.3K) - A Django app which lets you create beautiful forms in a.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 660 · 📦 76K · 📋 630 - 9% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 97 · 🔀 680 · 📦 16K · 📋 290 - 1% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 81 · 🔀 170 · 📥 2.4K · 📦 110K · 📋 180 - 3% open · ⏱️ 23.10.2021):
...
- [PyPi](https://pypi.org/project/more-itertools):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 7.7M · ⏱️ 17.09.2021):
	```
	conda install -c conda-forge more-itertools
	```
</details>
<details><summary><b><a href="https://github.com/pytoolz/toolz">Toolz</a></b> (🥈29 ·  ⭐ 3.7K) - A collection of functional utilities for iterators, functions, and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 70 · 🔀 210 · 📦 48K · 📋 210 - 35% open · ⏱️ 28.10.2021):
...
- [PyPi](https://pypi.org/project/toolz):
	...
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 5.3M · ⏱️ 24.09.2020):
	```
	conda install -c conda-forge toolz
	```
</details>
<details><summary><b><a href="https://github.com/Suor/funcy">funcy</a></b> (🥈27 ·  ⭐ 2.7K) - A fancy and practical functional tools. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 28 · 🔀 120 · 📦 3.7K · 📋 66 - 6% open · ⏱️ 14.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/funcy) (📥 660K / month):
	```
	pip install funcy
	```
- [Conda](https://anaconda.org/conda-forge/funcy) (📥 160K · ⏱️ 10.05.2021):
	```
	conda install -c conda-forge funcy
	```
</details>
<details><summary><b><a href="https://github.com/dry-python/returns">returns</a></b> (🥉23 ·  ⭐ 1.9K) - A set of type-safe monads, transformers, and composition utilities. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/dry-python/returns) (👨‍💻 35 · 🔀 82 · 📦 110 · 📋 360 - 13% open · ⏱️ 25.10.2021):
...
- [PyPi](https://pypi.org/project/returns):
	...
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 420 · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 27 · 🔀 99 · 📋 510 - 12% open · ⏱️ 06.03.2021):

	```
	git clone https://github.com/evhub/coconut
	```
- [PyPi](https://pypi.org/project/coconut) (📥 890 / month):
	```
	pip install coconut
	```
...
<details><summary><b><a href="https://github.com/pytoolz/cytoolz">CyToolz</a></b> (🥉18 ·  ⭐ 800) - Cython implementation of `Toolz`: High performance functional.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 61 · 📦 32K · 📋 60 - 33% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇28 ·  ⭐ 960) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 120 · 🔀 190 · 📦 14K · 📋 290 - 21% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/ChrisKnott/Eel">Eel</a></b> (🥈27 ·  ⭐ 4.6K) - A library for making simple Electron-like offline HTML/JS GUI apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ChrisKnott/Eel) (👨‍💻 38 · 🔀 460 · 📦 2.7K · 📋 420 - 28% open · ⏱️ 19.10.2021):

	```
	git clone https://github.com/ChrisKnott/Eel
	```
- [PyPi](https://pypi.org/project/Eel) (📥 44K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 99 · 🔀 760 · 📥 140 · 📦 440 · 📋 490 - 16% open · ⏱️ 12.06.2021):
...
- [PyPi](https://pypi.org/project/Gooey) (📥 3.8K / month):
	...
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 40K · ⏱️ 13.06.2021):
	```
	conda install -c conda-forge Gooey
	```
</details>
<details><summary><b><a href="https://github.com/PySimpleGUI/PySimpleGUI">PySimpleGUI</a></b> (🥈26 ·  ⭐ 8.7K) - Wrapper for tkinter, Qt, WxPython and Remi. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.3K · 📦 3.7K · 📋 2.4K - 26% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/PySimpleGUI):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 41K · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 250 · 📦 94 · 📋 420 - 18% open · ⏱️ 16.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 1.1K / month):
	```
	pip install flexx
	```
...
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉23 ·  ⭐ 6.2K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 280 · 📦 200 · 📋 770 - 11% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 340 · 📦 530 · 📋 560 - 3% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 34 · 🔀 110 · 📥 46 · 📦 190 · 📋 210 - 18% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/enaml):
	```
	pip install enaml
	```
- [Conda](https://anaconda.org/conda-forge/enaml) (📥 93K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 200 · 🔀 500 · 📋 500 - 24% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/graphql-python/graphene) (🔀 720 · 📦 11K · 📋 920 - 11% open · ⏱️ 30.09.2021):
...
<details><summary><b><a href="https://github.com/geopy/geopy">geopy</a></b> (🥇30 ·  ⭐ 3.5K) - Python Geocoding Toolbox. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/geopy/geopy) (👨‍💻 120 · 🔀 540 · 📦 28K · 📋 250 - 8% open · ⏱️ 26.09.2021):
...
<details><summary><b><a href="https://github.com/jazzband/geojson">geojson</a></b> (🥈20 ·  ⭐ 660) - Python bindings and utilities for GeoJSON. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 44 · 🔀 84 · 📦 7.9K · 📋 77 - 24% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/maxmind/geoip-api-python) (👨‍💻 13 · 🔀 53 · 📦 900 · ⏱️ 11.02.2021):
...
<details><summary><b><a href="https://github.com/martinblech/xmltodict">xmltodict</a></b> (🥈30 ·  ⭐ 4.6K · 💀) - Working with XML feel like you are working with JSON. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 50 · 🔀 170 · 📦 12K · 📋 170 - 24% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 1M / month):
	```
	pip install pyquery
	```
...
- [PyPi](https://pypi.org/project/untangle) (📥 150K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 1.8K · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 700 · 🔀 8.2K · 📦 1.2M · 📋 3.5K - 5% open · ⏱️ 21.10.2021):
...
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈32 ·  ⭐ 7.8K) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 140 · 🔀 500 · 📦 12K · 📋 620 - 7% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/httpx) (📥 5M / month):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 84K · ⏱️ 13.10.2021):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 290 · 🔀 830 · 📥 870 · 📦 680K · 📋 960 - 13% open · ⏱️ 26.10.2021):
...
<details><summary><b><a href="https://github.com/spyoungtech/grequests">grequests</a></b> (🥉27 ·  ⭐ 3.9K) - requests + gevent for asynchronous HTTP requests. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/httplib2/httplib2">httplib2</a></b> (🥉25 ·  ⭐ 420) - Comprehensive HTTP client library. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 67 · 🔀 150 · 📦 88K · 📋 100 - 38% open · ⏱️ 11.10.2021):
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 45 · 🔀 130 · 📥 110 · 📦 870 · 📋 140 - 37% open · ⏱️ 11.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/treq) (📥 66K / month):
	```
	pip install treq
	```
...
<details><summary><b><a href="https://github.com/boppreh/keyboard">keyboard</a></b> (🥇29 ·  ⭐ 2.6K) - Hook and simulate global keyboard events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 33 · 🔀 300 · 📦 4.8K · 📋 440 - 62% open · ⏱️ 29.09.2021):
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 360 · 🔀 1.5K · 📦 6.4K · 📋 1.2K - 2% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 78 · 📦 420 · 📋 86 - 70% open · ⏱️ 05.04.2021):
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 96 · 🔀 180 · 📥 5.3K · 📦 7K · 📋 360 - 3% open · ⏱️ 05.10.2021):
...
- [PyPi](https://pypi.org/project/wand):
	...
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 7K · ⏱️ 30.11.2020):
	```
	conda install -c conda-forge wand
	```
</details>
<details><summary><b><a href="https://github.com/thumbor/thumbor">thumbor</a></b> (🥇25 ·  ⭐ 8.6K) - A smart imaging service. It enables on-demand crop, re-sizing and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 160 · 🔀 710 · 📦 280 · 📋 850 - 14% open · ⏱️ 13.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/thumbor):
	```
	pip install thumbor
	```
...
<details><summary><b><a href="https://github.com/python-pillow/Pillow">pillow</a></b> (🥈23 ·  ⭐ 9.1K · 📉) - Pillow is the friendly.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 370 · 🔀 1.6K · 📋 2.3K - 6% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 38 · 🔀 85 · 📥 170 · 📦 9K · 📋 78 - 38% open · ⏱️ 11.10.2021):
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 11 · 🔀 30 · 📦 230 · 📋 250 - 35% open · ⏱️ 20.10.2021):
...
- [GitHub](https://github.com/hhatto/nude.py) (👨‍💻 12 · 🔀 130 · 📦 1K · 📋 10 - 70% open · ⏱️ 23.11.2020):
...
<details><summary><b><a href="https://github.com/rossgoodwin/hmap">hmap</a></b> (🥉8 ·  ⭐ 190 · 💀) - Image histogram remapping. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 19 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap):
	```
	pip install hmap
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 440 · 🔀 3.6K · 📥 26K · 📋 3.9K - 27% open · ⏱️ 28.10.2021):
...
- [PyPi](https://pypi.org/project/micropython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micropython) (📥 4.7K · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 29 · 🔀 180 · 📥 12K · 📋 420 - 45% open · ⏱️ 25.10.2021):
...
<details><summary><b><a href="https://github.com/python/cpython">CPython</a></b> (🥈17 ·  ⭐ 41K) - **Default, most widely used implementation of the Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/cpython) (👨‍💻 1.8K · 🔀 20K · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/Maratyszcza/PeachPy">PeachPy</a></b> (🥉15 ·  ⭐ 1.6K) - x86-64 assembler embedded in Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 21 · 🔀 120 · 📦 7 · 📋 82 - 25% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 24 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 17 · 🔀 64 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 800 / month):
	```
	pip install Pyjion
	```
...
<details><summary><b><a href="https://github.com/prompt-toolkit/ptpython">ptpython</a></b> (🥇27 ·  ⭐ 4.3K) - Advanced Python REPL built on top of the [python-prompt-.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 50 · 🔀 250 · 📦 1.6K · 📋 330 - 55% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 240K / month):
	```
	pip install ptpython
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 5.8K · ⏱️ 27.09.2021):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 120 · 🔀 200 · 📋 750 - 17% open · ⏱️ 22.10.2021):
...
- [PyPi](https://pypi.org/project/bpython) (📥 70K / month):
	...
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 29K · ⏱️ 26.01.2021):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 58 · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 140K / month):
	```
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 69K · ⏱️ 15.01.2021):
	```
...
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥇31 ·  ⭐ 7.6K) - A modern workflow orchestration framework that makes it easy to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 260 · 🔀 700 · 📦 470 · 📋 1.9K - 19% open · ⏱️ 22.10.2021):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 190K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 220K · ⏱️ 21.10.2021):
	```
	conda install -c conda-forge prefect
	```
</details>
<details><summary><b><a href="https://github.com/dbader/schedule">schedule</a></b> (🥈30 ·  ⭐ 9.1K) - Python job scheduling for humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dbader/schedule) (👨‍💻 45 · 🔀 750 · 📦 14K · 📋 340 - 29% open · ⏱️ 26.06.2021):
...
- [PyPi](https://pypi.org/project/schedule) (📥 1.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 9.6K · ⏱️ 10.04.2021):
	```
	conda install -c conda-forge schedule
	```
</details>
<details><summary><b><a href="https://github.com/sartography/SpiffWorkflow">Spiff</a></b> (🥈18 ·  ⭐ 1K) - A powerful workflow engine implemented in pure Python. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 40 · 🔀 230 · 📦 26 · 📋 68 - 7% open · ⏱️ 19.10.2021):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow):
	```
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 64 · 📋 9 - 11% open · ⏱️ 14.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/plan) (📥 330 / month):
	```
	pip install plan
	```
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥇29 ·  ⭐ 10K) - Library which aims to bring enjoyable logging in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/dmlc/xgboost">xgboost</a></b> (🥇34 ·  ⭐ 22K) - A scalable, portable, and distributed gradient boosting library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 540 · 🔀 7.7K · 📥 3.2K · 📦 23K · 📋 4.2K - 5% open · ⏱️ 28.10.2021):
...
- [PyPi](https://pypi.org/project/xgboost):
	...
	pip install xgboost
	```
- [Conda](https://anaconda.org/conda-forge/xgboost) (📥 2M · ⏱️ 24.10.2021):
	```
	conda install -c conda-forge xgboost
	```
</details>
<details><summary><b><a href="https://github.com/openai/gym">gym</a></b> (🥈31 ·  ⭐ 26K) - A toolkit for developing and comparing reinforcement learning.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/openai/gym) (👨‍💻 320 · 🔀 6.8K · 📦 24K · 📋 1.4K - 6% open · ⏱️ 25.10.2021):
...
- [PyPi](https://pypi.org/project/gym):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 74K · ⏱️ 07.09.2021):
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 220 · 🔀 1.8K · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉16 ·  ⭐ 4K) - MindsDB is an open source AI layer for existing databases that allows.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 76 · 🔀 540 · 📋 740 - 9% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb):
	```
	pip install mindsdb
	```
...
<details><summary><b><a href="https://github.com/mhammond/pywin32">PyWin32</a></b> (🥇25 ·  ⭐ 3.4K) - Python Extensions for Windows. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 68 · 🔀 630 · 📥 490K · 📦 57K · 📋 1.6K - 26% open · ⏱️ 24.10.2021):
...
<details><summary><b><a href="https://github.com/pythonnet/pythonnet">PythonNet</a></b> (🥉24 ·  ⭐ 2.8K) - Python Integration with the .NET Common Language Runtime (CLR). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 95 · 🔀 460 · 📦 45 · 📋 1K - 16% open · ⏱️ 22.10.2021):

	```
	git clone https://github.com/pythonnet/pythonnet
	```
- [PyPi](https://pypi.org/project/pythonnet):
	```
...
<details><summary><b><a href="https://github.com/pallets/itsdangerous">itsdangerous</a></b> (🥇34 ·  ⭐ 2.3K) - Various helpers to pass trusted data to untrusted environments. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 38 · 🔀 180 · 📦 500K · ⏱️ 06.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 61M / month):
	```
	pip install itsdangerous
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 2.4M · ⏱️ 18.05.2021):
	```
...
- [PyPi](https://pypi.org/project/boltons) (📥 1.1M / month):
	...
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 510K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.4K · 📦 310 · 📋 850 - 33% open · ⏱️ 30.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/magenta) (📥 5.8K / month):
	```
	pip install magenta
	```
...
<details><summary><b><a href="https://github.com/jek/blinker">blinker</a></b> (🥉25 ·  ⭐ 1.3K · 💤) - A fast Python in-process signal/event dispatching system. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/blinker):
	...
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 3.6M · ⏱️ 20.06.2018):
	```
	conda install -c conda-forge blinker
	```
</details>
<details><summary><b><a href="https://github.com/mitsuhiko/pluginbase">pluginbase</a></b> (🥉19 ·  ⭐ 980) - A simple but flexible plugin system for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 990 · ⏱️ 16.05.2021):
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 410 · 🔀 3.9K · 📥 3.5K · 📦 28K · 📋 1.7K - 20% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/RaRe-Technologies/gensim
	```
- [PyPi](https://pypi.org/project/gensim) (📥 16M / month):
	```
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 740K · ⏱️ 20.09.2021):
	```
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.2K · 📦 12K · 📋 780 - 73% open · ⏱️ 15.02.2020):
...
- [PyPi](https://pypi.org/project/jieba) (📥 470K / month):
	...
	pip install jieba
	```
- [Conda](https://anaconda.org/conda-forge/jieba) (📥 96K · ⏱️ 30.05.2021):
	```
...
- [PyPi](https://pypi.org/project/pattern) (📥 100K / month):
	...
	pip install pattern
	```
- [Conda](https://anaconda.org/conda-forge/pattern) (📥 8.7K · ⏱️ 05.05.2020):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 880 · 📥 70K · 📦 150 · 📋 140 - 72% open · ⏱️ 21.06.2020):
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 41 · 🔀 730 · 📦 700 · 📋 590 - 11% open · ⏱️ 05.10.2021):
...
- [PyPi](https://pypi.org/project/stanza):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 1.8K · ⏱️ 17.08.2021):
	```
...
- [PyPi](https://pypi.org/project/snownlp):
	...
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 170 · ⏱️ 07.09.2021):
	```
	conda install -c conda-forge snownlp
	```
</details>
<details><summary><b><a href="https://github.com/PetrochukM/PyTorch-NLP">PyTorch-NLP</a></b> (🥈21 ·  ⭐ 2K) - A toolkit enabling rapid deep learning NLP prototyping for research. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 240 · 📦 300 · 📋 65 - 24% open · ⏱️ 10.07.2021):
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 210 · 🔀 790 · 📥 280 · 📦 100 · 📋 130 - 44% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/napalm-automation/napalm">napalm</a></b> (🥇25 ·  ⭐ 1.8K) - Cross-vendor API to manipulate network devices. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 170 · 🔀 460 · 📦 710 · 📋 520 - 21% open · ⏱️ 22.10.2021):
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 77 · 🔀 1.5K · 📥 400K · 📦 110 · 📋 640 - 40% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mininet) (📥 980 / month):
	```
	pip install mininet
	```
...
<details><summary><b><a href="https://github.com/noxrepo/pox">pox</a></b> (🥉19 ·  ⭐ 550 · 💀) - A Python-based SDN control applications, such as OpenFlow SDN.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 420 · 📋 170 - 24% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 1.9M / month):
	```
	pip install pox
	```
...
<details><summary><b><a href="https://github.com/coleifer/peewee">peewee</a></b> (🥇31 ·  ⭐ 8.7K) - A small, expressive ORM. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 140 · 🔀 1.3K · 📦 14K · 📋 2.1K - 0% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/peewee):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 360K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 370 · 🔀 1.1K · 📦 15K · 📋 1.6K - 21% open · ⏱️ 25.10.2021):
...
<details><summary><b><a href="https://github.com/pynamodb/PynamoDB">PynamoDB</a></b> (🥈26 ·  ⭐ 1.8K) - A Pythonic interface for [Amazon.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 90 · 🔀 370 · 📦 820 · 📋 460 - 40% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/dataset):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 980 · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 200 · 📦 2.2K · 📋 550 - 44% open · ⏱️ 28.02.2021):
...
<details><summary><b><a href="https://github.com/encode/orm">orm</a></b> (🥉19 ·  ⭐ 1.4K) - An async ORM. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/orm) (👨‍💻 14 · 🔀 81 · 📋 65 - 21% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/encode/orm
	```
- [PyPi](https://pypi.org/project/orm) (📥 3.1K / month):
	```
	pip install orm
	```
...
<details><summary><b><a href="https://github.com/sdispater/orator">orator</a></b> (🥉17 ·  ⭐ 1.3K · 💀) - The Orator ORM provides a simple yet beautiful ActiveRecord.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 23 · 📋 10 - 50% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 710 / month):
	```
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 84 · 📋 51 - 70% open · ⏱️ 06.06.2016):
	...
	```
- [PyPi](https://pypi.org/project/redisco) (📥 300 / month):
	```
	pip install redisco
	```
...
<details><summary><b><a href="https://github.com/python-poetry/poetry">poetry</a></b> (🥇30 ·  ⭐ 17K) - Python dependency management and packaging made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 290 · 🔀 1.4K · 📥 8.9M · 📋 3.2K - 33% open · ⏱️ 10.10.2021):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 3.9M / month):
	```
	pip install poetry
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 410 · 📋 760 - 13% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/pypa/warehouse) (👨‍💻 310 · 🔀 720 · 📋 2.4K - 13% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/pypa/bandersnatch">bandersnatch</a></b> (🥉12 ·  ⭐ 270) - PyPI mirroring tool provided by Python Packaging Authority.. <code><a href="https://tldrlegal.com/search?q=AFL-3.0">❗️AFL-3.0</a></code></summary>
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.4K · 📋 4.5K - 1% open · ⏱️ 26.10.2021):
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉19 ·  ⭐ 7.1K · 💤) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 21 · 🔀 1.5K · 📋 110 - 14% open · ⏱️ 16.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 500 / month):
	```
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉16 ·  ⭐ 7K) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/trustedsec/social-engineer-toolkit) (👨‍💻 81 · 🔀 2K · 📋 770 - 21% open · ⏱️ 20.07.2021):
...
<details><summary><b><a href="https://github.com/django-guardian/django-guardian">django-guardian</a></b> (🥇24 ·  ⭐ 3.1K) - Implementation of per object permissions for Django.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 510 · 📦 4.4K · 📋 430 - 25% open · ⏱️ 23.10.2021):
...
<details><summary><b><a href="https://github.com/dfunckt/django-rules">django-rules</a></b> (🥉21 ·  ⭐ 1.4K) - A tiny but powerful app providing object-level permissions to.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 21 · 🔀 100 · 📦 690 · 📋 98 - 18% open · ⏱️ 23.05.2021):

	```
	git clone https://github.com/dfunckt/django-rules
	```
- [PyPi](https://pypi.org/project/django-rules):
	```
...
<details><summary><b><a href="https://github.com/amoffat/sh">sh</a></b> (🥇30 ·  ⭐ 5.9K) - A full-fledged subprocess replacement for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/amitt001/delegator.py">delegator.py</a></b> (🥉13 ·  ⭐ 1.6K · 💀) - .. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/amitt001/delegator.py) (👨‍💻 23 · 🔀 77 · 📋 45 - 17% open · ⏱️ 06.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/delegator.py):
	```
...
<details><summary><b><a href="https://github.com/spotify/annoy">annoy</a></b> (🥇24 ·  ⭐ 9.1K · 📉) - Approximate Nearest Neighbors in C++/Python optimized for memory.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/spotify/annoy) (👨‍💻 74 · 🔀 950 · 📦 1.8K · 📋 340 - 10% open · ⏱️ 18.10.2021):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 600 · 📦 570 · 📋 430 - 20% open · ⏱️ 07.02.2021):
...
<details><summary><b><a href="https://github.com/benfred/implicit">implicit</a></b> (🥈22 ·  ⭐ 2.5K) - A fast Python implementation of collaborative filtering for implicit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/NicolasHug/Surprise">Surprise</a></b> (🥉20 ·  ⭐ 5.1K · 💀) - A scikit for building and analyzing recommender systems. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/ibayer/fastFM">fastFM</a></b> (🥉18 ·  ⭐ 950 · 💤) - A library for Factorization Machines. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 190 · 📥 400 · 📦 88 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 680 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 66 · 🔀 120 · 📦 32K · 📋 230 - 30% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/rope) (📥 530K / month):
	```
	pip install rope
	```
...
<details><summary><b><a href="https://github.com/sanic-org/sanic">sanic</a></b> (🥇33 ·  ⭐ 16K) - A Python 3.6+ web server and web framework that's written to go fast. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 300 · 🔀 1.4K · 📦 6K · 📋 1.1K - 4% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 5.9M / month):
	```
	pip install sanic
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 180 · 🔀 830 · 📥 1.4K · 📦 5.9K · 📋 920 - 20% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 930 · 📦 66K · 📋 530 - 15% open · ⏱️ 07.07.2021):
...
- [PyPi](https://pypi.org/project/flask-restful) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-restful) (📥 97K · ⏱️ 30.05.2021):
	```
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 360 · 📦 1.2K · 📋 450 - 34% open · ⏱️ 10.08.2020):

	```
	git clone https://github.com/hugapi/hug
	```
- [PyPi](https://pypi.org/project/hug) (📥 35K / month):
	```
	pip install hug
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥉27 ·  ⭐ 37K) - A modern, fast, web framework for building APIs with Python 3.6+ based on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 270 · 🔀 2.7K · 📋 2.5K - 32% open · ⏱️ 26.10.2021):
...
- [PyPi](https://pypi.org/project/fastapi):
	...
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 420K · ⏱️ 07.10.2021):
	```
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 200 · 🔀 720 · 📦 980 · 📋 950 - 3% open · ⏱️ 14.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/eve) (📥 17K / month):
	```
	pip install eve
	```
...
<details><summary><b><a href="https://github.com/flask-api/flask-api">flask-api</a></b> (🥉22 ·  ⭐ 1.3K) - Browsable Web APIs for Flask. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 32 · 🔀 160 · 📦 4.7K · 📋 62 - 17% open · ⏱️ 01.09.2021):
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 180 · 📦 16 · 📋 78 - 33% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 290 / month):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 92 · 🔀 4.2K · 📋 250 - 2% open · ⏱️ 26.10.2021):
...
<details><summary><b><a href="https://github.com/sympy/sympy">SymPy</a></b> (🥇33 ·  ⭐ 8.5K) - A Python library for symbolic mathematics. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.4K · 📥 440K · 📦 36K · 📋 11K - 32% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 340 · 🔀 2.2K · 📥 26 · 📦 52K · 📋 4.5K - 45% open · ⏱️ 24.10.2021):
...
- [PyPi](https://pypi.org/project/statsmodels):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 5.1M · ⏱️ 03.10.2021):
	```
	conda install -c conda-forge statsmodels
	```
</details>
<details><summary><b><a href="https://github.com/quantopian/zipline">Zipline</a></b> (🥈27 ·  ⭐ 15K · 💤) - A Pythonic algorithmic trading library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 150 · 🔀 3.8K · 📦 790 · 📋 960 - 32% open · ⏱️ 14.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/zipline):
	```
	pip install zipline
	```
...
<details><summary><b><a href="https://github.com/pymc-devs/pymc">PyMC</a></b> (🥉24 ·  ⭐ 6.1K) - Markov Chain Monte Carlo sampling toolkit. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 330 · 🔀 1.4K · 📥 590 · 📦 560 · 📋 2.4K - 8% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/pymc-devs/pymc3
	```
- [PyPi](https://pypi.org/project/pymc3):
	```
	pip install pymc3
	```
...
<details><summary><b><a href="https://github.com/benedekrozemberczki/karateclub">Karate Club</a></b> (🥉23 ·  ⭐ 1.4K) - Unsupervised machine learning toolbox for graph structured data. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 13 · 🔀 160 · 📦 58 · ⏱️ 25.10.2021):

	```
	git clone https://github.com/benedekrozemberczki/karateclub
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 6.5K / month):
	```
	pip install karateclub
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 6.8K · ⏱️ 05.08.2021):
	```
	conda install -c conda-forge karateclub
	```
</details>
<details><summary><b><a href="https://github.com/bcbio/bcbio-nextgen">bcbio-nextgen</a></b> (🥉19 ·  ⭐ 840) - Providing best-practice pipelines for fully automated high.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 93 · 🔀 330 · 📋 2.9K - 2% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/chapmanb/bcbio-nextgen
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen):
	```
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 200 · 🔀 1.2K · 📦 7.4K · 📋 1.2K - 36% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-haystack) (📥 99K / month):
	```
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 120 · 🔀 690 · 📥 100 · 📦 5.2K · 📋 1.2K - 7% open · ⏱️ 12.08.2021):
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 300 · 📦 2.4K · 📋 140 - 13% open · ⏱️ 26.10.2021):
...
- [PyPi](https://pypi.org/project/marshmallow):
	...
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 820K · ⏱️ 19.10.2021):
	```
...
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 730K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 690K · ⏱️ 16.10.2021):
	```
	conda install -c conda-forge python-rapidjson
	```
</details>
<details><summary><b><a href="https://github.com/TkTech/pysimdjson">pysimdjson</a></b> (🥉22 ·  ⭐ 490) - A Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 12 · 🔀 34 · 📦 140 · 📋 68 - 14% open · ⏱️ 21.06.2021):
...
- [PyPi](https://pypi.org/project/pysimdjson) (📥 72K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 14K · ⏱️ 28.10.2021):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 75 · 🔀 300 · 📋 310 - 13% open · ⏱️ 19.10.2021):
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 47 · 🔀 210 · 📦 140 · 📋 87 - 39% open · ⏱️ 14.07.2021):
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 490 · 📥 5.4K · 📦 250 · 📋 2.2K - 13% open · ⏱️ 15.10.2021):
...
<details><summary><b><a href="https://github.com/jazzband/tablib">tablib</a></b> (🥇32 ·  ⭐ 4K) - A module for Tabular Datasets in XLS, CSV, JSON, YAML. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 110 · 🔀 550 · 📦 12K · 📋 230 - 12% open · ⏱️ 26.10.2021):

	```
	git clone https://github.com/jazzband/tablib
	```
- [PyPi](https://pypi.org/project/tablib) (📥 880K / month):
	```
	pip install tablib
	```
- [Conda](https://anaconda.org/conda-forge/tablib) (📥 68K · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 55 · 🔀 380 · 📥 27K · 📦 19K · 📋 1.4K - 22% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 650K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 380K · ⏱️ 27.10.2021):
	```
	conda install -c conda-forge xlwings
	```
</details>
<details><summary><b><a href="https://github.com/wireservice/csvkit">csvkit</a></b> (🥈27 ·  ⭐ 4.8K) - Utilities for converting to and working with CSV. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 540 · 📦 950 · 📋 830 - 6% open · ⏱️ 08.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/csvkit) (📥 46K / month):
	```
	pip install csvkit
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 45 · 🔀 540 · 📦 41K · 📋 740 - 1% open · ⏱️ 12.10.2021):

	```
	git clone https://github.com/jmcnamara/XlsxWriter
	```
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 7.8M / month):
	```
...
- [GitHub](https://github.com/euske/pdfminer) (👨‍💻 28 · 🔀 960 · 📦 2.6K · 📋 230 - 82% open · ⏱️ 18.01.2020):
...
<details><summary><b><a href="https://github.com/pyexcel/pyexcel">pyexcel</a></b> (🥈26 ·  ⭐ 970) - Providing one API for reading, manipulating and writing csv, ods,.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 150 · 🔀 670 · 📦 160K · 📋 720 - 4% open · ⏱️ 11.08.2021):
...
<details><summary><b><a href="https://github.com/lepture/mistune">Mistune</a></b> (🥉23 ·  ⭐ 2K · 📉) - Fastest and full featured pure Python parsers of Markdown. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lepture/mistune) (👨‍💻 31 · 🔀 190 · 📋 210 - 8% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/mistune):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 5.2M · ⏱️ 29.06.2021):
	```
	conda install -c conda-forge mistune
	```
</details>
<details><summary><b><a href="https://github.com/python-openxml/python-docx">python-docx</a></b> (🥉22 ·  ⭐ 2.8K) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 720 · 📋 870 - 44% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 930K / month):
	```
...
- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 330 · 📋 650 - 41% open · ⏱️ 20.09.2021):
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 59 · 📦 8 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 52 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 420 · 🔀 1.7K · 📥 430 · 📦 5.3K · 📋 1.5K - 2% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 1.8K · 📦 16K · 📋 1.6K - 6% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 220 · 🔀 330 · 📦 390 · 📋 2.1K - 1% open · ⏱️ 13.10.2021):
...
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇31 ·  ⭐ 7.9K) - Simple job queues for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/rq/rq) (👨‍💻 250 · 🔀 1.2K · 📦 9K · 📋 920 - 17% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 510K / month):
	```
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 63K · ⏱️ 30.06.2021):
	```
	conda install -c conda-forge rq
	```
</details>
<details><summary><b><a href="https://github.com/coleifer/huey">huey</a></b> (🥈27 ·  ⭐ 3.7K) - Little multi-threaded task queue. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/Bogdanp/dramatiq">dramatiq</a></b> (🥉24 ·  ⭐ 2.8K) - A fast and reliable background task processing library for Python.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 70 · 🔀 200 · 📥 32 · 📦 330 · 📋 260 - 7% open · ⏱️ 26.10.2021):
...
- [PyPi](https://pypi.org/project/dramatiq):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 25K · ⏱️ 23.10.2021):
	```
	conda install -c conda-forge dramatiq
	```
</details>
<details><summary><b><a href="https://github.com/pricingassistant/mrq">mrq</a></b> (🥉19 ·  ⭐ 850 · 💤) - A distributed worker task queue in Python using Redis & gevent. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇23 ·  ⭐ 8K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 290 · 🔀 1.4K · 📥 52K · 📋 800 - 4% open · ⏱️ 05.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/jinja) (📥 11K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 430 · 🔀 1.5K · 📦 41K · 📋 520 - 23% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 4.9M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 510K · ⏱️ 27.10.2021):
	```
	conda install -c conda-forge faker
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇32 ·  ⭐ 6.4K) - A generic test automation framework. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.4K · 📋 3.6K - 4% open · ⏱️ 21.10.2021):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 830K / month):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 100 · 🔀 260 · 📥 19 · 📦 11K · 📋 190 - 22% open · ⏱️ 25.10.2021):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 4.9M / month):
	```
	pip install responses
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 830K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 220 · 🔀 2.2K · 📦 1.9K · 📋 1.2K - 1% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/locust):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 40K · ⏱️ 19.10.2021):
	```
	conda install -c conda-forge locust
	```
</details>
<details><summary><b><a href="https://github.com/HypothesisWorks/hypothesis">hypothesis</a></b> (🥈30 ·  ⭐ 5.5K) - Hypothesis is an advanced Quickcheck style property based.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 450 · 📦 10K · 📋 1.2K - 5% open · ⏱️ 25.10.2021):
...
- [PyPi](https://pypi.org/project/hypothesis):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 4.9M · ⏱️ 23.10.2021):
	```
...
- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 240 · 📦 5.2K · 📋 220 - 37% open · ⏱️ 13.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/HTTPretty) (📥 420K / month):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 490 · 📦 5K · 📋 490 - 10% open · ⏱️ 25.10.2021):
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈26 ·  ⭐ 5.7K) - PyAutoGUI is a cross-platform GUI automation Python module for human.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 100 · 🔀 270 · 📥 180 · 📋 290 - 0% open · ⏱️ 24.10.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 87K / month):
	```
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 3.5K · ⏱️ 15.07.2020):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 120 · 🔀 320 · 📋 490 - 27% open · ⏱️ 19.10.2021):
...
<details><summary><b><a href="https://github.com/CleanCut/green">green</a></b> (🥉22 ·  ⭐ 710) - A clean, colorful test runner. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/spulec/freezegun">freezegun</a></b> (🥉20 ·  ⭐ 3K) - Travel through time by mocking the datetime module. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 48 · 📦 1.5K · 📋 26 - 42% open · ⏱️ 28.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/httmock) (📥 130K / month):
	```
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 5.5K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 19 · 🔀 36 · 📦 58 · 📋 53 - 3% open · ⏱️ 05.10.2021):
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 33 · 🔀 70 · 📋 580 - 16% open · ⏱️ 27.10.2021):
...
<details><summary><b><a href="https://github.com/klen/mixer">mixer</a></b> (🥉16 ·  ⭐ 770) - Another fixtures replacement. Supports Django, Flask, SQLAlchemy,.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/klen/mixer) (👨‍💻 41 · 🔀 87 · 📋 76 - 38% open · ⏱️ 13.10.2021):

	```
	git clone https://github.com/klen/mixer
	```
- [PyPi](https://pypi.org/project/mixer) (📥 58K / month):
	```
	pip install mixer
	```
...
<details><summary><b><a href="https://github.com/berinhard/model_mommy">model_mommy</a></b> (🥉14 ·  ⭐ 920 · 💀) - Creating random fixtures for testing in Django. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/pyparsing/pyparsing">pyparsing</a></b> (🥇35 ·  ⭐ 1.3K) - A general purpose framework for generating parsers. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 36 · 🔀 180 · 📥 6K · 📦 390K · 📋 200 - 10% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/pyparsing/pyparsing
	```
- [PyPi](https://pypi.org/project/pyparsing) (📥 71M / month):
	```
	pip install pyparsing
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 16M · ⏱️ 27.10.2021):
	```
...
<details><summary><b><a href="https://github.com/skorokithakis/shortuuid">shortuuid</a></b> (🥇27 ·  ⭐ 1.5K · 💤) - A generator library for concise, unambiguous and URL-safe UUIDs. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 22 · 🔀 91 · 📦 7K · 📋 31 - 6% open · ⏱️ 17.02.2021):
...
- [PyPi](https://pypi.org/project/shortuuid) (📥 1.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 120K · ⏱️ 12.07.2021):
	```
...
- [PyPi](https://pypi.org/project/sqlparse) (📥 30M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 490K · ⏱️ 10.09.2021):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 30 · 🔀 85 · 📦 21K · 📋 50 - 2% open · ⏱️ 12.05.2021):
...
- [PyPi](https://pypi.org/project/python-slugify):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 550K · ⏱️ 06.05.2021):
	```
	conda install -c conda-forge python-slugify
	```
</details>
<details><summary><b><a href="https://github.com/life4/textdistance">textdistance</a></b> (🥈24 ·  ⭐ 2.5K) - Compute distance between sequences with 30+ algorithms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/life4/textdistance) (👨‍💻 11 · 🔀 200 · 📥 290 · 📦 1.2K · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/textdistance):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 59K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 32 · 🔀 340 · 📋 170 - 14% open · ⏱️ 18.06.2020):

	```
	git clone https://github.com/dabeaz/ply
	```
- [PyPi](https://pypi.org/project/ply) (📥 4.9M / month):
	```
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 850K · ⏱️ 07.07.2018):
	```
	conda install -c conda-forge ply
	```
</details>
<details><summary><b><a href="https://github.com/chardet/chardet">chardet</a></b> (🥈22 ·  ⭐ 1.6K) - Python 2/3 compatible character encoding detector. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/chardet/chardet) (👨‍💻 44 · 🔀 210 · 📋 120 - 47% open · ⏱️ 22.10.2021):
...
<details><summary><b><a href="https://github.com/pwaller/pyfiglet">pyfiglet</a></b> (🥈22 ·  ⭐ 910) - An implementation of figlet written in Python. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/pyfiglet):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyfiglet) (📥 73K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 30 · 🔀 180 · 📦 3.3K · 📋 65 - 52% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/mozillazg/python-pinyin">pypinyin</a></b> (🥉18 ·  ⭐ 3.5K) - Convert Chinese hanzi () to pinyin (). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 20 · 🔀 500 · 📋 200 - 15% open · ⏱️ 06.10.2021):
...
- [GitHub](https://github.com/ztane/python-Levenshtein) (🔀 140 · 📦 9.6K · 📋 55 - 74% open · ⏱️ 01.02.2021):
...
- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 15 · 🔀 83 · 📦 740 · 📋 94 - 25% open · ⏱️ 09.08.2020):
...
<details><summary><b><a href="https://github.com/voronind/awesome-slugify">awesome-slugify</a></b> (🥉16 ·  ⭐ 460 · 💀) - A Python slugify library that can preserve unicode. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/awesome-slugify):
	...
	```
- [Conda](https://anaconda.org/conda-forge/awesome-slugify) (📥 55K · ⏱️ 28.06.2019):
	```
	conda install -c conda-forge awesome-slugify
	```
</details>
<details><summary><b><a href="https://github.com/mozilla/unicode-slugify">unicode-slugify</a></b> (🥉15 ·  ⭐ 300) - A slugifier that generates unicode slugs with Django.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 49 · 📦 1.9K · 📋 18 - 55% open · ⏱️ 22.10.2021):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 25 · 🔀 340 · 📋 130 - 2% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 21 · 📦 47 · 📋 8 - 37% open · ⏱️ 09.02.2019):
...
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥇35 ·  ⭐ 5.2K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 170 · 🔀 2K · 📥 93 · 📦 78K · 📋 840 - 3% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 33M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 930K · ⏱️ 26.10.2021):
	```
	conda install -c conda-forge google-api-python-client
	```
</details>
<details><summary><b><a href="https://github.com/boto/boto3">boto3</a></b> (🥈33 ·  ⭐ 6.8K) - Python interface to Amazon Web Services. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/boto/boto3) (👨‍💻 120 · 🔀 1.4K · 📦 140K · 📋 2.5K - 10% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/boto3):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 7.2M · ⏱️ 28.10.2021):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 130 · 🔀 820 · 📥 27 · 📦 12K · 📋 660 - 11% open · ⏱️ 25.10.2021):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 3.9M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 910 · 📦 3.2K · 📋 230 - 8% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/facebook-sdk) (📥 120K / month):
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 57 · 🔀 140 · 📦 3.2K · 📋 260 - 1% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 410K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 53 · 📦 2.5K · 📋 72 - 1% open · ⏱️ 29.07.2020):
...
<details><summary><b><a href="https://github.com/codeinthehole/purl">purl</a></b> (🥈22 ·  ⭐ 260) - A simple, immutable URL class with a clean API for interrogation and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 14 · 🔀 120 · 📋 99 - 20% open · ⏱️ 27.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 520K / month):
	```
	pip install furl
	```
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥇20 ·  ⭐ 2K) - Most Powerful multi-threaded Video Processing framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 7 · 🔀 150 · 📥 460 · 📦 140 · 📋 180 - 1% open · ⏱️ 27.10.2021):
...
<details><summary><b><a href="https://github.com/aizvorski/scikit-video">scikit-video</a></b> (🥉11 ·  ⭐ 100 · 💀) - Video processing routines for SciPy. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 23 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 47K / month):
	```
...
<details><summary><b><a href="https://github.com/jazzband/django-pipeline">django-pipeline</a></b> (🥇26 ·  ⭐ 1.4K) - An asset packaging library for Django. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/jschneier/django-storages">django-storages</a></b> (🥈24 ·  ⭐ 2K) - A collection of custom storage back ends for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 220 · 🔀 690 · 📋 540 - 25% open · ⏱️ 17.10.2021):

	```
	git clone https://github.com/jschneier/django-storages
	```
- [PyPi](https://pypi.org/project/django-storages) (📥 1.7M / month):
	```
	pip install django-storages
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 30K · ⏱️ 17.10.2021):
	```
	conda install -c conda-forge django-storages
	```
</details>
<details><summary><b><a href="https://github.com/miracle2k/webassets">webassets</a></b> (🥉23 ·  ⭐ 900) - Bundles, optimizes, and manages unique cache-busting URLs for.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 820 · 📦 6K · 📋 340 - 41% open · ⏱️ 10.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/requests-html) (📥 650K / month):
	```
	pip install requests-html
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 390 · ⏱️ 26.06.2021):
	```
	conda install -c conda-forge requests-html
	```
</details>
<details><summary><b><a href="https://github.com/miso-belica/sumy">sumy</a></b> (🥈26 ·  ⭐ 2.7K) - A module for automatic summarization of text documents and HTML pages. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 21 · 🔀 460 · 📦 950 · 📋 93 - 16% open · ⏱️ 21.10.2021):
...
- [PyPi](https://pypi.org/project/sumy) (📥 26K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 420 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 39 · 🔀 440 · 📋 200 - 37% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/textract) (📥 78K / month):
	```
...
<details><summary><b><a href="https://github.com/codelucas/newspaper">newspaper</a></b> (🥈23 ·  ⭐ 11K · 💀) - News extraction, article extraction and content curation.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/codelucas/newspaper) (👨‍💻 100 · 🔀 1.8K · 📦 3.1K · 📋 620 - 59% open · ⏱️ 02.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/newspaper):
	```
...
- [GitHub](https://github.com/Alir3z4/html2text) (👨‍💻 76 · 🔀 200 · 📋 190 - 35% open · ⏱️ 13.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/html2text) (📥 840K / month):
	```
	pip install html2text
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 7.1K · ⏱️ 09.02.2020):
	```
...
- [GitHub](https://github.com/buriy/python-readability) (👨‍💻 37 · 🔀 330 · 📦 850 · 📋 92 - 31% open · ⏱️ 24.09.2021):
...
<details><summary><b><a href="https://github.com/coleifer/micawber">micawber</a></b> (🥉20 ·  ⭐ 550) - A small library for extracting rich content from URLs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/micawber):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 1.4K · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/binux/pyspider) (👨‍💻 62 · 🔀 3.5K · 📦 300 · 📋 810 - 33% open · ⏱️ 02.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyspider) (📥 4.6K / month):
	```
...
<details><summary><b><a href="https://github.com/MechanicalSoup/MechanicalSoup">MechanicalSoup</a></b> (🥈22 ·  ⭐ 3.8K) - A Python library for automating interaction with websites. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 790 · 📋 73 - 58% open · ⏱️ 07.06.2015):
	...
	```
- [PyPi](https://pypi.org/project/robobrowser) (📥 6.2K / month):
	```
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 52 · 🔀 390 · 📦 42K · 📋 800 - 3% open · ⏱️ 24.10.2021):
...
- [PyPi](https://pypi.org/project/websockets) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 1M · ⏱️ 25.09.2021):
	```
...
- [GitHub](https://github.com/django/channels) (👨‍💻 230 · 🔀 680 · 📦 15K · 📋 1.1K - 8% open · ⏱️ 08.08.2021):

	```
	git clone https://github.com/django/channels
	```
- [PyPi](https://pypi.org/project/channels) (📥 390K / month):
	```
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 360 · 🔀 1.4K · 📥 98 · 📦 540K · 📋 1.7K - 17% open · ⏱️ 06.09.2021):

	```
	git clone https://github.com/benoitc/gunicorn
	```
- [PyPi](https://pypi.org/project/gunicorn) (📥 30M / month):
	```
	pip install gunicorn
	```
- [Conda](https://anaconda.org/conda-forge/gunicorn) (📥 770K · ⏱️ 11.05.2021):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 440 · 🔀 1.5K · 📥 250 · 📦 610K · 📋 900 - 2% open · ⏱️ 06.10.2021):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 63M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 3.6M · ⏱️ 20.05.2021):
	```
...
- [PyPi](https://pypi.org/project/bjoern) (📥 16K / month):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 55K · ⏱️ 13.10.2020):
	```
	conda install -c conda-forge bjoern
	```
</details>
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉21 ·  ⭐ 990) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 44 · 🔀 130 · 📋 190 - 8% open · ⏱️ 09.09.2021):
