...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 330 · 🔀 1.3K · 📦 13K · 📋 1.3K - 26% open · ⏱️ 08.11.2021):
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 180 · 🔀 830 · 📦 6.9K · 📋 790 - 7% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/flower) (📥 840K / month):
	```
	pip install flower
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 22 · 🔀 170 · 📦 30 · 📋 200 - 27% open · ⏱️ 09.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 170 / month):
	```
	pip install wooey
	```
...
<details><summary><b><a href="https://github.com/ajenti/ajenti">ajenti</a></b> (🥉20 ·  ⭐ 6.6K) - The admin panel your servers deserve. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 18 · 🔀 740 · 📦 21 · 📋 1.1K - 0% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 96 · 📋 11 - 63% open · ⏱️ 08.11.2021):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 220 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 820 · 🔀 32K · 📋 860 - 3% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 69 · 🔀 460 · 📦 1.8K · 📋 390 - 2% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/transitions) (📥 190K / month):
	```
	pip install transitions
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 89K · ⏱️ 04.10.2021):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 180 · 🔀 3.8K · 📦 53 · 📋 140 - 34% open · ⏱️ 08.11.2021):
...
- [PyPi](https://pypi.org/project/algorithms):
	...
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 400 · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 120 · 🔀 5.7K · 📋 74 - 16% open · ⏱️ 07.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-patterns) (📥 17 / month):
	```
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 110 · 🔀 350 · 📦 41K · 📋 520 - 11% open · ⏱️ 08.11.2021):
...
- [PyPi](https://pypi.org/project/uvicorn) (📥 4.4M / month):
	...
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 650K · ⏱️ 03.11.2021):
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 57 · 🔀 190 · 📦 12K · 📋 270 - 14% open · ⏱️ 09.11.2021):
...
- [PyPi](https://pypi.org/project/daphne) (📥 380K / month):
	...
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 66K · ⏱️ 07.04.2021):
	```
...
🔗&nbsp;<b><a href="https://github.com/timofurrer/awesome-asyncio">awesome-asyncio</a></b> ( ⭐ 3.2K)  - A curated list of awesome Python asyncio frameworks, libraries, software..

🔗&nbsp;<b><a href="https://twistedmatrix.com/trac/">Twisted</a></b>  - An event-driven networking engine.

<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇32 ·  ⭐ 8.2K) - Ultra fast asyncio event loop. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 42 · 🔀 410 · 📥 350 · 📦 29K · 📋 270 - 18% open · ⏱️ 10.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 8.7M / month):
	```
	pip install uvloop
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 250 · 📦 2.1K · 📋 650 - 39% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 3.1M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 620K · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 470 · 🔀 1.6K · 📥 6.9K · 📦 230 · 📋 2.4K - 18% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 35 · 🔀 120 · 📥 48K · 📦 5.7K · 📋 460 - 18% open · ⏱️ 31.10.2021):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 810K / month):
	```
	pip install mutagen
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 90 · 🔀 760 · 📦 9.4K · 📋 440 - 43% open · ⏱️ 08.06.2021):
...
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥈26 ·  ⭐ 380 · 💀) - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 20 · 🔀 87 · 📦 6.6K · 📋 71 - 38% open · ⏱️ 20.10.2020):
...
- [PyPi](https://pypi.org/project/audioread) (📥 440K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/audioread) (📥 360K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 25 · 🔀 1K · 📦 240 · 📋 270 - 59% open · ⏱️ 07.11.2021):
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 19 · 📦 1.2K · 📋 90 - 11% open · ⏱️ 25.03.2021):

	```
	git clone https://github.com/keunwoochoi/kapre
	```
- [PyPi](https://pypi.org/project/kapre) (📥 1.7K / month):
	```
	pip install kapre
	```
...
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥉22 ·  ⭐ 330) - A tool for working with audio files, specifically MP3 files containing.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 20 · 🔀 82 · 📦 430 · 📋 82 - 17% open · ⏱️ 28.08.2021):

	```
	git clone https://github.com/devsnd/tinytag
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 9.7K / month):
	```
	pip install tinytag
	```
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉19 ·  ⭐ 4.8K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 91 · 🔀 760 · 📋 920 - 3% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 63 · 📦 4 · 📋 32 - 34% open · ⏱️ 23.09.2021):
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 100 · 🔀 510 · 📦 160K · 📋 330 - 22% open · ⏱️ 09.11.2021):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 59M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 4.7M · ⏱️ 16.10.2021):
	```
...
- [PyPi](https://pypi.org/project/oauthlib):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 3.6M · ⏱️ 01.06.2021):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 540 · 🔀 2.4K · 📦 77K · 📋 1.8K - 18% open · ⏱️ 09.09.2021):
...
- [PyPi](https://pypi.org/project/django-allauth):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 67K · ⏱️ 23.12.2019):
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 800 · 📦 8.8K · 📋 130 - 37% open · ⏱️ 12.02.2018):
...
- [PyPi](https://pypi.org/project/python-oauth2):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-oauth2) (📥 83K · ⏱️ 28.06.2019):
	```
...
- [GitHub](https://github.com/omab/python-social-auth) (👨‍💻 280 · 🔀 1.1K · 📦 5.1K · 📋 660 - 2% open · ⏱️ 04.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/python-social-auth) (📥 51K / month):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 68 · 🔀 280 · 📋 280 - 8% open · ⏱️ 07.11.2021):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 3.7M / month):
	```
	pip install authlib
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 190 · 🔀 600 · 📋 640 - 18% open · ⏱️ 09.11.2021):
...
<details><summary><b><a href="https://github.com/mpdavis/python-jose">python-jose</a></b> (🥉23 ·  ⭐ 970) - A JOSE implementation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mpdavis/python-jose) (🔀 180 · 📦 9.6K · 📋 120 - 38% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 220 · 📋 490 - 15% open · ⏱️ 08.11.2021):
...
<details><summary><b><a href="https://github.com/platformio/platformio-core">PlatformIO</a></b> (🥉20 ·  ⭐ 5.5K) - A console tool to build code with different development platforms. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 55 · 🔀 580 · 📋 3.6K - 4% open · ⏱️ 09.11.2021):
...
<details><summary><b><a href="https://github.com/python-attrs/attrs">attrs</a></b> (🥇32 ·  ⭐ 3.7K) - Replacement for `__init__`, `__eq__`, `__repr__`, etc. boilerplate in class.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 110 · 🔀 270 · 📦 300K · 📋 500 - 19% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/python-attrs/attrs
	```
- [PyPi](https://pypi.org/project/attrs) (📥 90M / month):
	```
	pip install attrs
	```
...
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥈26 ·  ⭐ 930) - Efficient, Pythonic bidirectional map data structures and related.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/jab/bidict) (👨‍💻 11 · 🔀 44 · 📦 4.9K · 📋 46 - 4% open · ⏱️ 08.11.2021):
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 72 · 📥 30 · 📋 130 - 15% open · ⏱️ 22.08.2021):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 120 · 🔀 310 · 📥 2.9K · 📋 3.2K - 18% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 690 / month):
	```
	pip install indico
	```
...
<details><summary><b><a href="https://github.com/feincms/feincms">feincms</a></b> (🥉16 ·  ⭐ 820) - One of the most advanced Content Management Systems built on Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 59 · 🔀 170 · 📦 600 · 📋 290 - 6% open · ⏱️ 06.11.2021):
...
<details><summary><b><a href="https://github.com/bbangert/beaker">beaker</a></b> (🥈21 ·  ⭐ 480) - A WSGI middleware for sessions and caching. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 85 · 🔀 130 · 📦 3.1K · 📋 120 - 55% open · ⏱️ 10.11.2021):
...
<details><summary><b><a href="https://github.com/django-cache-machine/django-cache-machine">django-cache-machine</a></b> (🥉18 ·  ⭐ 820 · 💀) - Automatic caching and invalidation for Django models. <code>❗Unlicensed</code></summary>
...
🔗&nbsp;<b><a href="https://github.com/DmytroLitvinov/awesome-flake8-extensions">awesome-flake8-extensions</a></b> ( ⭐ 670)  - A curated awesome list of flake8 extensions. Feel free to..

🔗&nbsp;<b><a href="https://www.pylint.org/">pylint</a></b>  - A fully customizable source code analyzer.

🔗&nbsp;<b><a href="https://github.com/typeddjango/awesome-python-typing">awesome-python-typing</a></b> ( ⭐ 890)  - Collection of awesome Python types, stubs, plugins, and tools to..
...
- [GitHub](https://github.com/psf/black) (👨‍💻 280 · 🔀 1.4K · 📥 18K · 📦 94K · 📋 1.7K - 19% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 9.4M / month):
	```
	pip install black
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 420 · 📦 200K · 📋 1K - 3% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 790 · 📋 980 - 7% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 800 · 📦 25K · 📋 710 - 46% open · ⏱️ 08.11.2021):
...
- [PyPi](https://pypi.org/project/yapf) (📥 1.7M / month):
	...
	pip install yapf
	```
- [Conda](https://anaconda.org/conda-forge/yapf) (📥 880K · ⏱️ 19.04.2021):
	```
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈22 ·  ⭐ 820 · 💀) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
- [PyPi](https://pypi.org/project/pylama):
	...
	pip install pylama
	```
- [Conda](https://anaconda.org/conda-forge/pylama) (📥 70K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 70 · 🔀 210 · 📋 450 - 21% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 77 · 🔀 140 · 📋 280 - 18% open · ⏱️ 01.11.2021):
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 150 · 📋 140 - 22% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 36K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1K · 🔀 1.1K · 📋 1.5K - 10% open · ⏱️ 10.11.2021):
...
<details><summary><b><a href="https://github.com/facebook/pyre-check">pyre-check</a></b> (🥉17 ·  ⭐ 5.6K) - Performant type checking. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 350 · 📋 270 - 23% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 53 · 📦 66 · 📋 59 - 44% open · ⏱️ 12.10.2021):
...
- [PyPi](https://pypi.org/project/tqdm):
	...
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 8.6M · ⏱️ 20.09.2021):
	```
...
- [PyPi](https://pypi.org/project/rich):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 460K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 37 · 🔀 210 · 📦 550 · 📋 260 - 7% open · ⏱️ 26.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 8.9K / month):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (🔀 110 · 📦 470 · 📋 86 - 23% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 28K / month):
	```
...
<details><summary><b><a href="https://github.com/httpie/httpie">httpie</a></b> (🥇31 ·  ⭐ 53K) - A command line HTTP client, a user-friendly cURL replacement. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/httpie/httpie) (👨‍💻 140 · 🔀 3.2K · 📦 9.5K · 📋 710 - 15% open · ⏱️ 05.11.2021):
...
<details><summary><b><a href="https://github.com/cookiecutter/cookiecutter">cookiecutter</a></b> (🥇28 ·  ⭐ 16K) - A command-line utility that creates projects from cookiecutters.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/nvbn/thefuck">thefuck</a></b> (🥈27 ·  ⭐ 65K) - Correcting your previous console command. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 78 · 🔀 810 · 📦 370 · 📋 240 - 7% open · ⏱️ 26.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 2.9K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 61 · 🔀 200 · 📋 280 - 19% open · ⏱️ 30.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 4.9K / month):
	```
	pip install tmuxp
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥉21 ·  ⭐ 430) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 21 · 🔀 39 · 📦 25 · 📋 220 - 13% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 20 · 🔀 50 · 📦 120 · 📋 68 - 29% open · ⏱️ 11.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/litecli) (📥 6.2K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 260 · 📦 35 · 📋 91 - 31% open · ⏱️ 06.11.2021):
...
- [GitHub](https://github.com/mooz/percol) (👨‍💻 36 · 🔀 140 · 📦 28 · 📋 65 - 55% open · ⏱️ 23.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/percol) (📥 1.5K / month):
	```
	pip install percol
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 23 · 🔀 71 · 📥 6.4K · 📋 190 - 31% open · ⏱️ 17.08.2021):

	```
	git clone https://github.com/laixintao/iredis
	```
- [PyPi](https://pypi.org/project/iredis) (📥 830 / month):
	```
	pip install iredis
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 90 · 🔀 1.6K · 📥 740K · 📦 650 · 📋 440 - 26% open · ⏱️ 15.10.2021):
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 26 · 🔀 200 · 📦 570 · 📋 230 - 31% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 47 · 🔀 11K · 📥 450 · 📋 1.2K - 53% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 53K / month):
	```
	pip install face_recognition
	```
- [Conda](https://anaconda.org/conda-forge/face_recognition) (📥 3.6K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 38 · 🔀 550 · 📋 280 - 3% open · ⏱️ 03.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 1.3M / month):
	```
...
- [GitHub](https://github.com/kornia/kornia) (🔀 510 · 📥 140 · 📦 740 · 📋 480 - 21% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 18 · 🔀 81 · 📦 200 · 📋 72 - 43% open · ⏱️ 07.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/scoop) (📥 2.8K / month):
	```
	pip install scoop
	```
...
- [PyPi](https://pypi.org/project/python-decouple) (📥 640K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 32K · ⏱️ 05.01.2021):
	```
...
- [PyPi](https://pypi.org/project/hydra) (📥 5.4K / month):
	...
	pip install hydra
	```
- [Conda](https://anaconda.org/conda-forge/hydra) (📥 8.6K · ⏱️ 18.01.2021):
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 160 · 🔀 1.7K · 📦 49K · 📋 1.3K - 53% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 18M / month):
	```
	pip install paramiko
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 1.4M · ⏱️ 13.10.2021):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 61 · 🔀 180 · 📋 260 - 15% open · ⏱️ 07.11.2021):
...
- [PyPi](https://pypi.org/project/pynacl) (📥 23M / month):
	...
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 1.8M · ⏱️ 04.11.2021):
	```
...
- [GitHub](https://github.com/awslabs/aws-data-wrangler) (👨‍💻 83 · 🔀 360 · 📥 100K · 📋 520 - 6% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 220 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 49 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 23 · 🔀 200 · 📋 220 - 14% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/Julian/jsonschema) (👨‍💻 94 · 🔀 470 · 📦 180K · 📋 620 - 9% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 37M / month):
	```
	pip install jsonschema
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 8.4M · ⏱️ 06.11.2021):
	```
...
- [PyPi](https://pypi.org/project/schema) (📥 1.1M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 36K · ⏱️ 01.02.2021):
	```
...
<details><summary><b><a href="https://github.com/schematics/schematics">Schematics</a></b> (🥉21 ·  ⭐ 2.5K) - Data Structure Validation. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/schematics):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schematics) (📥 22K · ⏱️ 17.07.2019):
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 7 · 🔀 18 · 📦 47 · 📋 14 - 21% open · ⏱️ 07.03.2018):
...
<details><summary><b><a href="https://github.com/mwaskom/seaborn">Seaborn</a></b> (🥇38 ·  ⭐ 8.9K) - Statistical data visualization using Matplotlib. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 160 · 🔀 1.5K · 📥 210 · 📦 120K · 📋 1.9K - 4% open · ⏱️ 31.10.2021):

	```
	git clone https://github.com/mwaskom/seaborn
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 14M / month):
	```
	pip install seaborn
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 580 · 🔀 3.7K · 📦 41K · 📋 6.7K - 10% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 130 · 🔀 590 · 📦 18K · 📋 1.6K - 13% open · ⏱️ 11.11.2021):
...
<details><summary><b><a href="https://github.com/SciTools/cartopy">Cartopy</a></b> (🥉28 ·  ⭐ 960) - A cartographic python library with matplotlib support. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 100 · 🔀 300 · 📦 2K · 📋 990 - 25% open · ⏱️ 05.11.2021):
...
- [PyPi](https://pypi.org/project/cartopy) (📥 120K / month):
	...
	pip install cartopy
	```
- [Conda](https://anaconda.org/conda-forge/cartopy) (📥 1.8M · ⏱️ 05.11.2021):
	```
...
- [PyPi](https://pypi.org/project/bqplot) (📥 67K / month):
	...
	pip install bqplot
	```
- [Conda](https://anaconda.org/conda-forge/bqplot) (📥 880K · ⏱️ 01.10.2021):
	```
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 86 · 🔀 140 · 📦 2.6K · 📋 450 - 15% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 160 · 🔀 570 · 📦 620 · 📋 1.3K - 22% open · ⏱️ 10.11.2021):
...
- [PyPi](https://pypi.org/project/vispy) (📥 36K / month):
	...
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 190K · ⏱️ 05.11.2021):
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 97 · 🔀 860 · 📋 310 - 55% open · ⏱️ 21.08.2021):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 53K / month):
	```
	pip install diagrams
	```
- [Conda](https://anaconda.org/conda-forge/diagrams) (📥 97K · ⏱️ 05.11.2021):
	```
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 69 · 📦 780 · 📋 140 - 37% open · ⏱️ 09.11.2021):

	```
	git clone https://github.com/zopefoundation/ZODB
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 78K / month):
	```
	pip install ZODB
	```
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 100 · 📦 750 · 📋 53 - 26% open · ⏱️ 15.11.2019):
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.2K · 📥 1.7K · 📦 8.3K · 📋 1.4K - 14% open · ⏱️ 03.08.2021):
...
<details><summary><b><a href="https://github.com/redis/redis-py">redis-py</a></b> (🥇32 ·  ⭐ 9.8K · 📈) - The Python client for Redis. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/redis/redis-py) (👨‍💻 270 · 🔀 2K · 📦 120K · 📋 940 - 4% open · ⏱️ 11.11.2021):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 440K · ⏱️ 01.06.2020):
	```
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 110 · 🔀 1.3K · 📦 98K · 📋 580 - 2% open · ⏱️ 02.10.2021):
...
- [PyPi](https://pypi.org/project/PyMySQL) (📥 13M / month):
	...
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 400K · ⏱️ 09.01.2021):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 35 · 🔀 160 · 📦 13K · ⏱️ 09.11.2021):
...
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥈23 ·  ⭐ 710) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 34 · 🔀 130 · 📦 400 · 📋 200 - 12% open · ⏱️ 29.10.2021):

	```
	git clone https://github.com/mymarilyn/clickhouse-driver
	```
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 440K / month):
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 190 · 🔀 900 · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 150 · 📦 560 · 📋 200 - 10% open · ⏱️ 08.02.2021):
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 11 · 🔀 29 · 📦 99 · 📋 18 - 27% open · ⏱️ 07.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 3.1K / month):
	```
	pip install queries
	```
...
<details><summary><b><a href="https://github.com/timofurrer/maya">maya</a></b> (🥈26 ·  ⭐ 3.3K) - Datetimes for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 47 · 🔀 190 · 📦 840 · 📋 88 - 15% open · ⏱️ 05.11.2021):

	```
	git clone https://github.com/timofurrer/maya
	```
- [PyPi](https://pypi.org/project/maya) (📥 58K / month):
	```
	pip install maya
	```
...
<details><summary><b><a href="https://github.com/sdispater/pendulum">Pendulum</a></b> (🥈21 ·  ⭐ 4.6K) - Python datetimes made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/pendulum):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 400K · ⏱️ 08.11.2020):
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 120 · 📦 660 · 📋 61 - 40% open · ⏱️ 06.12.2020):
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 250 · 🔀 820 · 📥 170 · 📦 44K · 📋 770 - 10% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 80 · 🔀 400 · 📦 2.7K · 📋 170 - 31% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 780K / month):
	```
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥈25 ·  ⭐ 7.6K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 260 · 📥 6.9K · 📋 230 - 28% open · ⏱️ 11.11.2021):
...
- [PyPi](https://pypi.org/project/py-spy) (📥 520K / month):
	...
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 110K · ⏱️ 02.10.2021):
	```
	conda install -c conda-forge py-spy
	```
</details>
<details><summary><b><a href="https://github.com/pdbpp/pdbpp">pdb++</a></b> (🥈22 ·  ⭐ 830) - Another drop-in replacement for pdb. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 45 · 📦 2.4K · 📋 180 - 34% open · ⏱️ 28.09.2021):
...
<details><summary><b><a href="https://github.com/flask-debugtoolbar/flask-debugtoolbar">flask-debugtoolbar</a></b> (🥈22 ·  ⭐ 820 · 💀) - A port of the django-debug-toolbar to flask. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/flask-debugtoolbar):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-debugtoolbar) (📥 48K · ⏱️ 30.05.2021):
	```
	conda install -c conda-forge flask-debugtoolbar
	```
</details>
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥈21 ·  ⭐ 5.5K) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 16 · 🔀 110 · 📋 78 - 28% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/icecream) (📥 110K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 1.5K · ⏱️ 23.06.2021):
	```
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 150 · 📦 84 · 📋 80 - 30% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 3.7K / month):
	```
	pip install vprof
	```
...
<details><summary><b><a href="https://github.com/dcramer/django-devserver">django-devserver</a></b> (🥉20 ·  ⭐ 1.3K · 💀) - A drop-in replacement for Django's runserver. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 330 · 📋 67 - 58% open · ⏱️ 05.03.2016):
	...
	```
- [PyPi](https://pypi.org/project/django-devserver) (📥 8.2K / month):
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 100 · 📦 100 · 📋 110 - 26% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 6.4K / month):
	```
	pip install wdb
	```
...
- [PyPi](https://pypi.org/project/line_profiler) (📥 130K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 220K · ⏱️ 29.09.2021):
	```
...
<details><summary><b><a href="https://github.com/ionelmc/python-manhole">manhole</a></b> (🥉16 ·  ⭐ 320) - Debugging UNIX socket connections and present the stacktraces for all.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/google/pyringe) (🔀 71 · 📦 2 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 69 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 3.9K · 🔀 69K · 📦 170K · 📋 33K - 8% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/tensorflow/tensorflow
	```
- [PyPi](https://pypi.org/project/tensorflow) (📥 13M / month):
	```
	pip install tensorflow
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 2.9M · ⏱️ 04.11.2021):
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1K · 🔀 18K · 📋 11K - 1% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/keras-team/keras
	```
- [PyPi](https://pypi.org/project/keras) (📥 6.8M / month):
	```
	pip install keras
	```
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3K · 🔀 14K · 📥 240 · 📋 23K - 30% open · ⏱️ 11.11.2021):
...
- [PyPi](https://pypi.org/project/pytorch) (📥 45K / month):
	...
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 280K · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 970 · 🔀 6.5K · 📥 24K · 📋 9.4K - 18% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/dmlc/mxnet
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 640K / month):
	```
	pip install mxnet
	```
...
- [PyPi](https://pypi.org/project/caffe):
	...
	pip install caffe
	```
- [Conda](https://anaconda.org/conda-forge/caffe) (📥 73K · ⏱️ 27.06.2020):
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 700 · 📥 130 · ⏱️ 22.05.2020):

	```
	git clone https://github.com/SerpentAI/SerpentAI
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 140 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.1K · 📦 120K · 📋 1.5K - 11% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 38M / month):
	```
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 8.9M · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.5K · 🔀 20K · 📦 19K · 📋 30K - 3% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.7K · 🔀 5K · 📥 16K · 📋 24K - 9% open · ⏱️ 10.11.2021):
...
<details><summary><b><a href="https://github.com/Supervisor/supervisor">supervisor</a></b> (🥈26 ·  ⭐ 7.1K) - Supervisor process control system for UNIX. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 160 · 🔀 1.1K · 📦 6.5K · 📋 1K - 10% open · ⏱️ 04.11.2021):
...
<details><summary><b><a href="https://github.com/nickstenning/honcho">honcho</a></b> (🥉21 ·  ⭐ 1.4K) - A Python clone of [Foreman](https://github.com/ddollar/foreman), for.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/fabtools/fabtools">fabtools</a></b> (🥉19 ·  ⭐ 1.2K · 💀) - Tools for writing awesome Fabric files. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 190 · 📦 270 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools):
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 55 · 🔀 140 · 📦 34 · 📋 500 - 18% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 570 · 🔀 2.2K · 📦 1.6K · 📋 920 - 7% open · ⏱️ 07.11.2021):
...
- [PyPi](https://pypi.org/project/luigi):
	...
	pip install luigi
	```
- [Conda](https://anaconda.org/conda-forge/luigi) (📥 500K · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 480 · 🔀 1.4K · 📦 31K · 📋 4K - 15% open · ⏱️ 11.11.2021):
...
- [PyPi](https://pypi.org/project/dask):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 4.5M · ⏱️ 09.11.2021):
	```
	conda install -c conda-forge dask
	```
</details>
<details><summary><b><a href="https://github.com/robinhood/faust">faust</a></b> (🥈26 ·  ⭐ 5.8K · 💀) - A stream processing library, porting the ideas from [Kafka.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 93 · 🔀 480 · 📦 870 · 📋 450 - 48% open · ⏱️ 09.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/faust) (📥 390K / month):
	```
	pip install faust
	```
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 570 · 📦 870 · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
...
- [GitHub](https://github.com/ray-project/ray) (🔀 3K · 📋 8.3K - 21% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.6K · 📥 720K · 📋 4.3K - 7% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 630K / month):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 270K · ⏱️ 10.11.2021):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 17 · 🔀 150 · 📥 18 · 📦 300 · 📋 600 - 2% open · ⏱️ 09.11.2021):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 82K / month):
	```
	pip install pyarmor
	```
...
🔗&nbsp;<b><a href="https://github.com/yoloseem/awesome-sphinxdoc">awesome-sphinxdoc</a></b> ( ⭐ 770 · 💤)  - A curated list of awesome tools for Sphinx Python Documentation..
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.5K · 📦 170K · 📋 5.6K - 14% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 130 · 📦 240 · 📋 56 - 50% open · ⏱️ 20.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pycco) (📥 1.8K / month):
	```
	pip install pycco
	```
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥇27 ·  ⭐ 4.2K · 📈) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 18 · 🔀 870 · 📦 120 · ⏱️ 11.11.2021):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 63K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/s3tools/s3cmd) (👨‍💻 200 · 🔀 780 · 📥 3M · 📋 780 - 29% open · ⏱️ 08.11.2021):
...
<details><summary><b><a href="https://github.com/MicroPyramid/forex-python">forex-python</a></b> (🥇25 ·  ⭐ 440) - Foreign exchange rates, Bitcoin price index and currency conversion. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 21 · 🔀 140 · 📦 980 · 📋 57 - 24% open · ⏱️ 02.09.2021):
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 900 · 📦 190 · 📋 370 - 21% open · ⏱️ 28.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 4.3K / month):
	```
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 93 · 📦 97 · 📋 14 - 14% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 800 / month):
	```
	pip install alipay
	```
...
<details><summary><b><a href="https://github.com/Alir3z4/python-currencies">python-currencies</a></b> (🥉12 ·  ⭐ 56 · 💤) - Display money format and its filthy currencies. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/spyder-ide/spyder">spyder</a></b> (🥇35 ·  ⭐ 6.7K) - Open Source Python IDE. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 230 · 🔀 1.3K · 📥 1M · 📦 21K · 📋 14K - 8% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 110K / month):
	```
	pip install spyder
	```
- [Conda](https://anaconda.org/conda-forge/spyder) (📥 1.2M · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 170 · 🔀 2.6K · 📋 3.1K - 1% open · ⏱️ 05.11.2021):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 72 · 🔀 650 · 📥 32K · 📋 4K - 1% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/python-mode/python-mode) (👨‍💻 130 · 🔀 760 · 📋 880 - 2% open · ⏱️ 10.11.2021):
...
- [PyPi](https://pypi.org/project/yagmail):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 8.5K · ⏱️ 30.08.2021):
	```
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 54 · 🔀 170 · 📦 180 · 📋 88 - 59% open · ⏱️ 29.03.2021):

	```
	git clone https://github.com/mailgun/flanker
	```
- [PyPi](https://pypi.org/project/flanker) (📥 36K / month):
	```
	pip install flanker
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 100 · 🔀 270 · 📦 32 · 📋 1.6K - 4% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 50 · 📥 120 · 📋 72 - 36% open · ⏱️ 20.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/mailer) (📥 26K / month):
	```
	pip install mailer
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 50 · 📥 48 · 📦 14 · 📋 89 - 17% open · ⏱️ 05.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/salmon) (📥 53 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 350 · 🔀 2.2K · 📋 1.4K - 2% open · ⏱️ 09.11.2021):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 7K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 120 · 🔀 590 · 📦 43K · 📋 550 - 27% open · ⏱️ 01.10.2021):
...
- [PyPi](https://pypi.org/project/watchdog) (📥 4.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 840K · ⏱️ 07.11.2021):
	```
	conda install -c conda-forge watchdog
	```
</details>
<details><summary><b><a href="https://github.com/ahupp/python-magic">python-magic</a></b> (🥈28 ·  ⭐ 2K) - A Python interface to the libmagic file type identification.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 37 · 📦 6.2K · 📋 17 - 41% open · ⏱️ 14.02.2015):

	```
	git clone https://github.com/mikeorr/Unipath
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 90K / month):
	```
	pip install Unipath
	```
...
<details><summary><b><a href="https://github.com/PyFilesystem/pyfilesystem2">PyFilesystem2</a></b> (🥉18 ·  ⭐ 1.5K) - Python's filesystem abstraction layer. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/wtforms/wtforms">WTForms</a></b> (🥇34 ·  ⭐ 1.3K) - A flexible forms validation and rendering library. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 130 · 🔀 350 · 📦 110K · 📋 380 - 9% open · ⏱️ 07.11.2021):

	```
	git clone https://github.com/wtforms/wtforms
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 2M / month):
	```
	pip install wtforms
	```
- [Conda](https://anaconda.org/conda-forge/wtforms) (📥 82K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 660 · 📦 77K · 📋 630 - 9% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 53K · 📋 150 - 11% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 97 · 🔀 680 · 📦 16K · 📋 290 - 1% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 81 · 🔀 180 · 📥 2.4K · 📦 120K · 📋 180 - 4% open · ⏱️ 09.11.2021):
...
- [PyPi](https://pypi.org/project/more-itertools):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 8M · ⏱️ 10.11.2021):
	```
	conda install -c conda-forge more-itertools
	```
</details>
<details><summary><b><a href="https://github.com/pytoolz/toolz">Toolz</a></b> (🥈32 ·  ⭐ 3.7K) - A collection of functional utilities for iterators, functions, and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 70 · 🔀 210 · 📦 49K · 📋 210 - 34% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/pytoolz/toolz
	```
- [PyPi](https://pypi.org/project/toolz) (📥 12M / month):
	```
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 5.4M · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 28 · 🔀 120 · 📦 3.8K · 📋 66 - 6% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/Suor/funcy
	```
- [PyPi](https://pypi.org/project/funcy) (📥 670K / month):
	```
	pip install funcy
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 35 · 🔀 82 · 📦 110 · 📋 360 - 13% open · ⏱️ 08.11.2021):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 21K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 470 · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 29 · 🔀 99 · 📋 520 - 11% open · ⏱️ 07.11.2021):
...
- [PyPi](https://pypi.org/project/coconut):
	...
	pip install coconut
	```
- [Conda](https://anaconda.org/conda-forge/coconut) (📥 110K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 62 · 📦 32K · 📋 60 - 33% open · ⏱️ 06.11.2021):
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇31 ·  ⭐ 970) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 120 · 🔀 190 · 📦 14K · 📋 290 - 18% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/pyglet/pyglet
	```
- [PyPi](https://pypi.org/project/pyglet) (📥 620K / month):
	```
	pip install pyglet
	```
...
<details><summary><b><a href="https://github.com/PySimpleGUI/PySimpleGUI">PySimpleGUI</a></b> (🥈28 ·  ⭐ 8.8K) - Wrapper for tkinter, Qt, WxPython and Remi. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.3K · 📦 3.8K · 📋 2.5K - 26% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 80K / month):
	```
	pip install PySimpleGUI
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 42K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 99 · 🔀 760 · 📥 150 · 📦 450 · 📋 500 - 17% open · ⏱️ 12.06.2021):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 240 · 📦 94 · 📋 430 - 18% open · ⏱️ 16.09.2021):

	```
	git clone https://github.com/zoofIO/flexx
	```
- [PyPi](https://pypi.org/project/flexx) (📥 810 / month):
	```
	pip install flexx
	```
...
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉23 ·  ⭐ 6.4K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 290 · 📦 210 · 📋 790 - 12% open · ⏱️ 11.11.2021):
...
<details><summary><b><a href="https://github.com/ChrisKnott/Eel">Eel</a></b> (🥉23 ·  ⭐ 4.7K) - A library for making simple Electron-like offline HTML/JS GUI apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 340 · 📦 540 · 📋 570 - 5% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 200 · 🔀 500 · 📋 500 - 24% open · ⏱️ 07.11.2021):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 34 · 🔀 110 · 📥 46 · 📦 190 · 📋 210 - 19% open · ⏱️ 04.10.2021):
...
- [GitHub](https://github.com/tartiflette/tartiflette-aiohttp) (🔀 9 · 📦 33 · 📋 17 - 17% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 45 · 🔀 84 · 📦 8K · 📋 77 - 24% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 37 · 🔀 100 · 📦 700K · ⏱️ 05.11.2021):

	```
	git clone https://github.com/pallets/markupsafe
	```
- [PyPi](https://pypi.org/project/markupsafe) (📥 97M / month):
	```
...
<details><summary><b><a href="https://github.com/mozilla/bleach">bleach</a></b> (🥈28 ·  ⭐ 2.2K) - A whitelist-based HTML sanitization and text linkification library. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 72 · 🔀 200 · 📦 150K · 📋 330 - 13% open · ⏱️ 05.10.2021):

	```
	git clone https://github.com/mozilla/bleach
	```
- [PyPi](https://pypi.org/project/bleach) (📥 22M / month):
	```
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 5.4M · ⏱️ 25.08.2021):
	```
...
<details><summary><b><a href="https://github.com/gawel/pyquery">pyquery</a></b> (🥉23 ·  ⭐ 2.1K) - A jQuery-like library for parsing HTML. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/pyquery):
	...
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 20K · ⏱️ 27.11.2020):
	```
	conda install -c conda-forge pyquery
	```
</details>
<details><summary><b><a href="https://github.com/stchris/untangle">untangle</a></b> (🥉18 ·  ⭐ 530 · 💀) - Converts XML documents to Python objects for easy access. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/stchris/untangle) (👨‍💻 13 · 🔀 77 · 📥 520 · 📦 730 · 📋 44 - 40% open · ⏱️ 07.08.2020):
...
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈32 ·  ⭐ 7.9K) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 140 · 🔀 500 · 📦 13K · 📋 630 - 7% open · ⏱️ 01.11.2021):
...
- [PyPi](https://pypi.org/project/httpx) (📥 5M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 86K · ⏱️ 13.10.2021):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 290 · 🔀 830 · 📥 930 · 📦 690K · 📋 970 - 13% open · ⏱️ 05.11.2021):
...
- [PyPi](https://pypi.org/project/grequests):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 43K · ⏱️ 22.04.2020):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 34 · 🔀 300 · 📦 4.9K · 📋 450 - 62% open · ⏱️ 09.11.2021):
...
- [PyPi](https://pypi.org/project/keyboard) (📥 220K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 2K · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 360 · 🔀 1.5K · 📦 6.5K · 📋 1.3K - 2% open · ⏱️ 09.11.2021):
...
- [PyPi](https://pypi.org/project/scapy):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 15K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 340 · 📋 64 - 51% open · ⏱️ 20.03.2017):
	...
	```
- [PyPi](https://pypi.org/project/wifi) (📥 9.7K / month):
	```
	pip install wifi
	```
...
<details><summary><b><a href="https://github.com/SavinaRoja/PyUserInput">PyUserInput</a></b> (🥉18 ·  ⭐ 980 · 💤) - A module for cross-platform control of the mouse and.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 78 · 📦 440 · 📋 86 - 70% open · ⏱️ 05.04.2021):
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 160 · 🔀 710 · 📦 280 · 📋 860 - 14% open · ⏱️ 13.04.2021):

	```
	git clone https://github.com/thumbor/thumbor
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 8.6K / month):
	```
	pip install thumbor
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 96 · 🔀 190 · 📥 5.3K · 📦 7.3K · 📋 360 - 3% open · ⏱️ 05.10.2021):
...
- [PyPi](https://pypi.org/project/wand) (📥 440K / month):
	...
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 7.3K · ⏱️ 30.11.2020):
	```
	conda install -c conda-forge wand
	```
</details>
<details><summary><b><a href="https://github.com/python-pillow/Pillow">pillow</a></b> (🥈26 ·  ⭐ 9.1K · 📉) - Pillow is the friendly.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 370 · 🔀 1.6K · 📋 2.3K - 6% open · ⏱️ 09.11.2021):

	```
	git clone https://github.com/python-pillow/Pillow
	```
- [PyPi](https://pypi.org/project/Pillow) (📥 36M / month):
	```
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 11M · ⏱️ 10.11.2021):
	```
	conda install -c conda-forge Pillow
	```
</details>
<details><summary><b><a href="https://github.com/WhyNotHugo/python-barcode">python-barcode</a></b> (🥈25 ·  ⭐ 290) - Create barcodes in Python with no extra dependencies. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 38 · 🔀 86 · 📥 180 · 📦 9.3K · 📋 79 - 39% open · ⏱️ 08.11.2021):
...
<details><summary><b><a href="https://github.com/dylanaraps/pywal">pywal</a></b> (🥈24 ·  ⭐ 5.8K) - A tool that generates color schemes from images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 230 · 📥 600 · 📦 150 · 📋 470 - 21% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 12 · 🔀 31 · 📦 240 · 📋 250 - 35% open · ⏱️ 02.11.2021):
...
<details><summary><b><a href="https://github.com/daboth/pagan">pagan</a></b> (🥉17 ·  ⭐ 240 · 💀) - Retro identicon (Avatar) generation based on input string and hash. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/daboth/pagan) (👨‍💻 6 · 🔀 32 · 📦 37 · 📋 3 - 33% open · ⏱️ 09.07.2018):

	```
	git clone https://github.com/daboth/pagan
	```
- [PyPi](https://pypi.org/project/pagan) (📥 540 / month):
	```
	pip install pagan
	```
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 48 · 🔀 450 · 📋 150 - 15% open · ⏱️ 01.10.2021):
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 19 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 57 / month):
	```
	pip install hmap
	```
...
- [GitHub](https://github.com/ajknzhol/pygram) (🔀 12 · ⏱️ 22.02.2014):
	...
	```
- [PyPi](https://pypi.org/project/pygram) (📥 100 / month):
	```
	pip install pygram
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 440 · 🔀 3.6K · 📥 27K · 📋 3.9K - 27% open · ⏱️ 05.11.2021):
...
- [PyPi](https://pypi.org/project/micropython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micropython) (📥 4.8K · ⏱️ 14.09.2021):
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 29 · 🔀 190 · 📥 12K · 📋 420 - 45% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 1.9K · 🔀 20K · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 21 · 🔀 120 · 📦 8 · 📋 82 - 25% open · ⏱️ 13.10.2021):

	```
	git clone https://github.com/Maratyszcza/PeachPy
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 23 / month):
	```
	pip install PeachPy
	```
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉11 ·  ⭐ 760) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/ptpython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 6.1K · ⏱️ 27.09.2021):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 120 · 🔀 200 · 📋 750 - 17% open · ⏱️ 09.11.2021):
...
<details><summary><b><a href="https://github.com/ovalhub/pyicu">PyICU</a></b> (🥇18 ·  ⭐ 130 · 💤) - A wrapper of International Components for Unicode C++ library.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 58 · 📦 2K · ⏱️ 08.04.2021):
...
- [PyPi](https://pypi.org/project/pyicu):
	...
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 70K · ⏱️ 15.01.2021):
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 270 · 🔀 710 · 📦 490 · 📋 1.9K - 19% open · ⏱️ 10.11.2021):
...
- [PyPi](https://pypi.org/project/prefect):
	...
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 220K · ⏱️ 11.11.2021):
	```
	conda install -c conda-forge prefect
	```
</details>
<details><summary><b><a href="https://github.com/dbader/schedule">schedule</a></b> (🥈26 ·  ⭐ 9.2K) - Python job scheduling for humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dbader/schedule) (👨‍💻 45 · 🔀 750 · 📦 15K · 📋 340 - 29% open · ⏱️ 26.06.2021):
...
- [PyPi](https://pypi.org/project/schedule):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 9.8K · ⏱️ 10.04.2021):
	```
	conda install -c conda-forge schedule
	```
</details>
<details><summary><b><a href="https://github.com/sartography/SpiffWorkflow">Spiff</a></b> (🥈22 ·  ⭐ 1K) - A powerful workflow engine implemented in pure Python. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 42 · 🔀 230 · 📦 26 · 📋 69 - 5% open · ⏱️ 03.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 2.6K / month):
	```
...
- [PyPi](https://pypi.org/project/loguru) (📥 2M / month):
	...
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 300K · ⏱️ 02.11.2021):
	```
...
- [PyPi](https://pypi.org/project/gym) (📥 1.1M / month):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 77K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 540 · 🔀 7.7K · 📥 3.3K · 📦 23K · 📋 4.2K - 5% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 220 · 🔀 1.8K · ⏱️ 10.11.2021):
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉19 ·  ⭐ 4.1K) - MindsDB is an open source AI layer for existing databases that.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 84 · 🔀 540 · 📋 760 - 9% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 7.1K / month):
	```
	pip install mindsdb
	```
...
<details><summary><b><a href="https://github.com/mhammond/pywin32">PyWin32</a></b> (🥇27 ·  ⭐ 3.4K) - Python Extensions for Windows. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 70 · 🔀 630 · 📥 500K · 📦 59K · 📋 1.6K - 26% open · ⏱️ 10.11.2021):
...
- [PyPi](https://pypi.org/project/pywin32) (📥 2.8M / month):
	...
	pip install pywin32
	```
- [Conda](https://anaconda.org/conda-forge/pywin32) (📥 1.9M · ⏱️ 05.11.2021):
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 95 · 🔀 460 · 📦 49 · 📋 1K - 16% open · ⏱️ 22.10.2021):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 120K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 31K · ⏱️ 21.08.2021):
	```
...
<details><summary><b><a href="https://github.com/pallets/itsdangerous">itsdangerous</a></b> (🥇29 ·  ⭐ 2.3K) - Various helpers to pass trusted data to untrusted environments. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 38 · 🔀 180 · 📦 510K · ⏱️ 05.11.2021):
...
- [GitHub](https://github.com/jek/blinker) (👨‍💻 11 · 🔀 160 · 📦 85K · 📋 34 - 52% open · ⏱️ 29.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/blinker) (📥 8.1M / month):
	```
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 3.7M · ⏱️ 20.06.2018):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.4K · 📦 320 · 📋 860 - 33% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1K · ⏱️ 16.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 390K / month):
	```
...
- [PyPi](https://pypi.org/project/gensim):
	...
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 740K · ⏱️ 09.11.2021):
	```
...
- [PyPi](https://pypi.org/project/jieba):
	...
	pip install jieba
	```
- [Conda](https://anaconda.org/conda-forge/jieba) (📥 98K · ⏱️ 30.05.2021):
	```
	conda install -c conda-forge jieba
	```
</details>
<details><summary><b><a href="https://github.com/clips/pattern">pattern</a></b> (🥈24 ·  ⭐ 8.1K · 💀) - A web mining module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📦 1.2K · 📋 200 - 62% open · ⏱️ 25.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/pattern):
	```
	pip install pattern
	```
- [Conda](https://anaconda.org/conda-forge/pattern) (📥 8.9K · ⏱️ 05.05.2020):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 890 · 📥 71K · 📦 150 · 📋 140 - 72% open · ⏱️ 21.06.2020):
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 720 · 📋 100 - 36% open · ⏱️ 19.01.2020):

	```
	git clone https://github.com/isnowfy/snownlp
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 7.8K / month):
	```
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 210 · ⏱️ 07.09.2021):
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 41 · 🔀 730 · 📦 730 · 📋 600 - 10% open · ⏱️ 05.10.2021):
...
- [PyPi](https://pypi.org/project/stanza):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 1.9K · ⏱️ 17.08.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 220 · 🔀 790 · 📥 280 · 📦 100 · 📋 130 - 44% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 300 · 📦 590 · 📋 200 - 67% open · ⏱️ 22.09.2020):
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 270 · 📦 840 · 📋 71 - 36% open · ⏱️ 15.07.2017):
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 10 · 🔀 9.6K · 📋 42 - 33% open · ⏱️ 20.08.2021):
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 170 · 🔀 460 · 📦 720 · 📋 520 - 22% open · ⏱️ 22.10.2021):
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 78 · 🔀 1.5K · 📥 400K · 📦 110 · 📋 640 - 40% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 440 · 📦 720 · 📋 290 - 18% open · ⏱️ 31.05.2021):
...
<details><summary><b><a href="https://github.com/coleifer/peewee">peewee</a></b> (🥇34 ·  ⭐ 8.7K) - A small, expressive ORM. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 140 · 🔀 1.3K · 📦 14K · 📋 2.1K - 0% open · ⏱️ 31.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/peewee) (📥 540K / month):
	```
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 360K · ⏱️ 06.11.2021):
	```
	conda install -c conda-forge peewee
	```
</details>
<details><summary><b><a href="https://github.com/MongoEngine/mongoengine">mongoengine</a></b> (🥈32 ·  ⭐ 3.6K) - A Python Object-Document-Mapper for working with MongoDB. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 370 · 🔀 1.1K · 📦 15K · 📋 1.6K - 21% open · ⏱️ 06.11.2021):
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 91 · 🔀 370 · 📦 840 · 📋 460 - 39% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/pynamodb/PynamoDB
	```
- [PyPi](https://pypi.org/project/PynamoDB) (📥 880K / month):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 270 · 📦 2.1K · 📋 260 - 4% open · ⏱️ 30.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/dataset) (📥 90K / month):
	```
	pip install dataset
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 200 · 📦 2.2K · 📋 560 - 44% open · ⏱️ 28.02.2021):
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 15 · 🔀 80 · 📋 66 - 18% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/encode/orm
	```
- [PyPi](https://pypi.org/project/orm) (📥 3.5K / month):
	```
	pip install orm
	```
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 23 · 📋 10 - 50% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 500 / month):
	```
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 84 · 📋 51 - 70% open · ⏱️ 06.06.2016):
	...
	```
- [PyPi](https://pypi.org/project/redisco) (📥 270 / month):
	```
	pip install redisco
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 300 · 🔀 1.4K · 📥 9.2M · 📋 3.3K - 34% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 4.2M / month):
	```
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 310K · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 410 · 📋 770 - 14% open · ⏱️ 05.11.2021):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 4.4M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 19K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1K · 📋 8.1K - 24% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 81 · 🔀 91 · 📦 160 · 📋 660 - 14% open · ⏱️ 20.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/devpi) (📥 3K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypa/warehouse) (👨‍💻 310 · 🔀 720 · 📋 2.4K - 13% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 88 · 📋 180 - 14% open · ⏱️ 08.11.2021):
...
<details><summary><b><a href="https://github.com/sqlmapproject/sqlmap">sqlmap</a></b> (🥇19 ·  ⭐ 22K) - Automatic SQL injection and database takeover tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.4K · 📋 4.5K - 1% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 600 · 📦 580 · 📋 430 - 20% open · ⏱️ 07.02.2021):
...
<details><summary><b><a href="https://github.com/spotify/annoy">annoy</a></b> (🥈24 ·  ⭐ 9.2K) - Approximate Nearest Neighbors in C++/Python optimized for memory usage. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 30 · 🔀 500 · 📦 500 · 📋 360 - 23% open · ⏱️ 02.10.2021):
...
<details><summary><b><a href="https://github.com/ibayer/fastFM">fastFM</a></b> (🥉17 ·  ⭐ 950 · 💤) - A library for Factorization Machines. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 66 · 🔀 130 · 📦 33K · 📋 230 - 30% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 300 · 🔀 1.4K · 📦 6K · 📋 1.1K - 4% open · ⏱️ 07.11.2021):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 5.6M / month):
	```
	pip install sanic
	```
- [Conda](https://anaconda.org/conda-forge/sanic) (📥 170K · ⏱️ 06.11.2021):
	```
	conda install -c conda-forge sanic
	```
</details>
<details><summary><b><a href="https://github.com/flask-restful/flask-restful">flask-restful</a></b> (🥈32 ·  ⭐ 6.2K) - Quickly building REST APIs for Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/flask-restful) (📥 1.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-restful) (📥 98K · ⏱️ 30.05.2021):
	```
	conda install -c conda-forge flask-restful
	```
</details>
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥈30 ·  ⭐ 38K) - A modern, fast, web framework for building APIs with Python 3.6+ based on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 270 · 🔀 2.7K · 📋 2.5K - 32% open · ⏱️ 26.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 4M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 450K · ⏱️ 07.10.2021):
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 180 · 🔀 840 · 📥 1.5K · 📦 5.9K · 📋 930 - 20% open · ⏱️ 08.11.2021):
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 360 · 📦 1.2K · 📋 450 - 34% open · ⏱️ 10.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/hug) (📥 33K / month):
	```
	pip install hug
	```
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 32 · 🔀 160 · 📦 4.7K · 📋 63 - 19% open · ⏱️ 01.09.2021):
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 200 · 🔀 720 · 📦 980 · 📋 950 - 3% open · ⏱️ 06.11.2021):
...
<details><summary><b><a href="https://github.com/jeffknupp/sandman2">sandman2</a></b> (🥉18 ·  ⭐ 1.8K · 💤) - Automated REST APIs for existing database-driven systems. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 180 · 📦 16 · 📋 79 - 34% open · ⏱️ 21.12.2020):
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 92 · 🔀 4.2K · 📋 250 - 3% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.4K · 📥 440K · 📦 37K · 📋 11K - 32% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 1.9M / month):
	```
	pip install sympy
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 340 · 🔀 2.2K · 📥 26 · 📦 53K · 📋 4.5K - 46% open · ⏱️ 08.11.2021):

	```
	git clone https://github.com/statsmodels/statsmodels
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 6.9M / month):
	```
	pip install statsmodels
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 5.2M · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 150 · 🔀 3.9K · 📦 790 · 📋 960 - 32% open · ⏱️ 14.10.2020):
...
- [PyPi](https://pypi.org/project/zipline):
	...
	pip install zipline
	```
- [Conda](https://anaconda.org/conda-forge/zipline) (📥 5.2K · ⏱️ 05.10.2020):
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 340 · 🔀 1.4K · 📥 770 · 📦 560 · 📋 2.4K - 8% open · ⏱️ 11.11.2021):
...
- [PyPi](https://pypi.org/project/pymc3):
	...
	pip install pymc3
	```
- [Conda](https://anaconda.org/conda-forge/pymc3) (📥 340K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 13 · 🔀 170 · 📦 59 · ⏱️ 25.10.2021):

	```
	git clone https://github.com/benedekrozemberczki/karateclub
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 4.8K / month):
	```
	pip install karateclub
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 7K · ⏱️ 05.08.2021):
	```
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 93 · 🔀 330 · 📋 2.9K - 2% open · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/chapmanb/bcbb) (👨‍💻 32 · 🔀 210 · 📦 190 · 📋 73 - 20% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 190 · 🔀 560 · 📦 35K · 📋 1.1K - 10% open · ⏱️ 08.11.2021):
...
- [PyPi](https://pypi.org/project/marshmallow):
	...
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 860K · ⏱️ 19.10.2021):
	```
	conda install -c conda-forge marshmallow
	```
</details>
<details><summary><b><a href="https://github.com/python-rapidjson/python-rapidjson">python-rapidjson</a></b> (🥈21 ·  ⭐ 430) - A Python wrapper around.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 18 · 🔀 35 · 📦 1.8K · 📋 98 - 10% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-rapidjson):
	```
	pip install python-rapidjson
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 720K · ⏱️ 05.11.2021):
	```
	conda install -c conda-forge python-rapidjson
	```
</details>
<details><summary><b><a href="https://github.com/TkTech/pysimdjson">pysimdjson</a></b> (🥉19 ·  ⭐ 490) - A Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 12 · 🔀 38 · 📦 150 · 📋 69 - 15% open · ⏱️ 21.06.2021):
...
- [PyPi](https://pypi.org/project/pysimdjson):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 15K · ⏱️ 05.11.2021):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 500 · 📥 5.5K · 📦 260 · 📋 2.2K - 13% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 550 · 📦 12K · 📋 230 - 11% open · ⏱️ 04.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/tablib) (📥 960K / month):
	```
	pip install tablib
	```
...
- [PyPi](https://pypi.org/project/csvkit) (📥 46K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 57K · ⏱️ 13.07.2021):
	```
...
<details><summary><b><a href="https://github.com/lepture/mistune">Mistune</a></b> (🥉25 ·  ⭐ 2K · 📉) - Fastest and full featured pure Python parsers of Markdown. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 150 · 🔀 670 · 📦 160K · 📋 730 - 3% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 330 · 📋 660 - 41% open · ⏱️ 20.09.2021):

	```
	git clone https://github.com/scanny/python-pptx
	```
- [PyPi](https://pypi.org/project/python-pptx) (📥 650K / month):
	```
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 730 · 📋 870 - 44% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 940K / month):
	```
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 43 · 🔀 280 · 📦 900 · 📋 310 - 22% open · ⏱️ 06.10.2021):
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 59 · 📦 8 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 59 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 420 · 🔀 1.7K · 📥 440 · 📦 5.4K · 📋 1.5K - 2% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 1.8K · 📦 16K · 📋 1.6K - 6% open · ⏱️ 07.11.2021):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 220 · 🔀 330 · 📦 390 · 📋 2.1K - 1% open · ⏱️ 09.11.2021):
...
<details><summary><b><a href="https://github.com/lektor/lektor">lektor</a></b> (🥉20 ·  ⭐ 3.5K) - An easy to use static CMS and blog engine. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 89 · 🔀 270 · 📥 6.9K · 📋 550 - 38% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/lektor) (📥 2.3K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 140 · 🔀 540 · 📋 370 - 18% open · ⏱️ 10.11.2021):
...
- [PyPi](https://pypi.org/project/django-taggit) (📥 270K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-taggit) (📥 87K · ⏱️ 06.07.2021):
	```
...
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇27 ·  ⭐ 8K) - Simple job queues for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/rq/rq) (👨‍💻 250 · 🔀 1.2K · 📦 9.1K · 📋 920 - 16% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 66 · 🔀 320 · 📦 820 · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 72 · 🔀 200 · 📥 32 · 📦 330 · 📋 270 - 8% open · ⏱️ 09.11.2021):
...
- [PyPi](https://pypi.org/project/dramatiq):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 26K · ⏱️ 23.10.2021):
	```
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇21 ·  ⭐ 8.1K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 430 · 🔀 1.5K · 📦 42K · 📋 520 - 23% open · ⏱️ 02.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/faker) (📥 5.1M / month):
	```
	pip install faker
	```
...
<details><summary><b><a href="https://github.com/locustio/locust">locust</a></b> (🥇34 ·  ⭐ 18K) - Scalable user load testing tool written in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/locustio/locust) (👨‍💻 220 · 🔀 2.2K · 📦 1.9K · 📋 1.2K - 1% open · ⏱️ 08.11.2021):

	```
	git clone https://github.com/locustio/locust
	```
- [PyPi](https://pypi.org/project/locust) (📥 530K / month):
	```
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 41K · ⏱️ 06.11.2021):
	```
	conda install -c conda-forge locust
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇33 ·  ⭐ 6.4K) - A generic test automation framework. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.4K · 📋 3.6K - 4% open · ⏱️ 11.11.2021):
...
- [PyPi](https://pypi.org/project/robotframework) (📥 810K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robotframework) (📥 67K · ⏱️ 15.10.2021):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 100 · 🔀 260 · 📥 19 · 📦 11K · 📋 190 - 19% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 5.2M / month):
	```
	pip install responses
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 870K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 490 · 📦 5.1K · 📋 490 - 10% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 450 · 📦 10K · 📋 1.2K - 5% open · ⏱️ 10.11.2021):
...
- [PyPi](https://pypi.org/project/hypothesis):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5M · ⏱️ 07.11.2021):
	```
	conda install -c conda-forge hypothesis
	```
</details>
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈29 ·  ⭐ 5.7K) - PyAutoGUI is a cross-platform GUI automation Python module for human.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 760 · 📦 11K · 📋 510 - 61% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 520K / month):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 110 · 🔀 280 · 📦 3.4K · 📋 320 - 21% open · ⏱️ 03.11.2021):

	```
	git clone https://github.com/kevin1024/vcrpy
	```
- [PyPi](https://pypi.org/project/vcrpy) (📥 1.5M / month):
	```
	pip install vcrpy
	```
...
<details><summary><b><a href="https://github.com/gabrielfalcao/HTTPretty">httpretty</a></b> (🥈29 ·  ⭐ 1.9K) - HTTP request mock tool for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 240 · 📦 5.3K · 📋 230 - 38% open · ⏱️ 05.11.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 100 · 🔀 270 · 📥 180 · 📋 300 - 0% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 81K / month):
	```
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 3.7K · ⏱️ 15.07.2020):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 70 · 📦 610 · 📋 170 - 1% open · ⏱️ 16.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/green) (📥 18K / month):
	```
	pip install green
	```
...
<details><summary><b><a href="https://github.com/nose-devs/nose2">nose2</a></b> (🥉21 ·  ⭐ 700) - The successor to `nose`, based on `unittest2`. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/nose2):
	...
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 40K · ⏱️ 02.02.2020):
	```
...
- [PyPi](https://pypi.org/project/factory_boy):
	...
	```
- [Conda](https://anaconda.org/conda-forge/factory_boy) (📥 86K · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 8 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 220 / month):
	```
	pip install sixpack
	```
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 110 · 📦 16 · 📋 22 - 31% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/fake2db) (📥 280 / month):
	```
	pip install fake2db
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 33 · 🔀 71 · 📋 590 - 16% open · ⏱️ 03.11.2021):
...
<details><summary><b><a href="https://github.com/berinhard/model_mommy">model_mommy</a></b> (🥉18 ·  ⭐ 930 · 💀) - Creating random fixtures for testing in Django. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/klen/mixer">mixer</a></b> (🥉16 ·  ⭐ 780) - Another fixtures replacement. Supports Django, Flask, SQLAlchemy,.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 37 · 🔀 190 · 📥 6.1K · 📦 400K · 📋 200 - 9% open · ⏱️ 10.11.2021):
...
- [PyPi](https://pypi.org/project/pyparsing):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 16M · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 30 · 🔀 85 · 📦 22K · 📋 51 - 3% open · ⏱️ 12.05.2021):
...
- [PyPi](https://pypi.org/project/python-slugify):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 580K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 11 · 🔀 200 · 📥 320 · 📦 1.3K · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/textdistance):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 62K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 100 · 📦 4.2K · 📋 120 - 8% open · ⏱️ 17.05.2021):
...
<details><summary><b><a href="https://github.com/andialbrecht/sqlparse">sqlparse</a></b> (🥈22 ·  ⭐ 2.6K) - A non-validating SQL parser. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 91 · 🔀 510 · 📋 450 - 41% open · ⏱️ 10.09.2021):
...
- [PyPi](https://pypi.org/project/sqlparse):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 500K · ⏱️ 10.09.2021):
	```
...
- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 32 · 🔀 340 · 📋 170 - 15% open · ⏱️ 18.06.2020):

	```
	git clone https://github.com/dabeaz/ply
	```
- [PyPi](https://pypi.org/project/ply) (📥 5.6M / month):
	```
	pip install ply
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 44 · 🔀 210 · 📋 120 - 48% open · ⏱️ 22.10.2021):
...
- [PyPi](https://pypi.org/project/pyfiglet):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyfiglet) (📥 75K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 20 · 🔀 510 · 📋 210 - 15% open · ⏱️ 06.10.2021):

	```
	git clone https://github.com/mozillazg/python-pinyin
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 63 / month):
	```
...
<details><summary><b><a href="https://github.com/skorokithakis/shortuuid">shortuuid</a></b> (🥉19 ·  ⭐ 1.5K · 📉) - A generator library for concise, unambiguous and URL-safe UUIDs. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 23 · 🔀 92 · ⏱️ 11.11.2021):
...
- [PyPi](https://pypi.org/project/shortuuid):
	...
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 120K · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/ztane/python-Levenshtein) (🔀 140 · 📦 9.7K · 📋 55 - 74% open · ⏱️ 01.02.2021):
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 170 · 🔀 2K · 📥 93 · 📦 79K · 📋 840 - 3% open · ⏱️ 11.11.2021):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 31M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 950K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 120 · 🔀 1.4K · 📦 140K · 📋 2.5K - 10% open · ⏱️ 10.11.2021):
...
- [PyPi](https://pypi.org/project/boto3):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 7.4M · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 140 · 🔀 820 · 📥 34 · 📦 13K · 📋 660 - 11% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 4.3M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 910 · 📦 3.2K · 📋 230 - 8% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/facebook-sdk) (📥 110K / month):
	```
...
- [GitHub](https://github.com/jcarbaugh/django-wordpress) (👨‍💻 10 · 🔀 79 · 📦 4 · 📋 11 - 18% open · ⏱️ 24.01.2018):
	...
	```
- [PyPi](https://pypi.org/project/django-wordpress) (📥 15 / month):
	```
...
<details><summary><b><a href="https://github.com/ellisonleao/pyshorteners">pyshorteners</a></b> (🥇23 ·  ⭐ 320 · 💀) - A pure Python URL shortening lib. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 54 · 📦 2.7K · 📋 73 - 2% open · ⏱️ 29.07.2020):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 57 · 🔀 140 · 📦 3.2K · 📋 260 - 1% open · ⏱️ 08.11.2021):
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥇23 ·  ⭐ 2K) - Most Powerful multi-threaded Video Processing framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 7 · 🔀 150 · 📥 490 · 📦 140 · 📋 180 - 1% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/abhiTronix/vidgear
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 2.9K / month):
	```
	pip install vidgear
	```
...
- [GitHub](https://github.com/miracle2k/webassets) (👨‍💻 160 · 🔀 250 · 📦 5.3K · 📋 290 - 19% open · ⏱️ 01.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/webassets) (📥 150K / month):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 220 · 🔀 690 · 📋 540 - 24% open · ⏱️ 06.11.2021):
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 820 · 📦 6.2K · 📋 340 - 41% open · ⏱️ 10.05.2020):
...
- [PyPi](https://pypi.org/project/requests-html):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 440 · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 21 · 🔀 460 · 📦 970 · 📋 93 - 16% open · ⏱️ 21.10.2021):
...
- [PyPi](https://pypi.org/project/sumy):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 470 · ⏱️ 22.10.2021):
	```
	conda install -c conda-forge sumy
	```
</details>
<details><summary><b><a href="https://github.com/codelucas/newspaper">newspaper</a></b> (🥈22 ·  ⭐ 11K · 💀) - News extraction, article extraction and content curation.. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/html2text):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 7.3K · ⏱️ 09.02.2020):
	```
	conda install -c conda-forge html2text
	```
</details>
<details><summary><b><a href="https://github.com/coleifer/micawber">micawber</a></b> (🥉19 ·  ⭐ 560) - A small library for extracting rich content from URLs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📋 53 - 9% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 87 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 49 · 🔀 1.3K · 📥 140 · 📦 40 · 📋 450 - 25% open · ⏱️ 10.07.2019):

	```
	git clone https://github.com/scrapinghub/portia
	```
- [PyPi](https://pypi.org/project/portia) (📥 360 / month):
	```
	pip install portia
	```
...
<details><summary><b><a href="https://github.com/jmcarp/robobrowser">robobrowser</a></b> (🥉18 ·  ⭐ 3.6K · 💀) - A simple, Pythonic library for browsing the web without a.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/MasoniteFramework/masonite">Masonite</a></b> (🥇21 ·  ⭐ 1.7K) - The modern and developer centric Python web framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 74 · 🔀 100 · 📥 8 · 📋 260 - 2% open · ⏱️ 25.07.2021):
...
- [PyPi](https://pypi.org/project/channels) (📥 390K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 65K · ⏱️ 11.07.2021):
	```
	conda install -c conda-forge channels
	```
</details>
<details><summary><b><a href="https://github.com/aaugustin/websockets">websockets</a></b> (🥉26 ·  ⭐ 3.7K) - A library for building WebSocket servers and clients with a focus.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 52 · 🔀 390 · 📦 43K · 📋 800 - 2% open · ⏱️ 06.11.2021):
...
- [PyPi](https://pypi.org/project/websockets):
	...
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 1M · ⏱️ 05.11.2021):
	```
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 120 · 🔀 610 · 📦 16K · 📋 830 - 21% open · ⏱️ 22.07.2021):
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 360 · 🔀 1.4K · 📥 98 · 📦 550K · 📋 1.7K - 17% open · ⏱️ 06.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/gunicorn) (📥 28M / month):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 440 · 🔀 1.5K · 📥 250 · 📦 620K · 📋 910 - 2% open · ⏱️ 07.11.2021):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 64M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 3.7M · ⏱️ 20.05.2021):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 41 · 🔀 180 · 📦 380 · 📋 140 - 18% open · ⏱️ 13.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 17K / month):
	```
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 55K · ⏱️ 08.11.2021):
	```
	conda install -c conda-forge bjoern
	```
</details>
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉21 ·  ⭐ 1K) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>
