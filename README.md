...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 18 · 🔀 740 · 📦 23 · 📋 1.1K - 1% open · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 760 · 📋 560 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 540 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 100 · 📋 10 - 60% open · ⏱️ 14.12.2021):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 440 / month):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 180 · 🔀 3.8K · 📦 55 · 📋 140 - 35% open · ⏱️ 16.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 880 / month):
	```
	pip install algorithms
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 440 · ⏱️ 23.04.2021):
	```
...
<details><summary><b><a href="https://github.com/tylerlaberge/PyPattyrn">PyPattyrn</a></b> (🥉15 ·  ⭐ 1.3K · 💀) - A simple yet effective library for implementing common design.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 20 · 🔀 150 · 📋 140 - 11% open · ⏱️ 13.10.2021):
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇33 ·  ⭐ 4.7K) - A lightning-fast ASGI server implementation, using uvloop and httptools. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 120 · 🔀 370 · 📦 46K · 📋 540 - 11% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 4.6M / month):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 710K · ⏱️ 08.12.2021):
	```
...
- [PyPi](https://pypi.org/project/daphne) (📥 390K / month):
	...
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 71K · ⏱️ 07.04.2021):
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 42 · 🔀 420 · 📥 350 · 📦 31K · 📋 270 - 18% open · ⏱️ 10.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 4M / month):
	```
	pip install uvloop
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 250 · 📦 3.2K · 📋 650 - 39% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 2.5M / month):
	```
	pip install trio
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 480 · 🔀 1.6K · 📥 7K · 📦 230 · 📋 2.4K - 18% open · ⏱️ 12.12.2021):
...
<details><summary><b><a href="https://github.com/jiaaro/pydub">pydub</a></b> (🥈26 ·  ⭐ 5.8K) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/tyiannak/pyAudioAnalysis">pyAudioAnalysis</a></b> (🥈24 ·  ⭐ 4.5K) - Audio feature extraction, classification, segmentation and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 19 · 📦 1.2K · 📋 93 - 11% open · ⏱️ 14.11.2021):
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉22 ·  ⭐ 4.9K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 92 · 🔀 760 · 📋 920 - 3% open · ⏱️ 13.12.2021):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 560K / month):
	```
	pip install librosa
	```
...
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥉22 ·  ⭐ 340) - A tool for working with audio files, specifically MP3 files containing.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.2K · 📦 19 · 📋 200 - 36% open · ⏱️ 03.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 96 / month):
	```
	pip install dejavu
	```
...
<details><summary><b><a href="https://github.com/devsnd/tinytag">tinytag</a></b> (🥉17 ·  ⭐ 500) - A library for reading music meta data of MP3, OGG, FLAC and Wave files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 20 · 🔀 82 · 📦 450 · 📋 85 - 11% open · ⏱️ 15.12.2021):
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉16 ·  ⭐ 520) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 65 · 📦 4 · 📋 32 - 34% open · ⏱️ 27.11.2021):
...
<details><summary><b><a href="https://github.com/jpadilla/pyjwt">pyjwt</a></b> (🥇32 ·  ⭐ 4.1K) - JSON Web Token implementation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 110 · 🔀 520 · 📦 170K · 📋 330 - 20% open · ⏱️ 12.12.2021):
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 570 · 🔀 2.4K · 📦 79K · 📋 1.8K - 14% open · ⏱️ 15.12.2021):
...
<details><summary><b><a href="https://github.com/lepture/authlib">authlib</a></b> (🥉21 ·  ⭐ 2.9K · 📉) - JavaScript Object Signing and Encryption draft implementation. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/omab/python-social-auth">python-social-auth</a></b> (🥉21 ·  ⭐ 2.8K · 💀) - An easy-to-setup social authentication mechanism. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/omab/python-social-auth) (👨‍💻 280 · 🔀 1.1K · 📦 5.2K · 📋 660 - 2% open · ⏱️ 04.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/python-social-auth):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 190 · 🔀 610 · 📋 650 - 19% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 55 · 🔀 580 · 📋 3.6K - 4% open · ⏱️ 15.12.2021):
...
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥈23 ·  ⭐ 950) - Efficient, Pythonic bidirectional map data structures and related.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/jab/bidict) (👨‍💻 11 · 🔀 43 · 📦 5.3K · 📋 46 - 4% open · ⏱️ 08.11.2021):
...
<details><summary><b><a href="https://github.com/stephenmcd/mezzanine">mezzanine</a></b> (🥇25 ·  ⭐ 4.4K) - A powerful, consistent, and flexible content management platform. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 120 · 🔀 310 · 📥 2.9K · 📋 3.2K - 18% open · ⏱️ 13.12.2021):
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 64 · 🔀 110 · 📦 220 · 📋 210 - 19% open · ⏱️ 02.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 300 / month):
	```
	pip install Kotti
	```
...
<details><summary><b><a href="https://github.com/feincms/feincms">feincms</a></b> (🥉15 ·  ⭐ 820) - One of the most advanced Content Management Systems built on Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/errbotio/errbot) (🔀 540 · 📦 240 · 📋 730 - 8% open · ⏱️ 11.12.2021):
...
<details><summary><b><a href="https://github.com/psf/black">black</a></b> (🥇32 ·  ⭐ 24K) - The uncompromising Python code formatter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/psf/black) (👨‍💻 290 · 🔀 1.5K · 📥 19K · 📦 100K · 📋 1.8K - 18% open · ⏱️ 16.12.2021):
...
- [PyPi](https://pypi.org/project/black):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 2.6M · ⏱️ 13.12.2021):
	```
	conda install -c conda-forge black
	```
</details>
<details><summary><b><a href="https://github.com/PyCQA/isort">isort</a></b> (🥇30 ·  ⭐ 4.4K) - A Python utility / library to sort imports. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 420 · 📦 210K · 📋 1K - 2% open · ⏱️ 06.12.2021):
...
<details><summary><b><a href="https://github.com/wemake-services/wemake-python-styleguide">wemake-python-styleguide</a></b> (🥈26 ·  ⭐ 1.7K) - The strictest and most opinionated python linter ever. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 860 · 📋 980 - 7% open · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 29 · 🔀 91 · 📦 1.3K · 📋 150 - 10% open · ⏱️ 27.10.2021):
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈23 ·  ⭐ 840) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 160 · 📋 140 - 22% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 32K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1K · 🔀 1.2K · 📋 1.5K - 10% open · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 70 · 🔀 210 · 📋 470 - 21% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 350 · 📋 280 - 25% open · ⏱️ 16.12.2021):
...
<details><summary><b><a href="https://github.com/scottrogowski/code2flow">code2flow</a></b> (🥉15 ·  ⭐ 1.5K) - Turn your Python and JavaScript code into DOT flowcharts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 7 · 🔀 160 · 📦 5 · 📋 26 - 7% open · ⏱️ 15.12.2021):
...
<details><summary><b><a href="https://github.com/willmcgugan/rich">rich</a></b> (🥈33 ·  ⭐ 32K) - Python library for rich text and beautiful formatting in the terminal. Also.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 140 · 🔀 1K · 📦 9.4K · 📋 610 - 3% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 2.9M / month):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 540K · ⏱️ 15.12.2021):
	```
...
<details><summary><b><a href="https://github.com/peterbrittain/asciimatics">asciimatics</a></b> (🥈26 ·  ⭐ 2.9K) - A package to create full-screen text UIs (from interactive.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 37 · 🔀 210 · 📦 560 · 📋 260 - 6% open · ⏱️ 01.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 8K / month):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (🔀 120 · 📦 500 · 📋 90 - 26% open · ⏱️ 06.11.2021):
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 140 · 🔀 3.2K · 📦 9.7K · 📋 720 - 15% open · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 260 · 🔀 1.5K · 📋 680 - 26% open · ⏱️ 11.12.2021):

	```
	git clone https://github.com/audreyr/cookiecutter
	```
- [PyPi](https://pypi.org/project/cookiecutter) (📥 1.3M / month):
	```
...
<details><summary><b><a href="https://github.com/dbcli/pgcli">pgcli</a></b> (🥈27 ·  ⭐ 10K) - PostgreSQL CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 180 · 🔀 2.9K · 📦 310 · 📋 620 - 30% open · ⏱️ 05.09.2021):
...
<details><summary><b><a href="https://github.com/tmux-python/tmuxp">tmuxp</a></b> (🥈23 ·  ⭐ 3.3K) - A [tmux](https://github.com/tmux/tmux) session manager. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 24 · 🔀 74 · 📥 7.3K · 📋 190 - 30% open · ⏱️ 22.11.2021):
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈21 ·  ⭐ 450) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 24 · 🔀 44 · 📦 31 · 📋 220 - 13% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 3.9K / month):
	```
	pip install copier
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 90 · 🔀 1.7K · 📥 870K · 📦 750 · 📋 470 - 29% open · ⏱️ 15.10.2021):
...
<details><summary><b><a href="https://github.com/sirfz/tesserocr">tesserocr</a></b> (🥈27 ·  ⭐ 1.6K) - Another simple, Pillow-friendly, wrapper around the `tesseract-ocr`.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 26 · 🔀 200 · 📦 580 · 📋 230 - 31% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 73K / month):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉21 ·  ⭐ 5.6K) - Open Source Differentiable Computer Vision Library for PyTorch. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 540 · 📥 160 · 📦 830 · 📋 490 - 22% open · ⏱️ 12.12.2021):
...
- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 29 · 🔀 140 · 📥 4 · 📦 53K · 📋 72 - 9% open · ⏱️ 11.12.2021):

	```
	git clone https://github.com/henriquebastos/python-decouple
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 620K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 83 · 🔀 380 · 📦 5 · 📋 940 - 10% open · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 160 · 🔀 1.7K · 📦 51K · 📋 1.3K - 53% open · ⏱️ 29.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 20M / month):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 62 · 🔀 180 · 📋 270 - 16% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 220 · 📦 7 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 71 / month):
	```
	pip install mining
	```
...
<details><summary><b><a href="https://github.com/Julian/jsonschema">jsonschema</a></b> (🥇33 ·  ⭐ 3.5K) - An implementation of [JSON Schema](http://json-schema.org/) for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Julian/jsonschema) (👨‍💻 96 · 🔀 480 · 📦 190K · 📋 620 - 9% open · ⏱️ 15.12.2021):
...
- [PyPi](https://pypi.org/project/jsonschema) (📥 35M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 8.9M · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 160 · 🔀 1.5K · 📥 210 · 📦 130K · 📋 1.9K - 4% open · ⏱️ 27.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 6.9M / month):
	```
	pip install seaborn
	```
...
<details><summary><b><a href="https://github.com/SciTools/cartopy">Cartopy</a></b> (🥉27 ·  ⭐ 970) - A cartographic python library with matplotlib support. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 97 · 🔀 870 · 📋 310 - 56% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 54K / month):
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 280 · 🔀 2K · 📦 130K · 📋 990 - 7% open · ⏱️ 16.12.2021):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 530K · ⏱️ 22.11.2021):
	```
...
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥈23 ·  ⭐ 730) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 34 · 🔀 130 · 📦 420 · 📋 210 - 14% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 190 · 🔀 920 · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 150 · 📦 570 · 📋 200 - 10% open · ⏱️ 08.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/happybase) (📥 100K / month):
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 21 · 📦 9 · 📋 6 - 83% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 510 / month):
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 5 · 🔀 16 · 📦 20 · ⏱️ 31.08.2021):
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 250 · 🔀 830 · 📥 170 · 📦 45K · 📋 780 - 9% open · ⏱️ 16.12.2021):
...
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-debug-toolbar) (📥 130K · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 80 · 🔀 400 · 📦 2.8K · 📋 170 - 32% open · ⏱️ 15.12.2021):
...
- [PyPi](https://pypi.org/project/py-spy) (📥 600K / month):
	...
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 190K · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/flask-debugtoolbar/flask-debugtoolbar) (👨‍💻 38 · 🔀 120 · 📦 16K · 📋 89 - 29% open · ⏱️ 14.08.2020):
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 220 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 95 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 700 · 📥 140 · ⏱️ 22.05.2020):
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.1K · 📦 120K · 📋 1.5K - 12% open · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.5K · 🔀 21K · 📦 19K · 📋 30K - 3% open · ⏱️ 14.12.2021):
...
- [PyPi](https://pypi.org/project/ansible) (📥 5M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 470K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.7K · 🔀 5K · 📥 16K · 📋 24K - 9% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 60 · 🔀 260 · 📦 37 · 📋 510 - 17% open · ⏱️ 13.12.2021):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 5.5K / month):
	```
	pip install pyinfra
	```
...
<details><summary><b><a href="https://github.com/dask/dask">dask</a></b> (🥈30 ·  ⭐ 9.3K) - A flexible parallel computing library for analytic computing. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/dask/dask) (👨‍💻 490 · 🔀 1.4K · 📦 32K · 📋 4K - 16% open · ⏱️ 15.12.2021):
...
- [PyPi](https://pypi.org/project/dask):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 4.7M · ⏱️ 11.12.2021):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 3K · 📦 3.5K · 📋 8.6K - 21% open · ⏱️ 16.12.2021):
...
<details><summary><b><a href="https://github.com/robinhood/faust">faust</a></b> (🥉21 ·  ⭐ 5.9K · 💀) - A stream processing library, porting the ideas from [Kafka.. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/pyinstaller/pyinstaller">PyInstaller</a></b> (🥇24 ·  ⭐ 8.7K) - Converts Python programs into stand-alone executables.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.6K · 📥 720K · 📋 4.4K - 7% open · ⏱️ 12.12.2021):
...
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈21 ·  ⭐ 1.3K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 17 · 🔀 150 · 📥 18 · 📦 330 · 📋 620 - 1% open · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.5K · 📦 170K · 📋 5.7K - 15% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 32 · 🔀 110 · 📦 470 · 📋 200 - 4% open · ⏱️ 26.11.2021):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 98K / month):
	```
	pip install pdoc
	```
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 20 · 🔀 910 · 📦 120 · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 230 · 🔀 1.3K · 📥 1.1M · 📦 21K · 📋 14K - 8% open · ⏱️ 15.12.2021):
...
<details><summary><b><a href="https://github.com/mailgun/flanker">flanker</a></b> (🥈22 ·  ⭐ 1.5K · 💤) - An email address and Mime parsing library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/pyenv/pyenv">pyenv</a></b> (🥇23 ·  ⭐ 26K) - Simple Python version management. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 350 · 🔀 2.2K · 📋 1.4K - 2% open · ⏱️ 09.12.2021):
...
<details><summary><b><a href="https://github.com/gorakhargosh/watchdog">watchdog</a></b> (🥇32 ·  ⭐ 5.1K) - API and shell utilities to monitor file system events. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 120 · 🔀 590 · 📦 45K · 📋 550 - 27% open · ⏱️ 15.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 5.2M / month):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 53 · 🔀 220 · 📦 21K · 📋 160 - 14% open · ⏱️ 23.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-magic) (📥 3.4M / month):
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 37 · 📦 6.3K · 📋 17 - 41% open · ⏱️ 14.02.2015):
	...
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 71K / month):
	```
	pip install Unipath
	```
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 130 · 🔀 350 · 📦 110K · 📋 380 - 10% open · ⏱️ 07.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 2.1M / month):
	```
	pip install wtforms
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 98 · 🔀 670 · 📦 16K · 📋 290 - 1% open · ⏱️ 13.12.2021):
...
- [PyPi](https://pypi.org/project/more-itertools):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 8.5M · ⏱️ 24.11.2021):
	```
	conda install -c conda-forge more-itertools
	```
</details>
<details><summary><b><a href="https://github.com/pytoolz/toolz">Toolz</a></b> (🥈30 ·  ⭐ 3.8K) - A collection of functional utilities for iterators, functions, and.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 28 · 🔀 120 · 📦 4K · 📋 66 - 6% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 37 · 🔀 85 · 📦 120 · 📋 370 - 14% open · ⏱️ 15.12.2021):
...
- [PyPi](https://pypi.org/project/returns):
	...
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 570 · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 61 · 📦 34K · 📋 62 - 35% open · ⏱️ 06.11.2021):
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇28 ·  ⭐ 990) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 120 · 🔀 200 · 📦 15K · 📋 290 - 19% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.3K · 📦 4K · 📋 2.5K - 25% open · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 310 · 📦 230 · 📋 830 - 12% open · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 200 · 🔀 500 · 📋 500 - 24% open · ⏱️ 13.12.2021):
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 120 · 🔀 540 · 📦 30K · 📋 250 - 9% open · ⏱️ 26.09.2021):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 37 · 🔀 100 · 📦 730K · ⏱️ 05.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/markupsafe) (📥 79M / month):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 700 · 🔀 8.2K · 📦 1.2M · 📋 3.5K - 5% open · ⏱️ 05.12.2021):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 150 · 🔀 510 · 📦 14K · 📋 640 - 6% open · ⏱️ 14.12.2021):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 5.2M / month):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 93K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 290 · 🔀 840 · 📥 1.1K · 📦 720K · 📋 970 - 12% open · ⏱️ 14.12.2021):
...
<details><summary><b><a href="https://github.com/httplib2/httplib2">httplib2</a></b> (🥉30 ·  ⭐ 430) - Comprehensive HTTP client library. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 69 · 🔀 150 · 📦 92K · 📋 100 - 38% open · ⏱️ 19.11.2021):

	```
	git clone https://github.com/httplib2/httplib2
	```
- [PyPi](https://pypi.org/project/httplib2) (📥 25M / month):
	```
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 300 · 📦 2.7K · 📋 100 - 8% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/grequests) (📥 980K / month):
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 360 · 🔀 1.5K · 📦 6.7K · 📋 1.3K - 3% open · ⏱️ 10.12.2021):
...
- [PyPi](https://pypi.org/project/keyboard):
	...
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 2.4K · ⏱️ 08.11.2021):
	```
...
<details><summary><b><a href="https://github.com/boppreh/mouse">mouse</a></b> (🥉17 ·  ⭐ 550 · 💤) - Hook and simulate global mouse events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 83 · 📦 460 · 📋 91 - 71% open · ⏱️ 05.04.2021):
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 97 · 🔀 190 · 📥 5.3K · 📦 7.9K · 📋 360 - 3% open · ⏱️ 20.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/wand) (📥 390K / month):
	```
	pip install wand
	```
...
<details><summary><b><a href="https://github.com/thumbor/thumbor">thumbor</a></b> (🥇28 ·  ⭐ 8.7K) - A smart imaging service. It enables on-demand crop, re-sizing and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 40 · 🔀 88 · 📥 180 · 📦 9.9K · 📋 81 - 37% open · ⏱️ 12.12.2021):
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 240 · 📥 650 · 📦 160 · 📋 480 - 21% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 9 · 🔀 34 · 📦 38 · 📋 7 - 57% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/ajknzhol/pygram) (🔀 12 · ⏱️ 22.02.2014):
	...
	```
- [PyPi](https://pypi.org/project/pygram) (📥 93 / month):
	```
	pip install pygram
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 460 · 🔀 3.7K · 📥 29K · 📋 3.9K - 27% open · ⏱️ 15.12.2021):
...
<details><summary><b><a href="https://github.com/python/cpython">CPython</a></b> (🥈21 ·  ⭐ 42K) - **Default, most widely used implementation of the Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/cpython) (👨‍💻 1.9K · 🔀 21K · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 17 · 🔀 67 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 2.8K / month):
	```
	pip install Pyjion
	```
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉10 ·  ⭐ 780) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/ptpython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 7.5K · ⏱️ 14.11.2021):
	```
...
- [PyPi](https://pypi.org/project/pyicu):
	...
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 73K · ⏱️ 15.12.2021):
	```
...
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥇29 ·  ⭐ 7.9K) - A modern workflow orchestration framework that makes it easy to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 280 · 🔀 730 · 📦 530 · 📋 2K - 18% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 45 · 🔀 750 · 📦 15K · 📋 350 - 30% open · ⏱️ 26.06.2021):
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 43 · 🔀 240 · 📦 28 · 📋 73 - 4% open · ⏱️ 15.12.2021):
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥇29 ·  ⭐ 11K) - Library which aims to bring enjoyable logging in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 30 · 🔀 460 · 📦 13K · 📋 500 - 18% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 110 · 🔀 240 · 📥 4.5K · 📦 16K · 📋 580 - 29% open · ⏱️ 13.12.2021):
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 330 · 🔀 7K · 📦 25K · 📋 1.4K - 6% open · ⏱️ 16.12.2021):
...
- [PyPi](https://pypi.org/project/gym) (📥 930K / month):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 83K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 220 · 🔀 1.8K · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/josephreisinger/vowpal_porpoise) (👨‍💻 14 · 🔀 28 · 📋 9 - 66% open · ⏱️ 07.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/vowpal_porpoise) (📥 6 / month):
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 95 · 🔀 470 · 📦 57 · 📋 1K - 16% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 70 · 🔀 640 · 📥 510K · 📦 63K · 📋 1.6K - 27% open · ⏱️ 14.12.2021):
...
<details><summary><b><a href="https://github.com/fxsjy/jieba">jieba</a></b> (🥇31 ·  ⭐ 28K · 💀) - The most popular Chinese text segmentation library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/clips/pattern">pattern</a></b> (🥈25 ·  ⭐ 8.1K · 💀) - A web mining module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 750 · 📋 100 - 37% open · ⏱️ 19.01.2020):
...
- [PyPi](https://pypi.org/project/snownlp):
	...
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 250 · ⏱️ 07.09.2021):
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 420 · 📋 170 - 24% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 2M / month):
	```
	pip install pox
	```
...
<details><summary><b><a href="https://github.com/justquick/django-activity-stream">django-activity-stream</a></b> (🥇27 ·  ⭐ 2K) - Generating generic activity streams from the actions.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 440 · 📦 740 · 📋 290 - 19% open · ⏱️ 19.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-activity-stream) (📥 31K / month):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 270 · 📦 2.2K · 📋 260 - 3% open · ⏱️ 16.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/dataset) (📥 86K / month):
	```
	pip install dataset
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 92 · 🔀 370 · 📦 870 · 📋 470 - 39% open · ⏱️ 01.12.2021):
...
<details><summary><b><a href="https://github.com/python-poetry/poetry">poetry</a></b> (🥇28 ·  ⭐ 18K) - Python dependency management and packaging made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.4K · 📥 9.8M · 📋 3.3K - 33% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 410 · 📋 780 - 14% open · ⏱️ 12.11.2021):
...
- [GitHub](https://github.com/pypa/warehouse) (👨‍💻 310 · 🔀 720 · 📋 2.4K - 13% open · ⏱️ 16.12.2021):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 88 · 📋 180 - 13% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 24 · 🔀 110 · 📦 720 · 📋 100 - 20% open · ⏱️ 23.11.2021):
...
<details><summary><b><a href="https://github.com/amoffat/sh">sh</a></b> (🥇30 ·  ⭐ 6K) - A full-fledged subprocess replacement for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/spotify/annoy">annoy</a></b> (🥇30 ·  ⭐ 9.3K) - Approximate Nearest Neighbors in C++/Python optimized for memory usage. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/ibayer/fastFM">fastFM</a></b> (🥉20 ·  ⭐ 960 · 💤) - A library for Factorization Machines. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 190 · 📥 420 · 📦 91 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 2.4K / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 26 · 📋 120 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 310 / month):
	```
...
- [GitHub](https://github.com/ycjuan/libffm) (👨‍💻 5 · 🔀 420 · 📋 36 - 58% open · ⏱️ 22.02.2019):
	...
	```
- [PyPi](https://pypi.org/project/libffm) (📥 39 / month):
	```
	pip install libffm
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 68 · 🔀 130 · 📦 33K · 📋 230 - 30% open · ⏱️ 13.12.2021):
...
<details><summary><b><a href="https://github.com/falconry/falcon">falcon</a></b> (🥇30 ·  ⭐ 8.7K) - A high-performance framework for building cloud APIs and web app.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/falconry/falcon) (👨‍💻 180 · 🔀 840 · 📥 1.5K · 📦 6.1K · 📋 930 - 19% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 310 · 🔀 1.4K · 📦 6.2K · 📋 1.1K - 3% open · ⏱️ 15.12.2021):
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥈27 ·  ⭐ 39K) - A modern, fast, web framework for building APIs with Python 3.6+ based on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 280 · 🔀 2.9K · 📋 2.5K - 32% open · ⏱️ 12.12.2021):
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 94 · 🔀 4.3K · 📋 260 - 3% open · ⏱️ 13.12.2021):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.5K · 📥 440K · 📦 38K · 📋 11K - 32% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 2.1M / month):
	```
	pip install sympy
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 150 · 🔀 3.9K · 📦 800 · 📋 960 - 32% open · ⏱️ 14.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/zipline) (📥 4.3K / month):
	```
	pip install zipline
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 350 · 🔀 1.4K · 📥 1.2K · 📦 570 · 📋 2.5K - 8% open · ⏱️ 16.12.2021):
...
<details><summary><b><a href="https://github.com/benedekrozemberczki/karateclub">Karate Club</a></b> (🥉22 ·  ⭐ 1.5K) - Unsupervised machine learning toolbox for graph structured data. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/bcbio/bcbio-nextgen">bcbio-nextgen</a></b> (🥉20 ·  ⭐ 850) - Providing best-practice pipelines for fully automated high.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 93 · 🔀 330 · 📋 2.9K - 3% open · ⏱️ 16.12.2021):
...
<details><summary><b><a href="https://github.com/marshmallow-code/marshmallow">marshmallow</a></b> (🥇30 ·  ⭐ 5.9K) - A lightweight library for converting complex objects to and from.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 560 · 📦 37K · 📋 1.1K - 9% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/marshmallow-code/marshmallow
	```
- [PyPi](https://pypi.org/project/marshmallow) (📥 11M / month):
	```
...
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 580K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 770K · ⏱️ 12.11.2021):
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 12 · 🔀 40 · 📦 170 · 📋 70 - 11% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/TkTech/pysimdjson
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 93K / month):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 76 · 🔀 310 · 📋 310 - 13% open · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 500 · 📥 5.8K · 📦 280 · 📋 2.2K - 12% open · ⏱️ 12.12.2021):
...
<details><summary><b><a href="https://github.com/jazzband/tablib">tablib</a></b> (🥇29 ·  ⭐ 4.1K) - A module for Tabular Datasets in XLS, CSV, JSON, YAML. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/jmcnamara/XlsxWriter">XlsxWriter</a></b> (🥇29 ·  ⭐ 2.8K) - A Python module for creating Excel .xlsx files. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 540 · 📦 970 · 📋 830 - 7% open · ⏱️ 08.10.2021):

	```
	git clone https://github.com/wireservice/csvkit
	```
- [PyPi](https://pypi.org/project/csvkit) (📥 54K / month):
	```
	pip install csvkit
	```
...
<details><summary><b><a href="https://github.com/xlwings/xlwings">xlwings</a></b> (🥈25 ·  ⭐ 2.2K) - A BSD-licensed library that makes it easy to call Python from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 56 · 🔀 380 · 📥 27K · 📦 20K · 📋 1.4K - 22% open · ⏱️ 16.12.2021):
...
- [PyPi](https://pypi.org/project/xlwings):
	...
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 390K · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 150 · 🔀 680 · 📦 170K · 📋 730 - 3% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 43 · 🔀 280 · 📦 950 · 📋 320 - 22% open · ⏱️ 06.10.2021):
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 420 · 🔀 1.7K · 📥 450 · 📦 5.5K · 📋 1.5K - 2% open · ⏱️ 27.11.2021):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 220 · 🔀 330 · 📦 390 · 📋 2.1K - 1% open · ⏱️ 11.12.2021):
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 89 · 🔀 270 · 📥 6.9K · 📋 560 - 38% open · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 140 · 🔀 540 · 📋 370 - 17% open · ⏱️ 16.12.2021):

	```
	git clone https://github.com/jazzband/django-taggit
	```
- [PyPi](https://pypi.org/project/django-taggit) (📥 280K / month):
	```
...
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇32 ·  ⭐ 8.1K) - Simple job queues for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/rq/rq) (👨‍💻 250 · 🔀 1.2K · 📦 9.2K · 📋 930 - 16% open · ⏱️ 11.12.2021):
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 75 · 🔀 200 · 📥 32 · 📦 360 · 📋 270 - 8% open · ⏱️ 13.12.2021):

	```
	git clone https://github.com/Bogdanp/dramatiq
	```
- [PyPi](https://pypi.org/project/dramatiq) (📥 62K / month):
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 430 · 🔀 1.5K · 📦 45K · 📋 530 - 24% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/faker) (📥 5.3M / month):
	```
	pip install faker
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 100 · 🔀 270 · 📥 23 · 📦 11K · 📋 200 - 16% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/responses) (📥 5.6M / month):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 260 · 🔀 450 · 📦 11K · 📋 1.2K - 4% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 2.3M / month):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5.1M · ⏱️ 15.12.2021):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 220 · 🔀 2.2K · 📦 2.1K · 📋 1.2K - 1% open · ⏱️ 13.12.2021):
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.7K · 📋 3.7K - 4% open · ⏱️ 15.12.2021):
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 490 · 📦 5.1K · 📋 490 - 10% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 270 · 📥 190 · 📋 300 - 0% open · ⏱️ 16.12.2021):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 88K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 4.1K · ⏱️ 15.07.2020):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 22 · 🔀 36 · 📦 60 · 📋 54 - 3% open · ⏱️ 10.12.2021):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 40 · 🔀 200 · 📥 6.2K · 📦 420K · 📋 210 - 8% open · ⏱️ 15.12.2021):
...
- [PyPi](https://pypi.org/project/python-slugify):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 630K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 20 · 🔀 90 · 📦 15K · 📋 41 - 21% open · ⏱️ 04.09.2021):
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 22 · 📦 57 · 📋 8 - 37% open · ⏱️ 09.02.2019):
...
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥇35 ·  ⭐ 5.3K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2K · 📥 93 · 📦 82K · 📋 860 - 4% open · ⏱️ 14.12.2021):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 30M / month):
	```
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 130 · 🔀 1.4K · 📦 150K · 📋 2.5K - 10% open · ⏱️ 13.12.2021):
...
- [PyPi](https://pypi.org/project/boto3):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 7.9M · ⏱️ 14.12.2021):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 140 · 🔀 820 · 📥 52 · 📦 13K · 📋 670 - 9% open · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 58 · 🔀 140 · 📦 3.4K · 📋 260 - 2% open · ⏱️ 12.12.2021):
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 55 · 📦 3.2K · 📋 74 - 4% open · ⏱️ 29.07.2020):
...
<details><summary><b><a href="https://github.com/gruns/furl">furl</a></b> (🥉19 ·  ⭐ 2.2K) - A small Python library that makes parsing and manipulating URLs easy. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 220 · 🔀 690 · 📋 550 - 25% open · ⏱️ 06.11.2021):
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 200 · 🔀 540 · 📋 600 - 16% open · ⏱️ 14.12.2021):
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 820 · 📦 6.4K · 📋 340 - 42% open · ⏱️ 10.05.2020):
...
- [PyPi](https://pypi.org/project/requests-html):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 530 · ⏱️ 26.06.2021):
	```
...
- [PyPi](https://pypi.org/project/sumy):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 560 · ⏱️ 22.10.2021):
	```
...
- [PyPi](https://pypi.org/project/html2text):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 7.7K · ⏱️ 09.02.2020):
	```
...
- [GitHub](https://github.com/binux/pyspider) (👨‍💻 62 · 🔀 3.5K · 📦 300 · 📋 810 - 33% open · ⏱️ 02.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyspider) (📥 6.6K / month):
	```
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 65 · 🔀 250 · 📦 330 · 📋 220 - 12% open · ⏱️ 08.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 3.4K / month):
	```
	pip install grab
	```
...
<details><summary><b><a href="https://github.com/MechanicalSoup/MechanicalSoup">MechanicalSoup</a></b> (🥈23 ·  ⭐ 3.9K) - A Python library for automating interaction with websites. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 52 · 🔀 390 · 📦 45K · 📋 820 - 2% open · ⏱️ 20.11.2021):

	```
	git clone https://github.com/aaugustin/websockets
	```
- [PyPi](https://pypi.org/project/websockets) (📥 7.9M / month):
	```
...
- [GitHub](https://github.com/django/channels) (👨‍💻 230 · 🔀 680 · 📦 15K · 📋 1.1K - 9% open · ⏱️ 13.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/channels) (📥 410K / month):
	```
	pip install channels
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 70K · ⏱️ 11.07.2021):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 440 · 🔀 1.6K · 📥 250 · 📦 640K · 📋 910 - 2% open · ⏱️ 15.12.2021):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 47M / month):
	```
