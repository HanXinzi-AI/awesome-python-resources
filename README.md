...
- [GitHub](https://github.com/mher/flower) (👨‍💻 210 · 🔀 980 · 📦 16K · 📋 900 - 9% open · ⏱️ 17.12.2023):
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 25 · 🔀 810 · 📦 26 · 📋 1.2K - 1% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 520 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 44 · 📋 210 - 23% open · ⏱️ 14.12.2023):

	```
	git clone https://github.com/wooey/wooey
	```
- [PyPi](https://pypi.org/project/wooey) (📥 550 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 140 · 📦 13 · 📋 21 - 33% open · ⏱️ 26.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 140 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 1.2K · 🔀 42K · 📦 2 · 📋 1.4K - 1% open · ⏱️ 20.12.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 110M · ⏱️ 15.12.2023):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 76 · 🔀 500 · 📦 3.3K · 📋 440 - 3% open · ⏱️ 20.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/transitions) (📥 480K / month):
	```
...
<details><summary><b><a href="https://github.com/faif/python-patterns">python-patterns</a></b> (🥉19 ·  ⭐ 39K · 💤) - A collection of design patterns in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 130 · 🔀 6.6K · 📦 21 · 📋 85 - 14% open · ⏱️ 27.01.2023):
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 140 · 📦 42 · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 1.6K / month):
	```
...
<details><summary><b><a href="https://github.com/prabhupant/python-ds">python-ds</a></b> (🥉16 ·  ⭐ 2.5K · 💀) - A collection of data structure and algorithms for coding interviews. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 110 · 🔀 560 · 📋 89 - 19% open · ⏱️ 04.10.2022):

	```
	git clone https://github.com/prabhupant/python-ds
	```
- [PyPi](https://pypi.org/project/python-ds) (📥 31 / month):
	```
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇36 ·  ⭐ 7.4K · 📈) - A lightning-fast ASGI server implementation, using uvloop and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 170 · 🔀 610 · 📦 280K · 📋 660 - 4% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 60 · 🔀 500 · 📥 430 · 📦 110K · 📋 340 - 23% open · ⏱️ 22.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 9.9M / month):
	```
	pip install uvloop
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 150 · 🔀 300 · 📦 48K · 📋 760 - 36% open · ⏱️ 19.12.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 9.9M / month):
	```
	pip install trio
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 960 · 📦 45K · 📋 550 - 50% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 3.2M / month):
	```
	pip install pydub
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 560 · 🔀 1.7K · 📥 8.9K · 📦 350 · 📋 2.7K - 19% open · ⏱️ 17.12.2023):
...
- [PyPi](https://pypi.org/project/beets) (📥 4.2K / month):
	...
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 700 · ⏱️ 18.06.2023):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 44 · 🔀 150 · 📥 61K · 📦 16K · 📋 510 - 18% open · ⏱️ 28.10.2023):
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 28 · 🔀 1.1K · 📦 420 · 📋 300 - 60% open · ⏱️ 22.10.2023):
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 24 · 🔀 100 · 📦 17K · 📋 88 - 36% open · ⏱️ 15.12.2023):
...
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥉24 ·  ⭐ 510 · 💀) - A tool for working with audio files, specifically MP3 files.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 120 · 🔀 880 · 📋 1.2K - 4% open · ⏱️ 13.12.2023):
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 26 · 📦 2.3K · 📋 95 - 13% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/kapre) (📥 1.2K / month):
	```
	pip install kapre
	```
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 140 · 📦 28 · 📋 46 - 34% open · ⏱️ 23.08.2023):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 1.6K / month):
	```
...
- [GitHub](https://github.com/yomguy/TimeSide) (👨‍💻 22 · 🔀 60 · 📦 16 · 📋 220 - 14% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 89 / month):
	```
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 26 · 🔀 96 · 📋 100 - 9% open · ⏱️ 26.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 24K / month):
	```
	pip install tinytag
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 200 · 🔀 460 · 📦 480K · 📋 370 - 21% open · ⏱️ 25.10.2023):
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 140 · 🔀 630 · 📦 500K · 📋 420 - 3% open · ⏱️ 16.12.2023):
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 100 · 🔀 380 · 📦 30K · 📋 410 - 15% open · ⏱️ 17.12.2023):
...
- [PyPi](https://pypi.org/project/authlib) (📥 7M / month):
	...
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 120K · ⏱️ 18.12.2023):
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 11K · 📋 130 - 39% open · ⏱️ 12.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 140K / month):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 670 · 🔀 2.8K · 📦 21 · 📋 2.1K - 2% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/pennersr/django-allauth
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 800K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 240 · 🔀 720 · 📋 800 - 19% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 150 · 🔀 340 · 📦 910K · 📋 670 - 17% open · ⏱️ 08.12.2023):
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 15 · 🔀 61 · 📦 21K · 📋 57 - 5% open · ⏱️ 02.12.2023):
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 22 · 📥 90 · 📦 96 · 📋 9 - 77% open · ⏱️ 30.10.2015):
	...
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 130 / month):
	```
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.6K · 📋 1.1K - 3% open · ⏱️ 02.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 2.6K / month):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 380 · 📥 3K · 📋 3.5K - 19% open · ⏱️ 19.12.2023):
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 54 · 🔀 120 · 📥 460 · 📦 4.9K · 📋 190 - 11% open · ⏱️ 11.10.2023):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 430 · 🔀 2.2K · 📥 53K · 📦 450K · 📋 2.5K - 14% open · ⏱️ 14.12.2023):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 30M / month):
	```
	pip install black
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 290 · 🔀 530 · 📦 440K · 📋 1.2K - 13% open · ⏱️ 13.12.2023):

	```
	git clone https://github.com/timothycrosley/isort
	```
- [PyPi](https://pypi.org/project/isort) (📥 29M / month):
	```
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 5.6M · ⏱️ 14.12.2023):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 380 · 📦 16K · 📋 1.1K - 9% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/landscapeio/prospector) (👨‍💻 90 · 🔀 170 · 📦 4.7K · 📋 370 - 15% open · ⏱️ 18.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 720K / month):
	```
	pip install prospector
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 97K · ⏱️ 19.10.2023):
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 39 · 🔀 130 · 📦 4.2K · 📋 200 - 11% open · ⏱️ 06.12.2023):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 520K / month):
	```
	pip install vulture
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 250 · 🔀 410 · 📦 21 · 📋 380 - 31% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 70K / month):
	```
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 280 · 📦 420 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 5.2K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 100 · 🔀 260 · 📋 670 - 21% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 490K / month):
	```
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 180K · ⏱️ 19.12.2023):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 260 · 📦 37 · 📋 64 - 29% open · ⏱️ 08.01.2023):
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 47 · 🔀 160 · 📋 180 - 23% open · ⏱️ 21.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 99K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.4K · 🔀 1.6K · 📋 2.3K - 7% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.3K · 📥 12K · 📦 610K · 📋 950 - 39% open · ⏱️ 10.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 84M / month):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 45 · 🔀 240 · 📦 950 · 📋 300 - 7% open · ⏱️ 30.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 59K / month):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 180 · 📦 2.6K · 📋 210 - 7% open · ⏱️ 02.12.2023):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 630K / month):
	```
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 83 · 📦 170 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 3.5K / month):
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥇29 ·  ⭐ 1.4K) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 70 · 🔀 150 · 📦 770 · 📋 420 - 12% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 190K / month):
	```
	pip install copier
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 74 · 🔀 230 · 📦 280 · 📋 340 - 24% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/httpie/cli) (👨‍💻 160 · 🔀 3.6K · 📥 6.4K · 📦 1 · 📋 840 - 18% open · ⏱️ 24.10.2023):

	```
	git clone https://github.com/jakubroztocil/httpie
	```
- [PyPi](https://pypi.org/project/httpie) (📥 380K / month):
	```
	pip install httpie
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 180 · 🔀 520 · 📦 1.2K · 📋 680 - 20% open · ⏱️ 09.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 85K / month):
	```
	pip install pgcli
	```
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 83 · 🔀 850 · 📦 480 · 📋 260 - 4% open · ⏱️ 13.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 2.7K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 31 · 🔀 97 · 📥 12K · 📦 18 · 📋 210 - 24% open · ⏱️ 21.12.2023):

	```
	git clone https://github.com/laixintao/iredis
	```
- [PyPi](https://pypi.org/project/iredis) (📥 2.3K / month):
	```
	pip install iredis
	```
...
- [PyPi](https://pypi.org/project/litecli) (📥 13K / month):
	...
	pip install litecli
	```
- [Conda](https://anaconda.org/conda-forge/litecli) (📥 63 · ⏱️ 05.12.2023):
	```
...
- [GitHub](https://github.com/mooz/percol) (👨‍💻 36 · 🔀 140 · 📦 34 · 📋 65 - 55% open · ⏱️ 23.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/percol) (📥 820 / month):
	```
	pip install percol
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 49 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 54K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 130 · 🔀 2.8K · 📥 7.8M · 📦 4.6K · 📋 900 - 35% open · ⏱️ 04.09.2023):

	```
	git clone https://github.com/JaidedAI/EasyOCR
	```
- [PyPi](https://pypi.org/project/EasyOCR) (📥 240K / month):
	```
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 9.9K · ⏱️ 05.09.2023):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 29 · 🔀 250 · 📥 72 · 📦 920 · 📋 270 - 18% open · ⏱️ 09.10.2023):
...
- [GitHub](https://github.com/kornia/kornia) (🔀 880 · 📥 880 · 📦 7.6K · 📋 830 - 27% open · ⏱️ 19.12.2023):
...
<details><summary><b><a href="https://github.com/madmaze/pytesseract">pytesseract</a></b> (🥉25 ·  ⭐ 5.3K) - A wrapper for [Google Tesseract.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 45 · 🔀 670 · 📋 350 - 2% open · ⏱️ 18.11.2023):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 25 · 🔀 85 · 📦 400 · 📋 75 - 44% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 35 · 🔀 190 · 📥 12 · 📦 120K · 📋 93 - 8% open · ⏱️ 17.04.2023):
...
<details><summary><b><a href="https://github.com/DiffSK/configobj">configobj</a></b> (🥉27 ·  ⭐ 300 · 💤) - INI file parser with validation. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 72 · 📥 360 · 📦 32K · 📋 150 - 37% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/DiffSK/configobj
	```
- [PyPi](https://pypi.org/project/configobj) (📥 3.3M / month):
	```
	pip install configobj
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 760K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 190 · 🔀 1.9K · 📦 88K · 📋 1.6K - 49% open · ⏱️ 18.12.2023):
...
- [PyPi](https://pypi.org/project/paramiko) (📥 47M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 4.1M · ⏱️ 19.12.2023):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 67 · 🔀 210 · 📋 290 - 14% open · ⏱️ 17.12.2023):
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 140 · 🔀 640 · 📥 220K · 📦 1.3K · 📋 1K - 3% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 19 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 51 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 24 · 🔀 230 · 📦 1 · 📋 220 - 4% open · ⏱️ 19.05.2023):
	...
	```
- [PyPi](https://pypi.org/project/Optimus) (📥 10K / month):
	```
	pip install Optimus
	```
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 110 · 🔀 550 · 📥 130 · 📦 500K · 📋 800 - 3% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 96 · 🔀 210 · 📦 15K · 📋 250 - 15% open · ⏱️ 14.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/voluptuous) (📥 3.8M / month):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 66 · 🔀 230 · 📦 15K · 📋 350 - 3% open · ⏱️ 23.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 6M / month):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 66 · 🔀 200 · 📦 7.8K · 📋 150 - 51% open · ⏱️ 23.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/schema) (📥 9M / month):
	```
	pip install schema
	```
...
- [GitHub](https://github.com/schematics/schematics) (👨‍💻 120 · 🔀 270 · 📦 1.6K · 📋 330 - 27% open · ⏱️ 17.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/schematics) (📥 260K / month):
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 9 · 🔀 23 · 📦 69 · 📋 15 - 26% open · ⏱️ 05.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/valideer) (📥 9.4K / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 210 · 🔀 1.7K · 📥 360 · 📦 340K · 📋 2.4K - 4% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 160 · 🔀 710 · 📥 92 · 📦 95K · 📋 1.9K - 8% open · ⏱️ 16.12.2023):
...
<details><summary><b><a href="https://github.com/has2k1/plotnine">plotnine</a></b> (🥉29 ·  ⭐ 3.7K) - A grammar of graphics for Python based on ggplot2. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 100 · 🔀 200 · 📦 6.5K · 📋 590 - 13% open · ⏱️ 19.12.2023):
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 350 · 📦 4.2K · 📋 1.2K - 23% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 190 · 🔀 600 · 📦 1.4K · 📋 1.4K - 21% open · ⏱️ 19.12.2023):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 65K / month):
	```
	pip install vispy
	```
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 82 · 🔀 500 · 📦 12K · 📋 300 - 4% open · ⏱️ 24.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/tinydb) (📥 510K / month):
	```
	pip install tinydb
	```
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 87 · 📦 1.2K · 📋 160 - 39% open · ⏱️ 21.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 80K / month):
	```
	pip install ZODB
	```
...
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉20 ·  ⭐ 840 · 💤) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 47 · 🔀 200 · 📦 77K · ⏱️ 15.12.2023):
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.4K · 📦 200K · 📋 650 - 2% open · ⏱️ 14.12.2023):
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 58 · 🔀 200 · 📦 1.9K · 📋 310 - 16% open · ⏱️ 15.12.2023):

	```
	git clone https://github.com/mymarilyn/clickhouse-driver
	```
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 1.8M / month):
	```
...
- [GitHub](https://github.com/PyMySQL/mysqlclient) (👨‍💻 84 · 🔀 380 · 📥 5.3K · 📦 150K · 📋 330 - 3% open · ⏱️ 15.12.2023):
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 200 · 🔀 460 · 📦 5.9K · ⏱️ 20.12.2023):

	```
	git clone https://github.com/datastax/python-driver
	```
- [PyPi](https://pypi.org/project/python-driver) (📥 22 / month):
	```
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 21 · 🔀 160 · 📦 820 · 📋 210 - 11% open · ⏱️ 04.12.2023):

	```
	git clone https://github.com/wbolster/happybase
	```
- [PyPi](https://pypi.org/project/happybase) (📥 48K / month):
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 210 · 🔀 1K · ⏱️ 19.12.2023):
...
<details><summary><b><a href="https://github.com/plasticityai/supersqlite">SuperSQLite</a></b> (🥉16 ·  ⭐ 720 · 💀) - A supercharged SQLite library built on top of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/sdispater/pendulum">Pendulum</a></b> (🥇33 ·  ⭐ 5.9K) - Python datetimes made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 96 · 🔀 340 · 📥 430 · 📦 24K · 📋 500 - 36% open · ⏱️ 16.12.2023):
...
- [PyPi](https://pypi.org/project/pendulum) (📥 17M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 890K · ⏱️ 22.09.2023):
	```
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 48 · 🔀 200 · 📋 91 - 18% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/maya) (📥 62K / month):
	```
	pip install maya
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 28 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 470 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 280 · 🔀 890 · 📥 210 · 📦 81K · 📋 880 - 8% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 37 · 🔀 380 · 📥 15K · 📦 3.4K · 📋 330 - 42% open · ⏱️ 16.12.2023):
...
- [GitHub](https://github.com/pallets-eco/flask-debugtoolbar) (👨‍💻 52 · 🔀 140 · 📦 25K · 📋 120 - 28% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 58 · 🔀 140 · 📦 52K · 📋 190 - 32% open · ⏱️ 03.08.2023):
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 97 · 🔀 480 · 📦 6.6K · 📋 240 - 28% open · ⏱️ 08.12.2023):
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥈25 ·  ⭐ 8K · 💤) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 170 · 📦 21 · 📋 120 - 39% open · ⏱️ 04.12.2022):
...
- [PyPi](https://pypi.org/project/icecream) (📥 280K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 29K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 110 · 📦 210 · 📋 110 - 27% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 6.1K / month):
	```
	pip install wdb
	```
...
<details><summary><b><a href="https://github.com/ionelmc/python-manhole">manhole</a></b> (🥉19 ·  ⭐ 360) - Debugging UNIX socket connections and present the stacktraces for all.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 23 · 📦 270 · 📋 22 - 31% open · ⏱️ 18.12.2023):

	```
	git clone https://github.com/ionelmc/python-manhole
	```
- [PyPi](https://pypi.org/project/python-manhole) (📥 11 / month):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 43 · 📦 160 · 📋 96 - 43% open · ⏱️ 26.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-hunter) (📥 33 / month):
	```
...
<details><summary><b><a href="https://github.com/fabianp/memory_profiler">memory_profiler</a></b> (🥉16 ·  ⭐ 86 · 💀) - Monitor Memory usage of Python code. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 960K / month):
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 39 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):

	```
	git clone https://github.com/khamidou/lptrace
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 610 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.5K · 🔀 72K · 📦 330K · 📋 38K - 5% open · ⏱️ 21.12.2023):
...
- [PyPi](https://pypi.org/project/tensorflow) (📥 17M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tensorflow) (📥 4.4M · ⏱️ 17.12.2023):
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.3K · 🔀 19K · 📦 21 · 📋 11K - 1% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 4.5K · 🔀 19K · 📥 30K · 📦 360K · 📋 39K - 31% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 760 · 📥 320 · ⏱️ 22.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 57 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 200 · 🔀 1.3K · 📦 410K · 📋 1.7K - 15% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 81M / month):
	```
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 28M · ⏱️ 17.12.2023):
	```
	conda install -c conda-forge psutil
	```
</details>
<details><summary><b><a href="https://github.com/ansible/ansible">ansible</a></b> (🥈35 ·  ⭐ 60K) - A radically simple IT automation platform. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.8K · 🔀 23K · 📦 31K · 📋 32K - 1% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 16K · 📦 740 · 📋 26K - 9% open · ⏱️ 19.12.2023):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 54K / month):
	```
	pip install salt
	```
...
<details><summary><b><a href="https://github.com/Supervisor/supervisor">supervisor</a></b> (🥈27 ·  ⭐ 8.1K) - Supervisor process control system for UNIX. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 180 · 🔀 1.1K · 📦 10K · 📋 1.1K - 10% open · ⏱️ 18.11.2023):
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 19 · 🔀 1.7K · 📦 21 · 📋 1.7K - 24% open · ⏱️ 23.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/fabric) (📥 4.9M / month):
	```
	pip install fabric
	```
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 140 · 📦 7.3K · 📋 100 - 13% open · ⏱️ 24.10.2022):

	```
	git clone https://github.com/nickstenning/honcho
	```
- [PyPi](https://pypi.org/project/honcho) (📥 190K / month):
	```
	pip install honcho
	```
...
- [GitHub](https://github.com/pyinfra-dev/pyinfra) (👨‍💻 100 · 🔀 320 · 📦 96 · 📋 690 - 21% open · ⏱️ 26.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 34K / month):
	```
	pip install pyinfra
	```
...
- [GitHub](https://github.com/sebastien/cuisine) (👨‍💻 57 · 🔀 160 · 📦 190 · 📋 110 - 24% open · ⏱️ 06.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/cuisine) (📥 910 / month):
	```
	pip install cuisine
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 610 · 🔀 2.3K · 📦 2.3K · 📋 980 - 9% open · ⏱️ 17.12.2023):

	```
	git clone https://github.com/spotify/luigi
	```
- [PyPi](https://pypi.org/project/luigi) (📥 530K / month):
	```
	pip install luigi
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 590 · 🔀 1.6K · 📦 56K · 📋 4.9K - 17% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 6.7M / month):
	```
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 11M · ⏱️ 15.12.2023):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.8K · 📥 160 · 📦 13K · 📋 16K - 18% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 570 · 📦 1.4K · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 85K / month):
	```
	pip install mrjob
	```
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 44 · 🔀 210 · 📦 62 · 📋 330 - 19% open · ⏱️ 18.07.2022):

	```
	git clone https://github.com/Parsely/streamparse
	```
- [PyPi](https://pypi.org/project/streamparse) (📥 7.2K / month):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 460 · 🔀 1.8K · 📥 740K · 📦 52K · 📋 5.1K - 5% open · ⏱️ 20.12.2023):
...
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈28 ·  ⭐ 2.7K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 32 · 🔀 240 · 📦 1.1K · 📋 1.4K - 0% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 47 · 🔀 170 · 📦 2.4K · 📋 350 - 5% open · ⏱️ 19.12.2023):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 170K / month):
	```
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 33K · ⏱️ 19.12.2023):
	```
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 66 · 🔀 1.6K · 📦 460 · ⏱️ 20.12.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 74K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/s3tools/s3cmd) (👨‍💻 220 · 🔀 850 · 📥 3.2M · 📋 880 - 26% open · ⏱️ 19.12.2023):
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.3M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 9.5K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 200 · 📦 45 · 📋 140 - 61% open · ⏱️ 06.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 34K / month):
	```
	pip install s4cmd
	```
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 980 · 📦 220 · 📋 380 - 23% open · ⏱️ 28.02.2021):

	```
	git clone https://github.com/awesto/django-shop
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 31 · 📦 310 · 📋 23 - 30% open · ⏱️ 04.09.2016):
...
- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 12 · 📥 6 · 📦 68 · 📋 6 - 50% open · ⏱️ 22.12.2020):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 260 · 🔀 1.5K · 📥 3.9M · 📦 27K · 📋 17K - 6% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 61K / month):
	```
	pip install spyder
	```
- [Conda](https://anaconda.org/conda-forge/spyder) (📥 1.9M · ⏱️ 19.12.2023):
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 94 · 🔀 250 · 📦 210 · 📋 1.6K - 22% open · ⏱️ 03.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 360 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/DamnWidget/anaconda) (👨‍💻 89 · 🔀 260 · 📋 790 - 22% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/anaconda) (📥 32K / month):
	```
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 57 · 🔀 190 · 📦 500 · 📋 92 - 58% open · ⏱️ 03.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/flanker) (📥 28K / month):
	```
	pip install flanker
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 180 · 📦 210 · 📋 130 - 46% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 9.6K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 360 · 📦 41 · 📋 1.8K - 4% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 67 · 📥 120 · 📦 20 · 📋 90 - 18% open · ⏱️ 02.04.2023):

	```
	git clone https://github.com/moggers87/salmon
	```
- [PyPi](https://pypi.org/project/salmon) (📥 130 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 110 · 🔀 950 · 📦 350K · 📋 1.3K - 1% open · ⏱️ 18.12.2023):
...
- [PyPi](https://pypi.org/project/watchdog) (📥 13M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 2.7M · ⏱️ 22.09.2023):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 61 · 🔀 250 · 📦 51K · 📋 200 - 5% open · ⏱️ 09.10.2023):
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 99 · 🔀 680 · 📦 19K · 📋 300 - 1% open · ⏱️ 21.12.2023):

	```
	git clone https://github.com/dyve/django-bootstrap3
	```
- [PyPi](https://pypi.org/project/django-bootstrap3) (📥 97K / month):
	```
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 86 · 📦 22 · 📋 16 - 75% open · ⏱️ 12.07.2017):
	...
	```
- [PyPi](https://pypi.org/project/django-remote-forms) (📥 52 / month):
	```
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 110 · 🔀 250 · 📥 2.9K · 📦 200K · 📋 280 - 5% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 75 · 🔀 240 · 📦 130K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 33 · 🔀 140 · 📦 9.6K · 📋 78 - 7% open · ⏱️ 17.12.2023):
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 48 · 🔀 100 · 📦 490 · 📋 410 - 13% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 33 · 🔀 110 · 📋 700 - 10% open · ⏱️ 28.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/coconut) (📥 2.3K / month):
	```
	pip install coconut
	```
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 190 · 📦 480 · 📋 50 - 48% open · ⏱️ 13.10.2014):
	...
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 720 / month):
	```
	pip install fn.py
	```
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇33 ·  ⭐ 1.7K) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 160 · 🔀 280 · 📦 24K · 📋 540 - 19% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.8K · 📦 11K · 📋 3.5K - 20% open · ⏱️ 26.11.2023):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 480K / month):
	```
...
<details><summary><b><a href="https://github.com/python-eel/Eel">Eel</a></b> (🥈27 ·  ⭐ 6K · 💤) - A library for making simple Electron-like offline HTML/JS GUI apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 960 · 📥 560 · 📦 850 · 📋 590 - 21% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 4.9K / month):
	```
	pip install Gooey
	```
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 620 · 📦 2.5K · 📋 1.2K - 19% open · ⏱️ 19.12.2023):
...
<details><summary><b><a href="https://github.com/r0x0r/pywebview">pywebview</a></b> (🥉24 ·  ⭐ 4K) - A lightweight cross-platform native wrapper around a webview component. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/r0x0r/pywebview) (🔀 490 · 📦 1.6K · 📋 870 - 2% open · ⏱️ 10.12.2023):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 260 · 🔀 610 · 📥 2.3K · 📦 2 · 📋 790 - 15% open · ⏱️ 21.12.2023):

	```
	git clone https://github.com/pybee/toga
	```
- [PyPi](https://pypi.org/project/toga) (📥 4.2K / month):
	```
	pip install toga
	```
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 740 · 📦 220 · 📋 240 - 17% open · ⏱️ 18.12.2023):

	```
	git clone https://github.com/nucleic/enaml
	```
- [PyPi](https://pypi.org/project/enaml) (📥 3.2K / month):
	```
	pip install enaml
	```
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 130 · 🔀 610 · 📥 12 · 📋 280 - 8% open · ⏱️ 23.11.2023):
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 54 · 🔀 260 · 📋 280 - 10% open · ⏱️ 27.08.2023):
...
<details><summary><b><a href="https://github.com/pallets/markupsafe">MarkupSafe</a></b> (🥇31 ·  ⭐ 570) - Implements a XML/HTML/XHTML Markup safe string for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/pyquery) (📥 2M / month):
	...
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 58K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 750 · 🔀 8.8K · 📥 7.6K · 📦 2.6M · 📋 3.9K - 5% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 210 · 🔀 730 · 📦 140K · 📋 810 - 2% open · ⏱️ 21.12.2023):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 32M / month):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 980K · ⏱️ 20.12.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 340 · 🔀 1K · 📥 27K · 📦 1.6M · 📋 1.2K - 8% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 51 · 🔀 130 · 📥 250 · 📦 1.5K · 📋 160 - 34% open · ⏱️ 06.11.2023):

	```
	git clone https://github.com/twisted/treq
	```
- [PyPi](https://pypi.org/project/treq) (📥 86K / month):
	```
	pip install treq
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 9 · 🔀 130 · 📦 1.3K · 📋 120 - 74% open · ⏱️ 26.06.2023):
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 550 · 📋 100 - 70% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 8.9K / month):
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 460 · 🔀 1.9K · 📦 1.5M · 📋 3K - 2% open · ⏱️ 21.12.2023):

	```
	git clone https://github.com/python-pillow/Pillow
	```
- [PyPi](https://pypi.org/project/Pillow) (📥 75M / month):
	```
	pip install Pillow
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 200 · 📥 35K · 📦 18K · 📋 410 - 5% open · ⏱️ 13.12.2023):
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 280 · 📥 1.1K · 📦 280 · 📋 540 - 25% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/dylanaraps/pywal
	```
- [PyPi](https://pypi.org/project/pywal) (📥 4.8K / month):
	```
	pip install pywal
	```
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 16 · 🔀 48 · 📦 630 · 📋 390 - 40% open · ⏱️ 18.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyvips) (📥 53K / month):
	```
	pip install pyvips
	```
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 100 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 610 · 🔀 5.2K · 📥 71K · 📋 5.1K - 27% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.7K · 🔀 27K · 📦 3 · 📋 66K - 10% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📦 20 · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 540K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 25 · 🔀 150 · 📦 15 · 📋 89 - 26% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 78 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 67 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 640 / month):
	```
	pip install Pyjion
	```
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 60 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 210 / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 58 · 🔀 270 · 📦 2.8K · 📋 380 - 58% open · ⏱️ 14.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 610K / month):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 230 · 📋 780 - 16% open · ⏱️ 11.12.2023):
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 210 · 🔀 1.4K · 📦 4.1K · 📋 4.4K - 13% open · ⏱️ 21.12.2023):
...
- [PyPi](https://pypi.org/project/prefect) (📥 660K / month):
	...
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 570K · ⏱️ 21.12.2023):
	```
...
- [PyPi](https://pypi.org/project/schedule) (📥 1.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 48K · ⏱️ 02.10.2023):
	```
	conda install -c conda-forge schedule
	```
</details>
<details><summary><b><a href="https://github.com/sartography/SpiffWorkflow">Spiff</a></b> (🥈21 ·  ⭐ 1.5K) - A powerful workflow engine implemented in pure Python. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 53 · 🔀 290 · 📦 67 · 📋 130 - 1% open · ⏱️ 11.12.2023):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 7.7K / month):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 52 · 🔀 640 · 📦 71K · 📋 890 - 15% open · ⏱️ 16.12.2023):
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 200 · 🔀 420 · 📥 3.5K · 📋 1.1K - 12% open · ⏱️ 15.12.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 630 · 🔀 8.1K · 📥 7.9K · 📦 75K · 📋 5K - 6% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 8K · 📦 49K · 📋 1.8K - 4% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 840K / month):
	```
	pip install gym
	```
...
- [GitHub](https://github.com/numenta/nupic-legacy) (👨‍💻 120 · 🔀 1.6K · 📥 2 · 📦 21 · 📋 1.8K - 25% open · ⏱️ 31.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 1.1K / month):
	```
	pip install nupic
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 250 · 🔀 2K · 📦 21 · 📋 9.2K - 28% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 810 · 🔀 2.5K · 📋 3.6K - 13% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 34K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 4.2K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/josephreisinger/vowpal_porpoise) (👨‍💻 14 · 🔀 28 · 📋 9 - 66% open · ⏱️ 07.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/vowpal_porpoise) (📥 17 / month):
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 100 · 🔀 580 · 📥 2.7K · 📦 1.9K · 📋 1.4K - 8% open · ⏱️ 07.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/pythonnet) (📥 280K / month):
	```
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 90 · 🔀 760 · 📥 650K · 📦 160K · 📋 1.8K - 26% open · ⏱️ 02.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 5.5M / month):
	```
	pip install pywin32
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 210 · 📦 980K · 📋 110 - 0% open · ⏱️ 06.09.2023):
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 19 · 🔀 170 · 📥 22 · 📦 260K · 📋 47 - 6% open · ⏱️ 01.11.2023):
...
<details><summary><b><a href="https://github.com/mahmoud/boltons">boltons</a></b> (🥉31 ·  ⭐ 6.3K) - A set of pure-Python utilities. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 88 · 🔀 340 · 📥 25 · 📦 5.9K · 📋 160 - 32% open · ⏱️ 02.12.2023):
...
- [PyPi](https://pypi.org/project/boltons) (📥 3.2M / month):
	...
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 3.8M · ⏱️ 21.12.2023):
	```
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 2.1K · 📋 14 - 14% open · ⏱️ 16.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 700K / month):
	```
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 49 · 🔀 6.5K · 📦 26K · 📋 840 - 73% open · ⏱️ 15.02.2020):
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 100 · 📦 1.7K · 📋 200 - 62% open · ⏱️ 25.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/pattern) (📥 490K / month):
	```
	pip install pattern
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 66 · 🔀 840 · 📦 2.3K · 📋 840 - 8% open · ⏱️ 02.12.2023):

	```
	git clone https://github.com/stanfordnlp/stanza
	```
- [PyPi](https://pypi.org/project/stanza) (📥 200K / month):
	```
	pip install stanza
	```
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.3K · 📋 110 - 39% open · ⏱️ 19.01.2020):

	```
	git clone https://github.com/isnowfy/snownlp
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 20K / month):
	```
	pip install snownlp
	```
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 330 · 📦 1.1K · 📋 220 - 69% open · ⏱️ 22.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 59K / month):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 260 · 📦 610 · 📋 69 - 27% open · ⏱️ 04.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 7.8K / month):
	```
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 300 · 📦 9.1K · 📋 72 - 36% open · ⏱️ 15.07.2017):
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 13 · 🔀 13K · 📋 67 - 29% open · ⏱️ 24.08.2023):

	```
	git clone https://github.com/fighting41love/funNLP
	```
- [PyPi](https://pypi.org/project/funNLP) (📥 26 / month):
	```
	pip install funNLP
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 440 · 📋 200 - 15% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 12M / month):
	```
	pip install pox
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 9 · 📦 1.1K · 📋 300 - 5% open · ⏱️ 04.10.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-activity-stream) (📥 53K / month):
	```
...
- [GitHub](https://github.com/tschellenbach/Stream-Framework) (👨‍💻 26 · 🔀 530 · 📋 180 - 35% open · ⏱️ 15.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/Stream-Framework) (📥 990 / month):
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 390 · 🔀 1.1K · 📦 22K · 📋 1.7K - 20% open · ⏱️ 16.12.2023):

	```
	git clone https://github.com/MongoEngine/mongoengine
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 1.4M / month):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 110 · 🔀 420 · 📦 1.6K · 📋 580 - 36% open · ⏱️ 19.12.2023):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 410K · ⏱️ 29.11.2023):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 77 · 🔀 290 · 📦 3.5K · 📋 290 - 10% open · ⏱️ 12.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/dataset) (📥 110K / month):
	```
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 7.7K · ⏱️ 12.07.2023):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 230 · 📥 78 · 📦 3.8K · 📋 620 - 46% open · ⏱️ 25.09.2023):
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 200 · 🔀 520 · 📦 25K · 📋 1K - 14% open · ⏱️ 29.11.2023):
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 510 · 🔀 2K · 📥 15M · 📋 5.4K - 11% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/conda/conda) (🔀 1.4K · 📦 45K · 📋 9.4K - 7% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 98 · 🔀 120 · 📦 250 · 📋 780 - 10% open · ⏱️ 19.12.2023):

	```
	git clone https://github.com/devpi/devpi
	```
- [PyPi](https://pypi.org/project/devpi) (📥 5.5K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 370 · 🔀 850 · 📋 3.1K - 13% open · ⏱️ 19.12.2023):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 120 · 📋 250 - 16% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.8K · 📦 21 · 📋 140 - 31% open · ⏱️ 06.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 2.3K / month):
	```
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉20 ·  ⭐ 9.7K · 💀) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 530 · 📦 6.4K · 📋 450 - 28% open · ⏱️ 25.03.2022):
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 28 · 🔀 140 · 📦 1.5K · 📋 110 - 22% open · ⏱️ 23.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 620 / month):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 97 · 🔀 480 · 📦 14K · 📋 470 - 1% open · ⏱️ 20.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/sh) (📥 5.3M / month):
	```
	pip install sh
	```
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 88 · 🔀 1.1K · 📦 3.4K · 📋 390 - 12% open · ⏱️ 20.08.2023):
	...
	```
- [PyPi](https://pypi.org/project/annoy) (📥 800K / month):
	```
	pip install annoy
	```
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 47 · 🔀 660 · 📦 1.3K · 📋 490 - 27% open · ⏱️ 30.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/lightfm) (📥 680K / month):
	```
	pip install lightfm
	```
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 420 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 850 / month):
	```
...
<details><summary><b><a href="https://github.com/jfkirk/tensorrec">tensorrec</a></b> (🥉18 ·  ⭐ 1.3K · 💀) - A Recommendation Engine Framework in TensorFlow. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 34 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 240 / month):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 79 · 🔀 150 · 📦 71K · 📋 320 - 26% open · ⏱️ 21.12.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 800K / month):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 520 · 🔀 5.4K · 📦 280K · 📋 3.4K - 0% open · ⏱️ 20.12.2023):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 28M / month):
	```
	pip install fastapi
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 900 · 📥 7K · 📦 8.7K · 📋 1K - 15% open · ⏱️ 19.12.2023):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 790K / month):
	```
	pip install falcon
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 340 · 🔀 1.5K · 📦 17K · 📋 1.3K - 5% open · ⏱️ 13.12.2023):
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 210 · 🔀 730 · 📦 1.1K · 📋 970 - 2% open · ⏱️ 10.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/eve) (📥 9.5K / month):
	```
	pip install eve
	```
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 91 · 🔀 410 · 📦 750 · 📋 310 - 7% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/apistar) (📥 7.5K / month):
	```
	pip install apistar
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 120 · 🔀 5.8K · 📦 21 · 📋 340 - 5% open · ⏱️ 19.12.2023):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.3K · 🔀 4K · 📥 530K · 📦 100K · 📋 13K - 33% open · ⏱️ 20.12.2023):
...
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">statsmodels</a></b> (🥈35 ·  ⭐ 9.1K) - Statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 420 · 🔀 2.6K · 📥 30 · 📦 110K · 📋 5.3K - 48% open · ⏱️ 15.12.2023):
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 470 · 🔀 1.8K · 📥 1.9K · 📦 2.5K · 📋 3.2K - 6% open · ⏱️ 21.12.2023):

	```
	git clone https://github.com/pymc-devs/pymc3
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 530K / month):
	```
	pip install pymc3
	```
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 230 · 📦 210 · 📋 120 - 7% open · ⏱️ 01.07.2023):
	...
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 3.9K / month):
	```
...
<details><summary><b><a href="https://github.com/bcbio/bcbio-nextgen">bcbio-nextgen</a></b> (🥉20 ·  ⭐ 960) - Providing best-practice pipelines for fully automated high.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 97 · 🔀 350 · 📋 3K - 4% open · ⏱️ 18.12.2023):

	```
	git clone https://github.com/chapmanb/bcbio-nextgen
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 120 / month):
	```
...
- [GitHub](https://github.com/obspy/obspy) (🔀 520 · 📥 7K · 📋 1.7K - 10% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 9.4K · 📋 1.2K - 36% open · ⏱️ 19.12.2023):
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 71 · 🔀 310 · 📦 3.2K · 📋 150 - 15% open · ⏱️ 19.12.2023):
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 780 · 📥 200 · 📦 9.8K · 📋 1.3K - 10% open · ⏱️ 01.12.2023):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 210 · 🔀 600 · 📦 110K · 📋 1.2K - 12% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 50 · 📦 1.2K · 📋 84 - 8% open · ⏱️ 03.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 650K / month):
	```
	pip install pysimdjson
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 81K · ⏱️ 16.06.2023):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 600 · 📥 9.4K · 📋 2.5K - 11% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 550 · 📦 90K · 📋 250 - 10% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 210 · 🔀 1.2K · 📦 62K · 📋 960 - 8% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 16 · 🔀 900 · 📦 22K · 📋 1.1K - 43% open · ⏱️ 04.11.2023):
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 64 · 🔀 470 · 📥 19K · 📦 30K · 📋 1.8K - 17% open · ⏱️ 12.12.2023):
...
- [PyPi](https://pypi.org/project/xlwings) (📥 140K / month):
	...
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 700K · ⏱️ 13.12.2023):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 170 · 🔀 820 · 📥 18 · 📦 330K · 📋 850 - 3% open · ⏱️ 05.12.2023):
...
- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 370 · 📦 150 · 📋 490 - 17% open · ⏱️ 12.11.2021):

	```
	git clone https://github.com/unoconv/unoconv
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 8.5K / month):
	```
	pip install unoconv
	```
...
<details><summary><b><a href="https://github.com/elapouya/python-docx-template">docxtpl</a></b> (🥉19 ·  ⭐ 1.8K · 💤) - Editing a docx document by jinja2 template. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 57 · 📦 10 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 37 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 450 · 🔀 1.8K · 📥 970 · 📦 7.5K · 📋 1.6K - 2% open · ⏱️ 29.11.2023):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.3K · 📦 54K · 📋 1.9K - 5% open · ⏱️ 17.12.2023):
...
- [GitHub](https://github.com/sunainapai/makesite) (👨‍💻 8 · 🔀 280 · 📋 15 - 40% open · ⏱️ 12.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/makesite) (📥 87 / month):
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 150 · 🔀 570 · 📋 430 - 20% open · ⏱️ 26.10.2023):
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 300 · 🔀 1.4K · 📦 15K · 📋 1.1K - 14% open · ⏱️ 19.12.2023):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 1.6M / month):
	```
	pip install rq
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 360 · 📦 1.3K · ⏱️ 28.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/huey) (📥 96K / month):
	```
	pip install huey
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 98 · 🔀 270 · 📥 40 · 📦 1K · 📋 350 - 12% open · ⏱️ 17.12.2023):
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 40 · 🔀 120 · 📦 31 · 📋 170 - 30% open · ⏱️ 13.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrq) (📥 54 / month):
	```
	pip install mrq
	```
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 55K · 📦 21 · 📋 990 - 5% open · ⏱️ 06.09.2023):
	...
	```
- [PyPi](https://pypi.org/project/jinja) (📥 5.8K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 190 · 🔀 2.2K · 📥 550 · 📦 9.5K · 📋 4.3K - 5% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 320 · 📥 190 · 📦 33K · 📋 290 - 1% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 52 · 🔀 1.1K · 📦 30K · 📋 670 - 65% open · ⏱️ 07.06.2023):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 720K / month):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 320 · 🔀 560 · 📦 24K · 📋 1.5K - 2% open · ⏱️ 16.12.2023):
...
- [PyPi](https://pypi.org/project/hypothesis) (📥 5.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 8.3M · ⏱️ 16.12.2023):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 140 · 🔀 340 · 📦 8.2K · 📋 370 - 22% open · ⏱️ 18.12.2023):
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 490 · 📦 6.6K · 📋 520 - 9% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 310 · 🔀 2.7K · 📦 3 · 📋 1.5K - 0% open · ⏱️ 19.12.2023):
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 60 · 🔀 140 · 📦 270 · 📋 780 - 11% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 250 · 📥 5 · 📋 300 - 36% open · ⏱️ 19.12.2023):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 8.2M / month):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 130 · 🔀 360 · 📋 560 - 29% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · 📦 390 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 87K / month):
	```
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 120 · 📦 25 · 📋 22 - 31% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/fake2db) (📥 600 / month):
	```
	pip install fake2db
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 24 · 🔀 40 · 📦 90 · 📋 70 - 2% open · ⏱️ 26.11.2023):
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 43 · 🔀 91 · 📋 85 - 42% open · ⏱️ 23.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/mixer) (📥 93K / month):
	```
	pip install mixer
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 39 · 🔀 74 · 📋 180 - 4% open · ⏱️ 05.12.2023):

	```
	git clone https://github.com/CleanCut/green
	```
- [PyPi](https://pypi.org/project/green) (📥 19K / month):
	```
	pip install green
	```
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 62 · 🔀 260 · 📥 8.9K · 📦 900K · 📋 320 - 10% open · ⏱️ 20.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyparsing) (📥 99M / month):
	```
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📦 22K · 📋 190 - 44% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 5.6M / month):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 14 · 🔀 240 · 📥 970 · 📦 5.4K · ⏱️ 28.09.2023):
...
<details><summary><b><a href="https://github.com/pwaller/pyfiglet">pyfiglet</a></b> (🥈27 ·  ⭐ 1.3K) - An implementation of figlet written in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 30 · 🔀 110 · 📦 33K · 📋 61 - 3% open · ⏱️ 26.10.2023):
...
- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 36 · 🔀 440 · 📋 190 - 4% open · ⏱️ 19.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/ply) (📥 32M / month):
	```
	pip install ply
	```
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 47 · 📦 2.2K · 📋 18 - 55% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 170K / month):
	```
...
<details><summary><b><a href="https://github.com/derek73/python-nameparser">python-nameparser</a></b> (🥉20 ·  ⭐ 620) - Parsing human names into their individual components. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 30 · 🔀 390 · 📋 170 - 4% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 150 · 🔀 1.7K · 📦 390K · 📋 3.1K - 5% open · ⏱️ 21.12.2023):
...
- [PyPi](https://pypi.org/project/boto3) (📥 840M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 18M · ⏱️ 20.12.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 170 · 🔀 890 · 📥 2K · 📦 28K · 📋 870 - 5% open · ⏱️ 16.12.2023):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 7.8M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 930 · 📦 4.8K · 📋 240 - 8% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/facebook-sdk) (📥 200K / month):
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 63 · 📦 11K · ⏱️ 06.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 110K / month):
	```
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 15 · 🔀 140 · 📋 120 - 26% open · ⏱️ 01.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 2.1M / month):
	```
	pip install furl
	```
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥇25 ·  ⭐ 3.1K) - Most Powerful multi-threaded Video Processing framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 8 - 62% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 35K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 180 · 🔀 350 · 📦 2.4K · 📋 440 - 26% open · ⏱️ 21.12.2023):
...
- [GitHub](https://github.com/miracle2k/flask-assets) (👨‍💻 42 · 🔀 90 · 📦 7.4K · 📋 100 - 21% open · ⏱️ 15.12.2023):
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 220 · 🔀 550 · 📋 650 - 17% open · ⏱️ 13.12.2023):
...
- [PyPi](https://pypi.org/project/django-compressor) (📥 420K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-compressor) (📥 430 · ⏱️ 27.09.2023):
	```
...
- [GitHub](https://github.com/codelucas/newspaper) (👨‍💻 100 · 🔀 2K · 📦 21 · 📋 670 - 60% open · ⏱️ 02.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/newspaper) (📥 8.9K / month):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 30 · 🔀 510 · 📦 2.4K · 📋 120 - 13% open · ⏱️ 10.11.2023):
	...
	```
- [PyPi](https://pypi.org/project/sumy) (📥 49K / month):
	```
	pip install sumy
	```
...
- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 40 · 🔀 530 · 📋 230 - 44% open · ⏱️ 10.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/textract) (📥 160K / month):
	```
...
- [GitHub](https://github.com/elliotgao2/toapi) (👨‍💻 12 · 🔀 230 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 72 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 55 · 🔀 370 · 📥 43 · 📋 170 - 16% open · ⏱️ 20.12.2023):
...
- [GitHub](https://github.com/python-websockets/websockets) (👨‍💻 70 · 🔀 490 · 📦 150K · 📋 1.1K - 2% open · ⏱️ 16.12.2023):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 260 · 🔀 770 · 📦 21 · 📋 1.2K - 6% open · ⏱️ 12.12.2023):
	...
	```
- [PyPi](https://pypi.org/project/channels) (📥 750K / month):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 490 · 🔀 1.7K · 📥 700 · 📦 1.2M · 📋 1.1K - 0% open · ⏱️ 11.11.2023):
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 51 · 🔀 160 · 📦 170K · 📋 230 - 8% open · ⏱️ 09.09.2023):

	```
	git clone https://github.com/Pylons/waitress
	```
- [PyPi](https://pypi.org/project/waitress) (📥 4.5M / month):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 700 · 📋 160 - 16% open · ⏱️ 11.09.2022):

	```
	git clone https://github.com/jonashaag/bjoern
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 29K / month):
	```
	pip install bjoern
	```
