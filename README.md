...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 330 · 🔀 1.3K · 📦 13K · 📋 1.3K - 26% open · ⏱️ 12.11.2021):
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 180 · 🔀 840 · 📦 7K · 📋 790 - 7% open · ⏱️ 19.10.2021):

	```
	git clone https://github.com/mher/flower
	```
- [PyPi](https://pypi.org/project/flower) (📥 860K / month):
	```
	pip install flower
	```
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 18 · 🔀 740 · 📦 21 · 📋 1.1K - 0% open · ⏱️ 06.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 2.5K / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 760 · 📋 560 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 470 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 820 · 🔀 32K · 📋 870 - 3% open · ⏱️ 17.11.2021):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 40M · ⏱️ 26.10.2021):
	```
...
- [PyPi](https://pypi.org/project/transitions):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 100K · ⏱️ 04.10.2021):
	```
...
- [PyPi](https://pypi.org/project/algorithms) (📥 1.7K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 410 · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 100 · 🔀 450 · 📋 84 - 21% open · ⏱️ 24.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-ds) (📥 25 / month):
	```
...
- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 120 · 🔀 5.8K · 📋 74 - 16% open · ⏱️ 07.07.2021):
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇33 ·  ⭐ 4.6K) - A lightning-fast ASGI server implementation, using uvloop and httptools. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 110 · 🔀 350 · 📦 42K · 📋 530 - 12% open · ⏱️ 14.11.2021):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 4.5M / month):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 670K · ⏱️ 03.11.2021):
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 57 · 🔀 190 · 📦 12K · 📋 270 - 14% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/daphne) (📥 390K / month):
	```
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 67K · ⏱️ 07.04.2021):
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 42 · 🔀 420 · 📥 350 · 📦 29K · 📋 270 - 17% open · ⏱️ 10.08.2021):
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 250 · 📦 2.3K · 📋 650 - 39% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 3.2M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 630K · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 470 · 🔀 1.6K · 📥 6.9K · 📦 230 · 📋 2.4K - 18% open · ⏱️ 17.11.2021):
...
<details><summary><b><a href="https://github.com/quodlibet/mutagen">mutagen</a></b> (🥇27 ·  ⭐ 890) - A Python module to handle audio metadata. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 35 · 🔀 120 · 📥 48K · 📦 5.7K · 📋 460 - 18% open · ⏱️ 31.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 780K / month):
	```
	pip install mutagen
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 90 · 🔀 760 · 📦 9.5K · 📋 440 - 43% open · ⏱️ 08.06.2021):
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 20 · 🔀 88 · 📦 6.6K · 📋 71 - 38% open · ⏱️ 20.10.2020):

	```
	git clone https://github.com/beetbox/audioread
	```
- [PyPi](https://pypi.org/project/audioread) (📥 470K / month):
	```
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 22 · 🔀 44 · 📥 2.1K · 📦 1.5K · 📋 170 - 24% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 49K / month):
	```
	pip install eyeD3
	```
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 25 · 🔀 1K · 📦 240 · 📋 270 - 58% open · ⏱️ 12.11.2021):
...
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥉23 ·  ⭐ 790) - Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 19 · 📦 1.2K · 📋 91 - 12% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 92 · 🔀 760 · 📋 920 - 3% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 20 · 🔀 82 · 📦 430 · 📋 82 - 17% open · ⏱️ 28.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 10K / month):
	```
	pip install tinytag
	```
...
- [GitHub](https://github.com/Parisson/TimeSide) (👨‍💻 19 · 🔀 53 · 📦 14 · 📋 200 - 26% open · ⏱️ 20.04.2021):

	```
	git clone https://github.com/Parisson/TimeSide
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 210 / month):
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉15 ·  ⭐ 510) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/pennersr/django-allauth">django-allauth</a></b> (🥇34 ·  ⭐ 6.8K) - Authentication app for Django that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 560 · 🔀 2.4K · 📦 77K · 📋 1.8K - 18% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/pennersr/django-allauth
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 480K / month):
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 180 · 🔀 420 · 📦 190K · 📋 340 - 22% open · ⏱️ 14.11.2021):
...
- [PyPi](https://pypi.org/project/oauthlib):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 3.7M · ⏱️ 01.06.2021):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 100 · 🔀 510 · 📦 160K · 📋 330 - 20% open · ⏱️ 16.11.2021):
...
- [PyPi](https://pypi.org/project/pyjwt):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 4.8M · ⏱️ 16.10.2021):
	```
...
- [GitHub](https://github.com/omab/python-social-auth) (👨‍💻 280 · 🔀 1.1K · 📦 5.1K · 📋 660 - 2% open · ⏱️ 04.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/python-social-auth) (📥 44K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 190 · 🔀 600 · 📋 650 - 19% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/mpdavis/python-jose) (🔀 180 · 📦 9.8K · 📋 120 - 38% open · ⏱️ 12.10.2021):
...
<details><summary><b><a href="https://github.com/lepture/authlib">authlib</a></b> (🥉21 ·  ⭐ 2.8K · 📉) - JavaScript Object Signing and Encryption draft implementation. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/lepture/authlib) (👨‍💻 69 · 🔀 280 · 📋 280 - 8% open · ⏱️ 16.11.2021):
...
- [PyPi](https://pypi.org/project/authlib):
	...
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 67K · ⏱️ 18.10.2021):
	```
...
- [PyPi](https://pypi.org/project/pybuilder):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 8K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 55 · 🔀 580 · 📋 3.6K - 4% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 110 · 🔀 270 · 📦 300K · 📋 500 - 19% open · ⏱️ 17.11.2021):
...
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥈23 ·  ⭐ 940) - Efficient, Pythonic bidirectional map data structures and related.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/jab/bidict) (👨‍💻 11 · 🔀 44 · 📦 5K · 📋 46 - 4% open · ⏱️ 08.11.2021):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 120 · 🔀 310 · 📥 2.9K · 📋 3.2K - 18% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 640 / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 170 / month):
	```
	pip install quokka
	```
...
🔗&nbsp;<b><a href="https://github.com/typeddjango/awesome-python-typing">awesome-python-typing</a></b> ( ⭐ 900)  - Collection of awesome Python types, stubs, plugins, and tools to..

🔗&nbsp;<b><a href="http://mypy-lang.org/">mypy</a></b>  - Check variable types during compile time.

<details><summary><b><a href="https://github.com/psf/black">black</a></b> (🥇31 ·  ⭐ 24K) - The uncompromising Python code formatter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/psf/black) (👨‍💻 280 · 🔀 1.5K · 📥 18K · 📦 95K · 📋 1.7K - 19% open · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/black):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 2.5M · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 420 · 📦 200K · 📋 1K - 3% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 800 · 📋 980 - 7% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 130K / month):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 800 · 📦 26K · 📋 720 - 46% open · ⏱️ 08.11.2021):
...
- [PyPi](https://pypi.org/project/yapf) (📥 1.7M / month):
	...
	pip install yapf
	```
- [Conda](https://anaconda.org/conda-forge/yapf) (📥 890K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 29 · 🔀 90 · 📦 1.3K · 📋 150 - 9% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 180K / month):
	```
	pip install vulture
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 140 · 📋 280 - 17% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 160 · 📋 140 - 22% open · ⏱️ 15.09.2021):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 37K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 70 · 🔀 210 · 📋 450 - 20% open · ⏱️ 17.11.2021):
...
- [PyPi](https://pypi.org/project/pytype):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 63K · ⏱️ 13.10.2020):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1K · 🔀 1.1K · 📋 1.5K - 11% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 66 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 3K / month):
	```
...
<details><summary><b><a href="https://github.com/facebook/pyre-check">pyre-check</a></b> (🥉17 ·  ⭐ 5.7K) - Performant type checking. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 350 · 📋 270 - 24% open · ⏱️ 18.11.2021):
...
<details><summary><b><a href="https://github.com/willmcgugan/rich">rich</a></b> (🥇33 ·  ⭐ 31K) - Python library for rich text and beautiful formatting in the terminal. Also.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 130 · 🔀 970 · 📦 8.5K · 📋 580 - 2% open · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/rich) (📥 2.6M / month):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 480K · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1K · 📥 8K · 📦 220K · 📋 800 - 32% open · ⏱️ 20.09.2021):
...
- [PyPi](https://pypi.org/project/tqdm):
	...
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 8.7M · ⏱️ 20.09.2021):
	```
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 37 · 🔀 210 · 📦 550 · 📋 260 - 7% open · ⏱️ 26.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 8.5K / month):
	```
	pip install asciimatics
	```
- [Conda](https://anaconda.org/conda-forge/asciimatics) (📥 80K · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.2K · 📦 9.7K · 📋 240 - 40% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/rsalmei/alive-progress) (🔀 110 · 📦 480 · 📋 86 - 23% open · ⏱️ 06.11.2021):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 130 · 📋 28 - 60% open · ⏱️ 31.03.2021):
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 140 · 🔀 3.2K · 📦 9.5K · 📋 710 - 16% open · ⏱️ 05.11.2021):
...
- [PyPi](https://pypi.org/project/httpie) (📥 190K / month):
	...
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 68K · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 180 · 🔀 2.9K · 📦 310 · 📋 610 - 30% open · ⏱️ 05.09.2021):
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 160 · 🔀 440 · 📦 350 · 📋 610 - 20% open · ⏱️ 30.09.2021):
...
- [PyPi](https://pypi.org/project/cookiecutter):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 220K · ⏱️ 17.05.2021):
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 95 · 🔀 600 · 📦 210 · 📋 560 - 27% open · ⏱️ 09.05.2021):
...
- [PyPi](https://pypi.org/project/mycli) (📥 25K / month):
	...
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 21K · ⏱️ 11.11.2021):
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥉21 ·  ⭐ 440) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 22 · 🔀 40 · 📦 26 · 📋 220 - 13% open · ⏱️ 15.11.2021):
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 23 · 🔀 71 · 📥 6.6K · 📋 190 - 30% open · ⏱️ 17.08.2021):

	```
	git clone https://github.com/laixintao/iredis
	```
- [PyPi](https://pypi.org/project/iredis) (📥 900 / month):
	```
	pip install iredis
	```
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 260 · 📦 35 · 📋 91 - 31% open · ⏱️ 12.11.2021):
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 150 · 📥 520 · 📦 13 · 📋 69 - 82% open · ⏱️ 19.09.2018):

	```
	git clone https://github.com/cloudnativelabs/kube-shell
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 520 / month):
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 20 · 🔀 50 · 📦 120 · 📋 70 - 31% open · ⏱️ 11.09.2021):
...
<details><summary><b><a href="https://github.com/sloria/doitlive">doitlive</a></b> (🥉14 ·  ⭐ 3.1K) - A tool for live presentations in the terminal. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 16 · 🔀 90 · 📦 15 · 📋 47 - 27% open · ⏱️ 24.05.2021):
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 90 · 🔀 1.6K · 📥 770K · 📦 660 · 📋 440 - 27% open · ⏱️ 15.10.2021):
...
- [PyPi](https://pypi.org/project/tesserocr):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tesserocr) (📥 61K · ⏱️ 13.01.2021):
	```
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 38 · 🔀 550 · 📋 280 - 3% open · ⏱️ 03.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 1M / month):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉21 ·  ⭐ 5.3K) - Open Source Differentiable Computer Vision Library for PyTorch. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 510 · 📥 150 · 📦 770 · 📋 480 - 20% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 18 · 🔀 81 · 📦 200 · 📋 72 - 43% open · ⏱️ 07.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/scoop) (📥 2.7K / month):
	```
	pip install scoop
	```
...
- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 27 · 🔀 140 · 📥 3 · 📦 51K · 📋 70 - 7% open · ⏱️ 30.09.2021):
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 22 · 🔀 63 · 📦 16K · 📋 140 - 48% open · ⏱️ 14.10.2020):
...
- [PyPi](https://pypi.org/project/configobj):
	...
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 320K · ⏱️ 29.07.2018):
	```
	conda install -c conda-forge configobj
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉20 ·  ⭐ 5.1K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 81 · 🔀 370 · 📦 3 · 📋 920 - 9% open · ⏱️ 17.11.2021):
...
- [PyPi](https://pypi.org/project/hydra):
	...
	pip install hydra
	```
- [Conda](https://anaconda.org/conda-forge/hydra) (📥 8.7K · ⏱️ 18.01.2021):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 62 · 🔀 180 · 📋 260 - 16% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/awslabs/aws-data-wrangler) (👨‍💻 84 · 🔀 370 · 📥 100K · 📋 530 - 6% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 220 · 📦 6 · 📋 180 - 36% open · ⏱️ 02.12.2016):

	```
	git clone https://github.com/mining/mining
	```
- [PyPi](https://pypi.org/project/mining) (📥 56 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 23 · 🔀 200 · 📋 220 - 14% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/Julian/jsonschema) (👨‍💻 94 · 🔀 470 · 📦 180K · 📋 620 - 9% open · ⏱️ 15.11.2021):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 35M / month):
	```
	pip install jsonschema
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 8.5M · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 62 · 🔀 210 · 📦 10K · 📋 320 - 10% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 2.4M / month):
	```
	pip install cerberus
	```
- [Conda](https://anaconda.org/conda-forge/cerberus) (📥 170K · ⏱️ 02.12.2019):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 87 · 🔀 190 · 📦 4K · 📋 230 - 16% open · ⏱️ 20.09.2021):
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 170 · 📦 3.3K · 📋 130 - 49% open · ⏱️ 20.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/schema) (📥 1.3M / month):
	```
	pip install schema
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 7 · 🔀 18 · 📦 48 · 📋 14 - 21% open · ⏱️ 07.03.2018):

	```
	git clone https://github.com/podio/valideer
	```
- [PyPi](https://pypi.org/project/valideer) (📥 81K / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 160 · 🔀 1.5K · 📥 210 · 📦 130K · 📋 1.9K - 4% open · ⏱️ 31.10.2021):

	```
	git clone https://github.com/mwaskom/seaborn
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 11M / month):
	```
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 3.1M · ⏱️ 16.08.2021):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 580 · 🔀 3.7K · 📦 41K · 📋 6.8K - 10% open · ⏱️ 17.11.2021):
...
- [PyPi](https://pypi.org/project/bokeh):
	...
	pip install bokeh
	```
- [Conda](https://anaconda.org/conda-forge/bokeh) (📥 6M · ⏱️ 12.11.2021):
	```
	conda install -c conda-forge bokeh
	```
</details>
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈30 ·  ⭐ 7.1K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 130 · 🔀 590 · 📦 18K · 📋 1.6K - 13% open · ⏱️ 12.11.2021):
...
- [PyPi](https://pypi.org/project/bqplot) (📥 66K / month):
	...
	pip install bqplot
	```
- [Conda](https://anaconda.org/conda-forge/bqplot) (📥 900K · ⏱️ 01.10.2021):
	```
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 86 · 🔀 150 · 📦 2.6K · 📋 450 - 16% open · ⏱️ 16.11.2021):
...
<details><summary><b><a href="https://github.com/SciTools/cartopy">Cartopy</a></b> (🥉27 ·  ⭐ 960) - A cartographic python library with matplotlib support. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 100 · 🔀 300 · 📦 2K · 📋 990 - 25% open · ⏱️ 14.11.2021):
...
- [PyPi](https://pypi.org/project/cartopy):
	...
	pip install cartopy
	```
- [Conda](https://anaconda.org/conda-forge/cartopy) (📥 1.8M · ⏱️ 14.11.2021):
	```
...
- [PyPi](https://pypi.org/project/diagrams) (📥 55K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/diagrams) (📥 98K · ⏱️ 05.11.2021):
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 160 · 🔀 570 · 📦 630 · 📋 1.3K - 22% open · ⏱️ 10.11.2021):
...
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥉20 ·  ⭐ 500) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 69 · 📦 780 · 📋 140 - 37% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/ZODB):
	```
	pip install ZODB
	```
...
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉17 ·  ⭐ 620 · 💀) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 110 · 📦 760 · 📋 54 - 27% open · ⏱️ 15.11.2019):
...
<details><summary><b><a href="https://github.com/redis/redis-py">redis-py</a></b> (🥇34 ·  ⭐ 9.8K · 📈) - The Python client for Redis. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/redis/redis-py) (👨‍💻 270 · 🔀 2K · 📦 130K · 📋 950 - 5% open · ⏱️ 17.11.2021):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 460K · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 35 · 🔀 160 · 📦 14K · ⏱️ 09.11.2021):

	```
	git clone https://github.com/mongodb/motor
	```
- [PyPi](https://pypi.org/project/motor) (📥 1.8M / month):
	```
	pip install motor
	```
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.2K · 📥 1.7K · 📦 8.4K · 📋 1.4K - 14% open · ⏱️ 03.08.2021):
...
<details><summary><b><a href="https://github.com/PyMySQL/PyMySQL">PyMySQL</a></b> (🥈28 ·  ⭐ 6.7K) - A pure Python MySQL driver compatible to mysql-python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 110 · 🔀 1.3K · 📦 99K · 📋 580 - 3% open · ⏱️ 02.10.2021):
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 180 · 🔀 430 · 📦 3.3K · ⏱️ 17.09.2021):
...
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥈23 ·  ⭐ 720) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 34 · 🔀 130 · 📦 410 · 📋 210 - 13% open · ⏱️ 29.10.2021):

	```
	git clone https://github.com/mymarilyn/clickhouse-driver
	```
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 460K / month):
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 190 · 🔀 900 · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/happybase):
	...
	```
- [Conda](https://anaconda.org/conda-forge/happybase) (📥 69K · ⏱️ 01.07.2019):
	```
...
<details><summary><b><a href="https://github.com/gmr/queries">queries</a></b> (🥉17 ·  ⭐ 240) - A wrapper of the psycopg2 library for interacting with PostgreSQL. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 380 · 📥 35K · 📦 600K · 📋 590 - 37% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 68 · 🔀 250 · 📋 400 - 43% open · ⏱️ 19.10.2021):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 38 · 📦 600 · 📋 34 - 8% open · ⏱️ 27.11.2020):

	```
	git clone https://github.com/zachwill/moment
	```
- [PyPi](https://pypi.org/project/moment) (📥 76K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 13 · 📦 19 · 📋 9 - 44% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 330 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/dirn/When.py) (👨‍💻 5 · 🔀 17 · 📦 21 · ⏱️ 14.10.2017):
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 250 · 🔀 820 · 📥 170 · 📦 44K · 📋 770 - 10% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 80 · 🔀 400 · 📦 2.7K · 📋 170 - 31% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 800K / month):
	```
	pip install pyelftools
	```
- [Conda](https://anaconda.org/conda-forge/pyelftools) (📥 78K · ⏱️ 27.10.2020):
	```
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥈22 ·  ⭐ 7.6K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 260 · 📥 7K · 📋 230 - 27% open · ⏱️ 13.11.2021):
...
- [PyPi](https://pypi.org/project/py-spy):
	...
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 130K · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 100 · 📦 100 · 📋 110 - 26% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 6.5K / month):
	```
	pip install wdb
	```
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 16 · 🔀 110 · 📋 79 - 29% open · ⏱️ 31.08.2021):
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 35 · 📦 70 · 📋 85 - 41% open · ⏱️ 13.10.2021):
...
<details><summary><b><a href="https://github.com/ionelmc/python-manhole">manhole</a></b> (🥉17 ·  ⭐ 320) - Debugging UNIX socket connections and present the stacktraces for all.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 61 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 420K / month):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 71 · 📦 2 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 80 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 3.9K · 🔀 69K · 📦 170K · 📋 33K - 7% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1K · 🔀 18K · 📋 11K - 1% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/keras-team/keras
	```
- [PyPi](https://pypi.org/project/keras) (📥 7.2M / month):
	```
	pip install keras
	```
- [Conda](https://anaconda.org/conda-forge/keras) (📥 1.9M · ⏱️ 17.11.2021):
	```
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 970 · 🔀 6.5K · 📥 24K · 📋 9.4K - 18% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/dmlc/mxnet
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 680K / month):
	```
	pip install mxnet
	```
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3K · 🔀 14K · 📥 310 · 📋 23K - 30% open · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/pytorch):
	...
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 290K · ⏱️ 26.10.2021):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇33 ·  ⭐ 7.9K) - A cross-platform process and system utilities module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.1K · 📦 120K · 📋 1.5K - 11% open · ⏱️ 14.11.2021):
...
- [PyPi](https://pypi.org/project/psutil):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 9M · ⏱️ 02.11.2021):
	```
	conda install -c conda-forge psutil
	```
</details>
<details><summary><b><a href="https://github.com/ansible/ansible">ansible</a></b> (🥈30 ·  ⭐ 51K) - A radically simple IT automation platform. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.5K · 🔀 20K · 📦 19K · 📋 30K - 3% open · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/ansible):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 440K · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.7K · 🔀 5K · 📥 16K · 📋 24K - 9% open · ⏱️ 17.11.2021):
...
<details><summary><b><a href="https://github.com/fabric/fabric">fabric</a></b> (🥉21 ·  ⭐ 13K) - A simple, Pythonic tool for remote execution and deployment. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 59 · 🔀 250 · 📦 34 · 📋 500 - 16% open · ⏱️ 14.11.2021):
...
<details><summary><b><a href="https://github.com/dask/dask">dask</a></b> (🥇32 ·  ⭐ 9.1K) - A flexible parallel computing library for analytic computing. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/dask/dask) (👨‍💻 480 · 🔀 1.4K · 📦 32K · 📋 4K - 16% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 9.1M / month):
	```
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 4.6M · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 93 · 🔀 480 · 📦 880 · 📋 460 - 48% open · ⏱️ 09.10.2020):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 570 · 📦 880 · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
...
- [GitHub](https://github.com/ray-project/ray) (🔀 3K · 📋 8.4K - 21% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.6K · 📥 720K · 📋 4.3K - 7% open · ⏱️ 17.11.2021):
...
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥇26 ·  ⭐ 1.2K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 17 · 🔀 150 · 📥 18 · 📦 310 · 📋 600 - 1% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 71 · 📥 150 · 📋 89 - 29% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.5K · 📦 170K · 📋 5.7K - 14% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 31 · 🔀 110 · 📦 440 · 📋 190 - 3% open · ⏱️ 29.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 94K / month):
	```
	pip install pdoc
	```
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 18 · 🔀 880 · 📦 120 · ⏱️ 18.11.2021):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 58K / month):
	```
	pip install akshare
	```
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.7M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 5.4K · ⏱️ 22.12.2018):
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 34 · 🔀 190 · 📦 25 · 📋 130 - 59% open · ⏱️ 09.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 13K / month):
	```
	pip install s4cmd
	```
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 21 · 🔀 140 · 📦 1K · 📋 57 - 24% open · ⏱️ 02.09.2021):
...
<details><summary><b><a href="https://github.com/awesto/django-shop">django-shop</a></b> (🥈21 ·  ⭐ 2.7K · 💤) - A Django based shop system. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 900 · 📦 190 · 📋 370 - 21% open · ⏱️ 28.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-shop):
	```
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 74 · 🔀 280 · 📦 180 · 📋 150 - 15% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 430 / month):
	```
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 93 · 📦 97 · 📋 14 - 14% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 710 / month):
	```
	pip install alipay
	```
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 230 · 🔀 1.3K · 📥 1M · 📦 21K · 📋 14K - 8% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 80 · 🔀 230 · 📦 200 · 📋 1.5K - 22% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 910 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/DamnWidget/anaconda) (👨‍💻 89 · 🔀 240 · 📋 770 - 21% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 170 · 🔀 2.6K · 📋 3.1K - 1% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 72 · 🔀 640 · 📥 32K · 📋 4.1K - 1% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/python-mode/python-mode) (👨‍💻 130 · 🔀 760 · 📋 880 - 2% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 54 · 🔀 170 · 📦 200 · 📋 88 - 59% open · ⏱️ 29.03.2021):
...
- [PyPi](https://pypi.org/project/yagmail):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 8.6K · ⏱️ 30.08.2021):
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 48 · 🔀 150 · 📦 110 · 📋 110 - 42% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 21K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 50 · 📥 49 · 📦 14 · 📋 89 - 17% open · ⏱️ 05.10.2021):
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 350 · 🔀 2.2K · 📋 1.4K - 2% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 62 · 🔀 850 · 📋 1.2K - 5% open · ⏱️ 01.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 24M / month):
	```
...
- [PyPi](https://pypi.org/project/watchdog):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 860K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 37 · 📦 6.2K · 📋 17 - 41% open · ⏱️ 14.02.2015):
	...
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 79K / month):
	```
	pip install Unipath
	```
...
- [GitHub](https://github.com/PyFilesystem/pyfilesystem2) (👨‍💻 42 · 🔀 150 · 📋 310 - 17% open · ⏱️ 16.11.2021):
...
- [PyPi](https://pypi.org/project/wtforms) (📥 2M / month):
	...
	pip install wtforms
	```
- [Conda](https://anaconda.org/conda-forge/wtforms) (📥 83K · ⏱️ 07.11.2021):
	```
	conda install -c conda-forge wtforms
	```
</details>
<details><summary><b><a href="https://github.com/django-crispy-forms/django-crispy-forms">django-crispy-forms</a></b> (🥈28 ·  ⭐ 4.3K) - A Django app which lets you create beautiful forms in a.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 97 · 🔀 680 · 📦 16K · 📋 290 - 1% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 53K · 📋 150 - 11% open · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/more-itertools):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 8.1M · ⏱️ 10.11.2021):
	```
	conda install -c conda-forge more-itertools
	```
</details>
<details><summary><b><a href="https://github.com/pytoolz/toolz">Toolz</a></b> (🥈30 ·  ⭐ 3.7K) - A collection of functional utilities for iterators, functions, and.. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/toolz):
	...
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 5.5M · ⏱️ 06.11.2021):
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 36 · 🔀 83 · 📦 110 · 📋 360 - 13% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 19K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 490 · ⏱️ 05.10.2021):
	```
	conda install -c conda-forge returns
	```
</details>
<details><summary><b><a href="https://github.com/Suor/funcy">funcy</a></b> (🥉25 ·  ⭐ 2.7K) - A fancy and practical functional tools. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 61 · 📦 33K · 📋 61 - 34% open · ⏱️ 06.11.2021):
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 120 · 🔀 190 · 📦 14K · 📋 290 - 19% open · ⏱️ 12.11.2021):
...
<details><summary><b><a href="https://github.com/PySimpleGUI/PySimpleGUI">PySimpleGUI</a></b> (🥈27 ·  ⭐ 8.8K) - Wrapper for tkinter, Qt, WxPython and Remi. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.3K · 📦 3.8K · 📋 2.5K - 26% open · ⏱️ 16.11.2021):
...
- [PyPi](https://pypi.org/project/PySimpleGUI):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 43K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 99 · 🔀 760 · 📥 150 · 📦 460 · 📋 500 - 17% open · ⏱️ 12.06.2021):
...
- [GitHub](https://github.com/ChrisKnott/Eel) (👨‍💻 38 · 🔀 470 · 📦 2.8K · 📋 420 - 28% open · ⏱️ 19.10.2021):
...
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉22 ·  ⭐ 6.4K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 300 · 📦 210 · 📋 800 - 12% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 340 · 📦 540 · 📋 570 - 5% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 34 · 🔀 110 · 📥 46 · 📦 190 · 📋 210 - 19% open · ⏱️ 11.11.2021):
...
- [PyPi](https://pypi.org/project/enaml):
	...
	pip install enaml
	```
- [Conda](https://anaconda.org/conda-forge/enaml) (📥 94K · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 200 · 🔀 500 · 📋 500 - 24% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/graphql-python/graphene) (🔀 720 · 📦 11K · 📋 920 - 11% open · ⏱️ 13.11.2021):
...
<details><summary><b><a href="https://github.com/tartiflette/tartiflette-aiohttp">tartiflette-aiohttp</a></b> (🥉16 ·  ⭐ 53) - An `aiohttp`-based wrapper for Tartiflette to expose.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tartiflette/tartiflette-aiohttp) (🔀 9 · 📦 33 · 📋 17 - 17% open · ⏱️ 15.11.2021):
...
<details><summary><b><a href="https://github.com/geopy/geopy">geopy</a></b> (🥇32 ·  ⭐ 3.5K) - Python Geocoding Toolbox. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 120 · 🔀 540 · 📦 29K · 📋 250 - 8% open · ⏱️ 26.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/geopy) (📥 2.9M / month):
	```
	pip install geopy
	```
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 45 · 🔀 220 · 📋 230 - 4% open · ⏱️ 11.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 400K / month):
	```
...
<details><summary><b><a href="https://github.com/jazzband/geojson">geojson</a></b> (🥈20 ·  ⭐ 670) - Python bindings and utilities for GeoJSON. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/maxmind/geoip-api-python) (👨‍💻 13 · 🔀 53 · 📦 910 · ⏱️ 11.02.2021):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 37 · 🔀 100 · 📦 710K · ⏱️ 05.11.2021):

	```
	git clone https://github.com/pallets/markupsafe
	```
- [PyPi](https://pypi.org/project/markupsafe) (📥 90M / month):
	```
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 41 · 🔀 420 · 📦 33K · 📋 200 - 32% open · ⏱️ 26.04.2020):
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 72 · 🔀 200 · 📦 150K · 📋 330 - 13% open · ⏱️ 05.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/bleach) (📥 20M / month):
	```
	pip install bleach
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 50 · 🔀 170 · 📦 13K · 📋 170 - 24% open · ⏱️ 04.10.2021):

	```
	git clone https://github.com/gawel/pyquery
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 970K / month):
	```
	pip install pyquery
	```
...
- [GitHub](https://github.com/stchris/untangle) (👨‍💻 13 · 🔀 78 · 📥 520 · 📦 730 · 📋 44 - 40% open · ⏱️ 07.08.2020):
...
<details><summary><b><a href="https://github.com/html5lib/html5lib-python">html5lib</a></b> (🥉16 ·  ⭐ 940) - A standards-compliant library for parsing and serializing HTML documents.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 290 · 🔀 840 · 📥 950 · 📦 700K · 📋 970 - 12% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 140 · 🔀 500 · 📦 13K · 📋 630 - 7% open · ⏱️ 16.11.2021):
...
- [PyPi](https://pypi.org/project/httpx):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 88K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 300 · 📦 2.7K · 📋 100 - 8% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/grequests) (📥 440K / month):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 68 · 🔀 150 · 📦 90K · 📋 100 - 37% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 360 · 🔀 1.5K · 📦 6.5K · 📋 1.3K - 2% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 34 · 🔀 310 · 📦 4.9K · 📋 450 - 62% open · ⏱️ 09.11.2021):
...
- [PyPi](https://pypi.org/project/keyboard):
	...
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 2.1K · ⏱️ 08.11.2021):
	```
	conda install -c conda-forge keyboard
	```
</details>
<details><summary><b><a href="https://github.com/SavinaRoja/PyUserInput">PyUserInput</a></b> (🥉18 ·  ⭐ 990 · 💤) - A module for cross-platform control of the mouse and.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 390 · 📋 96 - 68% open · ⏱️ 19.04.2021):
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 80 · 📦 440 · 📋 86 - 70% open · ⏱️ 05.04.2021):
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 96 · 🔀 190 · 📥 5.3K · 📦 7.4K · 📋 360 - 3% open · ⏱️ 05.10.2021):
...
- [PyPi](https://pypi.org/project/wand) (📥 410K / month):
	...
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 7.4K · ⏱️ 30.11.2020):
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 370 · 🔀 1.6K · 📋 2.3K - 6% open · ⏱️ 16.11.2021):
...
<details><summary><b><a href="https://github.com/WhyNotHugo/python-barcode">python-barcode</a></b> (🥈22 ·  ⭐ 290) - Create barcodes in Python with no extra dependencies. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 39 · 🔀 85 · 📥 180 · 📦 9.4K · 📋 79 - 36% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 230 · 📥 610 · 📦 150 · 📋 470 - 21% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 12 · 🔀 31 · 📦 240 · 📋 250 - 35% open · ⏱️ 16.11.2021):
...
- [PyPi](https://pypi.org/project/pyvips):
	...
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 13K · ⏱️ 10.09.2021):
	```
...
- [GitHub](https://github.com/hhatto/nude.py) (👨‍💻 12 · 🔀 130 · 📦 1.2K · 📋 10 - 70% open · ⏱️ 23.11.2020):
...
- [GitHub](https://github.com/ajknzhol/pygram) (🔀 12 · ⏱️ 22.02.2014):
	...
	```
- [PyPi](https://pypi.org/project/pygram) (📥 120 / month):
	```
	pip install pygram
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 450 · 🔀 3.6K · 📥 27K · 📋 3.9K - 27% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 1.9K · 🔀 20K · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 29 · 🔀 190 · 📥 13K · 📋 420 - 45% open · ⏱️ 10.11.2021):
...
- [GitHub](https://github.com/google/grumpy) (👨‍💻 30 · 🔀 630 · 📋 140 - 43% open · ⏱️ 22.11.2017):
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 17 · 🔀 66 · 📋 110 - 33% open · ⏱️ 16.11.2020):
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉12 ·  ⭐ 770) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/prompt-toolkit/ptpython">ptpython</a></b> (🥇24 ·  ⭐ 4.4K) - Advanced Python REPL built on top of the [python-prompt-.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/ptpython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 6.5K · ⏱️ 14.11.2021):
	```
...
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥇31 ·  ⭐ 7.8K) - A modern workflow orchestration framework that makes it easy to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 270 · 🔀 720 · 📦 500 · 📋 1.9K - 19% open · ⏱️ 17.11.2021):
...
<details><summary><b><a href="https://github.com/sartography/SpiffWorkflow">Spiff</a></b> (🥈19 ·  ⭐ 1.1K) - A powerful workflow engine implemented in pure Python. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 42 · 🔀 230 · 📦 27 · 📋 71 - 2% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 30 · 🔀 460 · 📦 12K · 📋 480 - 16% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 110 · 🔀 240 · 📥 4.5K · 📦 16K · 📋 570 - 30% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 540 · 🔀 7.7K · 📥 3.4K · 📦 24K · 📋 4.2K - 5% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 330 · 🔀 6.9K · 📦 24K · 📋 1.4K - 6% open · ⏱️ 17.11.2021):
...
- [PyPi](https://pypi.org/project/gym):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 79K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 220 · 🔀 1.8K · ⏱️ 17.11.2021):
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉16 ·  ⭐ 4.1K) - MindsDB is an open source AI layer for existing databases that.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 86 · 🔀 540 · 📋 770 - 10% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 70 · 🔀 630 · 📥 500K · 📦 60K · 📋 1.6K - 27% open · ⏱️ 10.11.2021):

	```
	git clone https://github.com/mhammond/pywin32
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 2.9M / month):
	```
	pip install pywin32
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 95 · 🔀 460 · 📦 50 · 📋 1K - 16% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 38 · 🔀 180 · 📦 520K · ⏱️ 05.11.2021):
...
- [GitHub](https://github.com/jek/blinker) (👨‍💻 11 · 🔀 160 · 📦 86K · 📋 34 - 52% open · ⏱️ 29.01.2021):

	```
	git clone https://github.com/jek/blinker
	```
- [PyPi](https://pypi.org/project/blinker) (📥 9.6M / month):
	```
	pip install blinker
	```
...
- [PyPi](https://pypi.org/project/boltons) (📥 1.2M / month):
	...
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 520K · ⏱️ 27.05.2021):
	```
...
- [PyPi](https://pypi.org/project/gensim):
	...
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 750K · ⏱️ 09.11.2021):
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 41 · 🔀 730 · 📦 740 · 📋 600 - 10% open · ⏱️ 05.10.2021):

	```
	git clone https://github.com/stanfordnlp/stanza
	```
- [PyPi](https://pypi.org/project/stanza) (📥 74K / month):
	```
	pip install stanza
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 240 · 📦 300 · 📋 66 - 25% open · ⏱️ 10.07.2021):
...
<details><summary><b><a href="https://github.com/isnowfy/snownlp">snownlp</a></b> (🥉20 ·  ⭐ 5.6K · 💀) - A library for processing Chinese text. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/snownlp):
	...
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 220 · ⏱️ 07.09.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 220 · 🔀 790 · 📥 280 · 📦 100 · 📋 130 - 44% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 10 · 🔀 9.6K · 📋 42 - 33% open · ⏱️ 20.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/funNLP) (📥 6 / month):
	```
	pip install funNLP
	```
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 170 · 🔀 460 · 📦 720 · 📋 520 - 22% open · ⏱️ 15.11.2021):
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 440 · 📦 730 · 📋 290 - 18% open · ⏱️ 31.05.2021):
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 140 · 🔀 1.3K · 📦 14K · 📋 2.1K - 0% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 370 · 🔀 1.1K · 📦 15K · 📋 1.6K - 21% open · ⏱️ 12.11.2021):
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 92 · 🔀 370 · 📦 840 · 📋 460 - 39% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/pynamodb/PynamoDB
	```
- [PyPi](https://pypi.org/project/PynamoDB) (📥 910K / month):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 270 · 📦 2.2K · 📋 260 - 4% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/web2py/pydal) (🔀 120 · 📦 200 · 📋 300 - 47% open · ⏱️ 15.10.2021):
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 15 · 🔀 81 · 📋 67 - 17% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 84 · 📋 51 - 70% open · ⏱️ 06.06.2016):
	...
	```
- [PyPi](https://pypi.org/project/redisco) (📥 340 / month):
	```
	pip install redisco
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.4K · 📥 9.3M · 📋 3.3K - 33% open · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/poetry) (📥 4.2M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 320K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 410 · 📋 770 - 14% open · ⏱️ 12.11.2021):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 3.6M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 20K · ⏱️ 12.10.2021):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1K · 📋 8.1K - 23% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 81 · 🔀 91 · 📦 160 · 📋 660 - 14% open · ⏱️ 15.11.2021):

	```
	git clone https://github.com/devpi/devpi
	```
- [PyPi](https://pypi.org/project/devpi) (📥 2.8K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypa/warehouse) (👨‍💻 310 · 🔀 720 · 📋 2.4K - 13% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 88 · 📋 180 - 14% open · ⏱️ 15.11.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.4K · 📋 4.5K - 1% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 6K / month):
	```
	pip install sqlmap
	```
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉19 ·  ⭐ 7.2K · 💀) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 21 · 🔀 1.5K · 📋 110 - 14% open · ⏱️ 16.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 720 / month):
	```
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉17 ·  ⭐ 7K) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 23 · 🔀 110 · 📦 700 · 📋 99 - 19% open · ⏱️ 13.11.2021):
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 82 · 🔀 430 · 📦 8K · 📋 400 - 2% open · ⏱️ 12.11.2021):
...
<details><summary><b><a href="https://github.com/spotify/annoy">annoy</a></b> (🥇30 ·  ⭐ 9.2K) - Approximate Nearest Neighbors in C++/Python optimized for memory usage. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 74 · 🔀 950 · 📦 1.8K · 📋 340 - 10% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/annoy) (📥 750K / month):
	```
	pip install annoy
	```
...
<details><summary><b><a href="https://github.com/ibayer/fastFM">fastFM</a></b> (🥉20 ·  ⭐ 950 · 💤) - A library for Factorization Machines. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 190 · 📥 400 · 📦 89 · 📋 110 - 43% open · ⏱️ 24.03.2021):
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 26 · 📋 120 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 520 / month):
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 67 · 🔀 130 · 📦 33K · 📋 230 - 30% open · ⏱️ 14.11.2021):
...
- [PyPi](https://pypi.org/project/rope):
	...
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 600K · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 300 · 🔀 1.4K · 📦 6.1K · 📋 1.1K - 4% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 4.6M / month):
	```
	pip install sanic
	```
...
<details><summary><b><a href="https://github.com/falconry/falcon">falcon</a></b> (🥇33 ·  ⭐ 8.6K) - A high-performance framework for building cloud APIs and web app.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/falconry/falcon) (👨‍💻 180 · 🔀 840 · 📥 1.5K · 📦 6K · 📋 930 - 19% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 270 · 🔀 2.8K · 📋 2.5K - 32% open · ⏱️ 26.10.2021):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 4.1M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 460K · ⏱️ 07.10.2021):
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 930 · 📦 67K · 📋 530 - 15% open · ⏱️ 07.07.2021):
...
- [GitHub](https://github.com/Cornices/cornice) (👨‍💻 120 · 🔀 140 · 📦 670 · 📋 230 - 18% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/Cornices/cornice
	```
- [PyPi](https://pypi.org/project/cornice) (📥 41K / month):
	```
	pip install cornice
	```
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 180 · 📦 16 · 📋 79 - 34% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 380 / month):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 93 · 🔀 4.2K · 📋 250 - 3% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/0rpc/zerorpc-python) (👨‍💻 36 · 🔀 350 · 📋 160 - 30% open · ⏱️ 27.05.2020):
...
<details><summary><b><a href="https://github.com/sympy/sympy">SymPy</a></b> (🥇33 ·  ⭐ 8.6K) - A Python library for symbolic mathematics. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.4K · 📥 440K · 📦 37K · 📋 11K - 32% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 340 · 🔀 2.2K · 📥 26 · 📦 53K · 📋 4.5K - 46% open · ⏱️ 15.11.2021):
...
- [PyPi](https://pypi.org/project/statsmodels):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 5.3M · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 350 · 🔀 1.4K · 📥 890 · 📦 560 · 📋 2.4K - 8% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 13 · 🔀 170 · 📦 61 · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 93 · 🔀 330 · 📋 2.9K - 2% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 120 · 🔀 690 · 📥 100 · 📦 5.3K · 📋 1.2K - 7% open · ⏱️ 12.08.2021):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 560 · 📦 36K · 📋 1.1K - 9% open · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/marshmallow):
	...
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 880K · ⏱️ 15.11.2021):
	```
	conda install -c conda-forge marshmallow
	```
</details>
<details><summary><b><a href="https://github.com/python-rapidjson/python-rapidjson">python-rapidjson</a></b> (🥈21 ·  ⭐ 440) - A Python wrapper around.. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/python-rapidjson):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 740K · ⏱️ 12.11.2021):
	```
	conda install -c conda-forge python-rapidjson
	```
</details>
<details><summary><b><a href="https://github.com/TkTech/pysimdjson">pysimdjson</a></b> (🥉19 ·  ⭐ 500) - A Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 12 · 🔀 38 · 📦 150 · 📋 69 - 15% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 500 · 📥 5.6K · 📦 270 · 📋 2.2K - 13% open · ⏱️ 17.11.2021):
...
<details><summary><b><a href="https://github.com/jmcnamara/XlsxWriter">XlsxWriter</a></b> (🥇32 ·  ⭐ 2.7K · 📈) - A Python module for creating Excel .xlsx files. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 45 · 🔀 540 · 📦 41K · 📋 740 - 1% open · ⏱️ 13.11.2021):

	```
	git clone https://github.com/jmcnamara/XlsxWriter
	```
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 7.9M / month):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 56 · 🔀 380 · 📥 27K · 📦 19K · 📋 1.4K - 22% open · ⏱️ 29.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 640K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 380K · ⏱️ 14.11.2021):
	```
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 540 · 📦 960 · 📋 840 - 7% open · ⏱️ 08.10.2021):
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 31 · 🔀 190 · 📋 210 - 8% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/mistune) (📥 16M / month):
	```
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 5.4M · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 150 · 🔀 670 · 📦 160K · 📋 730 - 3% open · ⏱️ 17.11.2021):
...
- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 360 · 📦 83 · 📋 460 - 14% open · ⏱️ 12.11.2021):
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 43 · 🔀 280 · 📦 920 · 📋 320 - 22% open · ⏱️ 06.10.2021):
...
<details><summary><b><a href="https://github.com/python-openxml/python-docx">python-docx</a></b> (🥉19 ·  ⭐ 2.9K) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/python-docx):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-docx) (📥 93K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 420 · 🔀 1.7K · 📥 440 · 📦 5.4K · 📋 1.5K - 2% open · ⏱️ 15.11.2021):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 1.8K · 📦 16K · 📋 1.6K - 6% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 89 · 🔀 270 · 📥 6.9K · 📋 550 - 38% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/lektor) (📥 2.5K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 140 · 🔀 540 · 📋 370 - 18% open · ⏱️ 16.11.2021):
...
- [PyPi](https://pypi.org/project/django-taggit):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-taggit) (📥 87K · ⏱️ 16.11.2021):
	```
...
- [PyPi](https://pypi.org/project/rq):
	...
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 64K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 66 · 🔀 320 · 📦 820 · ⏱️ 12.11.2021):
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 72 · 🔀 200 · 📥 32 · 📦 340 · 📋 270 - 8% open · ⏱️ 09.11.2021):
...
<details><summary><b><a href="https://github.com/pricingassistant/mrq">mrq</a></b> (🥉17 ·  ⭐ 860 · 💤) - A distributed worker task queue in Python using Redis & gevent. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 220 · 🔀 2.2K · 📦 2K · 📋 1.2K - 1% open · ⏱️ 15.11.2021):

	```
	git clone https://github.com/locustio/locust
	```
- [PyPi](https://pypi.org/project/locust) (📥 510K / month):
	```
	pip install locust
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 430 · 🔀 1.5K · 📦 43K · 📋 520 - 23% open · ⏱️ 15.11.2021):
...
- [PyPi](https://pypi.org/project/faker):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 520K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 100 · 🔀 270 · 📥 21 · 📦 11K · 📋 190 - 19% open · ⏱️ 11.11.2021):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 5.3M / month):
	```
	pip install responses
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 890K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.5K · 📋 3.6K - 4% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 450 · 📦 10K · 📋 1.2K - 5% open · ⏱️ 18.11.2021):
...
- [PyPi](https://pypi.org/project/hypothesis):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 5M · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 760 · 📦 11K · 📋 520 - 61% open · ⏱️ 14.09.2021):
...
<details><summary><b><a href="https://github.com/lk-geimfari/mimesis">mimesis</a></b> (🥉22 ·  ⭐ 3.4K) - is a Python library that help you generate fake data. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 100 · 🔀 270 · 📥 180 · 📋 300 - 0% open · ⏱️ 17.11.2021):
...
- [PyPi](https://pypi.org/project/mimesis):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 3.8K · ⏱️ 15.07.2020):
	```
	conda install -c conda-forge mimesis
	```
</details>
<details><summary><b><a href="https://github.com/CleanCut/green">green</a></b> (🥉21 ·  ⭐ 720) - A clean, colorful test runner. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/spulec/freezegun">freezegun</a></b> (🥉20 ·  ⭐ 3.1K) - Travel through time by mocking the datetime module. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 19 · 🔀 36 · 📦 58 · 📋 53 - 3% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 110 · 📦 16 · 📋 22 - 31% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/fake2db) (📥 340 / month):
	```
	pip install fake2db
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 33 · 🔀 72 · 📋 590 - 16% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/klen/mixer) (👨‍💻 41 · 🔀 87 · 📋 77 - 38% open · ⏱️ 13.10.2021):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 37 · 🔀 190 · 📥 6.1K · 📦 400K · 📋 200 - 7% open · ⏱️ 13.11.2021):
...
- [PyPi](https://pypi.org/project/pyparsing):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 16M · ⏱️ 12.11.2021):
	```
...
- [PyPi](https://pypi.org/project/python-slugify):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 600K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 44 · 🔀 220 · 📋 120 - 48% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/chardet) (📥 64M / month):
	```
	pip install chardet
	```
...
<details><summary><b><a href="https://github.com/life4/textdistance">textdistance</a></b> (🥈24 ·  ⭐ 2.6K) - Compute distance between sequences with 30+ algorithms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/life4/textdistance) (👨‍💻 11 · 🔀 200 · 📥 330 · 📦 1.3K · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/textdistance):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 63K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 100 · 📦 4.3K · 📋 120 - 8% open · ⏱️ 17.05.2021):
...
- [PyPi](https://pypi.org/project/sqlparse):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 510K · ⏱️ 10.09.2021):
	```
...
- [PyPi](https://pypi.org/project/pyfiglet):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyfiglet) (📥 76K · ⏱️ 18.05.2019):
	```
...
<details><summary><b><a href="https://github.com/dabeaz/ply">ply</a></b> (🥉19 ·  ⭐ 2K · 💀) - Implementation of lex and yacc parsing tools for Python. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/ply):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 870K · ⏱️ 07.07.2018):
	```
...
- [PyPi](https://pypi.org/project/shortuuid):
	...
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 120K · ⏱️ 11.11.2021):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 20 · 🔀 510 · 📋 210 - 13% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/ztane/python-Levenshtein) (🔀 140 · 📦 9.8K · 📋 55 - 74% open · ⏱️ 01.02.2021):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 25 · 🔀 340 · 📋 130 - 2% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 120 · 🔀 1.4K · 📦 140K · 📋 2.5K - 10% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 240M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 7.5M · ⏱️ 18.11.2021):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 170 · 🔀 2K · 📥 93 · 📦 80K · 📋 850 - 4% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 28M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 960K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 140 · 🔀 820 · 📥 36 · 📦 13K · 📋 660 - 11% open · ⏱️ 14.11.2021):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 4.7M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 910 · 📦 3.3K · 📋 230 - 8% open · ⏱️ 27.12.2020):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 58 · 🔀 140 · 📦 3.3K · 📋 260 - 1% open · ⏱️ 17.11.2021):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 440K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 54 · 📦 2.8K · 📋 73 - 2% open · ⏱️ 29.07.2020):
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 14 · 🔀 120 · 📋 99 - 20% open · ⏱️ 27.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 480K / month):
	```
	pip install furl
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 7 · 🔀 150 · 📥 490 · 📦 140 · 📋 190 - 1% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/abhiTronix/vidgear
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 3.1K / month):
	```
	pip install vidgear
	```
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 23 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 56K / month):
	```
...
- [GitHub](https://github.com/miracle2k/flask-assets) (👨‍💻 38 · 🔀 82 · 📦 5.9K · 📋 94 - 21% open · ⏱️ 29.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/flask-assets) (📥 93K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 820 · 📦 6.2K · 📋 340 - 42% open · ⏱️ 10.05.2020):
...
- [PyPi](https://pypi.org/project/requests-html) (📥 580K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 460 · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 21 · 🔀 460 · 📦 980 · 📋 93 - 16% open · ⏱️ 21.10.2021):
...
- [PyPi](https://pypi.org/project/sumy):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 490 · ⏱️ 22.10.2021):
	```
...
- [PyPi](https://pypi.org/project/html2text) (📥 1.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 7.4K · ⏱️ 09.02.2020):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 82 · 📦 630 · ⏱️ 12.07.2021):
...
- [PyPi](https://pypi.org/project/micawber):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 1.5K · ⏱️ 14.07.2021):
	```
	conda install -c conda-forge micawber
	```
</details>
<details><summary><b><a href="https://github.com/codelucas/newspaper">newspaper</a></b> (🥉18 ·  ⭐ 11K · 💀) - News extraction, article extraction and content curation.. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/MechanicalSoup/MechanicalSoup">MechanicalSoup</a></b> (🥈21 ·  ⭐ 3.8K) - A Python library for automating interaction with websites. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 3 · 🔀 530 · 📦 3 · 📋 65 - 20% open · ⏱️ 01.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/cola) (📥 91 / month):
	```
	pip install cola
	```
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 52 · 🔀 390 · 📦 43K · 📋 800 - 1% open · ⏱️ 14.11.2021):

	```
	git clone https://github.com/aaugustin/websockets
	```
- [PyPi](https://pypi.org/project/websockets) (📥 9.7M / month):
	```
...
- [GitHub](https://github.com/django/channels) (👨‍💻 230 · 🔀 680 · 📦 15K · 📋 1.1K - 8% open · ⏱️ 12.11.2021):
...
- [PyPi](https://pypi.org/project/channels) (📥 400K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 66K · ⏱️ 11.07.2021):
	```
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 120 · 🔀 720 · 📦 16K · 📋 830 - 21% open · ⏱️ 15.11.2021):
...
<details><summary><b><a href="https://github.com/benoitc/gunicorn">gunicorn</a></b> (🥇36 ·  ⭐ 8K) - Pre-forked, ported from Ruby's Unicorn project. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 360 · 🔀 1.5K · 📥 98 · 📦 550K · 📋 1.7K - 17% open · ⏱️ 06.09.2021):
...
- [PyPi](https://pypi.org/project/gunicorn) (📥 26M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gunicorn) (📥 790K · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 440 · 🔀 1.6K · 📥 250 · 📦 620K · 📋 910 - 2% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 59M / month):
	```
...
- [PyPi](https://pypi.org/project/bjoern) (📥 16K / month):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 56K · ⏱️ 15.11.2021):
	```
...
- [PyPi](https://pypi.org/project/waitress):
	...
	```
- [Conda](https://anaconda.org/conda-forge/waitress) (📥 43K · ⏱️ 08.03.2021):
	```
