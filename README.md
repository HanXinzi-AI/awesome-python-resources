...
<details><summary><b><a href="https://github.com/flask-admin/flask-admin">flask-admin</a></b> (🥇30 ·  ⭐ 4.9K) - Simple and extensible administrative interface framework for Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 180 · 🔀 830 · 📦 6.9K · 📋 790 - 7% open · ⏱️ 19.10.2021):

	```
	git clone https://github.com/mher/flower
	```
- [PyPi](https://pypi.org/project/flower) (📥 830K / month):
	```
	pip install flower
	```
...
- [GitHub](https://github.com/geex-arts/django-jet) (👨‍💻 29 · 🔀 640 · 📦 2.5K · 📋 330 - 63% open · ⏱️ 21.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/django-jet) (📥 34K / month):
	```
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 18 · 🔀 740 · 📦 21 · 📋 1.1K - 0% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 3.1K / month):
	```
	pip install ajenti
	```
...
<details><summary><b><a href="https://github.com/sshwsfc/xadmin">django-xadmin</a></b> (🥉19 ·  ⭐ 4.6K · 💀) - Drop-in replacement of Django admin comes with lots.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 94 · 📋 11 - 63% open · ⏱️ 29.10.2021):
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 810 · 🔀 32K · 📋 850 - 3% open · ⏱️ 04.11.2021):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 39M · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 69 · 🔀 460 · 📦 1.8K · 📋 390 - 2% open · ⏱️ 04.10.2021):
...
- [PyPi](https://pypi.org/project/transitions):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 75K · ⏱️ 04.10.2021):
	```
	conda install -c conda-forge transitions
	```
</details>
<details><summary><b><a href="https://github.com/keon/algorithms">algorithms</a></b> (🥈23 ·  ⭐ 20K) - Minimal examples of data structures and algorithms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 170 · 🔀 3.8K · 📦 53 · 📋 140 - 34% open · ⏱️ 03.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/algorithms):
	```
	pip install algorithms
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 390 · ⏱️ 23.04.2021):
	```
...
<details><summary><b><a href="https://github.com/faif/python-patterns">python-patterns</a></b> (🥉15 ·  ⭐ 30K) - A collection of design patterns in Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 110 · 🔀 350 · 📦 41K · 📋 520 - 11% open · ⏱️ 15.10.2021):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 4.4M / month):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 630K · ⏱️ 03.11.2021):
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 57 · 🔀 190 · 📦 12K · 📋 270 - 14% open · ⏱️ 16.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/daphne) (📥 380K / month):
	```
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 65K · ⏱️ 07.04.2021):
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 42 · 🔀 410 · 📥 350 · 📦 29K · 📋 270 - 18% open · ⏱️ 10.08.2021):

	```
	git clone https://github.com/MagicStack/uvloop
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 9.8M / month):
	```
	pip install uvloop
	```
- [Conda](https://anaconda.org/conda-forge/uvloop) (📥 400K · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 250 · 📦 1.8K · 📋 650 - 39% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 2.2M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 600K · ⏱️ 05.07.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 470 · 🔀 1.6K · 📥 6.9K · 📦 220 · 📋 2.4K - 18% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 90 · 🔀 750 · 📦 9.3K · 📋 440 - 42% open · ⏱️ 08.06.2021):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 1M / month):
	```
	pip install pydub
	```
...
<details><summary><b><a href="https://github.com/quodlibet/mutagen">mutagen</a></b> (🥈27 ·  ⭐ 880) - A Python module to handle audio metadata. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 35 · 🔀 120 · 📥 48K · 📦 5.6K · 📋 460 - 18% open · ⏱️ 31.10.2021):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 770K / month):
	```
	pip install mutagen
	```
...
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥈25 ·  ⭐ 380 · 💀) - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 20 · 🔀 87 · 📦 6.5K · 📋 71 - 38% open · ⏱️ 20.10.2020):

	```
	git clone https://github.com/beetbox/audioread
	```
- [PyPi](https://pypi.org/project/audioread) (📥 440K / month):
	```
	pip install audioread
	```
- [Conda](https://anaconda.org/conda-forge/audioread) (📥 360K · ⏱️ 16.03.2021):
	```
	conda install -c conda-forge audioread
	```
</details>
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥈25 ·  ⭐ 330) - A tool for working with audio files, specifically MP3 files containing.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 22 · 🔀 44 · 📥 2.1K · 📦 1.5K · 📋 170 - 24% open · ⏱️ 14.09.2021):

	```
	git clone https://github.com/nicfit/eyeD3
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 36K / month):
	```
	pip install eyeD3
	```
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉22 ·  ⭐ 4.8K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 91 · 🔀 750 · 📋 910 - 3% open · ⏱️ 28.10.2021):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 450K / month):
	```
	pip install librosa
	```
- [Conda](https://anaconda.org/conda-forge/librosa) (📥 410K · ⏱️ 26.05.2021):
	```
	conda install -c conda-forge librosa
	```
</details>
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥉22 ·  ⭐ 780 · 💤) - Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 20 · 🔀 82 · 📦 420 · 📋 82 - 17% open · ⏱️ 28.08.2021):

	```
	git clone https://github.com/devsnd/tinytag
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 9K / month):
	```
	pip install tinytag
	```
...
- [GitHub](https://github.com/Parisson/TimeSide) (👨‍💻 19 · 🔀 52 · 📦 14 · 📋 200 - 26% open · ⏱️ 20.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 220 / month):
	```
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 63 · 📦 4 · 📋 30 - 30% open · ⏱️ 23.09.2021):
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 180 · 🔀 420 · 📦 180K · 📋 340 - 21% open · ⏱️ 22.10.2021):
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 100 · 🔀 510 · 📦 160K · 📋 330 - 23% open · ⏱️ 22.10.2021):

	```
	git clone https://github.com/jpadilla/pyjwt
	```
- [PyPi](https://pypi.org/project/pyjwt) (📥 59M / month):
	```
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 4.6M · ⏱️ 16.10.2021):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 540 · 🔀 2.4K · 📦 76K · 📋 1.8K - 18% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 490K / month):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 68 · 🔀 270 · 📋 280 - 8% open · ⏱️ 29.10.2021):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 3.6M / month):
	```
	pip install authlib
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 190 · 🔀 600 · 📋 640 - 18% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/mpdavis/python-jose) (🔀 180 · 📦 9.5K · 📋 120 - 38% open · ⏱️ 12.10.2021):
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 53 · 🔀 580 · 📋 3.6K - 4% open · ⏱️ 02.11.2021):
...
<details><summary><b><a href="https://github.com/python-attrs/attrs">attrs</a></b> (🥇29 ·  ⭐ 3.7K) - Replacement for `__init__`, `__eq__`, `__repr__`, etc. boilerplate in class.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 110 · 🔀 270 · 📦 300K · 📋 500 - 19% open · ⏱️ 04.11.2021):
...
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥈23 ·  ⭐ 930) - Efficient, Pythonic bidirectional map data structures and related.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/jab/bidict) (👨‍💻 12 · 🔀 43 · 📦 4.8K · 📋 46 - 6% open · ⏱️ 01.11.2021):
...
<details><summary><b><a href="https://github.com/cdgriffith/Box">Box</a></b> (🥉15 ·  ⭐ 1.8K) - Python dictionaries with advanced dot notation access. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/cdgriffith/Box) (🔀 71 · 📥 30 · 📋 130 - 17% open · ⏱️ 22.08.2021):
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 3 · 🔀 13 · 📥 60 · 📦 48 · 📋 9 - 77% open · ⏱️ 30.10.2015):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 110 · 🔀 310 · 📥 2.9K · 📋 3.2K - 18% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 720 / month):
	```
	pip install indico
	```
...
<details><summary><b><a href="https://github.com/Kotti/Kotti">Kotti</a></b> (🥉19 ·  ⭐ 370) - A high-level, Pythonic web application framework built on Pyramid. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 64 · 🔀 110 · 📦 220 · 📋 210 - 19% open · ⏱️ 02.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 840 / month):
	```
	pip install Kotti
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 220 · 📋 440 - 8% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 5.1K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 59 · 🔀 170 · 📦 600 · 📋 290 - 6% open · ⏱️ 19.10.2021):
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 26 · 🔀 150 · 📦 220 · 📋 71 - 21% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 8.5K / month):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 280 · 🔀 1.4K · 📥 18K · 📦 92K · 📋 1.7K - 19% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 9.1M / month):
	```
	pip install black
	```
...
<details><summary><b><a href="https://github.com/PyCQA/isort">isort</a></b> (🥇33 ·  ⭐ 4.3K) - A Python utility / library to sort imports. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 420 · 📦 200K · 📋 1K - 3% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 770 · 📋 980 - 7% open · ⏱️ 03.11.2021):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 120K / month):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 800 · 📦 25K · 📋 710 - 46% open · ⏱️ 04.11.2021):
...
<details><summary><b><a href="https://github.com/PyCQA/prospector">prospector</a></b> (🥈24 ·  ⭐ 1.5K) - A tool to analyse Python code. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 77 · 🔀 140 · 📋 280 - 17% open · ⏱️ 01.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 480K / month):
	```
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈24 ·  ⭐ 820 · 💀) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 38 · 🔀 79 · 📦 2.8K · 📋 120 - 55% open · ⏱️ 10.04.2019):

	```
	git clone https://github.com/klen/pylama
	```
- [PyPi](https://pypi.org/project/pylama) (📥 86K / month):
	```
	pip install pylama
	```
...
<details><summary><b><a href="https://github.com/facebook/pyre-check">pyre-check</a></b> (🥉21 ·  ⭐ 5.6K) - Performant type checking. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 340 · 📋 270 - 23% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 25K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 69 · 🔀 210 · 📋 450 - 21% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 140K / month):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 150 · 📋 140 - 22% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 35K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1K · 🔀 1.1K · 📋 1.4K - 10% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 6 · 🔀 140 · 📦 5 · 📋 22 - 4% open · ⏱️ 11.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 320 / month):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1K · 📥 8K · 📦 220K · 📋 800 - 33% open · ⏱️ 20.09.2021):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 27M / month):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.2K · 📦 9.5K · 📋 240 - 40% open · ⏱️ 17.06.2021):

	```
	git clone https://github.com/google/python-fire
	```
- [PyPi](https://pypi.org/project/python-fire) (📥 96 / month):
	```
...
- [PyPi](https://pypi.org/project/asciimatics):
	...
	```
- [Conda](https://anaconda.org/conda-forge/asciimatics) (📥 79K · ⏱️ 09.04.2021):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (🔀 110 · 📦 470 · 📋 85 - 22% open · ⏱️ 30.10.2021):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 83 · 📦 130 · 📋 28 - 60% open · ⏱️ 31.03.2021):
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 140 · 🔀 3.2K · 📦 9.4K · 📋 710 - 16% open · ⏱️ 03.11.2021):
...
<details><summary><b><a href="https://github.com/nvbn/thefuck">thefuck</a></b> (🥇30 ·  ⭐ 65K) - Correcting your previous console command. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 160 · 🔀 440 · 📦 340 · 📋 610 - 20% open · ⏱️ 30.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 44K / month):
	```
	pip install pgcli
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 95 · 🔀 600 · 📦 200 · 📋 560 - 27% open · ⏱️ 09.05.2021):
...
- [PyPi](https://pypi.org/project/mycli) (📥 25K / month):
	...
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 21K · ⏱️ 07.08.2021):
	```
	conda install -c conda-forge mycli
	```
</details>
<details><summary><b><a href="https://github.com/gleitz/howdoi">howdoi</a></b> (🥈24 ·  ⭐ 9.2K) - Instant coding answers via the command line. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 61 · 🔀 200 · 📋 280 - 19% open · ⏱️ 30.10.2021):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 4.8K / month):
	```
	pip install tmuxp
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥉21 ·  ⭐ 420) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 21 · 🔀 38 · 📦 25 · 📋 220 - 13% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 20 · 🔀 50 · 📦 120 · 📋 68 - 29% open · ⏱️ 11.09.2021):

	```
	git clone https://github.com/dbcli/litecli
	```
- [PyPi](https://pypi.org/project/litecli) (📥 6.3K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 260 · 📦 35 · 📋 91 - 31% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/donnemartin/saws
	```
- [PyPi](https://pypi.org/project/saws) (📥 370 / month):
	```
	pip install saws
	```
...
- [GitHub](https://github.com/mooz/percol) (👨‍💻 36 · 🔀 140 · 📦 28 · 📋 65 - 55% open · ⏱️ 23.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/percol) (📥 1.4K / month):
	```
	pip install percol
	```
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 150 · 📥 510 · 📦 13 · 📋 69 - 82% open · ⏱️ 19.09.2018):
	...
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 280 / month):
	```
...
<details><summary><b><a href="https://github.com/laixintao/iredis">iredis</a></b> (🥉18 ·  ⭐ 1.6K) - Redis CLI with autocompletion and syntax highlighting. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 23 · 🔀 71 · 📥 6.2K · 📋 190 - 31% open · ⏱️ 17.08.2021):

	```
	git clone https://github.com/laixintao/iredis
	```
- [PyPi](https://pypi.org/project/iredis) (📥 840 / month):
	```
	pip install iredis
	```
...
<details><summary><b><a href="https://github.com/sloria/doitlive">doitlive</a></b> (🥉15 ·  ⭐ 3.1K) - A tool for live presentations in the terminal. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 16 · 🔀 89 · 📦 15 · 📋 47 - 27% open · ⏱️ 24.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/doitlive) (📥 200 / month):
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 44 · 📋 130 - 35% open · ⏱️ 11.01.2021):
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 90 · 🔀 1.6K · 📥 720K · 📦 620 · 📋 440 - 26% open · ⏱️ 15.10.2021):
...
<details><summary><b><a href="https://github.com/ageitgey/face_recognition">Face Recognition</a></b> (🥈23 ·  ⭐ 42K) - Simple facial recognition library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 47 · 🔀 11K · 📥 450 · 📋 1.2K - 53% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition):
	```
	pip install face_recognition
	```
- [Conda](https://anaconda.org/conda-forge/face_recognition) (📥 3.5K · ⏱️ 30.04.2021):
	```
	conda install -c conda-forge face_recognition
	```
</details>
<details><summary><b><a href="https://github.com/madmaze/pytesseract">pytesseract</a></b> (🥈23 ·  ⭐ 3.9K) - A wrapper for [Google Tesseract.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 38 · 🔀 550 · 📋 280 - 3% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/kornia/kornia) (🔀 500 · 📥 140 · 📦 720 · 📋 480 - 20% open · ⏱️ 03.11.2021):
...
<details><summary><b><a href="https://github.com/sightmachine/SimpleCV">SimpleCV</a></b> (🥉20 ·  ⭐ 2.5K · 💀) - An open source framework for building computer vision applications. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/sightmachine/SimpleCV) (👨‍💻 100 · 🔀 750 · 📦 330 · 📋 330 - 22% open · ⏱️ 07.04.2015):
	...
	```
- [PyPi](https://pypi.org/project/SimpleCV):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 81 · 🔀 370 · 📦 3 · 📋 910 - 9% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 160 · 🔀 1.7K · 📦 49K · 📋 1.3K - 53% open · ⏱️ 15.10.2021):
...
<details><summary><b><a href="https://github.com/pyca/pynacl">pynacl</a></b> (🥉18 ·  ⭐ 820) - Python binding to the Networking and Cryptography (NaCl) library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 61 · 🔀 180 · 📋 260 - 15% open · ⏱️ 03.11.2021):
...
- [PyPi](https://pypi.org/project/pynacl):
	...
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 1.7M · ⏱️ 04.11.2021):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 64 · 🔀 360 · 📦 7.9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
...
- [GitHub](https://github.com/awslabs/aws-data-wrangler) (👨‍💻 83 · 🔀 360 · 📥 100K · 📋 510 - 5% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 23 · 🔀 200 · 📋 220 - 14% open · ⏱️ 30.10.2021):
...
- [GitHub](https://github.com/Julian/jsonschema) (👨‍💻 94 · 🔀 470 · 📦 180K · 📋 610 - 9% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 39M / month):
	```
	pip install jsonschema
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 8.3M · ⏱️ 20.10.2021):
	```
...
<details><summary><b><a href="https://github.com/keleshev/schema">schema</a></b> (🥈29 ·  ⭐ 2.5K) - A library for validating Python data structures. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 170 · 📦 3.3K · 📋 130 - 49% open · ⏱️ 20.10.2021):

	```
	git clone https://github.com/keleshev/schema
	```
- [PyPi](https://pypi.org/project/schema) (📥 1.1M / month):
	```
	pip install schema
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 7 · 🔀 18 · 📦 46 · 📋 14 - 21% open · ⏱️ 07.03.2018):
	...
	```
- [PyPi](https://pypi.org/project/valideer) (📥 95K / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 160 · 🔀 1.5K · 📥 200 · 📦 120K · 📋 1.9K - 4% open · ⏱️ 31.10.2021):
...
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈32 ·  ⭐ 7K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 130 · 🔀 590 · 📦 18K · 📋 1.6K - 13% open · ⏱️ 17.10.2021):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 3.1M / month):
	```
	pip install altair
	```
- [Conda](https://anaconda.org/conda-forge/altair) (📥 990K · ⏱️ 01.04.2020):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 580 · 🔀 3.7K · 📦 40K · 📋 6.7K - 10% open · ⏱️ 04.11.2021):
...
- [PyPi](https://pypi.org/project/bokeh) (📥 1.9M / month):
	...
	pip install bokeh
	```
- [Conda](https://anaconda.org/conda-forge/bokeh) (📥 5.9M · ⏱️ 16.10.2021):
	```
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 100 · 🔀 300 · 📦 2K · 📋 980 - 25% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/SciTools/cartopy
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 110K / month):
	```
	pip install cartopy
	```
- [Conda](https://anaconda.org/conda-forge/cartopy) (📥 1.8M · ⏱️ 29.10.2021):
	```
...
- [PyPi](https://pypi.org/project/bqplot) (📥 67K / month):
	...
	pip install bqplot
	```
- [Conda](https://anaconda.org/conda-forge/bqplot) (📥 860K · ⏱️ 01.10.2021):
	```
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 86 · 🔀 140 · 📦 2.6K · 📋 450 - 16% open · ⏱️ 21.09.2021):
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 160 · 🔀 570 · 📦 610 · 📋 1.3K - 25% open · ⏱️ 27.10.2021):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 37K / month):
	```
	pip install vispy
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 97 · 🔀 850 · 📋 300 - 55% open · ⏱️ 21.08.2021):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 52K / month):
	```
...
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥇23 ·  ⭐ 500) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 68 · 🔀 400 · 📋 270 - 4% open · ⏱️ 27.10.2021):
...
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉16 ·  ⭐ 610 · 💀) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
🔗&nbsp;<b><a href="https://github.com/dhamaniasad/awesome-postgres">awesome-postgres</a></b> ( ⭐ 7.4K)  - A curated list of awesome PostgreSQL software, libraries, tools and..
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.2K · 📥 1.7K · 📦 8.2K · 📋 1.4K - 13% open · ⏱️ 03.08.2021):

	```
	git clone https://github.com/dpkp/kafka-python
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 5.2M / month):
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 270 · 🔀 1.9K · 📦 120K · 📋 930 - 5% open · ⏱️ 04.11.2021):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 420K · ⏱️ 01.06.2020):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 33 · 🔀 160 · 📦 13K · ⏱️ 02.11.2021):

	```
	git clone https://github.com/mongodb/motor
	```
- [PyPi](https://pypi.org/project/motor) (📥 2.1M / month):
	```
	pip install motor
	```
- [Conda](https://anaconda.org/conda-forge/motor) (📥 16K · ⏱️ 20.11.2020):
	```
	conda install -c conda-forge motor
	```
</details>
<details><summary><b><a href="https://github.com/PyMySQL/PyMySQL">PyMySQL</a></b> (🥈27 ·  ⭐ 6.7K) - A pure Python MySQL driver compatible to mysql-python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 190 · 🔀 900 · ⏱️ 03.11.2021):
...
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥉20 ·  ⭐ 700) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 34 · 🔀 130 · 📦 400 · 📋 200 - 11% open · ⏱️ 29.10.2021):

	```
	git clone https://github.com/mymarilyn/clickhouse-driver
	```
- [PyPi](https://pypi.org/project/clickhouse-driver):
	```
	pip install clickhouse-driver
	```
- [Conda](https://anaconda.org/conda-forge/clickhouse-driver) (📥 260K · ⏱️ 24.09.2021):
	```
	conda install -c conda-forge clickhouse-driver
	```
</details>
<details><summary><b><a href="https://github.com/python-happybase/happybase">happybase</a></b> (🥉18 ·  ⭐ 570 · 💤) - A developer-friendly library for Apache HBase. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/happybase):
	...
	```
- [Conda](https://anaconda.org/conda-forge/happybase) (📥 68K · ⏱️ 01.07.2019):
	```
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 11 · 🔀 29 · 📦 99 · 📋 18 - 27% open · ⏱️ 07.08.2020):
...
<details><summary><b><a href="https://github.com/plasticityai/supersqlite">SuperSQLite</a></b> (🥉14 ·  ⭐ 680 · 💀) - A supercharged SQLite library built on top of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 21 · 📦 9 · 📋 6 - 83% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite):
	```
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 46 · 🔀 190 · 📦 830 · 📋 88 - 15% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/maya) (📥 47K / month):
	```
	pip install maya
	```
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 36 · 📦 600 · 📋 34 - 8% open · ⏱️ 27.11.2020):

	```
	git clone https://github.com/zachwill/moment
	```
- [PyPi](https://pypi.org/project/moment) (📥 73K / month):
	```
	pip install moment
	```
...
<details><summary><b><a href="https://github.com/shinux/PyTime">PyTime</a></b> (🥉15 ·  ⭐ 140) - An easy-to-use Python module which aims to operate date/time/datetime by.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 5 · 🔀 16 · 📦 18 · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 9.7K / month):
	```
	pip install PyTime
	```
...
<details><summary><b><a href="https://github.com/jazzband/django-debug-toolbar">django-debug-toolbar</a></b> (🥇28 ·  ⭐ 6.7K) - Display various debug information for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 250 · 🔀 820 · 📥 170 · 📦 44K · 📋 770 - 10% open · ⏱️ 01.11.2021):
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 80 · 🔀 180 · 📦 2.6K · 📋 270 - 45% open · ⏱️ 01.11.2021):
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥈22 ·  ⭐ 7.5K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 260 · 📥 6.9K · 📋 230 - 28% open · ⏱️ 21.10.2021):
...
- [PyPi](https://pypi.org/project/py-spy):
	...
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 97K · ⏱️ 02.10.2021):
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 46 · 📦 2.4K · 📋 180 - 34% open · ⏱️ 28.09.2021):
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥉18 ·  ⭐ 5.5K) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/fabianp/memory_profiler">memory_profiler</a></b> (🥉13 ·  ⭐ 66 · 💀) - Monitor Memory usage of Python code. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/google/pyringe">pyringe</a></b> (🥉12 ·  ⭐ 1.6K · 💀) - Debugger capable of attaching to and injecting code into Python.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/google/pyringe) (🔀 71 · 📦 2 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 36 · 📦 2 · 📋 12 - 50% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 96 / month):
	```
	pip install lptrace
	```
...
- [PyPi](https://pypi.org/project/Theano) (📥 240K / month):
	...
	pip install Theano
	```
- [Conda](https://anaconda.org/conda-forge/Theano) (📥 1.8M · ⏱️ 05.06.2021):
	```
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 2.9K · 🔀 14K · 📥 150 · 📋 23K - 30% open · ⏱️ 04.11.2021):
...
- [PyPi](https://pypi.org/project/pytorch) (📥 43K / month):
	...
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 270K · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1K · 🔀 18K · 📋 11K - 1% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 970 · 🔀 6.5K · 📥 24K · 📋 9.4K - 18% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 690 · 📥 130 · ⏱️ 22.05.2020):
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.5K · 🔀 20K · 📦 19K · 📋 30K - 3% open · ⏱️ 03.11.2021):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.6M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 430K · ⏱️ 02.11.2021):
	```
	conda install -c conda-forge ansible
	```
</details>
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇33 ·  ⭐ 7.8K) - A cross-platform process and system utilities module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.1K · 📦 120K · 📋 1.5K - 11% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.7K · 🔀 5K · 📥 16K · 📋 24K - 8% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 80K / month):
	```
	pip install salt
	```
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 160 · 🔀 1.1K · 📦 6.4K · 📋 1K - 11% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/Supervisor/supervisor
	```
- [PyPi](https://pypi.org/project/supervisor) (📥 790K / month):
	```
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 44 · 🔀 130 · 📦 3.1K · 📋 99 - 11% open · ⏱️ 31.10.2021):
...
<details><summary><b><a href="https://github.com/Fizzadar/pyinfra">pyinfra</a></b> (🥉22 ·  ⭐ 1.4K) - A versatile CLI tools and python libraries to automate infrastructure. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 54 · 🔀 130 · 📦 34 · 📋 490 - 18% open · ⏱️ 30.10.2021):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 11K / month):
	```
	pip install pyinfra
	```
...
<details><summary><b><a href="https://github.com/dask/dask">dask</a></b> (🥇32 ·  ⭐ 9K) - A flexible parallel computing library for analytic computing. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/dask/dask) (👨‍💻 480 · 🔀 1.4K · 📦 31K · 📋 4K - 15% open · ⏱️ 03.11.2021):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 7.5M / month):
	```
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 4.5M · ⏱️ 23.10.2021):
	```
	conda install -c conda-forge dask
	```
</details>
<details><summary><b><a href="https://github.com/spotify/luigi">luigi</a></b> (🥈30 ·  ⭐ 15K) - A module that helps you build complex pipelines of batch jobs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/ray-project/ray) (🔀 3K · 📋 8.2K - 21% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 93 · 🔀 480 · 📦 870 · 📋 450 - 48% open · ⏱️ 09.10.2020):
...
<details><summary><b><a href="https://github.com/pyinstaller/pyinstaller">PyInstaller</a></b> (🥇26 ·  ⭐ 8.6K) - Converts Python programs into stand-alone executables.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.6K · 📥 720K · 📋 4.3K - 7% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 600K / month):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 17 · 🔀 150 · 📥 18 · 📦 290 · 📋 600 - 1% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.5K · 📦 160K · 📋 5.6K - 14% open · ⏱️ 31.10.2021):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 31 · 🔀 110 · 📦 440 · 📋 190 - 3% open · ⏱️ 29.10.2021):
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥇26 ·  ⭐ 4.2K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 18 · 🔀 860 · 📦 120 · ⏱️ 04.11.2021):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 53K / month):
	```
	pip install akshare
	```
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.7M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 5.3K · ⏱️ 22.12.2018):
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 34 · 🔀 190 · 📦 25 · 📋 130 - 59% open · ⏱️ 09.07.2021):

	```
	git clone https://github.com/bloomreach/s4cmd
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 12K / month):
	```
	pip install s4cmd
	```
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 900 · 📦 190 · 📋 370 - 21% open · ⏱️ 28.02.2021):

	```
	git clone https://github.com/awesto/django-shop
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 4K / month):
	```
...
- [GitHub](https://github.com/agiliq/merchant) (👨‍💻 49 · 🔀 170 · 📦 19 · 📋 63 - 36% open · ⏱️ 08.07.2015):
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 93 · 📦 97 · 📋 14 - 14% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 810 / month):
	```
	pip install alipay
	```
...
<details><summary><b><a href="https://github.com/Alir3z4/python-currencies">python-currencies</a></b> (🥉12 ·  ⭐ 55 · 💤) - Display money format and its filthy currencies. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 230 · 🔀 1.3K · 📥 1M · 📦 21K · 📋 13K - 8% open · ⏱️ 03.11.2021):
...
<details><summary><b><a href="https://github.com/jorgenschaefer/elpy">elpy</a></b> (🥈20 ·  ⭐ 1.7K) - Emacs Python Development Environment. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 80 · 🔀 230 · 📦 200 · 📋 1.5K - 22% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/elpy):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 170 · 🔀 2.6K · 📋 3.1K - 1% open · ⏱️ 31.10.2021):
...
<details><summary><b><a href="https://github.com/DamnWidget/anaconda">anaconda</a></b> (🥉17 ·  ⭐ 2.1K) - Anaconda turns your Sublime Text 3 in a full featured Python.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/DamnWidget/anaconda) (👨‍💻 89 · 🔀 240 · 📋 770 - 21% open · ⏱️ 28.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/anaconda):
	```
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 27 · 🔀 240 · 📦 1.8K · 📋 180 - 44% open · ⏱️ 30.08.2021):
...
- [PyPi](https://pypi.org/project/yagmail):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 8.4K · ⏱️ 30.08.2021):
	```
	conda install -c conda-forge yagmail
	```
</details>
<details><summary><b><a href="https://github.com/modoboa/modoboa">modoboa</a></b> (🥈22 ·  ⭐ 2K) - A mail hosting and management platform including a modern Web UI. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 100 · 🔀 270 · 📦 32 · 📋 1.6K - 4% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa):
	```
	pip install modoboa
	```
...
<details><summary><b><a href="https://github.com/martinrusev/imbox">imbox</a></b> (🥉19 ·  ⭐ 1K) - Python IMAP for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 48 · 🔀 150 · 📦 110 · 📋 110 - 42% open · ⏱️ 25.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/imbox):
	```
	pip install imbox
	```
...
<details><summary><b><a href="https://github.com/marrow/mailer">mailer</a></b> (🥉17 ·  ⭐ 230 · 💤) - High-performance extensible mail delivery framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/moggers87/salmon">salmon</a></b> (🥉12 ·  ⭐ 510) - A Python Mail Server. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 340 · 🔀 2.2K · 📋 1.3K - 2% open · ⏱️ 31.10.2021):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 7.1K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 62 · 🔀 850 · 📋 1.2K - 5% open · ⏱️ 01.11.2021):
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 120 · 🔀 590 · 📦 42K · 📋 540 - 27% open · ⏱️ 01.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 4.8M / month):
	```
	pip install watchdog
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 820K · ⏱️ 02.10.2021):
	```
...
- [PyPi](https://pypi.org/project/python-magic):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-magic) (📥 110K · ⏱️ 08.06.2021):
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 37 · 📦 6.1K · 📋 17 - 41% open · ⏱️ 14.02.2015):
	...
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 100K / month):
	```
	pip install Unipath
	```
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 130 · 🔀 350 · 📦 110K · 📋 380 - 9% open · ⏱️ 02.11.2021):
...
- [PyPi](https://pypi.org/project/wtforms) (📥 1.9M / month):
	...
	pip install wtforms
	```
- [Conda](https://anaconda.org/conda-forge/wtforms) (📥 82K · ⏱️ 18.10.2021):
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 660 · 📦 76K · 📋 630 - 9% open · ⏱️ 02.11.2021):
...
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 590K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 43K · ⏱️ 25.09.2021):
	```
	conda install -c conda-forge django-crispy-forms
	```
</details>
<details><summary><b><a href="https://github.com/zostera/django-bootstrap4">django-bootstrap4</a></b> (🥈27 ·  ⭐ 940) - Bootstrap 4 integration with Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 53K · 📋 150 - 11% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 97 · 🔀 680 · 📦 16K · 📋 290 - 1% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 150 · 📦 700 · 📋 180 - 24% open · ⏱️ 23.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 7.9K / month):
	```
	pip install deform
	```
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 84 · 📦 18 · 📋 16 - 75% open · ⏱️ 12.07.2017):
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 81 · 🔀 180 · 📥 2.4K · 📦 110K · 📋 180 - 3% open · ⏱️ 23.10.2021):
...
- [PyPi](https://pypi.org/project/more-itertools) (📥 14M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 7.8M · ⏱️ 17.09.2021):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 70 · 🔀 210 · 📦 48K · 📋 210 - 35% open · ⏱️ 28.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/toolz) (📥 10M / month):
	```
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 5.4M · ⏱️ 24.09.2020):
	```
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 28 · 🔀 120 · 📦 3.8K · 📋 66 - 6% open · ⏱️ 14.10.2021):
...
<details><summary><b><a href="https://github.com/dry-python/returns">returns</a></b> (🥉26 ·  ⭐ 2K) - A set of type-safe monads, transformers, and composition utilities. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/dry-python/returns) (👨‍💻 35 · 🔀 82 · 📦 110 · 📋 360 - 13% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 24K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 440 · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 27 · 🔀 99 · 📋 510 - 12% open · ⏱️ 06.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/coconut) (📥 700 / month):
	```
	pip install coconut
	```
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 370 · 📋 45 - 44% open · ⏱️ 13.10.2014):
	...
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 1.1K / month):
	```
	pip install fn.py
	```
...
<details><summary><b><a href="https://github.com/pytoolz/cytoolz">CyToolz</a></b> (🥉18 ·  ⭐ 810) - Cython implementation of `Toolz`: High performance functional.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 62 · 📦 32K · 📋 60 - 33% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇28 ·  ⭐ 970) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 120 · 🔀 190 · 📦 14K · 📋 290 - 20% open · ⏱️ 02.11.2021):
...
- [PyPi](https://pypi.org/project/pyglet):
	...
	pip install pyglet
	```
- [Conda](https://anaconda.org/conda-forge/pyglet) (📥 340K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/ChrisKnott/Eel) (👨‍💻 38 · 🔀 460 · 📦 2.7K · 📋 420 - 28% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/Eel) (📥 46K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 99 · 🔀 760 · 📥 140 · 📦 440 · 📋 490 - 17% open · ⏱️ 12.06.2021):
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.3K · 📦 3.7K · 📋 2.5K - 26% open · ⏱️ 03.11.2021):
...
- [PyPi](https://pypi.org/project/PySimpleGUI):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 42K · ⏱️ 29.10.2021):
	```
...
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉23 ·  ⭐ 6.3K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 290 · 📦 210 · 📋 780 - 12% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 340 · 📦 530 · 📋 570 - 5% open · ⏱️ 25.10.2021):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 200 · 🔀 490 · 📋 500 - 24% open · ⏱️ 01.11.2021):
...
<details><summary><b><a href="https://github.com/tartiflette/tartiflette-aiohttp">tartiflette-aiohttp</a></b> (🥉15 ·  ⭐ 53 · 💤) - An `aiohttp`-based wrapper for Tartiflette to expose.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tartiflette/tartiflette-aiohttp) (🔀 8 · 📦 33 · 📋 17 - 17% open · ⏱️ 30.04.2021):
...
- [GitHub](https://github.com/tartiflette/tartiflette-asgi) (🔀 14 · 📦 7 · 📋 48 - 10% open · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 120 · 🔀 540 · 📦 29K · 📋 250 - 8% open · ⏱️ 26.09.2021):
...
- [PyPi](https://pypi.org/project/geopy) (📥 3.4M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 620K · ⏱️ 12.07.2021):
	```
...
<details><summary><b><a href="https://github.com/SmileyChris/django-countries">django-countries</a></b> (🥉15 ·  ⭐ 1K) - A Django app that provides a country field for models and forms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/pallets/markupsafe">MarkupSafe</a></b> (🥇31 ·  ⭐ 430) - Implements a XML/HTML/XHTML Markup safe string for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 37 · 🔀 100 · 📦 700K · ⏱️ 01.11.2021):

	```
	git clone https://github.com/pallets/markupsafe
	```
- [PyPi](https://pypi.org/project/markupsafe) (📥 100M / month):
	```
	pip install markupsafe
	```
- [Conda](https://anaconda.org/conda-forge/markupsafe) (📥 13M · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 41 · 🔀 420 · 📦 32K · 📋 200 - 32% open · ⏱️ 26.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/xmltodict) (📥 14M / month):
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 72 · 🔀 200 · 📦 140K · 📋 330 - 13% open · ⏱️ 05.10.2021):
...
- [PyPi](https://pypi.org/project/bleach):
	...
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 5.3M · ⏱️ 25.08.2021):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 290 · 🔀 830 · 📥 900 · 📦 680K · 📋 960 - 13% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/shazow/urllib3
	```
- [PyPi](https://pypi.org/project/urllib3) (📥 300M / month):
	```
	pip install urllib3
	```
...
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈28 ·  ⭐ 7.9K) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 140 · 🔀 500 · 📦 12K · 📋 630 - 7% open · ⏱️ 01.11.2021):
...
- [PyPi](https://pypi.org/project/httpx):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 85K · ⏱️ 13.10.2021):
	```
...
<details><summary><b><a href="https://github.com/httplib2/httplib2">httplib2</a></b> (🥉26 ·  ⭐ 420) - Comprehensive HTTP client library. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 68 · 🔀 150 · 📦 89K · 📋 100 - 37% open · ⏱️ 02.11.2021):
...
- [PyPi](https://pypi.org/project/httplib2):
	...
	```
- [Conda](https://anaconda.org/conda-forge/httplib2) (📥 1.2M · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 45 · 🔀 130 · 📥 110 · 📦 880 · 📋 140 - 37% open · ⏱️ 11.07.2021):
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 360 · 🔀 1.5K · 📦 6.4K · 📋 1.2K - 2% open · ⏱️ 01.11.2021):
...
- [PyPi](https://pypi.org/project/keyboard):
	...
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 1.8K · ⏱️ 16.08.2021):
	```
	conda install -c conda-forge keyboard
	```
</details>
<details><summary><b><a href="https://github.com/SavinaRoja/PyUserInput">PyUserInput</a></b> (🥉22 ·  ⭐ 980 · 💤) - A module for cross-platform control of the mouse and.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 160 · 📦 390 · 📋 96 - 68% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 9.2K / month):
	```
...
<details><summary><b><a href="https://github.com/boppreh/mouse">mouse</a></b> (🥉17 ·  ⭐ 540 · 💤) - Hook and simulate global mouse events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 78 · 📦 430 · 📋 86 - 70% open · ⏱️ 05.04.2021):
...
<details><summary><b><a href="https://github.com/emcconville/wand">wand</a></b> (🥇30 ·  ⭐ 1.1K) - Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/emcconville/wand) (👨‍💻 96 · 🔀 190 · 📥 5.3K · 📦 7.2K · 📋 360 - 3% open · ⏱️ 05.10.2021):

	```
	git clone https://github.com/dahlia/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 460K / month):
	```
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 7.1K · ⏱️ 30.11.2020):
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 370 · 🔀 1.6K · 📋 2.3K - 6% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 38 · 🔀 86 · 📥 170 · 📦 9.2K · 📋 79 - 39% open · ⏱️ 01.11.2021):
...
- [PyPi](https://pypi.org/project/python-barcode):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 4.4K · ⏱️ 22.08.2020):
	```
	conda install -c conda-forge python-barcode
	```
</details>
<details><summary><b><a href="https://github.com/dylanaraps/pywal">pywal</a></b> (🥈21 ·  ⭐ 5.8K) - A tool that generates color schemes from images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 230 · 📥 600 · 📦 140 · 📋 470 - 21% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 12 · 🔀 31 · 📦 230 · 📋 250 - 35% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/hhatto/nude.py) (👨‍💻 12 · 🔀 130 · 📦 1.1K · 📋 10 - 70% open · ⏱️ 23.11.2020):
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 48 · 🔀 440 · 📋 150 - 15% open · ⏱️ 01.10.2021):
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 440 · 🔀 3.6K · 📥 27K · 📋 3.9K - 27% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 1.9K · 🔀 20K · ⏱️ 04.11.2021):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 10K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 29 · 🔀 190 · 📥 12K · 📋 420 - 45% open · ⏱️ 30.10.2021):
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 21 · 🔀 120 · 📦 7 · 📋 82 - 25% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 28 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 17 · 🔀 64 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 620 / month):
	```
	pip install Pyjion
	```
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 52 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 35 / month):
	```
...
- [PyPi](https://pypi.org/project/ptpython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 5.9K · ⏱️ 27.09.2021):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 120 · 🔀 200 · 📋 750 - 17% open · ⏱️ 31.10.2021):
...
<details><summary><b><a href="https://github.com/ovalhub/pyicu">PyICU</a></b> (🥇13 ·  ⭐ 130 · 💤) - A wrapper of International Components for Unicode C++ library.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 58 · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu):
	```
	pip install pyicu
	```
...
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥇29 ·  ⭐ 7.7K) - A modern workflow orchestration framework that makes it easy to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 260 · 🔀 710 · 📦 480 · 📋 1.9K - 19% open · ⏱️ 03.11.2021):
...
- [PyPi](https://pypi.org/project/schedule):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 9.7K · ⏱️ 10.04.2021):
	```
	conda install -c conda-forge schedule
	```
</details>
<details><summary><b><a href="https://github.com/sartography/SpiffWorkflow">Spiff</a></b> (🥈19 ·  ⭐ 1K) - A powerful workflow engine implemented in pure Python. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 42 · 🔀 230 · 📦 26 · 📋 69 - 5% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 100 · 🔀 230 · 📥 4.5K · 📦 15K · 📋 570 - 30% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 540 · 🔀 7.7K · 📥 3.3K · 📦 23K · 📋 4.2K - 5% open · ⏱️ 03.11.2021):
...
- [PyPi](https://pypi.org/project/xgboost):
	...
	pip install xgboost
	```
- [Conda](https://anaconda.org/conda-forge/xgboost) (📥 2.1M · ⏱️ 24.10.2021):
	```
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 320 · 🔀 6.9K · 📦 24K · 📋 1.4K - 6% open · ⏱️ 30.10.2021):
...
- [PyPi](https://pypi.org/project/gym):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 75K · ⏱️ 07.09.2021):
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 220 · 🔀 1.8K · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 81 · 🔀 540 · 📋 760 - 10% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 69 · 🔀 630 · 📥 500K · 📦 58K · 📋 1.6K - 26% open · ⏱️ 01.11.2021):
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 95 · 🔀 460 · 📦 46 · 📋 1K - 16% open · ⏱️ 22.10.2021):
...
<details><summary><b><a href="https://github.com/pallets/itsdangerous">itsdangerous</a></b> (🥇33 ·  ⭐ 2.3K) - Various helpers to pass trusted data to untrusted environments. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 38 · 🔀 180 · 📦 510K · ⏱️ 01.11.2021):

	```
	git clone https://github.com/pallets/itsdangerous
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 62M / month):
	```
...
- [GitHub](https://github.com/jek/blinker) (👨‍💻 11 · 🔀 160 · 📦 85K · 📋 34 - 52% open · ⏱️ 29.01.2021):

	```
	git clone https://github.com/jek/blinker
	```
- [PyPi](https://pypi.org/project/blinker) (📥 6.7M / month):
	```
	pip install blinker
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.4K · 📦 310 · 📋 860 - 33% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1K · ⏱️ 16.05.2021):
...
<details><summary><b><a href="https://github.com/fxsjy/jieba">jieba</a></b> (🥇28 ·  ⭐ 27K · 💀) - The most popular Chinese text segmentation library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/jieba):
	...
	pip install jieba
	```
- [Conda](https://anaconda.org/conda-forge/jieba) (📥 97K · ⏱️ 30.05.2021):
	```
...
<details><summary><b><a href="https://github.com/stanfordnlp/stanza">Stanza</a></b> (🥈24 ·  ⭐ 5.8K) - The Stanford NLP Group's official Python library, supporting 60+.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 41 · 🔀 730 · 📦 720 · 📋 600 - 11% open · ⏱️ 05.10.2021):

	```
	git clone https://github.com/stanfordnlp/stanza
	```
- [PyPi](https://pypi.org/project/stanza) (📥 72K / month):
	```
	pip install stanza
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 240 · 📦 300 · 📋 65 - 24% open · ⏱️ 10.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 8.5K / month):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 890 · 📥 70K · 📦 150 · 📋 140 - 72% open · ⏱️ 21.06.2020):
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 710 · 📋 100 - 36% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 7.3K / month):
	```
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 190 · ⏱️ 07.09.2021):
	```
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 210 · 🔀 790 · 📥 280 · 📦 100 · 📋 130 - 44% open · ⏱️ 29.10.2021):
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 270 · 📦 830 · 📋 71 - 36% open · ⏱️ 15.07.2017):
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉14 ·  ⭐ 35K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 10 · 🔀 9.5K · 📋 42 - 33% open · ⏱️ 20.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/funNLP) (📥 8 / month):
	```
	pip install funNLP
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 420 · 📋 170 - 23% open · ⏱️ 20.05.2020):
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 140 · 🔀 1.3K · 📦 14K · 📋 2.1K - 0% open · ⏱️ 31.10.2021):
...
- [PyPi](https://pypi.org/project/peewee):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 360K · ⏱️ 28.10.2021):
	```
	conda install -c conda-forge peewee
	```
</details>
<details><summary><b><a href="https://github.com/MongoEngine/mongoengine">mongoengine</a></b> (🥈29 ·  ⭐ 3.6K) - A Python Object-Document-Mapper for working with MongoDB. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 90 · 🔀 370 · 📦 830 · 📋 460 - 40% open · ⏱️ 27.10.2021):
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 270 · 📦 2.1K · 📋 260 - 4% open · ⏱️ 30.10.2021):
...
- [PyPi](https://pypi.org/project/dataset):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 1K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 15 · 🔀 80 · 📋 65 - 16% open · ⏱️ 04.11.2021):
...
<details><summary><b><a href="https://github.com/stephenmcd/hot-redis">hot-redis</a></b> (🥉14 ·  ⭐ 280 · 💀) - Rich Python data types for Redis. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 300 · 🔀 1.4K · 📥 9M · 📋 3.2K - 34% open · ⏱️ 30.10.2021):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 4.1M / month):
	```
	pip install poetry
	```
...
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥉23 ·  ⭐ 5.3K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 160 · 🔀 410 · 📋 760 - 14% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/conda/conda) (🔀 1K · 📋 8.1K - 24% open · ⏱️ 04.11.2021):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 2 · 📋 110 - 30% open · ⏱️ 08.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 110 / month):
	```
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 88 · 📋 180 - 14% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.4K · 📋 4.5K - 1% open · ⏱️ 01.11.2021):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 7.7K / month):
	```
	pip install sqlmap
	```
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 21 · 🔀 1.5K · 📋 110 - 14% open · ⏱️ 16.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 600 / month):
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 21 · 🔀 110 · 📦 700 · 📋 98 - 18% open · ⏱️ 23.05.2021):

	```
	git clone https://github.com/dfunckt/django-rules
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 260 / month):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 81 · 🔀 430 · 📦 7.9K · 📋 400 - 2% open · ⏱️ 29.08.2021):

	```
	git clone https://github.com/amoffat/sh
	```
- [PyPi](https://pypi.org/project/sh) (📥 1.9M / month):
	```
	pip install sh
	```
...
- [GitHub](https://github.com/amitt001/delegator.py) (👨‍💻 23 · 🔀 78 · 📋 45 - 17% open · ⏱️ 06.05.2019):
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 74 · 🔀 950 · 📦 1.8K · 📋 340 - 10% open · ⏱️ 18.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/annoy) (📥 760K / month):
	```
	pip install annoy
	```
...
<details><summary><b><a href="https://github.com/lyst/lightfm">lightfm</a></b> (🥈26 ·  ⭐ 3.8K · 💤) - A Python implementation of a number of popular recommendation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 600 · 📦 570 · 📋 430 - 20% open · ⏱️ 07.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/lightfm) (📥 210K / month):
	```
	pip install lightfm
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 30 · 🔀 500 · 📦 490 · 📋 360 - 22% open · ⏱️ 02.10.2021):

	```
	git clone https://github.com/benfred/implicit
	```
- [PyPi](https://pypi.org/project/implicit) (📥 110K / month):
	```
...
<details><summary><b><a href="https://github.com/ibayer/fastFM">fastFM</a></b> (🥉19 ·  ⭐ 950 · 💤) - A library for Factorization Machines. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 190 · 📥 400 · 📦 88 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 720 / month):
	```
	pip install fastFM
	```
...
<details><summary><b><a href="https://github.com/NicolasHug/Surprise">Surprise</a></b> (🥉15 ·  ⭐ 5.1K · 💀) - A scikit for building and analyzing recommender systems. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/NicolasHug/Surprise) (👨‍💻 38 · 🔀 880 · 📋 330 - 12% open · ⏱️ 05.08.2020):
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 66 · 🔀 130 · 📦 32K · 📋 230 - 30% open · ⏱️ 31.10.2021):
...
<details><summary><b><a href="https://github.com/falconry/falcon">falcon</a></b> (🥇30 ·  ⭐ 8.6K) - A high-performance framework for building cloud APIs and web app.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/falconry/falcon) (👨‍💻 180 · 🔀 830 · 📥 1.5K · 📦 5.9K · 📋 930 - 20% open · ⏱️ 26.10.2021):
...
- [PyPi](https://pypi.org/project/falcon):
	...
	pip install falcon
	```
- [Conda](https://anaconda.org/conda-forge/falcon) (📥 230K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 300 · 🔀 1.4K · 📦 6K · 📋 1.1K - 4% open · ⏱️ 29.10.2021):
...
- [PyPi](https://pypi.org/project/sanic):
	...
	pip install sanic
	```
- [Conda](https://anaconda.org/conda-forge/sanic) (📥 170K · ⏱️ 02.11.2021):
	```
	conda install -c conda-forge sanic
	```
</details>
<details><summary><b><a href="https://github.com/flask-restful/flask-restful">flask-restful</a></b> (🥈28 ·  ⭐ 6.2K) - Quickly building REST APIs for Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥈27 ·  ⭐ 38K) - A modern, fast, web framework for building APIs with Python 3.6+ based on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/fastapi):
	...
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 430K · ⏱️ 07.10.2021):
	```
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 89 · 🔀 420 · 📦 660 · 📋 310 - 6% open · ⏱️ 31.08.2021):
...
- [PyPi](https://pypi.org/project/apistar):
	...
	pip install apistar
	```
- [Conda](https://anaconda.org/conda-forge/apistar) (📥 89K · ⏱️ 03.04.2019):
	```
...
<details><summary><b><a href="https://github.com/pyeve/eve">eve</a></b> (🥉21 ·  ⭐ 6.4K · 💤) - REST API framework powered by Flask, MongoDB and good intentions. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 200 · 🔀 720 · 📦 980 · 📋 950 - 3% open · ⏱️ 14.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/eve):
	```
	pip install eve
	```
...
<details><summary><b><a href="https://github.com/jeffknupp/sandman2">sandman2</a></b> (🥉18 ·  ⭐ 1.7K · 💤) - Automated REST APIs for existing database-driven systems. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 180 · 📦 16 · 📋 78 - 33% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 92 · 🔀 4.2K · 📋 250 - 3% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/0rpc/zerorpc-python) (👨‍💻 36 · 🔀 350 · 📋 150 - 31% open · ⏱️ 27.05.2020):
...
<details><summary><b><a href="https://github.com/sympy/sympy">SymPy</a></b> (🥇35 ·  ⭐ 8.6K) - A Python library for symbolic mathematics. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.4K · 📥 440K · 📦 37K · 📋 11K - 32% open · ⏱️ 03.11.2021):
...
- [PyPi](https://pypi.org/project/sympy) (📥 1.8M / month):
	...
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 1.8M · ⏱️ 09.10.2021):
	```
	conda install -c conda-forge sympy
	```
</details>
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">statsmodels</a></b> (🥈33 ·  ⭐ 6.8K) - Statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 340 · 🔀 2.2K · 📥 26 · 📦 52K · 📋 4.5K - 45% open · ⏱️ 03.11.2021):

	```
	git clone https://github.com/statsmodels/statsmodels
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 6.7M / month):
	```
	pip install statsmodels
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 5.2M · ⏱️ 03.10.2021):
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 330 · 🔀 1.4K · 📥 670 · 📦 560 · 📋 2.4K - 8% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 13 · 🔀 160 · 📦 59 · 📋 64 - 1% open · ⏱️ 25.10.2021):
...
- [PyPi](https://pypi.org/project/karateclub):
	...
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 6.9K · ⏱️ 05.08.2021):
	```
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 93 · 🔀 330 · 📋 2.9K - 2% open · ⏱️ 29.10.2021):
...
- [GitHub](https://github.com/obspy/obspy) (🔀 450 · 📥 6.7K · 📋 1.5K - 19% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/chapmanb/bcbb) (👨‍💻 32 · 🔀 210 · 📦 190 · 📋 72 - 19% open · ⏱️ 03.11.2021):
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 200 · 🔀 1.2K · 📦 7.4K · 📋 1.2K - 36% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 300 · 📦 2.4K · 📋 140 - 13% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 190 · 🔀 560 · 📦 35K · 📋 1.1K - 10% open · ⏱️ 29.10.2021):
...
- [PyPi](https://pypi.org/project/marshmallow) (📥 10M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 840K · ⏱️ 19.10.2021):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 18 · 🔀 35 · 📦 1.8K · 📋 98 - 10% open · ⏱️ 16.10.2021):

	```
	git clone https://github.com/python-rapidjson/python-rapidjson
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 710K / month):
	```
	pip install python-rapidjson
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 700K · ⏱️ 16.10.2021):
	```
	conda install -c conda-forge python-rapidjson
	```
</details>
<details><summary><b><a href="https://github.com/TkTech/pysimdjson">pysimdjson</a></b> (🥉21 ·  ⭐ 490) - A Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 12 · 🔀 34 · 📦 150 · 📋 68 - 14% open · ⏱️ 21.06.2021):

	```
	git clone https://github.com/TkTech/pysimdjson
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 71K / month):
	```
...
- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 75 · 🔀 300 · 📋 310 - 13% open · ⏱️ 02.11.2021):
...
<details><summary><b><a href="https://github.com/nficano/python-lambda">python-lambda</a></b> (🥉18 ·  ⭐ 1.3K) - A toolkit for developing and deploying Python code in AWS Lambda. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 47 · 🔀 220 · 📦 140 · 📋 87 - 39% open · ⏱️ 14.07.2021):
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 500 · 📥 5.4K · 📦 260 · 📋 2.2K - 13% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 550 · 📦 12K · 📋 230 - 11% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/jazzband/tablib
	```
- [PyPi](https://pypi.org/project/tablib) (📥 910K / month):
	```
	pip install tablib
	```
...
<details><summary><b><a href="https://github.com/jmcnamara/XlsxWriter">XlsxWriter</a></b> (🥇29 ·  ⭐ 2.7K) - A Python module for creating Excel .xlsx files. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 45 · 🔀 540 · 📦 41K · 📋 740 - 1% open · ⏱️ 01.11.2021):
...
- [PyPi](https://pypi.org/project/XlsxWriter):
	...
	```
- [Conda](https://anaconda.org/conda-forge/XlsxWriter) (📥 1.4M · ⏱️ 01.11.2021):
	```
	conda install -c conda-forge XlsxWriter
	```
</details>
<details><summary><b><a href="https://github.com/xlwings/xlwings">xlwings</a></b> (🥈28 ·  ⭐ 2.1K) - A BSD-licensed library that makes it easy to call Python from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 56 · 🔀 380 · 📥 27K · 📦 19K · 📋 1.4K - 22% open · ⏱️ 29.10.2021):
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 540 · 📦 950 · 📋 830 - 7% open · ⏱️ 08.10.2021):
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 150 · 🔀 670 · 📦 160K · 📋 720 - 3% open · ⏱️ 03.11.2021):
...
- [PyPi](https://pypi.org/project/mistune):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 5.3M · ⏱️ 02.11.2021):
	```
	conda install -c conda-forge mistune
	```
</details>
<details><summary><b><a href="https://github.com/pyexcel/pyexcel">pyexcel</a></b> (🥈23 ·  ⭐ 970) - Providing one API for reading, manipulating and writing csv, ods,.. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/pyexcel):
	...
	pip install pyexcel
	```
- [Conda](https://anaconda.org/conda-forge/pyexcel) (📥 39K · ⏱️ 12.09.2021):
	```
...
- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 730 · 📋 870 - 44% open · ⏱️ 15.05.2021):
...
- [PyPi](https://pypi.org/project/python-docx):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-docx) (📥 92K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 59 · 📦 8 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 62 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 420 · 🔀 1.7K · 📥 430 · 📦 5.4K · 📋 1.5K - 2% open · ⏱️ 12.10.2021):
...
- [PyPi](https://pypi.org/project/nikola) (📥 2.3K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 2.7K · ⏱️ 14.02.2021):
	```
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 1.8K · 📦 16K · 📋 1.6K - 6% open · ⏱️ 01.11.2021):
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 130 · 🔀 540 · 📋 370 - 18% open · ⏱️ 13.10.2021):
...
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇31 ·  ⭐ 8K) - Simple job queues for Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 250 · 🔀 1.2K · 📦 9K · 📋 920 - 17% open · ⏱️ 27.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/rq) (📥 520K / month):
	```
	pip install rq
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 66 · 🔀 320 · 📦 820 · ⏱️ 28.10.2021):
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 70 · 🔀 200 · 📥 32 · 📦 330 · 📋 260 - 8% open · ⏱️ 26.10.2021):
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 37 · 🔀 110 · 📦 26 · 📋 170 - 30% open · ⏱️ 13.12.2020):
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇23 ·  ⭐ 8.1K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/jinja) (👨‍💻 290 · 🔀 1.4K · 📥 52K · 📋 800 - 4% open · ⏱️ 02.11.2021):
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 430 · 🔀 1.5K · 📦 42K · 📋 520 - 23% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 5M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 510K · ⏱️ 03.11.2021):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.4K · 📋 3.6K - 4% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 820K / month):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 490 · 📦 5.1K · 📋 490 - 10% open · ⏱️ 03.11.2021):
...
<details><summary><b><a href="https://github.com/HypothesisWorks/hypothesis">hypothesis</a></b> (🥈31 ·  ⭐ 5.5K) - Hypothesis is an advanced Quickcheck style property based.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 450 · 📦 10K · 📋 1.2K - 5% open · ⏱️ 01.11.2021):
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 220 · 🔀 2.2K · 📦 1.9K · 📋 1.2K - 1% open · ⏱️ 03.11.2021):
...
- [PyPi](https://pypi.org/project/locust):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 40K · ⏱️ 02.11.2021):
	```
	conda install -c conda-forge locust
	```
</details>
<details><summary><b><a href="https://github.com/getsentry/responses">responses</a></b> (🥈29 ·  ⭐ 3.4K) - A utility library for mocking out the requests Python library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/getsentry/responses) (👨‍💻 100 · 🔀 260 · 📥 19 · 📦 11K · 📋 190 - 20% open · ⏱️ 04.11.2021):
...
- [PyPi](https://pypi.org/project/responses):
	...
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 850K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 760 · 📦 11K · 📋 510 - 61% open · ⏱️ 14.09.2021):
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 110 · 🔀 280 · 📦 3.3K · 📋 320 - 21% open · ⏱️ 03.11.2021):
...
<details><summary><b><a href="https://github.com/gabrielfalcao/HTTPretty">httpretty</a></b> (🥈26 ·  ⭐ 1.9K) - HTTP request mock tool for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 240 · 📦 5.3K · 📋 230 - 38% open · ⏱️ 13.09.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 100 · 🔀 270 · 📥 180 · 📋 300 - 1% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 83K / month):
	```
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 3.6K · ⏱️ 15.07.2020):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 120 · 📦 4.2K · 📋 250 - 20% open · ⏱️ 12.10.2021):
...
<details><summary><b><a href="https://github.com/FactoryBoy/factory_boy">factory_boy</a></b> (🥉20 ·  ⭐ 2.7K) - A test fixtures replacement for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 33 · 🔀 72 · 📋 580 - 16% open · ⏱️ 03.11.2021):
...
<details><summary><b><a href="https://github.com/emirozer/fake2db">fake2db</a></b> (🥉16 ·  ⭐ 2.1K · 💀) - Fake database generator. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 110 · 📦 16 · 📋 22 - 31% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/fake2db):
	```
	pip install fake2db
	```
...
<details><summary><b><a href="https://github.com/klen/mixer">mixer</a></b> (🥉12 ·  ⭐ 780) - Another fixtures replacement. Supports Django, Flask, SQLAlchemy,.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 37 · 🔀 180 · 📥 6K · 📦 390K · 📋 200 - 8% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/pyparsing/pyparsing
	```
- [PyPi](https://pypi.org/project/pyparsing) (📥 73M / month):
	```
	pip install pyparsing
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 16M · ⏱️ 30.10.2021):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 30 · 🔀 85 · 📦 21K · 📋 51 - 3% open · ⏱️ 12.05.2021):

	```
	git clone https://github.com/un33k/python-slugify
	```
- [PyPi](https://pypi.org/project/python-slugify) (📥 4.5M / month):
	```
	pip install python-slugify
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 570K · ⏱️ 06.05.2021):
	```
...
<details><summary><b><a href="https://github.com/life4/textdistance">textdistance</a></b> (🥈26 ·  ⭐ 2.5K) - Compute distance between sequences with 30+ algorithms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/life4/textdistance) (👨‍💻 11 · 🔀 200 · 📥 310 · 📦 1.2K · ⏱️ 27.10.2021):

	```
	git clone https://github.com/orsinium/textdistance
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 260K / month):
	```
	pip install textdistance
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 60K · ⏱️ 27.10.2021):
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 44 · 🔀 210 · 📋 120 - 47% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/chardet) (📥 71M / month):
	```
	pip install chardet
	```
- [Conda](https://anaconda.org/conda-forge/chardet) (📥 14M · ⏱️ 02.11.2021):
	```
	conda install -c conda-forge chardet
	```
</details>
<details><summary><b><a href="https://github.com/pwaller/pyfiglet">pyfiglet</a></b> (🥈25 ·  ⭐ 910) - An implementation of figlet written in Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 20 · 🔀 91 · 📦 14K · 📋 41 - 21% open · ⏱️ 04.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 920K / month):
	```
	pip install pyfiglet
	```
- [Conda](https://anaconda.org/conda-forge/pyfiglet) (📥 74K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 100 · 📦 4.2K · 📋 120 - 7% open · ⏱️ 17.05.2021):
...
- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 32 · 🔀 340 · 📋 170 - 14% open · ⏱️ 18.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/ply) (📥 5.2M / month):
	```
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 860K · ⏱️ 07.07.2018):
	```
	conda install -c conda-forge ply
	```
</details>
<details><summary><b><a href="https://github.com/andialbrecht/sqlparse">sqlparse</a></b> (🥉21 ·  ⭐ 2.6K) - A non-validating SQL parser. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 30 · 🔀 180 · 📦 3.4K · 📋 65 - 52% open · ⏱️ 28.10.2021):
...
<details><summary><b><a href="https://github.com/mozillazg/python-pinyin">pypinyin</a></b> (🥉19 ·  ⭐ 3.5K) - Convert Chinese hanzi () to pinyin (). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 20 · 🔀 510 · 📋 200 - 14% open · ⏱️ 06.10.2021):

	```
	git clone https://github.com/mozillazg/python-pinyin
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 50 / month):
	```
...
- [GitHub](https://github.com/voronind/awesome-slugify) (👨‍💻 11 · 🔀 39 · 📦 2.9K · 📋 23 - 52% open · ⏱️ 20.01.2017):
	...
	```
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 57K / month):
	```
...
<details><summary><b><a href="https://github.com/ztane/python-Levenshtein">Levenshtein</a></b> (🥉16 ·  ⭐ 1K · 💤) - Fast computation of Levenshtein distance and string.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 120 · 🔀 1.4K · 📦 140K · 📋 2.5K - 10% open · ⏱️ 03.11.2021):
...
- [PyPi](https://pypi.org/project/boto3):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 7.3M · ⏱️ 03.11.2021):
	```
	conda install -c conda-forge boto3
	```
</details>
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥈31 ·  ⭐ 5.2K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 170 · 🔀 2K · 📥 93 · 📦 78K · 📋 840 - 3% open · ⏱️ 02.11.2021):
...
- [PyPi](https://pypi.org/project/google-api-python-client):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 940K · ⏱️ 26.10.2021):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 140 · 🔀 820 · 📥 30 · 📦 12K · 📋 660 - 11% open · ⏱️ 02.11.2021):
...
<details><summary><b><a href="https://github.com/ryanmcgrath/twython">twython</a></b> (🥉27 ·  ⭐ 1.8K) - A Python wrapper for the Twitter API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 380 · 📦 4.7K · 📋 320 - 5% open · ⏱️ 16.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/twython):
	```
	pip install twython
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 57 · 🔀 140 · 📦 3.2K · 📋 260 - 1% open · ⏱️ 29.10.2021):
...
<details><summary><b><a href="https://github.com/ellisonleao/pyshorteners">pyshorteners</a></b> (🥈17 ·  ⭐ 320 · 💀) - A pure Python URL shortening lib. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 53 · 📦 2.6K · 📋 72 - 1% open · ⏱️ 29.07.2020):
...
<details><summary><b><a href="https://github.com/codeinthehole/purl">purl</a></b> (🥈17 ·  ⭐ 260) - A simple, immutable URL class with a clean API for interrogation and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 7 · 🔀 150 · 📥 480 · 📦 140 · 📋 180 - 1% open · ⏱️ 27.10.2021):
...
- [PyPi](https://pypi.org/project/scikit-video):
	...
	```
- [Conda](https://anaconda.org/conda-forge/scikit-video) (📥 15K · ⏱️ 20.09.2018):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 220 · 🔀 690 · 📋 540 - 24% open · ⏱️ 30.10.2021):
...
- [PyPi](https://pypi.org/project/django-storages):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 30K · ⏱️ 30.10.2021):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 820 · 📦 6.1K · 📋 340 - 41% open · ⏱️ 10.05.2020):
...
- [PyPi](https://pypi.org/project/requests-html) (📥 630K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 410 · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/codelucas/newspaper) (👨‍💻 100 · 🔀 1.8K · 📦 3.2K · 📋 620 - 59% open · ⏱️ 02.09.2020):
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 21 · 🔀 460 · 📦 960 · 📋 93 - 16% open · ⏱️ 21.10.2021):
...
- [PyPi](https://pypi.org/project/sumy) (📥 27K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 440 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 39 · 🔀 440 · 📋 200 - 37% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/textract) (📥 79K / month):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 82 · 📦 620 · ⏱️ 12.07.2021):
...
- [PyPi](https://pypi.org/project/html2text):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 7.2K · ⏱️ 09.02.2020):
	```
	conda install -c conda-forge html2text
	```
</details>
<details><summary><b><a href="https://github.com/buriy/python-readability">python-readability</a></b> (🥉18 ·  ⭐ 2K) - Fast Python port of arc90's readability tool. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/gaojiuli/toapi">toapi</a></b> (🥉15 ·  ⭐ 3.2K) - Every web site provides APIs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/michaelhelmick/lassie">lassie</a></b> (🥉15 ·  ⭐ 530) - Web Content Retrieval for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 65 · 🔀 250 · 📦 330 · 📋 220 - 12% open · ⏱️ 08.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 3.5K / month):
	```
	pip install grab
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 46 · 🔀 330 · 📥 42 · 📋 160 - 15% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 140K / month):
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 790 · 📋 73 - 58% open · ⏱️ 07.06.2015):
	...
	```
- [PyPi](https://pypi.org/project/robobrowser) (📥 6.3K / month):
	```
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 49 · 🔀 1.3K · 📥 140 · 📦 40 · 📋 450 - 24% open · ⏱️ 10.07.2019):
...
<details><summary><b><a href="https://github.com/qinxuye/cola">cola</a></b> (🥉13 ·  ⭐ 1.4K · 💀) - A distributed crawling framework. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 3 · 🔀 530 · 📦 3 · 📋 65 - 20% open · ⏱️ 01.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/cola):
	```
	pip install cola
	```
...
🔗&nbsp;<b><a href="https://github.com/shahraizali/awesome-django">awesome-django</a></b> ( ⭐ 690 · 💀)  - The Best Django Resource, Awesome Django for mature packages.
...
<details><summary><b><a href="https://github.com/MasoniteFramework/masonite">Masonite</a></b> (🥇17 ·  ⭐ 1.7K) - The modern and developer centric Python web framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 52 · 🔀 380 · 📦 42K · 📋 800 - 2% open · ⏱️ 28.10.2021):
...
- [PyPi](https://pypi.org/project/websockets) (📥 12M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 1M · ⏱️ 02.11.2021):
	```
...
- [PyPi](https://pypi.org/project/channels):
	...
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 64K · ⏱️ 11.07.2021):
	```
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 360 · 🔀 1.4K · 📥 98 · 📦 550K · 📋 1.7K - 17% open · ⏱️ 06.09.2021):
...
- [PyPi](https://pypi.org/project/gunicorn):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gunicorn) (📥 780K · ⏱️ 02.11.2021):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 440 · 🔀 1.5K · 📥 250 · 📦 610K · 📋 910 - 2% open · ⏱️ 01.11.2021):
...
<details><summary><b><a href="https://github.com/jonashaag/bjoern">bjoern</a></b> (🥉21 ·  ⭐ 2.7K) - Asynchronous, very fast and written in C. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 41 · 🔀 180 · 📦 380 · 📋 140 - 18% open · ⏱️ 13.08.2021):
...
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉17 ·  ⭐ 990) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/waitress):
	...
	```
- [Conda](https://anaconda.org/conda-forge/waitress) (📥 42K · ⏱️ 08.03.2021):
	```
