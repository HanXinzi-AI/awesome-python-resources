...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 24 · 🔀 790 · 📦 25 · 📋 1.1K - 0% open · ⏱️ 17.04.2023):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 210 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 42 · 📋 210 - 24% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 300 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 14.04.2023):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 610 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 990 · 🔀 39K · 📦 2 · 📋 1.2K - 1% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 89M · ⏱️ 06.04.2023):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 200 · 🔀 4.1K · 📦 80 · 📋 160 - 35% open · ⏱️ 04.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 5K / month):
	```
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 39 · ⏱️ 09.02.2020):
...
<details><summary><b><a href="https://github.com/prabhupant/python-ds">python-ds</a></b> (🥉15 ·  ⭐ 2.1K) - A collection of data structure and algorithms for coding interviews. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 160 · 🔀 550 · 📦 170K · 📋 640 - 4% open · ⏱️ 18.04.2023):
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 65 · 🔀 230 · 📋 300 - 10% open · ⏱️ 16.04.2023):
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 56 · 🔀 470 · 📥 370 · 📦 74K · 📋 310 - 19% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/MagicStack/uvloop
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 7.7M / month):
	```
	pip install uvloop
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 29K · 📋 700 - 37% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 7.1M / month):
	```
	pip install trio
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 920 · 📦 23K · 📋 520 - 49% open · ⏱️ 08.12.2022):
...
- [PyPi](https://pypi.org/project/pydub) (📥 6.8M / month):
	...
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 46K · ⏱️ 13.03.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 530 · 🔀 1.7K · 📥 8.1K · 📦 320 · 📋 2.6K - 18% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/beets) (📥 2.2K / month):
	...
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 250 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 43 · 🔀 130 · 📥 59K · 📦 11K · 📋 490 - 18% open · ⏱️ 18.04.2023):
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 25 · 🔀 55 · 📥 2.6K · 📦 2.3K · 📋 190 - 23% open · ⏱️ 08.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/eyeD3) (📥 28K / month):
	```
	pip install eyeD3
	```
...
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥈24 ·  ⭐ 440) - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 850 · 📋 1.1K - 4% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 1.9M / month):
	```
	pip install librosa
	```
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 26 · 🔀 95 · 📦 740 · 📋 99 - 13% open · ⏱️ 16.04.2023):
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 58 · 📦 16 · 📋 210 - 16% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/Parisson/TimeSide
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 60 / month):
	```
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 120 · 📦 13 · 📋 40 - 32% open · ⏱️ 27.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/matchering) (📥 590 / month):
	```
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.3K · 📋 230 - 42% open · ⏱️ 03.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 160 / month):
	```
	pip install dejavu
	```
...
- [PyPi](https://pypi.org/project/oauthlib) (📥 81M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 8.3M · ⏱️ 18.10.2022):
	```
	conda install -c conda-forge oauthlib
	```
</details>
<details><summary><b><a href="https://github.com/jpadilla/pyjwt">pyjwt</a></b> (🥈35 ·  ⭐ 4.6K) - JSON Web Token implementation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 140 · 🔀 610 · 📦 360K · 📋 400 - 4% open · ⏱️ 18.04.2023):
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 94 · 🔀 350 · 📦 26K · 📋 370 - 12% open · ⏱️ 24.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/authlib) (📥 8.1M / month):
	```
	pip install authlib
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 690 · 📋 750 - 21% open · ⏱️ 14.04.2023):
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 39 · 🔀 240 · 📋 500 - 16% open · ⏱️ 25.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 21K / month):
	```
	pip install pybuilder
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 40K · ⏱️ 22.02.2023):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 700 · 📋 3.9K - 4% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 330 · 📦 680K · 📋 630 - 17% open · ⏱️ 16.04.2023):
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 19 · 📥 69 · 📦 73 · 📋 9 - 77% open · ⏱️ 30.10.2015):
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 350 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 20.04.2023):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 710 / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 490 / month):
	```
	pip install Kotti
	```
...
<details><summary><b><a href="https://github.com/feincms/feincms">feincms</a></b> (🥉16 ·  ⭐ 860) - One of the most advanced Content Management Systems built on Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 48 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 120 · 📦 4.5K · 📋 190 - 10% open · ⏱️ 26.08.2022):
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 260 · 📋 72 - 22% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 370 · 🔀 2K · 📥 28K · 📦 360K · 📋 2.2K - 16% open · ⏱️ 19.04.2023):
...
<details><summary><b><a href="https://github.com/PyCQA/isort">isort</a></b> (🥇35 ·  ⭐ 5.8K) - A Python utility / library to sort imports. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 380K · 📋 1.2K - 11% open · ⏱️ 01.04.2023):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 360 · 📦 14K · 📋 1.1K - 8% open · ⏱️ 20.04.2023):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 320K / month):
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 87 · 🔀 160 · 📦 4.2K · 📋 360 - 14% open · ⏱️ 07.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/prospector) (📥 770K / month):
	```
	pip install prospector
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 67K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 150 · 🔀 860 · 📦 74K · 📋 780 - 47% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 95 · 📦 5.7K · 📋 140 - 33% open · ⏱️ 08.08.2022):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 240 · 🔀 390 · 📋 340 - 31% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 270 · 📦 400 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 9.9K / month):
	```
...
<details><summary><b><a href="https://github.com/scottrogowski/code2flow">code2flow</a></b> (🥉20 ·  ⭐ 3.2K) - Turn your Python and JavaScript code into DOT flowcharts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 15 · 📋 53 - 18% open · ⏱️ 08.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 4K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 92 · 🔀 250 · 📋 600 - 18% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/pytype) (📥 240K / month):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 150K · ⏱️ 19.04.2023):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 55 · 📦 120 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 3.7K / month):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 21% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.3K · 🔀 1.5K · 📋 2.1K - 7% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 220 · 🔀 1.5K · 📦 81K · 📋 1.1K - 8% open · ⏱️ 12.04.2023):
...
- [PyPi](https://pypi.org/project/rich) (📥 23M / month):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 3.5M · ⏱️ 12.04.2023):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 450K · 📋 910 - 37% open · ⏱️ 03.03.2023):
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 59 · 🔀 1.3K · 📦 20K · 📋 280 - 39% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-fire) (📥 190 / month):
	```
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 42 · 🔀 240 · 📦 830 · 📋 290 - 8% open · ⏱️ 16.04.2023):

	```
	git clone https://github.com/peterbrittain/asciimatics
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 56K / month):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 180 · 📦 1.7K · 📋 190 - 7% open · ⏱️ 15.04.2023):
...
- [PyPi](https://pypi.org/project/alive-progress) (📥 290K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 30K · ⏱️ 08.04.2023):
	```
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 7.3K / month):
	```
	pip install bashplotlib
	```
- [Conda](https://anaconda.org/conda-forge/bashplotlib) (📥 4.3K · ⏱️ 08.09.2018):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 3.3K · 📦 13K · 📋 810 - 16% open · ⏱️ 29.03.2023):
...
- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 280 · 🔀 1.8K · 📦 19K · 📋 770 - 25% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 660K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.2K · 📦 420 · 📋 670 - 31% open · ⏱️ 25.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/thefuck) (📥 6.4K / month):
	```
	pip install thefuck
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 72 · 🔀 220 · 📦 240 · 📋 340 - 23% open · ⏱️ 15.04.2023):
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 490 · 📦 900 · 📋 660 - 22% open · ⏱️ 18.03.2023):
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 290 · 📋 620 - 29% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/mycli) (📥 65K / month):
	...
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 55K · ⏱️ 02.09.2022):
	```
	conda install -c conda-forge mycli
	```
</details>
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈26 ·  ⭐ 990) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 55 · 🔀 120 · 📦 390 · 📋 350 - 13% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/copier) (📥 39K / month):
	...
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 2.6K · ⏱️ 20.04.2023):
	```
...
- [PyPi](https://pypi.org/project/iredis) (📥 1.8K / month):
	...
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 650 · ⏱️ 10.08.2022):
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 63 · 📦 220 · 📋 93 - 35% open · ⏱️ 11.07.2022):
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 670 · 📦 14 · 📋 70 - 82% open · ⏱️ 19.09.2018):
	...
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 640 / month):
	```
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 94 · 📦 18 · 📋 49 - 26% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/doitlive) (📥 180 / month):
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 46 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 70K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.5K · 📥 4.3M · 📦 2.5K · 📋 760 - 25% open · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 120K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 3.5K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 28 · 🔀 240 · 📦 820 · 📋 250 - 29% open · ⏱️ 16.04.2023):
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 13K · 📥 1.1K · 📋 1.3K - 54% open · ⏱️ 10.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 73K / month):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉24 ·  ⭐ 8.1K) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 810 · 📥 600 · 📦 3.8K · 📋 740 - 28% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/sightmachine/SimpleCV) (👨‍💻 100 · 🔀 760 · 📦 390 · 📋 330 - 22% open · ⏱️ 07.04.2015):
	...
	```
- [PyPi](https://pypi.org/project/SimpleCV) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 35 · 🔀 170 · 📥 11 · 📦 96K · 📋 85 - 4% open · ⏱️ 17.04.2023):
...
- [PyPi](https://pypi.org/project/python-decouple) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 60K · ⏱️ 02.03.2023):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 34 · 📦 25K · 📋 150 - 36% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/DiffSK/configobj
	```
- [PyPi](https://pypi.org/project/configobj) (📥 2.3M / month):
	```
	pip install configobj
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 610K · ⏱️ 20.01.2023):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 530 · 📋 1.2K - 14% open · ⏱️ 20.04.2023):
...
- [PyPi](https://pypi.org/project/hydra) (📥 8.5K / month):
	...
	pip install hydra
	```
- [Conda](https://anaconda.org/conda-forge/hydra) (📥 15K · ⏱️ 18.01.2021):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 64 · 🔀 200 · 📋 290 - 14% open · ⏱️ 14.04.2023):
...
- [PyPi](https://pypi.org/project/pynacl) (📥 40M / month):
	...
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 4.1M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 6.9K / month):
	```
	pip install blaze
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 130 · 🔀 580 · 📥 190K · 📦 960 · 📋 900 - 3% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 18 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 40 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 110 · 🔀 540 · 📦 360K · 📋 730 - 3% open · ⏱️ 17.04.2023):
...
- [PyPi](https://pypi.org/project/jsonschema) (📥 67M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 19M · ⏱️ 30.11.2022):
	```
...
- [PyPi](https://pypi.org/project/cerberus) (📥 5.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cerberus) (📥 310K · ⏱️ 10.12.2021):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 6.2K · 📋 150 - 52% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/schema) (📥 4.5M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 90K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 90 · 🔀 200 · 📦 13K · 📋 240 - 16% open · ⏱️ 22.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/voluptuous) (📥 2.2M / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 190 · 🔀 1.6K · 📥 240 · 📦 250K · 📋 2.3K - 4% open · ⏱️ 16.04.2023):
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📥 23 · 📦 52K · 📋 1.8K - 11% open · ⏱️ 07.04.2023):
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.8K · 📦 960 · 📋 430 - 58% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 96K / month):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 650 · 🔀 4K · 📦 210 · 📋 7.2K - 9% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 100 · 🔀 190 · 📦 4.8K · 📋 550 - 12% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/has2k1/plotnine
	```
- [PyPi](https://pypi.org/project/plotnine) (📥 670K / month):
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 590 · 📦 1.1K · 📋 1.4K - 20% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 340 · 📦 3.2K · 📋 1.1K - 26% open · ⏱️ 17.04.2023):

	```
	git clone https://github.com/SciTools/cartopy
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 66K / month):
	```
	pip install cartopy
	```
...
<details><summary><b><a href="https://github.com/msiemens/tinydb">tinydb</a></b> (🥇30 ·  ⭐ 5.8K) - A tiny, document-oriented database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥉23 ·  ⭐ 600) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 81 · 📦 1K · 📋 160 - 38% open · ⏱️ 18.04.2023):
...
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉21 ·  ⭐ 780) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 160K · 📋 630 - 3% open · ⏱️ 31.03.2023):

	```
	git clone https://github.com/PyMySQL/PyMySQL
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 31M / month):
	```
	pip install PyMySQL
	```
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 950K · ⏱️ 29.03.2023):
	```
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 54 · 🔀 180 · 📦 1.4K · 📋 280 - 13% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/clickhouse-driver) (📥 380K · ⏱️ 28.11.2022):
	```
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.8K · ⏱️ 08.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-driver) (📥 17 / month):
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 990 · ⏱️ 14.04.2023):
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 12 · 🔀 32 · 📦 120 · 📋 18 - 22% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 5.3K / month):
	```
	pip install queries
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 59 / month):
	```
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 88 · 🔀 310 · 📥 90 · 📦 19K · 📋 460 - 43% open · ⏱️ 25.02.2023):
...
- [PyPi](https://pypi.org/project/maya) (📥 45K / month):
	...
	pip install maya
	```
- [Conda](https://anaconda.org/conda-forge/maya) (📥 56K · ⏱️ 14.09.2022):
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 130 · 📦 920 · 📋 64 - 42% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 790 · 📋 40 - 7% open · ⏱️ 27.11.2020):
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 20 · 📦 33 · ⏱️ 05.11.2022):

	```
	git clone https://github.com/shinux/PyTime
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 960 / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 880 · 📥 190 · 📦 70K · 📋 840 - 7% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 330 · 📥 12K · 📦 2.5K · 📋 290 - 36% open · ⏱️ 09.12.2022):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 2.7M / month):
	```
	pip install py-spy
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 57 · 🔀 140 · 📦 44K · 📋 180 - 31% open · ⏱️ 11.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 3.2M / month):
	```
	pip install ipdb
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 90 · 🔀 450 · 📦 5K · 📋 210 - 31% open · ⏱️ 17.04.2023):
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 210 · 📦 4.7K · 📋 310 - 45% open · ⏱️ 13.03.2023):
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 41 · 🔀 58 · 📦 4.7K · 📋 200 - 38% open · ⏱️ 14.07.2022):
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 110 · 📦 200 · 📋 110 - 27% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 9.5K / month):
	```
	pip install wdb
	```
...
- [GitHub](https://github.com/rkern/line_profiler) (👨‍💻 14 · 🔀 250 · 📋 140 - 36% open · ⏱️ 23.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 370K / month):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 590 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 41 · 📦 130 · 📋 93 - 44% open · ⏱️ 29.10.2022):
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 680K / month):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 19 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 37 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 45 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 270K · 📋 37K - 5% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 6.3K · 📋 9.6K - 18% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 440K / month):
	```
	pip install mxnet
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 19.04.2023):
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥉30 ·  ⭐ 66K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 4K · 🔀 17K · 📥 14K · 📋 33K - 32% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 200 · 🔀 1.3K · 📦 300K · 📋 1.6K - 13% open · ⏱️ 20.04.2023):
...
- [PyPi](https://pypi.org/project/psutil) (📥 63M / month):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 21M · ⏱️ 17.04.2023):
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 27K · 📋 31K - 2% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.3M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 860K · ⏱️ 11.04.2023):
	```
	conda install -c conda-forge ansible
	```
</details>
<details><summary><b><a href="https://github.com/saltstack/salt">saltstack</a></b> (🥈29 ·  ⭐ 13K) - Infrastructure automation and management system. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 9K · 📋 1.1K - 10% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 140 · 📦 5K · 📋 100 - 11% open · ⏱️ 24.10.2022):
...
<details><summary><b><a href="https://github.com/Fizzadar/pyinfra">pyinfra</a></b> (🥉24 ·  ⭐ 2.3K) - A versatile CLI tools and python libraries to automate infrastructure. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 88 · 🔀 310 · 📦 77 · 📋 660 - 18% open · ⏱️ 16.03.2023):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 21K / month):
	```
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 770 · ⏱️ 14.04.2023):
	```
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 19 · 🔀 1.7K · 📋 1.7K - 23% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/sebastien/cuisine) (👨‍💻 57 · 🔀 160 · 📦 170 · 📋 110 - 24% open · ⏱️ 06.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/cuisine) (📥 1K / month):
	```
	pip install cuisine
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 48K · 📋 4.7K - 15% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.3K · 📥 58 · 📦 9K · 📋 14K - 18% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 43 · 🔀 210 · 📦 58 · 📋 330 - 19% open · ⏱️ 18.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/streamparse) (📥 3.3K / month):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 740K · 📦 42K · 📋 4.8K - 5% open · ⏱️ 16.04.2023):
...
- [PyPi](https://pypi.org/project/pyinstaller) (📥 1.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 430K · ⏱️ 15.04.2023):
	```
	conda install -c conda-forge pyinstaller
	```
</details>
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈27 ·  ⭐ 2.2K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 29 · 🔀 220 · 📦 790 · 📋 1.1K - 0% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 80 · 📥 420 · 📋 110 - 32% open · ⏱️ 04.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/shiv) (📥 20K / month):
	```
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 1.4K · ⏱️ 03.11.2022):
	```
...
<details><summary><b><a href="https://github.com/sphinx-doc/sphinx">sphinx</a></b> (🥇27 ·  ⭐ 5.4K) - Python Documentation generator. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.8K · 📦 300K · 📋 6.4K - 17% open · ⏱️ 18.04.2023):
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥇25 ·  ⭐ 6.4K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 56 · 🔀 1.4K · 📦 310 · ⏱️ 19.04.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 55K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 200 · 📦 34 · 📋 140 - 61% open · ⏱️ 06.05.2022):
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 26 · 🔀 170 · 📦 2K · 📋 75 - 24% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 950 · 📦 210 · 📋 380 - 22% open · ⏱️ 28.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 7.3K / month):
	```
...
- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 12 · 📥 6 · 📦 53 · 📋 6 - 50% open · ⏱️ 22.12.2020):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 3M · 📦 25K · 📋 17K - 6% open · ⏱️ 18.04.2023):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 54K / month):
	```
	pip install spyder
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 93 · 🔀 240 · 📦 210 · 📋 1.6K - 23% open · ⏱️ 02.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 820 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 180 · 🔀 2.7K · 📋 3.2K - 0% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 81 · 🔀 660 · 📥 33K · 📋 4.6K - 1% open · ⏱️ 14.04.2023):
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 330 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 20.04.2023):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 2.4K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 180 · 📋 130 - 48% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 9.7K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 56 · 📥 140 · 📋 72 - 33% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/mailer) (📥 64K / month):
	```
	pip install mailer
	```
...
<details><summary><b><a href="https://github.com/moggers87/salmon">salmon</a></b> (🥉14 ·  ⭐ 600) - A Python Mail Server. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 60 · 📥 85 · 📦 18 · 📋 90 - 18% open · ⏱️ 02.04.2023):

	```
	git clone https://github.com/moggers87/salmon
	```
- [PyPi](https://pypi.org/project/salmon) (📥 94 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 96 · 🔀 910 · 📦 250K · 📋 1.3K - 6% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/virtualenv) (📥 45M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 4.1M · ⏱️ 20.04.2023):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 420 · 🔀 2.7K · 📋 1.6K - 1% open · ⏱️ 16.04.2023):
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 58 · 🔀 250 · 📦 40K · 📋 190 - 16% open · ⏱️ 30.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-magic) (📥 5.7M / month):
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 38 · 📦 8.7K · 📋 17 - 35% open · ⏱️ 14.02.2015):
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 140 · 🔀 370 · 📦 170K · 📋 420 - 14% open · ⏱️ 13.01.2023):
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 690 · 📦 120K · 📋 670 - 8% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 98 · 🔀 680 · 📦 18K · 📋 290 - 2% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/dyve/django-bootstrap3
	```
- [PyPi](https://pypi.org/project/django-bootstrap3) (📥 89K / month):
	```
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 86 · 📦 20 · 📋 16 - 75% open · ⏱️ 12.07.2017):
	...
	```
- [PyPi](https://pypi.org/project/django-remote-forms) (📥 260 / month):
	```
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 100 · 🔀 240 · 📥 2.6K · 📦 170K · 📋 250 - 8% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 90K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 95 · 📦 340 · 📋 400 - 15% open · ⏱️ 14.04.2023):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 53K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 4.8K · ⏱️ 13.03.2022):
	```
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 460 · 📋 50 - 50% open · ⏱️ 13.10.2014):

	```
	git clone https://github.com/kachayev/fn.py
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 490 / month):
	```
	pip install fn.py
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 150 · 🔀 260 · 📦 21K · 📋 450 - 14% open · ⏱️ 20.04.2023):
...
<details><summary><b><a href="https://github.com/PySimpleGUI/PySimpleGUI">PySimpleGUI</a></b> (🥈30 ·  ⭐ 12K) - Wrapper for tkinter, Qt, WxPython and Remi. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.7K · 📦 8K · 📋 3.3K - 21% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 210K / month):
	```
	pip install PySimpleGUI
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 100K · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 46 · 🔀 540 · 📦 5.1K · 📋 500 - 32% open · ⏱️ 04.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/Eel) (📥 75K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 430 · 📦 730 · 📋 580 - 21% open · ⏱️ 08.05.2022):
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 530 · 📦 1.8K · 📋 1.2K - 16% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 440 · 📦 1K · 📋 750 - 3% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 450 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 590 / month):
	```
	pip install flexx
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 230 · 🔀 580 · 📥 1.4K · 📋 660 - 18% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 300 · 📦 210 · 📋 230 - 17% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/nucleic/enaml
	```
- [PyPi](https://pypi.org/project/enaml) (📥 1.9K / month):
	```
	pip install enaml
	```
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 130 · 🔀 590 · 📋 270 - 9% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/geopy) (📥 4.2M / month):
	```
	pip install geopy
	```
...
- [PyPi](https://pypi.org/project/django-countries) (📥 480K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-countries) (📥 3.1K · ⏱️ 28.02.2022):
	```
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 460 · 📦 1.2M · 📋 100 - 0% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 53K · 📋 230 - 31% open · ⏱️ 12.03.2023):
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 52 · 🔀 170 · 📦 18K · 📋 180 - 27% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 4.9M / month):
	```
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 39K · ⏱️ 28.12.2022):
	```
...
<details><summary><b><a href="https://github.com/stchris/untangle">untangle</a></b> (🥉23 ·  ⭐ 590) - Converts XML documents to Python objects for easy access. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/stchris/untangle) (👨‍💻 17 · 🔀 80 · 📥 530 · 📦 1K · 📋 56 - 26% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/untangle) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 4K · ⏱️ 30.06.2020):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 730 · 🔀 8.7K · 📥 5K · 📦 2.1M · 📋 3.7K - 5% open · ⏱️ 03.03.2023):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 190 · 🔀 660 · 📦 83K · 📋 750 - 3% open · ⏱️ 20.04.2023):
...
- [PyPi](https://pypi.org/project/httpx) (📥 17M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 550K · ⏱️ 11.04.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 980 · 📥 7.2K · 📦 1.3M · 📋 1.1K - 9% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 300 · 📦 3.7K · 📋 120 - 3% open · ⏱️ 26.01.2022):
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 50 · 🔀 130 · 📥 160 · 📦 1.5K · 📋 160 - 37% open · ⏱️ 10.09.2022):

	```
	git clone https://github.com/twisted/treq
	```
- [PyPi](https://pypi.org/project/treq) (📥 56K / month):
	```
	pip install treq
	```
- [Conda](https://anaconda.org/conda-forge/treq) (📥 70K · ⏱️ 30.01.2022):
	```
...
<details><summary><b><a href="https://github.com/secdev/scapy">scapy</a></b> (🥇34 ·  ⭐ 8.7K) - A brilliant packet manipulation library. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/secdev/scapy) (👨‍💻 420 · 🔀 1.8K · 📦 11K · 📋 1.4K - 4% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/scapy) (📥 2.8M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 78K · ⏱️ 25.12.2022):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 380 · 📦 10K · 📋 530 - 64% open · ⏱️ 31.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 370K / month):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 120 · 📦 1K · 📋 110 - 72% open · ⏱️ 23.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/mouse) (📥 44K / month):
	```
	pip install mouse
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 440 · 🔀 1.9K · 📦 1.1M · 📋 2.8K - 3% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 340 · 📋 940 - 0% open · ⏱️ 27.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 4.7K / month):
	```
	pip install thumbor
	```
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 44 · 🔀 110 · 📥 260 · 📦 17K · 📋 100 - 39% open · ⏱️ 13.04.2023):
...
- [PyPi](https://pypi.org/project/python-barcode) (📥 240K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 9.6K · ⏱️ 22.08.2020):
	```
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 280 · 📥 970 · 📦 230 · 📋 520 - 24% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 51 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 22 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 690 / month):
	```
	pip install hmap
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 560 · 🔀 4.7K · 📥 60K · 📋 4.7K - 26% open · ⏱️ 14.04.2023):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 56K · 📋 570 - 46% open · ⏱️ 17.04.2023):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 26K · 📋 63K - 10% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 68 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 700 / month):
	```
	pip install Pyjion
	```
- [Conda](https://anaconda.org/conda-forge/Pyjion) (📥 490 · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 60 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 81 / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 54 · 🔀 260 · 📦 2.5K · 📋 360 - 57% open · ⏱️ 12.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 270K / month):
	```
	pip install ptpython
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 32K · ⏱️ 31.10.2022):
	```
...
- [PyPi](https://pypi.org/project/bpython) (📥 100K / month):
	...
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 64K · ⏱️ 15.03.2023):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 51 · 📦 3.4K · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 460K / month):
	```
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 150K · ⏱️ 26.04.2022):
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 57 · 🔀 830 · 📦 25K · 📋 400 - 31% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 140 · 🔀 1.2K · 📦 2.6K · 📋 3.6K - 12% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 800K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 430K · ⏱️ 14.04.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 51 · 🔀 280 · 📦 59 · 📋 110 - 4% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 5.6K / month):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 350 · 📥 3.9K · 📦 42K · 📋 860 - 21% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 600 · 🔀 8K · 📥 6.3K · 📦 53K · 📋 4.8K - 6% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.9K · 📦 40K · 📋 1.8K - 3% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 580K / month):
	```
	pip install gym
	```
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.6K · 📦 120 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 3.2K / month):
	```
	pip install nupic
	```
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉22 ·  ⭐ 16K) - MindsDB is an open source AI layer for existing databases that.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 490 · 🔀 1.8K · 📋 2.6K - 21% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · 📋 160 - 88% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 17K / month):
	```
	pip install Metrics
	```
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 68K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 820K · ⏱️ 03.04.2023):

	```
	git clone https://github.com/pallets/itsdangerous
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 49M / month):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 84 · 🔀 330 · 📥 23 · 📦 4.2K · 📋 150 - 33% open · ⏱️ 02.04.2023):
...
- [PyPi](https://pypi.org/project/boltons) (📥 4.2M / month):
	...
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 1.3M · ⏱️ 27.02.2023):
	```
...
- [PyPi](https://pypi.org/project/blinker) (📥 7.1M / month):
	...
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 8.4M · ⏱️ 13.04.2023):
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 51 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/pattern) (📥 1.2M / month):
	```
	pip install pattern
	```
...
- [PyPi](https://pypi.org/project/stanza) (📥 180K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 9.4K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 250 · 📦 520 · 📋 69 - 28% open · ⏱️ 10.07.2021):

	```
	git clone https://github.com/PetrochukM/PyTorch-NLP
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 9.4K / month):
	```
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.1K · 📋 100 - 38% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 11K / month):
	```
	pip install snownlp
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 950 · 📥 110K · 📦 260 · 📋 160 - 74% open · ⏱️ 08.06.2022):
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 290 · 📦 1.5K · 📋 71 - 35% open · ⏱️ 15.07.2017):
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 11 · 🔀 12K · 📋 56 - 21% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/funNLP) (📥 15 / month):
	```
	pip install funNLP
	```
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 1.4K · 📋 590 - 21% open · ⏱️ 06.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/napalm) (📥 40K / month):
	```
	pip install napalm
	```
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 510K · 📦 210 · 📋 690 - 36% open · ⏱️ 23.11.2022):

	```
	git clone https://github.com/mininet/mininet
	```
- [PyPi](https://pypi.org/project/mininet) (📥 3.8K / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 21K · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/peewee) (📥 1.1M / month):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 500K · ⏱️ 19.04.2023):
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 380 · 🔀 1.1K · 📦 20K · 📋 1.7K - 20% open · ⏱️ 18.04.2023):
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 410 · 📦 1.4K · 📋 560 - 36% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/dataset) (📥 52K / month):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 5.2K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 230 · 📥 51 · 📦 3.4K · 📋 610 - 46% open · ⏱️ 15.12.2022):
...
<details><summary><b><a href="https://github.com/web2py/pydal">pydal</a></b> (🥉19 ·  ⭐ 450) - A pure Python Database Abstraction Layer. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 29 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 1.3K / month):
	```
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 18 · 🔀 92 · 📋 79 - 18% open · ⏱️ 30.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/orm) (📥 4.5K / month):
	```
	pip install orm
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 450 · 🔀 1.9K · 📥 15M · 📋 4.9K - 11% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/poetry) (📥 12M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 840K · ⏱️ 05.04.2023):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 500 · 📋 920 - 13% open · ⏱️ 09.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 9.4M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 83K · ⏱️ 07.04.2023):
	```
	conda install -c conda-forge pip-tools
	```
</details>
<details><summary><b><a href="https://github.com/conda/conda">conda</a></b> (🥉22 ·  ⭐ 5.4K) - Cross-platform, Python-agnostic binary package manager. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/conda/conda) (🔀 1.3K · 📦 39K · 📋 9K - 7% open · ⏱️ 17.04.2023):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 93 · 🔀 120 · 📦 210 · 📋 730 - 9% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 5 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 58 / month):
	```
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 340 · 🔀 800 · 📋 2.9K - 14% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 17.04.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 130 · 🔀 5K · 📋 4.9K - 1% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 7.3K / month):
	```
	pip install sqlmap
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 28 · 🔀 130 · 📦 1.2K · 📋 110 - 22% open · ⏱️ 23.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 300 / month):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 92 · 🔀 460 · 📦 12K · 📋 440 - 0% open · ⏱️ 03.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/sh) (📥 4.4M / month):
	```
	pip install sh
	```
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 29 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 2.4K / month):
	```
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 410 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 840 / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 480 · 📦 100 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 320 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 77 · 🔀 140 · 📦 62K · 📋 290 - 23% open · ⏱️ 18.04.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 740K / month):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 440 · 🔀 4.6K · 📦 170K · 📋 3.3K - 0% open · ⏱️ 13.04.2023):
...
- [PyPi](https://pypi.org/project/fastapi) (📥 17M / month):
	...
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 1.4M · ⏱️ 14.04.2023):
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 870 · 📥 4.4K · 📦 8K · 📋 980 - 15% open · ⏱️ 18.01.2023):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.5K · 📦 13K · 📋 1.3K - 4% open · ⏱️ 09.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/sanic) (📥 760K / month):
	```
	pip install sanic
	```
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 33 · 🔀 180 · 📦 5.8K · 📋 64 - 18% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.3K · 📋 310 - 4% open · ⏱️ 11.04.2023):
...
- [PyPi](https://pypi.org/project/zerorpc-python):
	...
	```
- [Conda](https://anaconda.org/conda-forge/zerorpc-python) (📥 2K · ⏱️ 06.06.2022):
	```
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.8K · 📥 500K · 📦 58K · 📋 12K - 32% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 7.1M / month):
	```
	pip install sympy
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 410 · 🔀 2.5K · 📥 27 · 📦 90K · 📋 5.1K - 47% open · ⏱️ 17.04.2023):
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4.1K · 📦 930 · 📋 980 - 32% open · ⏱️ 14.10.2020):
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 450 · 🔀 1.7K · 📥 1.9K · 📦 1.4K · 📋 3K - 5% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 150 · 📋 110 - 3% open · ⏱️ 26.03.2023):

	```
	git clone https://github.com/benedekrozemberczki/karateclub
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 3.5K / month):
	```
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 8.9K · 📋 1.2K - 36% open · ⏱️ 17.04.2023):
...
- [PyPi](https://pypi.org/project/django-haystack) (📥 120K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-haystack) (📥 5.3K · ⏱️ 31.05.2018):
	```
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 310 · 📦 3K · 📋 140 - 16% open · ⏱️ 12.04.2022):
...
- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 760 · 📥 170 · 📦 8.8K · 📋 1.3K - 9% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 75K · 📋 1.2K - 11% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 49 · 📦 980 · 📋 81 - 14% open · ⏱️ 12.09.2022):

	```
	git clone https://github.com/TkTech/pysimdjson
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 260K / month):
	```
	pip install pysimdjson
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 60K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 580 · 📥 8.5K · 📋 2.4K - 10% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 37 · 🔀 220 · 📦 210K · 📋 250 - 6% open · ⏱️ 24.03.2023):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 43K · 📋 240 - 11% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 58K · 📋 860 - 1% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 60 · 🔀 450 · 📥 24K · 📦 28K · 📋 1.7K - 15% open · ⏱️ 12.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 85K / month):
	```
	pip install xlwings
	```
...
- [PyPi](https://pypi.org/project/pdfminer) (📥 190K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pdfminer) (📥 29K · ⏱️ 15.02.2021):
	```
...
- [GitHub](https://github.com/pyexcel/pyexcel) (👨‍💻 20 · 🔀 160 · 📥 170 · 📦 3.4K · 📋 210 - 6% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/pyexcel) (📥 190K / month):
	...
	pip install pyexcel
	```
- [Conda](https://anaconda.org/conda-forge/pyexcel) (📥 56K · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 790 · 📦 260K · 📋 820 - 3% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 180 · 🔀 1.1K · 📋 730 - 7% open · ⏱️ 19.04.2023):
...
<details><summary><b><a href="https://github.com/python-openxml/python-docx">python-docx</a></b> (🥉22 ·  ⭐ 3.6K · 💀) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 53 · 🔀 330 · 📦 1.8K · 📋 390 - 19% open · ⏱️ 12.03.2023):
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 770 · 📦 6.9K · 📋 1.6K - 3% open · ⏱️ 20.04.2023):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.2K · 📦 42K · 📋 1.8K - 7% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 230 · 🔀 350 · 📦 480 · 📋 2.1K - 2% open · ⏱️ 17.04.2023):
...
- [PyPi](https://pypi.org/project/nikola) (📥 1.4K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 7.9K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 300 · 📥 7K · 📦 410 · 📋 630 - 35% open · ⏱️ 16.04.2023):
...
- [GitHub](https://github.com/sunainapai/makesite) (👨‍💻 8 · 🔀 270 · 📋 14 - 35% open · ⏱️ 12.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/makesite) (📥 180 / month):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 290 · 🔀 1.3K · 📦 13K · 📋 1K - 13% open · ⏱️ 08.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/rq) (📥 650K / month):
	```
	pip install rq
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 360 · 📦 1.2K · ⏱️ 24.03.2023):

	```
	git clone https://github.com/coleifer/huey
	```
- [PyPi](https://pypi.org/project/huey) (📥 72K / month):
	```
	pip install huey
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 89 · 🔀 240 · 📥 36 · 📦 880 · 📋 320 - 9% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/dramatiq) (📥 130K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 43K · ⏱️ 25.03.2023):
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 520 · 🔀 1.7K · 📦 130K · 📋 630 - 2% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/faker) (📥 7.5M / month):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 750K · ⏱️ 06.04.2023):
	```
	conda install -c conda-forge faker
	```
</details>
<details><summary><b><a href="https://github.com/locustio/locust">locust</a></b> (🥇35 ·  ⭐ 21K) - Scalable user load testing tool written in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.6K · 📦 5.5K · 📋 1.4K - 1% open · ⏱️ 14.04.2023):
...
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇35 ·  ⭐ 8K) - A generic test automation framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 180 · 🔀 2.1K · 📥 540 · 📦 7.5K · 📋 4.1K - 6% open · ⏱️ 14.04.2023):

	```
	git clone https://github.com/robotframework/robotframework
	```
- [PyPi](https://pypi.org/project/robotframework) (📥 1.5M / month):
	```
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 310 · 🔀 520 · 📦 20K · 📋 1.4K - 3% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/hypothesis) (📥 5.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7.4M · ⏱️ 20.04.2023):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.3K · 📋 520 - 9% open · ⏱️ 07.04.2023):
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 1K · 📦 23K · 📋 620 - 64% open · ⏱️ 14.09.2021):
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 120 · 🔀 300 · 📥 400 · 📦 1.3K · 📋 310 - 0% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 120K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 100K · ⏱️ 16.04.2023):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 120 · 🔀 310 · 📦 7.2K · 📋 340 - 25% open · ⏱️ 01.11.2022):
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 55 · 🔀 120 · 📦 220 · 📋 720 - 16% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/schemathesis) (📥 64K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 4.7K · ⏱️ 26.03.2023):
	```
...
- [PyPi](https://pypi.org/project/HTTPretty) (📥 480K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/HTTPretty) (📥 310K · ⏱️ 16.08.2021):
	```
...
- [PyPi](https://pypi.org/project/freezegun) (📥 6.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 900K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 23K · 📋 270 - 20% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/nose2) (📥 650K / month):
	...
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 90K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 38 · 🔀 73 · 📦 990 · 📋 180 - 2% open · ⏱️ 20.09.2022):
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 80 / month):
	```
	pip install sixpack
	```
...
- [PyPi](https://pypi.org/project/httmock) (📥 330K / month):
	...
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 7.8K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 24 · 🔀 38 · 📦 79 · 📋 63 - 1% open · ⏱️ 21.02.2023):
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 610 · 📦 720K · 📋 500 - 43% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/sqlparse) (📥 32M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 1.6M · ⏱️ 18.04.2023):
	```
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 55 · 🔀 250 · 📥 7.8K · 📦 760K · 📋 290 - 8% open · ⏱️ 19.04.2023):
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 33 · 🔀 100 · 📦 16K · ⏱️ 25.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/shortuuid) (📥 3.5M / month):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 25 · 🔀 99 · 📦 29K · 📋 50 - 30% open · ⏱️ 14.04.2023):
...
- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 36 · 🔀 410 · 📋 180 - 1% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/ply) (📥 24M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 5M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 240 - 10% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 33 / month):
	```
...
<details><summary><b><a href="https://github.com/derek73/python-nameparser">python-nameparser</a></b> (🥉18 ·  ⭐ 590) - Parsing human names into their individual components. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 22 · 🔀 95 · 📦 1.1K · 📋 100 - 20% open · ⏱️ 14.11.2022):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 27 · 🔀 380 · 📋 160 - 3% open · ⏱️ 18.04.2023):
...
- [GitHub](https://github.com/davidaurelio/hashids-python) (👨‍💻 10 · 🔀 99 · 📋 24 - 25% open · ⏱️ 07.09.2020):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.7K · 📦 290K · 📋 2.9K - 4% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/boto3) (📥 530M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 15M · ⏱️ 19.04.2023):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 140K · 📋 970 - 8% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 44M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 2.1M · ⏱️ 18.04.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 870 · 📥 600 · 📦 22K · 📋 790 - 6% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 390 · 📦 6.3K · 📋 330 - 6% open · ⏱️ 16.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/twython) (📥 170K / month):
	```
	pip install twython
	```
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 920 · 📦 4.5K · 📋 240 - 8% open · ⏱️ 27.12.2020):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 66 · 🔀 150 · 📦 6.1K · 📋 280 - 2% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 63 · 📦 8.2K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 42K / month):
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 220 · 📥 780 · 📦 370 · 📋 250 - 1% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 42K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.2K · 📋 440 - 26% open · ⏱️ 11.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 82K / month):
	```
...
- [PyPi](https://pypi.org/project/flask-assets) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-assets) (📥 39K · ⏱️ 24.12.2019):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 240 · 🔀 760 · 📋 620 - 26% open · ⏱️ 19.04.2023):
...
- [PyPi](https://pypi.org/project/django-storages) (📥 2.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 47K · ⏱️ 23.12.2022):
	```
...
- [PyPi](https://pypi.org/project/requests-html) (📥 850K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 6.2K · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 26 · 🔀 490 · 📦 1.9K · 📋 110 - 15% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/sumy) (📥 27K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 4.6K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 40 · 🔀 500 · 📋 220 - 42% open · ⏱️ 10.03.2022):
...
- [PyPi](https://pypi.org/project/textract) (📥 130K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textract) (📥 20K · ⏱️ 10.03.2022):
	```
...
- [PyPi](https://pypi.org/project/micawber) (📥 38K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 9.1K · ⏱️ 14.07.2021):
	```
...
- [PyPi](https://pypi.org/project/html2text) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 31K · ⏱️ 09.02.2020):
	```
...
<details><summary><b><a href="https://github.com/buriy/python-readability">python-readability</a></b> (🥉17 ·  ⭐ 2.3K) - Fast Python port of arc90's readability tool. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 53 · 🔀 360 · 📥 43 · 📋 160 - 15% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 55K / month):
	```
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 3 · 🔀 530 · 📦 18 · 📋 65 - 20% open · ⏱️ 01.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/cola) (📥 99 / month):
	```
	pip install cola
	```
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 84 · 🔀 120 · 📦 470 · 📋 380 - 7% open · ⏱️ 05.11.2022):

	```
	git clone https://github.com/MasoniteFramework/masonite
	```
- [PyPi](https://pypi.org/project/masonite) (📥 4.8K / month):
	```
...
- [GitHub](https://github.com/python-websockets/websockets) (👨‍💻 67 · 🔀 470 · 📦 99K · 📋 990 - 2% open · ⏱️ 18.04.2023):
...
- [PyPi](https://pypi.org/project/websockets) (📥 21M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 1.9M · ⏱️ 18.04.2023):
	```
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 130 · 🔀 740 · 📦 25K · 📋 880 - 20% open · ⏱️ 31.03.2023):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 740 · 📋 1.2K - 6% open · ⏱️ 17.04.2023):
...
- [PyPi](https://pypi.org/project/channels) (📥 640K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 150K · ⏱️ 11.11.2022):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 310 · 📦 980K · 📋 1.1K - 0% open · ⏱️ 19.04.2023):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 71M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 7.5M · ⏱️ 14.02.2023):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 610 · 📋 160 - 15% open · ⏱️ 11.09.2022):
