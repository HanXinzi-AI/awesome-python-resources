...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 350 · 🔀 1.5K · 📦 19K · 📋 1.4K - 28% open · ⏱️ 02.02.2023):
...
- [PyPi](https://pypi.org/project/flask-admin) (📥 1.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-admin) (📥 140K · ⏱️ 30.01.2022):
	```
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 200 · 🔀 940 · 📦 11K · 📋 850 - 12% open · ⏱️ 14.11.2022):
...
- [GitHub](https://github.com/geex-arts/django-jet) (👨‍💻 29 · 🔀 660 · 📦 2.9K · 📋 340 - 63% open · ⏱️ 21.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/django-jet) (📥 16K / month):
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 790 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 190 / month):
	```
	pip install xadmin
	```
...
<details><summary><b><a href="https://github.com/ajenti/ajenti">ajenti</a></b> (🥉23 ·  ⭐ 7K) - The admin panel your servers deserve. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 24 · 🔀 790 · 📦 25 · 📋 1.1K - 0% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 81 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 41 · 📋 210 - 24% open · ⏱️ 11.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/wooey) (📥 370 / month):
	```
	pip install wooey
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 810 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 980 · 🔀 38K · 📦 2 · 📋 1.2K - 1% open · ⏱️ 13.02.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 81M · ⏱️ 02.02.2023):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 75 · 🔀 500 · 📦 2.9K · 📋 420 - 1% open · ⏱️ 06.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/transitions) (📥 410K / month):
	```
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 35 · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 3.2K / month):
	```
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 110 · 🔀 510 · 📋 88 - 22% open · ⏱️ 04.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-ds) (📥 12 / month):
	```
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 150 · 🔀 530 · 📦 150K · 📋 630 - 3% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 11M / month):
	```
	pip install uvicorn
	```
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 63 · 🔀 220 · 📋 300 - 10% open · ⏱️ 07.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/daphne) (📥 630K / month):
	```
	pip install daphne
	```
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 56 · 🔀 460 · 📥 360 · 📦 68K · 📋 300 - 17% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/MagicStack/uvloop
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 18M / month):
	```
	pip install uvloop
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 24K · 📋 690 - 38% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 6.8M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 990K · ⏱️ 26.10.2022):
	```
...
- [PyPi](https://pypi.org/project/pydub) (📥 3.5M / month):
	...
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 39K · ⏱️ 13.03.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 7.9K · 📦 300 · 📋 2.6K - 18% open · ⏱️ 12.02.2023):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 3K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 130 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 40 · 🔀 130 · 📥 58K · 📦 10K · 📋 490 - 18% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 850K / month):
	```
	pip install mutagen
	```
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 27 · 🔀 1.1K · 📦 330 · 📋 290 - 59% open · ⏱️ 18.09.2022):

	```
	git clone https://github.com/tyiannak/pyAudioAnalysis
	```
- [PyPi](https://pypi.org/project/pyAudioAnalysis) (📥 17K / month):
	```
...
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉22 ·  ⭐ 5.7K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 850 · 📋 1.1K - 3% open · ⏱️ 09.02.2023):
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 22 · 📦 2.1K · 📋 95 - 13% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/kapre) (📥 3.9K / month):
	```
	pip install kapre
	```
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 57 · 📦 16 · 📋 210 - 18% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/Parisson/TimeSide
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 38 / month):
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉19 ·  ⭐ 840) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 110 · 📦 12 · 📋 40 - 32% open · ⏱️ 09.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/matchering) (📥 470 / month):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 590 · 📦 330K · 📋 390 - 3% open · ⏱️ 07.02.2023):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 100M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 9.5M · ⏱️ 20.10.2022):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 620 · 🔀 2.6K · 📦 130K · 📋 1.9K - 14% open · ⏱️ 10.02.2023):
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 91 · 🔀 340 · 📦 25K · 📋 360 - 12% open · ⏱️ 10.02.2023):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 5.1M / month):
	```
	pip install authlib
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 10K · 📋 130 - 38% open · ⏱️ 12.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 47K / month):
	```
...
<details><summary><b><a href="https://github.com/jazzband/django-oauth-toolkit">django-oauth-toolkit</a></b> (🥉25 ·  ⭐ 2.8K) - OAuth 2 goodies for Django. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 680 · 📋 740 - 20% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/evonove/django-oauth-toolkit
	```
- [PyPi](https://pypi.org/project/django-oauth-toolkit) (📥 440K / month):
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 39 · 🔀 240 · 📋 500 - 16% open · ⏱️ 04.11.2022):
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 18K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 34K · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 690 · 📋 3.9K - 4% open · ⏱️ 11.02.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 320 · 📦 620K · 📋 610 - 17% open · ⏱️ 12.02.2023):
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 52 · 📦 12K · 📋 54 - 5% open · ⏱️ 01.02.2023):
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 90 · 📥 31 · 📋 150 - 11% open · ⏱️ 04.02.2023):
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 17 · 📥 67 · 📦 71 · 📋 9 - 77% open · ⏱️ 30.10.2015):

	```
	git clone https://github.com/carlosescri/DottedDict
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 13 / month):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 350 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 14.02.2023):
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 680 / month):
	```
	pip install Kotti
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 210 · 📋 440 - 5% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 4.8K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 31 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 64 · 🔀 200 · 📦 1K · 📋 310 - 9% open · ⏱️ 11.07.2022):
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 72 · 📦 4.4K · 📋 190 - 10% open · ⏱️ 26.08.2022):
...
<details><summary><b><a href="https://github.com/django-cache-machine/django-cache-machine">django-cache-machine</a></b> (🥉20 ·  ⭐ 850 · 💤) - Automatic caching and invalidation for Django models. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 250 · 📋 71 - 21% open · ⏱️ 06.07.2022):

	```
	git clone https://github.com/django-cache-machine/django-cache-machine
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 7.6K / month):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 360 · 🔀 1.9K · 📥 27K · 📦 340K · 📋 2.2K - 15% open · ⏱️ 14.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/black) (📥 18M / month):
	```
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 6.2M · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 360K · 📋 1.2K - 10% open · ⏱️ 11.02.2023):
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 87 · 🔀 150 · 📦 4K · 📋 350 - 13% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 710K / month):
	```
	pip install prospector
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 58K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 850 · 📦 69K · 📋 770 - 47% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 2.8M / month):
	```
	pip install yapf
	```
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 34 · 🔀 110 · 📦 3.5K · 📋 170 - 6% open · ⏱️ 19.01.2023):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 450K / month):
	```
	pip install vulture
	```
...
- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 93 · 📦 5.6K · 📋 140 - 32% open · ⏱️ 08.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/pylama) (📥 180K / month):
	```
	pip install pylama
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 230 · 🔀 380 · 📋 340 - 31% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 67K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 15 · 📋 49 - 12% open · ⏱️ 08.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 2.8K / month):
	```
...
<details><summary><b><a href="https://github.com/Instagram/MonkeyType">MonkeyType</a></b> (🥉18 ·  ⭐ 4.1K) - A system for Python that generates static type annotations.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 19% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 76K / month):
	```
	pip install MonkeyType
	```
- [Conda](https://anaconda.org/conda-forge/MonkeyType) (📥 47K · ⏱️ 19.02.2022):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 87 · 🔀 250 · 📋 580 - 18% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 240K / month):
	```
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 150K · ⏱️ 15.02.2023):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.2K · 🔀 1.4K · 📋 2K - 8% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 210 · 🔀 1.5K · 📦 67K · 📋 1K - 7% open · ⏱️ 28.01.2023):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 21M / month):
	```
	pip install rich
	```
...
- [PyPi](https://pypi.org/project/tqdm) (📥 49M / month):
	...
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 17M · ⏱️ 03.09.2022):
	```
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 810 · 📋 290 - 8% open · ⏱️ 17.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 64K / month):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.6K · 📋 180 - 8% open · ⏱️ 01.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 210K / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 650 · 📋 1K - 47% open · ⏱️ 14.02.2023):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 6.3K / month):
	```
...
<details><summary><b><a href="https://github.com/httpie/httpie">httpie</a></b> (🥇33 ·  ⭐ 26K) - A command line HTTP client, a user-friendly cURL replacement. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 2.5K · 📦 13K · 📋 800 - 15% open · ⏱️ 15.01.2023):
...
- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 280 · 🔀 1.7K · 📦 18K · 📋 760 - 25% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 580K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.2K · 📦 400 · 📋 660 - 31% open · ⏱️ 25.09.2022):
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 71 · 🔀 220 · 📦 230 · 📋 340 - 23% open · ⏱️ 11.02.2023):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 6.6K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 480 · 📦 820 · 📋 660 - 22% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/dbcli/pgcli
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 46K / month):
	```
	pip install pgcli
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈25 ·  ⭐ 870) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 51 · 🔀 110 · 📦 350 · 📋 320 - 14% open · ⏱️ 16.02.2023):
...
- [PyPi](https://pypi.org/project/copier) (📥 26K / month):
	...
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 1.6K · ⏱️ 07.01.2023):
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 280 · 📋 620 - 29% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mycli) (📥 39K / month):
	```
	pip install mycli
	```
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 83 · 🔀 830 · 📦 450 · 📋 250 - 3% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 91 · 📥 11K · 📦 14 · 📋 200 - 24% open · ⏱️ 29.12.2022):

	```
	git clone https://github.com/laixintao/iredis
	```
- [PyPi](https://pypi.org/project/iredis) (📥 990 / month):
	```
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 540 · ⏱️ 10.08.2022):
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 62 · 📦 200 · 📋 88 - 32% open · ⏱️ 11.07.2022):
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 270 · 📦 38 · 📋 94 - 34% open · ⏱️ 15.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/saws) (📥 380 / month):
	```
	pip install saws
	```
...
<details><summary><b><a href="https://github.com/mooz/percol">percol</a></b> (🥉18 ·  ⭐ 3.2K · 💀) - Adds flavor of interactive selection to the traditional pipe.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 650 · 📦 14 · 📋 70 - 82% open · ⏱️ 19.09.2018):
	...
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 580 / month):
	```
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 92 · 📦 18 · 📋 48 - 25% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/doitlive) (📥 82 / month):
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 45 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 52K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.4K · 📥 3.6M · 📦 2.2K · 📋 720 - 23% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/JaidedAI/EasyOCR
	```
- [PyPi](https://pypi.org/project/EasyOCR) (📥 130K / month):
	```
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 2.4K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 27 · 🔀 240 · 📦 800 · 📋 250 - 30% open · ⏱️ 26.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 44K / month):
	```
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 12K · 📥 760 · 📋 1.3K - 54% open · ⏱️ 10.06.2022):
...
<details><summary><b><a href="https://github.com/madmaze/pytesseract">pytesseract</a></b> (🥉24 ·  ⭐ 4.6K) - A wrapper for [Google Tesseract.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 41 · 🔀 630 · 📋 320 - 7% open · ⏱️ 09.02.2023):
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉19 ·  ⭐ 7.7K) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 760 · 📥 520 · 📋 710 - 27% open · ⏱️ 12.02.2023):
...
<details><summary><b><a href="https://github.com/soravux/scoop">scoop</a></b> (🥇19 ·  ⭐ 580) - Scalable Concurrent Operations in Python. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 86 · 📦 300 · 📋 73 - 43% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/scoop) (📥 2.6K / month):
	```
	pip install scoop
	```
...
<details><summary><b><a href="https://github.com/HBNetwork/python-decouple">python-decouple</a></b> (🥇32 ·  ⭐ 2.3K) - Strict separation of settings from code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 33 · 🔀 170 · 📥 10 · 📦 90K · 📋 84 - 5% open · ⏱️ 09.01.2023):
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 18 · 📦 24K · 📋 150 - 35% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/DiffSK/configobj
	```
- [PyPi](https://pypi.org/project/configobj) (📥 3.1M / month):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 510 · 📦 14 · 📋 1.2K - 14% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 72K · 📋 1.5K - 51% open · ⏱️ 27.01.2023):
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 64 · 🔀 200 · 📋 290 - 14% open · ⏱️ 19.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pynacl) (📥 39M / month):
	```
	pip install pynacl
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 560 · 📥 180K · 📦 880 · 📋 850 - 4% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 24 · 🔀 220 · 📋 220 - 4% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/Optimus) (📥 17K / month):
	```
	pip install Optimus
	```
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 18 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 14 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 530 · 📦 330K · 📋 700 - 5% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 65M / month):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 63 · 🔀 220 · 📦 13K · 📋 340 - 12% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 4.2M / month):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 5.8K · 📋 150 - 52% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 90 · 🔀 200 · 📦 12K · 📋 240 - 16% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/alecthomas/voluptuous
	```
- [PyPi](https://pypi.org/project/voluptuous) (📥 2.4M / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 180 · 🔀 1.6K · 📥 240 · 📦 230K · 📋 2.2K - 4% open · ⏱️ 15.02.2023):
...
- [PyPi](https://pypi.org/project/seaborn) (📥 9.5M / month):
	...
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 5.9M · ⏱️ 31.12.2022):
	```
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📥 3 · 📦 45K · 📋 1.7K - 11% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 9.4M / month):
	```
	pip install altair
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 870 · 📋 420 - 57% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 94K / month):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 630 · 🔀 3.9K · 📦 190 · 📋 7.1K - 9% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 3.1K · 📋 1.1K - 26% open · ⏱️ 02.02.2023):
...
- [PyPi](https://pypi.org/project/vispy) (📥 43K / month):
	...
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 340K · ⏱️ 14.11.2022):
	```
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 79 · 🔀 470 · 📦 9.9K · 📋 290 - 2% open · ⏱️ 14.01.2023):
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 79 · 📦 980 · 📋 160 - 38% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/zopefoundation/ZODB
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 66K / month):
	```
	pip install ZODB
	```
...
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉20 ·  ⭐ 750 · 💀) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 16K · 📋 1.4K - 16% open · ⏱️ 27.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 7.4M / month):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 41 · 🔀 180 · 📦 51K · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 150K · 📋 620 - 4% open · ⏱️ 06.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 36M / month):
	```
	pip install PyMySQL
	```
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 380 · 🔀 2.2K · 📋 1.3K - 9% open · ⏱️ 15.02.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 890K · ⏱️ 09.02.2023):
	```
	conda install -c conda-forge redis-py
	```
</details>
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥈25 ·  ⭐ 980) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 980 · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 160 · 📦 730 · 📋 210 - 11% open · ⏱️ 12.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/happybase) (📥 180K / month):
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 150 / month):
	```
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 87 · 🔀 310 · 📥 69 · 📦 18K · 📋 460 - 42% open · ⏱️ 23.12.2022):
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 420 · 📥 35K · 📦 940K · 📋 650 - 40% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 48 · 🔀 190 · 📦 1K · 📋 90 - 17% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/timofurrer/maya
	```
- [PyPi](https://pypi.org/project/maya) (📥 42K / month):
	```
	pip install maya
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 130 · 📦 890 · 📋 64 - 42% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 770 · 📋 40 - 7% open · ⏱️ 27.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/moment) (📥 83K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 22 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 620 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 20 · 📦 32 · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 3.8K / month):
	```
	pip install PyTime
	```
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇31 ·  ⭐ 9.7K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 320 · 📥 11K · 📦 2.4K · 📋 270 - 34% open · ⏱️ 09.12.2022):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 1.7M / month):
	```
	pip install py-spy
	```
...
- [GitHub](https://github.com/pallets-eco/flask-debugtoolbar) (👨‍💻 46 · 🔀 130 · 📦 21K · 📋 110 - 36% open · ⏱️ 17.01.2023):
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 140 · 📋 98 - 29% open · ⏱️ 04.12.2022):
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 160 · 📦 110 · 📋 83 - 31% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/vprof) (📥 4.1K / month):
	```
	pip install vprof
	```
...
- [GitHub](https://github.com/rkern/line_profiler) (👨‍💻 14 · 🔀 250 · 📋 140 - 36% open · ⏱️ 23.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 340K / month):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 800 / month):
	```
	pip install pyflame
	```
...
<details><summary><b><a href="https://github.com/ionelmc/python-hunter">python-hunter</a></b> (🥉18 ·  ⭐ 710) - A flexible code tracing toolkit. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 670K / month):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 29 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 250K · 📋 37K - 5% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.8K · 🔀 17K · 📥 11K · 📋 31K - 32% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 67K / month):
	```
	pip install pytorch
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 730 · 📥 240 · ⏱️ 22.05.2020):

	```
	git clone https://github.com/SerpentAI/SerpentAI
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 43 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 270K · 📋 1.6K - 13% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/psutil) (📥 63M / month):
	```
	pip install psutil
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 26K · 📋 31K - 2% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 16K · 📋 25K - 9% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 72K / month):
	```
	pip install salt
	```
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.7K · 📋 1.1K - 10% open · ⏱️ 27.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/supervisor) (📥 1.7M / month):
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 88 · 🔀 300 · 📦 73 · 📋 650 - 17% open · ⏱️ 12.02.2023):
...
- [PyPi](https://pypi.org/project/pyinfra) (📥 17K / month):
	...
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 410 · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 19 · 🔀 1.7K · 📋 1.7K - 23% open · ⏱️ 20.01.2023):
...
- [GitHub](https://github.com/sebastien/cuisine) (👨‍💻 57 · 🔀 160 · 📦 170 · 📋 110 - 24% open · ⏱️ 09.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/cuisine) (📥 720 / month):
	```
	pip install cuisine
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 600 · 🔀 2.3K · 📦 2.1K · 📋 960 - 8% open · ⏱️ 09.02.2023):
...
- [PyPi](https://pypi.org/project/luigi) (📥 580K / month):
	...
	pip install luigi
	```
- [Conda](https://anaconda.org/conda-forge/luigi) (📥 600K · ⏱️ 20.01.2023):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 46K · 📋 4.6K - 16% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 7.4M / month):
	```
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 7.9M · ⏱️ 10.02.2023):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.1K · 📦 8.3K · 📋 13K - 19% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 43 · 🔀 210 · 📦 57 · 📋 330 - 19% open · ⏱️ 18.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/streamparse) (📥 2.3K / month):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 740K · 📦 40K · 📋 4.8K - 5% open · ⏱️ 14.02.2023):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 990K / month):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 27 · 🔀 210 · 📦 750 · 📋 890 - 5% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 120K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 80 · 📥 370 · 📋 110 - 32% open · ⏱️ 04.11.2022):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 14K / month):
	```
	pip install shiv
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.7K · 📦 280K · 📋 6.3K - 17% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 42 · 🔀 160 · 📦 1.6K · 📋 310 - 4% open · ⏱️ 04.02.2023):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 86K / month):
	```
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 10K · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/s3tools/s3cmd) (👨‍💻 210 · 🔀 820 · 📥 3.1M · 📋 840 - 26% open · ⏱️ 19.11.2022):
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.7M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 8K · ⏱️ 22.12.2018):
	```
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 49 · 🔀 1.3K · 📦 260 · 📋 760 - 0% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 36K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 280 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 290 / month):
	```
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 27 · 📦 280 · 📋 23 - 30% open · ⏱️ 04.09.2016):
	...
	```
- [PyPi](https://pypi.org/project/money) (📥 57K / month):
	```
	pip install money
	```
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.7M · 📦 25K · 📋 17K - 6% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 69K / month):
	```
	pip install spyder
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 92 · 🔀 240 · 📦 210 · 📋 1.6K - 23% open · ⏱️ 22.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 730 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 32 · 🔀 270 · 📦 2.9K · 📋 220 - 43% open · ⏱️ 28.09.2022):

	```
	git clone https://github.com/kootenpv/yagmail
	```
- [PyPi](https://pypi.org/project/yagmail) (📥 140K / month):
	```
	pip install yagmail
	```
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 55 · 🔀 180 · 📦 470 · 📋 88 - 59% open · ⏱️ 29.03.2021):

	```
	git clone https://github.com/mailgun/flanker
	```
- [PyPi](https://pypi.org/project/flanker) (📥 33K / month):
	```
	pip install flanker
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 320 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 10.02.2023):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 2.7K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 180 · 📋 130 - 48% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 23K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 59 · 📥 80 · 📦 18 · 📋 90 - 18% open · ⏱️ 06.06.2022):
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 410 · 🔀 2.7K · 📋 1.6K - 1% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 9.3K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 81K · 📋 590 - 26% open · ⏱️ 29.01.2023):
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 58 · 🔀 240 · 📦 38K · 📋 180 - 15% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/ahupp/python-magic
	```
- [PyPi](https://pypi.org/project/python-magic) (📥 6.9M / month):
	```
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 48 · 🔀 130 · 📋 130 - 1% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/jaraco/path.py
	```
- [PyPi](https://pypi.org/project/path.py) (📥 290K / month):
	```
	pip install path.py
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 39 · 📦 8.5K · 📋 17 - 35% open · ⏱️ 14.02.2015):
	...
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 62K / month):
	```
	pip install Unipath
	```
...
- [GitHub](https://github.com/PyFilesystem/pyfilesystem2) (👨‍💻 47 · 🔀 160 · 📋 340 - 22% open · ⏱️ 18.10.2022):
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 680 · 📦 110K · 📋 660 - 8% open · ⏱️ 13.02.2023):
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 220 · 📦 95K · 📋 160 - 13% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 760 · 📋 180 - 25% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 18K / month):
	```
	pip install deform
	```
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 96 · 🔀 220 · 📥 2.6K · 📦 170K · 📋 230 - 6% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/erikrose/more-itertools
	```
- [PyPi](https://pypi.org/project/more-itertools) (📥 35M / month):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 83K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 6.9K · 📋 74 - 8% open · ⏱️ 04.02.2023):
...
- [PyPi](https://pypi.org/project/funcy) (📥 1.8M / month):
	...
	pip install funcy
	```
- [Conda](https://anaconda.org/conda-forge/funcy) (📥 290K · ⏱️ 27.01.2023):
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 95 · 📦 320 · 📋 390 - 14% open · ⏱️ 13.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/returns) (📥 68K / month):
	```
	pip install returns
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 31 · 🔀 100 · 📋 610 - 9% open · ⏱️ 30.12.2022):

	```
	git clone https://github.com/evhub/coconut
	```
- [PyPi](https://pypi.org/project/coconut) (📥 1.4K / month):
	```
	pip install coconut
	```
...
<details><summary><b><a href="https://github.com/pytoolz/cytoolz">CyToolz</a></b> (🥉14 ·  ⭐ 900 · 📉) - Cython implementation of `Toolz`: High performance functional.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 66 · 📋 75 - 30% open · ⏱️ 19.12.2022):
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 20K · 📋 430 - 16% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/pyglet/pyglet
	```
- [PyPi](https://pypi.org/project/pyglet) (📥 300K / month):
	```
	pip install pyglet
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.6K · 📦 7.3K · 📋 3.2K - 21% open · ⏱️ 14.02.2023):
...
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 92K · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 45 · 🔀 530 · 📦 4.8K · 📋 490 - 32% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/ChrisKnott/Eel
	```
- [PyPi](https://pypi.org/project/Eel) (📥 89K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 430 · 📦 960 · 📋 710 - 3% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 230 · 🔀 570 · 📥 1.1K · 📋 620 - 18% open · ⏱️ 12.02.2023):
...
<details><summary><b><a href="https://github.com/nucleic/enaml">enaml</a></b> (🥉20 ·  ⭐ 1.5K) - Creating beautiful user-interfaces with Declarative Syntax like QML. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 220 · 📦 210 · 📋 220 - 16% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/nucleic/enaml
	```
- [PyPi](https://pypi.org/project/enaml) (📥 930 / month):
	```
	pip install enaml
	```
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 130 · 🔀 590 · 📋 260 - 8% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/geopy) (📥 3.7M / month):
	```
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 950K · ⏱️ 13.11.2022):
	```
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 53 · 🔀 250 · 📋 270 - 4% open · ⏱️ 31.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 490K / month):
	```
	pip install django-countries
	```
- [Conda](https://anaconda.org/conda-forge/django-countries) (📥 2.7K · ⏱️ 28.02.2022):
	```
...
- [GitHub](https://github.com/maxmind/geoip-api-python) (👨‍💻 12 · 🔀 53 · 📦 1.3K · ⏱️ 11.02.2021):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 360 · 📦 1.1M · ⏱️ 07.02.2023):
...
<details><summary><b><a href="https://github.com/martinblech/xmltodict">xmltodict</a></b> (🥈30 ·  ⭐ 5K · 💤) - Working with XML feel like you are working with JSON. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 50K · 📋 230 - 31% open · ⏱️ 08.05.2022):
...
- [GitHub](https://github.com/stchris/untangle) (👨‍💻 17 · 🔀 81 · 📥 530 · 📦 980 · 📋 56 - 26% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/requests) (📥 280M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 28M · ⏱️ 16.01.2023):
	```
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 190 · 🔀 640 · 📦 73K · 📋 740 - 3% open · ⏱️ 15.02.2023):
...
- [PyPi](https://pypi.org/project/httpx) (📥 12M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 470K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 970 · 📥 5.4K · 📦 1.2M · 📋 1.1K - 9% open · ⏱️ 14.02.2023):
...
- [PyPi](https://pypi.org/project/httplib2) (📥 31M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/httplib2) (📥 2.1M · ⏱️ 01.11.2022):
	```
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 290 · 📦 3.5K · 📋 110 - 2% open · ⏱️ 26.01.2022):
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 50 · 🔀 130 · 📥 150 · 📦 1.4K · 📋 150 - 36% open · ⏱️ 10.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/treq) (📥 80K / month):
	```
	pip install treq
	```
...
<details><summary><b><a href="https://github.com/secdev/scapy">scapy</a></b> (🥇34 ·  ⭐ 8.4K) - A brilliant packet manipulation library. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/secdev/scapy) (👨‍💻 410 · 🔀 1.7K · 📦 10K · 📋 1.4K - 4% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/secdev/scapy
	```
- [PyPi](https://pypi.org/project/scapy) (📥 2.6M / month):
	```
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 70K · ⏱️ 25.12.2022):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 380 · 📦 9.4K · 📋 530 - 64% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 350K / month):
	```
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 500 · 📋 100 - 70% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 5.6K / month):
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 430 · 🔀 1.8K · 📦 1M · 📋 2.7K - 3% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/python-pillow/Pillow
	```
- [PyPi](https://pypi.org/project/Pillow) (📥 52M / month):
	```
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 23M · ⏱️ 04.02.2023):
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 9.3K · 📦 15K · 📋 390 - 4% open · ⏱️ 14.01.2023):

	```
	git clone https://github.com/dahlia/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 600K / month):
	```
	pip install wand
	```
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 330 · 📋 930 - 1% open · ⏱️ 27.01.2023):

	```
	git clone https://github.com/thumbor/thumbor
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 6.3K / month):
	```
	pip install thumbor
	```
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 270 · 📥 930 · 📦 220 · 📋 520 - 25% open · ⏱️ 09.09.2021):
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 46 · 📦 480 · 📋 330 - 38% open · ⏱️ 11.02.2023):
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 11 · 🔀 42 · 📦 63 · 📋 8 - 50% open · ⏱️ 30.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pagan) (📥 240 / month):
	```
	pip install pagan
	```
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 120 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 22 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 820 / month):
	```
	pip install hmap
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 550 · 🔀 4.6K · 📥 56K · 📋 4.6K - 26% open · ⏱️ 16.02.2023):
...
<details><summary><b><a href="https://github.com/IronLanguages/ironpython3">IronPython</a></b> (🥇23 ·  ⭐ 2K) - Implementation of the Python programming language written in C#. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 48K · 📋 560 - 45% open · ⏱️ 17.01.2023):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 25K · 📋 62K - 10% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 90K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 25 · 🔀 150 · 📦 13 · 📋 89 - 26% open · ⏱️ 13.11.2022):

	```
	git clone https://github.com/Maratyszcza/PeachPy
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 31 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 71 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 650 / month):
	```
	pip install Pyjion
	```
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 59 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 21 / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 52 · 🔀 260 · 📦 2.4K · 📋 360 - 57% open · ⏱️ 06.12.2022):

	```
	git clone https://github.com/jonathanslenders/ptpython
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 440K / month):
	```
...
- [PyPi](https://pypi.org/project/bpython) (📥 110K / month):
	...
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 58K · ⏱️ 18.01.2023):
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 51 · 🔀 820 · 📦 23K · 📋 400 - 34% open · ⏱️ 23.04.2022):
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 130 · 🔀 1.1K · 📦 2.2K · 📋 3.3K - 20% open · ⏱️ 15.02.2023):
...
- [PyPi](https://pypi.org/project/prefect) (📥 690K / month):
	...
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 390K · ⏱️ 10.02.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 51 · 🔀 270 · 📦 59 · 📋 110 - 6% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 4.5K / month):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 580 · 📦 46K · 📋 700 - 9% open · ⏱️ 01.02.2023):
...
- [PyPi](https://pypi.org/project/loguru) (📥 4.7M / month):
	...
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 950K · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 330 · 📥 3.7K · 📦 39K · 📋 810 - 19% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 590 · 🔀 8K · 📥 6K · 📦 48K · 📋 4.7K - 6% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 9.1M / month):
	```
	pip install xgboost
	```
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.7K · 📦 38K · 📋 1.7K - 1% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 990K / month):
	```
	pip install gym
	```
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.6K · 📦 120 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 470 / month):
	```
	pip install nupic
	```
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉22 ·  ⭐ 13K) - MindsDB is an open source AI layer for existing databases that.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 280 · 🔀 1.5K · 📋 1.9K - 16% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 8.7K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 5.5K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/josephreisinger/vowpal_porpoise) (👨‍💻 14 · 🔀 28 · 📋 9 - 66% open · ⏱️ 07.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/vowpal_porpoise) (📥 8 / month):
	```
...
<details><summary><b><a href="https://github.com/pythonnet/pythonnet">PythonNet</a></b> (🥇30 ·  ⭐ 3.5K) - Python Integration with the .NET Common Language Runtime (CLR). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 98 · 🔀 540 · 📥 950 · 📦 1.3K · 📋 1.3K - 7% open · ⏱️ 03.02.2023):
...
- [PyPi](https://pypi.org/project/pythonnet) (📥 160K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 62K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 85 · 🔀 710 · 📥 600K · 📦 110K · 📋 1.7K - 25% open · ⏱️ 14.02.2023):

	```
	git clone https://github.com/mhammond/pywin32
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 3.8M / month):
	```
	pip install pywin32
	```
- [Conda](https://anaconda.org/conda-forge/pywin32) (📥 3.3M · ⏱️ 28.10.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 770K · ⏱️ 07.02.2023):

	```
	git clone https://github.com/pallets/itsdangerous
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 56M / month):
	```
	pip install itsdangerous
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 4.7M · ⏱️ 24.03.2022):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 82 · 🔀 330 · 📥 23 · 📦 3.9K · 📋 140 - 32% open · ⏱️ 20.01.2023):

	```
	git clone https://github.com/mahmoud/boltons
	```
- [PyPi](https://pypi.org/project/boltons) (📥 3.3M / month):
	```
	pip install boltons
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 16 · 🔀 160 · 📦 140K · 📋 36 - 2% open · ⏱️ 24.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/blinker) (📥 7.2M / month):
	```
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 7.7M · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 440 · 🔀 4.1K · 📥 4.3K · 📦 42K · 📋 1.8K - 20% open · ⏱️ 21.12.2022):
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 40 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/pattern) (📥 1.8M / month):
	```
	pip install pattern
	```
...
- [PyPi](https://pypi.org/project/stanza) (📥 160K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 8.1K · ⏱️ 15.09.2022):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 250 · 📦 500 · 📋 69 - 27% open · ⏱️ 10.07.2021):

	```
	git clone https://github.com/PetrochukM/PyTorch-NLP
	```
- [PyPi](https://pypi.org/project/PyTorch-NLP) (📥 5.9K / month):
	```
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.1K · 📋 100 - 38% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 5.8K / month):
	```
	pip install snownlp
	```
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 290 · 📦 1.4K · 📋 71 - 35% open · ⏱️ 15.07.2017):
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 11 · 🔀 11K · 📋 54 - 20% open · ⏱️ 17.11.2022):
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 230 · 🔀 800 · 📥 310 · 📋 140 - 45% open · ⏱️ 17.10.2022):
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 1.4K · 📋 580 - 21% open · ⏱️ 09.01.2023):
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 490K · 📦 190 · 📋 680 - 36% open · ⏱️ 23.11.2022):

	```
	git clone https://github.com/mininet/mininet
	```
- [PyPi](https://pypi.org/project/mininet) (📥 2.8K / month):
	```
	pip install mininet
	```
...
- [PyPi](https://pypi.org/project/pox) (📥 4M / month):
	...
	pip install pox
	```
- [Conda](https://anaconda.org/conda-forge/pox) (📥 270K · ⏱️ 24.10.2022):
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 5 · 📦 1K · 📋 300 - 4% open · ⏱️ 11.02.2023):
...
- [GitHub](https://github.com/tschellenbach/Stream-Framework) (👨‍💻 26 · 🔀 540 · 📋 180 - 35% open · ⏱️ 15.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/Stream-Framework) (📥 2K / month):
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 21K · 📋 2.2K - 0% open · ⏱️ 14.02.2023):
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 380 · 🔀 1.1K · 📦 19K · 📋 1.6K - 20% open · ⏱️ 28.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 920K / month):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 400 · 📦 1.3K · 📋 550 - 36% open · ⏱️ 29.01.2023):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 250K · ⏱️ 31.01.2023):
	```
...
- [PyPi](https://pypi.org/project/dataset) (📥 50K / month):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 4.6K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 46 · 📦 3.2K · 📋 600 - 46% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 630 / month):
	```
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 81 · 📋 51 - 70% open · ⏱️ 06.06.2016):
	...
	```
- [PyPi](https://pypi.org/project/redisco) (📥 350 / month):
	```
	pip install redisco
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 440 · 🔀 1.9K · 📥 15M · 📋 4.7K - 11% open · ⏱️ 15.02.2023):
...
- [PyPi](https://pypi.org/project/poetry) (📥 12M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 770K · ⏱️ 11.01.2023):
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 490 · 📋 900 - 12% open · ⏱️ 02.02.2023):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 9.7M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 72K · ⏱️ 31.01.2023):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.2K · 📋 8.8K - 10% open · ⏱️ 16.02.2023):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇20 ·  ⭐ 650) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/devpi/devpi) (👨‍💻 92 · 🔀 110 · 📦 210 · 📋 720 - 10% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 330 · 🔀 790 · 📋 2.9K - 14% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 5 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 26 / month):
	```
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 14.02.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 4.9K · 📋 4.9K - 1% open · ⏱️ 12.02.2023):
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉19 ·  ⭐ 8.3K) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.7K · 📋 130 - 25% open · ⏱️ 06.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 1K / month):
	```
...
- [GitHub](https://github.com/trustedsec/social-engineer-toolkit) (👨‍💻 85 · 🔀 2.3K · 📋 830 - 26% open · ⏱️ 26.01.2022):
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 530 · 📦 5.7K · 📋 440 - 27% open · ⏱️ 25.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-guardian) (📥 390K / month):
	```
	pip install django-guardian
	```
- [Conda](https://anaconda.org/conda-forge/django-guardian) (📥 43K · ⏱️ 26.05.2021):
	```
...
- [GitHub](https://github.com/amitt001/delegator.py) (👨‍💻 23 · 🔀 87 · 📋 45 - 17% open · ⏱️ 06.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/delegator.py) (📥 44K / month):
	```
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 82 · 🔀 1K · 📦 2.6K · 📋 370 - 12% open · ⏱️ 27.10.2022):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 640 · 📦 980 · 📋 470 - 25% open · ⏱️ 19.07.2022):
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 400 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 2.3K / month):
	```
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 29 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 1.6K / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 460 · 📦 100 · 📋 110 - 43% open · ⏱️ 24.03.2021):

	```
	git clone https://github.com/ibayer/fastFM
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 430 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 78 · 🔀 140 · 📦 58K · 📋 290 - 26% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 640K / month):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 420 · 🔀 4.4K · 📦 150K · 📋 3.3K - 27% open · ⏱️ 14.02.2023):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 12M / month):
	```
	pip install fastapi
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 880 · 📥 4.2K · 📦 7.7K · 📋 970 - 15% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 710K / month):
	```
	pip install falcon
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 980 · 📦 88K · 📋 550 - 17% open · ⏱️ 04.03.2022):

	```
	git clone https://github.com/flask-restful/flask-restful
	```
- [PyPi](https://pypi.org/project/flask-restful) (📥 1.6M / month):
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.5K · 📦 12K · 📋 1.3K - 4% open · ⏱️ 14.02.2023):
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 2.1K · 📋 460 - 35% open · ⏱️ 10.08.2020):

	```
	git clone https://github.com/hugapi/hug
	```
- [PyPi](https://pypi.org/project/hug) (📥 73K / month):
	```
	pip install hug
	```
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 33 · 🔀 180 · 📦 5.6K · 📋 64 - 18% open · ⏱️ 01.12.2022):
...
- [GitHub](https://github.com/Cornices/cornice) (👨‍💻 120 · 🔀 140 · 📦 800 · 📋 240 - 19% open · ⏱️ 18.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/cornice) (📥 36K / month):
	```
	pip install cornice
	```
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 210 · 📦 24 · 📋 84 - 38% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 260 / month):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.2K · 📋 310 - 4% open · ⏱️ 14.02.2023):
...
- [PyPi](https://pypi.org/project/zerorpc-python):
	...
	```
- [Conda](https://anaconda.org/conda-forge/zerorpc-python) (📥 1.7K · ⏱️ 06.06.2022):
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 400 · 🔀 2.5K · 📥 26 · 📦 85K · 📋 5K - 47% open · ⏱️ 15.02.2023):
...
- [PyPi](https://pypi.org/project/statsmodels) (📥 9.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 8.7M · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.8K · 📥 490K · 📦 54K · 📋 12K - 32% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 440 · 🔀 1.7K · 📥 1.9K · 📦 1.2K · 📋 3K - 5% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/pymc-devs/pymc3
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 320K / month):
	```
	pip install pymc3
	```
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 130 · 📋 100 - 2% open · ⏱️ 08.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 2.6K / month):
	```
...
<details><summary><b><a href="https://github.com/bcbio/bcbio-nextgen">bcbio-nextgen</a></b> (🥉20 ·  ⭐ 920) - Providing best-practice pipelines for fully automated high.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 96 · 🔀 340 · 📋 3K - 3% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 110 / month):
	```
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 300 · 📦 2.9K · 📋 140 - 15% open · ⏱️ 12.04.2022):
	...
	```
- [PyPi](https://pypi.org/project/pysolr) (📥 240K / month):
	```
	pip install pysolr
	```
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 69K · 📋 1.2K - 11% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 47 · 📦 860 · 📋 80 - 15% open · ⏱️ 12.09.2022):
...
- [PyPi](https://pypi.org/project/pysimdjson) (📥 240K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 53K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 19 · 🔀 42 · 📦 3.7K · 📋 100 - 11% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 950K / month):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 570 · 📥 8K · 📋 2.4K - 10% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 31K · 📋 240 - 12% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 56K · 📋 840 - 1% open · ⏱️ 13.02.2023):
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 560 · 📦 1.3K · 📋 870 - 7% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/wireservice/csvkit
	```
- [PyPi](https://pypi.org/project/csvkit) (📥 170K / month):
	```
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 81K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 440 · 📥 24K · 📦 27K · 📋 1.7K - 15% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 170 · 🔀 1K · 📋 670 - 9% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/mstamy2/PyPDF2
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 5.3M / month):
	```
	pip install PyPDF2
	```
...
<details><summary><b><a href="https://github.com/python-openxml/python-docx">python-docx</a></b> (🥉23 ·  ⭐ 3.4K · 💀) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 840 · 📋 1K - 49% open · ⏱️ 15.05.2021):

	```
	git clone https://github.com/python-openxml/python-docx
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 3.4M / month):
	```
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 56 · 📦 10 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 28 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 730 · 📦 6.7K · 📋 1.6K - 3% open · ⏱️ 30.01.2023):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 230 · 🔀 350 · 📦 470 · 📋 2.1K - 2% open · ⏱️ 03.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/nikola) (📥 730 / month):
	```
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 7.3K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 290 · 📥 7K · 📋 620 - 35% open · ⏱️ 18.12.2022):

	```
	git clone https://github.com/lektor/lektor
	```
- [PyPi](https://pypi.org/project/lektor) (📥 3.3K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/sunainapai/makesite) (👨‍💻 8 · 🔀 270 · 📋 13 - 38% open · ⏱️ 12.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/makesite) (📥 12 / month):
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 150 · 🔀 560 · 📋 400 - 18% open · ⏱️ 21.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-taggit) (📥 430K / month):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 13K · 📋 1K - 12% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 830K / month):
	```
	pip install rq
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 350 · 📦 1.1K · ⏱️ 10.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/huey) (📥 76K / month):
	```
	pip install huey
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 86 · 🔀 240 · 📥 36 · 📦 840 · 📋 310 - 10% open · ⏱️ 05.02.2023):
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 40 · 🔀 110 · 📦 29 · 📋 170 - 30% open · ⏱️ 13.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrq) (📥 140 / month):
	```
	pip install mrq
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 510 · 🔀 1.7K · 📦 110K · 📋 610 - 1% open · ⏱️ 13.02.2023):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 520 · 📦 19K · 📋 1.4K - 3% open · ⏱️ 12.02.2023):
...
- [PyPi](https://pypi.org/project/hypothesis) (📥 4.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7.1M · ⏱️ 12.02.2023):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 300 · 📥 86 · 📦 22K · 📋 260 - 0% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 9.3M / month):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.2K · 📋 510 - 8% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/cobrateam/splinter
	```
- [PyPi](https://pypi.org/project/splinter) (📥 98K / month):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 990 · 📦 21K · 📋 610 - 63% open · ⏱️ 14.09.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 570K / month):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 380 · 📦 1.3K · 📋 310 - 0% open · ⏱️ 27.01.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 100K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 80K · ⏱️ 18.12.2022):
	```
...
- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 120 · 🔀 310 · 📦 7K · 📋 340 - 24% open · ⏱️ 01.11.2022):
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.6K · 📋 1.4K - 0% open · ⏱️ 16.02.2023):
...
- [PyPi](https://pypi.org/project/locust) (📥 1.3M / month):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 99K · ⏱️ 06.01.2023):
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 51 · 🔀 120 · 📦 200 · 📋 700 - 16% open · ⏱️ 12.02.2023):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 61K / month):
	```
	pip install schemathesis
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 3.3K · ⏱️ 13.02.2023):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 240 · 📋 280 - 36% open · ⏱️ 09.02.2023):
...
- [PyPi](https://pypi.org/project/freezegun) (📥 6.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 710K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 190 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 54 / month):
	```
	pip install sixpack
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 24 · 🔀 39 · 📦 77 · 📋 62 - 1% open · ⏱️ 12.12.2022):
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 80K / month):
	```
...
<details><summary><b><a href="https://github.com/andialbrecht/sqlparse">sqlparse</a></b> (🥇35 ·  ⭐ 3.1K · 📈) - A non-validating SQL parser. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 600 · 📦 670K · 📋 490 - 42% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 53 · 🔀 230 · 📥 7.6K · 📦 720K · 📋 280 - 12% open · ⏱️ 12.02.2023):
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📦 17K · 📋 180 - 44% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 6.3M / month):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 33 · 🔀 110 · 📦 16K · ⏱️ 14.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/shortuuid) (📥 3.8M / month):
	```
	pip install shortuuid
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 310K · ⏱️ 17.11.2022):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 880 · 📦 3.6K · ⏱️ 18.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 410K / month):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 100 · 📦 27K · 📋 48 - 27% open · ⏱️ 16.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 980K / month):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 32 · 🔀 92 · 📋 64 - 3% open · ⏱️ 27.01.2023):
...
- [PyPi](https://pypi.org/project/ply) (📥 22M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 3.3M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 32 · 🔀 190 · 📦 5.6K · 📋 72 - 55% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 9.2K · 📋 130 - 9% open · ⏱️ 25.10.2022):
...
<details><summary><b><a href="https://github.com/mozillazg/python-pinyin">pypinyin</a></b> (🥉19 ·  ⭐ 4.2K) - Convert Chinese hanzi () to pinyin (). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 21 · 📦 120 · 📋 8 - 37% open · ⏱️ 09.02.2019):
...
- [GitHub](https://github.com/davidaurelio/hashids-python) (👨‍💻 10 · 🔀 97 · 📋 24 - 25% open · ⏱️ 07.09.2020):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.6K · 📦 270K · 📋 2.9K - 4% open · ⏱️ 15.02.2023):
...
- [PyPi](https://pypi.org/project/boto3) (📥 550M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 14M · ⏱️ 16.02.2023):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 140K · 📋 960 - 8% open · ⏱️ 15.02.2023):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 43M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 1.9M · ⏱️ 15.02.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 860 · 📥 300 · 📦 21K · 📋 780 - 7% open · ⏱️ 03.01.2023):
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 390 · 📦 6.2K · 📋 330 - 6% open · ⏱️ 16.07.2021):
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.7K · 📋 280 - 2% open · ⏱️ 15.02.2023):
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 60 · 📦 7.8K · ⏱️ 06.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 65K / month):
	```
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 35 · 📦 3.7K · 📋 20 - 25% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/purl) (📥 51K / month):
	```
	pip install purl
	```
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 15 · 🔀 140 · 📋 110 - 26% open · ⏱️ 01.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 2.9M / month):
	```
	pip install furl
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 210 · 📥 740 · 📦 350 · 📋 250 - 1% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 5K / month):
	```
	pip install vidgear
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.2K · 📋 440 - 27% open · ⏱️ 10.02.2023):
...
- [GitHub](https://github.com/miracle2k/webassets) (👨‍💻 160 · 🔀 250 · 📦 6.2K · 📋 290 - 19% open · ⏱️ 01.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/webassets) (📥 250K / month):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 240 · 🔀 750 · 📋 610 - 26% open · ⏱️ 14.02.2023):
...
- [PyPi](https://pypi.org/project/django-storages) (📥 2.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 44K · ⏱️ 23.12.2022):
	```
	conda install -c conda-forge django-storages
	```
</details>
<details><summary><b><a href="https://github.com/django-compressor/django-compressor">django-compressor</a></b> (🥉22 ·  ⭐ 2.6K) - Compresses linked and inline JavaScript or CSS into a.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 210 · 🔀 540 · 📋 630 - 16% open · ⏱️ 22.01.2023):

	```
	git clone https://github.com/django-compressor/django-compressor
	```
- [PyPi](https://pypi.org/project/django-compressor) (📥 450K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 870 · 📦 10K · 📋 370 - 43% open · ⏱️ 10.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/requests-html) (📥 880K / month):
	```
	pip install requests-html
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 5.1K · ⏱️ 26.06.2021):
	```
...
- [GitHub](https://github.com/miso-belica/sumy) (👨‍💻 25 · 🔀 490 · 📦 1.7K · 📋 110 - 16% open · ⏱️ 04.02.2023):
...
- [PyPi](https://pypi.org/project/sumy) (📥 27K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 3.9K · ⏱️ 25.10.2022):
	```
	conda install -c conda-forge sumy
	```
</details>
<details><summary><b><a href="https://github.com/coleifer/micawber">micawber</a></b> (🥈24 ·  ⭐ 590) - A small library for extracting rich content from URLs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 2.7K · ⏱️ 14.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/micawber) (📥 44K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 8K · ⏱️ 14.07.2021):
	```
...
- [PyPi](https://pypi.org/project/html2text) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 27K · ⏱️ 09.02.2020):
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 27 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/binux/pyspider) (👨‍💻 62 · 🔀 3.6K · 📦 320 · 📋 820 - 32% open · ⏱️ 02.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyspider) (📥 1.3K / month):
	```
...
<details><summary><b><a href="https://github.com/scrapinghub/portia">portia</a></b> (🥈24 ·  ⭐ 8.7K · 💀) - Visual scraping for Scrapy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 51 · 🔀 1.4K · 📥 220 · 📦 45 · 📋 450 - 25% open · ⏱️ 10.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/portia) (📥 160 / month):
	```
	pip install portia
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 890 · 📋 74 - 59% open · ⏱️ 07.06.2015):
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 66 · 🔀 260 · ⏱️ 28.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 2.2K / month):
	```
	pip install grab
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 53 · 🔀 360 · 📥 43 · 📋 160 - 15% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 57K / month):
	```
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 3 · 🔀 530 · 📦 17 · 📋 65 - 20% open · ⏱️ 01.03.2020):
	...
	```
- [PyPi](https://pypi.org/project/cola) (📥 74 / month):
	```
	pip install cola
	```
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 83 · 🔀 120 · 📦 460 · 📋 380 - 5% open · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/masonite) (📥 2.3K / month):
	```
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 63 · 🔀 450 · 📦 89K · 📋 960 - 1% open · ⏱️ 18.01.2023):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 740 · 📋 1.2K - 5% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/django/channels
	```
- [PyPi](https://pypi.org/project/channels) (📥 630K / month):
	```
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 870K · 📋 1.9K - 18% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 260 · 📦 930K · 📋 1K - 0% open · ⏱️ 14.02.2023):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 84M / month):
	```
...
- [PyPi](https://pypi.org/project/bjoern) (📥 23K / month):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 97K · ⏱️ 02.11.2022):
	```
