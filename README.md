...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 24 · 🔀 790 · 📦 25 · 📋 1.1K - 0% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 170 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 800 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 350 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 05.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 570 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 990 · 🔀 38K · 📦 2 · 📋 1.2K - 1% open · ⏱️ 10.04.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 88M · ⏱️ 06.04.2023):
	```
...
- [PyPi](https://pypi.org/project/transitions) (📥 400K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 390K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 200 · 🔀 4.1K · 📦 80 · 📋 160 - 35% open · ⏱️ 04.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 4.5K / month):
	```
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 160 · 🔀 550 · 📦 170K · 📋 640 - 4% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 64 · 🔀 230 · 📋 300 - 10% open · ⏱️ 07.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/daphne) (📥 600K / month):
	```
	pip install daphne
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 28K · 📋 700 - 37% open · ⏱️ 05.04.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 7.3M / month):
	```
	pip install trio
	```
...
<details><summary><b><a href="https://github.com/jiaaro/pydub">pydub</a></b> (🥇32 ·  ⭐ 7.1K) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 920 · 📦 22K · 📋 520 - 49% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 6.8M / month):
	```
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 45K · ⏱️ 13.03.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 530 · 🔀 1.7K · 📥 8.1K · 📦 310 · 📋 2.6K - 18% open · ⏱️ 09.04.2023):
...
- [PyPi](https://pypi.org/project/beets) (📥 2.2K / month):
	...
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 230 · ⏱️ 01.12.2022):
	```
...
- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 42 · 🔀 130 · 📥 59K · 📦 11K · 📋 490 - 18% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 2.2M / month):
	```
	pip install mutagen
	```
...
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥈25 ·  ⭐ 450) - A tool for working with audio files, specifically MP3 files containing.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 25 · 🔀 94 · 📦 730 · 📋 99 - 13% open · ⏱️ 20.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 17K / month):
	```
	pip install tinytag
	```
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 58 · 📦 16 · 📋 210 - 18% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 52 / month):
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉18 ·  ⭐ 920) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 120 · 📦 13 · 📋 40 - 32% open · ⏱️ 27.03.2023):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 560 / month):
	```
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.3K · 📋 230 - 42% open · ⏱️ 03.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 340 / month):
	```
	pip install dejavu
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 140 · 🔀 600 · 📦 360K · 📋 400 - 5% open · ⏱️ 10.04.2023):
...
- [PyPi](https://pypi.org/project/django-allauth) (📥 740K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 90K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 94 · 🔀 350 · 📦 26K · 📋 370 - 12% open · ⏱️ 24.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/authlib) (📥 7.8M / month):
	```
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 100K · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/omab/python-social-auth) (👨‍💻 280 · 🔀 1.1K · 📦 5.7K · 📋 660 - 2% open · ⏱️ 04.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/python-social-auth) (📥 33K / month):
	```
...
<details><summary><b><a href="https://github.com/jazzband/django-oauth-toolkit">django-oauth-toolkit</a></b> (🥉23 ·  ⭐ 2.8K) - OAuth 2 goodies for Django. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/pybuilder) (📥 20K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 39K · ⏱️ 22.02.2023):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 700 · 📋 3.9K - 4% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 330 · 📦 680K · 📋 620 - 17% open · ⏱️ 11.04.2023):
...
- [PyPi](https://pypi.org/project/bidict) (📥 1.4M / month):
	...
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 230K · ⏱️ 01.01.2023):
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 90 · 📥 31 · 📋 150 - 10% open · ⏱️ 22.02.2023):
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.6K · 📋 1K - 3% open · ⏱️ 02.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 4.9K / month):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 350 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 660 / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 210 · 📋 440 - 5% open · ⏱️ 09.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 5.4K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 43 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 110 · 📦 4.5K · 📋 190 - 10% open · ⏱️ 26.08.2022):
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 260 · 📋 72 - 22% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 5.9K / month):
	```
...
- [GitHub](https://github.com/psf/black) (👨‍💻 370 · 🔀 1.9K · 📥 28K · 📦 360K · 📋 2.2K - 16% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/black) (📥 20M / month):
	...
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 6.9M · ⏱️ 30.03.2023):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 370K · 📋 1.2K - 11% open · ⏱️ 01.04.2023):
...
- [PyPi](https://pypi.org/project/isort) (📥 26M / month):
	...
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 4.6M · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 360 · 📦 14K · 📋 1.1K - 8% open · ⏱️ 11.04.2023):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 300K / month):
	```
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 87 · 🔀 160 · 📦 4.2K · 📋 360 - 14% open · ⏱️ 07.04.2023):
...
- [PyPi](https://pypi.org/project/prospector) (📥 700K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 66K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 860 · 📦 74K · 📋 770 - 47% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 35 · 🔀 110 · 📦 3.7K · 📋 180 - 8% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 430K / month):
	```
	pip install vulture
	```
- [Conda](https://anaconda.org/conda-forge/vulture) (📥 68K · ⏱️ 09.01.2023):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 240 · 🔀 390 · 📋 340 - 31% open · ⏱️ 13.04.2023):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 63K / month):
	```
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 280 · 📦 400 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 10K / month):
	```
...
- [PyPi](https://pypi.org/project/code2flow) (📥 4.1K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/code2flow) (📥 2.3K · ⏱️ 10.01.2023):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 92 · 🔀 250 · 📋 600 - 18% open · ⏱️ 11.04.2023):
...
- [PyPi](https://pypi.org/project/pytype) (📥 260K / month):
	...
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 150K · ⏱️ 12.04.2023):
	```
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 55 · 📦 110 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 3.9K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.3K · 🔀 1.5K · 📋 2.1K - 7% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 220 · 🔀 1.5K · 📦 79K · 📋 1.1K - 8% open · ⏱️ 12.04.2023):
...
- [PyPi](https://pypi.org/project/rich) (📥 22M / month):
	...
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 3.4M · ⏱️ 12.04.2023):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 440K · 📋 910 - 37% open · ⏱️ 03.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 59M / month):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 59 · 🔀 1.3K · 📦 20K · 📋 280 - 39% open · ⏱️ 13.02.2023):
...
<details><summary><b><a href="https://github.com/peterbrittain/asciimatics">asciimatics</a></b> (🥉25 ·  ⭐ 3.3K) - A package to create full-screen text UIs (from interactive.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 830 · 📋 290 - 8% open · ⏱️ 17.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 57K / month):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.7K · 📋 190 - 7% open · ⏱️ 08.04.2023):
...
- [PyPi](https://pypi.org/project/alive-progress) (📥 290K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 29K · ⏱️ 08.04.2023):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 660 · 📋 1K - 47% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 6.5K / month):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 3.2K · 📦 13K · 📋 810 - 16% open · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/httpie) (📥 200K / month):
	...
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 97K · ⏱️ 01.11.2022):
	```
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 650K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.2K · 📦 420 · 📋 670 - 31% open · ⏱️ 25.09.2022):
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 72 · 🔀 220 · 📦 240 · 📋 340 - 23% open · ⏱️ 07.04.2023):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 4.7K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 490 · 📦 890 · 📋 660 - 22% open · ⏱️ 18.03.2023):

	```
	git clone https://github.com/dbcli/pgcli
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 47K / month):
	```
	pip install pgcli
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 290 · 📋 620 - 29% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mycli) (📥 67K / month):
	```
	pip install mycli
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈25 ·  ⭐ 980) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 55 · 🔀 120 · 📦 390 · 📋 350 - 13% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 39K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 2.5K · ⏱️ 12.04.2023):
	```
...
- [PyPi](https://pypi.org/project/iredis) (📥 1.8K / month):
	...
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 630 · ⏱️ 10.08.2022):
	```
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 83 · 🔀 840 · 📦 450 · 📋 260 - 3% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/gleitz/howdoi
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 4K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 63 · 📦 220 · 📋 92 - 34% open · ⏱️ 11.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/litecli) (📥 7.7K / month):
	```
	pip install litecli
	```
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 270 · 📦 38 · 📋 94 - 34% open · ⏱️ 15.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/saws) (📥 350 / month):
	```
	pip install saws
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 46 · 📋 130 - 35% open · ⏱️ 11.01.2021):
...
- [PyPi](https://pypi.org/project/modernize) (📥 71K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/modernize) (📥 29K · ⏱️ 04.10.2020):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.5K · 📥 4.2M · 📦 2.5K · 📋 750 - 25% open · ⏱️ 29.03.2023):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 130K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 3.2K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 13K · 📥 1.1K · 📋 1.3K - 54% open · ⏱️ 10.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 72K / month):
	```
...
- [GitHub](https://github.com/kornia/kornia) (🔀 810 · 📥 590 · 📦 3.7K · 📋 740 - 28% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 42 · 🔀 630 · 📋 330 - 8% open · ⏱️ 08.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 870K / month):
	```
...
- [GitHub](https://github.com/sightmachine/SimpleCV) (👨‍💻 100 · 🔀 760 · 📦 390 · 📋 330 - 22% open · ⏱️ 07.04.2015):
	...
	```
- [PyPi](https://pypi.org/project/SimpleCV) (📥 2.9K / month):
	```
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 84 · 📦 310 · 📋 75 - 44% open · ⏱️ 14.08.2022):
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 35 · 🔀 170 · 📥 11 · 📦 95K · 📋 85 - 4% open · ⏱️ 01.03.2023):
...
- [PyPi](https://pypi.org/project/python-decouple) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 59K · ⏱️ 02.03.2023):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 24 · 📦 25K · 📋 150 - 36% open · ⏱️ 18.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/configobj) (📥 2.5M / month):
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉21 ·  ⭐ 7K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 520 · 📋 1.2K - 15% open · ⏱️ 26.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/hydra) (📥 9.1K / month):
	```
	pip install hydra
	```
...
<details><summary><b><a href="https://github.com/paramiko/paramiko">paramiko</a></b> (🥇32 ·  ⭐ 8.3K) - The leading native Python SSHv2 protocol library. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 75K · 📋 1.5K - 50% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 130 · 🔀 580 · 📥 180K · 📦 950 · 📋 900 - 3% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 18 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 41 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 110 · 🔀 530 · 📦 360K · 📋 730 - 3% open · ⏱️ 28.03.2023):
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 63 · 🔀 230 · 📦 13K · 📋 340 - 12% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 5.5M / month):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 6.1K · 📋 150 - 52% open · ⏱️ 01.12.2021):
...
- [PyPi](https://pypi.org/project/schema) (📥 4.5M / month):
	...
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 89K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 190 · 🔀 1.6K · 📥 240 · 📦 240K · 📋 2.3K - 4% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/mwaskom/seaborn
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 9.1M / month):
	```
	pip install seaborn
	```
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📥 22 · 📦 51K · 📋 1.8K - 11% open · ⏱️ 07.04.2023):
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 940 · 📋 420 - 58% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 97K / month):
	```
	pip install diagrams
	```
- [Conda](https://anaconda.org/conda-forge/diagrams) (📥 150K · ⏱️ 07.04.2023):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 650 · 🔀 4K · 📦 210 · 📋 7.2K - 9% open · ⏱️ 12.04.2023):
...
<details><summary><b><a href="https://github.com/has2k1/plotnine">plotnine</a></b> (🥉28 ·  ⭐ 3.4K) - A grammar of graphics for Python based on ggplot2. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 99 · 🔀 190 · 📦 4.8K · 📋 550 - 12% open · ⏱️ 03.04.2023):

	```
	git clone https://github.com/has2k1/plotnine
	```
- [PyPi](https://pypi.org/project/plotnine) (📥 570K / month):
	```
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 62 · 🔀 440 · 📦 39 · 📋 580 - 37% open · ⏱️ 11.04.2023):

	```
	git clone https://github.com/bloomberg/bqplot
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 160K / month):
	```
	pip install bqplot
	```
...
- [PyPi](https://pypi.org/project/vispy) (📥 58K / month):
	...
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 370K · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 80 · 🔀 480 · 📦 10K · 📋 290 - 3% open · ⏱️ 04.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/tinydb) (📥 440K / month):
	```
	pip install tinydb
	```
- [Conda](https://anaconda.org/conda-forge/tinydb) (📥 280K · ⏱️ 14.01.2023):
	```
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 81 · 📦 1K · 📋 160 - 38% open · ⏱️ 28.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 60K / month):
	```
	pip install ZODB
	```
...
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉20 ·  ⭐ 780 · 💀) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
🔗&nbsp;<b><a href="https://github.com/dhamaniasad/awesome-postgres">awesome-postgres</a></b> ( ⭐ 8.6K)  - A curated list of awesome PostgreSQL software, libraries, tools and..
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 160K · 📋 630 - 4% open · ⏱️ 31.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 33M / month):
	```
	pip install PyMySQL
	```
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 17K · 📋 1.4K - 17% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/dpkp/kafka-python
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 7.2M / month):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 42 · 🔀 180 · 📦 56K · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/redis/redis-py) (👨‍💻 390 · 🔀 2.3K · 📋 1.4K - 11% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 54 · 🔀 180 · 📦 1.4K · 📋 270 - 12% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.8K · ⏱️ 08.04.2023):

	```
	git clone https://github.com/datastax/python-driver
	```
- [PyPi](https://pypi.org/project/python-driver) (📥 18 / month):
	```
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 990 · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 12 · 🔀 32 · 📦 120 · 📋 18 - 22% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 5.5K / month):
	```
	pip install queries
	```
...
- [GitHub](https://github.com/PyMySQL/mysqlclient) (👨‍💻 73 · 🔀 360 · 📥 5.2K · 📋 310 - 5% open · ⏱️ 31.03.2023):
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 56 / month):
	```
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 88 · 🔀 310 · 📥 89 · 📦 19K · 📋 460 - 43% open · ⏱️ 25.02.2023):
...
- [PyPi](https://pypi.org/project/pendulum) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 700K · ⏱️ 04.02.2023):
	```
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 420 · 📥 35K · 📦 1M · 📋 660 - 40% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 48 · 🔀 190 · 📦 1.1K · 📋 90 - 17% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/maya) (📥 44K / month):
	```
	pip install maya
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 24 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 350 / month):
	```
	pip install Chronyk
	```
...
<details><summary><b><a href="https://github.com/jazzband/django-debug-toolbar">django-debug-toolbar</a></b> (🥇31 ·  ⭐ 7.5K) - Display various debug information for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 880 · 📥 190 · 📦 69K · 📋 840 - 7% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 330 · 📥 12K · 📦 2.5K · 📋 280 - 36% open · ⏱️ 09.12.2022):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 2.5M / month):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 430K · ⏱️ 09.09.2022):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 57 · 🔀 140 · 📦 44K · 📋 180 - 31% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 89 · 🔀 440 · 📦 5K · 📋 210 - 31% open · ⏱️ 21.03.2023):
...
- [GitHub](https://github.com/pallets-eco/flask-debugtoolbar) (👨‍💻 46 · 🔀 120 · 📦 22K · 📋 110 - 37% open · ⏱️ 17.01.2023):
...
- [PyPi](https://pypi.org/project/pudb) (📥 220K / month):
	...
	pip install pudb
	```
- [Conda](https://anaconda.org/conda-forge/pudb) (📥 210K · ⏱️ 04.11.2022):
	```
...
- [PyPi](https://pypi.org/project/icecream) (📥 260K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 14K · ⏱️ 21.07.2022):
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 110 · 📦 190 · 📋 110 - 27% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 9.1K / month):
	```
	pip install wdb
	```
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 370 · 📋 67 - 58% open · ⏱️ 05.03.2016):
	...
	```
- [PyPi](https://pypi.org/project/django-devserver) (📥 5.9K / month):
	```
...
- [PyPi](https://pypi.org/project/line_profiler) (📥 350K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 380K · ⏱️ 09.12.2022):
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 530 / month):
	```
	pip install pyflame
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 21 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 37 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 22 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 270K · 📋 37K - 5% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 6.2K · 📋 9.6K - 18% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 460K / month):
	```
	pip install mxnet
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 4K · 🔀 17K · 📥 13K · 📋 33K - 32% open · ⏱️ 13.04.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 89K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 1.5M · ⏱️ 04.04.2023):
	```
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 740 · 📥 280 · ⏱️ 22.05.2020):

	```
	git clone https://github.com/SerpentAI/SerpentAI
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 46 / month):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 290K · 📋 1.6K - 14% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 27K · 📋 31K - 2% open · ⏱️ 12.04.2023):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.3M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 850K · ⏱️ 11.04.2023):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 15K · 📋 25K - 9% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 61K / month):
	```
	pip install salt
	```
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.9K · 📋 1.1K - 10% open · ⏱️ 10.04.2023):

	```
	git clone https://github.com/Supervisor/supervisor
	```
- [PyPi](https://pypi.org/project/supervisor) (📥 1.3M / month):
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 88 · 🔀 300 · 📦 75 · 📋 660 - 18% open · ⏱️ 16.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 18K / month):
	```
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 660 · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 190 · 📦 300 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools) (📥 5.3K / month):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 48K · 📋 4.7K - 15% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 7M / month):
	```
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 8.5M · ⏱️ 24.03.2023):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.2K · 📥 58 · 📦 8.9K · 📋 13K - 18% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 580 · 📦 1.3K · 📋 1.3K - 15% open · ⏱️ 16.11.2020):

	```
	git clone https://github.com/Yelp/mrjob
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 70K / month):
	```
	pip install mrjob
	```
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 43 · 🔀 210 · 📦 57 · 📋 330 - 19% open · ⏱️ 18.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/streamparse) (📥 2.6K / month):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 740K · 📦 42K · 📋 4.8K - 5% open · ⏱️ 12.04.2023):
...
- [PyPi](https://pypi.org/project/pyinstaller) (📥 1.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 420K · ⏱️ 12.04.2023):
	```
	conda install -c conda-forge pyinstaller
	```
</details>
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈27 ·  ⭐ 2.1K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 29 · 🔀 220 · 📦 790 · 📋 1.1K - 1% open · ⏱️ 13.04.2023):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 170K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 80 · 📥 420 · 📋 110 - 32% open · ⏱️ 04.11.2022):
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.8K · 📦 290K · 📋 6.4K - 17% open · ⏱️ 13.04.2023):
...
- [PyPi](https://pypi.org/project/pdoc) (📥 110K / month):
	...
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 13K · ⏱️ 22.03.2023):
	```
...
- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 55 · 🔀 1.4K · 📦 310 · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 26 · 🔀 170 · 📦 1.9K · 📋 75 - 25% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 29 · 📦 280 · 📋 23 - 30% open · ⏱️ 04.09.2016):

	```
	git clone https://github.com/carlospalol/money
	```
- [PyPi](https://pypi.org/project/money) (📥 46K / month):
	```
	pip install money
	```
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.9M · 📦 25K · 📋 17K - 6% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/davidhalter/jedi-vim) (👨‍💻 97 · 🔀 370 · 📋 770 - 2% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 57 · 🔀 180 · 📦 470 · 📋 88 - 59% open · ⏱️ 03.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/flanker) (📥 27K / month):
	```
	pip install flanker
	```
...
- [PyPi](https://pypi.org/project/yagmail) (📥 130K / month):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 25K · ⏱️ 11.09.2022):
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 180 · 📋 130 - 48% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 9.9K / month):
	```
	pip install imbox
	```
...
- [PyPi](https://pypi.org/project/mailer) (📥 60K / month):
	...
	pip install mailer
	```
- [Conda](https://anaconda.org/conda-forge/mailer) (📥 57K · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 60 · 📥 83 · 📦 18 · 📋 90 - 18% open · ⏱️ 02.04.2023):
	...
	```
- [PyPi](https://pypi.org/project/salmon) (📥 89 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 96 · 🔀 910 · 📦 250K · 📋 1.3K - 6% open · ⏱️ 09.04.2023):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 46M / month):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 4.1M · ⏱️ 13.03.2023):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 420 · 🔀 2.7K · 📋 1.6K - 1% open · ⏱️ 11.04.2023):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 11K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 88K · 📋 610 - 26% open · ⏱️ 04.04.2023):
...
- [PyPi](https://pypi.org/project/watchdog) (📥 13M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 2M · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 58 · 🔀 250 · 📦 40K · 📋 190 - 16% open · ⏱️ 30.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-magic) (📥 5.8M / month):
	```
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 48 · 🔀 130 · 📋 130 - 2% open · ⏱️ 23.02.2023):
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 38 · 📦 8.6K · 📋 17 - 35% open · ⏱️ 14.02.2015):
	...
	```
- [PyPi](https://pypi.org/project/Unipath) (📥 70K / month):
	```
	pip install Unipath
	```
...
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 800K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 70K · ⏱️ 14.02.2023):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 110K · 📋 160 - 13% open · ⏱️ 05.04.2023):
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 98 · 🔀 680 · 📦 18K · 📋 290 - 2% open · ⏱️ 07.04.2023):
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 100 · 🔀 230 · 📥 2.6K · 📦 170K · 📋 250 - 8% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 89K · 📋 220 - 35% open · ⏱️ 03.11.2022):
...
- [PyPi](https://pypi.org/project/toolz) (📥 17M / month):
	...
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 15M · ⏱️ 10.07.2022):
	```
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 140 · 📦 7.3K · 📋 74 - 5% open · ⏱️ 28.03.2023):
...
- [PyPi](https://pypi.org/project/funcy) (📥 1.5M / month):
	...
	pip install funcy
	```
- [Conda](https://anaconda.org/conda-forge/funcy) (📥 320K · ⏱️ 28.03.2023):
	```
	conda install -c conda-forge funcy
	```
</details>
<details><summary><b><a href="https://github.com/dry-python/returns">returns</a></b> (🥉26 ·  ⭐ 2.7K) - A set of type-safe monads, transformers, and composition utilities. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 95 · 📦 340 · 📋 400 - 15% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 54K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 4.7K · ⏱️ 13.03.2022):
	```
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 460 · 📋 49 - 48% open · ⏱️ 13.10.2014):
	...
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 430 / month):
	```
	pip install fn.py
	```
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇32 ·  ⭐ 1.5K) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 150 · 🔀 260 · 📦 21K · 📋 450 - 13% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.7K · 📦 7.9K · 📋 3.3K - 21% open · ⏱️ 11.04.2023):
...
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 200K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 99K · ⏱️ 17.10.2022):
	```
...
- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 46 · 🔀 540 · 📦 5.1K · 📋 500 - 32% open · ⏱️ 04.03.2023):
...
<details><summary><b><a href="https://github.com/chriskiehl/Gooey">Gooey</a></b> (🥈26 ·  ⭐ 18K · 💤) - Turn command line programs into a full GUI application with one line. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 420 · 📦 730 · 📋 580 - 21% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 6.9K / month):
	```
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 64K · ⏱️ 29.12.2021):
	```
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 520 · 📦 1.8K · 📋 1.1K - 16% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 450 · 📦 1K · 📋 750 - 2% open · ⏱️ 04.04.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 450 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 600 / month):
	```
	pip install flexx
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 230 · 🔀 580 · 📥 1.4K · 📋 650 - 19% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 290 · 📦 210 · 📋 230 - 17% open · ⏱️ 21.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/enaml) (📥 2K / month):
	```
	pip install enaml
	```
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 130 · 🔀 590 · 📋 260 - 8% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/geopy) (📥 4.3M / month):
	```
	pip install geopy
	```
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 53 · 🔀 250 · 📋 270 - 5% open · ⏱️ 16.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 480K / month):
	```
	pip install django-countries
	```
- [Conda](https://anaconda.org/conda-forge/django-countries) (📥 3K · ⏱️ 28.02.2022):
	```
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 53 · 🔀 110 · 📦 12K · 📋 91 - 23% open · ⏱️ 08.04.2023):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 450 · 📦 1.2M · 📋 100 - 0% open · ⏱️ 03.04.2023):
...
- [PyPi](https://pypi.org/project/xmltodict) (📥 23M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xmltodict) (📥 2.6M · ⏱️ 08.05.2022):
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 52 · 🔀 170 · 📦 18K · 📋 180 - 27% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 4.7M / month):
	```
	pip install pyquery
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 78 · 🔀 230 · 📦 240K · 📋 370 - 8% open · ⏱️ 23.01.2023):
...
- [PyPi](https://pypi.org/project/bleach) (📥 15M / month):
	...
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 12M · ⏱️ 24.01.2023):
	```
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 730 · 🔀 8.7K · 📥 4.9K · 📦 2.1M · 📋 3.7K - 5% open · ⏱️ 03.03.2023):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 190 · 🔀 650 · 📦 81K · 📋 750 - 3% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 17M / month):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 540K · ⏱️ 11.04.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 980 · 📥 6.9K · 📦 1.2M · 📋 1.1K - 9% open · ⏱️ 12.04.2023):
...
- [PyPi](https://pypi.org/project/grequests) (📥 310K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 74K · ⏱️ 22.04.2020):
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 420 · 🔀 1.8K · 📦 10K · 📋 1.4K - 4% open · ⏱️ 11.04.2023):
...
- [PyPi](https://pypi.org/project/scapy) (📥 2.6M / month):
	...
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 77K · ⏱️ 25.12.2022):
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 380 · 📦 10K · 📋 530 - 64% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 380K / month):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 120 · 📦 1K · 📋 110 - 72% open · ⏱️ 23.08.2022):
...
- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 470 · 📋 64 - 51% open · ⏱️ 20.03.2017):
	...
	```
- [PyPi](https://pypi.org/project/wifi) (📥 16K / month):
	```
	pip install wifi
	```
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 440 · 🔀 1.9K · 📦 1.1M · 📋 2.8K - 2% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 340 · 📋 940 - 0% open · ⏱️ 27.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 4.9K / month):
	```
	pip install thumbor
	```
...
<details><summary><b><a href="https://github.com/WhyNotHugo/python-barcode">python-barcode</a></b> (🥈25 ·  ⭐ 450) - Create barcodes in Python with no extra dependencies. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 44 · 🔀 110 · 📥 260 · 📦 16K · 📋 100 - 39% open · ⏱️ 13.04.2023):
...
- [PyPi](https://pypi.org/project/python-barcode) (📥 230K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 9.5K · ⏱️ 22.08.2020):
	```
	conda install -c conda-forge python-barcode
	```
</details>
<details><summary><b><a href="https://github.com/dylanaraps/pywal">pywal</a></b> (🥈24 ·  ⭐ 7.2K · 💀) - A tool that generates color schemes from images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 270 · 📥 970 · 📦 230 · 📋 520 - 24% open · ⏱️ 09.09.2021):
...
- [PyPi](https://pypi.org/project/pyvips) (📥 45K / month):
	...
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 52K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 11 · 🔀 42 · 📦 65 · 📋 8 - 50% open · ⏱️ 30.11.2022):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 53 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 560 · 🔀 4.7K · 📥 59K · 📋 4.7K - 26% open · ⏱️ 12.04.2023):
...
- [PyPi](https://pypi.org/project/micropython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micropython) (📥 13K · ⏱️ 17.06.2022):
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 55K · 📋 570 - 46% open · ⏱️ 17.03.2023):
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 26K · 📋 63K - 10% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 25 · 🔀 150 · 📦 14 · 📋 89 - 26% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 35 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 68 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 710 / month):
	```
	pip install Pyjion
	```
- [Conda](https://anaconda.org/conda-forge/Pyjion) (📥 480 · ⏱️ 13.02.2022):
	```
	conda install -c conda-forge Pyjion
	```
</details>
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉12 ·  ⭐ 920 · 💀) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 60 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 67 / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 54 · 🔀 260 · 📦 2.5K · 📋 360 - 57% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/jonathanslenders/ptpython
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 280K / month):
	```
...
- [PyPi](https://pypi.org/project/bpython) (📥 99K / month):
	...
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 63K · ⏱️ 15.03.2023):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 51 · 📦 3.4K · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 420K / month):
	```
	pip install pyicu
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 57 · 🔀 830 · 📦 24K · 📋 400 - 31% open · ⏱️ 11.04.2023):
...
- [PyPi](https://pypi.org/project/schedule) (📥 2.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 32K · ⏱️ 11.04.2023):
	```
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 140 · 🔀 1.2K · 📦 2.6K · 📋 3.5K - 17% open · ⏱️ 13.04.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 820K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 420K · ⏱️ 11.04.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 51 · 🔀 280 · 📦 59 · 📋 110 - 4% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 78 · 📋 9 - 11% open · ⏱️ 14.05.2020):

	```
	git clone https://github.com/fengsp/plan
	```
- [PyPi](https://pypi.org/project/plan) (📥 910 / month):
	```
	pip install plan
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 590 · 📦 50K · 📋 740 - 11% open · ⏱️ 10.04.2023):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 7.5M / month):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 1.1M · ⏱️ 10.04.2023):
	```
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 350 · 📥 3.9K · 📦 41K · 📋 860 - 20% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 600 · 🔀 8K · 📥 6.3K · 📦 52K · 📋 4.8K - 6% open · ⏱️ 11.04.2023):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 8.4M / month):
	```
	pip install xgboost
	```
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.8K · 📦 40K · 📋 1.8K - 2% open · ⏱️ 30.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/gym) (📥 610K / month):
	```
	pip install gym
	```
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 460 · 🔀 1.8K · 📋 2.5K - 20% open · ⏱️ 13.04.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 12K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · 📋 160 - 88% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 12K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/josephreisinger/vowpal_porpoise) (👨‍💻 14 · 🔀 28 · 📋 9 - 66% open · ⏱️ 07.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/vowpal_porpoise) (📥 9 / month):
	```
...
<details><summary><b><a href="https://github.com/pythonnet/pythonnet">PythonNet</a></b> (🥇30 ·  ⭐ 3.7K) - Python Integration with the .NET Common Language Runtime (CLR). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 99 · 🔀 550 · 📥 1.5K · 📦 1.4K · 📋 1.3K - 7% open · ⏱️ 12.03.2023):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 88 · 🔀 730 · 📥 610K · 📦 120K · 📋 1.8K - 26% open · ⏱️ 26.03.2023):

	```
	git clone https://github.com/mhammond/pywin32
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 4.7M / month):
	```
	pip install pywin32
	```
- [Conda](https://anaconda.org/conda-forge/pywin32) (📥 3.7M · ⏱️ 28.10.2022):
	```
...
- [PyPi](https://pypi.org/project/boltons) (📥 4.2M / month):
	...
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 1.1M · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 16 · 🔀 160 · 📦 150K · ⏱️ 12.04.2023):
...
- [PyPi](https://pypi.org/project/blinker) (📥 7.1M / month):
	...
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 8.3M · ⏱️ 13.04.2023):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 160 · 🔀 3.6K · 📦 410 · 📋 920 - 36% open · ⏱️ 18.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/magenta) (📥 9K / month):
	```
	pip install magenta
	```
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1.8K · 📋 13 - 7% open · ⏱️ 16.05.2021):
...
<details><summary><b><a href="https://github.com/clips/pattern">pattern</a></b> (🥈29 ·  ⭐ 8.5K · 💀) - A web mining module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 51 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 58 · 🔀 820 · 📦 1.7K · 📋 780 - 9% open · ⏱️ 14.03.2023):
...
- [PyPi](https://pypi.org/project/stanza) (📥 180K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 9.2K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 320 · 📦 960 · 📋 220 - 68% open · ⏱️ 22.09.2020):
...
<details><summary><b><a href="https://github.com/isnowfy/snownlp">snownlp</a></b> (🥉23 ·  ⭐ 6.1K · 💀) - A library for processing Chinese text. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.1K · 📋 100 - 38% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 10K / month):
	```
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 1.8K · ⏱️ 07.09.2021):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 950 · 📥 100K · 📦 260 · 📋 160 - 74% open · ⏱️ 08.06.2022):
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 11 · 🔀 12K · 📋 56 - 21% open · ⏱️ 17.11.2022):
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 1.4K · 📋 590 - 21% open · ⏱️ 06.04.2023):

	```
	git clone https://github.com/napalm-automation/napalm
	```
- [PyPi](https://pypi.org/project/napalm) (📥 42K / month):
	```
	pip install napalm
	```
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 510K · 📦 200 · 📋 690 - 36% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mininet) (📥 3.7K / month):
	```
	pip install mininet
	```
...
- [PyPi](https://pypi.org/project/pox) (📥 4.1M / month):
	...
	pip install pox
	```
- [Conda](https://anaconda.org/conda-forge/pox) (📥 300K · ⏱️ 24.10.2022):
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 6 · 📦 1.1K · 📋 300 - 4% open · ⏱️ 31.03.2023):
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 21K · ⏱️ 09.04.2023):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 310K · ⏱️ 21.02.2023):
	```
	conda install -c conda-forge PynamoDB
	```
</details>
<details><summary><b><a href="https://github.com/pudo/dataset">dataset</a></b> (🥈26 ·  ⭐ 4.5K) - Store Python dicts in a database - works with SQLite, MySQL, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 3K · 📋 280 - 8% open · ⏱️ 30.01.2023):
...
- [PyPi](https://pypi.org/project/dataset) (📥 50K / month):
	...
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 5.1K · ⏱️ 01.02.2023):
	```
...
- [PyPi](https://pypi.org/project/orator) (📥 16K / month):
	...
	pip install orator
	```
- [Conda](https://anaconda.org/conda-forge/orator) (📥 2.6K · ⏱️ 18.03.2020):
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 450 · 🔀 1.9K · 📥 15M · 📋 4.9K - 12% open · ⏱️ 12.04.2023):
...
- [PyPi](https://pypi.org/project/poetry) (📥 12M / month):
	...
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 830K · ⏱️ 05.04.2023):
	```
	conda install -c conda-forge poetry
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥉25 ·  ⭐ 6.8K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 500 · 📋 920 - 13% open · ⏱️ 09.04.2023):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 9.6M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 81K · ⏱️ 07.04.2023):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.3K · 📦 39K · 📋 9K - 7% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 92 · 🔀 110 · 📦 210 · 📋 730 - 9% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 5 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 53 / month):
	```
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 340 · 🔀 800 · 📋 2.9K - 14% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 5K · 📋 4.9K - 1% open · ⏱️ 11.04.2023):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 7.4K / month):
	```
	pip install sqlmap
	```
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉20 ·  ⭐ 8.5K · 💤) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.7K · 📋 130 - 27% open · ⏱️ 06.09.2022):
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 530 · 📦 5.8K · 📋 440 - 27% open · ⏱️ 25.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-guardian) (📥 380K / month):
	```
	pip install django-guardian
	```
- [Conda](https://anaconda.org/conda-forge/django-guardian) (📥 45K · ⏱️ 26.05.2021):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 92 · 🔀 460 · 📦 12K · 📋 440 - 1% open · ⏱️ 03.04.2023):
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 85 · 🔀 1.1K · 📦 2.7K · 📋 380 - 12% open · ⏱️ 10.04.2023):

	```
	git clone https://github.com/spotify/annoy
	```
- [PyPi](https://pypi.org/project/annoy) (📥 950K / month):
	```
	pip install annoy
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 570 · 📥 330 · 📦 910 · 📋 450 - 16% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 410 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 820 / month):
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥇38 ·  ⭐ 57K · 📈) - A modern, fast, web framework for building APIs with Python 3.6+ based.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 430 · 🔀 4.6K · 📦 170K · 📋 3.3K - 0% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 870 · 📥 4.4K · 📦 7.9K · 📋 980 - 15% open · ⏱️ 18.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/falcon) (📥 700K / month):
	```
	pip install falcon
	```
...
- [PyPi](https://pypi.org/project/flask-restful) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-restful) (📥 160K · ⏱️ 30.05.2021):
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.5K · 📦 13K · 📋 1.3K - 4% open · ⏱️ 09.04.2023):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 850K / month):
	```
	pip install sanic
	```
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 2.3K · 📋 460 - 35% open · ⏱️ 10.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/hug) (📥 65K / month):
	```
	pip install hug
	```
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 33 · 🔀 180 · 📦 5.7K · 📋 64 - 18% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 210 · 🔀 730 · 📦 1.1K · 📋 970 - 2% open · ⏱️ 22.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/eve) (📥 15K / month):
	```
	pip install eve
	```
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 91 · 🔀 410 · 📦 730 · 📋 310 - 7% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/apistar) (📥 9.9K / month):
	```
	pip install apistar
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.3K · 📋 310 - 3% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/0rpc/zerorpc-python) (👨‍💻 38 · 🔀 370 · 📋 160 - 26% open · ⏱️ 06.01.2022):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.8K · 📥 500K · 📦 57K · 📋 12K - 32% open · ⏱️ 08.04.2023):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 6.4M / month):
	```
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 3.2M · ⏱️ 20.03.2023):
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 410 · 🔀 2.5K · 📥 27 · 📦 89K · 📋 5.1K - 47% open · ⏱️ 07.04.2023):
...
- [PyPi](https://pypi.org/project/statsmodels) (📥 9.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 9.4M · ⏱️ 04.11.2022):
	```
...
<details><summary><b><a href="https://github.com/pymc-devs/pymc">PyMC</a></b> (🥉27 ·  ⭐ 7.5K) - Markov Chain Monte Carlo sampling toolkit. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 450 · 🔀 1.7K · 📥 1.9K · 📦 1.3K · 📋 3K - 5% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 96 · 🔀 340 · 📋 3K - 3% open · ⏱️ 20.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/bcbio-nextgen) (📥 210 / month):
	```
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 8.9K · 📋 1.2K - 36% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 74K · 📋 1.2K - 11% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 22 · 🔀 42 · 📦 3.8K · 📋 100 - 11% open · ⏱️ 15.03.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 930K / month):
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 49 · 📦 960 · 📋 81 - 14% open · ⏱️ 12.09.2022):
...
- [PyPi](https://pypi.org/project/pysimdjson) (📥 240K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 59K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📥 290 · 📋 1.3K - 47% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/Zappa) (📥 99K / month):
	```
	pip install Zappa
	```
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 48 · 🔀 220 · 📦 180 · 📋 90 - 41% open · ⏱️ 03.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 4.3K / month):
	```
...
<details><summary><b><a href="https://github.com/xonsh/xonsh">xonsh</a></b> (🥇15 ·  ⭐ 7K) - A Python-powered, cross-platform, Unix-gazing shell language and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xonsh/xonsh) (🔀 580 · 📥 8.4K · 📋 2.4K - 10% open · ⏱️ 12.04.2023):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 550 · 📦 41K · 📋 240 - 11% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 58K · 📋 860 - 2% open · ⏱️ 09.04.2023):
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 560 · 📦 1.3K · 📋 870 - 7% open · ⏱️ 07.03.2023):
...
- [PyPi](https://pypi.org/project/csvkit) (📥 150K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 85K · ⏱️ 22.02.2023):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 60 · 🔀 450 · 📥 24K · 📦 28K · 📋 1.7K - 15% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 84K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 580K · ⏱️ 31.03.2023):
	```
...
- [GitHub](https://github.com/euske/pdfminer) (👨‍💻 28 · 🔀 1K · 📦 3.8K · 📋 240 - 82% open · ⏱️ 18.01.2020):
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 790 · 📦 260K · 📋 810 - 4% open · ⏱️ 06.04.2023):
...
- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 180 · 🔀 1.1K · 📋 720 - 6% open · ⏱️ 10.04.2023):

	```
	git clone https://github.com/mstamy2/PyPDF2
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 4.5M / month):
	```
	pip install PyPDF2
	```
...
<details><summary><b><a href="https://github.com/scanny/python-pptx">python-pptx</a></b> (🥉22 ·  ⭐ 1.8K · 💀) - Python library for creating and updating PowerPoint (.pptx) files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 770 · 📦 6.8K · 📋 1.6K - 3% open · ⏱️ 27.03.2023):
...
- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.1K · 📦 42K · 📋 1.8K - 6% open · ⏱️ 10.04.2023):
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 230 · 🔀 350 · 📦 480 · 📋 2.1K - 2% open · ⏱️ 08.04.2023):
...
- [PyPi](https://pypi.org/project/nikola) (📥 1.3K / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 7.8K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 300 · 📥 7K · 📦 410 · 📋 630 - 35% open · ⏱️ 10.04.2023):

	```
	git clone https://github.com/lektor/lektor
	```
- [PyPi](https://pypi.org/project/lektor) (📥 3.6K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 150 · 🔀 560 · 📋 410 - 19% open · ⏱️ 21.11.2022):
...
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇33 ·  ⭐ 8.9K) - Simple job queues for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/rq/rq) (👨‍💻 290 · 🔀 1.3K · 📦 13K · 📋 1K - 13% open · ⏱️ 08.04.2023):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 660K / month):
	```
	pip install rq
	```
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇22 ·  ⭐ 9.2K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 960 - 5% open · ⏱️ 07.04.2023):

	```
	git clone https://github.com/pallets/jinja
	```
- [PyPi](https://pypi.org/project/jinja) (📥 6.7K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 520 · 🔀 1.7K · 📦 120K · 📋 630 - 2% open · ⏱️ 06.04.2023):
...
- [PyPi](https://pypi.org/project/faker) (📥 7.5M / month):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 740K · ⏱️ 06.04.2023):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 180 · 🔀 2.1K · 📥 540 · 📦 7.5K · 📋 4.1K - 6% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 310 · 🔀 520 · 📦 20K · 📋 1.4K - 3% open · ⏱️ 07.04.2023):
...
- [PyPi](https://pypi.org/project/hypothesis) (📥 4.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7.4M · ⏱️ 07.04.2023):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 310 · 📥 110 · 📦 24K · 📋 260 - 0% open · ⏱️ 10.03.2023):
...
- [PyPi](https://pypi.org/project/responses) (📥 10M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 1.6M · ⏱️ 26.05.2022):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.3K · 📋 520 - 8% open · ⏱️ 07.04.2023):

	```
	git clone https://github.com/cobrateam/splinter
	```
- [PyPi](https://pypi.org/project/splinter) (📥 88K / month):
	```
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈30 ·  ⭐ 8K · 💀) - PyAutoGUI is a cross-platform GUI automation Python module for.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 120 · 🔀 300 · 📥 390 · 📦 1.3K · 📋 310 - 0% open · ⏱️ 13.04.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 130K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 100K · ⏱️ 07.04.2023):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.6K · 📋 1.4K - 0% open · ⏱️ 13.04.2023):
...
- [PyPi](https://pypi.org/project/locust) (📥 1.4M / month):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 110K · ⏱️ 14.03.2023):
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 54 · 🔀 120 · 📦 210 · 📋 720 - 17% open · ⏱️ 22.03.2023):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 67K / month):
	```
	pip install schemathesis
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 4.4K · ⏱️ 26.03.2023):
	```
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 240 · 📋 280 - 37% open · ⏱️ 22.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 6.4M / month):
	```
	pip install freezegun
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 870K · ⏱️ 12.08.2022):
	```
...
- [PyPi](https://pypi.org/project/nose2) (📥 650K / month):
	...
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 89K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 38 · 🔀 72 · 📦 990 · 📋 180 - 2% open · ⏱️ 20.09.2022):
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 74 / month):
	```
	pip install sixpack
	```
...
- [PyPi](https://pypi.org/project/httmock) (📥 340K / month):
	...
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 7.7K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 83K / month):
	```
...
<details><summary><b><a href="https://github.com/klen/mixer">mixer</a></b> (🥉17 ·  ⭐ 890 · 💀) - Another fixtures replacement. Supports Django, Flask,.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 600 · 📦 720K · 📋 500 - 42% open · ⏱️ 20.03.2023):
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 54 · 🔀 240 · 📥 7.8K · 📦 750K · 📋 290 - 9% open · ⏱️ 13.04.2023):

	```
	git clone https://github.com/pyparsing/pyparsing
	```
- [PyPi](https://pypi.org/project/pyparsing) (📥 76M / month):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 33 · 🔀 100 · 📦 16K · ⏱️ 25.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/shortuuid) (📥 3.7M / month):
	```
...
<details><summary><b><a href="https://github.com/pwaller/pyfiglet">pyfiglet</a></b> (🥈28 ·  ⭐ 1.1K) - An implementation of figlet written in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 25 · 🔀 99 · 📦 28K · 📋 50 - 30% open · ⏱️ 09.04.2023):

	```
	git clone https://github.com/pwaller/pyfiglet
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 890K / month):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 900 · 📦 3.9K · ⏱️ 18.09.2022):

	```
	git clone https://github.com/orsinium/textdistance
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 380K / month):
	```
	pip install textdistance
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 360K · ⏱️ 18.09.2022):
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 48 · 🔀 240 · 📋 130 - 38% open · ⏱️ 02.12.2022):

	```
	git clone https://github.com/chardet/chardet
	```
- [PyPi](https://pypi.org/project/chardet) (📥 56M / month):
	```
	pip install chardet
	```
...
- [PyPi](https://pypi.org/project/ply) (📥 24M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 4.9M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 32 · 🔀 190 · 📦 5.9K · 📋 74 - 56% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 240 - 10% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 34 / month):
	```
...
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 58K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/awesome-slugify) (📥 66K · ⏱️ 28.06.2019):
	```
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 27 · 🔀 380 · 📋 160 - 3% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.7K · 📦 290K · 📋 2.9K - 4% open · ⏱️ 12.04.2023):
...
- [PyPi](https://pypi.org/project/boto3) (📥 510M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 15M · ⏱️ 13.04.2023):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 140K · 📋 970 - 8% open · ⏱️ 11.04.2023):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 44M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 2M · ⏱️ 11.04.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 870 · 📥 570 · 📦 22K · 📋 790 - 6% open · ⏱️ 04.04.2023):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 8.5M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 66 · 🔀 150 · 📦 6.1K · 📋 280 - 3% open · ⏱️ 13.04.2023):
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 62 · 📦 8.2K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 47K / month):
	```
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 48K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.2K · 📋 440 - 26% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 240 · 🔀 760 · 📋 620 - 26% open · ⏱️ 28.02.2023):
...
- [PyPi](https://pypi.org/project/requests-html) (📥 880K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 6K · ⏱️ 26.06.2021):
	```
...
- [PyPi](https://pypi.org/project/sumy) (📥 26K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 4.5K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 2.7K · ⏱️ 14.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/micawber) (📥 38K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 9K · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 58 / month):
	```
	pip install toapi
	```
...
- [PyPi](https://pypi.org/project/robobrowser) (📥 14K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robobrowser) (📥 5K · ⏱️ 23.03.2018):
	```
...
<details><summary><b><a href="https://github.com/python-websockets/websockets">websockets</a></b> (🥇30 ·  ⭐ 4.5K) - A library for building WebSocket servers and clients with a focus.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/python-websockets/websockets) (👨‍💻 67 · 🔀 460 · 📦 97K · 📋 990 - 2% open · ⏱️ 11.04.2023):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 740 · 📋 1.2K - 6% open · ⏱️ 07.04.2023):
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 910K · 📋 1.9K - 19% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 310 · 📦 970K · 📋 1.1K - 0% open · ⏱️ 12.04.2023):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 73M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 7.4M · ⏱️ 14.02.2023):
	```
	conda install -c conda-forge werkzeug
	```
</details>
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉29 ·  ⭐ 1.2K) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>
