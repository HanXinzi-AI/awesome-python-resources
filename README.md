...
- [Job Scheduler](#job-scheduler) _10 projects_
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 180 · 🔀 800 · 📦 6.1K · 📋 770 - 5% open · ⏱️ 22.06.2021):
...
- [PyPi](https://pypi.org/project/flower) (📥 800K / month):
	...
	pip install flower
	```
- [Conda](https://anaconda.org/conda-forge/flower) (📥 87K · ⏱️ 09.02.2021):
	```
...
- [GitHub](https://github.com/geex-arts/django-jet) (👨‍💻 29 · 🔀 620 · 📦 2.3K · 📋 330 - 63% open · ⏱️ 21.05.2019):
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 740 · 📋 560 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 780 / month):
	```
	pip install xadmin
	```
...
<details><summary><b><a href="https://github.com/jet-admin/jet-bridge">jet-bridge</a></b> (🥉15 ·  ⭐ 980) - Admin panel framework for any application with nice UI (ex Jet Django). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 720 · 🔀 30K · 📋 700 - 1% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 31M · ⏱️ 29.06.2021):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 68 · 🔀 430 · 📦 1.7K · 📋 370 - 2% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 170 · 🔀 3.7K · 📦 49 · 📋 140 - 35% open · ⏱️ 28.06.2021):
...
- [PyPi](https://pypi.org/project/algorithms) (📥 1.7K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 130 · ⏱️ 23.04.2021):
	```
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 100 · 🔀 430 · 📋 83 - 21% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 110 · 🔀 330 · 📦 28K · 📋 480 - 9% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/uvicorn) (📥 2.4M / month):
	...
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 480K · ⏱️ 30.06.2021):
	```
...
- [PyPi](https://pypi.org/project/daphne) (📥 360K / month):
	...
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 49K · ⏱️ 07.04.2021):
	```
...
<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇29 ·  ⭐ 7.9K) - Ultra fast asyncio event loop. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 41 · 🔀 390 · 📥 320 · 📦 24K · 📋 250 - 16% open · ⏱️ 19.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 3.1M / month):
	```
	pip install uvloop
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 240 · 📦 1K · 📋 640 - 39% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 110K / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 440K · ⏱️ 15.06.2021):
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 90 · 🔀 720 · 📦 7.7K · 📋 430 - 42% open · ⏱️ 08.06.2021):
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 460 · 🔀 1.6K · 📥 6.7K · 📦 210 · 📋 2.4K - 19% open · ⏱️ 29.06.2021):
...
<details><summary><b><a href="https://github.com/quodlibet/mutagen">mutagen</a></b> (🥈26 ·  ⭐ 800) - A Python module to handle audio metadata. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 34 · 🔀 110 · 📥 45K · 📦 4.9K · 📋 440 - 16% open · ⏱️ 14.03.2021):
...
- [PyPi](https://pypi.org/project/mutagen) (📥 390K / month):
	...
	pip install mutagen
	```
- [Conda](https://anaconda.org/conda-forge/mutagen) (📥 95K · ⏱️ 30.05.2021):
	```
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 20 · 🔀 81 · 📦 5.5K · 📋 71 - 38% open · ⏱️ 20.10.2020):

	```
	git clone https://github.com/beetbox/audioread
	```
- [PyPi](https://pypi.org/project/audioread) (📥 560K / month):
	```
	pip install audioread
	```
- [Conda](https://anaconda.org/conda-forge/audioread) (📥 250K · ⏱️ 16.03.2021):
	```
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 90 · 🔀 720 · 📋 880 - 4% open · ⏱️ 01.07.2021):
...
- [PyPi](https://pypi.org/project/librosa) (📥 540K / month):
	...
	pip install librosa
	```
- [Conda](https://anaconda.org/conda-forge/librosa) (📥 300K · ⏱️ 26.05.2021):
	```
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 130 · 📥 12 · 📦 880 · 📋 89 - 10% open · ⏱️ 25.03.2021):
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 20 · 🔀 79 · 📦 380 · 📋 76 - 13% open · ⏱️ 13.06.2021):
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.2K · 📦 18 · 📋 200 - 35% open · ⏱️ 03.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 85 / month):
	```
	pip install dejavu
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉17 ·  ⭐ 450) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 55 · 📦 3 · 📋 27 - 33% open · ⏱️ 03.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/matchering) (📥 150 / month):
	```
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 180 · 🔀 410 · 📦 160K · 📋 330 - 20% open · ⏱️ 01.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 52M / month):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 95 · 🔀 490 · 📦 130K · 📋 310 - 23% open · ⏱️ 15.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyjwt) (📥 44M / month):
	```
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 3.6M · ⏱️ 28.04.2021):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 540 · 🔀 2.2K · 📦 67K · 📋 1.7K - 17% open · ⏱️ 05.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 530K / month):
	```
...
<details><summary><b><a href="https://github.com/lepture/authlib">authlib</a></b> (🥈29 ·  ⭐ 2.6K) - JavaScript Object Signing and Encryption draft implementation. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/lepture/authlib) (👨‍💻 64 · 🔀 250 · 📦 15K · 📋 260 - 9% open · ⏱️ 19.06.2021):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 2.3M / month):
	```
	pip install authlib
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 8.4K · 📋 130 - 37% open · ⏱️ 12.02.2018):

	```
	git clone https://github.com/joestump/python-oauth2
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 83K / month):
	```
...
- [GitHub](https://github.com/mpdavis/python-jose) (🔀 170 · 📦 7.3K · 📋 110 - 37% open · ⏱️ 07.06.2021):
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 48 · 🔀 540 · 📋 3.5K - 5% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 100 · 🔀 260 · 📦 250K · 📋 480 - 21% open · ⏱️ 30.06.2021):

	```
	git clone https://github.com/python-attrs/attrs
	```
- [PyPi](https://pypi.org/project/attrs) (📥 58M / month):
	```
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 9.2M · ⏱️ 07.05.2021):
	```
	conda install -c conda-forge attrs
	```
</details>
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥈24 ·  ⭐ 860) - Efficient, Pythonic bidirectional map data structures and related.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/jab/bidict) (👨‍💻 11 · 🔀 41 · 📦 3.4K · 📋 44 - 2% open · ⏱️ 15.06.2021):

	```
	git clone https://github.com/jab/bidict
	```
- [PyPi](https://pypi.org/project/bidict) (📥 530K / month):
	```
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 93K · ⏱️ 07.09.2020):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 110 · 🔀 290 · 📥 2.8K · 📋 3.1K - 18% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 64 · 🔀 110 · 📦 220 · 📋 210 - 19% open · ⏱️ 12.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 370 / month):
	```
	pip install Kotti
	```
...
<details><summary><b><a href="https://github.com/feincms/feincms">feincms</a></b> (🥉15 ·  ⭐ 800) - One of the most advanced Content Management Systems built on Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 130 · 🔀 210 · 📋 440 - 8% open · ⏱️ 25.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 3.1K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 450 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 95 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 59 · 🔀 170 · 📦 520 · 📋 280 - 7% open · ⏱️ 03.05.2021):
...
🔗&nbsp;<b><a href="https://github.com/DmytroLitvinov/awesome-flake8-extensions">awesome-flake8-extensions</a></b> ( ⭐ 600)  - A curated awesome list of flake8 extensions. Feel free to..
...
- [GitHub](https://github.com/psf/black) (👨‍💻 260 · 🔀 1.3K · 📥 14K · 📦 65K · 📋 1.6K - 17% open · ⏱️ 23.06.2021):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 7.8M / month):
	```
	pip install black
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 240 · 🔀 400 · 📦 180K · 📋 970 - 2% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 140 · 🔀 280 · 📦 410 · 📋 950 - 8% open · ⏱️ 01.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 75K / month):
	```
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 160 · 🔀 320 · 📋 260 - 23% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 28 · 🔀 81 · 📦 990 · 📋 140 - 7% open · ⏱️ 04.06.2021):
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥉24 ·  ⭐ 780 · 💀) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 38 · 🔀 75 · 📦 2.5K · 📋 120 - 55% open · ⏱️ 10.04.2019):

	```
	git clone https://github.com/klen/pylama
	```
- [PyPi](https://pypi.org/project/pylama) (📥 94K / month):
	```
	pip install pylama
	```
- [Conda](https://anaconda.org/conda-forge/pylama) (📥 60K · ⏱️ 18.05.2019):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 63 · 🔀 180 · 📋 420 - 22% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 120 · 📦 120 · 📋 140 - 22% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 930 · 🔀 1.1K · 📋 1.3K - 9% open · ⏱️ 01.07.2021):
...
<details><summary><b><a href="https://github.com/dropbox/pyannotate">pyannotate</a></b> (🥉18 ·  ⭐ 1.2K) - Auto-generate PEP-484 annotations. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/scottrogowski/code2flow">code2flow</a></b> (🥉14 ·  ⭐ 870) - Turn your Python and JavaScript code into DOT flowcharts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 5 · 🔀 140 · 📦 5 · ⏱️ 27.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 120 / month):
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 100 · 🔀 930 · 📥 7.9K · 📦 190K · 📋 760 - 32% open · ⏱️ 12.06.2021):
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 95 · 🔀 800 · 📦 5K · 📋 470 - 1% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.1K · 📦 8K · 📋 230 - 38% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 180 · 🔀 550 · 📦 160K · 📋 880 - 44% open · ⏱️ 17.06.2021):
...
- [GitHub](https://github.com/rsalmei/alive-progress) (🔀 100 · 📦 330 · 📋 67 - 26% open · ⏱️ 08.01.2021):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 82 · 📦 130 · 📋 28 - 60% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 1.8K / month):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 120 · 🔀 3.1K · 📦 8.7K · 📋 690 - 17% open · ⏱️ 01.07.2021):
...
- [PyPi](https://pypi.org/project/httpie) (📥 220K / month):
	...
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 61K · ⏱️ 14.10.2020):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 180 · 🔀 2.8K · 📦 280 · 📋 600 - 33% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 69 · 🔀 790 · 📦 330 · 📋 220 - 7% open · ⏱️ 26.06.2021):

	```
	git clone https://github.com/gleitz/howdoi
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 4.7K / month):
	```
	pip install howdoi
	```
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 250 · 📦 35 · 📋 91 - 32% open · ⏱️ 26.06.2021):
...
- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 21 · 🔀 63 · 📥 4K · 📋 180 - 31% open · ⏱️ 04.06.2021):
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 150 · 📥 490 · 📦 11 · 📋 68 - 82% open · ⏱️ 19.09.2018):
...
- [GitHub](https://github.com/copier-org/copier) (👨‍💻 15 · 🔀 29 · 📋 200 - 18% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 40 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 430K / month):
	```
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 80 · 🔀 1.4K · 📥 350K · 📦 330 · 📋 350 - 35% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 26 · 🔀 190 · 📦 520 · 📋 210 - 28% open · ⏱️ 19.06.2021):
...
- [PyPi](https://pypi.org/project/tesserocr) (📥 62K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/tesserocr) (📥 50K · ⏱️ 13.01.2021):
	```
	conda install -c conda-forge tesserocr
	```
</details>
<details><summary><b><a href="https://github.com/ageitgey/face_recognition">Face Recognition</a></b> (🥈26 ·  ⭐ 41K) - Simple facial recognition library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/face_recognition) (📥 70K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/face_recognition) (📥 2.3K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 38 · 🔀 520 · 📋 270 - 4% open · ⏱️ 14.06.2021):

	```
	git clone https://github.com/madmaze/pytesseract
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 700K / month):
	```
...
- [GitHub](https://github.com/kornia/kornia) (🔀 400 · 📥 45 · 📦 470 · 📋 400 - 19% open · ⏱️ 30.06.2021):
...
<details><summary><b><a href="https://github.com/henriquebastos/python-decouple">python-decouple</a></b> (🥇28 ·  ⭐ 1.8K) - Strict separation of settings from code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 24 · 🔀 140 · 📦 41K · 📋 62 - 9% open · ⏱️ 05.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 430K / month):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 76 · 🔀 330 · 📋 800 - 7% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/hydra) (📥 8.7K / month):
	...
	pip install hydra
	```
- [Conda](https://anaconda.org/conda-forge/hydra) (📥 6.8K · ⏱️ 18.01.2021):
	```
...
- [PyPi](https://pypi.org/project/pynacl) (📥 16M / month):
	...
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 1.2M · ⏱️ 19.04.2021):
	```
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 21 · 🔀 190 · 📋 210 - 18% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/awslabs/aws-data-wrangler) (👨‍💻 73 · 🔀 290 · 📥 52K · 📋 430 - 5% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/Julian/jsonschema) (👨‍💻 86 · 🔀 450 · 📦 160K · 📋 580 - 10% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/jsonschema) (📥 27M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 6.8M · ⏱️ 04.03.2021):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 62 · 🔀 210 · 📦 9.6K · 📋 320 - 10% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 2.6M / month):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 61 · 🔀 160 · 📦 2.9K · 📋 120 - 49% open · ⏱️ 12.03.2021):
...
- [GitHub](https://github.com/schematics/schematics) (👨‍💻 110 · 🔀 280 · 📦 960 · 📋 320 - 29% open · ⏱️ 22.12.2018):
	...
	```
- [PyPi](https://pypi.org/project/schematics) (📥 200K / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 150 · 🔀 1.4K · 📥 170 · 📦 100K · 📋 1.9K - 4% open · ⏱️ 18.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 8.1M / month):
	```
	pip install seaborn
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 560 · 🔀 3.7K · 📦 36K · 📋 6.6K - 10% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/bokeh) (📥 1.9M / month):
	...
	pip install bokeh
	```
- [Conda](https://anaconda.org/conda-forge/bokeh) (📥 4.8M · ⏱️ 11.05.2021):
	```
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 130 · 🔀 570 · 📦 13K · 📋 1.5K - 13% open · ⏱️ 04.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/altair) (📥 1.7M / month):
	```
	pip install altair
	```
- [Conda](https://anaconda.org/conda-forge/altair) (📥 780K · ⏱️ 01.04.2020):
	```
...
- [GitHub](https://github.com/bqplot/bqplot) (👨‍💻 52 · 🔀 410 · 📦 26 · 📋 540 - 35% open · ⏱️ 28.06.2021):

	```
	git clone https://github.com/bloomberg/bqplot
	```
- [PyPi](https://pypi.org/project/bqplot) (📥 59K / month):
	```
	pip install bqplot
	```
- [Conda](https://anaconda.org/conda-forge/bqplot) (📥 670K · ⏱️ 08.06.2021):
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 88 · 🔀 790 · 📋 280 - 54% open · ⏱️ 23.05.2021):
...
- [PyPi](https://pypi.org/project/diagrams) (📥 52K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/diagrams) (📥 77K · ⏱️ 25.05.2021):
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 160 · 🔀 550 · 📦 530 · 📋 1.2K - 26% open · ⏱️ 01.07.2021):
...
- [PyPi](https://pypi.org/project/vispy) (📥 29K / month):
	...
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 160K · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 67 · 🔀 380 · 📋 260 - 3% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 65 · 📦 730 · 📋 140 - 37% open · ⏱️ 03.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 49K / month):
	```
	pip install ZODB
	```
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 11 · 🔀 97 · 📦 630 · 📋 50 - 22% open · ⏱️ 15.11.2019):
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 200 · 🔀 1.1K · 📥 1.7K · 📦 7.1K · 📋 1.3K - 12% open · ⏱️ 22.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 5.6M / month):
	```
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 110 · 🔀 1.2K · 📦 87K · 📋 570 - 3% open · ⏱️ 27.06.2021):
...
- [PyPi](https://pypi.org/project/PyMySQL) (📥 11M / month):
	...
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 320K · ⏱️ 09.01.2021):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 31 · 🔀 150 · 📦 6.1K · ⏱️ 07.06.2021):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 180 · 🔀 890 · 📦 100K · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/andymccurdy/redis-py) (👨‍💻 250 · 🔀 1.9K · 📋 890 - 6% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 31 · 🔀 110 · 📦 320 · 📋 170 - 18% open · ⏱️ 09.06.2021):

	```
	git clone https://github.com/mymarilyn/clickhouse-driver
	```
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 260K / month):
	```
...
<details><summary><b><a href="https://github.com/dateutil/dateutil">dateutil</a></b> (🥇28 ·  ⭐ 1.6K · 📈) - Extensions to the standard Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 120 · 🔀 360 · 📥 35K · 📦 510K · 📋 570 - 38% open · ⏱️ 31.05.2021):
...
- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 66 · 🔀 240 · 📋 390 - 42% open · ⏱️ 11.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 4.4M / month):
	```
...
- [GitHub](https://github.com/myusuf3/delorean) (🔀 120 · 📦 600 · 📋 60 - 40% open · ⏱️ 06.12.2020):
...
- [PyPi](https://pypi.org/project/moment) (📥 46K / month):
	...
	pip install moment
	```
- [Conda](https://anaconda.org/conda-forge/moment) (📥 7.7K · ⏱️ 31.01.2019):
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 5 · 🔀 16 · 📦 15 · ⏱️ 17.09.2020):

	```
	git clone https://github.com/shinux/PyTime
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 7.4K / month):
	```
	pip install PyTime
	```
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇30 ·  ⭐ 7.1K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 26 · 🔀 240 · 📥 5.5K · 📦 910 · 📋 210 - 27% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 710K / month):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 6.6K · ⏱️ 17.05.2021):
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 240 · 🔀 800 · 📥 160 · 📦 40K · 📋 760 - 10% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 75 · 🔀 380 · 📦 2.3K · 📋 160 - 30% open · ⏱️ 27.05.2021):
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 77 · 🔀 170 · 📦 2.4K · 📋 260 - 48% open · ⏱️ 25.06.2021):
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥈22 ·  ⭐ 5K) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gruns/icecream) (👨‍💻 14 · 🔀 99 · 📋 66 - 21% open · ⏱️ 22.06.2021):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 68K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 400 · ⏱️ 23.06.2021):
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 99 · 📦 95 · 📋 110 - 26% open · ⏱️ 16.09.2019):
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 8 · 🔀 31 · 📦 63 · 📋 81 - 43% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/google/pyringe) (🔀 68 · 📦 2 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 54 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 3.7K · 🔀 68K · 📦 150K · 📋 32K - 10% open · ⏱️ 01.07.2021):
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥈36 ·  ⭐ 49K · 📉) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 2.7K · 🔀 13K · 📦 84K · 📋 21K - 30% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/apache/incubator-mxnet) (👨‍💻 960 · 🔀 6.5K · 📥 24K · 📦 2.2K · 📋 9.4K - 18% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 930 · 🔀 18K · 📋 11K - 5% open · ⏱️ 01.07.2021):
...
- [PyPi](https://pypi.org/project/caffe):
	...
	pip install caffe
	```
- [Conda](https://anaconda.org/conda-forge/caffe) (📥 66K · ⏱️ 27.06.2020):
	```
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 160 · 🔀 1.1K · 📦 92K · 📋 1.4K - 10% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 24M / month):
	```
	pip install psutil
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.4K · 🔀 20K · 📦 17K · 📋 29K - 3% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/ansible) (📥 4.3M / month):
	...
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 340K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.7K · 🔀 4.9K · 📥 16K · 📋 24K - 8% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 160 · 🔀 1.1K · 📦 6K · 📋 1K - 10% open · ⏱️ 04.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/supervisor) (📥 960K / month):
	```
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 18 · 🔀 1.7K · 📋 1.6K - 23% open · ⏱️ 06.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/fabric) (📥 990K / month):
	```
	pip install fabric
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 200 · 📦 270 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools) (📥 3.8K / month):
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 50 · 🔀 120 · 📦 27 · 📋 440 - 11% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 6.1K / month):
	```
	pip install pyinfra
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 560 · 🔀 2.2K · 📦 1.5K · 📋 900 - 6% open · ⏱️ 16.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/luigi) (📥 800K / month):
	```
	pip install luigi
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 460 · 🔀 1.3K · 📦 29K · 📋 3.7K - 18% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/dask/dask
	```
- [PyPi](https://pypi.org/project/dask) (📥 4.6M / month):
	```
	pip install dask
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 2.7K · 📦 2.4K · 📋 7K - 21% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 91 · 🔀 470 · 📦 790 · 📋 430 - 47% open · ⏱️ 09.10.2020):

	```
	git clone https://github.com/robinhood/faust
	```
- [PyPi](https://pypi.org/project/faust) (📥 1.2M / month):
	```
	pip install faust
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 400 · 🔀 1.6K · 📥 710K · 📦 18K · 📋 4.2K - 7% open · ⏱️ 28.06.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 570K / month):
	```
...
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈23 ·  ⭐ 990) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 16 · 🔀 130 · 📥 18 · 📦 220 · 📋 510 - 1% open · ⏱️ 30.06.2021):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 55K / month):
	```
	pip install pyarmor
	```
...
<details><summary><b><a href="https://github.com/linkedin/shiv">shiv</a></b> (🥉20 ·  ⭐ 1.2K) - A command line utility for building fully self-contained zipapps (PEP 441),.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 33 · 🔀 68 · 📥 140 · 📋 82 - 26% open · ⏱️ 28.06.2021):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 8.2K / month):
	```
	pip install shiv
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.4K · 📦 150K · 📋 5.4K - 13% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 30 · 🔀 100 · 📦 340 · 📋 170 - 2% open · ⏱️ 16.06.2021):
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 130 · 📦 220 · 📋 55 - 49% open · ⏱️ 20.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pycco) (📥 3.5K / month):
	```
	pip install pycco
	```
...
- [GitHub](https://github.com/jindaxiang/akshare) (👨‍💻 15 · 🔀 750 · 📦 85 · 📋 230 - 0% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 12K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/s3tools/s3cmd) (👨‍💻 200 · 🔀 770 · 📥 2.9M · 📋 770 - 31% open · ⏱️ 25.04.2021):
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 19 · 🔀 140 · 📦 800 · 📋 50 - 24% open · ⏱️ 08.06.2021):
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 25 · 📦 210 · 📋 23 - 30% open · ⏱️ 04.09.2016):
	...
	```
- [PyPi](https://pypi.org/project/money) (📥 33K / month):
	```
	pip install money
	```
...
<details><summary><b><a href="https://github.com/agiliq/merchant">merchant</a></b> (🥉17 ·  ⭐ 960 · 💀) - A Django app to accept payments from various payment processors. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 95 · 📦 91 · 📋 14 - 14% open · ⏱️ 22.11.2017):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 220 · 🔀 1.3K · 📥 630K · 📦 19K · 📋 13K - 8% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 73 · 🔀 640 · 📥 31K · 📋 3.9K - 16% open · ⏱️ 28.06.2021):
...
- [PyPi](https://pypi.org/project/yagmail) (📥 140K / month):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 5.9K · ⏱️ 12.05.2021):
	```
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 55 · 🔀 170 · 📦 140 · 📋 88 - 59% open · ⏱️ 29.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/flanker) (📥 60K / month):
	```
	pip install flanker
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 100 · 🔀 260 · 📦 32 · 📋 1.6K - 4% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 46 · 🔀 150 · 📦 99 · 📋 110 - 43% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/martinrusev/imbox
	```
- [PyPi](https://pypi.org/project/imbox) (📥 5.4K / month):
	```
	pip install imbox
	```
...
- [PyPi](https://pypi.org/project/mailer) (📥 25K / month):
	...
	pip install mailer
	```
- [Conda](https://anaconda.org/conda-forge/mailer) (📥 38K · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 330 · 🔀 2.1K · 📋 1.3K - 2% open · ⏱️ 29.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 6.6K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 110 · 🔀 560 · 📦 36K · 📋 520 - 26% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/gorakhargosh/watchdog
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 3.7M / month):
	```
	pip install watchdog
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 580K · ⏱️ 26.06.2021):
	```
...
- [PyPi](https://pypi.org/project/python-magic) (📥 2.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-magic) (📥 94K · ⏱️ 08.06.2021):
	```
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 130 · 🔀 340 · 📦 99K · 📋 370 - 10% open · ⏱️ 19.05.2021):

	```
	git clone https://github.com/wtforms/wtforms
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 2.5M / month):
	```
	pip install wtforms
	```
- [Conda](https://anaconda.org/conda-forge/wtforms) (📥 73K · ⏱️ 29.07.2020):
	```
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 71 · 🔀 160 · 📥 2.2K · 📦 110K · 📋 160 - 4% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/more-itertools) (📥 14M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 6.3M · ⏱️ 21.05.2021):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 69 · 🔀 200 · 📦 42K · 📋 200 - 34% open · ⏱️ 22.04.2021):

	```
	git clone https://github.com/pytoolz/toolz
	```
- [PyPi](https://pypi.org/project/toolz) (📥 5.6M / month):
	```
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 4.5M · ⏱️ 24.09.2020):
	```
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 26 · 🔀 120 · 📦 3.2K · 📋 61 - 3% open · ⏱️ 10.05.2021):

	```
	git clone https://github.com/Suor/funcy
	```
- [PyPi](https://pypi.org/project/funcy) (📥 510K / month):
	```
	pip install funcy
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 30 · 🔀 67 · 📦 82 · 📋 360 - 12% open · ⏱️ 28.06.2021):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 42K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 120 · ⏱️ 14.05.2021):
	```
...
- [GitHub](https://github.com/evhub/coconut) (👨‍💻 27 · 🔀 98 · 📋 490 - 13% open · ⏱️ 06.03.2021):
...
- [PyPi](https://pypi.org/project/coconut) (📥 860 / month):
	...
	pip install coconut
	```
- [Conda](https://anaconda.org/conda-forge/coconut) (📥 99K · ⏱️ 06.03.2021):
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 110 · 🔀 160 · 📦 12K · 📋 250 - 19% open · ⏱️ 30.06.2021):

	```
	git clone https://github.com/pyglet/pyglet
	```
- [PyPi](https://pypi.org/project/pyglet) (📥 590K / month):
	```
	pip install pyglet
	```
- [Conda](https://anaconda.org/conda-forge/pyglet) (📥 290K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/ChrisKnott/Eel) (👨‍💻 36 · 🔀 430 · 📦 2.1K · 📋 390 - 29% open · ⏱️ 17.08.2020):
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 99 · 🔀 730 · 📥 90 · 📦 370 · 📋 460 - 16% open · ⏱️ 12.06.2021):
...
- [PyPi](https://pypi.org/project/Gooey) (📥 4.7K / month):
	...
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 33K · ⏱️ 13.06.2021):
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.1K · 📦 2.8K · 📋 2.3K - 31% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 71K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 33K · ⏱️ 21.06.2021):
	```
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 240 · 📦 90 · 📋 420 - 18% open · ⏱️ 02.06.2021):

	```
	git clone https://github.com/zoofIO/flexx
	```
- [PyPi](https://pypi.org/project/flexx) (📥 820 / month):
	```
	pip install flexx
	```
...
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉22 ·  ⭐ 5.4K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 250 · 📦 140 · 📋 540 - 8% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 330 · 📦 450 · 📋 530 - 5% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 190 · 🔀 480 · 📋 490 - 24% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 33 · 🔀 97 · 📥 45 · 📦 180 · 📋 200 - 18% open · ⏱️ 24.05.2021):
...
- [PyPi](https://pypi.org/project/enaml) (📥 3.1K / month):
	...
	pip install enaml
	```
- [Conda](https://anaconda.org/conda-forge/enaml) (📥 83K · ⏱️ 19.04.2021):
	```
...
<details><summary><b><a href="https://github.com/graphql-python/graphene">graphene</a></b> (🥇24 ·  ⭐ 6.7K) - GraphQL framework for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/graphql-python/graphene) (🔀 690 · 📦 9.4K · 📋 890 - 9% open · ⏱️ 23.04.2021):
...
<details><summary><b><a href="https://github.com/geopy/geopy">geopy</a></b> (🥇32 ·  ⭐ 3.4K) - Python Geocoding Toolbox. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 44 · 🔀 84 · 📦 7K · 📋 75 - 29% open · ⏱️ 21.03.2021):
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 34 · 🔀 98 · 📦 610K · 📋 75 - 1% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/pallets/markupsafe
	```
- [PyPi](https://pypi.org/project/markupsafe) (📥 68M / month):
	```
...
- [PyPi](https://pypi.org/project/xmltodict) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/xmltodict) (📥 950K · ⏱️ 11.02.2019):
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 71 · 🔀 200 · 📦 130K · 📋 320 - 14% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/html5lib/html5lib-python) (👨‍💻 62 · 🔀 250 · 📦 93K · 📋 240 - 33% open · ⏱️ 19.05.2021):
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 680 · 🔀 8.1K · 📦 1M · 📋 3.4K - 7% open · ⏱️ 01.06.2021):
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 280 · 🔀 820 · 📥 340 · 📦 590K · 📋 930 - 15% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 130 · 🔀 460 · 📦 7.8K · 📋 600 - 6% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 44 · 🔀 130 · 📥 84 · 📦 840 · 📋 140 - 37% open · ⏱️ 24.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/treq) (📥 79K / month):
	```
	pip install treq
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 340 · 🔀 1.4K · 📦 5.5K · 📋 1.2K - 3% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 31 · 🔀 280 · 📦 3.8K · 📋 410 - 62% open · ⏱️ 20.06.2021):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 150K / month):
	```
	pip install keyboard
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 410 · ⏱️ 15.06.2021):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 77 · 📦 340 · 📋 78 - 69% open · ⏱️ 05.04.2021):
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 360 · 🔀 1.5K · 📦 500K · 📋 2.2K - 6% open · ⏱️ 01.07.2021):
...
- [PyPi](https://pypi.org/project/Pillow) (📥 34M / month):
	...
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 9.1M · ⏱️ 01.07.2021):
	```
	conda install -c conda-forge Pillow
	```
</details>
<details><summary><b><a href="https://github.com/thumbor/thumbor">thumbor</a></b> (🥇28 ·  ⭐ 8.4K) - A smart imaging service. It enables on-demand crop, re-sizing and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 160 · 🔀 690 · 📦 280 · 📋 840 - 13% open · ⏱️ 13.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 9.1K / month):
	```
	pip install thumbor
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 95 · 🔀 180 · 📥 5.2K · 📦 5.2K · 📋 350 - 4% open · ⏱️ 14.06.2021):

	```
	git clone https://github.com/dahlia/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 420K / month):
	```
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 5.2K · ⏱️ 30.11.2020):
	```
...
- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 57 · 🔀 210 · 📥 510 · 📦 120 · 📋 440 - 18% open · ⏱️ 27.09.2020):
...
<details><summary><b><a href="https://github.com/WhyNotHugo/python-barcode">python-barcode</a></b> (🥈24 ·  ⭐ 260) - Create barcodes in Python with no extra dependencies. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 36 · 🔀 78 · 📥 160 · 📦 6.9K · 📋 74 - 37% open · ⏱️ 07.04.2021):
...
- [PyPi](https://pypi.org/project/python-barcode) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 3.2K · ⏱️ 22.08.2020):
	```
	conda install -c conda-forge python-barcode
	```
</details>
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥉22 ·  ⭐ 330 · 📈) - A fast image processing library with low memory needs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 11 · 🔀 29 · 📦 200 · 📋 230 - 34% open · ⏱️ 28.06.2021):
...
- [PyPi](https://pypi.org/project/pyvips) (📥 13K / month):
	...
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 9.7K · ⏱️ 28.06.2021):
	```
...
- [GitHub](https://github.com/hhatto/nude.py) (👨‍💻 12 · 🔀 130 · 📦 440 · 📋 9 - 77% open · ⏱️ 23.11.2020):
...
- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 41 · 🔀 430 · 📋 140 - 17% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 110 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 520 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 29 · 🔀 180 · 📥 4.9K · 📦 2K · 📋 380 - 45% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 420 · 🔀 3.4K · 📥 19K · 📋 3.7K - 26% open · ⏱️ 01.07.2021):
...
- [PyPi](https://pypi.org/project/micropython):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micropython) (📥 3.4K · ⏱️ 18.06.2021):
	```
...
- [GitHub](https://github.com/python/cpython) (👨‍💻 1.7K · 🔀 19K · ⏱️ 01.07.2021):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 6.7K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 840 · 🔀 49 · 📋 250 - 4% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 48 · 🔀 240 · 📦 1.4K · 📋 320 - 55% open · ⏱️ 26.06.2021):
...
- [PyPi](https://pypi.org/project/ptpython) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 1.4K · ⏱️ 26.06.2021):
	```
...
- [PyPi](https://pypi.org/project/pyicu) (📥 580K / month):
	...
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 58K · ⏱️ 15.01.2021):
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 45 · 🔀 720 · 📦 12K · 📋 330 - 26% open · ⏱️ 26.06.2021):

	```
	git clone https://github.com/dbader/schedule
	```
- [PyPi](https://pypi.org/project/schedule) (📥 1.4M / month):
	```
	pip install schedule
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 7.1K · ⏱️ 10.04.2021):
	```
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 64 · 📋 9 - 11% open · ⏱️ 14.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/plan) (📥 450 / month):
	```
	pip install plan
	```
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥇30 ·  ⭐ 9.2K · 📉) - Library which aims to bring enjoyable logging in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 99 · 🔀 210 · 📥 4.5K · 📦 12K · 📋 520 - 28% open · ⏱️ 14.06.2021):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 520 · 🔀 7.6K · 📥 2.6K · 📦 19K · 📋 4.1K - 6% open · ⏱️ 30.06.2021):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 6.3M / month):
	```
	pip install xgboost
	```
...
- [PyPi](https://pypi.org/project/gym) (📥 650K / month):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 53K · ⏱️ 30.04.2021):
	```
	conda install -c conda-forge gym
	```
</details>
<details><summary><b><a href="https://github.com/numenta/nupic">NuPIC</a></b> (🥈24 ·  ⭐ 6.2K · 💀) - Numenta Platform for Intelligent Computing. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 210 · 🔀 1.8K · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 56 · 🔀 440 · 📋 600 - 10% open · ⏱️ 15.06.2021):
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 67 · 🔀 590 · 📥 470K · 📦 46K · 📋 1.5K - 27% open · ⏱️ 24.06.2021):
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 36 · 🔀 180 · 📦 450K · ⏱️ 01.07.2021):

	```
	git clone https://github.com/pallets/itsdangerous
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 30M / month):
	```
...
- [GitHub](https://github.com/jek/blinker) (👨‍💻 11 · 🔀 150 · 📦 74K · 📋 34 - 52% open · ⏱️ 29.01.2021):

	```
	git clone https://github.com/jek/blinker
	```
- [PyPi](https://pypi.org/project/blinker) (📥 4.3M / month):
	```
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 2.8M · ⏱️ 20.06.2018):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 150 · 🔀 3.4K · 📦 300 · 📋 840 - 33% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 850 · ⏱️ 16.05.2021):

	```
	git clone https://github.com/mitsuhiko/pluginbase
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 380K / month):
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 410 · 🔀 3.8K · 📥 3.3K · 📦 25K · 📋 1.6K - 20% open · ⏱️ 29.06.2021):
...
- [PyPi](https://pypi.org/project/gensim) (📥 7.9M / month):
	...
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 680K · ⏱️ 15.06.2021):
	```
...
- [PyPi](https://pypi.org/project/jieba) (📥 460K / month):
	...
	pip install jieba
	```
- [Conda](https://anaconda.org/conda-forge/jieba) (📥 84K · ⏱️ 30.05.2021):
	```
...
- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 38 · 🔀 700 · 📦 530 · 📋 530 - 11% open · ⏱️ 08.06.2021):
...
- [PyPi](https://pypi.org/project/stanza) (📥 45K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 800 · ⏱️ 28.01.2021):
	```
	conda install -c conda-forge stanza
	```
</details>
<details><summary><b><a href="https://github.com/PetrochukM/PyTorch-NLP">PyTorch-NLP</a></b> (🥈23 ·  ⭐ 1.9K) - A toolkit enabling rapid deep learning NLP prototyping for research. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 300 · 📦 520 · 📋 200 - 67% open · ⏱️ 22.09.2020):
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 200 · 🔀 780 · 📥 240 · 📦 86 · 📋 130 - 43% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 630 · 📋 99 - 34% open · ⏱️ 19.01.2020):
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 270 · 📦 740 · 📋 70 - 35% open · ⏱️ 15.07.2017):
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 10 · 🔀 8.9K · 📋 40 - 30% open · ⏱️ 13.07.2020):
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 76 · 🔀 1.4K · 📥 380K · 📦 97 · 📋 630 - 40% open · ⏱️ 28.03.2021):

	```
	git clone https://github.com/mininet/mininet
	```
- [PyPi](https://pypi.org/project/mininet) (📥 930 / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 420 · 📋 170 - 24% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 770K / month):
	```
	pip install pox
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 140 · 🔀 1.2K · 📦 13K · 📋 2K - 0% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 88 · 🔀 350 · 📦 740 · 📋 440 - 38% open · ⏱️ 29.06.2021):

	```
	git clone https://github.com/pynamodb/PynamoDB
	```
- [PyPi](https://pypi.org/project/PynamoDB) (📥 710K / month):
	```
	pip install PynamoDB
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 100K · ⏱️ 29.06.2021):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 74 · 🔀 270 · 📦 2K · 📋 260 - 4% open · ⏱️ 25.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/dataset) (📥 87K / month):
	```
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 430 · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 190 · 📦 2K · 📋 550 - 44% open · ⏱️ 28.02.2021):
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 10 · 🔀 78 · 📋 56 - 48% open · ⏱️ 06.04.2020):
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 280 · 🔀 1.2K · 📥 7M · 📋 2.9K - 33% open · ⏱️ 27.06.2021):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 2.6M / month):
	```
	pip install poetry
	```
...
- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 150 · 🔀 390 · 📋 730 - 15% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 2.6M / month):
	```
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 79 · 🔀 82 · 📦 150 · 📋 650 - 13% open · ⏱️ 25.06.2021):

	```
	git clone https://github.com/devpi/devpi
	```
- [PyPi](https://pypi.org/project/devpi) (📥 4K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypa/warehouse) (👨‍💻 300 · 🔀 700 · 📋 2.3K - 13% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 86 · 📋 170 - 11% open · ⏱️ 28.06.2021):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.2K · 📋 4.3K - 1% open · ⏱️ 24.06.2021):
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉18 ·  ⭐ 6.8K · 💤) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 21 · 🔀 1.5K · 📋 99 - 8% open · ⏱️ 16.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 410 / month):
	```
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 500 · 📦 4.2K · 📋 420 - 23% open · ⏱️ 02.06.2021):
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 21 · 🔀 100 · 📦 640 · 📋 95 - 17% open · ⏱️ 23.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 430 / month):
	```
...
- [GitHub](https://github.com/benfred/implicit) (👨‍💻 29 · 🔀 480 · 📦 440 · 📋 350 - 23% open · ⏱️ 08.05.2021):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 590 · 📦 500 · 📋 420 - 18% open · ⏱️ 07.02.2021):
...
- [PyPi](https://pypi.org/project/lightfm) (📥 150K / month):
	...
	pip install lightfm
	```
- [Conda](https://anaconda.org/conda-forge/lightfm) (📥 97K · ⏱️ 07.02.2021):
	```
...
- [GitHub](https://github.com/NicolasHug/Surprise) (👨‍💻 38 · 🔀 860 · 📦 1.2K · 📋 330 - 12% open · ⏱️ 05.08.2020):
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 8 · 🔀 220 · 📦 26 · 📋 120 - 27% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 700 / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 190 · 📥 390 · 📦 82 · 📋 100 - 42% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 670 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 63 · 🔀 120 · 📦 30K · 📋 180 - 36% open · ⏱️ 20.05.2021):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 450K / month):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 170 · 🔀 810 · 📥 840 · 📦 5.6K · 📋 900 - 21% open · ⏱️ 26.06.2021):
...
- [PyPi](https://pypi.org/project/falcon) (📥 570K / month):
	...
	pip install falcon
	```
- [Conda](https://anaconda.org/conda-forge/falcon) (📥 200K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 300 · 🔀 1.3K · 📦 5.5K · 📋 1K - 3% open · ⏱️ 27.06.2021):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 6.2M / month):
	```
	pip install sanic
	```
- [Conda](https://anaconda.org/conda-forge/sanic) (📥 140K · ⏱️ 28.06.2021):
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥈29 ·  ⭐ 33K) - A modern, fast, web framework for building APIs with Python 3.6+ based on.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 220 · 🔀 2.3K · 📋 2.2K - 28% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 32 · 🔀 150 · 📦 4.5K · 📋 60 - 15% open · ⏱️ 15.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/flask-api) (📥 360K / month):
	```
...
<details><summary><b><a href="https://github.com/Cornices/cornice">cornice</a></b> (🥉23 ·  ⭐ 360) - A RESTful framework for Pyramid. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 87 · 🔀 3.9K · 📋 240 - 2% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.3K · 📥 430K · 📦 33K · 📋 11K - 33% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 1.4M / month):
	```
	pip install sympy
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 320 · 🔀 2.1K · 📥 25 · 📦 45K · 📋 4.3K - 45% open · ⏱️ 24.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 5.6M / month):
	```
	pip install statsmodels
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 4.3M · ⏱️ 15.02.2021):
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 150 · 🔀 3.7K · 📦 740 · 📋 960 - 31% open · ⏱️ 14.10.2020):

	```
	git clone https://github.com/quantopian/zipline
	```
- [PyPi](https://pypi.org/project/zipline) (📥 5.9K / month):
	```
	pip install zipline
	```
- [Conda](https://anaconda.org/conda-forge/zipline) (📥 4.4K · ⏱️ 05.10.2020):
	```
...
- [GitHub](https://github.com/pymc-devs/pymc3) (👨‍💻 320 · 🔀 1.3K · 📥 160 · 📦 2.7K · 📋 2.3K - 8% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/pymc-devs/pymc3
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 430K / month):
	```
	pip install pymc3
	```
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 12 · 🔀 150 · 📦 47 · 📋 57 - 1% open · ⏱️ 19.05.2021):

	```
	git clone https://github.com/benedekrozemberczki/karateclub
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 6.7K / month):
	```
	pip install karateclub
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 4.1K · ⏱️ 20.05.2021):
	```
...
- [GitHub](https://github.com/obspy/obspy) (🔀 430 · 📥 6.6K · 📋 1.5K - 18% open · ⏱️ 29.06.2021):
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 64 · 🔀 290 · 📦 2.3K · 📋 130 - 12% open · ⏱️ 17.05.2021):
...
<details><summary><b><a href="https://github.com/elastic/elasticsearch-dsl-py">elasticsearch-dsl-py</a></b> (🥉23 ·  ⭐ 3.3K · 💤) - The official high-level Python client for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 190 · 🔀 540 · 📦 30K · 📋 1K - 9% open · ⏱️ 28.06.2021):
...
- [PyPi](https://pypi.org/project/marshmallow) (📥 8.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 620K · ⏱️ 11.05.2021):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 18 · 🔀 38 · 📦 1.4K · 📋 97 - 9% open · ⏱️ 25.06.2021):

	```
	git clone https://github.com/python-rapidjson/python-rapidjson
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 560K / month):
	```
	pip install python-rapidjson
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 550K · ⏱️ 25.06.2021):
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 12 · 🔀 34 · 📦 94 · 📋 66 - 13% open · ⏱️ 21.06.2021):

	```
	git clone https://github.com/TkTech/pysimdjson
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 79K / month):
	```
	pip install pysimdjson
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 9.9K · ⏱️ 21.06.2021):
	```
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 47 · 🔀 210 · 📦 140 · 📋 86 - 39% open · ⏱️ 02.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 5.8K / month):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 470 · 📥 4.6K · 📦 210 · 📋 2.1K - 12% open · ⏱️ 01.07.2021):
...
- [PyPi](https://pypi.org/project/mistune) (📥 11M / month):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 4.3M · ⏱️ 29.06.2021):
	```
...
- [PyPi](https://pypi.org/project/tablib) (📥 840K / month):
	...
	pip install tablib
	```
- [Conda](https://anaconda.org/conda-forge/tablib) (📥 64K · ⏱️ 05.12.2020):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 54 · 🔀 360 · 📥 25K · 📦 17K · 📋 1.3K - 23% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 500K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 350K · ⏱️ 27.06.2021):
	```
...
- [GitHub](https://github.com/mstamy2/PyPDF2) (👨‍💻 83 · 🔀 850 · 📦 19K · 📋 410 - 74% open · ⏱️ 25.06.2018):
...
<details><summary><b><a href="https://github.com/unoconv/unoconv">unoconv</a></b> (🥉24 ·  ⭐ 2.1K) - Convert between any document format supported by.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 51 · 🔀 360 · 📦 72 · 📋 460 - 25% open · ⏱️ 24.06.2021):

	```
	git clone https://github.com/unoconv/unoconv
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 12K / month):
	```
	pip install unoconv
	```
...
<details><summary><b><a href="https://github.com/pyexcel/pyexcel">pyexcel</a></b> (🥉24 ·  ⭐ 930) - Providing one API for reading, manipulating and writing csv, ods,.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 140 · 🔀 620 · 📦 140K · 📋 700 - 3% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 310 · 📋 610 - 43% open · ⏱️ 17.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-pptx) (📥 670K / month):
	```
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 41 · 🔀 260 · 📦 770 · 📋 290 - 19% open · ⏱️ 09.05.2021):
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 59 · 📦 6 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 74 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 420 · 🔀 1.7K · 📥 370 · 📦 5.1K · 📋 1.5K - 2% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 130 · 🔀 520 · 📋 360 - 17% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/django-taggit) (📥 270K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-taggit) (📥 80K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 240 · 🔀 1.2K · 📦 8.3K · 📋 870 - 16% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/rq) (📥 480K / month):
	...
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 55K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 65 · 🔀 180 · 📥 27 · 📦 280 · 📋 240 - 8% open · ⏱️ 26.06.2021):
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 37 · 🔀 110 · 📦 23 · 📋 170 - 30% open · ⏱️ 13.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrq) (📥 390 / month):
	```
	pip install mrq
	```
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 280 · 🔀 1.4K · 📥 52K · 📦 670K · 📋 780 - 5% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/pallets/jinja
	```
- [PyPi](https://pypi.org/project/jinja) (📥 9.7K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 400 · 🔀 1.4K · 📦 31K · 📋 490 - 23% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/faker) (📥 4.5M / month):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 450K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 200 · 🔀 2.1K · 📦 1.4K · 📋 1.2K - 2% open · ⏱️ 26.06.2021):

	```
	git clone https://github.com/locustio/locust
	```
- [PyPi](https://pypi.org/project/locust) (📥 310K / month):
	```
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 31K · ⏱️ 27.06.2021):
	```
	conda install -c conda-forge locust
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇32 ·  ⭐ 6.1K) - A generic test automation framework. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 140 · 🔀 1.7K · 📥 510 · 📦 3.9K · 📋 3.6K - 4% open · ⏱️ 30.06.2021):
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 96 · 🔀 250 · 📥 1 · 📦 9.8K · 📋 180 - 32% open · ⏱️ 27.04.2021):
...
- [PyPi](https://pypi.org/project/responses) (📥 4.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 620K · ⏱️ 27.04.2021):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 480 · 📦 4.8K · 📋 490 - 13% open · ⏱️ 01.07.2021):
...
- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 250 · 🔀 440 · 📦 9.1K · 📋 1.1K - 5% open · ⏱️ 15.06.2021):
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 94 · 🔀 200 · 📦 8.3K · 📋 230 - 27% open · ⏱️ 18.06.2021):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 4.4M / month):
	```
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈28 ·  ⭐ 5.2K) - PyAutoGUI is a cross-platform GUI automation Python module for human.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 50 · 🔀 710 · 📦 8.6K · 📋 470 - 63% open · ⏱️ 18.04.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 410K / month):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 100 · 🔀 270 · 📥 160 · 📋 290 - 1% open · ⏱️ 28.06.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 82K / month):
	```
	pip install mimesis
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 120 · 🔀 320 · 📋 480 - 27% open · ⏱️ 25.06.2021):
...
- [GitHub](https://github.com/CleanCut/green) (👨‍💻 37 · 🔀 69 · 📦 580 · 📋 170 - 3% open · ⏱️ 28.04.2021):
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 120 · 📦 3.8K · 📋 250 - 21% open · ⏱️ 10.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 430K / month):
	```
	pip install nose2
	```
...
<details><summary><b><a href="https://github.com/schemathesis/schemathesis">Schemathesis</a></b> (🥉22 ·  ⭐ 900) - A tool for automatic property-based testing of web applications.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 29 · 🔀 63 · 📋 540 - 15% open · ⏱️ 23.06.2021):
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 150 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 160K / month):
	```
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 110 · 📦 13 · 📋 22 - 31% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/fake2db) (📥 160 / month):
	```
	pip install fake2db
	```
...
- [PyPi](https://pypi.org/project/chardet) (📥 110M / month):
	...
	pip install chardet
	```
- [Conda](https://anaconda.org/conda-forge/chardet) (📥 11M · ⏱️ 28.06.2021):
	```
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 32 · 🔀 170 · 📥 5.5K · 📦 340K · 📋 170 - 23% open · ⏱️ 14.05.2021):
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 68 · 🔀 830 · 📦 9.2K · 📋 170 - 42% open · ⏱️ 20.02.2021):
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 30 · 🔀 84 · 📦 18K · 📋 49 - 2% open · ⏱️ 12.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-slugify) (📥 3.4M / month):
	```
	pip install python-slugify
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 370K · ⏱️ 06.05.2021):
	```
...
- [PyPi](https://pypi.org/project/shortuuid) (📥 1.1M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 91K · ⏱️ 07.04.2021):
	```
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 91 · 🔀 480 · 📋 440 - 40% open · ⏱️ 12.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sqlparse) (📥 15M / month):
	```
	pip install sqlparse
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 410K · ⏱️ 08.10.2020):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 10 · 🔀 160 · 📥 100 · 📦 720 · ⏱️ 22.06.2021):
...
- [PyPi](https://pypi.org/project/textdistance) (📥 280K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 42K · ⏱️ 29.01.2021):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 20 · 🔀 490 · 📦 1.2K · 📋 190 - 13% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 64 / month):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 20 · 🔀 87 · 📦 11K · 📋 40 - 20% open · ⏱️ 08.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 560K / month):
	```
	pip install pyfiglet
	```
- [Conda](https://anaconda.org/conda-forge/pyfiglet) (📥 63K · ⏱️ 18.05.2019):
	```
	conda install -c conda-forge pyfiglet
	```
</details>
<details><summary><b><a href="https://github.com/dabeaz/ply">ply</a></b> (🥉21 ·  ⭐ 1.9K · 💀) - Implementation of lex and yacc parsing tools for Python. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/ply) (📥 3.3M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 770K · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 28 · 🔀 180 · 📦 2.9K · 📋 64 - 51% open · ⏱️ 16.03.2021):
...
- [GitHub](https://github.com/LuminosoInsight/python-ftfy) (👨‍💻 18 · 🔀 100 · 📦 3.5K · 📋 120 - 10% open · ⏱️ 17.05.2021):
...
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 53K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/awesome-slugify) (📥 51K · ⏱️ 28.06.2019):
	```
...
- [GitHub](https://github.com/ztane/python-Levenshtein) (🔀 140 · 📦 8.5K · 📋 53 - 79% open · ⏱️ 01.02.2021):
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 22 · 🔀 320 · 📋 120 - 1% open · ⏱️ 25.06.2021):
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 21 · 📦 31 · 📋 7 - 28% open · ⏱️ 09.02.2019):
...
- [GitHub](https://github.com/davidaurelio/hashids-python) (👨‍💻 10 · 🔀 87 · 📋 22 - 22% open · ⏱️ 07.09.2020):
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 120 · 🔀 1.3K · 📦 120K · 📋 2.4K - 11% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/boto3) (📥 130M / month):
	...
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 5.9M · ⏱️ 01.07.2021):
	```
...
- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 170 · 🔀 1.9K · 📥 90 · 📦 65K · 📋 790 - 4% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 25M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 760K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 120 · 🔀 790 · 📦 11K · 📋 630 - 14% open · ⏱️ 30.06.2021):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 3M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 380 · 📦 4.5K · 📋 320 - 6% open · ⏱️ 14.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/twython) (📥 78K / month):
	```
	pip install twython
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 6 · 🔀 130 · 📥 350 · 📦 110 · 📋 160 - 2% open · ⏱️ 25.04.2021):
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 160 · 🔀 350 · 📦 1.8K · 📋 430 - 28% open · ⏱️ 09.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 76K / month):
	```
...
- [PyPi](https://pypi.org/project/django-storages) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 27K · ⏱️ 21.11.2019):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 800 · 📦 4.8K · 📋 330 - 39% open · ⏱️ 10.05.2020):
...
- [PyPi](https://pypi.org/project/requests-html) (📥 740K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 34 · ⏱️ 26.06.2021):
	```
...
- [PyPi](https://pypi.org/project/sumy) (📥 26K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 88 · ⏱️ 22.06.2021):
	```
...
- [GitHub](https://github.com/Alir3z4/html2text) (👨‍💻 76 · 🔀 190 · 📋 180 - 34% open · ⏱️ 13.06.2021):

	```
	git clone https://github.com/Alir3z4/html2text
	```
- [PyPi](https://pypi.org/project/html2text) (📥 790K / month):
	```
	pip install html2text
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 5.3K · ⏱️ 09.02.2020):
	```
...
- [PyPi](https://pypi.org/project/micawber) (📥 15K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 570 · ⏱️ 04.06.2021):
	```
...
- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 30 · 🔀 420 · 📋 190 - 37% open · ⏱️ 14.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/textract) (📥 55K / month):
	```
...
- [GitHub](https://github.com/buriy/python-readability) (👨‍💻 36 · 🔀 320 · 📦 780 · 📋 91 - 30% open · ⏱️ 19.11.2020):
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 210 · 📋 53 - 9% open · ⏱️ 28.06.2021):

	```
	git clone https://github.com/gaojiuli/toapi
	```
- [PyPi](https://pypi.org/project/toapi) (📥 250 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/lorien/grab) (👨‍💻 65 · 🔀 250 · 📦 310 · 📋 220 - 12% open · ⏱️ 08.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/grab) (📥 5.6K / month):
	```
	pip install grab
	```
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 46 · 🔀 330 · 📥 39 · 📋 150 - 15% open · ⏱️ 09.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 370K / month):
	```
...
- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 49 · 🔀 1.3K · 📥 130 · 📦 39 · 📋 450 - 24% open · ⏱️ 10.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/portia) (📥 390 / month):
	```
	pip install portia
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 760 · 📋 72 - 58% open · ⏱️ 07.06.2015):
	...
	```
- [PyPi](https://pypi.org/project/robobrowser) (📥 5.6K / month):
	```
...
🔗&nbsp;<b><a href="https://github.com/shahraizali/awesome-django">awesome-django</a></b> ( ⭐ 660 · 💤)  - The Best Django Resource, Awesome Django for mature packages.
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 73 · 🔀 98 · 📥 8 · 📋 250 - 10% open · ⏱️ 28.05.2021):
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 48 · 🔀 360 · 📦 36K · 📋 740 - 2% open · ⏱️ 26.06.2021):

	```
	git clone https://github.com/aaugustin/websockets
	```
- [PyPi](https://pypi.org/project/websockets) (📥 6.4M / month):
	```
	pip install websockets
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 790K · ⏱️ 30.06.2021):
	```
...
- [PyPi](https://pypi.org/project/channels) (📥 380K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 48K · ⏱️ 28.12.2020):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 420 · 🔀 1.5K · 📥 240 · 📦 540K · 📋 880 - 3% open · ⏱️ 01.07.2021):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 34M / month):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 40 · 🔀 180 · 📦 310 · 📋 140 - 18% open · ⏱️ 30.06.2021):
...
- [PyPi](https://pypi.org/project/bjoern) (📥 15K / month):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 49K · ⏱️ 13.10.2020):
	```
	conda install -c conda-forge bjoern
	```
</details>
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉21 ·  ⭐ 950) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/waitress) (📥 2.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/waitress) (📥 35K · ⏱️ 08.03.2021):
	```
