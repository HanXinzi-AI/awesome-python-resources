...
本资源清单包含690个python相关的开源工具资源，这些热门工具总共分成91个不同的应用领域，目前在github上已经收到3.2M个点赞。所有的工具(github项目)每周会自动从GitHub和工具维护平台采集信息，并更新排行展示。本清单参考[best-of模板](https://github.com/best-of-lists/best-of)完成，内容参考了[awesome-python](https://github.com/vinta/awesome-python)，欢迎大家提PR丰富本清单。
## Contents
...
<details><summary><b><a href="https://github.com/flask-admin/flask-admin">flask-admin</a></b> (🥇34 ·  ⭐ 5.3K) - Simple and extensible administrative interface framework for Flask. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 350 · 🔀 1.5K · 📦 19K · 📋 1.4K - 28% open · ⏱️ 20.02.2023):
...
- [PyPi](https://pypi.org/project/flask-admin) (📥 1.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-admin) (📥 140K · ⏱️ 20.02.2023):
	```
	conda install -c conda-forge flask-admin
	```
</details>
<details><summary><b><a href="https://github.com/mher/flower">flower</a></b> (🥈29 ·  ⭐ 5.6K) - Real-time monitor and web admin for Celery. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mher/flower) (👨‍💻 200 · 🔀 940 · 📦 11K · 📋 860 - 12% open · ⏱️ 14.11.2022):

	```
	git clone https://github.com/mher/flower
	```
- [PyPi](https://pypi.org/project/flower) (📥 1.5M / month):
	```
	pip install flower
	```
- [Conda](https://anaconda.org/conda-forge/flower) (📥 140K · ⏱️ 30.10.2022):
	```
...
- [GitHub](https://github.com/geex-arts/django-jet) (👨‍💻 29 · 🔀 660 · 📦 2.9K · 📋 340 - 63% open · ⏱️ 21.05.2019):

	```
	git clone https://github.com/geex-arts/django-jet
	```
- [PyPi](https://pypi.org/project/django-jet) (📥 15K / month):
	```
...
<details><summary><b><a href="https://github.com/ajenti/ajenti">ajenti</a></b> (🥉24 ·  ⭐ 7K) - The admin panel your servers deserve. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 24 · 🔀 790 · 📦 25 · 📋 1.1K - 1% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/ajenti/ajenti
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 420 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 790 · 📋 570 - 65% open · ⏱️ 03.04.2019):
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 41 · 📋 210 - 24% open · ⏱️ 11.12.2022):

	```
	git clone https://github.com/wooey/wooey
	```
- [PyPi](https://pypi.org/project/wooey) (📥 240 / month):
	```
	pip install wooey
	```
...
<details><summary><b><a href="https://github.com/jet-admin/jet-bridge">jet-bridge</a></b> (🥉17 ·  ⭐ 1.3K) - Admin panel framework for any application with nice UI (ex Jet Django). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 400 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 980 · 🔀 38K · 📦 2 · 📋 1.2K - 1% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 82M · ⏱️ 02.02.2023):
	```
	conda install -c conda-forge Python
	```
</details>
<details><summary><b><a href="https://github.com/pytransitions/transitions">transitions</a></b> (🥇29 ·  ⭐ 4.8K) - A lightweight, object-oriented finite state machine implementation. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 75 · 🔀 500 · 📦 2.9K · 📋 420 - 1% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/pytransitions/transitions
	```
- [PyPi](https://pypi.org/project/transitions) (📥 400K / month):
	```
	pip install transitions
	```
- [Conda](https://anaconda.org/conda-forge/transitions) (📥 340K · ⏱️ 02.09.2022):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 190 · 🔀 4.1K · 📦 79 · 📋 160 - 37% open · ⏱️ 12.11.2022):

	```
	git clone https://github.com/keon/algorithms
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 20K / month):
	```
	pip install algorithms
	```
- [Conda](https://anaconda.org/conda-forge/algorithms) (📥 1.3K · ⏱️ 23.04.2021):
	```
	conda install -c conda-forge algorithms
	```
</details>
<details><summary><b><a href="https://github.com/grantjenks/python-sortedcontainers">sortedcontainers</a></b> (🥉23 ·  ⭐ 2.9K) - Fast and pure-Python implementation of sorted.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/grantjenks/python-sortedcontainers) (👨‍💻 23 · 🔀 180 · 📦 100K · 📋 170 - 9% open · ⏱️ 06.11.2022):
...
<details><summary><b><a href="https://github.com/tylerlaberge/PyPattyrn">PyPattyrn</a></b> (🥉18 ·  ⭐ 1.9K · 💀) - A simple yet effective library for implementing common design.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 35 · ⏱️ 09.02.2020):

	```
	git clone https://github.com/tylerlaberge/PyPattyrn
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 2.7K / month):
	```
...
<details><summary><b><a href="https://github.com/faif/python-patterns">python-patterns</a></b> (🥉16 ·  ⭐ 37K) - A collection of design patterns in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 130 · 🔀 6.4K · 📋 82 - 10% open · ⏱️ 27.01.2023):

	```
	git clone https://github.com/faif/python-patterns
	```
- [PyPi](https://pypi.org/project/python-patterns) (📥 18 / month):
	```
...
<details><summary><b><a href="https://github.com/prabhupant/python-ds">python-ds</a></b> (🥉15 ·  ⭐ 2K) - A collection of data structure and algorithms for coding interviews. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 110 · 🔀 510 · 📋 88 - 22% open · ⏱️ 04.10.2022):

	```
	git clone https://github.com/prabhupant/python-ds
	```
- [PyPi](https://pypi.org/project/python-ds) (📥 14 / month):
	```
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇36 ·  ⭐ 6.2K · 📈) - A lightning-fast ASGI server implementation, using uvloop and.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 150 · 🔀 530 · 📦 160K · 📋 630 - 3% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 12M / month):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 1.6M · ⏱️ 23.11.2022):
	```
	conda install -c conda-forge uvicorn
	```
</details>
<details><summary><b><a href="https://github.com/django/daphne">daphne</a></b> (🥉21 ·  ⭐ 1.9K · 📉) - A HTTP, HTTP2 and WebSocket protocol server for ASGI and ASGI-HTTP. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/django/daphne) (👨‍💻 63 · 🔀 220 · 📋 300 - 10% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/django/daphne
	```
- [PyPi](https://pypi.org/project/daphne) (📥 610K / month):
	```
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 130K · ⏱️ 11.11.2022):
	```
...
🔗&nbsp;<b><a href="https://github.com/timofurrer/awesome-asyncio">awesome-asyncio</a></b> ( ⭐ 3.9K)  - A curated list of awesome Python asyncio frameworks, libraries, software..

🔗&nbsp;<b><a href="https://twistedmatrix.com/trac/">Twisted</a></b>  - An event-driven networking engine.

<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇34 ·  ⭐ 9.2K) - Ultra fast asyncio event loop. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 56 · 🔀 460 · 📥 360 · 📦 69K · 📋 300 - 18% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/MagicStack/uvloop
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 16M / month):
	```
	pip install uvloop
	```
- [Conda](https://anaconda.org/conda-forge/uvloop) (📥 550K · ⏱️ 26.10.2022):
	```
	conda install -c conda-forge uvloop
	```
</details>
<details><summary><b><a href="https://github.com/python-trio/trio">trio</a></b> (🥉30 ·  ⭐ 5.2K) - A friendly library for async concurrency and I/O. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 25K · 📋 690 - 38% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 7.2M / month):
	```
	pip install trio
	```
- [Conda](https://anaconda.org/conda-forge/trio) (📥 1M · ⏱️ 26.10.2022):
	```
...
<details><summary><b><a href="https://github.com/jiaaro/pydub">pydub</a></b> (🥇32 ·  ⭐ 6.8K) - Manipulate audio with a simple and easy high level interface. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 900 · 📦 19K · 📋 520 - 49% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 3.8M / month):
	```
	pip install pydub
	```
- [Conda](https://anaconda.org/conda-forge/pydub) (📥 40K · ⏱️ 13.03.2021):
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 8K · 📦 310 · 📋 2.6K - 18% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 2.9K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 140 · ⏱️ 01.12.2022):
	```
	conda install -c conda-forge beets
	```
</details>
<details><summary><b><a href="https://github.com/quodlibet/mutagen">mutagen</a></b> (🥈29 ·  ⭐ 1.2K) - A Python module to handle audio metadata. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/quodlibet/mutagen) (👨‍💻 40 · 🔀 130 · 📥 58K · 📦 10K · 📋 490 - 18% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/quodlibet/mutagen
	```
- [PyPi](https://pypi.org/project/mutagen) (📥 970K / month):
	```
	pip install mutagen
	```
- [Conda](https://anaconda.org/conda-forge/mutagen) (📥 150K · ⏱️ 09.10.2022):
	```
	conda install -c conda-forge mutagen
	```
</details>
<details><summary><b><a href="https://github.com/nicfit/eyeD3">eyeD3</a></b> (🥈25 ·  ⭐ 440) - A tool for working with audio files, specifically MP3 files containing.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 25 · 🔀 55 · 📥 2.5K · 📦 2.2K · 📋 190 - 24% open · ⏱️ 08.10.2022):
...
<details><summary><b><a href="https://github.com/tyiannak/pyAudioAnalysis">pyAudioAnalysis</a></b> (🥈24 ·  ⭐ 5.1K) - Audio feature extraction, classification, segmentation and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 27 · 🔀 1.1K · 📦 330 · 📋 300 - 59% open · ⏱️ 18.09.2022):

	```
	git clone https://github.com/tyiannak/pyAudioAnalysis
	```
- [PyPi](https://pypi.org/project/pyAudioAnalysis) (📥 18K / month):
	```
...
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥈24 ·  ⭐ 420) - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 23 · 🔀 99 · 📦 11K · 📋 84 - 38% open · ⏱️ 18.11.2022):
...
- [PyPi](https://pypi.org/project/audioread) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/audioread) (📥 580K · ⏱️ 29.10.2022):
	```
	conda install -c conda-forge audioread
	```
</details>
<details><summary><b><a href="https://github.com/librosa/librosa">librosa</a></b> (🥉23 ·  ⭐ 5.7K) - Python library for audio and music analysis. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/librosa/librosa) (👨‍💻 110 · 🔀 850 · 📋 1.1K - 3% open · ⏱️ 18.02.2023):

	```
	git clone https://github.com/librosa/librosa
	```
- [PyPi](https://pypi.org/project/librosa) (📥 1.5M / month):
	```
	pip install librosa
	```
...
<details><summary><b><a href="https://github.com/devsnd/tinytag">tinytag</a></b> (🥉22 ·  ⭐ 580) - A library for reading music meta data of MP3, OGG, FLAC and Wave files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 25 · 🔀 91 · 📦 700 · 📋 98 - 16% open · ⏱️ 15.01.2023):
...
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥉21 ·  ⭐ 880 · 💤) - Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/Ircam-WAM/TimeSide">TimeSide</a></b> (🥉20 ·  ⭐ 340) - Open web audio processing framework. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>

- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 58 · 📦 16 · 📋 210 - 18% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/Parisson/TimeSide
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 68 / month):
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉19 ·  ⭐ 850) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 110 · 📦 12 · 📋 40 - 32% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 430 / month):
	```
...
<details><summary><b><a href="https://github.com/worldveil/dejavu">dejavu</a></b> (🥉18 ·  ⭐ 6K · 💀) - Audio fingerprinting and recognition. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.3K · 📦 26 · 📋 220 - 41% open · ⏱️ 03.06.2020):
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 190 · 🔀 440 · 📦 330K · 📋 360 - 19% open · ⏱️ 10.01.2023):

	```
	git clone https://github.com/idan/oauthlib
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 88M / month):
	```
	pip install oauthlib
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 7.7M · ⏱️ 18.10.2022):
	```
	conda install -c conda-forge oauthlib
	```
</details>
<details><summary><b><a href="https://github.com/jpadilla/pyjwt">pyjwt</a></b> (🥈35 ·  ⭐ 4.5K) - JSON Web Token implementation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 590 · 📦 340K · 📋 390 - 3% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 100M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 9.6M · ⏱️ 20.10.2022):
	```
	conda install -c conda-forge pyjwt
	```
</details>
<details><summary><b><a href="https://github.com/pennersr/django-allauth">django-allauth</a></b> (🥈34 ·  ⭐ 7.8K) - Authentication app for Django that just works. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 620 · 🔀 2.6K · 📦 140K · 📋 1.9K - 14% open · ⏱️ 10.02.2023):

	```
	git clone https://github.com/pennersr/django-allauth
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 680K / month):
	```
	pip install django-allauth
	```
- [Conda](https://anaconda.org/conda-forge/django-allauth) (📥 86K · ⏱️ 07.06.2022):
	```
	conda install -c conda-forge django-allauth
	```
</details>
<details><summary><b><a href="https://github.com/lepture/authlib">authlib</a></b> (🥈34 ·  ⭐ 3.5K) - JavaScript Object Signing and Encryption draft implementation. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lepture/authlib) (👨‍💻 92 · 🔀 340 · 📦 25K · 📋 360 - 12% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 5M / month):
	```
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 95K · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/omab/python-social-auth) (👨‍💻 280 · 🔀 1.1K · 📦 5.6K · 📋 660 - 2% open · ⏱️ 04.02.2017):

	```
	git clone https://github.com/omab/python-social-auth
	```
- [PyPi](https://pypi.org/project/python-social-auth) (📥 34K / month):
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 10K · 📋 130 - 38% open · ⏱️ 12.02.2018):

	```
	git clone https://github.com/joestump/python-oauth2
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 44K / month):
	```
	pip install python-oauth2
	```
- [Conda](https://anaconda.org/conda-forge/python-oauth2) (📥 88K · ⏱️ 28.06.2019):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 680 · 📋 740 - 20% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/evonove/django-oauth-toolkit
	```
- [PyPi](https://pypi.org/project/django-oauth-toolkit) (📥 400K / month):
	```
...
- [GitHub](https://github.com/mpdavis/python-jose) (🔀 210 · 📋 140 - 44% open · ⏱️ 09.02.2022):
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 39 · 🔀 240 · 📋 500 - 16% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/pybuilder/pybuilder
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 19K / month):
	```
	pip install pybuilder
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 35K · ⏱️ 22.02.2023):
	```
	conda install -c conda-forge pybuilder
	```
</details>
<details><summary><b><a href="https://github.com/platformio/platformio-core">PlatformIO</a></b> (🥉20 ·  ⭐ 6.6K) - A console tool to build code with different development platforms. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 690 · 📋 3.9K - 4% open · ⏱️ 18.02.2023):
...
<details><summary><b><a href="https://github.com/python-attrs/attrs">attrs</a></b> (🥇34 ·  ⭐ 4.6K) - Replacement for `__init__`, `__eq__`, `__repr__`, etc. boilerplate in class.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 320 · 📦 630K · 📋 610 - 17% open · ⏱️ 12.02.2023):

	```
	git clone https://github.com/python-attrs/attrs
	```
- [PyPi](https://pypi.org/project/attrs) (📥 130M / month):
	```
	pip install attrs
	```
- [Conda](https://anaconda.org/conda-forge/attrs) (📥 25M · ⏱️ 21.12.2022):
	```
	conda install -c conda-forge attrs
	```
</details>
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥈27 ·  ⭐ 1.2K) - Efficient, Pythonic bidirectional map data structures and related.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 52 · 📦 12K · 📋 54 - 5% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/jab/bidict
	```
- [PyPi](https://pypi.org/project/bidict) (📥 1.3M / month):
	```
	pip install bidict
	```
- [Conda](https://anaconda.org/conda-forge/bidict) (📥 200K · ⏱️ 01.01.2023):
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 90 · 📥 31 · 📋 150 - 9% open · ⏱️ 22.02.2023):
...
<details><summary><b><a href="https://github.com/carlosescri/DottedDict">DottedDict</a></b> (🥉15 ·  ⭐ 160 · 💀) - A library that provides a method of accessing lists and dicts with.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 17 · 📥 68 · 📦 71 · 📋 9 - 77% open · ⏱️ 30.10.2015):

	```
	git clone https://github.com/carlosescri/DottedDict
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 16 / month):
	```
...
<details><summary><b><a href="https://github.com/indico/indico">indico</a></b> (🥇24 ·  ⭐ 1.4K) - A feature-rich event management system, made @.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 350 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 1.7K / month):
	```
	pip install indico
	```
...
<details><summary><b><a href="https://github.com/stephenmcd/mezzanine">mezzanine</a></b> (🥈23 ·  ⭐ 4.6K) - A powerful, consistent, and flexible content management platform. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/Kotti/Kotti">Kotti</a></b> (🥉18 ·  ⭐ 390 · 💤) - A high-level, Pythonic web application framework built on Pyramid. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 410 / month):
	```
	pip install Kotti
	```
...
<details><summary><b><a href="https://github.com/feincms/feincms">feincms</a></b> (🥉15 ·  ⭐ 850 · 💤) - One of the most advanced Content Management Systems built on Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 210 · 📋 440 - 5% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 5.2K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 52 / month):
	```
	pip install quokka
	```
...
<details><summary><b><a href="https://github.com/Suor/django-cacheops">django-cacheops</a></b> (🥇27 ·  ⭐ 1.8K) - A slick ORM cache with automatic granular event-driven.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 64 · 🔀 200 · 📦 1K · 📋 310 - 8% open · ⏱️ 22.02.2023):
...
<details><summary><b><a href="https://github.com/lericson/pylibmc">pylibmc</a></b> (🥇27 ·  ⭐ 460) - A Python wrapper around the.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 75 · 📦 4.4K · 📋 190 - 10% open · ⏱️ 26.08.2022):
...
- [PyPi](https://pypi.org/project/pylibmc) (📥 220K / month):
	...
	pip install pylibmc
	```
- [Conda](https://anaconda.org/conda-forge/pylibmc) (📥 200K · ⏱️ 30.10.2022):
	```
	conda install -c conda-forge pylibmc
	```
</details>
<details><summary><b><a href="https://github.com/bbangert/beaker">beaker</a></b> (🥉26 ·  ⭐ 500) - A WSGI middleware for sessions and caching. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 88 · 🔀 140 · 📦 4.4K · 📋 120 - 51% open · ⏱️ 04.02.2023):
...
- [PyPi](https://pypi.org/project/beaker) (📥 340K / month):
	...
	pip install beaker
	```
- [Conda](https://anaconda.org/conda-forge/beaker) (📥 67K · ⏱️ 06.02.2023):
	```
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 250 · 📋 71 - 21% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/django-cache-machine/django-cache-machine
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 6.9K / month):
	```
...
- [GitHub](https://github.com/errbotio/errbot) (🔀 580 · 📦 290 · 📋 760 - 8% open · ⏱️ 04.02.2023):
...
🔗&nbsp;<b><a href="https://github.com/DmytroLitvinov/awesome-flake8-extensions">awesome-flake8-extensions</a></b> ( ⭐ 1K)  - A curated awesome list of flake8 extensions. Feel free to..

🔗&nbsp;<b><a href="https://www.pylint.org/">pylint</a></b>  - A fully customizable source code analyzer.

🔗&nbsp;<b><a href="https://github.com/typeddjango/awesome-python-typing">awesome-python-typing</a></b> ( ⭐ 1.3K)  - Collection of awesome Python types, stubs, plugins, and tools to..

🔗&nbsp;<b><a href="http://mypy-lang.org/">mypy</a></b>  - Check variable types during compile time.

<details><summary><b><a href="https://github.com/psf/black">black</a></b> (🥇35 ·  ⭐ 31K) - The uncompromising Python code formatter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/psf/black) (👨‍💻 360 · 🔀 1.9K · 📥 27K · 📦 340K · 📋 2.2K - 15% open · ⏱️ 14.02.2023):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 19M / month):
	```
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 6.3M · ⏱️ 01.02.2023):
	```
	conda install -c conda-forge black
	```
</details>
<details><summary><b><a href="https://github.com/PyCQA/isort">isort</a></b> (🥇35 ·  ⭐ 5.6K) - A Python utility / library to sort imports. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 360K · 📋 1.2K - 10% open · ⏱️ 22.02.2023):
...
- [PyPi](https://pypi.org/project/isort) (📥 26M / month):
	...
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 4.3M · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 180 · 🔀 360 · 📦 14K · 📋 1K - 9% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 260K / month):
	```
...
<details><summary><b><a href="https://github.com/PyCQA/prospector">prospector</a></b> (🥈31 ·  ⭐ 1.8K) - A tool to analyse Python code. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 87 · 🔀 160 · 📦 4.1K · 📋 350 - 14% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 680K / month):
	```
	pip install prospector
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 59K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 850 · 📦 70K · 📋 770 - 47% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 2.9M / month):
	```
	pip install yapf
	```
- [Conda](https://anaconda.org/conda-forge/yapf) (📥 1.3M · ⏱️ 06.01.2022):
	```
	conda install -c conda-forge yapf
	```
</details>
<details><summary><b><a href="https://github.com/jendrikseipp/vulture">vulture</a></b> (🥈26 ·  ⭐ 2.4K) - A tool for finding and analysing dead Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 34 · 🔀 110 · 📦 3.6K · 📋 170 - 7% open · ⏱️ 18.02.2023):

	```
	git clone https://github.com/jendrikseipp/vulture
	```
- [PyPi](https://pypi.org/project/vulture) (📥 440K / month):
	```
	pip install vulture
	```
- [Conda](https://anaconda.org/conda-forge/vulture) (📥 66K · ⏱️ 09.01.2023):
	```
	conda install -c conda-forge vulture
	```
</details>
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈26 ·  ⭐ 980) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 46 · 🔀 93 · 📦 5.6K · 📋 140 - 32% open · ⏱️ 08.08.2022):
...
- [PyPi](https://pypi.org/project/pylama) (📥 170K / month):
	...
	pip install pylama
	```
- [Conda](https://anaconda.org/conda-forge/pylama) (📥 89K · ⏱️ 18.05.2019):
	```
	conda install -c conda-forge pylama
	```
</details>
<details><summary><b><a href="https://github.com/facebook/pyre-check">pyre-check</a></b> (🥉23 ·  ⭐ 6.2K) - Performant type checking. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 230 · 🔀 390 · 📋 340 - 31% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 66K / month):
	```
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 270 · 📦 400 · 📋 160 - 30% open · ⏱️ 28.02.2018):
...
<details><summary><b><a href="https://github.com/scottrogowski/code2flow">code2flow</a></b> (🥉20 ·  ⭐ 3.1K) - Turn your Python and JavaScript code into DOT flowcharts. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 15 · 📋 49 - 12% open · ⏱️ 08.01.2023):

	```
	git clone https://github.com/scottrogowski/code2flow
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 3.1K / month):
	```
	pip install code2flow
	```
- [Conda](https://anaconda.org/conda-forge/code2flow) (📥 2K · ⏱️ 10.01.2023):
	```
	conda install -c conda-forge code2flow
	```
</details>
<details><summary><b><a href="https://github.com/google/pytype">pytype</a></b> (🥉18 ·  ⭐ 4.1K) - Pytype checks and infers types for Python code - without.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/pytype) (👨‍💻 87 · 🔀 250 · 📋 590 - 18% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 250K / month):
	```
	pip install pytype
	```
- [Conda](https://anaconda.org/conda-forge/pytype) (📥 150K · ⏱️ 22.02.2023):
	```
...
- [GitHub](https://github.com/coala/coala) (🔀 1.3K · 📥 160 · 📦 12 · 📋 3K - 21% open · ⏱️ 11.06.2021):
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 100 · 📋 59 - 44% open · ⏱️ 12.10.2021):

	```
	git clone https://github.com/dropbox/pyannotate
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 5.3K / month):
	```
...
<details><summary><b><a href="https://github.com/Instagram/MonkeyType">MonkeyType</a></b> (🥉17 ·  ⭐ 4.1K) - A system for Python that generates static type annotations.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 20% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/Instagram/MonkeyType
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 48K / month):
	```
	pip install MonkeyType
	```
- [Conda](https://anaconda.org/conda-forge/MonkeyType) (📥 48K · ⏱️ 19.02.2022):
	```
	conda install -c conda-forge MonkeyType
	```
</details>
<details><summary><b><a href="https://github.com/python/typeshed">typeshed</a></b> (🥉15 ·  ⭐ 3.4K) - Collection of library stubs for Python, with static types. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.3K · 🔀 1.4K · 📋 2K - 7% open · ⏱️ 22.02.2023):
...
<details><summary><b><a href="https://github.com/Textualize/rich">rich</a></b> (🥇37 ·  ⭐ 42K) - Python library for rich text and beautiful formatting in the terminal. Also.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Textualize/rich) (👨‍💻 210 · 🔀 1.5K · 📦 68K · 📋 1K - 8% open · ⏱️ 19.02.2023):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 22M / month):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 3M · ⏱️ 28.01.2023):
	```
	conda install -c conda-forge rich
	```
</details>
<details><summary><b><a href="https://github.com/tqdm/tqdm">tqdm</a></b> (🥇37 ·  ⭐ 24K) - Fast, extensible progress bar for loops and CLI. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 410K · 📋 880 - 36% open · ⏱️ 03.09.2022):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 49M / month):
	```
	pip install tqdm
	```
- [Conda](https://anaconda.org/conda-forge/tqdm) (📥 18M · ⏱️ 03.09.2022):
	```
	conda install -c conda-forge tqdm
	```
</details>
<details><summary><b><a href="https://github.com/google/python-fire">python-fire</a></b> (🥈27 ·  ⭐ 24K) - A library for creating command line interfaces from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/google/python-fire) (👨‍💻 59 · 🔀 1.3K · 📦 18K · 📋 270 - 38% open · ⏱️ 13.02.2023):
...
<details><summary><b><a href="https://github.com/peterbrittain/asciimatics">asciimatics</a></b> (🥈27 ·  ⭐ 3.3K) - A package to create full-screen text UIs (from interactive.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 810 · 📋 290 - 8% open · ⏱️ 17.01.2023):

	```
	git clone https://github.com/peterbrittain/asciimatics
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 63K / month):
	```
	pip install asciimatics
	```
- [Conda](https://anaconda.org/conda-forge/asciimatics) (📥 120K · ⏱️ 10.11.2022):
	```
	conda install -c conda-forge asciimatics
	```
</details>
<details><summary><b><a href="https://github.com/rsalmei/alive-progress">alive-progress</a></b> (🥉24 ·  ⭐ 4.2K) - A new kind of Progress Bar, with real-time throughput, eta and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.6K · 📋 180 - 8% open · ⏱️ 01.01.2023):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 230K / month):
	```
	pip install alive-progress
	```
- [Conda](https://anaconda.org/conda-forge/alive-progress) (📥 26K · ⏱️ 02.01.2023):
	```
	conda install -c conda-forge alive-progress
	```
</details>
<details><summary><b><a href="https://github.com/prompt-toolkit/python-prompt-toolkit">python-prompt-toolkit</a></b> (🥉19 ·  ⭐ 8.2K) - A library for building powerful interactive command.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 650 · 📋 1K - 47% open · ⏱️ 21.02.2023):
...
- [GitHub](https://github.com/glamp/bashplotlib) (👨‍💻 20 · 🔀 84 · 📦 160 · 📋 29 - 62% open · ⏱️ 31.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/bashplotlib) (📥 6.2K / month):
	```
	pip install bashplotlib
	```
- [Conda](https://anaconda.org/conda-forge/bashplotlib) (📥 4.1K · ⏱️ 08.09.2018):
	```
...
<details><summary><b><a href="https://github.com/httpie/httpie">httpie</a></b> (🥇33 ·  ⭐ 27K) - A command line HTTP client, a user-friendly cURL replacement. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 2.5K · 📦 13K · 📋 810 - 16% open · ⏱️ 15.01.2023):
...
- [PyPi](https://pypi.org/project/httpie) (📥 170K / month):
	...
	pip install httpie
	```
- [Conda](https://anaconda.org/conda-forge/httpie) (📥 94K · ⏱️ 01.11.2022):
	```
	conda install -c conda-forge httpie
	```
</details>
<details><summary><b><a href="https://github.com/cookiecutter/cookiecutter">cookiecutter</a></b> (🥇32 ·  ⭐ 19K) - A command-line utility that creates projects from cookiecutters.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 280 · 🔀 1.8K · 📦 18K · 📋 760 - 25% open · ⏱️ 09.09.2022):
...
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.2M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 590K · ⏱️ 01.06.2022):
	```
	conda install -c conda-forge cookiecutter
	```
</details>
<details><summary><b><a href="https://github.com/nvbn/thefuck">thefuck</a></b> (🥈29 ·  ⭐ 76K) - Correcting your previous console command. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.2K · 📦 410 · 📋 660 - 31% open · ⏱️ 25.09.2022):
...
<details><summary><b><a href="https://github.com/tmux-python/tmuxp">tmuxp</a></b> (🥈27 ·  ⭐ 3.6K) - A [tmux](https://github.com/tmux/tmux) session manager. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 72 · 🔀 220 · 📦 230 · 📋 340 - 23% open · ⏱️ 19.02.2023):

	```
	git clone https://github.com/tony/tmuxp
	```
- [PyPi](https://pypi.org/project/tmuxp) (📥 5.9K / month):
	```
	pip install tmuxp
	```
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 480 · 📦 840 · 📋 660 - 22% open · ⏱️ 03.01.2023):
...
- [PyPi](https://pypi.org/project/pgcli) (📥 41K / month):
	...
	pip install pgcli
	```
- [Conda](https://anaconda.org/conda-forge/pgcli) (📥 140K · ⏱️ 16.09.2022):
	```
	conda install -c conda-forge pgcli
	```
</details>
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈25 ·  ⭐ 880) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 54 · 🔀 110 · 📦 360 · 📋 320 - 15% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 26K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 1.7K · ⏱️ 07.01.2023):
	```
	conda install -c conda-forge copier
	```
</details>
<details><summary><b><a href="https://github.com/dbcli/mycli">mycli</a></b> (🥈24 ·  ⭐ 11K) - MySQL CLI with autocompletion and syntax highlighting. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 280 · 📋 620 - 29% open · ⏱️ 08.11.2022):

	```
	git clone https://github.com/dbcli/mycli
	```
- [PyPi](https://pypi.org/project/mycli) (📥 45K / month):
	```
	pip install mycli
	```
- [Conda](https://anaconda.org/conda-forge/mycli) (📥 51K · ⏱️ 02.09.2022):
	```
	conda install -c conda-forge mycli
	```
</details>
<details><summary><b><a href="https://github.com/gleitz/howdoi">howdoi</a></b> (🥈24 ·  ⭐ 9.9K) - Instant coding answers via the command line. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 83 · 🔀 840 · 📦 450 · 📋 250 - 3% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/gleitz/howdoi
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 6.6K / month):
	```
	pip install howdoi
	```
...
<details><summary><b><a href="https://github.com/laixintao/iredis">iredis</a></b> (🥈24 ·  ⭐ 2.2K) - Redis CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 30 · 🔀 90 · 📥 11K · 📦 14 · 📋 200 - 24% open · ⏱️ 29.12.2022):
...
- [PyPi](https://pypi.org/project/iredis) (📥 1.3K / month):
	...
	pip install iredis
	```
- [Conda](https://anaconda.org/conda-forge/iredis) (📥 550 · ⏱️ 10.08.2022):
	```
...
- [GitHub](https://github.com/facebook/PathPicker) (👨‍💻 78 · 🔀 280 · 📥 45K · 📦 3 · 📋 170 - 10% open · ⏱️ 03.07.2022):

	```
	git clone https://github.com/facebook/PathPicker
	```
- [PyPi](https://pypi.org/project/PathPicker) (📥 1 / month):
	```
...
<details><summary><b><a href="https://github.com/dbcli/litecli">litecli</a></b> (🥉19 ·  ⭐ 1.8K · 💤) - SQLite CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 24 · 🔀 62 · 📦 210 · 📋 88 - 32% open · ⏱️ 11.07.2022):

	```
	git clone https://github.com/dbcli/litecli
	```
- [PyPi](https://pypi.org/project/litecli) (📥 8K / month):
	```
	pip install litecli
	```
...
<details><summary><b><a href="https://github.com/donnemartin/saws">saws</a></b> (🥉18 ·  ⭐ 5.1K · 💀) - A Supercharged [aws-cli](https://github.com/aws/aws-cli). <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 270 · 📦 38 · 📋 94 - 34% open · ⏱️ 15.01.2022):
...
- [PyPi](https://pypi.org/project/saws) (📥 410 / month):
	...
	pip install saws
	```
- [Conda](https://anaconda.org/conda-forge/saws) (📥 23K · ⏱️ 16.03.2020):
	```
	conda install -c conda-forge saws
	```
</details>
<details><summary><b><a href="https://github.com/cloudnativelabs/kube-shell">kube-shell</a></b> (🥉18 ·  ⭐ 2.2K · 💀) - An integrated shell for working with the Kubernetes CLI. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 650 · 📦 14 · 📋 70 - 82% open · ⏱️ 19.09.2018):
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 92 · 📦 18 · 📋 48 - 25% open · ⏱️ 14.08.2022):

	```
	git clone https://github.com/sloria/doitlive
	```
- [PyPi](https://pypi.org/project/doitlive) (📥 98 / month):
	```
...
<details><summary><b><a href="https://github.com/timofurrer/try">try</a></b> (🥉12 ·  ⭐ 660 · 💤) - A dead simple CLI to try out python packages - it's never been easier. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/timofurrer/try) (👨‍💻 4 · 🔀 36 · 📦 5 · 📋 13 - 30% open · ⏱️ 15.05.2022):
...
<details><summary><b><a href="https://github.com/PyCQA/modernize">modernize</a></b> (🥇17 ·  ⭐ 310 · 💀) - Modernizes Python code for eventual Python 3 migration. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 45 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 51K / month):
	```
	pip install modernize
	```
- [Conda](https://anaconda.org/conda-forge/modernize) (📥 28K · ⏱️ 04.10.2020):
	```
...
<details><summary><b><a href="https://github.com/JaidedAI/EasyOCR">EasyOCR</a></b> (🥇31 ·  ⭐ 17K) - Ready-to-use OCR with 40+ languages supported. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.4K · 📥 3.7M · 📦 2.2K · 📋 720 - 23% open · ⏱️ 06.01.2023):

	```
	git clone https://github.com/JaidedAI/EasyOCR
	```
- [PyPi](https://pypi.org/project/EasyOCR) (📥 140K / month):
	```
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 2.5K · ⏱️ 30.01.2023):
	```
	conda install -c conda-forge EasyOCR
	```
</details>
<details><summary><b><a href="https://github.com/sirfz/tesserocr">tesserocr</a></b> (🥈26 ·  ⭐ 1.8K) - Another simple, Pillow-friendly, wrapper around the `tesseract-ocr`.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sirfz/tesserocr) (👨‍💻 27 · 🔀 240 · 📦 800 · 📋 250 - 30% open · ⏱️ 26.08.2022):

	```
	git clone https://github.com/sirfz/tesserocr
	```
- [PyPi](https://pypi.org/project/tesserocr) (📥 42K / month):
	```
...
<details><summary><b><a href="https://github.com/ageitgey/face_recognition">Face Recognition</a></b> (🥈25 ·  ⭐ 47K · 💤) - Simple facial recognition library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 12K · 📥 820 · 📋 1.3K - 54% open · ⏱️ 10.06.2022):

	```
	git clone https://github.com/ageitgey/face_recognition
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 50K / month):
	```
...
<details><summary><b><a href="https://github.com/madmaze/pytesseract">pytesseract</a></b> (🥉24 ·  ⭐ 4.7K) - A wrapper for [Google Tesseract.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 41 · 🔀 630 · 📋 330 - 7% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/madmaze/pytesseract
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 720K / month):
	```
...
- [GitHub](https://github.com/sightmachine/SimpleCV) (👨‍💻 100 · 🔀 760 · 📦 390 · 📋 330 - 22% open · ⏱️ 07.04.2015):
	...
	```
- [PyPi](https://pypi.org/project/SimpleCV) (📥 1.4K / month):
	```
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉19 ·  ⭐ 7.8K) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 770 · 📥 540 · 📋 710 - 28% open · ⏱️ 23.02.2023):
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 24 · 🔀 86 · 📦 300 · 📋 73 - 43% open · ⏱️ 14.08.2022):

	```
	git clone https://github.com/soravux/scoop
	```
- [PyPi](https://pypi.org/project/scoop) (📥 2.2K / month):
	```
	pip install scoop
	```
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 33 · 🔀 170 · 📥 11 · 📦 91K · 📋 84 - 5% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/henriquebastos/python-decouple
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 1.3M / month):
	```
	pip install python-decouple
	```
- [Conda](https://anaconda.org/conda-forge/python-decouple) (📥 56K · ⏱️ 09.01.2023):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 19 · 📦 24K · 📋 150 - 35% open · ⏱️ 18.01.2023):
...
- [PyPi](https://pypi.org/project/configobj) (📥 2.9M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 560K · ⏱️ 20.01.2023):
	```
	conda install -c conda-forge configobj
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉23 ·  ⭐ 6.8K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 520 · 📦 14 · 📋 1.2K - 14% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 20K / month):
	```
	pip install hydra
	```
- [Conda](https://anaconda.org/conda-forge/hydra) (📥 14K · ⏱️ 18.01.2021):
	```
...
<details><summary><b><a href="https://github.com/paramiko/paramiko">paramiko</a></b> (🥇32 ·  ⭐ 8.2K) - The leading native Python SSHv2 protocol library. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 73K · 📋 1.5K - 51% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/paramiko/paramiko
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 33M / month):
	```
	pip install paramiko
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 2.7M · ⏱️ 26.01.2023):
	```
	conda install -c conda-forge paramiko
	```
</details>
<details><summary><b><a href="https://github.com/pyca/pynacl">pynacl</a></b> (🥉22 ·  ⭐ 940) - Python binding to the Networking and Cryptography (NaCl) library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 64 · 🔀 200 · 📋 290 - 14% open · ⏱️ 19.01.2023):
...
- [PyPi](https://pypi.org/project/pynacl) (📥 38M / month):
	...
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 3.7M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 9K · 📋 750 - 33% open · ⏱️ 15.08.2019):

	```
	git clone https://github.com/blaze/blaze
	```
- [PyPi](https://pypi.org/project/blaze) (📥 9.2K / month):
	```
	pip install blaze
	```
...
<details><summary><b><a href="https://github.com/aws/aws-sdk-pandas">AWS Data Wrangler</a></b> (🥈25 ·  ⭐ 3.3K) - Pandas on AWS. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 560 · 📥 180K · 📦 890 · 📋 860 - 4% open · ⏱️ 23.02.2023):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 18 · 📋 180 - 36% open · ⏱️ 02.12.2016):

	```
	git clone https://github.com/mining/mining
	```
- [PyPi](https://pypi.org/project/mining) (📥 12 / month):
	```
	pip install mining
	```
...
<details><summary><b><a href="https://github.com/python-jsonschema/jsonschema">jsonschema</a></b> (🥇33 ·  ⭐ 4K) - An implementation of [JSON Schema](http://json-schema.org/) for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 530 · 📦 340K · 📋 700 - 3% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/Julian/jsonschema
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 64M / month):
	```
	pip install jsonschema
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 17M · ⏱️ 30.11.2022):
	```
	conda install -c conda-forge jsonschema
	```
</details>
<details><summary><b><a href="https://github.com/pyeve/cerberus">Cerberus</a></b> (🥈31 ·  ⭐ 2.9K · 💀) - A lightweight and extensible data validation library. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 63 · 🔀 220 · 📦 13K · 📋 340 - 12% open · ⏱️ 05.05.2021):
...
- [PyPi](https://pypi.org/project/cerberus) (📥 4.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/cerberus) (📥 290K · ⏱️ 10.12.2021):
	```
	conda install -c conda-forge cerberus
	```
</details>
<details><summary><b><a href="https://github.com/keleshev/schema">schema</a></b> (🥈31 ·  ⭐ 2.7K · 💀) - A library for validating Python data structures. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 5.9K · 📋 150 - 52% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/keleshev/schema
	```
- [PyPi](https://pypi.org/project/schema) (📥 4.5M / month):
	```
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 81K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 90 · 🔀 200 · 📦 13K · 📋 240 - 16% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/alecthomas/voluptuous
	```
- [PyPi](https://pypi.org/project/voluptuous) (📥 2.3M / month):
	```
	pip install voluptuous
	```
- [Conda](https://anaconda.org/conda-forge/voluptuous) (📥 250K · ⏱️ 07.04.2022):
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 9 · 🔀 23 · 📦 65 · 📋 15 - 26% open · ⏱️ 05.01.2023):
...
- [PyPi](https://pypi.org/project/valideer) (📥 13K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/valideer) (📥 20K · ⏱️ 06.07.2018):
	```
...
🔗&nbsp;<b><a href="https://github.com/ucg8j/awesome-dash">awesome-dash</a></b> ( ⭐ 1.8K)  - A curated list of awesome Dash (plotly) resources.
...
<details><summary><b><a href="https://github.com/mwaskom/seaborn">Seaborn</a></b> (🥇38 ·  ⭐ 10K · 📈) - Statistical data visualization using Matplotlib. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 190 · 🔀 1.6K · 📥 240 · 📦 230K · 📋 2.3K - 4% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/mwaskom/seaborn
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 9.2M / month):
	```
	pip install seaborn
	```
- [Conda](https://anaconda.org/conda-forge/seaborn) (📥 6M · ⏱️ 31.12.2022):
	```
	conda install -c conda-forge seaborn
	```
</details>
<details><summary><b><a href="https://github.com/altair-viz/altair">Altair</a></b> (🥈35 ·  ⭐ 8.1K) - Declarative statistical visualization library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📥 11 · 📦 46K · 📋 1.7K - 11% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 9.6M / month):
	```
	pip install altair
	```
...
<details><summary><b><a href="https://github.com/mingrammer/diagrams">diagrams</a></b> (🥈31 ·  ⭐ 28K) - Diagram as Code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 890 · 📋 420 - 57% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 91K / month):
	```
	pip install diagrams
	```
- [Conda](https://anaconda.org/conda-forge/diagrams) (📥 150K · ⏱️ 23.01.2022):
	```
	conda install -c conda-forge diagrams
	```
</details>
<details><summary><b><a href="https://github.com/bokeh/bokeh">Bokeh</a></b> (🥉29 ·  ⭐ 17K) - Interactive Web Plotting for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/SciTools/cartopy">Cartopy</a></b> (🥉26 ·  ⭐ 1.2K) - A cartographic python library with matplotlib support. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 3.1K · 📋 1.1K - 26% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/SciTools/cartopy
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 53K / month):
	```
	pip install cartopy
	```
- [Conda](https://anaconda.org/conda-forge/cartopy) (📥 2.7M · ⏱️ 13.12.2022):
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 180 · 🔀 590 · 📦 1K · 📋 1.4K - 21% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 43K / month):
	```
	pip install vispy
	```
- [Conda](https://anaconda.org/conda-forge/vispy) (📥 350K · ⏱️ 14.11.2022):
	```
	conda install -c conda-forge vispy
	```
</details>
<details><summary><b><a href="https://github.com/has2k1/plotnine">plotnine</a></b> (🥉22 ·  ⭐ 3.4K) - A grammar of graphics for Python based on ggplot2. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 99 · 🔀 190 · 📋 540 - 13% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/has2k1/plotnine
	```
- [PyPi](https://pypi.org/project/plotnine) (📥 280K / month):
	```
...
<details><summary><b><a href="https://github.com/msiemens/tinydb">tinydb</a></b> (🥇31 ·  ⭐ 5.7K) - A tiny, document-oriented database. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 80 · 🔀 480 · 📦 10K · 📋 290 - 2% open · ⏱️ 18.02.2023):
...
- [PyPi](https://pypi.org/project/tinydb) (📥 450K / month):
	...
	pip install tinydb
	```
- [Conda](https://anaconda.org/conda-forge/tinydb) (📥 250K · ⏱️ 14.01.2023):
	```
	conda install -c conda-forge tinydb
	```
</details>
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥉24 ·  ⭐ 580) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 79 · 📦 990 · 📋 160 - 38% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/zopefoundation/ZODB
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 63K / month):
	```
	pip install ZODB
	```
- [Conda](https://anaconda.org/conda-forge/ZODB) (📥 54K · ⏱️ 09.11.2022):
	```
	conda install -c conda-forge ZODB
	```
</details>
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉20 ·  ⭐ 760 · 💀) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 120 · 📦 1.1K · 📋 57 - 28% open · ⏱️ 15.11.2019):

	```
	git clone https://github.com/patx/pickledb
	```
- [PyPi](https://pypi.org/project/pickledb) (📥 36K / month):
	```
	pip install pickledb
	```
- [Conda](https://anaconda.org/conda-forge/pickledb) (📥 3.4K · ⏱️ 17.04.2019):
	```
...
🔗&nbsp;<b><a href="https://github.com/dhamaniasad/awesome-postgres">awesome-postgres</a></b> ( ⭐ 8.4K)  - A curated list of awesome PostgreSQL software, libraries, tools and..

🔗&nbsp;<b><a href="http://initd.org/psycopg/">psycopg2</a></b>  - The most popular PostgreSQL adapter for Python.

🔗&nbsp;<b><a href="https://github.com/planetopendata/awesome-sqlite">awesome-sqlite</a></b> ( ⭐ 210)  - A collection of awesome sqlite tools, scripts, books, etc.
...
<details><summary><b><a href="https://github.com/dpkp/kafka-python">kafka-python</a></b> (🥇33 ·  ⭐ 5.1K · 💤) - The Python client for Apache Kafka. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 16K · 📋 1.4K - 16% open · ⏱️ 27.03.2022):

	```
	git clone https://github.com/dpkp/kafka-python
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 14M / month):
	```
	pip install kafka-python
	```
- [Conda](https://anaconda.org/conda-forge/kafka-python) (📥 380K · ⏱️ 30.09.2020):
	```
	conda install -c conda-forge kafka-python
	```
</details>
<details><summary><b><a href="https://github.com/mongodb/motor">motor</a></b> (🥇33 ·  ⭐ 2.1K) - The async Python driver for MongoDB. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/mongodb/motor) (👨‍💻 41 · 🔀 180 · 📦 52K · ⏱️ 17.02.2023):
...
- [PyPi](https://pypi.org/project/motor) (📥 1.2M / month):
	...
	pip install motor
	```
- [Conda](https://anaconda.org/conda-forge/motor) (📥 53K · ⏱️ 25.10.2022):
	```
	conda install -c conda-forge motor
	```
</details>
<details><summary><b><a href="https://github.com/PyMySQL/PyMySQL">PyMySQL</a></b> (🥈32 ·  ⭐ 7.2K) - A pure Python MySQL driver compatible to mysql-python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 150K · 📋 620 - 4% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/PyMySQL/PyMySQL
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 47M / month):
	```
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 1M · ⏱️ 09.01.2021):
	```
	conda install -c conda-forge PyMySQL
	```
</details>
<details><summary><b><a href="https://github.com/redis/redis-py">redis-py</a></b> (🥈27 ·  ⭐ 11K · 📉) - The Python client for Redis. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/redis/redis-py) (👨‍💻 380 · 🔀 2.2K · 📋 1.3K - 9% open · ⏱️ 19.02.2023):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 900K · ⏱️ 09.02.2023):
	```
	conda install -c conda-forge redis-py
	```
</details>
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥈25 ·  ⭐ 990) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 51 · 🔀 180 · 📦 1.3K · 📋 270 - 11% open · ⏱️ 11.02.2023):
...
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/clickhouse-driver) (📥 360K · ⏱️ 28.11.2022):
	```
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.7K · ⏱️ 24.01.2023):

	```
	git clone https://github.com/datastax/python-driver
	```
- [PyPi](https://pypi.org/project/python-driver) (📥 9 / month):
	```
...
<details><summary><b><a href="https://github.com/mongodb/mongo-python-driver">pymongo</a></b> (🥉21 ·  ⭐ 3.8K) - The official Python client for MongoDB. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 980 · ⏱️ 17.02.2023):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 160 · 📦 730 · 📋 210 - 11% open · ⏱️ 12.07.2022):

	```
	git clone https://github.com/wbolster/happybase
	```
- [PyPi](https://pypi.org/project/happybase) (📥 170K / month):
	```
	pip install happybase
	```
- [Conda](https://anaconda.org/conda-forge/happybase) (📥 120K · ⏱️ 01.07.2019):
	```
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 12 · 🔀 32 · 📦 120 · 📋 18 - 22% open · ⏱️ 16.11.2021):

	```
	git clone https://github.com/gmr/queries
	```
- [PyPi](https://pypi.org/project/queries) (📥 3.3K / month):
	```
	pip install queries
	```
...
<details><summary><b><a href="https://github.com/PyMySQL/mysqlclient">mysqlclient</a></b> (🥉16 ·  ⭐ 2.2K) - MySQL connector with Python 3 support ([mysql-.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/PyMySQL/mysqlclient) (👨‍💻 73 · 🔀 350 · 📥 5.2K · 📋 300 - 5% open · ⏱️ 17.01.2023):
...
<details><summary><b><a href="https://github.com/plasticityai/supersqlite">SuperSQLite</a></b> (🥉16 ·  ⭐ 700 · 💀) - A supercharged SQLite library built on top of.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 90 / month):
	```
...
<details><summary><b><a href="https://github.com/sdispater/pendulum">Pendulum</a></b> (🥇32 ·  ⭐ 5.3K) - Python datetimes made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 87 · 🔀 310 · 📥 72 · 📦 18K · 📋 460 - 42% open · ⏱️ 23.12.2022):

	```
	git clone https://github.com/sdispater/pendulum
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 10M / month):
	```
	pip install pendulum
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 660K · ⏱️ 04.02.2023):
	```
	conda install -c conda-forge pendulum
	```
</details>
<details><summary><b><a href="https://github.com/dateutil/dateutil">dateutil</a></b> (🥈28 ·  ⭐ 2K) - Extensions to the standard Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 420 · 📥 35K · 📦 950K · 📋 650 - 40% open · ⏱️ 03.12.2022):
...
- [PyPi](https://pypi.org/project/maya) (📥 41K / month):
	...
	pip install maya
	```
- [Conda](https://anaconda.org/conda-forge/maya) (📥 54K · ⏱️ 14.09.2022):
	```
	conda install -c conda-forge maya
	```
</details>
<details><summary><b><a href="https://github.com/myusuf3/delorean">delorean</a></b> (🥉21 ·  ⭐ 1.8K · 💤) - A library for clearing up the inconvenient truths that arise dealing.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/myusuf3/delorean) (🔀 130 · 📦 900 · 📋 64 - 42% open · ⏱️ 28.06.2022):
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 770 · 📋 40 - 7% open · ⏱️ 27.11.2020):

	```
	git clone https://github.com/zachwill/moment
	```
- [PyPi](https://pypi.org/project/moment) (📥 80K / month):
	```
	pip install moment
	```
- [Conda](https://anaconda.org/conda-forge/moment) (📥 10K · ⏱️ 31.01.2019):
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 24 · 📋 10 - 50% open · ⏱️ 02.08.2015):

	```
	git clone https://github.com/KoffeinFlummi/Chronyk
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 540 / month):
	```
	pip install Chronyk
	```
...
<details><summary><b><a href="https://github.com/shinux/PyTime">PyTime</a></b> (🥉14 ·  ⭐ 150) - An easy-to-use Python module which aims to operate date/time/datetime by.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 20 · 📦 32 · ⏱️ 05.11.2022):

	```
	git clone https://github.com/shinux/PyTime
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 1.4K / month):
	```
	pip install PyTime
	```
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇31 ·  ⭐ 9.8K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 31 · 🔀 320 · 📥 11K · 📦 2.4K · 📋 280 - 34% open · ⏱️ 09.12.2022):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 1.8M / month):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 370K · ⏱️ 09.09.2022):
	```
	conda install -c conda-forge py-spy
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/django-debug-toolbar">django-debug-toolbar</a></b> (🥇31 ·  ⭐ 7.4K) - Display various debug information for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 870 · 📥 180 · 📦 67K · 📋 830 - 7% open · ⏱️ 14.02.2023):

	```
	git clone https://github.com/jazzband/django-debug-toolbar
	```
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 1.8M / month):
	```
	pip install django-debug-toolbar
	```
- [Conda](https://anaconda.org/conda-forge/django-debug-toolbar) (📥 150K · ⏱️ 06.02.2023):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 54 · 🔀 140 · 📦 42K · 📋 180 - 31% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/gotcha/ipdb
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 2.2M / month):
	```
	pip install ipdb
	```
- [Conda](https://anaconda.org/conda-forge/ipdb) (📥 330K · ⏱️ 24.12.2022):
	```
...
- [GitHub](https://github.com/pallets-eco/flask-debugtoolbar) (👨‍💻 46 · 🔀 120 · 📦 21K · 📋 110 - 37% open · ⏱️ 17.01.2023):
...
- [PyPi](https://pypi.org/project/flask-debugtoolbar) (📥 120K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-debugtoolbar) (📥 59K · ⏱️ 30.03.2022):
	```
	conda install -c conda-forge flask-debugtoolbar
	```
</details>
<details><summary><b><a href="https://github.com/eliben/pyelftools">pyelftools</a></b> (🥈27 ·  ⭐ 1.6K) - Parsing and analyzing ELF files and DWARF debugging.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 89 · 🔀 440 · 📦 4.7K · 📋 210 - 32% open · ⏱️ 04.02.2023):
...
- [PyPi](https://pypi.org/project/pyelftools) (📥 2.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyelftools) (📥 120K · ⏱️ 29.10.2022):
	```
	conda install -c conda-forge pyelftools
	```
</details>
<details><summary><b><a href="https://github.com/inducer/pudb">pudb</a></b> (🥈26 ·  ⭐ 2.6K) - A full-screen, console-based Python debugger. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 210 · 📦 4.5K · 📋 300 - 45% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/pudb) (📥 250K / month):
	...
	pip install pudb
	```
- [Conda](https://anaconda.org/conda-forge/pudb) (📥 190K · ⏱️ 04.11.2022):
	```
	conda install -c conda-forge pudb
	```
</details>
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥈22 ·  ⭐ 6.6K) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 140 · 📋 100 - 31% open · ⏱️ 04.12.2022):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 240K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 11K · ⏱️ 21.07.2022):
	```
	conda install -c conda-forge icecream
	```
</details>
<details><summary><b><a href="https://github.com/pdbpp/pdbpp">pdb++</a></b> (🥈22 ·  ⭐ 1.1K · 💤) - Another drop-in replacement for pdb. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 41 · 🔀 56 · 📦 4.5K · 📋 200 - 37% open · ⏱️ 14.07.2022):
...
- [GitHub](https://github.com/nvdv/vprof) (👨‍💻 17 · 🔀 160 · 📦 110 · 📋 83 - 31% open · ⏱️ 15.07.2022):

	```
	git clone https://github.com/nvdv/vprof
	```
- [PyPi](https://pypi.org/project/vprof) (📥 3.8K / month):
	```
	pip install vprof
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 110 · 📦 190 · 📋 110 - 27% open · ⏱️ 16.09.2019):
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 360 · 📋 67 - 58% open · ⏱️ 05.03.2016):
	...
	```
- [PyPi](https://pypi.org/project/django-devserver) (📥 4.7K / month):
	```
...
- [GitHub](https://github.com/rkern/line_profiler) (👨‍💻 14 · 🔀 250 · 📋 140 - 36% open · ⏱️ 23.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 320K / month):
	```
	pip install line_profiler
	```
- [Conda](https://anaconda.org/conda-forge/line_profiler) (📥 320K · ⏱️ 09.12.2022):
	```
	conda install -c conda-forge line_profiler
	```
</details>
<details><summary><b><a href="https://github.com/ionelmc/python-hunter">python-hunter</a></b> (🥉18 ·  ⭐ 720) - A flexible code tracing toolkit. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 41 · 📦 110 · 📋 92 - 43% open · ⏱️ 29.10.2022):
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 620 / month):
	```
	pip install pyflame
	```
...
<details><summary><b><a href="https://github.com/ionelmc/python-manhole">manhole</a></b> (🥉17 ·  ⭐ 340) - Debugging UNIX socket connections and present the stacktraces for all.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/ionelmc/python-manhole) (👨‍💻 11 · 🔀 20 · 📦 230 · 📋 22 - 31% open · ⏱️ 17.12.2022):

	```
	git clone https://github.com/ionelmc/python-manhole
	```
- [PyPi](https://pypi.org/project/python-manhole) (📥 2 / month):
	```
...
<details><summary><b><a href="https://github.com/fabianp/memory_profiler">memory_profiler</a></b> (🥉16 ·  ⭐ 80 · 💀) - Monitor Memory usage of Python code. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 660K / month):
	```
	pip install memory_profiler
	```
- [Conda](https://anaconda.org/conda-forge/memory_profiler) (📥 280K · ⏱️ 16.11.2022):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):

	```
	git clone https://github.com/google/pyringe
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 35 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 37 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 240 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 260K · 📋 37K - 5% open · ⏱️ 22.02.2023):
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 6.1K · 📋 9.5K - 18% open · ⏱️ 26.01.2023):
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 22.02.2023):
...
- [PyPi](https://pypi.org/project/Theano) (📥 260K / month):
	...
	pip install Theano
	```
- [Conda](https://anaconda.org/conda-forge/Theano) (📥 2.3M · ⏱️ 16.03.2022):
	```
	conda install -c conda-forge Theano
	```
</details>
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥉30 ·  ⭐ 63K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.9K · 🔀 17K · 📥 11K · 📋 32K - 32% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 72K / month):
	```
	pip install pytorch
	```
- [Conda](https://anaconda.org/conda-forge/pytorch) (📥 1.3M · ⏱️ 07.02.2023):
	```
...
- [PyPi](https://pypi.org/project/caffe):
	...
	pip install caffe
	```
- [Conda](https://anaconda.org/conda-forge/caffe) (📥 110K · ⏱️ 27.06.2020):
	```
	conda install -c conda-forge caffe
	```
</details>
<details><summary><b><a href="https://github.com/SerpentAI/SerpentAI">SerpentAI</a></b> (🥉14 ·  ⭐ 6.4K · 💀) - Game agent framework. Use any video game as a deep learning sandbox. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 730 · 📥 250 · ⏱️ 22.05.2020):

	```
	git clone https://github.com/SerpentAI/SerpentAI
	```
- [PyPi](https://pypi.org/project/SerpentAI) (📥 60 / month):
	```
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇37 ·  ⭐ 9.1K) - A cross-platform process and system utilities module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 270K · 📋 1.6K - 13% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/giampaolo/psutil
	```
- [PyPi](https://pypi.org/project/psutil) (📥 62M / month):
	```
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 19M · ⏱️ 08.11.2022):
	```
	conda install -c conda-forge psutil
	```
</details>
<details><summary><b><a href="https://github.com/ansible/ansible">ansible</a></b> (🥈33 ·  ⭐ 56K) - A radically simple IT automation platform. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 27K · 📋 31K - 2% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/ansible/ansible
	```
- [PyPi](https://pypi.org/project/ansible) (📥 4.2M / month):
	```
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 820K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 17K · 📋 25K - 9% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 66K / month):
	```
	pip install salt
	```
...
<details><summary><b><a href="https://github.com/Supervisor/supervisor">supervisor</a></b> (🥈27 ·  ⭐ 7.7K) - Supervisor process control system for UNIX. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.7K · 📋 1.1K - 10% open · ⏱️ 27.12.2022):
...
- [PyPi](https://pypi.org/project/supervisor) (📥 1.8M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/supervisor) (📥 230K · ⏱️ 29.12.2022):
	```
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 130 · 📦 4.6K · 📋 100 - 11% open · ⏱️ 24.10.2022):
...
<details><summary><b><a href="https://github.com/Fizzadar/pyinfra">pyinfra</a></b> (🥉24 ·  ⭐ 2.2K) - A versatile CLI tools and python libraries to automate infrastructure. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 88 · 🔀 300 · 📦 73 · 📋 650 - 17% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 15K / month):
	```
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 440 · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 19 · 🔀 1.7K · 📋 1.7K - 23% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/fabric/fabric
	```
- [PyPi](https://pypi.org/project/fabric) (📥 3.1M / month):
	```
	pip install fabric
	```
- [Conda](https://anaconda.org/conda-forge/fabric) (📥 60K · ⏱️ 22.01.2023):
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 190 · 📦 300 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools) (📥 2.4K / month):
	```
...
- [GitHub](https://github.com/sebastien/cuisine) (👨‍💻 57 · 🔀 160 · 📦 170 · 📋 110 - 24% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/sebastien/cuisine
	```
- [PyPi](https://pypi.org/project/cuisine) (📥 740 / month):
	```
	pip install cuisine
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 600 · 🔀 2.3K · 📦 2.1K · 📋 960 - 8% open · ⏱️ 23.02.2023):
...
- [PyPi](https://pypi.org/project/luigi) (📥 660K / month):
	...
	pip install luigi
	```
- [Conda](https://anaconda.org/conda-forge/luigi) (📥 610K · ⏱️ 20.02.2023):
	```
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 46K · 📋 4.6K - 16% open · ⏱️ 23.02.2023):
...
- [PyPi](https://pypi.org/project/dask) (📥 7.1M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 8M · ⏱️ 10.02.2023):
	```
	conda install -c conda-forge dask
	```
</details>
<details><summary><b><a href="https://github.com/ray-project/ray">Ray</a></b> (🥈27 ·  ⭐ 24K) - A system for parallel and distributed Python that unifies the machine.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ray-project/ray) (🔀 4.1K · 📦 8.3K · 📋 13K - 19% open · ⏱️ 23.02.2023):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 580 · 📦 1.2K · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
...
<details><summary><b><a href="https://github.com/robinhood/faust">faust</a></b> (🥉25 ·  ⭐ 6.5K · 💀) - A stream processing library, porting the ideas from [Kafka.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/robinhood/faust) (👨‍💻 94 · 🔀 540 · 📦 1.4K · 📋 470 - 49% open · ⏱️ 09.10.2020):

	```
	git clone https://github.com/robinhood/faust
	```
- [PyPi](https://pypi.org/project/faust) (📥 28K / month):
	```
	pip install faust
	```
...
- [GitHub](https://github.com/Parsely/streamparse) (👨‍💻 43 · 🔀 210 · 📦 57 · 📋 330 - 19% open · ⏱️ 18.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/streamparse) (📥 2.4K / month):
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 740K · 📦 40K · 📋 4.8K - 5% open · ⏱️ 19.02.2023):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 1M / month):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 400K · ⏱️ 11.02.2023):
	```
	conda install -c conda-forge pyinstaller
	```
</details>
<details><summary><b><a href="https://github.com/dashingsoft/pyarmor">pyarmor</a></b> (🥈27 ·  ⭐ 2K) - A tool used to obfuscate python scripts, bind obfuscated scripts.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 27 · 🔀 210 · 📦 750 · 📋 890 - 5% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 100K / month):
	```
	pip install pyarmor
	```
...
<details><summary><b><a href="https://github.com/linkedin/shiv">shiv</a></b> (🥉19 ·  ⭐ 1.6K) - A command line utility for building fully self-contained zipapps (PEP 441),.. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 80 · 📥 380 · 📋 110 - 32% open · ⏱️ 04.11.2022):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 15K / month):
	```
	pip install shiv
	```
- [Conda](https://anaconda.org/conda-forge/shiv) (📥 1.1K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/spotify/dh-virtualenv) (👨‍💻 60 · 🔀 170 · 📋 200 - 14% open · ⏱️ 03.01.2023):
...
🔗&nbsp;<b><a href="https://github.com/yoloseem/awesome-sphinxdoc">awesome-sphinxdoc</a></b> ( ⭐ 850)  - A curated list of awesome tools for Sphinx Python Documentation Generator.

<details><summary><b><a href="https://github.com/sphinx-doc/sphinx">sphinx</a></b> (🥇27 ·  ⭐ 5.2K) - Python Documentation generator. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.8K · 📦 280K · 📋 6.4K - 17% open · ⏱️ 18.02.2023):
...
<details><summary><b><a href="https://github.com/mitmproxy/pdoc">pdoc</a></b> (🥉25 ·  ⭐ 1.5K) - Epydoc replacement to auto generate API documentation for Python.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>

- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 42 · 🔀 160 · 📦 1.6K · 📋 310 - 4% open · ⏱️ 19.02.2023):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 84K / month):
	```
	pip install pdoc
	```
- [Conda](https://anaconda.org/conda-forge/pdoc) (📥 10K · ⏱️ 20.02.2023):
	```
...
- [GitHub](https://github.com/pycco-docs/pycco) (👨‍💻 36 · 🔀 140 · 📦 280 · 📋 57 - 50% open · ⏱️ 20.12.2019):

	```
	git clone https://github.com/pycco-docs/pycco
	```
- [PyPi](https://pypi.org/project/pycco) (📥 1.3K / month):
	```
	pip install pycco
	```
...
<details><summary><b><a href="https://github.com/s3tools/s3cmd">s3cmd</a></b> (🥇26 ·  ⭐ 4.1K) - A command line tool for managing Amazon S3 and CloudFront. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/s3tools/s3cmd) (👨‍💻 210 · 🔀 820 · 📥 3.1M · 📋 840 - 27% open · ⏱️ 19.11.2022):
...
- [PyPi](https://pypi.org/project/s3cmd) (📥 1.6M / month):
	...
	pip install s3cmd
	```
- [Conda](https://anaconda.org/conda-forge/s3cmd) (📥 8.1K · ⏱️ 22.12.2018):
	```
	conda install -c conda-forge s3cmd
	```
</details>
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥉25 ·  ⭐ 6K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 49 · 🔀 1.3K · 📦 270 · 📋 770 - 0% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 46K / month):
	```
	pip install akshare
	```
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 35 · 🔀 200 · 📦 33 · 📋 140 - 61% open · ⏱️ 06.05.2022):

	```
	git clone https://github.com/bloomreach/s4cmd
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 35K / month):
	```
	pip install s4cmd
	```
...
<details><summary><b><a href="https://github.com/MicroPyramid/forex-python">forex-python</a></b> (🥇25 ·  ⭐ 550) - Foreign exchange rates, Bitcoin price index and currency conversion. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 26 · 🔀 160 · 📦 1.9K · 📋 71 - 23% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 950 · 📦 210 · 📋 380 - 22% open · ⏱️ 28.02.2021):

	```
	git clone https://github.com/awesto/django-shop
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 5.6K / month):
	```
...
<details><summary><b><a href="https://github.com/stephenmcd/cartridge">Cartridge</a></b> (🥈20 ·  ⭐ 680) - A shopping cart app built using the Mezzanine. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 280 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 360 / month):
	```
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 27 · 📦 280 · 📋 23 - 30% open · ⏱️ 04.09.2016):

	```
	git clone https://github.com/carlospalol/money
	```
- [PyPi](https://pypi.org/project/money) (📥 52K / month):
	```
	pip install money
	```
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 91 · 📦 110 · 📋 15 - 20% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 310 / month):
	```
	pip install alipay
	```
...
- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 12 · 📥 6 · 📦 50 · 📋 6 - 50% open · ⏱️ 22.12.2020):
...
<details><summary><b><a href="https://github.com/spyder-ide/spyder">spyder</a></b> (🥇35 ·  ⭐ 7.4K) - Open Source Python IDE. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.7M · 📦 25K · 📋 17K - 6% open · ⏱️ 22.02.2023):
...
- [PyPi](https://pypi.org/project/spyder) (📥 56K / month):
	...
	pip install spyder
	```
- [Conda](https://anaconda.org/conda-forge/spyder) (📥 1.6M · ⏱️ 19.01.2023):
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 92 · 🔀 240 · 📦 210 · 📋 1.6K - 23% open · ⏱️ 22.09.2022):

	```
	git clone https://github.com/jorgenschaefer/elpy
	```
- [PyPi](https://pypi.org/project/elpy) (📥 670 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 180 · 🔀 2.7K · 📋 3.2K - 0% open · ⏱️ 07.02.2023):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 81 · 🔀 660 · 📥 33K · 📋 4.5K - 2% open · ⏱️ 02.02.2023):
...
- [GitHub](https://github.com/davidhalter/jedi-vim) (👨‍💻 96 · 🔀 370 · 📋 770 - 2% open · ⏱️ 28.12.2022):
...
- [GitHub](https://github.com/python-mode/python-mode) (👨‍💻 130 · 🔀 770 · 📋 900 - 2% open · ⏱️ 25.11.2022):
...
<details><summary><b><a href="https://github.com/kootenpv/yagmail">yagmail</a></b> (🥇26 ·  ⭐ 2.4K) - Yet another Gmail/SMTP client. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 32 · 🔀 260 · 📦 3K · 📋 220 - 43% open · ⏱️ 28.09.2022):
...
- [PyPi](https://pypi.org/project/yagmail) (📥 150K / month):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 23K · ⏱️ 11.09.2022):
	```
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 56 · 🔀 180 · 📦 470 · 📋 88 - 59% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/mailgun/flanker
	```
- [PyPi](https://pypi.org/project/flanker) (📥 32K / month):
	```
	pip install flanker
	```
...
<details><summary><b><a href="https://github.com/modoboa/modoboa">modoboa</a></b> (🥈25 ·  ⭐ 2.4K) - A mail hosting and management platform including a modern Web UI. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 320 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 2.8K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 180 · 📋 130 - 48% open · ⏱️ 17.11.2022):

	```
	git clone https://github.com/martinrusev/imbox
	```
- [PyPi](https://pypi.org/project/imbox) (📥 19K / month):
	```
	pip install imbox
	```
...
<details><summary><b><a href="https://github.com/marrow/mailer">mailer</a></b> (🥉19 ·  ⭐ 260 · 💤) - High-performance extensible mail delivery framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 55 · 📥 140 · 📋 72 - 33% open · ⏱️ 15.07.2022):

	```
	git clone https://github.com/marrow/mailer
	```
- [PyPi](https://pypi.org/project/mailer) (📥 56K / month):
	```
	pip install mailer
	```
- [Conda](https://anaconda.org/conda-forge/mailer) (📥 55K · ⏱️ 01.07.2021):
	```
	conda install -c conda-forge mailer
	```
</details>
<details><summary><b><a href="https://github.com/moggers87/salmon">salmon</a></b> (🥉13 ·  ⭐ 590 · 💤) - A Python Mail Server. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 60 · 📥 81 · 📦 18 · 📋 90 - 18% open · ⏱️ 06.06.2022):

	```
	git clone https://github.com/moggers87/salmon
	```
- [PyPi](https://pypi.org/project/salmon) (📥 57 / month):
	```
	pip install salmon
	```
...
<details><summary><b><a href="https://github.com/pypa/virtualenv">virtualenv</a></b> (🥇33 ·  ⭐ 4.4K) - A tool to create isolated Python environments. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 89 · 🔀 900 · 📦 230K · 📋 1.3K - 6% open · ⏱️ 16.02.2023):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 45M / month):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 3.6M · ⏱️ 08.02.2023):
	```
	conda install -c conda-forge virtualenv
	```
</details>
<details><summary><b><a href="https://github.com/pyenv/pyenv">pyenv</a></b> (🥉27 ·  ⭐ 31K) - Simple Python version management. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 410 · 🔀 2.7K · 📋 1.6K - 1% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 9.2K / month):
	```
	pip install pyenv
	```
...
<details><summary><b><a href="https://github.com/gorakhargosh/watchdog">watchdog</a></b> (🥇35 ·  ⭐ 5.7K) - API and shell utilities to monitor file system events. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 82K · 📋 590 - 26% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/gorakhargosh/watchdog
	```
- [PyPi](https://pypi.org/project/watchdog) (📥 11M / month):
	```
	pip install watchdog
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 1.8M · ⏱️ 01.01.2023):
	```
...
- [GitHub](https://github.com/ahupp/python-magic) (👨‍💻 58 · 🔀 240 · 📦 39K · 📋 180 - 15% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/ahupp/python-magic
	```
- [PyPi](https://pypi.org/project/python-magic) (📥 6.5M / month):
	```
	pip install python-magic
	```
- [Conda](https://anaconda.org/conda-forge/python-magic) (📥 190K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/jaraco/path) (👨‍💻 48 · 🔀 130 · 📋 130 - 1% open · ⏱️ 23.02.2023):
...
- [PyPi](https://pypi.org/project/path.py) (📥 300K / month):
	...
	pip install path.py
	```
- [Conda](https://anaconda.org/conda-forge/path.py) (📥 550K · ⏱️ 28.07.2020):
	```
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 39 · 📦 8.5K · 📋 17 - 35% open · ⏱️ 14.02.2015):
...
- [GitHub](https://github.com/PyFilesystem/pyfilesystem2) (👨‍💻 47 · 🔀 160 · 📋 350 - 22% open · ⏱️ 18.10.2022):
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 140 · 🔀 370 · 📦 160K · 📋 410 - 12% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/wtforms/wtforms
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 3.6M / month):
	```
	pip install wtforms
	```
- [Conda](https://anaconda.org/conda-forge/wtforms) (📥 130K · ⏱️ 24.12.2021):
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 690 · 📦 110K · 📋 660 - 8% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/django-crispy-forms/django-crispy-forms
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 770K / month):
	```
	pip install django-crispy-forms
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 66K · ⏱️ 14.02.2023):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 96K · 📋 160 - 13% open · ⏱️ 14.12.2022):

	```
	git clone https://github.com/zostera/django-bootstrap4
	```
- [PyPi](https://pypi.org/project/django-bootstrap4) (📥 160K / month):
	```
	pip install django-bootstrap4
	```
- [Conda](https://anaconda.org/conda-forge/django-bootstrap4) (📥 22K · ⏱️ 20.10.2021):
	```
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 98 · 🔀 680 · 📦 18K · 📋 290 - 2% open · ⏱️ 14.12.2022):
...
- [PyPi](https://pypi.org/project/django-bootstrap3) (📥 100K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-bootstrap3) (📥 25K · ⏱️ 04.08.2019):
	```
	conda install -c conda-forge django-bootstrap3
	```
</details>
<details><summary><b><a href="https://github.com/Pylons/deform">Deform</a></b> (🥉20 ·  ⭐ 390 · 💤) - Python HTML form generation library influenced by the formish.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 760 · 📋 180 - 25% open · ⏱️ 15.07.2022):

	```
	git clone https://github.com/Pylons/deform
	```
- [PyPi](https://pypi.org/project/deform) (📥 17K / month):
	```
	pip install deform
	```
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 86 · 📦 20 · 📋 16 - 75% open · ⏱️ 12.07.2017):

	```
	git clone https://github.com/WiserTogether/django-remote-forms
	```
- [PyPi](https://pypi.org/project/django-remote-forms) (📥 150 / month):
	```
...
<details><summary><b><a href="https://github.com/more-itertools/more-itertools">more-itertools</a></b> (🥇36 ·  ⭐ 2.9K · 📈) - More routines for operating on iterables, beyond `itertools`. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 96 · 🔀 230 · 📥 2.6K · 📦 170K · 📋 240 - 7% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/erikrose/more-itertools
	```
- [PyPi](https://pypi.org/project/more-itertools) (📥 34M / month):
	```
	pip install more-itertools
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 11M · ⏱️ 18.10.2022):
	```
	conda install -c conda-forge more-itertools
	```
</details>
<details><summary><b><a href="https://github.com/pytoolz/toolz">Toolz</a></b> (🥈32 ·  ⭐ 4.2K) - A collection of functional utilities for iterators, functions, and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 83K · 📋 220 - 34% open · ⏱️ 03.11.2022):
...
- [PyPi](https://pypi.org/project/toolz) (📥 17M / month):
	...
	pip install toolz
	```
- [Conda](https://anaconda.org/conda-forge/toolz) (📥 13M · ⏱️ 10.07.2022):
	```
	conda install -c conda-forge toolz
	```
</details>
<details><summary><b><a href="https://github.com/Suor/funcy">funcy</a></b> (🥈28 ·  ⭐ 3K) - A fancy and practical functional tools. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 7K · 📋 74 - 8% open · ⏱️ 19.02.2023):

	```
	git clone https://github.com/Suor/funcy
	```
- [PyPi](https://pypi.org/project/funcy) (📥 1.8M / month):
	```
	pip install funcy
	```
- [Conda](https://anaconda.org/conda-forge/funcy) (📥 300K · ⏱️ 27.01.2023):
	```
	conda install -c conda-forge funcy
	```
</details>
<details><summary><b><a href="https://github.com/dry-python/returns">returns</a></b> (🥉27 ·  ⭐ 2.6K) - A set of type-safe monads, transformers, and composition utilities. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 95 · 📦 320 · 📋 390 - 14% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 67K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 4.3K · ⏱️ 13.03.2022):
	```
	conda install -c conda-forge returns
	```
</details>
<details><summary><b><a href="https://github.com/evhub/coconut">Coconut</a></b> (🥉22 ·  ⭐ 3.7K) - A variant of Python built for simple, elegant, Pythonic functional.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/evhub/coconut) (👨‍💻 31 · 🔀 100 · 📋 620 - 9% open · ⏱️ 30.12.2022):

	```
	git clone https://github.com/evhub/coconut
	```
- [PyPi](https://pypi.org/project/coconut) (📥 950 / month):
	```
	pip install coconut
	```
- [Conda](https://anaconda.org/conda-forge/coconut) (📥 160K · ⏱️ 30.12.2022):
	```
	conda install -c conda-forge coconut
	```
</details>
<details><summary><b><a href="https://github.com/pytoolz/cytoolz">CyToolz</a></b> (🥉21 ·  ⭐ 910) - Cython implementation of `Toolz`: High performance functional.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 66 · 📦 47K · 📋 75 - 30% open · ⏱️ 19.12.2022):
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 460 · 📋 48 - 47% open · ⏱️ 13.10.2014):

	```
	git clone https://github.com/kachayev/fn.py
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 440 / month):
	```
	pip install fn.py
	```
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇32 ·  ⭐ 1.4K) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 20K · 📋 430 - 16% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/pyglet/pyglet
	```
- [PyPi](https://pypi.org/project/pyglet) (📥 260K / month):
	```
	pip install pyglet
	```
- [Conda](https://anaconda.org/conda-forge/pyglet) (📥 480K · ⏱️ 27.01.2023):
	```
	conda install -c conda-forge pyglet
	```
</details>
<details><summary><b><a href="https://github.com/PySimpleGUI/PySimpleGUI">PySimpleGUI</a></b> (🥈30 ·  ⭐ 11K) - Wrapper for tkinter, Qt, WxPython and Remi. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.7K · 📦 7.4K · 📋 3.2K - 21% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 170K / month):
	```
	pip install PySimpleGUI
	```
- [Conda](https://anaconda.org/conda-forge/PySimpleGUI) (📥 93K · ⏱️ 17.10.2022):
	```
	conda install -c conda-forge PySimpleGUI
	```
</details>
<details><summary><b><a href="https://github.com/python-eel/Eel">Eel</a></b> (🥈28 ·  ⭐ 5.5K) - A library for making simple Electron-like offline HTML/JS GUI apps. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 45 · 🔀 540 · 📦 4.8K · 📋 490 - 32% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/ChrisKnott/Eel
	```
- [PyPi](https://pypi.org/project/Eel) (📥 80K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 390 · 📦 710 · 📋 570 - 20% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 4.6K / month):
	```
	pip install Gooey
	```
- [Conda](https://anaconda.org/conda-forge/Gooey) (📥 61K · ⏱️ 29.12.2021):
	```
	conda install -c conda-forge Gooey
	```
</details>
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥈25 ·  ⭐ 9.7K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 500 · 📦 1.6K · 📋 1.1K - 14% open · ⏱️ 14.02.2023):
...
<details><summary><b><a href="https://github.com/r0x0r/pywebview">pywebview</a></b> (🥉24 ·  ⭐ 3.4K) - A lightweight cross-platform native wrapper around a webview.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/r0x0r/pywebview) (🔀 430 · 📦 960 · 📋 720 - 3% open · ⏱️ 21.02.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 440 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 420 / month):
	```
	pip install flexx
	```
- [Conda](https://anaconda.org/conda-forge/flexx) (📥 96K · ⏱️ 12.04.2022):
	```
	conda install -c conda-forge flexx
	```
</details>
<details><summary><b><a href="https://github.com/beeware/toga">Toga</a></b> (🥉21 ·  ⭐ 3.4K) - A Python native, OS native GUI toolkit. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/beeware/toga) (👨‍💻 230 · 🔀 570 · 📥 1.1K · 📋 620 - 17% open · ⏱️ 20.02.2023):
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 230 · 📦 210 · 📋 220 - 16% open · ⏱️ 21.02.2023):
...
<details><summary><b><a href="https://github.com/graphql-python/graphene">graphene</a></b> (🥇25 ·  ⭐ 7.6K) - GraphQL framework for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/graphql-python/graphene) (🔀 780 · 📦 17K · 📋 970 - 10% open · ⏱️ 25.12.2022):
...
- [GitHub](https://github.com/tartiflette/tartiflette-aiohttp) (🔀 8 · 📦 51 · 📋 18 - 16% open · ⏱️ 07.09.2022):
...
<details><summary><b><a href="https://github.com/tartiflette/tartiflette-asgi">tartiflette-asgi</a></b> (🥉14 ·  ⭐ 99 · 💤) - ASGI support for the Tartiflette GraphQL engine. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tartiflette/tartiflette-asgi) (🔀 16 · 📦 16 · 📋 49 - 12% open · ⏱️ 20.05.2022):
...
<details><summary><b><a href="https://github.com/geopy/geopy">geopy</a></b> (🥇27 ·  ⭐ 3.9K) - Python Geocoding Toolbox. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/geopy) (📥 3.6M / month):
	...
	pip install geopy
	```
- [Conda](https://anaconda.org/conda-forge/geopy) (📥 960K · ⏱️ 13.11.2022):
	```
	conda install -c conda-forge geopy
	```
</details>
<details><summary><b><a href="https://github.com/SmileyChris/django-countries">django-countries</a></b> (🥈21 ·  ⭐ 1.2K) - A Django app that provides a country field for models and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 53 · 🔀 250 · 📋 270 - 4% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/SmileyChris/django-countries
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 460K / month):
	```
	pip install django-countries
	```
- [Conda](https://anaconda.org/conda-forge/django-countries) (📥 2.8K · ⏱️ 28.02.2022):
	```
	conda install -c conda-forge django-countries
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/geojson">geojson</a></b> (🥉18 ·  ⭐ 780) - Python bindings and utilities for GeoJSON. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 52 · 🔀 100 · 📦 12K · 📋 89 - 21% open · ⏱️ 16.02.2023):
...
- [GitHub](https://github.com/maxmind/geoip-api-python) (👨‍💻 12 · 🔀 52 · 📦 1.3K · ⏱️ 11.02.2021):
...
<details><summary><b><a href="https://github.com/pallets/markupsafe">MarkupSafe</a></b> (🥇32 ·  ⭐ 520) - Implements a XML/HTML/XHTML Markup safe string for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 370 · 📦 1.1M · ⏱️ 07.02.2023):
...
- [PyPi](https://pypi.org/project/markupsafe) (📥 110M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/markupsafe) (📥 27M · ⏱️ 19.01.2023):
	```
	conda install -c conda-forge markupsafe
	```
</details>
<details><summary><b><a href="https://github.com/martinblech/xmltodict">xmltodict</a></b> (🥈30 ·  ⭐ 5.1K · 💤) - Working with XML feel like you are working with JSON. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 51K · 📋 230 - 31% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/martinblech/xmltodict
	```
- [PyPi](https://pypi.org/project/xmltodict) (📥 21M / month):
	```
	pip install xmltodict
	```
- [Conda](https://anaconda.org/conda-forge/xmltodict) (📥 2.4M · ⏱️ 08.05.2022):
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 78 · 🔀 230 · 📦 230K · 📋 360 - 7% open · ⏱️ 23.01.2023):
...
- [PyPi](https://pypi.org/project/bleach) (📥 15M / month):
	...
	pip install bleach
	```
- [Conda](https://anaconda.org/conda-forge/bleach) (📥 11M · ⏱️ 24.01.2023):
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 52 · 🔀 170 · 📦 18K · 📋 180 - 27% open · ⏱️ 02.01.2023):

	```
	git clone https://github.com/gawel/pyquery
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 1.3M / month):
	```
	pip install pyquery
	```
- [Conda](https://anaconda.org/conda-forge/pyquery) (📥 36K · ⏱️ 28.12.2022):
	```
	conda install -c conda-forge pyquery
	```
</details>
<details><summary><b><a href="https://github.com/stchris/untangle">untangle</a></b> (🥉23 ·  ⭐ 580) - Converts XML documents to Python objects for easy access. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/stchris/untangle) (👨‍💻 17 · 🔀 80 · 📥 530 · 📦 980 · 📋 56 - 26% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/stchris/untangle
	```
- [PyPi](https://pypi.org/project/untangle) (📥 170K / month):
	```
	pip install untangle
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 3.5K · ⏱️ 30.06.2020):
	```
	conda install -c conda-forge untangle
	```
</details>
<details><summary><b><a href="https://github.com/html5lib/html5lib-python">html5lib</a></b> (🥉16 ·  ⭐ 1K · 💀) - A standards-compliant library for parsing and serializing HTML.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/html5lib/html5lib-python) (👨‍💻 62 · 🔀 260 · 📋 250 - 35% open · ⏱️ 17.09.2021):
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 730 · 🔀 8.6K · 📥 4.5K · 📦 2M · 📋 3.7K - 5% open · ⏱️ 21.01.2023):

	```
	git clone https://github.com/psf/requests
	```
- [PyPi](https://pypi.org/project/requests) (📥 280M / month):
	```
	pip install requests
	```
- [Conda](https://anaconda.org/conda-forge/requests) (📥 29M · ⏱️ 16.01.2023):
	```
	conda install -c conda-forge requests
	```
</details>
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈36 ·  ⭐ 10K) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 190 · 🔀 650 · 📦 74K · 📋 740 - 3% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 12M / month):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 480K · ⏱️ 04.01.2023):
	```
	conda install -c conda-forge httpx
	```
</details>
<details><summary><b><a href="https://github.com/urllib3/urllib3">urllib3</a></b> (🥈36 ·  ⭐ 3.3K) - A HTTP library with thread-safe connection pooling, file post support,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 970 · 📥 5.7K · 📦 1.2M · 📋 1.1K - 9% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/shazow/urllib3
	```
- [PyPi](https://pypi.org/project/urllib3) (📥 310M / month):
	```
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 29M · ⏱️ 11.01.2023):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 77 · 🔀 180 · 📦 130K · 📋 110 - 40% open · ⏱️ 19.01.2023):

	```
	git clone https://github.com/httplib2/httplib2
	```
- [PyPi](https://pypi.org/project/httplib2) (📥 37M / month):
	```
	pip install httplib2
	```
- [Conda](https://anaconda.org/conda-forge/httplib2) (📥 2.2M · ⏱️ 01.11.2022):
	```
	conda install -c conda-forge httplib2
	```
</details>
<details><summary><b><a href="https://github.com/spyoungtech/grequests">grequests</a></b> (🥉27 ·  ⭐ 4.2K · 💀) - requests + gevent for asynchronous HTTP requests. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 290 · 📦 3.6K · 📋 110 - 2% open · ⏱️ 26.01.2022):

	```
	git clone https://github.com/spyoungtech/grequests
	```
- [PyPi](https://pypi.org/project/grequests) (📥 320K / month):
	```
	pip install grequests
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 70K · ⏱️ 22.04.2020):
	```
	conda install -c conda-forge grequests
	```
</details>
<details><summary><b><a href="https://github.com/twisted/treq">treq</a></b> (🥉20 ·  ⭐ 550) - Python requests like API built on top of Twisted's HTTP client. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/twisted/treq) (👨‍💻 50 · 🔀 130 · 📥 150 · 📦 1.4K · 📋 150 - 36% open · ⏱️ 10.09.2022):
...
- [PyPi](https://pypi.org/project/treq) (📥 72K / month):
	...
	pip install treq
	```
- [Conda](https://anaconda.org/conda-forge/treq) (📥 68K · ⏱️ 30.01.2022):
	```
...
<details><summary><b><a href="https://github.com/secdev/scapy">scapy</a></b> (🥇34 ·  ⭐ 8.5K) - A brilliant packet manipulation library. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/secdev/scapy) (👨‍💻 410 · 🔀 1.7K · 📦 10K · 📋 1.4K - 4% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/secdev/scapy
	```
- [PyPi](https://pypi.org/project/scapy) (📥 2.7M / month):
	```
	pip install scapy
	```
- [Conda](https://anaconda.org/conda-forge/scapy) (📥 71K · ⏱️ 25.12.2022):
	```
	conda install -c conda-forge scapy
	```
</details>
<details><summary><b><a href="https://github.com/boppreh/keyboard">keyboard</a></b> (🥈29 ·  ⭐ 3.3K) - Hook and simulate global keyboard events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 380 · 📦 9.5K · 📋 530 - 64% open · ⏱️ 31.01.2023):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 360K / month):
	```
	pip install keyboard
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 14K · ⏱️ 01.11.2022):
	```
	conda install -c conda-forge keyboard
	```
</details>
<details><summary><b><a href="https://github.com/boppreh/mouse">mouse</a></b> (🥉22 ·  ⭐ 730) - Hook and simulate global mouse events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 110 · 📦 950 · 📋 110 - 72% open · ⏱️ 23.08.2022):

	```
	git clone https://github.com/boppreh/mouse
	```
- [PyPi](https://pypi.org/project/mouse) (📥 26K / month):
	```
	pip install mouse
	```
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 500 · 📋 100 - 70% open · ⏱️ 19.04.2021):

	```
	git clone https://github.com/SavinaRoja/PyUserInput
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 5.5K / month):
	```
...
- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 450 · 📋 64 - 51% open · ⏱️ 20.03.2017):
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 430 · 🔀 1.8K · 📦 1.1M · 📋 2.7K - 3% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/Pillow) (📥 51M / month):
	...
	pip install Pillow
	```
- [Conda](https://anaconda.org/conda-forge/Pillow) (📥 24M · ⏱️ 04.02.2023):
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 9.4K · 📦 15K · 📋 390 - 4% open · ⏱️ 14.01.2023):

	```
	git clone https://github.com/dahlia/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 590K / month):
	```
	pip install wand
	```
...
<details><summary><b><a href="https://github.com/thumbor/thumbor">thumbor</a></b> (🥈29 ·  ⭐ 9.4K) - A smart imaging service. It enables on-demand crop, re-sizing and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 330 · 📋 930 - 0% open · ⏱️ 27.01.2023):

	```
	git clone https://github.com/thumbor/thumbor
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 5.7K / month):
	```
	pip install thumbor
	```
...
<details><summary><b><a href="https://github.com/dylanaraps/pywal">pywal</a></b> (🥈25 ·  ⭐ 7K · 💀) - A tool that generates color schemes from images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 270 · 📥 940 · 📦 220 · 📋 520 - 25% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/dylanaraps/pywal
	```
- [PyPi](https://pypi.org/project/pywal) (📥 2.7K / month):
	```
	pip install pywal
	```
...
<details><summary><b><a href="https://github.com/WhyNotHugo/python-barcode">python-barcode</a></b> (🥈25 ·  ⭐ 430) - Create barcodes in Python with no extra dependencies. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 43 · 🔀 110 · 📥 260 · 📦 16K · 📋 100 - 39% open · ⏱️ 14.02.2023):

	```
	git clone https://github.com/WhyNotHugo/python-barcode
	```
- [PyPi](https://pypi.org/project/python-barcode) (📥 230K / month):
	```
	pip install python-barcode
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 9K · ⏱️ 22.08.2020):
	```
	conda install -c conda-forge python-barcode
	```
</details>
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥉18 ·  ⭐ 480) - A fast image processing library with low memory needs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 46 · 📋 340 - 37% open · ⏱️ 11.02.2023):
...
- [PyPi](https://pypi.org/project/pyvips) (📥 31K / month):
	...
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 47K · ⏱️ 29.10.2022):
	```
	conda install -c conda-forge pyvips
	```
</details>
<details><summary><b><a href="https://github.com/daboth/pagan">pagan</a></b> (🥉18 ·  ⭐ 290) - Retro identicon (Avatar) generation based on input string and hash. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/daboth/pagan) (👨‍💻 11 · 🔀 42 · 📦 63 · 📋 8 - 50% open · ⏱️ 30.11.2022):

	```
	git clone https://github.com/daboth/pagan
	```
- [PyPi](https://pypi.org/project/pagan) (📥 230 / month):
	```
	pip install pagan
	```
...
<details><summary><b><a href="https://github.com/hhatto/nude.py">nude.py</a></b> (🥉16 ·  ⭐ 890 · 💀) - Nudity detection. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hhatto/nude.py) (👨‍💻 12 · 🔀 130 · 📦 3.2K · 📋 10 - 70% open · ⏱️ 23.11.2020):
...
<details><summary><b><a href="https://github.com/lincolnloop/python-qrcode">python-qrcode</a></b> (🥉12 ·  ⭐ 3.5K) - A pure Python QR Code generator. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/lincolnloop/python-qrcode) (👨‍💻 56 · 🔀 540 · 📋 200 - 20% open · ⏱️ 05.02.2023):
...
<details><summary><b><a href="https://github.com/fogleman/Quads">Quads</a></b> (🥉12 ·  ⭐ 1.1K · 💀) - Computer art based on quadtrees. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/micropython/micropython">MicroPython</a></b> (🥇23 ·  ⭐ 16K) - A lean and efficient Python programming language.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/micropython/micropython) (👨‍💻 560 · 🔀 4.6K · 📥 57K · 📋 4.6K - 26% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/micropython/micropython
	```
- [PyPi](https://pypi.org/project/micropython) (📥 5 / month):
	```
	pip install micropython
	```
- [Conda](https://anaconda.org/conda-forge/micropython) (📥 12K · ⏱️ 17.06.2022):
	```
	conda install -c conda-forge micropython
	```
</details>
<details><summary><b><a href="https://github.com/IronLanguages/ironpython3">IronPython</a></b> (🥇23 ·  ⭐ 2.1K) - Implementation of the Python programming language written in C#. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 49K · 📋 560 - 45% open · ⏱️ 17.01.2023):
...
<details><summary><b><a href="https://github.com/python/cpython">CPython</a></b> (🥈22 ·  ⭐ 51K) - **Default, most widely used implementation of the Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 25K · 📋 62K - 10% open · ⏱️ 23.02.2023):
...
<details><summary><b><a href="https://github.com/Maratyszcza/PeachPy">PeachPy</a></b> (🥈17 ·  ⭐ 1.7K) - x86-64 assembler embedded in Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 25 · 🔀 150 · 📦 14 · 📋 89 - 26% open · ⏱️ 13.11.2022):

	```
	git clone https://github.com/Maratyszcza/PeachPy
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 32 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 260K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 71 · 📋 110 - 33% open · ⏱️ 16.11.2020):

	```
	git clone https://github.com/Microsoft/Pyjion
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 600 / month):
	```
	pip install Pyjion
	```
- [Conda](https://anaconda.org/conda-forge/Pyjion) (📥 440 · ⏱️ 13.02.2022):
	```
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉10 ·  ⭐ 900 · 💀) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 59 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 19 / month):
	```
...
🔗&nbsp;<b><a href="https://github.com/markusschanta/awesome-jupyter">awesome-jupyter</a></b> ( ⭐ 3.2K)  - A curated list of awesome Jupyter projects, libraries and resources.

<details><summary><b><a href="https://github.com/prompt-toolkit/ptpython">ptpython</a></b> (🥇27 ·  ⭐ 4.7K) - Advanced Python REPL built on top of the [python-prompt-.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 54 · 🔀 260 · 📦 2.4K · 📋 360 - 57% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/jonathanslenders/ptpython
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 410K / month):
	```
	pip install ptpython
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 28K · ⏱️ 31.10.2022):
	```
	conda install -c conda-forge ptpython
	```
</details>
<details><summary><b><a href="https://github.com/bpython/bpython">bpython</a></b> (🥉18 ·  ⭐ 2.3K) - A fancy interface to the Python interpreter. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 210 · 📋 770 - 16% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/bpython/bpython
	```
- [PyPi](https://pypi.org/project/bpython) (📥 98K / month):
	```
	pip install bpython
	```
- [Conda](https://anaconda.org/conda-forge/bpython) (📥 59K · ⏱️ 18.01.2023):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 52 · 📦 3.3K · ⏱️ 08.04.2021):
...
- [PyPi](https://pypi.org/project/pyicu) (📥 240K / month):
	...
	pip install pyicu
	```
- [Conda](https://anaconda.org/conda-forge/pyicu) (📥 130K · ⏱️ 26.04.2022):
	```
...
- [GitHub](https://github.com/dbader/schedule) (👨‍💻 51 · 🔀 820 · 📦 24K · 📋 400 - 34% open · ⏱️ 23.04.2022):

	```
	git clone https://github.com/dbader/schedule
	```
- [PyPi](https://pypi.org/project/schedule) (📥 2.4M / month):
	```
	pip install schedule
	```
- [Conda](https://anaconda.org/conda-forge/schedule) (📥 29K · ⏱️ 10.04.2021):
	```
	conda install -c conda-forge schedule
	```
</details>
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥈30 ·  ⭐ 11K) - A modern workflow orchestration framework that makes it easy to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 130 · 🔀 1.1K · 📦 2.2K · 📋 3.3K - 20% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 710K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 400K · ⏱️ 19.02.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 51 · 🔀 270 · 📦 59 · 📋 110 - 5% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 4.7K / month):
	```
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 76 · 📋 9 - 11% open · ⏱️ 14.05.2020):

	```
	git clone https://github.com/fengsp/plan
	```
- [PyPi](https://pypi.org/project/plan) (📥 1.2K / month):
	```
	pip install plan
	```
...
<details><summary><b><a href="https://github.com/Delgan/loguru">loguru</a></b> (🥇33 ·  ⭐ 14K) - Library which aims to bring enjoyable logging in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 580 · 📦 47K · 📋 700 - 10% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 5.7M / month):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 960K · ⏱️ 26.10.2022):
	```
	conda install -c conda-forge loguru
	```
</details>
<details><summary><b><a href="https://github.com/getsentry/sentry-python">sentry-python</a></b> (🥉29 ·  ⭐ 1.4K) - Sentry SDK for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 330 · 📥 3.8K · 📦 40K · 📋 820 - 19% open · ⏱️ 22.02.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 590 · 🔀 8K · 📥 6.1K · 📦 48K · 📋 4.7K - 6% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 8.9M / month):
	```
	pip install xgboost
	```
...
<details><summary><b><a href="https://github.com/openai/gym">gym</a></b> (🥈34 ·  ⭐ 30K) - A toolkit for developing and comparing reinforcement learning.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.7K · 📦 38K · 📋 1.7K - 2% open · ⏱️ 30.01.2023):
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.6K · 📦 120 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 810 / month):
	```
	pip install nupic
	```
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉21 ·  ⭐ 14K) - MindsDB is an open source AI layer for existing databases that.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 300 · 🔀 1.5K · 📋 2K - 16% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 7.8K / month):
	```
	pip install mindsdb
	```
...
<details><summary><b><a href="https://github.com/h2oai/h2o-3">H2O</a></b> (🥉20 ·  ⭐ 6.2K) - Open Source Fast Scalable Machine Learning Platform. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 23.02.2023):
...
<details><summary><b><a href="https://github.com/benhamner/Metrics">Metrics</a></b> (🥉16 ·  ⭐ 1.6K · 💀) - Machine learning evaluation metrics. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 6.5K / month):
	```
	pip install Metrics
	```
...
<details><summary><b><a href="https://github.com/pythonnet/pythonnet">PythonNet</a></b> (🥇30 ·  ⭐ 3.6K) - Python Integration with the .NET Common Language Runtime (CLR). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 98 · 🔀 540 · 📥 1K · 📦 1.3K · 📋 1.3K - 7% open · ⏱️ 03.02.2023):

	```
	git clone https://github.com/pythonnet/pythonnet
	```
- [PyPi](https://pypi.org/project/pythonnet) (📥 150K / month):
	```
	pip install pythonnet
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 63K · ⏱️ 03.11.2022):
	```
	conda install -c conda-forge pythonnet
	```
</details>
<details><summary><b><a href="https://github.com/mhammond/pywin32">PyWin32</a></b> (🥉29 ·  ⭐ 4.2K) - Python Extensions for Windows. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 85 · 🔀 720 · 📥 600K · 📦 110K · 📋 1.7K - 25% open · ⏱️ 19.02.2023):

	```
	git clone https://github.com/mhammond/pywin32
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 4M / month):
	```
	pip install pywin32
	```
- [Conda](https://anaconda.org/conda-forge/pywin32) (📥 3.4M · ⏱️ 28.10.2022):
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 780K · ⏱️ 07.02.2023):

	```
	git clone https://github.com/pallets/itsdangerous
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 53M / month):
	```
	pip install itsdangerous
	```
- [Conda](https://anaconda.org/conda-forge/itsdangerous) (📥 4.8M · ⏱️ 24.03.2022):
	```
	conda install -c conda-forge itsdangerous
	```
</details>
<details><summary><b><a href="https://github.com/mahmoud/boltons">boltons</a></b> (🥈31 ·  ⭐ 6.1K) - A set of pure-Python utilities. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 83 · 🔀 330 · 📥 23 · 📦 4K · 📋 140 - 31% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/mahmoud/boltons
	```
- [PyPi](https://pypi.org/project/boltons) (📥 3.4M / month):
	```
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 750K · ⏱️ 27.05.2021):
	```
	conda install -c conda-forge boltons
	```
</details>
<details><summary><b><a href="https://github.com/pallets-eco/blinker">blinker</a></b> (🥉29 ·  ⭐ 1.5K) - A fast Python in-process signal/event dispatching system. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 16 · 🔀 160 · 📦 140K · 📋 36 - 2% open · ⏱️ 24.01.2023):

	```
	git clone https://github.com/jek/blinker
	```
- [PyPi](https://pypi.org/project/blinker) (📥 7M / month):
	```
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 7.8M · ⏱️ 03.10.2022):
	```
	conda install -c conda-forge blinker
	```
</details>
<details><summary><b><a href="https://github.com/magenta/magenta">magenta</a></b> (🥉26 ·  ⭐ 18K) - A tool to generate music and art using artificial intelligence. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/magenta/magenta) (👨‍💻 160 · 🔀 3.6K · 📦 410 · 📋 910 - 36% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/magenta/magenta
	```
- [PyPi](https://pypi.org/project/magenta) (📥 7.3K / month):
	```
	pip install magenta
	```
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1.7K · 📋 13 - 7% open · ⏱️ 16.05.2021):

	```
	git clone https://github.com/mitsuhiko/pluginbase
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 550K / month):
	```
	pip install pluginbase
	```
- [Conda](https://anaconda.org/conda-forge/pluginbase) (📥 270K · ⏱️ 04.02.2019):
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 440 · 🔀 4.1K · 📥 4.3K · 📦 42K · 📋 1.8K - 20% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/RaRe-Technologies/gensim
	```
- [PyPi](https://pypi.org/project/gensim) (📥 4.4M / month):
	```
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 980K · ⏱️ 21.12.2022):
	```
	conda install -c conda-forge gensim
	```
</details>
<details><summary><b><a href="https://github.com/fxsjy/jieba">jieba</a></b> (🥇32 ·  ⭐ 30K · 💀) - The most popular Chinese text segmentation library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.4K · 📦 21K · 📋 820 - 73% open · ⏱️ 15.02.2020):

	```
	git clone https://github.com/fxsjy/jieba
	```
- [PyPi](https://pypi.org/project/jieba) (📥 510K / month):
	```
	pip install jieba
	```
- [Conda](https://anaconda.org/conda-forge/jieba) (📥 130K · ⏱️ 30.05.2021):
	```
	conda install -c conda-forge jieba
	```
</details>
<details><summary><b><a href="https://github.com/clips/pattern">pattern</a></b> (🥈29 ·  ⭐ 8.4K · 💀) - A web mining module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📥 40 · 📦 1.5K · 📋 200 - 62% open · ⏱️ 25.04.2020):

	```
	git clone https://github.com/clips/pattern
	```
- [PyPi](https://pypi.org/project/pattern) (📥 1.6M / month):
	```
	pip install pattern
	```
- [Conda](https://anaconda.org/conda-forge/pattern) (📥 13K · ⏱️ 05.05.2020):
	```
	conda install -c conda-forge pattern
	```
</details>
<details><summary><b><a href="https://github.com/stanfordnlp/stanza">Stanza</a></b> (🥈25 ·  ⭐ 6.5K) - The Stanford NLP Group's official Python library, supporting 60+.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 54 · 🔀 820 · 📦 1.6K · 📋 750 - 10% open · ⏱️ 15.09.2022):
...
- [PyPi](https://pypi.org/project/stanza) (📥 160K / month):
	...
	pip install stanza
	```
- [Conda](https://anaconda.org/conda-forge/stanza) (📥 8.2K · ⏱️ 15.09.2022):
	```
...
- [GitHub](https://github.com/PetrochukM/PyTorch-NLP) (👨‍💻 18 · 🔀 250 · 📦 500 · 📋 69 - 28% open · ⏱️ 10.07.2021):
...
<details><summary><b><a href="https://github.com/aboSamoor/polyglot">polyglot</a></b> (🥈23 ·  ⭐ 2.1K · 💀) - Natural language pipeline supporting hundreds of languages. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 310 · 📦 940 · 📋 220 - 68% open · ⏱️ 22.09.2020):

	```
	git clone https://github.com/aboSamoor/polyglot
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 61K / month):
	```
...
<details><summary><b><a href="https://github.com/lancopku/pkuseg-python">pkuseg-python</a></b> (🥉22 ·  ⭐ 6.1K · 💤) - A toolkit for Chinese word segmentation in various domains. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 940 · 📥 99K · 📦 240 · 📋 160 - 74% open · ⏱️ 08.06.2022):
...
<details><summary><b><a href="https://github.com/isnowfy/snownlp">snownlp</a></b> (🥉22 ·  ⭐ 6K · 💀) - A library for processing Chinese text. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.1K · 📋 100 - 38% open · ⏱️ 19.01.2020):

	```
	git clone https://github.com/isnowfy/snownlp
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 6.2K / month):
	```
	pip install snownlp
	```
- [Conda](https://anaconda.org/conda-forge/snownlp) (📥 1.5K · ⏱️ 07.09.2021):
	```
	conda install -c conda-forge snownlp
	```
</details>
<details><summary><b><a href="https://github.com/facebookresearch/pytext">pytext</a></b> (🥉17 ·  ⭐ 6.4K) - A natural language modeling framework based on PyTorch. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 230 · 🔀 790 · 📥 320 · 📦 110 · 📋 140 - 45% open · ⏱️ 17.10.2022):
...
- [GitHub](https://github.com/saffsd/langid.py) (👨‍💻 9 · 🔀 280 · 📦 1.4K · 📋 71 - 35% open · ⏱️ 15.07.2017):
...
<details><summary><b><a href="https://github.com/fighting41love/funNLP">funNLP</a></b> (🥉15 ·  ⭐ 47K) - A collection of tools and datasets for Chinese NLP. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 11 · 🔀 12K · 📋 54 - 20% open · ⏱️ 17.11.2022):
...
<details><summary><b><a href="https://github.com/napalm-automation/napalm">napalm</a></b> (🥇29 ·  ⭐ 2K) - Cross-vendor API to manipulate network devices. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 1.4K · 📋 580 - 21% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/napalm-automation/napalm
	```
- [PyPi](https://pypi.org/project/napalm) (📥 47K / month):
	```
	pip install napalm
	```
...
<details><summary><b><a href="https://github.com/mininet/mininet">mininet</a></b> (🥉27 ·  ⭐ 4.7K) - A popular network emulator and API written in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 500K · 📦 200 · 📋 680 - 36% open · ⏱️ 23.11.2022):

	```
	git clone https://github.com/mininet/mininet
	```
- [PyPi](https://pypi.org/project/mininet) (📥 3K / month):
	```
	pip install mininet
	```
...
<details><summary><b><a href="https://github.com/noxrepo/pox">pox</a></b> (🥉20 ·  ⭐ 590 · 💀) - A Python-based SDN control applications, such as OpenFlow SDN.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 430 · 📋 190 - 22% open · ⏱️ 20.05.2020):

	```
	git clone https://github.com/noxrepo/pox
	```
- [PyPi](https://pypi.org/project/pox) (📥 4M / month):
	```
	pip install pox
	```
- [Conda](https://anaconda.org/conda-forge/pox) (📥 280K · ⏱️ 24.10.2022):
	```
...
- [GitHub](https://github.com/justquick/django-activity-stream) (👨‍💻 110 · 🔀 460 · 📥 6 · 📦 1K · 📋 300 - 4% open · ⏱️ 11.02.2023):

	```
	git clone https://github.com/justquick/django-activity-stream
	```
- [PyPi](https://pypi.org/project/django-activity-stream) (📥 40K / month):
	```
...
<details><summary><b><a href="https://github.com/tschellenbach/Stream-Framework">Stream Framework</a></b> (🥉17 ·  ⭐ 4.7K · 💀) - Building news feed and notification systems using.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/tschellenbach/Stream-Framework) (👨‍💻 26 · 🔀 540 · 📋 180 - 35% open · ⏱️ 15.07.2020):
	...
	```
- [PyPi](https://pypi.org/project/Stream-Framework) (📥 1.5K / month):
	```
...
<details><summary><b><a href="https://github.com/coleifer/peewee">peewee</a></b> (🥇36 ·  ⭐ 9.8K) - A small, expressive ORM. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 21K · ⏱️ 20.02.2023):
...
- [PyPi](https://pypi.org/project/peewee) (📥 1.3M / month):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 480K · ⏱️ 11.11.2022):
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 380 · 🔀 1.1K · 📦 19K · 📋 1.6K - 20% open · ⏱️ 28.01.2023):

	```
	git clone https://github.com/MongoEngine/mongoengine
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 890K / month):
	```
	pip install mongoengine
	```
- [Conda](https://anaconda.org/conda-forge/mongoengine) (📥 190K · ⏱️ 21.01.2023):
	```
	conda install -c conda-forge mongoengine
	```
</details>
<details><summary><b><a href="https://github.com/pynamodb/PynamoDB">PynamoDB</a></b> (🥈30 ·  ⭐ 2.1K) - A Pythonic interface for [Amazon.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 400 · 📦 1.3K · 📋 550 - 36% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/pynamodb/PynamoDB
	```
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.3M / month):
	```
	pip install PynamoDB
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 250K · ⏱️ 21.02.2023):
	```
	conda install -c conda-forge PynamoDB
	```
</details>
<details><summary><b><a href="https://github.com/pudo/dataset">dataset</a></b> (🥈26 ·  ⭐ 4.3K) - Store Python dicts in a database - works with SQLite, MySQL, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 2.9K · 📋 280 - 7% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/pudo/dataset
	```
- [PyPi](https://pypi.org/project/dataset) (📥 50K / month):
	```
	pip install dataset
	```
- [Conda](https://anaconda.org/conda-forge/dataset) (📥 4.7K · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 32 · 🔀 160 · 📦 530 · 📋 320 - 42% open · ⏱️ 13.03.2022):

	```
	git clone https://github.com/sdispater/orator
	```
- [PyPi](https://pypi.org/project/orator) (📥 17K / month):
	```
	pip install orator
	```
- [Conda](https://anaconda.org/conda-forge/orator) (📥 2.5K · ⏱️ 18.03.2020):
	```
	conda install -c conda-forge orator
	```
</details>
<details><summary><b><a href="https://github.com/ponyorm/pony">pony</a></b> (🥉20 ·  ⭐ 3.2K) - ORM that provides a generator-oriented interface to SQL. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 46 · 📦 3.2K · 📋 610 - 46% open · ⏱️ 15.12.2022):
...
<details><summary><b><a href="https://github.com/web2py/pydal">pydal</a></b> (🥉18 ·  ⭐ 440) - A pure Python Database Abstraction Layer. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/web2py/pydal) (🔀 130 · 📦 390 · 📋 310 - 44% open · ⏱️ 21.11.2022):
...
- [GitHub](https://github.com/encode/orm) (👨‍💻 18 · 🔀 92 · 📋 79 - 18% open · ⏱️ 30.08.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):

	```
	git clone https://github.com/stephenmcd/hot-redis
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 600 / month):
	```
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 81 · 📋 51 - 70% open · ⏱️ 06.06.2016):
	...
	```
- [PyPi](https://pypi.org/project/redisco) (📥 420 / month):
	```
	pip install redisco
	```
...
<details><summary><b><a href="https://github.com/python-poetry/poetry">poetry</a></b> (🥇30 ·  ⭐ 24K) - Python dependency management and packaging made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 440 · 🔀 1.9K · 📥 15M · 📋 4.7K - 11% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 11M / month):
	```
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 780K · ⏱️ 11.01.2023):
	```
	conda install -c conda-forge poetry
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥉25 ·  ⭐ 6.6K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 490 · 📋 900 - 12% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 9.5M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 73K · ⏱️ 31.01.2023):
	```
	conda install -c conda-forge pip-tools
	```
</details>
<details><summary><b><a href="https://github.com/conda/conda">conda</a></b> (🥉15 ·  ⭐ 5.2K) - Cross-platform, Python-agnostic binary package manager. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/conda/conda) (🔀 1.3K · 📋 8.9K - 9% open · ⏱️ 22.02.2023):
...
<details><summary><b><a href="https://github.com/devpi/devpi">devpi</a></b> (🥇20 ·  ⭐ 660) - PyPI server and packaging/testing/release tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/devpi/devpi) (👨‍💻 92 · 🔀 110 · 📦 210 · 📋 720 - 10% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/devpi/devpi
	```
- [PyPi](https://pypi.org/project/devpi) (📥 3.3K / month):
	```
	pip install devpi
	```
...
<details><summary><b><a href="https://github.com/pypi/warehouse">warehouse</a></b> (🥈15 ·  ⭐ 3.2K) - Next generation Python Package Repository (PyPI). <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 330 · 🔀 790 · 📋 2.9K - 14% open · ⏱️ 22.02.2023):
...
<details><summary><b><a href="https://github.com/pypa/bandersnatch">bandersnatch</a></b> (🥉13 ·  ⭐ 360) - PyPI mirroring tool provided by Python Packaging Authority.. <code><a href="https://tldrlegal.com/search?q=AFL-3.0">❗️AFL-3.0</a></code></summary>

- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 21.02.2023):
...
<details><summary><b><a href="https://github.com/sqlmapproject/sqlmap">sqlmap</a></b> (🥇23 ·  ⭐ 26K) - Automatic SQL injection and database takeover tool. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 4.9K · 📋 4.9K - 1% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 6.4K / month):
	```
	pip install sqlmap
	```
...
<details><summary><b><a href="https://github.com/Manisso/fsociety">fsociety</a></b> (🥉19 ·  ⭐ 8.4K) - A Penetration testing framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Manisso/fsociety) (👨‍💻 22 · 🔀 1.7K · 📋 130 - 25% open · ⏱️ 06.09.2022):

	```
	git clone https://github.com/Manisso/fsociety
	```
- [PyPi](https://pypi.org/project/fsociety) (📥 1.1K / month):
	```
...
<details><summary><b><a href="https://github.com/trustedsec/social-engineer-toolkit">setoolkit</a></b> (🥉18 ·  ⭐ 8.6K · 💀) - A toolkit for social engineering. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/trustedsec/social-engineer-toolkit) (👨‍💻 85 · 🔀 2.3K · 📋 840 - 26% open · ⏱️ 26.01.2022):
...
- [GitHub](https://github.com/django-guardian/django-guardian) (👨‍💻 160 · 🔀 530 · 📦 5.7K · 📋 440 - 27% open · ⏱️ 25.03.2022):
...
- [PyPi](https://pypi.org/project/django-guardian) (📥 350K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-guardian) (📥 44K · ⏱️ 26.05.2021):
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 26 · 🔀 130 · 📦 1.2K · 📋 110 - 22% open · ⏱️ 11.01.2023):

	```
	git clone https://github.com/dfunckt/django-rules
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 120 / month):
	```
...
<details><summary><b><a href="https://github.com/amoffat/sh">sh</a></b> (🥇31 ·  ⭐ 6.5K) - A full-fledged subprocess replacement for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/amoffat/sh) (👨‍💻 91 · 🔀 460 · 📦 12K · 📋 430 - 0% open · ⏱️ 13.02.2023):

	```
	git clone https://github.com/amoffat/sh
	```
- [PyPi](https://pypi.org/project/sh) (📥 3.9M / month):
	```
	pip install sh
	```
- [Conda](https://anaconda.org/conda-forge/sh) (📥 160K · ⏱️ 13.02.2023):
	```
	conda install -c conda-forge sh
	```
</details>
<details><summary><b><a href="https://github.com/amitt001/delegator.py">delegator.py</a></b> (🥉18 ·  ⭐ 1.6K · 💀) - .. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/amitt001/delegator.py) (👨‍💻 23 · 🔀 87 · 📋 45 - 17% open · ⏱️ 06.05.2019):

	```
	git clone https://github.com/amitt001/delegator.py
	```
- [PyPi](https://pypi.org/project/delegator.py) (📥 41K / month):
	```
...
<details><summary><b><a href="https://github.com/spotify/annoy">annoy</a></b> (🥇30 ·  ⭐ 11K) - Approximate Nearest Neighbors in C++/Python optimized for memory usage. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/spotify/annoy) (👨‍💻 82 · 🔀 1.1K · 📦 2.6K · 📋 370 - 12% open · ⏱️ 27.10.2022):
...
<details><summary><b><a href="https://github.com/benfred/implicit">implicit</a></b> (🥈27 ·  ⭐ 3.1K) - A fast Python implementation of collaborative filtering for implicit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 560 · 📥 310 · 📦 860 · 📋 450 - 16% open · ⏱️ 11.12.2022):
...
<details><summary><b><a href="https://github.com/lyst/lightfm">lightfm</a></b> (🥈26 ·  ⭐ 4.3K · 💤) - A Python implementation of a number of popular recommendation.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 640 · 📦 980 · 📋 480 - 26% open · ⏱️ 19.07.2022):

	```
	git clone https://github.com/lyst/lightfm
	```
- [PyPi](https://pypi.org/project/lightfm) (📥 390K / month):
	```
	pip install lightfm
	```
...
<details><summary><b><a href="https://github.com/NicolasHug/Surprise">Surprise</a></b> (🥉20 ·  ⭐ 5.7K) - A scikit for building and analyzing recommender systems. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/maciejkula/spotlight">spotlight</a></b> (🥉20 ·  ⭐ 2.8K · 💀) - Deep recommender models using PyTorch. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 400 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 1.1K / month):
	```
...
- [GitHub](https://github.com/jfkirk/tensorrec) (👨‍💻 9 · 🔀 220 · 📦 29 · 📋 130 - 28% open · ⏱️ 04.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/tensorrec) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 470 · 📦 100 · 📋 110 - 43% open · ⏱️ 24.03.2021):

	```
	git clone https://github.com/ibayer/fastFM
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 280 / month):
	```
	pip install fastFM
	```
...
<details><summary><b><a href="https://github.com/python-rope/rope">Rope</a></b> (🥇29 ·  ⭐ 1.5K) - Rope is a python refactoring library. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/python-rope/rope) (👨‍💻 78 · 🔀 140 · 📦 58K · 📋 290 - 26% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 600K / month):
	```
	pip install rope
	```
- [Conda](https://anaconda.org/conda-forge/rope) (📥 1M · ⏱️ 29.01.2023):
	```
...
<details><summary><b><a href="https://github.com/tiangolo/fastapi">fastapi</a></b> (🥇38 ·  ⭐ 55K · 📈) - A modern, fast, web framework for building APIs with Python 3.6+ based.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 420 · 🔀 4.4K · 📦 150K · 📋 3.3K - 27% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 13M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 1.3M · ⏱️ 14.02.2023):
	```
	conda install -c conda-forge fastapi
	```
</details>
<details><summary><b><a href="https://github.com/falconry/falcon">falcon</a></b> (🥈34 ·  ⭐ 9K) - A high-performance framework for building cloud APIs and web app.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 880 · 📥 4.3K · 📦 7.7K · 📋 970 - 15% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 720K / month):
	```
	pip install falcon
	```
- [Conda](https://anaconda.org/conda-forge/falcon) (📥 300K · ⏱️ 19.11.2022):
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 980 · 📦 88K · 📋 550 - 16% open · ⏱️ 04.03.2022):
...
- [PyPi](https://pypi.org/project/flask-restful) (📥 1.5M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-restful) (📥 150K · ⏱️ 30.05.2021):
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.4K · 📦 13K · 📋 1.3K - 4% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 940K / month):
	```
	pip install sanic
	```
- [Conda](https://anaconda.org/conda-forge/sanic) (📥 260K · ⏱️ 28.12.2022):
	```
	conda install -c conda-forge sanic
	```
</details>
<details><summary><b><a href="https://github.com/hugapi/hug">hug</a></b> (🥉29 ·  ⭐ 6.7K · 💀) - A Python 3 framework for cleanly exposing APIs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 2.2K · 📋 460 - 35% open · ⏱️ 10.08.2020):

	```
	git clone https://github.com/hugapi/hug
	```
- [PyPi](https://pypi.org/project/hug) (📥 83K / month):
	```
	pip install hug
	```
- [Conda](https://anaconda.org/conda-forge/hug) (📥 170K · ⏱️ 26.01.2022):
	```
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 33 · 🔀 180 · 📦 5.7K · 📋 64 - 18% open · ⏱️ 01.12.2022):

	```
	git clone https://github.com/flask-api/flask-api
	```
- [PyPi](https://pypi.org/project/flask-api) (📥 150K / month):
	```
...
- [GitHub](https://github.com/pyeve/eve) (👨‍💻 210 · 🔀 730 · 📦 1.1K · 📋 970 - 2% open · ⏱️ 10.11.2022):
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 91 · 🔀 410 · 📦 730 · 📋 310 - 7% open · ⏱️ 31.08.2021):
...
- [GitHub](https://github.com/Cornices/cornice) (👨‍💻 120 · 🔀 140 · 📦 800 · 📋 240 - 19% open · ⏱️ 18.07.2022):
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 210 · 📦 24 · 📋 84 - 38% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 230 / month):
	```
...
<details><summary><b><a href="https://github.com/AtsushiSakai/PythonRobotics">PythonRobotics</a></b> (🥇17 ·  ⭐ 18K) - This is a compilation of various robotics algorithms.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 110 · 🔀 5.2K · 📋 310 - 4% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/zerorpc-python):
	...
	```
- [Conda](https://anaconda.org/conda-forge/zerorpc-python) (📥 1.8K · ⏱️ 06.06.2022):
	```
...
<details><summary><b><a href="https://github.com/statsmodels/statsmodels">statsmodels</a></b> (🥇35 ·  ⭐ 8.2K) - Statistical modeling and econometrics in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 410 · 🔀 2.5K · 📥 27 · 📦 86K · 📋 5K - 47% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/statsmodels/statsmodels
	```
- [PyPi](https://pypi.org/project/statsmodels) (📥 8.9M / month):
	```
	pip install statsmodels
	```
- [Conda](https://anaconda.org/conda-forge/statsmodels) (📥 8.8M · ⏱️ 04.11.2022):
	```
	conda install -c conda-forge statsmodels
	```
</details>
<details><summary><b><a href="https://github.com/sympy/sympy">SymPy</a></b> (🥈34 ·  ⭐ 10K) - A Python library for symbolic mathematics. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.8K · 📥 490K · 📦 54K · 📋 12K - 32% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 3M / month):
	```
	pip install sympy
	```
- [Conda](https://anaconda.org/conda-forge/sympy) (📥 2.9M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4.1K · 📦 910 · 📋 980 - 33% open · ⏱️ 14.10.2020):
...
- [PyPi](https://pypi.org/project/zipline) (📥 2.7K / month):
	...
	pip install zipline
	```
- [Conda](https://anaconda.org/conda-forge/zipline) (📥 6.8K · ⏱️ 05.10.2020):
	```
	conda install -c conda-forge zipline
	```
</details>
<details><summary><b><a href="https://github.com/pymc-devs/pymc">PyMC</a></b> (🥉27 ·  ⭐ 7.3K) - Markov Chain Monte Carlo sampling toolkit. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 440 · 🔀 1.7K · 📥 1.9K · 📦 1.2K · 📋 3K - 5% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/pymc-devs/pymc3
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 300K / month):
	```
	pip install pymc3
	```
- [Conda](https://anaconda.org/conda-forge/pymc3) (📥 490K · ⏱️ 20.05.2022):
	```
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 130 · 📋 100 - 2% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/benedekrozemberczki/karateclub
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 2.4K / month):
	```
	pip install karateclub
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 16K · ⏱️ 28.01.2022):
	```
	conda install -c conda-forge karateclub
	```
</details>
<details><summary><b><a href="https://github.com/bcbio/bcbio-nextgen">bcbio-nextgen</a></b> (🥉21 ·  ⭐ 920) - Providing best-practice pipelines for fully automated high.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 96 · 🔀 340 · 📋 3K - 3% open · ⏱️ 23.01.2023):
...
<details><summary><b><a href="https://github.com/obspy/obspy">ObsPy</a></b> (🥉18 ·  ⭐ 1K) - A Python toolbox for seismology. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/obspy/obspy) (🔀 500 · 📥 6.8K · 📋 1.7K - 9% open · ⏱️ 23.01.2023):
...
<details><summary><b><a href="https://github.com/chapmanb/bcbb">bccb</a></b> (🥉18 ·  ⭐ 560 · 💀) - Collection of useful code related to biological analysis. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/chapmanb/bcbb) (👨‍💻 32 · 🔀 220 · 📦 250 · 📋 74 - 20% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 210 · 🔀 1.2K · 📦 8.8K · 📋 1.2K - 36% open · ⏱️ 30.01.2023):
...
- [PyPi](https://pypi.org/project/django-haystack) (📥 110K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/django-haystack) (📥 5.2K · ⏱️ 31.05.2018):
	```
	conda install -c conda-forge django-haystack
	```
</details>
<details><summary><b><a href="https://github.com/django-haystack/pysolr">pysolr</a></b> (🥉27 ·  ⭐ 630 · 💤) - A lightweight Python wrapper for [Apache.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 300 · 📦 2.9K · 📋 140 - 15% open · ⏱️ 12.04.2022):

	```
	git clone https://github.com/django-haystack/pysolr
	```
- [PyPi](https://pypi.org/project/pysolr) (📥 230K / month):
	```
	pip install pysolr
	```
- [Conda](https://anaconda.org/conda-forge/pysolr) (📥 20K · ⏱️ 28.04.2020):
	```
	conda install -c conda-forge pysolr
	```
</details>
<details><summary><b><a href="https://github.com/elastic/elasticsearch-dsl-py">elasticsearch-dsl-py</a></b> (🥉23 ·  ⭐ 3.6K) - The official high-level Python client for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 750 · 📥 160 · 📦 8.6K · 📋 1.3K - 9% open · ⏱️ 27.10.2022):
...
<details><summary><b><a href="https://github.com/marshmallow-code/marshmallow">marshmallow</a></b> (🥇30 ·  ⭐ 6.4K) - A lightweight library for converting complex objects to and from.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 70K · 📋 1.2K - 11% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/marshmallow-code/marshmallow
	```
- [PyPi](https://pypi.org/project/marshmallow) (📥 19M / month):
	```
	pip install marshmallow
	```
- [Conda](https://anaconda.org/conda-forge/marshmallow) (📥 1.5M · ⏱️ 13.11.2022):
	```
	conda install -c conda-forge marshmallow
	```
</details>
<details><summary><b><a href="https://github.com/TkTech/pysimdjson">pysimdjson</a></b> (🥈23 ·  ⭐ 570) - A Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 47 · 📦 880 · 📋 80 - 15% open · ⏱️ 12.09.2022):

	```
	git clone https://github.com/TkTech/pysimdjson
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 210K / month):
	```
	pip install pysimdjson
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 54K · ⏱️ 29.10.2022):
	```
	conda install -c conda-forge pysimdjson
	```
</details>
<details><summary><b><a href="https://github.com/python-rapidjson/python-rapidjson">python-rapidjson</a></b> (🥉22 ·  ⭐ 470) - A Python wrapper around.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 19 · 🔀 42 · 📦 3.7K · 📋 100 - 11% open · ⏱️ 17.10.2022):

	```
	git clone https://github.com/python-rapidjson/python-rapidjson
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 910K / month):
	```
	pip install python-rapidjson
	```
- [Conda](https://anaconda.org/conda-forge/python-rapidjson) (📥 1.1M · ⏱️ 28.10.2022):
	```
	conda install -c conda-forge python-rapidjson
	```
</details>
<details><summary><b><a href="https://github.com/ultrajson/ultrajson">ultrajson</a></b> (🥉15 ·  ⭐ 4K) - A fast JSON decoder and encoder written in C with Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/ultrajson/ultrajson) (👨‍💻 85 · 🔀 330 · 📋 330 - 6% open · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📥 290 · 📋 1.3K - 47% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/Zappa) (📥 97K / month):
	```
	pip install Zappa
	```
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 48 · 🔀 220 · 📦 180 · 📋 90 - 41% open · ⏱️ 03.06.2022):

	```
	git clone https://github.com/nficano/python-lambda
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 4.8K / month):
	```
...
<details><summary><b><a href="https://github.com/xonsh/xonsh">xonsh</a></b> (🥇15 ·  ⭐ 6.8K) - A Python-powered, cross-platform, Unix-gazing shell language and.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xonsh/xonsh) (🔀 570 · 📥 8.2K · 📋 2.4K - 10% open · ⏱️ 23.02.2023):
...
<details><summary><b><a href="https://github.com/lepture/mistune">Mistune</a></b> (🥇34 ·  ⭐ 2.2K) - Fastest and full featured pure Python parsers of Markdown. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/lepture/mistune) (👨‍💻 36 · 🔀 220 · 📦 200K · 📋 250 - 5% open · ⏱️ 04.02.2023):
...
- [PyPi](https://pypi.org/project/mistune) (📥 13M / month):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 11M · ⏱️ 07.02.2023):
	```
	conda install -c conda-forge mistune
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/tablib">tablib</a></b> (🥇33 ·  ⭐ 4.2K) - A module for Tabular Datasets in XLS, CSV, JSON, YAML. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 32K · 📋 240 - 11% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/jazzband/tablib
	```
- [PyPi](https://pypi.org/project/tablib) (📥 1.5M / month):
	```
	pip install tablib
	```
- [Conda](https://anaconda.org/conda-forge/tablib) (📥 82K · ⏱️ 16.01.2023):
	```
	conda install -c conda-forge tablib
	```
</details>
<details><summary><b><a href="https://github.com/jmcnamara/XlsxWriter">XlsxWriter</a></b> (🥈32 ·  ⭐ 3.2K) - A Python module for creating Excel .xlsx files. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 56K · 📋 840 - 1% open · ⏱️ 19.02.2023):
...
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/XlsxWriter) (📥 2.5M · ⏱️ 03.02.2023):
	```
	conda install -c conda-forge XlsxWriter
	```
</details>
<details><summary><b><a href="https://github.com/wireservice/csvkit">csvkit</a></b> (🥈28 ·  ⭐ 5.4K) - Utilities for converting to and working with CSV. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 560 · 📦 1.3K · 📋 870 - 7% open · ⏱️ 22.02.2023):
...
- [PyPi](https://pypi.org/project/csvkit) (📥 160K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 81K · ⏱️ 22.02.2023):
	```
	conda install -c conda-forge csvkit
	```
</details>
<details><summary><b><a href="https://github.com/euske/pdfminer">PDFMiner</a></b> (🥈27 ·  ⭐ 5K · 💀) - A tool for extracting information from PDF documents. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/euske/pdfminer) (👨‍💻 28 · 🔀 1K · 📦 3.6K · 📋 240 - 82% open · ⏱️ 18.01.2020):
...
- [PyPi](https://pypi.org/project/pdfminer) (📥 160K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pdfminer) (📥 27K · ⏱️ 15.02.2021):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 440 · 📥 24K · 📦 27K · 📋 1.7K - 15% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 78K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 550K · ⏱️ 05.02.2023):
	```
...
- [GitHub](https://github.com/pyexcel/pyexcel) (👨‍💻 20 · 🔀 160 · 📥 160 · 📦 3.3K · 📋 210 - 6% open · ⏱️ 09.09.2022):

	```
	git clone https://github.com/pyexcel/pyexcel
	```
- [PyPi](https://pypi.org/project/pyexcel) (📥 180K / month):
	```
	pip install pyexcel
	```
- [Conda](https://anaconda.org/conda-forge/pyexcel) (📥 54K · ⏱️ 13.02.2022):
	```
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 770 · 📦 250K · 📋 800 - 4% open · ⏱️ 09.01.2023):
...
<details><summary><b><a href="https://github.com/py-pdf/pypdf">PyPDF2</a></b> (🥉23 ·  ⭐ 5.2K · 📉) - A library capable of splitting, merging and transforming PDF.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 170 · 🔀 1K · 📋 680 - 10% open · ⏱️ 15.02.2023):

	```
	git clone https://github.com/mstamy2/PyPDF2
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 4.9M / month):
	```
	pip install PyPDF2
	```
- [Conda](https://anaconda.org/conda-forge/PyPDF2) (📥 350K · ⏱️ 29.10.2022):
	```
	conda install -c conda-forge PyPDF2
	```
</details>
<details><summary><b><a href="https://github.com/unoconv/unoconv">unoconv</a></b> (🥉23 ·  ⭐ 2.4K · 💀) - Convert between any document format supported by.. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 370 · 📦 110 · 📋 480 - 16% open · ⏱️ 12.11.2021):

	```
	git clone https://github.com/unoconv/unoconv
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 25K / month):
	```
	pip install unoconv
	```
...
<details><summary><b><a href="https://github.com/python-openxml/python-docx">python-docx</a></b> (🥉22 ·  ⭐ 3.5K · 💀) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 840 · 📋 1K - 48% open · ⏱️ 15.05.2021):

	```
	git clone https://github.com/python-openxml/python-docx
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 3.2M / month):
	```
	pip install python-docx
	```
- [Conda](https://anaconda.org/conda-forge/python-docx) (📥 130K · ⏱️ 27.05.2021):
	```
	conda install -c conda-forge python-docx
	```
</details>
<details><summary><b><a href="https://github.com/scanny/python-pptx">python-pptx</a></b> (🥉22 ·  ⭐ 1.7K · 💀) - Python library for creating and updating PowerPoint (.pptx) files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 380 · 📋 760 - 46% open · ⏱️ 20.09.2021):

	```
	git clone https://github.com/scanny/python-pptx
	```
- [PyPi](https://pypi.org/project/python-pptx) (📥 1.4M / month):
	```
	pip install python-pptx
	```
- [Conda](https://anaconda.org/conda-forge/python-pptx) (📥 190K · ⏱️ 21.09.2021):
	```
	conda install -c conda-forge python-pptx
	```
</details>
<details><summary><b><a href="https://github.com/elapouya/python-docx-template">docxtpl</a></b> (🥉20 ·  ⭐ 1.5K) - Editing a docx document by jinja2 template. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 51 · 🔀 330 · 📦 1.6K · 📋 390 - 19% open · ⏱️ 07.01.2023):
...
<details><summary><b><a href="https://github.com/getpelican/pelican">pelican</a></b> (🥇31 ·  ⭐ 11K) - Static site generator that supports Markdown and reST syntax. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>

- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 740 · 📦 6.7K · 📋 1.6K - 4% open · ⏱️ 30.01.2023):
...
<details><summary><b><a href="https://github.com/mkdocs/mkdocs">mkdocs</a></b> (🥈28 ·  ⭐ 16K) - Markdown friendly documentation generator. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/mkdocs/mkdocs) (🔀 2.1K · 📦 40K · 📋 1.8K - 6% open · ⏱️ 06.11.2022):
...
- [PyPi](https://pypi.org/project/nikola) (📥 900 / month):
	...
	pip install nikola
	```
- [Conda](https://anaconda.org/conda-forge/nikola) (📥 7.4K · ⏱️ 24.05.2022):
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 300 · 📥 7K · 📋 620 - 35% open · ⏱️ 18.12.2022):

	```
	git clone https://github.com/lektor/lektor
	```
- [PyPi](https://pypi.org/project/lektor) (📥 3.2K / month):
	```
	pip install lektor
	```
- [Conda](https://anaconda.org/conda-forge/lektor) (📥 60K · ⏱️ 22.09.2022):
	```
...
- [GitHub](https://github.com/sunainapai/makesite) (👨‍💻 8 · 🔀 270 · 📋 13 - 38% open · ⏱️ 12.10.2022):
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 150 · 🔀 560 · 📋 400 - 18% open · ⏱️ 21.11.2022):

	```
	git clone https://github.com/jazzband/django-taggit
	```
- [PyPi](https://pypi.org/project/django-taggit) (📥 400K / month):
	```
	pip install django-taggit
	```
- [Conda](https://anaconda.org/conda-forge/django-taggit) (📥 100K · ⏱️ 18.11.2022):
	```
...
<details><summary><b><a href="https://github.com/rq/rq">rq</a></b> (🥇33 ·  ⭐ 8.8K) - Simple job queues for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 13K · 📋 1K - 13% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/rq) (📥 800K / month):
	...
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 86K · ⏱️ 30.06.2021):
	```
	conda install -c conda-forge rq
	```
</details>
<details><summary><b><a href="https://github.com/coleifer/huey">huey</a></b> (🥈29 ·  ⭐ 4.4K) - Little multi-threaded task queue. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 350 · 📦 1.1K · ⏱️ 10.02.2023):

	```
	git clone https://github.com/coleifer/huey
	```
- [PyPi](https://pypi.org/project/huey) (📥 73K / month):
	```
	pip install huey
	```
...
<details><summary><b><a href="https://github.com/Bogdanp/dramatiq">dramatiq</a></b> (🥉26 ·  ⭐ 3.5K) - A fast and reliable background task processing library for Python.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 86 · 🔀 240 · 📥 36 · 📦 840 · 📋 310 - 11% open · ⏱️ 05.02.2023):

	```
	git clone https://github.com/Bogdanp/dramatiq
	```
- [PyPi](https://pypi.org/project/dramatiq) (📥 120K / month):
	```
	pip install dramatiq
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 40K · ⏱️ 06.02.2023):
	```
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 40 · 🔀 110 · 📦 29 · 📋 170 - 30% open · ⏱️ 13.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrq) (📥 200 / month):
	```
	pip install mrq
	```
...
<details><summary><b><a href="https://github.com/pallets/jinja">Jinja2</a></b> (🥇23 ·  ⭐ 9.1K) - A modern and designer friendly templating language. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 940 - 5% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/pallets/jinja
	```
- [PyPi](https://pypi.org/project/jinja) (📥 8.6K / month):
	```
	pip install jinja
	```
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 510 · 🔀 1.7K · 📦 110K · 📋 610 - 1% open · ⏱️ 19.02.2023):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 7.3M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 720K · ⏱️ 14.02.2023):
	```
	conda install -c conda-forge faker
	```
</details>
<details><summary><b><a href="https://github.com/robotframework/robotframework">Robot Framework</a></b> (🥇35 ·  ⭐ 7.8K) - A generic test automation framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 170 · 🔀 2K · 📥 540 · 📦 7.2K · 📋 4K - 5% open · ⏱️ 15.02.2023):
...
- [PyPi](https://pypi.org/project/robotframework) (📥 1.6M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robotframework) (📥 110K · ⏱️ 12.01.2023):
	```
	conda install -c conda-forge robotframework
	```
</details>
<details><summary><b><a href="https://github.com/HypothesisWorks/hypothesis">hypothesis</a></b> (🥇33 ·  ⭐ 6.5K) - Hypothesis is an advanced Quickcheck style property based.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 520 · 📦 19K · 📋 1.4K - 3% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 4.8M / month):
	```
	pip install hypothesis
	```
- [Conda](https://anaconda.org/conda-forge/hypothesis) (📥 7.2M · ⏱️ 17.02.2023):
	```
	conda install -c conda-forge hypothesis
	```
</details>
<details><summary><b><a href="https://github.com/getsentry/responses">responses</a></b> (🥇33 ·  ⭐ 3.8K) - A utility library for mocking out the requests Python library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 300 · 📥 87 · 📦 23K · 📋 260 - 0% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 8.8M / month):
	```
	pip install responses
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 1.4M · ⏱️ 26.05.2022):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.2K · 📋 510 - 8% open · ⏱️ 23.02.2023):
...
<details><summary><b><a href="https://github.com/asweigart/pyautogui">PyAutoGUI</a></b> (🥈30 ·  ⭐ 7.7K · 💀) - PyAutoGUI is a cross-platform GUI automation Python module for.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 1K · 📦 21K · 📋 610 - 63% open · ⏱️ 14.09.2021):
...
- [PyPi](https://pypi.org/project/pyautogui) (📥 550K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pyautogui) (📥 180K · ⏱️ 10.09.2022):
	```
	conda install -c conda-forge pyautogui
	```
</details>
<details><summary><b><a href="https://github.com/lk-geimfari/mimesis">mimesis</a></b> (🥈30 ·  ⭐ 3.9K) - is a Python library that help you generate fake data. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 380 · 📦 1.3K · 📋 310 - 0% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 100K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 82K · ⏱️ 18.12.2022):
	```
	conda install -c conda-forge mimesis
	```
</details>
<details><summary><b><a href="https://github.com/kevin1024/vcrpy">VCR.py</a></b> (🥈30 ·  ⭐ 2.4K) - Record and replay HTTP interactions on your tests. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/kevin1024/vcrpy) (👨‍💻 120 · 🔀 310 · 📦 7K · 📋 340 - 25% open · ⏱️ 01.11.2022):

	```
	git clone https://github.com/kevin1024/vcrpy
	```
- [PyPi](https://pypi.org/project/vcrpy) (📥 1.2M / month):
	```
	pip install vcrpy
	```
- [Conda](https://anaconda.org/conda-forge/vcrpy) (📥 280K · ⏱️ 01.09.2022):
	```
	conda install -c conda-forge vcrpy
	```
</details>
<details><summary><b><a href="https://github.com/locustio/locust">locust</a></b> (🥈29 ·  ⭐ 21K) - Scalable user load testing tool written in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.6K · 📋 1.4K - 0% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/locustio/locust
	```
- [PyPi](https://pypi.org/project/locust) (📥 1.3M / month):
	```
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 100K · ⏱️ 06.01.2023):
	```
	conda install -c conda-forge locust
	```
</details>
<details><summary><b><a href="https://github.com/schemathesis/schemathesis">Schemathesis</a></b> (🥉28 ·  ⭐ 1.6K) - A tool for automatic property-based testing of web applications.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 53 · 🔀 120 · 📦 200 · 📋 700 - 16% open · ⏱️ 20.02.2023):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 60K / month):
	```
	pip install schemathesis
	```
- [Conda](https://anaconda.org/conda-forge/schemathesis) (📥 3.5K · ⏱️ 18.02.2023):
	```
	conda install -c conda-forge schemathesis
	```
</details>
<details><summary><b><a href="https://github.com/gabrielfalcao/HTTPretty">httpretty</a></b> (🥉27 ·  ⭐ 2K) - HTTP request mock tool for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gabrielfalcao/HTTPretty) (👨‍💻 100 · 🔀 250 · 📦 14K · 📋 240 - 39% open · ⏱️ 16.10.2022):

	```
	git clone https://github.com/gabrielfalcao/HTTPretty
	```
- [PyPi](https://pypi.org/project/HTTPretty) (📥 450K / month):
	```
	pip install HTTPretty
	```
- [Conda](https://anaconda.org/conda-forge/HTTPretty) (📥 280K · ⏱️ 16.08.2021):
	```
	conda install -c conda-forge HTTPretty
	```
</details>
<details><summary><b><a href="https://github.com/spulec/freezegun">freezegun</a></b> (🥉24 ·  ⭐ 3.6K) - Travel through time by mocking the datetime module. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 230 · 📋 280 - 36% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 6.2M / month):
	```
	pip install freezegun
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 720K · ⏱️ 12.08.2022):
	```
	conda install -c conda-forge freezegun
	```
</details>
<details><summary><b><a href="https://github.com/nose-devs/nose2">nose2</a></b> (🥉24 ·  ⭐ 740) - The successor to `nose`, based on `unittest2`. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 23K · 📋 260 - 19% open · ⏱️ 07.02.2023):
...
- [PyPi](https://pypi.org/project/nose2) (📥 560K / month):
	...
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 84K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 130 · 🔀 350 · 📋 540 - 29% open · ⏱️ 07.02.2023):

	```
	git clone https://github.com/FactoryBoy/factory_boy
	```
- [PyPi](https://pypi.org/project/factory_boy) (📥 2.6M / month):
	```
	pip install factory_boy
	```
- [Conda](https://anaconda.org/conda-forge/factory_boy) (📥 120K · ⏱️ 26.10.2021):
	```
	conda install -c conda-forge factory_boy
	```
</details>
<details><summary><b><a href="https://github.com/CleanCut/green">green</a></b> (🥉21 ·  ⭐ 760) - A clean, colorful test runner. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/CleanCut/green) (👨‍💻 38 · 🔀 72 · 📦 970 · 📋 180 - 2% open · ⏱️ 20.09.2022):
...
- [PyPi](https://pypi.org/project/green) (📥 14K / month):
	...
	pip install green
	```
- [Conda](https://anaconda.org/conda-forge/green) (📥 120K · ⏱️ 30.10.2022):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):

	```
	git clone https://github.com/seatgeek/sixpack
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 98 / month):
	```
	pip install sixpack
	```
...
- [GitHub](https://github.com/patrys/httmock) (👨‍💻 29 · 🔀 48 · 📦 2.1K · 📋 26 - 42% open · ⏱️ 28.10.2020):

	```
	git clone https://github.com/patrys/httmock
	```
- [PyPi](https://pypi.org/project/httmock) (📥 330K / month):
	```
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 7.3K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 24 · 🔀 39 · 📦 78 · ⏱️ 21.02.2023):
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 110 · 📦 22 · 📋 22 - 31% open · ⏱️ 25.11.2019):

	```
	git clone https://github.com/emirozer/fake2db
	```
- [PyPi](https://pypi.org/project/fake2db) (📥 220 / month):
	```
	pip install fake2db
	```
...
- [GitHub](https://github.com/berinhard/model_mommy) (👨‍💻 100 · 🔀 140 · ⏱️ 21.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/model_mommy) (📥 75K / month):
	```
...
<details><summary><b><a href="https://github.com/klen/mixer">mixer</a></b> (🥉17 ·  ⭐ 880 · 💤) - Another fixtures replacement. Supports Django, Flask,.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/klen/mixer) (👨‍💻 43 · 🔀 90 · 📋 84 - 41% open · ⏱️ 23.03.2022):

	```
	git clone https://github.com/klen/mixer
	```
- [PyPi](https://pypi.org/project/mixer) (📥 110K / month):
	```
	pip install mixer
	```
...
<details><summary><b><a href="https://github.com/andialbrecht/sqlparse">sqlparse</a></b> (🥇35 ·  ⭐ 3.2K · 📈) - A non-validating SQL parser. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 600 · 📦 680K · 📋 490 - 42% open · ⏱️ 05.01.2023):

	```
	git clone https://github.com/andialbrecht/sqlparse
	```
- [PyPi](https://pypi.org/project/sqlparse) (📥 33M / month):
	```
	pip install sqlparse
	```
- [Conda](https://anaconda.org/conda-forge/sqlparse) (📥 1.5M · ⏱️ 24.09.2022):
	```
	conda install -c conda-forge sqlparse
	```
</details>
<details><summary><b><a href="https://github.com/pyparsing/pyparsing">pyparsing</a></b> (🥇34 ·  ⭐ 1.8K) - A general purpose framework for generating parsers. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 53 · 🔀 240 · 📥 7.6K · 📦 730K · 📋 280 - 12% open · ⏱️ 12.02.2023):

	```
	git clone https://github.com/pyparsing/pyparsing
	```
- [PyPi](https://pypi.org/project/pyparsing) (📥 77M / month):
	```
	pip install pyparsing
	```
- [Conda](https://anaconda.org/conda-forge/pyparsing) (📥 32M · ⏱️ 14.07.2022):
	```
	conda install -c conda-forge pyparsing
	```
</details>
<details><summary><b><a href="https://github.com/seatgeek/fuzzywuzzy">fuzzywuzzy</a></b> (🥈31 ·  ⭐ 8.8K · 💀) - Fuzzy String Matching. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📦 17K · 📋 180 - 44% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/seatgeek/fuzzywuzzy
	```
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 6.1M / month):
	```
	pip install fuzzywuzzy
	```
- [Conda](https://anaconda.org/conda-forge/fuzzywuzzy) (📥 440K · ⏱️ 18.11.2020):
	```
	conda install -c conda-forge fuzzywuzzy
	```
</details>
<details><summary><b><a href="https://github.com/skorokithakis/shortuuid">shortuuid</a></b> (🥈30 ·  ⭐ 1.8K) - A generator library for concise, unambiguous and URL-safe UUIDs. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 33 · 🔀 110 · 📦 16K · ⏱️ 14.01.2023):

	```
	git clone https://github.com/skorokithakis/shortuuid
	```
- [PyPi](https://pypi.org/project/shortuuid) (📥 3.6M / month):
	```
	pip install shortuuid
	```
- [Conda](https://anaconda.org/conda-forge/shortuuid) (📥 320K · ⏱️ 17.11.2022):
	```
	conda install -c conda-forge shortuuid
	```
</details>
<details><summary><b><a href="https://github.com/life4/textdistance">textdistance</a></b> (🥈27 ·  ⭐ 3.1K) - Compute distance between sequences with 30+ algorithms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 880 · 📦 3.6K · ⏱️ 18.09.2022):

	```
	git clone https://github.com/orsinium/textdistance
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 400K / month):
	```
	pip install textdistance
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 320K · ⏱️ 18.09.2022):
	```
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 100 · 📦 27K · 📋 48 - 27% open · ⏱️ 16.09.2022):

	```
	git clone https://github.com/pwaller/pyfiglet
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 950K / month):
	```
	pip install pyfiglet
	```
- [Conda](https://anaconda.org/conda-forge/pyfiglet) (📥 130K · ⏱️ 18.05.2019):
	```
	conda install -c conda-forge pyfiglet
	```
</details>
<details><summary><b><a href="https://github.com/chardet/chardet">chardet</a></b> (🥈24 ·  ⭐ 1.9K) - Python 2/3 compatible character encoding detector. <code><a href="https://tldrlegal.com/search?q=LGPL-2.1">❗️LGPL-2.1</a></code></summary>

- [GitHub](https://github.com/chardet/chardet) (👨‍💻 48 · 🔀 240 · 📋 130 - 36% open · ⏱️ 02.12.2022):

	```
	git clone https://github.com/chardet/chardet
	```
- [PyPi](https://pypi.org/project/chardet) (📥 58M / month):
	```
	pip install chardet
	```
- [Conda](https://anaconda.org/conda-forge/chardet) (📥 19M · ⏱️ 02.12.2022):
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 32 · 🔀 92 · 📋 65 - 3% open · ⏱️ 27.01.2023):

	```
	git clone https://github.com/un33k/python-slugify
	```
- [PyPi](https://pypi.org/project/python-slugify) (📥 13M / month):
	```
	pip install python-slugify
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 1.3M · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 35 · 🔀 400 · 📋 180 - 1% open · ⏱️ 29.11.2022):

	```
	git clone https://github.com/dabeaz/ply
	```
- [PyPi](https://pypi.org/project/ply) (📥 22M / month):
	```
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 3.4M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 32 · 🔀 190 · 📦 5.7K · 📋 72 - 55% open · ⏱️ 16.02.2023):
...
<details><summary><b><a href="https://github.com/mozillazg/python-pinyin">pypinyin</a></b> (🥉20 ·  ⭐ 4.2K) - Convert Chinese hanzi () to pinyin (). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 240 - 10% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/mozillazg/python-pinyin
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 25 / month):
	```
...
<details><summary><b><a href="https://github.com/rspeer/python-ftfy">ftfy</a></b> (🥉20 ·  ⭐ 3.4K) - Makes Unicode text less broken and more consistent automagically. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 9.3K · 📋 130 - 9% open · ⏱️ 25.10.2022):
...
<details><summary><b><a href="https://github.com/mozilla/unicode-slugify">unicode-slugify</a></b> (🥉20 ·  ⭐ 320 · 💀) - A slugifier that generates unicode slugs with Django as a.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/derek73/python-nameparser">python-nameparser</a></b> (🥉18 ·  ⭐ 580) - Parsing human names into their individual components. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/derek73/python-nameparser) (👨‍💻 22 · 🔀 93 · 📦 1.1K · 📋 100 - 20% open · ⏱️ 14.11.2022):
...
<details><summary><b><a href="https://github.com/voronind/awesome-slugify">awesome-slugify</a></b> (🥉18 ·  ⭐ 470 · 💀) - A Python slugify library that can preserve unicode. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/voronind/awesome-slugify) (👨‍💻 11 · 🔀 41 · 📦 3.2K · 📋 24 - 54% open · ⏱️ 20.01.2017):

	```
	git clone https://github.com/dimka665/awesome-slugify
	```
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 58K / month):
	```
	pip install awesome-slugify
	```
- [Conda](https://anaconda.org/conda-forge/awesome-slugify) (📥 65K · ⏱️ 28.06.2019):
	```
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 27 · 🔀 380 · 📋 160 - 3% open · ⏱️ 10.02.2023):
...
<details><summary><b><a href="https://github.com/vinta/pangu.py">pangu.py</a></b> (🥉14 ·  ⭐ 200 · 💀) - Paranoid text spacing. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 21 · 📦 130 · 📋 8 - 37% open · ⏱️ 09.02.2019):
...
- [GitHub](https://github.com/davidaurelio/hashids-python) (👨‍💻 10 · 🔀 98 · 📋 24 - 25% open · ⏱️ 07.09.2020):
...
<details><summary><b><a href="https://github.com/boto/boto3">boto3</a></b> (🥇37 ·  ⭐ 7.9K) - Python interface to Amazon Web Services. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.6K · 📦 270K · 📋 2.9K - 4% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 550M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 14M · ⏱️ 23.02.2023):
	```
	conda install -c conda-forge boto3
	```
</details>
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥈35 ·  ⭐ 6.3K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 140K · 📋 960 - 8% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 43M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 1.9M · ⏱️ 21.02.2023):
	```
	conda install -c conda-forge google-api-python-client
	```
</details>
<details><summary><b><a href="https://github.com/burnash/gspread">gspread</a></b> (🥈35 ·  ⭐ 6.3K) - Google Spreadsheets Python API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 860 · 📥 330 · 📦 21K · 📋 780 - 7% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 8.4M / month):
	```
	pip install gspread
	```
- [Conda](https://anaconda.org/conda-forge/gspread) (📥 250K · ⏱️ 22.11.2022):
	```
	conda install -c conda-forge gspread
	```
</details>
<details><summary><b><a href="https://github.com/ryanmcgrath/twython">twython</a></b> (🥉28 ·  ⭐ 1.9K · 💀) - A Python wrapper for the Twitter API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/ryanmcgrath/twython) (👨‍💻 100 · 🔀 390 · 📦 6.3K · 📋 330 - 6% open · ⏱️ 16.07.2021):
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 920 · 📦 4.4K · 📋 240 - 8% open · ⏱️ 27.12.2020):
...
- [GitHub](https://github.com/jcarbaugh/django-wordpress) (👨‍💻 10 · 🔀 78 · 📦 6 · 📋 11 - 18% open · ⏱️ 24.01.2018):
	...
	```
- [PyPi](https://pypi.org/project/django-wordpress) (📥 16 / month):
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.8K · 📋 280 - 2% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 820K / month):
	```
	pip install webargs
	```
- [Conda](https://anaconda.org/conda-forge/webargs) (📥 190K · ⏱️ 13.07.2022):
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 60 · 📦 7.8K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 61K / month):
	```
...
<details><summary><b><a href="https://github.com/codeinthehole/purl">purl</a></b> (🥉22 ·  ⭐ 290 · 💀) - A simple, immutable URL class with a clean API for interrogation and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 35 · 📦 3.7K · 📋 20 - 25% open · ⏱️ 15.05.2021):
...
- [PyPi](https://pypi.org/project/furl) (📥 2.2M / month):
	...
	pip install furl
	```
- [Conda](https://anaconda.org/conda-forge/furl) (📥 230K · ⏱️ 28.09.2021):
	```
...
<details><summary><b><a href="https://github.com/abhiTronix/vidgear">vidgear</a></b> (🥇24 ·  ⭐ 2.7K) - Most Powerful multi-threaded Video Processing framework. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 210 · 📥 740 · 📦 350 · 📋 250 - 1% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/abhiTronix/vidgear
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 4.9K / month):
	```
	pip install vidgear
	```
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 37K / month):
	```
	pip install scikit-video
	```
- [Conda](https://anaconda.org/conda-forge/scikit-video) (📥 23K · ⏱️ 20.09.2018):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.2K · 📋 440 - 27% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/jazzband/django-pipeline
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 84K / month):
	```
...
- [GitHub](https://github.com/miracle2k/webassets) (👨‍💻 160 · 🔀 250 · 📦 6.2K · 📋 290 - 19% open · ⏱️ 01.05.2021):

	```
	git clone https://github.com/miracle2k/webassets
	```
- [PyPi](https://pypi.org/project/webassets) (📥 230K / month):
	```
	pip install webassets
	```
- [Conda](https://anaconda.org/conda-forge/webassets) (📥 53K · ⏱️ 24.12.2019):
	```
...
- [GitHub](https://github.com/miracle2k/flask-assets) (👨‍💻 38 · 🔀 86 · 📦 6.9K · 📋 97 - 21% open · ⏱️ 29.02.2020):

	```
	git clone https://github.com/miracle2k/flask-assets
	```
- [PyPi](https://pypi.org/project/flask-assets) (📥 150K / month):
	```
	pip install flask-assets
	```
- [Conda](https://anaconda.org/conda-forge/flask-assets) (📥 37K · ⏱️ 24.12.2019):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 240 · 🔀 750 · 📋 610 - 26% open · ⏱️ 18.02.2023):

	```
	git clone https://github.com/jschneier/django-storages
	```
- [PyPi](https://pypi.org/project/django-storages) (📥 2.1M / month):
	```
	pip install django-storages
	```
- [Conda](https://anaconda.org/conda-forge/django-storages) (📥 45K · ⏱️ 23.12.2022):
	```
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 210 · 🔀 540 · 📋 640 - 16% open · ⏱️ 22.01.2023):

	```
	git clone https://github.com/django-compressor/django-compressor
	```
- [PyPi](https://pypi.org/project/django-compressor) (📥 390K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 870 · 📦 10K · 📋 370 - 43% open · ⏱️ 10.05.2020):
...
- [PyPi](https://pypi.org/project/requests-html) (📥 830K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 5.2K · ⏱️ 26.06.2021):
	```
	conda install -c conda-forge requests-html
	```
</details>
<details><summary><b><a href="https://github.com/miso-belica/sumy">sumy</a></b> (🥈26 ·  ⭐ 3.1K) - A module for automatic summarization of text documents and HTML pages. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/sumy) (📥 23K / month):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 4K · ⏱️ 25.10.2022):
	```
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 2.7K · ⏱️ 14.12.2022):

	```
	git clone https://github.com/coleifer/micawber
	```
- [PyPi](https://pypi.org/project/micawber) (📥 46K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 8.1K · ⏱️ 14.07.2021):
	```
	conda install -c conda-forge micawber
	```
</details>
<details><summary><b><a href="https://github.com/codelucas/newspaper">newspaper</a></b> (🥈23 ·  ⭐ 12K · 💀) - News extraction, article extraction and content curation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/deanmalmgren/textract">textract</a></b> (🥈23 ·  ⭐ 3.4K · 💤) - Extract text from any document, Word, PowerPoint, PDFs, etc. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 40 · 🔀 500 · 📋 220 - 41% open · ⏱️ 10.03.2022):
...
- [PyPi](https://pypi.org/project/textract) (📥 140K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textract) (📥 19K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/Alir3z4/html2text) (👨‍💻 76 · 🔀 230 · 📋 200 - 39% open · ⏱️ 22.02.2022):

	```
	git clone https://github.com/Alir3z4/html2text
	```
- [PyPi](https://pypi.org/project/html2text) (📥 1.3M / month):
	```
	pip install html2text
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 28K · ⏱️ 09.02.2020):
	```
	conda install -c conda-forge html2text
	```
</details>
<details><summary><b><a href="https://github.com/buriy/python-readability">python-readability</a></b> (🥉18 ·  ⭐ 2.2K) - Fast Python port of arc90's readability tool. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/buriy/python-readability) (👨‍💻 39 · 🔀 340 · 📋 98 - 33% open · ⏱️ 09.12.2022):
...
<details><summary><b><a href="https://github.com/gaojiuli/toapi">toapi</a></b> (🥉17 ·  ⭐ 3.4K · 💀) - Every web site provides APIs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):

	```
	git clone https://github.com/gaojiuli/toapi
	```
- [PyPi](https://pypi.org/project/toapi) (📥 68 / month):
	```
	pip install toapi
	```
...
<details><summary><b><a href="https://github.com/michaelhelmick/lassie">lassie</a></b> (🥉17 ·  ⭐ 580 · 💀) - Web Content Retrieval for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/michaelhelmick/lassie) (👨‍💻 15 · 🔀 47 · 📦 34 · 📋 39 - 25% open · ⏱️ 20.08.2021):
...
- [GitHub](https://github.com/binux/pyspider) (👨‍💻 62 · 🔀 3.6K · 📦 320 · 📋 820 - 32% open · ⏱️ 02.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyspider) (📥 1.4K / month):
	```
...
<details><summary><b><a href="https://github.com/scrapinghub/portia">portia</a></b> (🥈24 ·  ⭐ 8.8K · 💀) - Visual scraping for Scrapy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/scrapinghub/portia) (👨‍💻 51 · 🔀 1.4K · 📥 220 · 📦 45 · 📋 450 - 25% open · ⏱️ 10.07.2019):

	```
	git clone https://github.com/scrapinghub/portia
	```
- [PyPi](https://pypi.org/project/portia) (📥 200 / month):
	```
	pip install portia
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 900 · 📋 74 - 59% open · ⏱️ 07.06.2015):
...
- [PyPi](https://pypi.org/project/robobrowser) (📥 19K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/robobrowser) (📥 4.9K · ⏱️ 23.03.2018):
	```
...
<details><summary><b><a href="https://github.com/MechanicalSoup/MechanicalSoup">MechanicalSoup</a></b> (🥉21 ·  ⭐ 4.3K) - A Python library for automating interaction with websites. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 53 · 🔀 360 · 📥 43 · 📋 160 - 15% open · ⏱️ 13.12.2022):

	```
	git clone https://github.com/MechanicalSoup/MechanicalSoup
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 50K / month):
	```
...
- [GitHub](https://github.com/qinxuye/cola) (👨‍💻 3 · 🔀 530 · 📦 17 · 📋 65 - 20% open · ⏱️ 01.03.2020):
...
🔗&nbsp;<b><a href="https://github.com/shahraizali/awesome-django">awesome-django</a></b> ( ⭐ 1.1K)  - The Best Django Resource, Awesome Django for mature packages.
...
<details><summary><b><a href="https://github.com/MasoniteFramework/masonite">Masonite</a></b> (🥇26 ·  ⭐ 2K) - The modern and developer centric Python web framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 83 · 🔀 120 · 📦 460 · 📋 380 - 5% open · ⏱️ 05.11.2022):

	```
	git clone https://github.com/MasoniteFramework/masonite
	```
- [PyPi](https://pypi.org/project/masonite) (📥 2.2K / month):
	```
...
<details><summary><b><a href="https://github.com/aaugustin/websockets">websockets</a></b> (🥇30 ·  ⭐ 4.4K) - A library for building WebSocket servers and clients with a focus.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 63 · 🔀 450 · 📦 90K · 📋 960 - 1% open · ⏱️ 19.02.2023):

	```
	git clone https://github.com/aaugustin/websockets
	```
- [PyPi](https://pypi.org/project/websockets) (📥 15M / month):
	```
	pip install websockets
	```
- [Conda](https://anaconda.org/conda-forge/websockets) (📥 1.8M · ⏱️ 26.10.2022):
	```
...
- [GitHub](https://github.com/crossbario/autobahn-python) (👨‍💻 130 · 🔀 730 · 📦 24K · 📋 880 - 20% open · ⏱️ 08.02.2023):
...
<details><summary><b><a href="https://github.com/django/channels">channels</a></b> (🥉22 ·  ⭐ 5.5K · 📉) - Developer-friendly asynchrony for Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 740 · 📋 1.2K - 6% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/django/channels
	```
- [PyPi](https://pypi.org/project/channels) (📥 610K / month):
	```
	pip install channels
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 130K · ⏱️ 11.11.2022):
	```
...
<details><summary><b><a href="https://github.com/benoitc/gunicorn">gunicorn</a></b> (🥇37 ·  ⭐ 8.8K) - Pre-forked, ported from Ruby's Unicorn project. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 380 · 🔀 1.6K · 📥 100 · 📦 880K · 📋 1.9K - 18% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/benoitc/gunicorn
	```
- [PyPi](https://pypi.org/project/gunicorn) (📥 24M / month):
	```
	pip install gunicorn
	```
- [Conda](https://anaconda.org/conda-forge/gunicorn) (📥 1.8M · ⏱️ 26.10.2022):
	```
	conda install -c conda-forge gunicorn
	```
</details>
<details><summary><b><a href="https://github.com/pallets/werkzeug">werkzeug</a></b> (🥈36 ·  ⭐ 6.3K) - A WSGI utility library for Python that powers Flask and can easily be.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 270 · 📦 940K · 📋 1K - 1% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 80M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 6.9M · ⏱️ 14.02.2023):
	```
	conda install -c conda-forge werkzeug
	```
</details>
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉28 ·  ⭐ 1.2K) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 50 · 🔀 150 · 📦 110K · 📋 210 - 6% open · ⏱️ 23.01.2023):

	```
	git clone https://github.com/Pylons/waitress
	```
- [PyPi](https://pypi.org/project/waitress) (📥 3.5M / month):
	```
	pip install waitress
	```
- [Conda](https://anaconda.org/conda-forge/waitress) (📥 110K · ⏱️ 31.05.2022):
	```
	conda install -c conda-forge waitress
	```
</details>
<details><summary><b><a href="https://github.com/jonashaag/bjoern">bjoern</a></b> (🥉22 ·  ⭐ 2.9K) - Asynchronous, very fast and written in C. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 570 · 📋 160 - 15% open · ⏱️ 11.09.2022):
...
- [PyPi](https://pypi.org/project/bjoern) (📥 24K / month):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 98K · ⏱️ 02.11.2022):
	```
