...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 350 · 🔀 1.5K · 📦 19K · 📋 1.4K - 28% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/flask-admin) (📥 2M / month):
	```
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 200 · 🔀 940 · 📦 11K · 📋 860 - 12% open · ⏱️ 14.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/flower) (📥 1.6M / month):
	```
	pip install flower
	```
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 24 · 🔀 790 · 📦 25 · 📋 1.1K - 1% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/ajenti) (📥 410 / month):
	```
	pip install ajenti
	```
...
- [GitHub](https://github.com/sshwsfc/xadmin) (👨‍💻 51 · 🔀 1.4K · 📦 790 · 📋 570 - 65% open · ⏱️ 03.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/xadmin) (📥 290 / month):
	```
	pip install xadmin
	```
...
- [GitHub](https://github.com/wooey/Wooey) (👨‍💻 24 · 🔀 180 · 📦 42 · 📋 210 - 24% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 120 · 📋 19 - 31% open · ⏱️ 23.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 510 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 980 · 🔀 38K · 📦 2 · 📋 1.2K - 1% open · ⏱️ 02.03.2023):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 83M · ⏱️ 02.02.2023):
	```
	conda install -c conda-forge Python
	```
</details>
<details><summary><b><a href="https://github.com/pytransitions/transitions">transitions</a></b> (🥈28 ·  ⭐ 4.8K) - A lightweight, object-oriented finite state machine implementation. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 75 · 🔀 500 · 📦 2.9K · 📋 420 - 1% open · ⏱️ 06.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/transitions) (📥 430K / month):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 190 · 🔀 4.1K · 📦 79 · 📋 160 - 37% open · ⏱️ 12.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 19K / month):
	```
...
- [GitHub](https://github.com/tylerlaberge/PyPattyrn) (👨‍💻 4 · 🔀 130 · 📦 35 · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/PyPattyrn) (📥 2.8K / month):
	```
...
<details><summary><b><a href="https://github.com/faif/python-patterns">python-patterns</a></b> (🥉17 ·  ⭐ 37K) - A collection of design patterns in Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/faif/python-patterns) (👨‍💻 130 · 🔀 6.4K · 📋 82 - 10% open · ⏱️ 27.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-patterns) (📥 29 / month):
	```
...
- [GitHub](https://github.com/prabhupant/python-ds) (👨‍💻 110 · 🔀 510 · 📋 88 - 22% open · ⏱️ 04.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-ds) (📥 13 / month):
	```
...
- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 150 · 🔀 530 · 📦 160K · 📋 630 - 3% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 63 · 🔀 220 · 📋 300 - 10% open · ⏱️ 07.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/daphne) (📥 650K / month):
	```
	pip install daphne
	```
...
<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇33 ·  ⭐ 9.2K) - Ultra fast asyncio event loop. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 140 · 🔀 280 · 📦 25K · 📋 690 - 38% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 95 · 🔀 890 · 📦 19K · 📋 520 - 49% open · ⏱️ 08.12.2022):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 4.1M / month):
	```
	pip install pydub
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 520 · 🔀 1.7K · 📥 8K · 📦 310 · 📋 2.6K - 18% open · ⏱️ 22.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/beets) (📥 2.8K / month):
	```
	pip install beets
	```
- [Conda](https://anaconda.org/conda-forge/beets) (📥 150 · ⏱️ 01.12.2022):
	```
...
<details><summary><b><a href="https://github.com/tyiannak/pyAudioAnalysis">pyAudioAnalysis</a></b> (🥈24 ·  ⭐ 5.2K) - Audio feature extraction, classification, segmentation and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/tyiannak/pyAudioAnalysis) (👨‍💻 27 · 🔀 1.1K · 📦 340 · 📋 300 - 59% open · ⏱️ 18.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/pyAudioAnalysis) (📥 19K / month):
	```
...
<details><summary><b><a href="https://github.com/beetbox/audioread">audioread</a></b> (🥈24 ·  ⭐ 430) - Cross-library (GStreamer + Core Audio + MAD + FFmpeg) audio decoding. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 23 · 🔀 99 · 📦 12K · 📋 84 - 38% open · ⏱️ 18.11.2022):
...
- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 25 · 🔀 91 · 📦 710 · 📋 98 - 16% open · ⏱️ 15.01.2023):

	```
	git clone https://github.com/devsnd/tinytag
	```
- [PyPi](https://pypi.org/project/tinytag) (📥 20K / month):
	```
	pip install tinytag
	```
...
- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 22 · 📦 2.2K · 📋 95 - 13% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/kapre) (📥 3.8K / month):
	```
	pip install kapre
	```
...
- [GitHub](https://github.com/Ircam-WAM/TimeSide) (👨‍💻 22 · 🔀 58 · 📦 16 · 📋 210 - 18% open · ⏱️ 01.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/TimeSide) (📥 85 / month):
	```
...
<details><summary><b><a href="https://github.com/sergree/matchering">matchering</a></b> (🥉19 ·  ⭐ 860) - A library for automated reference audio mastering. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/sergree/matchering) (👨‍💻 3 · 🔀 110 · 📦 13 · 📋 40 - 32% open · ⏱️ 09.01.2023):

	```
	git clone https://github.com/sergree/matchering
	```
- [PyPi](https://pypi.org/project/matchering) (📥 440 / month):
	```
...
<details><summary><b><a href="https://github.com/oauthlib/oauthlib">oauthlib</a></b> (🥇37 ·  ⭐ 2.6K) - A generic and thorough implementation of the OAuth request-signing.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/oauthlib/oauthlib) (👨‍💻 190 · 🔀 440 · 📦 330K · 📋 360 - 19% open · ⏱️ 10.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/oauthlib) (📥 89M / month):
	```
	pip install oauthlib
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 7.8M · ⏱️ 18.10.2022):
	```
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 130 · 🔀 600 · 📦 340K · 📋 390 - 3% open · ⏱️ 21.02.2023):
...
- [PyPi](https://pypi.org/project/pyjwt) (📥 110M / month):
	...
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 9.7M · ⏱️ 20.10.2022):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 92 · 🔀 340 · 📦 25K · 📋 360 - 12% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/lepture/authlib
	```
- [PyPi](https://pypi.org/project/authlib) (📥 5.3M / month):
	```
	pip install authlib
	```
- [Conda](https://anaconda.org/conda-forge/authlib) (📥 96K · ⏱️ 06.12.2022):
	```
...
- [GitHub](https://github.com/joestump/python-oauth2) (👨‍💻 42 · 🔀 810 · 📦 10K · 📋 130 - 38% open · ⏱️ 12.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/python-oauth2) (📥 46K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 220 · 🔀 680 · 📋 740 - 20% open · ⏱️ 16.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-oauth-toolkit) (📥 420K / month):
	```
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 39 · 🔀 240 · 📋 500 - 16% open · ⏱️ 25.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 22K / month):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 74 · 🔀 690 · 📋 3.9K - 4% open · ⏱️ 28.02.2023):
...
<details><summary><b><a href="https://github.com/python-attrs/attrs">attrs</a></b> (🥇34 ·  ⭐ 4.7K) - Replacement for `__init__`, `__eq__`, `__repr__`, etc. boilerplate in class.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 140 · 🔀 330 · 📦 640K · 📋 620 - 18% open · ⏱️ 27.02.2023):
...
- [GitHub](https://github.com/jab/bidict) (👨‍💻 13 · 🔀 52 · 📦 12K · 📋 54 - 5% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/bidict) (📥 1.4M / month):
	```
	pip install bidict
	```
...
<details><summary><b><a href="https://github.com/carlosescri/DottedDict">DottedDict</a></b> (🥉17 ·  ⭐ 160 · 💀) - A library that provides a method of accessing lists and dicts with.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 4 · 🔀 18 · 📥 68 · 📦 71 · 📋 9 - 77% open · ⏱️ 30.10.2015):

	```
	git clone https://github.com/carlosescri/DottedDict
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 24 / month):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 140 · 🔀 350 · 📥 2.9K · 📋 3.4K - 18% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/indico/indico
	```
- [PyPi](https://pypi.org/project/indico) (📥 1.1K / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/stephenmcd/mezzanine) (👨‍💻 330 · 🔀 1.5K · 📋 1K - 3% open · ⏱️ 02.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mezzanine) (📥 4.6K / month):
	```
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 66 · 🔀 110 · 📦 230 · 📋 210 - 20% open · ⏱️ 03.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 540 / month):
	```
	pip install Kotti
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 210 · 📋 440 - 5% open · ⏱️ 04.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 5.7K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/quokkaproject/quokka) (👨‍💻 9 · 🔀 440 · 📋 420 - 15% open · ⏱️ 06.03.2019):
	...
	```
- [PyPi](https://pypi.org/project/quokka) (📥 66 / month):
	```
	pip install quokka
	```
...
- [GitHub](https://github.com/Suor/django-cacheops) (👨‍💻 66 · 🔀 200 · 📦 1K · 📋 310 - 5% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/lericson/pylibmc) (👨‍💻 52 · 🔀 120 · 📥 81 · 📦 4.4K · 📋 190 - 10% open · ⏱️ 26.08.2022):

	```
	git clone https://github.com/lericson/pylibmc
	```
- [PyPi](https://pypi.org/project/pylibmc) (📥 240K / month):
	```
	pip install pylibmc
	```
...
- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 88 · 🔀 140 · 📦 4.4K · 📋 120 - 51% open · ⏱️ 04.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/beaker) (📥 360K / month):
	```
	pip install beaker
	```
...
- [GitHub](https://github.com/django-cache-machine/django-cache-machine) (👨‍💻 27 · 🔀 150 · 📦 250 · 📋 71 - 21% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-cache-machine) (📥 7K / month):
	```
...
<details><summary><b><a href="https://github.com/psf/black">black</a></b> (🥇35 ·  ⭐ 32K) - The uncompromising Python code formatter. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/psf/black) (👨‍💻 360 · 🔀 1.9K · 📥 27K · 📦 340K · 📋 2.2K - 16% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 20M / month):
	```
	pip install black
	```
- [Conda](https://anaconda.org/conda-forge/black) (📥 6.4M · ⏱️ 01.02.2023):
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 280 · 🔀 500 · 📦 360K · 📋 1.2K - 10% open · ⏱️ 02.03.2023):
...
- [PyPi](https://pypi.org/project/isort) (📥 27M / month):
	...
	pip install isort
	```
- [Conda](https://anaconda.org/conda-forge/isort) (📥 4.4M · ⏱️ 01.02.2023):
	```
	conda install -c conda-forge isort
	```
</details>
<details><summary><b><a href="https://github.com/wemake-services/wemake-python-styleguide">wemake-python-styleguide</a></b> (🥈31 ·  ⭐ 2.2K) - The strictest and most opinionated python linter ever. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 87 · 🔀 160 · 📦 4.1K · 📋 350 - 14% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/PyCQA/prospector
	```
- [PyPi](https://pypi.org/project/prospector) (📥 690K / month):
	```
	pip install prospector
	```
- [Conda](https://anaconda.org/conda-forge/prospector) (📥 60K · ⏱️ 10.03.2022):
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 140 · 🔀 860 · 📦 70K · 📋 770 - 47% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/google/yapf
	```
- [PyPi](https://pypi.org/project/yapf) (📥 3.2M / month):
	```
	pip install yapf
	```
...
<details><summary><b><a href="https://github.com/jendrikseipp/vulture">vulture</a></b> (🥉25 ·  ⭐ 2.4K) - A tool for finding and analysing dead Python code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/jendrikseipp/vulture) (👨‍💻 35 · 🔀 110 · 📦 3.6K · 📋 170 - 7% open · ⏱️ 27.02.2023):
...
<details><summary><b><a href="https://github.com/facebook/pyre-check">pyre-check</a></b> (🥉23 ·  ⭐ 6.3K) - Performant type checking. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 240 · 🔀 390 · 📋 340 - 31% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 65K / month):
	```
...
- [GitHub](https://github.com/gak/pycallgraph) (👨‍💻 23 · 🔀 270 · 📦 400 · 📋 160 - 30% open · ⏱️ 28.02.2018):
	...
	```
- [PyPi](https://pypi.org/project/pycallgraph) (📥 26K / month):
	```
...
- [GitHub](https://github.com/scottrogowski/code2flow) (👨‍💻 10 · 🔀 230 · 📦 15 · 📋 49 - 12% open · ⏱️ 08.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/code2flow) (📥 3.2K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 89 · 🔀 250 · 📋 590 - 18% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 45 · 🔀 150 · 📋 160 - 20% open · ⏱️ 13.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 52K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1.3K · 🔀 1.4K · 📋 2K - 7% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/Textualize/rich) (👨‍💻 210 · 🔀 1.5K · 📦 70K · 📋 1K - 8% open · ⏱️ 19.02.2023):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 23M / month):
	```
	pip install rich
	```
- [Conda](https://anaconda.org/conda-forge/rich) (📥 3.1M · ⏱️ 28.01.2023):
	```
	conda install -c conda-forge rich
	```
</details>
<details><summary><b><a href="https://github.com/tqdm/tqdm">tqdm</a></b> (🥈36 ·  ⭐ 24K) - Fast, extensible progress bar for loops and CLI. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1.2K · 📥 11K · 📦 420K · 📋 890 - 36% open · ⏱️ 03.09.2022):

	```
	git clone https://github.com/tqdm/tqdm
	```
- [PyPi](https://pypi.org/project/tqdm) (📥 52M / month):
	```
	pip install tqdm
	```
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 59 · 🔀 1.3K · 📦 19K · 📋 280 - 38% open · ⏱️ 13.02.2023):
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 41 · 🔀 240 · 📦 820 · 📋 290 - 8% open · ⏱️ 17.01.2023):
...
- [GitHub](https://github.com/rsalmei/alive-progress) (👨‍💻 7 · 🔀 170 · 📦 1.6K · 📋 180 - 8% open · ⏱️ 01.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 260K / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/python-prompt-toolkit) (👨‍💻 210 · 🔀 650 · 📋 1K - 46% open · ⏱️ 28.02.2023):
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 160 · 🔀 3.5K · 📥 2.7K · 📦 13K · 📋 810 - 16% open · ⏱️ 15.01.2023):
...
- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 280 · 🔀 1.8K · 📦 19K · 📋 760 - 25% open · ⏱️ 09.09.2022):

	```
	git clone https://github.com/audreyr/cookiecutter
	```
- [PyPi](https://pypi.org/project/cookiecutter) (📥 2.4M / month):
	```
	pip install cookiecutter
	```
- [Conda](https://anaconda.org/conda-forge/cookiecutter) (📥 600K · ⏱️ 01.06.2022):
	```
...
- [GitHub](https://github.com/nvbn/thefuck) (👨‍💻 190 · 🔀 3.2K · 📦 410 · 📋 660 - 31% open · ⏱️ 25.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/thefuck) (📥 6.2K / month):
	```
	pip install thefuck
	```
...
- [GitHub](https://github.com/tmux-python/tmuxp) (👨‍💻 72 · 🔀 220 · 📦 230 · 📋 340 - 22% open · ⏱️ 26.02.2023):
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 170 · 🔀 480 · 📦 850 · 📋 660 - 22% open · ⏱️ 27.02.2023):
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥈25 ·  ⭐ 890) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 54 · 🔀 110 · 📦 360 · 📋 320 - 14% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/pykong/copier
	```
- [PyPi](https://pypi.org/project/copier) (📥 28K / month):
	```
	pip install copier
	```
- [Conda](https://anaconda.org/conda-forge/copier) (📥 1.8K · ⏱️ 07.01.2023):
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 100 · 🔀 630 · 📦 280 · 📋 620 - 29% open · ⏱️ 08.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mycli) (📥 52K / month):
	```
	pip install mycli
	```
...
- [GitHub](https://github.com/gleitz/howdoi) (👨‍💻 83 · 🔀 840 · 📦 450 · 📋 250 - 3% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/howdoi) (📥 6.8K / month):
	```
	pip install howdoi
	```
...
<details><summary><b><a href="https://github.com/dbcli/litecli">litecli</a></b> (🥉20 ·  ⭐ 1.8K · 💤) - SQLite CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 270 · 📦 38 · 📋 94 - 34% open · ⏱️ 15.01.2022):
	...
	```
- [PyPi](https://pypi.org/project/saws) (📥 450 / month):
	```
	pip install saws
	```
...
- [GitHub](https://github.com/cloudnativelabs/kube-shell) (👨‍💻 6 · 🔀 170 · 📥 660 · 📦 14 · 📋 70 - 82% open · ⏱️ 19.09.2018):

	```
	git clone https://github.com/cloudnativelabs/kube-shell
	```
- [PyPi](https://pypi.org/project/kube-shell) (📥 530 / month):
	```
...
- [GitHub](https://github.com/mooz/percol) (👨‍💻 36 · 🔀 140 · 📦 33 · 📋 65 - 55% open · ⏱️ 23.07.2019):
	...
	```
- [PyPi](https://pypi.org/project/percol) (📥 960 / month):
	```
	pip install percol
	```
...
- [GitHub](https://github.com/sloria/doitlive) (👨‍💻 18 · 🔀 92 · 📦 18 · 📋 48 - 25% open · ⏱️ 14.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/doitlive) (📥 130 / month):
	```
...
- [GitHub](https://github.com/PyCQA/modernize) (👨‍💻 32 · 🔀 45 · 📋 130 - 35% open · ⏱️ 11.01.2021):
	...
	```
- [PyPi](https://pypi.org/project/modernize) (📥 55K / month):
	```
...
<details><summary><b><a href="https://github.com/JaidedAI/EasyOCR">EasyOCR</a></b> (🥇30 ·  ⭐ 17K) - Ready-to-use OCR with 40+ languages supported. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 110 · 🔀 2.4K · 📥 3.8M · 📦 2.2K · 📋 730 - 23% open · ⏱️ 06.01.2023):
...
- [PyPi](https://pypi.org/project/EasyOCR) (📥 150K / month):
	...
	pip install EasyOCR
	```
- [Conda](https://anaconda.org/conda-forge/EasyOCR) (📥 2.6K · ⏱️ 30.01.2023):
	```
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 54 · 🔀 12K · 📥 880 · 📋 1.3K - 54% open · ⏱️ 10.06.2022):
...
<details><summary><b><a href="https://github.com/sirfz/tesserocr">tesserocr</a></b> (🥈25 ·  ⭐ 1.8K · 💤) - Another simple, Pillow-friendly, wrapper around the `tesseract-.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉24 ·  ⭐ 7.8K) - Open Source Differentiable Computer Vision Library for PyTorch. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 770 · 📥 550 · 📦 3.2K · 📋 720 - 28% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 41 · 🔀 630 · 📋 330 - 7% open · ⏱️ 09.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pytesseract) (📥 770K / month):
	```
...
- [GitHub](https://github.com/HBNetwork/python-decouple) (👨‍💻 35 · 🔀 170 · 📥 11 · 📦 91K · 📋 84 - 4% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 8 · 🔀 68 · 📥 19 · 📦 25K · 📋 150 - 35% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/DiffSK/configobj
	```
- [PyPi](https://pypi.org/project/configobj) (📥 3.2M / month):
	```
	pip install configobj
	```
- [Conda](https://anaconda.org/conda-forge/configobj) (📥 570K · ⏱️ 20.01.2023):
	```
...
- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 110 · 🔀 520 · 📦 14 · 📋 1.2K - 14% open · ⏱️ 25.02.2023):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 17K / month):
	```
	pip install hydra
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 180 · 🔀 1.8K · 📦 73K · 📋 1.5K - 51% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/paramiko/paramiko
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 34M / month):
	```
	pip install paramiko
	```
- [Conda](https://anaconda.org/conda-forge/paramiko) (📥 2.8M · ⏱️ 26.01.2023):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 64 · 🔀 200 · 📋 290 - 14% open · ⏱️ 19.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pynacl) (📥 40M / month):
	```
	pip install pynacl
	```
- [Conda](https://anaconda.org/conda-forge/pynacl) (📥 3.8M · ⏱️ 27.10.2022):
	```
...
- [GitHub](https://github.com/blaze/blaze) (👨‍💻 65 · 🔀 360 · 📦 9K · 📋 750 - 33% open · ⏱️ 15.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/blaze) (📥 9.6K / month):
	```
	pip install blaze
	```
...
- [GitHub](https://github.com/aws/aws-sdk-pandas) (👨‍💻 120 · 🔀 560 · 📥 180K · 📦 900 · 📋 870 - 5% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/hi-primus/optimus) (👨‍💻 24 · 🔀 220 · 📋 220 - 4% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/Optimus) (📥 15K / month):
	```
	pip install Optimus
	```
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 230 · 📦 18 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 19 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/python-jsonschema/jsonschema) (👨‍💻 100 · 🔀 530 · 📦 340K · 📋 700 - 3% open · ⏱️ 21.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/jsonschema) (📥 67M / month):
	```
...
- [GitHub](https://github.com/pyeve/cerberus) (👨‍💻 63 · 🔀 220 · 📦 13K · 📋 340 - 12% open · ⏱️ 05.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/cerberus) (📥 4.5M / month):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 190 · 📦 5.9K · 📋 150 - 52% open · ⏱️ 01.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/schema) (📥 4.7M / month):
	```
	pip install schema
	```
- [Conda](https://anaconda.org/conda-forge/schema) (📥 82K · ⏱️ 02.12.2021):
	```
...
- [GitHub](https://github.com/alecthomas/voluptuous) (👨‍💻 90 · 🔀 200 · 📦 13K · 📋 240 - 16% open · ⏱️ 22.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/voluptuous) (📥 2.5M / month):
	```
	pip install voluptuous
	```
- [Conda](https://anaconda.org/conda-forge/voluptuous) (📥 260K · ⏱️ 07.04.2022):
	```
...
- [GitHub](https://github.com/podio/valideer) (👨‍💻 9 · 🔀 24 · 📦 65 · 📋 15 - 26% open · ⏱️ 05.01.2023):
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 190 · 🔀 1.6K · 📥 240 · 📦 230K · 📋 2.3K - 4% open · ⏱️ 26.02.2023):
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 150 · 🔀 680 · 📥 18 · 📦 47K · 📋 1.7K - 11% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/altair-viz/altair
	```
- [PyPi](https://pypi.org/project/altair) (📥 10M / month):
	```
	pip install altair
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 130 · 🔀 1.7K · 📦 900 · 📋 420 - 57% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/mingrammer/diagrams
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 98K / month):
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 640 · 🔀 3.9K · 📦 200 · 📋 7.2K - 9% open · ⏱️ 01.03.2023):
...
<details><summary><b><a href="https://github.com/bqplot/bqplot">bqplot</a></b> (🥉26 ·  ⭐ 3.4K) - Interactive Plotting Library for the Jupyter Notebook. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 120 · 🔀 330 · 📦 3.1K · 📋 1.1K - 26% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/SciTools/cartopy
	```
- [PyPi](https://pypi.org/project/cartopy) (📥 57K / month):
	```
	pip install cartopy
	```
...
<details><summary><b><a href="https://github.com/has2k1/plotnine">plotnine</a></b> (🥉21 ·  ⭐ 3.4K) - A grammar of graphics for Python based on ggplot2. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/plotnine) (📥 300K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/plotnine) (📥 240K · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 80 · 🔀 480 · 📦 10K · 📋 290 - 3% open · ⏱️ 18.02.2023):

	```
	git clone https://github.com/msiemens/tinydb
	```
- [PyPi](https://pypi.org/project/tinydb) (📥 460K / month):
	```
	pip install tinydb
	```
...
<details><summary><b><a href="https://github.com/zopefoundation/ZODB">ZODB</a></b> (🥉24 ·  ⭐ 590) - A native object database for Python. A key-value and object graph.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 79 · 📦 990 · 📋 160 - 39% open · ⏱️ 06.02.2023):

	```
	git clone https://github.com/zopefoundation/ZODB
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 67K / month):
	```
	pip install ZODB
	```
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 120 · 📦 1.1K · 📋 57 - 28% open · ⏱️ 15.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/pickledb) (📥 37K / month):
	```
...
🔗&nbsp;<b><a href="https://github.com/planetopendata/awesome-sqlite">awesome-sqlite</a></b> ( ⭐ 220)  - A collection of awesome sqlite tools, scripts, books, etc.
...
- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.3K · 📥 1.8K · 📦 16K · 📋 1.4K - 16% open · ⏱️ 27.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 15M / month):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 41 · 🔀 180 · 📦 53K · ⏱️ 17.02.2023):

	```
	git clone https://github.com/mongodb/motor
	```
- [PyPi](https://pypi.org/project/motor) (📥 1.3M / month):
	```
	pip install motor
	```
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 120 · 🔀 1.3K · 📦 150K · 📋 630 - 4% open · ⏱️ 06.02.2023):
...
- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 51 · 🔀 180 · 📦 1.4K · 📋 270 - 11% open · ⏱️ 11.02.2023):
...
- [PyPi](https://pypi.org/project/clickhouse-driver) (📥 1.4M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/clickhouse-driver) (📥 370K · ⏱️ 28.11.2022):
	```
...
- [GitHub](https://github.com/datastax/python-driver) (👨‍💻 190 · 🔀 450 · 📦 4.7K · ⏱️ 28.02.2023):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 200 · 🔀 980 · ⏱️ 02.03.2023):
...
- [PyPi](https://pypi.org/project/happybase) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/happybase) (📥 130K · ⏱️ 01.07.2019):
	```
...
- [GitHub](https://github.com/gmr/queries) (👨‍💻 12 · 🔀 32 · 📦 120 · 📋 18 - 22% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/queries) (📥 3.9K / month):
	```
	pip install queries
	```
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 24 · 📦 10 · 📋 7 - 85% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 88 / month):
	```
...
<details><summary><b><a href="https://github.com/sdispater/pendulum">Pendulum</a></b> (🥇32 ·  ⭐ 5.4K) - Python datetimes made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/sdispater/pendulum) (👨‍💻 88 · 🔀 310 · 📥 75 · 📦 18K · 📋 460 - 42% open · ⏱️ 25.02.2023):

	```
	git clone https://github.com/sdispater/pendulum
	```
- [PyPi](https://pypi.org/project/pendulum) (📥 11M / month):
	```
	pip install pendulum
	```
- [Conda](https://anaconda.org/conda-forge/pendulum) (📥 670K · ⏱️ 04.02.2023):
	```
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 420 · 📥 35K · 📦 960K · 📋 660 - 40% open · ⏱️ 03.12.2022):
...
- [GitHub](https://github.com/timofurrer/maya) (👨‍💻 48 · 🔀 190 · 📦 1.1K · 📋 90 - 17% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/maya) (📥 45K / month):
	```
	pip install maya
	```
...
- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 42 · 📦 770 · 📋 40 - 7% open · ⏱️ 27.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/moment) (📥 79K / month):
	```
	pip install moment
	```
...
- [GitHub](https://github.com/KoffeinFlummi/Chronyk) (👨‍💻 3 · 🔀 16 · 📦 24 · 📋 10 - 50% open · ⏱️ 02.08.2015):
	...
	```
- [PyPi](https://pypi.org/project/Chronyk) (📥 390 / month):
	```
	pip install Chronyk
	```
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 7 · 🔀 20 · 📦 32 · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 1.3K / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 270 · 🔀 870 · 📥 180 · 📦 68K · 📋 830 - 7% open · ⏱️ 28.02.2023):
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥇30 ·  ⭐ 9.8K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [PyPi](https://pypi.org/project/py-spy) (📥 1.8M / month):
	...
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 380K · ⏱️ 09.09.2022):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 54 · 🔀 140 · 📦 43K · 📋 180 - 31% open · ⏱️ 13.12.2022):
...
- [PyPi](https://pypi.org/project/ipdb) (📥 2.3M / month):
	...
	pip install ipdb
	```
- [Conda](https://anaconda.org/conda-forge/ipdb) (📥 340K · ⏱️ 24.12.2022):
	```
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 89 · 🔀 440 · 📦 4.8K · 📋 210 - 32% open · ⏱️ 04.02.2023):

	```
	git clone https://github.com/eliben/pyelftools
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 2.5M / month):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 91 · 🔀 210 · 📦 4.5K · 📋 310 - 45% open · ⏱️ 10.01.2023):
...
- [PyPi](https://pypi.org/project/pudb) (📥 250K / month):
	...
	pip install pudb
	```
- [Conda](https://anaconda.org/conda-forge/pudb) (📥 200K · ⏱️ 04.11.2022):
	```
...
- [GitHub](https://github.com/gruns/icecream) (👨‍💻 21 · 🔀 140 · 📋 100 - 32% open · ⏱️ 04.12.2022):

	```
	git clone https://github.com/gruns/icecream
	```
- [PyPi](https://pypi.org/project/icecream) (📥 250K / month):
	```
	pip install icecream
	```
- [Conda](https://anaconda.org/conda-forge/icecream) (📥 12K · ⏱️ 21.07.2022):
	```
...
- [GitHub](https://github.com/dcramer/django-devserver) (👨‍💻 39 · 🔀 140 · 📦 360 · 📋 67 - 58% open · ⏱️ 05.03.2016):
	...
	```
- [PyPi](https://pypi.org/project/django-devserver) (📥 4.5K / month):
	```
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 110 · 📦 190 · 📋 110 - 27% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 11K / month):
	```
	pip install wdb
	```
...
- [GitHub](https://github.com/uber-archive/pyflame) (👨‍💻 22 · 🔀 230 · 📋 77 - 31% open · ⏱️ 03.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/pyflame) (📥 570 / month):
	```
	pip install pyflame
	```
...
<details><summary><b><a href="https://github.com/ionelmc/python-hunter">python-hunter</a></b> (🥉17 ·  ⭐ 720) - A flexible code tracing toolkit. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>

- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 41 · 📦 120 · 📋 93 - 44% open · ⏱️ 29.10.2022):
...
- [GitHub](https://github.com/fabianp/memory_profiler) (👨‍💻 62 · 🔀 13 · ⏱️ 28.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/memory_profiler) (📥 700K / month):
	```
...
- [GitHub](https://github.com/google/pyringe) (🔀 75 · 📦 5 · 📋 24 - 62% open · ⏱️ 10.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/pyringe) (📥 62 / month):
	```
	pip install pyringe
	```
...
- [GitHub](https://github.com/khamidou/lptrace) (🔀 37 · 📦 3 · 📋 12 - 41% open · ⏱️ 24.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/lptrace) (📥 270 / month):
	```
	pip install lptrace
	```
...
- [GitHub](https://github.com/tensorflow/tensorflow) (👨‍💻 4.3K · 🔀 71K · 📦 260K · 📋 37K - 5% open · ⏱️ 02.03.2023):
...
<details><summary><b><a href="https://github.com/apache/mxnet">mxnet</a></b> (🥈35 ·  ⭐ 20K) - A deep learning framework designed for both efficiency and flexibility. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/apache/mxnet) (👨‍💻 980 · 🔀 6.5K · 📥 26K · 📦 6.1K · 📋 9.5K - 18% open · ⏱️ 26.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/mxnet) (📥 470K / month):
	```
	pip install mxnet
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1.2K · 🔀 18K · 📋 12K - 2% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3.9K · 🔀 17K · 📥 12K · 📋 32K - 32% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 78K / month):
	```
	pip install pytorch
	```
...
<details><summary><b><a href="https://github.com/Theano/Theano">Theano</a></b> (🥉30 ·  ⭐ 9.7K) - A library for fast numerical computation. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/SerpentAI/SerpentAI) (👨‍💻 7 · 🔀 730 · 📥 260 · ⏱️ 22.05.2020):
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 190 · 🔀 1.3K · 📦 280K · 📋 1.6K - 13% open · ⏱️ 26.01.2023):
...
- [PyPi](https://pypi.org/project/psutil) (📥 65M / month):
	...
	pip install psutil
	```
- [Conda](https://anaconda.org/conda-forge/psutil) (📥 20M · ⏱️ 08.11.2022):
	```
...
- [GitHub](https://github.com/ansible/ansible) (👨‍💻 6.7K · 🔀 22K · 📦 27K · 📋 31K - 2% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/ansible/ansible
	```
- [PyPi](https://pypi.org/project/ansible) (📥 4.4M / month):
	```
	pip install ansible
	```
- [Conda](https://anaconda.org/conda-forge/ansible) (📥 820K · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.9K · 🔀 5.2K · 📥 17K · 📋 25K - 9% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/saltstack/salt
	```
- [PyPi](https://pypi.org/project/salt) (📥 67K / month):
	```
	pip install salt
	```
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 170 · 🔀 1.1K · 📦 8.7K · 📋 1.1K - 10% open · ⏱️ 27.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/supervisor) (📥 1.9M / month):
	```
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 47 · 🔀 140 · 📦 4.7K · 📋 100 - 11% open · ⏱️ 24.10.2022):

	```
	git clone https://github.com/nickstenning/honcho
	```
- [PyPi](https://pypi.org/project/honcho) (📥 180K / month):
	```
	pip install honcho
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 88 · 🔀 300 · 📦 74 · 📋 650 - 17% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 12K / month):
	```
	pip install pyinfra
	```
- [Conda](https://anaconda.org/conda-forge/pyinfra) (📥 460 · ⏱️ 21.01.2023):
	```
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 19 · 🔀 1.7K · 📋 1.7K - 23% open · ⏱️ 16.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/fabric) (📥 3.3M / month):
	```
	pip install fabric
	```
...
- [GitHub](https://github.com/fabtools/fabtools) (👨‍💻 88 · 🔀 190 · 📦 300 · 📋 140 - 54% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/fabtools) (📥 2.6K / month):
	```
...
<details><summary><b><a href="https://github.com/sebastien/cuisine">cuisine</a></b> (🥉18 ·  ⭐ 1.3K) - Chef-like functionality for Fabric. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/sebastien/cuisine) (👨‍💻 57 · 🔀 160 · 📦 170 · 📋 110 - 24% open · ⏱️ 09.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/cuisine) (📥 1.2K / month):
	```
	pip install cuisine
	```
...
- [GitHub](https://github.com/spotify/luigi) (👨‍💻 600 · 🔀 2.3K · 📦 2.1K · 📋 960 - 8% open · ⏱️ 25.02.2023):
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 580 · 🔀 1.6K · 📦 46K · 📋 4.6K - 16% open · ⏱️ 01.03.2023):
...
- [PyPi](https://pypi.org/project/dask) (📥 7.2M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 8M · ⏱️ 02.03.2023):
	```
...
- [GitHub](https://github.com/ray-project/ray) (🔀 4.1K · 📥 10 · 📦 8.4K · 📋 13K - 19% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 580 · 📦 1.2K · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 80K / month):
	```
	pip install mrjob
	```
- [Conda](https://anaconda.org/conda-forge/mrjob) (📥 510K · ⏱️ 06.02.2022):
	```
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 95 · 🔀 540 · 📦 1.4K · 📋 470 - 49% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/robinhood/faust
	```
- [PyPi](https://pypi.org/project/faust) (📥 29K / month):
	```
	pip install faust
	```
...
- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 450 · 🔀 1.7K · 📥 740K · 📦 40K · 📋 4.8K - 5% open · ⏱️ 26.02.2023):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 1.1M / month):
	```
	pip install pyinstaller
	```
- [Conda](https://anaconda.org/conda-forge/pyinstaller) (📥 410K · ⏱️ 11.02.2023):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 27 · 🔀 210 · 📦 760 · 📋 900 - 5% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 110K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 39 · 🔀 80 · 📥 390 · 📋 110 - 32% open · ⏱️ 04.11.2022):
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.8K · 📦 290K · 📋 6.4K - 17% open · ⏱️ 18.02.2023):
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 42 · 🔀 160 · 📦 1.6K · 📋 310 - 5% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/mitmproxy/pdoc
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 90K / month):
	```
	pip install pdoc
	```
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥇25 ·  ⭐ 6.1K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 50 · 🔀 1.3K · 📦 280 · 📋 770 - 0% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/jindaxiang/akshare
	```
- [PyPi](https://pypi.org/project/akshare) (📥 48K / month):
	```
	pip install akshare
	```
...
<details><summary><b><a href="https://github.com/s3tools/s3cmd">s3cmd</a></b> (🥇25 ·  ⭐ 4.1K) - A command line tool for managing Amazon S3 and CloudFront. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 950 · 📦 210 · 📋 380 - 22% open · ⏱️ 28.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-shop) (📥 5.9K / month):
	```
...
- [GitHub](https://github.com/carlospalol/money) (👨‍💻 4 · 🔀 27 · 📦 280 · 📋 23 - 30% open · ⏱️ 04.09.2016):
	...
	```
- [PyPi](https://pypi.org/project/money) (📥 54K / month):
	```
	pip install money
	```
...
- [GitHub](https://github.com/stephenmcd/cartridge) (👨‍💻 75 · 🔀 280 · 📋 150 - 14% open · ⏱️ 19.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/cartridge) (📥 420 / month):
	```
...
- [GitHub](https://github.com/lxneng/alipay) (👨‍💻 13 · 🔀 91 · 📦 110 · 📋 15 - 20% open · ⏱️ 22.11.2017):
	...
	```
- [PyPi](https://pypi.org/project/alipay) (📥 380 / month):
	```
	pip install alipay
	```
...
<details><summary><b><a href="https://github.com/Alir3z4/python-currencies">python-currencies</a></b> (🥉13 ·  ⭐ 65 · 💀) - Display money format and its filthy currencies. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/Alir3z4/python-currencies) (👨‍💻 5 · 🔀 12 · 📥 6 · 📦 51 · 📋 6 - 50% open · ⏱️ 22.12.2020):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 250 · 🔀 1.5K · 📥 2.7M · 📦 25K · 📋 17K - 6% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/spyder-ide/spyder
	```
- [PyPi](https://pypi.org/project/spyder) (📥 58K / month):
	```
	pip install spyder
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 92 · 🔀 240 · 📦 210 · 📋 1.6K - 23% open · ⏱️ 22.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/elpy) (📥 720 / month):
	```
	pip install elpy
	```
...
- [GitHub](https://github.com/DamnWidget/anaconda) (👨‍💻 89 · 🔀 260 · 📋 780 - 21% open · ⏱️ 28.02.2022):
	...
	```
- [PyPi](https://pypi.org/project/anaconda) (📥 15K / month):
	```
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 180 · 🔀 2.7K · 📋 3.2K - 0% open · ⏱️ 27.02.2023):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 81 · 🔀 660 · 📥 33K · 📋 4.6K - 1% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/kootenpv/yagmail) (👨‍💻 32 · 🔀 270 · 📦 3K · 📋 220 - 43% open · ⏱️ 28.09.2022):
...
- [GitHub](https://github.com/mailgun/flanker) (👨‍💻 56 · 🔀 180 · 📦 470 · 📋 88 - 59% open · ⏱️ 22.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/flanker) (📥 34K / month):
	```
	pip install flanker
	```
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 110 · 🔀 320 · 📦 35 · 📋 1.7K - 4% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/modoboa/modoboa
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 3.1K / month):
	```
	pip install modoboa
	```
...
- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 53 · 🔀 170 · 📦 180 · 📋 130 - 48% open · ⏱️ 17.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/imbox) (📥 16K / month):
	```
	pip install imbox
	```
...
- [GitHub](https://github.com/marrow/mailer) (👨‍💻 20 · 🔀 55 · 📥 140 · 📋 72 - 33% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/mailer) (📥 60K / month):
	```
	pip install mailer
	```
...
- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 60 · 📥 81 · 📦 18 · 📋 90 - 18% open · ⏱️ 06.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/salmon) (📥 73 / month):
	```
	pip install salmon
	```
...
- [GitHub](https://github.com/pypa/virtualenv) (👨‍💻 89 · 🔀 910 · 📦 230K · 📋 1.3K - 6% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/pypa/virtualenv
	```
- [PyPi](https://pypi.org/project/virtualenv) (📥 47M / month):
	```
	pip install virtualenv
	```
- [Conda](https://anaconda.org/conda-forge/virtualenv) (📥 3.7M · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 410 · 🔀 2.7K · 📋 1.6K - 1% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/pyenv/pyenv
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 9.8K / month):
	```
	pip install pyenv
	```
...
- [GitHub](https://github.com/gorakhargosh/watchdog) (👨‍💻 140 · 🔀 650 · 📦 83K · 📋 600 - 26% open · ⏱️ 28.02.2023):
...
- [PyPi](https://pypi.org/project/watchdog) (📥 11M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/watchdog) (📥 1.8M · ⏱️ 28.02.2023):
	```
...
- [PyPi](https://pypi.org/project/path.py) (📥 350K / month):
	...
	pip install path.py
	```
- [Conda](https://anaconda.org/conda-forge/path.py) (📥 560K · ⏱️ 28.07.2020):
	```
	conda install -c conda-forge path.py
	```
</details>
<details><summary><b><a href="https://github.com/mikeorr/Unipath">Unipath</a></b> (🥉20 ·  ⭐ 510 · 💀) - An object-oriented approach to file/directory operations. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/wtforms/wtforms) (👨‍💻 140 · 🔀 370 · 📦 160K · 📋 410 - 13% open · ⏱️ 13.01.2023):

	```
	git clone https://github.com/wtforms/wtforms
	```
- [PyPi](https://pypi.org/project/wtforms) (📥 3.7M / month):
	```
	pip install wtforms
	```
- [Conda](https://anaconda.org/conda-forge/wtforms) (📥 140K · ⏱️ 24.12.2021):
	```
...
- [GitHub](https://github.com/django-crispy-forms/django-crispy-forms) (👨‍💻 220 · 🔀 690 · 📦 110K · 📋 660 - 8% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/django-crispy-forms/django-crispy-forms
	```
- [PyPi](https://pypi.org/project/django-crispy-forms) (📥 840K / month):
	```
	pip install django-crispy-forms
	```
- [Conda](https://anaconda.org/conda-forge/django-crispy-forms) (📥 67K · ⏱️ 14.02.2023):
	```
	conda install -c conda-forge django-crispy-forms
	```
</details>
<details><summary><b><a href="https://github.com/zostera/django-bootstrap4">django-bootstrap4</a></b> (🥈28 ·  ⭐ 990) - Bootstrap 4 integration with Django. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/zostera/django-bootstrap4) (👨‍💻 140 · 🔀 210 · 📦 98K · 📋 160 - 13% open · ⏱️ 14.12.2022):
...
- [GitHub](https://github.com/zostera/django-bootstrap3) (👨‍💻 98 · 🔀 680 · 📦 18K · 📋 290 - 2% open · ⏱️ 14.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/django-bootstrap3) (📥 110K / month):
	```
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 160 · 📦 760 · 📋 180 - 25% open · ⏱️ 15.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 20K / month):
	```
	pip install deform
	```
...
<details><summary><b><a href="https://github.com/more-itertools/more-itertools">more-itertools</a></b> (🥇36 ·  ⭐ 3K · 📈) - More routines for operating on iterables, beyond `itertools`. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 97 · 🔀 230 · 📥 2.6K · 📦 170K · 📋 240 - 9% open · ⏱️ 28.02.2023):
...
- [PyPi](https://pypi.org/project/more-itertools) (📥 36M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 11M · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/pytoolz/toolz) (👨‍💻 74 · 🔀 230 · 📦 84K · 📋 220 - 34% open · ⏱️ 03.11.2022):
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 31 · 🔀 130 · 📦 7K · 📋 74 - 6% open · ⏱️ 26.02.2023):

	```
	git clone https://github.com/Suor/funcy
	```
- [PyPi](https://pypi.org/project/funcy) (📥 2M / month):
	```
	pip install funcy
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 42 · 🔀 95 · 📦 320 · 📋 390 - 14% open · ⏱️ 13.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/returns) (📥 69K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 4.4K · ⏱️ 13.03.2022):
	```
...
- [GitHub](https://github.com/pytoolz/cytoolz) (🔀 65 · 📦 48K · 📋 75 - 30% open · ⏱️ 19.12.2022):
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 460 · 📋 48 - 47% open · ⏱️ 13.10.2014):
	...
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 520 / month):
	```
	pip install fn.py
	```
...
- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 140 · 🔀 250 · 📦 21K · 📋 440 - 16% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/pyglet/pyglet
	```
- [PyPi](https://pypi.org/project/pyglet) (📥 250K / month):
	```
	pip install pyglet
	```
...
- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.7K · 📦 7.5K · 📋 3.2K - 21% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 180K / month):
	```
...
- [GitHub](https://github.com/python-eel/Eel) (👨‍💻 45 · 🔀 540 · 📦 4.8K · 📋 490 - 32% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/Eel) (📥 79K / month):
	```
	pip install Eel
	```
...
- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 500 · 📦 1.7K · 📋 1.1K - 15% open · ⏱️ 02.03.2023):
...
<details><summary><b><a href="https://github.com/chriskiehl/Gooey">Gooey</a></b> (🥉24 ·  ⭐ 17K · 💤) - Turn command line programs into a full GUI application with one line. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/chriskiehl/Gooey) (👨‍💻 100 · 🔀 900 · 📥 390 · 📦 710 · 📋 570 - 21% open · ⏱️ 08.05.2022):

	```
	git clone https://github.com/chriskiehl/Gooey
	```
- [PyPi](https://pypi.org/project/Gooey) (📥 5.2K / month):
	```
	pip install Gooey
	```
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 430 · 📦 970 · 📋 730 - 3% open · ⏱️ 28.02.2023):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 260 · 📦 120 · 📋 440 - 19% open · ⏱️ 22.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/flexx) (📥 500 / month):
	```
	pip install flexx
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 230 · 🔀 570 · 📥 1.1K · 📋 620 - 18% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/pybee/toga
	```
- [PyPi](https://pypi.org/project/toga) (📥 1.4K / month):
	```
	pip install toga
	```
...
- [GitHub](https://github.com/nucleic/enaml) (👨‍💻 39 · 🔀 120 · 📥 240 · 📦 210 · 📋 220 - 16% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/nucleic/enaml
	```
- [PyPi](https://pypi.org/project/enaml) (📥 3K / month):
	```
	pip install enaml
	```
...
- [GitHub](https://github.com/graphql-python/graphene) (🔀 780 · 📦 17K · 📋 970 - 10% open · ⏱️ 28.02.2023):
...
- [GitHub](https://github.com/geopy/geopy) (👨‍💻 130 · 🔀 590 · 📋 260 - 8% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/geopy) (📥 3.9M / month):
	```
	pip install geopy
	```
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 53 · 🔀 250 · 📋 270 - 4% open · ⏱️ 31.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 510K / month):
	```
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 40 · 🔀 120 · 📥 380 · 📦 1.1M · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 49 · 🔀 440 · 📦 51K · 📋 230 - 31% open · ⏱️ 08.05.2022):
	...
	```
- [PyPi](https://pypi.org/project/xmltodict) (📥 22M / month):
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 52 · 🔀 170 · 📦 18K · 📋 180 - 27% open · ⏱️ 02.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 1.4M / month):
	```
	pip install pyquery
	```
...
- [PyPi](https://pypi.org/project/untangle) (📥 170K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/untangle) (📥 3.6K · ⏱️ 30.06.2020):
	```
	conda install -c conda-forge untangle
	```
</details>
<details><summary><b><a href="https://github.com/html5lib/html5lib-python">html5lib</a></b> (🥉16 ·  ⭐ 1K) - A standards-compliant library for parsing and serializing HTML documents.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/html5lib/html5lib-python) (👨‍💻 65 · 🔀 260 · 📋 250 - 30% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 730 · 🔀 8.6K · 📥 4.6K · 📦 2M · 📋 3.7K - 5% open · ⏱️ 27.02.2023):
...
- [GitHub](https://github.com/encode/httpx) (👨‍💻 190 · 🔀 650 · 📦 75K · 📋 740 - 3% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/encode/httpx
	```
- [PyPi](https://pypi.org/project/httpx) (📥 13M / month):
	```
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 490K · ⏱️ 04.01.2023):
	```
...
- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 320 · 🔀 970 · 📥 5.7K · 📦 1.2M · 📋 1.1K - 9% open · ⏱️ 17.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/urllib3) (📥 320M / month):
	```
	pip install urllib3
	```
- [Conda](https://anaconda.org/conda-forge/urllib3) (📥 30M · ⏱️ 11.01.2023):
	```
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 77 · 🔀 180 · 📦 130K · 📋 110 - 40% open · ⏱️ 19.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/httplib2) (📥 38M / month):
	```
...
<details><summary><b><a href="https://github.com/spyoungtech/grequests">grequests</a></b> (🥉26 ·  ⭐ 4.2K · 💀) - requests + gevent for asynchronous HTTP requests. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [PyPi](https://pypi.org/project/grequests) (📥 320K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/grequests) (📥 71K · ⏱️ 22.04.2020):
	```
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 50 · 🔀 130 · 📥 160 · 📦 1.4K · 📋 150 - 36% open · ⏱️ 10.09.2022):

	```
	git clone https://github.com/twisted/treq
	```
- [PyPi](https://pypi.org/project/treq) (📥 70K / month):
	```
	pip install treq
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 410 · 🔀 1.7K · 📦 10K · 📋 1.4K - 4% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/secdev/scapy
	```
- [PyPi](https://pypi.org/project/scapy) (📥 2.8M / month):
	```
	pip install scapy
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 41 · 🔀 380 · 📦 9.5K · 📋 530 - 64% open · ⏱️ 31.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 390K / month):
	```
...
<details><summary><b><a href="https://github.com/boppreh/mouse">mouse</a></b> (🥉22 ·  ⭐ 740 · 💤) - Hook and simulate global mouse events on Windows and Linux. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 110 · 📦 960 · 📋 110 - 72% open · ⏱️ 23.08.2022):

	```
	git clone https://github.com/boppreh/mouse
	```
- [PyPi](https://pypi.org/project/mouse) (📥 28K / month):
	```
	pip install mouse
	```
...
- [GitHub](https://github.com/SavinaRoja/PyUserInput) (👨‍💻 21 · 🔀 170 · 📦 500 · 📋 100 - 70% open · ⏱️ 19.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyUserInput) (📥 5.8K / month):
	```
...
- [GitHub](https://github.com/rockymeza/wifi) (👨‍💻 13 · 🔀 140 · 📦 460 · 📋 64 - 51% open · ⏱️ 20.03.2017):
...
- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 430 · 🔀 1.8K · 📦 1.1M · 📋 2.7K - 3% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 100 · 🔀 190 · 📥 9.8K · 📦 15K · 📋 390 - 4% open · ⏱️ 14.01.2023):

	```
	git clone https://github.com/dahlia/wand
	```
- [PyPi](https://pypi.org/project/wand) (📥 610K / month):
	```
	pip install wand
	```
...
- [GitHub](https://github.com/thumbor/thumbor) (👨‍💻 190 · 🔀 770 · 📦 330 · 📋 930 - 0% open · ⏱️ 27.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/thumbor) (📥 5.5K / month):
	```
	pip install thumbor
	```
...
- [PyPi](https://pypi.org/project/python-barcode) (📥 240K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-barcode) (📥 9.1K · ⏱️ 22.08.2020):
	```
	conda install -c conda-forge python-barcode
	```
</details>
<details><summary><b><a href="https://github.com/dylanaraps/pywal">pywal</a></b> (🥈24 ·  ⭐ 7.1K · 💀) - A tool that generates color schemes from images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 280 · 📥 940 · 📦 220 · 📋 520 - 25% open · ⏱️ 09.09.2021):
...
<details><summary><b><a href="https://github.com/libvips/pyvips">pyvips</a></b> (🥉22 ·  ⭐ 480) - A fast image processing library with low memory needs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 15 · 🔀 46 · 📦 480 · 📋 340 - 37% open · ⏱️ 28.02.2023):
...
- [PyPi](https://pypi.org/project/pyvips) (📥 31K / month):
	...
	pip install pyvips
	```
- [Conda](https://anaconda.org/conda-forge/pyvips) (📥 48K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 11 · 🔀 42 · 📦 63 · 📋 8 - 50% open · ⏱️ 30.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/pagan) (📥 260 / month):
	```
	pip install pagan
	```
...
- [GitHub](https://github.com/hhatto/nude.py) (👨‍💻 12 · 🔀 130 · 📦 3.3K · 📋 10 - 70% open · ⏱️ 23.11.2020):
...
- [GitHub](https://github.com/fogleman/Quads) (🔀 140 · ⏱️ 20.05.2014):
	...
	```
- [PyPi](https://pypi.org/project/Quads) (📥 140 / month):
	```
	pip install Quads
	```
...
- [GitHub](https://github.com/rossgoodwin/hmap) (👨‍💻 3 · 🔀 22 · ⏱️ 04.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/hmap) (📥 780 / month):
	```
	pip install hmap
	```
...
<details><summary><b><a href="https://github.com/micropython/micropython">MicroPython</a></b> (🥇25 ·  ⭐ 16K) - A lean and efficient Python programming language.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/micropython/micropython) (👨‍💻 560 · 🔀 4.6K · 📥 57K · 📦 37 · 📋 4.6K - 26% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/IronLanguages/ironpython3) (👨‍💻 33 · 🔀 240 · 📥 49K · 📋 560 - 46% open · ⏱️ 26.02.2023):
...
<details><summary><b><a href="https://github.com/python/cpython">CPython</a></b> (🥈21 ·  ⭐ 51K) - **Default, most widely used implementation of the Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/cpython) (👨‍💻 2.4K · 🔀 25K · 📋 62K - 10% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 53K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/pyston/pyston_v1) (🔀 290 · 📥 5.1K · 📋 280 - 3% open · ⏱️ 06.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyston) (📥 280K / month):
	```
	pip install pyston
	```
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 25 · 🔀 150 · 📦 14 · 📋 89 - 26% open · ⏱️ 13.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 37 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/microsoft/Pyjion) (👨‍💻 19 · 🔀 71 · 📋 110 - 33% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/Pyjion) (📥 460 / month):
	```
	pip install Pyjion
	```
...
<details><summary><b><a href="https://github.com/stackless-dev/stackless">Stackless Python</a></b> (🥉11 ·  ⭐ 900 · 💀) - An enhanced version of the Python programming language. <code>❗Unlicensed</code></summary>
...
- [PyPi](https://pypi.org/project/ptpython) (📥 430K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 29K · ⏱️ 31.10.2022):
	```
...
- [GitHub](https://github.com/bpython/bpython) (👨‍💻 130 · 🔀 220 · 📋 770 - 16% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 130 · 🔀 1.1K · 📦 2.3K · 📋 3.4K - 20% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 760K / month):
	```
	pip install prefect
	```
- [Conda](https://anaconda.org/conda-forge/prefect) (📥 400K · ⏱️ 24.02.2023):
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 51 · 🔀 270 · 📦 59 · 📋 110 - 5% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/knipknap/SpiffWorkflow
	```
- [PyPi](https://pypi.org/project/SpiffWorkflow) (📥 5.3K / month):
	```
...
- [GitHub](https://github.com/Delgan/loguru) (👨‍💻 42 · 🔀 580 · 📦 47K · 📋 710 - 10% open · ⏱️ 01.02.2023):

	```
	git clone https://github.com/Delgan/loguru
	```
- [PyPi](https://pypi.org/project/loguru) (📥 7M / month):
	```
	pip install loguru
	```
- [Conda](https://anaconda.org/conda-forge/loguru) (📥 990K · ⏱️ 26.10.2022):
	```
	conda install -c conda-forge loguru
	```
</details>
<details><summary><b><a href="https://github.com/getsentry/sentry-python">sentry-python</a></b> (🥉29 ·  ⭐ 1.5K) - Sentry SDK for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/getsentry/sentry-python) (👨‍💻 160 · 🔀 340 · 📥 3.7K · 📦 40K · 📋 820 - 19% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 600 · 🔀 8K · 📥 6.1K · 📦 49K · 📋 4.7K - 6% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 9.4M / month):
	```
	pip install xgboost
	```
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 380 · 🔀 7.7K · 📦 39K · 📋 1.7K - 2% open · ⏱️ 30.01.2023):

	```
	git clone https://github.com/openai/gym
	```
- [PyPi](https://pypi.org/project/gym) (📥 800K / month):
	```
	pip install gym
	```
...
<details><summary><b><a href="https://github.com/numenta/nupic">NuPIC</a></b> (🥈23 ·  ⭐ 6.3K · 💀) - Numenta Platform for Intelligent Computing. <code><a href="http://bit.ly/3pwmjO5">❗️AGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.6K · 📦 120 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 970 / month):
	```
	pip install nupic
	```
...
<details><summary><b><a href="https://github.com/mindsdb/mindsdb">MindsDB</a></b> (🥉22 ·  ⭐ 14K) - MindsDB is an open source AI layer for existing databases that.. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>

- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 320 · 🔀 1.5K · 📋 2.1K - 16% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 9.5K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 240 · 🔀 1.9K · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/benhamner/Metrics) (👨‍💻 7 · 🔀 420 · 📋 19 - 63% open · ⏱️ 09.09.2015):
	...
	```
- [PyPi](https://pypi.org/project/Metrics) (📥 7.5K / month):
	```
	pip install Metrics
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 98 · 🔀 540 · 📥 1.1K · 📦 1.3K · 📋 1.3K - 7% open · ⏱️ 03.02.2023):

	```
	git clone https://github.com/pythonnet/pythonnet
	```
- [PyPi](https://pypi.org/project/pythonnet) (📥 160K / month):
	```
	pip install pythonnet
	```
- [Conda](https://anaconda.org/conda-forge/pythonnet) (📥 64K · ⏱️ 03.11.2022):
	```
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 85 · 🔀 720 · 📥 600K · 📦 110K · 📋 1.7K - 25% open · ⏱️ 19.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 4.4M / month):
	```
	pip install pywin32
	```
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 42 · 🔀 200 · 📦 780K · ⏱️ 01.03.2023):

	```
	git clone https://github.com/pallets/itsdangerous
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 55M / month):
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 83 · 🔀 330 · 📥 23 · 📦 4K · 📋 140 - 31% open · ⏱️ 20.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/boltons) (📥 3.7M / month):
	```
	pip install boltons
	```
- [Conda](https://anaconda.org/conda-forge/boltons) (📥 750K · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/pallets-eco/blinker) (👨‍💻 16 · 🔀 160 · 📦 140K · 📋 36 - 2% open · ⏱️ 24.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/blinker) (📥 7.4M / month):
	```
	pip install blinker
	```
- [Conda](https://anaconda.org/conda-forge/blinker) (📥 7.9M · ⏱️ 03.10.2022):
	```
...
- [GitHub](https://github.com/magenta/magenta) (👨‍💻 160 · 🔀 3.6K · 📦 410 · 📋 910 - 35% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/magenta/magenta
	```
- [PyPi](https://pypi.org/project/magenta) (📥 7.4K / month):
	```
	pip install magenta
	```
...
- [GitHub](https://github.com/mitsuhiko/pluginbase) (👨‍💻 9 · 🔀 140 · 📦 1.7K · 📋 13 - 7% open · ⏱️ 16.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/pluginbase) (📥 560K / month):
	```
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 440 · 🔀 4.1K · 📥 4.3K · 📦 43K · 📋 1.8K - 20% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/RaRe-Technologies/gensim
	```
- [PyPi](https://pypi.org/project/gensim) (📥 4.6M / month):
	```
	pip install gensim
	```
- [Conda](https://anaconda.org/conda-forge/gensim) (📥 990K · ⏱️ 21.12.2022):
	```
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.4K · 📦 21K · 📋 820 - 73% open · ⏱️ 15.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jieba) (📥 530K / month):
	```
	pip install jieba
	```
...
<details><summary><b><a href="https://github.com/stanfordnlp/stanza">Stanza</a></b> (🥈24 ·  ⭐ 6.5K) - The Stanford NLP Group's official Python library, supporting 60+.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 54 · 🔀 820 · 📦 1.6K · 📋 760 - 10% open · ⏱️ 15.09.2022):

	```
	git clone https://github.com/stanfordnlp/stanza
	```
- [PyPi](https://pypi.org/project/stanza) (📥 170K / month):
	```
	pip install stanza
	```
...
<details><summary><b><a href="https://github.com/aboSamoor/polyglot">polyglot</a></b> (🥈24 ·  ⭐ 2.1K · 💀) - Natural language pipeline supporting hundreds of languages. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/aboSamoor/polyglot) (👨‍💻 26 · 🔀 310 · 📦 940 · 📋 220 - 68% open · ⏱️ 22.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/polyglot) (📥 68K / month):
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 940 · 📥 100K · 📦 250 · 📋 160 - 74% open · ⏱️ 08.06.2022):
...
- [GitHub](https://github.com/isnowfy/snownlp) (👨‍💻 8 · 🔀 1.3K · 📦 1.1K · 📋 100 - 38% open · ⏱️ 19.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/snownlp) (📥 6.9K / month):
	```
	pip install snownlp
	```
...
- [GitHub](https://github.com/fighting41love/funNLP) (👨‍💻 11 · 🔀 12K · 📋 55 - 20% open · ⏱️ 17.11.2022):

	```
	git clone https://github.com/fighting41love/funNLP
	```
- [PyPi](https://pypi.org/project/funNLP) (📥 17 / month):
	```
	pip install funNLP
	```
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 200 · 🔀 510 · 📦 1.4K · 📋 580 - 21% open · ⏱️ 17.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/napalm) (📥 51K / month):
	```
	pip install napalm
	```
...
<details><summary><b><a href="https://github.com/mininet/mininet">mininet</a></b> (🥉28 ·  ⭐ 4.7K) - A popular network emulator and API written in Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/mininet/mininet) (👨‍💻 80 · 🔀 1.6K · 📥 500K · 📦 200 · 📋 680 - 36% open · ⏱️ 23.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/mininet) (📥 3.4K / month):
	```
	pip install mininet
	```
...
- [GitHub](https://github.com/noxrepo/pox) (👨‍💻 26 · 🔀 430 · 📋 190 - 22% open · ⏱️ 20.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/pox) (📥 4.2M / month):
	```
	pip install pox
	```
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 21K · ⏱️ 28.02.2023):
...
- [PyPi](https://pypi.org/project/peewee) (📥 1.3M / month):
	...
	pip install peewee
	```
- [Conda](https://anaconda.org/conda-forge/peewee) (📥 480K · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 380 · 🔀 1.1K · 📦 19K · 📋 1.6K - 20% open · ⏱️ 26.02.2023):

	```
	git clone https://github.com/MongoEngine/mongoengine
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 980K / month):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 100 · 🔀 400 · 📦 1.3K · 📋 560 - 36% open · ⏱️ 28.02.2023):
...
- [PyPi](https://pypi.org/project/PynamoDB) (📥 1.3M / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/PynamoDB) (📥 260K · ⏱️ 21.02.2023):
	```
...
- [GitHub](https://github.com/pudo/dataset) (👨‍💻 76 · 🔀 280 · 📦 2.9K · 📋 280 - 7% open · ⏱️ 30.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/dataset) (📥 53K / month):
	```
	pip install dataset
	```
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 32 · 🔀 160 · 📦 530 · 📋 320 - 42% open · ⏱️ 13.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/orator) (📥 18K / month):
	```
	pip install orator
	```
...
- [GitHub](https://github.com/ponyorm/pony) (🔀 220 · 📥 46 · 📦 3.3K · 📋 610 - 46% open · ⏱️ 15.12.2022):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 27 · 📋 11 - 54% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 680 / month):
	```
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 81 · 📋 51 - 70% open · ⏱️ 06.06.2016):
	...
	```
- [PyPi](https://pypi.org/project/redisco) (📥 480 / month):
	```
	pip install redisco
	```
...
- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 440 · 🔀 1.9K · 📥 15M · 📋 4.8K - 11% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/sdispater/poetry
	```
- [PyPi](https://pypi.org/project/poetry) (📥 12M / month):
	```
	pip install poetry
	```
- [Conda](https://anaconda.org/conda-forge/poetry) (📥 780K · ⏱️ 28.02.2023):
	```
	conda install -c conda-forge poetry
	```
</details>
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥉25 ·  ⭐ 6.7K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/jazzband/pip-tools) (👨‍💻 180 · 🔀 490 · 📋 900 - 12% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/jazzband/pip-tools
	```
- [PyPi](https://pypi.org/project/pip-tools) (📥 10M / month):
	```
	pip install pip-tools
	```
- [Conda](https://anaconda.org/conda-forge/pip-tools) (📥 74K · ⏱️ 01.03.2023):
	```
...
- [GitHub](https://github.com/conda/conda) (🔀 1.3K · 📋 8.9K - 9% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 92 · 🔀 110 · 📦 210 · 📋 730 - 9% open · ⏱️ 25.02.2023):

	```
	git clone https://github.com/devpi/devpi
	```
- [PyPi](https://pypi.org/project/devpi) (📥 3.5K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypi/warehouse) (👨‍💻 330 · 🔀 790 · 📋 2.9K - 14% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/mvantellingen/localshop) (👨‍💻 46 · 🔀 110 · 📦 5 · 📋 110 - 30% open · ⏱️ 17.07.2022):
	...
	```
- [PyPi](https://pypi.org/project/localshop) (📥 89 / month):
	```
...
- [GitHub](https://github.com/pypa/bandersnatch) (🔀 110 · 📋 230 - 15% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 120 · 🔀 4.9K · 📋 4.9K - 1% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/sqlmapproject/sqlmap
	```
- [PyPi](https://pypi.org/project/sqlmap) (📥 6.7K / month):
	```
	pip install sqlmap
	```
...
- [GitHub](https://github.com/dfunckt/django-rules) (👨‍💻 28 · 🔀 130 · 📦 1.2K · 📋 110 - 22% open · ⏱️ 23.02.2023):

	```
	git clone https://github.com/dfunckt/django-rules
	```
- [PyPi](https://pypi.org/project/django-rules) (📥 130 / month):
	```
...
- [GitHub](https://github.com/amoffat/sh) (👨‍💻 91 · 🔀 460 · 📦 12K · 📋 430 - 1% open · ⏱️ 13.02.2023):
...
- [GitHub](https://github.com/spotify/annoy) (👨‍💻 83 · 🔀 1.1K · 📦 2.7K · 📋 370 - 12% open · ⏱️ 25.02.2023):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 650 · 📦 980 · 📋 480 - 26% open · ⏱️ 19.07.2022):
...
<details><summary><b><a href="https://github.com/benfred/implicit">implicit</a></b> (🥈26 ·  ⭐ 3.1K) - A fast Python implementation of collaborative filtering for implicit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/implicit) (👨‍💻 34 · 🔀 560 · 📥 320 · 📦 870 · 📋 450 - 16% open · ⏱️ 11.12.2022):
...
- [GitHub](https://github.com/NicolasHug/Surprise) (👨‍💻 45 · 🔀 940 · 📋 370 - 18% open · ⏱️ 27.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/Surprise) (📥 14K / month):
	```
...
- [GitHub](https://github.com/maciejkula/spotlight) (👨‍💻 11 · 🔀 400 · 📋 110 - 56% open · ⏱️ 09.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/spotlight) (📥 870 / month):
	```
...
- [GitHub](https://github.com/ibayer/fastFM) (👨‍💻 20 · 🔀 200 · 📥 470 · 📦 100 · 📋 110 - 43% open · ⏱️ 24.03.2021):
	...
	```
- [PyPi](https://pypi.org/project/fastFM) (📥 300 / month):
	```
	pip install fastFM
	```
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 78 · 🔀 140 · 📦 59K · 📋 290 - 26% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/python-rope/rope
	```
- [PyPi](https://pypi.org/project/rope) (📥 630K / month):
	```
	pip install rope
	```
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 420 · 🔀 4.5K · 📦 150K · 📋 3.3K - 1% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 14M / month):
	```
	pip install fastapi
	```
...
- [GitHub](https://github.com/falconry/falcon) (👨‍💻 200 · 🔀 880 · 📥 4.3K · 📦 7.8K · 📋 970 - 15% open · ⏱️ 18.01.2023):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 760K / month):
	```
	pip install falcon
	```
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 330 · 🔀 1.5K · 📦 13K · 📋 1.3K - 4% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 990K / month):
	```
	pip install sanic
	```
...
- [GitHub](https://github.com/hugapi/hug) (👨‍💻 120 · 🔀 380 · 📦 2.2K · 📋 460 - 35% open · ⏱️ 10.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/hug) (📥 98K / month):
	```
	pip install hug
	```
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 33 · 🔀 180 · 📦 5.7K · 📋 64 - 18% open · ⏱️ 01.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/flask-api) (📥 160K / month):
	```
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 210 · 📦 24 · 📋 84 - 38% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 410 / month):
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 410 · 🔀 2.5K · 📥 27 · 📦 86K · 📋 5K - 47% open · ⏱️ 26.02.2023):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.2K · 🔀 3.8K · 📥 490K · 📦 54K · 📋 12K - 32% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/quantopian/zipline) (👨‍💻 160 · 🔀 4.1K · 📦 910 · 📋 980 - 33% open · ⏱️ 14.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/zipline) (📥 2.6K / month):
	```
	pip install zipline
	```
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 440 · 🔀 1.7K · 📥 1.9K · 📦 1.2K · 📋 3K - 5% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 17 · 🔀 220 · 📦 130 · ⏱️ 08.02.2023):
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 310 · 📦 2.9K · 📋 140 - 15% open · ⏱️ 12.04.2022):

	```
	git clone https://github.com/django-haystack/pysolr
	```
- [PyPi](https://pypi.org/project/pysolr) (📥 250K / month):
	```
	pip install pysolr
	```
...
<details><summary><b><a href="https://github.com/elastic/elasticsearch-dsl-py">elasticsearch-dsl-py</a></b> (🥉25 ·  ⭐ 3.6K) - The official high-level Python client for.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/elastic/elasticsearch-dsl-py) (👨‍💻 130 · 🔀 750 · 📥 160 · 📦 8.6K · 📋 1.3K - 9% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 600 · 📦 71K · 📋 1.2K - 11% open · ⏱️ 21.02.2023):

	```
	git clone https://github.com/marshmallow-code/marshmallow
	```
- [PyPi](https://pypi.org/project/marshmallow) (📥 20M / month):
	```
...
- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 14 · 🔀 47 · 📦 900 · 📋 80 - 15% open · ⏱️ 12.09.2022):
...
- [PyPi](https://pypi.org/project/pysimdjson) (📥 210K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/pysimdjson) (📥 55K · ⏱️ 29.10.2022):
	```
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 19 · 🔀 42 · 📦 3.7K · 📋 100 - 11% open · ⏱️ 17.10.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 960K / month):
	```
...
- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 48 · 🔀 220 · 📦 180 · 📋 90 - 41% open · ⏱️ 03.06.2022):
	...
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 5.1K / month):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 580 · 📥 8.3K · 📋 2.4K - 10% open · ⏱️ 02.03.2023):
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 36 · 🔀 220 · 📦 200K · 📋 250 - 5% open · ⏱️ 28.02.2023):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 540 · 📦 34K · 📋 240 - 11% open · ⏱️ 17.02.2023):
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 47 · 🔀 580 · 📦 57K · 📋 840 - 1% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/jmcnamara/XlsxWriter
	```
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 12M / month):
	```
...
- [PyPi](https://pypi.org/project/csvkit) (📥 160K / month):
	...
	pip install csvkit
	```
- [Conda](https://anaconda.org/conda-forge/csvkit) (📥 82K · ⏱️ 22.02.2023):
	```
...
- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 57 · 🔀 440 · 📥 25K · 📦 27K · 📋 1.7K - 15% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 82K / month):
	```
	pip install xlwings
	```
...
<details><summary><b><a href="https://github.com/euske/pdfminer">PDFMiner</a></b> (🥈26 ·  ⭐ 5K · 💀) - A tool for extracting information from PDF documents. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/Python-Markdown/markdown) (👨‍💻 160 · 🔀 780 · 📦 250K · 📋 800 - 4% open · ⏱️ 09.01.2023):
...
<details><summary><b><a href="https://github.com/py-pdf/pypdf">PyPDF2</a></b> (🥉23 ·  ⭐ 5.3K · 📉) - A library capable of splitting, merging and transforming PDF.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/py-pdf/pypdf) (👨‍💻 170 · 🔀 1K · 📋 680 - 7% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/mstamy2/PyPDF2
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 4.8M / month):
	```
	pip install PyPDF2
	```
- [Conda](https://anaconda.org/conda-forge/PyPDF2) (📥 360K · ⏱️ 29.10.2022):
	```
	conda install -c conda-forge PyPDF2
	```
</details>
<details><summary><b><a href="https://github.com/python-openxml/python-docx">python-docx</a></b> (🥉23 ·  ⭐ 3.5K · 💀) - Reads, queries and modifies Microsoft Word 2007/2008 docx files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-openxml/python-docx) (👨‍💻 14 · 🔀 850 · 📋 1K - 48% open · ⏱️ 15.05.2021):

	```
	git clone https://github.com/python-openxml/python-docx
	```
- [PyPi](https://pypi.org/project/python-docx) (📥 3.3M / month):
	```
	pip install python-docx
	```
- [Conda](https://anaconda.org/conda-forge/python-docx) (📥 140K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/elapouya/python-docx-template) (👨‍💻 51 · 🔀 330 · 📦 1.7K · 📋 390 - 19% open · ⏱️ 07.01.2023):
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 440 · 🔀 1.8K · 📥 740 · 📦 6.8K · 📋 1.6K - 4% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/getpelican/pelican
	```
- [PyPi](https://pypi.org/project/pelican) (📥 20K / month):
	```
	pip install pelican
	```
...
- [GitHub](https://github.com/getnikola/nikola) (👨‍💻 230 · 🔀 350 · 📦 470 · 📋 2.1K - 2% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/getnikola/nikola
	```
- [PyPi](https://pypi.org/project/nikola) (📥 1.1K / month):
	```
	pip install nikola
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 93 · 🔀 300 · 📥 7K · 📋 620 - 36% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/lektor/lektor
	```
- [PyPi](https://pypi.org/project/lektor) (📥 3.5K / month):
	```
	pip install lektor
	```
- [Conda](https://anaconda.org/conda-forge/lektor) (📥 60K · ⏱️ 01.03.2023):
	```
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 280 · 🔀 1.3K · 📦 13K · 📋 1K - 13% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 840K / month):
	```
	pip install rq
	```
- [Conda](https://anaconda.org/conda-forge/rq) (📥 87K · ⏱️ 30.06.2021):
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 67 · 🔀 360 · 📦 1.1K · ⏱️ 24.02.2023):

	```
	git clone https://github.com/coleifer/huey
	```
- [PyPi](https://pypi.org/project/huey) (📥 77K / month):
	```
	pip install huey
	```
...
<details><summary><b><a href="https://github.com/Bogdanp/dramatiq">dramatiq</a></b> (🥉27 ·  ⭐ 3.5K) - A fast and reliable background task processing library for Python.. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 87 · 🔀 240 · 📥 36 · 📦 850 · 📋 310 - 11% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/Bogdanp/dramatiq
	```
- [PyPi](https://pypi.org/project/dramatiq) (📥 130K / month):
	```
	pip install dramatiq
	```
- [Conda](https://anaconda.org/conda-forge/dramatiq) (📥 40K · ⏱️ 27.02.2023):
	```
...
- [GitHub](https://github.com/pricingassistant/mrq) (👨‍💻 40 · 🔀 110 · 📦 29 · 📋 170 - 30% open · ⏱️ 13.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrq) (📥 230 / month):
	```
	pip install mrq
	```
...
- [GitHub](https://github.com/pallets/jinja) (👨‍💻 300 · 🔀 1.5K · 📥 54K · 📋 950 - 5% open · ⏱️ 01.03.2023):
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 510 · 🔀 1.7K · 📦 110K · 📋 620 - 2% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/joke2k/faker
	```
- [PyPi](https://pypi.org/project/faker) (📥 7.6M / month):
	```
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 720K · ⏱️ 25.02.2023):
	```
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 170 · 🔀 2K · 📥 540 · 📦 7.2K · 📋 4K - 6% open · ⏱️ 01.03.2023):
...
<details><summary><b><a href="https://github.com/HypothesisWorks/hypothesis">hypothesis</a></b> (🥇33 ·  ⭐ 6.6K) - Hypothesis is an advanced Quickcheck style property based.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 300 · 🔀 520 · 📦 20K · 📋 1.4K - 3% open · ⏱️ 17.02.2023):

	```
	git clone https://github.com/HypothesisWorks/hypothesis
	```
- [PyPi](https://pypi.org/project/hypothesis) (📥 5.1M / month):
	```
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 120 · 🔀 310 · 📥 88 · 📦 23K · 📋 260 - 1% open · ⏱️ 09.02.2023):

	```
	git clone https://github.com/getsentry/responses
	```
- [PyPi](https://pypi.org/project/responses) (📥 9.2M / month):
	```
	pip install responses
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 1.5M · ⏱️ 26.05.2022):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 180 · 🔀 500 · 📦 6.2K · 📋 510 - 8% open · ⏱️ 27.02.2023):

	```
	git clone https://github.com/cobrateam/splinter
	```
- [PyPi](https://pypi.org/project/splinter) (📥 90K / month):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 1K · 📦 21K · 📋 610 - 64% open · ⏱️ 14.09.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 560K / month):
	```
...
- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 300 · 📥 380 · 📦 1.3K · 📋 310 - 0% open · ⏱️ 26.02.2023):
...
- [PyPi](https://pypi.org/project/mimesis) (📥 110K / month):
	...
	pip install mimesis
	```
- [Conda](https://anaconda.org/conda-forge/mimesis) (📥 84K · ⏱️ 18.12.2022):
	```
...
- [GitHub](https://github.com/locustio/locust) (👨‍💻 280 · 🔀 2.6K · 📋 1.4K - 0% open · ⏱️ 01.03.2023):
...
- [PyPi](https://pypi.org/project/locust) (📥 1.3M / month):
	...
	pip install locust
	```
- [Conda](https://anaconda.org/conda-forge/locust) (📥 100K · ⏱️ 28.02.2023):
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 53 · 🔀 120 · 📦 200 · 📋 710 - 16% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 63K / month):
	```
...
<details><summary><b><a href="https://github.com/gabrielfalcao/HTTPretty">httpretty</a></b> (🥉26 ·  ⭐ 2K) - HTTP request mock tool for Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/spulec/freezegun) (👨‍💻 110 · 🔀 240 · 📋 280 - 36% open · ⏱️ 22.02.2023):

	```
	git clone https://github.com/spulec/freezegun
	```
- [PyPi](https://pypi.org/project/freezegun) (📥 6.6M / month):
	```
	pip install freezegun
	```
- [Conda](https://anaconda.org/conda-forge/freezegun) (📥 740K · ⏱️ 12.08.2022):
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 74 · 🔀 130 · 📦 23K · 📋 260 - 19% open · ⏱️ 07.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 580K / month):
	```
	pip install nose2
	```
- [Conda](https://anaconda.org/conda-forge/nose2) (📥 85K · ⏱️ 02.02.2020):
	```
...
- [GitHub](https://github.com/FactoryBoy/factory_boy) (👨‍💻 130 · 🔀 350 · 📋 540 - 29% open · ⏱️ 07.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/factory_boy) (📥 2.7M / month):
	```
...
- [GitHub](https://github.com/sixpack/sixpack) (👨‍💻 56 · 🔀 180 · 📦 10 · 📋 190 - 35% open · ⏱️ 26.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/sixpack) (📥 170 / month):
	```
	pip install sixpack
	```
...
- [PyPi](https://pypi.org/project/httmock) (📥 350K / month):
	...
	pip install httmock
	```
- [Conda](https://anaconda.org/conda-forge/httmock) (📥 7.4K · ⏱️ 23.10.2017):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 24 · 🔀 39 · 📦 79 · ⏱️ 21.02.2023):
...
- [GitHub](https://github.com/emirozer/fake2db) (👨‍💻 18 · 🔀 110 · 📦 22 · 📋 22 - 31% open · ⏱️ 25.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/fake2db) (📥 210 / month):
	```
	pip install fake2db
	```
...
- [GitHub](https://github.com/andialbrecht/sqlparse) (👨‍💻 100 · 🔀 600 · 📦 680K · 📋 490 - 42% open · ⏱️ 05.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/sqlparse) (📥 34M / month):
	```
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 53 · 🔀 240 · 📥 7.6K · 📦 730K · 📋 280 - 12% open · ⏱️ 12.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/pyparsing) (📥 79M / month):
	```
...
<details><summary><b><a href="https://github.com/seatgeek/fuzzywuzzy">fuzzywuzzy</a></b> (🥈32 ·  ⭐ 8.8K · 💀) - Fuzzy String Matching. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 870 · 📦 17K · 📋 180 - 44% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 6.4M / month):
	```
	pip install fuzzywuzzy
	```
- [Conda](https://anaconda.org/conda-forge/fuzzywuzzy) (📥 450K · ⏱️ 18.11.2020):
	```
...
- [GitHub](https://github.com/skorokithakis/shortuuid) (👨‍💻 33 · 🔀 110 · 📦 16K · ⏱️ 25.02.2023):
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 24 · 🔀 100 · 📦 28K · 📋 49 - 28% open · ⏱️ 16.09.2022):

	```
	git clone https://github.com/pwaller/pyfiglet
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 970K / month):
	```
...
<details><summary><b><a href="https://github.com/life4/textdistance">textdistance</a></b> (🥈26 ·  ⭐ 3.1K) - Compute distance between sequences with 30+ algorithms. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 13 · 🔀 240 · 📥 880 · 📦 3.6K · ⏱️ 18.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/textdistance) (📥 430K / month):
	```
	pip install textdistance
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 330K · ⏱️ 18.09.2022):
	```
...
- [GitHub](https://github.com/chardet/chardet) (👨‍💻 48 · 🔀 240 · 📋 130 - 36% open · ⏱️ 02.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/chardet) (📥 60M / month):
	```
	pip install chardet
	```
...
- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 33 · 🔀 93 · 📋 65 - 1% open · ⏱️ 24.02.2023):

	```
	git clone https://github.com/un33k/python-slugify
	```
- [PyPi](https://pypi.org/project/python-slugify) (📥 14M / month):
	```
	pip install python-slugify
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 1.3M · ⏱️ 25.02.2023):
	```
...
- [GitHub](https://github.com/selwin/python-user-agents) (👨‍💻 32 · 🔀 190 · 📦 5.7K · 📋 73 - 56% open · ⏱️ 16.02.2023):
...
<details><summary><b><a href="https://github.com/dabeaz/ply">ply</a></b> (🥉21 ·  ⭐ 2.4K) - Implementation of lex and yacc parsing tools for Python. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/dabeaz/ply) (👨‍💻 35 · 🔀 410 · 📋 180 - 1% open · ⏱️ 29.11.2022):
...
- [PyPi](https://pypi.org/project/ply) (📥 24M / month):
	...
	pip install ply
	```
- [Conda](https://anaconda.org/conda-forge/ply) (📥 3.5M · ⏱️ 07.07.2018):
	```
...
- [GitHub](https://github.com/mozillazg/python-pinyin) (👨‍💻 22 · 🔀 570 · 📋 240 - 10% open · ⏱️ 15.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/python-pinyin) (📥 28 / month):
	```
...
- [GitHub](https://github.com/mozilla/unicode-slugify) (👨‍💻 14 · 🔀 46 · 📦 2.1K · 📋 18 - 55% open · ⏱️ 22.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/unicode-slugify) (📥 46K / month):
	```
...
- [GitHub](https://github.com/rspeer/python-ftfy) (👨‍💻 18 · 🔀 110 · 📦 9.4K · 📋 130 - 9% open · ⏱️ 25.10.2022):
...
- [GitHub](https://github.com/voronind/awesome-slugify) (👨‍💻 11 · 🔀 41 · 📦 3.2K · 📋 24 - 54% open · ⏱️ 20.01.2017):
	...
	```
- [PyPi](https://pypi.org/project/awesome-slugify) (📥 61K / month):
	```
...
- [GitHub](https://github.com/boto/boto3) (👨‍💻 140 · 🔀 1.6K · 📦 270K · 📋 2.9K - 4% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 560M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 14M · ⏱️ 01.03.2023):
	```
	conda install -c conda-forge boto3
	```
</details>
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥈35 ·  ⭐ 6.4K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2.2K · 📦 140K · 📋 970 - 8% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 44M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 1.9M · ⏱️ 02.03.2023):
	```
...
- [GitHub](https://github.com/burnash/gspread) (👨‍💻 160 · 🔀 860 · 📥 370 · 📦 21K · 📋 780 - 7% open · ⏱️ 03.01.2023):

	```
	git clone https://github.com/burnash/gspread
	```
- [PyPi](https://pypi.org/project/gspread) (📥 8.6M / month):
	```
	pip install gspread
	```
...
- [GitHub](https://github.com/jcarbaugh/django-wordpress) (👨‍💻 10 · 🔀 78 · 📦 6 · 📋 11 - 18% open · ⏱️ 24.01.2018):
	...
	```
- [PyPi](https://pypi.org/project/django-wordpress) (📥 17 / month):
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 65 · 🔀 150 · 📦 5.8K · 📋 280 - 2% open · ⏱️ 21.02.2023):
	...
	```
- [PyPi](https://pypi.org/project/webargs) (📥 850K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 60 · 📦 7.9K · ⏱️ 06.06.2022):

	```
	git clone https://github.com/ellisonleao/pyshorteners
	```
- [PyPi](https://pypi.org/project/pyshorteners) (📥 63K / month):
	```
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 35 · 📦 3.7K · 📋 20 - 25% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/purl) (📥 48K / month):
	```
	pip install purl
	```
...
<details><summary><b><a href="https://github.com/gruns/furl">furl</a></b> (🥉20 ·  ⭐ 2.4K · 💤) - A small Python library that makes parsing and manipulating URLs.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 15 · 🔀 140 · 📋 110 - 26% open · ⏱️ 01.08.2022):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 1.6M / month):
	```
	pip install furl
	```
- [Conda](https://anaconda.org/conda-forge/furl) (📥 240K · ⏱️ 28.09.2021):
	```
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 13 · 🔀 210 · 📥 750 · 📦 350 · 📋 250 - 1% open · ⏱️ 26.01.2023):

	```
	git clone https://github.com/abhiTronix/vidgear
	```
- [PyPi](https://pypi.org/project/vidgear) (📥 5.2K / month):
	```
	pip install vidgear
	```
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 22 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 39K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 2.2K · 📋 440 - 27% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/jazzband/django-pipeline
	```
- [PyPi](https://pypi.org/project/django-pipeline) (📥 87K / month):
	```
...
- [GitHub](https://github.com/miracle2k/webassets) (👨‍💻 160 · 🔀 250 · 📦 6.3K · 📋 290 - 19% open · ⏱️ 01.05.2021):

	```
	git clone https://github.com/miracle2k/webassets
	```
- [PyPi](https://pypi.org/project/webassets) (📥 240K / month):
	```
...
- [GitHub](https://github.com/miracle2k/flask-assets) (👨‍💻 38 · 🔀 85 · 📦 6.9K · 📋 97 - 21% open · ⏱️ 29.02.2020):
...
- [PyPi](https://pypi.org/project/flask-assets) (📥 160K / month):
	...
	```
- [Conda](https://anaconda.org/conda-forge/flask-assets) (📥 38K · ⏱️ 24.12.2019):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 240 · 🔀 750 · 📋 610 - 26% open · ⏱️ 28.02.2023):

	```
	git clone https://github.com/jschneier/django-storages
	```
- [PyPi](https://pypi.org/project/django-storages) (📥 2.2M / month):
	```
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 210 · 🔀 540 · 📋 640 - 16% open · ⏱️ 22.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/django-compressor) (📥 400K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 64 · 🔀 870 · 📦 10K · 📋 370 - 43% open · ⏱️ 26.02.2023):

	```
	git clone https://github.com/psf/requests-html
	```
- [PyPi](https://pypi.org/project/requests-html) (📥 850K / month):
	```
	pip install requests-html
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 5.3K · ⏱️ 26.06.2021):
	```
...
<details><summary><b><a href="https://github.com/codelucas/newspaper">newspaper</a></b> (🥈23 ·  ⭐ 13K · 💀) - News extraction, article extraction and content curation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/codelucas/newspaper) (👨‍💻 100 · 🔀 1.9K · 📋 660 - 60% open · ⏱️ 02.09.2020):
	...
	```
- [PyPi](https://pypi.org/project/newspaper) (📥 12K / month):
	```
...
- [GitHub](https://github.com/deanmalmgren/textract) (👨‍💻 40 · 🔀 500 · 📋 220 - 41% open · ⏱️ 10.03.2022):
	...
	```
- [PyPi](https://pypi.org/project/textract) (📥 150K / month):
	```
...
<details><summary><b><a href="https://github.com/coleifer/micawber">micawber</a></b> (🥈23 ·  ⭐ 600) - A small library for extracting rich content from URLs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 84 · 📦 2.7K · ⏱️ 14.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/micawber) (📥 50K / month):
	```
	pip install micawber
	```
- [Conda](https://anaconda.org/conda-forge/micawber) (📥 8.3K · ⏱️ 14.07.2021):
	```
...
- [GitHub](https://github.com/gaojiuli/toapi) (👨‍💻 12 · 🔀 220 · 📦 19 · 📋 54 - 11% open · ⏱️ 28.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/toapi) (📥 77 / month):
	```
	pip install toapi
	```
...
- [GitHub](https://github.com/michaelhelmick/lassie) (👨‍💻 15 · 🔀 47 · 📦 34 · 📋 39 - 25% open · ⏱️ 20.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/lassie) (📥 1.5K / month):
	```
	pip install lassie
	```
...
- [GitHub](https://github.com/binux/pyspider) (👨‍💻 62 · 🔀 3.6K · 📦 320 · 📋 820 - 32% open · ⏱️ 02.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/pyspider) (📥 1.6K / month):
	```
...
<details><summary><b><a href="https://github.com/scrapinghub/portia">portia</a></b> (🥈23 ·  ⭐ 8.8K · 💀) - Visual scraping for Scrapy. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 900 · 📋 74 - 59% open · ⏱️ 07.06.2015):
	...
	```
- [PyPi](https://pypi.org/project/robobrowser) (📥 21K / month):
	```
...
<details><summary><b><a href="https://github.com/MechanicalSoup/MechanicalSoup">MechanicalSoup</a></b> (🥉20 ·  ⭐ 4.3K) - A Python library for automating interaction with websites. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/MechanicalSoup/MechanicalSoup) (👨‍💻 53 · 🔀 360 · 📥 43 · 📋 160 - 15% open · ⏱️ 13.12.2022):
	...
	```
- [PyPi](https://pypi.org/project/MechanicalSoup) (📥 48K / month):
	```
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 83 · 🔀 120 · 📦 460 · 📋 380 - 5% open · ⏱️ 05.11.2022):
	...
	```
- [PyPi](https://pypi.org/project/masonite) (📥 2.1K / month):
	```
...
- [GitHub](https://github.com/aaugustin/websockets) (👨‍💻 64 · 🔀 450 · 📦 91K · 📋 970 - 1% open · ⏱️ 02.03.2023):

	```
	git clone https://github.com/aaugustin/websockets
	```
- [PyPi](https://pypi.org/project/websockets) (📥 16M / month):
	```
...
- [GitHub](https://github.com/django/channels) (👨‍💻 250 · 🔀 730 · 📋 1.2K - 6% open · ⏱️ 08.02.2023):

	```
	git clone https://github.com/django/channels
	```
- [PyPi](https://pypi.org/project/channels) (📥 650K / month):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 470 · 🔀 1.6K · 📥 270 · 📦 940K · 📋 1K - 1% open · ⏱️ 01.03.2023):

	```
	git clone https://github.com/pallets/werkzeug
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 82M / month):
	```
	pip install werkzeug
	```
- [Conda](https://anaconda.org/conda-forge/werkzeug) (📥 7M · ⏱️ 14.02.2023):
	```
...
- [GitHub](https://github.com/Pylons/waitress) (👨‍💻 50 · 🔀 150 · 📦 110K · 📋 210 - 6% open · ⏱️ 23.01.2023):
	...
	```
- [PyPi](https://pypi.org/project/waitress) (📥 3.8M / month):
	```
...
- [GitHub](https://github.com/jonashaag/bjoern) (👨‍💻 44 · 🔀 180 · 📦 570 · 📋 160 - 15% open · ⏱️ 11.09.2022):
	...
	```
- [PyPi](https://pypi.org/project/bjoern) (📥 25K / month):
	```
	pip install bjoern
	```
