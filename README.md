...
- [GitHub](https://github.com/flask-admin/flask-admin) (👨‍💻 340 · 🔀 1.3K · 📦 13K · 📋 1.3K - 26% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/flask-admin/flask-admin
	```
- [PyPi](https://pypi.org/project/flask-admin) (📥 850K / month):
	```
...
- [GitHub](https://github.com/mher/flower) (👨‍💻 180 · 🔀 840 · 📦 7.1K · 📋 800 - 8% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/mher/flower
	```
- [PyPi](https://pypi.org/project/flower) (📥 470K / month):
	```
	pip install flower
	```
...
- [GitHub](https://github.com/geex-arts/django-jet) (👨‍💻 29 · 🔀 640 · 📦 2.5K · 📋 330 - 63% open · ⏱️ 21.05.2019):
	...
	```
- [PyPi](https://pypi.org/project/django-jet) (📥 20K / month):
	```
...
- [GitHub](https://github.com/ajenti/ajenti) (👨‍💻 18 · 🔀 740 · 📦 23 · 📋 1.1K - 1% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/jet-admin/jet-bridge) (👨‍💻 4 · 🔀 98 · 📋 10 - 60% open · ⏱️ 25.11.2021):

	```
	git clone https://github.com/jet-admin/jet-bridge
	```
- [PyPi](https://pypi.org/project/jet-bridge) (📥 180 / month):
	```
...
- [GitHub](https://github.com/TheAlgorithms/Python) (👨‍💻 820 · 🔀 33K · 📋 880 - 1% open · ⏱️ 28.11.2021):
...
- [PyPi](https://pypi.org/project/Python):
	...
	pip install Python
	```
- [Conda](https://anaconda.org/conda-forge/Python) (📥 41M · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/pytransitions/transitions) (👨‍💻 70 · 🔀 460 · 📦 1.9K · 📋 390 - 2% open · ⏱️ 29.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/transitions) (📥 100K / month):
	```
...
- [GitHub](https://github.com/keon/algorithms) (👨‍💻 180 · 🔀 3.8K · 📦 55 · 📋 140 - 35% open · ⏱️ 20.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/algorithms) (📥 710 / month):
	```
...
<details><summary><b><a href="https://github.com/encode/uvicorn">uvicorn</a></b> (🥇32 ·  ⭐ 4.6K) - A lightning-fast ASGI server implementation, using uvloop and httptools. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/uvicorn) (👨‍💻 120 · 🔀 370 · 📦 45K · 📋 540 - 10% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/encode/uvicorn
	```
- [PyPi](https://pypi.org/project/uvicorn) (📥 2.4M / month):
	```
	pip install uvicorn
	```
- [Conda](https://anaconda.org/conda-forge/uvicorn) (📥 700K · ⏱️ 08.12.2021):
	```
	conda install -c conda-forge uvicorn
	```
</details>
<details><summary><b><a href="https://github.com/django/daphne">daphne</a></b> (🥉26 ·  ⭐ 1.7K) - A HTTP, HTTP2 and WebSocket protocol server for ASGI and ASGI-HTTP. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/django/daphne) (👨‍💻 57 · 🔀 190 · 📦 12K · 📋 270 - 14% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/daphne) (📥 210K / month):
	```
	pip install daphne
	```
- [Conda](https://anaconda.org/conda-forge/daphne) (📥 70K · ⏱️ 07.04.2021):
	```
...
<details><summary><b><a href="https://github.com/MagicStack/uvloop">uvloop</a></b> (🥇31 ·  ⭐ 8.2K) - Ultra fast asyncio event loop. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/MagicStack/uvloop) (👨‍💻 42 · 🔀 420 · 📥 350 · 📦 31K · 📋 270 - 18% open · ⏱️ 10.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/uvloop) (📥 2.4M / month):
	```
	pip install uvloop
	```
...
- [GitHub](https://github.com/python-trio/trio) (👨‍💻 130 · 🔀 250 · 📦 3K · 📋 650 - 39% open · ⏱️ 02.11.2021):

	```
	git clone https://github.com/python-trio/trio
	```
- [PyPi](https://pypi.org/project/trio) (📥 1.4M / month):
	```
	pip install trio
	```
...
- [GitHub](https://github.com/beetbox/beets) (👨‍💻 480 · 🔀 1.6K · 📥 7K · 📦 230 · 📋 2.4K - 18% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/beetbox/beets
	```
- [PyPi](https://pypi.org/project/beets) (📥 1.1K / month):
	```
	pip install beets
	```
...
- [GitHub](https://github.com/jiaaro/pydub) (👨‍💻 90 · 🔀 770 · 📦 9.8K · 📋 450 - 43% open · ⏱️ 08.06.2021):

	```
	git clone https://github.com/jiaaro/pydub
	```
- [PyPi](https://pypi.org/project/pydub) (📥 460K / month):
	```
	pip install pydub
	```
...
- [GitHub](https://github.com/beetbox/audioread) (👨‍💻 21 · 🔀 89 · 📦 6.8K · 📋 75 - 38% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/beetbox/audioread
	```
- [PyPi](https://pypi.org/project/audioread):
	```
...
<details><summary><b><a href="https://github.com/keunwoochoi/kapre">kapre</a></b> (🥈22 ·  ⭐ 790) - Keras Audio Preprocessors. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/keunwoochoi/kapre) (👨‍💻 13 · 🔀 140 · 📥 19 · 📦 1.2K · 📋 93 - 12% open · ⏱️ 14.11.2021):
...
- [GitHub](https://github.com/nicfit/eyeD3) (👨‍💻 22 · 🔀 45 · 📥 2.1K · 📦 1.6K · 📋 170 - 24% open · ⏱️ 14.09.2021):
...
<details><summary><b><a href="https://github.com/tyiannak/pyAudioAnalysis">pyAudioAnalysis</a></b> (🥉20 ·  ⭐ 4.3K) - Audio feature extraction, classification, segmentation and.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/librosa/librosa) (👨‍💻 92 · 🔀 760 · 📋 920 - 3% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/worldveil/dejavu) (👨‍💻 23 · 🔀 1.2K · 📦 19 · 📋 200 - 36% open · ⏱️ 03.06.2020):
	...
	```
- [PyPi](https://pypi.org/project/dejavu) (📥 50 / month):
	```
	pip install dejavu
	```
...
<details><summary><b><a href="https://github.com/devsnd/tinytag">tinytag</a></b> (🥉16 ·  ⭐ 490) - A library for reading music meta data of MP3, OGG, FLAC and Wave files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/devsnd/tinytag) (👨‍💻 20 · 🔀 82 · 📦 450 · 📋 84 - 17% open · ⏱️ 28.08.2021):
...
- [GitHub](https://github.com/jpadilla/pyjwt) (👨‍💻 100 · 🔀 520 · 📦 170K · 📋 330 - 21% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/jpadilla/pyjwt
	```
- [PyPi](https://pypi.org/project/pyjwt) (📥 32M / month):
	```
	pip install pyjwt
	```
- [Conda](https://anaconda.org/conda-forge/pyjwt) (📥 4.9M · ⏱️ 06.12.2021):
	```
...
- [GitHub](https://github.com/pennersr/django-allauth) (👨‍💻 560 · 🔀 2.4K · 📦 78K · 📋 1.8K - 18% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/pennersr/django-allauth
	```
- [PyPi](https://pypi.org/project/django-allauth) (📥 260K / month):
	```
...
<details><summary><b><a href="https://github.com/oauthlib/oauthlib">oauthlib</a></b> (🥈32 ·  ⭐ 2.3K) - A generic and thorough implementation of the OAuth request-signing.. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [PyPi](https://pypi.org/project/oauthlib):
	...
	```
- [Conda](https://anaconda.org/conda-forge/oauthlib) (📥 3.8M · ⏱️ 01.06.2021):
	```
...
- [GitHub](https://github.com/omab/python-social-auth) (👨‍💻 280 · 🔀 1.1K · 📦 5.1K · 📋 660 - 2% open · ⏱️ 04.02.2017):
	...
	```
- [PyPi](https://pypi.org/project/python-social-auth) (📥 21K / month):
	```
...
- [GitHub](https://github.com/lepture/authlib) (👨‍💻 70 · 🔀 280 · 📋 290 - 9% open · ⏱️ 29.11.2021):
...
- [GitHub](https://github.com/jazzband/django-oauth-toolkit) (👨‍💻 190 · 🔀 610 · 📋 650 - 19% open · ⏱️ 23.11.2021):
...
- [GitHub](https://github.com/davedoesdev/python-jwt) (👨‍💻 5 · 🔀 23 · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-jwt) (📥 110K / month):
	```
...
<details><summary><b><a href="https://github.com/mpdavis/python-jose">python-jose</a></b> (🥉16 ·  ⭐ 980) - A JOSE implementation in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/pybuilder/pybuilder) (👨‍💻 36 · 🔀 220 · 📋 490 - 16% open · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pybuilder) (📥 11K / month):
	```
	pip install pybuilder
	```
- [Conda](https://anaconda.org/conda-forge/pybuilder) (📥 8.4K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/platformio/platformio-core) (👨‍💻 55 · 🔀 580 · 📋 3.6K - 4% open · ⏱️ 08.12.2021):
...
<details><summary><b><a href="https://github.com/python-attrs/attrs">attrs</a></b> (🥇32 ·  ⭐ 3.8K) - Replacement for `__init__`, `__eq__`, `__repr__`, etc. boilerplate in class.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-attrs/attrs) (👨‍💻 110 · 🔀 280 · 📦 310K · 📋 510 - 19% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/python-attrs/attrs
	```
- [PyPi](https://pypi.org/project/attrs) (📥 39M / month):
	```
	pip install attrs
	```
...
<details><summary><b><a href="https://github.com/jab/bidict">bidict</a></b> (🥈25 ·  ⭐ 950) - Efficient, Pythonic bidirectional map data structures and related.. <code><a href="http://bit.ly/3postzC">MPL-2.0</a></code></summary>

- [GitHub](https://github.com/jab/bidict) (👨‍💻 11 · 🔀 43 · 📦 5.2K · 📋 46 - 4% open · ⏱️ 08.11.2021):

	```
	git clone https://github.com/jab/bidict
	```
- [PyPi](https://pypi.org/project/bidict) (📥 290K / month):
	```
	pip install bidict
	```
...
- [GitHub](https://github.com/cdgriffith/Box) (🔀 74 · 📥 30 · 📋 130 - 15% open · ⏱️ 22.08.2021):
...
- [GitHub](https://github.com/carlosescri/DottedDict) (👨‍💻 3 · 🔀 14 · 📥 60 · 📦 49 · 📋 9 - 77% open · ⏱️ 30.10.2015):
	...
	```
- [PyPi](https://pypi.org/project/DottedDict) (📥 11 / month):
	```
...
- [GitHub](https://github.com/indico/indico) (👨‍💻 120 · 🔀 310 · 📥 2.9K · 📋 3.2K - 18% open · ⏱️ 02.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/indico) (📥 260 / month):
	```
	pip install indico
	```
...
- [GitHub](https://github.com/Kotti/Kotti) (👨‍💻 64 · 🔀 110 · 📦 220 · 📋 210 - 19% open · ⏱️ 02.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/Kotti) (📥 210 / month):
	```
	pip install Kotti
	```
...
- [GitHub](https://github.com/feincms/feincms) (👨‍💻 140 · 🔀 220 · 📋 440 - 8% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/feincms) (📥 2.5K / month):
	```
	pip install feincms
	```
...
- [GitHub](https://github.com/bbangert/beaker) (👨‍💻 86 · 🔀 130 · 📦 3.1K · 📋 120 - 54% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/errbotio/errbot) (🔀 540 · 📦 240 · 📋 730 - 8% open · ⏱️ 03.12.2021):
...
- [GitHub](https://github.com/psf/black) (👨‍💻 290 · 🔀 1.5K · 📥 19K · 📦 100K · 📋 1.7K - 19% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/python/black
	```
- [PyPi](https://pypi.org/project/black) (📥 5.3M / month):
	```
	pip install black
	```
...
- [GitHub](https://github.com/PyCQA/isort) (👨‍💻 250 · 🔀 420 · 📦 210K · 📋 1K - 3% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/isort) (📥 9M / month):
	```
	pip install isort
	```
...
- [GitHub](https://github.com/google/yapf) (👨‍💻 130 · 🔀 800 · 📦 27K · 📋 720 - 46% open · ⏱️ 08.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/yapf) (📥 870K / month):
	```
	pip install yapf
	```
...
- [GitHub](https://github.com/wemake-services/wemake-python-styleguide) (👨‍💻 160 · 🔀 310 · 📦 840 · 📋 980 - 7% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/wemake-services/wemake-python-styleguide
	```
- [PyPi](https://pypi.org/project/wemake-python-styleguide) (📥 78K / month):
	```
...
<details><summary><b><a href="https://github.com/klen/pylama">pylama</a></b> (🥈23 ·  ⭐ 830) - A code audit tool for Python and JavaScript. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/klen/pylama) (👨‍💻 41 · 🔀 81 · 📦 3K · 📋 120 - 28% open · ⏱️ 03.12.2021):
...
- [GitHub](https://github.com/facebook/pyre-check) (👨‍💻 180 · 🔀 350 · 📋 270 - 24% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/facebook/pyre-check
	```
- [PyPi](https://pypi.org/project/pyre-check) (📥 15K / month):
	```
...
- [GitHub](https://github.com/Instagram/MonkeyType) (👨‍💻 37 · 🔀 130 · 📦 160 · 📋 140 - 22% open · ⏱️ 15.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/MonkeyType) (📥 18K / month):
	```
...
- [GitHub](https://github.com/python/typeshed) (👨‍💻 1K · 🔀 1.1K · 📋 1.5K - 10% open · ⏱️ 09.12.2021):
...
<details><summary><b><a href="https://github.com/PyCQA/prospector">prospector</a></b> (🥉19 ·  ⭐ 1.6K) - A tool to analyse Python code. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>

- [GitHub](https://github.com/PyCQA/prospector) (👨‍💻 78 · 🔀 140 · 📋 290 - 17% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/dropbox/pyannotate) (👨‍💻 17 · 🔀 54 · 📦 66 · 📋 59 - 44% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyannotate) (📥 1.5K / month):
	```
...
- [GitHub](https://github.com/google/pytype) (👨‍💻 70 · 🔀 210 · 📋 460 - 20% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/google/pytype
	```
- [PyPi](https://pypi.org/project/pytype) (📥 74K / month):
	```
	pip install pytype
	```
...
- [GitHub](https://github.com/willmcgugan/rich) (👨‍💻 140 · 🔀 990 · 📦 9.2K · 📋 600 - 3% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/willmcgugan/rich
	```
- [PyPi](https://pypi.org/project/rich) (📥 1.4M / month):
	```
	pip install rich
	```
...
- [GitHub](https://github.com/tqdm/tqdm) (👨‍💻 110 · 🔀 1K · 📥 8.1K · 📦 230K · 📋 800 - 33% open · ⏱️ 20.09.2021):
...
- [GitHub](https://github.com/google/python-fire) (👨‍💻 46 · 🔀 1.2K · 📦 10K · 📋 240 - 40% open · ⏱️ 17.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-fire) (📥 98 / month):
	```
...
- [GitHub](https://github.com/peterbrittain/asciimatics) (👨‍💻 37 · 🔀 210 · 📦 560 · 📋 260 - 6% open · ⏱️ 01.12.2021):

	```
	git clone https://github.com/peterbrittain/asciimatics
	```
- [PyPi](https://pypi.org/project/asciimatics) (📥 4.1K / month):
	```
	pip install asciimatics
	```
- [Conda](https://anaconda.org/conda-forge/asciimatics) (📥 82K · ⏱️ 15.11.2021):
	```
...
- [GitHub](https://github.com/rsalmei/alive-progress) (🔀 120 · 📦 500 · 📋 89 - 25% open · ⏱️ 06.11.2021):

	```
	git clone https://github.com/rsalmei/alive-progress
	```
- [PyPi](https://pypi.org/project/alive-progress) (📥 8.2K / month):
	```
...
- [GitHub](https://github.com/httpie/httpie) (👨‍💻 140 · 🔀 3.2K · 📦 9.6K · 📋 720 - 15% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/cookiecutter/cookiecutter) (👨‍💻 260 · 🔀 1.5K · 📋 680 - 25% open · ⏱️ 05.12.2021):

	```
	git clone https://github.com/audreyr/cookiecutter
	```
- [PyPi](https://pypi.org/project/cookiecutter) (📥 660K / month):
	```
...
<details><summary><b><a href="https://github.com/dbcli/pgcli">pgcli</a></b> (🥇28 ·  ⭐ 10K) - PostgreSQL CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/dbcli/pgcli) (👨‍💻 160 · 🔀 440 · 📦 360 · 📋 610 - 20% open · ⏱️ 18.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pgcli) (📥 19K / month):
	```
	pip install pgcli
	```
...
- [GitHub](https://github.com/dbcli/mycli) (👨‍💻 95 · 🔀 600 · 📦 220 · 📋 570 - 28% open · ⏱️ 09.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/mycli) (📥 14K / month):
	```
	pip install mycli
	```
...
<details><summary><b><a href="https://github.com/laixintao/iredis">iredis</a></b> (🥈21 ·  ⭐ 1.7K) - Redis CLI with autocompletion and syntax highlighting. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/laixintao/iredis) (👨‍💻 24 · 🔀 73 · 📥 7.1K · 📋 190 - 30% open · ⏱️ 22.11.2021):
...
- [GitHub](https://github.com/donnemartin/saws) (👨‍💻 8 · 🔀 260 · 📦 36 · 📋 91 - 31% open · ⏱️ 04.12.2021):
...
- [GitHub](https://github.com/dbcli/litecli) (👨‍💻 20 · 🔀 51 · 📦 130 · 📋 70 - 31% open · ⏱️ 11.09.2021):

	```
	git clone https://github.com/dbcli/litecli
	```
- [PyPi](https://pypi.org/project/litecli) (📥 3.9K / month):
	```
	pip install litecli
	```
...
<details><summary><b><a href="https://github.com/copier-org/copier">copier</a></b> (🥉18 ·  ⭐ 450) - A library and command-line utility for rendering projects templates. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/copier-org/copier) (👨‍💻 24 · 🔀 43 · 📦 29 · 📋 220 - 13% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/JaidedAI/EasyOCR) (👨‍💻 90 · 🔀 1.7K · 📥 840K · 📦 740 · 📋 460 - 29% open · ⏱️ 15.10.2021):
...
- [GitHub](https://github.com/ageitgey/face_recognition) (👨‍💻 47 · 🔀 12K · 📥 450 · 📋 1.2K - 53% open · ⏱️ 14.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/face_recognition) (📥 27K / month):
	```
	pip install face_recognition
	```
- [Conda](https://anaconda.org/conda-forge/face_recognition) (📥 3.8K · ⏱️ 30.04.2021):
	```
...
- [GitHub](https://github.com/madmaze/pytesseract) (👨‍💻 38 · 🔀 550 · 📋 280 - 3% open · ⏱️ 08.12.2021):
...
<details><summary><b><a href="https://github.com/kornia/kornia">Kornia</a></b> (🥉21 ·  ⭐ 5.5K) - Open Source Differentiable Computer Vision Library for PyTorch. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/kornia/kornia) (🔀 530 · 📥 160 · 📦 810 · 📋 490 - 21% open · ⏱️ 05.12.2021):
...
<details><summary><b><a href="https://github.com/soravux/scoop">scoop</a></b> (🥇17 ·  ⭐ 520 · 💀) - Scalable Concurrent Operations in Python. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>
...
- [GitHub](https://github.com/soravux/scoop) (👨‍💻 18 · 🔀 81 · 📦 210 · 📋 72 - 43% open · ⏱️ 07.12.2019):
	...
	```
- [PyPi](https://pypi.org/project/scoop) (📥 690 / month):
	```
	pip install scoop
	```
...
<details><summary><b><a href="https://github.com/henriquebastos/python-decouple">python-decouple</a></b> (🥇29 ·  ⭐ 2K) - Strict separation of settings from code. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/henriquebastos/python-decouple) (👨‍💻 27 · 🔀 140 · 📥 4 · 📦 53K · 📋 72 - 9% open · ⏱️ 30.09.2021):

	```
	git clone https://github.com/henriquebastos/python-decouple
	```
- [PyPi](https://pypi.org/project/python-decouple) (📥 340K / month):
	```
...
- [GitHub](https://github.com/DiffSK/configobj) (👨‍💻 22 · 🔀 63 · 📦 16K · 📋 140 - 48% open · ⏱️ 14.10.2020):
	...
	```
- [PyPi](https://pypi.org/project/configobj) (📥 840K / month):
	```
...
<details><summary><b><a href="https://github.com/facebookresearch/hydra">hydra</a></b> (🥉21 ·  ⭐ 5.2K) - Hydra is a framework for elegantly configuring complex applications. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/facebookresearch/hydra) (👨‍💻 83 · 🔀 380 · 📦 4 · 📋 940 - 10% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/facebookresearch/hydra
	```
- [PyPi](https://pypi.org/project/hydra) (📥 4.2K / month):
	```
	pip install hydra
	```
- [Conda](https://anaconda.org/conda-forge/hydra) (📥 8.9K · ⏱️ 18.01.2021):
	```
...
- [GitHub](https://github.com/paramiko/paramiko) (👨‍💻 160 · 🔀 1.7K · 📦 50K · 📋 1.3K - 53% open · ⏱️ 29.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/paramiko) (📥 9.8M / month):
	```
...
- [GitHub](https://github.com/pyca/pynacl) (👨‍💻 62 · 🔀 180 · 📋 260 - 16% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/pyca/pynacl
	```
- [PyPi](https://pypi.org/project/pynacl) (📥 11M / month):
	```
	pip install pynacl
	```
...
- [GitHub](https://github.com/awslabs/aws-data-wrangler) (👨‍💻 85 · 🔀 370 · 📥 110K · 📋 550 - 5% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/mining/mining) (👨‍💻 14 · 🔀 220 · 📦 7 · 📋 180 - 36% open · ⏱️ 02.12.2016):
	...
	```
- [PyPi](https://pypi.org/project/mining) (📥 42 / month):
	```
	pip install mining
	```
...
- [GitHub](https://github.com/Julian/jsonschema) (👨‍💻 94 · 🔀 480 · 📦 190K · 📋 620 - 9% open · ⏱️ 15.11.2021):
...
- [PyPi](https://pypi.org/project/jsonschema):
	...
	```
- [Conda](https://anaconda.org/conda-forge/jsonschema) (📥 8.8M · ⏱️ 07.12.2021):
	```
...
- [GitHub](https://github.com/keleshev/schema) (👨‍💻 62 · 🔀 180 · 📦 3.4K · 📋 130 - 49% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/schematics/schematics) (👨‍💻 120 · 🔀 280 · 📦 1K · 📋 320 - 27% open · ⏱️ 17.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/schematics) (📥 82K / month):
	```
...
- [GitHub](https://github.com/mwaskom/seaborn) (👨‍💻 160 · 🔀 1.5K · 📥 210 · 📦 130K · 📋 1.9K - 4% open · ⏱️ 27.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/seaborn) (📥 4M / month):
	```
	pip install seaborn
	```
...
- [GitHub](https://github.com/bokeh/bokeh) (👨‍💻 580 · 🔀 3.8K · 📦 42K · 📋 6.8K - 10% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/bokeh/bokeh
	```
- [PyPi](https://pypi.org/project/bokeh) (📥 1.1M / month):
	```
	pip install bokeh
	```
...
- [GitHub](https://github.com/altair-viz/altair) (👨‍💻 130 · 🔀 600 · 📦 19K · 📋 1.6K - 13% open · ⏱️ 19.11.2021):
...
<details><summary><b><a href="https://github.com/SciTools/cartopy">Cartopy</a></b> (🥉28 ·  ⭐ 970) - A cartographic python library with matplotlib support. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/SciTools/cartopy) (👨‍💻 110 · 🔀 300 · 📦 2.1K · 📋 1K - 26% open · ⏱️ 05.12.2021):
...
- [GitHub](https://github.com/has2k1/plotnine) (👨‍💻 89 · 🔀 150 · 📦 2.7K · 📋 450 - 16% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/has2k1/plotnine
	```
- [PyPi](https://pypi.org/project/plotnine) (📥 94K / month):
	```
...
- [GitHub](https://github.com/vispy/vispy) (👨‍💻 170 · 🔀 570 · 📦 640 · 📋 1.3K - 20% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/vispy/vispy
	```
- [PyPi](https://pypi.org/project/vispy) (📥 19K / month):
	```
	pip install vispy
	```
...
- [GitHub](https://github.com/mingrammer/diagrams) (👨‍💻 97 · 🔀 870 · 📋 310 - 55% open · ⏱️ 21.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/diagrams) (📥 27K / month):
	```
...
- [GitHub](https://github.com/msiemens/tinydb) (👨‍💻 70 · 🔀 410 · 📋 270 - 2% open · ⏱️ 04.12.2021):

	```
	git clone https://github.com/msiemens/tinydb
	```
- [PyPi](https://pypi.org/project/tinydb) (📥 170K / month):
	```
	pip install tinydb
	```
...
- [GitHub](https://github.com/zopefoundation/ZODB) (👨‍💻 120 · 🔀 70 · 📦 780 · 📋 140 - 37% open · ⏱️ 09.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/ZODB) (📥 32K / month):
	```
	pip install ZODB
	```
...
<details><summary><b><a href="https://github.com/patx/pickledb">pickleDB</a></b> (🥉19 ·  ⭐ 620 · 💀) - A simple and lightweight key-value store for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/patx/pickledb) (👨‍💻 12 · 🔀 110 · 📦 780 · 📋 54 - 27% open · ⏱️ 15.11.2019):
	...
	```
- [PyPi](https://pypi.org/project/pickledb) (📥 5.1K / month):
	```
...
<details><summary><b><a href="https://github.com/redis/redis-py">redis-py</a></b> (🥇34 ·  ⭐ 9.9K · 📈) - The Python client for Redis. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/redis/redis-py) (👨‍💻 280 · 🔀 2K · 📦 130K · 📋 970 - 5% open · ⏱️ 09.12.2021):
...
- [PyPi](https://pypi.org/project/redis-py):
	...
	```
- [Conda](https://anaconda.org/conda-forge/redis-py) (📥 510K · ⏱️ 22.11.2021):
	```
	conda install -c conda-forge redis-py
	```
</details>
<details><summary><b><a href="https://github.com/dpkp/kafka-python">kafka-python</a></b> (🥇33 ·  ⭐ 4.7K) - The Python client for Apache Kafka. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/dpkp/kafka-python) (👨‍💻 210 · 🔀 1.2K · 📥 1.7K · 📦 8.6K · 📋 1.4K - 14% open · ⏱️ 03.08.2021):

	```
	git clone https://github.com/dpkp/kafka-python
	```
- [PyPi](https://pypi.org/project/kafka-python) (📥 2.8M / month):
	```
...
- [GitHub](https://github.com/PyMySQL/PyMySQL) (👨‍💻 110 · 🔀 1.3K · 📦 100K · 📋 590 - 3% open · ⏱️ 02.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyMySQL) (📥 7.2M / month):
	```
	pip install PyMySQL
	```
- [Conda](https://anaconda.org/conda-forge/PyMySQL) (📥 420K · ⏱️ 09.01.2021):
	```
...
- [GitHub](https://github.com/mongodb/motor) (👨‍💻 35 · 🔀 160 · 📦 15K · ⏱️ 09.11.2021):
...
- [GitHub](https://github.com/mongodb/mongo-python-driver) (👨‍💻 190 · 🔀 910 · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/python-happybase/happybase) (👨‍💻 19 · 🔀 150 · 📦 570 · 📋 200 - 10% open · ⏱️ 08.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/happybase) (📥 61K / month):
	```
...
<details><summary><b><a href="https://github.com/mymarilyn/clickhouse-driver">clickhouse-driver</a></b> (🥉20 ·  ⭐ 730) - Python driver with native interface for ClickHouse. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/mymarilyn/clickhouse-driver) (👨‍💻 34 · 🔀 130 · 📦 420 · 📋 210 - 13% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/plasticityai/supersqlite) (👨‍💻 2 · 🔀 21 · 📦 9 · 📋 6 - 83% open · ⏱️ 27.08.2019):
	...
	```
- [PyPi](https://pypi.org/project/supersqlite) (📥 340 / month):
	```
...
- [GitHub](https://github.com/dateutil/dateutil) (👨‍💻 130 · 🔀 380 · 📥 35K · 📦 610K · 📋 590 - 37% open · ⏱️ 12.10.2021):
...
<details><summary><b><a href="https://github.com/zachwill/moment">moment</a></b> (🥉19 ·  ⭐ 690 · 💀) - A Python library for dealing with dates/times. Inspired by.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/zachwill/moment) (👨‍💻 4 · 🔀 38 · 📦 610 · 📋 35 - 11% open · ⏱️ 27.11.2020):
...
- [GitHub](https://github.com/shinux/PyTime) (👨‍💻 5 · 🔀 16 · 📦 19 · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/PyTime) (📥 5.6K / month):
	```
	pip install PyTime
	```
...
- [GitHub](https://github.com/jazzband/django-debug-toolbar) (👨‍💻 250 · 🔀 830 · 📥 170 · 📦 45K · 📋 770 - 10% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/jazzband/django-debug-toolbar
	```
- [PyPi](https://pypi.org/project/django-debug-toolbar) (📥 680K / month):
	```
...
- [GitHub](https://github.com/gotcha/ipdb) (👨‍💻 49 · 🔀 130 · 📦 29K · 📋 170 - 33% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/ipdb) (📥 930K / month):
	```
	pip install ipdb
	```
...
<details><summary><b><a href="https://github.com/eliben/pyelftools">pyelftools</a></b> (🥈25 ·  ⭐ 1.3K) - Parsing and analyzing ELF files and DWARF debugging.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/eliben/pyelftools) (👨‍💻 80 · 🔀 400 · 📦 2.8K · 📋 170 - 32% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyelftools) (📥 410K / month):
	```
...
<details><summary><b><a href="https://github.com/benfred/py-spy">py-spy</a></b> (🥈24 ·  ⭐ 7.7K) - A sampling profiler for Python programs. Written in Rust. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/py-spy) (👨‍💻 29 · 🔀 260 · 📥 7.2K · 📋 230 - 28% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/benfred/py-spy
	```
- [PyPi](https://pypi.org/project/py-spy) (📥 300K / month):
	```
	pip install py-spy
	```
- [Conda](https://anaconda.org/conda-forge/py-spy) (📥 170K · ⏱️ 13.11.2021):
	```
...
- [GitHub](https://github.com/inducer/pudb) (👨‍💻 80 · 🔀 180 · 📦 2.7K · 📋 270 - 45% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/inducer/pudb
	```
- [PyPi](https://pypi.org/project/pudb) (📥 84K / month):
	```
	pip install pudb
	```
...
- [GitHub](https://github.com/pdbpp/pdbpp) (👨‍💻 40 · 🔀 46 · 📦 2.4K · 📋 180 - 34% open · ⏱️ 27.11.2021):
...
- [GitHub](https://github.com/flask-debugtoolbar/flask-debugtoolbar) (👨‍💻 38 · 🔀 120 · 📦 16K · 📋 88 - 28% open · ⏱️ 14.08.2020):
...
- [GitHub](https://github.com/Kozea/wdb) (👨‍💻 22 · 🔀 100 · 📦 110 · 📋 110 - 26% open · ⏱️ 16.09.2019):
	...
	```
- [PyPi](https://pypi.org/project/wdb) (📥 3.4K / month):
	```
	pip install wdb
	```
...
<details><summary><b><a href="https://github.com/gruns/icecream">icecream</a></b> (🥉18 ·  ⭐ 5.6K) - Inspect variables, expressions, and program execution with a single,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/rkern/line_profiler) (👨‍💻 14 · 🔀 240 · 📋 140 - 36% open · ⏱️ 23.04.2019):
	...
	```
- [PyPi](https://pypi.org/project/line_profiler) (📥 66K / month):
	```
...
- [GitHub](https://github.com/ionelmc/python-hunter) (👨‍💻 9 · 🔀 35 · 📦 73 · 📋 85 - 41% open · ⏱️ 13.10.2021):
...
<details><summary><b><a href="https://github.com/fabianp/memory_profiler">memory_profiler</a></b> (🥉13 ·  ⭐ 67 · 💀) - Monitor Memory usage of Python code. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/Theano/Theano) (👨‍💻 380 · 🔀 2.4K · 📦 12K · 📋 2.7K - 21% open · ⏱️ 23.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/Theano) (📥 120K / month):
	```
	pip install Theano
	```
...
<details><summary><b><a href="https://github.com/pytorch/pytorch">pytorch</a></b> (🥈28 ·  ⭐ 53K) - Tensors and Dynamic neural networks in Python with strong GPU.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pytorch/pytorch) (👨‍💻 3K · 🔀 14K · 📥 520 · 📋 24K - 31% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/pytorch/pytorch
	```
- [PyPi](https://pypi.org/project/pytorch) (📥 26K / month):
	```
	pip install pytorch
	```
...
- [GitHub](https://github.com/keras-team/keras) (👨‍💻 1K · 🔀 18K · 📋 11K - 1% open · ⏱️ 08.12.2021):
...
<details><summary><b><a href="https://github.com/giampaolo/psutil">psutil</a></b> (🥇35 ·  ⭐ 7.9K) - A cross-platform process and system utilities module. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/giampaolo/psutil) (👨‍💻 170 · 🔀 1.1K · 📦 120K · 📋 1.5K - 11% open · ⏱️ 30.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/psutil) (📥 18M / month):
	```
	pip install psutil
	```
...
- [GitHub](https://github.com/Supervisor/supervisor) (👨‍💻 160 · 🔀 1.1K · 📦 6.6K · 📋 1K - 10% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/Supervisor/supervisor
	```
- [PyPi](https://pypi.org/project/supervisor) (📥 450K / month):
	```
...
- [GitHub](https://github.com/saltstack/salt) (👨‍💻 3.7K · 🔀 5K · 📥 16K · 📋 24K - 9% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/fabric/fabric) (👨‍💻 18 · 🔀 1.7K · 📋 1.7K - 23% open · ⏱️ 15.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/fabric) (📥 560K / month):
	```
	pip install fabric
	```
...
<details><summary><b><a href="https://github.com/nickstenning/honcho">honcho</a></b> (🥈25 ·  ⭐ 1.4K) - A Python clone of [Foreman](https://github.com/ddollar/foreman), for.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/nickstenning/honcho) (👨‍💻 44 · 🔀 130 · 📦 3.2K · 📋 99 - 11% open · ⏱️ 31.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/honcho) (📥 58K / month):
	```
	pip install honcho
	```
...
- [GitHub](https://github.com/Fizzadar/pyinfra) (👨‍💻 59 · 🔀 260 · 📦 37 · 📋 510 - 17% open · ⏱️ 14.11.2021):

	```
	git clone https://github.com/Fizzadar/pyinfra
	```
- [PyPi](https://pypi.org/project/pyinfra) (📥 4.4K / month):
	```
	pip install pyinfra
	```
...
<details><summary><b><a href="https://github.com/sebastien/cuisine">cuisine</a></b> (🥉19 ·  ⭐ 1.2K · 💀) - Chef-like functionality for Fabric. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/spotify/luigi">luigi</a></b> (🥇32 ·  ⭐ 15K) - A module that helps you build complex pipelines of batch jobs. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/dask/dask) (👨‍💻 490 · 🔀 1.4K · 📦 32K · 📋 4K - 16% open · ⏱️ 08.12.2021):
...
- [PyPi](https://pypi.org/project/dask) (📥 4.3M / month):
	...
	pip install dask
	```
- [Conda](https://anaconda.org/conda-forge/dask) (📥 4.7M · ⏱️ 20.11.2021):
	```
...
- [GitHub](https://github.com/Yelp/mrjob) (👨‍💻 140 · 🔀 570 · 📦 900 · 📋 1.3K - 15% open · ⏱️ 16.11.2020):
	...
	```
- [PyPi](https://pypi.org/project/mrjob) (📥 58K / month):
	```
	pip install mrjob
	```
...
<details><summary><b><a href="https://github.com/ray-project/ray">Ray</a></b> (🥉26 ·  ⭐ 18K · 📈) - A system for parallel and distributed Python that unifies the machine.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/ray-project/ray) (🔀 3K · 📦 3.5K · 📋 8.6K - 21% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/robinhood/faust) (👨‍💻 93 · 🔀 490 · 📦 890 · 📋 460 - 48% open · ⏱️ 09.10.2020):

	```
	git clone https://github.com/robinhood/faust
	```
- [PyPi](https://pypi.org/project/faust) (📥 190K / month):
	```
	pip install faust
	```
...
<details><summary><b><a href="https://github.com/pyinstaller/pyinstaller">PyInstaller</a></b> (🥇25 ·  ⭐ 8.7K) - Converts Python programs into stand-alone executables.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/pyinstaller/pyinstaller) (👨‍💻 420 · 🔀 1.6K · 📥 720K · 📋 4.3K - 7% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/pyinstaller/pyinstaller
	```
- [PyPi](https://pypi.org/project/pyinstaller) (📥 370K / month):
	```
...
- [GitHub](https://github.com/dashingsoft/pyarmor) (👨‍💻 17 · 🔀 150 · 📥 18 · 📦 320 · 📋 620 - 1% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/dashingsoft/pyarmor
	```
- [PyPi](https://pypi.org/project/pyarmor) (📥 33K / month):
	```
	pip install pyarmor
	```
...
- [GitHub](https://github.com/linkedin/shiv) (👨‍💻 34 · 🔀 71 · 📥 160 · 📋 93 - 25% open · ⏱️ 18.11.2021):

	```
	git clone https://github.com/linkedin/shiv
	```
- [PyPi](https://pypi.org/project/shiv) (📥 3.5K / month):
	```
	pip install shiv
	```
...
- [GitHub](https://github.com/sphinx-doc/sphinx) (🔀 1.5K · 📦 170K · 📋 5.7K - 15% open · ⏱️ 08.12.2021):
...
<details><summary><b><a href="https://github.com/mitmproxy/pdoc">pdoc</a></b> (🥉20 ·  ⭐ 1.1K) - Epydoc replacement to auto generate API documentation for Python.. <code><a href="http://bit.ly/3rvuUlR">Unlicense</a></code></summary>
...
- [GitHub](https://github.com/mitmproxy/pdoc) (👨‍💻 32 · 🔀 110 · 📦 460 · 📋 190 - 3% open · ⏱️ 26.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pdoc) (📥 52K / month):
	```
	pip install pdoc
	```
...
- [GitHub](https://github.com/s3tools/s3cmd) (👨‍💻 200 · 🔀 780 · 📥 3M · 📋 790 - 29% open · ⏱️ 08.11.2021):
...
<details><summary><b><a href="https://github.com/akfamily/akshare">akshare</a></b> (🥉22 ·  ⭐ 4.3K) - A financial data interface library, built for human beings!. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/akfamily/akshare) (👨‍💻 20 · 🔀 900 · 📦 120 · ⏱️ 09.12.2021):
...
<details><summary><b><a href="https://github.com/bloomreach/s4cmd">s4cmd</a></b> (🥉20 ·  ⭐ 1.2K) - Super S3 command line tool, good for higher performance. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
- [GitHub](https://github.com/bloomreach/s4cmd) (👨‍💻 34 · 🔀 190 · 📦 26 · 📋 130 - 59% open · ⏱️ 09.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/s4cmd) (📥 7.5K / month):
	```
	pip install s4cmd
	```
...
- [GitHub](https://github.com/MicroPyramid/forex-python) (👨‍💻 24 · 🔀 140 · 📦 1K · 📋 57 - 24% open · ⏱️ 03.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/forex-python) (📥 70K / month):
	```
...
- [GitHub](https://github.com/awesto/django-shop) (👨‍💻 96 · 🔀 900 · 📦 200 · 📋 370 - 22% open · ⏱️ 28.02.2021):
...
- [GitHub](https://github.com/spyder-ide/spyder) (👨‍💻 230 · 🔀 1.3K · 📥 1.1M · 📦 21K · 📋 14K - 8% open · ⏱️ 08.12.2021):
...
<details><summary><b><a href="https://github.com/DamnWidget/anaconda">anaconda</a></b> (🥈20 ·  ⭐ 2.1K) - Anaconda turns your Sublime Text 3 in a full featured Python.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/DamnWidget/anaconda) (👨‍💻 89 · 🔀 240 · 📋 770 - 21% open · ⏱️ 28.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/anaconda) (📥 5.7K / month):
	```
...
- [GitHub](https://github.com/jorgenschaefer/elpy) (👨‍💻 82 · 🔀 230 · 📦 200 · 📋 1.5K - 22% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/ycm-core/YouCompleteMe) (👨‍💻 170 · 🔀 2.6K · 📋 3.1K - 0% open · ⏱️ 04.12.2021):
...
- [GitHub](https://github.com/microsoft/PTVS) (👨‍💻 73 · 🔀 650 · 📥 32K · 📋 4.1K - 2% open · ⏱️ 08.12.2021):
...
- [PyPi](https://pypi.org/project/yagmail):
	...
	pip install yagmail
	```
- [Conda](https://anaconda.org/conda-forge/yagmail) (📥 8.9K · ⏱️ 30.08.2021):
	```
	conda install -c conda-forge yagmail
	```
</details>
<details><summary><b><a href="https://github.com/modoboa/modoboa">modoboa</a></b> (🥇24 ·  ⭐ 2K) - A mail hosting and management platform including a modern Web UI. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>
...
- [GitHub](https://github.com/modoboa/modoboa) (👨‍💻 100 · 🔀 270 · 📦 33 · 📋 1.6K - 4% open · ⏱️ 10.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/modoboa) (📥 940 / month):
	```
	pip install modoboa
	```
...
<details><summary><b><a href="https://github.com/mailgun/flanker">flanker</a></b> (🥈21 ·  ⭐ 1.5K · 💤) - An email address and Mime parsing library. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>
...
<details><summary><b><a href="https://github.com/martinrusev/imbox">imbox</a></b> (🥉20 ·  ⭐ 1K) - Python IMAP for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/martinrusev/imbox) (👨‍💻 49 · 🔀 160 · 📦 120 · 📋 110 - 42% open · ⏱️ 06.12.2021):
...
<details><summary><b><a href="https://github.com/moggers87/salmon">salmon</a></b> (🥉12 ·  ⭐ 520) - A Python Mail Server. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/moggers87/salmon) (👨‍💻 15 · 🔀 50 · 📥 49 · 📦 15 · 📋 90 - 18% open · ⏱️ 05.10.2021):
...
- [GitHub](https://github.com/pyenv/pyenv) (👨‍💻 350 · 🔀 2.2K · 📋 1.4K - 2% open · ⏱️ 08.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyenv) (📥 3.6K / month):
	```
	pip install pyenv
	```
...
<details><summary><b><a href="https://github.com/gorakhargosh/watchdog">watchdog</a></b> (🥇31 ·  ⭐ 5.1K) - API and shell utilities to monitor file system events. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/PyFilesystem/pyfilesystem2) (👨‍💻 42 · 🔀 150 · 📋 310 - 18% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/mikeorr/Unipath) (👨‍💻 6 · 🔀 37 · 📦 6.3K · 📋 17 - 41% open · ⏱️ 14.02.2015):
...
- [GitHub](https://github.com/Pylons/deform) (👨‍💻 100 · 🔀 150 · 📦 700 · 📋 180 - 24% open · ⏱️ 23.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/deform) (📥 4.8K / month):
	```
	pip install deform
	```
...
- [GitHub](https://github.com/WiserTogether/django-remote-forms) (👨‍💻 9 · 🔀 84 · 📦 18 · 📋 16 - 75% open · ⏱️ 12.07.2017):
	...
	```
- [PyPi](https://pypi.org/project/django-remote-forms) (📥 97 / month):
	```
...
- [GitHub](https://github.com/more-itertools/more-itertools) (👨‍💻 86 · 🔀 180 · 📥 2.4K · 📦 120K · 📋 190 - 3% open · ⏱️ 06.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/more-itertools) (📥 7.3M / month):
	```
	pip install more-itertools
	```
- [Conda](https://anaconda.org/conda-forge/more-itertools) (📥 8.4M · ⏱️ 24.11.2021):
	```
...
- [GitHub](https://github.com/Suor/funcy) (👨‍💻 28 · 🔀 120 · 📦 3.9K · 📋 66 - 6% open · ⏱️ 11.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/funcy) (📥 410K / month):
	```
	pip install funcy
	```
...
- [GitHub](https://github.com/dry-python/returns) (👨‍💻 37 · 🔀 85 · 📦 120 · 📋 370 - 14% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/dry-python/returns
	```
- [PyPi](https://pypi.org/project/returns) (📥 8.3K / month):
	```
	pip install returns
	```
- [Conda](https://anaconda.org/conda-forge/returns) (📥 560 · ⏱️ 05.10.2021):
	```
...
- [GitHub](https://github.com/kachayev/fn.py) (👨‍💻 18 · 🔀 180 · 📦 380 · 📋 45 - 44% open · ⏱️ 13.10.2014):
	...
	```
- [PyPi](https://pypi.org/project/fn.py) (📥 300 / month):
	```
	pip install fn.py
	```
...
<details><summary><b><a href="https://github.com/pyglet/pyglet">pyglet</a></b> (🥇30 ·  ⭐ 990) - A cross-platform windowing and multimedia library for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/pyglet/pyglet) (👨‍💻 120 · 🔀 200 · 📦 14K · 📋 290 - 19% open · ⏱️ 09.12.2021):
...
<details><summary><b><a href="https://github.com/PySimpleGUI/PySimpleGUI">PySimpleGUI</a></b> (🥈28 ·  ⭐ 9K) - Wrapper for tkinter, Qt, WxPython and Remi. <code><a href="http://bit.ly/37RvQcA">❗️LGPL-3.0</a></code></summary>

- [GitHub](https://github.com/PySimpleGUI/PySimpleGUI) (👨‍💻 18 · 🔀 1.3K · 📦 4K · 📋 2.5K - 25% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/PySimpleGUI/PySimpleGUI
	```
- [PyPi](https://pypi.org/project/PySimpleGUI) (📥 44K / month):
	```
...
- [GitHub](https://github.com/ChrisKnott/Eel) (👨‍💻 38 · 🔀 470 · 📦 2.8K · 📋 430 - 28% open · ⏱️ 19.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/Eel) (📥 23K / month):
	```
	pip install Eel
	```
...
<details><summary><b><a href="https://github.com/hoffstadt/DearPyGui">DearPyGui</a></b> (🥉23 ·  ⭐ 6.6K) - A Simple GPU accelerated Python GUI framework. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/hoffstadt/DearPyGui) (🔀 310 · 📦 220 · 📋 820 - 12% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/flexxui/flexx) (👨‍💻 37 · 🔀 240 · 📦 96 · 📋 430 - 19% open · ⏱️ 16.09.2021):
...
- [GitHub](https://github.com/r0x0r/pywebview) (🔀 350 · 📦 560 · 📋 580 - 5% open · ⏱️ 22.11.2021):
...
- [PyPi](https://pypi.org/project/enaml) (📥 2K / month):
	...
	pip install enaml
	```
- [Conda](https://anaconda.org/conda-forge/enaml) (📥 96K · ⏱️ 21.11.2021):
	```
...
- [GitHub](https://github.com/beeware/toga) (👨‍💻 200 · 🔀 500 · 📋 500 - 24% open · ⏱️ 05.12.2021):
...
- [GitHub](https://github.com/tartiflette/tartiflette-aiohttp) (🔀 9 · 📦 34 · 📋 17 - 17% open · ⏱️ 15.11.2021):
...
- [GitHub](https://github.com/jazzband/geojson) (👨‍💻 45 · 🔀 84 · 📦 8.2K · 📋 77 - 24% open · ⏱️ 11.11.2021):
...
- [GitHub](https://github.com/SmileyChris/django-countries) (👨‍💻 45 · 🔀 220 · 📋 230 - 4% open · ⏱️ 11.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-countries) (📥 210K / month):
	```
...
- [GitHub](https://github.com/martinblech/xmltodict) (👨‍💻 41 · 🔀 420 · 📦 33K · 📋 200 - 32% open · ⏱️ 26.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/xmltodict) (📥 7.7M / month):
	```
...
- [GitHub](https://github.com/pallets/markupsafe) (👨‍💻 37 · 🔀 100 · 📦 720K · ⏱️ 05.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/markupsafe) (📥 40M / month):
	```
...
- [GitHub](https://github.com/gawel/pyquery) (👨‍💻 50 · 🔀 170 · 📦 13K · 📋 170 - 25% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyquery) (📥 450K / month):
	```
	pip install pyquery
	```
...
- [GitHub](https://github.com/mozilla/bleach) (👨‍💻 73 · 🔀 210 · 📦 150K · 📋 330 - 14% open · ⏱️ 05.10.2021):
...
<details><summary><b><a href="https://github.com/stchris/untangle">untangle</a></b> (🥉21 ·  ⭐ 530 · 💀) - Converts XML documents to Python objects for easy access. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/stchris/untangle) (👨‍💻 13 · 🔀 78 · 📥 520 · 📦 750 · 📋 44 - 40% open · ⏱️ 07.08.2020):
	...
	```
- [PyPi](https://pypi.org/project/untangle) (📥 53K / month):
	```
...
<details><summary><b><a href="https://github.com/html5lib/html5lib-python">html5lib</a></b> (🥉15 ·  ⭐ 940) - A standards-compliant library for parsing and serializing HTML documents.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/psf/requests) (👨‍💻 700 · 🔀 8.2K · 📦 1.2M · 📋 3.5K - 4% open · ⏱️ 05.12.2021):

	```
	git clone https://github.com/psf/requests
	```
- [PyPi](https://pypi.org/project/requests) (📥 69M / month):
	```
...
<details><summary><b><a href="https://github.com/urllib3/urllib3">urllib3</a></b> (🥈32 ·  ⭐ 2.9K) - A HTTP library with thread-safe connection pooling, file post support,.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/urllib3/urllib3) (👨‍💻 290 · 🔀 840 · 📥 1K · 📦 710K · 📋 970 - 12% open · ⏱️ 07.12.2021):
...
<details><summary><b><a href="https://github.com/encode/httpx">httpx</a></b> (🥈31 ·  ⭐ 8K) - A next generation HTTP client for Python. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/httpx) (👨‍💻 140 · 🔀 510 · 📦 14K · 📋 630 - 7% open · ⏱️ 06.12.2021):
...
- [PyPi](https://pypi.org/project/httpx) (📥 2.5M / month):
	...
	pip install httpx
	```
- [Conda](https://anaconda.org/conda-forge/httpx) (📥 92K · ⏱️ 16.11.2021):
	```
	conda install -c conda-forge httpx
	```
</details>
<details><summary><b><a href="https://github.com/httplib2/httplib2">httplib2</a></b> (🥉29 ·  ⭐ 430) - Comprehensive HTTP client library. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/httplib2/httplib2) (👨‍💻 69 · 🔀 150 · 📦 91K · 📋 100 - 38% open · ⏱️ 19.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/httplib2) (📥 12M / month):
	```
...
- [GitHub](https://github.com/spyoungtech/grequests) (👨‍💻 28 · 🔀 300 · 📦 2.7K · 📋 100 - 8% open · ⏱️ 04.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/grequests) (📥 460K / month):
	```
...
<details><summary><b><a href="https://github.com/twisted/treq">treq</a></b> (🥉21 ·  ⭐ 540) - Python requests like API built on top of Twisted's HTTP client. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/twisted/treq) (👨‍💻 45 · 🔀 130 · 📥 110 · 📦 890 · 📋 140 - 37% open · ⏱️ 11.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/treq) (📥 38K / month):
	```
	pip install treq
	```
...
- [GitHub](https://github.com/secdev/scapy) (👨‍💻 360 · 🔀 1.5K · 📦 6.7K · 📋 1.3K - 3% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/secdev/scapy
	```
- [PyPi](https://pypi.org/project/scapy) (📥 860K / month):
	```
	pip install scapy
	```
...
- [GitHub](https://github.com/boppreh/keyboard) (👨‍💻 34 · 🔀 320 · 📦 5.1K · 📋 460 - 62% open · ⏱️ 09.11.2021):

	```
	git clone https://github.com/boppreh/keyboard
	```
- [PyPi](https://pypi.org/project/keyboard) (📥 96K / month):
	```
	pip install keyboard
	```
- [Conda](https://anaconda.org/conda-forge/keyboard) (📥 2.3K · ⏱️ 08.11.2021):
	```
...
- [GitHub](https://github.com/boppreh/mouse) (👨‍💻 8 · 🔀 83 · 📦 460 · 📋 90 - 71% open · ⏱️ 05.04.2021):

	```
	git clone https://github.com/boppreh/mouse
	```
- [PyPi](https://pypi.org/project/mouse) (📥 9.7K / month):
	```
	pip install mouse
	```
...
- [GitHub](https://github.com/emcconville/wand) (👨‍💻 97 · 🔀 190 · 📥 5.3K · 📦 7.8K · 📋 360 - 3% open · ⏱️ 20.11.2021):
...
- [PyPi](https://pypi.org/project/wand):
	...
	pip install wand
	```
- [Conda](https://anaconda.org/conda-forge/wand) (📥 7.8K · ⏱️ 30.11.2020):
	```
...
- [GitHub](https://github.com/WhyNotHugo/python-barcode) (👨‍💻 39 · 🔀 88 · 📥 180 · 📦 9.8K · 📋 80 - 37% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/WhyNotHugo/python-barcode
	```
- [PyPi](https://pypi.org/project/python-barcode) (📥 76K / month):
	```
...
<details><summary><b><a href="https://github.com/dylanaraps/pywal">pywal</a></b> (🥈24 ·  ⭐ 5.9K) - A tool that generates color schemes from images. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/dylanaraps/pywal) (👨‍💻 60 · 🔀 240 · 📥 630 · 📦 150 · 📋 480 - 21% open · ⏱️ 09.09.2021):

	```
	git clone https://github.com/dylanaraps/pywal
	```
- [PyPi](https://pypi.org/project/pywal) (📥 1.6K / month):
	```
	pip install pywal
	```
...
<details><summary><b><a href="https://github.com/python-pillow/Pillow">pillow</a></b> (🥈23 ·  ⭐ 9.2K · 📉) - Pillow is the friendly.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python-pillow/Pillow) (👨‍💻 380 · 🔀 1.6K · 📋 2.3K - 5% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/libvips/pyvips) (👨‍💻 12 · 🔀 31 · 📦 250 · 📋 250 - 36% open · ⏱️ 16.11.2021):
...
- [GitHub](https://github.com/daboth/pagan) (👨‍💻 9 · 🔀 33 · 📦 38 · 📋 7 - 57% open · ⏱️ 02.12.2021):
...
- [GitHub](https://github.com/ajknzhol/pygram) (🔀 12 · ⏱️ 22.02.2014):
	...
	```
- [PyPi](https://pypi.org/project/pygram) (📥 61 / month):
	```
	pip install pygram
	```
...
- [GitHub](https://github.com/micropython/micropython) (👨‍💻 460 · 🔀 3.7K · 📥 29K · 📋 3.9K - 27% open · ⏱️ 09.12.2021):
...
<details><summary><b><a href="https://github.com/python/cpython">CPython</a></b> (🥈20 ·  ⭐ 42K) - **Default, most widely used implementation of the Python.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/python/cpython) (👨‍💻 1.9K · 🔀 20K · ⏱️ 09.12.2021):

	```
	git clone https://github.com/python/cpython
	```
- [PyPi](https://pypi.org/project/cpython) (📥 5.3K / month):
	```
	pip install cpython
	```
...
- [GitHub](https://github.com/Maratyszcza/PeachPy) (👨‍💻 21 · 🔀 130 · 📦 9 · 📋 82 - 25% open · ⏱️ 13.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/PeachPy) (📥 19 / month):
	```
	pip install PeachPy
	```
...
- [GitHub](https://github.com/stackless-dev/stackless) (👨‍💻 1K · 🔀 52 · 📋 270 - 4% open · ⏱️ 11.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/stackless) (📥 17 / month):
	```
...
- [GitHub](https://github.com/prompt-toolkit/ptpython) (👨‍💻 50 · 🔀 250 · 📦 1.6K · 📋 330 - 55% open · ⏱️ 14.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/ptpython) (📥 130K / month):
	```
	pip install ptpython
	```
- [Conda](https://anaconda.org/conda-forge/ptpython) (📥 7.3K · ⏱️ 14.11.2021):
	```
...
- [GitHub](https://github.com/ovalhub/pyicu) (👨‍💻 18 · 🔀 58 · 📦 2K · ⏱️ 08.04.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyicu) (📥 94K / month):
	```
	pip install pyicu
	```
...
<details><summary><b><a href="https://github.com/PrefectHQ/prefect">Prefect</a></b> (🥇31 ·  ⭐ 7.9K) - A modern workflow orchestration framework that makes it easy to.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/PrefectHQ/prefect) (👨‍💻 280 · 🔀 720 · 📦 520 · 📋 2K - 18% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/PrefectHQ/prefect
	```
- [PyPi](https://pypi.org/project/prefect) (📥 100K / month):
	```
	pip install prefect
	```
...
- [GitHub](https://github.com/sartography/SpiffWorkflow) (👨‍💻 42 · 🔀 240 · 📦 28 · 📋 73 - 4% open · ⏱️ 01.12.2021):
...
- [GitHub](https://github.com/fengsp/plan) (👨‍💻 7 · 🔀 89 · 📦 65 · 📋 9 - 11% open · ⏱️ 14.05.2020):
	...
	```
- [PyPi](https://pypi.org/project/plan) (📥 260 / month):
	```
	pip install plan
	```
...
- [GitHub](https://github.com/dmlc/xgboost) (👨‍💻 540 · 🔀 7.7K · 📥 3.5K · 📦 25K · 📋 4.2K - 6% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/dmlc/xgboost
	```
- [PyPi](https://pypi.org/project/xgboost) (📥 4.8M / month):
	```
	pip install xgboost
	```
...
- [GitHub](https://github.com/openai/gym) (👨‍💻 330 · 🔀 7K · 📦 25K · 📋 1.4K - 7% open · ⏱️ 09.12.2021):
...
- [PyPi](https://pypi.org/project/gym) (📥 450K / month):
	...
	pip install gym
	```
- [Conda](https://anaconda.org/conda-forge/gym) (📥 82K · ⏱️ 07.11.2021):
	```
...
- [GitHub](https://github.com/numenta/nupic) (👨‍💻 120 · 🔀 1.5K · 📦 110 · 📋 1.8K - 25% open · ⏱️ 23.10.2019):
	...
	```
- [PyPi](https://pypi.org/project/nupic) (📥 1.7K / month):
	```
	pip install nupic
	```
...
- [GitHub](https://github.com/h2oai/h2o-3) (👨‍💻 220 · 🔀 1.8K · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/mindsdb/mindsdb) (👨‍💻 89 · 🔀 550 · 📋 770 - 9% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/mindsdb/mindsdb
	```
- [PyPi](https://pypi.org/project/mindsdb) (📥 4.5K / month):
	```
	pip install mindsdb
	```
...
- [GitHub](https://github.com/mhammond/pywin32) (👨‍💻 70 · 🔀 640 · 📥 500K · 📦 62K · 📋 1.6K - 27% open · ⏱️ 23.11.2021):

	```
	git clone https://github.com/mhammond/pywin32
	```
- [PyPi](https://pypi.org/project/pywin32) (📥 1.6M / month):
	```
	pip install pywin32
	```
...
- [GitHub](https://github.com/pythonnet/pythonnet) (👨‍💻 95 · 🔀 470 · 📦 54 · 📋 1K - 16% open · ⏱️ 29.11.2021):

	```
	git clone https://github.com/pythonnet/pythonnet
	```
- [PyPi](https://pypi.org/project/pythonnet) (📥 70K / month):
	```
...
<details><summary><b><a href="https://github.com/pallets/itsdangerous">itsdangerous</a></b> (🥇32 ·  ⭐ 2.3K) - Various helpers to pass trusted data to untrusted environments. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/pallets/itsdangerous) (👨‍💻 38 · 🔀 180 · 📦 530K · ⏱️ 05.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/itsdangerous) (📥 21M / month):
	```
...
- [GitHub](https://github.com/jek/blinker) (👨‍💻 11 · 🔀 160 · 📦 88K · 📋 34 - 52% open · ⏱️ 29.01.2021):

	```
	git clone https://github.com/jek/blinker
	```
- [PyPi](https://pypi.org/project/blinker) (📥 4.8M / month):
	```
	pip install blinker
	```
...
- [GitHub](https://github.com/mahmoud/boltons) (👨‍💻 72 · 🔀 310 · 📥 23 · 📦 1.9K · 📋 130 - 28% open · ⏱️ 11.10.2021):

	```
	git clone https://github.com/mahmoud/boltons
	```
- [PyPi](https://pypi.org/project/boltons) (📥 700K / month):
	```
	pip install boltons
	```
...
<details><summary><b><a href="https://github.com/mitsuhiko/pluginbase">pluginbase</a></b> (🥉19 ·  ⭐ 990 · 💤) - A simple but flexible plugin system for Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/RaRe-Technologies/gensim) (👨‍💻 420 · 🔀 3.9K · 📥 3.5K · 📦 29K · 📋 1.7K - 20% open · ⏱️ 05.12.2021):

	```
	git clone https://github.com/RaRe-Technologies/gensim
	```
- [PyPi](https://pypi.org/project/gensim) (📥 5.4M / month):
	```
	pip install gensim
	```
...
<details><summary><b><a href="https://github.com/fxsjy/jieba">jieba</a></b> (🥇30 ·  ⭐ 27K · 💀) - The most popular Chinese text segmentation library. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/fxsjy/jieba) (👨‍💻 48 · 🔀 6.2K · 📦 12K · 📋 790 - 73% open · ⏱️ 15.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/jieba) (📥 260K / month):
	```
	pip install jieba
	```
...
- [GitHub](https://github.com/clips/pattern) (👨‍💻 30 · 🔀 1.5K · 📦 1.2K · 📋 200 - 62% open · ⏱️ 25.04.2020):
	...
	```
- [PyPi](https://pypi.org/project/pattern) (📥 56K / month):
	```
	pip install pattern
	```
...
- [GitHub](https://github.com/lancopku/pkuseg-python) (👨‍💻 6 · 🔀 890 · 📥 72K · 📦 160 · 📋 150 - 72% open · ⏱️ 21.06.2020):
...
<details><summary><b><a href="https://github.com/aboSamoor/polyglot">polyglot</a></b> (🥈22 ·  ⭐ 1.9K · 💀) - Natural language pipeline supporting hundreds of languages. <code><a href="http://bit.ly/2M0xdwT">❗️GPL-3.0</a></code></summary>
...
<details><summary><b><a href="https://github.com/stanfordnlp/stanza">Stanza</a></b> (🥉21 ·  ⭐ 5.9K) - The Stanford NLP Group's official Python library, supporting 60+.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/stanfordnlp/stanza) (👨‍💻 41 · 🔀 740 · 📦 770 · 📋 600 - 10% open · ⏱️ 18.11.2021):
...
- [GitHub](https://github.com/facebookresearch/pytext) (👨‍💻 220 · 🔀 790 · 📥 280 · 📦 100 · 📋 130 - 44% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/napalm-automation/napalm) (👨‍💻 170 · 🔀 460 · 📦 740 · 📋 530 - 22% open · ⏱️ 29.11.2021):
...
- [GitHub](https://github.com/coleifer/peewee) (👨‍💻 150 · 🔀 1.3K · 📦 15K · 📋 2.1K - 0% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/coleifer/peewee
	```
- [PyPi](https://pypi.org/project/peewee) (📥 290K / month):
	```
	pip install peewee
	```
...
- [GitHub](https://github.com/MongoEngine/mongoengine) (👨‍💻 370 · 🔀 1.1K · 📦 15K · 📋 1.6K - 21% open · ⏱️ 30.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/mongoengine) (📥 370K / month):
	```
...
- [GitHub](https://github.com/pynamodb/PynamoDB) (👨‍💻 92 · 🔀 370 · 📦 860 · 📋 460 - 39% open · ⏱️ 01.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/PynamoDB) (📥 500K / month):
	```
...
<details><summary><b><a href="https://github.com/pudo/dataset">dataset</a></b> (🥈26 ·  ⭐ 4.1K) - Store Python dicts in a database - works with SQLite, MySQL, and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
<details><summary><b><a href="https://github.com/sdispater/orator">orator</a></b> (🥉19 ·  ⭐ 1.3K · 💀) - The Orator ORM provides a simple yet beautiful ActiveRecord.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/sdispater/orator) (👨‍💻 31 · 🔀 150 · 📋 310 - 41% open · ⏱️ 06.01.2020):
	...
	```
- [PyPi](https://pypi.org/project/orator) (📥 6.7K / month):
	```
	pip install orator
	```
...
<details><summary><b><a href="https://github.com/encode/orm">orm</a></b> (🥉16 ·  ⭐ 1.5K) - An async ORM. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>

- [GitHub](https://github.com/encode/orm) (👨‍💻 15 · 🔀 82 · 📋 67 - 16% open · ⏱️ 29.11.2021):
...
- [GitHub](https://github.com/stephenmcd/hot-redis) (👨‍💻 6 · 🔀 28 · 📦 24 · 📋 10 - 50% open · ⏱️ 16.10.2018):
	...
	```
- [PyPi](https://pypi.org/project/hot-redis) (📥 260 / month):
	```
...
- [GitHub](https://github.com/kiddouk/redisco) (👨‍💻 20 · 🔀 84 · 📋 51 - 70% open · ⏱️ 06.06.2016):
	...
	```
- [PyPi](https://pypi.org/project/redisco) (📥 220 / month):
	```
	pip install redisco
	```
...
<details><summary><b><a href="https://github.com/python-poetry/poetry">poetry</a></b> (🥇29 ·  ⭐ 17K) - Python dependency management and packaging made easy. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/python-poetry/poetry) (👨‍💻 320 · 🔀 1.4K · 📥 9.6M · 📋 3.3K - 33% open · ⏱️ 07.12.2021):
...
<details><summary><b><a href="https://github.com/jazzband/pip-tools">pip-tools</a></b> (🥉23 ·  ⭐ 5.4K) - A set of tools to keep your pinned Python dependencies fresh. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
- [GitHub](https://github.com/conda/conda) (🔀 1K · 📋 8.2K - 21% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/devpi/devpi) (👨‍💻 81 · 🔀 92 · 📦 160 · 📋 670 - 14% open · ⏱️ 07.12.2021):
	...
	```
- [PyPi](https://pypi.org/project/devpi) (📥 1.4K / month):
	```
	pip install devpi
	```
...
- [GitHub](https://github.com/pypa/warehouse) (👨‍💻 310 · 🔀 720 · 📋 2.4K - 13% open · ⏱️ 05.12.2021):
...
<details><summary><b><a href="https://github.com/mvantellingen/localshop">localshop</a></b> (🥉14 ·  ⭐ 380 · 💀) - Local PyPI server (custom packages and auto-mirroring of pypi). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/sqlmapproject/sqlmap) (👨‍💻 110 · 🔀 4.4K · 📋 4.5K - 1% open · ⏱️ 03.12.2021):
...
- [GitHub](https://github.com/lyst/lightfm) (👨‍💻 44 · 🔀 610 · 📦 600 · 📋 430 - 20% open · ⏱️ 07.02.2021):
...
<details><summary><b><a href="https://github.com/benfred/implicit">implicit</a></b> (🥇24 ·  ⭐ 2.6K) - A fast Python implementation of collaborative filtering for implicit.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/benfred/implicit) (👨‍💻 30 · 🔀 500 · 📦 520 · 📋 370 - 22% open · ⏱️ 02.10.2021):
...
- [GitHub](https://github.com/python-rope/rope) (👨‍💻 68 · 🔀 130 · 📦 33K · 📋 230 - 30% open · ⏱️ 05.12.2021):
...
- [GitHub](https://github.com/sanic-org/sanic) (👨‍💻 310 · 🔀 1.4K · 📦 6.2K · 📋 1.1K - 3% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/huge-success/sanic
	```
- [PyPi](https://pypi.org/project/sanic) (📥 740K / month):
	```
	pip install sanic
	```
...
<details><summary><b><a href="https://github.com/falconry/falcon">falcon</a></b> (🥇32 ·  ⭐ 8.6K) - A high-performance framework for building cloud APIs and web app.. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/falconry/falcon) (👨‍💻 180 · 🔀 840 · 📥 1.5K · 📦 6K · 📋 930 - 19% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/falconry/falcon
	```
- [PyPi](https://pypi.org/project/falcon) (📥 380K / month):
	```
	pip install falcon
	```
...
- [GitHub](https://github.com/flask-restful/flask-restful) (👨‍💻 160 · 🔀 940 · 📦 68K · 📋 530 - 15% open · ⏱️ 07.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/flask-restful) (📥 640K / month):
	```
...
- [GitHub](https://github.com/tiangolo/fastapi) (👨‍💻 280 · 🔀 2.8K · 📋 2.5K - 32% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/tiangolo/fastapi
	```
- [PyPi](https://pypi.org/project/fastapi) (📥 2.2M / month):
	```
	pip install fastapi
	```
- [Conda](https://anaconda.org/conda-forge/fastapi) (📥 490K · ⏱️ 07.10.2021):
	```
	conda install -c conda-forge fastapi
	```
</details>
<details><summary><b><a href="https://github.com/hugapi/hug">hug</a></b> (🥉26 ·  ⭐ 6.6K · 💀) - A Python 3 framework for cleanly exposing APIs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/flask-api/flask-api) (👨‍💻 32 · 🔀 160 · 📦 4.7K · 📋 63 - 19% open · ⏱️ 01.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/flask-api) (📥 65K / month):
	```
...
- [GitHub](https://github.com/encode/apistar) (👨‍💻 89 · 🔀 420 · 📦 660 · 📋 310 - 6% open · ⏱️ 31.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/apistar) (📥 9K / month):
	```
	pip install apistar
	```
...
- [GitHub](https://github.com/jeffknupp/sandman2) (👨‍💻 23 · 🔀 180 · 📦 17 · 📋 79 - 34% open · ⏱️ 21.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/sandman2) (📥 200 / month):
	```
...
- [GitHub](https://github.com/AtsushiSakai/PythonRobotics) (👨‍💻 93 · 🔀 4.3K · 📋 260 - 3% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/0rpc/zerorpc-python) (👨‍💻 36 · 🔀 360 · 📋 160 - 30% open · ⏱️ 27.05.2020):
...
- [GitHub](https://github.com/sympy/sympy) (👨‍💻 1.1K · 🔀 3.4K · 📥 440K · 📦 38K · 📋 11K - 32% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/sympy/sympy
	```
- [PyPi](https://pypi.org/project/sympy) (📥 980K / month):
	```
	pip install sympy
	```
...
- [GitHub](https://github.com/statsmodels/statsmodels) (👨‍💻 350 · 🔀 2.2K · 📥 26 · 📦 54K · 📋 4.5K - 46% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/pymc-devs/pymc) (👨‍💻 350 · 🔀 1.4K · 📥 1.1K · 📦 570 · 📋 2.5K - 8% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/pymc-devs/pymc3
	```
- [PyPi](https://pypi.org/project/pymc3) (📥 150K / month):
	```
	pip install pymc3
	```
...
- [GitHub](https://github.com/benedekrozemberczki/karateclub) (👨‍💻 13 · 🔀 170 · 📦 64 · 📋 65 - 1% open · ⏱️ 21.11.2021):

	```
	git clone https://github.com/benedekrozemberczki/karateclub
	```
- [PyPi](https://pypi.org/project/karateclub) (📥 2.2K / month):
	```
	pip install karateclub
	```
- [Conda](https://anaconda.org/conda-forge/karateclub) (📥 7.3K · ⏱️ 05.08.2021):
	```
...
- [GitHub](https://github.com/bcbio/bcbio-nextgen) (👨‍💻 93 · 🔀 330 · 📋 2.9K - 2% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/obspy/obspy) (🔀 450 · 📥 6.7K · 📋 1.5K - 19% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/django-haystack/django-haystack) (👨‍💻 200 · 🔀 1.2K · 📦 7.5K · 📋 1.2K - 36% open · ⏱️ 02.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-haystack) (📥 56K / month):
	```
...
- [GitHub](https://github.com/django-haystack/pysolr) (👨‍💻 65 · 🔀 300 · 📦 2.5K · 📋 140 - 13% open · ⏱️ 02.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/pysolr) (📥 64K / month):
	```
	pip install pysolr
	```
...
- [GitHub](https://github.com/marshmallow-code/marshmallow) (👨‍💻 200 · 🔀 560 · 📦 37K · 📋 1.1K - 9% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/marshmallow-code/marshmallow
	```
- [PyPi](https://pypi.org/project/marshmallow) (📥 5.5M / month):
	```
...
<details><summary><b><a href="https://github.com/python-rapidjson/python-rapidjson">python-rapidjson</a></b> (🥈22 ·  ⭐ 430) - A Python wrapper around.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/python-rapidjson/python-rapidjson) (👨‍💻 18 · 🔀 35 · 📦 1.9K · 📋 98 - 10% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-rapidjson) (📥 310K / month):
	```
...
<details><summary><b><a href="https://github.com/TkTech/pysimdjson">pysimdjson</a></b> (🥉20 ·  ⭐ 500) - A Python bindings for.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/TkTech/pysimdjson) (👨‍💻 12 · 🔀 39 · 📦 170 · 📋 70 - 11% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/TkTech/pysimdjson
	```
- [PyPi](https://pypi.org/project/pysimdjson) (📥 49K / month):
	```
...
- [GitHub](https://github.com/Miserlou/Zappa) (👨‍💻 260 · 🔀 1.2K · 📥 260 · 📋 1.3K - 47% open · ⏱️ 20.02.2021):
	...
	```
- [PyPi](https://pypi.org/project/Zappa) (📥 57K / month):
	```
	pip install Zappa
	```
...
<details><summary><b><a href="https://github.com/nficano/python-lambda">python-lambda</a></b> (🥉21 ·  ⭐ 1.3K) - A toolkit for developing and deploying Python code in AWS Lambda. <code><a href="http://bit.ly/3hkKRql">ISC</a></code></summary>

- [GitHub](https://github.com/nficano/python-lambda) (👨‍💻 47 · 🔀 210 · 📦 140 · 📋 88 - 39% open · ⏱️ 14.07.2021):

	```
	git clone https://github.com/nficano/python-lambda
	```
- [PyPi](https://pypi.org/project/python-lambda) (📥 3.2K / month):
	```
...
- [GitHub](https://github.com/xonsh/xonsh) (🔀 500 · 📥 5.7K · 📦 270 · 📋 2.2K - 13% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/jazzband/tablib) (👨‍💻 120 · 🔀 550 · 📦 12K · 📋 240 - 11% open · ⏱️ 04.11.2021):

	```
	git clone https://github.com/jazzband/tablib
	```
- [PyPi](https://pypi.org/project/tablib) (📥 570K / month):
	```
	pip install tablib
	```
...
- [GitHub](https://github.com/jmcnamara/XlsxWriter) (👨‍💻 46 · 🔀 540 · 📦 42K · 📋 740 - 1% open · ⏱️ 26.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/XlsxWriter) (📥 4.3M / month):
	```
...
- [GitHub](https://github.com/mstamy2/PyPDF2) (👨‍💻 83 · 🔀 880 · 📦 25K · 📋 420 - 74% open · ⏱️ 25.06.2018):
	...
	```
- [PyPi](https://pypi.org/project/PyPDF2) (📥 1.4M / month):
	```
	pip install PyPDF2
	```
...
- [GitHub](https://github.com/wireservice/csvkit) (👨‍💻 100 · 🔀 540 · 📦 960 · 📋 830 - 7% open · ⏱️ 08.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/csvkit) (📥 27K / month):
	```
	pip install csvkit
	```
...
<details><summary><b><a href="https://github.com/xlwings/xlwings">xlwings</a></b> (🥈27 ·  ⭐ 2.2K) - A BSD-licensed library that makes it easy to call Python from.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/xlwings/xlwings) (👨‍💻 56 · 🔀 380 · 📥 27K · 📦 20K · 📋 1.4K - 22% open · ⏱️ 03.12.2021):

	```
	git clone https://github.com/ZoomerAnalytics/xlwings
	```
- [PyPi](https://pypi.org/project/xlwings) (📥 320K / month):
	```
	pip install xlwings
	```
- [Conda](https://anaconda.org/conda-forge/xlwings) (📥 380K · ⏱️ 03.12.2021):
	```
...
- [GitHub](https://github.com/pyexcel/pyexcel) (👨‍💻 21 · 🔀 150 · 📥 160 · 📦 2.3K · 📋 190 - 5% open · ⏱️ 20.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyexcel) (📥 76K / month):
	```
	pip install pyexcel
	```
...
- [GitHub](https://github.com/lepture/mistune) (👨‍💻 32 · 🔀 200 · 📋 210 - 8% open · ⏱️ 05.12.2021):
...
- [PyPi](https://pypi.org/project/mistune):
	...
	pip install mistune
	```
- [Conda](https://anaconda.org/conda-forge/mistune) (📥 5.6M · ⏱️ 08.12.2021):
	```
...
- [GitHub](https://github.com/unoconv/unoconv) (👨‍💻 52 · 🔀 360 · 📦 84 · 📋 470 - 15% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/unoconv) (📥 4.5K / month):
	```
	pip install unoconv
	```
...
<details><summary><b><a href="https://github.com/scanny/python-pptx">python-pptx</a></b> (🥉22 ·  ⭐ 1.4K) - Python library for creating and updating PowerPoint (.pptx) files. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/scanny/python-pptx) (👨‍💻 12 · 🔀 330 · 📋 670 - 41% open · ⏱️ 20.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/python-pptx) (📥 360K / month):
	```
...
- [PyPi](https://pypi.org/project/python-docx):
	...
	```
- [Conda](https://anaconda.org/conda-forge/python-docx) (📥 94K · ⏱️ 27.05.2021):
	```
...
- [GitHub](https://github.com/mitsuhiko/unp) (👨‍💻 2 · 🔀 59 · 📦 9 · 📋 7 - 85% open · ⏱️ 26.08.2014):
	...
	```
- [PyPi](https://pypi.org/project/unp) (📥 27 / month):
	```
	pip install unp
	```
...
- [GitHub](https://github.com/getpelican/pelican) (👨‍💻 420 · 🔀 1.7K · 📥 450 · 📦 5.4K · 📋 1.5K - 2% open · ⏱️ 27.11.2021):

	```
	git clone https://github.com/getpelican/pelican
	```
- [PyPi](https://pypi.org/project/pelican) (📥 9.8K / month):
	```
	pip install pelican
	```
...
- [GitHub](https://github.com/lektor/lektor) (👨‍💻 89 · 🔀 270 · 📥 6.9K · 📋 550 - 38% open · ⏱️ 16.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/lektor) (📥 1.3K / month):
	```
	pip install lektor
	```
...
- [GitHub](https://github.com/jazzband/django-taggit) (👨‍💻 140 · 🔀 540 · 📋 370 - 18% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/rq/rq) (👨‍💻 250 · 🔀 1.2K · 📦 9.2K · 📋 920 - 16% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/rq/rq
	```
- [PyPi](https://pypi.org/project/rq) (📥 260K / month):
	```
	pip install rq
	```
...
- [GitHub](https://github.com/coleifer/huey) (👨‍💻 66 · 🔀 320 · 📦 830 · ⏱️ 03.12.2021):

	```
	git clone https://github.com/coleifer/huey
	```
- [PyPi](https://pypi.org/project/huey) (📥 24K / month):
	```
	pip install huey
	```
...
- [GitHub](https://github.com/Bogdanp/dramatiq) (👨‍💻 74 · 🔀 200 · 📥 32 · 📦 350 · 📋 270 - 8% open · ⏱️ 27.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/dramatiq) (📥 33K / month):
	```
...
<details><summary><b><a href="https://github.com/pricingassistant/mrq">mrq</a></b> (🥉18 ·  ⭐ 860 · 💤) - A distributed worker task queue in Python using Redis & gevent. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/joke2k/faker) (👨‍💻 430 · 🔀 1.5K · 📦 44K · 📋 530 - 23% open · ⏱️ 07.12.2021):
...
- [PyPi](https://pypi.org/project/faker):
	...
	pip install faker
	```
- [Conda](https://anaconda.org/conda-forge/faker) (📥 520K · ⏱️ 07.12.2021):
	```
	conda install -c conda-forge faker
	```
</details>
<details><summary><b><a href="https://github.com/locustio/locust">locust</a></b> (🥇33 ·  ⭐ 18K) - Scalable user load testing tool written in Python. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/locustio/locust) (👨‍💻 220 · 🔀 2.2K · 📦 2K · 📋 1.2K - 1% open · ⏱️ 08.12.2021):
...
- [GitHub](https://github.com/robotframework/robotframework) (👨‍💻 150 · 🔀 1.8K · 📥 510 · 📦 4.7K · 📋 3.7K - 4% open · ⏱️ 07.12.2021):
...
<details><summary><b><a href="https://github.com/HypothesisWorks/hypothesis">hypothesis</a></b> (🥇30 ·  ⭐ 5.6K) - Hypothesis is an advanced Quickcheck style property based.. <code>❗Unlicensed</code></summary>

- [GitHub](https://github.com/HypothesisWorks/hypothesis) (👨‍💻 260 · 🔀 450 · 📦 11K · 📋 1.2K - 4% open · ⏱️ 09.12.2021):
...
- [GitHub](https://github.com/getsentry/responses) (👨‍💻 100 · 🔀 270 · 📥 21 · 📦 11K · 📋 200 - 16% open · ⏱️ 06.12.2021):
...
- [PyPi](https://pypi.org/project/responses):
	...
	```
- [Conda](https://anaconda.org/conda-forge/responses) (📥 910K · ⏱️ 16.11.2021):
	```
...
- [GitHub](https://github.com/asweigart/pyautogui) (👨‍💻 51 · 🔀 780 · 📦 12K · 📋 520 - 62% open · ⏱️ 14.09.2021):

	```
	git clone https://github.com/asweigart/pyautogui
	```
- [PyPi](https://pypi.org/project/pyautogui) (📥 270K / month):
	```
...
- [GitHub](https://github.com/cobrateam/splinter) (👨‍💻 170 · 🔀 490 · 📦 5.1K · 📋 490 - 10% open · ⏱️ 08.12.2021):
...
<details><summary><b><a href="https://github.com/lk-geimfari/mimesis">mimesis</a></b> (🥉24 ·  ⭐ 3.4K) - is a Python library that help you generate fake data. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/lk-geimfari/mimesis) (👨‍💻 110 · 🔀 270 · 📥 180 · 📋 300 - 0% open · ⏱️ 09.12.2021):

	```
	git clone https://github.com/lk-geimfari/mimesis
	```
- [PyPi](https://pypi.org/project/mimesis) (📥 48K / month):
	```
	pip install mimesis
	```
...
- [GitHub](https://github.com/nose-devs/nose2) (👨‍💻 71 · 🔀 120 · 📦 4.3K · 📋 250 - 20% open · ⏱️ 12.10.2021):
	...
	```
- [PyPi](https://pypi.org/project/nose2) (📥 210K / month):
	```
	pip install nose2
	```
...
- [GitHub](https://github.com/schemathesis/schemathesis) (👨‍💻 35 · 🔀 74 · 📋 600 - 16% open · ⏱️ 04.12.2021):

	```
	git clone https://github.com/kiwicom/schemathesis
	```
- [PyPi](https://pypi.org/project/schemathesis) (📥 24K / month):
	```
...
- [GitHub](https://github.com/mindflayer/python-mocket) (👨‍💻 22 · 🔀 36 · 📦 60 · 📋 54 - 3% open · ⏱️ 03.12.2021):
...
<details><summary><b><a href="https://github.com/berinhard/model_mommy">model_mommy</a></b> (🥉17 ·  ⭐ 930 · 💀) - Creating random fixtures for testing in Django. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/klen/mixer">mixer</a></b> (🥉12 ·  ⭐ 790) - Another fixtures replacement. Supports Django, Flask, SQLAlchemy,.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pyparsing/pyparsing) (👨‍💻 39 · 🔀 190 · 📥 6.2K · 📦 410K · 📋 210 - 7% open · ⏱️ 06.12.2021):

	```
	git clone https://github.com/pyparsing/pyparsing
	```
- [PyPi](https://pypi.org/project/pyparsing) (📥 42M / month):
	```
...
<details><summary><b><a href="https://github.com/seatgeek/fuzzywuzzy">fuzzywuzzy</a></b> (🥇30 ·  ⭐ 8.6K) - Fuzzy String Matching. <code><a href="http://bit.ly/2KucAZR">❗️GPL-2.0</a></code></summary>
...
- [GitHub](https://github.com/seatgeek/fuzzywuzzy) (👨‍💻 70 · 🔀 860 · 📦 11K · 📋 180 - 43% open · ⏱️ 09.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/fuzzywuzzy) (📥 2.7M / month):
	```
...
<details><summary><b><a href="https://github.com/un33k/python-slugify">python-slugify</a></b> (🥈28 ·  ⭐ 1.1K · 💤) - A Python slugify library that translates unicode to ASCII. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/un33k/python-slugify) (👨‍💻 30 · 🔀 87 · 📦 23K · 📋 51 - 1% open · ⏱️ 12.05.2021):

	```
	git clone https://github.com/un33k/python-slugify
	```
- [PyPi](https://pypi.org/project/python-slugify) (📥 2.4M / month):
	```
	pip install python-slugify
	```
- [Conda](https://anaconda.org/conda-forge/python-slugify) (📥 620K · ⏱️ 06.05.2021):
	```
...
- [GitHub](https://github.com/life4/textdistance) (👨‍💻 11 · 🔀 200 · 📥 390 · 📦 1.4K · ⏱️ 29.11.2021):
...
- [PyPi](https://pypi.org/project/textdistance):
	...
	```
- [Conda](https://anaconda.org/conda-forge/textdistance) (📥 66K · ⏱️ 27.10.2021):
	```
	conda install -c conda-forge textdistance
	```
</details>
<details><summary><b><a href="https://github.com/pwaller/pyfiglet">pyfiglet</a></b> (🥈24 ·  ⭐ 920) - An implementation of figlet written in Python. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/pwaller/pyfiglet) (👨‍💻 20 · 🔀 91 · 📦 15K · 📋 41 - 21% open · ⏱️ 04.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/pyfiglet) (📥 340K / month):
	```
...
<details><summary><b><a href="https://github.com/andialbrecht/sqlparse">sqlparse</a></b> (🥈22 ·  ⭐ 2.7K) - A non-validating SQL parser. <code><a href="http://bit.ly/3aKzpTv">BSD-3</a></code></summary>
...
<details><summary><b><a href="https://github.com/dabeaz/ply">ply</a></b> (🥉21 ·  ⭐ 2.1K · 💀) - Implementation of lex and yacc parsing tools for Python. <code>❗Unlicensed</code></summary>
...
<details><summary><b><a href="https://github.com/mozillazg/python-pinyin">pypinyin</a></b> (🥉19 ·  ⭐ 3.6K) - Convert Chinese hanzi () to pinyin (). <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/daviddrysdale/python-phonenumbers) (👨‍💻 25 · 🔀 350 · 📋 130 - 3% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/vinta/pangu.py) (👨‍💻 7 · 🔀 22 · 📦 53 · 📋 8 - 37% open · ⏱️ 09.02.2019):
...
<details><summary><b><a href="https://github.com/boto/boto3">boto3</a></b> (🥇36 ·  ⭐ 6.9K) - Python interface to Amazon Web Services. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/boto/boto3) (👨‍💻 130 · 🔀 1.4K · 📦 150K · 📋 2.5K - 10% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/boto/boto3
	```
- [PyPi](https://pypi.org/project/boto3) (📥 94M / month):
	```
	pip install boto3
	```
- [Conda](https://anaconda.org/conda-forge/boto3) (📥 7.8M · ⏱️ 09.12.2021):
	```
	conda install -c conda-forge boto3
	```
</details>
<details><summary><b><a href="https://github.com/googleapis/google-api-python-client">google-api-python-client</a></b> (🥈34 ·  ⭐ 5.3K) - Google APIs Client Library for Python. <code><a href="http://bit.ly/3nYMfla">Apache-2</a></code></summary>

- [GitHub](https://github.com/googleapis/google-api-python-client) (👨‍💻 180 · 🔀 2K · 📥 93 · 📦 82K · 📋 860 - 4% open · ⏱️ 08.12.2021):

	```
	git clone https://github.com/google/google-api-python-client
	```
- [PyPi](https://pypi.org/project/google-api-python-client) (📥 14M / month):
	```
	pip install google-api-python-client
	```
- [Conda](https://anaconda.org/conda-forge/google-api-python-client) (📥 980K · ⏱️ 07.12.2021):
	```
	conda install -c conda-forge google-api-python-client
	```
</details>
<details><summary><b><a href="https://github.com/burnash/gspread">gspread</a></b> (🥈28 ·  ⭐ 5.7K) - Google Spreadsheets Python API. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/burnash/gspread) (👨‍💻 140 · 🔀 820 · 📥 52 · 📦 13K · 📋 670 - 10% open · ⏱️ 07.12.2021):
...
- [GitHub](https://github.com/mobolic/facebook-sdk) (👨‍💻 99 · 🔀 910 · 📦 3.3K · 📋 240 - 8% open · ⏱️ 27.12.2020):
	...
	```
- [PyPi](https://pypi.org/project/facebook-sdk) (📥 64K / month):
	```
...
- [GitHub](https://github.com/marshmallow-code/webargs) (👨‍💻 58 · 🔀 140 · 📦 3.3K · 📋 260 - 2% open · ⏱️ 02.12.2021):

	```
	git clone https://github.com/marshmallow-code/webargs
	```
- [PyPi](https://pypi.org/project/webargs) (📥 250K / month):
	```
	pip install webargs
	```
...
- [GitHub](https://github.com/codeinthehole/purl) (👨‍💻 18 · 🔀 34 · 📦 1.8K · 📋 20 - 25% open · ⏱️ 15.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/purl) (📥 22K / month):
	```
	pip install purl
	```
...
- [GitHub](https://github.com/gruns/furl) (👨‍💻 14 · 🔀 120 · 📋 100 - 20% open · ⏱️ 27.09.2021):
	...
	```
- [PyPi](https://pypi.org/project/furl) (📥 270K / month):
	```
	pip install furl
	```
...
- [GitHub](https://github.com/ellisonleao/pyshorteners) (👨‍💻 24 · 🔀 55 · 📦 3.1K · 📋 73 - 2% open · ⏱️ 29.07.2020):
...
- [GitHub](https://github.com/abhiTronix/vidgear) (👨‍💻 9 · 🔀 150 · 📥 500 · 📦 150 · 📋 190 - 1% open · ⏱️ 05.12.2021):
...
- [GitHub](https://github.com/aizvorski/scikit-video) (👨‍💻 2 · 🔀 23 · 📋 7 - 57% open · ⏱️ 28.05.2016):
	...
	```
- [PyPi](https://pypi.org/project/scikit-video) (📥 27K / month):
	```
...
- [GitHub](https://github.com/jazzband/django-pipeline) (👨‍💻 170 · 🔀 350 · 📦 1.9K · 📋 430 - 28% open · ⏱️ 25.11.2021):
...
<details><summary><b><a href="https://github.com/miracle2k/webassets">webassets</a></b> (🥈26 ·  ⭐ 900 · 💤) - Bundles, optimizes, and manages unique cache-busting URLs.. <code>❗Unlicensed</code></summary>
...
- [GitHub](https://github.com/miracle2k/webassets) (👨‍💻 160 · 🔀 250 · 📦 5.3K · 📋 290 - 19% open · ⏱️ 01.05.2021):
	...
	```
- [PyPi](https://pypi.org/project/webassets) (📥 70K / month):
	```
...
- [GitHub](https://github.com/jschneier/django-storages) (👨‍💻 220 · 🔀 690 · 📋 550 - 24% open · ⏱️ 06.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/django-storages) (📥 890K / month):
	```
...
<details><summary><b><a href="https://github.com/miracle2k/flask-assets">flask-assets</a></b> (🥉24 ·  ⭐ 420 · 💀) - Helps you integrate webassets into your Flask app. <code><a href="http://bit.ly/3rqEWVr">BSD-2</a></code></summary>
...
- [GitHub](https://github.com/miracle2k/flask-assets) (👨‍💻 38 · 🔀 83 · 📦 6K · 📋 94 - 21% open · ⏱️ 29.02.2020):
	...
	```
- [PyPi](https://pypi.org/project/flask-assets) (📥 53K / month):
	```
...
- [GitHub](https://github.com/django-compressor/django-compressor) (👨‍💻 200 · 🔀 540 · 📋 600 - 16% open · ⏱️ 07.12.2021):

	```
	git clone https://github.com/django-compressor/django-compressor
	```
- [PyPi](https://pypi.org/project/django-compressor) (📥 160K / month):
	```
...
- [GitHub](https://github.com/psf/requests-html) (👨‍💻 62 · 🔀 820 · 📦 6.4K · 📋 340 - 41% open · ⏱️ 10.05.2020):
...
- [PyPi](https://pypi.org/project/requests-html):
	...
	```
- [Conda](https://anaconda.org/conda-forge/requests-html) (📥 510 · ⏱️ 26.06.2021):
	```
...
- [PyPi](https://pypi.org/project/sumy):
	...
	pip install sumy
	```
- [Conda](https://anaconda.org/conda-forge/sumy) (📥 550 · ⏱️ 22.10.2021):
	```
...
- [GitHub](https://github.com/Alir3z4/html2text) (👨‍💻 76 · 🔀 200 · 📋 190 - 35% open · ⏱️ 13.06.2021):
	...
	```
- [PyPi](https://pypi.org/project/html2text) (📥 660K / month):
	```
	pip install html2text
	```
- [Conda](https://anaconda.org/conda-forge/html2text) (📥 7.6K · ⏱️ 09.02.2020):
	```
...
<details><summary><b><a href="https://github.com/coleifer/micawber">micawber</a></b> (🥉21 ·  ⭐ 560) - A small library for extracting rich content from URLs. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/coleifer/micawber) (👨‍💻 27 · 🔀 82 · 📦 630 · ⏱️ 12.07.2021):
	...
	```
- [PyPi](https://pypi.org/project/micawber) (📥 7.1K / month):
	```
...
<details><summary><b><a href="https://github.com/michaelhelmick/lassie">lassie</a></b> (🥉17 ·  ⭐ 540) - Web Content Retrieval for Humans. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>
...
- [GitHub](https://github.com/michaelhelmick/lassie) (👨‍💻 15 · 🔀 42 · 📦 27 · 📋 38 - 23% open · ⏱️ 20.08.2021):
	...
	```
- [PyPi](https://pypi.org/project/lassie) (📥 820 / month):
	```
	pip install lassie
	```
...
- [GitHub](https://github.com/jmcarp/robobrowser) (👨‍💻 10 · 🔀 330 · 📦 800 · 📋 73 - 58% open · ⏱️ 07.06.2015):
...
- [GitHub](https://github.com/MasoniteFramework/masonite) (👨‍💻 74 · 🔀 99 · 📥 8 · 📋 260 - 3% open · ⏱️ 06.12.2021):
...
- [GitHub](https://github.com/django/channels) (👨‍💻 230 · 🔀 680 · 📦 15K · 📋 1.1K - 9% open · ⏱️ 12.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/channels) (📥 220K / month):
	```
	pip install channels
	```
- [Conda](https://anaconda.org/conda-forge/channels) (📥 69K · ⏱️ 11.07.2021):
	```
...
- [GitHub](https://github.com/pallets/werkzeug) (👨‍💻 440 · 🔀 1.6K · 📥 250 · 📦 630K · 📋 910 - 2% open · ⏱️ 16.11.2021):
	...
	```
- [PyPi](https://pypi.org/project/werkzeug) (📥 25M / month):
	```
...
- [GitHub](https://github.com/benoitc/gunicorn) (👨‍💻 360 · 🔀 1.5K · 📥 99 · 📦 570K · 📋 1.7K - 17% open · ⏱️ 06.09.2021):
...
- [PyPi](https://pypi.org/project/gunicorn):
	...
	```
- [Conda](https://anaconda.org/conda-forge/gunicorn) (📥 810K · ⏱️ 02.11.2021):
	```
...
- [PyPi](https://pypi.org/project/bjoern):
	...
	pip install bjoern
	```
- [Conda](https://anaconda.org/conda-forge/bjoern) (📥 57K · ⏱️ 15.11.2021):
	```
	conda install -c conda-forge bjoern
	```
</details>
<details><summary><b><a href="https://github.com/Pylons/waitress">waitress</a></b> (🥉15 ·  ⭐ 1K) - Multi-threaded, powers Pyramid. <code>❗Unlicensed</code></summary>
